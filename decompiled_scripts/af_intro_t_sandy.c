...
int func_13(int iParam0) // Position - 0xA51 Hash - 0x93E56CA5 ^0x1301DA8F
{
...
void func_14(int iParam0, eCharacter echParam1) // Position - 0xAA7 Hash - 0x67CD27CA ^0x810DD823
{
	eCharacter character;
