...
BOOL func_6(Player plParam0, int iParam1) // Position - 0x241 Hash - 0x1A32E11A ^0x6AADE226
{
	BOOL flag;
...
BOOL func_10(Player plParam0) // Position - 0x309 Hash - 0x68897CDD ^0x62820466
{
