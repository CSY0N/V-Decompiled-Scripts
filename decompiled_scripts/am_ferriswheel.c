...
void main() // Position - 0x0 Hash - 0x5D84F89F ^0x5D84F89F
{
	...
	iLocal_44 = 49;
	iLocal_45 = 64;
	hLocal_285 = joaat("prop_ld_ferris_wheel");
	hLocal_286 = joaat("prop_ferris_car_01");
	sLocal_287 = "MISSFINALE_C2IG_5";
	fLocal_306 = 2f;
	uLocal_307 = { -1663.97f, -1126.7f, 30.7f };
	uLocal_310 = { 0.5f, 0.5f, -1.94f };
	fLocal_316 = 13f;
	iLocal_317 = -1;
	iLocal_318 = -1;
	iLocal_319 = -1;
	iLocal_320 = -1;
	bLocal_321 = true;
	sLocal_397 = "anim@mp_ferris_wheel";
	bLocal_427 = true;
	flag = NETWORK::NETWORK_IS_GAME_IN_PROGRESS();

	if (flag)
	{
		if (!func_199(uScriptParam_0))
			func_190();
	...
	while (true)
	{
		...
		if (!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), -1645.5549f, -1123.872f, 17.3436f, 300f, 300f, 300f, false, true, 0) || _IS_FMMC_ACTIVE() || NETWORK::NETWORK_IS_ACTIVITY_SESSION() || func_176() && !func_174())
			uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/] = 3;
	
		func_162();
	
		if (IS_BIT_SET(iLocal_416, 3))
			if (!Global_101444.f_1482)
				MISC::CLEAR_BIT(&iLocal_416, 3);
	
		switch (func_161(NETWORK::PARTICIPANT_ID_TO_INT()))
		{
			case 0:
				if (func_160() > 0)
					uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/] = 1;
				break;
		
			case 1:
				if (func_160() > 1)
					if (func_155())
						uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/] = 2;
				break;
			...
			case 3:
				if (!_STOPWATCH_IS_INITIALIZED(&uLocal_1138))
					if (!STREAMING::IS_NEW_LOAD_SCENE_ACTIVE())
						func_22(64, 0, false, true, 0);
			
				if (_STOPWATCH_HAS_TIME_PASSED(&uLocal_1138, 3000, false) || func_19() || func_18() || func_14(PLAYER::PLAYER_ID()))
					func_190();
				break;
		}
...
void func_1() // Position - 0x29C Hash - 0xFEB52B97 ^0xCBAA6E7D
{
	int num;
	Player playerIndex;
	...
	{
		playerIndex = NETWORK::NETWORK_GET_PLAYER_INDEX(PLAYER::INT_TO_PARTICIPANTINDEX(iLocal_395));
	
		switch (iLocal_1140)
		{
			case 0:
				if (IS_BIT_SET(uLocal_1404[iLocal_395 /*5*/].f_2, 4) && !IS_BIT_SET(iLocal_1140.f_3[iLocal_395], 1))
				{
					MISC::CLEAR_BIT(&(iLocal_1140.f_2), 0);
					MISC::CLEAR_BIT(&iLocal_1140.f_3[iLocal_395], 0);
					MISC::SET_BIT(&(iLocal_1140.f_2), 2);
					iLocal_419 = 30000;
					iLocal_1140 = 1;
					_STOPWATCH_DESTROY(&uLocal_417);
					MISC::SET_BIT(&iLocal_1140.f_3[iLocal_395], 1);
				}
			
				if (IS_BIT_SET(uLocal_1404[iLocal_395 /*5*/].f_2, 3) && !IS_BIT_SET(iLocal_1140.f_3[iLocal_395], 0))
				{
					num = func_4(iLocal_395);
					...
					{
						iLocal_1140.f_197[iLocal_395 /*2*/].f_1 = playerIndex;
						iLocal_1140.f_197[iLocal_395 /*2*/] = num;
						iLocal_1140.f_262 = func_2();
						MISC::SET_BIT(&(iLocal_1140.f_2), 0);
						MISC::SET_BIT(&iLocal_1140.f_3[iLocal_395], 0);
					}
				}
				break;
		
			case 1:
				if (IS_BIT_SET(iLocal_1140.f_3[iLocal_395], 1))
					MISC::CLEAR_BIT(&iLocal_1140.f_3[iLocal_395], 1);
				break;
		}
	}
	else if (iLocal_1140.f_3[iLocal_395] != 0 || iLocal_1140.f_197[iLocal_395 /*2*/] != -1 || iLocal_1140.f_197[iLocal_395 /*2*/].f_1 != 0)
	{
		iLocal_1140.f_3[iLocal_395] = 0;
		iLocal_1140.f_197[iLocal_395 /*2*/] = -1;
		iLocal_1140.f_197[iLocal_395 /*2*/].f_1 = 0;
		iLocal_1140.f_262 = func_2();
	}

	iLocal_395 = iLocal_395 + 1;

	if (iLocal_395 == NETWORK::NETWORK_GET_MAX_NUM_PARTICIPANTS())
		iLocal_395 = 0;

	return;
}

int func_2() // Position - 0x44D Hash - 0xDB18EADE ^0x80FF6033
{
	int num;
	int i;
	int num2;
...
int func_3() // Position - 0x4B5 Hash - 0x8A076508 ^0xA30247AF
{
	int i;
	...
	for (i = 0; i < 16; i = i + 1)
	{
		...
		if (iLocal_1140.f_36[i /*10*/].f_6 >= Global_2746723)
			return i;
	}

	if (iLocal_1140.f_36[0 /*10*/].f_6 >= Global_2746723)
		return 0;
	else
		return 1;
...
int func_4(int iParam0) // Position - 0x50F Hash - 0x654ECD27 ^0x88AA756B
{
	int i;
	int j;
	BOOL flag;
	...
	for (j = 0; j < 2; j = j + 1)
	{
		if (IS_BIT_SET(uLocal_1404[iParam0 /*5*/].f_2, 0))
		{
			return uLocal_1404[iParam0 /*5*/].f_3;
		}
		else
		{
			for (i = 0; i < 16; i = i + 1)
			{
				...
				if (!(iLocal_1140.f_36[i /*10*/].f_3 >= 2))
					if (iLocal_1140.f_36[i /*10*/].f_6 >= Global_2746723)
						if (!(iLocal_1140.f_36[i /*10*/].f_3 > 0) || flag)
							return i;
			}
		
			if (!(iLocal_1140.f_36[0 /*10*/].f_3 >= 2))
				if (iLocal_1140.f_36[0 /*10*/].f_6 >= Global_2746723)
					if (!(iLocal_1140.f_36[0 /*10*/].f_3 > 0) || flag)
						return 0;
				else
					return 1;
...
void _STOPWATCH_DESTROY(var uParam0) // Position - 0x5FA Hash - 0xBA5A1D5A ^0x33644ECA
{
	uParam0->f_1 = 0;
	return;
}

void func_6() // Position - 0x607 Hash - 0x520E2F92 ^0xE23D2710
{
	int i;
	var unk;
	...
	switch (iLocal_1140)
	{
		...
		case 1:
			if (_STOPWATCH_HAS_TIME_PASSED(&uLocal_417, iLocal_419, false))
			{
				if (func_9())
				{
					if (iLocal_1140.f_262 != -1)
					{
						unk = iLocal_1140.f_197[iLocal_1140.f_262 /*2*/];
					
						for (i = 0; i < 32; i = i + 1)
						{
							if (iLocal_1140.f_197[i /*2*/] == unk)
							{
								MISC::CLEAR_BIT(&iLocal_1140.f_3[i], 0);
								MISC::CLEAR_BIT(&iLocal_1140.f_3[i], 1);
								iLocal_1140.f_197[i /*2*/] = -1;
								iLocal_1140.f_197[i /*2*/].f_1 = 0;
							}
						}
					
						iLocal_1140.f_197[iLocal_1140.f_262 /*2*/] = -1;
						iLocal_1140.f_197[iLocal_1140.f_262 /*2*/].f_1 = 0;
					}
					...
					MISC::CLEAR_BIT(&(iLocal_1140.f_2), 3);
					MISC::CLEAR_BIT(&(iLocal_1140.f_2), 4);
					iLocal_1140 = 0;
				}
				else
				{
			...
			{
				if (30000 - _STOPWATCH_GET_TIME_PASSED(&uLocal_417, false, false) < 4000)
					MISC::SET_BIT(&(iLocal_1140.f_2), 4);
			
				if (30000 - _STOPWATCH_GET_TIME_PASSED(&uLocal_417, false, false) < 3000)
					MISC::SET_BIT(&(iLocal_1140.f_2), 3);
			
				if (iLocal_1140.f_262 != -1 && !IS_BIT_SET(uLocal_1404[iLocal_1140.f_262 /*5*/].f_2, 6) && ENTITY::IS_ENTITY_AT_COORD(PLAYER::GET_PLAYER_PED(iLocal_1140.f_197[iLocal_1140.f_262 /*2*/].f_1), -1661.9504f, -1127.0112f, 12.6973f, 1f, 1f, 2f, false, true, 0) && IS_BIT_SET(iLocal_1140.f_2, 2))
					if (!IS_BIT_SET(iLocal_1140.f_2, 1))
						MISC::SET_BIT(&(iLocal_1140.f_2), 1);
				else if (IS_BIT_SET(iLocal_1140.f_2, 1))
					MISC::CLEAR_BIT(&(iLocal_1140.f_2), 1);
			}
			break;
	}
...
int _STOPWATCH_GET_TIME_PASSED(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x7E5 Hash - 0xAB71C5AE ^0x10186D95
{
...
BOOL func_8() // Position - 0x82C Hash - 0x86D35BAE ^0x71F58414
{
	int i;

	for (i = 0; i < NETWORK::NETWORK_GET_MAX_NUM_PARTICIPANTS(); i = i + 1)
	{
		if (iLocal_1140.f_197[i /*2*/] != -1)
			return true;
	}
...
BOOL func_9() // Position - 0x85B Hash - 0x37E45A93 ^0x202CF64A
{
	int i;

	for (i = func_10(); i >= 0; i = i + -1)
	{
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(i)))
			if (IS_BIT_SET(uLocal_1404[i /*5*/].f_2, 9) || IS_BIT_SET(uLocal_1404[i /*5*/].f_2, 10))
				return false;
	}
...
int func_10() // Position - 0x8AB Hash - 0xA5E19383 ^0xA5E19383
{
	if (Global_2692280)
		return 32;
...
BOOL func_11() // Position - 0x8C6 Hash - 0x1BFB0F00 ^0x32C0EB4A
{
	int i;

	for (i = 0; i < 16; i = i + 1)
	{
		iLocal_1140.f_36[i /*10*/].f_6 = ((360f / 16f) * (float)i) - 21.5f;
	}

	iLocal_1140.f_36[0 /*10*/].f_6 = iLocal_1140.f_36[0 /*10*/].f_6 + 360f;
	return true;
}

BOOL func_12() // Position - 0x91C Hash - 0x54141E57 ^0xBB60BD19
{
	int i;
	Player player;
	...
	for (i = 0; i < 32; i = i + 1)
	{
		...
		if (_NETWORK_IS_PLAYER_VALID(player, false, true))
			if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::GET_PLAYER_PED(player), -1662.0095f, -1126.8689f, 12.6973f, 500f, 500f, 500f, false, true, 0))
				return true;
	}
...
BOOL _NETWORK_IS_PLAYER_VALID(Player player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x97D Hash - 0x3FF6E4CA ^0xE6B59972
{
	Player player;
...
BOOL func_14(Player plParam0) // Position - 0x9DD Hash - 0x79327863 ^0x79327863
{
	if (func_15(plParam0, true, false))
...
BOOL func_15(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0xA02 Hash - 0x326C99FC ^0x326C99FC
{
	if (bParam1)
		if (func_16(plParam0))
			return true;
...
BOOL func_16(Player plParam0) // Position - 0xA34 Hash - 0x3E978ED3 ^0x3E978ED3
{
	return func_17(plParam0);
}

BOOL func_17(Player plParam0) // Position - 0xA42 Hash - 0x1ACBF981 ^0x51A073B
{
	return IS_BIT_SET(Global_1845263[plParam0 /*877*/].f_11.f_1, 0);
}

BOOL func_18() // Position - 0xA59 Hash - 0x6197B5B0 ^0x4089F3C4
{
	return IS_BIT_SET(Global_1845263[PLAYER::PLAYER_ID() /*877*/].f_36.f_18, 0);
}

BOOL func_19() // Position - 0xA72 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1575079;
}

BOOL _STOPWATCH_HAS_TIME_PASSED(var pStopwatch, int millis, BOOL useLocalTimer) // Position - 0xA7E Hash - 0x154EA353 ^0xBFA672B0
{
	if (millis == -1)
		return true;
...
void _STOPWATCH_INITIALIZE(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0xADC Hash - 0x6F79B86B ^0x7B76DD66
{
	if (pStopwatch->f_1 == 0)
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !useLocalTimer)
...
void func_22(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xB21 Hash - 0xECB6BFBA ^0x4A87976F
{
	if (iParam0 != 198)
	{
		if (Global_79248)
		...
		func_25(iParam0, bParam3, iParam4, false);
...
void func_23(int iParam0, int iParam1) // Position - 0xB79 Hash - 0x98D88B1B ^0x13CF2AF0
{
	switch (iParam0)
	{
		case 12:
...
void func_24(int iParam0, BOOL bParam1) // Position - 0xC58 Hash - 0xF0703301 ^0x756A9364
{
	if (bParam1)
...
BOOL func_25(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0xC81 Hash - 0x72F8706 ^0xBE0DD95D
{
	BOOL flag;
	int num;
	int num2;
...
BOOL func_26() // Position - 0x15E6 Hash - 0x6134FBB2 ^0x82030B41
{
...
int func_27() // Position - 0x1616 Hash - 0x21D64237 ^0x21D64237
{
	return Global_32829;
}

int func_28() // Position - 0x1621 Hash - 0x21D64237 ^0x21D64237
{
	return Global_32828;
}

int func_29(var uParam0, int iParam1) // Position - 0x162C Hash - 0x5A2CB71 ^0x72E51ABA
{
	int i;
...
BOOL _STOPWATCH_IS_INITIALIZED(var uParam0) // Position - 0x4E6C Hash - 0xD73B9827 ^0x2D8CE86B
{
	return uParam0->f_1;
}

void func_31() // Position - 0x4E78 Hash - 0xDCADD28 ^0xBEC67786
{
	switch (uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_1)
	{
		case 0:
			if (iLocal_1140 == 1)
			{
				HUD::CLEAR_HELP(true);
				MISC::CLEAR_BIT(&iLocal_416, 1);
				MISC::CLEAR_BIT(&(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2), 4);
				iLocal_396 = 0;
				uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_1 = 1;
			}
			else
			{
				if (IS_BIT_SET(iLocal_1140.f_2, 0))
					if (iLocal_1140.f_262 != -1)
						if (Global_2746723 != iLocal_1140.f_36[iLocal_1140.f_197[iLocal_1140.f_262 /*2*/] /*10*/].f_6)
							func_151();
				else
					func_151();
			
				if (IS_BIT_SET(iLocal_1140.f_3[NETWORK::PARTICIPANT_ID_TO_INT()], 0))
				{
					uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_3 = iLocal_1140.f_197[NETWORK::PARTICIPANT_ID_TO_INT() /*2*/];
				
					if (uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_3 != -1)
					{
						if (Global_2746723 != iLocal_1140.f_36[uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_3 /*10*/].f_6)
						{
							if (IS_BIT_SET(iLocal_416, 0))
							{
								HUD::CLEAR_HELP(true);
								MISC::CLEAR_BIT(&iLocal_416, 0);
							}
						
							if (!IS_BIT_SET(iLocal_416, 1))
							{
								if (IS_BIT_SET(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2, 0))
									_DISPLAY_HELP_TEXT("AMFW_WAIT_OFF" /*The ride will stop on the next rotation.*/, -1);
								else
									_DISPLAY_HELP_TEXT("AMFW_WAIT" /*Stopping...*/, -1);
							
								MISC::SET_BIT(&iLocal_416, 1);
							}
						}
						else if (!IS_BIT_SET(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2, 4))
						{
							MISC::SET_BIT(&(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2), 4);
							MISC::CLEAR_BIT(&(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2), 3);
							bLocal_427 = true;
						}
					}
					else
				...
				else if (!IS_BIT_SET(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2, 8))
				{
					if (!func_149(0) && !func_145(PLAYER::PLAYER_ID()) && !func_144(PLAYER::PLAYER_ID(), 21) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) && !PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) && VEHICLE::GET_CLOSEST_VEHICLE(-1661.9504f, -1127.0112f, 12.6973f, 1f, 0, 6) == 0 && !func_143(PLAYER::PLAYER_PED_ID()) && !_IS_PLAYER_IN_ANIMAL_FORM(PLAYER::PLAYER_ID()))
					{
						if (!func_139())
						{
							if (!IS_BIT_SET(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2, 0))
							{
								...
								{
									func_138("AMFW_ENTER" /*Press ~INPUT_CONTEXT~ to ride the Ferris Whale. The cost is $~1~.*/, Global_262145.f_8431, -1);
									MISC::SET_BIT(&iLocal_416, 0);
								
									if (PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_CONTEXT))
									{
										func_119();
										MISC::SET_BIT(&(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2), 3);
									}
								}
								else if (IS_BIT_SET(iLocal_416, 0))
								{
									HUD::CLEAR_HELP(true);
									MISC::CLEAR_BIT(&iLocal_416, 0);
								}
		...
		case 1:
			if (iLocal_1140 == 0)
			{
				if (IS_BIT_SET(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2, 5) || IS_BIT_SET(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2, 7))
				{
					func_85();
					func_83(25);
				}
				...
				if (!IS_BIT_SET(iLocal_1140.f_3[NETWORK::PARTICIPANT_ID_TO_INT()], 0))
					MISC::CLEAR_BIT(&(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2), 8);
			
				HUD::CLEAR_HELP(true);
				MISC::CLEAR_BIT(&(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2), 7);
				MISC::CLEAR_BIT(&iLocal_416, 2);
				MISC::CLEAR_BIT(&(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2), 11);
				MISC::CLEAR_BIT(&(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2), 6);
				uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_1 = 0;
			...
			else
			{
				if (IS_BIT_SET(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2, 0))
				{
					if (iLocal_1140.f_262 != -1 && uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_3 != -1 && uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_3 == iLocal_1140.f_197[iLocal_1140.f_262 /*2*/])
					{
						if (!IS_BIT_SET(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2, 7))
						{
							if (!IS_BIT_SET(iLocal_1140.f_2, 4))
								_DISPLAY_HELP_TEXT("AMFW_GET_OUT" /*Press ~INPUT_ENTER~ to get out.*/, -1);
						
							func_82(&uLocal_393, false);
							func_82(&uLocal_322, false);
							func_81(&caLocal_323, false, true);
							MISC::SET_BIT(&(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2), 7);
						}
					
						if (!IS_BIT_SET(iLocal_1140.f_2, 3))
							if (PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_ENTER))
								func_79(_GET_PARTICIPANTS_SCRIPT_EVENT_BITS(true));
					}
					else
					{
						func_93();
				...
				else if (!func_149(0) && !func_145(PLAYER::PLAYER_ID()) && !func_144(PLAYER::PLAYER_ID(), 21) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) && !PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) && VEHICLE::GET_CLOSEST_VEHICLE(-1661.9504f, -1127.0112f, 12.6973f, 1f, 0, 6) == 0 && !func_78() && !Global_1574582.f_6)
				{
					if (!func_139())
					{
						if (IS_BIT_SET(iLocal_1140.f_2, 1))
						{
							if (iLocal_1140.f_197[iLocal_1140.f_262 /*2*/].f_1 == PLAYER::PLAYER_ID())
							{
								if (!IS_BIT_SET(iLocal_1140.f_2, 3))
								{
									if (!IS_BIT_SET(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2, 11))
									{
										func_79(_GET_PARTICIPANTS_SCRIPT_EVENT_BITS(true));
										MISC::SET_BIT(&(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2), 11);
									}
								}
							}
						}
						else if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), -1661.9504f, -1127.0112f, 12.6973f, 1f, 1f, 2f, false, true, 0))
						{
							if (!IS_BIT_SET(iLocal_1140.f_2, 3) && !IS_BIT_SET(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2, 9) && iLocal_1140.f_262 != -1)
							{
								if (!(iLocal_1140.f_36[iLocal_1140.f_197[iLocal_1140.f_262 /*2*/] /*10*/].f_3 >= 2))
								{
									if (IS_BIT_SET(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2, 8))
										_DISPLAY_HELP_TEXT("AMFW_GET_IN" /*Press ~INPUT_ENTER~ to get in.*/, -1);
									else
										func_138("AMFW_GET_IN_P" /*Press ~INPUT_ENTER~ to get in the gondola. The cost is $~1~.*/, Global_262145.f_8431, -1);
								
									if (PAD::IS_CONTROL_JUST_PRESSED(PLAYER_CONTROL, INPUT_ENTER))
									{
										if (!IS_BIT_SET(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2, 8))
											func_119();
								...
								else if (!IS_BIT_SET(iLocal_416, 2))
								{
									_DISPLAY_HELP_TEXT("AMFW_CAR_FULL" /*This gondola is full. You may wait for the next one.*/, -1);
									MISC::SET_BIT(&iLocal_416, 2);
								}
							}
						}
					}
				...
				if (iLocal_1140.f_262 != -1)
				{
					if (IS_BIT_SET(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2, 9))
						func_69();
				
					if (IS_BIT_SET(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2, 10))
						func_39();
				}
			}
			break;
...
void func_32() // Position - 0x54CC Hash - 0x74FBF672 ^0x2B9AF1F5
{
	float entityCoords;

	if (VEHICLE::IS_ANY_VEHICLE_NEAR_POINT(-1666.7106f, -1127.5184f, 12.6973f, 3f) && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), -1666.7106f, -1127.5184f, 12.6973f, 0.5f, 0.5f, 1f, false, true, 0) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), -1666.383f, -1126.2861f, 12.6973f, 0.5f, 0.5f, 1f, false, true, 0))
	{
		if (!IS_BIT_SET(iLocal_416, 5))
		{
			...
			{
				_STOPWATCH_DESTROY(&uLocal_420);
				MISC::SET_BIT(&iLocal_416, 5);
			}
		}
		else if (_STOPWATCH_HAS_TIME_PASSED(&uLocal_420, 2000, false))
		{
			if (TASK::IS_PED_WALKING(PLAYER::PLAYER_PED_ID()) || TASK::IS_PED_RUNNING(PLAYER::PLAYER_PED_ID()) || TASK::IS_PED_SPRINTING(PLAYER::PLAYER_PED_ID()) || TASK::IS_PED_STRAFING(PLAYER::PLAYER_PED_ID()))
			{
				entityCoords = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
				ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), entityCoords, entityCoords.f_1, entityCoords.f_2 + 2f, true, false, false, true);
				MISC::CLEAR_BIT(&iLocal_416, 5);
			}
		}
	}
...
void func_33(int iParam0) // Position - 0x5600 Hash - 0x7E11E9C ^0x544BF257
{
	if (func_38())
		return;
...
void func_34(int iParam0) // Position - 0x5633 Hash - 0x4066FEF5 ^0x9787FBDA
{
	if (func_38())
		return;
...
BOOL func_35() // Position - 0x56BD Hash - 0xD140D54A ^0xE638D98F
{
...
void func_36(BOOL bParam0, BOOL bParam1) // Position - 0x56E4 Hash - 0xF40FC178 ^0xA6F60F17
{
	if (bParam0)
	{
		if (func_149(0))
...
BOOL func_37() // Position - 0x5758 Hash - 0x8DF3D75D ^0x8DF3D75D
{
	return IS_BIT_SET(Global_1956030, 5);
}

BOOL func_38() // Position - 0x5766 Hash - 0xC41437CB ^0xC41437CB
{
	return IS_BIT_SET(Global_1956030, 19);
}

void func_39() // Position - 0x5775 Hash - 0xEE3FBE07 ^0x198761A5
{
	TEXT_LABEL_ASSIGN_STRING(&uLocal_410, "exit_player_", 24);

	if (uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_4 == 0)
		TEXT_LABEL_APPEND_STRING(&uLocal_410, "one", 24);
	else
		TEXT_LABEL_APPEND_STRING(&uLocal_410, "two", 24);

	iLocal_425 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(uLocal_313, 0f, 0f, 0f, 2, false, false, 1065353216, 0, 1065353216);
	NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_425, sLocal_397, &uLocal_410, 8f, -8f, 131072, 0, 1148846080, 0);
	NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_425);
	HUD::CLEAR_HELP(true);
	...
	func_43(_GET_PARTICIPANTS_SCRIPT_EVENT_BITS(false));
	...
	func_41();
	MISC::SET_BIT(&(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2), 6);
	MISC::CLEAR_BIT(&(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2), 7);
	MISC::CLEAR_BIT(&(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2), 0);
	MISC::CLEAR_BIT(&(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2), 5);
	MISC::CLEAR_BIT(&(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2), 10);
	MISC::CLEAR_BIT(&(Global_1845263[PLAYER::PLAYER_ID() /*877*/].f_873), 14);
	func_40(_GET_PARTICIPANTS_SCRIPT_EVENT_BITS(true), uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_4, 0);
	uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_4 = -1;
	NETWORK::NETWORK_DISABLE_LEAVE_REMOTE_PED_BEHIND(false);
	return;
}

void func_40(int iParam0, var uParam1, int iParam2) // Position - 0x58E7 Hash - 0xE6AE429F ^0xB9FD126D
{
	int num;
...
void func_41() // Position - 0x5921 Hash - 0xACE86773 ^0xFFE787C7
{
	if (IS_BIT_SET(iLocal_416, 8))
	{
		func_42(&iLocal_317);
		func_42(&iLocal_319);
		func_42(&iLocal_320);
		...
		MISC::CLEAR_BIT(&iLocal_416, 8);
	}

	MISC::CLEAR_BIT(&iLocal_416, 7);
	return;
}

void func_42(var uParam0) // Position - 0x596F Hash - 0x4D96479A ^0x9A0BB87
{
	if (*uParam0 != -1)
	{
...
void func_43(int iParam0) // Position - 0x5990 Hash - 0xCA9AF2A3 ^0xB165B699
{
	int num;
...
BOOL func_44(Object obParam0) // Position - 0x59BE Hash - 0x251F0A94 ^0x6A446318
{
...
void func_45(BOOL bParam0) // Position - 0x59DC Hash - 0x8CAD05DF ^0x8062B046
{
	if (bParam0)
	{
		if (!IS_BIT_SET(iLocal_416, 6))
		{
			func_52(0, false);
			MISC::SET_BIT(&iLocal_416, 6);
		}
	}
	else if (IS_BIT_SET(iLocal_416, 6))
	{
		func_46();
		MISC::CLEAR_BIT(&iLocal_416, 6);
	}

	return;
}

void func_46() // Position - 0x5A1A Hash - 0x22E350E ^0xA38AA903
{
...
void func_47(int iParam0, int iParam1, BOOL bParam2) // Position - 0x5A48 Hash - 0x4BEFCAC6 ^0x4BEFCAC6
{
	if (func_51())
	{
		if (iParam1 == 1)
...
BOOL func_48() // Position - 0x5B12 Hash - 0x974E48B4 ^0x974E48B4
{
	return Global_2684312.f_841;
}

void func_49(BOOL bParam0) // Position - 0x5B21 Hash - 0x3C9A3419 ^0x64F3D42A
{
...
void _STOPWATCH_RESET(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x5C1A Hash - 0x6A4AB354 ^0xD9372BF4
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !useLocalTimer)
		if (!useAccurateTime)
			*pStopwatch = NETWORK::GET_NETWORK_TIME();
...
BOOL func_51() // Position - 0x5C57 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1574582;
}

void func_52(int iParam0, BOOL bParam1) // Position - 0x5C63 Hash - 0x8FCFD9DB ^0x2C74B8BF
{
	if (!func_15(PLAYER::PLAYER_ID(), true, false) || bParam1)
	{
		if (!func_51())
		{
...
void func_53(int iParam0, BOOL bParam1, int iParam2) // Position - 0x5CB8 Hash - 0x9EF7419F ^0x582C4A65
{
	if (!func_51() || bParam1)
	{
		Global_1574582 = true;
		...
		if (!NETWORK::NETWORK_IS_ACTIVITY_SESSION() && !func_48() && !func_14(PLAYER::PLAYER_ID()) && !func_145(PLAYER::PLAYER_ID()))
			Global_1057440 = 1;
...
void _SET_PLAYER_CONTROL_EX(Player plParam0, BOOL bParam1, eSetPlayerControlFlags espcfParam2, BOOL bParam3) // Position - 0x5D25 Hash - 0xCD788E2C ^0x50180146
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(plParam0) && PLAYER::IS_PLAYER_PLAYING(plParam0) || bParam3 == true)
		{
			...
			if (!flag18)
			{
				...
				else if (flag14 || !func_64(PLAYER::PLAYER_ID(), 0) && !func_63() && !func_62(PLAYER::PLAYER_ID()))
			...
			if (bParam1)
			{
				...
				if (!func_58(playerPed) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(playerPed))
					if (!flag20)
			...
			else
			{
				if (!func_58(playerPed) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(playerPed))
				{
					...
					if (func_55(*Global_4718592.f_183007))
...
BOOL func_55(int iParam0) // Position - 0x61D7 Hash - 0xFB453256 ^0xFB453256
{
	return iParam0 == 17;
}

void func_56() // Position - 0x61E4 Hash - 0xBC63612E ^0xBC63612E
{
	var unk;
...
void func_57() // Position - 0x6231 Hash - 0x5FEB45C4 ^0x33557962
{
...
BOOL func_58(Ped pedParam0) // Position - 0x626F Hash - 0x93DB01D2 ^0x43DCC591
{
...
void func_59(BOOL bParam0, Ped pedParam1, int iParam2) // Position - 0x62A0 Hash - 0x19FE7AFC ^0x4538006F
{
	int num;
	eViewModeContext i;
...
void _MPPLY_STAT_SET_BOOL(Hash hParam0, BOOL bParam1) // Position - 0x6370 Hash - 0x269D56BD ^0xB104E3E4
{
	Hash statName;
...
void func_61() // Position - 0x638C Hash - 0xEFF6029E ^0x224AB476
{
	eViewModeContext i;
...
BOOL func_62(Player plParam0) // Position - 0x63E4 Hash - 0x68897CDD ^0x62820466
{
	if (func_64(plParam0, 0))
		return true;
...
BOOL func_63() // Position - 0x6423 Hash - 0xA525B2F4 ^0xA525B2F4
{
	return IS_BIT_SET(Global_2621446, 3);
}

BOOL func_64(Player plParam0, int iParam1) // Position - 0x6431 Hash - 0x1A32E11A ^0x6AADE226
{
	BOOL flag;
...
int func_65(int iParam0, BOOL bParam1) // Position - 0x648A Hash - 0x1DCD393E ^0x1DCD393E
{
	int num;
	int num2;
...
int func_66() // Position - 0x64CB Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1574925;
}

BOOL func_67(Player plParam0) // Position - 0x64D7 Hash - 0x6A46C9B4 ^0x6A46C9B4
{
	int num;
...
BOOL func_68() // Position - 0x64F9 Hash - 0xEBB0E6F7 ^0x19BAFBE9
{
...
void func_69() // Position - 0x652A Hash - 0x9620EBC1 ^0xC2527524
{
	Vector3 vector;
	Vector3 offsetFromEntityGivenWorldCoords;
	int localSceneFromNetworkId;

	vector = { -1661.9143f, -1126.8416f, 12.6973f };

	if (!IS_BIT_SET(iLocal_416, 7))
	{
		...
		{
			if (!_STOPWATCH_IS_INITIALIZED(&uLocal_422))
				_STOPWATCH_INITIALIZE(&uLocal_422, true, false);
			else if (func_77(uLocal_422, 4000, true))
				MISC::SET_BIT(&iLocal_416, 7);
		
			return;
		}
		else
		{
			MISC::SET_BIT(&iLocal_416, 8);
			MISC::SET_BIT(&iLocal_416, 7);
		}
	}
	...
	{
		case 0:
			if (_NETWORK_IS_PLAYER_VALID(PLAYER::PLAYER_ID(), true, true) && !Global_1574582.f_6)
			{
				uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_3 = iLocal_1140.f_197[iLocal_1140.f_262 /*2*/];
				uLocal_313 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_288[uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_3], 0f, 0f, 0f) };
			
				if (!iLocal_1140.f_36[iLocal_1140.f_197[iLocal_1140.f_262 /*2*/] /*10*/][0])
					uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_4 = 0;
				else if (!iLocal_1140.f_36[iLocal_1140.f_197[iLocal_1140.f_262 /*2*/] /*10*/][1])
					uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_4 = 1;
			
				TEXT_LABEL_ASSIGN_STRING(&uLocal_398, "enter_player_", 24);
				TEXT_LABEL_ASSIGN_STRING(&uLocal_404, "idle_a_player_", 24);
			
				if (uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_4 == 0)
				{
					TEXT_LABEL_APPEND_STRING(&uLocal_398, "one", 24);
					TEXT_LABEL_APPEND_STRING(&uLocal_404, "one", 24);
				}
				else
				{
					TEXT_LABEL_APPEND_STRING(&uLocal_398, "two", 24);
					TEXT_LABEL_APPEND_STRING(&uLocal_404, "two", 24);
				}
			
				_SET_PLAYER_CONTROL_EX(PLAYER::PLAYER_ID(), false, SPC_CLEAR_TASKS | 256, false);
				func_45(true);
				TASK::TASK_GO_STRAIGHT_TO_COORD(PLAYER::PLAYER_PED_ID(), vector, 1f, 20000, 98.6981f, 0.2f);
				MISC::CLEAR_BIT(&(Global_1845263[PLAYER::PLAYER_ID() /*877*/].f_873), 14);
			...
			{
				MISC::CLEAR_BIT(&(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2), 9);
				func_40(_GET_PARTICIPANTS_SCRIPT_EVENT_BITS(true), uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_4, 1);
			}
			break;
		...
		case 1:
			...
			{
				iLocal_424 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(uLocal_313, 0f, 0f, 0f, 2, true, false, 1065353216, 0, 1065353216);
				NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_424, sLocal_397, &uLocal_398, 8f, -8f, 131072, 0, 1148846080, 0);
				NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_424);
				iLocal_426 = 2;
			}
			break;
	
		case 2:
			localSceneFromNetworkId = NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(iLocal_424);
		
			if (PED::GET_SYNCHRONIZED_SCENE_PHASE(localSceneFromNetworkId) > 0.99f)
			{
				iLocal_424 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(uLocal_313, 0f, 0f, 0f, 2, false, true, 1065353216, 0, 1065353216);
				NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_424, sLocal_397, &uLocal_404, 8f, -8f, 131072, 0, 1148846080, 0);
				NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_424);
				iLocal_426 = 3;
			}
			break;
		...
		case 3:
			...
			offsetFromEntityGivenWorldCoords = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(uLocal_288[uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_3], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)) };
			ENTITY::ATTACH_ENTITY_TO_ENTITY(PLAYER::PLAYER_PED_ID(), uLocal_288[uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_3], 0, offsetFromEntityGivenWorldCoords, 0f, 0f, ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()), false, false, false, false, 2, true, 0);
			NETWORK::NETWORK_ALLOW_REMOTE_ATTACHMENT_MODIFICATION(PLAYER::PLAYER_PED_ID(), true);
			func_70(_GET_PARTICIPANTS_SCRIPT_EVENT_BITS(false), uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_3, offsetFromEntityGivenWorldCoords, ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()));
			MISC::SET_BIT(&(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2), 5);
			MISC::SET_BIT(&(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2), 0);
			MISC::CLEAR_BIT(&(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2), 9);
			iLocal_426 = 0;
			func_40(_GET_PARTICIPANTS_SCRIPT_EVENT_BITS(true), uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_4, 1);
			break;
...
void func_70(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x68F0 Hash - 0x21FF075A ^0xDA060369
{
	int num;
	...
	if (!(iParam0 == 0))
		unk_0x71A6F836422FDD2B(1, &num, 8, iParam0, num);

	return;
}

void func_71() // Position - 0x6935 Hash - 0x35BBF2A0 ^0x35BBF2A0
{
	if (func_76() || func_75())
	{
		func_74();
...
void func_72() // Position - 0x6956 Hash - 0x4E2E9530 ^0xC4C076B7
{
	if (!_IS_FMMC_ACTIVE() && !func_73() && Global_2685248)
		Global_4718592.f_126144 = 0;

	return;
}

BOOL func_73() // Position - 0x6984 Hash - 0x974E48B4 ^0x974E48B4
{
	return Global_2684312.f_691;
}

void func_74() // Position - 0x6993 Hash - 0x92C2AC43 ^0x92C2AC43
{
	Global_2684312.f_756 = 1;
	return;
}

BOOL func_75() // Position - 0x69A3 Hash - 0x974E48B4 ^0x974E48B4
{
	return Global_2684312.f_735;
}

BOOL func_76() // Position - 0x69B2 Hash - 0xEDAE0057 ^0x5A1A7786
{
	return IS_BIT_SET(Global_2684312.f_2, 11);
}

BOOL func_77(int iParam0, var uParam1, int iParam2, BOOL bParam3) // Position - 0x69C3 Hash - 0x932F3142 ^0x2480F5A5
{
	if (iParam2 == -1)
		return true;
...
BOOL func_78() // Position - 0x6A16 Hash - 0x8E975DBA ^0xBE61962E
{
...
void func_79(int iParam0) // Position - 0x6A30 Hash - 0xCA9AF2A3 ^0xFB7393B2
{
	int num;
...
int _GET_PARTICIPANTS_SCRIPT_EVENT_BITS(BOOL includeLocalPlayer) // Position - 0x6A5E Hash - 0xCD3305A1 ^0xACF585BB
{
	int address;
	int i;
	Player playerIndex;
...
void func_81(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x6ABB Hash - 0xB8299397 ^0x1316F39D
{
...
void func_82(var uParam0, BOOL bParam1) // Position - 0x6B55 Hash - 0x4E79218 ^0xE6188FBD
{
	if (CAM::DOES_CAM_EXIST(*uParam0))
	{
...
void func_83(int iParam0) // Position - 0x6B88 Hash - 0x33704D3C ^0xA53E6AA3
{
	int i;
	...
	for (i = 0; i < 3; i = i + 1)
	{
		if (Global_2359296[func_84() /*5569*/].f_681.f_4243[i /*3*/] == iParam0)
		{
...
int func_84() // Position - 0x6BEB Hash - 0xF9396AAC ^0xF9396AAC
{
	int num;
...
void func_85() // Position - 0x6BF8 Hash - 0xC3E305DD ^0x65EC48E4
{
	func_91(&uLocal_354, -1703.854f, -1082.2223f, 42.006f, -8.3096f, 0f, -111.8213f, 0, 0);
	func_89(&uLocal_354, &uLocal_393, false, false, 1, 1);

	if (IS_BIT_SET(iLocal_416, 8))
	{
		iLocal_317 = AUDIO::GET_SOUND_ID();
		AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_317, "GENERATOR", obLocal_305, "THE_FERRIS_WHALE_SOUNDSET", false, 0);
		iLocal_319 = AUDIO::GET_SOUND_ID();
		AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_319, "SLOW_SQUEAK", obLocal_305, "THE_FERRIS_WHALE_SOUNDSET", false, 0);
		iLocal_320 = AUDIO::GET_SOUND_ID();
		AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_320, "SLOW_SQUEAK", uLocal_288[1], "THE_FERRIS_WHALE_SOUNDSET", false, 0);
		iLocal_318 = AUDIO::GET_SOUND_ID();
		AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_318, "CARRIAGE", uLocal_288[1], "THE_FERRIS_WHALE_SOUNDSET", false, 0);
	}
...
void func_86() // Position - 0x6CC0 Hash - 0xCB68F4D7 ^0x2779C3C8
{
	if (func_44(PLAYER::PLAYER_PED_ID()))
	{
		func_87(&uLocal_377);
...
void func_87(var uParam0) // Position - 0x6D11 Hash - 0x1C7CDD7 ^0xD980243E
{
...
void func_88(var uParam0) // Position - 0x6D38 Hash - 0x76E25014 ^0x39845AED
{
	if (CAM::DOES_CAM_EXIST(uParam0->f_10))
	{
...
void func_89(var uParam0, var uParam1, BOOL bParam2, BOOL bParam3, int iParam4, int iParam5) // Position - 0x6D60 Hash - 0x2AB4438 ^0x97605647
{
	Vector3 vector;
	float fieldOfView;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x6E7B Hash - 0x16E871AD ^0x10C54C39
{
...
void func_91(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, int iParam7, int iParam8) // Position - 0x6EA5 Hash - 0x4F0899A7 ^0x45DE362F
{
	func_92(uParam0);
...
void func_92(var uParam0) // Position - 0x6EE2 Hash - 0xE2D527A2 ^0x1D90508B
{
	*uParam0 = 0;
...
void func_93() // Position - 0x6F3C Hash - 0xB17F79F9 ^0x2365F03
{
	if (IS_BIT_SET(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2, 0))
	{
		...
		if (!HUD::IS_PAUSE_MENU_ACTIVE())
		{
			...
			if (!IS_BIT_SET(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2, 4) && !IS_BIT_SET(iLocal_1140.f_3[NETWORK::PARTICIPANT_ID_TO_INT()], 0) && !IS_BIT_SET(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2, 3))
			{
				if (PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_CONTEXT))
				{
					MISC::SET_BIT(&(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2), 3);
		...
		if (iLocal_394 == 1)
		{
			...
			{
				func_108(&caLocal_323, true, true, false, false, 0.1f, false, 1065353216, false);
				CAM::SET_CAM_ROT(caLocal_323, ENTITY::GET_ENTITY_ROTATION(PLAYER::PLAYER_PED_ID(), 2) + caLocal_323.f_14, 2);
...
void func_94() // Position - 0x7035 Hash - 0xD22EB874 ^0x8D892E9B
{
	if (IS_BIT_SET(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2, 0))
	{
		if (IS_BIT_SET(iLocal_416, 4))
		{
			if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_428))
			{
				if (bLocal_427)
				{
					uLocal_1129 = { func_107() };
					func_105(&uLocal_429);
					func_104(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(FRONTEND_CONTROL, INPUT_SCRIPT_SELECT, true), "AMFW_BTNCV" /*Change View*/, &uLocal_429, 0);
				
					if (!IS_BIT_SET(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2, 3))
						func_104(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(FRONTEND_CONTROL, INPUT_CONTEXT, true), "AMFW_BTNEX" /*Exit*/, &uLocal_429, 0);
				...
				func_103(1);
				func_102(1);
				func_95(&iLocal_428, &uLocal_1129, &uLocal_429, func_101(&uLocal_429));
			}
		}
		else
		{
			iLocal_428 = GRAPHICS::REQUEST_SCALEFORM_MOVIE("instructional_buttons");
			MISC::SET_BIT(&iLocal_416, 4);
		}
	}
	else
	{
		GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&iLocal_428);
		MISC::CLEAR_BIT(&iLocal_416, 4);
		bLocal_427 = true;
	}
...
void func_95(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x710A Hash - 0x10FFA3CB ^0xBFC78809
{
	int i;
			...
			for (i = 0; i < uParam2->f_693; i = i + 1)
			{
				if (IS_BIT_SET(uParam2->f_689, i))
				{
					...
					if (!IS_BIT_SET(uParam2->f_690, i))
					{
						...
						func_99(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(control, action, true));
					
						if (action2 < 365)
							func_99(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(control, action2, true));
					}
					else
					{
						control2 = uParam2->f_1[i /*57*/].f_54;
						controlGroup = uParam2->f_1[i /*57*/].f_55;
						func_99(PAD::GET_CONTROL_GROUP_INSTRUCTIONAL_BUTTONS_STRING(control2, controlGroup, true));
					}
				...
				else
				{
					GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(*uParam0, "SET_DATA_SLOT");
					GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(i);
					func_99(&uParam2->f_1[i /*57*/]);
				
					if (!MISC::IS_STRING_NULL_OR_EMPTY(&(uParam2->f_1[i /*57*/].f_16)))
						func_99(&(uParam2->f_1[i /*57*/].f_16));
...
void func_96() // Position - 0x74B2 Hash - 0xBA92F148 ^0xFCB5C23
{
...
void func_97(int iParam0, var uParam1) // Position - 0x74D0 Hash - 0xC10B3243 ^0x6B89859A
{
	GRAPHICS::DRAW_SCALEFORM_MOVIE_FULLSCREEN(iParam0, uParam1->f_4, uParam1->f_5, uParam1->f_6, uParam1->f_7, 0);
	return;
}

void func_98(const char* sParam0) // Position - 0x74EF Hash - 0x8E2F5FE2 ^0x29D9D432
{
...
void func_99(const char* sParam0) // Position - 0x7501 Hash - 0x690E6520 ^0x509C71F3
{
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_PLAYER_NAME_STRING(sParam0);
	return;
}

void func_100(var uParam0) // Position - 0x750F Hash - 0xB7743C40 ^0xB7743C40
{
	uParam0->f_692 = 0;
	return;
}

int func_101(var uParam0) // Position - 0x751D Hash - 0x9BB76AD4 ^0x9BB76AD4
{
	return uParam0->f_692;
}

void func_102(int iParam0) // Position - 0x752A Hash - 0xE49C42EC ^0xE49C42EC
{
	Global_1577933 = iParam0;
	return;
}

void func_103(int iParam0) // Position - 0x7538 Hash - 0xE47D2A15 ^0xE47D2A15
{
	Global_1669875.f_1163 = iParam0;
	return;
}

void func_104(const char* sParam0, char* sParam1, var uParam2, char* sParam3) // Position - 0x7549 Hash - 0x1C6DE86C ^0x8D13F6FB
{
	int num;
...
void func_105(var uParam0) // Position - 0x7599 Hash - 0xACEB12D7 ^0xACEB12D7
{
	func_106(uParam0);
	uParam0->f_692 = 1;
	return;
...
void func_106(var uParam0) // Position - 0x75AD Hash - 0x18D93256 ^0x6203FAA3
{
	int i;
...
struct<9> func_107() // Position - 0x7696 Hash - 0xB2D33A0B ^0xC243FD27
{
	float num;
...
void func_108(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, float fParam5, BOOL bParam6, int iParam7, BOOL bParam8) // Position - 0x76DA Hash - 0xBD3DA880 ^0xF1F2F0B8
{
	var unk;
	...
	func_111(&unk[0], &unk[1], &unk[2], &unk[3], false, false);
	...
	if (PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL))
	{
		...
		if (bParam4)
		{
			unk[2] = -SYSTEM::ROUND(num * fParam5 * 127f);
			unk[3] = -SYSTEM::ROUND(num2 * fParam5 * 127f);
		}
		else
		{
			unk[2] = SYSTEM::ROUND(PAD::GET_CONTROL_UNBOUND_NORMAL(FRONTEND_CONTROL, INPUT_SCALED_LOOK_LR) * fParam5 * 127f);
			unk[3] = SYSTEM::ROUND(PAD::GET_CONTROL_UNBOUND_NORMAL(FRONTEND_CONTROL, INPUT_SCALED_LOOK_UD) * fParam5 * 127f);
		}
	
		unk[2] = func_110(unk[2] + uParam0->f_24, -127, 127);
		unk[3] = func_110(unk[3] + uParam0->f_25, -127, 127);
	}
	...
	{
		uParam0->f_14 = uParam0->f_14 + func_109((num4 - uParam0->f_14) * 0.05f * num3 * iParam7, -3f, 3f);
		uParam0->f_14.f_1 = uParam0->f_14.f_1 + func_109((num4.f_1 - uParam0->f_14.f_1) * 0.05f * num3 * iParam7, -3f, 3f);
		uParam0->f_14.f_2 = uParam0->f_14.f_2 + func_109((num4.f_2 - uParam0->f_14.f_2) * 0.05f * num3 * iParam7, -3f, 3f);
	}

	if (uParam0->f_26)
	{
		uParam0->f_14 = func_109(uParam0->f_14, SYSTEM::TO_FLOAT(-uParam0->f_21), SYSTEM::TO_FLOAT(uParam0->f_21));
		uParam0->f_14.f_1 = func_109(uParam0->f_14.f_1, SYSTEM::TO_FLOAT(-uParam0->f_22), SYSTEM::TO_FLOAT(uParam0->f_22));
		uParam0->f_14.f_2 = func_109(uParam0->f_14.f_2, SYSTEM::TO_FLOAT(-uParam0->f_20), SYSTEM::TO_FLOAT(uParam0->f_20));
	}
	...
	if (bParam1)
	{
		if (PAD::IS_USING_KEYBOARD_AND_MOUSE(PLAYER_CONTROL))
		{
			...
			if (bParam3)
				uParam0->f_17 = func_109(uParam0->f_17, uParam0->f_7 - uParam0->f_19, uParam0->f_7);
			else
				uParam0->f_17 = func_109(uParam0->f_17, uParam0->f_7 - uParam0->f_19, uParam0->f_7 + uParam0->f_19);
		}
		else if (bParam8)
		{
...
float func_109(float fParam0, float fParam1, float fParam2) // Position - 0x7C2E Hash - 0xF4DC03E3 ^0xF4DC03E3
{
	if (fParam0 > fParam2)
		return fParam2;
...
int func_110(int iParam0, int iParam1, int iParam2) // Position - 0x7C55 Hash - 0x1D7642BB ^0x1D7642BB
{
	if (iParam0 > iParam2)
		return iParam2;
...
void func_111(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x7C7A Hash - 0x61DDCD0A ^0x4AAD6D
{
...
void func_112(var uParam0) // Position - 0x7D7E Hash - 0x2D903F23 ^0xEEF4600A
{
	float num;
	float num2;
	float num3;
	...
	if (*uParam0 == 1)
	{
		if (MISC::ABSF(PAD::GET_CONTROL_NORMAL(FRONTEND_CONTROL, INPUT_SCRIPT_RIGHT_AXIS_X)) > 0.1f)
		{
			...
			{
				uParam0->f_12 = func_109(uParam0->f_12, -80f, 80f);
			}
		}
		...
		if (MISC::ABSF(PAD::GET_CONTROL_NORMAL(FRONTEND_CONTROL, INPUT_SCRIPT_RIGHT_AXIS_Y)) > 0.1f)
		{
			...
			{
				uParam0->f_11 = func_109(uParam0->f_11, -30f, 30f);
			}
		}
		...
		if (MISC::ABSF(PAD::GET_CONTROL_NORMAL(FRONTEND_CONTROL, INPUT_SCRIPT_LEFT_AXIS_Y)) > 0.1f)
		{
			...
			uParam0->f_13 = func_109(uParam0->f_13, 20f, 50f);
		}
		...
		if (CAM::DOES_CAM_EXIST(uParam0->f_10))
		{
			...
			{
				func_113(ENTITY::GET_ENTITY_COORDS(uParam0->f_8, true), ENTITY::GET_ENTITY_COORDS(uParam0->f_9, true), &num, &num2, 1);
...
void func_113(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, int iParam8) // Position - 0x7FB3 Hash - 0x6C0088A9 ^0x6C0088A9
{
	var unk;

	unk = { uParam3 - uParam0 };
	func_114(unk, uParam6, uParam7, iParam8);
	return;
}

void func_114(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5) // Position - 0x7FD6 Hash - 0x850E5E45 ^0xCCF0822A
{
	float num;
...
void func_115() // Position - 0x8080 Hash - 0xDEC2515D ^0x89FC5CD9
{
	var pedBoneCoords;
	...
	{
		func_82(&uLocal_393, false);
		caLocal_323.f_20 = 160;
		caLocal_323.f_21 = 20;
	
		if (bLocal_321)
		{
			pedBoneCoords = { PED::GET_PED_BONE_COORDS(PLAYER::PLAYER_PED_ID(), 31086, 0f, -0.25f, 0f) };
			func_118(&caLocal_323, pedBoneCoords, ENTITY::GET_ENTITY_ROTATION(PLAYER::PLAYER_PED_ID(), 2), 50f, caLocal_323.f_20, caLocal_323.f_21, 3, 1101004800, 0, 0, -1082130432, false);
			CAM::ATTACH_CAM_TO_PED_BONE(caLocal_323, PLAYER::PLAYER_PED_ID(), 31086, 0f, -0.25f, 0f, true);
		}
		else
		{
			func_117(&uLocal_377, true);
			func_116(&uLocal_377, false, 3000);
		}
...
int func_116(var uParam0, BOOL bParam1, int iParam2) // Position - 0x8143 Hash - 0x19E697B7 ^0xE718852E
{
	if (!(uParam0->f_1 == 1))
		return 0;
...
void func_117(var uParam0, BOOL bParam1) // Position - 0x8228 Hash - 0x4D9C051C ^0x53D4C2FD
{
	*uParam0 = 1;
	uParam0->f_1 = 1;
...
void func_118(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7, var uParam8, var uParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, BOOL bParam15) // Position - 0x8255 Hash - 0xA08DC8D3 ^0x3E642322
{
	uParam0->f_1 = { uParam1 };
	uParam0->f_4 = { uParam4 };
	uParam0->f_7 = fParam7;
...
void func_119() // Position - 0x834D Hash - 0x76BFAB66 ^0x17BFEC54
{
	int num;

	if (func_137(true) >= Global_262145.f_8431 || MONEY::NETWORK_CAN_SPEND_MONEY(Global_262145.f_8431, false, false, true, -1, 0))
	{
		if (_NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM())
		{
			_NETSHOPPING_PROCESS_TRANSACTION(joaat("SERVICE_SPEND_FAIRGROUND"), Global_262145.f_8431, &num, false, true, false);
			Global_4535851[num /*85*/].f_1 = 2;
		}
		else
		{
			MONEY::NETWORK_BUY_FAIRGROUND_RIDE(Global_262145.f_8431, 2, false, true, 0);
		}
	
		MISC::SET_BIT(&(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2), 8);
	}
	else if (!IS_BIT_SET(iLocal_416, 3))
	{
		func_120(false, 31, 5);
		MISC::SET_BIT(&iLocal_416, 3);
	}

	return;
}

void func_120(BOOL bParam0, int iParam1, int iParam2) // Position - 0x83E1 Hash - 0xC641E830 ^0x727B8684
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_15(PLAYER::PLAYER_ID(), true, false))
		return;
...
BOOL func_121() // Position - 0x84BC Hash - 0x1C9B9817 ^0x5956764E
{
	if (func_122())
		return false;
...
BOOL func_122() // Position - 0x84DC Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_2696462;
}

BOOL func_123() // Position - 0x84E8 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_2697412;
}

void _NETSHOPPING_PROCESS_TRANSACTION(Hash hParam0, int iParam1, var uParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x84F4 Hash - 0x213EB214 ^0x213EB214
{
	int num;
...
int func_125(var uParam0, int iParam1, Hash hParam2, Hash hParam3, Hash hParam4, int iParam5, int iParam6, int iParam7) // Position - 0x8E07 Hash - 0x9D9428F4 ^0x9DF63005
{
	BOOL flag;
	BOOL flag2;
	int i;
	...
	if (!flag)
	{
		if (!NETSHOPPING::NET_GAMESERVER_IS_SESSION_VALID(func_66()) || NETSHOPPING::NET_GAMESERVER_IS_SESSION_REFRESH_PENDING())
		{
			Global_4537357 = 1;
			return 0;
		}
...
void func_126(int iParam0, Hash hParam1, int iParam2, int iParam3, int iParam4) // Position - 0x8FB4 Hash - 0x5DB723FD ^0x21C356CC
{
	switch (hParam1)
	{
		case joaat("SERVICE_SPEND_BETTING"):
...
void func_127(int iParam0) // Position - 0x8FEC Hash - 0x1EF7AEAB ^0xF113E33C
{
	BOOL flag;
...
void func_128(Hash hParam0) // Position - 0x9040 Hash - 0x5FAAFA5C ^0x2758B106
{
	hParam0->f_66 = 0;
...
void func_129(var uParam0) // Position - 0x9150 Hash - 0x9819A0D5 ^0x98F58DC2
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
BOOL func_130(int iParam0) // Position - 0x9198 Hash - 0x117606EA ^0x642E4F1E
{
...
void func_131(int iParam0, Hash hParam1) // Position - 0x91C3 Hash - 0x8B1B3DA8 ^0x8B1B3DA8
{
...
int func_132(int iParam0, int iParam1, Hash hParam2, Hash hParam3, Hash hParam4, int iParam5, BOOL bParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x91D7 Hash - 0xD5ABF8B4 ^0xF440D67E
{
	int i;
...
void func_134() // Position - 0x93A8 Hash - 0xF91DC52E ^0x282E06D4
{
	SCRIPT::REQUEST_SCRIPT("AM_ARENA_SHP");
	return;
}

int func_135(int iParam0) // Position - 0x93B8 Hash - 0x8B0BD82A ^0xC12B7C0B
{
	int address;
...
BOOL _NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM() // Position - 0x93D3 Hash - 0x2E0B1DC1 ^0xD2D0A3D9
{
	if (MISC::IS_PC_VERSION())
...
int func_137(BOOL bParam0) // Position - 0x93EA Hash - 0x50A8971F ^0xE9EC581E
{
	int vcBankBalance;
...
void func_138(char* sParam0, int iParam1, int iParam2) // Position - 0x9409 Hash - 0xF37B3394 ^0xD9AA8A62
{
...
BOOL func_139() // Position - 0x9426 Hash - 0xD356B7F9 ^0xD356B7F9
{
	return func_141() || func_176() || func_140() == 2 || func_140() == 16;
}

int func_140() // Position - 0x9455 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1057441;
}

BOOL func_141() // Position - 0x9461 Hash - 0x8DF3D75D ^0x8DF3D75D
{
	return IS_BIT_SET(Global_2684312, 5);
}

BOOL _IS_PLAYER_IN_ANIMAL_FORM(Player plParam0) // Position - 0x946F Hash - 0x1472FE30 ^0xCA1769CE
{
	Ped playerPed;
	Hash entityModel;
...
BOOL func_143(Ped pedParam0) // Position - 0x94DB Hash - 0x2647C996 ^0xFC1E7E1A
{
...
BOOL func_144(Player plParam0, int iParam1) // Position - 0x9513 Hash - 0x8278D653 ^0x3D27063A
{
	return IS_BIT_SET(Global_2657921[plParam0 /*463*/].f_218, iParam1);
}

BOOL func_145(Player plParam0) // Position - 0x9529 Hash - 0x85F8BECA ^0x85F8BECA
{
...
BOOL func_146(Player plParam0) // Position - 0x954C Hash - 0xE40D6326 ^0xE40D6326
{
	Player player;
...
BOOL func_147(Player plParam0, int iParam1) // Position - 0x956A Hash - 0x7CD5054C ^0x870BEA81
{
	return IS_BIT_SET(Global_1886967[plParam0 /*609*/].f_10.f_4, iParam1);
}

BOOL func_148(Player plParam0) // Position - 0x9582 Hash - 0x295F4323 ^0xC9EF0000
{
	Player player;
...
BOOL func_149(int iParam0) // Position - 0x95A5 Hash - 0xE8921B44 ^0x4F063755
{
	if (iParam0 == 1)
...
void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x95FC Hash - 0xCBB0D91 ^0x21070E5C
{
...
void func_151() // Position - 0x9613 Hash - 0x36DED35B ^0x779D7A0B
{
	int i;
	var entityCoords;
	float num;
	...
	if (iLocal_396 != 0)
		num = (float)NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME_ACCURATE(), iLocal_396) / 1000f;

	iLocal_396 = NETWORK::GET_NETWORK_TIME_ACCURATE();

	if (iLocal_1140.f_262 != -1 && IS_BIT_SET(iLocal_1140.f_2, 0) && Global_2746723 < iLocal_1140.f_36[iLocal_1140.f_197[iLocal_1140.f_262 /*2*/] /*10*/].f_6 && Global_2746723 + (fLocal_306 * num) > iLocal_1140.f_36[iLocal_1140.f_197[iLocal_1140.f_262 /*2*/] /*10*/].f_6)
		Global_2746723 = iLocal_1140.f_36[iLocal_1140.f_197[iLocal_1140.f_262 /*2*/] /*10*/].f_6;
	else
		Global_2746723 = Global_2746723 + (fLocal_306 * num);

	if (Global_2746723 >= 360f)
		Global_2746723 = Global_2746723 - 360f;

	if (func_44(obLocal_305))
	{
		ENTITY::SET_ENTITY_COORDS(obLocal_305, uLocal_307, true, false, false, true);
		ENTITY::SET_ENTITY_ROTATION(obLocal_305, -Global_2746723 - (360f / 16f), 0f, 0f, 2, true);
		ENTITY::FREEZE_ENTITY_POSITION(obLocal_305, true);
	}
	...
	if (AUDIO::IS_AUDIO_SCENE_ACTIVE("FAIRGROUND_RIDES_FERRIS_WHALE"))
	{
		...
		AUDIO::SET_AUDIO_SCENE_VARIABLE("FAIRGROUND_RIDES_FERRIS_WHALE", "HEIGHT", entityCoords.f_2 - fLocal_316);
	}

	for (i = 0; i < 16; i = i + 1)
	{
		func_152(&iLocal_1140.f_36[i /*10*/]);
	}

	return;
}

void func_152(var uParam0) // Position - 0x9777 Hash - 0xCAE7F186 ^0x34E6B7E0
{
	Vector3 vector;

	vector = { func_154(uParam0->f_5) };

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_288[uParam0->f_5]))
	{
		ENTITY::SET_ENTITY_COORDS(uLocal_288[uParam0->f_5], vector, true, false, false, true);
		ENTITY::SET_ENTITY_LOD_DIST(uLocal_288[uParam0->f_5], 1000);
		ENTITY::FREEZE_ENTITY_POSITION(uLocal_288[uParam0->f_5], true);
	}

	return;
}

BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0x97CE Hash - 0x3D210083 ^0xF7E7C389
{
...
Vector3 func_154(int iParam0) // Position - 0x97EF Hash - 0xBA511474 ^0xA0F177FB
{
	float value;

	value = (360f / SYSTEM::TO_FLOAT(16)) * SYSTEM::TO_FLOAT(iParam0);
	return ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(obLocal_305, 0f, 15.3f * SYSTEM::SIN(value), -15.3f * SYSTEM::COS(value));
}

BOOL func_155() // Position - 0x982C Hash - 0x31245FB9 ^0xE89C6F81
{
	STREAMING::REQUEST_ANIM_DICT(sLocal_397);
	STREAMING::REQUEST_ANIM_DICT(sLocal_287);
	STREAMING::REQUEST_MODEL(hLocal_285);
	STREAMING::REQUEST_MODEL(hLocal_286);

	if (!STREAMING::HAS_ANIM_DICT_LOADED(sLocal_397))
		return false;

	if (!STREAMING::HAS_ANIM_DICT_LOADED(sLocal_287))
		return false;

	if (!STREAMING::HAS_MODEL_LOADED(hLocal_285))
		return false;

	if (!STREAMING::HAS_MODEL_LOADED(hLocal_286))
		return false;

	func_158();
	func_157(_GET_PARTICIPANTS_SCRIPT_EVENT_BITS(false));
	func_156(_GET_PARTICIPANTS_SCRIPT_EVENT_BITS(false));
	iLocal_426 = 0;
	return true;
}

void func_156(int iParam0) // Position - 0x98A7 Hash - 0xCA9AF2A3 ^0x187E655F
{
	int num;
...
void func_157(int iParam0) // Position - 0x98D5 Hash - 0xCA9AF2A3 ^0x31B29B40
{
	int num;
...
void func_158() // Position - 0x9903 Hash - 0xEC3930D5 ^0xD7AB390F
{
	int i;

	i = 0;
	Global_2746723 = 0f;
	obLocal_305 = OBJECT::CREATE_OBJECT(hLocal_285, 0f, 1f, 2f, false, false, false);
	ENTITY::SET_ENTITY_COORDS(obLocal_305, uLocal_307, true, false, false, true);
	ENTITY::SET_ENTITY_ROTATION(obLocal_305, Global_2746723, 0f, 0f, 2, true);
	ENTITY::FREEZE_ENTITY_POSITION(obLocal_305, true);
	ENTITY::SET_ENTITY_LOD_DIST(obLocal_305, 1000);
	ENTITY::SET_ENTITY_INVINCIBLE(obLocal_305, true);
	ENTITY::SET_ENTITY_USE_MAX_DISTANCE_FOR_WATER_REFLECTION(obLocal_305, false);
	...
	for (i = 0; i < 16; i = i + 1)
	{
		func_159(&iLocal_1140.f_36[i /*10*/], i);
	}

	if (!STREAMING::IS_NEW_LOAD_SCENE_ACTIVE())
		func_22(64, 1, false, true, 0);

	return;
}

void func_159(var uParam0, int iParam1) // Position - 0x99AD Hash - 0x932D7C23 ^0xA39E2014
{
	uParam0->f_5 = iParam1;
	uLocal_288[uParam0->f_5] = OBJECT::CREATE_OBJECT(hLocal_286, 0f, 1f, 2f, false, false, false);
	ENTITY::SET_ENTITY_INVINCIBLE(uLocal_288[uParam0->f_5], true);
	func_152(uParam0);
	return;
}

int func_160() // Position - 0x99E5 Hash - 0xCAD2DEE5 ^0x5B3632DA
{
	return iLocal_1140.f_1;
}

int func_161(int iParam0) // Position - 0x99F2 Hash - 0x8EF3095B ^0x8EF3095B
{
	return uLocal_1404[iParam0 /*5*/];
}

void func_162() // Position - 0x9A01 Hash - 0xD3E9B038 ^0xFCE7CFC7
{
	int i;
...
void func_163(int iParam0) // Position - 0x9AE9 Hash - 0x7050651A ^0x5404C8DD
{
	struct<4> eventData;
	...
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
		...
		{
			if (eventData.f_3 < 0 || eventData.f_3 >= 32)
				return;
		
			iLocal_1140.f_3[eventData.f_3] = 0;
			iLocal_1140.f_197[eventData.f_3 /*2*/] = -1;
			iLocal_1140.f_197[eventData.f_3 /*2*/].f_1 = 0;
			iLocal_1140.f_262 = func_2();
		}
	}
...
void func_164(int iParam0) // Position - 0x9B51 Hash - 0xBF5170A6 ^0x9D5CB1AD
{
	struct<5> eventData;
	...
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
		...
		{
			MISC::CLEAR_BIT(&(iLocal_1140.f_2), 3);
			MISC::CLEAR_BIT(&(iLocal_1140.f_2), 2);
		
			if (iLocal_1140.f_262 > -1 && iLocal_1140.f_262 < 32 && iLocal_1140.f_197[iLocal_1140.f_262 /*2*/] > -1 && iLocal_1140.f_197[iLocal_1140.f_262 /*2*/] < 16 && eventData.f_3 >= 0 && eventData.f_3 < 2)
			{
				if (!eventData.f_4)
				{
					iLocal_1140.f_36[iLocal_1140.f_197[iLocal_1140.f_262 /*2*/] /*10*/].f_3 = iLocal_1140.f_36[iLocal_1140.f_197[iLocal_1140.f_262 /*2*/] /*10*/].f_3 - 1;
					iLocal_1140.f_36[iLocal_1140.f_197[iLocal_1140.f_262 /*2*/] /*10*/][eventData.f_3] = 0;
				}
				else
				{
					iLocal_1140.f_36[iLocal_1140.f_197[iLocal_1140.f_262 /*2*/] /*10*/].f_3 = iLocal_1140.f_36[iLocal_1140.f_197[iLocal_1140.f_262 /*2*/] /*10*/].f_3 + 1;
					iLocal_1140.f_36[iLocal_1140.f_197[iLocal_1140.f_262 /*2*/] /*10*/][eventData.f_3] = 1;
				}
			}
		}
	}
...
void func_165(int iParam0) // Position - 0x9C7C Hash - 0x82D69B9D ^0x2FA84883
{
	struct<4> eventData;
	...
	if (SCRIPT::GET_EVENT_DATA(SCRIPT_EVENT_QUEUE_NETWORK, iParam0, &eventData, 4))
		if (!eventData.f_3)
			if (IS_BIT_SET(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2, 0))
				MISC::SET_BIT(&(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2), 10);
			else
				MISC::SET_BIT(&(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2), 9);

	return;
}

void func_166(int iParam0) // Position - 0x9CD1 Hash - 0x38AD71E3 ^0xDD734272
{
	struct<3> eventData;
	BOOL flag;
	...
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
		...
		{
			flag = IS_BIT_SET(iLocal_1140.f_2, 3);
			func_167(func_135(eventData.f_1), flag);
...
void func_167(int iParam0, BOOL bParam1) // Position - 0x9D17 Hash - 0xBBFFB135 ^0xEAB886D
{
	int num;
...
void func_168(int iParam0) // Position - 0x9D4B Hash - 0x37AAC44B ^0xB38605FC
{
	struct<3> eventData;

	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
		if (SCRIPT::GET_EVENT_DATA(SCRIPT_EVENT_QUEUE_NETWORK, iParam0, &eventData, 3))
			func_169(func_135(eventData.f_1));

	return;
}

void func_169(int iParam0) // Position - 0x9D76 Hash - 0x3FBF8FD6 ^0xCBEE19CF
{
	int num;

	num = 1123248983;
	num.f_1 = PLAYER::PLAYER_ID();
	num.f_3 = Global_2746723;
...
void func_170(int iParam0) // Position - 0x9DAC Hash - 0xA823FA59 ^0x357113E
{
	struct<4> eventData;

	if (SCRIPT::GET_EVENT_DATA(SCRIPT_EVENT_QUEUE_NETWORK, iParam0, &eventData, 4))
		Global_2746723 = eventData.f_3;

	return;
}

void func_171(int iParam0) // Position - 0x9DCC Hash - 0x6887780E ^0x487E6678
{
	struct<3> eventData;
	Ped playerPed;
...
void func_172(int iParam0) // Position - 0x9E0A Hash - 0x717A9097 ^0xB7065AE4
{
	struct<8> eventData;
	Ped playerPed;

	if (SCRIPT::GET_EVENT_DATA(SCRIPT_EVENT_QUEUE_NETWORK, iParam0, &eventData, 8))
	{
		if (eventData.f_3 >= 0 && eventData.f_3 < 16)
		{
			playerPed = PLAYER::GET_PLAYER_PED(eventData.f_1);
			...
			{
				NETWORK::NETWORK_ALLOW_REMOTE_ATTACHMENT_MODIFICATION(playerPed, true);
				ENTITY::ATTACH_ENTITY_TO_ENTITY(playerPed, uLocal_288[eventData.f_3], 0, eventData.f_4, 0f, 0f, eventData.f_7, false, false, false, false, 2, true, 0);
			}
		}
	}
...
void func_173(int iParam0) // Position - 0x9E7C Hash - 0xA250B75E ^0x78744E5D
{
	struct<3> eventData;
	...
	if (SCRIPT::GET_EVENT_DATA(SCRIPT_EVENT_QUEUE_NETWORK, iParam0, &eventData, 3))
	{
		if (IS_BIT_SET(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2, 0))
		{
			NETWORK::NETWORK_ALLOW_REMOTE_ATTACHMENT_MODIFICATION(PLAYER::PLAYER_PED_ID(), true);
			offsetFromEntityGivenWorldCoords = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(uLocal_288[uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_3], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)) };
			func_70(func_135(eventData.f_1), uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_3, offsetFromEntityGivenWorldCoords, ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()));
		}
	}
...
BOOL func_174() // Position - 0x9EF1 Hash - 0xDBD936D3 ^0xDBD936D3
{
	if (func_175() == 0)
		return true;
...
int func_175() // Position - 0x9F06 Hash - 0x4228A1C2 ^0x58D4D226
{
	return Global_1574632.f_18;
}

BOOL func_176() // Position - 0x9F14 Hash - 0x56648017 ^0x56648017
{
	if (func_180() || func_179() || func_178() || func_177())
		return true;

	return false;
}

BOOL func_177() // Position - 0x9F46 Hash - 0x97999A47 ^0x97999A47
{
	return IS_BIT_SET(Global_2684312, 1);
}

BOOL func_178() // Position - 0x9F54 Hash - 0x70FF297D ^0x70FF297D
{
	return IS_BIT_SET(Global_2684312, 2);
}

BOOL func_179() // Position - 0x9F62 Hash - 0x7BB65268 ^0x7BB65268
{
	return IS_BIT_SET(Global_2684312, 20);
}

BOOL func_180() // Position - 0x9F71 Hash - 0x974E48B4 ^0x974E48B4
{
	return Global_2684312.f_698;
}

BOOL _IS_FMMC_ACTIVE() // Position - 0x9F80 Hash - 0x9A79549B ^0x5E09568E
{
	return Global_1845263[PLAYER::PLAYER_ID() /*877*/].f_192 != 0;
}

BOOL _SHOULD_NETWORK_SCRIPT_TERMINATE() // Position - 0x9F97 Hash - 0x52E21E9B ^0xD0F85E96
{
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0xA01B Hash - 0x90B5165C ^0xB8DD5DC8
{
	switch (func_28())
	{
		case 0:
...
Hash func_184() // Position - 0xA04E Hash - 0x61402777 ^0xB9FAC976
{
...
BOOL _DOES_EVENT_OF_TYPE_EXIST(int iParam0) // Position - 0xA072 Hash - 0xA28ADBB4 ^0x6EB81E64
{
...
BOOL func_186() // Position - 0xA089 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_2695951;
}

BOOL func_187() // Position - 0xA095 Hash - 0x974E48B4 ^0x974E48B4
{
	return Global_2684312.f_693;
}

void func_188() // Position - 0xA0A4 Hash - 0x66E327B2 ^0x39BE3C9E
{
	SYSTEM::WAIT(0);
	return;
}

void func_189() // Position - 0xA0B1 Hash - 0xBB9EB543 ^0x35E17168
{
	!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false);
	return;
}

void func_190() // Position - 0xA0C6 Hash - 0xF049237F ^0xDCE11803
{
	func_196();
	func_194(false);
	func_82(&uLocal_393, false);
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (IS_BIT_SET(uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2, 0) || _IS_FMMC_ACTIVE())
		{
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && ENTITY::IS_ENTITY_ATTACHED(PLAYER::PLAYER_PED_ID()))
				ENTITY::DETACH_ENTITY(PLAYER::PLAYER_PED_ID(), true, true);
...
void func_191(var uParam0) // Position - 0xA193 Hash - 0xBEAECF16 ^0xBEAECF16
{
	int i;
...
int func_192(var uParam0, int iParam1) // Position - 0xA1B8 Hash - 0x48141E64 ^0x294B0088
{
	...
	func_193(&uParam0->[iParam1 /*7*/]);
	return 1;
}

void func_193(var uParam0) // Position - 0xA3A8 Hash - 0x99F7243D ^0x36B2A3DE
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_194(BOOL bParam0) // Position - 0xA3CD Hash - 0x5FE88D2A ^0xA22C291D
{
	if (bParam0)
	{
		func_195();
...
void func_195() // Position - 0xA430 Hash - 0xF8FE2348 ^0xA77911B2
{
...
void func_196() // Position - 0xA459 Hash - 0x8A6EB5F7 ^0x7E249544
{
	int i;

	if (!STREAMING::IS_NEW_LOAD_SCENE_ACTIVE())
		func_22(64, 0, 0, true, 0);

	for (i = 0; i < 16; i = i + 1)
	{
		func_198(&iLocal_1140.f_36[i /*10*/]);
	}
	...
	func_42(&iLocal_317);
	func_42(&iLocal_318);
	func_197(&obLocal_305);
	return;
}

void func_197(Object* pobParam0) // Position - 0xA4DC Hash - 0x4EAFEE58 ^0x34D7ECA6
{
...
void func_198(var uParam0) // Position - 0xA507 Hash - 0x2C9BF530 ^0x3BED5429
{
	if (uLocal_288[uParam0->f_5] == 0)
		return;

	func_197(&uLocal_288[uParam0->f_5]);
	uLocal_288[uParam0->f_5] = 0;
	return;
}

BOOL func_199(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20) // Position - 0xA536 Hash - 0x41024A0B ^0xF5B52F4
{
	func_204(func_205(uParam0), uParam0);
	NETWORK::RESERVE_NETWORK_MISSION_OBJECTS(0);
	_NETWORK_ENSURE_SCRIPT_IS_NETWORKED(0, -1, false);
	NETWORK::NETWORK_REGISTER_HOST_BROADCAST_VARIABLES(&iLocal_1140, 264, 0);
	NETWORK::NETWORK_REGISTER_PLAYER_BROADCAST_VARIABLES(&uLocal_1404, 161, 0);
	MISC::SET_THIS_SCRIPT_CAN_BE_PAUSED(false);
	uLocal_1404[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/] = 0;
	func_200(_GET_PARTICIPANTS_SCRIPT_EVENT_BITS(true));
	return true;
}

void func_200(int iParam0) // Position - 0xA588 Hash - 0xC9667ABD ^0x5BF17BAD
{
	int num;

	num = -2120841502;
	num.f_1 = PLAYER::PLAYER_ID();
	num.f_3 = NETWORK::PARTICIPANT_ID_TO_INT();
...
int _NETWORK_ENSURE_SCRIPT_IS_NETWORKED(int iParam0, int iParam1, BOOL bNoTerminate) // Position - 0xA5BE Hash - 0x75751681 ^0x9140C9A0
{
	int i;
...
BOOL func_202(BOOL bParam0) // Position - 0xA6D4 Hash - 0x1CCCE169 ^0x1CCCE169
{
	bParam0;
	return Global_1575052;
}

void func_203() // Position - 0xA6E5 Hash - 0xCE5FB49E ^0x214A59D5
{
	SCRIPT::TERMINATE_THIS_THREAD();
	return;
}

void func_204(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21) // Position - 0xA6F1 Hash - 0xC235AC36 ^0xBC71EF59
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		func_203();
...
int func_205(int iParam0) // Position - 0xA710 Hash - 0xACFA5A53 ^0xACFA5A53
{
	switch (iParam0)
	{
		case 3:
	...
	switch (func_206(func_207(iParam0, true)))
	{
		case 0:
			return 8;
...
int func_206(int iParam0) // Position - 0xAE9B Hash - 0x85B1DE75 ^0x85B1DE75
{
	switch (iParam0)
	{
		case 150:
...
int func_207(int iParam0, BOOL bParam1) // Position - 0xB121 Hash - 0xC74E3D8B ^0xC74E3D8B
{
	switch (iParam0)
	{
		case 210:
