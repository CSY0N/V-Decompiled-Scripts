...
void func_292(var uParam0) // Position - 0x340CD Hash - 0x8E7A9068 ^0xA765D5AF
{
	NETWORK::NETWORK_SET_THIS_SCRIPT_IS_NETWORK_SCRIPT(32, false, -1);
	func_295(&uLocal_98, joaat("velum2"), "Plane");
	func_55(&uLocal_98, 1);
	func_293(&uLocal_98, -1581.6901f, -3023.0054f, 15.8275f, 0.739f, 0.0046f, -100.8783f, "HS4_LSA_TAKE_VEL", 0, 1, uParam0->f_4, 0);
	return;
}
