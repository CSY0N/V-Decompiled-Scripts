...
void func_292() // Position - 0x340CD Hash - 0xFE72808B ^0xD6C2186A
{
	NETWORK::NETWORK_SET_THIS_SCRIPT_IS_NETWORK_SCRIPT(32, false, -1);
	func_295(&uLocal_98, joaat("nimbus"), "Plane_1");
	func_293(&uLocal_98, 4494.8423f, -4522.1455f, 4.9819f, -10.7044f, 0.1567f, 155.8207f, "HS4_NIMB_ISD_LSA", 0, 0, 1, 0);
	return;
}
