...
void main() // Position - 0x0 Hash - 0x5D84F89F ^0x5D84F89F
{
	...
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("ambient_tonya")) > 1)
...
void func_1() // Position - 0x156 Hash - 0x7B189B06 ^0x152C8BC7
{
	if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_246))
	{
		if (func_199(61))
			iLocal_77 = 6;
		else
...
void func_2() // Position - 0x17D Hash - 0x18A1A3F7 ^0x18A1A3F7
{
	int num;
...
BOOL func_3(int iParam0) // Position - 0x1CA Hash - 0xAFF3DD75 ^0x9BDD4E4E
{
	const char* str;
	var unk32;

	while (!func_151(iParam0))
	{
		if (func_140(iParam0))
		{
			func_139("LAUNCH_RC_MISSION - Script denied by RC Controller");
			return false;
		}
	...
	TEXT_LABEL_COPY(&unk32, { func_118(iParam0) }, 4);
...
void func_4(int iParam0, const char* sParam1) // Position - 0x24C Hash - 0xA9A7342A ^0xA9284257
{
	func_22(sParam1);
...
void func_5(int iParam0) // Position - 0x304 Hash - 0x74C873D2 ^0x74C873D2
{
	int num;
	int num2;
...
void func_6() // Position - 0x45E Hash - 0x6EF841A5 ^0x6EF841A5
{
	int i;
...
void func_7(int iParam0) // Position - 0x511 Hash - 0xB8CA5CA7 ^0x96AAFF46
{
	switch (iParam0)
	{
		case 2:
...
void func_8(int iParam0) // Position - 0x8F9 Hash - 0xA84FABDE ^0xA84FABDE
{
	Global_64031 = true;
	Global_64034 = 1;
...
void func_9(int iParam0) // Position - 0x944 Hash - 0x4878B614 ^0x92338679
{
...
struct<2> func_10(int iParam0) // Position - 0x978 Hash - 0xC0DDA5B7 ^0x4737EB52
{
	var unk;
	var unk3;
...
void func_11() // Position - 0x9AE Hash - 0xDE0A4F6 ^0xDE0A4F6
{
	if (Global_64038)
		return;
...
void func_12() // Position - 0xA04 Hash - 0x49CBF5B6 ^0x790810FF
{
	int i;
...
void func_13() // Position - 0xA31 Hash - 0x45508BA8 ^0x301C64C9
{
	int i;
...
void func_14() // Position - 0xA68 Hash - 0x8D222CF ^0x8D222CF
{
	Global_64197 = 0;
	return;
}

void func_15() // Position - 0xA74 Hash - 0xCEA3FAB3 ^0xBE2318F
{
	Global_64057 = 0;
...
var func_16(Hash hParam0) // Position - 0xAC8 Hash - 0x4A0C678B ^0x403B983B
{
	var outValue;
...
void func_17() // Position - 0xADC Hash - 0x43632AFE ^0x43632AFE
{
	int i;
...
void func_18(BOOL bParam0) // Position - 0xB06 Hash - 0xFFF39126 ^0xFFF39126
{
...
void func_19() // Position - 0xB1A Hash - 0xFC34B768 ^0xE1D0CFD9
{
	int i;
...
void func_20() // Position - 0xB53 Hash - 0x4A353A3B ^0x7D95A0CE
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("mission_stat_watcher")) > 0)
	{
		if (func_21())
...
BOOL func_21() // Position - 0xB93 Hash - 0x46E5692F ^0xA798242F
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("mission_stat_watcher")) < 1)
		return false;
...
void func_22(const char* sParam0) // Position - 0xBBD Hash - 0xF54A2398 ^0xC5887C42
{
	MISC::ARE_STRINGS_EQUAL(sParam0, sParam0);
	return;
}

void func_23(char* sParam0, int iParam1) // Position - 0xBD0 Hash - 0x1166ABB2 ^0x89B55D9D
{
...
void func_24(char* sParam0, int iParam1, Ped pedParam2) // Position - 0xBED Hash - 0x38F1102B ^0x38F1102B
{
	if (Global_101392 != 10 && Global_101392 != 9)
	{
		TEXT_LABEL_ASSIGN_STRING(&Global_104925, sParam0, 32);
		func_26(&Global_104933, sParam0, 0, "Start", iParam1, pedParam2);
		func_25();
		Global_95550 = 0;
	}
...
void func_25() // Position - 0xC31 Hash - 0x59B932B3 ^0xFC5559FC
{
	int i;
	int j;
...
void func_26(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0x18C5 Hash - 0x53B0865D ^0xC434A1E8
{
	int i;
	eCharacter j;
	...
	*uParam0 = _GET_CURRENT_PLAYER_CHARACTER();
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		func_61(PLAYER::PLAYER_PED_ID(), false);
...
int func_27(var uParam0) // Position - 0x274E Hash - 0x56C64BA4 ^0xCAE61007
{
...
void func_28(var uParam0, var uParam1, Ped pedParam2, int iParam3, int iParam4, int iParam5) // Position - 0x2770 Hash - 0x4709079E ^0x71C884C9
{
	Vehicle vehicle;
...
int func_29(var uParam0, var uParam1, Vehicle veParam2, int iParam3) // Position - 0x27F8 Hash - 0x6BF8E630 ^0xF655D74B
{
...
BOOL func_30(Vehicle veParam0) // Position - 0x2838 Hash - 0x8CDF26D5 ^0xCE04F037
{
	int i;
...
void func_31(var uParam0, Vehicle veParam1, int iParam2) // Position - 0x2866 Hash - 0x9B217A45 ^0xEE9A0448
{
...
int func_32(Vehicle veParam0) // Position - 0x2942 Hash - 0xDEF2B534 ^0x25A18686
{
	int i;
...
eCharacter func_33(Vehicle veParam0) // Position - 0x2984 Hash - 0x593067C2 ^0x2918B7DD
{
	int i;
...
int func_34(Vehicle veParam0, eCharacter echParam1, int iParam2) // Position - 0x29E7 Hash - 0xC883A039 ^0x6D45755E
{
	int i;
		...
		if (ENTITY::DOES_ENTITY_EXIST(Global_98703[i]))
			if (Global_98703[i] == veParam0)
				if (echParam1 == _CHAR_NULL || echParam1 == Global_98713[i])
					if (iParam2 == 0 || ENTITY::GET_ENTITY_MODEL(veParam0) == func_35(echParam1, iParam2))
						return 1;
	}
...
Hash func_35(eCharacter echParam0, int iParam1) // Position - 0x2A75 Hash - 0x3C1119CD ^0x1010ECAE
{
	Hash num;
...
void func_36(eCharacter echParam0, var uParam1, int iParam2) // Position - 0x2AB7 Hash - 0xF92B8944 ^0xD11BCD5C
{
	int num;
...
BOOL func_37(eCharacter echParam0) // Position - 0x2D0E Hash - 0x8907F004 ^0x8907F004
{
	return echParam0 < CHAR_MULTIPLAYER;
}

void func_38(Vehicle veParam0, var uParam1) // Position - 0x2D1A Hash - 0x5E84B52A ^0xEF20F807
{
	int i;
...
int func_39(int iParam0) // Position - 0x2FC3 Hash - 0xEE599357 ^0xEE599357
{
	switch (iParam0)
	{
		case 1:
...
int func_40(var uParam0, var uParam1, var uParam2) // Position - 0x3073 Hash - 0x4455160E ^0x8E5B3F28
{
	int i;
	int modType;
...
BOOL func_41(int iParam0) // Position - 0x3266 Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_42(var uParam0) // Position - 0x3286 Hash - 0xB95AF921 ^0x4DC7C61C
{
	int i;
...
BOOL func_43(Ped pedParam0, var uParam1, int iParam2, int iParam3) // Position - 0x3336 Hash - 0x6795F6D3 ^0x3A08E8AF
{
			...
			if (ENTITY::DOES_ENTITY_EXIST(*uParam1))
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(*uParam1, false))
				{
					if (iParam2 == 0 || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(*uParam1, true), ENTITY::GET_ENTITY_COORDS(pedParam0, true), true) < 100f)
					{
						...
						if (func_44(*uParam1, _GET_CURRENT_PLAYER_CHARACTER(), true))
						{
...
BOOL func_44(Vehicle veParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x3462 Hash - 0xBCC62924 ^0x77695844
{
	int i;
	var garageName;
	int num;
	...
	for (i = 0; func_45(echParam1, i, &garageName, &num); i = i + 1)
	{
...
BOOL func_45(eCharacter echParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x34D0 Hash - 0xC6FC7B8B ^0xC6FC7B8B
{
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x35A2 Hash - 0xAC4E9801 ^0xB379A75F
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x35DF Hash - 0xADCB9755 ^0xADCB9755
{
...
Hash func_48(eCharacter echParam0) // Position - 0x3604 Hash - 0xE4CEEC2C ^0xE4CEEC2C
{
	return Global_2139[echParam0 /*29*/];
}

void func_49(Ped pedParam0, var uParam1, int iParam2, int iParam3) // Position - 0x3613 Hash - 0x4CE94407 ^0xC863C983
{
	eCharacter character;
	ePedComponentType i;
	...
	if (!PED::IS_PED_INJURED(pedParam0))
	{
		...
		{
			func_57(pedParam0, i, &uParam1->f_13[i], &uParam1->[i], &uParam1->f_26[i], iParam2, 145);
		}
	
		for (i = PV_COMP_HEAD; i < PV_COMP_TASK; i = i + 1)
		{
			func_56(pedParam0, i, &uParam1->f_39[i], &uParam1->f_49[i], iParam2, 145);
		}
...
int func_50(int iParam0, int iParam1) // Position - 0x37AD Hash - 0x744E461C ^0x94D7C845
{
	Hash statHash;
	int outValue;
...
Hash func_51(int iParam0, int iParam1) // Position - 0x37DC Hash - 0x505A9F99 ^0x8B00E935
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_52(iParam1));
}

int func_52(int iParam0) // Position - 0x37F1 Hash - 0x1A3F3220 ^0x1A3F3220
{
	int num;
	int num2;
...
int func_53() // Position - 0x3825 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1574925;
}

BOOL func_54(int iParam0, int iParam1) // Position - 0x3831 Hash - 0x5137F6D6 ^0x3B535546
{
	Hash statHash;
	BOOL outValue;
...
Hash func_55(int iParam0, int iParam1) // Position - 0x3855 Hash - 0x1D62A43E ^0x33D7B335
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_52(iParam1));
}

void func_56(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x386A Hash - 0x65821445 ^0x4849EA55
{
	eCharacter character;
...
void func_57(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3DB3 Hash - 0x10358CC6 ^0xCC2A186D
{
	eCharacter character;
...
eCharacter func_58() // Position - 0x3FF4 Hash - 0xA4EEF940 ^0xA4EEF940
{
	func_59();
	return Global_114370.f_2366.f_539.f_4321;
}

void func_59() // Position - 0x4010 Hash - 0xD1F2D853 ^0xF9F5FD4D
{
	eCharacter character;
...
BOOL func_60(int iParam0) // Position - 0x410D Hash - 0x937D8816 ^0x937D8816
{
	return Global_43922 == iParam0;
}

void func_61(Ped pedParam0, BOOL bParam1) // Position - 0x411B Hash - 0xC106EC1D ^0x74ED6306
{
	eCharacter character;
	...
	if (func_37(character) && !PED::IS_PED_INJURED(pedParam0))
	{
		if (pedParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_62(pedParam0, &Global_114370.f_2366.f_539.f_298[character /*477*/]);
...
void func_62(Ped pedParam0, var uParam1) // Position - 0x420E Hash - 0xDEAAD761 ^0xB2E3A390
{
	int i;
	int j;
	Hash k;
	...
	if (!PED::IS_PED_INJURED(pedParam0))
	{
		...
		for (i = 0; i <= 44 - 1; i = i + 1)
		{
			...
			if (hash != 0)
			{
				pedWeapontypeInSlot = WEAPON::GET_PED_WEAPONTYPE_IN_SLOT(pedParam0, func_67(i));
				...
				if (pedWeapontypeInSlot != 0 && pedWeapontypeInSlot != joaat("WEAPON_UNARMED"))
				{
					...
					for (k = func_65(pedWeapontypeInSlot, j); k != 0; k = func_65(pedWeapontypeInSlot, j))
					{
		...
		{
			if (FILES::GET_DLC_WEAPON_DATA_SP(l, &outData) && !func_64(outData.f_1) && num < 51)
			{
				if (!FILES::IS_CONTENT_ITEM_LOCKED(outData))
				{
					...
					for (j = 0; j < FILES::GET_NUM_DLC_WEAPON_COMPONENTS_SP(l); j = j + 1)
					{
						...
						{
							if (!func_63(ComponentDataPtr.f_3))
							{
...
BOOL func_63(int iParam0) // Position - 0x4496 Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
...
BOOL func_64(int iParam0) // Position - 0x4537 Hash - 0xD9D843D5 ^0xF9D91FBE
{
...
Hash func_65(Hash hParam0, int iParam1) // Position - 0x4723 Hash - 0x6010BC66 ^0x1DFF9FB7
{
	int num;
	int dlcWeaponIndex;
	int i;
	...
	switch (hParam0)
	{
		...
		default:
			if (hParam0 != 0)
			{
				dlcWeaponIndex = func_66(hParam0, &unk);
...
int func_66(Hash hParam0, Any* panParam1) // Position - 0x5444 Hash - 0x539D27DB ^0xB7B7AD25
{
	int i;
	int numDlcWeapons;
...
Hash func_67(int iParam0) // Position - 0x547F Hash - 0x5FB59AC3 ^0x9BC6B2ED
{
	int num;
...
void func_68(Ped pedParam0) // Position - 0x56F3 Hash - 0x27D5295B ^0xD1A82444
{
	eCharacter character;
...
void func_69(var uParam0, int iParam1) // Position - 0x572F Hash - 0x635FFA34 ^0xAE461588
{
	var unk;
	var unk2;
	var unk5;
...
BOOL func_70(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5C7E Hash - 0xA7FD254F ^0xFF9CDA51
{
...
BOOL func_71(int iParam0, var uParam1, var uParam2) // Position - 0x5CC2 Hash - 0xE3586C79 ^0xE3586C79
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
...
BOOL func_72(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x6441 Hash - 0x2D46096D ^0xEA41378F
{
	if (bParam6)
...
BOOL func_73(var uParam0) // Position - 0x6488 Hash - 0xDB33C708 ^0xF5B91AC7
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_101())
		{
			*uParam0 = func_79(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), 6, -1, false, true, -1);
...
BOOL func_74(int iParam0) // Position - 0x64E3 Hash - 0xCAEAF99E ^0xCAEAF99E
{
	return func_75(iParam0, 0, true);
}

BOOL func_75(int iParam0, int iParam1, BOOL bParam2) // Position - 0x64F3 Hash - 0xA45BEB30 ^0x6033D2A2
{
	if (iParam0 == -1)
		return false;
...
int func_76(int iParam0) // Position - 0x6553 Hash - 0x28E83966 ^0x9E37924F
{
	switch (iParam0)
	{
		case 0:
...
int func_77() // Position - 0x68FB Hash - 0x21D64237 ^0x21D64237
{
	return Global_32828;
}

BOOL func_78(int iParam0) // Position - 0x6906 Hash - 0xBE61F0FD ^0xBE61F0FD
{
	return func_75(iParam0, 5, true);
}

int func_79(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6916 Hash - 0x4E8D2C12 ^0x4E8D2C12
{
	int i;
	...
	for (i = 0; i <= 60; i = i + 1)
	{
		if (iParam3 == 6 || iParam3 == func_100(i))
		{
			...
			{
				distanceBetweenCoords = MISC::GET_DISTANCE_BETWEEN_COORDS(vParam0, func_80(i, false), true);
...
Vector3 func_80(int iParam0, BOOL bParam1) // Position - 0x69B8 Hash - 0x4894642D ^0x4894642D
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_81() // Position - 0x7123 Hash - 0x6E37375C ^0x6E37375C
{
...
int func_82() // Position - 0x741E Hash - 0x974E48B4 ^0x974E48B4
{
	return Global_2652572.f_2650;
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x742D Hash - 0x16E871AD ^0x10C54C39
{
...
Vector3 func_84(float fParam0, float fParam1, float fParam2) // Position - 0x7457 Hash - 0xD52A1F8B ^0x5D514503
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_85(), 0f, fParam0);
}

Vector3 func_85() // Position - 0x746C Hash - 0x21158019 ^0x21158019
{
	return -880f, -2770f, -50f;
}

BOOL func_86(Player plParam0) // Position - 0x7483 Hash - 0x78AB9EAC ^0x78AB9EAC
{
...
Vector3 func_87(int iParam0, int iParam1) // Position - 0x74DB Hash - 0x7E203DFC ^0x7E203DFC
{
	var unk;
	var unk7;
...
BOOL func_88(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x7585 Hash - 0x5642A5C0 ^0x5642A5C0
{
	var unk;
	Vector3 vector;
	var unk12;
...
Vector3 func_89(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x761A Hash - 0x8959C4D1 ^0x8922A2E2
{
	float num;
	float num2;
	float num3;
...
struct<6> func_90(int iParam0) // Position - 0x765E Hash - 0xC73C1158 ^0x2A6D4A6F
{
	var unk;
...
struct<6> func_91(int iParam0) // Position - 0x77E2 Hash - 0x2623C81B ^0x2623C81B
{
	return func_92(iParam0);
}

struct<6> func_92(int iParam0) // Position - 0x77F0 Hash - 0x7684F11 ^0xD37BE1E4
{
	var unk;
...
BOOL func_93(int iParam0, var uParam1) // Position - 0x82B8 Hash - 0x31632D18 ^0xF002B35A
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_94(Player plParam0) // Position - 0x833A Hash - 0x9D5E1610 ^0x9D5E1610
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x8392 Hash - 0x478900E4 ^0x478900E4
{
	return -1;
}

Vector3 func_96(int iParam0) // Position - 0x839B Hash - 0xCBED323 ^0xCBED323
{
	switch (iParam0)
	{
		case 1:
...
int func_97() // Position - 0x8607 Hash - 0x5976C0FC ^0xC3C6644E
{
	return func_98(PLAYER::PLAYER_ID());
}

int func_98(Player plParam0) // Position - 0x8617 Hash - 0x1A54F100 ^0x35DB7B9D
{
	return MISC::GET_BITS_IN_RANGE(Global_2657921[plParam0 /*463*/].f_321.f_3, 28, 31);
}

BOOL func_99(int iParam0) // Position - 0x8634 Hash - 0xA85A6891 ^0xA85A6891
{
	return func_75(iParam0, 0, false);
}

int func_100(int iParam0) // Position - 0x8644 Hash - 0x1BE0B176 ^0x1BE0B176
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_101() // Position - 0x897A Hash - 0xD56328D2 ^0xD56328D2
{
	return Global_101444.f_393 > 0;
}

var func_102() // Position - 0x898B Hash - 0x9E44C35 ^0xB9993D58
{
	var unk;
...
void func_103(var uParam0, int iParam1) // Position - 0x89D1 Hash - 0x15B9927E ^0x4A4674
{
	if (iParam1 <= 0)
		return;
...
void func_104(var uParam0, int iParam1) // Position - 0x8A57 Hash - 0x4C70B2C3 ^0x4C70B2C3
{
...
void func_105(var uParam0, int iParam1) // Position - 0x8A8A Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
int func_106(int iParam0, int iParam1) // Position - 0x8ADB Hash - 0xD3EBACB3 ^0xD3EBACB3
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_107(int iParam0) // Position - 0x8B7D Hash - 0xE1B0542C ^0x127A471E
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_108(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8B9F Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
int func_109(int iParam0) // Position - 0x8BB6 Hash - 0x2D4DB85F ^0x2D4DB85F
{
	return iParam0 & 15;
}

void func_110(var uParam0, int iParam1) // Position - 0x8BC3 Hash - 0x864304A8 ^0x1F5003E2
{
...
void func_111(var uParam0, int iParam1) // Position - 0x8BFD Hash - 0x76860AE7 ^0x32308FFF
{
...
void func_112(var uParam0, int iParam1) // Position - 0x8C38 Hash - 0xDB8A72C0 ^0x4F6D426D
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0x8C74 Hash - 0x77F66043 ^0x77F66043
{
	if (Global_101392 == 10 || Global_101392 == 9)
		return true;
...
void func_114(int iParam0) // Position - 0x8C98 Hash - 0x35AC36F2 ^0xED95C957
{
	int num;
	var textLabel;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8CF1 Hash - 0x4C81F065 ^0x79C65D03
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x8D07 Hash - 0x4C81F065 ^0xB17A9745
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_117(char* sParam0, Any anParam1, int iParam2) // Position - 0x8D1D Hash - 0x2EA3BF73 ^0x928E41DB
{
...
struct<2> func_118(int iParam0) // Position - 0x8D5E Hash - 0xE223CD68 ^0x3D6B5431
{
	var unk;
...
void func_119(int iParam0, var uParam1) // Position - 0x91AA Hash - 0x3CDD9B2C ^0xF58FC314
{
	switch (iParam0)
	{
		case 0:
			func_120(uParam1, "Abigail1", func_10(iParam0), 0, 0, 4, -1604.668f, 5239.1f, 3.01f, 66, "", 109, 0, "ambient_Diving", 0, 0, 1, 4, 1, 0, 2359, func_121(iParam0), 1, 0);
			break;
	
		case 1:
			func_120(uParam1, "Abigail2", func_10(iParam0), 0, 0, 4, -1592.84f, 5214.04f, 3.01f, 400, "", 110, 0, "", 0, 0, -1, 4, 1, 0, 2359, func_121(iParam0), 1, 0);
			break;
	
		case 2:
			func_120(uParam1, "Barry1", func_10(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, &func_2, "", 74, 0, "", 0, 1, -1, 4, 1, 0, 2359, func_121(iParam0), 1, 0);
			break;
	
		case 3:
			func_120(uParam1, "Barry2", func_10(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, &func_2, "", -1, 0, "", 0, 1, -1, 4, 4, 0, 2359, func_121(iParam0), 1, 1);
			break;
	
		case 4:
			func_120(uParam1, "Barry3", func_10(iParam0), 0, 1, 4, 414f, -761f, 29f, &func_2, "", -1, 0, "", 164, 1, -1, 0, 2, 0, 2359, func_121(iParam0), 0, 0);
			break;
	
		case 5:
			func_120(uParam1, "Barry3A", func_10(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, &func_2, "BARSTASH" /*Areas where you can find vehicles with a hidden stash have been marked on the map. Collect these vehicles for Barry.*/, 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_121(iParam0), 0, 1);
			break;
	
		case 6:
			func_120(uParam1, "Barry3C", func_10(iParam0), 3, 1, 0, -468.9f, -1713.06f, 18.21f, &func_2, "", 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_121(iParam0), 0, 1);
			break;
	
		case 7:
			func_120(uParam1, "Barry4", func_10(iParam0), 0, 1, 4, 237.65f, -385.41f, 44.4f, &func_2, "", 85, 0, "postRC_Barry4", 0, 0, -1, 4, 2, 800, 2000, func_121(iParam0), 0, 0);
			break;
	
		case 8:
			func_120(uParam1, "Dreyfuss1", func_10(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT" /*The killer's identity and location have been revealed.*/, 106, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_121(iParam0), 0, 0);
			break;
	
		case 9:
			func_120(uParam1, "Epsilon1", func_10(iParam0), 0, 3, 4, -1622.89f, 4204.87f, 83.3f, 66, "", 86, 0, "", 0, 1, 10, 4, 1, 0, 2359, func_121(iParam0), 0, 0);
			break;
	
		case 10:
			func_120(uParam1, "Epsilon2", func_10(iParam0), 0, 3, 4, 242.7f, 362.7f, 104.74f, 206, "", 87, 16, "", 0, 0, 11, 4, 1, 0, 2359, func_121(iParam0), 1, 0);
			break;
	
		case 11:
			func_120(uParam1, "Epsilon3", func_10(iParam0), 0, 3, 4, 1835.53f, 4705.86f, 38.1f, 206, "", 88, 16, "epsCars", 0, 0, 12, 4, 1, 0, 2359, func_121(iParam0), 0, 0);
			break;
	
		case 12:
			func_120(uParam1, "Epsilon4", func_10(iParam0), 0, 3, 4, 1826.13f, 4698.88f, 38.92f, 206, "", 90, 16, "postRC_Epsilon4", 0, 0, 13, 4, 1, 0, 2359, func_121(iParam0), 0, 0);
			break;
	
		case 13:
			func_120(uParam1, "Epsilon5", func_10(iParam0), 0, 3, 4, 637.02f, 119.7093f, 89.5f, 206, "", 89, 16, "epsRobes", 0, 0, 14, 4, 1, 0, 2359, func_121(iParam0), 1, 0);
			break;
	
		case 14:
			func_120(uParam1, "Epsilon6", func_10(iParam0), 0, 3, 4, -2892.93f, 3192.37f, 11.66f, 206, "", 93, 0, "", 0, 0, 15, 4, 1, 0, 2359, func_121(iParam0), 0, 1);
			break;
	
		case 15:
			func_120(uParam1, "Epsilon7", func_10(iParam0), 0, 3, 4, 524.43f, 3079.82f, 39.48f, 206, "", -1, 16, "epsDesert", 0, 0, 16, 4, 1, 0, 2359, func_121(iParam0), 0, 0);
			break;
	
		case 16:
			func_120(uParam1, "Epsilon8", func_10(iParam0), 0, 3, 4, -697.75f, 45.38f, 43.03f, 206, "", 94, 16, "epsilonTract", 0, 0, -1, 4, 1, 0, 2359, func_121(iParam0), 1, 0);
			break;
	
		case 17:
			func_120(uParam1, "Extreme1", func_10(iParam0), 0, 4, 4, -188.22f, 1296.1f, 302.86f, 66, "", -1, 0, "", 4, 1, 18, 4, 2, 0, 2359, func_121(iParam0), 0, 1);
			break;
	
		case 18:
			func_120(uParam1, "Extreme2", func_10(iParam0), 0, 4, 4, -954.19f, -2760.05f, 14.64f, 382, "", 96, 0, "", 171, 0, 19, 4, 2, 0, 2359, func_121(iParam0), 0, 1);
			break;
	
		case 19:
			func_120(uParam1, "Extreme3", func_10(iParam0), 0, 4, 4, -63.8f, -809.5f, 321.8f, 382, "", 97, 0, "", 0, 0, 20, 4, 2, 0, 2359, func_121(iParam0), 0, 1);
			break;
	
		case 20:
			func_120(uParam1, "Extreme4", func_10(iParam0), 0, 4, 4, 1731.41f, 96.96f, 170.39f, 382, "", 98, 16, "", 0, 0, -1, 4, 2, 0, 2359, func_121(iParam0), 0, 0);
			break;
	
		case 21:
			func_120(uParam1, "Fanatic1", func_10(iParam0), 0, 5, 4, -1877.82f, -440.649f, 45.05f, 405, "", 74, 0, "", 0, 1, -1, 4, 1, 700, 2000, func_121(iParam0), 1, 0);
			break;
	
		case 22:
			func_120(uParam1, "Fanatic2", func_10(iParam0), 0, 5, 4, 809.66f, 1279.76f, 360.49f, 405, "", -1, 0, "", 0, 1, -1, 4, 4, 700, 2000, func_121(iParam0), 1, 0);
			break;
	
		case 23:
			func_120(uParam1, "Fanatic3", func_10(iParam0), 0, 5, 4, -915.6f, 6139.2f, 5.5f, 405, "", -1, 0, "", 0, 1, -1, 4, 2, 700, 2000, func_121(iParam0), 0, 1);
			break;
	
		case 24:
			func_120(uParam1, "Hao1", func_10(iParam0), 0, 6, 4, -72.29f, -1260.63f, 28.14f, 66, "", -1, 0, "controller_Races", 13, 1, -1, 4, 2, 2000, 500, func_121(iParam0), 0, 1);
			break;
	
		case 25:
			func_120(uParam1, "Hunting1", func_10(iParam0), 0, 7, 4, 1804.32f, 3931.33f, 32.82f, 66, "", -1, 0, "", 174, 1, 26, 4, 4, 0, 2359, func_121(iParam0), 0, 1);
			break;
	
		case 26:
			func_120(uParam1, "Hunting2", func_10(iParam0), 0, 7, 4, -684.17f, 5839.16f, 16.09f, 384, "", 99, 0, "", 7, 0, -1, 4, 4, 0, 2359, func_121(iParam0), 0, 1);
			break;
	
		case 27:
			func_120(uParam1, "Josh1", func_10(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 66, "", -1, 0, "forSaleSigns", 0, 1, 28, 4, 4, 0, 2359, func_121(iParam0), 1, 0);
			break;
	
		case 28:
			func_120(uParam1, "Josh2", func_10(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", 105, 0, "", 0, 0, 29, 4, 4, 0, 2359, func_121(iParam0), 1, 1);
			break;
	
		case 29:
			func_120(uParam1, "Josh3", func_10(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", -1, 16, "", 0, 0, 30, 4, 4, 0, 2359, func_121(iParam0), 1, 1);
			break;
	
		case 30:
			func_120(uParam1, "Josh4", func_10(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 385, "", -1, 36, "", 0, 0, -1, 4, 4, 0, 2359, func_121(iParam0), 1, 0);
			break;
	
		case 31:
			func_120(uParam1, "Maude1", func_10(iParam0), 0, 9, 4, 2726.1f, 4145f, 44.3f, 66, "", -1, 0, "BailBond_Launcher", 0, 1, -1, 4, 4, 0, 2359, func_121(iParam0), 0, 1);
			break;
	
		case 32:
			func_120(uParam1, "Minute1", func_10(iParam0), 0, 10, 4, 327.85f, 3405.7f, 35.73f, 66, "", -1, 0, "", 0, 1, 33, 4, 4, 0, 2359, func_121(iParam0), 0, 1);
			break;
	
		case 33:
			func_120(uParam1, "Minute2", func_10(iParam0), 0, 10, 4, 18f, 4527f, 105f, 386, "", -1, 10, "", 0, 0, 34, 4, 4, 0, 2359, func_121(iParam0), 0, 1);
			break;
	
		case 34:
			func_120(uParam1, "Minute3", func_10(iParam0), 0, 10, 4, -303.82f, 6211.29f, 31.05f, 386, "", -1, 10, "", 0, 0, -1, 4, 4, 0, 2359, func_121(iParam0), 0, 1);
			break;
	
		case 35:
			func_120(uParam1, "MrsPhilips1", func_10(iParam0), 0, 11, 4, 1972.59f, 3816.43f, 32.42f, 66, "", -1, 0, "ambient_MrsPhilips", 0, 1, -1, 4, 4, 0, 2359, func_121(iParam0), 0, 0);
			break;
	
		case 36:
			func_120(uParam1, "MrsPhilips2", func_10(iParam0), 0, 11, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 1, -1, 4, 4, 0, 2359, func_121(iParam0), 0, 0);
			break;
	
		case 37:
			func_120(uParam1, "Nigel1", func_10(iParam0), 0, 12, 4, -1097.16f, 790.01f, 164.52f, 66, "", -1, 0, "", 177, 1, -1, 1, 4, 0, 2359, func_121(iParam0), 1, 0);
			break;
	
		case 38:
			func_120(uParam1, "Nigel1A", func_10(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS" /*Areas where you can find celebrity items have been marked on the map. Steal these items for Nigel and Mrs. Thornhill.*/, 100, 0, "", 0, 0, 42, 4, 4, 0, 2359, func_121(iParam0), 1, 1);
			break;
	
		case 39:
			func_120(uParam1, "Nigel1B", func_10(iParam0), 0, 12, 1, -1034.15f, 366.08f, 80.11f, 149, "", 100, 0, "", 0, 0, 42, 4, 4, 700, 2000, func_121(iParam0), 1, 1);
			break;
	
		case 40:
			func_120(uParam1, "Nigel1C", func_10(iParam0), 0, 12, 1, -623.91f, -266.17f, 37.76f, 149, "", 100, 0, "", 0, 0, 42, 4, 4, 700, 2000, func_121(iParam0), 1, 1);
			break;
	
		case 41:
			func_120(uParam1, "Nigel1D", func_10(iParam0), 0, 12, 1, -1096.85f, 67.68f, 52.95f, 149, "", 100, 0, "", 0, 0, 42, 4, 4, 700, 2000, func_121(iParam0), 1, 1);
			break;
	
		case 42:
			func_120(uParam1, "Nigel2", func_10(iParam0), 0, 12, 4, -1310.7f, -640.22f, 26.54f, 149, "", -1, 8, "", 0, 0, 43, 4, 4, 0, 2359, func_121(iParam0), 1, 1);
			break;
	
		case 43:
			func_120(uParam1, "Nigel3", func_10(iParam0), 0, 12, 4, -44.75f, -1288.67f, 28.21f, 149, "", -1, 16, "postRC_Nigel3", 0, 0, -1, 4, 4, 0, 2359, func_121(iParam0), 1, 1);
			break;
	
		case 44:
			func_120(uParam1, "Omega1", func_10(iParam0), 0, 13, 4, 2468.51f, 3437.39f, 49.9f, 66, "", -1, 0, "spaceshipParts", 0, 1, 45, 4, 2, 0, 2359, func_121(iParam0), 0, 0);
			break;
	
		case 45:
			func_120(uParam1, "Omega2", func_10(iParam0), 0, 13, 4, 2319.44f, 2583.58f, 46.76f, 387, "", 107, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_121(iParam0), 0, 0);
			break;
	
		case 46:
			func_120(uParam1, "Paparazzo1", func_10(iParam0), 0, 14, 4, -149.75f, 285.81f, 93.67f, 66, "", -1, 0, "", 0, 1, 47, 4, 2, 0, 2359, func_121(iParam0), 0, 1);
			break;
	
		case 47:
			func_120(uParam1, "Paparazzo2", func_10(iParam0), 0, 14, 4, -70.71f, 301.43f, 106.79f, 389, "", -1, 8, "", 0, 0, 48, 4, 2, 0, 2359, func_121(iParam0), 0, 1);
			break;
	
		case 48:
			func_120(uParam1, "Paparazzo3", func_10(iParam0), 0, 14, 4, -257.22f, 292.85f, 90.63f, 389, "", -1, 8, "", 183, 1, -1, 2, 2, 0, 2359, func_121(iParam0), 0, 0);
			break;
	
		case 49:
			func_120(uParam1, "Paparazzo3A", func_10(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO" /*Areas where you can find celebrity photo opportunities have been marked on the map. Track down and photograph these celebrities for Beverly.*/, 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_121(iParam0), 0, 1);
			break;
	
		case 50:
			func_120(uParam1, "Paparazzo3B", func_10(iParam0), 0, 14, 2, 1040.96f, -534.42f, 60.17f, 389, "", 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_121(iParam0), 0, 1);
			break;
	
		case 51:
			func_120(uParam1, "Paparazzo4", func_10(iParam0), 0, 14, 4, -484.2f, 229.68f, 82.21f, 389, "", -1, 8, "", 0, 1, -1, 4, 2, 0, 2359, func_121(iParam0), 0, 0);
			break;
	
		case 52:
			func_120(uParam1, "Rampage1", func_10(iParam0), 0, 15, 4, 908f, 3643.7f, 32.2f, 66, "", -1, 0, "", 0, 1, 54, 4, 4, 0, 2359, func_121(iParam0), 0, 0);
			break;
	
		case 54:
			func_120(uParam1, "Rampage3", func_10(iParam0), 0, 15, 4, 465.1f, -1849.3f, 27.8f, 84, "", -1, 0, "", 0, 1, 55, 4, 4, 0, 2359, func_121(iParam0), 1, 0);
			break;
	
		case 55:
			func_120(uParam1, "Rampage4", func_10(iParam0), 0, 15, 4, -161f, -1669.7f, 33f, 84, "", -1, 0, "", 0, 0, 56, 4, 4, 0, 2359, func_121(iParam0), 1, 0);
			break;
	
		case 56:
			func_120(uParam1, "Rampage5", func_10(iParam0), 0, 15, 4, -1298.2f, 2504.14f, 21.09f, 84, "", -1, 0, "", 0, 0, 53, 4, 4, 0, 2359, func_121(iParam0), 0, 0);
			break;
	
		case 53:
			func_120(uParam1, "Rampage2", func_10(iParam0), 0, 15, 4, 1181.5f, -400.1f, 67.5f, 84, "", -1, 0, "rampage_controller", 0, 0, -1, 4, 4, 0, 2359, func_121(iParam0), 1, 0);
			break;
	
		case 57:
			func_120(uParam1, "TheLastOne", func_10(iParam0), 0, 16, 4, -1298.98f, 4640.16f, 105.67f, 66, "", 133, 1, "", 0, 1, -1, 4, 2, 0, 2359, func_121(iParam0), 0, 1);
			break;
	
		case 58:
			func_120(uParam1, "Tonya1", func_10(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS" /*Strangers and Freaks can be found throughout San Andreas at ~HUD_COLOUR_FRANKLIN~~BLIP_RANDOM_CHARACTER~~s~*/, -1, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_121(iParam0), 0, 1);
			break;
	
		case 59:
			func_120(uParam1, "Tonya2", func_10(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48, "ambient_Tonya", 185, 0, 60, 4, 2, 0, 2359, func_121(iParam0), 0, 1);
			break;
	
		case 60:
			func_120(uParam1, "Tonya3", func_10(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 187, 0, 61, 4, 2, 0, 2359, func_121(iParam0), 0, 1);
			break;
	
		case 61:
			func_120(uParam1, "Tonya4", func_10(iParam0), 0, 17, 4, 0f, 0f, 0f, -1, "", -1, 0, "", 0, 0, 62, 4, 2, 0, 2359, func_121(iParam0), 0, 1);
			break;
	
		case 62:
			func_120(uParam1, "Tonya5", func_10(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", -1, 48, "", 0, 0, -1, 4, 2, 0, 2359, func_121(iParam0), 0, 1);
			break;
...
int func_121(int iParam0) // Position - 0xA3EE Hash - 0xC999F6B2 ^0xC999F6B2
{
	switch (iParam0)
	{
		case 0:
...
void func_122(int iParam0) // Position - 0xA734 Hash - 0x73C8C716 ^0x5F170793
{
	char* scriptName;
	...
	func_123(iParam0);
	iLocal_246 = SYSTEM::START_NEW_SCRIPT(scriptName, 60500);
	SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED(scriptName);
	return;
}

void func_123(int iParam0) // Position - 0xA786 Hash - 0xE0445FFC ^0x204FFA11
{
	var name;
...
void func_124(int iParam0) // Position - 0xA821 Hash - 0xE70A4F17 ^0xE70A4F17
{
	if (iParam0 < 63)
	{
		func_125();
...
void func_125() // Position - 0xA847 Hash - 0xD5DFA716 ^0xD54995D4
{
	Global_79503 != 6;
...
void func_126(Ped pedParam0) // Position - 0xA87F Hash - 0x91438920 ^0xDA692F14
{
	int num;
	int num2;
	int num3;
...
void func_127(int iParam0) // Position - 0xA8D8 Hash - 0xBB510F32 ^0xE77AE77B
{
...
int func_128(Ped pedParam0) // Position - 0xA95B Hash - 0x14AF2EDD ^0xC5BC7CD2
{
	int i;
...
void func_129(int iParam0, int iParam1, int iParam2) // Position - 0xA98C Hash - 0xF54D70EF ^0xF54D70EF
{
	func_130(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_130(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xA9A1 Hash - 0x9F3D8BA2 ^0x9F3D8BA2
{
	int num;
...
int func_131() // Position - 0xAA23 Hash - 0x11506CC4 ^0x2E9F5641
{
	int i;
...
BOOL func_132(int iParam0, int iParam1, int iParam2) // Position - 0xAA54 Hash - 0x3A30B8C2 ^0x3A30B8C2
{
...
int func_133(int iParam0, int iParam1, int iParam2) // Position - 0xAA6F Hash - 0x61F8C119 ^0x1C9B84EC
{
	int i;
...
int func_134(Ped pedParam0) // Position - 0xAABB Hash - 0xDCBB968F ^0xDCBB968F
{
	int i;
...
BOOL func_135(Ped pedParam0) // Position - 0xAB04 Hash - 0x7E48B415 ^0x126328AB
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xAB24 Hash - 0x3D210083 ^0xF7E7C389
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_137(int iParam0) // Position - 0xAB45 Hash - 0xBF3EFB31 ^0xBF3EFB31
{
	switch (iParam0)
	{
		case 5:
...
void func_138() // Position - 0xAB98 Hash - 0x53295875 ^0x53295875
{
...
void func_139(char* sParam0) // Position - 0xAC15 Hash - 0x54B64147 ^0x56EEAFB9
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

BOOL func_140(int iParam0) // Position - 0xAC27 Hash - 0x6F2BC7EE ^0x6F2BC7EE
{
	if (iParam0 == -1)
		iParam0 = func_150();
...
BOOL func_141(int iParam0) // Position - 0xACBC Hash - 0xDE7BA54D ^0xDE7BA54D
{
...
BOOL func_142() // Position - 0xACFB Hash - 0x29CB2928 ^0xE369A18D
{
...
BOOL func_143() // Position - 0xAD18 Hash - 0x98CCC132 ^0x97B0D6ED
{
	if (Global_98294 != -1)
...
BOOL func_144(int iParam0) // Position - 0xAD3B Hash - 0xC2630182 ^0xFBD23031
{
	if (func_146() && Global_101392.f_11 == 6 && iParam0 == func_145(&(Global_101392.f_3), 0))
		return true;

	return false;
}

int func_145(char* sParam0, int iParam1) // Position - 0xAD6F Hash - 0x76A2E0AF ^0x8A5231BB
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL func_146() // Position - 0xADB8 Hash - 0x25806CBF ^0x25806CBF
{
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xADF6 Hash - 0xECB6C71B ^0xECB6C71B
{
	return func_148(iParam0, Global_43922);
}

BOOL func_148(int iParam0, int iParam1) // Position - 0xAE07 Hash - 0x1FD727E0 ^0x1FD727E0
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_149(int iParam0) // Position - 0xAFE8 Hash - 0x1156B580 ^0x34C7FA05
{
	if (_IS_MISSION_REPEAT_ACTIVE(false))
...
int func_150() // Position - 0xB010 Hash - 0x613FC6AD ^0xDC7835B3
{
	return func_145(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

BOOL func_151(int iParam0) // Position - 0xB021 Hash - 0x5C21BF6B ^0xB5545E1F
{
	int num;
	...
	num = func_153(&(Global_113457[iParam0 /*10*/].f_9), 1, 4, false, 0);
...
void func_152(int iParam0) // Position - 0xB066 Hash - 0xF49E441F ^0xE21552CB
{
...
int func_153(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB098 Hash - 0x8F9349A ^0xC5C097C1
{
	int i;
	...
	if (*iParam0 == -1)
	{
		...
		*iParam0 = Global_43886;
		...
		if (iParam4 != 0)
			func_154(iParam0, iParam4);
	}

	return 2;
}

void func_154(int iParam0, int iParam1) // Position - 0xB1CF Hash - 0x6AC97785 ^0x6AC97785
{
	int i;
...
BOOL func_155(int iParam0) // Position - 0xB21E Hash - 0x3BAB94E9 ^0x3BAB94E9
{
	if (Global_43922 == 15)
		return false;
...
BOOL func_156(int iParam0) // Position - 0xB240 Hash - 0x97844555 ^0xADCD6DAA
{
	eCharacter character;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_164() || Global_113417 || Global_32831 || func_163() || func_162(8, -1) || func_101() || func_161() || func_160() || func_159() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_164() || Global_32831 || func_163() || func_162(8, -1) || func_160() || func_101() || func_161() || func_159() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_164() || Global_113417 || Global_32831 || func_163() || func_162(8, -1) || func_160() || func_101() || func_161() || func_159() || Global_114370.f_7691.f_919[character] == 5 || Global_44469 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_164() || Global_113417 || Global_32831 || func_163() || func_162(8, -1) || func_101() || func_161() || func_159() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_164() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_162(8, -1) || func_159() || func_158() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 5:
						if (func_162(8, -1) || func_101() || func_161() || func_158() || func_157())
							return false;
...
BOOL func_157() // Position - 0xB95D Hash - 0x4228A1C2 ^0x952FE30F
{
	return Global_101431.f_1;
}

BOOL func_158() // Position - 0xB96B Hash - 0xC20DBA70 ^0xAC4006FB
{
	if (Global_98294 != -1)
...
BOOL func_159() // Position - 0xB98E Hash - 0x3CA1BB47 ^0xB78A1ACB
{
...
BOOL func_160() // Position - 0xB9A8 Hash - 0xE663B8F6 ^0xE663B8F6
{
	if (Global_79509)
		return true;
...
BOOL func_161() // Position - 0xB9D2 Hash - 0xD56328D2 ^0xD56328D2
{
	return Global_101444.f_394 > 0;
}

BOOL func_162(int iParam0, int iParam1) // Position - 0xB9E3 Hash - 0xA14C4D3F ^0xA6034F77
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_163() // Position - 0xBA1B Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1575079;
}

BOOL func_164() // Position - 0xBA27 Hash - 0x7FE517FE ^0x128A3BC8
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void func_165() // Position - 0xBA43 Hash - 0xB123F698 ^0xB123F698
{
	if (!func_166(103))
	{
		iLocal_77 = 1;
...
BOOL func_166(int iParam0) // Position - 0xBA5B Hash - 0x96384BE4 ^0xDBE380F3
{
...
void func_167() // Position - 0xBABF Hash - 0x8CA1C1EF ^0x7E2685A7
{
	switch (iLocal_78)
	{
		case 0:
			if (!func_185())
			{
				if (func_166(103))
				{
					_CONVERSATION_INITIALIZE_ACTOR(&uLocal_79, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
					_CONVERSATION_INITIALIZE_ACTOR(&uLocal_79, 3, 0, "TONYA", 0, 1);
				
					if (func_199(60))
						func_170(&uLocal_79, 103, "TOWAUD", "TOW_CALL_02", 4, 1, 0, 0, false);
					else
						func_170(&uLocal_79, 103, "TOWAUD", "TOW_CALL_01", 4, 1, 0, 0, false);
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xBBAB Hash - 0x152DA0B2 ^0x220E93E9
{
...
BOOL func_169(int iParam0) // Position - 0xBBCD Hash - 0xBEDC0B63 ^0xB0FE2A8C
{
	if (Global_118[iParam0 /*10*/].f_8 != 178)
...
int func_170(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, BOOL bParam8) // Position - 0xBC0B Hash - 0xB2BF6D68 ^0xB2BF6D68
{
	func_183(uParam0, iParam1, sParam2, iParam6, iParam7, 0);
	Global_22214 = 0;
	Global_22173 = true;
	Global_22180 = 0;
	Global_22175 = 0;
	...
	Global_2883585 = 0;
	return func_171(sParam3, iParam4, bParam8);
}

int func_171(char* sParam0, int iParam1, BOOL bParam2) // Position - 0xBC6A Hash - 0x77297D51 ^0x40DC584A
{
	Global_22167 = 0;
...
void func_172() // Position - 0xBF38 Hash - 0xF42BEB19 ^0xA29557DA
{
	if (!func_173())
		return;
...
BOOL func_173() // Position - 0xBF6F Hash - 0x7B74B45F ^0xCE052A5D
{
...
BOOL func_174(Player plParam0) // Position - 0xBFD2 Hash - 0x6E46BC72 ^0x6E46BC72
{
	return func_175(plParam0, 20);
}

BOOL func_175(Player plParam0, int iParam1) // Position - 0xBFE2 Hash - 0x7CD5054C ^0x870BEA81
{
	return IS_BIT_SET(Global_1886967[plParam0 /*609*/].f_10.f_4, iParam1);
}

void func_176() // Position - 0xBFFA Hash - 0xA92653FC ^0x70B72632
{
	int i;
...
void func_177() // Position - 0xC02C Hash - 0xCD8A4D28 ^0xCD8A4D28
{
...
BOOL func_178() // Position - 0xC0C1 Hash - 0xD140D54A ^0xE638D98F
{
...
BOOL func_179() // Position - 0xC0E8 Hash - 0x9A999369 ^0x4033F7BF
{
	int num;
	int weaponHash;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0xC181 Hash - 0x98476CE1 ^0x250FEB7C
{
	if (func_60(14))
	{
...
void func_181() // Position - 0xC223 Hash - 0xAA1F0501 ^0xEF04D548
{
	int i;
...
void func_182() // Position - 0xC27A Hash - 0xE32CF1EF ^0xB9A7BEB2
{
...
void func_183(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xC2D1 Hash - 0xC6B752B2 ^0xC6B752B2
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xC327 Hash - 0x6C235EE0 ^0x9E57F206
{
...
BOOL func_185() // Position - 0xC3C2 Hash - 0x2BF82AC3 ^0x2BF82AC3
{
	if (Global_20798)
		return true;
...
void func_186() // Position - 0xC3D8 Hash - 0xFAE57094 ^0xFAE57094
{
	switch (iLocal_78)
	{
		case 0:
...
BOOL func_187() // Position - 0xC42C Hash - 0xF513CDE6 ^0xF513CDE6
{
	if (func_155(0))
		return false;
	...
	if (func_199(60) && !func_188(104))
		return false;
	else if (func_199(59) && !func_188(103))
		return false;
...
BOOL func_188(int iParam0) // Position - 0xC493 Hash - 0xB6246282 ^0x2350A449
{
...
BOOL func_189(int iParam0) // Position - 0xC4C0 Hash - 0x3D43FEFC ^0x3D43FEFC
{
	int i;
...
void func_190() // Position - 0xC528 Hash - 0xD7FE7F07 ^0xD7FE7F07
{
	func_191(103, 1, false);
	iLocal_77 = 1;
	iLocal_78 = 0;
	return;
}

void func_191(eCharacter echParam0, eCharacter echParam1, BOOL bParam2) // Position - 0xC53E Hash - 0x95F9A85C ^0xCFF8B9F9
{
	int num;
	...
	if (Global_118[echParam0 /*10*/].f_8 != 178)
	{
		...
		if (echParam1 == 4)
		{
			func_197(echParam0, 0, 1);
			func_197(echParam0, 1, 1);
			func_197(echParam0, 2, 1);
			func_196(echParam0, 0, 1);
			func_196(echParam0, 1, 1);
			func_196(echParam0, 2, 1);
		}
		else
		{
			if (func_195(echParam0, echParam1) == 1 && func_194(echParam0, echParam1) == 1)
				bParam2 = false;
		
			num = echParam1;
			func_197(echParam0, num, 1);
			func_196(echParam0, num, 1);
...
void func_192() // Position - 0xC6BC Hash - 0x59410113 ^0xA1EB8776
{
	var txdName;
	var subject;
...
struct<4> _GET_CHARACTER_NAME(eCharacter character) // Position - 0xC737 Hash - 0x5D6A4A13 ^0x32291975
{
	return Global_2139[character /*29*/].f_3;
}

int func_194(eCharacter echParam0, int iParam1) // Position - 0xC74A Hash - 0x97DCD8A1 ^0xF8178EDD
{
...
int func_195(eCharacter echParam0, int iParam1) // Position - 0xC774 Hash - 0x97DCD8A1 ^0x5A8D70D2
{
	if (iParam1 < 0 || iParam1 > 4)
		return 0;
...
void func_196(eCharacter echParam0, int iParam1, int iParam2) // Position - 0xC79E Hash - 0xAB9B6CC ^0x1B5EEB55
{
	if (iParam1 < 0 || iParam1 > 4)
		return;
...
void func_197(eCharacter echParam0, int iParam1, int iParam2) // Position - 0xC7E3 Hash - 0xAB9B6CC ^0x80AE0F15
{
	if (iParam1 < 0 || iParam1 > 4)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0xC828 Hash - 0x3C5423D7 ^0x3C5423D7
{
	func_59();
	return Global_114370.f_2366.f_539.f_4321;
}

BOOL func_199(int iParam0) // Position - 0xC841 Hash - 0x5ADD7F05 ^0x5ADD7F05
{
...
BOOL func_200(int iParam0, int iParam1) // Position - 0xC86C Hash - 0xDEE74A4E ^0xDEE74A4E
{
	BOOL flag;
...
int func_201(int iParam0) // Position - 0xC8B6 Hash - 0xFCBFD2CC ^0x1DBFD43E
{
	int num;
	int offset;
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0xC90D Hash - 0x15889021 ^0xE7262364
{
...
void func_203() // Position - 0xC935 Hash - 0x76489A78 ^0xDDCAA4DA
{
	if (func_199(61) || func_199(62))
		func_204(28);
...
int func_204(int iParam0) // Position - 0xC95D Hash - 0xFCBFD2CC ^0x1DBFD43E
{
	int num;
	int offset;
