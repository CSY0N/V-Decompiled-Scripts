		...
		if (Global_20813.f_1 != 9)
		{
			switch (Global_20813.f_1)
			{
				case 7:
					...
					{
						GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(Global_20794, "APP_FUNCTION");
				...
				case 8:
					if (func_6(FRONTEND_CONTROL, Global_20781, 0))
					{
						func_5();
						Global_20791 = true;
						func_10();
	...
	else if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		for (i = 0; i < Global_4543258; i = i + 1)
		{
			...
			if (iLocal_29 == 0)
			{
				...
				GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(fLocal_28);
				GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(Global_4543236[i]);
				GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
			}
