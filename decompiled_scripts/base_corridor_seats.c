...
BOOL func_70() // Position - 0x17F9 Hash - 0x9D72CDB3 ^0x378B5237
{
	if (Global_1845100 != _INVALID_PLAYER_INDEX())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("base_corridor_seats", Global_1845100, true, 0))
			return false;
...
void func_71() // Position - 0x1845 Hash - 0x1E17DD2B ^0x1E17DD2B
{
	var unk;
	...
	unk[0] = 0;
	unk[1] = 1;
	func_72(5, &uLocal_98, &unk);
	unk[0] = 2;
	unk[1] = 3;
	func_72(6, &uLocal_98, &unk);
	return;
}
