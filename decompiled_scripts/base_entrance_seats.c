...
void func_3(var uParam0) // Position - 0xC3 Hash - 0xB8C26EBF ^0xCF01AD98
{
...
void func_4(var uParam0, BOOL bParam1) // Position - 0xDC Hash - 0xDB544986 ^0x713B955D
{
	if (func_5(uParam0))
		HUD::CLEAR_HELP(true);
...
BOOL func_5(var uParam0) // Position - 0x101 Hash - 0x80B2F70E ^0xDCD31C80
{
	var unk;
	var unk5;
...
void func_7(var uParam0, int iParam1, char* sParam2) // Position - 0x14A Hash - 0x96F3E881 ^0xD6A5C9F6
{
...
void func_11(var uParam0) // Position - 0x219 Hash - 0x1FD0CF16 ^0x77E4B5F2
{
	var animDict;
	var animName;
	int num;
	...
	num = { uParam0->[uParam0->f_57.f_2 /*14*/] };
...
void func_12(var uParam0, BOOL bParam1) // Position - 0x62F Hash - 0x64C0EDC6 ^0x955D2602
{
	...
	if (bParam1)
	{
		...
		if (num != uParam0->f_57.f_8.f_1)
			if (num == 0)
				randomIntInRange = 11 + uParam0->f_57.f_8.f_1;
			else
				randomIntInRange = 6 + num;
		else
			randomIntInRange = uParam0->f_57.f_8.f_2;
	...
	else if (uParam0->f_57.f_8.f_2 == 5)
	{
		...
		if (randomIntInRange == uParam0->f_57.f_8.f_3)
...
int func_13(var uParam0) // Position - 0x768 Hash - 0xDA3B8145 ^0x98CA9AB3
{
...
void func_18(var uParam0) // Position - 0x817 Hash - 0x392A29FC ^0x318C4B2
{
	Vector3 vector;
	float num;
	...
	if (uParam0->f_57.f_4 == 6)
	{
		...
		if (uParam0->f_57.f_4 == 6 && !ENTITY::HAS_ANIM_EVENT_FIRED(PLAYER::PLAYER_PED_ID(), joaat("block_interrupt")) && !func_8(&(uParam0->f_57), 12))
			if (num >= 0.35f)
				func_23(uParam0);
...
BOOL func_22(var uParam0) // Position - 0xAED Hash - 0x8C89182D ^0xF7A22FC2
{
	return func_8(&(uParam0->f_57), 9);
}

void func_23(var uParam0) // Position - 0xAFF Hash - 0xBC1B827E ^0x3F44A32A
{
	var animDict;
	var animnName;
...
void func_24(var uParam0) // Position - 0xBC0 Hash - 0xDF70B9DB ^0x3D04A136
{
	var animDict;
...
void func_26(var uParam0) // Position - 0xC42 Hash - 0x7EDCD81E ^0x4090A23F
{
	int weaponHash;
...
Vector3 func_38(var uParam0) // Position - 0xEEA Hash - 0x5F25677 ^0x8BB42DD8
{
	var unk;

	unk = { uParam0->[uParam0->f_57.f_2 /*14*/].f_8.f_3 };
...
Vector3 func_39(var uParam0) // Position - 0xF28 Hash - 0x4B9F1C47 ^0x10149D06
{
	return uParam0->[uParam0->f_57.f_2 /*14*/].f_8;
}

void func_40(var uParam0, char* sParam1) // Position - 0xF3E Hash - 0xE3D53270 ^0xCDB3DF7C
{
...
void func_41(var uParam0, char* sParam1) // Position - 0x103A Hash - 0x7324B9B1 ^0x5BA72DD6
{
...
void func_42(var uParam0) // Position - 0x117A Hash - 0xE3D7DFC1 ^0xADC4C9B3
{
...
int func_43(var uParam0) // Position - 0x11B6 Hash - 0x24A5AB68 ^0xBC6E4B2C
{
	int randomIntInRange;
...
BOOL func_46(var uParam0) // Position - 0x136D Hash - 0x320A2490 ^0xB9450D26
{
...
BOOL func_47(var uParam0) // Position - 0x139C Hash - 0x1FE791FA ^0x35DB15F5
{
	...
	for (i = 0; i < NETWORK::NETWORK_GET_MAX_NUM_PARTICIPANTS(); i = i + 1)
	{
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(i)))
		{
			...
			if (playerIndex != PLAYER::PLAYER_ID() && _NETWORK_IS_PLAYER_VALID(playerIndex, true, true) && func_50(PLAYER::GET_PLAYER_PED(playerIndex), &uParam0->[uParam0->f_57.f_2 /*14*/]))
				return 1;
		}
	}
...
BOOL func_49(var uParam0) // Position - 0x1467 Hash - 0x5DB3FF9E ^0x94A1FFD5
{
...
BOOL func_51(var uParam0) // Position - 0x149D Hash - 0xBE78C6FE ^0x2E6D8A6C
{
	int i;
...
void func_52(var uParam0, int iParam1) // Position - 0x14E4 Hash - 0xD6BCD227 ^0x6787E6B6
{
...
void func_54(var uParam0) // Position - 0x1504 Hash - 0xE91BA0BB ^0xCB21F2F4
{
	if (uParam0->f_57.f_4 == 6)
	{
	}
...
float func_55(var uParam0) // Position - 0x1588 Hash - 0x7B8D0FB0 ^0xCDB6DFC0
{
...
void func_56(var uParam0) // Position - 0x15DA Hash - 0xFBA1CE25 ^0x3A2A69E8
{
...
{
	return ENTITY::IS_ENTITY_IN_ANGLED_AREA(pedParam0, 451.6327f, 4829.453f, -54.97165f, 499.98096f, 4842.0337f, -50.679607f, 30.75f, false, true, 0);
}
...
BOOL func_70() // Position - 0x17F9 Hash - 0x9D72CDB3 ^0x378B5237
{
	if (Global_1845100 != _INVALID_PLAYER_INDEX())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("base_entrance_seats", Global_1845100, true, 0))
			return false;
...
void func_71() // Position - 0x1845 Hash - 0xE6C843BF ^0xE6C843BF
{
	var unk;
	...
	unk[0] = 0;
	unk[1] = 1;
	func_72(0, &uLocal_98, &unk);
	unk[0] = 2;
	unk[1] = 3;
	func_72(1, &uLocal_98, &unk);
	return;
}

void func_72(int iParam0, var uParam1, var uParam2) // Position - 0x187C Hash - 0x32E80A9 ^0x32E80A9
{
	var unk;
	float num;
	int i;
	...
	for (i = 0; i < 2; i = i + 1)
	{
		...
		uParam1->[uParam2->[i] /*14*/].f_8 = { func_75(func_76(i), num) + unk };
		uParam1->[uParam2->[i] /*14*/].f_8.f_3 = { 0f, 0f, num + 174f };
		uParam1->[uParam2->[i] /*14*/].f_1 = { func_75(func_74(i), num) + unk };
		uParam1->[uParam2->[i] /*14*/].f_1.f_3 = { func_75(func_73(i), num) + unk };
...
Vector3 func_73(int iParam0) // Position - 0x1937 Hash - 0x2C359028 ^0x2C359028
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_74(int iParam0) // Position - 0x1985 Hash - 0x170013E3 ^0x170013E3
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_75(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x19C7 Hash - 0x8959C4D1 ^0x8922A2E2
{
	float num;
	float num2;
	float num3;
...
Vector3 func_76(int iParam0) // Position - 0x1A0B Hash - 0x9A1B2C82 ^0x9A1B2C82
{
	switch (iParam0)
	{
		case 0:
			return { -59.42f, 4832.75f, 391.558f } - func_77();
	
		case 1:
			return { -59.42f, 4832.75f, 392.858f } - func_77();
...
Vector3 func_77() // Position - 0x1A57 Hash - 0x80F8E7AE ^0x80F8E7AE
{
	return func_78() + { 0f, -8.946f, 47.215f };
}

Vector3 func_78() // Position - 0x1A6F Hash - 0x21158019 ^0x21158019
{
	return 345.0041f, 4842.001f, -59.9997f;
}

void func_79(int iParam0, var uParam1, var uParam2) // Position - 0x1A86 Hash - 0xC9A706AA ^0xC9A706AA
{
	switch (iParam0)
	{
		case 0:
	...
	*uParam1 = { *uParam1 + func_78() };
	return;
}

int _NETWORK_ENSURE_SCRIPT_IS_NETWORKED(int iParam0, int iParam1, BOOL bNoTerminate) // Position - 0x1C24 Hash - 0x75751681 ^0x9140C9A0
{
	int i;
...
BOOL func_81(BOOL bParam0) // Position - 0x1D3A Hash - 0x1CCCE169 ^0x1CCCE169
{
	bParam0;
