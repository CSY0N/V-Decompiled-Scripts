...
void main() // Position - 0x0 Hash - 0x5D84F89F ^0x5D84F89F
{
	...
	for (i = 0; i < 10; i = i + 1)
	{
		TEXT_LABEL_ASSIGN_STRING(&Global_42455[i /*8*/], "", 32);
	}
		...
		else
		{
			...
			switch (iLocal_77)
			{
				...
				case 1:
					...
					if (func_83())
					{
						if (!func_82(9) || Global_113079.f_19 == 4)
						{
							func_58();
...
void func_1() // Position - 0x1A6 Hash - 0x8F987E ^0xE48C7875
{
	if (!IS_BIT_SET(Global_42617, 0))
	{
		if (!ENTITY::DOES_ENTITY_EXIST(uLocal_181[0]))
		{
			...
			{
				uLocal_181[0] = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("xm_prop_x17dlc_rep_sign_01a"), 2222.883f, 5612.299f, 55.291f, false, false, true);
				ENTITY::SET_ENTITY_ROTATION(uLocal_181[0], 0.5f, 0f, 15.325f, 2, true);
				ENTITY::FREEZE_ENTITY_POSITION(uLocal_181[0], true);
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("xm_prop_x17dlc_rep_sign_01a"));
			}
		}
	}
	else if (ENTITY::DOES_ENTITY_EXIST(uLocal_181[0]))
	{
		OBJECT::DELETE_OBJECT(&uLocal_181[0]);
	}
	...
	if (func_2())
	{
		if (!ENTITY::DOES_ENTITY_EXIST(uLocal_181[1]))
		{
			...
			{
				uLocal_181[1] = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("xm_prop_base_cabinet_door_01"), -362.402f, 4829.89f, 142.477f, false, false, true);
				ENTITY::SET_ENTITY_ROTATION(uLocal_181[1], 0f, 0f, 320f, 2, true);
				ENTITY::FREEZE_ENTITY_POSITION(uLocal_181[1], true);
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("xm_prop_base_cabinet_door_01"));
			}
		}
	}
	else if (ENTITY::DOES_ENTITY_EXIST(uLocal_181[1]))
	{
		OBJECT::DELETE_OBJECT(&uLocal_181[1]);
	}

	return;
}

BOOL func_2() // Position - 0x2C0 Hash - 0xDEFE746A ^0xF5CF5F57
{
	if (IS_BIT_SET(Global_42617, 1))
		return false;
	...
	if (NETWORK::NETWORK_IS_ACTIVITY_SESSION())
		if (func_7(*Global_4718592.f_126144) == 14 || func_7(*Global_4718592.f_126144) == 15)
			return false;
	else if (_NETWORK_IS_PLAYER_VALID(PLAYER::PLAYER_ID(), true, true))
		if (func_5(PLAYER::PLAYER_ID()) || func_3(PLAYER::PLAYER_ID()))
			return false;

	return true;
}

BOOL func_3(Player plParam0) // Position - 0x344 Hash - 0xA439E034 ^0x18C6D29E
{
...
Player _INVALID_PLAYER_INDEX() // Position - 0x3AA Hash - 0x478900E4 ^0x478900E4
{
	return -1;
}

BOOL func_5(Player plParam0) // Position - 0x3B3 Hash - 0x7C71011F ^0x7C71011F
{
...
BOOL _NETWORK_IS_PLAYER_VALID(Player player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x3E4 Hash - 0x3FF6E4CA ^0xE6B59972
{
	Player player;
...
int func_7(Hash hParam0) // Position - 0x444 Hash - 0x2802F40E ^0x2802F40E
{
...
int func_8() // Position - 0x5BA Hash - 0x21D64237 ^0x21D64237
{
	return Global_32828;
}

void func_9() // Position - 0x5C5 Hash - 0xD89489FC ^0xBC765F99
{
	int i;
	var iplName;

	if (!bLocal_176 && !STREAMING::IS_NEW_LOAD_SCENE_ACTIVE() && func_24())
	{
		if (!Global_1836227)
		{
		...
		if (!STREAMING::IS_NEW_LOAD_SCENE_ACTIVE())
		{
			if (!Global_1836227)
			{
				...
				for (i = 0; i < 12; i = i + 1)
				{
					if (i != 8)
					{
						TEXT_LABEL_ASSIGN_STRING(&iplName, "GR_case", 24);
						TEXT_LABEL_APPEND_INT(&iplName, i, 24);
						TEXT_LABEL_APPEND_STRING(&iplName, "_BunkerClosed", 24);
	...
	if (!STREAMING::IS_NEW_LOAD_SCENE_ACTIVE() && func_24())
	{
		if (!NETWORK::NETWORK_IS_ACTIVITY_SESSION() || func_20())
		{
			if (!Global_1836228)
			{
				...
				if (!IS_BIT_SET(*Global_4718592.f_176241, 14))
		...
		else if (IS_BIT_SET(*Global_4718592.f_176241, 13))
		{
			if (!STREAMING::IS_IPL_ACTIVE("xm_siloentranceclosed_x17"))
				STREAMING::REQUEST_IPL("xm_siloentranceclosed_x17");
		...
		if (IS_BIT_SET(Global_1942781.f_1562, 8))
		{
			STREAMING::REMOVE_IPL("Coroner_Int_on");
			STREAMING::REQUEST_IPL("Coroner_Int_off");
			MISC::CLEAR_BIT(&(Global_1942781.f_1562), 8);
		}
		...
		if (!Global_1836231)
		{
			if (IS_BIT_SET(Global_1942781.f_5, 18))
			...
			if (IS_BIT_SET(Global_1942781.f_5, 19))
			{
		...
		if (Global_262145.f_32132)
			func_17();
	}

	if (!func_24())
		Global_1836228 = false;
	...
	else if (!STREAMING::IS_NEW_LOAD_SCENE_ACTIVE() && !func_24())
	{
		func_10();
		bLocal_178 = false;
	}

	if (bLocal_179 && func_24())
	{
		func_10();
		bLocal_179 = false;
	}
	...
	if (bLocal_180)
	{
		if (!Global_1836227 && func_24() && !STREAMING::IS_NEW_LOAD_SCENE_ACTIVE())
		{
...
void func_10() // Position - 0x1045 Hash - 0xE3C25053 ^0xE3C25053
{
	int i;
...
void func_11(int iParam0, BOOL bParam1) // Position - 0x1067 Hash - 0x21DBAF7 ^0x981BB455
{
	int i;
	...
	if (func_16(iParam0))
	{
		for (i = 0; i < 2; i = i + 1)
		{
			STREAMING::REMOVE_IPL(func_14(iParam0, i));
		}
	
		if (!bParam1)
		{
			if (Global_2748596.f_93[iParam0])
			{
				Global_2748596.f_93[iParam0] = false;
				Global_2748596.f_136 = Global_2748596.f_136 + -1;
			}
		
			if (Global_2748596.f_136 <= 0)
			{
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(func_13());
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(func_12());
				Global_2748596.f_136 = 0;
			}
		}
	}
...
Hash func_12() // Position - 0x10E3 Hash - 0x9F572D68 ^0x157F45E5
{
	return joaat("apa_mp_apa_yacht");
}

Hash func_13() // Position - 0x10F0 Hash - 0x9F572D68 ^0x539BB60D
{
	return joaat("apa_mp_apa_yacht_win");
}

const char* func_14(int iParam0, int iParam1) // Position - 0x10FD Hash - 0x49BFE5FD ^0xEC0B68B8
{
	return func_15(&Global_4280768[iParam0 /*45*/].f_15[iParam1 /*8*/]);
}

const char* func_15(var uParam0) // Position - 0x1117 Hash - 0xC9D82232 ^0xC9D82232
{
	return uParam0;
}

BOOL func_16(int iParam0) // Position - 0x1121 Hash - 0xA73E48FC ^0xA73E48FC
{
...
void func_17() // Position - 0x113F Hash - 0x563B74D1 ^0x75C11B7
{
...
int func_18(int iParam0) // Position - 0x115B Hash - 0xB17F4FFB ^0xB17F4FFB
{
	int i;

	for (i = 0; i < 11; i = i + 1)
	{
		if (iParam0 == func_19(i))
			return i;
	}
...
int func_19(int iParam0) // Position - 0x1187 Hash - 0x62114499 ^0x518492C0
{
	if (iParam0 != -1)
...
BOOL func_20() // Position - 0x11A6 Hash - 0xDA2E4073 ^0x67B01C0E
{
	if (NETWORK::NETWORK_IS_ACTIVITY_SESSION())
		return func_22();

	return func_21(*Global_4718592.f_126144);
}

BOOL func_21(Hash hParam0) // Position - 0x11CA Hash - 0x4813BA45 ^0x4813BA45
{
	int i;
...
BOOL func_22() // Position - 0x1204 Hash - 0x4228A1C2 ^0xF0823820
{
	return Global_2684312.f_19;
}

void func_23() // Position - 0x1212 Hash - 0x94794D11 ^0x592F7DD7
{
	ENTITY::CREATE_MODEL_HIDE(-1785.189f, 444.5226f, 127.1124f, 0.5f, joaat("prop_parasol_01"), true);
	ENTITY::CREATE_MODEL_HIDE(-1785.2925f, 432.9928f, 127.1134f, 0.5f, joaat("prop_parasol_01"), true);
	ENTITY::CREATE_MODEL_HIDE(-1784.2349f, 444.5237f, 127.6224f, 0.5f, joaat("prop_yaught_chair_01"), true);
	ENTITY::CREATE_MODEL_HIDE(-1785.3584f, 445.6732f, 127.6216f, 0.5f, joaat("prop_yaught_chair_01"), true);
	ENTITY::CREATE_MODEL_HIDE(-1783.1411f, 446.3715f, 127.6272f, 0.5f, joaat("prop_yaught_chair_01"), true);
	STREAMING::REQUEST_IPL("h4_CH2_Mansion_Final");
	return;
}

BOOL func_24() // Position - 0x12B8 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_2697664;
}

void func_25() // Position - 0x12C4 Hash - 0xC22116A5 ^0xC22116A5
{
	int num;
	Vector3 vector;
	int i;
	...
	for (i = 0; i < 8; i = i + 1)
	{
		if (Global_39262[i] != 0 || Global_39271[i] != 0)
			flag = false;
	}
	...
	if (func_33(num))
	{
		if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), vector, true) > 250f)
		{
			func_32(num, false);
			func_31(num, true);
	...
	if (func_30(num) && !MISC::ARE_STRINGS_EQUAL(&Global_40217, vector.f_3))
	{
		flag2 = false;
		...
		if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), vector, true) > 250f && !flag2)
		{
			func_28(num, false);
			func_26(num, true);
...
void func_26(int iParam0, BOOL bParam1) // Position - 0x1499 Hash - 0x417FF99 ^0x6FCF88FF
{
	char* string2;
	Interior interior;
	...
	string2 = "NULL";
	interior = 0;
	string2 = func_27(iParam0, &interior);
...
char* func_27(int iParam0, var uParam1) // Position - 0x1545 Hash - 0x724FFEBB ^0x3397F292
{
	Vector3 vector;

	vector = { func_34(iParam0) };
	*uParam1 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vector, vector.f_3);
	return vector.f_4;
}

void func_28(int iParam0, BOOL bParam1) // Position - 0x156A Hash - 0x159D970A ^0x2BF0B4B
{
	int offset;

	offset = { func_29(iParam0) };
...
struct<2> func_29(int iParam0) // Position - 0x15AD Hash - 0x87F664E1 ^0xB5A53089
{
	int num;
...
BOOL func_30(int iParam0) // Position - 0x15DA Hash - 0x3EFCD0D0 ^0xC443C103
{
	int num;
...
void func_31(int iParam0, BOOL bParam1) // Position - 0x160B Hash - 0x514025D8 ^0x38F60CD7
{
	char* string2;
	Interior interior;
	Interior interiorFromPrimaryView;
...
void func_32(int iParam0, BOOL bParam1) // Position - 0x16D2 Hash - 0x159D970A ^0x2BF0B4B
{
	int offset;
...
BOOL func_33(int iParam0) // Position - 0x1715 Hash - 0x3EFCD0D0 ^0xC443C103
{
	int num;
...
struct<5> func_34(int iParam0) // Position - 0x1746 Hash - 0xAA1C3943 ^0x71899C1C
{
	var unk;
	var unk6;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x425F Hash - 0x16E871AD ^0x10C54C39
{
...
struct<6> func_36(int iParam0, BOOL bParam1) // Position - 0x4289 Hash - 0x293B24C9 ^0x49F602D8
{
	var unk;
...
void func_37() // Position - 0x4E3F Hash - 0x1CD06876 ^0xE8498E8C
{
	...
	{
		fLocal_64 = MISC::GET_DISTANCE_BETWEEN_COORDS(Global_42618[iLocal_62 /*31*/].f_2, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), true);
	}
	else
	{
		distanceBetweenCoords = MISC::GET_DISTANCE_BETWEEN_COORDS(Global_42618[iLocal_62 /*31*/].f_2, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), true);
	
		if (distanceBetweenCoords < fLocal_64)
		{
			fLocal_64 = distanceBetweenCoords;
			iLocal_63 = iLocal_62;
		}
	}
	...
	if (!bLocal_66)
	{
		if (Global_42618[iLocal_65 /*31*/].f_24 == 0)
		{
			iLocal_67 = 0;
		...
		else
		{
			...
			if (iLocal_67 >= Global_42618[iLocal_65 /*31*/].f_24)
			{
				iLocal_67 = 0;
				iLocal_65 = iLocal_65 + 1;
...
void func_38(int iParam0) // Position - 0x4F3C Hash - 0xC003A006 ^0x72E948EB
{
	int i;
	Ped ped;
	BOOL flag;
	...
	if (IS_BIT_SET(iLocal_76, iParam0))
		return;

	MISC::SET_BIT(&iLocal_76, iParam0);

	if (IS_BIT_SET(Global_42618[iParam0 /*31*/].f_1, 4))
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
			if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0)
				if (!IS_BIT_SET(Global_42618[iParam0 /*31*/].f_1, 6))
					func_45(iParam0, true);
			else if (IS_BIT_SET(Global_42618[iParam0 /*31*/].f_1, 6))
				func_45(iParam0, false);
	...
	if (Global_42618[iParam0 /*31*/].f_24 > 0)
	{
		for (i = 0; i < Global_42618[iParam0 /*31*/].f_24; i = i + 1)
		{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(ped))
				func_44(iParam0, ped, true);
		}
	}

	if (IS_BIT_SET(Global_42618[iParam0 /*31*/].f_1, 6) || IS_BIT_SET(Global_42618[iParam0 /*31*/].f_1, 5) || func_42(iParam0))
	{
		func_41(iParam0);
		iLocal_65 = iParam0;
	
		if (Global_42618[iParam0 /*31*/] == -1735618852 || Global_42618[iParam0 /*31*/] == 213039352 || Global_42618[iParam0 /*31*/] == -1247364148 || Global_42618[iParam0 /*31*/] == 935592315 || Global_42618[iParam0 /*31*/] == 179480401 || Global_42618[iParam0 /*31*/] == -804938986 || Global_42618[iParam0 /*31*/] == -599111730 || Global_42618[iParam0 /*31*/] == 1423193534 || Global_42618[iParam0 /*31*/] == -1958174046)
			AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(Global_42618[iParam0 /*31*/], true);
	
		if (IS_BIT_SET(Global_42618[iParam0 /*31*/].f_1, 7))
			func_40(iParam0, true);
	
		if (!IS_BIT_SET(Global_42618[iParam0 /*31*/].f_1, 2))
		{
			if (IS_BIT_SET(Global_42618[iParam0 /*31*/].f_1, 1))
			{
				if (Global_42618[iParam0 /*31*/].f_22 > -1f)
				{
					Global_42618[iParam0 /*31*/].f_22 = Global_42618[iParam0 /*31*/].f_22 - (Global_42618[iParam0 /*31*/].f_23 * SYSTEM::TIMESTEP());
				
					if (Global_42618[iParam0 /*31*/].f_22 < -1f)
						Global_42618[iParam0 /*31*/].f_22 = -1f;
				
					MISC::CLEAR_BIT(&(Global_42618[iParam0 /*31*/].f_1), 3);
				}
				else
				{
					MISC::SET_BIT(&(Global_42618[iParam0 /*31*/].f_1), 2);
				}
			}
			else if (Global_42618[iParam0 /*31*/].f_22 < 1f)
			{
				Global_42618[iParam0 /*31*/].f_22 = Global_42618[iParam0 /*31*/].f_22 + (Global_42618[iParam0 /*31*/].f_23 * SYSTEM::TIMESTEP());
		...
		else if (IS_BIT_SET(Global_42618[iParam0 /*31*/].f_1, 1))
		{
			if (Global_42618[iParam0 /*31*/].f_22 > -1f)
				MISC::CLEAR_BIT(&(Global_42618[iParam0 /*31*/].f_1), 2);
		}
		else if (Global_42618[iParam0 /*31*/].f_22 < 1f)
		{
			MISC::CLEAR_BIT(&(Global_42618[iParam0 /*31*/].f_1), 2);
	...
	else
	{
		...
		if (!IS_BIT_SET(Global_42618[iParam0 /*31*/].f_1, 3))
		{
			flag = false;
			closestVehicle = VEHICLE::GET_CLOSEST_VEHICLE(Global_42618[iParam0 /*31*/].f_2, 15f, 0, 2175);
		
			if (ENTITY::DOES_ENTITY_EXIST(closestVehicle))
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(closestVehicle, false))
				{
					num = SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(closestVehicle, true), Global_42618[iParam0 /*31*/].f_2);
				
					if (num < Global_42618[iParam0 /*31*/].f_7)
						flag = true;
				}
			}
			...
			if (IS_BIT_SET(Global_42618[iParam0 /*31*/].f_1, 1))
			{
				if (Global_42618[iParam0 /*31*/].f_22 < 0f)
				{
					if (!flag)
					{
						Global_42618[iParam0 /*31*/].f_22 = Global_42618[iParam0 /*31*/].f_22 + (Global_42618[iParam0 /*31*/].f_23 * SYSTEM::TIMESTEP());
				...
				{
					Global_42618[iParam0 /*31*/].f_22 = 0f;
					MISC::SET_BIT(&(Global_42618[iParam0 /*31*/].f_1), 3);
				}
			}
			else if (Global_42618[iParam0 /*31*/].f_22 > 0f)
			{
				if (!flag)
				{
					Global_42618[iParam0 /*31*/].f_22 = Global_42618[iParam0 /*31*/].f_22 - (Global_42618[iParam0 /*31*/].f_23 * SYSTEM::TIMESTEP());
		...
		{
			if (Global_42618[iParam0 /*31*/] == -1735618852 || Global_42618[iParam0 /*31*/] == 213039352 || Global_42618[iParam0 /*31*/] == -1247364148 || Global_42618[iParam0 /*31*/] == 935592315 || Global_42618[iParam0 /*31*/] == 179480401 || Global_42618[iParam0 /*31*/] == -804938986 || Global_42618[iParam0 /*31*/] == -599111730 || Global_42618[iParam0 /*31*/] == 1423193534 || Global_42618[iParam0 /*31*/] == -1958174046)
				AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(Global_42618[iParam0 /*31*/], false);
...
void func_39(int iParam0) // Position - 0x54AC Hash - 0x29C127DC ^0x29C127DC
{
	int i;
	BOOL flag;
	int num;
	...
	for (i = 0; i < num; i = i + 1)
	{
		if (flag)
		{
			uLocal_71[i - 1] = uLocal_71[i];
		}
		else if (uLocal_71[i] == iParam0)
		{
...
void func_40(int iParam0, BOOL bParam1) // Position - 0x54F8 Hash - 0x34F890 ^0x88453C67
{
	int num;
	BOOL flag;
	Vehicle closestVehicle;
	...
	if (Global_42618[iParam0 /*31*/] == -1298870201)
		num = 23;
	else if (Global_42618[iParam0 /*31*/] == 65926040)
		num = 22;
	else if (Global_42618[iParam0 /*31*/] == 1423193534)
		num = 26;
	else if (Global_42618[iParam0 /*31*/] == -1958174046)
		num = 25;

	if (bParam1)
	{
		if (!IS_BIT_SET(Global_42618[num /*31*/].f_1, 2))
		{
			if (IS_BIT_SET(Global_42618[num /*31*/].f_1, 1))
			{
				if (Global_42618[num /*31*/].f_22 > -1f)
				{
					Global_42618[num /*31*/].f_22 = Global_42618[num /*31*/].f_22 - (Global_42618[num /*31*/].f_23 * SYSTEM::TIMESTEP());
				
					if (Global_42618[num /*31*/].f_22 < -1f)
						Global_42618[num /*31*/].f_22 = -1f;
				
					MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 3);
				}
				else
				{
					MISC::SET_BIT(&(Global_42618[num /*31*/].f_1), 2);
				}
			}
			else if (Global_42618[num /*31*/].f_22 < 1f)
			{
				Global_42618[num /*31*/].f_22 = Global_42618[num /*31*/].f_22 + (Global_42618[num /*31*/].f_23 * SYSTEM::TIMESTEP());
			...
			OBJECT::DOOR_SYSTEM_SET_OPEN_RATIO(Global_42618[num /*31*/], Global_42618[num /*31*/].f_22, false, false);
			OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Global_42618[num /*31*/], 1, false, true);
		}
		else if (IS_BIT_SET(Global_42618[num /*31*/].f_1, 1))
		{
			if (Global_42618[num /*31*/].f_22 > -1f)
				MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 2);
		}
		else if (Global_42618[num /*31*/].f_22 < 1f)
		{
			MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 2);
	...
	else if (!IS_BIT_SET(Global_42618[num /*31*/].f_1, 3))
	{
		flag = false;
		closestVehicle = VEHICLE::GET_CLOSEST_VEHICLE(Global_42618[num /*31*/].f_2, 15f, 0, 2175);
	
		if (ENTITY::DOES_ENTITY_EXIST(closestVehicle))
		{
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(closestVehicle, false))
			{
				num2 = SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(closestVehicle, true), Global_42618[num /*31*/].f_2);
			
				if (num2 < Global_42618[num /*31*/].f_7)
					flag = true;
			}
		}
		...
		if (IS_BIT_SET(Global_42618[num /*31*/].f_1, 1))
		{
			if (Global_42618[num /*31*/].f_22 < 0f)
			{
				if (!flag)
				{
					Global_42618[num /*31*/].f_22 = Global_42618[num /*31*/].f_22 + (Global_42618[num /*31*/].f_23 * SYSTEM::TIMESTEP());
			...
			{
				Global_42618[num /*31*/].f_22 = 0f;
				MISC::SET_BIT(&(Global_42618[num /*31*/].f_1), 3);
			}
		}
		else if (Global_42618[num /*31*/].f_22 > 0f)
		{
			if (!flag)
			{
				Global_42618[num /*31*/].f_22 = Global_42618[num /*31*/].f_22 - (Global_42618[num /*31*/].f_23 * SYSTEM::TIMESTEP());
...
void func_41(int iParam0) // Position - 0x5843 Hash - 0xA578585E ^0xA578585E
{
	int i;

	if (iLocal_70 < uLocal_71)
	{
		for (i = 0; i < iLocal_70; i = i + 1)
		{
			if (uLocal_71[i] == iParam0)
				return;
		}
	
		uLocal_71[iLocal_70] = iParam0;
		iLocal_70 = iLocal_70 + 1;
	}
...
BOOL func_42(int iParam0) // Position - 0x5881 Hash - 0xD3F391A5 ^0x411B2AE
{
	int i;
	Ped ped;
	...
	if (Global_42618[iParam0 /*31*/].f_24 > 0)
	{
		for (i = 0; i < Global_42618[iParam0 /*31*/].f_24; i = i + 1)
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(ped))
			{
				...
				{
					if (SYSTEM::VDIST2(Global_42618[iParam0 /*31*/].f_2, ENTITY::GET_ENTITY_COORDS(ped, true)) < Global_42618[iParam0 /*31*/].f_6)
					{
						if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(ped, Global_42618[iParam0 /*31*/].f_9, Global_42618[iParam0 /*31*/].f_12, Global_42618[iParam0 /*31*/].f_8, false, true, 0))
						{
							iLocal_67 = i;
							return true;
						}
					
						if (IS_BIT_SET(Global_42618[iParam0 /*31*/].f_1, 0))
						{
							if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(ped, Global_42618[iParam0 /*31*/].f_16, Global_42618[iParam0 /*31*/].f_19, Global_42618[iParam0 /*31*/].f_15, false, true, 0))
							{
								iLocal_67 = i;
								return true;
							}
						...
						{
							vehiclePedIsIn = PED::GET_VEHICLE_PED_IS_IN(ped, false);
							minimum = { func_43() };
							maximum = { func_43() };
							offsetFromEntityInWorldCoords = { func_43() };
							offsetFromEntityInWorldCoords2 = { func_43() };
							MISC::GET_MODEL_DIMENSIONS(ENTITY::GET_ENTITY_MODEL(vehiclePedIsIn), &minimum, &maximum);
							maximum = 0f;
							minimum = 0f;
							offsetFromEntityInWorldCoords = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(vehiclePedIsIn, maximum) };
							offsetFromEntityInWorldCoords2 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(vehiclePedIsIn, minimum) };
						
							if (OBJECT::IS_POINT_IN_ANGLED_AREA(offsetFromEntityInWorldCoords, Global_42618[iParam0 /*31*/].f_9, Global_42618[iParam0 /*31*/].f_12, Global_42618[iParam0 /*31*/].f_8, false, true))
							{
								iLocal_67 = i;
								return true;
							}
						
							if (OBJECT::IS_POINT_IN_ANGLED_AREA(offsetFromEntityInWorldCoords2, Global_42618[iParam0 /*31*/].f_9, Global_42618[iParam0 /*31*/].f_12, Global_42618[iParam0 /*31*/].f_8, false, true))
							{
								iLocal_67 = i;
								return true;
							}
							...
							if (IS_BIT_SET(Global_42618[iParam0 /*31*/].f_1, 0))
							{
								if (OBJECT::IS_POINT_IN_ANGLED_AREA(offsetFromEntityInWorldCoords, Global_42618[iParam0 /*31*/].f_16, Global_42618[iParam0 /*31*/].f_19, Global_42618[iParam0 /*31*/].f_15, false, true))
								{
									iLocal_67 = i;
									return true;
								}
							
								if (OBJECT::IS_POINT_IN_ANGLED_AREA(offsetFromEntityInWorldCoords2, Global_42618[iParam0 /*31*/].f_16, Global_42618[iParam0 /*31*/].f_19, Global_42618[iParam0 /*31*/].f_15, false, true))
								{
									iLocal_67 = i;
									return true;
								}
							...
							if (VEHICLE::IS_VEHICLE_ATTACHED_TO_TRAILER(vehiclePedIsIn))
							{
								trailer = 0;
							
								if (VEHICLE::GET_VEHICLE_TRAILER_VEHICLE(vehiclePedIsIn, &trailer))
								{
									if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(trailer, Global_42618[iParam0 /*31*/].f_9, Global_42618[iParam0 /*31*/].f_12, Global_42618[iParam0 /*31*/].f_8, false, true, 0))
									{
										iLocal_67 = i;
										return true;
									}
									...
									if (IS_BIT_SET(Global_42618[iParam0 /*31*/].f_1, 0))
									{
										if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(trailer, Global_42618[iParam0 /*31*/].f_16, Global_42618[iParam0 /*31*/].f_19, Global_42618[iParam0 /*31*/].f_15, false, true, 0))
										{
											iLocal_67 = i;
											return true;
										}
...
Vector3 func_43() // Position - 0x5B36 Hash - 0x7288DDF0 ^0x7288DDF0
{
	var unk;
...
void func_44(int iParam0, Ped pedParam1, BOOL bParam2) // Position - 0x5B42 Hash - 0xEF5292C5 ^0x2CEADA48
{
	int i;
	BOOL flag;
...
void func_45(int iParam0, BOOL bParam1) // Position - 0x5BFE Hash - 0xB3443939 ^0xF63DD105
{
	if (bParam1)
		MISC::SET_BIT(&(Global_42618[iParam0 /*31*/].f_1), 6);
	else
		MISC::CLEAR_BIT(&(Global_42618[iParam0 /*31*/].f_1), 6);

	return;
}

void func_46(int iParam0) // Position - 0x5C2A Hash - 0x7680DEC0 ^0xBD03A3AF
{
			...
			switch (iParam0)
			{
				case 13:
					if (PED::IS_PED_IN_ANY_POLICE_VEHICLE(PLAYER::PLAYER_PED_ID()))
						if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(Global_92160[78 /*34*/].f_6) == 0)
							if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), Global_42618[13 /*31*/].f_2, true) <= 100f)
								if (!func_57(13, PLAYER::PLAYER_PED_ID()))
									func_56(13, PLAYER::PLAYER_PED_ID());
							else if (func_57(13, PLAYER::PLAYER_PED_ID()))
								func_44(13, PLAYER::PLAYER_PED_ID(), false);
					else if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(Global_92160[78 /*34*/].f_6) == 0)
						if (func_57(13, PLAYER::PLAYER_PED_ID()))
							func_44(13, PLAYER::PLAYER_PED_ID(), false);
					break;
				...
				case 17:
				case 16:
					if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(Global_92160[9 /*34*/].f_6) == 0 && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("extreme2")) == 0)
					{
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), Global_42618[17 /*31*/].f_2, true) <= 100f)
						{
							switch (_GET_CURRENT_PLAYER_CHARACTER())
							{
								case CHAR_MICHAEL:
									if (func_49(12, 5))
									{
										if (!func_57(17, PLAYER::PLAYER_PED_ID()))
											func_56(17, PLAYER::PLAYER_PED_ID());
									
										if (!func_57(16, PLAYER::PLAYER_PED_ID()))
											func_56(16, PLAYER::PLAYER_PED_ID());
									}
									else
									{
										if (func_57(17, PLAYER::PLAYER_PED_ID()))
											func_44(17, PLAYER::PLAYER_PED_ID(), false);
									
										if (func_57(16, PLAYER::PLAYER_PED_ID()))
											func_44(16, PLAYER::PLAYER_PED_ID(), false);
									}
									break;
				...
				case 22:
					if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), Global_42618[22 /*31*/].f_2, true) <= 100f)
					{
						switch (_GET_CURRENT_PLAYER_CHARACTER())
						{
							case CHAR_MICHAEL:
								if (func_49(12, 5))
								{
									if (!func_57(22, PLAYER::PLAYER_PED_ID()))
										func_56(22, PLAYER::PLAYER_PED_ID());
								
									if (!func_57(23, PLAYER::PLAYER_PED_ID()))
										func_56(23, PLAYER::PLAYER_PED_ID());
								}
								else
								{
									if (func_57(22, PLAYER::PLAYER_PED_ID()))
										func_44(22, PLAYER::PLAYER_PED_ID(), false);
								
									if (func_57(23, PLAYER::PLAYER_PED_ID()))
										func_44(23, PLAYER::PLAYER_PED_ID(), false);
								}
								break;
				...
				case 14:
				case 15:
					if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(Global_92160[27 /*34*/].f_6) == 0)
					{
						if (func_57(14, PLAYER::PLAYER_PED_ID()))
							func_44(14, PLAYER::PLAYER_PED_ID(), false);
					
						if (func_57(15, PLAYER::PLAYER_PED_ID()))
							func_44(15, PLAYER::PLAYER_PED_ID(), false);
					}
					break;
			
				case 24:
					if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 480.4354f, -1317.9095f, 29.5957f) < 400f)
						if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(Global_92160[8 /*34*/].f_6) == 0 && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(Global_92160[10 /*34*/].f_6) == 0)
							if (func_57(24, PLAYER::PLAYER_PED_ID()))
								if (INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) != INTERIOR::GET_INTERIOR_AT_COORDS(480.4354f, -1317.9095f, 29.5957f) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 486.86005f, -1316.6035f, 27.719374f, 484.8906f, -1312.6472f, 31.723122f, 4.25f, false, true, 0))
									func_44(24, PLAYER::PLAYER_PED_ID(), false);
							else if (INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(480.4354f, -1317.9095f, 29.5957f, "v_chopshop"))
								func_56(24, PLAYER::PLAYER_PED_ID());
						else if (!func_57(24, PLAYER::PLAYER_PED_ID()))
							func_56(24, PLAYER::PLAYER_PED_ID());
					break;
			
				case 25:
				case 26:
					if (!func_57(25, PLAYER::PLAYER_PED_ID()))
						func_56(25, PLAYER::PLAYER_PED_ID());
				
					if (!func_57(26, PLAYER::PLAYER_PED_ID()))
						func_56(26, PLAYER::PLAYER_PED_ID());
					break;
			
				case 4:
					if (!func_57(4, PLAYER::PLAYER_PED_ID()))
					{
						switch (_GET_CURRENT_PLAYER_CHARACTER())
						{
							case CHAR_MICHAEL:
								if (SYSTEM::VDIST2(Global_42618[4 /*31*/].f_2, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false)) < 10000f)
									func_56(4, PLAYER::PLAYER_PED_ID());
								break;
						
							case CHAR_FRANKLIN:
								if (func_48(2))
									if (func_48(17))
										if (func_48(19) || func_47(19))
											if (SYSTEM::VDIST2(Global_42618[4 /*31*/].f_2, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false)) < 10000f)
												func_56(4, PLAYER::PLAYER_PED_ID());
									else if (SYSTEM::VDIST2(Global_42618[4 /*31*/].f_2, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false)) < 10000f)
										func_56(4, PLAYER::PLAYER_PED_ID());
								break;
...
BOOL func_47(int iParam0) // Position - 0x635F Hash - 0x3D43FEFC ^0x3D43FEFC
{
	int i;
...
BOOL func_48(int iParam0) // Position - 0x63C7 Hash - 0x35F9F9C ^0x35F9F9C
{
	if (iParam0 == 94 || iParam0 == -1)
		return false;
...
BOOL func_49(int iParam0, int iParam1) // Position - 0x63F3 Hash - 0x9EA0654 ^0x9EA0654
{
	if (iParam0 == -1)
		return false;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x6413 Hash - 0x3C5423D7 ^0x3C5423D7
{
	func_51();
	return Global_114370.f_2366.f_539.f_4321;
}

void func_51() // Position - 0x642C Hash - 0xD1F2D853 ^0xF9F5FD4D
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114370.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_52(character) && !func_82(14) || Global_113320)
			{
				if (Global_114370.f_2366.f_539.f_4321 != character && func_52(Global_114370.f_2366.f_539.f_4321))
...
BOOL func_52(eCharacter echParam0) // Position - 0x6529 Hash - 0x8907F004 ^0x8907F004
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x6535 Hash - 0xAC4E9801 ^0xB379A75F
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x6572 Hash - 0xADCB9755 ^0xADCB9755
{
...
Hash func_55(eCharacter echParam0) // Position - 0x6597 Hash - 0xE4CEEC2C ^0xE4CEEC2C
{
	return Global_2139[echParam0 /*29*/];
}

void func_56(int iParam0, Ped pedParam1) // Position - 0x65A6 Hash - 0x48BEDF86 ^0xD93CA775
{
	int i;
	Ped ped;
	BOOL flag;
...
BOOL func_57(int iParam0, Ped pedParam1) // Position - 0x6658 Hash - 0xFED9DEFF ^0xB17AF2BA
{
	int i;
...
void func_58() // Position - 0x6691 Hash - 0x5D0CAEDC ^0x91A475ED
{
	var unk;
	int i;
	...
	unk = 226;
	unk.f_228 = 8;
	func_81(&Global_40225, &unk);
	func_59(iLocal_60);

	for (i = 0; i < unk.f_227; i = i + 1)
	{
		if (unk[i] != iLocal_60)
			func_59(unk[i]);
	}
...
void func_59(int iParam0) // Position - 0x66F1 Hash - 0x46E66B49 ^0x46E66B49
{
	if (IS_BIT_SET(Global_39291[iParam0 / 32], iParam0 % 32) && Global_39754[iParam0] != 2 && !IS_BIT_SET(Global_39527[iParam0 / 32], iParam0 % 32))
	{
		Global_39300[iParam0] = Global_39300[iParam0] - 1;
	
		if (Global_39300[iParam0] <= 0)
		{
...
void func_60(int iParam0) // Position - 0x676F Hash - 0xE7EE45FB ^0x26036F0B
{
	Vector3 vector;
	BOOL flag;
	BOOL flag2;
	...
	vector = { func_80(iParam0) };

	if (IS_BIT_SET(vector.f_4, 2))
		func_66(iParam0, &vector);
...
void func_61(int iParam0) // Position - 0x6C34 Hash - 0xF9254656 ^0xECCFDFAF
{
...
BOOL func_62() // Position - 0x6C7F Hash - 0x70B4A54B ^0xF137E5FF
{
	if (PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
		return false;
...
int func_63(int iParam0) // Position - 0x6CFE Hash - 0x46546439 ^0x46546439
{
	eCharacter character;
...
BOOL func_64(int iParam0) // Position - 0x6F26 Hash - 0x5A075A23 ^0x27F6B86F
{
	Hash entityModel;
	...
	if (iParam0 == 40 || iParam0 == 49 || iParam0 == 52)
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				entityModel = ENTITY::GET_ENTITY_MODEL(func_65(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), true)));
...
Vehicle func_65(Vehicle veParam0) // Position - 0x6F92 Hash - 0xC9D82232 ^0xC9D82232
{
	return veParam0;
}

void func_66(int iParam0, var uParam1) // Position - 0x6F9C Hash - 0x45AE8BFD ^0xA0700457
{
	int num;
	int num2;
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_67(iParam0) && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(Global_92160[26 /*34*/].f_6) == 0)
			{
				Global_114370.f_7264[iParam0] = 1;
				OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(uParam1->f_5, Global_114370.f_7264[iParam0], true, true);
			}
...
BOOL func_67(int iParam0) // Position - 0x7934 Hash - 0xDEE87AD1 ^0x5F1ACD39
{
	var unk;
	int doorState;
...
int func_68(int iParam0) // Position - 0x7968 Hash - 0x626AEC54 ^0xDB28E416
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_69() // Position - 0x797B Hash - 0x9E44C35 ^0xB9993D58
{
	var unk;

	func_79(&unk, CLOCK::GET_CLOCK_SECONDS());
	func_78(&unk, CLOCK::GET_CLOCK_MINUTES());
	func_77(&unk, CLOCK::GET_CLOCK_HOURS());
	func_72(&unk, CLOCK::GET_CLOCK_DAY_OF_MONTH());
	func_71(&unk, CLOCK::GET_CLOCK_MONTH());
	func_70(&unk, CLOCK::GET_CLOCK_YEAR());
	return unk;
}

void func_70(var uParam0, int iParam1) // Position - 0x79C1 Hash - 0x15B9927E ^0x4A4674
{
	if (iParam1 <= 0)
		return;
...
void func_71(var uParam0, int iParam1) // Position - 0x7A47 Hash - 0x4C70B2C3 ^0x4C70B2C3
{
...
void func_72(var uParam0, int iParam1) // Position - 0x7A7A Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;

	num = func_76(*uParam0);
	num2 = func_74(*uParam0);
...
int func_73(int iParam0, int iParam1) // Position - 0x7ACB Hash - 0xD3EBACB3 ^0xD3EBACB3
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_74(int iParam0) // Position - 0x7B6D Hash - 0xE1B0542C ^0x127A471E
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_75(BOOL bParam0, var uParam1, var uParam2) // Position - 0x7B8F Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
int func_76(int iParam0) // Position - 0x7BA6 Hash - 0x2D4DB85F ^0x2D4DB85F
{
	return iParam0 & 15;
}

void func_77(var uParam0, int iParam1) // Position - 0x7BB3 Hash - 0x864304A8 ^0x1F5003E2
{
...
void func_78(var uParam0, int iParam1) // Position - 0x7BED Hash - 0x76860AE7 ^0x32308FFF
{
...
void func_79(var uParam0, int iParam1) // Position - 0x7C28 Hash - 0xDB8A72C0 ^0x4F6D426D
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
struct<7> func_80(int iParam0) // Position - 0x7C64 Hash - 0xA6A81C3E ^0x591CC9FB
{
	var unk;
...
void func_81(var uParam0, var uParam1) // Position - 0xA86F Hash - 0xA8541744 ^0xCF768C83
{
	*uParam1 = { *uParam0 };
...
BOOL func_82(int iParam0) // Position - 0xA89C Hash - 0x937D8816 ^0x937D8816
{
	return Global_43922 == iParam0;
}

BOOL func_83() // Position - 0xA8AA Hash - 0x6134FBB2 ^0x82030B41
{
	if (func_8() == -1 || func_8() == 999 && !(func_84() == 0))
		return true;

	return false;
}

int func_84() // Position - 0xA8DA Hash - 0x21D64237 ^0x21D64237
{
	return Global_32829;
}

void func_85() // Position - 0xA8E5 Hash - 0x90E3F508 ^0x257812A2
{
	int i;
	int j;
	int k;
	...
	if (!STREAMING::IS_NEW_LOAD_SCENE_ACTIVE())
	{
		for (i = 0; i < 10; i = i + 1)
		{
			if (!MISC::IS_STRING_NULL_OR_EMPTY(&Global_42536[i /*8*/]))
			{
				if (!STREAMING::IS_IPL_ACTIVE(&Global_42536[i /*8*/]))
					STREAMING::REQUEST_IPL(&Global_42536[i /*8*/]);
			
				TEXT_LABEL_ASSIGN_STRING(&Global_42536[i /*8*/], "", 32);
			}
		}
	}
	...
	for (k = 0; k < 2; k = k + 1)
	{
		...
		if (j < 198)
		{
			if (func_90(j))
			{
				if (j == 179 || j == 174 || j == 178 || j == 175 || j == 176 || j == 177)
				{
					func_90(179);
					func_90(174);
					func_90(178);
	...
	if (Global_41657)
	{
		...
		{
			func_89(&uLocal_80, j);
			func_88(&uLocal_80, j, Global_40860[j]);
			func_86(&uLocal_80, j, Global_40860[j]);
			Global_41857[j] = false;
		}
	...
	if (CAM::IS_SCREEN_FADED_OUT())
	{
		for (l = 0; l < 10; l = l + 1)
		{
			if (!MISC::IS_STRING_NULL_OR_EMPTY(&Global_42455[l /*8*/]))
			{
				if (STREAMING::IS_IPL_ACTIVE(&Global_42455[l /*8*/]))
					STREAMING::REMOVE_IPL(&Global_42455[l /*8*/]);
			
				TEXT_LABEL_ASSIGN_STRING(&Global_42455[l /*8*/], "", 32);
			}
		}
	}
...
void func_86(var uParam0, int iParam1, int iParam2) // Position - 0xAA92 Hash - 0xC2BC31E8 ^0x7DF779A9
{
	if (!func_87(uParam0->f_79, 0f, 0f, 0f, false))
	{
		if (iParam2 == 0)
		{
			if (Global_41658[iParam1])
			{
				PED::REMOVE_SCENARIO_BLOCKING_AREA(Global_42255[iParam1], false);
				Global_41658[iParam1] = false;
			}
		}
		else if (iParam2 == 1 || iParam2 == 2)
		{
			if (!Global_41658[iParam1])
			{
				Global_42255[iParam1] = PED::ADD_SCENARIO_BLOCKING_AREA(uParam0->f_79, uParam0->f_82, false, true, true, true, 1);
				Global_41658[iParam1] = true;
			}
		}
	}
...
BOOL func_87(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0xAB13 Hash - 0x2D46096D ^0xEA41378F
{
	if (bParam6)
...
void func_88(var uParam0, int iParam1, int iParam2) // Position - 0xAB5A Hash - 0xFF4484BA ^0x4B309F21
{
	if (!func_87(uParam0->f_58, 0f, 0f, 0f, false) && !func_87(uParam0->f_61, 0f, 0f, 0f, false))
	...
	if (!func_87(uParam0->f_68, 0f, 0f, 0f, false))
	{
		if (uParam0->f_75[iParam2])
		{
			if (!Global_41258[iParam1])
			{
				Global_41059[iParam1] = PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(uParam0->f_68, uParam0->f_71, uParam0->f_74, false, 7);
				Global_41258[iParam1] = true;
			}
		}
		else if (Global_41258[iParam1])
		{
			PATHFIND::REMOVE_NAVMESH_BLOCKING_OBJECT(Global_41059[iParam1]);
			Global_41258[iParam1] = false;
		}
	}

	if (!func_87(uParam0->f_85, 0f, 0f, 0f, false) && !func_87(uParam0->f_88, 0f, 0f, 0f, false))
...
int func_89(var uParam0, int iParam1) // Position - 0xAC7F Hash - 0x260A42E5 ^0x11A906B6
{
	int i;
...
BOOL func_90(int iParam0) // Position - 0xE373 Hash - 0x9765D1A7 ^0x9765D1A7
{
	BOOL flag;
	BOOL num;
	...
	if (Global_40661[iParam0] || !func_83() && !Global_41457[iParam0])
	{
		if (func_94(iParam0, false, 0, false))
		{
			num = 1;
			Global_1918312 = 0;
		}
	...
	if (Global_40860[iParam0] == 1)
	{
		func_89(&uLocal_80, iParam0);
		flag = true;
	
		if (uLocal_80.f_33)
			if (MISC::GET_HASH_KEY(&uLocal_80.f_8[2 /*8*/]) != MISC::GET_HASH_KEY(""))
				if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), uLocal_80, true) > 250f)
					func_91(iParam0, 2, 0, true, 0);
	}

	if (Global_42056[iParam0])
	{
		if (!flag)
		{
			func_89(&uLocal_80, iParam0);
		...
		func_88(&uLocal_80, iParam0, Global_40860[iParam0]);
		Global_42056[iParam0] = false;
	}

	if (Global_41857[iParam0])
	{
		if (!flag)
		{
			func_89(&uLocal_80, iParam0);
		...
		func_86(&uLocal_80, iParam0, Global_40860[iParam0]);
		Global_41857[iParam0] = false;
	}

	return num;
}

void func_91(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xE47B Hash - 0xECB6BFBA ^0x4A87976F
{
	if (iParam0 != 198)
	{
		if (Global_79248)
		...
		func_94(iParam0, bParam3, iParam4, false);
...
void func_92(int iParam0, int iParam1) // Position - 0xE4D3 Hash - 0xF488CE34 ^0x7519DF4D
{
	switch (iParam0)
	{
		case 12:
...
void func_93(int iParam0, BOOL bParam1) // Position - 0xE5BC Hash - 0xF0703301 ^0x756A9364
{
	if (bParam1)
...
BOOL func_94(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0xE5E5 Hash - 0x72F8706 ^0xBE0DD95D
{
	BOOL flag;
	int num;
	int num2;
...
void func_95() // Position - 0xEF1E Hash - 0xE152633F ^0xCCD68B7B
{
	int i;
	var unk;
	...
	if (Global_39281)
	{
		for (i = 0; i < 226; i = i + 1)
		{
			...
			if (OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(unk.f_5))
				OBJECT::REMOVE_DOOR_FROM_SYSTEM(unk.f_5, 0);
		}
		...
		for (i = 0; i < 27; i = i + 1)
		{
			if (OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(Global_42618[i /*31*/]))
				OBJECT::REMOVE_DOOR_FROM_SYSTEM(Global_42618[i /*31*/], 0);
		}
	}
...
void func_96() // Position - 0xEF91 Hash - 0x2D68AFAF ^0x861E20F9
{
	if (!bLocal_79 && IS_BIT_SET(Global_114370.f_9088.f_2[27 /*3*/], 2))
	{
		bLocal_79 = true;
		bLocal_78 = true;
	}
	...
	if (bLocal_78 && !STREAMING::IS_NEW_LOAD_SCENE_ACTIVE() || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() && STREAMING::GET_PLAYER_SWITCH_STATE() == 5)
	{
		...
		if (func_83())
		{
			func_98("prologue_DistantLights");
			func_98("prologue_LODLights");
		}
		else
		{
...
void func_97(BOOL bParam0) // Position - 0xF265 Hash - 0xACA0BD3B ^0xCD9FCCD1
{
	int i;
	int zoneFromNameId;

	if (!(bParam0 == Global_39259))
	{
		i = 0;
	
		for (i = 0; i < 263; i = i + 1)
		{
			MISC::SET_BIT(&(Global_33208[i /*23*/].f_11), 18);
		}
...
void func_98(char* sParam0) // Position - 0xF2C9 Hash - 0x5A9761BE ^0x6DD18E82
{
	int i;
	Hash hashKey;
	Hash hashKey2;
	...
	else
	{
		...
		for (i = 0; i < 10; i = i + 1)
		{
			hashKey2 = MISC::GET_HASH_KEY(&Global_42455[i /*8*/]);
		...
		if (!flag && num != -1)
			TEXT_LABEL_ASSIGN_STRING(&Global_42455[num /*8*/], sParam0, 32);
	}

	return;
}

void func_99() // Position - 0xF346 Hash - 0x860E71DB ^0xA1CD4677
{
	int i;
	int j;
	...
	else if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_8() != 2)
	{
		return;
	}
	...
	Global_40225.f_227 = 0;

	for (i = 0; i < 226; i = i + 1)
	{
		MISC::SET_BIT(&Global_39282[i / 32], i % 32);
		Global_39300[i] = 0;
		MISC::CLEAR_BIT(&Global_39291[i / 32], i % 32);
		Global_39754[i] = 0;
		Global_39981[i] = 1;
		MISC::SET_BIT(&Global_39527[i / 32], i % 32);
	}

	for (i = 0; i < 198; i = i + 1)
	{
		Global_40462[i] = false;
	
		if (Global_41258[i])
		{
			PATHFIND::REMOVE_NAVMESH_BLOCKING_OBJECT(Global_41059[i]);
			Global_41258[i] = false;
		}
	
		if (Global_41658[i])
		{
			PED::REMOVE_SCENARIO_BLOCKING_AREA(Global_42255[i], false);
			Global_41658[i] = false;
		}
	
		Global_41457[i] = false;
	}
	...
	if (func_83())
	{
		MISC::SET_BIT(&iLocal_59, 1);
		MISC::SET_BIT(&iLocal_59, 2);
	}
	else
	{
		MISC::SET_BIT(&iLocal_59, 0);
	}
	...
	for (j = 0; j < 10; j = j + 1)
	{
		TEXT_LABEL_ASSIGN_STRING(&Global_42536[j /*8*/], "", 32);
	}
...
void func_100() // Position - 0xF55D Hash - 0x58827BC7 ^0x765F382A
{
	...
	OBJECT::ADD_EXTENDED_PICKUP_PROBE_AREA(-8.5274f, 3327.2117f, 40.5878f, 40f);
	OBJECT::ADD_EXTENDED_PICKUP_PROBE_AREA(2086.27f, 1761.5515f, 102.98f, 40f);
	OBJECT::ADD_EXTENDED_PICKUP_PROBE_AREA(1874.689f, 284.791f, 159.961f, 40f);
	return;
}

void func_101() // Position - 0xF63D Hash - 0xCE5FB49E ^0xFFA8A5C
{
	OBJECT::CLEAR_EXTENDED_PICKUP_PROBE_AREAS();
	return;
}

void func_102(int iParam0) // Position - 0xF649 Hash - 0x33F14F42 ^0x33F14F42
{
	int i;
...
void func_103() // Position - 0xF68D Hash - 0x292C36A3 ^0x292C36A3
{
	int i;
...
BOOL func_104() // Position - 0xF92D Hash - 0x974E48B4 ^0x974E48B4
{
	return Global_2684312.f_691;
}

void func_105() // Position - 0xF93C Hash - 0xDC6E78D8 ^0x5F10379D
{
	func_92(12, Global_114370.f_7264.f_227[12]);
	func_92(65, Global_114370.f_7264.f_227[65]);
	func_92(6, Global_114370.f_7264.f_227[6]);
	func_92(174, Global_114370.f_7264.f_227[174]);
	func_92(37, Global_114370.f_7264.f_227[37]);
	return;
}

void func_106() // Position - 0xF99D Hash - 0xBA2DE1AC ^0x494AC3C
{
	int i;
	Vector3 vector;
...
void func_107() // Position - 0xF9E5 Hash - 0xF71AEACB ^0x1F2AF393
{
	int i;

	for (i = 0; i < 27; i = i + 1)
	{
		OBJECT::ADD_DOOR_TO_SYSTEM(Global_42618[i /*31*/], Global_42618[i /*31*/].f_5, Global_42618[i /*31*/].f_2, true, true, false);
		OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Global_42618[i /*31*/], 1, true, false);
		Global_42618[i /*31*/].f_22 = OBJECT::DOOR_SYSTEM_GET_OPEN_RATIO(Global_42618[i /*31*/]);
		MISC::CLEAR_BIT(&(Global_42618[i /*31*/].f_1), 2);
		MISC::CLEAR_BIT(&(Global_42618[i /*31*/].f_1), 3);
		MISC::CLEAR_BIT(&(Global_42618[i /*31*/].f_1), 5);
		MISC::CLEAR_BIT(&(Global_42618[i /*31*/].f_1), 6);
	}
...
void func_108() // Position - 0xFA7F Hash - 0xA4461D26 ^0x9D2AAA00
{
	int num;

	num = 4;
	Global_42618[num /*31*/] = -1735618852;
	Global_42618[num /*31*/].f_2 = { -844f, 156f, 66f };
	Global_42618[num /*31*/].f_5 = joaat("prop_lrggate_02_ld");
	Global_42618[num /*31*/].f_6 = 900f;
	Global_42618[num /*31*/].f_7 = 36f;
	Global_42618[num /*31*/].f_8 = 15f;
	Global_42618[num /*31*/].f_9 = { -851.81586f, 170.87428f, 61.302193f };
	Global_42618[num /*31*/].f_12 = { -851.57f, 148.1459f, 71.34533f };
	Global_42618[num /*31*/].f_15 = 15f;
	Global_42618[num /*31*/].f_16 = { -836.65967f, 175.33656f, 65.05977f };
	Global_42618[num /*31*/].f_19 = { -836.6878f, 152.78897f, 73.66382f };
	Global_42618[num /*31*/].f_23 = 0.25f;
	MISC::SET_BIT(&(Global_42618[num /*31*/].f_1), 0);
	MISC::SET_BIT(&(Global_42618[num /*31*/].f_1), 1);
	MISC::SET_BIT(&(Global_42618[num /*31*/].f_1), 3);
	MISC::SET_BIT(&(Global_42618[num /*31*/].f_1), 4);
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 7);
	num = 0;
	Global_42618[num /*31*/] = -303823323;
	Global_42618[num /*31*/].f_2 = { 19f, -2530f, 5f };
	Global_42618[num /*31*/].f_5 = joaat("prop_gate_docks_ld");
	Global_42618[num /*31*/].f_6 = 625f;
	Global_42618[num /*31*/].f_7 = 49f;
	Global_42618[num /*31*/].f_8 = 7.75f;
	Global_42618[num /*31*/].f_9 = { 15.188263f, -2531.2031f, 5.05037f };
	Global_42618[num /*31*/].f_12 = { 30.920921f, -2542.128f, 7.5043f };
	Global_42618[num /*31*/].f_23 = 0.55f;
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 0);
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 1);
	MISC::SET_BIT(&(Global_42618[num /*31*/].f_1), 3);
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 7);
	num = 1;
	Global_42618[num /*31*/] = -1110491335;
	Global_42618[num /*31*/].f_2 = { 11f, -2542f, 5f };
	Global_42618[num /*31*/].f_5 = joaat("prop_gate_docks_ld");
	Global_42618[num /*31*/].f_6 = 625f;
	Global_42618[num /*31*/].f_7 = 49f;
	Global_42618[num /*31*/].f_8 = 7.75f;
	Global_42618[num /*31*/].f_9 = { 13.802609f, -2540.9292f, 5.050376f };
	Global_42618[num /*31*/].f_12 = { -5.521768f, -2527.885f, 7.542066f };
	Global_42618[num /*31*/].f_23 = 0.55f;
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 0);
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 1);
	MISC::SET_BIT(&(Global_42618[num /*31*/].f_1), 3);
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 7);
	num = 2;
	Global_42618[num /*31*/] = 883531289;
	Global_42618[num /*31*/].f_2 = { -193f, -2515f, 5f };
	Global_42618[num /*31*/].f_5 = joaat("prop_gate_docks_ld");
	Global_42618[num /*31*/].f_6 = 625f;
	Global_42618[num /*31*/].f_7 = 49f;
	Global_42618[num /*31*/].f_8 = 12f;
	Global_42618[num /*31*/].f_9 = { -190.6964f, -2515.2878f, 4.678052f };
	Global_42618[num /*31*/].f_12 = { -190.7913f, -2536.6917f, 9.000118f };
	Global_42618[num /*31*/].f_23 = 0.55f;
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 0);
	MISC::SET_BIT(&(Global_42618[num /*31*/].f_1), 1);
	MISC::SET_BIT(&(Global_42618[num /*31*/].f_1), 3);
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 7);
	num = 3;
	Global_42618[num /*31*/] = -1464860354;
	Global_42618[num /*31*/].f_2 = { -203f, -2515f, 5f };
	Global_42618[num /*31*/].f_5 = joaat("prop_gate_docks_ld");
	Global_42618[num /*31*/].f_6 = 625f;
	Global_42618[num /*31*/].f_7 = 49f;
	Global_42618[num /*31*/].f_8 = 12f;
	Global_42618[num /*31*/].f_9 = { -200.20796f, -2515.3787f, 5.047561f };
	Global_42618[num /*31*/].f_12 = { -200.32407f, -2495.3093f, 7.891297f };
	Global_42618[num /*31*/].f_23 = 0.55f;
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 0);
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 1);
	MISC::SET_BIT(&(Global_42618[num /*31*/].f_1), 3);
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 7);
	num = 5;
	Global_42618[num /*31*/] = 1862541262;
	Global_42618[num /*31*/].f_2 = { 476f, -3116f, 5f };
	Global_42618[num /*31*/].f_5 = joaat("prop_gate_docks_ld");
	Global_42618[num /*31*/].f_6 = 900f;
	Global_42618[num /*31*/].f_7 = 49f;
	Global_42618[num /*31*/].f_8 = 40f;
	Global_42618[num /*31*/].f_9 = { 484.58102f, -3115.5476f, 4.652226f };
	Global_42618[num /*31*/].f_12 = { 473.63788f, -3116.0505f, 11.070095f };
	Global_42618[num /*31*/].f_23 = 0.55f;
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 0);
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 1);
	MISC::SET_BIT(&(Global_42618[num /*31*/].f_1), 3);
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 7);
	num = 6;
	Global_42618[num /*31*/] = 747815589;
	Global_42618[num /*31*/].f_2 = { 492f, -3116f, 5f };
	Global_42618[num /*31*/].f_5 = joaat("prop_gate_docks_ld");
	Global_42618[num /*31*/].f_6 = 900f;
	Global_42618[num /*31*/].f_7 = 49f;
	Global_42618[num /*31*/].f_8 = 40f;
	Global_42618[num /*31*/].f_9 = { 484.0876f, -3115.8008f, 4.652227f };
	Global_42618[num /*31*/].f_12 = { 494.8903f, -3115.7874f, 11.068663f };
	Global_42618[num /*31*/].f_23 = 0.55f;
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 0);
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 1);
	MISC::SET_BIT(&(Global_42618[num /*31*/].f_1), 3);
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 7);
	num = 7;
	Global_42618[num /*31*/] = 616346630;
	Global_42618[num /*31*/].f_2 = { 1600f, -2806f, 16f };
	Global_42618[num /*31*/].f_5 = joaat("prop_gate_military_01");
	Global_42618[num /*31*/].f_6 = 900f;
	Global_42618[num /*31*/].f_7 = 25f;
	Global_42618[num /*31*/].f_8 = 40f;
	Global_42618[num /*31*/].f_9 = { -1599.609f, 2805.8953f, 15.67009f };
	Global_42618[num /*31*/].f_12 = { -1593.8154f, 2811.3923f, 22.024572f };
	Global_42618[num /*31*/].f_23 = 0.55f;
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 0);
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 1);
	MISC::SET_BIT(&(Global_42618[num /*31*/].f_1), 3);
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 7);
	num = 8;
	Global_42618[num /*31*/] = 447317969;
	Global_42618[num /*31*/].f_2 = { 1605f, -2801f, 16f };
	Global_42618[num /*31*/].f_5 = joaat("prop_gate_military_01");
	Global_42618[num /*31*/].f_6 = 900f;
	Global_42618[num /*31*/].f_7 = 25f;
	Global_42618[num /*31*/].f_8 = 40f;
	Global_42618[num /*31*/].f_9 = { -1599.609f, 2805.8953f, 15.67009f };
	Global_42618[num /*31*/].f_12 = { -1605.8582f, 2800.5408f, 22.508896f };
	Global_42618[num /*31*/].f_23 = 0.55f;
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 0);
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 1);
	MISC::SET_BIT(&(Global_42618[num /*31*/].f_1), 3);
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 7);
	num = 9;
	Global_42618[num /*31*/] = -367370493;
	Global_42618[num /*31*/].f_2 = { -1041f, 4906f, 209f };
	Global_42618[num /*31*/].f_5 = joaat("prop_gate_cult_01_l");
	Global_42618[num /*31*/].f_6 = 900f;
	Global_42618[num /*31*/].f_7 = 25f;
	Global_42618[num /*31*/].f_8 = 40f;
	Global_42618[num /*31*/].f_9 = { -1050.4371f, 4909.1963f, 200f };
	Global_42618[num /*31*/].f_12 = { -1027.9218f, 4921.7476f, 215f };
	Global_42618[num /*31*/].f_23 = 0.55f;
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 0);
	MISC::SET_BIT(&(Global_42618[num /*31*/].f_1), 1);
	MISC::SET_BIT(&(Global_42618[num /*31*/].f_1), 3);
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 7);
	num = 10;
	Global_42618[num /*31*/] = -1402957286;
	Global_42618[num /*31*/].f_2 = { -1045f, 4915f, 209f };
	Global_42618[num /*31*/].f_5 = joaat("prop_gate_cult_01_r");
	Global_42618[num /*31*/].f_6 = 900f;
	Global_42618[num /*31*/].f_7 = 36f;
	Global_42618[num /*31*/].f_8 = 40f;
	Global_42618[num /*31*/].f_9 = { -1050.4371f, 4909.1963f, 200f };
	...
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 7);
	num = 11;
	Global_42618[num /*31*/] = -170964766;
	Global_42618[num /*31*/].f_2 = { 523.982f, 167.7104f, 100.5962f };
	Global_42618[num /*31*/].f_5 = joaat("prop_hw1_03_gardoor_01");
	Global_42618[num /*31*/].f_6 = 625f;
	Global_42618[num /*31*/].f_7 = 9f;
	Global_42618[num /*31*/].f_8 = 21.75f;
	Global_42618[num /*31*/].f_9 = { 520.24365f, 164.89319f, 98.044174f };
	Global_42618[num /*31*/].f_12 = { 523.08f, 172.69986f, 102.782425f };
	Global_42618[num /*31*/].f_23 = 0.55f;
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 0);
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 1);
	MISC::SET_BIT(&(Global_42618[num /*31*/].f_1), 3);
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 7);
	num = 12;
	Global_42618[num /*31*/] = -1247364148;
	Global_42618[num /*31*/].f_2 = { 18.6504f, 546.3401f, 176.3448f };
	Global_42618[num /*31*/].f_5 = joaat("prop_ch_025c_g_door_01");
	Global_42618[num /*31*/].f_6 = 324f;
	Global_42618[num /*31*/].f_7 = 9f;
	Global_42618[num /*31*/].f_8 = 14.75f;
	Global_42618[num /*31*/].f_9 = { 19.32684f, 550.176f, 174.00014f };
	Global_42618[num /*31*/].f_12 = { 15.769264f, 543.8351f, 178.02298f };
	Global_42618[num /*31*/].f_23 = 0.55f;
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 0);
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 1);
	MISC::SET_BIT(&(Global_42618[num /*31*/].f_1), 3);
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 7);
	num = 13;
	Global_42618[num /*31*/] = 213039352;
	Global_42618[num /*31*/].f_2 = { 397.83f, -1607.34f, 28.34f };
	Global_42618[num /*31*/].f_5 = joaat("prop_facgate_07b");
	Global_42618[num /*31*/].f_6 = 324f;
	Global_42618[num /*31*/].f_7 = 9f;
	Global_42618[num /*31*/].f_8 = 14.5f;
	Global_42618[num /*31*/].f_9 = { 405.36505f, -1612.8865f, 27.522816f };
	Global_42618[num /*31*/].f_12 = { 396.68396f, -1605.7609f, 32.76698f };
	Global_42618[num /*31*/].f_23 = 0.55f;
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 0);
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 1);
	MISC::SET_BIT(&(Global_42618[num /*31*/].f_1), 3);
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 7);
	num = 14;
	Global_42618[num /*31*/] = -166321961;
	Global_42618[num /*31*/].f_2 = { -2559.19f, 1910.86f, 169.07f };
	Global_42618[num /*31*/].f_5 = joaat("prop_lrggate_01c_l");
	Global_42618[num /*31*/].f_6 = 324f;
	Global_42618[num /*31*/].f_7 = 9f;
	Global_42618[num /*31*/].f_8 = 13f;
	Global_42618[num /*31*/].f_9 = { -2551.3604f, 1909.9075f, 166.4336f };
	Global_42618[num /*31*/].f_12 = { -2572.051f, 1924.1799f, 171.39471f };
	Global_42618[num /*31*/].f_23 = 0.55f;
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 0);
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 1);
	MISC::SET_BIT(&(Global_42618[num /*31*/].f_1), 3);
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 7);
	num = 15;
	Global_42618[num /*31*/] = -2036678178;
	Global_42618[num /*31*/].f_2 = { -2556.66f, 1915.72f, 169.07f };
	Global_42618[num /*31*/].f_5 = joaat("prop_lrggate_01c_r");
	Global_42618[num /*31*/].f_6 = 324f;
	Global_42618[num /*31*/].f_7 = 9f;
	Global_42618[num /*31*/].f_8 = 13f;
	Global_42618[num /*31*/].f_9 = { -2551.3604f, 1909.9075f, 166.4336f };
	...
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 7);
	num = 16;
	Global_42618[num /*31*/] = -599111730;
	Global_42618[num /*31*/].f_2 = { -961.23f, -2796.28f, 13.96f };
	Global_42618[num /*31*/].f_5 = joaat("prop_sec_barrier_ld_01a");
	Global_42618[num /*31*/].f_6 = 324f;
	Global_42618[num /*31*/].f_7 = 9f;
	Global_42618[num /*31*/].f_8 = 7f;
	Global_42618[num /*31*/].f_9 = { -958.54016f, -2798.2808f, 12.714785f };
	Global_42618[num /*31*/].f_12 = { -964.4572f, -2808.5933f, 17.714787f };
	Global_42618[num /*31*/].f_23 = 0.55f;
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 0);
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 1);
	MISC::SET_BIT(&(Global_42618[num /*31*/].f_1), 3);
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 7);
	num = 17;
	Global_42618[num /*31*/] = -804938986;
	Global_42618[num /*31*/].f_2 = { -967.01f, -2802.45f, 13.96f };
	Global_42618[num /*31*/].f_5 = joaat("prop_sec_barrier_ld_01a");
	Global_42618[num /*31*/].f_6 = 324f;
	Global_42618[num /*31*/].f_7 = 9f;
	Global_42618[num /*31*/].f_8 = 6.5f;
	Global_42618[num /*31*/].f_9 = { -970.272f, -2800.3525f, 12.714786f };
	Global_42618[num /*31*/].f_12 = { -965.00525f, -2791.1013f, 17.714787f };
	Global_42618[num /*31*/].f_23 = 0.55f;
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 0);
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 1);
	MISC::SET_BIT(&(Global_42618[num /*31*/].f_1), 3);
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 7);
	num = 18;
	Global_42618[num /*31*/] = 935592315;
	Global_42618[num /*31*/].f_2 = { 431.41f, -1000.16f, 28.65f };
	Global_42618[num /*31*/].f_5 = joaat("prop_com_gar_door_01");
	Global_42618[num /*31*/].f_6 = 324f;
	Global_42618[num /*31*/].f_7 = 9f;
	Global_42618[num /*31*/].f_8 = 11f;
	Global_42618[num /*31*/].f_9 = { 433.78268f, -1001.4897f, 23.797237f };
	Global_42618[num /*31*/].f_12 = { 433.88623f, -1017.2217f, 29.593578f };
	Global_42618[num /*31*/].f_23 = 0.55f;
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 0);
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 1);
	MISC::SET_BIT(&(Global_42618[num /*31*/].f_1), 3);
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 7);
	num = 19;
	Global_42618[num /*31*/] = 179480401;
	Global_42618[num /*31*/].f_2 = { 436.22f, -1001.17f, 26.71f };
	Global_42618[num /*31*/].f_5 = joaat("prop_com_gar_door_01");
	Global_42618[num /*31*/].f_6 = 324f;
	Global_42618[num /*31*/].f_7 = 9f;
	Global_42618[num /*31*/].f_8 = 11f;
	...
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 7);
	num = 20;
	Global_42618[num /*31*/] = -2128682856;
	Global_42618[num /*31*/].f_2 = { -1588.27f, 2794.21f, 16.85f };
	Global_42618[num /*31*/].f_5 = joaat("prop_sec_barrier_ld_01a");
	Global_42618[num /*31*/].f_6 = 324f;
	Global_42618[num /*31*/].f_7 = 9f;
	Global_42618[num /*31*/].f_8 = 6.75f;
	Global_42618[num /*31*/].f_9 = { -1585.3486f, 2796.7646f, 15.333453f };
	Global_42618[num /*31*/].f_12 = { -1573.8737f, 2783.339f, 20.003242f };
	Global_42618[num /*31*/].f_23 = 0.55f;
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 0);
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 1);
	MISC::SET_BIT(&(Global_42618[num /*31*/].f_1), 3);
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 7);
	num = 21;
	Global_42618[num /*31*/] = 313531445;
	Global_42618[num /*31*/].f_2 = { -1589.58f, 2793.67f, 16.86f };
	Global_42618[num /*31*/].f_5 = joaat("prop_sec_barrier_ld_01a");
	Global_42618[num /*31*/].f_6 = 324f;
	Global_42618[num /*31*/].f_7 = 9f;
	Global_42618[num /*31*/].f_8 = 6.75f;
	Global_42618[num /*31*/].f_9 = { -1592.5518f, 2791.0398f, 15.326007f };
	Global_42618[num /*31*/].f_12 = { -1604.54f, 2805.5576f, 20.174604f };
	Global_42618[num /*31*/].f_23 = 0.55f;
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 0);
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 1);
	MISC::SET_BIT(&(Global_42618[num /*31*/].f_1), 3);
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 7);
	num = 22;
	Global_42618[num /*31*/] = -1298870201;
	Global_42618[num /*31*/].f_2 = { -984.08f, -2348.4f, 12.94f };
	Global_42618[num /*31*/].f_5 = joaat("prop_facgate_01");
	Global_42618[num /*31*/].f_6 = 324f;
	Global_42618[num /*31*/].f_7 = 9f;
	Global_42618[num /*31*/].f_8 = 15.25f;
	Global_42618[num /*31*/].f_9 = { -979.2388f, -2341.411f, 11.924736f };
	Global_42618[num /*31*/].f_12 = { -993.52515f, -2333.147f, 20.424732f };
	Global_42618[num /*31*/].f_15 = 15.25f;
	Global_42618[num /*31*/].f_16 = { -984.4644f, -2357.3196f, 11.924736f };
	Global_42618[num /*31*/].f_19 = { -1002.4512f, -2346.9883f, 20.444717f };
	Global_42618[num /*31*/].f_23 = 0.55f;
	MISC::SET_BIT(&(Global_42618[num /*31*/].f_1), 0);
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 1);
	MISC::SET_BIT(&(Global_42618[num /*31*/].f_1), 3);
	MISC::SET_BIT(&(Global_42618[num /*31*/].f_1), 7);
	num = 23;
	Global_42618[num /*31*/] = 65926040;
	Global_42618[num /*31*/].f_2 = { -994.5f, -2341.65f, 12.94f };
	Global_42618[num /*31*/].f_5 = joaat("prop_facgate_01");
	Global_42618[num /*31*/].f_6 = 324f;
	Global_42618[num /*31*/].f_7 = 9f;
	Global_42618[num /*31*/].f_8 = 15.25f;
	...
	MISC::SET_BIT(&(Global_42618[num /*31*/].f_1), 7);
	num = 24;
	Global_42618[num /*31*/] = 1061779107;
	Global_42618[num /*31*/].f_2 = { 484.56f, -1315.57f, 30.2f };
	Global_42618[num /*31*/].f_5 = joaat("prop_com_gar_door_01");
	Global_42618[num /*31*/].f_6 = 324f;
	Global_42618[num /*31*/].f_7 = 9f;
	Global_42618[num /*31*/].f_8 = 6.5f;
	Global_42618[num /*31*/].f_9 = { 486.4057f, -1311.6654f, 27.751633f };
	Global_42618[num /*31*/].f_12 = { 488.91235f, -1316.529f, 31.652016f };
	Global_42618[num /*31*/].f_15 = 8.5f;
	Global_42618[num /*31*/].f_16 = { 482.3187f, -1319.8066f, 26.918484f };
	Global_42618[num /*31*/].f_19 = { 478.04105f, -1311.5107f, 31.95297f };
	Global_42618[num /*31*/].f_23 = 0.55f;
	MISC::SET_BIT(&(Global_42618[num /*31*/].f_1), 0);
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 1);
	MISC::SET_BIT(&(Global_42618[num /*31*/].f_1), 3);
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 7);
	num = 25;
	Global_42618[num /*31*/] = 1423193534;
	Global_42618[num /*31*/].f_2 = { 451.81f, -1994.17f, 22.14f };
	Global_42618[num /*31*/].f_5 = joaat("prop_facgate_01");
	Global_42618[num /*31*/].f_6 = 324f;
	Global_42618[num /*31*/].f_7 = 9f;
	Global_42618[num /*31*/].f_8 = 10f;
	Global_42618[num /*31*/].f_9 = { 444.06693f, -1993.7362f, 21.10992f };
	Global_42618[num /*31*/].f_12 = { 459.42303f, -2010.0255f, 26.195147f };
	Global_42618[num /*31*/].f_15 = 10f;
	Global_42618[num /*31*/].f_16 = { 452.25137f, -1987.2552f, 21.18945f };
	Global_42618[num /*31*/].f_19 = { 466.8117f, -2002.8776f, 25.8988f };
	Global_42618[num /*31*/].f_23 = 0.3f;
	MISC::SET_BIT(&(Global_42618[num /*31*/].f_1), 0);
	MISC::CLEAR_BIT(&(Global_42618[num /*31*/].f_1), 1);
	MISC::SET_BIT(&(Global_42618[num /*31*/].f_1), 3);
	MISC::SET_BIT(&(Global_42618[num /*31*/].f_1), 7);
	num = 26;
	Global_42618[num /*31*/] = -1958174046;
	Global_42618[num /*31*/].f_2 = { 460.06f, -2003.11f, 22.14f };
	Global_42618[num /*31*/].f_5 = joaat("prop_facgate_01b");
	Global_42618[num /*31*/].f_6 = 324f;
	Global_42618[num /*31*/].f_7 = 9f;
	Global_42618[num /*31*/].f_8 = 10f;
	Global_42618[num /*31*/].f_9 = { 444.06693f, -1993.7362f, 21.10992f };
...
void func_109() // Position - 0x11332 Hash - 0x9F188580 ^0x87049572
{
	int i;
	...
	{
		if (func_83())
			Global_114370.f_7264.f_227[i] = 0;
		else
			Global_43456.f_227[i] = 0;
	...
	if (func_83())
	{
		Global_114370.f_7264.f_227[185] = 1;
		Global_114370.f_7264.f_227[187] = 1;
		Global_114370.f_7264.f_227[186] = 1;
		Global_114370.f_7264.f_227[86] = 1;
		Global_114370.f_7264[106] = 0;
		Global_114370.f_7264[64] = 0;
		Global_114370.f_7264[65] = 0;
		Global_114370.f_7264[66] = 0;
		Global_114370.f_7264[164] = 0;
		Global_114370.f_7264.f_426 = 1;
	}
	else
	{
		Global_43456.f_227[62] = 1;
		Global_43456.f_227[179] = 1;
		Global_43456.f_227[14] = 1;
		Global_43456.f_227[86] = 1;
		Global_43456.f_227[173] = 1;
		Global_43456.f_227[76] = 1;
		Global_43456.f_227[94] = 1;
		Global_43456.f_227[70] = 1;
		Global_43456.f_227[71] = 1;
		Global_43456.f_227[73] = 1;
		Global_43456.f_227[72] = 0;
		Global_43456.f_227[74] = 0;
		Global_43456.f_426 = 1;
	}

	Global_114370.f_7264.f_227[76] = 1;
	Global_114370.f_7264.f_227[94] = 1;
	return;
}

BOOL func_110() // Position - 0x11522 Hash - 0xCBCC7961 ^0xCBCC7961
{
	if (func_83())
		return Global_114370.f_7264.f_426;

	return Global_43456.f_426;
}

void func_111() // Position - 0x11547 Hash - 0x9473D616 ^0x7C6BFD83
{
	Interior interiorAtCoordsWithType;

	interiorAtCoordsWithType = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(1200f, -3250f, -50f, "M23_1_dlc_int_02_M23_1");

	if (interiorAtCoordsWithType != 0)
	{
		if (INTERIOR::IS_INTERIOR_DISABLED(interiorAtCoordsWithType))
		{
		}
		else
		{
			INTERIOR::DISABLE_INTERIOR(interiorAtCoordsWithType, true);
		}
	}

	interiorAtCoordsWithType = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(1000f, -2274f, -50f, "m23_2_dlc_int_garage");
...
void func_112(BOOL bParam0) // Position - 0x115B3 Hash - 0x26D50F6E ^0x741BDACD
{
	func_113("MPINT_MISC_DOOR", joaat("prop_sc1_12_door"), -58.47f, -1530.51f, 34.54f, bParam0);
	func_113("MPINT_HIGHEND1_DOOR_L", joaat("prop_ss1_mpint_door_l"), -778.36f, 313.54f, 86.14f, bParam0);
	func_113("MPINT_HIGHEND1_DOOR_R", joaat("prop_ss1_mpint_door_r"), -776.2f, 313.54f, 86.14f, bParam0);
	func_113("MPINT_HIGHEND1_DOOR_GARAGE", joaat("prop_ss1_mpint_garage"), -796.08f, 313.78f, 86.68f, bParam0);
	func_113("MPINT_HIGHEND5_DOOR_L", joaat("prop_dt1_20_mp_door_l"), -263.46f, -970.52f, 31.61f, bParam0);
	func_113("MPINT_HIGHEND5_DOOR_R", joaat("prop_dt1_20_mp_door_r"), -260.66f, -969.21f, 31.61f, bParam0);
	func_113("MPINT_HIGHEND5_DOOR_GARAGE", joaat("prop_dt1_20_mp_gar"), -282.55f, -995.16f, 24.67f, bParam0);
	func_113("MPINT_HIGHEND7_DOOR_L", joaat("sm_14_mp_door_l"), -1444.28f, -545.01f, 34.98f, bParam0);
	func_113("MPINT_HIGHEND7_DOOR_R", joaat("sm_14_mp_door_r"), -1442.3f, -543.63f, 34.98f, bParam0);
	func_113("MPINT_HIGHEND7_DOOR_GARAGE", joaat("prop_sm_14_mp_gar"), -1455.81f, -503.98f, 32.29f, bParam0);
	func_113("MPINT_HIGHEND9_DOOR_L", joaat("prop_bh1_09_mp_l"), -914.06f, -453.65f, 39.81f, bParam0);
	func_113("MPINT_HIGHEND9_DOOR_R", joaat("prop_bh1_09_mp_r"), -912.91f, -455.89f, 39.81f, bParam0);
	func_113("MPINT_HIGHEND9_DOOR_GARAGE", joaat("prop_bh1_09_mp_gar"), -820.57f, -436.81f, 37.44f, bParam0);
	func_113("MPINT_HIGHEND12_DOOR_L", joaat("dt1_03_mp_door"), -47.84f, -588.77f, 38.36f, bParam0);
	func_113("MPINT_HIGHEND12_DOOR_GARAGE", joaat("prop_com_gar_door_01"), -33.79f, -621.62f, 36.11f, bParam0);
	func_113("MPINT_HIGHEND14_DOOR_GARAGE", joaat("prop_bh1_08_mp_gar"), -878.02f, -359.46f, 36.27f, bParam0);
	func_113("MPINT_HIGHEND16_DOOR_L", joaat("prop_ss1_mpint_door_l"), -615.8f, 38.37f, 44.04f, bParam0);
	func_113("MPINT_HIGHEND16_DOOR_R", joaat("prop_ss1_mpint_door_r"), -613.64f, 38.37f, 44.04f, bParam0);
	func_113("MPINT_HIGHEND16_DOOR_GARAGE", joaat("prop_ss1_mpint_garage"), -629.91f, 56.57f, 44.72f, bParam0);
	func_113("MPINT_LOWEND1_DOOR", joaat("p_cut_door_01"), -40.19f, -58.21f, 64.21f, bParam0);
	func_113("MPINT_LOWEND2_DOOR", joaat("p_cut_door_03"), -200.29f, 185.6f, 80.66f, bParam0);
	func_113("MPINT_LOWEND3_DOOR_L", joaat("prop_kt1_10_mpdoor_l"), -812.83f, -979.01f, 14.6f, bParam0);
	func_113("MPINT_LOWEND3_DOOR_R", joaat("prop_kt1_10_mpdoor_r"), -811.25f, -981.27f, 14.61f, bParam0);
	func_113("MPINT_LOWEND4_DOOR", joaat("kt1_11_mp_door"), -661.87f, -854.63f, 24.69f, bParam0);
	func_113("MPINT_LOWEND5_DOOR", joaat("prop_sm_10_mp_door"), -1533.58f, -327.59f, 48.09f, bParam0);
	func_113("MPINT_LOWEND6_DOOR_L", joaat("prop_sm1_11_doorr"), -1565.58f, -406.92f, 42.61f, bParam0);
	func_113("MPINT_LOWEND6_DOOR_R", joaat("prop_sm1_11_doorl"), -1564.01f, -405.04f, 42.61f, bParam0);
	func_113("MP_APARTMENT_DOOR_01", joaat("prop_sm1_11_doorr"), -1605.0138f, -431.9617f, 40.6384f, bParam0);
	func_113("MPINT_LOWEND7_DOOR_GARAGE", joaat("prop_sm1_11_garaged"), -1605.26f, -447.18f, 38.58f, bParam0);
	func_113("MPINT_MIDEND1_DOOR_L", joaat("prop_bh1_44_door_01l"), 286.91f, -159.22f, 64.84f, bParam0);
	func_113("MPINT_MIDEND1_DOOR_R", joaat("prop_bh1_44_door_01r"), 285.94f, -161.88f, 64.84f, bParam0);
	func_113("MPINT_MIDEND2_DOOR", joaat("prop_bh1_44_door_01r"), 4.4f, 37.32f, 71.75f, bParam0);
	func_113("MPINT_MIDEND3_DOOR", joaat("prop_bh1_44_door_01r"), 8.74f, 81.31f, 78.65f, bParam0);
	func_113("MPINT_MIDEND4_DOOR_L", joaat("prop_sm1_11_doorl"), -510.42f, 108f, 64.02f, bParam0);
	func_113("MPINT_MIDEND4_DOOR_R", joaat("prop_sm1_11_doorr"), -512.84f, 107.66f, 64.02f, bParam0);
	func_113("MPINT_MIDEND5_DOOR", joaat("prop_ss1_05_mp_door"), -197.23f, 85.16f, 69.9f, bParam0);
	func_113("MPINT_MIDEND6_DOOR_L", joaat("prop_ss1_08_mp_door_l"), -627.34f, 170.87f, 61.29f, bParam0);
	func_113("MPINT_MIDEND6_DOOR_R", joaat("prop_ss1_08_mp_door_r"), -627.34f, 168.53f, 61.29f, bParam0);
	func_113("MPINT_MIDEND7_DOOR_L", joaat("vb_43_door_l_mp"), -969.36f, -1429.98f, 7.97f, bParam0);
	func_113("MPINT_MIDEND7_DOOR_R", joaat("vb_43_door_r_mp"), -968.6f, -1432.04f, 6.77f, bParam0);
	func_113("MPINT_MIDEND8_DOOR_L", joaat("prop_kt1_10_mpdoor_r"), -830.05f, -862.99f, 21.09f, bParam0);
	func_113("MPINT_MIDEND8_DOOR_R", joaat("prop_kt1_10_mpdoor_l"), -832.81f, -862.99f, 21.09f, bParam0);
	func_113("MPINT_MIDEND9_DOOR_L", joaat("prop_kt1_06_door_l"), -763.9f, -755.08f, 28.19f, bParam0);
	func_113("MPINT_MIDEND9_DOOR_R", joaat("prop_kt1_06_door_r"), -763.9f, -752.49f, 28.19f, bParam0);
	return;
}

void func_113(char* sParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, BOOL bParam5) // Position - 0x11AE3 Hash - 0x8A1FEF5A ^0x4C5F9A4A
{
	Hash hashKey;
	...
	if (bParam5)
	{
		if (!OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(hashKey))
			OBJECT::ADD_DOOR_TO_SYSTEM(hashKey, hParam1, fParam2, false, false, false);
	
		OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(hashKey, 1, false, true);
	}
	else if (OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(hashKey))
	{
		OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(hashKey, 0, false, true);
		OBJECT::REMOVE_DOOR_FROM_SYSTEM(hashKey, 0);
	}

	return;
}

BOOL func_114() // Position - 0x11B36 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1575044;
}

void func_115() // Position - 0x11B42 Hash - 0x2B658381 ^0x55570EC5
{
	if (func_83())
	{
		if (!Global_114370.f_7264.f_426 || IS_BIT_SET(iLocal_59, 0) || NETWORK::NETWORK_IS_GAME_IN_PROGRESS() || Global_39280)
		{
			if (!Global_2697663)
			{
				if (IS_BIT_SET(iLocal_59, 0) || Global_39280)
					bLocal_175 = true;
	...
	else if (!Global_43456.f_426 || IS_BIT_SET(iLocal_59, 1) || !NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !func_104() && !func_116() || Global_39280)
	{
		if (func_8() == 2)
			if (IS_BIT_SET(iLocal_59, 2))
				iLocal_77 = 0;
		else
			iLocal_77 = 0;
	
		if (IS_BIT_SET(iLocal_59, 1))
			bLocal_175 = true;
	}
...
BOOL func_116() // Position - 0x11BFB Hash - 0x41025EF1 ^0x41025EF1
{
	if (func_120() || func_119() || func_104() || func_118() || func_117())
		return true;

	return false;
}

BOOL func_117() // Position - 0x11C37 Hash - 0x974E48B4 ^0x974E48B4
{
	return Global_2684312.f_843;
}

BOOL func_118() // Position - 0x11C46 Hash - 0x974E48B4 ^0x974E48B4
{
	return Global_2684312.f_693;
}

BOOL func_119() // Position - 0x11C55 Hash - 0x974E48B4 ^0x974E48B4
{
	return Global_2684312.f_706;
}

BOOL func_120() // Position - 0x11C64 Hash - 0x14C33082 ^0x14C33082
{
	return IS_BIT_SET(Global_2684312, 21);
}

BOOL func_121() // Position - 0x11C73 Hash - 0x9FFBCA6 ^0x9FFBCA6
{
