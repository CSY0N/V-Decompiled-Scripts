		...
		while (num2 != 2)
		{
			if (func_13(&Global_33169[num /*7*/]))
			{
				if (func_12(num, entityCoords))
				{
					...
					{
						if (SCRIPT::IS_THREAD_ACTIVE(Global_33169[num /*7*/].f_5))
							PLAYER::FORCE_CLEANUP_FOR_THREAD_WITH_THIS_ID(Global_33169[num /*7*/].f_5, 1);
			...
			{
				if (func_5(&Global_33169[num /*7*/], entityCoords))
					func_1(num);
			}
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0x328 Hash - 0xECB6C71B ^0xECB6C71B
{
...
BOOL func_12(int iParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0x553 Hash - 0x1C33B09 ^0x6484329E
{
	...
	if (!SCRIPT::IS_THREAD_ACTIVE(Global_33169[iParam0 /*7*/].f_5))
		return true;
