...
void main() // Position - 0x0 Hash - 0x5D84F89F ^0x5D84F89F
{
	...
	fLocal_30 = 180f;
	iLocal_33 = 3;
	iLocal_78 = func_445(CHAR_MARNIE);
	iLocal_79 = func_445(14);
	uLocal_142 = { 1813.2936f, 4698.785f, 38.9553f };
	uLocal_145 = { 1827.1781f, 4698.114f, 38.1653f };
	fLocal_148 = 187.4554f;
	uLocal_149 = { 1811.9602f, 4697.071f, 39.1076f };
	fLocal_152 = 330.5137f;
	uLocal_153 = { 1814.0197f, 4697.051f, 38.9678f };
	fLocal_156 = 24.0044f;
	hLocal_157 = joaat("WEAPON_DIGISCANNER");
	hLocal_158 = WEAPON::GET_WEAPONTYPE_MODEL(hLocal_157);
	sLocal_159 = "empty";
	iLocal_337 = 1;
	iLocal_762 = -1;
	iLocal_763 = -1;
	...
	fLocal_768 = 0.02f;
	fLocal_769 = -0.05f;
	uLocal_81 = { uScriptParam_0 };
	func_443(&uLocal_81);
	MISC::SET_MISSION_FLAG(true);

	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(19))
	{
		func_442("Force cleanup [TERMINATING]");
		func_425(true);
		func_422();
	}
	...
	iLocal_160 = func_411();
	iLocal_161 = func_410(1855.08f, 4755.85f, 36.81f, 25f);
	iLocal_762 = PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(1815.39f, 4698f, 38.87f, 3.5f, 3.5f, 3f, 0f, false, 7);
	iLocal_763 = PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(1824.12f, 4701.39f, 38.29f, 2.5f, 2.5f, 2.5f, 0f, false, 7);
	iLocal_764 = PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(1801.28f, 4700.25f, 39.42f, 2f, 2f, 2f, 0f, false, 7);

	if (!AUDIO::IS_AUDIO_SCENE_ACTIVE("EPSILONISM_04_MIX"))
	{
		_DEBUG_PRINT("Starting dynamic mix EPSILONISM_04_MIX");
	...
	iLocal_358 = GRAPHICS::SET_GRASS_CULL_SPHERE(1751.65f, 4676.77f, 43.03f, 1.5f);
	func_406();
	func_389();
	func_388();
	iLocal_770 = 0;
	...
	for (i = 0; i < iLocal_534; i = i + 1)
	{
		func_385(&uLocal_361[i /*43*/]);
	}

	func_384(&uLocal_604[0 /*8*/], uLocal_149, fLocal_152, uLocal_81.f_28[0], 0);
	func_384(&uLocal_604[1 /*8*/], uLocal_153, fLocal_156, uLocal_81.f_28[1], 0);

	if (_IS_MISSION_REPLAY_IN_PROGRESS())
	{
		if (func_383() == 0)
		{
			func_382(uLocal_145, fLocal_148, 1, 0);
			func_381(1);
			func_380(&uLocal_81, false, true);
			func_379();
			_DEBUG_PRINT("Done replay setup");
		}
	}
	...
	while (true)
	{
		...
		func_356(uLocal_81.f_9, 0, 0, 0, 0, 0);
		...
		if (func_354(PLAYER::PLAYER_PED_ID()))
		{
			if (func_353(PLAYER::PLAYER_PED_ID()) == hLocal_157)
			{
...
void func_1() // Position - 0x3FD Hash - 0x24922B81 ^0xA5AD911
{
	char* string1;

	switch (iLocal_770.f_1)
	{
		case 0:
			func_9();
			...
			if (MISC::ARE_STRINGS_EQUAL(string1, sLocal_159))
				func_425(true);
			else
				func_7(string1, true);
		...
		case 1:
			...
			{
				func_4();
				func_2(&uLocal_604[0 /*8*/]);
				func_2(&uLocal_604[1 /*8*/]);
				func_422();
			}
			break;
	}
...
void func_2(Ped* ppedParam0) // Position - 0x4E3 Hash - 0x3E52B6AE ^0xC58F4B15
{
	ppedParam0->f_1 = 0;
	ppedParam0->f_2 = 0;
	func_3(ppedParam0);
...
void func_3(Ped* ppedParam0) // Position - 0x4FB Hash - 0xCA79453F ^0x7BA88177
{
...
void func_4() // Position - 0x53C Hash - 0x34E1489A ^0x672C57D9
{
	int i;

	for (i = 0; i < iLocal_534; i = i + 1)
	{
		func_5(&(uLocal_361[i /*43*/].f_1));
	}

	return;
}

void func_5(Object* pobParam0) // Position - 0x565 Hash - 0x4EAFEE58 ^0x34D7ECA6
{
...
BOOL func_6() // Position - 0x590 Hash - 0x56F647A6 ^0x56F647A6
{
	if (Global_4)
		return true;
...
void func_7(char* sParam0, BOOL bParam1) // Position - 0x5BD Hash - 0x2E949C6A ^0x2E949C6A
{
	func_8(sParam0);
	func_425(bParam1);
	return;
...
void func_8(char* sParam0) // Position - 0x5D1 Hash - 0xF8A91B1F ^0x74AC5217
{
...
void func_9() // Position - 0x610 Hash - 0x56481192 ^0x2D514EE
{
	AUDIO::STOP_SCRIPTED_CONVERSATION(false);
	HUD::CLEAR_PRINTS();

	if (_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("EPS4_T0") || _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("EPS4_T1"))
		HUD::CLEAR_HELP(true);

	return;
}

BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0x63E Hash - 0xCD6A3595 ^0xB0E86AA0
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(message);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_11() // Position - 0x651 Hash - 0x2154124E ^0x8B2ED577
{
	int outValue;
	...
	func_9();
	func_223(false);
	func_372(CHAR_JIMMY_BOSTON, CHAR_MICHAEL, true);
	func_22(76, true);
	Global_114370.f_18577.f_381 = 0;
	...
	while (func_353(PLAYER::PLAYER_PED_ID()) == hLocal_157)
	{
		SYSTEM::WAIT(0);
		HUD::HIDE_HUD_COMPONENT_THIS_FRAME(HUD_WEAPON_ICON);
		...
		if (STREAMING::HAS_ANIM_DICT_LOADED("weapons@holster_1h"))
			if (!ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), "weapons@holster_1h", "holster", 3))
				TASK::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), "weapons@holster_1h", "holster", 1090519040, -1056964608, -1, 0, 0, false, false, false);
			else if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(PLAYER::PLAYER_PED_ID(), "weapons@holster_1h", "holster") >= 0.5f)
				WEAPON::SET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("WEAPON_UNARMED"), true);
	}

	STATS::STAT_GET_INT(joaat("NUM_EPSILON_STEP"), &outValue, -1);
...
BOOL func_12(int iParam0, int iParam1) // Position - 0x770 Hash - 0x77E0C72A ^0x80DA2A54
{
...
BOOL func_13(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x7C1 Hash - 0xCD7D90D3 ^0xCD7D90D3
{
	int num;
	var unk10;
	int num2;
	...
	if (Global_114370.f_7691.f_866 < CHAR_STEVE_MIKE_CONF)
	{
		num = iParam0;
		num.f_3 = func_21(iParam1);
		...
		Global_114370.f_7691.f_765[Global_114370.f_7691.f_866 /*10*/] = { num };
		Global_114370.f_7691.f_866 = Global_114370.f_7691.f_866 + 1;
		return true;
	}
	else
	{
		unk10 = { func_20(iParam0, iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8, iParam9) };
		num2 = 0;
		func_19(&num2);
		num3 = func_18(unk10, Global_114370.f_7691.f_765[num2 /*10*/]);
	
		if (num3 == 2)
		{
			func_16(Global_114370.f_7691.f_765[num2 /*10*/]);
			Global_114370.f_7691.f_765[num2 /*10*/] = { unk10 };
			func_15(&unk10);
			return true;
		}
		else if (num3 == 1)
		{
			...
			{
				if (!func_14(Global_114370.f_7691.f_765[num2 /*10*/]))
				{
					Global_114370.f_7691.f_765[num2 /*10*/] = { unk10 };
					func_15(&unk10);
					return true;
...
BOOL func_14(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9) // Position - 0x9E0 Hash - 0x5829CA23 ^0x90D2141D
{
	if (uParam0.f_8 == 0)
		return false;
...
void func_15(var uParam0) // Position - 0x9F8 Hash - 0x7F9E7548 ^0x7F9E7548
{
	var unk;
...
void func_16(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9) // Position - 0xA0A Hash - 0xA7FCC8CC ^0xD13FD65B
{
	if (func_14(uParam0))
		func_17(uParam0.f_8, 0);

	return;
}

void func_17(int iParam0, int iParam1) // Position - 0xA27 Hash - 0xEFDF2B54 ^0x1CE7BA3B
{
...
int func_18(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19) // Position - 0xA64 Hash - 0xC393E93F ^0x75404E91
{
	var unk;
	var unk2;
...
void func_19(var uParam0) // Position - 0xA95 Hash - 0x2F9672FB ^0x2F9672FB
{
	eCharacter i;
	...
	*uParam0 = 0;
	...
	{
		if (func_18(Global_114370.f_7691.f_765[i /*10*/], Global_114370.f_7691.f_765[*uParam0 /*10*/]) == 0)
			*uParam0 = i;
	}
...
struct<10> func_20(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0xAEC Hash - 0x242D9B5A ^0x9F57922F
{
	int num;
...
int func_21(int iParam0) // Position - 0xB45 Hash - 0x17C68833 ^0x17C68833
{
	switch (iParam0)
	{
		case 0:
...
void func_22(int iParam0, BOOL bParam1) // Position - 0xBAF Hash - 0x3FCC5D82 ^0x93BAFA48
{
	int num;
	var unk;
	...
	func_178(num, 1, false, false);
	func_177(0, 0);
	TEXT_LABEL_COPY(&unk, { func_175(num) }, 4);
...
int func_23() // Position - 0xCE3 Hash - 0x9482CBBF ^0x8B17A994
{
	if (_IS_MISSION_REPEAT_ACTIVE(false))
		return 0;
...
void func_24(int iParam0, int iParam1, int iParam2) // Position - 0xD2E Hash - 0xEC2439E7 ^0x1B67A713
{
	BOOL flag;
...
void func_25() // Position - 0xE14 Hash - 0x9F269E94 ^0x9F269E94
{
	int num;
	float num2;
	float num3;
	...
	if (!DATAFILE::DATAFILE_IS_SAVE_PENDING())
	{
		if (!Global_79248)
		{
			if (func_26() == 2 == false && !NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
...
int func_26() // Position - 0x12D2 Hash - 0x21D64237 ^0x21D64237
{
	return Global_32828;
}

void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x12DD Hash - 0xCF91FBA1 ^0xAE1D9C41
{
	if (iParam2 == -1)
		iParam2 = func_28();
...
int func_28() // Position - 0x12FB Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1574925;
}

void func_29() // Position - 0x1307 Hash - 0x21D73E90 ^0xBFBA56A9
{
	func_46();
	func_38();
	func_34();
...
void func_30(int iParam0) // Position - 0x1360 Hash - 0x7BC1D73E ^0x69FC312C
{
	if (iParam0 == 1)
...
void func_31() // Position - 0x1389 Hash - 0x2D183413 ^0x53DF279A
{
...
void func_32() // Position - 0x13A7 Hash - 0x7E597A75 ^0x7E597A75
{
...
void func_33() // Position - 0x13C1 Hash - 0x6D3C3E0B ^0x29698AD2
{
	int i;
...
void func_34() // Position - 0x13E6 Hash - 0x640F0DB2 ^0x6312FFED
{
	Global_101392 = 13;
	Global_101392.f_1 = -1;
	Global_101392.f_2 = 0;
...
void func_35() // Position - 0x1435 Hash - 0x9CDA93C5 ^0x9D13FE10
{
...
void func_36() // Position - 0x1455 Hash - 0x25C54BA4 ^0xBB7B0D50
{
...
void func_37(int iParam0) // Position - 0x1493 Hash - 0x42A5A26 ^0x42A5A26
{
	if (iParam0 == 1)
		Global_44471 = 1;
	else
...
void func_38() // Position - 0x14AC Hash - 0xB32E3D0E ^0xB32E3D0E
{
	func_39(&Global_107917);
	return;
}

void func_39(int iParam0) // Position - 0x14BC Hash - 0x6B1DFD44 ^0x8A9E401E
{
	int i;
	int j;
...
void func_40(var uParam0) // Position - 0x1A4C Hash - 0xF73DF469 ^0x8FEB8393
{
	*uParam0 = -1;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_41(var uParam0) // Position - 0x1A67 Hash - 0xCD56C133 ^0xC692BD1A
{
...
void func_42(var uParam0) // Position - 0x1A96 Hash - 0xB95AF921 ^0x4DC7C61C
{
	int i;
...
void func_43(var uParam0) // Position - 0x1B46 Hash - 0x69C08C2 ^0x2D922D7C
{
	*uParam0 = { 0f, 0f, 0f };
	uParam0->f_3 = 0f;
	uParam0->f_4 = 0;
...
void func_44(var uParam0) // Position - 0x1B64 Hash - 0x723850B4 ^0xE9C4F6A8
{
	int i;
...
void func_45(var uParam0) // Position - 0x1C44 Hash - 0xEE73B491 ^0xBDB3BDC2
{
	*uParam0 = -15;
	return;
}

void func_46() // Position - 0x1C52 Hash - 0x395D2A17 ^0x395D2A17
{
...
void func_47() // Position - 0x1C6B Hash - 0xC6C55AD9 ^0xC6C55AD9
{
...
void func_48() // Position - 0x1CE8 Hash - 0x199B5FA7 ^0xB0F19AB8
{
	int i;
	Ped ped;
...
BOOL func_49(Ped pedParam0, ePedComponentType epctParam1, ePedComponentType epctParam2) // Position - 0x1DA9 Hash - 0x42ECC7CD ^0x7567053A
{
	Hash entityModel;
	ePedComponentType i;
	var unk;
...
BOOL func_50(Ped pedParam0, Hash hParam1, var uParam2) // Position - 0x1F66 Hash - 0xA81FB6AC ^0x11DBFE4A
{
	int num;
...
int func_51(Hash hParam0) // Position - 0x2007 Hash - 0x389E0506 ^0x389E0506
{
	switch (hParam0)
	{
...
int func_52(Ped pedParam0, int iParam1, ePedComponentType epctParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x2042 Hash - 0x2F89DA4B ^0xC114075C
{
	int i;
	int j;
	int k;
...
void func_53(Hash hParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x2853 Hash - 0x193E1C5C ^0xBF5A02F8
{
	ePedComponentType type;
	int num;
...
BOOL func_54(Hash hParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x28DD Hash - 0x2BE7FB4 ^0x1D60B8BA
{
	if (hParam0 == joaat("Player_Zero"))
		if (iParam1 == 4)
...
BOOL func_55(Hash hParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x29BB Hash - 0xCA8B24F3 ^0x4C678A52
{
	Global_79031[1 /*14*/] = { func_102(hParam0, iParam1, epctParam2, -1) };
	return IS_BIT_SET(Global_79031[1 /*14*/].f_6, 2);
}

BOOL func_56(Hash hParam0, ePedComponentType epctParam1, int iParam2, ePedComponentType epctParam3, var uParam4, int iParam5) // Position - 0x29E3 Hash - 0x4EAC6644 ^0x84ED5CC8
{
	var unk;
	int i;
...
BOOL func_57(Hash hParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x2FE7 Hash - 0x1194ADFB ^0x1194ADFB
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
ePedComponentType func_58(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x3080 Hash - 0x6AEB8E24 ^0x393FEB8F
{
	ePedComponentType i;
	ePedComponentType j;
...
BOOL func_59(Hash hParam0, int iParam1, ePedComponentType epctParam2, var uParam3) // Position - 0x3121 Hash - 0x66694B65 ^0x9B4A4885
{
	int num;
...
ePedComponentType func_60(Ped pedParam0, Hash hParam1, int iParam2, ePedComponentType epctParam3, int iParam4, int iParam5) // Position - 0x3428 Hash - 0x13FAC17C ^0xAC271D21
{
	ePedComponentType type;
	ePedComponentType type2;
	ePedComponentType type3;
...
BOOL func_61(int iParam0, ePedComponentType epctParam1, ePedComponentType epctParam2, ePedComponentType epctParam3, var uParam4) // Position - 0x3FDB Hash - 0x12FA7EA6 ^0x41952975
{
	int num;
...
ePedComponentType func_62(Hash hParam0, ePedComponentType epctParam1, ePedComponentType epctParam2, int iParam3) // Position - 0x42C0 Hash - 0x243669A7 ^0x243669A7
{
	int num;
...
ePedComponentType func_63(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x4587 Hash - 0x836A6BCB ^0x1BDA295A
{
	ePedComponentType i;
	ePedComponentType type;
...
BOOL func_64(Ped pedParam0, int iParam1, ePedComponentType epctParam2, ePedComponentType epctParam3) // Position - 0x45BE Hash - 0x181F6657 ^0x181F6657
{
	ePedComponentType type;
...
BOOL func_65(Hash hParam0, ePedComponentType epctParam1, var uParam2) // Position - 0x45E7 Hash - 0x9FD3CF97 ^0x79A65971
{
	*uParam2 = -99;
...
BOOL func_66(Hash hParam0, int iParam1, ePedComponentType epctParam2, var uParam3) // Position - 0x48B1 Hash - 0x6C977D30 ^0xDCB1D2AD
{
	int num;
...
ePedComponentType func_67(Hash hParam0, ePedComponentType epctParam1, ePedComponentType epctParam2) // Position - 0x4B3B Hash - 0x678DE6D2 ^0x678DE6D2
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
void func_68(Ped pedParam0, ePedComponentType epctParam1, int iParam2, int iParam3) // Position - 0x4C92 Hash - 0x64D2154E ^0x9C1670D6
{
	ePedComponentType type;
	...
	else
	{
		...
		if (epctParam1 == PV_COMP_HEAD)
		{
			type = func_73(pedParam0, iParam2, iParam3, epctParam1);
		
			if (func_69(ENTITY::GET_ENTITY_MODEL(pedParam0), 14, type, FILES::GET_HASH_NAME_FOR_PROP(pedParam0, 0, iParam2, iParam3)))
			{
...
BOOL func_69(Hash hParam0, int iParam1, ePedComponentType epctParam2, Hash hParam3) // Position - 0x4D2C Hash - 0xC42704DB ^0xC42704DB
{
	switch (hParam0)
	{
...
Hash func_70(Hash hParam0, ePedComponentType epctParam1, int iParam2, int iParam3) // Position - 0x4DFA Hash - 0x3B4EF0B2 ^0x11322F71
{
	var outProp;
	int componentId;
	int num;
...
int func_71(Hash hParam0, int iParam1) // Position - 0x4F14 Hash - 0x765E2190 ^0x765E2190
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_72(Hash hParam0) // Position - 0x52BB Hash - 0xC0824942 ^0x8EB5258
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
ePedComponentType func_73(Ped pedParam0, int iParam1, int iParam2, ePedComponentType epctParam3) // Position - 0x531C Hash - 0x3F809B31 ^0x8E48393
{
	Hash entityModel;
...
int func_74(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x5418 Hash - 0xB8AC6F7F ^0x2249C2B3
{
	Hash entityModel;
...
int func_75(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x5556 Hash - 0x37A3B7AE ^0x8CDB7FD1
{
	var outfit;
	int i;
	int num;
...
int func_76(Hash hParam0) // Position - 0x5611 Hash - 0x3694542E ^0xA74289BE
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_77(ePedComponentType epctParam0) // Position - 0x5670 Hash - 0xEE599357 ^0xEE599357
{
	switch (epctParam0)
	{
		case PV_COMP_HEAD:
...
BOOL func_78(Hash hParam0, int iParam1, ePedComponentType epctParam2, Hash hParam3) // Position - 0x56F6 Hash - 0xCC83E9BC ^0xCC83E9BC
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_79(Hash hParam0, int iParam1, ePedComponentType epctParam2, Hash hParam3) // Position - 0x5973 Hash - 0x261C127A ^0x57548E07
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_80(Hash hParam0, int iParam1, ePedComponentType epctParam2, Hash hParam3) // Position - 0x5D98 Hash - 0xAC33D304 ^0xAC33D304
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
ePedComponentType func_81(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x608B Hash - 0xA9FF3076 ^0xC030B76B
{
	int pedPropIndex;
...
ePedComponentType func_82(Ped pedParam0, int iParam1) // Position - 0x60D2 Hash - 0x5DC76C2F ^0x122A4DD3
{
...
ePedComponentType func_83(Ped pedParam0, int iParam1, int iParam2, int iParam3) // Position - 0x6132 Hash - 0x8F4AAD60 ^0xD2AF7F3D
{
	ePedComponentType componentId;
...
void func_84(int iParam0) // Position - 0x6189 Hash - 0xE5A1F74D ^0x61D497DD
{
...
void func_85(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x6235 Hash - 0x302FBF28 ^0x92BCD54A
{
	int num;
	int offset;
	int num2;
	...
	if (func_90(hParam0, iParam1, &num2, &offset, bParam2, bParam3))
	{
...
void func_86(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x627D Hash - 0x99A9B13C ^0x9ABF46
{
	Hash statName;
...
Hash func_87(int iParam0, int iParam1) // Position - 0x62AB Hash - 0x505A9F99 ^0x8B00E935
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_88(iParam1));
}

int func_88(int iParam0) // Position - 0x62C0 Hash - 0x1A3F3220 ^0x1A3F3220
{
	int num;
	int num2;
...
int func_89(int iParam0, int iParam1) // Position - 0x62F4 Hash - 0x744E461C ^0x94D7C845
{
	Hash statHash;
	int outValue;
...
BOOL func_90(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x6323 Hash - 0x1B8A3878 ^0xAE12BCDE
{
...
BOOL func_91(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x8E13 Hash - 0xDF4F0B01 ^0xAAD287D4
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
BOOL func_92(int iParam0) // Position - 0x9CB6 Hash - 0x972D67C7 ^0x6B327493
{
	if (!IS_BIT_SET(Global_79031[1 /*14*/].f_6, 0))
		return false;
...
BOOL func_93(Ped pedParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x9CFE Hash - 0x490228A8 ^0xCA034CC2
{
	int num;
...
ePedComponentType func_94(ePedComponentType epctParam0) // Position - 0x9DA9 Hash - 0xF91DA7A7 ^0xF91DA7A7
{
	switch (epctParam0)
	{
		case 0:
...
struct<10> func_95(Hash hParam0, ePedComponentType epctParam1) // Position - 0x9E59 Hash - 0x2A30F768 ^0x18171033
{
	int i;
	var unk;
...
void func_96(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0xA788 Hash - 0xE5FA3D79 ^0xC01023AA
{
	int num;
	Hash itemHash;
	Hash outPropVariant;
...
void func_97(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0xA8B2 Hash - 0xF7320378 ^0xF7320378
{
	uParam0->[0] = iParam1;
	uParam0->[1] = iParam2;
	uParam0->[2] = iParam3;
...
struct<17> func_98(Hash hParam0, ePedComponentType epctParam1) // Position - 0xA8FA Hash - 0x10D20E1D ^0x38BDAFC5
{
	int i;
	var unk;
...
void func_99(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0xC744 Hash - 0xD805D094 ^0x25EDFC78
{
	int num;
	Hash outfit;
...
int func_100(ePedComponentType epctParam0) // Position - 0xC92E Hash - 0xF91DA7A7 ^0xF91DA7A7
{
	switch (epctParam0)
	{
		case 0:
...
void func_101(var uParam0, int iParam1, int iParam2, ePedComponentType epctParam3, ePedComponentType epctParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0xC9DE Hash - 0xEC425A3E ^0xEC425A3E
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
...
struct<14> func_102(Hash hParam0, ePedComponentType epctParam1, ePedComponentType epctParam2, int iParam3) // Position - 0xCA4F Hash - 0x7D5AC326 ^0xB460D68E
{
	func_166();
...
void func_103(int iParam0, int iParam1) // Position - 0xCAA1 Hash - 0x2A09B983 ^0x2A09B983
{
	switch (iParam0)
	{
		case 0:
...
void func_104(int iParam0) // Position - 0xCB91 Hash - 0x678352E1 ^0xD7ECDF4E
{
	BOOL flag;
	int num;
	var unk;
...
void func_105(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0xDDCB Hash - 0xA2DFD38C ^0xCA7EA132
{
	int num;
	int num2;
...
BOOL func_106(int iParam0, int iParam1, var uParam2) // Position - 0xE16C Hash - 0x805F0D09 ^0xD5FF8259
{
	*uParam2 = 979;
...
int func_107(int iParam0, int iParam1) // Position - 0xE571 Hash - 0x4CEDF2DA ^0xD4A47B95
{
	switch (iParam1)
	{
		case 0:
...
int func_108(int iParam0, int iParam1) // Position - 0xE96C Hash - 0x4CEDF2DA ^0x7536052F
{
	switch (iParam1)
	{
		case 0:
...
BOOL func_109(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xED67 Hash - 0x8D68F96D ^0x8D68F96D
{
	int num;
	int num2;
	int num3;
	...
	if (func_90(hParam0, iParam1, &num3, &num2, bParam2, bParam3))
	{
...
BOOL func_110(int iParam0) // Position - 0xEDA5 Hash - 0x937D8816 ^0x937D8816
{
	return Global_43922 == iParam0;
}

int func_111(int iParam0) // Position - 0xEDB3 Hash - 0xE4C61EBD ^0xE4C61EBD
{
	switch (iParam0)
	{
		case -1:
...
void func_112(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0xEE87 Hash - 0xE3509264 ^0xCA79B364
{
	int num;
	int num2;
	Hash outfit;
...
void func_113(int iParam0) // Position - 0xF10D Hash - 0x8C8D9F27 ^0x29157890
{
	BOOL flag;
	int num;
	var unk;
...
void func_114(int iParam0) // Position - 0xF25A Hash - 0x7D56211F ^0xBFDECF34
{
	BOOL flag;
	int num;
	var unk;
...
void func_115(int iParam0) // Position - 0xF767 Hash - 0x937E49C4 ^0x9AC79266
{
	BOOL flag;
	int num;
	var unk;
...
void func_116(int iParam0) // Position - 0xF7DB Hash - 0xE19FC910 ^0x434219DD
{
	BOOL flag;
	int num;
	var unk;
...
void func_117(int iParam0) // Position - 0xF84E Hash - 0xC290E725 ^0xFD4E63F6
{
	BOOL flag;
	int num;
	var unk;
...
void func_118(int iParam0) // Position - 0xF935 Hash - 0xF2B15C74 ^0x1102A3FE
{
	BOOL flag;
	int num;
	var unk;
...
void func_119(int iParam0) // Position - 0xFC77 Hash - 0xD6C1CA87 ^0xAEDBAA05
{
	BOOL flag;
	int num;
	var unk;
...
void func_120(int iParam0) // Position - 0xFE7F Hash - 0xDDFE7744 ^0x3F7486E0
{
	BOOL flag;
	int num;
	var unk;
...
void func_121(int iParam0) // Position - 0x100A1 Hash - 0x55F36249 ^0x6640CEC9
{
	BOOL flag;
	int num;
	var unk;
...
void func_122(int iParam0) // Position - 0x101AA Hash - 0xEF2456FB ^0xF26EBF47
{
	BOOL flag;
	int num;
	var unk;
...
void func_123(int iParam0) // Position - 0x10B3C Hash - 0xD968CB7E ^0xD0E57EAB
{
	BOOL flag;
	int num;
	var unk;
...
void func_124(int iParam0) // Position - 0x11694 Hash - 0x2732DFB2 ^0x9C99461
{
	if (iParam0 < 136)
		func_126(iParam0);
	else
...
void func_125(int iParam0) // Position - 0x116C9 Hash - 0x7B542CFB ^0x7B7172E8
{
	BOOL flag;
	int num;
	var unk;
...
void func_126(int iParam0) // Position - 0x122CD Hash - 0x7B542CFB ^0x837E7A07
{
	BOOL flag;
	int num;
	var unk;
...
void func_127(int iParam0) // Position - 0x131CD Hash - 0xC2F9B35A ^0xC8B1CFF1
{
	BOOL flag;
	int num;
	var unk;
...
void func_128(int iParam0) // Position - 0x132FA Hash - 0x6D4FAE74 ^0x347BF851
{
	BOOL flag;
	int num;
	var unk;
...
void func_129(int iParam0, int iParam1) // Position - 0x133F1 Hash - 0x2A09B983 ^0x2A09B983
{
	switch (iParam0)
	{
		case 0:
...
void func_130(int iParam0) // Position - 0x134E1 Hash - 0xD7DC8F33 ^0x465C2FC7
{
	BOOL flag;
	int num;
	var unk;
...
void func_131(int iParam0) // Position - 0x149AF Hash - 0xAA65CF00 ^0x9797DF8F
{
	BOOL flag;
	int num;
	var unk;
...
void func_132(int iParam0) // Position - 0x14AF6 Hash - 0x4B9467AD ^0x1763FDF5
{
	BOOL flag;
	int num;
	var unk;
...
void func_133(int iParam0) // Position - 0x15000 Hash - 0xB5B326B5 ^0xEDFAB17E
{
	BOOL flag;
	int num;
	var unk;
...
void func_134(int iParam0) // Position - 0x15669 Hash - 0x8CFCE32E ^0xB4943CDB
{
	BOOL flag;
	int num;
	var unk;
...
void func_135(int iParam0) // Position - 0x156DC Hash - 0xCB73BC76 ^0x237B7BE9
{
	BOOL flag;
	int num;
	var unk;
...
void func_136(int iParam0) // Position - 0x157AC Hash - 0xFB5B157 ^0x3CD6D2D7
{
	BOOL flag;
	int num;
	var unk;
...
void func_137(int iParam0) // Position - 0x15CA7 Hash - 0x68DC7268 ^0xCFC3823F
{
	BOOL flag;
	int num;
	var unk;
...
void func_138(int iParam0) // Position - 0x15E38 Hash - 0xDE9CA139 ^0xF62A67D1
{
	BOOL flag;
	int num;
	var unk;
...
void func_139(int iParam0) // Position - 0x16627 Hash - 0x595530FC ^0xD680D9DB
{
	BOOL flag;
	int num;
	var unk;
...
void func_140(int iParam0) // Position - 0x16730 Hash - 0xE2721790 ^0x97B98ACE
{
	BOOL flag;
	int num;
	var unk;
...
void func_141(int iParam0) // Position - 0x17653 Hash - 0xBC068BE9 ^0x4B9EE948
{
	BOOL flag;
	int num;
	var unk;
...
void func_142(int iParam0) // Position - 0x18301 Hash - 0x905863CF ^0x4D59FCB8
{
	if (iParam0 < 107)
		func_145(iParam0);
	else if (iParam0 < 227)
...
void func_143(int iParam0) // Position - 0x18347 Hash - 0x6B1EB2DB ^0x8D9C5D3A
{
	BOOL flag;
	int num;
	var unk;
...
void func_144(int iParam0) // Position - 0x18DEB Hash - 0x6B1EB2DB ^0xE53A8B5A
{
	BOOL flag;
	int num;
	var unk;
...
void func_145(int iParam0) // Position - 0x19BD9 Hash - 0x6B1EB2DB ^0xB7858D6D
{
	BOOL flag;
	int num;
	var unk;
...
void func_146(int iParam0) // Position - 0x1A818 Hash - 0xD1DB443F ^0x63934AF9
{
	BOOL flag;
	int num;
	var unk;
...
void func_147(int iParam0) // Position - 0x1AA90 Hash - 0xC4661163 ^0x354938B4
{
	BOOL flag;
	int num;
	var unk;
...
void func_148(int iParam0, int iParam1) // Position - 0x1ABCC Hash - 0x2A09B983 ^0x2A09B983
{
	switch (iParam0)
	{
		case 0:
...
void func_149(int iParam0) // Position - 0x1ACBC Hash - 0x19E2E5B3 ^0x1F5AD6B9
{
	BOOL flag;
	int num;
	var unk;
...
void func_150(int iParam0) // Position - 0x1BA1A Hash - 0x1C6FB7CF ^0xBD3E694D
{
	BOOL flag;
	int num;
	var unk;
...
void func_151(int iParam0) // Position - 0x1BB89 Hash - 0x7AE9DF25 ^0xB410FFAA
{
	BOOL flag;
	int num;
	var unk;
...
void func_152(int iParam0) // Position - 0x1C0FC Hash - 0xC7DEB280 ^0xBE91EDDD
{
	BOOL flag;
	int num;
	var unk;
...
void func_153(int iParam0) // Position - 0x1C624 Hash - 0x4FBA058A ^0x914F51F9
{
	BOOL flag;
	int num;
	var unk;
...
void func_154(int iParam0) // Position - 0x1C697 Hash - 0xBC3ED9F1 ^0xA6C437C3
{
	BOOL flag;
	int num;
	var unk;
...
void func_155(int iParam0) // Position - 0x1C767 Hash - 0x2031E722 ^0x869C89BD
{
	BOOL flag;
	int num;
	var unk;
...
void func_156(int iParam0) // Position - 0x1CC17 Hash - 0x351B239F ^0x64C7C5AC
{
	BOOL flag;
	int num;
	var unk;
...
void func_157(int iParam0) // Position - 0x1CE72 Hash - 0x5C7249DA ^0x1F9BBF6C
{
	BOOL flag;
	int num;
	var unk;
...
void func_158(int iParam0) // Position - 0x1D132 Hash - 0xB4B062E1 ^0xE26FBDEF
{
	BOOL flag;
	int num;
	var unk;
...
void func_159(int iParam0) // Position - 0x1D2ED Hash - 0xE4934E8C ^0xDC8F39FD
{
	BOOL flag;
	int num;
	var unk;
...
void func_160(int iParam0) // Position - 0x1DE33 Hash - 0xC75B5564 ^0x4C4B30B7
{
	BOOL flag;
	int num;
	var unk;
...
void func_161(int iParam0) // Position - 0x1EA65 Hash - 0xA5A40372 ^0xCEFC4EDB
{
	if (iParam0 < 60)
		func_163(iParam0);
	else
...
void func_162(int iParam0) // Position - 0x1EA9A Hash - 0x910619D4 ^0x9843F2EF
{
	BOOL flag;
	int num;
	var unk;
...
void func_163(int iParam0) // Position - 0x1F82D Hash - 0x8425A109 ^0x4A36C0E0
{
	BOOL flag;
	int num;
	var unk;
...
void func_164(int iParam0) // Position - 0x1FEAF Hash - 0x646F46FD ^0x7B392C80
{
	BOOL flag;
	int num;
	var unk;
...
void func_165(int iParam0) // Position - 0x1FF95 Hash - 0xC9153F1 ^0xE49FD2E2
{
	BOOL flag;
	int num;
	var unk;
...
void func_166() // Position - 0x2008E Hash - 0xE5F61993 ^0xEFD41040
{
...
BOOL func_167(Ped pedParam0, ePedComponentType epctParam1, ePedComponentType epctParam2) // Position - 0x20106 Hash - 0x1B00EC8E ^0x386C7313
{
	Hash entityModel;
	ePedComponentType type;
	int i;
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x2035F Hash - 0xAC4E9801 ^0xB379A75F
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x2039C Hash - 0xADCB9755 ^0xADCB9755
{
...
Hash func_170(eCharacter echParam0) // Position - 0x203C1 Hash - 0xE4CEEC2C ^0xE4CEEC2C
{
	return Global_2139[echParam0 /*29*/];
}

BOOL func_171(eCharacter echParam0) // Position - 0x203D0 Hash - 0x8907F004 ^0x8907F004
{
	return echParam0 < CHAR_MULTIPLAYER;
}

void func_172(const char* sParam0, int iParam1) // Position - 0x203DC Hash - 0x2EC06FB2 ^0xEBDB73F8
{
...
int func_173() // Position - 0x2042D Hash - 0x35BC7314 ^0x35BC7314
{
	func_174();
...
void func_174() // Position - 0x20473 Hash - 0xD1F2D853 ^0xF9F5FD4D
{
	eCharacter character;
...
struct<2> func_175(int iParam0) // Position - 0x20570 Hash - 0x67606F7 ^0x26561E85
{
	var unk;
	var unk3;
...
struct<2> func_176(int iParam0) // Position - 0x205A7 Hash - 0xD0487CEA ^0x8ED9C7AC
{
	var unk;
...
void func_177(int iParam0, BOOL bParam1) // Position - 0x209F3 Hash - 0x91747301 ^0x6F31F55
{
...
void func_178(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x20A3D Hash - 0xCD53339A ^0x850B1A98
{
...
void func_179(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x20ADA Hash - 0x7B81EE40 ^0xF76D595D
{
	var unk;
	var unk33;
...
void func_180(const char* sParam0, Any anParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x20B19 Hash - 0xE38F878C ^0xECAA089F
{
...
void func_181(int iParam0, var uParam1) // Position - 0x20B5D Hash - 0x9E8B9A27 ^0x59180AAB
{
	switch (iParam0)
	{
		case 0:
...
int func_183(int iParam0) // Position - 0x21DA3 Hash - 0xC999F6B2 ^0xC999F6B2
{
	switch (iParam0)
	{
		case 0:
...
void func_184(int iParam0) // Position - 0x220E9 Hash - 0xC0234809 ^0x4FD853DC
{
	Global_44473 = MISC::GET_GAME_TIMER() + iParam0;
	return;
}

void func_185() // Position - 0x220FB Hash - 0x74F480E1 ^0x5568A371
{
	if (Global_98684)
	{
		func_174();
...
char* func_186(eCharacter echParam0) // Position - 0x2212D Hash - 0xFACF4A94 ^0xFACF4A94
{
	echParam0 = echParam0;
	return "";
}

void func_187() // Position - 0x2213C Hash - 0x65F656DA ^0x79421D66
{
	var textLabel;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x2217F Hash - 0x4C81F065 ^0x79C65D03
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x22195 Hash - 0x4C81F065 ^0xB17A9745
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_190(int iParam0, int iParam1) // Position - 0x221AB Hash - 0x53BDC649 ^0x53BDC649
{
...
void func_191() // Position - 0x221BF Hash - 0xD5DFA716 ^0xD54995D4
{
	Global_79503 != 6;
...
void func_192(int iParam0) // Position - 0x221F7 Hash - 0x995C9E2 ^0x995C9E2
{
	if (*iParam0 == -1)
		return;
...
void func_193(int iParam0, BOOL bParam1) // Position - 0x22234 Hash - 0x68B34216 ^0xC1B6AFB2
{
	var unk;
	int newsStory;
	BOOL flag;
...
int func_194(int iParam0) // Position - 0x223B1 Hash - 0x957CB64C ^0xEA59BAC2
{
	switch (iParam0)
	{
		case 0:
...
void func_195(int iParam0) // Position - 0x22738 Hash - 0xDDB71E45 ^0x3573EEDB
{
...
int func_196() // Position - 0x2276E Hash - 0xC3538935 ^0x25088A4A
{
	return Global_114370.f_10019.f_21 + Global_114370.f_18577.f_380;
}

void func_197(int iParam0, BOOL bParam1) // Position - 0x2278A Hash - 0xC86A28AA ^0xC86A28AA
{
	int num;
	int num2;
	int num3;
...
void func_198(int iParam0) // Position - 0x22AAE Hash - 0xA7DEABE8 ^0x629FB868
{
...
void func_199(int iParam0) // Position - 0x22AE1 Hash - 0x477E672 ^0x477E672
{
	switch (iParam0)
	{
		case 30:
...
void func_200(int iParam0, BOOL bParam1) // Position - 0x22B16 Hash - 0xF45B4890 ^0xF45B4890
{
	if (iParam0 == -1)
		return;
...
void func_201(int iParam0, int iParam1, BOOL bParam2) // Position - 0x22B73 Hash - 0xDEF0CB8B ^0x421AAE37
{
	if (iParam0 == -1)
		return;
...
BOOL func_202(int iParam0, int iParam1) // Position - 0x22BAE Hash - 0x9EA0654 ^0x9EA0654
{
	if (iParam0 == -1)
		return false;
...
void func_203(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x22BCE Hash - 0xECB6BFBA ^0x4A87976F
{
	if (iParam0 != 198)
	{
		if (Global_79248)
...
void func_204(int iParam0, int iParam1) // Position - 0x22C26 Hash - 0xF488CE34 ^0xDFDA0E8B
{
	switch (iParam0)
	{
		case 12:
...
void func_205(int iParam0, BOOL bParam1) // Position - 0x22D0F Hash - 0xF0703301 ^0x756A9364
{
	if (bParam1)
...
BOOL func_206(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x22D38 Hash - 0x72F8706 ^0xBE0DD95D
{
	BOOL flag;
	int num;
	int num2;
...
BOOL func_207() // Position - 0x23687 Hash - 0x6134FBB2 ^0x82030B41
{
	if (func_26() == -1 || func_26() == 999 && !(func_208() == 0))
		return true;

	return false;
}

int func_208() // Position - 0x236B7 Hash - 0x21D64237 ^0x21D64237
{
	return Global_32829;
}

int func_209(var uParam0, int iParam1) // Position - 0x236C2 Hash - 0x4BA9211B ^0xB6BC9633
{
	int i;
...
int func_210(int iParam0) // Position - 0x26E5D Hash - 0xAA837AEF ^0xAA837AEF
{
	switch (iParam0)
	{
		case 46:
...
void func_211(int iParam0, BOOL bParam1) // Position - 0x26F4C Hash - 0x9EF3CEFE ^0x9EF3CEFE
{
	switch (iParam0)
	{
		case 46:
...
void func_212(int iParam0, BOOL bParam1) // Position - 0x26F9D Hash - 0x856D02E3 ^0xCCD7C4A8
{
	int offset;
...
void func_213(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x27003 Hash - 0x4646ED21 ^0x4646ED21
{
	func_214(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
	return;
}

void func_214(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x27024 Hash - 0x28B28C5C ^0xAC7E8F9D
{
	int i;
...
void func_215() // Position - 0x271F7 Hash - 0xCF8881D1 ^0x40507183
{
	int i;
...
BOOL func_216(int iParam0) // Position - 0x2730E Hash - 0x3F44A899 ^0x7041C53
{
	int num;
	int i;
...
void func_217(char* sParam0) // Position - 0x2734E Hash - 0x41785ABA ^0xC536F67B
{
...
char* func_218(int iParam0) // Position - 0x27372 Hash - 0xE6862179 ^0xFBBD15B9
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_219(int iParam0) // Position - 0x27545 Hash - 0x156C351F ^0x156C351F
{
...
BOOL func_220(const char* sParam0) // Position - 0x2756F Hash - 0xEC346BB4 ^0x47D9434
{
...
int func_221() // Position - 0x275CF Hash - 0x613FC6AD ^0xDC7835B3
{
	return func_222(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_222(const char* sParam0, int iParam1) // Position - 0x275E0 Hash - 0x76A2E0AF ^0x8A5231BB
{
	int num;
	const char* str;
	Hash hashKey;
...
void func_223(BOOL bParam0) // Position - 0x27629 Hash - 0x5FE88D2A ^0xA22C291D
{
	if (bParam0)
	{
		func_230();
...
void func_224(int iParam0) // Position - 0x2768C Hash - 0x4066FEF5 ^0x9787FBDA
{
	if (func_228())
		return;
...
BOOL func_225() // Position - 0x27716 Hash - 0xD140D54A ^0xE638D98F
{
...
void func_226(BOOL bParam0, BOOL bParam1) // Position - 0x2773D Hash - 0xF40FC178 ^0xA6F60F17
{
	if (bParam0)
	{
		if (func_229(0))
...
BOOL func_227() // Position - 0x277B1 Hash - 0x8DF3D75D ^0x8DF3D75D
{
	return IS_BIT_SET(Global_1956030, 5);
}

BOOL func_228() // Position - 0x277BF Hash - 0xC41437CB ^0xC41437CB
{
	return IS_BIT_SET(Global_1956030, 19);
}

BOOL func_229(int iParam0) // Position - 0x277CE Hash - 0xE8921B44 ^0x4F063755
{
	if (iParam0 == 1)
...
void func_230() // Position - 0x27825 Hash - 0xF8FE2348 ^0xA77911B2
{
...
void func_231() // Position - 0x2784E Hash - 0x90732954 ^0xBA41A77B
{
	AUDIO::STOP_SOUND(obLocal_623.f_2);
	AUDIO::STOP_SOUND(obLocal_623.f_3);
	AUDIO::STOP_SOUND(obLocal_623.f_4);
	AUDIO::STOP_SOUND(obLocal_623.f_5);
	obLocal_623.f_6 = 0;
	obLocal_623.f_7 = 0;
	return;
}

void func_232(int iParam0) // Position - 0x27886 Hash - 0xDB2F75DE ^0xDB2F75DE
{
	BOOL flag;
	int i;
...
void func_233() // Position - 0x278F7 Hash - 0xA7E039F3 ^0xEABE114F
{
	switch (iLocal_770.f_1)
	{
		case 0:
			...
			HUD::HIDE_HUD_COMPONENT_THIS_FRAME(HUD_WEAPON_ICON);
			WEAPON::REMOVE_WEAPON_FROM_PED(PLAYER::PLAYER_PED_ID(), hLocal_157);
			iLocal_770.f_1 = 1;
			break;
		...
		case 1:
			...
			else if (ENTITY::IS_ENTITY_DEAD(uLocal_604[0 /*8*/], false))
			{
				func_243(6);
				iLocal_770.f_9 = 2;
				iLocal_770.f_1 = 3;
			}
			else if (ENTITY::IS_ENTITY_DEAD(uLocal_604[1 /*8*/], false))
			{
				func_243(6);
				iLocal_770.f_9 = 3;
				iLocal_770.f_1 = 3;
			}
			else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_604[0 /*8*/], PLAYER::PLAYER_PED_ID(), true) && WEAPON::HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(uLocal_604[0 /*8*/], 0, 2))
			{
				func_243(6);
				iLocal_770.f_9 = 4;
				iLocal_770.f_1 = 3;
			}
			else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_604[1 /*8*/], PLAYER::PLAYER_PED_ID(), true) && WEAPON::HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(uLocal_604[1 /*8*/], 0, 2))
			{
				func_243(6);
				iLocal_770.f_9 = 5;
				iLocal_770.f_1 = 3;
			}
			else if (func_236(&uLocal_604[0 /*8*/]))
			{
				func_243(6);
				iLocal_770.f_9 = 6;
				iLocal_770.f_1 = 3;
			}
			else if (func_236(&uLocal_604[1 /*8*/]))
			{
				func_243(6);
				iLocal_770.f_9 = 7;
				iLocal_770.f_1 = 3;
			}
			else if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_604[0 /*8*/]))
			{
				if (func_234(PLAYER::PLAYER_PED_ID(), uLocal_604[0 /*8*/], true) >= 50f)
				{
...
float func_234(Ped pedParam0, Ped pedParam1, BOOL bParam2) // Position - 0x27B1A Hash - 0x7B2C17A2 ^0xDF922C6D
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Object obParam0) // Position - 0x27B78 Hash - 0x3D210083 ^0xF7E7C389
{
...
BOOL func_236(var uParam0) // Position - 0x27B99 Hash - 0x32C60641 ^0xABC71EB2
{
	if (func_237(*uParam0, 1090519040, 1097859072))
		return true;

	return false;
}

BOOL func_237(Object obParam0, int iParam1, int iParam2) // Position - 0x27BBA Hash - 0x479528E7 ^0x4585619B
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(obParam0))
	{
		if (MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(obParam0, true), iParam1, false))
			return true;
	
		if (func_238(obParam0, iParam2, false, false))
			return true;
	}
...
BOOL func_238(Object obParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x27BF2 Hash - 0x1310B579 ^0x2AAFC0CC
{
	float entityCoords;
	float num;

	entityCoords = { ENTITY::GET_ENTITY_COORDS(obParam0, true) };
	num = { entityCoords };
	entityCoords = entityCoords - iParam1;
	entityCoords.f_1 = entityCoords.f_1 - iParam1;
	entityCoords.f_2 = entityCoords.f_2 - iParam1;
	num = num + iParam1;
	num.f_1 = num.f_1 + iParam1;
	num.f_2 = num.f_2 + iParam1;

	if (bParam2)
	{
		if (MISC::IS_PROJECTILE_TYPE_WITHIN_DISTANCE(ENTITY::GET_ENTITY_COORDS(obParam0, true), joaat("WEAPON_GRENADE"), iParam1, true) || MISC::IS_PROJECTILE_TYPE_WITHIN_DISTANCE(ENTITY::GET_ENTITY_COORDS(obParam0, true), joaat("WEAPON_MOLOTOV"), iParam1, true) || MISC::IS_PROJECTILE_TYPE_WITHIN_DISTANCE(ENTITY::GET_ENTITY_COORDS(obParam0, true), joaat("WEAPON_SMOKEGRENADE"), iParam1, true) || MISC::IS_PROJECTILE_TYPE_WITHIN_DISTANCE(ENTITY::GET_ENTITY_COORDS(obParam0, true), joaat("WEAPON_STICKYBOMB"), 5f, true))
		{
			if (bParam3)
				if (func_239(obParam0, iParam1))
					return true;
				else
					return false;
...
BOOL func_239(Object obParam0, int iParam1) // Position - 0x27CFE Hash - 0xFA3D7088 ^0x33A74060
{
	var outProjectile;
	var outCoords;

	if (MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(obParam0, joaat("WEAPON_GRENADE"), iParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(obParam0, joaat("WEAPON_SMOKEGRENADE"), iParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(obParam0, joaat("WEAPON_BZGAS"), iParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(obParam0, joaat("WEAPON_STICKYBOMB"), iParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(obParam0, joaat("WEAPON_MOLOTOV"), iParam1, &outCoords, &outProjectile, false))
		if (func_240(obParam0, outCoords, 90f, 0))
			return true;

	return false;
}

BOOL func_240(Object obParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0x27D93 Hash - 0x3F40E5FA ^0xC3BEFE6A
{
	var unk;
	var entityForwardVector;
	float num;

	unk = { func_242(uParam1 - ENTITY::GET_ENTITY_COORDS(obParam0, true)) };
	...
	if (iParam5 == 0)
		...
		entityForwardVector = { func_242(PED::GET_PED_BONE_COORDS(obParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(obParam0, 31086, 0f, 0f, 0f)) };

	num = func_241(entityForwardVector, unk);
...
float func_241(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0x27E21 Hash - 0x596BEA29 ^0x5FBCDBE5
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_242(float fParam0, var uParam1, var uParam2) // Position - 0x27E42 Hash - 0xFB6A39D2 ^0x80C9C759
{
	float num;
	float num2;
...
void func_243(int iParam0) // Position - 0x27E81 Hash - 0xFE217F66 ^0x4A9C7A1F
{
	iLocal_770.f_8 = iParam0;
	return;
}

void func_244() // Position - 0x27E90 Hash - 0xE5740035 ^0x8DF87D41
{
	int gameTimer;
	...
	if (iLocal_770.f_3 == 1)
	{
		...
		if (iLocal_351 == 0)
			func_307("EPS_4_MCS_1");
		else if (iLocal_351 == 1)
			func_307("EPS_4_MCS_2");
		else
			func_307("EPS_4_MCS_3");
	
		if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
		{
			_DEBUG_PRINT("Trying to set player component variation");
		
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()))
				func_300("Michael", PLAYER::PLAYER_PED_ID(), 0, 2);
		
			if (iLocal_351 == 0 || iLocal_351 == 2)
			{
				_DEBUG_PRINT("Trying to set Jimmy prop variation");
				CUTSCENE::SET_CUTSCENE_PED_PROP_VARIATION("Jimmy_Boston", 1, 0, 0, 0);
			}
		}
	
		_DEBUG_PRINT("SKIP: Doing sync for cutscene skip");
		func_299(1, 1, 1);
		iLocal_770.f_3 = 0;
	}
	...
	if (iLocal_770.f_1 == 0)
	{
		func_298("Doing setup for RockScene:", iLocal_351);
		func_296(1);
		func_295();
		PAD::SET_CONTROL_SHAKE(PLAYER_CONTROL, 200, 150);
		...
		if (!func_294(obLocal_360))
		{
			obLocal_360 = VEHICLE::CREATE_VEHICLE(joaat("bison"), 1851.57f, 4772.12f, 39.8f, 31.35f, true, true, false);
			VEHICLE::SET_VEHICLE_COLOURS(obLocal_360, 157, 157);
			VEHICLE::SET_VEHICLE_EXTRA_COLOURS(obLocal_360, 5, 157);
			VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(obLocal_360, 1084227584);
		}
	
		func_293(&uLocal_604[1 /*8*/], true);
		func_293(&uLocal_604[0 /*8*/], true);
	
		if (func_354(PLAYER::PLAYER_PED_ID()))
		{
			while (!func_283(1, 1093140480, 0))
			{
			...
			while (MISC::GET_GAME_TIMER() - gameTimer < 500)
			{
				_DEBUG_PRINT("Doing 500ms pause");
				HUD::HIDE_HUD_COMPONENT_THIS_FRAME(HUD_WEAPON_ICON);
				PLAYER::SET_PLAYER_FORCED_AIM(PLAYER::PLAYER_ID(), true);
				func_296(1);
				func_295();
			...
			if (iLocal_351 == 0)
			{
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_604[1 /*8*/]))
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_604[1 /*8*/], "Jimmy_Boston", 0, 0, 0);
			
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_604[0 /*8*/]))
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_604[0 /*8*/], "Marnie", 0, 0, 0);
			
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()))
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(PLAYER::PLAYER_PED_ID(), "Michael", 0, 0, 0);
			
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(obLocal_623))
				{
					obLocal_639 = func_276(PLAYER::PLAYER_PED_ID(), joaat("WEAPON_DIGISCANNER"), 1, false, 0, 0, 0, 0, 0);
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(obLocal_639, "Artefact_Detector", 0, 0, 0);
				}
			
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_361[iLocal_351 /*43*/].f_1))
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_361[iLocal_351 /*43*/].f_1, "EPS_TV", 0, 0, 0);
			}
			else if (iLocal_351 == 1)
			{
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_604[0 /*8*/]))
				{
					uLocal_604[0 /*8*/].f_7 = 0;
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_604[0 /*8*/], "Marnie", 0, 0, 0);
				}
				...
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_361[iLocal_351 /*43*/].f_1))
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_361[iLocal_351 /*43*/].f_1, "EPS_Battery", 0, 0, 0);
			}
			else
			{
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_604[1 /*8*/]))
				...
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_361[iLocal_351 /*43*/].f_1))
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_361[iLocal_351 /*43*/].f_1, "Old_Boot", 0, 0, 0);
			}
			...
			while (MISC::GET_GAME_TIMER() - gameTimer < 1)
			{
				HUD::HIDE_HUD_COMPONENT_THIS_FRAME(HUD_WEAPON_ICON);
				SYSTEM::WAIT(0);
				RECORDING::REPLAY_CHECK_FOR_EVENT_THIS_FRAME("SF_Epsilon4", 0);
			...
			func_267(uLocal_361[iLocal_351 /*43*/].f_25, uLocal_361[iLocal_351 /*43*/].f_28, uLocal_361[iLocal_351 /*43*/].f_31, uLocal_361[iLocal_351 /*43*/].f_32, uLocal_361[iLocal_351 /*43*/].f_35, func_275(), true, true, true, false, false);
			func_262(uLocal_361[iLocal_351 /*43*/].f_2, 1, 0, 1, 1, 1, true, false, true, 1, true);
		}
	
		func_298("Finished setup, moving to run loop for RockScene #:", iLocal_351);
		iLocal_770.f_1 = 1;
	}
	...
	if (iLocal_770.f_1 == 1)
	{
		...
		else if (iLocal_770.f_6)
		{
			iLocal_770.f_1 = 3;
		}
		else if (iLocal_770.f_4)
		{
			if (iLocal_351 < iLocal_534 - 1)
				func_243(2);
			else
				func_243(5);
		...
		else
		{
			if (iLocal_351 >= 2)
				if (CUTSCENE::IS_CUTSCENE_PLAYING())
					if (CUTSCENE::GET_CUTSCENE_TIME() > 17000)
						if (!STREAMING::IS_NEW_LOAD_SCENE_ACTIVE())
							STREAMING::NEW_LOAD_SCENE_START(1847.4722f, 4756.157f, 36.6968f, func_260(271.4718f), 145f, 0);
			...
			if (iLocal_770.f_2 == 0)
			{
				...
				{
					iLocal_770.f_2 = -1;
					_DEBUG_PRINT("Cutscene not active, setting event -1");
				}
			}
			...
			if (iLocal_770.f_2 == -1)
			{
				...
				if (iLocal_351 >= 2)
				{
					...
					func_5(&(uLocal_361[iLocal_351 /*43*/].f_1));
				}
			
				iLocal_770.f_1 = 3;
				iLocal_351 = iLocal_351 + 1;
				func_298("END CUTSCENE: iCurrentRock = ", iLocal_351);
			}
		}
	}
	...
	if (iLocal_770.f_1 == 3)
	{
		...
		_DEBUG_PRINT("Doing cleanup for RockScene");
		func_245(1, 0, 1, true);
		func_379();
	}
...
void func_245(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x285C9 Hash - 0xD5DA5E14 ^0x5BD94F24
{
	Player playerIndex;
	...
	func_246(false, true, false, false, false, false, false);
...
void func_246(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x28673 Hash - 0x787E640E ^0x67C15509
{
	if (bParam0)
	{
		...
		func_253(true, bParam3, bParam2, false);
		Global_64044 = 1;
		Global_76372 = true;
		Global_79246 = true;
	}
	else
	{
		...
		func_253(false, bParam3, bParam2, false);
	
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_251(PLAYER::PLAYER_ID()) && !func_248(PLAYER::PLAYER_ID(), 0) && !func_247() && !bParam4 && !bParam5 && !NETWORK::NETWORK_IS_IN_SPECTATOR_MODE())
...
BOOL func_247() // Position - 0x287C0 Hash - 0xAA7793E3 ^0x3F62CDC8
{
	return IS_BIT_SET(Global_1845263[PLAYER::PLAYER_ID() /*877*/].f_36.f_18, 14);
}

BOOL func_248(Player plParam0, int iParam1) // Position - 0x287DA Hash - 0x1A32E11A ^0x6AADE226
{
	BOOL flag;
...
int func_249(int iParam0, BOOL bParam1) // Position - 0x28833 Hash - 0x1DCD393E ^0x1DCD393E
{
	int num;
	int num2;
...
BOOL func_250(Player plParam0) // Position - 0x28874 Hash - 0x6A46C9B4 ^0x6A46C9B4
{
	Player player;
...
BOOL func_251(Player plParam0) // Position - 0x28896 Hash - 0x68897CDD ^0x62820466
{
	if (func_248(plParam0, 0))
		return true;
...
BOOL func_252() // Position - 0x288D5 Hash - 0xA525B2F4 ^0xA525B2F4
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_253(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x288E3 Hash - 0x3167F4C7 ^0xCE6B9B6A
{
	int num;
...
void func_254(int iParam0) // Position - 0x28916 Hash - 0x1B2EEE72 ^0xEDBC1F9D
{
	if (iParam0 == 1)
...
void func_255() // Position - 0x28939 Hash - 0xC3CE7F4C ^0xD86D8EC7
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_163, "SET_COLOUR");
	...
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_163, "SET_DISTANCE");
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(10f);
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	HUD::SET_TEXT_RENDER_ID(iLocal_164);
	GRAPHICS::DRAW_SCALEFORM_MOVIE(iLocal_163, 0.1f, 0.24f, 0.21f, 0.51f, 100, 100, 100, 255, 0);
	return;
}

BOOL func_256() // Position - 0x289C5 Hash - 0xCBC817CB ^0x90610876
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()))
	{
		if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Michael", 0))
		{
			if (iLocal_351 >= 2)
			{
				_DEBUG_PRINT("*** Forcing Michael's move state (end cutscene)");
			...
			else
			{
				...
				if (func_353(PLAYER::PLAYER_PED_ID()) != hLocal_157)
					WEAPON::GIVE_WEAPON_TO_PED(PLAYER::PLAYER_PED_ID(), hLocal_157, -1, true, true);
...
void func_257() // Position - 0x28A43 Hash - 0x79F43E4D ^0x5060DB8B
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_604[1 /*8*/]))
	{
		if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Jimmy_Boston", 0))
		{
			if (iLocal_351 >= 2)
			{
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_81.f_28[1]) && func_294(obLocal_360))
				{
					TASK::OPEN_SEQUENCE_TASK(&iLocal_780);
					TASK::TASK_WARP_PED_INTO_VEHICLE(0, obLocal_360, 0);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_780);
					TASK::TASK_PERFORM_SEQUENCE(uLocal_81.f_28[1], iLocal_780);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_780);
					_DEBUG_PRINT("Did Jimmy pass exit");
				}
			}
			else
			{
				TASK::TASK_GO_STRAIGHT_TO_COORD(uLocal_81.f_28[1], 1764.089f, 4665.8794f, 42.3031f, 1f, 20000, 1193033728, 1056964608);
				_DEBUG_PRINT("Did Jimmy regular exit");
			}
		
			PED::FORCE_PED_MOTION_STATE(uLocal_604[1 /*8*/], joaat("MotionState_Walk"), false, 1, false);
		}
	}
...
void func_258() // Position - 0x28AFF Hash - 0x490F6134 ^0x12B1F035
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_604[0 /*8*/]))
	{
		if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Marnie", 0))
		{
			if (iLocal_351 >= 2)
			{
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_81.f_28[0]) && func_294(obLocal_360))
				{
					TASK::OPEN_SEQUENCE_TASK(&iLocal_780);
					TASK::TASK_WARP_PED_INTO_VEHICLE(0, obLocal_360, -1);
					TASK::TASK_VEHICLE_DRIVE_TO_COORD(0, obLocal_360, 1743.33f, 4962.18f, 45.16f, 20f, 0, joaat("bison"), 786599, 5f, -1f);
					TASK::TASK_VEHICLE_DRIVE_WANDER(0, obLocal_360, 30f, 262275);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_780);
					TASK::TASK_PERFORM_SEQUENCE(uLocal_81.f_28[0], iLocal_780);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_780);
					_DEBUG_PRINT("Did Marnie pass exit");
				}
			}
			else
			{
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(uLocal_81.f_28[0], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_81.f_28[0], 0f, 7f, 0f), 1f, 20000, 1048576000, 5, 1193033728);
				_DEBUG_PRINT("Did Marnie regular exit");
			}
		
			PED::FORCE_PED_MOTION_STATE(uLocal_604[0 /*8*/], joaat("MotionState_Walk"), false, 1, false);
		}
	}
...
void func_259() // Position - 0x28BF4 Hash - 0x2C8599B5 ^0x7742D170
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(obLocal_639))
	{
		if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Artefact_Detector", 0))
		{
			if (iLocal_351 < 2)
			{
				_DEBUG_PRINT("*** Detector exit");
				WEAPON::GIVE_WEAPON_OBJECT_TO_PED(obLocal_639, PLAYER::PLAYER_PED_ID());
				func_5(&obLocal_639);
			
				if (!ENTITY::DOES_ENTITY_EXIST(obLocal_623))
				{
					_DEBUG_PRINT("*** Recreating gDetector.hObj after cutscene...");
					obLocal_623 = WEAPON::GET_CURRENT_PED_WEAPON_ENTITY_INDEX(PLAYER::PLAYER_PED_ID(), 1);
				}
			}
			else
			{
				_DEBUG_PRINT("*** Detector exit (end cutscene)");
				func_5(&obLocal_639);
			}
		}
	}
...
Vector3 func_260(float fParam0) // Position - 0x28C64 Hash - 0x22303A60 ^0x2A964B45
{
	return -SYSTEM::SIN(fParam0), SYSTEM::COS(fParam0), 0f;
}

BOOL func_261() // Position - 0x28C7A Hash - 0xC0390B5D ^0x6BC0CC14
{
	if (ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
	{
		func_243(6);
	...
	else if (ENTITY::IS_ENTITY_DEAD(uLocal_604[0 /*8*/], false))
	{
		if (iLocal_351 < 2)
		{
			...
			iLocal_770.f_9 = 2;
			iLocal_770.f_1 = 3;
			_DEBUG_PRINT("Mission failed: Marnie dead");
			return true;
		}
	}
	else if (ENTITY::IS_ENTITY_DEAD(uLocal_604[1 /*8*/], false))
	{
		if (iLocal_351 < 2)
		{
			...
			iLocal_770.f_9 = 3;
			iLocal_770.f_1 = 3;
			_DEBUG_PRINT("Mission failed: Jimmy dead");
			return true;
		}
	}
	else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_604[0 /*8*/], PLAYER::PLAYER_PED_ID(), true) && WEAPON::HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(uLocal_604[0 /*8*/], 0, 2))
	{
		...
		iLocal_770.f_9 = 4;
		iLocal_770.f_1 = 3;
		_DEBUG_PRINT("Mission failed: Marnie injured");
		return true;
	}
	else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_604[1 /*8*/], PLAYER::PLAYER_PED_ID(), true) && WEAPON::HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(uLocal_604[1 /*8*/], 0, 2))
	{
		...
		iLocal_770.f_9 = 5;
		iLocal_770.f_1 = 3;
		_DEBUG_PRINT("Mission failed: Jimmy injured");
		return true;
	}
...
void func_262(float fParam0, float fParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, int iParam11, BOOL bParam12) // Position - 0x28D94 Hash - 0x394D5546 ^0xF43EBD07
{
	Player playerIndex;
...
void func_263(int iParam0, BOOL bParam1) // Position - 0x28F52 Hash - 0xE7B2CDD3 ^0xC2D0D6D9
{
...
Vector3 _GET_PLAYER_COORDS(Player plParam0) // Position - 0x28F8E Hash - 0x6712BF53 ^0x688D5BEC
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(plParam0), false);
}

eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x28FA1 Hash - 0x3C5423D7 ^0x3C5423D7
{
	func_174();
	return Global_114370.f_2366.f_539.f_4321;
}

void func_266(BOOL bParam0) // Position - 0x28FBA Hash - 0xD10400C0 ^0xB6845444
{
	Player playerIndex;
	...
	func_246(true, true, false, false, false, false, false);
	return;
}

void func_267(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, float fParam9, float fParam10, var uParam11, var uParam12, var uParam13, BOOL bParam14, BOOL bParam15, BOOL bParam16, BOOL bParam17, BOOL bParam18) // Position - 0x28FF9 Hash - 0xC60077FB ^0xC60077FB
{
	func_268(fParam0, fParam3, fParam6, fParam7, fParam10, uParam11, bParam14, bParam15, bParam16, bParam17, bParam18);
	return;
}

void func_268(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5, float fParam6, Vector3 vParam7, var uParam8, var uParam9, float fParam10, float fParam11, var uParam12, var uParam13, BOOL bParam14, BOOL bParam15, BOOL bParam16, BOOL bParam17, BOOL bParam18) // Position - 0x29023 Hash - 0xFD52326E ^0x1AB3EC4D
{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(playersLastVehicle, false))
		{
			...
			else
			{
				...
				if (entityCoords.f_2 > vParam0.f_2 && entityCoords.f_2 < vParam3.f_2 || entityCoords.f_2 > vParam3.f_2 && entityCoords.f_2 < vParam0.f_2)
					if (func_272(playersLastVehicle, vParam0, vParam3, fParam6))
						flag = true;
			}
			...
			if (bParam16)
				if (func_270(playersLastVehicle, _GET_CURRENT_PLAYER_CHARACTER(), true))
					flag = false;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x29419 Hash - 0x16E871AD ^0x10C54C39
{
...
BOOL func_270(Vehicle veParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x29443 Hash - 0xBCC62924 ^0x77695844
{
	int i;
	var garageName;
	int num;
	...
	for (i = 0; func_271(echParam1, i, &garageName, &num); i = i + 1)
	{
...
BOOL func_271(eCharacter echParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x294B1 Hash - 0x71B3D0FF ^0xAD7F211F
{
...
BOOL func_272(Vehicle veParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7) // Position - 0x29589 Hash - 0x54559876 ^0xE4811CB1
{
	float num;
	var unk3;
	var unk6;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		if (func_273(unk18[0 /*3*/], unk18[1 /*3*/], unk6, unk9) || func_273(unk18[0 /*3*/], unk18[1 /*3*/], unk9, unk15) || func_273(unk18[0 /*3*/], unk18[1 /*3*/], unk12, unk15) || func_273(unk18[0 /*3*/], unk18[1 /*3*/], unk6, unk12) || func_273(unk18[1 /*3*/], unk18[3 /*3*/], unk6, unk9) || func_273(unk18[1 /*3*/], unk18[3 /*3*/], unk9, unk15) || func_273(unk18[1 /*3*/], unk18[3 /*3*/], unk12, unk15) || func_273(unk18[1 /*3*/], unk18[3 /*3*/], unk6, unk12) || func_273(unk18[3 /*3*/], unk18[2 /*3*/], unk6, unk9) || func_273(unk18[3 /*3*/], unk18[2 /*3*/], unk9, unk15) || func_273(unk18[3 /*3*/], unk18[2 /*3*/], unk12, unk15) || func_273(unk18[3 /*3*/], unk18[2 /*3*/], unk6, unk12) || func_273(unk18[2 /*3*/], unk18[0 /*3*/], unk6, unk9) || func_273(unk18[2 /*3*/], unk18[0 /*3*/], unk9, unk15) || func_273(unk18[2 /*3*/], unk18[0 /*3*/], unk12, unk15) || func_273(unk18[2 /*3*/], unk18[0 /*3*/], unk6, unk12))
			return true;
	}
...
BOOL func_273(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, float fParam9, var uParam10, var uParam11) // Position - 0x2987F Hash - 0x3823BB3 ^0xD0DFB98E
{
	float num;
	float num2;
	float num3;
...
void func_274(Vehicle veParam0) // Position - 0x29933 Hash - 0xE71E0364 ^0xCB8720DC
{
...
Vector3 func_275() // Position - 0x29998 Hash - 0x21158019 ^0x21158019
{
	return 2.55f, 5.665f, 2.55f;
}

Object func_276(Ped pedParam0, Hash hParam1, int iParam2, BOOL bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x299AF Hash - 0x1C8E596E ^0x4C27AF61
{
	BOOL showWorldModel;
	Object weaponObject;
	Hash weaponhash;
	...
	while (func_280(weaponhash, num) != 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(pedParam0, false))
			if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(pedParam0, weaponhash, func_280(weaponhash, num)))
				if (func_279(func_280(weaponhash, num)))
					weaponComponentTypeModel = WEAPON::GET_WEAPON_COMPONENT_TYPE_MODEL(func_280(weaponhash, num));
	...
	while (func_280(weaponhash, num2) != 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(pedParam0, false))
		{
			if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(pedParam0, weaponhash, func_280(weaponhash, num2)))
			{
				WEAPON::GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(weaponObject, func_280(weaponhash, num2));
				func_277(weaponObject, func_280(weaponhash, num2));
			}
		}
...
void func_277(Object obParam0, Hash hParam1) // Position - 0x29B23 Hash - 0x16091E68 ^0x411E0AFB
{
	Hash componentHash;

	componentHash = func_278(hParam1);
...
Hash func_278(Hash hParam0) // Position - 0x29B41 Hash - 0xBA965109 ^0x17F74FEC
{
	switch (hParam0)
	{
...
BOOL func_279(Hash hParam0) // Position - 0x29CD8 Hash - 0x1DB3839 ^0x3F7ACF0C
{
...
Hash func_280(Hash hParam0, int iParam1) // Position - 0x29EE8 Hash - 0x6010BC66 ^0x1DFF9FB7
{
	Hash num;
	int dlcWeaponIndex;
	int i;
	...
	switch (hParam0)
	{
		...
		default:
			if (hParam0 != 0)
			{
				dlcWeaponIndex = func_282(hParam0, &unk);
				...
				if (dlcWeaponIndex != -1)
				{
					for (i = 0; i < FILES::GET_NUM_DLC_WEAPON_COMPONENTS(dlcWeaponIndex); i = i + 1)
					{
						...
						{
							if (!func_281(ComponentDataPtr.f_3))
							{
								if (num2 == iParam1)
...
BOOL func_281(int iParam0) // Position - 0x2AC09 Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
...
int func_282(Hash hParam0, Any* panParam1) // Position - 0x2ACAA Hash - 0x539D27DB ^0xB7B7AD25
{
	int i;
	int numDlcWeapons;
...
BOOL func_283(int iParam0, int iParam1, int iParam2) // Position - 0x2ACE5 Hash - 0x45E861F0 ^0xB70C2EC3
{
	int num;
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		{
			if (!func_290(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), iParam1, 1, 1056964608, false, true, false))
			{
				num = 0;
			}
			else if (iParam2 == 1)
			{
				...
				if (!func_289(PLAYER::PLAYER_PED_ID(), SCRIPT_TASK_LEAVE_ANY_VEHICLE))
...
BOOL func_284() // Position - 0x2ADB9 Hash - 0x7E48580B ^0x77F2F890
{
...
void func_285() // Position - 0x2ADDC Hash - 0xC536DD5 ^0xC536DD5
{
	Global_21032 = 0;
	func_286();
	return;
...
void func_286() // Position - 0x2ADEC Hash - 0xE32CF1EF ^0xB9A7BEB2
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x2AE43 Hash - 0x152DA0B2 ^0x220E93E9
{
...
void func_288() // Position - 0x2AE65 Hash - 0x2A0AC5B7 ^0xAF27577A
{
	PAD::DISABLE_CONTROL_ACTION(PLAYER_CONTROL, INPUT_SPRINT, true);
...
BOOL func_289(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x2AEB6 Hash - 0x5CB13EA9 ^0x50B73240
{
	if (func_354(pedParam0))
...
BOOL func_290(Vehicle veParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x2AEE9 Hash - 0xEF9D4F61 ^0xC848BDEA
{
	func_292(bParam5, bParam6);
	func_291(veParam0);
...
void func_291(Vehicle veParam0) // Position - 0x2AF40 Hash - 0x94E8CB0B ^0x47923A23
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_292(BOOL bParam0, BOOL bParam1) // Position - 0x2AF6C Hash - 0xC86614C6 ^0xCD39041A
{
...
void func_293(var uParam0, BOOL bParam1) // Position - 0x2B0BD Hash - 0xF428454 ^0x66EF0B6C
{
	if (func_354(*uParam0))
	{
		uParam0->f_1 = 3;
		...
		if (uParam0->f_3 != -1)
		{
			uLocal_536[uParam0->f_3 /*6*/].f_5 = 0;
			uParam0->f_3 = -1;
		}
...
BOOL func_294(Object obParam0) // Position - 0x2B126 Hash - 0x7E47BB06 ^0x692E6B64
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(obParam0))
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(obParam0, false))
			if (!FIRE::IS_ENTITY_ON_FIRE(obParam0))
				return true;

	return false;
}

void func_295() // Position - 0x2B150 Hash - 0x322C673E ^0x63C793AD
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_163, "SET_COLOUR");
...
void func_296(int iParam0) // Position - 0x2B1DA Hash - 0x73BE11F0 ^0x461BC32F
{
	if (iParam0 == 1)
	{
		if (func_297())
		{
			if (MISC::ARE_STRINGS_EQUAL(obLocal_623.f_14, "NO_RECENT_ANIM") || !ENTITY::IS_ENTITY_PLAYING_ANIM(obLocal_623, "rcm_epsilonism4", obLocal_623.f_14, 3) || ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(obLocal_623, "rcm_epsilonism4", obLocal_623.f_14) >= 0.98f)
			{
				if (fLocal_638 > 80f)
					obLocal_623.f_14 = "detector_level3_prop";
				else if (fLocal_638 > 50f)
					obLocal_623.f_14 = "detector_level2_prop";
				else
					obLocal_623.f_14 = "detector_level1_prop";
			
				ENTITY::PLAY_ENTITY_ANIM(obLocal_623, obLocal_623.f_14, "rcm_epsilonism4", 16f, false, false, false, 0, 0);
			}
		}
	}
	else if (func_297())
	{
		if (!MISC::ARE_STRINGS_EQUAL(obLocal_623.f_14, "NO_RECENT_ANIM"))
		{
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(obLocal_623, "rcm_epsilonism4", obLocal_623.f_14, 1))
			{
				if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(obLocal_623, "rcm_epsilonism4", obLocal_623.f_14) <= 0.05f)
				{
					ENTITY::STOP_ENTITY_ANIM(obLocal_623, obLocal_623.f_14, "rcm_epsilonism4", -4f);
					obLocal_623.f_14 = "NO_RECENT_ANIM";
				}
			}
		}
	}
...
BOOL func_297() // Position - 0x2B2EE Hash - 0x1103C270 ^0xE7EA00AA
{
	if (ENTITY::DOES_ENTITY_EXIST(obLocal_623))
		return true;
...
void func_298(char* sParam0, int iParam1) // Position - 0x2B305 Hash - 0xCD55D96D ^0xCD55D96D
{
	sParam0 = sParam0;
	iParam1 = iParam1;
	return;
...
void func_299(int iParam0, int iParam1, int iParam2) // Position - 0x2B315 Hash - 0x6642E4D8 ^0xFA541DE7
{
...
void func_300(char* sParam0, Ped pedParam1, Hash hParam2, int iParam3) // Position - 0x2B349 Hash - 0xC980A90D ^0x7E65C60D
{
	var unk;
	int i;
	...
	unk.f_39 = 9;
	unk.f_49 = 9;
	func_301(pedParam1, &unk, iParam3);
...
void func_301(Ped pedParam0, var uParam1, int iParam2) // Position - 0x2B404 Hash - 0x93670E25 ^0x293D2351
{
	ePedComponentType i;
	var unk;
	var unk2;
	...
	unk2.f_49 = 9;
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	func_302(pedParam0, &unk2, 0, -1);
	func_302(pedParam0, uParam1, iParam2, -1);
	num = 0;
	num2 = 0;
	...
	for (i = PV_COMP_HEAD; i < PV_COMP_MAX; i = i + 1)
	{
		...
		{
			if (func_59(entityModel, func_100(i), func_83(pedParam0, unk2.f_13[i], unk2[i], func_100(i)), &unk))
			{
				unk67 = { func_102(entityModel, 2, uParam1->f_59, -1) };
				uParam1->f_13[2] = unk67.f_3;
				uParam1->[2] = unk67.f_4;
				num = 1;
			}
		
			if (func_66(entityModel, func_100(i), func_83(pedParam0, unk2.f_13[i], unk2[i], func_100(i)), &unk))
			{
				unk67 = { func_102(entityModel, 1, uParam1->f_62, -1) };
	...
	for (i = PV_COMP_HEAD; i < PV_COMP_TASK; i = i + 1)
	{
		...
		{
			if (func_59(entityModel, 14, func_73(pedParam0, unk2.f_39[i], unk2.f_49[i], i), &unk))
			{
				unk67 = { func_102(entityModel, 2, uParam1->f_59, -1) };
				uParam1->f_13[2] = unk67.f_3;
				uParam1->[2] = unk67.f_4;
			...
			if (func_66(entityModel, 14, func_73(pedParam0, unk2.f_39[i], unk2.f_49[i], i), &unk))
			{
				unk67 = { func_102(entityModel, 1, uParam1->f_62, -1) };
				uParam1->f_13[1] = unk67.f_3;
				uParam1->[1] = unk67.f_4;
	...
	if (num2 || num)
	{
		type = func_83(pedParam0, uParam1->f_13[1], uParam1->[1], 1);
		type2 = func_83(pedParam0, uParam1->f_13[2], uParam1->[2], 2);
		type3 = func_67(entityModel, type2, type);
	
		if (type3 != -99)
		{
			unk67 = { func_102(entityModel, 0, type3, -1) };
...
void func_302(Ped pedParam0, var uParam1, int iParam2, int iParam3) // Position - 0x2B679 Hash - 0x4CE94407 ^0xC863C983
{
	eCharacter character;
	ePedComponentType i;
	...
	if (!PED::IS_PED_INJURED(pedParam0))
	{
		...
		for (i = PV_COMP_HEAD; i < PV_COMP_MAX; i = i + 1)
		{
			func_306(pedParam0, i, &uParam1->f_13[i], &uParam1->[i], &uParam1->f_26[i], iParam2, 145);
		}
	
		for (i = PV_COMP_HEAD; i < PV_COMP_TASK; i = i + 1)
		{
			func_305(pedParam0, i, &uParam1->f_39[i], &uParam1->f_49[i], iParam2, 145);
		}
...
BOOL func_303(int iParam0, int iParam1) // Position - 0x2B813 Hash - 0x5137F6D6 ^0x3B535546
{
	Hash statHash;
	BOOL outValue;

	statHash = func_304(iParam0, iParam1);
...
Hash func_304(int iParam0, int iParam1) // Position - 0x2B837 Hash - 0x1D62A43E ^0x33D7B335
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_88(iParam1));
}

void func_305(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x2B84C Hash - 0x65821445 ^0x4849EA55
{
	eCharacter character;
...
void func_306(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x2BD95 Hash - 0x10358CC6 ^0xCC2A186D
{
	eCharacter character;
...
void func_307(char* sParam0) // Position - 0x2BFD6 Hash - 0x1656F548 ^0x7B51C4A1
{
	func_246(true, true, false, false, false, false, false);
...
void func_308(BOOL bParam0, BOOL bParam1) // Position - 0x2BFF1 Hash - 0xCC2C4D47 ^0x52FF058A
{
	if (bParam0)
		func_309(false, 1, 1);
	...
	func_262(0f, 0f, 0f, 0, 0, 0, 1, 1, true, bParam1, true, 1, true);
	return;
}

void func_309(BOOL bParam0, int iParam1, int iParam2) // Position - 0x2C026 Hash - 0xED51D894 ^0xCC59B59F
{
...
void func_310() // Position - 0x2C085 Hash - 0x5F8B5EDE ^0xD05188A
{
	int i;
	float groundZ;
	float entityCoords;
	...
	if (iLocal_770.f_3 == 1)
	{
		...
		if (iLocal_351 == 0)
		{
			if (!func_342())
			{
				ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), uLocal_145, true, false, false, true);
				ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), fLocal_148);
			}
		
			func_293(&uLocal_604[1 /*8*/], true);
			func_293(&uLocal_604[0 /*8*/], true);
		
			if (func_354(uLocal_604[1 /*8*/]))
			{
				ENTITY::FREEZE_ENTITY_POSITION(uLocal_81.f_28[1], false);
				ENTITY::SET_ENTITY_COORDS(uLocal_604[1 /*8*/], 1829.75f, 4693.5f, 38.51f, true, false, false, true);
				ENTITY::SET_ENTITY_HEADING(uLocal_604[1 /*8*/], 27.46f);
				entityCoords = { ENTITY::GET_ENTITY_COORDS(uLocal_604[1 /*8*/], true) };
				MISC::GET_GROUND_Z_FOR_3D_COORD(1829.75f, 4693.5f, 38.51f, &groundZ, false, false);
				ENTITY::SET_ENTITY_COORDS(uLocal_604[1 /*8*/], entityCoords, entityCoords.f_1, groundZ, true, false, false, true);
				_DEBUG_PRINT("Setting Jimmy position (0)");
			}
		
			if (func_354(uLocal_604[0 /*8*/]))
			{
				ENTITY::SET_ENTITY_COORDS(uLocal_604[0 /*8*/], 1827.32f, 4692.59f, 38.53f, true, false, false, true);
				ENTITY::SET_ENTITY_HEADING(uLocal_604[0 /*8*/], 171.22f);
				_DEBUG_PRINT("Setting Marnie position (0)");
			}
		}
		else if (iLocal_351 == 1)
		{
			...
			if (func_354(uLocal_604[1 /*8*/]))
			{
				ENTITY::SET_ENTITY_COORDS(uLocal_604[1 /*8*/], 1758.5857f, 4670.0854f, 42.6276f, true, false, false, true);
				ENTITY::SET_ENTITY_HEADING(uLocal_604[1 /*8*/], 262.4368f);
				_DEBUG_PRINT("Setting Jimmy position (1)");
			}
		
			if (func_354(uLocal_604[0 /*8*/]))
			{
				ENTITY::SET_ENTITY_COORDS(uLocal_604[0 /*8*/], 1759.9169f, 4683.584f, 42.7266f, true, false, false, true);
				ENTITY::SET_ENTITY_HEADING(uLocal_604[0 /*8*/], 148.3211f);
				_DEBUG_PRINT("Setting Marnie position (1)");
			}
		}
		else if (iLocal_351 == 2)
		{
			...
			if (func_354(uLocal_604[0 /*8*/]))
			{
				ENTITY::SET_ENTITY_COORDS(uLocal_604[0 /*8*/], 1755.0052f, 4827.329f, 40.0736f, true, false, false, true);
				ENTITY::SET_ENTITY_HEADING(uLocal_604[0 /*8*/], 169.6486f);
				_DEBUG_PRINT("Setting Marnie position (2)");
			}
		}
	...
	if (iLocal_770.f_1 == 0)
	{
		func_298("Doing setup for FindRock section:", iLocal_351);
		func_293(&uLocal_604[1 /*8*/], false);
		bLocal_348 = false;
		iLocal_350 = 0;
		iLocal_621 = 0;
		iLocal_357 = -1;
		iLocal_751 = 0;
		iLocal_752 = 0;
		iLocal_753 = MISC::GET_GAME_TIMER();
		...
		if (iLocal_351 == 0)
		{
			...
			if (func_354(uLocal_604[1 /*8*/]))
			{
				WEAPON::REMOVE_WEAPON_FROM_PED(uLocal_604[1 /*8*/], hLocal_157);
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(uLocal_604[1 /*8*/], 1826.2458f, 4696.506f, 38.1187f, 1f, 20000, 0.1f, 0, 1193033728);
			}
		
			func_340(&uLocal_604[1 /*8*/], true);
			iLocal_746 = 8;
			iLocal_747 = 8;
			iLocal_749 = 0;
			iLocal_748 = 0;
		...
		else if (iLocal_351 == 1)
		{
			...
			func_340(&uLocal_604[0 /*8*/], false);
			func_339(&uLocal_604[1 /*8*/], iLocal_758);
			iLocal_746 = 8;
			iLocal_747 = 8;
			iLocal_749 = 0;
			iLocal_748 = 0;
		...
		else if (iLocal_351 == 2)
		{
			...
			func_339(&uLocal_604[0 /*8*/], iLocal_761);
			func_338(&uLocal_604[1 /*8*/], iLocal_759);
			iLocal_746 = 11;
			iLocal_747 = 12;
			iLocal_749 = 0;
			iLocal_748 = 0;
		...
		_CONVERSATION_INITIALIZE_ACTOR(&uLocal_166, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
		_CONVERSATION_INITIALIZE_ACTOR(&uLocal_166, 5, uLocal_604[1 /*8*/], "JIMMYBOSTON", 0, 1);
		_CONVERSATION_INITIALIZE_ACTOR(&uLocal_166, 4, uLocal_604[0 /*8*/], "MARNIE", 0, 1);
	
		if (iLocal_351 == 0)
			obLocal_359 = uLocal_604[1 /*8*/];
		else
			obLocal_359 = uLocal_604[0 /*8*/];
	
		func_336(uLocal_361[iLocal_351 /*43*/].f_18, uLocal_361[iLocal_351 /*43*/].f_19, uLocal_361[iLocal_351 /*43*/].f_20, uLocal_361[iLocal_351 /*43*/].f_21, uLocal_361[iLocal_351 /*43*/].f_22);
		bLocal_334 = false;
		bLocal_335 = false;
		bLocal_336 = false;
		iLocal_337 = 1;
		...
		iLocal_745 = MISC::GET_GAME_TIMER() + 1000;
		func_298("Finished setup, moving to run loop for rock #:", iLocal_351);
		iLocal_770.f_1 = 1;
	}
	...
	if (iLocal_770.f_1 == 1)
	{
		...
		else if (!func_335(&uLocal_692, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)))
		{
			func_243(6);
			iLocal_770.f_9 = 8;
			iLocal_770.f_1 = 3;
		...
		else if (iLocal_770.f_5)
		{
			...
			{
				func_243(1);
				_DEBUG_PRINT("P skipping to intro...");
			}
			else
			{
				iLocal_351 = iLocal_351 - 1;
		...
		else
		{
			for (i = 0; i < 2; i = i + 1)
			{
				func_332(&uLocal_604[i /*8*/]);
			}
		
			if (ENTITY::DOES_ENTITY_EXIST(uLocal_361[iLocal_351 /*43*/].f_1))
			{
				if (iLocal_351 == 0)
				{
					if (func_234(PLAYER::PLAYER_PED_ID(), uLocal_361[iLocal_351 /*43*/].f_1, true) < 100f)
					{
						if (!CUTSCENE::HAS_CUTSCENE_LOADED())
						{
							CUTSCENE::REQUEST_CUTSCENE("EPS_4_MCS_1", 8);
							_DEBUG_PRINT("Requesting midtro now");
						}
					}
					else if (func_234(PLAYER::PLAYER_PED_ID(), uLocal_361[iLocal_351 /*43*/].f_1, true) > 120f)
					{
						if (CUTSCENE::HAS_CUTSCENE_LOADED())
						{
							_DEBUG_PRINT("Player moved away - unloading midtro");
							CUTSCENE::REMOVE_CUTSCENE();
						}
					}
				}
				...
				else if (func_234(PLAYER::PLAYER_PED_ID(), uLocal_361[iLocal_351 /*43*/].f_1, true) < 100f)
				{
					if (!CUTSCENE::HAS_CUTSCENE_LOADED())
					{
			...
			func_331(&uLocal_361[iLocal_351 /*43*/]);
		
			if (iLocal_351 == 0)
			{
				if (iLocal_744 == 0)
				{
					if (iLocal_745 < MISC::GET_GAME_TIMER())
					{
						if (!func_355())
						{
							func_330("EPS4_T0");
							iLocal_745 = MISC::GET_GAME_TIMER() + 7500;
							iLocal_744 = iLocal_744 + 1;
				...
				else if (iLocal_744 == 1)
				{
					if (PAD::IS_CONTROL_JUST_PRESSED(PLAYER_CONTROL, INPUT_AIM) || iLocal_745 < MISC::GET_GAME_TIMER())
					{
						HUD::CLEAR_HELP(true);
						iLocal_745 = MISC::GET_GAME_TIMER() + 1000;
						iLocal_744 = iLocal_744 + 1;
			...
			func_296(obLocal_623.f_1);
		
			if (iLocal_337 == 1)
			{
				func_329(&blLocal_162);
			
				if (!func_335(&uLocal_640, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)))
				{
					iLocal_337 = 0;
					AUDIO::STOP_SCRIPTED_CONVERSATION(false);
					HUD::CLEAR_PRINTS();
				}
				else if (iLocal_345 == 0 && bLocal_336)
				{
					if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
					{
						iLocal_356 = MISC::GET_GAME_TIMER();
				...
				{
					if (MISC::ARE_STRINGS_EQUAL(uLocal_361[iLocal_351 /*43*/].f_36, sLocal_159) || _CONVERSATION_ADD_LINE(&uLocal_166, "EPS4AUD", uLocal_361[iLocal_351 /*43*/].f_36, 7, 0, 0, 0))
					{
						if (!MISC::ARE_STRINGS_EQUAL(uLocal_361[iLocal_351 /*43*/].f_36, sLocal_159))
							if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(obLocal_359))
								TASK::TASK_LOOK_AT_ENTITY(obLocal_359, PLAYER::PLAYER_PED_ID(), 10000, 0, 2);
				...
				else if (iLocal_344 == 0)
				{
					if (iLocal_351 == 0)
					{
						if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
						{
							_SHOW_SUBTITLE_CLEAR_EXISTING("EPS4_A2", 7500, 0);
							iLocal_356 = MISC::GET_GAME_TIMER();
							iLocal_344 = 1;
						}
					}
				...
				{
					if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && MISC::GET_GAME_TIMER() - iLocal_356 >= 7500)
					{
						if (MISC::ARE_STRINGS_EQUAL(uLocal_361[iLocal_351 /*43*/].f_37, sLocal_159) || !ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), obLocal_359, 30f, 30f, 30f, false, true, 0) || _CONVERSATION_ADD_LINE(&uLocal_166, "EPS4AUD", uLocal_361[iLocal_351 /*43*/].f_37, 7, 0, 0, 0))
						{
							if (!MISC::ARE_STRINGS_EQUAL(uLocal_361[iLocal_351 /*43*/].f_37, sLocal_159))
								if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(obLocal_359))
									TASK::TASK_LOOK_AT_ENTITY(obLocal_359, PLAYER::PLAYER_PED_ID(), 5000, 0, 2);
				...
				else if (bLocal_336 == false && !func_313(PLAYER::PLAYER_PED_ID(), uLocal_361[iLocal_351 /*43*/].f_2, 9f, true))
				{
					if (func_313(PLAYER::PLAYER_PED_ID(), uLocal_361[iLocal_351 /*43*/].f_2, 20f, true))
					{
						if (!bLocal_341)
						{
							if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
							{
								if (_CONVERSATION_ADD_LINE(&uLocal_166, "EPS4AUD", uLocal_361[iLocal_351 /*43*/].f_42, 7, 0, 0, 0))
								{
									if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(obLocal_359))
										TASK::TASK_LOOK_AT_ENTITY(obLocal_359, PLAYER::PLAYER_PED_ID(), 5000, 0, 2);
					...
					{
						if (func_312(PLAYER::PLAYER_PED_ID(), obLocal_359, 30f, true) || iLocal_351 == 2)
						{
							if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && MISC::GET_GAME_TIMER() - iLocal_354 > 15000)
							{
								if (bLocal_334)
								{
									if (iLocal_350 == 0)
									{
										if (iLocal_748 < iLocal_746)
										{
											if (MISC::ARE_STRINGS_EQUAL(uLocal_361[iLocal_351 /*43*/].f_40, sLocal_159) || _CONVERSATION_ADD_LINE(&uLocal_166, "EPS4AUD", uLocal_361[iLocal_351 /*43*/].f_40, 7, 0, 0, 0))
											{
												if (func_354(obLocal_359))
													TASK::TASK_LOOK_AT_ENTITY(obLocal_359, PLAYER::PLAYER_PED_ID(), 3000, 0, 2);
											
												iLocal_354 = MISC::GET_GAME_TIMER();
												iLocal_748 = iLocal_748 + 1;
									...
									else if (iLocal_750 < 12)
									{
										if (MISC::ARE_STRINGS_EQUAL(uLocal_361[iLocal_351 /*43*/].f_40, sLocal_159) || _CONVERSATION_ADD_LINE(&uLocal_166, "EPS4AUD", "EPS4_HASSIG", 7, 0, 0, 0))
										{
											iLocal_354 = MISC::GET_GAME_TIMER();
											iLocal_750 = iLocal_750 + 1;
										}
									}
								}
								else if (iLocal_749 < iLocal_747)
								{
									if (MISC::ARE_STRINGS_EQUAL(uLocal_361[iLocal_351 /*43*/].f_41, sLocal_159) || _CONVERSATION_ADD_LINE(&uLocal_166, "EPS4AUD", uLocal_361[iLocal_351 /*43*/].f_41, 7, 0, 0, 0))
									{
										if (func_354(obLocal_359))
											TASK::TASK_LOOK_AT_ENTITY(obLocal_359, PLAYER::PLAYER_PED_ID(), 3000, 0, 2);
							...
							else if (bLocal_334 != obLocal_623.f_1)
							{
								bLocal_334 = obLocal_623.f_1;
							
								if (obLocal_623.f_1 == 0)
									iLocal_350 = 0;
								...
								if (bLocal_334)
								{
									if (iLocal_355 < MISC::GET_GAME_TIMER())
									{
										...
										iLocal_354 = MISC::GET_GAME_TIMER() - 7500;
					...
					{
						iLocal_354 = MISC::GET_GAME_TIMER() - 5000;
					}
				}
				...
				if (iLocal_351 == 0)
				{
					if (iLocal_751 < 5)
					{
						if (MISC::GET_GAME_TIMER() - iLocal_753 > 7500 && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && !HUD::IS_MESSAGE_BEING_DISPLAYED())
						{
							if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_604[0 /*8*/]))
							{
								if (func_234(uLocal_604[0 /*8*/], PLAYER::PLAYER_PED_ID(), true) < 4f)
								{
									if (_CONVERSATION_ADD_LINE(&uLocal_166, "EPS4AUD", "EPS4_NEARM", 6, 0, 0, 0))
									{
										iLocal_751 = iLocal_751 + 1;
										iLocal_753 = MISC::GET_GAME_TIMER();
									}
								}
							}
				...
				else if (iLocal_351 == 1)
				{
					if (iLocal_751 < 4)
					{
						if (MISC::GET_GAME_TIMER() - iLocal_753 > 7500 && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && !HUD::IS_MESSAGE_BEING_DISPLAYED())
						{
							if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_604[1 /*8*/]))
							{
								if (func_234(uLocal_604[1 /*8*/], PLAYER::PLAYER_PED_ID(), true) < 4f)
								{
									if (_CONVERSATION_ADD_LINE(&uLocal_166, "EPS4AUD", "EPS4_NEARJ", 6, 0, 0, 0))
									{
										iLocal_751 = iLocal_751 + 1;
										iLocal_753 = MISC::GET_GAME_TIMER();
									}
					...
					if (iLocal_751 < 3)
					{
						if (MISC::GET_GAME_TIMER() - iLocal_753 > 7500 && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && !HUD::IS_MESSAGE_BEING_DISPLAYED())
						{
							if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_604[1 /*8*/]))
							{
								if (func_234(uLocal_604[1 /*8*/], PLAYER::PLAYER_PED_ID(), true) < 4f)
								{
									if (_CONVERSATION_ADD_LINE(&uLocal_166, "EPS4AUD", "EPS4_NEARJP", 6, 0, 0, 0))
									{
										iLocal_751 = iLocal_751 + 1;
										iLocal_753 = MISC::GET_GAME_TIMER();
									}
					...
					if (iLocal_752 < 4)
					{
						if (MISC::GET_GAME_TIMER() - iLocal_753 > 7500 && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && !HUD::IS_MESSAGE_BEING_DISPLAYED())
						{
							if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_604[0 /*8*/]))
							{
								if (func_234(uLocal_604[0 /*8*/], PLAYER::PLAYER_PED_ID(), true) < 4f)
								{
									if (_CONVERSATION_ADD_LINE(&uLocal_166, "EPS4AUD", "EPS4_NEARMP", 6, 0, 0, 0))
									{
										iLocal_752 = iLocal_752 + 1;
										iLocal_753 = MISC::GET_GAME_TIMER();
									}
								}
							}
				...
				if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), uLocal_361[iLocal_351 /*43*/].f_2, 6.2f, 6.2f, 2f, false, false, 1))
				{
					if (iLocal_357 == -1)
					{
						iLocal_357 = MISC::GET_GAME_TIMER();
					}
					else if (MISC::GET_GAME_TIMER() - iLocal_357 >= 1500)
					{
						if (_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
							func_285();
				...
				else if (!func_313(PLAYER::PLAYER_PED_ID(), uLocal_361[iLocal_351 /*43*/].f_2, 9f + 2f, true))
				{
					bLocal_335 = false;
				}
			}
			...
			{
				if (!HUD::DOES_BLIP_EXIST(blLocal_162))
					blLocal_162 = func_311(uLocal_142, 5, false);
				...
				else if (iLocal_346 == 0)
				{
					if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
					{
						_SHOW_SUBTITLE_CLEAR_EXISTING("EPS4_A1", 7500, 0);
						iLocal_356 = MISC::GET_GAME_TIMER();
						iLocal_346 = 1;
					}
				}
				...
				{
					if (iLocal_351 < 2)
						if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), obLocal_359, 30f, 30f, 30f, false, true, 0))
							if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && !HUD::IS_MESSAGE_BEING_DISPLAYED())
								if (MISC::ARE_STRINGS_EQUAL(uLocal_361[iLocal_351 /*43*/].f_38, sLocal_159) || _CONVERSATION_ADD_LINE(&uLocal_166, "EPS4AUD", uLocal_361[iLocal_351 /*43*/].f_38, 7, 0, 0, 0))
									iLocal_342 = 1;
					else if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && !HUD::IS_MESSAGE_BEING_DISPLAYED())
						if (MISC::ARE_STRINGS_EQUAL(uLocal_361[iLocal_351 /*43*/].f_38, sLocal_159) || _CONVERSATION_ADD_LINE(&uLocal_166, "EPS4AUD", uLocal_361[iLocal_351 /*43*/].f_38, 7, 0, 0, 0))
							iLocal_342 = 1;
				}
				else if (iLocal_343 == 0)
				{
					if (iLocal_351 < 2)
						if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), obLocal_359, 30f, 30f, 30f, false, true, 0))
							if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && MISC::GET_GAME_TIMER() - iLocal_356 >= 7500 && !HUD::IS_MESSAGE_BEING_DISPLAYED())
								if (MISC::ARE_STRINGS_EQUAL(uLocal_361[iLocal_351 /*43*/].f_39, sLocal_159) || _CONVERSATION_ADD_LINE(&uLocal_166, "EPS4AUD", uLocal_361[iLocal_351 /*43*/].f_39, 7, 0, 0, 0))
									iLocal_343 = 1;
					else if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && MISC::GET_GAME_TIMER() - iLocal_356 >= 7500 && !HUD::IS_MESSAGE_BEING_DISPLAYED())
						if (MISC::ARE_STRINGS_EQUAL(uLocal_361[iLocal_351 /*43*/].f_39, sLocal_159) || _CONVERSATION_ADD_LINE(&uLocal_166, "EPS4AUD", uLocal_361[iLocal_351 /*43*/].f_39, 7, 0, 0, 0))
							iLocal_343 = 1;
				}
			}
	...
	{
		HUD::HIDE_HUD_COMPONENT_THIS_FRAME(HUD_WEAPON_ICON);
		_DEBUG_PRINT("In cleanup for FindRock");
		...
		if (MISC::GET_GAME_TIMER() - iLocal_535 > 750)
		{
			func_231();
...
Blip func_311(Vector3 vParam0, var uParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x2D411 Hash - 0x8C13D1D ^0x7BBAA1E4
{
	Blip blip;
...
BOOL func_312(Ped pedParam0, Object obParam1, float fParam2, BOOL bParam3) // Position - 0x2D43F Hash - 0x4D9C41B8 ^0xBA8EAE2A
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(pedParam0, bParam3), ENTITY::GET_ENTITY_COORDS(obParam1, bParam3)) <= fParam2 * fParam2;
}

BOOL func_313(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5) // Position - 0x2D461 Hash - 0x9A4C1B16 ^0x6EACDAB9
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(pedParam0, bParam5), vParam1) <= fParam4 * fParam4;
}

void _SHOW_SUBTITLE_CLEAR_EXISTING(char* sParam0, int iParam1, int iParam2) // Position - 0x2D47F Hash - 0x8A76EF8E ^0x32DD2C0C
{
	iParam2 = iParam2;
...
BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x2D498 Hash - 0x384540C1 ^0x384540C1
{
	...
	Global_23163 = 0;
	Global_2883585 = 0;
	return func_316(sParam2, iParam3, false);
}

BOOL func_316(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x2D4E6 Hash - 0x77297D51 ^0x40DC584A
{
	Global_22167 = 0;
...
void func_317() // Position - 0x2D7B4 Hash - 0xF42BEB19 ^0xA29557DA
{
	if (!func_318())
		return;
...
BOOL func_318() // Position - 0x2D7EB Hash - 0x7B74B45F ^0xCE052A5D
{
...
BOOL func_319(Player plParam0) // Position - 0x2D84E Hash - 0x6E46BC72 ^0x6E46BC72
{
	return func_320(plParam0, 20);
}

BOOL func_320(Player plParam0, int iParam1) // Position - 0x2D85E Hash - 0x7CD5054C ^0x870BEA81
{
	return IS_BIT_SET(Global_1886967[plParam0 /*609*/].f_10.f_4, iParam1);
}

Player _INVALID_PLAYER_INDEX() // Position - 0x2D876 Hash - 0x478900E4 ^0x478900E4
{
	return -1;
}

void func_322() // Position - 0x2D87F Hash - 0x1FADAEC9 ^0xE776D9CE
{
	int i;
...
void func_323() // Position - 0x2D8B0 Hash - 0xCD8A4D28 ^0xCD8A4D28
{
...
BOOL func_324() // Position - 0x2D945 Hash - 0x9A999369 ^0x4033F7BF
{
	int num;
	int weaponHash;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x2D9DE Hash - 0x98476CE1 ^0x250FEB7C
{
	if (func_110(14))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
...
void func_326() // Position - 0x2DA80 Hash - 0x2CD0AE91 ^0x61399191
{
	int i;
...
BOOL func_327(int iParam0, int iParam1) // Position - 0x2DAD7 Hash - 0xA14C4D3F ^0xA6034F77
{
	switch (iParam0)
	{
		case 5:
...
void func_328(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x2DB0F Hash - 0xC6B752B2 ^0xC6B752B2
{
...
void func_329(Blip* pblParam0) // Position - 0x2DB65 Hash - 0x4C359FE5 ^0xBAF5111C
{
...
void func_330(char* sParam0) // Position - 0x2DB85 Hash - 0x99A98712 ^0xE46BE9F0
{
...
void func_331(var uParam0) // Position - 0x2DB9B Hash - 0x49DBBA1E ^0x2F5DC110
{
	float num;
	...
	num = SYSTEM::VDIST(uParam0->f_2, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true));
	entityForwardVector = { ENTITY::GET_ENTITY_FORWARD_VECTOR(PLAYER::PLAYER_PED_ID()) };

	if (num > obLocal_623.f_11)
	{
		value = 0f;
	
		if (obLocal_623.f_8 > 0f)
			value = value + (SYSTEM::SIN((num - obLocal_623.f_11) * (360f / obLocal_623.f_8)) * obLocal_623.f_10);
	
		if (obLocal_623.f_9 > 0f)
			value = value + (SYSTEM::SIN((num - obLocal_623.f_11) * (360f / obLocal_623.f_9)) * obLocal_623.f_10 * -0.7f);
	
		x1 = (entityForwardVector * SYSTEM::COS(value)) - (entityForwardVector.f_1 * SYSTEM::SIN(value));
		x1.f_1 = (entityForwardVector.f_1 * SYSTEM::COS(value)) + (entityForwardVector * SYSTEM::SIN(value));
	}
	else
	{
		x1 = { entityForwardVector };
	}

	num2 = { uParam0->f_2 - ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
	x2 = { uParam0->f_2 - ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(PLAYER::PLAYER_PED_ID(), 0f, -5f, 0f) };
	flag = (num2 * x1) + (num2.f_1 * x1.f_1) > 0f;
	num3 = 1f - (MISC::GET_ANGLE_BETWEEN_2D_VECTORS(x1, x1.f_1, x2, x2.f_1) / 180f);

	if (num >= 10f)
		obLocal_623.f_12 = 0.92f;
	else
		obLocal_623.f_12 = 0.95f;

	flag2 = num3 > obLocal_623.f_12 && flag;
	obLocal_623.f_1 = flag2;

	if (obLocal_623.f_6 == 1)
	{
		PAD::SET_CONTROL_SHAKE(PLAYER_CONTROL, 200, 150);
	
		if (num > 6.5f || flag2 == false)
		{
			AUDIO::STOP_SOUND(obLocal_623.f_4);
			obLocal_623.f_6 = 0;
			iLocal_352 = 0;
	...
	else if (iLocal_352 < MISC::GET_GAME_TIMER())
	{
		if (num <= 6.5f && flag2)
		{
			AUDIO::STOP_SOUND(obLocal_623.f_3);
			AUDIO::PLAY_SOUND_FROM_ENTITY(obLocal_623.f_4, "CONTINUAL_BEEP", PLAYER::PLAYER_PED_ID(), "EPSILONISM_04_SOUNDSET", false, 0);
			obLocal_623.f_6 = 1;
		}
		else
		{
			...
			num5 = 125 + SYSTEM::ROUND((num4 / 40f) * (1250f - 125f));
		
			if (num5 > 1250)
				num5 = 1250;
		
			iLocal_352 = MISC::GET_GAME_TIMER() + num5;
			num5 = num5 / 3;
		
			if (num5 < 100)
				num5 = 100;
		
			iLocal_353 = MISC::GET_GAME_TIMER() + num5;
			AUDIO::PLAY_SOUND_FROM_ENTITY(obLocal_623.f_3, "IDLE_BEEP", PLAYER::PLAYER_PED_ID(), "EPSILONISM_04_SOUNDSET", false, 0);
		
			if (flag2)
				PAD::SET_CONTROL_SHAKE(PLAYER_CONTROL, 200, 150);
			else
				PAD::SET_CONTROL_SHAKE(PLAYER_CONTROL, 200, 100);
		}
	}

	if (iLocal_353 > 0 && MISC::GET_GAME_TIMER() > iLocal_353)
	{
		AUDIO::STOP_SOUND(obLocal_623.f_3);
		iLocal_353 = 0;
	}
	...
	if (CAM::IS_AIM_CAM_ACTIVE())
	{
		if (obLocal_623.f_7 == 0)
		{
			AUDIO::PLAY_SOUND_FROM_ENTITY(obLocal_623.f_5, "SCAN", PLAYER::PLAYER_PED_ID(), "EPSILONISM_04_SOUNDSET", false, 0);
			obLocal_623.f_7 = 1;
		}
		else if (flag2)
		{
			AUDIO::SET_VARIABLE_ON_SOUND(obLocal_623.f_5, "IsOnTarget", 1f);
		}
		else
		{
			AUDIO::SET_VARIABLE_ON_SOUND(obLocal_623.f_5, "IsOnTarget", 0f);
		}
	
		iLocal_757 = MISC::GET_GAME_TIMER();
	}
	else if (obLocal_623.f_7 == 1)
	{
		AUDIO::STOP_SOUND(obLocal_623.f_5);
		obLocal_623.f_7 = 0;
	}
	...
	{
		num6 = (num - 6.5f) / (uParam0->f_23 - 6.5f);
		...
		if (obLocal_623.f_1)
		{
			fLocal_638 = 100f - (num6 * 100f);
		}
		else
		{
			fLocal_638 = 100f - (num6 * 100f);
			fLocal_638 = fLocal_638 * -1f;
		}
		...
		if (fLocal_638 >= 95f && fLocal_638 <= 99.8f)
			fLocal_638 = 94.9f;
		else if (fLocal_638 <= -95f && fLocal_638 >= -99.8f)
			fLocal_638 = -94.9f;
		...
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_163, "SET_DISTANCE");
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(fLocal_638);
		GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
		HUD::SET_TEXT_RENDER_ID(iLocal_164);
		GRAPHICS::DRAW_SCALEFORM_MOVIE(iLocal_163, 0.1f, 0.24f, 0.21f, 0.51f, 100, 100, 100, 255, 0);
	}

	if (PAD::IS_CONTROL_PRESSED(PLAYER_CONTROL, INPUT_AIM))
	{
...
void func_332(var uParam0) // Position - 0x2E0BB Hash - 0xFDA527EF ^0xEA53D5FA
{
	int i;

	if (func_354(*uParam0) && PED::IS_PED_IN_GROUP(*uParam0))
	...
	switch (uParam0->f_1)
	{
		...
		case 1:
			...
			{
				for (i = MISC::GET_RANDOM_INT_IN_RANGE(0, iLocal_603); uParam0->f_3 == -1; i = (i + 1) % iLocal_603)
				{
					if (uLocal_536[i /*6*/].f_5 == 0)
					{
						if (uLocal_536[i /*6*/].f_4 == 0)
						{
							if (!ENTITY::IS_ENTITY_AT_COORD(*uParam0, uLocal_536[i /*6*/], 3f, 3f, 3f, false, true, 0))
							{
								func_298("Telling ped to go to marker: ", i);
								uLocal_536[i /*6*/].f_5 = 1;
								uParam0->f_3 = i;
							}
						}
					}
				...
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, uLocal_536[uParam0->f_3 /*6*/], 1f, -1, 0.25f, 5, 1193033728);
				uParam0->f_2 = 1;
			}
			else if (uParam0->f_2 == 1)
			{
				if (!uParam0->f_7)
				{
					if (TASK::GET_SCRIPT_TASK_STATUS(*uParam0, SCRIPT_TASK_FOLLOW_NAV_MESH_TO_COORD) == 7)
					{
						_DEBUG_PRINT("Eps reached marker! (follow nav to coord)");
						uParam0->f_1 = 2;
						uParam0->f_2 = 0;
					}
				}
				else if (TASK::GET_SCRIPT_TASK_STATUS(*uParam0, SCRIPT_TASK_GO_STRAIGHT_TO_COORD) == 7)
				{
					_DEBUG_PRINT("Eps reached marker! (go straight to coord)");
					uParam0->f_7 = 0;
					uParam0->f_1 = 2;
					uParam0->f_2 = 0;
				}
		...
		case 2:
			...
			{
				func_298("Telling ped do sequence for marker: ", uParam0->f_3);
				TASK::OPEN_SEQUENCE_TASK(&iLocal_165);
			
				if (uLocal_536[uParam0->f_3 /*6*/].f_4 == 0)
				{
					if (*uParam0 == uLocal_604[1 /*8*/])
					{
						TASK::TASK_PLAY_ANIM(0, "rcm_epsilonism4", "eps_4_ig_1_jimmy_lookaround_entry_jb", 4f, -4f, -1, 0, 0, false, false, false);
						TASK::TASK_PLAY_ANIM(0, "rcm_epsilonism4", "eps_4_ig_1_jimmy_lookaround_idle_a_jb", 1090519040, -4f, -1, 0, 0, false, false, false);
						TASK::TASK_PLAY_ANIM(0, "rcm_epsilonism4", "eps_4_ig_1_jimmy_lookaround_exit_jb", 4f, -4f, -1, 0, 0, false, false, false);
					}
					else
					{
						TASK::TASK_PLAY_ANIM(0, "rcm_epsilonism4", "eps_4_ig_1_marnie_lookaround_entry_marnie", 4f, -4f, -1, 0, 0, false, false, false);
						TASK::TASK_PLAY_ANIM(0, "rcm_epsilonism4", "eps_4_ig_1_marnie_lookaround_idle_a_marnie", 1090519040, -4f, -1, 0, 0, false, false, false);
						TASK::TASK_PLAY_ANIM(0, "rcm_epsilonism4", "eps_4_ig_1_marnie_lookaround_exit_marnie", 4f, -4f, -1, 0, 0, false, false, false);
					}
				}
				else if (uLocal_536[uParam0->f_3 /*6*/].f_4 == 2)
				{
					TASK::TASK_ACHIEVE_HEADING(0, uLocal_536[uParam0->f_3 /*6*/].f_3, 0);
					TASK::TASK_PLAY_ANIM(0, "rcm_epsilonism4", "peeing", 1090519040, -1056964608, -1, 0, 0, false, false, false);
				}
				else if (uLocal_536[uParam0->f_3 /*6*/].f_4 == 3)
				{
					TASK::TASK_PLAY_ANIM(0, "rcm_epsilonism4", "hippy_a", 8f, -8f, -1, 1, 0, false, false, false);
				}
				else if (uLocal_536[uParam0->f_3 /*6*/].f_4 == 1)
				{
					TASK::TASK_PLAY_ANIM(0, "rcm_epsilonism4", "eps_4_ig_1_jimmy_lookaround_entry_jb", 4f, -4f, -1, 0, 0, false, false, false);
					TASK::TASK_PLAY_ANIM(0, "rcm_epsilonism4", "eps_4_ig_1_jimmy_lookaround_idle_a_jb", 1090519040, -4f, -1, 0, 0, false, false, false);
					TASK::TASK_PLAY_ANIM(0, "rcm_epsilonism4", "eps_4_ig_1_jimmy_lookaround_exit_jb", 4f, -4f, -1, 0, 0, false, false, false);
				...
				TASK::CLOSE_SEQUENCE_TASK(iLocal_165);
				TASK::TASK_PERFORM_SEQUENCE(*uParam0, iLocal_165);
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_165);
				uParam0->f_2 = 1;
			}
			else if (uParam0->f_2 == 1)
			{
				if (TASK::GET_SCRIPT_TASK_STATUS(*uParam0, SCRIPT_TASK_PERFORM_SEQUENCE) == 7)
				{
					uLocal_536[uParam0->f_3 /*6*/].f_5 = 0;
					uParam0->f_3 = -1;
					uParam0->f_1 = 1;
		...
		case 4:
			...
			{
				if (!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), uParam0->f_4, 1f, 1f, 1f, false, true, 0) || iLocal_351 > 0)
				{
					if (!PED::IS_PED_IN_GROUP(*uParam0))
					{
						TASK::CLEAR_PED_TASKS(*uParam0);
						PED::SET_PED_AS_GROUP_MEMBER(*uParam0, func_333());
					...
					if (iLocal_351 == 0)
						PED::SET_GROUP_FORMATION(func_333(), 0);
					else
						PED::SET_GROUP_FORMATION(func_333(), 0);
				
					PED::SET_GROUP_FORMATION_SPACING(func_333(), 4f, -1082130432, -1082130432);
					uParam0->f_2 = 1;
				}
			}
			else if (uParam0->f_2 == 1)
			{
				...
				if (TASK::IS_PED_STILL(*uParam0))
				{
					if (!bLocal_348)
					{
						if (MISC::GET_GAME_TIMER() - iLocal_754 > 6000)
						{
							TASK::OPEN_SEQUENCE_TASK(&iLocal_165);
							...
							if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && !HUD::IS_MESSAGE_BEING_DISPLAYED())
								if (*uParam0 == uLocal_604[1 /*8*/])
									_CONVERSATION_ADD_LINE(&uLocal_166, "EPS4AUD", "EPS4_DAWDJ", 7, 0, 0, 0);
								else
									_CONVERSATION_ADD_LINE(&uLocal_166, "EPS4AUD", "EPS4_DAWDM", 7, 0, 0, 0);
					...
					else
					{
						...
						if (!func_289(*uParam0, SCRIPT_TASK_PERFORM_SEQUENCE))
							bLocal_348 = false;
					}
				}
				else
				...
				if (TASK::IS_PED_SPRINTING(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_JUMPING(PLAYER::PLAYER_PED_ID()))
					if (MISC::GET_GAME_TIMER() - iLocal_755 > 7500 && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && !HUD::IS_MESSAGE_BEING_DISPLAYED() && !bLocal_335)
						if (*uParam0 == uLocal_604[1 /*8*/])
							if (_CONVERSATION_ADD_LINE(&uLocal_166, "EPS4AUD", "EPS4_MESSJ", 7, 0, 0, 0))
								iLocal_755 = MISC::GET_GAME_TIMER();
						else if (_CONVERSATION_ADD_LINE(&uLocal_166, "EPS4AUD", "EPS4_MESSM", 7, 0, 0, 0))
							iLocal_755 = MISC::GET_GAME_TIMER();
			
				if (MISC::GET_GAME_TIMER() - iLocal_757 > 15000)
				{
					if (iLocal_756 < 4 && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && !HUD::IS_MESSAGE_BEING_DISPLAYED() && !bLocal_335 && !func_355())
					{
						if (*uParam0 == uLocal_604[1 /*8*/])
						{
							if (_CONVERSATION_ADD_LINE(&uLocal_166, "EPS4AUD", "EPS4_PROMPTJ", 7, 0, 0, 0))
							{
								iLocal_757 = MISC::GET_GAME_TIMER();
								iLocal_756 = iLocal_756 + 1;
							}
						}
						else if (_CONVERSATION_ADD_LINE(&uLocal_166, "EPS4AUD", "EPS4_PROMPTM", 7, 0, 0, 0))
						{
							iLocal_757 = MISC::GET_GAME_TIMER();
							iLocal_756 = iLocal_756 + 1;
						}
...
int func_333() // Position - 0x2E811 Hash - 0xDED80B4D ^0xD3C18941
{
	return PLAYER::GET_PLAYER_GROUP(PLAYER::GET_PLAYER_INDEX());
}

void func_334(Ped pedParam0) // Position - 0x2E821 Hash - 0x41828D37 ^0x95921802
{
	if (func_354(pedParam0) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()))
	{
		if (iLocal_621 == 0)
		{
			if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), pedParam0) && PED::IS_PED_RAGDOLL(pedParam0))
			{
				_DEBUG_PRINT("Player knocked Eps over!");
				iLocal_621 = 1;
				pedLocal_622 = pedParam0;
				TASK::CLEAR_PED_TASKS(pedParam0);
			}
		}
		else if (func_354(pedLocal_622))
		{
			if (TASK::IS_PED_GETTING_UP(pedLocal_622) || PED::IS_PED_ON_FOOT(pedLocal_622))
			{
				if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && !HUD::IS_MESSAGE_BEING_DISPLAYED())
				{
					if (pedLocal_622 == uLocal_604[1 /*8*/])
					{
						if (_CONVERSATION_ADD_LINE(&uLocal_166, "EPS4AUD", "EPS4_JKNOCK", 7, 0, 0, 0))
						{
							iLocal_621 = 0;
							pedLocal_622 = 0;
						}
					}
					else if (_CONVERSATION_ADD_LINE(&uLocal_166, "EPS4AUD", "EPS4_MKNOCK", 7, 0, 0, 0))
					{
						iLocal_621 = 0;
						pedLocal_622 = 0;
					}
...
BOOL func_335(var uParam0, float fParam1, var uParam2, var uParam3) // Position - 0x2E8F7 Hash - 0xEF71070A ^0x3D4398AD
{
	BOOL flag;
	int num;
	int num2;
...
void func_336(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x2E9B3 Hash - 0xE3A0DB18 ^0xBBC03CA7
{
	AUDIO::PLAY_SOUND_FROM_ENTITY(obLocal_623.f_2, "DEVICE", PLAYER::PLAYER_PED_ID(), "EPSILONISM_04_SOUNDSET", false, 0);

	if (obLocal_623.f_13 == 0)
	{
		obLocal_623.f_8 = uParam0;
		obLocal_623.f_9 = uParam1;
		obLocal_623.f_10 = uParam2;
		obLocal_623.f_11 = uParam3;
		obLocal_623.f_12 = uParam4;
	}
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x2EA14 Hash - 0x6C235EE0 ^0x9E57F206
{
...
void func_338(var uParam0, int iParam1) // Position - 0x2EAAF Hash - 0x66ED9F5A ^0x7F86F788
{
	if (func_354(*uParam0))
	{
		if (uParam0->f_1 == 2)
			uLocal_536[iParam1 /*6*/].f_5 = 0;
	
		uParam0->f_1 = 2;
		uParam0->f_2 = 0;
		uLocal_536[iParam1 /*6*/].f_5 = 1;
		uParam0->f_3 = iParam1;
		...
		TASK::CLEAR_PED_TASKS_IMMEDIATELY(*uParam0);
		ENTITY::SET_ENTITY_COORDS(*uParam0, uLocal_536[iParam1 /*6*/], true, false, false, true);
		ENTITY::SET_ENTITY_HEADING(*uParam0, uLocal_536[iParam1 /*6*/].f_3);
	}
	else
	{
		uParam0->f_1 = 0;
...
void func_339(var uParam0, int iParam1) // Position - 0x2EB36 Hash - 0xCE68AE04 ^0x88FC43E0
{
	if (func_354(*uParam0))
	{
		uParam0->f_1 = 1;
...
void func_340(var uParam0, BOOL bParam1) // Position - 0x2EB79 Hash - 0x22B57116 ^0xED2C37C7
{
	if (func_354(*uParam0) && func_354(PLAYER::PLAYER_PED_ID()))
	{
		uParam0->f_1 = 4;
		uParam0->f_2 = 0;
...
void func_341(Vehicle veParam0, int iParam1, int iParam2) // Position - 0x2EBDD Hash - 0xBB66B13B ^0xEE89352E
{
	if (_IS_MISSION_REPLAY_IN_PROGRESS() && func_342())
	{
...
BOOL func_342() // Position - 0x2ECA1 Hash - 0xDB96C64C ^0xAB601103
{
	return IS_BIT_SET(Global_101392.f_20, 13);
}

BOOL func_343() // Position - 0x2ECB2 Hash - 0xBFEDA118 ^0xBFEDA118
{
	if (func_346() && func_345() && func_344())
		return true;

	return false;
}

BOOL func_344() // Position - 0x2ECD8 Hash - 0xC52BB111 ^0x3BE2FA73
{
...
int func_345() // Position - 0x2ED0F Hash - 0x24B56B40 ^0x4CBE78BD
{
	int i;

	for (i = 0; i < iLocal_534; i = i + 1)
	{
		STREAMING::REQUEST_MODEL(uLocal_361[i /*43*/]);
	}

	STREAMING::REQUEST_MODEL(hLocal_158);
	STREAMING::REQUEST_MODEL(joaat("bison"));

	for (i = 0; i < iLocal_534; i = i + 1)
	{
		if (!STREAMING::HAS_MODEL_LOADED(uLocal_361[i /*43*/]))
			return 0;
	}

	if (!STREAMING::HAS_MODEL_LOADED(hLocal_158) || !STREAMING::HAS_MODEL_LOADED(joaat("bison")))
		return 0;

	return 1;
}

int func_346() // Position - 0x2ED8B Hash - 0x221E49E0 ^0x533EB12
{
...
void func_347() // Position - 0x2EDA9 Hash - 0x77C20C51 ^0xEB094C68
{
	if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
	{
		_DEBUG_PRINT("Can request assets for cutscene entity in Eps 4");
		CUTSCENE::SET_CUTSCENE_PED_PROP_VARIATION("Jimmy_Boston", 1, 0, 0, 0);
	...
	if (iLocal_770.f_3 == 1)
	{
		func_308(true, true);
		CUTSCENE::REMOVE_CUTSCENE();
		_DEBUG_PRINT("SKIP: Doing sync for intro skip");
	...
	if (iLocal_770.f_1 == 0)
	{
		...
		_DEBUG_PRINT("In Intro setup, waiting for cutscene to be ready...");
	
		if (func_283(1, 1093140480, 0))
		{
			_DEBUG_PRINT("Starting intro cutscene...");
		
			if (func_354(PLAYER::PLAYER_PED_ID()))
				CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(PLAYER::PLAYER_PED_ID(), "Michael", 0, 0, 0);
		
			if (func_354(uLocal_81.f_28[0]))
				CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_81.f_28[0], "Marnie", 0, 0, 0);
		
			if (func_354(uLocal_81.f_28[1]))
			{
				ENTITY::FREEZE_ENTITY_POSITION(uLocal_81.f_28[1], false);
			
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(WEAPON::GET_CURRENT_PED_WEAPON_ENTITY_INDEX(uLocal_81.f_28[1], 1)))
				{
					obLocal_639 = func_276(uLocal_81.f_28[1], joaat("WEAPON_DIGISCANNER"), 1, false, 0, 0, 0, 0, 0);
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(obLocal_639, "Artefact_Detector", 0, 0, 0);
				}
			
				CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_81.f_28[1], "Jimmy_Boston", 0, 0, 0);
			}
			...
			func_299(1, 1, 0);
			func_267(1833.3932f, 4703.8486f, 32.50218f, 1819.3683f, 4693.4126f, 43.89163f, 18f, 1816.55f, 4683.33f, 37.75f, 339.76f, func_275(), true, true, true, false, false);
			func_262(1812f, 4697f, 39.1f, 1, 0, 1, 1, 1, true, true, true, 1, true);
			...
			_DEBUG_PRINT("Loaded all assets! Moving to intro run loop...");
			iLocal_770.f_1 = 1;
		}
	}
	...
	if (iLocal_770.f_1 == 1)
	{
		...
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				_DEBUG_PRINT("*** Forcing Michael's move state");
				func_350(PLAYER::PLAYER_PED_ID(), 1827.1611f, 4698.6445f, 38.094f, 184.1384f, false, true);
				WEAPON::GIVE_WEAPON_TO_PED(PLAYER::PLAYER_PED_ID(), hLocal_157, -1, true, true);
			}
		}
	...
	if (iLocal_770.f_1 == 3)
	{
		_DEBUG_PRINT("Doing intro cleanup and progressing");
...
void func_348() // Position - 0x2F11E Hash - 0x9F6D603C ^0x367A760E
{
	float groundZ;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_604[1 /*8*/]))
	{
		if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Jimmy_Boston", 0))
		{
			MISC::GET_GROUND_Z_FOR_3D_COORD(1829.8f, 4693.48f, 38.5f, &groundZ, false, false);
			ENTITY::SET_ENTITY_COORDS(uLocal_604[1 /*8*/], 1829.8f, 4693.48f, groundZ, true, false, false, true);
		}
	}
...
void func_349() // Position - 0x2F171 Hash - 0x3D666E9B ^0x7C4A978E
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_604[0 /*8*/]))
	{
		if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Marnie", 0))
		{
			func_339(&uLocal_604[0 /*8*/], iLocal_760);
			uLocal_604[0 /*8*/].f_1 = 1;
			uLocal_604[0 /*8*/].f_2 = 1;
		
			if (uLocal_604[0 /*8*/].f_3 != -1)
				uLocal_536[uLocal_604[0 /*8*/].f_3 /*6*/].f_5 = 0;
		
			uLocal_604[0 /*8*/].f_3 = iLocal_760;
			TASK::TASK_GO_STRAIGHT_TO_COORD(uLocal_604[0 /*8*/], uLocal_536[uLocal_604[0 /*8*/].f_3 /*6*/], 1f, -1, 1193033728, 1056964608);
			PED::FORCE_PED_MOTION_STATE(uLocal_604[0 /*8*/], joaat("MotionState_Walk"), false, 1, true);
			uLocal_604[0 /*8*/].f_7 = 1;
			_DEBUG_PRINT("Done Marnie intro exit state");
		}
	}
...
BOOL func_350(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4, BOOL bParam5, BOOL bParam6) // Position - 0x2F222 Hash - 0x5FA2F2C9 ^0x1375335B
{
...
void func_351() // Position - 0x2F27E Hash - 0x9F2F2451 ^0x9F2F2451
{
	int num;
...
void func_352() // Position - 0x2F29E Hash - 0x6E152A68 ^0xD9D3B37
{
	func_406();
	...
	{
		func_308(true, true);
		_DEBUG_PRINT("SKIP: Doing sync for leadin skip");
		func_299(1, 1, 1);
		iLocal_770.f_3 = 0;
	}
	...
	if (iLocal_770.f_1 == 0)
	{
		...
		if (!_IS_MISSION_REPEAT_ACTIVE(false) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1826.6212f, 4698.7344f, 41.36862f, 1831.1576f, 4680.1914f, 32.426258f, 16.5f, false, true, 0))
		{
			_DEBUG_PRINT("Doing setup for leadin");
			_CONVERSATION_INITIALIZE_ACTOR(&uLocal_166, 4, uLocal_81.f_28[0], "MARNIE", 0, 1);
	...
	if (iLocal_770.f_1 == 1)
	{
		if (MISC::GET_GAME_TIMER() - iLocal_352 > 1250)
		{
		...
		if (!_IS_MISSION_REPEAT_ACTIVE(false) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1826.6212f, 4698.7344f, 41.36862f, 1831.1576f, 4680.1914f, 32.426258f, 16.5f, false, true, 0))
		{
			if (func_234(PLAYER::PLAYER_PED_ID(), uLocal_81.f_28[0], true) >= 3f)
			{
				if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
				{
					if (!bLocal_331)
					{
						if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_81.f_28[0]))
						{
							CAM::SET_GAMEPLAY_ENTITY_HINT(uLocal_81.f_28[0], 0f, 0f, 0.2f, true, 30000, 2000, 2000, 0);
							CAM::SET_GAMEPLAY_HINT_FOV(fLocal_765);
							CAM::SET_GAMEPLAY_HINT_FOLLOW_DISTANCE_SCALAR(fLocal_766);
							CAM::SET_GAMEPLAY_HINT_BASE_ORBIT_PITCH_OFFSET(fLocal_767);
							CAM::SET_GAMEPLAY_HINT_CAMERA_RELATIVE_SIDE_OFFSET(fLocal_768);
							CAM::SET_GAMEPLAY_HINT_CAMERA_RELATIVE_VERTICAL_OFFSET(fLocal_769);
							CAM::SET_GAMEPLAY_HINT_CAMERA_BLEND_TO_FOLLOW_PED_MEDIUM_VIEW_MODE(true);
						
							if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()))
							{
								TASK::OPEN_SEQUENCE_TASK(&iLocal_165);
								TASK::TASK_LOOK_AT_ENTITY(0, uLocal_81.f_28[0], 15000, 0, 2);
								TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 1827.34f, 4697.22f, 38.02f, 1f, 20000, 0.25f, 1, 1193033728);
								TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, uLocal_81.f_28[0], 0);
								TASK::CLOSE_SEQUENCE_TASK(iLocal_165);
								TASK::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), iLocal_165);
								TASK::CLEAR_SEQUENCE_TASK(&iLocal_165);
			...
			if (!bLocal_332)
			{
				if (func_354(uLocal_81.f_28[0]) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
				{
					TASK::TASK_LOOK_AT_ENTITY(uLocal_81.f_28[0], PLAYER::PLAYER_PED_ID(), -1, SLF_WIDEST_YAW_LIMIT | 32, 2);
					TASK::TASK_PLAY_ANIM(uLocal_81.f_28[0], "rcm_epsilonism4leadinout", "ep_4_rcm_leadin_marnie", 8f, -8f, -1, 2, 0, false, false, false);
					CUTSCENE::REMOVE_CUTSCENE();
					CUTSCENE::REQUEST_CUTSCENE_WITH_PLAYBACK_LIST("EP_4_RCM_CONCAT", 2, 8);
					_DEBUG_PRINT("Done Marnie leadin anim - request concat cutscene");
					bLocal_332 = true;
				}
			}
			else if (func_354(uLocal_81.f_28[0]))
			{
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_81.f_28[0], "rcm_epsilonism4leadinout", "ep_4_rcm_leadin_marnie", 3))
				{
					if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(uLocal_81.f_28[0], "rcm_epsilonism4leadinout", "ep_4_rcm_leadin_marnie") > 0.25f)
					{
						if (!bLocal_333)
						{
							if (_CONVERSATION_ADD_LINE(&uLocal_166, "EPS4AUD", "ESP4_RCL", 8, 0, 0, 0))
							{
								_DEBUG_PRINT("Leadin convo done");
								bLocal_333 = true;
							}
						}
					}
				
					if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(uLocal_81.f_28[0], "rcm_epsilonism4leadinout", "ep_4_rcm_leadin_marnie") > 0.95f)
					{
						_DEBUG_PRINT("Leadin done, launch cutscene");
						func_243(1);
						iLocal_770.f_1 = 3;
					}
				
					if (func_234(PLAYER::PLAYER_PED_ID(), uLocal_81.f_28[0], true) <= 1.5f)
					{
						PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, 0);
						TASK::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
					}
		...
		{
			_DEBUG_PRINT("Replay in progress/wrong area, skipping leadin");
			func_243(1);
			iLocal_770.f_1 = 3;
		}
	}
	...
	if (iLocal_770.f_1 == 3)
	{
		_DEBUG_PRINT("Doing leadin cleanup and progressing");
		func_379();
	}
...
Hash func_353(Ped pedParam0) // Position - 0x2F63E Hash - 0xA860C4B2 ^0x4F46EE3F
{
	Hash weaponHash;
...
BOOL func_354(Object obParam0) // Position - 0x2F652 Hash - 0x7E48B415 ^0x126328AB
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(obParam0))
		if (!PED::IS_PED_INJURED(obParam0))
			return true;

	return false;
}

BOOL func_355() // Position - 0x2F672 Hash - 0xF07E96DA ^0xE8D5CA6C
{
...
void func_356(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10) // Position - 0x2F68B Hash - 0x91EBF9FE ^0x91EBF9FE
{
	float num;
	int value;
	int alpha;
	...
	if (Global_79503 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				text = { func_358(Global_79504, Global_79506, iParam10) };
				y == -0.014f;
...
float func_357(const char* sParam0) // Position - 0x2F970 Hash - 0x8E5AA519 ^0xD17CA0B4
{
	HUD::BEGIN_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(sParam0);
	return HUD::END_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(true);
}

struct<2> func_358(int iParam0, int iParam1, int iParam2) // Position - 0x2F983 Hash - 0x15D9AD85 ^0x15D9AD85
{
	var unk;
	int num;
	...
	{
		case 1:
			unk = { func_366(iParam0) };
			break;
	
		case 7:
			unk = { func_175(iParam0) };
			break;
		...
		case 3:
			...
			{
				case 0:
					unk = { func_365(iParam2) };
					break;
			
				case 8:
					unk = { func_364(iParam2) };
					break;
			
				case 7:
					unk = { func_363(iParam2) };
					break;
			
				case 10:
					unk = { func_362(iParam2) };
					break;
			
				case 5:
					unk = { func_361(iParam2) };
					break;
			
				case 4:
					unk = { func_360(iParam2) };
					break;
			
				default:
					TEXT_LABEL_ASSIGN_STRING(&unk, func_359(num), 8);
					break;
			}
			break;
...
char* func_359(int iParam0) // Position - 0x2FA59 Hash - 0xC0B97DCE ^0x3512A327
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_360(int iParam0) // Position - 0x2FBC1 Hash - 0xBFCAA041 ^0xF3EAB1A8
{
	var unk;
	var unk3;
...
struct<2> func_361(int iParam0) // Position - 0x2FBF5 Hash - 0xF9DE2542 ^0xE1190339
{
	var unk;
	var unk3;
...
struct<2> func_362(int iParam0) // Position - 0x2FC29 Hash - 0x57FFED04 ^0xDA67E568
{
	var unk;
	var unk3;
...
struct<2> func_363(int iParam0) // Position - 0x2FC5D Hash - 0xEAC1B948 ^0xBAA4345F
{
	var unk;
	var unk3;
...
struct<2> func_364(int iParam0) // Position - 0x2FC91 Hash - 0x5099F8D6 ^0x96998B5C
{
	var unk;
	var unk3;
...
struct<2> func_365(int iParam0) // Position - 0x2FCCF Hash - 0xEB470AAA ^0x9CD3A02B
{
	var unk;
	var unk3;
...
struct<2> func_366(int iParam0) // Position - 0x2FD03 Hash - 0x6B35EB4A ^0x28D930E2
{
	var unk;
...
BOOL func_367(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x2FD70 Hash - 0x85B8B964 ^0x3D7CA22B
{
	if (!func_369(0) || Global_79519 || Global_79507 == 1 || !CAM::IS_SCREEN_FADED_IN())
		return false;
	...
	switch (Global_79503)
	{
		...
		case 5:
			if (CUTSCENE::IS_CUTSCENE_PLAYING() || func_229(0) || func_368(true))
			{
			}
			else
			{
...
BOOL func_368(BOOL bParam0) // Position - 0x2FE89 Hash - 0x1F743529 ^0xDFDFCA73
{
	if (bParam0)
...
BOOL func_369(int iParam0) // Position - 0x2FEB2 Hash - 0x3BAB94E9 ^0x3BAB94E9
{
	if (Global_43922 == 15)
		return false;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0x2FED4 Hash - 0xECB6C71B ^0xECB6C71B
{
	return func_371(iParam0, Global_43922);
}

BOOL func_371(int iParam0, int iParam1) // Position - 0x2FEE5 Hash - 0x1FD727E0 ^0x1FD727E0
{
	if (iParam1 == 15)
		return 1;
...
void func_372(eCharacter echParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x300C8 Hash - 0x95F9A85C ^0xCFF8B9F9
{
	int num;
	...
	if (Global_118[echParam0 /*10*/].f_8 != 178)
	{
		...
		if (echParam1 == 4)
		{
			func_378(echParam0, 0, 1);
			func_378(echParam0, 1, 1);
			func_378(echParam0, 2, 1);
			func_377(echParam0, 0, 1);
			func_377(echParam0, 1, 1);
			func_377(echParam0, 2, 1);
		}
		else
		{
			if (func_376(echParam0, echParam1) == 1 && func_375(echParam0, echParam1) == 1)
				bParam2 = false;
		
			num = echParam1;
			func_378(echParam0, num, 1);
			func_377(echParam0, num, 1);
...
void func_373() // Position - 0x30246 Hash - 0xC5CC0B7A ^0x266D4F79
{
	var txdName;
	var subject;
...
struct<4> _GET_CHARACTER_NAME(eCharacter character) // Position - 0x302C3 Hash - 0x5D6A4A13 ^0x32291975
{
	return Global_2139[character /*29*/].f_3;
}

int func_375(eCharacter echParam0, int iParam1) // Position - 0x302D6 Hash - 0x97DCD8A1 ^0xF8178EDD
{
...
int func_376(eCharacter echParam0, int iParam1) // Position - 0x30300 Hash - 0x97DCD8A1 ^0x5A8D70D2
{
	if (iParam1 < 0 || iParam1 > 4)
		return 0;
...
void func_377(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x3032A Hash - 0xAB9B6CC ^0x1B5EEB55
{
	if (iParam1 < 0 || iParam1 > 4)
		return;
...
void func_378(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x3036F Hash - 0xAB9B6CC ^0x80AE0F15
{
	if (iParam1 < 0 || iParam1 > 4)
		return;
...
void func_379() // Position - 0x303B4 Hash - 0x341F7E56 ^0xA99829BF
{
	if (iLocal_770.f_4 || iLocal_770.f_5 || iLocal_770.f_6)
	{
		iLocal_770.f_3 = 1;
	
		if (iLocal_770.f_8 == 1)
			_DEBUG_PRINT("Sync for skip is TRUE and Intro is queued!");
	}
	else
	{
		iLocal_770.f_3 = 0;
	...
	iLocal_770.f_5 = 0;
	iLocal_770.f_6 = 0;
	iLocal_770 = iLocal_770.f_8;
	iLocal_770.f_1 = 0;
	iLocal_770.f_2 = 0;
	return;
}

void func_380(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x304B4 Hash - 0x50B95D9E ^0x1806B4C4
{
	int i;
...
void func_381(int iParam0) // Position - 0x305A9 Hash - 0xCC905E76 ^0xB706E385
{
	iLocal_770.f_7 = iParam0;
	iLocal_770.f_6 = 1;
	return;
}

void func_382(var uParam0, var uParam1, var uParam2, float fParam3, int iParam4, int iParam5) // Position - 0x305BE Hash - 0xF88978B9 ^0xA249DBD8
{
	if (_IS_MISSION_REPLAY_IN_PROGRESS())
	{
...
int func_383() // Position - 0x30653 Hash - 0x8A8720E2 ^0x75007B29
{
...
int func_384(var uParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, Hash hParam6) // Position - 0x3067D Hash - 0x5758282F ^0x3A217FEC
{
	if (iParam5 != 0)
	{
		*uParam0 = iParam5;
		_DEBUG_PRINT("*** Epsilonist exists, grabbing ped index");
	}
	else
	{
		*uParam0 = PED::CREATE_PED(PED_TYPE_CIVFEMALE, hParam6, vParam1, fParam4, true, true);
		_DEBUG_PRINT("*** Epsilonist does not exist, creating new");
	}
...
void func_385(var uParam0) // Position - 0x30713 Hash - 0x4BEBFEF6 ^0xFA8FCFB
{
	Vector3 vector;

	vector = { uParam0->f_2 };
	func_386("Rock created at: ", uParam0->f_2);
	uParam0->f_1 = OBJECT::CREATE_OBJECT_NO_OFFSET(*uParam0, vector, true, true, false);

	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_1))
	{
		ENTITY::SET_ENTITY_ROTATION(uParam0->f_1, uParam0->f_5, 0, true);
		func_386("Rock rot vector: ", ENTITY::GET_ENTITY_ROTATION(uParam0->f_1, 0));
		func_386("Rock actual position: ", ENTITY::GET_ENTITY_COORDS(uParam0->f_1, false));
...
void func_386(char* sParam0, var uParam1, var uParam2, var uParam3) // Position - 0x30797 Hash - 0xD1C5EC88 ^0xD1C5EC88
{
	sParam0 = sParam0;
	uParam1 = { uParam1 };
	return;
...
void func_387() // Position - 0x307AB Hash - 0x33996964 ^0x86507BF1
{
	obLocal_623.f_2 = AUDIO::GET_SOUND_ID();
	obLocal_623.f_3 = AUDIO::GET_SOUND_ID();
	obLocal_623.f_4 = AUDIO::GET_SOUND_ID();
	obLocal_623.f_5 = AUDIO::GET_SOUND_ID();
	obLocal_623.f_12 = 0.92f;
	obLocal_623.f_13 = 0;
	obLocal_623.f_14 = "NO_RECENT_ANIM";
	iLocal_163 = GRAPHICS::REQUEST_SCALEFORM_MOVIE("digiscanner");

	while (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_163))
	{
		SYSTEM::WAIT(0);
	}
	...
	HUD::LINK_NAMED_RENDERTARGET(hLocal_158);

	if (HUD::IS_NAMED_RENDERTARGET_REGISTERED("digiscanner"))
		iLocal_164 = HUD::GET_NAMED_RENDERTARGET_RENDER_ID("digiscanner");

	return;
}

void func_388() // Position - 0x30842 Hash - 0xF0334FED ^0xAC038C54
{
	iLocal_770.f_4 = 0;
	iLocal_770.f_5 = 0;
	iLocal_770.f_6 = 0;
...
void func_389() // Position - 0x30868 Hash - 0x463A038A ^0xE41B0D8
{
	func_405(joaat("prop_tv_test"), 1751.65f, 4676.77f, 43.03f, -2.33f, 0.99f, 91.36f);
	func_404(1755.4631f, 4678.6196f, 44.1477f, -9.5251f, 0f, 122.2955f, 50.832f);
	func_403(3f, -4.5f, 0f);
	func_402(1689.951f, 4762.6133f, 40.9216f, 272.5499f);
	func_401(1779.514f, 4691.4473f, 39.345768f, 1744.225f, 4674.6465f, 46.84829f, 16.5f);
	func_400("EPS4_JCHAT1", sLocal_159);
	func_399("EPS4_JGOOD", "EPS4_JBAD");
	func_398("EPS4_JRET1", "EPS4_JRET2");
	func_397("EPS4_JCLOSE");
	func_396(0f, 0f, 0f);
	func_395(30f, 115f, 0.9f);
	func_405(joaat("prop_battery_01"), 1756.68f, 4832.28f, 39.43f, 90f, 13.21f, 78.57f);
	func_404(1758.0319f, 4826.5605f, 41.459f, -11.6785f, 0f, 6.5381f, 34.3083f);
	func_403(2f, 4f, 0f);
	func_402(1690.2666f, 4769.9937f, 40.9216f, 269.3043f);
	func_401(1750.0653f, 4833.117f, 36.87026f, 1763.2238f, 4831.8223f, 43.542503f, 13.75f);
	func_400("EPS4_MCHAT1", "EPS4_MCHAT2");
	func_399("EPS4_MGOOD", "EPS4_MBAD");
	func_398("EPS4_MRET1", "EPS4_MRET2");
	func_397("EPS4_MCLOSE");
	func_396(0f, 0f, 0f);
	func_395(30f, 195f, 0.9f);
	func_405(joaat("prop_old_boot"), 1847.863f, 4756.059f, 36.71f, -70.53f, 75.48f, 132.44f);
	func_404(1829.3098f, 4756.158f, 42.4876f, -23.5614f, 0f, -92.2873f, 50f);
	func_403(7.5f, -7.5f, 0f);
	func_402(1689.7749f, 4777.7695f, 40.9216f, 267.4597f);
	func_401(1856.2178f, 4755.223f, 34.67169f, 1841.1143f, 4755.489f, 41.434017f, 13.75f);
	func_400("EPS4_PCHAT1", "EPS4_PCHAT2");
	func_399("EPS4_PGOOD", "EPS4_PBAD");
	func_398(sLocal_159, "EPS4_PRET2");
	func_397("EPS4_PCLOSE");
	func_396(0f, 0f, 0f);
	func_395(20.5f, 155f, 0.9f);
	func_394(1820.1013f, 4701.0986f, 38.545f, 280.7432f, 0);
	func_394(1803.0437f, 4700.244f, 39.3123f, 72.1396f, 0);
	func_394(1820.4816f, 4672.5347f, 35.6368f, 253.4126f, 0);
	func_394(1819.8701f, 4694.0303f, 38.408f, 231.2265f, 0);
	func_394(1807.1217f, 4684.4185f, 38.5566f, 150.6129f, 0);
	func_394(1791.058f, 4689.403f, 40.5128f, 103.4073f, 0);
	func_394(1872.6261f, 4718.827f, 37.2889f, 210.8288f, 1);
	iLocal_758 = func_394(1764.089f, 4665.8794f, 42.3031f, 281.6336f, 2);
	iLocal_760 = func_394(1814.27f, 4651.32f, 37.58f, 173.1089f, 0);
	iLocal_759 = func_394(1846.5121f, 4705.6143f, 38.1214f, 25.7591f, 3);
	iLocal_761 = func_394(1790.4141f, 4722.897f, 37.8533f, 221.4777f, 0);
	func_393(&uLocal_640);
	func_392(&uLocal_640, 1897.42f, 4596.51f, 36.4f);
	func_392(&uLocal_640, 1912.2f, 4676.93f, 39.44f);
	func_392(&uLocal_640, 1886.09f, 4733.68f, 39.48f);
	func_392(&uLocal_640, 1800.24f, 4820.64f, 40.96f);
	func_392(&uLocal_640, 1796.556f, 4893.541f, 40.4741f);
	func_392(&uLocal_640, 1782.6514f, 4916.3325f, 41.4418f);
	func_392(&uLocal_640, 1746.5521f, 4942.362f, 42.8677f);
	func_392(&uLocal_640, 1702.5366f, 4893.8237f, 36.7751f);
	func_392(&uLocal_640, 1707.2734f, 4814.8096f, 40.9407f);
	func_392(&uLocal_640, 1729.46f, 4655.21f, 42.61f);
	func_392(&uLocal_640, 1772.0504f, 4602.1426f, 36.457f);
	func_391(&uLocal_640);
	func_390(&uLocal_692, &uLocal_640, 20f);
	return;
}

void func_390(var uParam0, var uParam1, float fParam2) // Position - 0x30D42 Hash - 0x6C5CF72A ^0xFC560CB2
{
	int num;
	int num2;
	int num3;
	...
	while (num2 < uParam1->f_46)
	{
		...
		if (func_335(uParam1, uParam1->[num2 /*3*/] + num6))
			num6 = { -num6 };
...
void func_391(var uParam0) // Position - 0x30E4F Hash - 0x6A0A7C37 ^0x4AB04E31
{
	int i;
	float num;
...
void func_392(var uParam0, float fParam1, float fParam2, float fParam3) // Position - 0x30EEF Hash - 0x488A8B25 ^0x21309DD6
{
	uParam0->f_51 == 0;
	uParam0->f_46 >= 15;
...
void func_393(var uParam0) // Position - 0x30F20 Hash - 0x94803123 ^0x38D79261
{
	uParam0->f_51;
	uParam0->f_46 = 0;
...
int func_394(float fParam0, float fParam1, float fParam2, float fParam3, int iParam4) // Position - 0x30F47 Hash - 0x268F2FDA ^0x9221552F
{
	int num;

	iLocal_603 >= 11;
	num = iLocal_603;
	iLocal_603 = iLocal_603 + 1;
	uLocal_536[num /*6*/] = { fParam0 };
	uLocal_536[num /*6*/].f_3 = fParam3;
	uLocal_536[num /*6*/].f_4 = iParam4;
	uLocal_536[num /*6*/].f_5 = 0;
	return num;
}

void func_395(float fParam0, float fParam1, float fParam2) // Position - 0x30F93 Hash - 0x946B5DDC ^0xD43D1917
{
	int num;

	num = iLocal_534 - 1;
	num < 0;
	uLocal_361[num /*43*/].f_21 = fParam0;
	uLocal_361[num /*43*/].f_23 = fParam1;
	uLocal_361[num /*43*/].f_22 = fParam2;
	return;
}

void func_396(float fParam0, float fParam1, float fParam2) // Position - 0x30FC9 Hash - 0x946B5DDC ^0x38AA483E
{
	int num;

	num = iLocal_534 - 1;
	num < 0;
	uLocal_361[num /*43*/].f_18 = fParam0;
	uLocal_361[num /*43*/].f_19 = fParam1;
	uLocal_361[num /*43*/].f_20 = fParam2;
	return;
}

void func_397(char* sParam0) // Position - 0x30FFF Hash - 0x70CBC01F ^0x4B31C1F0
{
	int num;

	num = iLocal_534 - 1;
	num < 0;
	uLocal_361[num /*43*/].f_42 = sParam0;
	return;
}

void func_398(char* sParam0, char* sParam1) // Position - 0x3101F Hash - 0x216520B8 ^0xBBC373BD
{
	int num;

	num = iLocal_534 - 1;
	num < 0;
	uLocal_361[num /*43*/].f_38 = sParam0;
	uLocal_361[num /*43*/].f_39 = sParam1;
	return;
}

void func_399(char* sParam0, char* sParam1) // Position - 0x3104A Hash - 0x216520B8 ^0x87158E26
{
	int num;

	num = iLocal_534 - 1;
	num < 0;
	uLocal_361[num /*43*/].f_40 = sParam0;
	uLocal_361[num /*43*/].f_41 = sParam1;
	return;
}

void func_400(char* sParam0, char* sParam1) // Position - 0x31075 Hash - 0x216520B8 ^0xF064093C
{
	int num;

	num = iLocal_534 - 1;
	num < 0;
	uLocal_361[num /*43*/].f_36 = sParam0;
	uLocal_361[num /*43*/].f_37 = sParam1;
	return;
}

void func_401(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x310A0 Hash - 0xA81F562E ^0x843CFA29
{
	int num;

	num = iLocal_534 - 1;
	num < 0;
	uLocal_361[num /*43*/].f_25 = { fParam0 };
	uLocal_361[num /*43*/].f_25 = { fParam3 };
	uLocal_361[num /*43*/].f_31 = fParam6;
	return;
}

void func_402(float fParam0, float fParam1, float fParam2, float fParam3) // Position - 0x310DE Hash - 0x77DB54A1 ^0x17B839BD
{
	int num;

	num = iLocal_534 - 1;
	num < 0;
	uLocal_361[num /*43*/].f_32 = { fParam0 };
	uLocal_361[num /*43*/].f_35 = fParam3;
	return;
}

void func_403(float fParam0, float fParam1, float fParam2) // Position - 0x3110D Hash - 0xF294B3D3 ^0xBF67768
{
	int num;

	num = iLocal_534 - 1;
	num < 0;
	uLocal_361[num /*43*/].f_15 = { fParam0 };
	return;
}

void func_404(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x31131 Hash - 0xA81F562E ^0xAC7ED43B
{
	int num;

	num = iLocal_534 - 1;
	num < 0;
	uLocal_361[num /*43*/].f_8 = { fParam0 };
	uLocal_361[num /*43*/].f_11 = { fParam3 };
	uLocal_361[num /*43*/].f_14 = fParam6;
	return;
}

void func_405(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x3116F Hash - 0xCD3F6FDF ^0xFA45A716
{
	int num;

	iLocal_534 >= 4;
	num = iLocal_534;
	iLocal_534 = iLocal_534 + 1;
	uLocal_361[num /*43*/] = iParam0;
	uLocal_361[num /*43*/].f_2 = { fParam1 };
	uLocal_361[num /*43*/].f_5 = { fParam4 };
	uLocal_361[num /*43*/].f_23 = 150f;
	uLocal_361[num /*43*/].f_24 = -1f;
	uLocal_361[num /*43*/].f_36 = sLocal_159;
	uLocal_361[num /*43*/].f_37 = sLocal_159;
	uLocal_361[num /*43*/].f_38 = sLocal_159;
	uLocal_361[num /*43*/].f_39 = sLocal_159;
	uLocal_361[num /*43*/].f_40 = sLocal_159;
	uLocal_361[num /*43*/].f_41 = sLocal_159;
	return;
}

void func_406() // Position - 0x3120C Hash - 0xE60F63BE ^0xE60F63BE
{
	func_408(0);
	func_288();
	func_407();
...
void func_407() // Position - 0x31221 Hash - 0xC95798F1 ^0x61ADB9D7
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			if (func_290(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 10.5f, 1, 1056964608, false, true, false))
...
void func_408(int iParam0) // Position - 0x31279 Hash - 0x7E11E9C ^0x544BF257
{
	if (func_228())
		return;
...
void _DEBUG_PRINT(char* sParam0) // Position - 0x312AC Hash - 0x6EF28A6B ^0x6EF28A6B
{
	sParam0 = sParam0;
	return;
}

int func_410(float fParam0, float fParam1, float fParam2, float fParam3) // Position - 0x312B8 Hash - 0x2E7DD541 ^0x2E7DD541
{
	var unk;
...
int func_411() // Position - 0x312EB Hash - 0x5A4670E ^0xE582B183
{
	return PED::ADD_SCENARIO_BLOCKING_AREA(1789.2f, 4658f, 30.73f, 1871.87f, 4745.51f, 40.17f, false, true, true, true, 1);
}

BOOL func_412(var uParam0) // Position - 0x3131A Hash - 0xE409E9BE ^0xD548A955
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_77)
	{
		case 0:
			...
			func_419(&(uParam0->f_48), "rcm_epsilonism4", "ep_4_rcm_marnie_base_marnie", "ep_4_rcm_marnie_lookaround_marnie");
			iLocal_77 = 1;
			break;
	
		case 1:
			if (!func_418(&num) || !func_416(&(uParam0->f_48)))
				return false;
		...
		case 2:
			...
			{
				if (func_413(&uParam0->f_28[0], CHAR_MARNIE, 1826.13f, 4698.88f, 38.92f, 21.63f, "EPSILON LAUNCHER RC - MARNIE", 1))
				{
			...
			{
				if (func_413(&uParam0->f_28[1], CHAR_JIMMY_BOSTON, 1827.24f, 4699.76f, 39.09f, 57.09f, "EPSILON LAUNCHER RC - JIMMY", 1))
				{
					...
					func_350(uParam0->f_28[1], 1827.24f, 4699.76f, 39.09f, 57.09f, true, true);
				}
				else
				{
					flag = false;
...
BOOL func_413(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x31547 Hash - 0x5E27D69A ^0xE8A3C3CE
{
	if (func_414(ppedParam0, echParam1, fParam2, fParam5, true))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
BOOL func_414(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x315A3 Hash - 0xC57592AD ^0x9AA0BE7
{
	Hash model;

	if (!func_171(echParam1))
	{
		model = func_445(echParam1);
...
int func_415(Entity eParam0, eCharacter echParam1) // Position - 0x31631 Hash - 0x5AC42C11 ^0x5AC42C11
{
	int num;
...
BOOL func_416(var uParam0) // Position - 0x31677 Hash - 0xB319BDFA ^0xA1F4DAFB
{
	if (func_417(uParam0))
	{
...
BOOL func_417(var uParam0) // Position - 0x316A1 Hash - 0x6329B93C ^0xCBBB8D92
{
...
BOOL func_418(var uParam0) // Position - 0x316C6 Hash - 0xC42B20E0 ^0x728F1DAE
{
	int i;
...
void func_419(var uParam0, char* sParam1, char* sParam2, char* sParam3) // Position - 0x316F7 Hash - 0x6EEDFC2 ^0xD51569DC
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x31733 Hash - 0x15889021 ^0xE7262364
{
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0x3175B Hash - 0x77F66043 ^0x77F66043
{
	if (Global_101392 == 10 || Global_101392 == 9)
		return true;
...
void func_422() // Position - 0x3177F Hash - 0x3A7082CA ^0xD77DEBB0
{
	func_351();
	...
	GRAPHICS::REMOVE_GRASS_CULL_SPHERE(iLocal_358);

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_604[0 /*8*/]) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_604[1 /*8*/]))
		if (PED::IS_PED_IN_GROUP(uLocal_604[0 /*8*/]))
			PED::REMOVE_PED_FROM_GROUP(uLocal_604[0 /*8*/]);
		else if (PED::IS_PED_IN_GROUP(uLocal_604[1 /*8*/]))
			PED::REMOVE_PED_FROM_GROUP(uLocal_604[1 /*8*/]);

	func_423(&uLocal_604[0 /*8*/], true, 1, 1);
	func_423(&uLocal_604[1 /*8*/], true, 1, 1);
	HUD::RELEASE_NAMED_RENDERTARGET("digiscanner");
	PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_160, false);
	PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_161, false);
	PATHFIND::REMOVE_NAVMESH_BLOCKING_OBJECT(iLocal_762);
	PATHFIND::REMOVE_NAVMESH_BLOCKING_OBJECT(iLocal_763);
	PATHFIND::REMOVE_NAVMESH_BLOCKING_OBJECT(iLocal_764);

	if (AUDIO::IS_AUDIO_SCENE_ACTIVE("EPSILONISM_04_MIX"))
	{
		_DEBUG_PRINT("Stopping dynamic mix EPSILONISM_04_MIX");
...
void func_423(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x31893 Hash - 0x34362197 ^0xC592197
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
BOOL func_424() // Position - 0x318E3 Hash - 0xBE5BC0C3 ^0x39FB8F89
{
	int num;
...
void func_425(BOOL bParam0) // Position - 0x31984 Hash - 0x7B759B34 ^0x4EF237EA
{
	int num;
	...
	if (!func_440())
	{
		...
		if (bParam0)
		{
			...
			func_426(SCRIPT::GET_THIS_SCRIPT_NAME(), num);
		}
		else
		{
			if (Global_113457[num /*10*/].f_9 == -1)
...
void func_426(const char* sParam0, int iParam1) // Position - 0x31A54 Hash - 0xF8D2A766 ^0x5740ACF1
{
	if (Global_101392 != 12)
		if (func_427(sParam0, 6, iParam1))
			Global_101392.f_1 = iParam1;

	return;
}

BOOL func_427(const char* sParam0, int iParam1, int iParam2) // Position - 0x31A7C Hash - 0x71022A4D ^0x7DE21930
{
	...
	if (func_433())
	{
		...
		{
			num = func_428(SCRIPT::GET_THIS_SCRIPT_NAME());
...
int func_428(char* sParam0) // Position - 0x31C0B Hash - 0x3ADFBBE4 ^0x7249D707
{
...
int func_429() // Position - 0x31C65 Hash - 0x2618AC69 ^0x91ED0F4F
{
	int num;
	int num2;

	num = func_430(&(Global_101392.f_3), false);
	num2 = 0;
...
int func_430(char* sParam0, BOOL bParam1) // Position - 0x31C89 Hash - 0xB77E1B23 ^0xEB3CA535
{
	Hash hashKey;
	int num;

	hashKey = MISC::GET_HASH_KEY(sParam0);
	num = func_431(hashKey, true);
	num == -1 && !bParam1;
	return num;
}

int func_431(Hash hParam0, BOOL bParam1) // Position - 0x31CB3 Hash - 0x486E1959 ^0x3A81F66C
{
	int i;
...
BOOL func_432() // Position - 0x31CE9 Hash - 0x4DEF90DC ^0x5BCA2C2E
{
...
BOOL func_433() // Position - 0x31D39 Hash - 0x5C8B3FB8 ^0x45F2ABEA
{
	...
	if (Global_101392.f_11 == 5)
		if (func_428(&(Global_101392.f_3)) > -1)
			return true;

	return false;
}

void func_434(BOOL bParam0) // Position - 0x31DA5 Hash - 0x7936EEB2 ^0x2BE2E139
{
...
void func_435(int iParam0) // Position - 0x31DB9 Hash - 0x3208FCBD ^0xBA877D65
{
	if (iParam0 == 1)
	{
		HUD::THEFEED_PAUSE();
...
void func_436(int iParam0) // Position - 0x31DF3 Hash - 0xFA45F741 ^0xA5B13A23
{
	if (iParam0 == 1)
	{
...
void func_437() // Position - 0x31E2D Hash - 0x9A142650 ^0x4D0752C1
{
	Global_23572.f_5 = 1;
	return;
}

void func_438() // Position - 0x31E3B Hash - 0xC30A8265 ^0x139DE662
{
	Global_23572.f_5 = 0;
	return;
}

void func_439() // Position - 0x31E49 Hash - 0xA68B3BE7 ^0xA68B3BE7
{
	Global_95548 = 0;
	Global_95549 = false;
	return;
...
BOOL func_440() // Position - 0x31E5B Hash - 0x25806CBF ^0x25806CBF
{
...
void func_441() // Position - 0x31E99 Hash - 0x7E381BB5 ^0x9B41A205
{
	Global_101427 = 1;
...
void func_442(char* sParam0) // Position - 0x31F8C Hash - 0x54B64147 ^0x56EEAFB9
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_443(var uParam0) // Position - 0x31F9E Hash - 0x23409181 ^0x17F55207
{
	func_444(&(uParam0->f_28));
	func_444(&(uParam0->f_35));
	func_444(&(uParam0->f_41));
	return;
}

void func_444(var uParam0) // Position - 0x31FBE Hash - 0x9B320D7B ^0x189EAC80
{
	int i;
...
Hash func_445(eCharacter echParam0) // Position - 0x31FF8 Hash - 0xBF0B24A5 ^0xBF0B24A5
{
	if (!func_171(echParam0))
		return func_170(echParam0);
	else
