#region Local Var
	...
	var uLocal_81 = 0;
	var uLocal_82 = 5;
	var uLocal_83 = 1076887552;
	var uLocal_84 = 0;
	var uLocal_85 = 0;
	var uLocal_86 = 0;
	var uLocal_87 = 0;
	var uLocal_88 = 1135869952;
	var uLocal_89 = 2;
	var uLocal_90 = 0;
	var uLocal_91 = 0;
	var uLocal_92 = 0;
	...
	var uLocal_106 = 0;
	var uLocal_107 = 5;
	var uLocal_108 = 1076887552;
	var uLocal_109 = 0;
	var uLocal_110 = 0;
	var uLocal_111 = 0;
	var uLocal_112 = 0;
	var uLocal_113 = 1135869952;
	var uLocal_114 = 2;
	var uLocal_115 = 0;
	var uLocal_116 = 0;
	var uLocal_117 = 0;
...
void main() // Position - 0x0 Hash - 0x5D84F89F ^0x5D84F89F
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(num[1]))
		num[1] = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1645.1455f, -1126.6127f, 17.4326f, 0.3f, joaat("prop_roller_car_02"), true, false, true);

	if (!ENTITY::DOES_ENTITY_EXIST(num[2]))
		num[2] = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1646.7676f, -1128.5453f, 17.4326f, 0.3f, joaat("prop_roller_car_02"), true, false, true);

	if (!ENTITY::DOES_ENTITY_EXIST(num[3]))
		num[3] = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1648.3896f, -1130.4784f, 17.4326f, 0.3f, joaat("prop_roller_car_02"), true, false, true);
	...
	for (i = 0; i < num; i = i + 1)
	{
		...
		{
			ENTITY::FREEZE_ENTITY_POSITION(num[i], true);
			ENTITY::SET_ENTITY_INVINCIBLE(num[i], true);
		}
	}
	...
	while (true)
	{
		...
		if (func_67(PLAYER::PLAYER_PED_ID(), unk, false) > 100f + 20f)
			func_77();
		...
		if (!func_66(14))
		{
			...
			else if (uLocal_72[0 /*24*/].f_9 == 0)
			{
				uLocal_72[0 /*24*/].f_9 = 15;
				uLocal_97[0 /*24*/].f_9 = 8;
				sLocal_38.f_9 = 0;
				sLocal_55.f_9 = 0;
			}
		}
		...
		if (func_64(64) != 0)
			func_56(64, 0, 0, true, 0);
	
		if (func_1(&uLocal_72, &sLocal_38, false, false, true, FRIEND))
			func_77();
...
BOOL func_1(var uParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, eStackSize essParam5) // Position - 0x2A0 Hash - 0x8996399F ^0x2E8DDA26
{
	int i;
	...
	switch (uParam1->f_13)
	{
				...
				for (i = 0; i < *uParam0; i = i + 1)
				{
					if (func_42(&uParam0->[i /*24*/]) && uParam0->[i /*24*/])
					{
						...
						if (uParam0->[i /*24*/].f_7 || MISC::GET_MISSION_FLAG() && uParam1->f_16 == 0)
							...
							func_41(uParam1, 2);
						else if (func_29() < uParam0->[uParam1->f_12 /*24*/].f_9)
							func_41(uParam1, 1);
						else if (func_24())
							func_41(uParam1, 7);
						else
		...
		case 2:
			...
			if (func_17(&uParam0->[uParam1->f_12 /*24*/]) || uParam0->[i /*24*/].f_8 == 0)
			{
				func_41(uParam1, 0);
				return false;
			}
		...
		case 1:
			if (!uParam1->f_9)
				func_12(uParam1, uParam1->f_2, uParam0->[uParam1->f_12 /*24*/].f_9);
		
			if (func_17(&uParam0->[uParam1->f_12 /*24*/]) || func_29() >= uParam0->[uParam1->f_12 /*24*/].f_9)
			{
				func_41(uParam1, 0);
				return false;
			}
		...
		case 6:
			...
			if (func_17(&uParam0->[uParam1->f_12 /*24*/]) || !func_45(uParam1->f_16))
			{
				func_41(uParam1, 0);
				return false;
			}
		...
		case 3:
			...
			if (func_17(&uParam0->[uParam1->f_12 /*24*/]) || bParam2 == false || !func_45(uParam1->f_16))
			{
				func_41(uParam1, 0);
				return false;
			}
		...
		case 8:
			...
			if (func_17(&uParam0->[uParam1->f_12 /*24*/]) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0)
			{
				func_41(uParam1, 0);
				return false;
			}
		...
		case 9:
			...
			if (func_17(&uParam0->[uParam1->f_12 /*24*/]) || func_9(&uParam0->[uParam1->f_12 /*24*/]))
			{
				func_41(uParam1, 0);
				return false;
			}
		...
		case 4:
			...
			if (func_29() < uParam0->[uParam1->f_12 /*24*/].f_9)
			{
				func_41(uParam1, 1);
				return false;
			}
			...
			if (!uParam1->f_9)
				func_12(uParam1, *uParam1, uParam0->[uParam1->f_12 /*24*/].f_9);
			...
			if (PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_CONTEXT) && uParam1->f_9 == 1)
				if (!func_9(&uParam0->[uParam1->f_12 /*24*/]))
					func_41(uParam1, 9);
				else
					func_41(uParam1, 5);
			break;
...
int func_2(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x9E2 Hash - 0xEF9D4F61 ^0xC848BDEA
{
...
void func_3(Vehicle veParam0) // Position - 0xA39 Hash - 0x94E8CB0B ^0x47923A23
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_4(BOOL bParam0, BOOL bParam1) // Position - 0xA65 Hash - 0xC86614C6 ^0xCD39041A
{
...
int _GET_VEHICLE_SEAT_PED_IS_IN(Ped ped, BOOL includeLastVehicle) // Position - 0xBB6 Hash - 0x4E1330D6 ^0x886EF094
{
...
BOOL func_6(BOOL bParam0) // Position - 0xC3B Hash - 0xBC517E8E ^0xBC517E8E
{
	if (bParam0)
		if (func_7())
			return true;
...
BOOL func_7() // Position - 0xC61 Hash - 0x10D488D5 ^0x92DBA025
{
	if (Global_113314)
		return true;

	if (!func_66(14) && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("director_mode")) > 0)
		return true;

	return false;
}

void func_8() // Position - 0xC93 Hash - 0x9A142650 ^0xE9E53C81
{
	Global_23572.f_6 = 1;
	return;
}

BOOL func_9(var uParam0) // Position - 0xCA1 Hash - 0xF5F2B273 ^0xF18782D6
{
	var entityRotation;
	Ped vehiclePedIsIn;
	Ped ped;
	...
	if (func_10(uParam0->f_12, entityRotation) > SYSTEM::COS(uParam0->f_15))
		return 1;

	return 0;
}

float func_10(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xD4A Hash - 0x9ECDD667 ^0x170D4E4C
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1);
}

BOOL func_11() // Position - 0xD61 Hash - 0xBAE5BE54 ^0x8C6F0E0A
{
	Vehicle vehiclePedIsIn;
...
int func_12(var uParam0, const char* sParam1, int iParam2) // Position - 0xD9B Hash - 0x8355FF75 ^0x5A8F0C8E
{
...
void func_13(const char* sParam0, int iParam1) // Position - 0xDE7 Hash - 0xAFD19873 ^0xBBBE5748
{
...
BOOL func_14(var uParam0) // Position - 0xE03 Hash - 0x3512D277 ^0xF9635378
{
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(const char* message) // Position - 0xE5D Hash - 0xCD6A3595 ^0xB0E86AA0
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(message);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

BOOL func_16(const char* sParam0, int iParam1) // Position - 0xE70 Hash - 0xCB708C57 ^0xEA56376
{
...
BOOL func_17(var uParam0) // Position - 0xE89 Hash - 0x4C14E206 ^0x9590158A
{
	var unk;
	...
	if (uParam0->f_11 == 0)
		return !func_20(PLAYER::PLAYER_PED_ID(), uParam0->f_1, uParam0->f_10 + 2f, true);

	unk = { func_18(uParam0->f_16, 2f) };
	return !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), unk[0 /*3*/], unk[1 /*3*/], unk.f_7, false, true, 0);
}

struct<8> func_18(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, float fParam8) // Position - 0xF2D Hash - 0xA273CE48 ^0xA273CE48
{
	var unk;
	var unk9;

	unk = 2;
	unk9 = { func_19(uParam0[1 /*3*/] - uParam0[0 /*3*/]) * { fParam8, fParam8, fParam8 } };
...
Vector3 func_19(float fParam0, var uParam1, var uParam2) // Position - 0xF8F Hash - 0xFB6A39D2 ^0x80C9C759
{
	float num;
	float num2;
...
BOOL func_20(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5) // Position - 0xFCE Hash - 0x9A4C1B16 ^0x6EACDAB9
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(pedParam0, bParam5), vParam1) <= fParam4 * fParam4;
}

int func_21(var uParam0, const char* sParam1) // Position - 0xFEC Hash - 0xAB97D92D ^0x632C2B75
{
	if (MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		return 0;
...
void func_22(const char* sParam0) // Position - 0x1035 Hash - 0x99A98712 ^0xE46BE9F0
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, true, true, -1);
	return;
...
void func_23(var uParam0) // Position - 0x104B Hash - 0x46411C7A ^0x1AD808B0
{
	if (func_14(uParam0))
		HUD::CLEAR_HELP(true);
...
BOOL func_24() // Position - 0x1078 Hash - 0xC58A5FA9 ^0x73B964DD
{
	Vehicle vehiclePedIsIn;
	...
	if (func_28(vehiclePedIsIn))
		return true;

	if (func_25(vehiclePedIsIn, 3))
		return true;

	return !VEHICLE::IS_VEHICLE_DRIVEABLE(vehiclePedIsIn, false);
}

BOOL func_25(Vehicle veParam0, int iParam1) // Position - 0x10CC Hash - 0xA2B23595 ^0x26123F56
{
	int num;
...
BOOL func_26(Vehicle veParam0) // Position - 0x1168 Hash - 0x7E47BB06 ^0x692E6B64
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Vehicle veParam0) // Position - 0x1192 Hash - 0x3D210083 ^0xF7E7C389
{
...
BOOL func_28(Vehicle veParam0) // Position - 0x11B3 Hash - 0x2E9AC124 ^0x5164B34A
{
	if (ENTITY::DOES_ENTITY_EXIST(veParam0))
		if (ENTITY::IS_ENTITY_DEAD(veParam0, false))
			return true;
...
int func_29() // Position - 0x11F6 Hash - 0x177E4C87 ^0x8B4FC090
{
...
int func_30(int iParam0) // Position - 0x1244 Hash - 0xE4CEEC2C ^0xE4CEEC2C
{
	return Global_61212[iParam0];
}

eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x1253 Hash - 0x3C5423D7 ^0x3C5423D7
{
	func_32();
	return Global_114370.f_2366.f_539.f_4321;
}

void func_32() // Position - 0x126C Hash - 0xD1F2D853 ^0xF9F5FD4D
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114370.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_33(character) && !func_66(14) || Global_113320)
			{
...
BOOL func_33(eCharacter echParam0) // Position - 0x1369 Hash - 0x8907F004 ^0x8907F004
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x1375 Hash - 0xAC4E9801 ^0xB379A75F
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x13B2 Hash - 0xADCB9755 ^0xADCB9755
{
...
Hash func_36(eCharacter echParam0) // Position - 0x13D7 Hash - 0xE4CEEC2C ^0xE4CEEC2C
{
	return Global_2139[echParam0 /*29*/];
}

int func_37(Player plParam0) // Position - 0x13E6 Hash - 0xB3F5DAA8 ^0xB3F5DAA8
{
	int num;

	num = func_38(plParam0);
	return num;
}

int func_38(Player plParam0) // Position - 0x13F8 Hash - 0x7998C8F7 ^0x50053313
{
	if (plParam0 > -1)
		if (plParam0 == PLAYER::PLAYER_ID())
			return MONEY::NETWORK_GET_VC_WALLET_BALANCE(-1);
		else if (func_39(plParam0))
...
BOOL func_39(Player plParam0) // Position - 0x143B Hash - 0x392A396A ^0x1DEEBA83
{
	if (!func_40(plParam0))
		return false;
...
BOOL func_40(Player plParam0) // Position - 0x145A Hash - 0x6A46C9B4 ^0x6A46C9B4
{
	Player player;
...
void func_41(var uParam0, int iParam1) // Position - 0x147C Hash - 0x948772F0 ^0xC07820E1
{
...
BOOL func_42(var uParam0) // Position - 0x1490 Hash - 0x94D713D7 ^0x5446E692
{
	func_68(PLAYER::PLAYER_PED_ID());
	...
	return func_20(PLAYER::PLAYER_PED_ID(), uParam0->f_1, uParam0->f_10, true);
}

BOOL func_43() // Position - 0x1549 Hash - 0x44A439DC ^0x3D5209CD
{
	return MISC::GET_GAME_TIMER() <= Global_23711.f_6481 + 100;
}

BOOL func_44(BOOL bParam0) // Position - 0x155E Hash - 0x1F743529 ^0xDFDFCA73
{
	if (bParam0)
...
BOOL func_45(int iParam0) // Position - 0x1587 Hash - 0x717ACAE8 ^0x20195B72
{
	if (iParam0 == 0)
		if (func_65())
			return false;
...
BOOL func_46(Player plParam0) // Position - 0x15F3 Hash - 0x85F8BECA ^0x85F8BECA
{
	if (func_49(plParam0))
		return true;
...
BOOL func_47(Player plParam0) // Position - 0x1616 Hash - 0xE40D6326 ^0xE40D6326
{
	Player player;
	...
	if (player != -1)
		return func_48(plParam0, 9);

	return false;
}

BOOL func_48(Player plParam0, int iParam1) // Position - 0x1634 Hash - 0x7CD5054C ^0x870BEA81
{
	return IS_BIT_SET(Global_1886967[plParam0 /*609*/].f_10.f_4, iParam1);
}

BOOL func_49(Player plParam0) // Position - 0x164C Hash - 0x295F4323 ^0xC9EF0000
{
	Player player;
...
BOOL func_50(int iParam0) // Position - 0x166F Hash - 0xE8921B44 ^0x4F063755
{
	if (iParam0 == 1)
...
void func_51(var uParam0) // Position - 0x16C6 Hash - 0x46261827 ^0x6A7ACEE5
{
	if (uParam0->f_11 == 1)
...
void func_52(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x16FB Hash - 0x608B27C3 ^0x72A9B272
{
	int i;
	float num;
	float num2;
...
void func_53(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x17B0 Hash - 0xAFA32A88 ^0xC11A84EF
{
	func_54(uParam0->[0 /*3*/], uParam0->[1 /*3*/], uParam0->f_7, iParam1, iParam2, iParam3, iParam4);
	return;
}

void func_54(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10) // Position - 0x17D6 Hash - 0x343DF434 ^0x343DF434
{
	var unk;
	var unk4;
	float num;
	...
	unk = { func_19(uParam3 - uParam0) };
	unk4 = { func_55(unk, 0f, 0f, 1f) };
	num = fParam6 / 2f;
	unk13 = 8;
	unk7 = { uParam0 };
	unk10 = { uParam3 };
...
Vector3 func_55(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x19E6 Hash - 0xFED631D9 ^0x4FB6D3D3
{
...
void func_56(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x1A1F Hash - 0xECB6BFBA ^0x4A87976F
{
	if (iParam0 != 198)
	{
		if (Global_79248)
		...
		func_59(iParam0, bParam3, iParam4, false);
...
void func_57(int iParam0, int iParam1) // Position - 0x1A77 Hash - 0x45677974 ^0x367715F6
{
	switch (iParam0)
	{
		case 12:
...
void func_58(int iParam0, BOOL bParam1) // Position - 0x1B53 Hash - 0xF0703301 ^0x756A9364
{
	if (bParam1)
...
BOOL func_59(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x1B7C Hash - 0x72F8706 ^0xBE0DD95D
{
	BOOL flag;
	int num;
	int num2;
...
BOOL func_60() // Position - 0x24E1 Hash - 0x6134FBB2 ^0x82030B41
{
	if (func_62() == -1 || func_62() == 999 && !(func_61() == 0))
		return true;

	return false;
}

int func_61() // Position - 0x2511 Hash - 0x21D64237 ^0x21D64237
{
	return Global_32829;
}

int func_62() // Position - 0x251C Hash - 0x21D64237 ^0x21D64237
{
	return Global_32828;
}

int func_63(var uParam0, int iParam1) // Position - 0x2527 Hash - 0x5A2CB71 ^0x1D338919
{
	int i;
...
int func_64(int iParam0) // Position - 0x5D6A Hash - 0x1F7BC62B ^0x6B7721DF
{
	if (iParam0 != 198)
		if (Global_79248)
...
BOOL func_65() // Position - 0x5DA0 Hash - 0x1CB029D8 ^0x1CB029D8
{
	if (Global_43922 == 15)
		return false;
...
BOOL func_66(int iParam0) // Position - 0x5DB5 Hash - 0x937D8816 ^0x937D8816
{
	return Global_43922 == iParam0;
}

float func_67(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x5DC3 Hash - 0xC22B942A ^0xE0DB8793
{
...
BOOL func_68(Vehicle veParam0) // Position - 0x5DFD Hash - 0x251F0A94 ^0x6A446318
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0))
		return false;
...
void func_69() // Position - 0x5E1B Hash - 0x160837B9 ^0x3567845B
{
	if (func_66(14))
	{
		func_75(&uLocal_97[0 /*24*/], 0, "Bigwheel", func_76(158), 0, "", 0, 6.2f);
		func_70(&uLocal_72[0 /*24*/], 0, "Rollercoaster", -1651.6411f, -1134.325f, 21.903982f, -1640.9845f, -1121.5903f, 16.503132f, 6.75f, 0, "", 0);
	}
	else
	{
		func_75(&uLocal_97[0 /*24*/], 0, "Bigwheel", func_76(158), 8, "", 0, 6.2f);
		func_70(&uLocal_72[0 /*24*/], 0, "Rollercoaster", -1651.6411f, -1134.325f, 21.903982f, -1640.9845f, -1121.5903f, 16.503132f, 6.75f, 15, "", 0);
	}
...
void func_70(var uParam0, int iParam1, char* sParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, float fParam9, int iParam10, char* sParam11, int iParam12) // Position - 0x5F2D Hash - 0xAA3EF073 ^0x360A7098
{
	uParam0->f_5 = sParam2;
	...
	*uParam0 = 1;
	...
	uParam0->f_15 = 360f;
	func_74(&(uParam0->f_16), fParam3, fParam6, fParam9);
	uParam0->f_1 = { func_71(uParam0->f_16) };
	return;
}

Vector3 func_71(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x5F96 Hash - 0xBEF52C41 ^0xBEF52C41
{
	return func_72(uParam0[0 /*3*/], uParam0[1 /*3*/], 0.5f, true);
}

Vector3 func_72(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x5FB6 Hash - 0x2B576588 ^0x2B576588
{
	if (bParam7)
		fParam6 = func_73(fParam6, 0f, 1f);

	return uParam0 + ({ fParam6, fParam6, fParam6 } * (uParam3 - uParam0));
}

float func_73(float fParam0, float fParam1, float fParam2) // Position - 0x5FDF Hash - 0xF4DC03E3 ^0xF4DC03E3
{
	if (fParam0 > fParam2)
		return fParam2;
...
void func_74(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7) // Position - 0x6006 Hash - 0x99D8DEA4 ^0x8C54318C
{
	uParam0->[0 /*3*/] = { uParam1 };
	uParam0->[1 /*3*/] = { uParam4 };
	uParam0->f_7 = fParam7;
...
void func_75(var uParam0, int iParam1, char* sParam2, var uParam3, var uParam4, var uParam5, int iParam6, char* sParam7, int iParam8, float fParam9) // Position - 0x602A Hash - 0x372A5F05 ^0x40F3047B
{
	uParam0->f_5 = sParam2;
	uParam0->f_1 = { uParam3 };
	uParam0->f_4 = sParam7;
...
Vector3 func_76(int iParam0) // Position - 0x609F Hash - 0x95581D1A ^0x95581D1A
{
	int num;
...
void func_77() // Position - 0x60B7 Hash - 0xB7489E5A ^0xAB8A36B8
{
	func_78(&uLocal_97[0 /*24*/]);
	func_78(&uLocal_72[0 /*24*/]);
	func_23(&sLocal_38);
	func_23(&sLocal_55);
	SCRIPT::TERMINATE_THIS_THREAD();
	return;
...
void func_78(var uParam0) // Position - 0x60E1 Hash - 0x4918B04C ^0x4918B04C
{
	*uParam0 = 0;
	return;
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x60ED Hash - 0x16E871AD ^0x10C54C39
{
