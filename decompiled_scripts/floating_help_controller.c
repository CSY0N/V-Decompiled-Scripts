...
void func_1() // Position - 0x1C Hash - 0xF933B2AA ^0x12BAFCE2
{
	...
	for (i = 0; i < Global_113021; i = i + 1)
	{
		if (Global_113021[i /*28*/].f_21 != 0)
		{
			...
			if (MISC::GET_GAME_TIMER() > Global_113021[i /*28*/].f_21 && Global_113021[i /*28*/].f_21 != -1)
			{
				if (func_3(i))
			...
			else if (func_3(i))
			{
				if (Global_113021[i /*28*/].f_21 != -1)
				{
					...
					{
						Global_113021[i /*28*/].f_21 = Global_113021[i /*28*/].f_21 + SYSTEM::ROUND(MISC::GET_FRAME_TIME() * 1000f);
					
						if (HUD::IS_FLOATING_HELP_TEXT_ON_SCREEN(hudIndex))
							MISC::SET_BIT(&(Global_113021[i /*28*/].f_27), 0);
					}
				}
			
				if (Global_113021[i /*28*/].f_24.f_2 != 9999f)
					if (Global_113021[i /*28*/].f_23 != 0)
						if (!ENTITY::IS_ENTITY_DEAD(Global_113021[i /*28*/].f_23, false))
							if (!IS_BIT_SET(Global_113021[i /*28*/].f_27, 3))
								HUD::SET_FLOATING_HELP_TEXT_WORLD_POSITION(hudIndex, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Global_113021[i /*28*/].f_23, Global_113021[i /*28*/].f_24));
							else
								HUD::SET_FLOATING_HELP_TEXT_TO_ENTITY(hudIndex, Global_113021[i /*28*/].f_23, Global_113021[i /*28*/].f_24, Global_113021[i /*28*/].f_24.f_1);
					else if (Global_113021[i /*28*/].f_24 != 0f || Global_113021[i /*28*/].f_24.f_1 != 0f || Global_113021[i /*28*/].f_24.f_2 != 0f)
						HUD::SET_FLOATING_HELP_TEXT_WORLD_POSITION(hudIndex, Global_113021[i /*28*/].f_24);
				else
					HUD::SET_FLOATING_HELP_TEXT_SCREEN_POSITION(hudIndex, Global_113021[i /*28*/].f_24, Global_113021[i /*28*/].f_24.f_1);
			}
			else if (MISC::GET_GAME_TIMER() - Global_113021[i /*28*/].f_22 > 1000)
			{
				func_2(i);
			}
		}
