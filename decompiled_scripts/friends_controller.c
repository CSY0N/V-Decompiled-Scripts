...
void main() // Position - 0x0
{
	...
	for (i = 0; i < 9; i = i + 1)
	{
		if (Global_97369[i /*2*/] == -1)
		{
			if (IS_BIT_SET(Global_113969.f_18106.f_175[i /*19*/].f_18, 1))
			{
				func_472(i, 0);
	...
	{
		SYSTEM::WAIT(0);
		Global_97247 = _GET_CURRENT_PLAYER_CHARACTER_0();
	
		if (Global_97247 == _CHAR_NULL)
		{
			bLocal_94;
		}
		else
		{
			...
			{
				if (func_470(iLocal_95, &unk))
					func_421(iLocal_95, unk);
			
				iLocal_95 = (iLocal_95 + 1) % 9;
			
				if (!Global_113969.f_18106.f_398)
				{
					if (Global_113969.f_18106.f_406)
					{
						switch (func_419("AM_H_NOFRND" /*Friends will not always be available to Hang Out when you call. They may have things to do or could even be asleep.*/))
						{
							case 2:
								func_418("AM_H_NOFRND" /*Friends will not always be available to Hang Out when you call. They may have things to do or could even be asleep.*/, 2, 0, 1000, 7500, 7, 0, 0, 0);
								break;
						
							case 1:
								Global_113969.f_18106.f_398 = 1;
								break;
						}
					}
				}
				...
				if (Global_97359 == 4)
					if (func_417(0) || func_417(3) || func_417(2))
						func_416(Global_97360, 5, Global_97361);
				else if (Global_97359 == 5)
					if (!func_415())
						func_414(Global_97360);
			
				if (MISC::GET_FRAME_COUNT() % 10 == 0)
				{
					if (!SCRIPT::IS_THREAD_ACTIVE(Global_113969.f_18106.f_395))
					{
						if (func_413(&Global_113969.f_18106.f_362[iLocal_96 /*3*/]))
							if (Global_113969.f_18106.f_381[iLocal_96] == -1 || !func_412(Global_113969.f_18106.f_381[iLocal_96]) || func_411(Global_113969.f_18106.f_381[iLocal_96]) == 6)
								func_409(iLocal_96);
...
BOOL func_1() // Position - 0x271
{
	if (!func_415())
		return true;

	if (func_417(6) || func_417(7) || func_417(2) || func_417(5) || func_417(17) || func_417(18))
		return true;
...
void func_2(var uParam0, var uParam1) // Position - 0x2CB
{
	...
	if (func_408() || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		if (uParam0->f_49 == 0)
		{
			if (func_407(Global_98991.f_45) && !PED::IS_PED_INJURED(uParam0->[Global_98991.f_45 /*15*/].f_2))
				TASK::CLEAR_PED_TASKS(uParam0->[Global_98991.f_45 /*15*/].f_2);
		
			func_406(uParam0);
			func_405(uParam0, false);
	...
	else if (Global_44042 == 2)
	{
		func_403(uParam0, false);
	}
	else if (Global_44042 == 6 || Global_44042 == 7 && Global_97339 < 22)
	{
		func_403(uParam0, false);
	}
	...
	else
	{
		...
		if (uParam0->f_60 == 0)
		{
			...
			if (uParam0->f_50 != 0)
			{
				if (func_407(uParam0->f_51) && uParam0->[uParam0->f_51 /*15*/] == 3 || uParam0->[uParam0->f_51 /*15*/] == 4 || uParam0->[uParam0->f_51 /*15*/] == 5)
				{
					func_32(uParam0, uParam1);
				}
				else
				{
					if (func_407(uParam0->f_51))
...
void func_6(var uParam0) // Position - 0x721
{
	...
	func_22(Global_97247, uParam0->f_74, &unk41, &unk57);
...
void func_7(var uParam0) // Position - 0x834
{
	if (*uParam0 == -1)
		return;
...
BOOL func_9(Ped pedParam0) // Position - 0x91B
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0x93B
{
...
void func_11(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x95C
{
	if (bParam0)
	{
...
BOOL func_12() // Position - 0xAA9
{
	return IS_BIT_SET(Global_1845281[PLAYER::PLAYER_ID() /*883*/].f_36.f_18, 14);
}

BOOL func_13(Player plParam0, int iParam1) // Position - 0xAC3
{
	BOOL flag;
...
int func_14(int iParam0, BOOL bParam1) // Position - 0xB1C
{
	int num;
	int num2;
...
int func_15() // Position - 0xB5D
{
	return Global_1574926;
}

BOOL func_16(Player plParam0) // Position - 0xB69
{
	Player player;
...
BOOL func_17(Player plParam0) // Position - 0xB8B
{
...
BOOL func_18() // Position - 0xBCA
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_19(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xBD8
{
	int num;
...
void func_21(int iParam0) // Position - 0xC32
{
	if (iParam0 == 1)
...
void func_22(eCharacter echParam0, int iParam1, char* sParam2, char* sParam3) // Position - 0xC55
{
	if (echParam0 == 0)
	{
		if (iParam1 == 1)
...
void func_23(int iParam0, var uParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5) // Position - 0xD02
{
	switch (iParam0)
	{
		case 0:
...
void func_24(eCharacter echParam0, eCharacter echParam1, int iParam2) // Position - 0xDA0
{
	int num;
	int num2;
	int num3;
	...
	if (num3 != 10)
	{
		func_25(&(Global_113969.f_18106.f_175[num3 /*19*/].f_5));
...
void func_25(int* piParam0) // Position - 0xDED
{
	func_26(piParam0, 0f);
	return;
}

void func_26(int* piParam0, float fParam1) // Position - 0xDFC
{
...
float func_27(BOOL bParam0) // Position - 0xE27
{
	float num;
	float num2;
	int networkTime;
...
int func_28(int iParam0, int iParam1) // Position - 0xE7F
{
	int num;
...
int func_29(eCharacter echParam0) // Position - 0x1009
{
	if (echParam0 == 145)
		return 7;
...
int func_30(int iParam0) // Position - 0x1061
{
	return Global_2169[iParam0 /*29*/].f_11;
}

int func_31() // Position - 0x1072
{
...
void func_32(var uParam0, var uParam1) // Position - 0x1094
{
	int num;
	...
	{
		case 1:
			if (func_94(Global_97247, uParam0->f_51) > 2f * 60f || func_93(Global_97247, uParam0->f_51) != 2)
				func_92(uParam0, 2);
			else
				func_92(uParam0, 3);
			break;
		...
		case 2:
			if (func_90(uParam0, uParam1, Global_97247, uParam0->f_51, 31, false))
			{
				func_92(uParam0, 3);
				uParam0->f_47 = 1;
			}
		...
		case 4:
			if (uParam0->f_47 || func_90(uParam0, uParam1, Global_97247, uParam0->f_51, 11, true))
			{
				func_92(uParam0, 5);
				uParam0->f_47 = 1;
			}
		...
		case 5:
			if (func_70(uParam0, uParam1, Global_97247, uParam0->f_51, 0, 0))
				func_3(uParam0, &uParam0->[uParam0->f_51 /*15*/]);
			break;
	
		case 6:
			if (uParam0->f_47 || func_90(uParam0, uParam1, Global_97247, uParam0->f_51, 13, true))
			{
				func_92(uParam0, 7);
				uParam0->f_47 = 1;
			}
		...
		case 7:
			...
			if (func_70(uParam0, uParam1, Global_97247, uParam0->f_51, 0, 1))
				func_3(uParam0, &uParam0->[uParam0->f_51 /*15*/]);
			break;
		...
		case 11:
			if (func_70(uParam0, uParam1, Global_97247, uParam0->f_51, 0, 2))
				func_3(uParam0, &uParam0->[uParam0->f_51 /*15*/]);
			break;
		...
		case 9:
			if (func_70(uParam0, uParam1, Global_97247, uParam0->f_51, 1, 3))
				func_3(uParam0, &uParam0->[uParam0->f_51 /*15*/]);
			break;
		...
		case 13:
			if (func_90(uParam0, uParam1, uParam0->f_51, Global_97247, 21, true))
				func_3(uParam0, &uParam0->[uParam0->f_51 /*15*/]);
			break;
		...
		case 15:
			...
			if (uParam0->f_47 || uParam0->f_48 || func_90(uParam0, uParam1, Global_97247, uParam0->f_51, func_66(uParam0, false), true))
			{
				func_92(uParam0, 16);
				uParam0->f_47 = 1;
			}
		...
		case 14:
			...
			{
				if (uParam0->f_47 || uParam0->f_48 || func_90(uParam0, uParam1, uParam0->f_51, Global_97247, func_66(uParam0, false), true))
				{
					func_92(uParam0, 16);
					uParam0->f_47 = 1;
				}
			}
			else if (uParam0->f_47 || uParam0->f_48 || func_90(uParam0, uParam1, Global_97247, uParam0->f_51, func_66(uParam0, true), true))
			{
				func_92(uParam0, 16);
				uParam0->f_47 = 1;
			}
		...
		case 16:
			...
			if (uParam0->f_48 || func_90(uParam0, uParam1, Global_97247, uParam0->f_51, 16, true))
			{
		...
		case 18:
			if (func_90(uParam0, uParam1, Global_97247, uParam0->f_51, 19, true))
				func_92(uParam0, 19);
		...
		case 19:
			if (func_90(uParam0, uParam1, Global_97247, uParam0->f_51, 20, true))
			{
				func_3(uParam0, &uParam0->[uParam0->f_51 /*15*/]);
				func_55(uParam0);
			}
		...
		case 20:
			...
			if (func_90(uParam0, uParam1, Global_97247, uParam0->f_51, 17, true))
				func_92(uParam0, 21);
			break;
		...
		case 21:
			...
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) || func_90(uParam0, uParam1, Global_97247, uParam0->f_51, 18, true))
				func_92(uParam0, 22);
			break;
		...
		case 22:
			...
			if (func_54(Global_97247, uParam0->f_51, &num) && func_53(num) == 0)
			{
				func_472(num, 3);
				func_52(num, 3);
				uParam0->f_48 = 1;
		...
		case 23:
			...
			if (!func_54(Global_97247, uParam0->f_51, &num) || func_53(num) != 3 && func_53(num) != 4)
				func_3(uParam0, &uParam0->[uParam0->f_51 /*15*/]);
			break;
	
		case 25:
			if (uParam0->f_47 || func_90(uParam0, uParam1, Global_97247, uParam0->f_51, func_66(uParam0, false), true))
			{
				func_92(uParam0, 26);
				uParam0->f_47 = 1;
			}
		...
		case 24:
			if (!func_65(&uParam0->[uParam0->f_51 /*15*/]))
			{
				if (uParam0->f_47 || func_90(uParam0, uParam1, uParam0->f_51, Global_97247, func_66(uParam0, false), true))
				{
					func_92(uParam0, 26);
					uParam0->f_47 = 1;
				}
			}
			else if (uParam0->f_47 || func_90(uParam0, uParam1, Global_97247, uParam0->f_51, func_66(uParam0, true), true))
			{
				func_92(uParam0, 26);
				uParam0->f_47 = 1;
			}
		...
		case 26:
			if (func_90(uParam0, uParam1, Global_97247, uParam0->f_51, 14, true))
				func_92(uParam0, 27);
			break;
	
		case 27:
			if (func_90(uParam0, uParam1, uParam0->f_51, Global_97247, 20, true))
				func_40(uParam0);
			break;
		...
		case 30:
			if (func_90(uParam0, uParam1, Global_97247, uParam0->f_51, 15, true))
				func_92(uParam0, 31);
			break;
...
void func_33(int iParam0) // Position - 0x1898
{
	if (func_38())
		return;
...
void func_34(int iParam0) // Position - 0x18CB
{
	if (func_38())
		return;
...
void func_35(BOOL bParam0, BOOL bParam1) // Position - 0x1955
{
	if (bParam0)
	{
		if (func_37(0))
...
BOOL func_36() // Position - 0x19C9
{
	return IS_BIT_SET(Global_1956920, 5);
}

BOOL func_37(int iParam0) // Position - 0x19D7
{
	if (iParam0 == 1)
...
BOOL func_38() // Position - 0x1A2E
{
	return IS_BIT_SET(Global_1956920, 19);
}

void func_39() // Position - 0x1A3D
{
	Global_23692.f_6 = 1;
	return;
}

void func_40(var uParam0) // Position - 0x1A4B
{
	int i;
	int num;
...
int func_41(var uParam0) // Position - 0x1ACD
{
	int num;

	if (func_54(Global_97247, uParam0->f_1, &num))
		if (uParam0->f_11 == 1 || uParam0->f_11 == 3)
			return 1;
		else if (uParam0->f_11 == 2)
			return 3;
		else if (num == 0 && !func_51(17))
			if (!IS_BIT_SET(Global_113969.f_18106.f_410, 0))
				return 4;
			else
				return 29;
		else if (num == 2 && func_50(129))
			if (!IS_BIT_SET(Global_113969.f_18106.f_410, 1))
				return 6;
			else
				return 12;
		else if (num == 1 && func_50(135))
			if (!IS_BIT_SET(Global_113969.f_18106.f_410, 2))
				return 10;
			else
				return 12;
		else if (num == 0 && func_50(136))
			if (!IS_BIT_SET(Global_113969.f_18106.f_410, 3))
				return 8;
			else
				return 12;
		else if (func_49(Global_97247, uParam0->f_1, 0))
			if (func_48(func_29(Global_97247), func_29(uParam0->f_1)))
				if (func_46())
					return 24;
				else
					return 25;
...
BOOL func_42(var uParam0) // Position - 0x1C62
{
	int num;
	int num2;
	int num3;
	...
	if (Global_97359 == 0 || IS_BIT_SET(Global_97361, uParam0->f_1) && !func_49(Global_97247, uParam0->f_1, 1) && !func_49(Global_97247, uParam0->f_1, 2) && Global_113969.f_7691.f_919[Global_97247] != 5)
	{
		if (func_54(Global_97247, uParam0->f_1, &num))
		{
			num3 = func_45(&num2);
			...
			if (num2 != num)
				if (num3 == 0)
					...
					if (func_43(num, num2, &num4) && func_53(num4) == 0)
						if (Global_113969.f_18106.f_175[num4 /*19*/].f_2 == 0)
							return true;
		}
	}
...
BOOL func_43(int iParam0, int iParam1, var uParam2) // Position - 0x1D24
{
	int num;
	int num2;
	...
	if (Global_113969.f_18106.f_175[iParam0 /*19*/] == Global_113969.f_18106.f_175[iParam1 /*19*/])
	{
		num = Global_113969.f_18106.f_175[iParam0 /*19*/].f_1;
		num2 = Global_113969.f_18106.f_175[iParam1 /*19*/].f_1;
	}
	else if (Global_113969.f_18106.f_175[iParam0 /*19*/].f_1 == Global_113969.f_18106.f_175[iParam1 /*19*/].f_1)
	{
		num = Global_113969.f_18106.f_175[iParam0 /*19*/];
		num2 = Global_113969.f_18106.f_175[iParam1 /*19*/];
	}
	else if (Global_113969.f_18106.f_175[iParam0 /*19*/] == Global_113969.f_18106.f_175[iParam1 /*19*/].f_1)
	{
		num = Global_113969.f_18106.f_175[iParam0 /*19*/].f_1;
		num2 = Global_113969.f_18106.f_175[iParam1 /*19*/];
	}
	else if (Global_113969.f_18106.f_175[iParam0 /*19*/].f_1 == Global_113969.f_18106.f_175[iParam1 /*19*/])
	{
		num = Global_113969.f_18106.f_175[iParam0 /*19*/];
		num2 = Global_113969.f_18106.f_175[iParam1 /*19*/].f_1;
	}

	if (func_407(func_44(num)) || func_407(func_44(num2)))
	{
...
eCharacter func_44(int iParam0) // Position - 0x1E71
{
	switch (iParam0)
	{
		case 0:
...
int func_45(var uParam0) // Position - 0x1ED3
{
	int num;
	int i;
	...
	*uParam0 = 10;
	...
	for (i = 0; i < 9; i = i + 1)
	{
		if (Global_97369[i /*2*/] == 3 || Global_97369[i /*2*/] == 4)
		{
			if (*uParam0 == 10)
				*uParam0 = i;
...
BOOL func_47(int iParam0) // Position - 0x2143
{
	return IS_BIT_SET(Global_113969.f_7232[iParam0], 0);
}

BOOL func_48(int iParam0, int iParam1) // Position - 0x2158
{
	if (iParam0 == 0 && iParam1 == 2 || iParam1 == 0 && iParam0 == 2)
		if (func_49(func_44(iParam0), func_44(iParam1), 0))
			if (Global_113969.f_18106.f_175[2 /*19*/].f_3 == 46)
				return false;

	return true;
}

BOOL func_49(eCharacter echParam0, eCharacter echParam1, int iParam2) // Position - 0x21AF
{
	int num;
	int num2;
	int num3;
	...
	return IS_BIT_SET(Global_113969.f_18106.f_175[num3 /*19*/].f_2, iParam2);
}

BOOL func_50(int iParam0) // Position - 0x21EE
{
...
BOOL func_51(int iParam0) // Position - 0x221B
{
...
void func_52(int iParam0, int iParam1) // Position - 0x2247
{
	if (iParam0 < 9)
		Global_97369[iParam0 /*2*/].f_1 = iParam1;

	return;
}

int func_53(int iParam0) // Position - 0x2265
{
	if (iParam0 < 9)
...
BOOL func_54(eCharacter echParam0, eCharacter echParam1, var uParam2) // Position - 0x2283
{
	int num;
	int num2;
...
void func_55(var uParam0) // Position - 0x22C8
{
	int i;
	int num;
...
BOOL _CONTEXT_IS_HELP_TEXT_BEING_DISPLAYED(int iParam0, int iParam1) // Position - 0x2334
{
	int num;
	BOOL flag;
...
int func_57(int iParam0) // Position - 0x23E9
{
	int i;
...
BOOL func_58(int iParam0, BOOL bParam1) // Position - 0x2424
{
	int num;
...
void _CONTEXT_ADD_HELP_TEXT(var uParam0, int iParam1, char* sParam2, int iParam3, const char* sParam4, int iParam5, int iParam6) // Position - 0x24DC
{
	int i;
...
void _CONTEXT_REMOVE_HELP_TEXT(var uParam0) // Position - 0x2607
{
	int num;
...
BOOL func_61(int* piParam0, float fParam1) // Position - 0x265E
{
	if (func_63(piParam0))
...
float func_62(int* piParam0) // Position - 0x2680
{
	if (func_63(piParam0))
...
BOOL func_63(int* piParam0) // Position - 0x26BC
{
	return IS_BIT_SET(*piParam0, 1);
}

int func_64(var uParam0) // Position - 0x26C9
{
	int num;
	int i;
...
BOOL func_65(var uParam0) // Position - 0x270D
{
	if (func_47(1))
	{
		if (Global_97247 == CHAR_MICHAEL && uParam0->f_1 == 2)
			return true;
	
		if (Global_97247 == CHAR_TREVOR && uParam0->f_1 == 0)
			return true;
	}
...
int func_66(var uParam0, BOOL bParam1) // Position - 0x274E
{
	if (bParam1)
		return 31;
...
BOOL func_67(var uParam0) // Position - 0x277C
{
	int num;

	num = func_93(Global_97247, uParam0->f_1);

	if (num == 1 || num == 2)
		if (func_94(Global_97247, uParam0->f_1) < 6f * 60f)
			return true;

	return false;
}

void func_68(var uParam0) // Position - 0x27BF
{
	int i;
	int num;
...
void func_69(var uParam0) // Position - 0x2840
{
	int i;
...
BOOL func_70(var uParam0, var uParam1, eCharacter echParam2, eCharacter echParam3, int iParam4, int iParam5) // Position - 0x2896
{
	var unk;
	var unk5;
	...
	if (uParam0->f_52)
	{
		...
		{
			MISC::SET_BIT(&(Global_113969.f_18106.f_410), iParam5);
			uParam0->f_52 = 0;
		}
	}
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x28F0
{
...
BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x2912
{
...
BOOL func_73(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x2960
{
	Global_22287 = 0;
...
BOOL func_76(Player plParam0) // Position - 0x2CC8
{
	return func_77(plParam0, 20);
}

BOOL func_77(Player plParam0, int iParam1) // Position - 0x2CD8
{
	return IS_BIT_SET(Global_1887305[plParam0 /*610*/].f_10.f_4, iParam1);
}

Player _INVALID_PLAYER_INDEX() // Position - 0x2CF0
{
	return -1;
}

void func_79() // Position - 0x2CF9
{
	int i;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x2E59
{
	if (func_417(14))
	{
...
BOOL func_84(int iParam0, int iParam1) // Position - 0x2F53
{
	switch (iParam0)
	{
		case 5:
...
void func_86(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x2FE2
{
...
BOOL func_87(eCharacter echParam0, eCharacter echParam1, int iParam2, char* sParam3, char* sParam4) // Position - 0x3038
{
	int num;
	int num2;
...
struct<4> func_88(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3092
{
	var unk;
	int num;
	int num2;
...
char* func_89(int iParam0) // Position - 0x318A
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_90(var uParam0, var uParam1, eCharacter echParam2, eCharacter echParam3, int iParam4, BOOL bParam5) // Position - 0x31FD
{
	var unk;
	var unk5;
...
BOOL func_91(eCharacter echParam0, eCharacter echParam1, int iParam2, char* sParam3, char* sParam4) // Position - 0x3257
{
	int num;
	int num2;
...
void func_92(var uParam0, int iParam1) // Position - 0x3744
{
...
int func_93(eCharacter echParam0, eCharacter echParam1) // Position - 0x3775
{
	int num;
	int num2;
	int num3;
	...
	if (num3 < 9)
		return Global_113969.f_18106.f_175[num3 /*19*/].f_8;

	return 1;
}

float func_94(eCharacter echParam0, eCharacter echParam1) // Position - 0x37B4
{
	int num;
	int num2;
	int num3;
	...
	if (num3 < 9)
		if (func_63(&(Global_113969.f_18106.f_175[num3 /*19*/].f_5)))
			return func_62(&(Global_113969.f_18106.f_175[num3 /*19*/].f_5));

	return 0f;
}

void func_95(var uParam0) // Position - 0x380D
{
	int num;
	eCharacter character;
	int i;
...
BOOL func_96() // Position - 0x38A1
{
	if (PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || Global_113016 || func_99() || func_84(8, -1) || func_98() || func_97() || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
		return false;

	return true;
}

BOOL func_97() // Position - 0x390C
{
	return Global_101585.f_394 > 0;
}

BOOL func_98() // Position - 0x391D
{
	if (Global_79650)
		return true;
...
BOOL func_99() // Position - 0x3947
{
	return Global_1575083;
}

void func_100(var uParam0, BOOL bParam1, Ped pedParam2) // Position - 0x3953
{
...
void func_101(var uParam0, int iParam1, BOOL bParam2, Ped pedParam3) // Position - 0x3987
{
	uParam0->f_14 = 1;
	uParam0->f_12 = iParam1;
	uParam0->f_5 = pedParam3;

	if (func_93(Global_97247, uParam0->f_1) == 2)
		if (func_94(Global_97247, uParam0->f_1) < 3f * 60f)
			func_24(Global_97247, uParam0->f_1, 2);
...
void func_102(var uParam0, var uParam1, var uParam2) // Position - 0x39DE
{
	float num;
	float groundZ;
	Ped ped;
	...
	{
		if (*uParam1 != 0)
			func_373(uParam0, uParam1, true, true, false);
	...
	{
		if (*uParam1 != 0)
			func_373(uParam0, uParam1, false, true, true);
	...
	else if (*uParam1 != 0 && *uParam1 != 1)
	{
		if (PED::IS_PED_INJURED(uParam1->f_2))
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam1->f_2) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				if (SYSTEM::VDIST2(entityCoords, entityCoords2) < 150f)
				{
					...
					if (num2 < 6)
						func_370("FR_X_INJ_1m" /*~a~ was injured.*/, &(Global_2169[uParam1->f_1 /*29*/].f_3), 3, 0, 20000, 10000, 7, 0, 0, 0);
				}
			}
			...
			if (!func_366(uParam1, false))
			{
				if (num4 != -1)
				{
					num5 = func_364(uParam1->f_2);
				
					if (num5 != 0)
						if (!func_363(num4) || func_351(num4) == 6)
							func_290(Global_97247, uParam1->f_1, 2, 0, num5, num4, -1);
				}
			}
		...
		{
			func_373(uParam0, uParam1, false, false, true);
		
			if (uParam1->f_1 == Global_97247 && func_287(uParam0, uParam1, uParam2))
			{
		...
		else if (uParam1->f_2 != Global_98991[func_285(uParam1->f_1)])
		{
			func_373(uParam0, uParam1, false, true, true);
			return;
		}
		else if (PED::IS_PED_FALLING(uParam1->f_2) || PED::IS_PED_IN_PARACHUTE_FREE_FALL(uParam1->f_2) && !ENTITY::HAS_COLLISION_LOADED_AROUND_ENTITY(uParam1->f_2) && !PED::IS_PED_INJURED(uParam1->f_2) || !MISC::GET_GROUND_Z_FOR_3D_COORD(ENTITY::GET_ENTITY_COORDS(uParam1->f_2, true), &groundZ, false, false) || groundZ < -200f)
		{
			...
			func_373(uParam0, uParam1, true, true, true);
			return;
		}
...
BOOL func_103(var uParam0, var uParam1) // Position - 0x41E2
{
	var animDict;
	var animationName;
	var animationName2;
	...
	func_22(Global_97247, uParam1->f_1, &animDict2, &animName2);
...
void _SHOW_SUBTITLE_CLEAR_EXISTING(const char* sParam0, int iParam1, int iParam2) // Position - 0x45B1
{
	iParam2 = iParam2;
...
int func_105(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x45CA
{
	var unk;
...
void func_106(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, int iParam11, BOOL bParam12) // Position - 0x45FD
{
	Player playerIndex;
...
void func_107(int iParam0, BOOL bParam1) // Position - 0x47BB
{
...
Vector3 _GET_PLAYER_COORDS(Player plParam0) // Position - 0x47F7
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(plParam0), false);
}

int func_109(Ped pedParam0, int iParam1, ePedComponentType epctParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x480A
{
	int i;
	int j;
	int k;
	...
	if (iParam5 == 0)
	{
		Global_79172[1 /*14*/] = { func_161(entityModel, iParam1, epctParam2, -1) };
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
			if (unk[i] != -99)
			{
				Global_79172[1 /*14*/] = { func_161(entityModel, i, unk[i], -1) };
				...
				if (IS_BIT_SET(Global_79172[1 /*14*/].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							Global_79172[1 /*14*/] = { func_161(entityModel, 14, unk18[j], -1) };
							func_129(pedParam0, Global_79172[1 /*14*/].f_12, Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4);
							func_152(14);
					...
					else if (i != 14 && i != 12)
					{
						...
						if (iParam4 == -1)
							PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_119(i), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(pedParam0, func_119(i)));
						else
							PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_119(i), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, iParam4);
			...
			{
				Global_79172[1 /*14*/] = { func_161(entityModel, i, func_118(pedParam0, i, PV_COMP_INVALID), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			Global_79172[1 /*14*/] = { func_161(entityModel, 14, unk59[j], -1) };
			func_129(pedParam0, Global_79172[1 /*14*/].f_12, Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4);
			func_152(14);
	...
	{
		if (iParam4 == -1)
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_119(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(pedParam0, func_119(iParam1)));
		else
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_119(iParam1), Global_79172[1 /*14*/].f_3, Global_79172[1 /*14*/].f_4, iParam4);
...
BOOL func_110(Ped pedParam0, Hash hParam1, var uParam2) // Position - 0x501B
{
	int num;
	...
	{
		if (!func_225(pedParam0, Global_113969.f_2366.f_539[num /*65*/].f_64, Global_113969.f_2366.f_539[num /*65*/].f_63))
		{
...
int func_111(Hash hParam0) // Position - 0x50BC
{
	switch (hParam0)
	{
...
void func_112(Hash hParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x50F7
{
	ePedComponentType type;
	int num;
...
BOOL func_113(Hash hParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x5181
{
	if (hParam0 == joaat("Player_Zero"))
		if (iParam1 == 4)
...
BOOL func_114(Hash hParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x525F
{
	Global_79172[1 /*14*/] = { func_161(hParam0, iParam1, epctParam2, -1) };
	return IS_BIT_SET(Global_79172[1 /*14*/].f_6, 2);
}

BOOL func_115(Hash hParam0, ePedComponentType epctParam1, int iParam2, ePedComponentType epctParam3, var uParam4, int iParam5) // Position - 0x5287
{
	var unk;
	int i;
...
BOOL func_116(Hash hParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x588B
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_117(Ped pedParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x5924
{
	int num;
	...
	{
		if (!func_225(pedParam0, Global_113969.f_2366.f_539[num /*65*/].f_61, Global_113969.f_2366.f_539[num /*65*/].f_60) || iParam3 == 1)
		{
...
ePedComponentType func_118(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x59CF
{
	ePedComponentType i;
	ePedComponentType j;
...
ePedComponentType func_119(int iParam0) // Position - 0x5A70
{
	switch (iParam0)
	{
		case 0:
...
int func_120(Hash hParam0, int iParam1, ePedComponentType epctParam2, var uParam3) // Position - 0x5B20
{
	int num;
...
ePedComponentType func_121(Ped pedParam0, Hash hParam1, int iParam2, ePedComponentType epctParam3, int iParam4, int iParam5) // Position - 0x5E27
{
	ePedComponentType type;
	ePedComponentType type2;
	ePedComponentType type3;
...
BOOL func_122(int iParam0, ePedComponentType epctParam1, ePedComponentType epctParam2, ePedComponentType epctParam3, var uParam4) // Position - 0x69DA
{
	int num;
...
ePedComponentType func_123(Hash hParam0, ePedComponentType epctParam1, ePedComponentType epctParam2, int iParam3) // Position - 0x6CBE
{
	int num;
...
ePedComponentType func_124(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x6F85
{
	ePedComponentType i;
	ePedComponentType type;
...
BOOL func_125(Ped pedParam0, int iParam1, ePedComponentType epctParam2, ePedComponentType epctParam3) // Position - 0x6FBC
{
	ePedComponentType type;
...
BOOL func_126(Hash hParam0, ePedComponentType epctParam1, var uParam2) // Position - 0x6FE5
{
	*uParam2 = -99;
...
int func_127(Hash hParam0, int iParam1, ePedComponentType epctParam2, var uParam3) // Position - 0x72AF
{
	int num;
...
ePedComponentType func_128(Hash hParam0, ePedComponentType epctParam1, ePedComponentType epctParam2) // Position - 0x7539
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
void func_129(Ped pedParam0, ePedComponentType epctParam1, int iParam2, int iParam3) // Position - 0x7690
{
	ePedComponentType type;
...
BOOL func_130(Hash hParam0, int iParam1, ePedComponentType epctParam2, Hash hParam3) // Position - 0x772A
{
	switch (hParam0)
	{
...
Hash func_131(Hash hParam0, ePedComponentType epctParam1, int iParam2, int iParam3) // Position - 0x77F8
{
	var outProp;
	int componentId;
	int num;
...
int func_132(Hash hParam0, int iParam1) // Position - 0x7912
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_133(Hash hParam0) // Position - 0x7CB9
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
ePedComponentType func_134(Ped pedParam0, int iParam1, int iParam2, ePedComponentType epctParam3) // Position - 0x7D1A
{
	Hash entityModel;
...
int func_135(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x7E16
{
	Hash entityModel;
...
int func_136(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x7F54
{
	var outfit;
	int i;
	int num;
...
int func_137(Hash hParam0) // Position - 0x8010
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_138(ePedComponentType epctParam0) // Position - 0x806F
{
	switch (epctParam0)
	{
		case PV_COMP_HEAD:
...
struct<10> func_139(Hash hParam0, ePedComponentType epctParam1) // Position - 0x80F5
{
	int i;
	var unk;
...
void func_140(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x8A24
{
	int num;
	Hash itemHash;
	Hash outPropVariant;
...
void func_141(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x8B4E
{
	uParam0->[0] = iParam1;
	uParam0->[1] = iParam2;
	uParam0->[2] = iParam3;
...
struct<17> func_142(Hash hParam0, ePedComponentType epctParam1) // Position - 0x8B96
{
	int i;
	var unk;
	...
	switch (hParam0)
	{
		case joaat("Player_Zero"):
			switch (epctParam1)
			{
				...
				case 5:
					func_145(&unk, -99, -99, Global_113969.f_2366.f_539.f_196[0], Global_113969.f_2366.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (epctParam1)
			{
				...
				case 2:
					func_145(&unk, -99, -99, Global_113969.f_2366.f_539.f_196[1], Global_113969.f_2366.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (epctParam1)
			{
				...
				case 4:
					func_145(&unk, -99, -99, Global_113969.f_2366.f_539.f_196[2], Global_113969.f_2366.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_143(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0xA9DE
{
	int num;
	Hash outfit;
...
int func_144(int iParam0) // Position - 0xABC8
{
	switch (iParam0)
	{
		case 0:
...
void func_145(var uParam0, int iParam1, int iParam2, ePedComponentType epctParam3, ePedComponentType epctParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0xAC78
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
...
BOOL func_146(Hash hParam0, int iParam1, ePedComponentType epctParam2, Hash hParam3) // Position - 0xACE9
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_147(Hash hParam0, int iParam1, ePedComponentType epctParam2, Hash hParam3) // Position - 0xAF66
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_148(Hash hParam0, int iParam1, ePedComponentType epctParam2, Hash hParam3) // Position - 0xB38B
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
ePedComponentType func_149(Ped pedParam0, ePedComponentType epctParam1) // Position - 0xB67E
{
	int pedPropIndex;
...
ePedComponentType func_150(Ped pedParam0, int iParam1) // Position - 0xB6C5
{
...
int func_151(Ped pedParam0, int iParam1, int iParam2, int iParam3) // Position - 0xB725
{
	ePedComponentType componentId;
...
void func_152(int iParam0) // Position - 0xB77C
{
	if (IS_BIT_SET(Global_79172[1 /*14*/].f_6, 1) && !IS_BIT_SET(Global_79172[1 /*14*/].f_6, 6))
		func_159(iParam0, Global_79172[1 /*14*/].f_5, Global_79172[1 /*14*/].f_2, 2, Global_79172[1 /*14*/].f_1, 1, 0);
...
void func_153(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xB828
{
	int num;
	int offset;
	int num2;
...
void func_154(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0xB870
{
	Hash statName;
...
Hash func_155(int iParam0, int iParam1) // Position - 0xB89E
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_156(iParam1));
}

int func_156(int iParam0) // Position - 0xB8B3
{
	int num;
	int num2;
...
int func_157(int iParam0, int iParam1) // Position - 0xB8E7
{
	Hash statHash;
	int outValue;
...
BOOL func_158(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0xB916
{
...
BOOL func_159(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xE5A0
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
BOOL func_160(int iParam0) // Position - 0xF443
{
	if (!IS_BIT_SET(Global_79172[1 /*14*/].f_6, 0))
		return false;
...
struct<14> func_161(Hash hParam0, int iParam1, ePedComponentType epctParam2, int iParam3) // Position - 0xF48B
{
	func_224();
...
void func_162(int iParam0, int iParam1) // Position - 0xF4DD
{
	switch (iParam0)
	{
		case 0:
...
void func_163(int iParam0) // Position - 0xF5CD
{
	BOOL flag;
	int num;
	var unk;
	...
	func_164(&Global_79172[0 /*14*/], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}

void func_164(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x10846
{
	int num;
	int num2;
	...
	*iParam0 = iParam9;
	...
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			num = func_157(func_167(iParam1, iParam0->f_2), Global_79169);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 1);
		
			num = func_157(func_166(iParam1, iParam0->f_2), Global_79169);
			...
			{
				num = func_157(num2, Global_79169);
...
BOOL func_165(int iParam0, int iParam1, var uParam2) // Position - 0x10BE8
{
	*uParam2 = 979;
...
int func_166(int iParam0, int iParam1) // Position - 0x10FED
{
	switch (iParam1)
	{
		case 0:
...
int func_167(int iParam0, int iParam1) // Position - 0x113E8
{
	switch (iParam1)
	{
		case 0:
...
BOOL func_168(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x117E3
{
	int num;
	int num2;
	int num3;
...
int func_169(int iParam0) // Position - 0x11821
{
	switch (iParam0)
	{
		case -1:
...
void func_170(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x118F5
{
	int num;
	int num2;
	Hash outfit;
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_164(&Global_79172[0 /*14*/], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_164(&Global_79172[0 /*14*/], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		FILES::INIT_SHOP_PED_PROP(&outProp);
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_164(&Global_79172[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_79370)
		{
			...
			func_164(&Global_79172[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
...
void func_171(int iParam0) // Position - 0x11B7C
{
	BOOL flag;
	int num;
	var unk;
...
void func_172(int iParam0) // Position - 0x11CD3
{
	BOOL flag;
	int num;
	var unk;
...
void func_173(int iParam0) // Position - 0x121E1
{
	BOOL flag;
	int num;
	var unk;
...
void func_174(int iParam0) // Position - 0x12256
{
	BOOL flag;
	int num;
	var unk;
...
void func_175(int iParam0) // Position - 0x122CA
{
	BOOL flag;
	int num;
	var unk;
...
void func_176(int iParam0) // Position - 0x123B1
{
	BOOL flag;
	int num;
	var unk;
...
void func_177(int iParam0) // Position - 0x12714
{
	BOOL flag;
	int num;
	var unk;
...
void func_178(int iParam0) // Position - 0x12925
{
	BOOL flag;
	int num;
	var unk;
...
void func_179(int iParam0) // Position - 0x12B55
{
	BOOL flag;
	int num;
	var unk;
...
void func_180(int iParam0) // Position - 0x12C65
{
	BOOL flag;
	int num;
	var unk;
...
void func_181(int iParam0) // Position - 0x13604
{
	BOOL flag;
	int num;
	var unk;
...
void func_182(int iParam0) // Position - 0x14178
{
	if (iParam0 < 136)
		func_184(iParam0);
	else
...
void func_183(int iParam0) // Position - 0x141AD
{
	BOOL flag;
	int num;
	var unk;
...
void func_184(int iParam0) // Position - 0x14DB1
{
	BOOL flag;
	int num;
	var unk;
...
void func_185(int iParam0) // Position - 0x15CBF
{
	BOOL flag;
	int num;
	var unk;
...
void func_186(int iParam0) // Position - 0x15DEC
{
	BOOL flag;
	int num;
	var unk;
...
void func_187(int iParam0, int iParam1) // Position - 0x15EEA
{
	switch (iParam0)
	{
		case 0:
...
void func_188(int iParam0) // Position - 0x15FDA
{
	BOOL flag;
	int num;
	var unk;
...
void func_189(int iParam0) // Position - 0x174CB
{
	BOOL flag;
	int num;
	var unk;
...
void func_190(int iParam0) // Position - 0x1761C
{
	BOOL flag;
	int num;
	var unk;
...
void func_191(int iParam0) // Position - 0x17B27
{
	BOOL flag;
	int num;
	var unk;
...
void func_192(int iParam0) // Position - 0x18196
{
	BOOL flag;
	int num;
	var unk;
...
void func_193(int iParam0) // Position - 0x1820A
{
	BOOL flag;
	int num;
	var unk;
...
void func_194(int iParam0) // Position - 0x182DA
{
	BOOL flag;
	int num;
	var unk;
...
void func_195(int iParam0) // Position - 0x1880A
{
	BOOL flag;
	int num;
	var unk;
...
void func_196(int iParam0) // Position - 0x189A1
{
	BOOL flag;
	int num;
	var unk;
...
void func_197(int iParam0) // Position - 0x1919F
{
	BOOL flag;
	int num;
	var unk;
...
void func_198(int iParam0) // Position - 0x192AF
{
	BOOL flag;
	int num;
	var unk;
...
void func_199(int iParam0) // Position - 0x1A1DA
{
	BOOL flag;
	int num;
	var unk;
...
void func_200(int iParam0) // Position - 0x1AE97
{
	if (iParam0 < 107)
		func_203(iParam0);
	else if (iParam0 < 227)
...
void func_201(int iParam0) // Position - 0x1AEDD
{
	BOOL flag;
	int num;
	var unk;
...
void func_202(int iParam0) // Position - 0x1B982
{
	BOOL flag;
	int num;
	var unk;
...
void func_203(int iParam0) // Position - 0x1C773
{
	BOOL flag;
	int num;
	var unk;
...
void func_204(int iParam0) // Position - 0x1D3BC
{
	BOOL flag;
	int num;
	var unk;
...
void func_205(int iParam0) // Position - 0x1D635
{
	BOOL flag;
	int num;
	var unk;
...
void func_206(int iParam0, int iParam1) // Position - 0x1D77B
{
	switch (iParam0)
	{
		case 0:
...
void func_207(int iParam0) // Position - 0x1D86B
{
	BOOL flag;
	int num;
	var unk;
...
void func_208(int iParam0) // Position - 0x1E5F5
{
	BOOL flag;
	int num;
	var unk;
...
void func_209(int iParam0) // Position - 0x1E76F
{
	BOOL flag;
	int num;
	var unk;
...
void func_210(int iParam0) // Position - 0x1ECE6
{
	BOOL flag;
	int num;
	var unk;
...
void func_211(int iParam0) // Position - 0x1F210
{
	BOOL flag;
	int num;
	var unk;
...
void func_212(int iParam0) // Position - 0x1F284
{
	BOOL flag;
	int num;
	var unk;
...
void func_213(int iParam0) // Position - 0x1F354
{
	BOOL flag;
	int num;
	var unk;
...
void func_214(int iParam0) // Position - 0x1F82C
{
	BOOL flag;
	int num;
	var unk;
...
void func_215(int iParam0) // Position - 0x1FA95
{
	BOOL flag;
	int num;
	var unk;
...
void func_216(int iParam0) // Position - 0x1FD6B
{
	BOOL flag;
	int num;
	var unk;
...
void func_217(int iParam0) // Position - 0x1FF34
{
	BOOL flag;
	int num;
	var unk;
...
void func_218(int iParam0) // Position - 0x20B2D
{
	BOOL flag;
	int num;
	var unk;
...
void func_219(int iParam0) // Position - 0x21777
{
	if (iParam0 < 60)
		func_221(iParam0);
	else
...
void func_220(int iParam0) // Position - 0x217AC
{
	BOOL flag;
	int num;
	var unk;
...
void func_221(int iParam0) // Position - 0x2254C
{
	BOOL flag;
	int num;
	var unk;
...
void func_222(int iParam0) // Position - 0x22BD8
{
	BOOL flag;
	int num;
	var unk;
...
void func_223(int iParam0) // Position - 0x22CBF
{
	BOOL flag;
	int num;
	var unk;
...
void func_224() // Position - 0x22DBD
{
...
BOOL func_225(Ped pedParam0, ePedComponentType epctParam1, ePedComponentType epctParam2) // Position - 0x22E36
{
	Hash entityModel;
	ePedComponentType type;
	int i;
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_79172[1 /*14*/] = { func_161(entityModel, epctParam1, epctParam2, -1) };
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_225(pedParam0, i, unk[i]))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							if (!func_225(pedParam0, 14, unk18[j]))
							{
								for (k = 0; k <= 19; k = k + 1)
								{
									Global_79172[2 /*14*/] = { func_161(entityModel, 14, k, -1) };
								
									if (Global_79172[2 /*14*/].f_12 == j)
										if (func_225(pedParam0, 14, k))
											if (!func_115(entityModel, epctParam2, 14, k, &unk, &Global_79172[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_79172[2 /*14*/] = { func_161(entityModel, i, type, -1) };
					
						if (!func_115(entityModel, epctParam2, i, type, &unk, &Global_79172[2 /*14*/]))
							return false;
					}
				}
			}
	...
	else if (Global_79172[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_119(epctParam1)) && Global_79172[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_119(epctParam1)))
	{
		return true;
	}
...
void func_226(BOOL bParam0) // Position - 0x2308F
{
	Player playerIndex;
...
void func_227(int iParam0, var uParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, var uParam6, var uParam7) // Position - 0x230CE
{
	BOOL flag;
...
BOOL func_228(var uParam0, var uParam1) // Position - 0x2333E
{
	int num;
...
int func_229(var uParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0x23377
{
	int i;
...
void func_230(var uParam0, int iParam1) // Position - 0x234AE
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0x234FD
{
	return func_232(iParam0, Global_44042);
}

BOOL func_232(int iParam0, int iParam1) // Position - 0x2350E
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_233(int iParam0) // Position - 0x236EF
{
	if (Global_44042 == 15)
		return false;
...
BOOL func_234(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x23711
{
	Ped ped;
	int num;
	var unk;
		...
		if (INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == 0 && INTERIOR::GET_INTERIOR_FROM_ENTITY(uParam1->f_2) == 0)
		{
			if (!PED::IS_PED_IN_ANY_VEHICLE(uParam1->f_2, false) || PED::IS_PED_ON_ANY_BIKE(uParam1->f_2) || VEHICLE::IS_VEHICLE_A_CONVERTIBLE(PED::GET_VEHICLE_PED_IS_IN(uParam1->f_2, false), true) && VEHICLE::GET_CONVERTIBLE_ROOF_STATE(PED::GET_VEHICLE_PED_IS_IN(uParam1->f_2, false)) == 2 || VEHICLE::GET_CONVERTIBLE_ROOF_STATE(PED::GET_VEHICLE_PED_IS_IN(uParam1->f_2, false)) == 6)
			{
				...
				else if (uParam1->f_4 == 1)
				{
					if (func_241(uParam0))
					{
						if (func_94(Global_97247, uParam1->f_1) > 15f)
						{
							if (fParam3 < 8f * 8f)
							{
								if (func_366(uParam1, false))
									func_91(Global_97247, uParam1->f_1, 29, &unk5, &unk);
								else
									func_91(Global_97247, uParam1->f_1, 22, &unk5, &unk);
								...
								if (_CONVERSATION_ADD_LINE(uParam2, &unk5, &unk, 4, 0, 0, 0))
								{
									...
									func_24(Global_97247, uParam1->f_1, 2);
									uParam1->f_4 = uParam1->f_4 + 1;
								}
							}
						}
				...
				else if (uParam1->f_4 == 2)
				{
					if (func_241(uParam0))
					{
						if (func_94(Global_97247, uParam1->f_1) > 10f)
						{
							if (fParam3 < 8f * 8f)
							{
								if (func_366(uParam1, false))
									...
									func_91(Global_97247, uParam1->f_1, 23, &unk5, &unk);
						...
						if (func_94(Global_97247, uParam1->f_1) > 10f)
						{
							if (fParam3 < 8f * 8f)
							{
								if (func_366(uParam1, false))
									...
									func_91(Global_97247, uParam1->f_1, 24, &unk5, &unk);
					...
					if (fParam3 < 8f * 8f)
					{
						if (func_94(Global_97247, uParam1->f_1) > 10f)
							if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("appinternet")) == 0)
								if (Global_97343 && uParam0->f_50 == 0 && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) || PED::IS_PED_ON_ANY_BIKE(PLAYER::PLAYER_PED_ID()) && MISC::ABSF(ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID())) < 10f && !PED::IS_PED_IN_ANY_VEHICLE(uParam1->f_2, false) && !ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) && !ENTITY::IS_ENTITY_IN_AIR(uParam1->f_2) && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_RAGDOLL(uParam1->f_2) && !func_408() && !STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() && func_235(uParam0, uParam1))
									return true;
...
BOOL func_235(var uParam0, var uParam1) // Position - 0x2414C
{
	Vector3 entityCoords;
	float dx;
...
void func_236(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x2431C
{
	switch (iParam0)
	{
		case 0:
...
void func_237(var uParam0, eCharacter echParam1, Ped pedParam2, BOOL bParam3) // Position - 0x24440
{
	var unk;
	int num;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x2446D
{
...
int func_239(eCharacter echParam0) // Position - 0x24508
{
	switch (echParam0)
	{
		case CHAR_MICHAEL:
...
char* func_240(eCharacter echParam0) // Position - 0x24567
{
	switch (echParam0)
	{
		case CHAR_MICHAEL:
...
BOOL func_241(var uParam0) // Position - 0x245DA
{
...
void func_242(var uParam0, Ped pedParam1) // Position - 0x24604
{
...
BOOL func_243(Entity eParam0, Entity eParam1, float fParam2) // Position - 0x24637
{
	float entityCoords;
	var entityCoords2;
...
void func_244(var uParam0) // Position - 0x24695
{
	int num;
...
int _GET_VEHICLE_SEAT_PED_IS_IN(Ped ped, BOOL includeLastVehicle) // Position - 0x2472E
{
	Vehicle vehiclePedIsIn;
...
void func_246(var uParam0) // Position - 0x247B3
{
	if (!func_255(uParam0->f_2, SCRIPT_TASK_ENTER_VEHICLE))
	{
		TASK::CLEAR_PED_TASKS(uParam0->f_2);
...
void func_247(var uParam0) // Position - 0x247E9
{
...
BOOL func_248() // Position - 0x24818
{
...
eCharacter func_249(Vehicle veParam0) // Position - 0x24830
{
	int i;
...
void func_250(var uParam0) // Position - 0x24893
{
...
void func_251(var uParam0, float fParam1, int iParam2) // Position - 0x2491C
{
...
BOOL func_252(var uParam0, Vehicle veParam1, int iParam2) // Position - 0x2495F
{
...
void func_253(Ped pedParam0, char* sParam1, int iParam2) // Position - 0x249F5
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(pedParam0, sParam1, AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(iParam2), 1);
	return;
}

char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x24A0C
{
	char* str;
...
BOOL func_255(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x24C01
{
	if (func_9(pedParam0))
...
void func_256(var uParam0, BOOL bParam1) // Position - 0x24C34
{
	if (bParam1)
	{
...
BOOL func_257(var uParam0, var uParam1) // Position - 0x24D88
{
...
BOOL func_258(var uParam0, var uParam1) // Position - 0x24DFE
{
...
BOOL func_259(Ped pedParam0, float fParam1) // Position - 0x24E66
{
	float xSize;
...
BOOL func_260(Ped pedParam0, float fParam1) // Position - 0x24EDC
{
	return func_261(pedParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

BOOL func_261(Ped pedParam0, Ped pedParam1, float fParam2, int iParam3, int iParam4, int iParam5) // Position - 0x24EF4
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_262(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0x24FB5
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_263(Ped pedParam0, int iParam1) // Position - 0x250E1
{
...
BOOL func_265(Ped pedParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x251F0
{
	var unk;
...
float func_266(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0x25281
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_267(float fParam0, var uParam1, var uParam2) // Position - 0x252A2
{
	float num;
	float num2;
...
void func_268(var uParam0) // Position - 0x252E1
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_269(Ped pedParam0, Ped pedParam1) // Position - 0x252FC
{
	int i;
...
BOOL func_270(Ped pedParam0) // Position - 0x2533B
{
...
void func_271(var uParam0, var uParam1) // Position - 0x25363
{
	Vector3 entityCoords;
	Vector3 entityCoords2;
	Vector3 outPosition;
...
BOOL func_272(Entity eParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x255AA
{
	float entityCoords;
...
BOOL func_273(var uParam0, BOOL bParam1, var uParam2) // Position - 0x255FD
{
	var sizeAndPeds;
	int i;
	int pedNearbyPeds;
...
BOOL func_274(var uParam0) // Position - 0x256C3
{
	Vehicle vehiclePedIsIn;
	Vector3 entityCoords;
...
BOOL func_275(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x257C6
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_276(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0x258C1
{
	float entityCoords;
	float num;
...
BOOL func_277(Ped pedParam0, float fParam1) // Position - 0x259CD
{
	var outProjectile;
	var outCoords;
...
BOOL func_278(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0x25A62
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_279(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0x25AF0
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_280(var uParam0) // Position - 0x25B38
{
	int num;
...
BOOL func_281(var uParam0) // Position - 0x25B70
{
	eCharacter i;
...
BOOL func_282(var uParam0, var uParam1) // Position - 0x25BBB
{
	int flags;
					...
					if (num < num2 * num2)
					{
						if (!func_280(uParam1))
						{
							...
							if (ENTITY::IS_ENTITY_ON_SCREEN(uParam1->f_2) && !ENTITY::IS_ENTITY_OCCLUDED(uParam1->f_2))
								if (func_96() && Global_79660.f_1 == false)
									return true;
						}
					}
				}
...
Entity func_283(Vehicle veParam0) // Position - 0x25DC8
{
	return veParam0;
}

void func_284(var uParam0, var uParam1, BOOL bParam2) // Position - 0x25DD2
{
	if (bParam2)
	{
		if (uParam1->f_8 == 0 && uParam1->f_1 != Global_97247)
		{
...
int func_285(eCharacter echParam0) // Position - 0x25E79
{
...
BOOL func_286(Ped pedParam0) // Position - 0x25EB4
{
	int i;

	for (i = 0; i < Global_101458; i = i + 1)
	{
		if (Global_101458[i] == pedParam0)
			return true;
	}
...
BOOL func_287(var uParam0, var uParam1, var uParam2) // Position - 0x25EE3
{
	int num;
	int num2;
	char* entityScript;
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		else if (!PED::IS_PED_INJURED(Global_97351[uParam1->f_1]))
		{
			uParam1->f_2 = Global_97351[uParam1->f_1];
			uParam1->f_11 = Global_97355[uParam1->f_1];
		...
		else
		{
			...
			uParam1->f_2 = Global_98991[num];
		
			if (!PED::IS_PED_INJURED(uParam1->f_2))
			{
				if (IS_BIT_SET(Global_98991.f_47, num))
				{
				}
				else if (func_286(uParam1->f_2))
				{
				}
				else if (func_54(Global_97247, uParam1->f_1, &num2) && func_53(num2) == 0)
				{
					entityScript = "";
					script = 0;
...
BOOL func_288(var uParam0, int iParam1, float fParam2) // Position - 0x26141
{
	int num;
	float num2;
	float num3;
...
void func_289(var uParam0, var uParam1, var uParam2) // Position - 0x261A1
{
	Vehicle vehiclePedIsIn;
	...
	if (!PED::IS_PED_INJURED(uParam1->f_2))
	{
		...
		func_237(uParam2, Global_97247, PLAYER::PLAYER_PED_ID(), false);
		func_237(uParam2, uParam1->f_1, uParam1->f_2, false);
...
int func_290(eCharacter echParam0, eCharacter echParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x2629B
{
	int num;
	int num2;
	int num3;
	...
	num = 3;
	num2 = func_29(echParam1);
	num3 = func_350(echParam0);
	num4 = 10000;

	if (iParam3 == 0)
	{
		if (func_348(num2, iParam2, -1, &num5, &num6))
		{
			if (iParam5 == -1)
				return 0;
			...
			if (func_344(iParam5, num5, num6, num, num3, echParam1, num4, 10000, iParam6, iParam4, num8, num7, 1))
				return 1;
			else
				return 0;
		}
	}
	else if (func_342(num2, iParam2, -1, &unk))
	{
...
void func_291() // Position - 0x26445
{
	eCharacter character;
	int num;
...
int func_292(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x26487
{
...
int func_293(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x264BB
{
	float num;
	int num2;
	int num3;
...
void func_294(BOOL bParam0) // Position - 0x26ABA
{
	int i;
	int j;
...
void func_295(int iParam0) // Position - 0x26D3C
{
	int value;
...
void func_296(int iParam0) // Position - 0x26D96
{
	BOOL flag;
	var txdName;
	...
	else if (IS_BIT_SET(Global_113969.f_20567.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_298() /*5570*/].f_681.f_10, iParam0))
	{
		flag = true;
		MISC::CLEAR_BIT(&(Global_113969.f_20567.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2359296[func_298() /*5570*/].f_681.f_10), iParam0);
	}
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0(int iParam0) // Position - 0x26F10
{
	switch (iParam0)
	{
		case 0:
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x27020
{
	if (iParam2 == -1)
		iParam2 = func_15();
...
void func_300(int iParam0) // Position - 0x2703E
{
	func_319(93, iParam0);
	func_319(29, iParam0);
	func_319(30, iParam0);
...
BOOL func_301(int iParam0) // Position - 0x2705E
{
	int cloudTimeAsInt;
	int num;
	int cloudTimeAsInt2;
	...
	return IS_BIT_SET(Global_2359296[func_298() /*5570*/].f_681.f_10, iParam0);
}

BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x271FE
{
	if (iParam1 == -1)
		iParam1 = func_15();
...
int func_303(BOOL bParam0) // Position - 0x2721A
{
	var outValue;
	int value;
	int outValue2;
...
int func_304(int iParam0, int iParam1) // Position - 0x272D1
{
	if (iParam0 >= 78)
		return 0;
...
int func_305(int iParam0, int iParam1) // Position - 0x272EC
{
	if (func_417(14) && !func_316(iParam0))
		return 0;
	...
	if (func_315(&Global_4543384))
	{
		if (func_313(&Global_4543384, iParam0))
			return 0;
	
		if (func_306(&Global_4543384, iParam0))
			return 1;
	}
	else
	{
...
BOOL func_306(var uParam0, int iParam1) // Position - 0x27389
{
	int i;
	var unk;
	...
	if (func_417(14) && !func_316(iParam1))
		return false;
...
int func_307(var uParam0, int iParam1) // Position - 0x2743A
{
	int i;
...
BOOL func_308(var uParam0, int iParam1) // Position - 0x274B5
{
	return uParam0->[iParam1] == 78;
}

void func_309(var uParam0) // Position - 0x274C6
{
	int i;
	...
	func_311(uParam0, Global_4543383 - 0.5f);
	return;
}

void func_310(var uParam0, int iParam1) // Position - 0x274FA
{
	uParam0->[iParam1] = 78;
	return;
}

void func_311(var uParam0, int iParam1) // Position - 0x2750A
{
	if (iParam1 == 0f)
		uParam0->f_80 = 0f;
	else
...
float func_312(var uParam0) // Position - 0x27527
{
	return uParam0->f_80;
}

BOOL func_313(var uParam0, int iParam1) // Position - 0x27533
{
	return func_314(uParam0, iParam1) != -1;
}

int func_314(var uParam0, int iParam1) // Position - 0x27545
{
	int i;
...
BOOL func_315(var uParam0) // Position - 0x27572
{
	return uParam0->f_79 == 1;
}

BOOL func_316(int iParam0) // Position - 0x27580
{
	switch (iParam0)
	{
		case 60:
...
BOOL func_317(int iParam0, int iParam1) // Position - 0x275D0
{
...
void func_318(Hash hParam0, int iParam1) // Position - 0x27621
{
	int outValue;
...
void func_319(int iParam0, int iParam1) // Position - 0x27644
{
	int outValue;
...
void func_320() // Position - 0x276A1
{
	int outValue;
...
int func_321(eCharacter echParam0) // Position - 0x27716
{
	return Global_2169[echParam0 /*29*/].f_17;
}

int _GET_PLAYER_CASH(eCharacter echParam0) // Position - 0x27727
{
	int outValue;
...
void func_323() // Position - 0x2777F
{
	eCharacter character;
	int num;
...
void func_324() // Position - 0x277C1
{
	eCharacter character;
	int num;
...
void func_325() // Position - 0x27803
{
	eCharacter character;
	int num;
...
void func_326() // Position - 0x27845
{
	eCharacter character;
	int num;
...
BOOL _SEND_TEXT_MESSAGE_FROM_CHARACTER_2(eCharacter echParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9) // Position - 0x27887
{
	int num;
	char* str;
	int num2;
...
struct<4> _GET_CHARACTER_NAME(eCharacter character) // Position - 0x27916
{
	return Global_2169[character /*29*/].f_3;
}

int func_329(eCharacter echParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10, int iParam11, int iParam12, int iParam13, char* sParam14, char* sParam15, int iParam16) // Position - 0x27929
{
	int num;
	int num2;
	...
	if (!Global_21146)
	{
		...
		{
			func_336(Global_20911, "SET_DATA_SLOT_EMPTY", 1f, -1082130432, -1082130432, -1082130432, -1082130432);
			func_332(1);
			func_336(Global_20911, "DISPLAY_VIEW", 1f, SYSTEM::TO_FLOAT(Global_20910), -1082130432, -1082130432, -1082130432);
		}
	}
...
void func_330(eCharacter echParam0, char* sParam1, BOOL bParam2, Hash hParam3) // Position - 0x27E04
{
	eCharacter character;
...
Hash func_331(Player plParam0) // Position - 0x27E9F
{
	return Global_1845281[plParam0 /*883*/].f_206.f_6;
}

void func_332(int iParam0) // Position - 0x27EB4
{
	int i;
	int num;
	int value;
				...
				if (iParam0 == Global_8807[num /*15*/].f_11)
				{
					if (i == Global_8807[num /*15*/].f_4)
					{
						if (Global_9369[i] == false)
						{
							...
							if (Global_2696167)
								if (num == 14)
									func_333(Global_20911, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8807[num /*15*/].f_10), SYSTEM::TO_FLOAT(Global_23349), -1f, &Global_8807[num /*15*/], 0, 0, 0, 0);
					...
					if (i == Global_8807[num /*15*/].f_4)
					{
						if (Global_9369[i] == false)
						{
							...
							if (num == 1)
							{
								...
								func_333(Global_20911, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8807[num /*15*/].f_10), SYSTEM::TO_FLOAT(Global_23354), -1f, &Global_8807[num /*15*/], 0, 0, 0, 0);
							}
							else if (num == 7)
							{
								if (Global_79389)
								{
									...
									func_333(Global_20911, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8807[num /*15*/].f_10), SYSTEM::TO_FLOAT(value2), -1f, &Global_8807[num /*15*/], 0, 0, 0, 0);
								}
								else
								{
									switch (Global_20930)
									...
									func_333(Global_20911, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8807[num /*15*/].f_10), SYSTEM::TO_FLOAT(value3), -1f, &Global_8807[num /*15*/], 0, 0, 0, 0);
								}
							}
							else if (num == 14)
							{
							...
							else if (Global_8807[num /*15*/].f_10 == 57 && num == 23)
							{
								...
								func_333(Global_20911, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8807[num /*15*/].f_10), SYSTEM::TO_FLOAT(value6), -1f, &Global_8807[num /*15*/], 0, 0, 0, 0);
							}
							else
							{
								func_333(Global_20911, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8807[num /*15*/].f_10), SYSTEM::TO_FLOAT(0), -1f, &Global_8807[num /*15*/], 0, 0, 0, 0);
							}
...
void func_333(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, const char* sParam8, const char* sParam9, const char* sParam10, const char* sParam11) // Position - 0x28438
{
...
void func_334(char* sParam0) // Position - 0x284EB
{
...
void func_335() // Position - 0x284FD
{
	int i;
...
void func_336(int iParam0, char* sParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x28520
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, sParam1);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(SYSTEM::ROUND(fParam2));
...
void func_337(int iParam0) // Position - 0x28583
{
	var unk;
	var unk2;
...
void func_338(int iParam0) // Position - 0x285A2
{
	int clockSeconds;
	int clockMinutes;
	int clockHours;
...
void func_339() // Position - 0x28634
{
	int num;
	int num2;
	int num3;
	...
	while (num3 < num2)
	{
		if (!func_340(Global_113969.f_14144[num3 /*104*/].f_18, Global_113969.f_14144[Global_23353 /*104*/].f_18))
			Global_23353 = num3;
...
BOOL func_340(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11) // Position - 0x286FF
{
	int num;
	int num2;
	int num3;
...
int func_341() // Position - 0x287EA
{
	...
	while (i < num2)
	{
		if (Global_113969.f_14144[i /*104*/].f_24 == 0 || Global_113969.f_14144[i /*104*/].f_24 == 1)
			if (!func_340(Global_113969.f_14144[i /*104*/].f_18, Global_113969.f_14144[Global_23353 /*104*/].f_18))
				Global_23353 = i;
...
BOOL func_342(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0x28952
{
	var unk;
	var unk5;
	eCharacter character;
	...
	else
	{
		...
		if (iParam2 == -1)
		{
			...
			if (func_343(&unk5[0 /*4*/], character))
				iParam2 = 1;
			else if (func_343(&unk5[1 /*4*/], character))
				iParam2 = 0;
			else
...
BOOL func_343(const char* sParam0, eCharacter echParam1) // Position - 0x28A8A
{
	int num;
	int num2;
	...
	while (num < 35)
	{
		if (!MISC::IS_STRING_NULL(&Global_113969.f_14144[num /*104*/]))
			if (MISC::ARE_STRINGS_EQUAL(&Global_113969.f_14144[num /*104*/], sParam0))
				if (Global_113969.f_14144[num /*104*/].f_99[echParam1])
					num2 = 1;
...
BOOL func_344(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, eCharacter echParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12) // Position - 0x28AFE
{
	int num;
	...
	if (Global_113969.f_7691.f_764 < CHAR_MIKE_FRANK_CONF)
	{
		...
		func_345(CHAR_MICHAEL);
		func_345(CHAR_FRANKLIN);
		func_345(CHAR_TREVOR);
		return true;
	}
...
void func_345(eCharacter echParam0) // Position - 0x28C39
{
	eCharacter i;
	int num;
	eCharacter j;
...
int func_346(int iParam0) // Position - 0x28CF7
{
	switch (iParam0)
	{
		case 0:
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x28D61
{
...
BOOL func_348(int iParam0, int iParam1, int iParam2, var uParam3, var uParam4) // Position - 0x28D89
{
	var unk;
	eCharacter character;
	...
	else
	{
		...
		if (iParam2 == -1)
		{
			...
			if (func_342(iParam0, iParam1, 0, &unk[0 /*4*/]) && func_342(iParam0, iParam1, 1, &unk[1 /*4*/]))
			{
				character = func_44(iParam0);
			
				if (func_343(&unk[0 /*4*/], character))
					iParam2 = 1;
				else if (func_343(&unk[1 /*4*/], character))
					iParam2 = 0;
				else
					iParam2 = MISC::GET_RANDOM_INT_IN_RANGE(0, 2);
			}
		...
		*uParam4 = func_349(iParam1, iParam2);
		return true;
	}
...
int func_349(int iParam0, int iParam1) // Position - 0x28E8B
{
...
int func_350(eCharacter echParam0) // Position - 0x28F39
{
	switch (echParam0)
	{
		case CHAR_MICHAEL:
...
int func_351(int iParam0) // Position - 0x28F70
{
	int gameTimer;
	eCharacter i;
	...
	for (i = CHAR_MICHAEL; i < Global_113969.f_7691.f_136; i = i + 1)
	{
		if (Global_113969.f_7691[i /*15*/] == iParam0)
			return func_361(iParam0, gameTimer);
	}

	for (i = CHAR_MICHAEL; i < Global_113969.f_7691.f_764; i = i + 1)
	{
		if (Global_113969.f_7691.f_651[i /*14*/] == iParam0)
			return func_359(iParam0, gameTimer);
	}

	for (i = CHAR_MICHAEL; i < Global_113969.f_7691.f_866; i = i + 1)
	{
		if (Global_113969.f_7691.f_765[i /*10*/] == iParam0)
			return func_352(iParam0, gameTimer);
	}

	return 6;
}

int func_352(int iParam0, int iParam1) // Position - 0x29026
{
	int num;
	BOOL flag;

	num = { func_358(iParam0) };

	if (num != iParam0)
		return 6;

	if (!func_407(_GET_CURRENT_PLAYER_CHARACTER_0()))
		return 6;
	...
	if (flag)
		if (num.f_3 < Global_113969.f_7691.f_919[_GET_CURRENT_PLAYER_CHARACTER()])
			return 5;

	if (num.f_6 != 144)
		if (Global_44594[num.f_6] > iParam1)
			return 3;

	if (Global_44593 > iParam1)
		return 2;

	return 1;
}

eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x290BB
{
	func_354();
	return Global_113969.f_2366.f_539.f_4321;
}

void func_354() // Position - 0x290D4
{
	eCharacter character;
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_113969.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_407(character) && !func_417(14) || Global_112917)
			{
				if (Global_113969.f_2366.f_539.f_4321 != character && func_407(Global_113969.f_2366.f_539.f_4321))
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x291D1
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x2920E
{
	if (func_407(character))
		return func_357(character);
	else
		character != _CHAR_NULL;
...
Hash func_357(eCharacter echParam0) // Position - 0x29233
{
	return Global_2169[echParam0 /*29*/];
}

struct<10> func_358(int iParam0) // Position - 0x29242
{
	eCharacter i;
	var unk;
...
int func_359(int iParam0, int iParam1) // Position - 0x29291
{
	int num;
	BOOL flag;
...
struct<14> func_360(int iParam0) // Position - 0x2931D
{
	eCharacter i;
	var unk;
...
int func_361(int iParam0, int iParam1) // Position - 0x2936C
{
	int num;
	BOOL flag;
	...
	if (Global_44589 != -1)
		if (Global_113969.f_7691[Global_44589 /*15*/] == iParam0)
			return 0;
...
struct<15> func_362(int iParam0) // Position - 0x29414
{
	eCharacter i;
	var unk;
...
BOOL func_363(int iParam0) // Position - 0x2945C
{
	eCharacter i;
...
int func_364(Entity eParam0) // Position - 0x29558
{
	var entityCoords;
	...
	if (ENTITY::DOES_ENTITY_EXIST(eParam0))
	{
		...
		{
			switch (func_365(entityCoords, true))
			{
				case 0:
					return 202;
...
int func_365(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x295EB
{
	int i;
	...
	for (i = 0; i <= 5 - 1; i = i + 1)
	{
		if (Global_96716[i /*9*/].f_7 != 263)
		{
			if (!bParam3 || IS_BIT_SET(Global_113969.f_7232.f_11[i], 0))
			{
				distanceBetweenCoords = MISC::GET_DISTANCE_BETWEEN_COORDS(vParam0, Global_96716[i /*9*/].f_3, true);
...
BOOL func_366(var uParam0, BOOL bParam1) // Position - 0x29665
{
	if (uParam0->f_1 == 1 && Global_97247 == CHAR_TREVOR || uParam0->f_1 == 2 && Global_97247 == CHAR_FRANKLIN)
	{
		if (!func_51(30))
		{
			if (bParam1)
...
void func_367(int iParam0, int iParam1) // Position - 0x296EF
{
	if (iParam0 < 6)
	{
		func_25(&Global_113969.f_18106.f_362[iParam0 /*3*/]);
		Global_113969.f_18106.f_381[iParam0] = iParam1;
	
		if (iParam1 != -1)
			func_368(&Global_113969.f_18106.f_362[iParam0 /*3*/]);
	}

	return;
}

void func_368(int* piParam0) // Position - 0x2973A
{
	if (func_63(piParam0))
	{
		if (!func_413(piParam0))
...
int func_369(int iParam0) // Position - 0x29771
{
	if (iParam0 == 0)
		return 2091854273;
	else if (iParam0 == 1)
...
void func_370(char* sParam0, const char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x297DD
{
	func_371(sParam0, sParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8, iParam9);
	return;
}

void func_371(char* sParam0, const char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x297FD
{
	int i;
...
void func_372() // Position - 0x299D1
{
	int i;
...
void func_373(var uParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x29AE8
{
	if (*uParam1 != 0)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(uParam1->f_2) && ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(uParam1->f_2, false) && !func_286(uParam1->f_2))
		{
			if (PED::IS_PED_INJURED(uParam1->f_2))
			{
				Global_113969.f_18536[uParam1->f_1] = CHAR_MICHAEL;
				func_387(uParam1->f_2);
				Global_113969.f_2366.f_539.f_2296[uParam1->f_1] = func_376();
...
void func_374(Ped pedParam0) // Position - 0x29BA3
{
	int num;
	int i;
	...
	{
		if (num < 0)
			if (!ENTITY::DOES_ENTITY_EXIST(Global_101458[i]))
				num = i;
	}

	if (num < 0 || num > Global_101458)
		num = 0;

	Global_101458[num] = pedParam0;
	return;
}

void func_375(var uParam0, var uParam1) // Position - 0x29BFE
{
	if (!PED::IS_PED_INJURED(uParam1->f_2))
	{
...
int func_376() // Position - 0x29C36
{
	var unk;

	func_386(&unk, CLOCK::GET_CLOCK_SECONDS());
	func_385(&unk, CLOCK::GET_CLOCK_MINUTES());
	func_384(&unk, CLOCK::GET_CLOCK_HOURS());
	func_379(&unk, CLOCK::GET_CLOCK_DAY_OF_MONTH());
	func_378(&unk, CLOCK::GET_CLOCK_MONTH());
	func_377(&unk, CLOCK::GET_CLOCK_YEAR());
	return unk;
}

void func_377(var uParam0, int iParam1) // Position - 0x29C7C
{
	if (iParam1 <= 0)
		return;
...
void func_378(var uParam0, int iParam1) // Position - 0x29D02
{
...
void func_379(var uParam0, int iParam1) // Position - 0x29D35
{
	int num;
	int num2;

	num = func_383(*uParam0);
	num2 = func_381(*uParam0);

	if (iParam1 < 1 || iParam1 > func_380(num, num2))
		return;
...
int func_380(int iParam0, int iParam1) // Position - 0x29D86
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_381(int iParam0) // Position - 0x29E28
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_382(BOOL bParam0, var uParam1, var uParam2) // Position - 0x29E4A
{
	if (bParam0)
		return uParam1;
...
int func_383(int iParam0) // Position - 0x29E61
{
	return iParam0 & 15;
}

void func_384(var uParam0, int iParam1) // Position - 0x29E6E
{
...
void func_385(var uParam0, int iParam1) // Position - 0x29EA8
{
...
void func_386(var uParam0, int iParam1) // Position - 0x29EE3
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
void func_387(Ped pedParam0) // Position - 0x29F1F
{
	eCharacter character;
	Vector3 vector;
	float num;
	...
	vector = { Global_113969.f_2366.f_539.f_2300[character /*3*/] };
	num = Global_113969.f_2366.f_539.f_2310[character];
	hash = Global_113969.f_2366.f_539.f_2314[character];
	unk3 = { Global_113969.f_2366.f_539.f_2318[character /*3*/] };
	func_389(pedParam0, false);

	if (!func_388(vector, 0f, 0f, 0f, false))
	{
		num2 = MISC::ABSF(Global_113969.f_2366.f_539.f_2300[character /*3*/].f_2 - vector.f_2);
		num3 = SYSTEM::VDIST2(vector, Global_113969.f_2366.f_539.f_2300[character /*3*/]);
		num4 = SYSTEM::VMAG(Global_113969.f_2366.f_539.f_2318[character /*3*/]);
		flag = false;
		...
		if (flag)
		{
			Global_113969.f_2366.f_539.f_2300[character /*3*/] = { vector };
			Global_113969.f_2366.f_539.f_2310[character] = num;
			Global_113969.f_2366.f_539.f_2314[character] = hash;
			Global_113969.f_2366.f_539.f_2318[character /*3*/] = { unk3 };
		}
	}
...
BOOL func_388(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x2A09E
{
	if (bParam6)
...
void func_389(Ped pedParam0, BOOL bParam1) // Position - 0x2A0E5
{
	func_402(pedParam0);
	func_395(pedParam0, bParam1);
	func_394(pedParam0);
	func_393(pedParam0);
	func_392(pedParam0);
	func_391(pedParam0);
...
void func_390(Ped pedParam0) // Position - 0x2A119
{
	eCharacter character;

	character = _GET_PLAYER_CHARACTER_FROM_PED(pedParam0);

	if (func_407(character) && !PED::IS_PED_INJURED(pedParam0))
...
void func_391(Ped pedParam0) // Position - 0x2A160
{
	eCharacter character;
...
void func_392(Ped pedParam0) // Position - 0x2A19E
{
	eCharacter character;
...
void func_393(Ped pedParam0) // Position - 0x2A32B
{
	eCharacter character;
...
void func_394(Ped pedParam0) // Position - 0x2A367
{
	eCharacter character;
...
void func_395(Ped pedParam0, BOOL bParam1) // Position - 0x2A3C4
{
	eCharacter character;
	...
	if (func_407(character) && !PED::IS_PED_INJURED(pedParam0))
	{
		if (pedParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_396(pedParam0, &Global_113969.f_2366.f_539.f_298[character /*477*/]);
...
void func_396(Ped pedParam0, var uParam1) // Position - 0x2A4B7
{
	int i;
	int j;
	Hash k;
	...
	if (!PED::IS_PED_INJURED(pedParam0))
	{
		...
		for (i = 0; i <= 44 - 1; i = i + 1)
		{
			...
			if (hash != 0)
			{
				pedWeapontypeInSlot = WEAPON::GET_PED_WEAPONTYPE_IN_SLOT(pedParam0, func_401(i));
				...
				if (pedWeapontypeInSlot != 0 && pedWeapontypeInSlot != joaat("WEAPON_UNARMED"))
				{
					...
					for (k = func_399(pedWeapontypeInSlot, j); k != 0; k = func_399(pedWeapontypeInSlot, j))
					{
		...
		{
			if (FILES::GET_DLC_WEAPON_DATA_SP(l, &outData) && !func_398(outData.f_1) && num < 51)
			{
				if (!FILES::IS_CONTENT_ITEM_LOCKED(outData))
				{
					...
					for (j = 0; j < FILES::GET_NUM_DLC_WEAPON_COMPONENTS_SP(l); j = j + 1)
					{
						...
						{
							if (!func_397(ComponentDataPtr.f_3))
							{
...
BOOL func_397(int iParam0) // Position - 0x2A73F
{
	switch (iParam0)
	{
...
BOOL func_398(int iParam0) // Position - 0x2A7E0
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
Hash func_399(Hash hParam0, int iParam1) // Position - 0x2A9D2
{
	int num;
	int dlcWeaponIndex;
	int i;
	...
	switch (hParam0)
	{
		...
		default:
			if (hParam0 != 0)
			{
				dlcWeaponIndex = func_400(hParam0, &unk);
...
int func_400(Hash hParam0, Any* panParam1) // Position - 0x2B713
{
	int i;
	int numDlcWeapons;
...
Hash func_401(int iParam0) // Position - 0x2B74E
{
	int num;
...
void func_402(Ped pedParam0) // Position - 0x2B9C2
{
	eCharacter character;
	...
	if (func_407(character) && !PED::IS_PED_INJURED(pedParam0))
		Global_113969.f_2366.f_539.f_2296[character] = func_376();

	return;
}

void func_403(var uParam0, BOOL bParam1) // Position - 0x2B9FC
{
	int i;
	...
	for (i = 0; i < 3; i = i + 1)
	{
		func_373(uParam0, &uParam0->[i /*15*/], bParam1, true, true);
	}
...
void func_404(var uParam0) // Position - 0x2BA49
{
	int i;
...
void func_405(var uParam0, BOOL bParam1) // Position - 0x2BAC6
{
	if (uParam0->f_50 != 0)
	{
...
void func_406(var uParam0) // Position - 0x2BAE4
{
	int i;
...
BOOL func_407(eCharacter echParam0) // Position - 0x2BB31
{
	return echParam0 < CHAR_MULTIPLAYER;
}

BOOL func_408() // Position - 0x2BB3D
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void func_409(int iParam0) // Position - 0x2BB59
{
	if (iParam0 < 6)
	{
		Global_113969.f_18106.f_381[iParam0] = -1;
	
		if (func_63(&Global_113969.f_18106.f_362[iParam0 /*3*/]) && func_413(&Global_113969.f_18106.f_362[iParam0 /*3*/]))
			func_410(&Global_113969.f_18106.f_362[iParam0 /*3*/]);
	}

	return;
}

void func_410(int* piParam0) // Position - 0x2BBB7
{
	if (func_63(piParam0))
	{
		if (func_413(piParam0))
...
int func_411(int iParam0) // Position - 0x2BBF2
{
	int gameTimer;
	eCharacter i;
...
BOOL func_412(int iParam0) // Position - 0x2BC3A
{
	eCharacter i;
...
BOOL func_413(int* piParam0) // Position - 0x2BC75
{
	return IS_BIT_SET(*piParam0, 2);
}

void func_414(int iParam0) // Position - 0x2BC82
{
	if (iParam0 >= 94)
		return;
...
BOOL func_415() // Position - 0x2BCB7
{
	if (Global_44042 == 15)
		return false;
...
void func_416(int iParam0, int iParam1, int iParam2) // Position - 0x2BCCC
{
	if (Global_97359 == 5)
		if (!func_415())
			func_414(Global_97360);
	...
	if (Global_97359 != 0)
	{
		...
		Global_97361 != iParam2;
	}

	Global_97360 = iParam0;
	Global_97359 = iParam1;
	Global_97361 = iParam2;
	return;
}

BOOL func_417(int iParam0) // Position - 0x2BD3B
{
	return Global_44042 == iParam0;
}

void func_418(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x2BD49
{
	func_371(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
	return;
}

int func_419(char* sParam0) // Position - 0x2BD6B
{
...
BOOL func_420(char* sParam0) // Position - 0x2BD92
{
	int i;
...
void func_421(int iParam0, var uParam1) // Position - 0x2BDCD
{
	eCharacter character;
	BOOL flag;
	BOOL flag2;
	...
	num = Global_97369[iParam0 /*2*/];

	if (num == 0)
	{
		if (!func_417(17))
		{
			if (func_469(character))
			{
				if (!func_233(6))
				{
					if (func_431(character, &flag, &flag2, &flag3))
					{
						if (flag)
						{
							if (flag3)
						...
						{
							Global_113969.f_18106.f_175[iParam0 /*19*/].f_16 = uParam1;
							func_430(iParam0, 2, false);
							func_430(iParam0, 3, flag2);
							func_472(iParam0, 2);
						}
	...
	else if (num == 1)
	{
		...
		if (func_427() || func_426())
		{
			if (func_429(iParam0, 2))
			{
				func_24(Global_97247, character, 0);
				Global_113969.f_18106.f_404 = 1;
				func_472(iParam0, 3);
			}
			else
			{
	...
	{
		if (func_429(iParam0, 3) && func_407(character))
		{
			if (!func_469(character))
			{
				if (Global_113969.f_18106.f_406 == false)
					Global_113969.f_18106.f_406 = 1;
		...
		else
		{
			...
			if (func_427() || func_426())
			{
				if (func_429(iParam0, 2))
				{
					...
					if (Global_113969.f_18106.f_406 == false)
						Global_113969.f_18106.f_406 = 1;
					else if (!func_429(iParam0, 3))
						func_422(Global_97247, character, 0);
				}
	...
	else if (num == 3)
	{
		...
		if (!SCRIPT::IS_THREAD_ACTIVE(Global_113969.f_18106.f_395))
		{
			...
			else
			{
				...
				Global_113969.f_18106.f_395 = num2;
...
void func_422(eCharacter echParam0, eCharacter echParam1, int iParam2) // Position - 0x2C051
{
	switch (iParam2)
	{
		case 0:
			func_423(echParam0, echParam1, -1);
			break;
		...
		case 3:
			func_423(echParam0, echParam1, -2);
			break;
	
		case 4:
			func_423(echParam0, echParam1, -5);
			break;
		...
		case 7:
			func_423(echParam0, echParam1, 3);
			break;
...
void func_423(eCharacter echParam0, eCharacter echParam1, int iParam2) // Position - 0x2C0FB
{
	func_424(echParam0, echParam1, func_425(echParam0, echParam1) + iParam2);
	return;
}

void func_424(eCharacter echParam0, eCharacter echParam1, int iParam2) // Position - 0x2C116
{
	int num;
	int num2;
	int num3;
...
int func_425(eCharacter echParam0, eCharacter echParam1) // Position - 0x2C191
{
	int num;
	int num2;
	int num3;
	...
	num2 = func_29(echParam1);
	num3 = func_28(num, num2);
	return Global_113969.f_18106.f_175[num3 /*19*/].f_17;
}

int func_426() // Position - 0x2C1C2
{
...
BOOL func_428() // Position - 0x2C1FC
{
	if (Global_22286 == 4)
		if (AUDIO::IS_MOBILE_PHONE_CALL_ONGOING())
			return true;
...
BOOL func_429(int iParam0, int iParam1) // Position - 0x2C221
{
	if (iParam0 < 9)
		return IS_BIT_SET(Global_113969.f_18106.f_175[iParam0 /*19*/].f_18, iParam1);

	return false;
}

void func_430(int iParam0, int iParam1, BOOL bParam2) // Position - 0x2C249
{
	if (iParam0 < 9)
		if (bParam2)
			MISC::SET_BIT(&(Global_113969.f_18106.f_175[iParam0 /*19*/].f_18), iParam1);
		else
			MISC::CLEAR_BIT(&(Global_113969.f_18106.f_175[iParam0 /*19*/].f_18), iParam1);

	return;
}

BOOL func_431(eCharacter echParam0, var uParam1, var uParam2, var uParam3) // Position - 0x2C28D
{
	eCharacter character;
	int num;
	int num2;
	...
	if (!func_458(num, num2))
	{
		if (func_407(echParam0) || func_456(&uLocal_179, echParam0))
		{
			*uParam1 = 0;
			*uParam2 = 1;
			return true;
	...
	else if (func_452(num, num2))
	{
		func_451(num, &unk25, &num4);
		func_443(num, num2, &num5, &num6, true);
		func_442(character, echParam0, unk25, &unk, &unk5);
		func_442(character, echParam0, num4, &unk, &unk9);
		func_442(character, echParam0, num5, &unk, &unk13);
		func_442(character, echParam0, num6, &unk, &unk21);
		unk17 = { unk13 };
	
		if (num5 == 9)
			TEXT_LABEL_APPEND_STRING(&unk17, "_1", 16);
	
		if (func_437(&uLocal_179, func_44(num2), &unk, &unk5, &unk5, &unk9, &unk9, &unk13, &unk17, &unk21, &unk21, 12, num3, 0, 0, false))
		{
			if (num5 == 12)
				*uParam3 = 1;
			else
	...
	else if (!func_436(num2))
	{
		randomIntInRange = MISC::GET_RANDOM_INT_IN_RANGE(0, 3);
	
		if (randomIntInRange == 0)
			func_442(character, echParam0, 35, &unk, &unk5);
		else if (randomIntInRange == 1)
			func_442(character, echParam0, 36, &unk, &unk5);
		else
			func_442(character, echParam0, 37, &unk, &unk5);
	
		if (func_435(&uLocal_179, func_44(num2), &unk, &unk5, 12, num3, 0, 0, false))
		{
			*uParam1 = 0;
			*uParam2 = 0;
			return true;
	...
	{
		func_451(num, &num7, &num8);
		func_432(num, num2, &num9, &num10);
		func_442(character, echParam0, num7, &unk, &unk5);
		func_442(character, echParam0, num8, &unk, &unk9);
		func_442(character, echParam0, num9, &unk, &unk13);
		func_442(character, echParam0, num10, &unk, &unk21);
	
		if (func_437(&uLocal_179, func_44(num2), &unk, &unk5, &unk5, &unk9, &unk9, &unk13, &unk13, &unk21, &unk21, 12, num3, 0, 0, false))
		{
			*uParam1 = 0;
			*uParam2 = 0;
			return true;
...
int func_432(int iParam0, int iParam1, var uParam2, var uParam3) // Position - 0x2C4BA
{
	int num;
	var unk;

	if (!func_434(iParam0, iParam1, &unk, &num))
	{
		if (num == 1 || num == 2)
		{
			*uParam2 = 16;
	...
	else if (!func_433(iParam0, iParam1))
	{
		*uParam2 = 18;
		*uParam3 = 19;
		return 1;
...
BOOL func_433(int iParam0, int iParam1) // Position - 0x2C531
{
	return !func_49(func_44(iParam0), func_44(iParam1), 0);
}

BOOL func_434(int iParam0, int iParam1, var uParam2, var uParam3) // Position - 0x2C54B
{
	eCharacter character;
...
BOOL func_435(var uParam0, eCharacter echParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, BOOL bParam8) // Position - 0x2C58C
{
...
BOOL func_436(int iParam0) // Position - 0x2C5EB
{
	int clockHours;
...
BOOL func_437(var uParam0, eCharacter echParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, int iParam11, int iParam12, int iParam13, int iParam14, BOOL bParam15) // Position - 0x2C631
{
	var unk;
	var unk12;
	...
	unk = 10;
	unk12 = 10;
	func_439(4, &unk, &unk12, uParam3, uParam4, uParam5, uParam6, uParam7, uParam8, uParam9, uParam10, 0, 0, 0, 0, 0, 0);
	return func_438(&unk, &unk12, iParam11, bParam15);
}

BOOL func_438(var uParam0, var uParam1, int iParam2, BOOL bParam3) // Position - 0x2C694
{
	int i;
...
void func_439(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16) // Position - 0x2C9FF
{
	func_440(iParam0);
	uParam1->[0] = uParam3;
	uParam2->[0] = uParam4;
...
void func_440(int iParam0) // Position - 0x2CA6F
{
...
void func_441() // Position - 0x2CA95
{
	Global_22334 = false;
	Global_22293 = true;
	Global_22300 = false;
...
int func_442(eCharacter echParam0, eCharacter echParam1, int iParam2, char* sParam3, char* sParam4) // Position - 0x2CACE
{
	int num;
	int num2;
...
int func_443(int iParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x2CDB6
{
	int num;

	num = func_28(iParam0, iParam1);

	if (!Global_113969.f_18106.f_404)
	{
		*uParam2 = 9;
		*uParam3 = 13;
		return 1;
	}
	else if (Global_113969.f_18106.f_175[num /*19*/].f_17 < 30)
	{
		*uParam2 = 10;
		*uParam3 = 13;
		return 1;
	}
	else if (func_450(&(Global_113969.f_18106.f_175[num /*19*/].f_5)))
	{
		*uParam2 = 8;
		*uParam3 = 13;
		return 1;
	}
	else if (func_449(&(Global_113969.f_18106.f_175[num /*19*/].f_5)))
	{
		*uParam2 = 7;
		*uParam3 = 13;
		return 1;
	}
	else if (bParam4 && MISC::GET_RANDOM_INT_IN_RANGE(0, 100) < 15 && !(iParam0 == 2 && iParam1 == 0) && !(iParam0 == 0 && iParam1 == 5) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && func_444(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)))
	{
		*uParam2 = 12;
		*uParam3 = 14;
		return 1;
...
BOOL func_444(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x2CED2
{
	Vector3 outPosition;
	float outHeading;
	var outNumLanes;
	...
	if (func_448())
		if (MISC::GET_DISTANCE_BETWEEN_COORDS(vParam0, Global_96814[0 /*18*/], true) < 10f)
			return true;
		else
			func_447();
	...
	if (!func_446())
	{
		if (Global_98441 == false)
		{
			if (PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE_WITH_HEADING(vParam0, 1, &outPosition, &outHeading, &outNumLanes, 4, 1077936128, 0))
			{
				...
				if (func_445(unk7, offsetFromCoordAndHeadingInWorldCoords) > 0f)
				...
				Global_96814[0 /*18*/] = { vector };
				Global_96814[0 /*18*/].f_3 = { outPosition3 - vector };
				Global_96814[0 /*18*/].f_6 = { outPosition4 - vector };
				Global_96814[0 /*18*/].f_9 = { 0f, 0f, 0f };
				Global_96814[0 /*18*/].f_12 = 0f;
				Global_96814[0 /*18*/].f_13 = { vector2 };
				Global_96814[0 /*18*/].f_16 = 10;
				Global_96814[0 /*18*/].f_17 = 1215;
				return true;
			}
		}
	}
...
float func_445(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0x2D18F
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1);
}

BOOL func_446() // Position - 0x2D1A6
{
	return Global_96814[0 /*18*/].f_17 != false;
}

void func_447() // Position - 0x2D1B9
{
	Global_96814[0 /*18*/].f_17 = 0;
	return;
}

BOOL func_448() // Position - 0x2D1CB
{
	return Global_96814[0 /*18*/].f_17 & 1024 != 0;
}

BOOL func_449(int* piParam0) // Position - 0x2D1E2
{
...
BOOL func_450(int* piParam0) // Position - 0x2D203
{
...
int func_451(int iParam0, var uParam1, var uParam2) // Position - 0x2D224
{
	int num;
	int num2;
	int num3;
	...
	if (func_45(&num2) > 0)
	{
		num3 = Global_113969.f_18106.f_175[num2 /*19*/];
		num4 = Global_113969.f_18106.f_175[num2 /*19*/].f_1;
...
BOOL func_452(int iParam0, int iParam1) // Position - 0x2D2C6
{
	var unk;
	var unk2;
	...
	if (!func_454(iParam0, iParam1))
		if (!func_434(iParam0, iParam1, &unk2, &unk))
			return false;
...
BOOL func_453(int iParam0, int iParam1) // Position - 0x2D32D
{
	eCharacter character;
	eCharacter character2;
	int num;
	...
	if (func_54(character, character2, &num))
		if (num4 == 0)
			...
			if (func_43(num2, num, &num3))
				if (Global_113969.f_18106.f_175[num3 /*19*/].f_2 == 0)
					return true;

	return false;
}

BOOL func_454(int iParam0, int iParam1) // Position - 0x2D392
{
	int num;
	int num2;

	num = func_28(iParam0, iParam1);
	num2 = Global_113969.f_18106.f_175[num /*19*/].f_16;
...
BOOL func_455(int iParam0, int iParam1) // Position - 0x2D3C1
{
	return !func_49(func_44(iParam0), func_44(iParam1), 2);
}

BOOL func_456(var uParam0, eCharacter echParam1) // Position - 0x2D3DB
{
	int num;
	var unk;
	var unk5;
	...
	num = 0;
	func_457(func_29(echParam1), &unk, &unk5);

	if (func_435(uParam0, echParam1, &unk, &unk5, 2, num, 0, 0, false))
		return 1;

	return 0;
}

int func_457(int iParam0, char* sParam1, char* sParam2) // Position - 0x2D41F
{
...
BOOL func_458(int iParam0, int iParam1) // Position - 0x2D4AC
{
	var unk;
	var unk2;
	var unk3;
	...
	if (!func_467(iParam1))
		return false;
	else if (!func_464(iParam1))
		return false;
	else if (!func_48(iParam0, iParam1))
		return false;
	else if (!func_463(iParam0, iParam1))
		return false;
	else if (!func_461(iParam0, iParam1))
		return false;
	else if (!func_459(iParam1, &unk, &unk2, &unk3))
		return false;
	else if (func_454(iParam0, iParam1))
...
BOOL func_459(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x2D542
{
	func_460(iParam0, uParam1, uParam2);
...
int func_460(int iParam0, var uParam1, var uParam2) // Position - 0x2D5A8
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_461(int iParam0, int iParam1) // Position - 0x2D641
{
	eCharacter character;
	eCharacter character2;
	int num;
	...
	if (func_54(character, character2, &num) && func_53(num) == 0)
		if (num4 == 0)
			...
			if (func_43(num2, num, &num3) && func_53(num3) == 0)
				if (func_462(num, CHAR_JIMMY) || func_462(num2, CHAR_JIMMY))
					return false;
				else
					return true;
...
int func_462(int iParam0, eCharacter echParam1) // Position - 0x2D6CD
{
	int num;
	...
	if (num < 6)
		if (Global_113969.f_18106.f_175[iParam0 /*19*/] == num || Global_113969.f_18106.f_175[iParam0 /*19*/].f_1 == num)
			return 1;

	return 0;
}

BOOL func_463(int iParam0, int iParam1) // Position - 0x2D713
{
	return !func_49(func_44(iParam0), func_44(iParam1), 1);
}

BOOL func_464(int iParam0) // Position - 0x2D72D
{
	if (func_465(iParam0))
		return false;
...
BOOL func_465(int iParam0) // Position - 0x2D743
{
	if (iParam0 < 6)
	{
		if (func_63(&Global_113969.f_18106.f_362[iParam0 /*3*/]))
		{
			if (func_62(&Global_113969.f_18106.f_362[iParam0 /*3*/]) < 3f * 60f)
			{
				return true;
			}
			else
			{
				func_466(&Global_113969.f_18106.f_362[iParam0 /*3*/]);
				return false;
			}
		}
	}
...
void func_466(int* piParam0) // Position - 0x2D7A4
{
	piParam0->f_1 = 0f;
	piParam0->f_2 = 0f;
	*piParam0 = 0;
...
BOOL func_467(int iParam0) // Position - 0x2D7BA
{
	eCharacter character;
	int num;
	Ped ped;
	...
	if (!func_468(character))
	{
		...
		else
		{
			...
			if (num2 < 3)
				if (ENTITY::DOES_ENTITY_EXIST(Global_97347[num2]))
					return false;
		}
	}
...
BOOL func_468(eCharacter echParam0) // Position - 0x2D825
{
	func_354();
	return echParam0 == Global_113969.f_2366.f_539.f_4321;
}

BOOL func_469(eCharacter echParam0) // Position - 0x2D841
{
	if (Global_23400 == 0)
		return false;
...
BOOL func_470(int iParam0, var uParam1) // Position - 0x2D895
{
	int num;

	num = func_29(Global_97247);

	if (Global_113969.f_18106.f_175[iParam0 /*19*/].f_1 == num)
	{
		*uParam1 = Global_113969.f_18106.f_175[iParam0 /*19*/];
		return true;
	}

	if (Global_113969.f_18106.f_175[iParam0 /*19*/] == num)
	{
		*uParam1 = Global_113969.f_18106.f_175[iParam0 /*19*/].f_1;
		return true;
	}
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x2D8FC
{
	func_354();
	return Global_113969.f_2366.f_539.f_4321;
}

void func_472(int iParam0, int iParam1) // Position - 0x2D915
{
	if (iParam0 < 9)
	{
...
void func_473() // Position - 0x2D942
{
	return;
}

void func_474() // Position - 0x2D94A
{
	func_477(true);
	func_475();
	func_404(&uLocal_97);
...
void func_475() // Position - 0x2D961
{
	func_476(11, 0, 68);
	func_476(13, 1, 96);
	func_476(16, 1, 97);
...
void func_476(int iParam0, int iParam1, int iParam2) // Position - 0x2DA27
{
	Global_97249[iParam0 /*2*/].f_1 = iParam1;
	Global_97249[iParam0 /*2*/] = iParam2;
	return;
}

void func_477(BOOL bParam0) // Position - 0x2DA45
{
	if (bParam0)
	{
		func_481(0, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 10);
		func_480(0f, 0f, 0f, 0f, 0f, 0f, 0f);
	}

	func_481(1, -824.9975f, 179.9752f, 70.4895f, 5.8945f, -0.6014f, 0.6636f, 7.3145f, -2.6014f, 0.7136f, 0);
	func_480(-860.8041f, 136.4404f, 59.025f, 0.6456f, -828.7663f, 178.8821f, 71.2117f);
	func_479(1);
	func_478(896);
	func_481(2, 1986.8676f, 3810.9841f, 31.1159f, -2.28f, 0.42f, 0.11f, -1.02f, 2.28f, 0.0138f, 1);
	func_480(2138.5615f, 3767.5957f, 32.1819f, 120.8022f, 1995.6809f, 3818.5762f, 32.1837f);
	func_479(1);
	func_478(896);
	func_481(3, -13.8595f, -1454.3317f, 29.4997f, 0.1999f, 8.5446f, 0.1003f, -1.0001f, 7.9046f, 0.1003f, 5);
	func_480(70.9006f, -1477.2407f, 28.2852f, 140.958f, -24.3995f, -1457.3259f, 30.6446f);
	func_479(2);
	func_478(896);
	func_481(4, 10.8316f, 549.0906f, 174.9739f, -1.4644f, -9.0339f, 0.0539f, -2.4844f, -8.6139f, -0.0211f, 6);
	func_480(-90.6814f, 511.137f, 142.8975f, 68.9617f, 5.0911f, 547.0732f, 174.9908f);
	func_479(2);
	func_478(896);
	func_481(5, 1986.8674f, 3810.984f, 31.1159f, -2.28f, 0.42f, 0.11f, -1.02f, 2.28f, 0.0138f, 2);
	func_480(2138.5615f, 3767.5957f, 32.1819f, 120.8022f, 1995.6809f, 3818.5762f, 32.1837f);
	func_479(4);
	func_478(896);
	func_481(6, -1158.263f, -1515.8615f, 3.2873f, 3.7331f, 0.363f, 0.0341f, 3.1931f, 1.563f, 0.0341f, 3);
	func_480(-1079.3735f, -1475.24f, 4.1272f, 25.0007f, -1166.1702f, -1519.4685f, 4.229f);
	func_479(4);
	func_478(896);
	func_481(7, 132.7787f, -1305.2081f, 28.1826f, -1.1933f, 4.1322f, 0.0451f, -2.1933f, 3.8922f, -0.0049f, 4);
	func_480(65.7439f, -1308.3253f, 28.3417f, 210.5102f, 125.2967f, -1307.992f, 29.2187f);
	func_479(4);
	func_478(768);
	func_481(8, 176.9471f, -1340.8126f, 28.2908f, -1.2f, 2.1f, 0.0032f, -3f, 0.12f, 0.0032f, 4);
	func_480(361.4975f, -1296.7698f, 31.3318f, 140.8159f, 182.2761f, -1333.3795f, 28.8827f);
	func_479(4);
	func_478(640);
	func_481(9, -57.8633f, -1459.2397f, 30.994f, -1.14f, 2.52f, 0.22f, -3.36f, 1.74f, 0.1667f, 10);
	func_480(68.9364f, -1479.6398f, 29.2941f, 145.6588f, -50.0051f, -1459.1348f, 31.9645f);
	func_479(8);
	func_478(896);
	func_481(10, -14.7793f, -114.3548f, 55.8073f, -0.7199f, 3.7608f, 0.05f, 0.76f, 3.48f, 0.05f, 10);
	func_480(40.216f, -256.6415f, 47.4194f, 340.2766f, -23.3476f, -113.7569f, 55.8956f);
	func_479(1);
	func_478(384);
	func_481(11, -597.897f, -305.1185f, 33.9548f, -1.02f, 0.84f, -0.047f, 0f, 1.68f, -0.047f, 10);
	func_480(-584.9772f, -258.7058f, 34.8225f, 210.2552f, -590.3728f, -302.9131f, 34.853f);
	func_479(32);
	func_478(384);
	func_481(12, -155.6107f, -175.4378f, 42.7614f, 4.5615f, 6.7732f, -0.1419f, 3.1815f, 7.1932f, -0.1419f, 10);
	func_480(-107.3334f, -191.8515f, 45.7935f, 165.1659f, -158.1629f, -174.8294f, 43.2478f);
	func_479(16);
	func_478(384);
	func_481(13, 194.0434f, -42.2946f, 67.5703f, 0.24f, 4.86f, 0f, 1.5f, 4.68f, 0f, 10);
	func_480(298.4399f, -19.2893f, 75.8441f, 157.1038f, 202.8657f, -46.2839f, 68.6749f);
	func_479(6);
	func_478(384);
	func_481(14, -165.44f, -788.5505f, 30.9774f, -6.3719f, 2.4632f, 0.0021f, -7.3019f, 1.7432f, 0.0021f, 10);
	func_480(-156.6818f, -713.4197f, 33.5995f, 241.8992f, -159.4454f, -778.2214f, 32.2215f);
	func_479(33);
	func_478(384);
	func_481(15, -820.9531f, -1088.2756f, 10.0086f, -1.804f, 4.1191f, 0.1191f, -3.124f, 3.2191f, 0.1191f, 10);
	func_480(-841.6274f, -1165.0057f, 6.0014f, 294.8121f, -819.1121f, -1091.4512f, 10.6171f);
	func_479(6);
	func_478(128);
	func_481(16, 234.715f, -959.095f, 28.2856f, -1.6816f, -0.2787f, 0.0127f, -1.0216f, 1.4013f, 0.0127f, 10);
	func_480(354.8806f, -855.5883f, 28.3444f, 89.9428f, 240.9607f, -948.6324f, 28.1587f);
	func_479(18);
	func_478(384);
	func_481(17, 249.3746f, -1008.3277f, 28.2705f, 3.848f, -3.0003f, 0.0001f, 4.328f, -1.8003f, 0.0001f, 10);
	func_480(238.4106f, -1127.997f, 28.2691f, 87.3779f, 244.4703f, -1020.0197f, 29.1059f);
	func_479(4);
	func_478(256);
	func_481(18, -210.3783f, -1498.2042f, 30.4273f, 2.28f, -2.727f, 0.1f, 0.6f, -2.727f, 0.1f, 10);
	func_480(-281.035f, -1533.1519f, 26.3419f, 343.7635f, -219.2698f, -1492.0404f, 31.2461f);
	func_479(8);
	func_478(384);
	func_481(19, -1220.5693f, -773.4271f, 17.1055f, 3.8194f, 4.9089f, 0.0656f, 5.9194f, 4.1889f, -0.0844f, 10);
	func_480(-1212.7676f, -876.4072f, 12.1331f, 309.3317f, -1209.4172f, -785.0978f, 16.9499f);
	func_479(49);
	func_478(384);
	func_481(20, -1391.7634f, -584.7326f, 29.2332f, -2.1715f, -1.7725f, -0.01f, -2.6515f, -3.3925f, -0.11f, 10);
	func_480(-1513.6841f, -678.0259f, 27.4965f, 47.765f, -1409.2719f, -590.8218f, 30.3243f);
	func_479(4);
	func_478(256);
	func_481(21, -1345.2792f, -385.1048f, 35.755f, 1.86f, -0.78f, 0f, 1.2f, -1.62f, 0f, 10);
	func_480(-1325.355f, -453.5642f, 33.4523f, 35.295f, -1346.2457f, -397.871f, 36.6207f);
	func_479(10);
	func_478(384);
	func_481(22, -14.6068f, 6505.2427f, 30.5105f, -0.5104f, -7.4223f, 0.0239f, 0.8696f, -6.2223f, 0.0239f, 10);
	func_480(90.1534f, 6595.789f, 30.5382f, 47.4841f, -8.4122f, 6513.6074f, 31.3368f);
	func_479(63);
	func_478(384);
	func_481(23, 1393.7161f, 3592.5854f, 33.9297f, 0.8771f, 4.9569f, 0.0859f, -0.9829f, 5.4369f, 0.0859f, 10);
	func_480(1449.0967f, 3669.69f, 33.1474f, 201.6678f, 1408.6346f, 3599.183f, 34.8791f);
	func_479(63);
	func_478(384);
	return;
}

void func_478(int iParam0) // Position - 0x2E3AB
{
	Global_96814[iLocal_92 /*18*/].f_17 = Global_96814[iLocal_92 /*18*/].f_17 || iParam0;
	return;
}

void func_479(int iParam0) // Position - 0x2E3CA
{
	Global_96814[iLocal_92 /*18*/].f_17 = Global_96814[iLocal_92 /*18*/].f_17 || iParam0;
	return;
}

void func_480(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x2E3E9
{
	Global_96814[iLocal_92 /*18*/].f_9 = { fParam0 };
	Global_96814[iLocal_92 /*18*/].f_12 = fParam3;
	Global_96814[iLocal_92 /*18*/].f_13 = { fParam4 };
	return;
}

void func_481(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, float fParam9, int iParam10) // Position - 0x2E41D
{
	iLocal_92 = iParam0;
	Global_96814[iLocal_92 /*18*/] = { fParam1 };
	Global_96814[iLocal_92 /*18*/].f_3 = { fParam4 };
	Global_96814[iLocal_92 /*18*/].f_6 = { fParam7 };
	Global_96814[iLocal_92 /*18*/].f_17 = 0;
	Global_96814[iLocal_92 /*18*/].f_16 = iParam10;
	return;
}

void func_482() // Position - 0x2E46E
{
	int i;
	int j;
	...
	for (i = 0; i < 9; i = i + 1)
	{
		if (Global_97369[i /*2*/] == 1 || Global_97369[i /*2*/] == 2 || Global_97369[i /*2*/] == 3)
			func_472(i, 0);
	}

	func_403(&uLocal_97, false);

	for (j = 0; j < 3; j = j + 1)
	{
		if (!PED::IS_PED_INJURED(Global_97351[j]))
		{
			func_374(Global_97351[j]);
			Global_97351[j] = 0;
		}
	}
