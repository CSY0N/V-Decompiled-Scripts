...
void main() // Position - 0x0 Hash - 0x5D84F89F ^0x5D84F89F
{
	...
	fLocal_23 = -0.0375f;
	fLocal_24 = 0.17f;
	TEXT_LABEL_ASSIGN_STRING(&uLocal_620, "JHP1ADS", 16);
	TEXT_LABEL_ASSIGN_STRING(&uLocal_624, "JEWEL_STORE_HEIST_SETUP_BUGSTAR_ALARMS", 64);
	uLocal_640 = { 154.94778f, -3092.5234f, 4.911984f };
	TEXT_LABEL_ASSIGN_STRING(&uLocal_643, "jhp1a_sec_arrive", 24);
	iLocal_649 = 0;
	iLocal_655 = 6;
	iLocal_2552 = -1;
	iLocal_2556 = -1;
	iLocal_2557 = -1;
	TEXT_LABEL_ASSIGN_STRING(&uLocal_2558, "", 16);
	TEXT_LABEL_ASSIGN_STRING(&uLocal_2562, "", 16);
	fLocal_2567 = 100000000f;
	bLocal_2570 = 1;
	iLocal_2573 = -1;
	TEXT_LABEL_ASSIGN_STRING(&uLocal_2574, "", 16);
	iLocal_2578 = -1;
	bLocal_2579 = true;
	iLocal_2583 = -1;
	iLocal_2584 = -1;
	TEXT_LABEL_ASSIGN_STRING(&uLocal_2585, "", 16);
	TEXT_LABEL_ASSIGN_STRING(&uLocal_2589, "", 16);
	bLocal_2593 = true;
	bLocal_2595 = true;
	iLocal_2599 = -1;
	iLocal_2601 = -1;
...
void func_1() // Position - 0x143 Hash - 0xD2C8FEC5 ^0xD2C8FEC5
{
	switch (iLocal_649)
	{
		case 0:
...
void func_2() // Position - 0x175 Hash - 0x6F17B1D1 ^0x84D0C7F5
{
	int entityHealth;

	if (iLocal_2602 != -1 && ENTITY::DOES_ENTITY_EXIST(iLocal_577[iLocal_2602 /*8*/]) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_577[iLocal_2602 /*8*/], false))
	{
		entityHealth = ENTITY::GET_ENTITY_HEALTH(iLocal_577[iLocal_2602 /*8*/]);
		func_23(iLocal_577[iLocal_2602 /*8*/], -1);
	}

	if (entityHealth >= 750 || entityHealth <= 0)
		Global_97797 = 1000;
	else
		Global_97797 = entityHealth;

	if (!func_22(&uLocal_1696[3 /*8*/]))
		func_21(699);
...
void func_3(BOOL bParam0, BOOL bParam1) // Position - 0x21C Hash - 0x56032C5B ^0x18DFBA48
{
	int num;
	int num2;
	...
	if (bParam0)
	{
		if (_IS_MISSION_REPEAT_ACTIVE(false) && Global_79495.f_1 == 1 && func_5(Global_79495))
		{
		}
		else
		{
...
int func_4() // Position - 0x2EC Hash - 0x39D9D518 ^0xBC98C03C
{
	int i;
...
BOOL func_5(int iParam0) // Position - 0x31E Hash - 0xE5CDC45F ^0xE5CDC45F
{
	switch (iParam0)
	{
		case 71:
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x35C Hash - 0x15889021 ^0xE7262364
{
...
BOOL func_7(int iParam0) // Position - 0x384 Hash - 0x35F9F9C ^0x35F9F9C
{
...
void func_8(BOOL bParam0) // Position - 0x3B0 Hash - 0x8EF6F4FF ^0xDE87DACF
{
	int i;
	int j;
	...
	func_18(&uLocal_1696);
	func_13(&uLocal_1671, true, false);
	bLocal_2551 = false;
	iLocal_2552 = -1;
	bLocal_2596 = false;
	bLocal_2597 = false;
	...
	for (i = 0; i < iLocal_618; i = i + 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_618[i]))
			if (bParam0)
				OBJECT::DELETE_OBJECT(&iLocal_618[i]);
			else
				ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&iLocal_618[i]);
	}

	for (i = 0; i < iLocal_26; i = i + 1)
	{
		func_10(&iLocal_26[i /*110*/], bParam0);
	}

	func_10(&pedLocal_467, bParam0);

	for (i = 0; i < iLocal_577; i = i + 1)
	{
		for (j = 0; j < 4; j = j + 1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_577[i /*8*/].f_2[j]))
				if (bParam0)
					PED::DELETE_PED(&iLocal_577[i /*8*/].f_2[j]);
				else
					ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&iLocal_577[i /*8*/].f_2[j]);
		}
	
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_577[i /*8*/]))
			if (bParam0)
				VEHICLE::DELETE_VEHICLE(&iLocal_577[i /*8*/]);
			else
				ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_577[i /*8*/]);
	}

	if (AUDIO::IS_ALARM_PLAYING(&uLocal_624))
		AUDIO::STOP_ALARM(&uLocal_624, bParam0);
...
void func_9() // Position - 0x608 Hash - 0xFEC7C9F6 ^0xFEC7C9F6
{
	Global_97227 = 0;
	return;
}

void func_10(Ped* ppedParam0, BOOL bParam1) // Position - 0x615 Hash - 0xF17DDEF0 ^0x4857DBF4
{
	...
	ppedParam0->f_40 = 0;
	ppedParam0->f_92 = -1;
	ppedParam0->f_43 = { 0f, 0f, 0f };
	ppedParam0->f_88 = { 0f, 0f, 0f };
	ppedParam0->f_91 = 0;

	if (ENTITY::DOES_ENTITY_EXIST(ppedParam0->f_105))
	{
		if (ENTITY::IS_ENTITY_ATTACHED(ppedParam0->f_105))
			ENTITY::DETACH_ENTITY(ppedParam0->f_105, true, true);
	
		if (bParam1)
			OBJECT::DELETE_OBJECT(&(ppedParam0->f_105));
		else
			ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&(ppedParam0->f_105));
	}
...
void func_11() // Position - 0x6E4 Hash - 0xC536DD5 ^0xC536DD5
{
	Global_21032 = 0;
	func_12();
	return;
...
void func_12() // Position - 0x6F4 Hash - 0xF6D04E68 ^0x80AE5309
{
...
void func_13(Blip* pblParam0, BOOL bParam1, BOOL bParam2) // Position - 0x715 Hash - 0x634140C0 ^0xD1086239
{
	int i;
	...
	for (i = 0; i < 3; i = i + 1)
	{
		if (!PED::IS_PED_INJURED(pblParam0->f_17[i]))
		{
			...
			if (bParam1)
				if (PED::IS_PED_GROUP_MEMBER(pblParam0->f_17[i], func_14()) && pblParam0->f_17[i] != PLAYER::PLAYER_PED_ID())
...
int func_14() // Position - 0x8C0 Hash - 0xDED80B4D ^0xD3C18941
{
	return PLAYER::GET_PLAYER_GROUP(PLAYER::GET_PLAYER_INDEX());
}

void func_15(int iParam0, Blip* pblParam1) // Position - 0x8D0 Hash - 0x15448333 ^0xBC910CAF
{
	switch (iParam0)
	{
		case 0:
...
void func_16(int iParam0, Blip* pblParam1) // Position - 0x918 Hash - 0x1E3FA253 ^0xEDD411CE
{
	switch (iParam0)
	{
		case 0:
...
void func_17(Blip* pblParam0) // Position - 0x960 Hash - 0x2F9D6A60 ^0x6561436A
{
...
void func_18(var uParam0) // Position - 0x97B Hash - 0x7D3EE57A ^0x7D3EE57A
{
	int i;
...
void func_19(var uParam0) // Position - 0x9A1 Hash - 0x23200235 ^0x23200235
{
	if (!func_20(uParam0))
		*uParam0 = 0;
...
BOOL func_20(var uParam0) // Position - 0x9B7 Hash - 0x276CB350 ^0x276CB350
{
	if (*uParam0 == 0)
		return true;
...
void func_21(int iParam0) // Position - 0x9CE Hash - 0xDB2F75DE ^0xDB2F75DE
{
	BOOL flag;
	int i;
...
BOOL func_22(var uParam0) // Position - 0xA3F Hash - 0xEE94F424 ^0xEFD1669
{
...
void func_23(Vehicle veParam0, int iParam1) // Position - 0xA6D Hash - 0xEA11BB32 ^0x75D6FA73
{
	int i;
...
void func_24(int iParam0) // Position - 0xAD8 Hash - 0x35831929 ^0x35831929
{
	if (iParam0 == 2)
	{
	}
...
BOOL func_25() // Position - 0xAF6 Hash - 0x91FACC27 ^0x849530CB
{
	BOOL flag;

	if (!bLocal_651)
	{
		func_176(&uLocal_656, "SCRIPT\\JWL_HA_RAID_STORE");
		func_175(&uLocal_656, joaat("S_M_M_Security_01"));
		func_174(&uLocal_1696[1 /*8*/], 0, false, 1);
		func_174(&uLocal_1696[0 /*8*/], 0, false, 1);
		func_174(&uLocal_1696[4 /*8*/], 0, false, 1);
		func_112(0f, 0f, 0f, 0f, 1, _GET_CURRENT_PLAYER_CHARACTER());
		Global_97797 = 1000;
		PLAYER::SET_WANTED_LEVEL_MULTIPLIER(0.1f);
		_SHOW_SUBTITLE_CLEAR_EXISTING("JHP1A_STEAL_BSV", 7500, 1);
		bLocal_651 = true;
	}
	...
	if (bLocal_651)
	{
		switch (iLocal_650)
		{
			case 0:
				...
				else if (func_104() && ENTITY::DOES_ENTITY_EXIST(iLocal_577[func_103() /*8*/]) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_577[func_103() /*8*/], false))
				{
					...
					if (iLocal_2602 != func_103())
					{
						...
						func_23(iLocal_577[func_103() /*8*/], -1);
						func_105(iLocal_577[func_103() /*8*/], -1);
						iLocal_2602 = func_103();
					}
				
					if (func_101(&uLocal_1671, 692.8256f, -1012.5445f, 21.722f, 692.9143f, -1003.5558f, 21.508389f, 692.6511f, -1021.6041f, 26.206753f, 9.75f, true, iLocal_577[func_103() /*8*/], "", "", "", true, 0, true, INVALID))
						iLocal_650 = iLocal_650 + 1;
				}
				else if (func_100())
				{
					VEHICLE::SET_RANDOM_VEHICLE_DENSITY_MULTIPLIER_THIS_FRAME(0.5f);
					func_56(&uLocal_1671, 692.8256f, -1012.5445f, 21.722f, 0.1f, 0.1f, 0.1f, true, veLocal_2603, "", "", "", true, 0, true, INVALID);
				
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_577[func_55() /*8*/], 692.9143f, -1003.5558f, 21.508389f, 692.6511f, -1021.6041f, 26.206753f, 9.75f, false, true, 0))
						iLocal_650 = iLocal_650 + 1;
				}
				else
				{
			...
			case 1:
				if (func_104())
					if (func_52(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 5f, 1, 1056964608, false, true, false))
						flag = true;
				else if (func_100())
					if (func_52(veLocal_2603, 5f, 1, 1056964608, false, true, false))
						flag = true;
				...
				if (flag)
				{
					...
					if (func_104())
					{
						VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(iLocal_577[iLocal_2602 /*8*/], false);
					}
					else if (func_100())
					{
						VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(iLocal_577[func_55() /*8*/], false);
						VEHICLE::SET_VEHICLE_DISABLE_TOWING(iLocal_577[func_55() /*8*/], true);
						VEHICLE::DETACH_VEHICLE_FROM_ANY_TOW_TRUCK(iLocal_577[func_55() /*8*/]);
					}
			...
			case 1000:
				...
				{
					_CONVERSATION_INITIALIZE_ACTOR(&uLocal_2386, 3, 0, "LESTER", 0, 1);
				
					if (func_28(&uLocal_2386, 12, "JHFAUD", "JHF_P10c", 8, 1, 0, 0, false))
						iLocal_650 = iLocal_650 + 1;
				}
				break;
...
void func_26() // Position - 0xEA8 Hash - 0x30030AB2 ^0x19CBFA53
{
	int i;
...
BOOL func_27() // Position - 0xF5B Hash - 0x3E5D30B5 ^0x66847798
{
...
BOOL func_28(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, BOOL bParam8) // Position - 0xF84 Hash - 0xB2BF6D68 ^0xB2BF6D68
{
...
BOOL func_29(char* sParam0, int iParam1, BOOL bParam2) // Position - 0xFE3 Hash - 0x77297D51 ^0x40DC584A
{
	Global_22167 = 0;
...
void func_30() // Position - 0x12B1 Hash - 0xF42BEB19 ^0xA29557DA
{
	if (!func_31())
		return;
...
BOOL func_31() // Position - 0x12E8 Hash - 0x7B74B45F ^0xCE052A5D
{
...
BOOL func_32(ePedComponentType epctParam0) // Position - 0x134B Hash - 0x6E46BC72 ^0x6E46BC72
{
	return func_33(epctParam0, 20);
}

BOOL func_33(ePedComponentType epctParam0, int iParam1) // Position - 0x135B Hash - 0x7CD5054C ^0x870BEA81
{
	return IS_BIT_SET(Global_1886967[epctParam0 /*609*/].f_10.f_4, iParam1);
}

Player _INVALID_PLAYER_INDEX() // Position - 0x1373 Hash - 0x478900E4 ^0x478900E4
{
	return -1;
}

void func_35() // Position - 0x137C Hash - 0x56A7738B ^0xC5F5F9
{
	int i;
...
void func_36() // Position - 0x13AD Hash - 0xCD8A4D28 ^0xCD8A4D28
{
...
BOOL func_37() // Position - 0x1442 Hash - 0xD140D54A ^0xE638D98F
{
...
BOOL func_38() // Position - 0x1469 Hash - 0x9A999369 ^0x4033F7BF
{
	int num;
	int weaponHash;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x1502 Hash - 0x98476CE1 ^0x250FEB7C
{
	if (func_40(14))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
...
BOOL func_40(int iParam0) // Position - 0x15A4 Hash - 0x937D8816 ^0x937D8816
{
	return Global_43922 == iParam0;
}

void func_41() // Position - 0x15B2 Hash - 0x8F25DAD1 ^0x9F4D529F
{
	int i;
...
BOOL func_42(int iParam0, int iParam1) // Position - 0x1609 Hash - 0xA14C4D3F ^0xA6034F77
{
	switch (iParam0)
	{
		case 5:
...
void func_43() // Position - 0x1641 Hash - 0xE32CF1EF ^0xB9A7BEB2
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_23177 = 0;
...
void func_44(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x1698 Hash - 0xC6B752B2 ^0xC6B752B2
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x16EE Hash - 0x6C235EE0 ^0x9E57F206
{
...
void func_46() // Position - 0x1789 Hash - 0xC536DD5 ^0xC536DD5
{
	Global_21032 = 0;
	func_47();
	return;
...
void func_47() // Position - 0x1799 Hash - 0x21027D29 ^0xBEB9ECFD
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
...
BOOL func_48() // Position - 0x17BD Hash - 0xD0D4EACB ^0xE3E0578A
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x17E3 Hash - 0x152DA0B2 ^0x220E93E9
{
...
void func_50(BOOL bParam0, BOOL bParam1) // Position - 0x1805 Hash - 0x23F963F4 ^0x9321E2D5
{
	if (!bParam1)
...
void func_51(BOOL bParam0) // Position - 0x18BF Hash - 0xE2D43119 ^0xDD9AD4EF
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
	{
...
BOOL func_52(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x193B Hash - 0xEF9D4F61 ^0xC848BDEA
{
...
void func_53(Vehicle veParam0) // Position - 0x1992 Hash - 0x94E8CB0B ^0x47923A23
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_54(BOOL bParam0, BOOL bParam1) // Position - 0x19BE Hash - 0xC86614C6 ^0xCD39041A
{
...
int func_55() // Position - 0x1B0F Hash - 0x88EB581E ^0x79CE8336
{
	int i;
	...
	if (func_100())
	{
		for (i = 0; i <= 2; i = i + 1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_577[i /*8*/]) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_577[i /*8*/], false))
				if (VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(veLocal_2603, iLocal_577[i /*8*/]))
					return i;
		}
	}
...
BOOL func_56(Blip* pblParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, BOOL bParam7, Vehicle veParam8, char* sParam9, char* sParam10, char* sParam11, BOOL bParam12, int iParam13, BOOL bParam14, eBlipSprite ebsParam15) // Position - 0x1B66 Hash - 0xEB9D47F8 ^0xEB9D47F8
{
	return func_57(pblParam0, fParam1, fParam4, func_99(), func_99(), bParam7, 5, 0, 0, 0, veParam8, sParam9, func_98(), func_98(), func_98(), func_98(), sParam10, false, bParam12, sParam11, false, iParam13, bParam14, ebsParam15, 0, 0, 0, true, 1065353216);
}

BOOL func_57(Blip* pblParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6, Vector3 vParam7, var uParam8, var uParam9, Vector3 vParam10, var uParam11, var uParam12, BOOL bParam13, int iParam14, int iParam15, int iParam16, int iParam17, Vehicle veParam18, char* sParam19, char* sParam20, char* sParam21, char* sParam22, char* sParam23, char* sParam24, BOOL bParam25, BOOL bParam26, char* sParam27, BOOL bParam28, int iParam29, BOOL bParam30, eBlipSprite ebsParam31, char* sParam32, char* sParam33, char* sParam34, BOOL bParam35, int iParam36) // Position - 0x1BB5 Hash - 0xF32A40D2 ^0xFCCFE72F
{
	...
	if (func_79(pblParam0, pblParam0->f_17[0], pblParam0->f_17[1], pblParam0->f_17[2], sParam20, sParam21, sParam22, sParam23, pblParam0->f_8, bParam25, veParam18, false, false, sParam32, sParam33, sParam34, iParam14, bParam26))
	{
		func_78(sParam20);
		func_78(sParam21);
		func_78(sParam22);
		...
		if (CAM::IS_SCREEN_FADED_IN())
		{
			...
			if (flag)
			{
				func_78(sParam24);
				func_78(sParam27);
				func_78("MORE_SEATS" /*A vehicle with more seats is needed.*/);
				...
				if (bParam26 && PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
				{
					...
					if (!func_73(pblParam0, 1) && !func_72(pblParam0) && !IS_BIT_SET(pblParam0->f_13, 0))
					{
						if (bParam30)
						{
							func_71(pblParam0, "LOSE_WANTED" /*Lose the Cops.*/, false);
						
							if (!PED::IS_PED_INJURED(pblParam0->f_17[0]))
								func_69(pblParam0->f_17[0], "VEHICLE_POLICE_PURSUIT", 3);
						}
				...
				else
				{
					...
					{
						func_78("LOSE_WANTED" /*Lose the Cops.*/);
					...
					{
						if (!func_73(pblParam0, 1))
						{
							if (!PED::IS_PED_INJURED(pblParam0->f_17[0]))
								func_69(pblParam0->f_17[0], "LOSE_WANTED_LEVEL", 3);
					...
					if (!HUD::DOES_BLIP_EXIST(pblParam0->f_5))
					{
						...
						pblParam0->f_5 = func_68(vector, false);
					
						if (!(ebsParam31 == INVALID))
							HUD::SET_BLIP_SPRITE(pblParam0->f_5, ebsParam31);
					
						if (bParam35)
							func_67(pblParam0->f_5, pblParam0);
					}
					else if (!func_66(vector, HUD::GET_BLIP_COORDS(pblParam0->f_5), 0.1f, false))
					{
					...
					if (!func_73(pblParam0, 2))
					{
						if (!IS_BIT_SET(pblParam0->f_13, 2))
						{
							func_71(pblParam0, sParam19, false);
					...
					if (flag)
					{
						...
						for (i = 0; i < 3; i = i + 1)
						{
							if (!PED::IS_PED_INJURED(pblParam0->f_17[i]))
							{
								...
								else if (!PED::IS_PED_GROUP_MEMBER(pblParam0->f_17[i], func_14()) || !func_64(pblParam0->f_17[i], true))
								{
									flag = false;
								}
							}
				...
				else
				{
					...
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam18, false))
					{
						if (!HUD::DOES_BLIP_EXIST(*pblParam0))
						{
							...
							*pblParam0 = func_58(veParam18, false, false);
							HUD::SET_BLIP_DISPLAY(*pblParam0, 2);
						
							if (!IS_BIT_SET(pblParam0->f_13, 4))
								func_67(*pblParam0, pblParam0);
						}
						...
						if (!func_73(pblParam0, 2))
						{
							...
							{
								func_71(pblParam0, sParam24, false);
								MISC::SET_BIT(&(pblParam0->f_13), 3);
								MISC::CLEAR_BIT(&(pblParam0->f_13), 4);
							}
							else if (IS_BIT_SET(pblParam0->f_13, 9))
							{
								if (!MISC::IS_STRING_NULL(sParam27))
								{
									if (!IS_BIT_SET(pblParam0->f_13, 4))
									{
										func_71(pblParam0, sParam27, false);
								...
								{
									if (!PED::IS_PED_INJURED(pblParam0->f_17[0]))
										func_69(pblParam0->f_17[0], "GET_IN_CAR", 3);
							...
							if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
							{
								if (!IS_BIT_SET(pblParam0->f_13, 13))
								{
									...
									if (!PED::IS_PED_INJURED(pblParam0->f_17[randomIntInRange]))
										func_69(pblParam0->f_17[randomIntInRange], "NEED_A_BIGGER_VEHICLE", 3);
								
									func_71(pblParam0, "MORE_SEATS" /*A vehicle with more seats is needed.*/, false);
...
Blip func_58(Vehicle veParam0, BOOL bParam1, BOOL bParam2) // Position - 0x24BA Hash - 0x177BFEFF ^0x177BFEFF
{
	return func_59(veParam0, !bParam1, bParam2);
}

Blip func_59(Entity eParam0, BOOL bParam1, BOOL bParam2) // Position - 0x24CD Hash - 0x2E5A72B ^0x64F26CC0
{
	Blip blip;
...
var func_60(BOOL bParam0, var uParam1, var uParam2) // Position - 0x2571 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
BOOL func_61(Blip* pblParam0) // Position - 0x2588 Hash - 0x6909601B ^0x43769063
{
	if (IS_BIT_SET(pblParam0->f_13, 12))
		if (func_63(PLAYER::PLAYER_PED_ID()))
			if (func_62(true, false, true) || IS_BIT_SET(pblParam0->f_13, 7))
				return true;
	else if (func_62(true, false, true) || IS_BIT_SET(pblParam0->f_13, 7))
		return true;

	return false;
}

BOOL func_62(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x25DD Hash - 0xF0D380FF ^0x29DD7336
{
	Vehicle vehiclePedIsIn;
...
BOOL func_63(Ped pedParam0) // Position - 0x26C2 Hash - 0x71630E54 ^0xA6BB5465
{
	float entitySpeed;
...
BOOL func_64(Ped pedParam0, BOOL bParam1) // Position - 0x26F9 Hash - 0x66565C22 ^0x7D7F41BD
{
	if (!PED::IS_PED_INJURED(pedParam0))
	{
		if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()) && bParam1)
		{
			if (func_65(PLAYER::PLAYER_PED_ID(), pedParam0))
			{
				PED::SET_GROUP_SEPARATION_RANGE(func_14(), 50f);
				return true;
			}
		}
		else if (PED::IS_PED_GROUP_MEMBER(pedParam0, func_14()))
		{
			PED::SET_GROUP_SEPARATION_RANGE(func_14(), 50f);
			return true;
		}
...
BOOL func_65(Ped pedParam0, Ped pedParam1) // Position - 0x2764 Hash - 0xB2684CBC ^0x4356A1AE
{
	Vehicle vehiclePedIsIn;
...
BOOL func_66(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, int iParam6, BOOL bParam7) // Position - 0x27AC Hash - 0x1FB736D4 ^0x234AEAB7
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
void func_67(Blip blParam0, Blip* pblParam1) // Position - 0x2827 Hash - 0xB76BB510 ^0x44EEA9C5
{
...
Blip func_68(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x2862 Hash - 0xF4E99477 ^0x29669E98
{
	Blip blip;
...
void func_69(Ped pedParam0, char* sParam1, int iParam2) // Position - 0x288E Hash - 0x48D349EA ^0xA208047E
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(pedParam0, sParam1, AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(iParam2), 1);
	return;
}

char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x28A5 Hash - 0xA17D549C ^0x2E3406FE
{
	char* str;
...
void func_71(Blip* pblParam0, char* sParam1, BOOL bParam2) // Position - 0x2A9A Hash - 0xED6F4513 ^0xFBC22E6C
{
	if (!bParam2)
...
BOOL func_72(Blip* pblParam0) // Position - 0x2AD1 Hash - 0x76C26D7D ^0xC80C7EEA
{
...
BOOL func_73(Blip* pblParam0, int iParam1) // Position - 0x2AF5 Hash - 0x4C09C8B0 ^0x26FD74C8
{
	if (iParam1 != 1 || HUD::IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
	{
		...
		if (func_75(pblParam0))
			return true;
	}

	if (iParam1 != 2 || HUD::IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
		if (_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && !func_74())
			return true;

	return false;
}

BOOL func_74() // Position - 0x2B4D Hash - 0xB8E6BAC9 ^0xB8E6BAC9
{
	if (Global_23177 == 1)
		return true;
...
BOOL func_75(Blip* pblParam0) // Position - 0x2B64 Hash - 0xAF65C0BD ^0x2A755CFA
{
	int num;
	int gameTimer;
...
BOOL func_76(Blip* pblParam0, int iParam1) // Position - 0x2B87 Hash - 0x8E2FACB ^0xA4BF42F5
{
	Vehicle vehiclePedIsIn;
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		if (func_77(vehiclePedIsIn, pblParam0, iParam1))
			return true;
	}
...
BOOL func_77(Vehicle veParam0, Blip* pblParam1, int iParam2) // Position - 0x2BB8 Hash - 0xD4375383 ^0x983550B3
{
	int num;
...
void func_78(char* sParam0) // Position - 0x2C4C Hash - 0x78302BA0 ^0xA1CD23FC
{
...
BOOL func_79(Blip* pblParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, char* sParam7, float fParam8, BOOL bParam9, Vehicle veParam10, BOOL bParam11, BOOL bParam12, var uParam13, var uParam14, var uParam15, int iParam16, BOOL bParam17) // Position - 0x2C64 Hash - 0x6DAD9811 ^0xC9215DBA
{
	int i;
	int num;
	int num2;
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(pblParam0->f_21, false))
		{
			if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(pblParam0->f_21, true)) < 400f)
			{
				if (!PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
				{
					...
					{
						if (func_77(pblParam0->f_21, pblParam0, num3))
						{
							for (i = 0; i < 3; i = i + 1)
							{
								if (!PED::IS_PED_INJURED(pblParam0->f_17[i]))
								{
									...
									if (PED::IS_PED_GROUP_MEMBER(pblParam0->f_17[i], func_14()))
										PED::REMOVE_PED_FROM_GROUP(pblParam0->f_17[i]);
								
									if (TASK::GET_SCRIPT_TASK_STATUS(pblParam0->f_17[i], SCRIPT_TASK_ENTER_VEHICLE) == 7 && !func_94(pblParam0->f_17[i], pblParam0->f_21))
									{
		...
		if (flag4)
		{
			...
			for (i = 0; i < 3; i = i + 1)
			{
				if (!PED::IS_PED_INJURED(pblParam0->f_17[i]))
				{
					...
					if (!PED::IS_PED_GROUP_MEMBER(pblParam0->f_17[i], func_14()))
						if (func_92(pblParam0, pblParam0->f_17[i], fParam8, true))
							PED::SET_PED_AS_GROUP_MEMBER(pblParam0->f_17[i], func_14());
				}
			}
		}
	}
	...
	if (!IS_BIT_SET(pblParam0->f_13, 26))
	{
		if (!func_91(pblParam0) && PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()) && !ENTITY::DOES_ENTITY_EXIST(veParam10))
		{
			vehiclePedIsIn = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false);
		...
		if (!ENTITY::DOES_ENTITY_EXIST(veParam10))
		{
			if (!PED::IS_PED_INJURED(pblParam0->f_17[0]) || !PED::IS_PED_INJURED(pblParam0->f_17[1]) || !PED::IS_PED_INJURED(pblParam0->f_17[2]))
			{
				...
				{
					if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()) && !func_73(pblParam0, 2))
					{
						vehiclePedIsIn = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false);
					
						if (func_90(vehiclePedIsIn, pblParam0))
						{
							func_71(pblParam0, "CMN_VEHSUIT" /*~s~Vehicle is not suitable.*/, false);
				...
				else if (!PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
				{
					...
					func_78("CMN_VEHSUIT" /*~s~Vehicle is not suitable.*/);
				}
			}
		}
			...
			if (ENTITY::DOES_ENTITY_EXIST(pblParam0->f_17[i]))
			{
				if (!PED::IS_PED_INJURED(pblParam0->f_17[i]))
				{
					...
					if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
					{
						...
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(vehiclePedIsIn, false))
							if (PED::IS_PED_GROUP_MEMBER(pblParam0->f_17[i], func_14()))
								if (!func_91(pblParam0) && PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
									if (!func_89(pblParam0->f_17[i]))
										PED::REMOVE_PED_FROM_GROUP(pblParam0->f_17[i]);
					...
					if (PED::IS_PED_GROUP_MEMBER(pblParam0->f_17[i], func_14()))
					{
						...
						{
							if (func_77(vehiclePedIsUsing, pblParam0, 0))
							{
								if (func_88(i, pblParam0) || !IS_BIT_SET(pblParam0->f_13, 27))
								{
									PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(pblParam0->f_17[i], i);
									func_15(i, pblParam0);
									num4 = num4 + 1;
					...
					if (!PED::IS_PED_GROUP_MEMBER(pblParam0->f_17[i], func_14()) && !func_86(pblParam0->f_17[i], veParam10) && !func_85(pblParam0->f_17[i], veParam10))
					{
						if (func_92(pblParam0, pblParam0->f_17[i], fParam8, bParam11))
						{
							if (!PED::IS_PED_GROUP_MEMBER(pblParam0->f_17[i], func_14()))
							{
						...
						if (flag2)
						{
							if (!HUD::DOES_BLIP_EXIST(pblParam0->f_1[i]))
							{
								...
								pblParam0->f_1[i] = func_58(pblParam0->f_17[i], false, false);
								HUD::SET_BLIP_DISPLAY(pblParam0->f_1[i], 2);
							
								if (bParam9)
									func_67(pblParam0->f_1[i], pblParam0);
							}
						}
					...
					{
						if (func_64(pblParam0->f_17[i], true) || func_86(pblParam0->f_17[i], veParam10) || bParam12 || VEHICLE::IS_VEHICLE_DRIVEABLE(veParam10, false) && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), veParam10, false))
						{
							if (HUD::DOES_BLIP_EXIST(pblParam0->f_1[i]))
							{
								HUD::REMOVE_BLIP(&pblParam0->f_1[i]);
					...
					else if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam10, false))
					{
						if (!PED::IS_PED_SITTING_IN_VEHICLE(pblParam0->f_17[i], veParam10))
						{
							if (ENTITY::IS_ENTITY_AT_ENTITY(pblParam0->f_17[i], veParam10, 20f, 20f, 5f, false, true, 0) && !IS_BIT_SET(pblParam0->f_13, 11) && !(bParam17 && PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), veParam10, false)))
							{
								if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(pblParam0->f_17[i]))
								{
									...
									{
										if (!func_64(pblParam0->f_17[i], true))
										{
											if (func_63(pblParam0->f_17[i]))
											{
								...
								else
								{
									...
									if (scriptTaskStatus == 7 && !func_94(pblParam0->f_17[i], veParam10))
									{
										if (!PED::IS_PED_JUMPING_OUT_OF_VEHICLE(pblParam0->f_17[i]) && !PED::IS_PED_JUMPING_OUT_OF_VEHICLE(PLAYER::PLAYER_PED_ID()) && !func_84(pblParam0->f_17[i], 2f) && !PED::IS_PED_RAGDOLL(pblParam0->f_17[i]) && !TASK::IS_PED_GETTING_UP(pblParam0->f_17[i]) && !FIRE::IS_ENTITY_ON_FIRE(veParam10))
										{
											PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(pblParam0->f_17[i], true);
							...
							else if (!PED::IS_PED_GROUP_MEMBER(pblParam0->f_17[i], func_14()))
							{
								if (func_92(pblParam0, pblParam0->f_17[i], fParam8, bParam11))
								{
									if (!PED::IS_PED_RAGDOLL(pblParam0->f_17[i]) && !TASK::IS_PED_GETTING_UP(pblParam0->f_17[i]))
						...
						else if (PED::IS_PED_GROUP_MEMBER(pblParam0->f_17[i], func_14()) && !FIRE::IS_ENTITY_ON_FIRE(veParam10))
						{
							PED::REMOVE_PED_FROM_GROUP(pblParam0->f_17[i]);
						}
					}
			...
			if (num > 0)
			{
				for (i = 0; i < 3; i = i + 1)
				{
					if (unk[i])
					{
						if (!PED::IS_PED_INJURED(pblParam0->f_17[i]))
						{
							if (func_89(pblParam0->f_17[i]) || ENTITY::IS_ENTITY_AT_ENTITY(pblParam0->f_17[i], PLAYER::PLAYER_PED_ID(), pblParam0->f_8, pblParam0->f_8, pblParam0->f_8, false, true, 0))
							{
								num = num - 1;
								unk[i] = 0;
							}
					...
					{
						!ENTITY::IS_ENTITY_AT_ENTITY(pblParam0->f_17[i], PLAYER::PLAYER_PED_ID(), pblParam0->f_8 * 0.85f, pblParam0->f_8 * 0.85f, pblParam0->f_8, false, true, 0) && !func_89(pblParam0->f_17[i]);
					}
				}
			}
				...
				if (num > 0)
				{
					if (pblParam0->f_12 < num)
					{
						if (num == num3 || num2 + num == num3 && num3 > 1)
						{
							...
							{
								func_71(pblParam0, sParam7, false);
							...
							for (i = 0; i < 3; i = i + 1)
							{
								if (unk[i])
								{
									if (!func_83(i, pblParam0))
									{
										...
										if (!func_83(i, pblParam0))
										{
											func_71(pblParam0, unk5[i], false);
											func_80(i, pblParam0);
											pblParam0->f_12 = num;
										}
									}
...
void func_80(int iParam0, Blip* pblParam1) // Position - 0x3CA9 Hash - 0x1E3FA253 ^0x58FA4A13
{
	switch (iParam0)
	{
		case 0:
...
void func_81(Blip* pblParam0, const char* sParam1, const char* sParam2, BOOL bParam3) // Position - 0x3CF1 Hash - 0x8178C591 ^0xA830137A
{
	if (!bParam3)
		if (!MISC::IS_STRING_NULL(sParam1))
			if (!MISC::ARE_STRINGS_EQUAL(sParam1, ""))
...
void func_82(const char* sParam0, const char* sParam1, int iParam2, int iParam3) // Position - 0x3D2A Hash - 0xA3B0AE7D ^0x4927FD61
{
	iParam3 = iParam3;
...
BOOL func_83(int iParam0, Blip* pblParam1) // Position - 0x3D49 Hash - 0x600BF84A ^0x55A07351
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_84(Ped pedParam0, float fParam1) // Position - 0x3D89 Hash - 0x430D9426 ^0x1E20BEFF
{
	Vehicle vehiclePedIsIn;
...
BOOL func_85(Ped pedParam0, Vehicle veParam1) // Position - 0x3DC0 Hash - 0x3428DDCA ^0x5AEC4411
{
	Vehicle vehiclePedIsEntering;

	if (!PED::IS_PED_INJURED(pedParam0))
	{
		if (!PED::IS_PED_GROUP_MEMBER(pedParam0, func_14()))
		{
...
BOOL func_86(Ped pedParam0, Vehicle veParam1) // Position - 0x3E27 Hash - 0x980D507B ^0x3BE5D72A
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
void func_87(int iParam0, Blip* pblParam1) // Position - 0x3E5C Hash - 0x15448333 ^0xB9FB55EE
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_88(int iParam0, Blip* pblParam1) // Position - 0x3EA4 Hash - 0x933A2257 ^0x69FB2D8F
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_89(Ped pedParam0) // Position - 0x3EE4 Hash - 0x8AAA640C ^0xAE198AD7
{
	Vehicle vehiclePedIsUsing;
...
BOOL func_90(Vehicle veParam0, Blip* pblParam1) // Position - 0x3F71 Hash - 0x3E226C88 ^0xEA75D78A
{
	int num;
	int num2;
	int i;
...
BOOL func_91(Blip* pblParam0) // Position - 0x40D2 Hash - 0x3C89153B ^0x56EFDE35
{
	Vehicle vehiclePedIsIn;
	...
	if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (func_77(vehiclePedIsIn, pblParam0, 0))
			return true;
	}
...
BOOL func_92(Blip* pblParam0, Ped pedParam1, float fParam2, BOOL bParam3) // Position - 0x4101 Hash - 0x1C5C3B1A ^0x5D8BFBBA
{
	Vehicle vehiclePedIsIn;
...
BOOL func_93(Vehicle veParam0) // Position - 0x41DF Hash - 0x6799283D ^0x73763D18
{
	float entitySpeed;
...
BOOL func_94(Ped pedParam0, Vehicle veParam1) // Position - 0x4217 Hash - 0xFB12ABF0 ^0x730FD205
{
	Vehicle vehiclePedIsUsing;
...
void func_95() // Position - 0x4247 Hash - 0xD3ADA56D ^0x10639AB8
{
	Vehicle vehiclePedIsEntering;
	Ped pedInVehicleSeat;
...
void func_96(Blip* pblParam0) // Position - 0x42B4 Hash - 0xFF242068 ^0x3467AFB3
{
	int i;
...
void func_97(Blip* pblParam0) // Position - 0x4354 Hash - 0xBD02C826 ^0xC8C2D545
{
	int i;
...
char* func_98() // Position - 0x43EA Hash - 0x2ED91BC3 ^0x2ED91BC3
{
	char* unk;
...
Vector3 func_99() // Position - 0x43F4 Hash - 0x7288DDF0 ^0x7288DDF0
{
	var unk;
...
BOOL func_100() // Position - 0x4400 Hash - 0xE2904954 ^0x40750ACE
{
	if (ENTITY::DOES_ENTITY_EXIST(veLocal_2603) && VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_2603, false))
		return true;

	return false;
}

BOOL func_101(Blip* pblParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, float fParam9, float fParam10, BOOL bParam11, Vehicle veParam12, char* sParam13, char* sParam14, char* sParam15, BOOL bParam16, int iParam17, BOOL bParam18, eBlipSprite ebsParam19) // Position - 0x4424 Hash - 0xCA6870AB ^0xCA6870AB
{
	return func_57(pblParam0, fParam1, func_102(), fParam4, fParam7, bParam11, 5, 0, 0, 0, veParam12, sParam13, func_98(), func_98(), func_98(), func_98(), sParam14, false, bParam16, sParam15, true, iParam17, bParam18, ebsParam19, func_98(), func_98(), func_98(), true, fParam10);
}

Vector3 func_102() // Position - 0x4479 Hash - 0xB451132E ^0xB451132E
{
	return 0f, 0f, 2f;
}

int func_103() // Position - 0x4484 Hash - 0x7B59F8B5 ^0x15B33B2D
{
	int i;
	...
	if (func_104())
	{
		...
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_577[i /*8*/]) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_577[i /*8*/], false))
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_577[i /*8*/], true))
					return i;
		}
	}
...
BOOL func_104() // Position - 0x44EB Hash - 0x65D1C8CB ^0xA7D56D5E
{
	int i;
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_577[i /*8*/]) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_577[i /*8*/], false))
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_577[i /*8*/], false))
					return true;
		}
	}
...
void func_105(Vehicle veParam0, int iParam1) // Position - 0x4548 Hash - 0x691F9D08 ^0x691F9D08
{
...
int func_106(BOOL bParam0) // Position - 0x455A Hash - 0x17AB22EE ^0xDAD68BA6
{
	int num;
	int i;
	...
	for (i = 0; i <= 2; i = i + 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_577[i /*8*/]) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_577[i /*8*/], false) && !func_110(iLocal_577[i /*8*/]) && !bParam0 || func_107(iLocal_577[i /*8*/]))
			num = num + 1;
	}
...
BOOL func_107(Ped pedParam0) // Position - 0x45C5 Hash - 0xEB2EA92 ^0x36E09CC2
{
	if (INTERIOR::GET_INTERIOR_FROM_ENTITY(pedParam0) == inLocal_2555)
		if (func_109(PLAYER::PLAYER_PED_ID(), uLocal_640, true) < 500f)
			return true;
	else if (func_108(pedParam0, PLAYER::PLAYER_PED_ID(), true) < 300f)
		return true;

	return false;
}

float func_108(Ped pedParam0, Ped pedParam1, BOOL bParam2) // Position - 0x4610 Hash - 0x7B2C17A2 ^0xDF922C6D
{
...
float func_109(Ped pedParam0, float fParam1, float fParam2, float fParam3, BOOL bParam4) // Position - 0x466E Hash - 0xC22B942A ^0xE0DB8793
{
	Vector3 entityCoords;
...
BOOL func_110(Vehicle veParam0) // Position - 0x46A8 Hash - 0x599658D2 ^0xAEDD3553
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
		if (VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(veParam0, 0, 7000) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(veParam0, 1, 7000) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(veParam0, 2, 7000))
			return true;

	return false;
}

void _SHOW_SUBTITLE_CLEAR_EXISTING(char* sParam0, int iParam1, int iParam2) // Position - 0x46EC Hash - 0x8A76EF8E ^0x32DD2C0C
{
	iParam2 = iParam2;
	HUD::BEGIN_TEXT_COMMAND_PRINT(sParam0);
...
void func_112(float fParam0, float fParam1, float fParam2, float fParam3, int iParam4, eCharacter echParam5) // Position - 0x4705 Hash - 0xFAD52877 ^0x5B3475CA
{
	var unk;
	float num;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_104933.f_4))
	{
		...
		{
			if (func_168(24) != Global_104933.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_165(ENTITY::GET_ENTITY_COORDS(Global_104933.f_4, true), echParam5, &unk, &num))
					{
						fParam0 = { unk };
						fParam3 = num;
					}
				...
				func_113(Global_104933.f_4, fParam0, fParam3, 24, false);
			}
		}
	}
...
void func_113(Vehicle veParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5, BOOL bParam6) // Position - 0x4780 Hash - 0x29B4C4C8 ^0x31C8EC4C
{
	var unk;
	...
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		unk.f_9 = 49;
		unk.f_59 = 2;
		func_159(veParam0, &unk);
	
		if (func_158(uParam1, 0f, 0f, 0f, false))
		{
		...
		func_151(iParam5, &unk, uParam1, fParam4, func_157(veParam0));
		func_114(iParam5, veParam0, 0);
	}

	return;
}

void func_114(int iParam0, Vehicle veParam1, int iParam2) // Position - 0x48A9 Hash - 0x9860D273 ^0xD433FB9F
{
	Vehicle vehicle;
	...
	if (!func_147(&Global_78038.f_555[0 /*21*/], iParam0))
		return;
...
void func_115(Vehicle veParam0, eCharacter echParam1) // Position - 0x49C0 Hash - 0x403E4E98 ^0x34F9BF63
{
	Ped pedInVehicleSeat;
	int i;
	int j;

	if (!func_116(veParam0))
		return;
	...
	func_159(veParam0, &(Global_114370.f_32752.f_5510));
	return;
}

BOOL func_116(Vehicle veParam0) // Position - 0x4BC2 Hash - 0x835CB3EF ^0xB88368F0
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false) || func_134(veParam0, 0, false) || func_134(veParam0, 1, false) || func_134(veParam0, 2, false) || func_157(veParam0) != _CHAR_NULL || func_133(veParam0) || func_132(veParam0) || func_131(veParam0) || func_130(veParam0) || !func_117(ENTITY::GET_ENTITY_MODEL(veParam0)))
	{
		func_132(veParam0);
		func_132(veParam0);
		func_134(veParam0, 0, false);
		func_134(veParam0, 1, false);
		func_134(veParam0, 2, false);
		func_157(veParam0) != _CHAR_NULL;
		return false;
	}
...
BOOL func_117(ePedComponentType epctParam0) // Position - 0x4C9F Hash - 0x66FE4A4A ^0x10D5195D
{
	if (epctParam0 == PV_COMP_HEAD)
		return false;

	if (!func_118(epctParam0, false, -1))
		return false;
...
BOOL func_118(ePedComponentType epctParam0, BOOL bParam1, int iParam2) // Position - 0x4E5D Hash - 0x9BD8A1CC ^0xA5081522
{
	int i;
	Hash outData;
	...
	if (epctParam0 == joaat("blimp"))
		if (!func_128() && !func_127() && !func_126() && !func_125() && !_IS_EXCLUSIVE_CONTENT_UNLOCKED())
			return false;
	...
	if (bParam1)
		if (!func_121(epctParam0, iParam2))
			return false;

	if (!func_119(epctParam0))
		return false;

	return true;
}

BOOL func_119(Hash hParam0) // Position - 0x4FDF Hash - 0xC7E3100C ^0x2C128D41
{
	int num;
	var unk;
	var name;
...
BOOL _NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM() // Position - 0x50AB Hash - 0x2E0B1DC1 ^0xD2D0A3D9
{
...
BOOL func_121(Hash hParam0, int iParam1) // Position - 0x50C2 Hash - 0x2FF24ACC ^0x65397852
{
	BOOL num;
	int cloudTimeAsInt;
...
Hash func_122(BOOL bParam0) // Position - 0xA5F9 Hash - 0x9AA99395 ^0x67DFE72D
{
	if (bParam0)
		return -426933872;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0xA613 Hash - 0x4C81F065 ^0x79C65D03
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0xA629 Hash - 0x4C81F065 ^0xB17A9745
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

BOOL func_125() // Position - 0xA63F Hash - 0x98B7EFDD ^0x98B7EFDD
{
	return false;
}

BOOL func_126() // Position - 0xA648 Hash - 0xFD255207 ^0xFD255207
{
	return true;
}

BOOL func_127() // Position - 0xA651 Hash - 0xFD255207 ^0xFD255207
{
	return true;
}

BOOL func_128() // Position - 0xA65A Hash - 0x64659D79 ^0xC3C726F6
{
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0xA673 Hash - 0x44DD83CC ^0x7B62A376
{
	int profileSetting;
...
BOOL func_130(Vehicle veParam0) // Position - 0xA72B Hash - 0xC71C0264 ^0x19ED560A
{
	...
	if (!func_118(entityModel, false, -1))
		return true;

	return false;
}

BOOL func_131(Vehicle veParam0) // Position - 0xA772 Hash - 0xA5B9FC6B ^0x23EADD90
{
	int i;
...
BOOL func_132(Vehicle veParam0) // Position - 0xA7AD Hash - 0xB4CAAE6F ^0x153EF8BE
{
	int i;
...
BOOL func_133(Vehicle veParam0) // Position - 0xA829 Hash - 0x7BB181DF ^0x17C4552A
{
	int i;
...
BOOL func_134(Vehicle veParam0, int iParam1, BOOL bParam2) // Position - 0xA911 Hash - 0xBCC62924 ^0x77695844
{
	int i;
	var garageName;
	int num;
	...
	for (i = 0; func_135(iParam1, i, &garageName, &num); i = i + 1)
	{
...
BOOL func_135(int iParam0, int iParam1, char* sParam2, var uParam3) // Position - 0xA97F Hash - 0x4B66F314 ^0xEEAA87CE
{
...
var func_136() // Position - 0xAA57 Hash - 0x9E44C35 ^0xB9993D58
{
	var unk;

	func_146(&unk, CLOCK::GET_CLOCK_SECONDS());
	func_145(&unk, CLOCK::GET_CLOCK_MINUTES());
	func_144(&unk, CLOCK::GET_CLOCK_HOURS());
	func_139(&unk, CLOCK::GET_CLOCK_DAY_OF_MONTH());
	func_138(&unk, CLOCK::GET_CLOCK_MONTH());
	func_137(&unk, CLOCK::GET_CLOCK_YEAR());
	return unk;
}

void func_137(var uParam0, int iParam1) // Position - 0xAA9D Hash - 0x15B9927E ^0x4A4674
{
	if (iParam1 <= 0)
		return;
...
void func_138(var uParam0, int iParam1) // Position - 0xAB23 Hash - 0x4C70B2C3 ^0x4C70B2C3
{
...
void func_139(var uParam0, int iParam1) // Position - 0xAB56 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;

	num = func_143(*uParam0);
	num2 = func_141(*uParam0);
...
int func_140(int iParam0, int iParam1) // Position - 0xABA7 Hash - 0xD3EBACB3 ^0xD3EBACB3
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_141(int iParam0) // Position - 0xAC49 Hash - 0xE1B0542C ^0x127A471E
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_142(BOOL bParam0, var uParam1, var uParam2) // Position - 0xAC6B Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
int func_143(int iParam0) // Position - 0xAC82 Hash - 0x2D4DB85F ^0x2D4DB85F
{
	return iParam0 & 15;
}

void func_144(var uParam0, int iParam1) // Position - 0xAC8F Hash - 0x864304A8 ^0x1F5003E2
{
...
void func_145(var uParam0, int iParam1) // Position - 0xACC9 Hash - 0x76860AE7 ^0x32308FFF
{
...
void func_146(var uParam0, int iParam1) // Position - 0xAD04 Hash - 0xDB8A72C0 ^0x4F6D426D
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_147(var uParam0, int iParam1) // Position - 0xAD40 Hash - 0x83F20E10 ^0x71B22E10
{
	BOOL num;
	int num2;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	switch (iParam1)
	{
		case 0:
			*uParam0 = { -831.8538f, 172.1154f, 69.9058f };
			...
			uParam0->f_4 = func_148(CHAR_MICHAEL, 1);
			uParam0->f_12 = 0;
		...
		case 2:
			*uParam0 = { -22.6297f, -1439.1368f, 29.6549f };
			...
			uParam0->f_4 = func_148(CHAR_FRANKLIN, 1);
			uParam0->f_12 = 1;
			MISC::SET_BIT(&(uParam0->f_9), 20);
			MISC::SET_BIT(&(uParam0->f_9), 7);
			num = 1;
		...
		case 3:
			*uParam0 = { -22.5229f, -1434.6986f, 29.6552f };
			...
			uParam0->f_4 = func_148(CHAR_FRANKLIN, 2);
			uParam0->f_12 = 1;
		...
		case 6:
			*uParam0 = { 1981.4163f, 3808.1313f, 31.1384f };
			...
			uParam0->f_4 = func_148(CHAR_TREVOR, 1);
			uParam0->f_12 = 2;
			MISC::SET_BIT(&(uParam0->f_9), 20);
			MISC::SET_BIT(&(uParam0->f_9), 7);
			num = 1;
	...
	if (IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_158(Global_114370.f_32752.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, false))
	...
	{
		if (!func_158(Global_114370.f_2366.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, false))
		{
	...
	{
		if (!func_158(Global_114370.f_2366.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, false))
		{
...
Hash func_148(eCharacter echParam0, int iParam1) // Position - 0xC432 Hash - 0x3C1119CD ^0x1010ECAE
{
	int num;

	if (func_150(echParam0))
	{
		num.f_11 = 12;
		num.f_31 = 49;
		num.f_81 = 2;
		func_149(echParam0, &num, iParam1);
		return num;
	}
	else
	{
...
void func_149(eCharacter echParam0, var uParam1, int iParam2) // Position - 0xC474 Hash - 0xF92B8944 ^0xD11BCD5C
{
	int num;
...
BOOL func_150(eCharacter echParam0) // Position - 0xC6D0 Hash - 0x8907F004 ^0x8907F004
{
	return echParam0 < CHAR_MULTIPLAYER;
}

void func_151(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5, eCharacter echParam6) // Position - 0xC6DC Hash - 0xE596DE1C ^0xAEF9731A
{
	if (func_147(&Global_78038.f_555[0 /*21*/], iParam0))
	{
		...
		{
			func_156(iParam0);
			func_155(uParam1, &Global_114370.f_32752.f_69[Global_78038.f_555[0 /*21*/].f_14 /*78*/]);
...
void func_152(int iParam0, BOOL bParam1) // Position - 0xC7D5 Hash - 0xF45B4890 ^0xF45B4890
{
	if (iParam0 == -1)
		return;
	...
	if (bParam1)
	{
		...
		{
			func_153(iParam0, 1, false);
			func_153(iParam0, 2, false);
			func_153(iParam0, 3, false);
			func_153(iParam0, 4, false);
			func_153(iParam0, 0, true);
			Global_78038[iParam0] = 1;
		}
	}
	else
	{
		func_153(iParam0, 0, false);
	}

	return;
}

void func_153(int iParam0, int iParam1, BOOL bParam2) // Position - 0xC832 Hash - 0xDEF0CB8B ^0x421AAE37
{
	if (iParam0 == -1)
		return;
...
BOOL func_154(int iParam0, int iParam1) // Position - 0xC86D Hash - 0x9EA0654 ^0x9EA0654
{
	if (iParam0 == -1)
		return false;
...
void func_155(var uParam0, var uParam1) // Position - 0xC88D Hash - 0x8EF4EDA5 ^0xC1247BD8
{
...
void func_156(int iParam0) // Position - 0xC959 Hash - 0x64A608A0 ^0xF3C031DC
{
	if (iParam0 == -1)
		return;
	...
	if (func_147(&Global_78038.f_555[0 /*21*/], iParam0))
	{
		...
		if (IS_BIT_SET(Global_78038.f_555[0 /*21*/].f_9, 13))
			func_152(iParam0, false);
	}

	return;
}

eCharacter func_157(Vehicle veParam0) // Position - 0xC9D0 Hash - 0x593067C2 ^0x2918B7DD
{
	int i;
...
BOOL func_158(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0xCA33 Hash - 0x2D46096D ^0xEA41378F
{
	if (bParam6)
...
void func_159(Vehicle veParam0, var uParam1) // Position - 0xCA7A Hash - 0x5E84B52A ^0xEF20F807
{
	int i;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(veParam0);
		...
		if (uParam1->f_65 == -1 && !func_162(uParam1->f_66))
			uParam1->f_65 = 0;
		...
		func_161(&veParam0, &(uParam1->f_9), &(uParam1->f_59));
	
		for (i = 0; i <= 11; i = i + 1)
		{
			if (VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(veParam0, i + 1))
				MISC::SET_BIT(&(uParam1->f_77), func_160(i + 1));
		}
...
int func_160(int iParam0) // Position - 0xCD25 Hash - 0xEE599357 ^0xEE599357
{
	switch (iParam0)
	{
		case 1:
...
int func_161(var uParam0, var uParam1, var uParam2) // Position - 0xCDD5 Hash - 0x4455160E ^0x8E5B3F28
{
	int i;
	int modType;
...
BOOL func_162(int iParam0) // Position - 0xCFC8 Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_163(var uParam0) // Position - 0xCFE8 Hash - 0xB95AF921 ^0x4DC7C61C
{
	int i;
...
void func_164(int iParam0) // Position - 0xD098 Hash - 0x6203AFCC ^0x6203AFCC
{
...
BOOL func_165(var uParam0, var uParam1, var uParam2, eCharacter echParam3, var uParam4, var uParam5) // Position - 0xD0BF Hash - 0x2129E9A2 ^0x2129E9A2
{
	int num;

	num = func_166(uParam0, echParam3, 1);
...
int func_166(Vector3 vParam0, var uParam1, var uParam2, eCharacter echParam3, int iParam4) // Position - 0xD1D5 Hash - 0xF069BA05 ^0x35D3817B
{
	int i;
...
BOOL func_167(int iParam0) // Position - 0xD264 Hash - 0x757E9BA6 ^0x757E9BA6
{
	return IS_BIT_SET(Global_114370.f_7232[iParam0], 0);
}

Vehicle func_168(int iParam0) // Position - 0xD279 Hash - 0x220835E3 ^0xF13BEB49
{
	if (iParam0 == -1)
		return 0;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0xD295 Hash - 0x3C5423D7 ^0x3C5423D7
{
	func_170();
	return Global_114370.f_2366.f_539.f_4321;
}

void func_170() // Position - 0xD2AE Hash - 0xD1F2D853 ^0xF9F5FD4D
{
	eCharacter character;
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114370.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_150(character) && !func_40(14) || Global_113320)
			{
				if (Global_114370.f_2366.f_539.f_4321 != character && func_150(Global_114370.f_2366.f_539.f_4321))
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0xD3AB Hash - 0xAC4E9801 ^0xB379A75F
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0xD3E8 Hash - 0xADCB9755 ^0xADCB9755
{
	if (func_150(character))
		return func_173(character);
	else
...
Hash func_173(eCharacter echParam0) // Position - 0xD40D Hash - 0xE4CEEC2C ^0xE4CEEC2C
{
	return Global_2139[echParam0 /*29*/];
}

int func_174(var uParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xD41C Hash - 0x6F0BF0A6 ^0x6F0BF0A6
{
	if (*uParam0 == -1)
	{
		return 0;
...
int func_175(var uParam0, Hash hParam1) // Position - 0xD49C Hash - 0x952BCC76 ^0xEB2136FB
{
	int i;
	int num;
...
int func_176(var uParam0, char* sParam1) // Position - 0xD545 Hash - 0xB9CC4494 ^0x4D0C916E
{
	int i;
	int num;
...
void func_177(var uParam0) // Position - 0xD60F Hash - 0xDE50A71 ^0x8D11C4D7
{
	int i;
	...
	for (i = 0; i < *uParam0; i = i + 1)
	{
		...
		{
			case 1:
				uParam0->[i /*8*/].f_7(&uParam0->[i /*8*/]);
				break;
		
			case 2:
				if (MISC::GET_GAME_TIMER() - uParam0->[i /*8*/].f_5 > uParam0->[i /*8*/].f_6)
				{
					uParam0->[i /*8*/] = 1;
					uParam0->[i /*8*/].f_6 = 0;
				}
...
void func_178() // Position - 0xD67F Hash - 0x953D74A ^0xC2F67CED
{
	int i;
	int j;
	BOOL flag;
	...
	if (func_109(PLAYER::PLAYER_PED_ID(), uLocal_640, true) < 70f)
	...
	if (iLocal_2601 == 9)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(pedLocal_467))
			if (func_108(pedLocal_467, PLAYER::PLAYER_PED_ID(), true) > 300f)
				ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&pedLocal_467);
	}
	...
	if (func_188())
	{
		...
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_577[i /*8*/]) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_577[i /*8*/], false))
				if (VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), iLocal_577[i /*8*/]))
					veLocal_2603 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false);
		}
	}
	...
	if (iLocal_649 == 0)
	{
		...
		for (j = 0; j < iLocal_26; j = j + 1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_26[j /*110*/]))
				if (iLocal_26[j /*110*/].f_5 == 5 && func_108(PLAYER::PLAYER_PED_ID(), iLocal_26[j /*110*/], true) > 300f && func_109(PLAYER::PLAYER_PED_ID(), uLocal_640, true) > 300f)
					PED::DELETE_PED(&iLocal_26[j /*110*/]);
		}
		...
		for (i = 0; i <= 2; i = i + 1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_577[i /*8*/]))
			{
				if (!VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_577[i /*8*/], false))
				{
					ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_577[i /*8*/]);
				
					if (HUD::DOES_BLIP_EXIST(iLocal_577[i /*8*/].f_1))
						HUD::REMOVE_BLIP(&(iLocal_577[i /*8*/].f_1));
				...
				else if (func_110(iLocal_577[i /*8*/]))
				{
					if (HUD::DOES_BLIP_EXIST(iLocal_577[i /*8*/].f_1))
						HUD::REMOVE_BLIP(&(iLocal_577[i /*8*/].f_1));
				...
				else if (!func_107(iLocal_577[i /*8*/]))
				{
					if (INTERIOR::GET_INTERIOR_FROM_ENTITY(iLocal_577[i /*8*/]) == inLocal_2555)
						if (num != 4)
							num = 5;
					else
						num = 4;
			...
			if (iLocal_2601 == 9 && func_103() != -1 && ENTITY::DOES_ENTITY_EXIST(iLocal_577[func_103() /*8*/]) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_577[func_103() /*8*/], false) && !func_110(iLocal_577[func_103() /*8*/]) || iLocal_2601 == 10 && func_55() != -1 && ENTITY::DOES_ENTITY_EXIST(iLocal_577[func_55() /*8*/]) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_577[func_55() /*8*/], false))
			{
				if (HUD::DOES_BLIP_EXIST(iLocal_577[i /*8*/].f_1))
					HUD::REMOVE_BLIP(&(iLocal_577[i /*8*/].f_1));
			}
			else if (ENTITY::DOES_ENTITY_EXIST(iLocal_577[i /*8*/]) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_577[i /*8*/], false) && !func_110(iLocal_577[i /*8*/]) && func_107(iLocal_577[i /*8*/]) && iLocal_650 == 0)
			{
				if (!HUD::DOES_BLIP_EXIST(iLocal_577[i /*8*/].f_1))
				{
					iLocal_577[i /*8*/].f_1 = func_180(iLocal_577[i /*8*/], false, false);
					HUD::SET_BLIP_PRIORITY(iLocal_577[i /*8*/].f_1, 1);
				}
			}
		}
		...
		{
			if (func_179("JHP1A_BKIN", 0, 0) || func_179("JHP1A_BKINANY", 0, 0))
				HUD::CLEAR_PRINTS();
		}
		else if (iLocal_650 == 0)
		{
			...
			{
				if (func_106(true) == 1)
					_SHOW_SUBTITLE_CLEAR_EXISTING("JHP1A_BKIN", 7500, 1);
...
BOOL func_179(char* sParam0, int iParam1, const char* sParam2) // Position - 0xDAC3 Hash - 0x45D21E98 ^0x1340B068
{
...
Blip func_180(Entity eParam0, BOOL bParam1, BOOL bParam2) // Position - 0xDAE1 Hash - 0x177BFEFF ^0x177BFEFF
{
	return func_59(eParam0, !bParam1, bParam2);
}

void func_181() // Position - 0xDAF4 Hash - 0x6BAF6FA9 ^0x21A59AFE
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_577[3 /*8*/], true))
		{
			iLocal_2601 = 11;
		}
		else if (func_187())
		...
		else if (ENTITY::DOES_ENTITY_EXIST(pedLocal_2604) && VEHICLE::IS_VEHICLE_DRIVEABLE(pedLocal_2604, false) && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), pedLocal_2604, true) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(pedLocal_2604, uLocal_640, 119.72285f, -3092.4724f, 13.461255f, 44f, false, true, 0))
		{
			iLocal_2601 = 5;
		}
		else if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) && ENTITY::DOES_ENTITY_EXIST(PLAYER::GET_PLAYERS_LAST_VEHICLE()) && !func_184() && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::GET_PLAYERS_LAST_VEHICLE(), uLocal_640, 119.72285f, -3092.4724f, 13.461255f, 44f, false, true, 0))
		{
			pedLocal_2604 = PLAYER::GET_PLAYERS_LAST_VEHICLE();
			iLocal_2601 = 5;
		}
		else if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), uLocal_640, 119.72285f, -3092.4724f, 13.461255f, 44f, false, true, 0))
		{
			iLocal_2601 = 2;
		}
		else if (ENTITY::DOES_ENTITY_EXIST(pedLocal_2604) && VEHICLE::IS_VEHICLE_DRIVEABLE(pedLocal_2604, false) && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), pedLocal_2604, true) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(pedLocal_2604, 170.8236f, -3092.4058f, 4.849259f, 154.32996f, -3092.4502f, 9.783653f, 14.0625f, false, true, 0) || ENTITY::IS_ENTITY_AT_COORD(pedLocal_2604, 115.75562f, -3092.2944f, 7.576007f, 4.375f, 10.1875f, 2.5625f, false, true, 0))
		{
			iLocal_2601 = 4;
		}
		else if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) && ENTITY::DOES_ENTITY_EXIST(PLAYER::GET_PLAYERS_LAST_VEHICLE()) && !func_184() && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 170.8236f, -3092.4058f, 4.849259f, 154.32996f, -3092.4502f, 9.783653f, 14.0625f, false, true, 0) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 115.75562f, -3092.2944f, 7.576007f, 4.375f, 10.1875f, 2.5625f, false, true, 0))
		{
			pedLocal_2604 = PLAYER::GET_PLAYERS_LAST_VEHICLE();
			iLocal_2601 = 4;
		}
		else if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) && !func_184() && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), uLocal_640, 119.72285f, -3092.4724f, 13.461255f, 44f, false, true, 0))
		{
			pedLocal_2604 = PLAYER::GET_PLAYERS_LAST_VEHICLE();
			iLocal_2601 = 3;
		}
		else if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) && !func_184() && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 170.8236f, -3092.4058f, 4.849259f, 154.32996f, -3092.4502f, 9.783653f, 14.0625f, false, true, 0))
		{
			pedLocal_2604 = PLAYER::GET_PLAYERS_LAST_VEHICLE();
			iLocal_2601 = 1;
		}
		...
		if (iLocal_2601 == 1)
			if (func_183(iLocal_26[0 /*110*/]))
				func_182(iLocal_26[0 /*110*/], 120f, 20f, 120f, -90f, 90f, 1101004800, 1125515264);
		else if (func_183(iLocal_26[0 /*110*/]))
			func_182(iLocal_26[0 /*110*/], 17.5f, 10f, 120f, -90f, 90f, 1101004800, 1125515264);
	
		if (bLocal_2598)
			PED::SET_PED_RESET_FLAG(PLAYER::PLAYER_PED_ID(), 155, true);
	
		iLocal_2601 != -1 && PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) && PED::IS_COP_PED_IN_AREA_3D({ 101.92259f, -3119.8838f, 182.95369f } - { 108.0625f, 239.75f, 94.25f }, { 101.92259f, -3119.8838f, 182.95369f } + { 108.0625f, 239.75f, 94.25f });
	}

	return;
}

void func_182(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, int iParam6, int iParam7) // Position - 0xDFDC Hash - 0x9066C332 ^0x80D38D72
{
	if (!PED::IS_PED_INJURED(pedParam0))
	{
...
BOOL func_183(Ped pedParam0) // Position - 0xE02A Hash - 0x1CB043FC ^0xFAADE2D6
{
	if (pedParam0 != 0 && ENTITY::DOES_ENTITY_EXIST(pedParam0))
	{
		switch (ENTITY::GET_ENTITY_TYPE(pedParam0))
		{
			case 1:
...
BOOL func_184() // Position - 0xE098 Hash - 0x3BC3AA5 ^0x32D46F78
{
	int i;
	...
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_577[i /*8*/]) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_577[i /*8*/], false))
			if (PLAYER::GET_PLAYERS_LAST_VEHICLE() == iLocal_577[i /*8*/])
				return true;
	}
...
BOOL func_185() // Position - 0xE0E4 Hash - 0xF244D4B9 ^0x928C2FB5
{
	int i;

	for (i = 0; i <= 2; i = i + 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_577[i /*8*/]) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_577[i /*8*/], PLAYER::PLAYER_PED_ID(), true))
			return true;
	}
...
BOOL func_186() // Position - 0xE126 Hash - 0x6615A459 ^0x18DFAE8C
{
	int i;
	...
	if (PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()))
	{
		for (i = 0; i <= 2; i = i + 1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_577[i /*8*/]) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_577[i /*8*/], false) && PED::GET_VEHICLE_PED_IS_ENTERING(PLAYER::PLAYER_PED_ID()) == iLocal_577[i /*8*/])
				return true;
		}
	}
...
BOOL func_187() // Position - 0xE184 Hash - 0x8511434B ^0xE9067EDC
{
	int i;
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) && !PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()))
	{
		...
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_577[i /*8*/]) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_577[i /*8*/], false))
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_577[i /*8*/], true))
					return true;
		}
	}
...
BOOL func_188() // Position - 0xE1FD Hash - 0x3F27B5FD ^0xA7A2872A
{
	Vehicle vehiclePedIsIn;
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(vehiclePedIsIn, false) && ENTITY::GET_ENTITY_MODEL(vehiclePedIsIn) == joaat("towtruck") || ENTITY::GET_ENTITY_MODEL(vehiclePedIsIn) == joaat("towtruck2"))
			return true;
	}
...
void func_189() // Position - 0xE24E Hash - 0xF0EE311A ^0xE911810B
{
	int i;
	...
	for (i = 0; i < iLocal_26; i = i + 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_26[i /*110*/]))
		{
			if (iLocal_26[i /*110*/].f_93)
				if (iLocal_26[i /*110*/].f_102)
					func_190(iLocal_26[i /*110*/], &(iLocal_26[i /*110*/].f_94), 3, 0, false, false, -1082130432, 0, -1, -1, true, false, false);
				else
					func_190(iLocal_26[i /*110*/], &(iLocal_26[i /*110*/].f_94), 2, 0, false, false, -1082130432, 0, -1, -1, true, false, false);
		
			if (!func_183(iLocal_26[i /*110*/]))
				if (iLocal_26[i /*110*/].f_103 == -1)
					iLocal_26[i /*110*/].f_103 = MISC::GET_GAME_TIMER();
				else
					MISC::GET_GAME_TIMER() - iLocal_26[i /*110*/].f_103 >= 5000;
		}
	}

	for (i = 0; i < iLocal_577; i = i + 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_577[i /*8*/]) && iLocal_577[i /*8*/].f_7)
		{
			if (!func_183(iLocal_577[i /*8*/]))
			{
				if (HUD::DOES_BLIP_EXIST(iLocal_577[i /*8*/].f_1))
					HUD::REMOVE_BLIP(&(iLocal_577[i /*8*/].f_1));
...
int func_190(Ped pedParam0, var uParam1, int iParam2, Player plParam3, BOOL bParam4, BOOL bParam5, int iParam6, const char* sParam7, int iParam8, int iParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12) // Position - 0xE386 Hash - 0x1E0371E4 ^0x2179AF37
{
	BOOL flag;
...
void func_191() // Position - 0xE57A Hash - 0x9C9FCBFB ^0x5F4BC195
{
	Vector3 vector;
	float heading;
	...
	if (bLocal_652 == true)
	{
		...
		else
		{
			...
			if (!func_250())
			{
				func_249(iLocal_649, &vector, &heading);
				...
				func_247(&uLocal_656, vector, 50f, 0);
			}
			...
			{
				case 0:
					func_175(&uLocal_656, joaat("burrito2"));
					func_175(&uLocal_656, joaat("S_M_Y_PestCont_01"));
					func_175(&uLocal_656, joaat("S_M_M_Security_01"));
					func_175(&uLocal_656, joaat("dilettante2"));
					func_175(&uLocal_656, joaat("p_amb_clipboard_01"));
					func_245(&uLocal_656, &uLocal_643);
					func_244(&uLocal_656, "misslsdhsclipboard@base");
					func_244(&uLocal_656, "misslsdhsclipboard@idle_a");
					func_244(&uLocal_656, "misstrevor3");
					func_243(&uLocal_656, inLocal_2555);
				
					if (func_242() && !VEHICLE::IS_THIS_MODEL_A_BOAT(func_241()) && !VEHICLE::IS_THIS_MODEL_A_PLANE(func_241()) && !VEHICLE::IS_THIS_MODEL_A_HELI(func_241()))
						func_175(&uLocal_656, func_241());
					break;
			...
			switch (iLocal_649)
			{
				case 0:
					if (func_242() && !VEHICLE::IS_THIS_MODEL_A_BOAT(func_241()) && !VEHICLE::IS_THIS_MODEL_A_PLANE(func_241()) && !VEHICLE::IS_THIS_MODEL_A_HELI(func_241()))
					{
						...
						iLocal_577[4 /*8*/] = func_198(189.3979f, -2932.7214f, 5.6127f, 180.5455f);
					}
				
					if (func_250())
					{
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_577[4 /*8*/]))
							func_195(iLocal_577[4 /*8*/], -1, 1);
						else
							func_195(0, -1, 1);
					}
					else
					{
						...
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_577[4 /*8*/]))
							PED::SET_PED_INTO_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_577[4 /*8*/], -1);
					}
				
					while (!func_192(false))
					{
						SYSTEM::WAIT(0);
					}
				...
				case 1:
					if (!func_7(88))
					{
						iLocal_577[0 /*8*/] = VEHICLE::CREATE_VEHICLE(joaat("burrito2"), 693.725f, -1006.3015f, 21.8355f, 359.884f, true, true, false);
						VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(iLocal_577[0 /*8*/], false);
						VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_577[0 /*8*/], 1084227584);
					}
...
BOOL func_192(BOOL bParam0) // Position - 0xE8D2 Hash - 0x127E1267 ^0x63D0B1D1
{
	BOOL flag;
	BOOL flag2;
	int taskSequenceId;
	...
	if (bParam0)
	{
		...
		{
			iLocal_577[0 /*8*/] = Global_97869[0];
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_577[0 /*8*/], true, true);
		}
		else
		{
			flag = true;
		...
		{
			iLocal_577[1 /*8*/] = Global_97869[1];
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_577[1 /*8*/], true, true);
		}
		else
		{
			flag = true;
		...
		{
			iLocal_577[2 /*8*/] = Global_97869[2];
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_577[2 /*8*/], true, true);
		}
		else
		{
			flag = true;
		...
		{
			iLocal_26[1 /*110*/] = Global_97869.f_9[0];
		
			if (!PED::IS_PED_INJURED(iLocal_26[1 /*110*/]))
				ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_26[1 /*110*/], false, 1);
		
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_26[1 /*110*/], true, true);
		}
		else
		{
			flag = true;
		...
		{
			iLocal_26[1 /*110*/].f_105 = Global_97869.f_28[0];
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_26[1 /*110*/].f_105, true, true);
		}
		else
		{
			flag = true;
		...
		{
			iLocal_26[0 /*110*/] = Global_97869.f_9[2];
		
			if (!PED::IS_PED_INJURED(iLocal_26[0 /*110*/]))
				ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_26[0 /*110*/], false, 1);
		
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_26[0 /*110*/], true, true);
		}
		else
		{
			flag = true;
		...
		{
			iLocal_26[2 /*110*/] = Global_97869.f_9[3];
		
			if (!PED::IS_PED_INJURED(iLocal_26[3 /*110*/]))
				ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_26[2 /*110*/], false, 1);
		
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_26[2 /*110*/], true, true);
		}
		else
		{
			flag = true;
		...
		{
			iLocal_26[3 /*110*/] = Global_97869.f_9[4];
		
			if (!PED::IS_PED_INJURED(iLocal_26[3 /*110*/]))
				ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_26[3 /*110*/], false, 1);
		
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_26[3 /*110*/], true, true);
		}
		else
		{
			flag = true;
		...
		{
			pedLocal_467 = Global_97869.f_9[5];
		
			if (!PED::IS_PED_INJURED(pedLocal_467))
				ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(pedLocal_467, false, 1);
		
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(pedLocal_467, true, true);
		}
		else
		{
			flag = true;
		...
		{
			iLocal_577[3 /*8*/] = Global_97869[3];
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_577[3 /*8*/], true, true);
		}
		else
		{
			flag = true;
	...
	{
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_577[0 /*8*/]))
			iLocal_577[0 /*8*/] = VEHICLE::CREATE_VEHICLE(joaat("burrito2"), 148.7243f, -3104.619f, 4.8962f, 179.6158f, true, true, false);
	
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_577[1 /*8*/]))
			iLocal_577[1 /*8*/] = VEHICLE::CREATE_VEHICLE(joaat("burrito2"), 145.9856f, -3080f, 4.8962f, 269.0827f, true, true, false);
	
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_577[2 /*8*/]))
			iLocal_577[2 /*8*/] = VEHICLE::CREATE_VEHICLE(joaat("burrito2"), 129.9696f, -3089.3313f, 4.8796f, 269.9255f, true, true, false);
	
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_26[1 /*110*/]))
		{
			iLocal_26[1 /*110*/] = PED::CREATE_PED(PED_TYPE_MISSION, joaat("S_M_Y_PestCont_01"), 126.2174f, -3089.3833f, 4.9199f, 275.4068f, true, true);
			ENTITY::SET_ENTITY_HEALTH(iLocal_26[1 /*110*/], 150, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_26[1 /*110*/], PV_COMP_ACCS, 1, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_26[1 /*110*/], PV_COMP_HEAD, 0, 2, 0);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_26[1 /*110*/], PV_COMP_UPPR, 0, 1, 0);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_26[1 /*110*/], PV_COMP_LOWR, 0, 1, 0);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_26[1 /*110*/], PV_COMP_ACCS, 0, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_26[1 /*110*/], PV_COMP_DECL, 1, 0, 0);
			PED::SET_PED_PROP_INDEX(iLocal_26[1 /*110*/], 0, 1, 0, false, 1);
			PED::SET_PED_PROP_INDEX(iLocal_26[1 /*110*/], 1, 0, 0, false, 1);
			PED::SET_PED_LOD_MULTIPLIER(iLocal_26[1 /*110*/], 2f);
		}
	
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_26[1 /*110*/].f_105))
		{
			iLocal_26[1 /*110*/].f_105 = OBJECT::CREATE_OBJECT(joaat("p_amb_clipboard_01"), PED::GET_PED_BONE_COORDS(iLocal_26[1 /*110*/], 60309, 0f, 0f, 0f), true, true, false);
			ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_26[1 /*110*/].f_105, iLocal_26[1 /*110*/], PED::GET_PED_BONE_INDEX(iLocal_26[1 /*110*/], 60309), 0f, 0f, 0f, 0f, 0f, 0f, true, true, true, false, 2, true, 0);
		}
	
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_26[0 /*110*/]))
		{
			iLocal_26[0 /*110*/] = PED::CREATE_PED(PED_TYPE_MISSION, joaat("S_M_Y_PestCont_01"), 155.74f, -3098.89f, 5.93f, 0, true, true);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_26[0 /*110*/], PV_COMP_HEAD, 0, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_26[0 /*110*/], PV_COMP_UPPR, 0, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_26[0 /*110*/], PV_COMP_LOWR, 0, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_26[0 /*110*/], PV_COMP_ACCS, 1, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_26[0 /*110*/], PV_COMP_DECL, 0, 0, 0);
			PED::SET_PED_PROP_INDEX(iLocal_26[0 /*110*/], 0, 0, 0, false, 1);
			PED::SET_PED_LOD_MULTIPLIER(iLocal_26[0 /*110*/], 2f);
		}
	
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_26[2 /*110*/]))
		{
			iLocal_26[2 /*110*/] = PED::CREATE_PED(PED_TYPE_MISSION, joaat("S_M_Y_PestCont_01"), 159.8f, -3085.96f, 6f, 0, true, true);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_26[2 /*110*/], PV_COMP_HEAD, 0, 1, 0);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_26[2 /*110*/], PV_COMP_UPPR, 0, 2, 0);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_26[2 /*110*/], PV_COMP_LOWR, 0, 2, 0);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_26[2 /*110*/], PV_COMP_ACCS, 1, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_26[2 /*110*/], PV_COMP_DECL, 1, 0, 0);
			PED::SET_PED_PROP_INDEX(iLocal_26[2 /*110*/], 1, 0, 0, false, 1);
			PED::SET_PED_LOD_MULTIPLIER(iLocal_26[2 /*110*/], 2f);
		}
	
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_26[3 /*110*/]))
		{
			iLocal_26[3 /*110*/] = PED::CREATE_PED(PED_TYPE_MISSION, joaat("S_M_Y_PestCont_01"), 159.06f, -3085f, 6.01f, 0, true, true);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_26[3 /*110*/], PV_COMP_HEAD, 1, 1, 0);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_26[3 /*110*/], PV_COMP_UPPR, 0, 3, 0);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_26[3 /*110*/], PV_COMP_LOWR, 0, 3, 0);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_26[3 /*110*/], PV_COMP_ACCS, 1, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_26[3 /*110*/], PV_COMP_DECL, 0, 0, 0);
			PED::SET_PED_PROP_INDEX(iLocal_26[3 /*110*/], 0, 0, 0, false, 1);
			PED::SET_PED_LOD_MULTIPLIER(iLocal_26[3 /*110*/], 2f);
		}
	
		if (!ENTITY::DOES_ENTITY_EXIST(pedLocal_467) && !ENTITY::DOES_ENTITY_EXIST(iLocal_577[3 /*8*/]))
		{
			if (CLOCK::GET_CLOCK_HOURS() >= 5 && CLOCK::GET_CLOCK_HOURS() < 21)
			{
				iLocal_577[3 /*8*/] = VEHICLE::CREATE_VEHICLE(joaat("dilettante2"), 144.84f, -2982.75f, 5.32f, 266.5972f, true, true, false);
				pedLocal_467 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_577[3 /*8*/], PED_TYPE_MISSION, joaat("S_M_M_Security_01"), -1, true, true);
			}
			else
			{
				iLocal_577[3 /*8*/] = VEHICLE::CREATE_VEHICLE(joaat("dilettante2"), 169.3554f, -3110.0254f, 4.8228f, 88.4411f, true, true, false);
				pedLocal_467 = PED::CREATE_PED(PED_TYPE_MISSION, joaat("S_M_M_Security_01"), 161.7414f, -3117.0742f, 4.9643f, 333.7041f, true, true);
			}
		}
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_577[0 /*8*/]))
	{
		func_194(iLocal_577[0 /*8*/], 0);
		VEHICLE::SET_VEHICLE_DOORS_LOCKED(iLocal_577[0 /*8*/], 7);
		VEHICLE::SET_VEHICLE_ALARM(iLocal_577[0 /*8*/], true);
		VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(iLocal_577[0 /*8*/], true);
		iLocal_577[0 /*8*/].f_7 = 0;
	}

	if (ENTITY::DOES_ENTITY_EXIST(iLocal_577[1 /*8*/]))
	{
		func_194(iLocal_577[1 /*8*/], 1);
		VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_577[1 /*8*/], true, true, false);
		VEHICLE::SET_DOOR_ALLOWED_TO_BE_BROKEN_OFF(iLocal_577[1 /*8*/], 4, false);
		VEHICLE::SET_VEHICLE_DOOR_OPEN(iLocal_577[1 /*8*/], 0, true, false);
		VEHICLE::SET_VEHICLE_DOOR_OPEN(iLocal_577[1 /*8*/], 4, false, true);
		VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(iLocal_577[1 /*8*/], true);
		iLocal_577[1 /*8*/].f_7 = 0;
	}

	if (ENTITY::DOES_ENTITY_EXIST(iLocal_577[2 /*8*/]))
	{
		func_194(iLocal_577[2 /*8*/], 2);
		VEHICLE::SET_VEHICLE_DOOR_OPEN(iLocal_577[2 /*8*/], 2, true, false);
		VEHICLE::SET_VEHICLE_DOOR_OPEN(iLocal_577[2 /*8*/], 3, true, false);
		VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(iLocal_577[2 /*8*/], true);
		iLocal_577[2 /*8*/].f_7 = 0;
	}

	if (ENTITY::DOES_ENTITY_EXIST(iLocal_26[1 /*110*/]))
	{
		PED::SET_PED_NAME_DEBUG(iLocal_26[1 /*110*/], &(iLocal_26[1 /*110*/].f_1));
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_26[1 /*110*/], true);
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_26[1 /*110*/], hLocal_2553);
		AUDIO::STOP_PED_SPEAKING(iLocal_26[1 /*110*/], true);
		func_182(iLocal_26[1 /*110*/], 20f, 5f, 90f, -90f, 90f, 1101004800, 1125515264);
		PED::SET_PED_HEARING_RANGE(iLocal_26[1 /*110*/], 50f);
		TEXT_LABEL_ASSIGN_STRING(&(iLocal_26[1 /*110*/].f_1), "foreman2(rear)", 16);
		iLocal_26[1 /*110*/].f_42 = 20f;
		iLocal_26[1 /*110*/].f_86 = 1;
		iLocal_26[1 /*110*/].f_87 = 1;
		iLocal_26[1 /*110*/].f_107 = joaat("p_amb_clipboard_01");
		iLocal_26[1 /*110*/].f_106 = 60309;
		iLocal_26[1 /*110*/].f_108 = 0;
	}

	if (ENTITY::DOES_ENTITY_EXIST(iLocal_26[0 /*110*/]))
	{
		PED::SET_PED_NAME_DEBUG(iLocal_26[0 /*110*/], &(iLocal_26[0 /*110*/].f_1));
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_26[0 /*110*/], true);
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_26[0 /*110*/], hLocal_2553);
		AUDIO::STOP_PED_SPEAKING(iLocal_26[0 /*110*/], true);
		func_182(iLocal_26[0 /*110*/], 17.5f, 10f, 120f, -90f, 90f, 1101004800, 1125515264);
		PED::SET_PED_HEARING_RANGE(iLocal_26[0 /*110*/], 50f);
		TEXT_LABEL_ASSIGN_STRING(&(iLocal_26[0 /*110*/].f_1), "foreman1(front)", 16);
		iLocal_26[0 /*110*/].f_86 = 1;
		iLocal_26[0 /*110*/].f_87 = 1;
		iLocal_26[0 /*110*/].f_42 = 17.5f;
	}

	if (ENTITY::DOES_ENTITY_EXIST(iLocal_26[2 /*110*/]))
	{
		PED::SET_PED_NAME_DEBUG(iLocal_26[2 /*110*/], &(iLocal_26[2 /*110*/].f_1));
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_26[2 /*110*/], true);
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_26[2 /*110*/], hLocal_2553);
		func_182(iLocal_26[2 /*110*/], 20f, 5f, 90f, -90f, 90f, 1101004800, 1125515264);
		AUDIO::STOP_PED_SPEAKING(iLocal_26[2 /*110*/], true);
		PED::SET_PED_HEARING_RANGE(iLocal_26[2 /*110*/], 50f);
		TEXT_LABEL_ASSIGN_STRING(&(iLocal_26[2 /*110*/].f_1), "front 1", 16);
		iLocal_26[2 /*110*/].f_86 = 0;
		iLocal_26[2 /*110*/].f_87 = 0;
		iLocal_26[2 /*110*/].f_42 = 17.5f;
	}

	if (ENTITY::DOES_ENTITY_EXIST(iLocal_26[3 /*110*/]))
	{
		PED::SET_PED_NAME_DEBUG(iLocal_26[3 /*110*/], &(iLocal_26[3 /*110*/].f_1));
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_26[3 /*110*/], true);
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_26[3 /*110*/], hLocal_2553);
		PED::SET_PED_HEARING_RANGE(iLocal_26[3 /*110*/], 50f);
		func_182(iLocal_26[3 /*110*/], 20f, 5f, 90f, -90f, 90f, 1101004800, 1125515264);
		AUDIO::STOP_PED_SPEAKING(iLocal_26[3 /*110*/], true);
		TEXT_LABEL_ASSIGN_STRING(&(iLocal_26[3 /*110*/].f_1), "front 2", 16);
		iLocal_26[3 /*110*/].f_86 = 0;
		iLocal_26[3 /*110*/].f_87 = 0;
		iLocal_26[3 /*110*/].f_42 = 17.5f;
	}

	if (ENTITY::DOES_ENTITY_EXIST(pedLocal_467) && ENTITY::DOES_ENTITY_EXIST(iLocal_577[3 /*8*/]))
	{
		PED::SET_PED_NAME_DEBUG(pedLocal_467, &(pedLocal_467.f_1));
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(pedLocal_467, true);
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(pedLocal_467, hLocal_2553);
		PED::SET_PED_TARGET_LOSS_RESPONSE(pedLocal_467, 2);
		PED::SET_PED_COMBAT_ATTRIBUTES(pedLocal_467, BF_CanDoDrivebys, false);
		WEAPON::GIVE_WEAPON_TO_PED(pedLocal_467, joaat("WEAPON_NIGHTSTICK"), -1, false, true);
		PED::SET_PED_ACCURACY(pedLocal_467, 5);
		func_182(pedLocal_467, 40f, 5f, 90f, -90f, 90f, 1101004800, 1125515264);
		TEXT_LABEL_ASSIGN_STRING(&(pedLocal_467.f_1), "sec", 16);
		pedLocal_467.f_86 = 1;
		pedLocal_467.f_87 = 1;
		pedLocal_467.f_93 = 0;
	
		if (Global_97869.f_357 == true)
		{
			if (!func_193(pedLocal_467, SCRIPT_TASK_PERFORM_SEQUENCE, true))
			{
				if (TASK::DOES_SCENARIO_OF_TYPE_EXIST_IN_AREA(203.68f, -3132.46f, 4.79f, "WORLD_HUMAN_SMOKING", 1f, true))
				{
					bLocal_2605 = false;
					TASK::OPEN_SEQUENCE_TASK(&taskSequenceId);
					TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(0, iLocal_577[3 /*8*/], &uLocal_643, 786599, 0, 0, -1, -1082130432, false, 1073741824);
					TASK::TASK_LEAVE_VEHICLE(0, iLocal_577[3 /*8*/], 0);
					TASK::TASK_USE_NEAREST_SCENARIO_TO_COORD(0, 203.68f, -3132.46f, 4.79f, 1f, 0);
					TASK::CLOSE_SEQUENCE_TASK(taskSequenceId);
					TASK::TASK_PERFORM_SEQUENCE(pedLocal_467, taskSequenceId);
		...
		else if (!func_193(pedLocal_467, SCRIPT_TASK_USE_NEAREST_SCENARIO_CHAIN_TO_POS, true))
		{
			if (TASK::DOES_SCENARIO_OF_TYPE_EXIST_IN_AREA(162.69f, -3115.67f, 4.95f, "WORLD_HUMAN_SECURITY_SHINE_TORCH", 1f, true))
			{
				bLocal_2605 = true;
				TASK::TASK_USE_NEAREST_SCENARIO_CHAIN_TO_COORD_WARP(pedLocal_467, 162.69f, -3115.67f, 4.95f, 1f, 0);
			}
			else
			{
				flag2 = false;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_577[0 /*8*/]) && ENTITY::DOES_ENTITY_EXIST(iLocal_577[1 /*8*/]) && ENTITY::DOES_ENTITY_EXIST(iLocal_577[2 /*8*/]) && ENTITY::DOES_ENTITY_EXIST(iLocal_577[3 /*8*/]) && ENTITY::DOES_ENTITY_EXIST(iLocal_26[1 /*110*/]) && ENTITY::DOES_ENTITY_EXIST(iLocal_26[0 /*110*/]) && ENTITY::DOES_ENTITY_EXIST(iLocal_26[2 /*110*/]) && ENTITY::DOES_ENTITY_EXIST(iLocal_26[3 /*110*/]) && ENTITY::DOES_ENTITY_EXIST(pedLocal_467) && flag2)
		return true;
	else if (flag)
		return false;
...
BOOL func_193(Ped pedParam0, eScriptTaskHash esthParam1, BOOL bParam2) // Position - 0xF4CC Hash - 0xF0B5FECC ^0x31E215E9
{
	int scriptTaskStatus;
...
void func_194(Vehicle veParam0, int iParam1) // Position - 0xF512 Hash - 0xAF05FCB ^0xAAD3205
{
	Global_101392.f_22[iParam1] = veParam0;
	return;
}

void func_195(Vehicle veParam0, int iParam1, int iParam2) // Position - 0xF526 Hash - 0xBB66B13B ^0xEE89352E
{
	if (_IS_MISSION_REPLAY_IN_PROGRESS() && func_250())
	{
...
void func_196(int iParam0) // Position - 0xF5EA Hash - 0x7BC1D73E ^0x69FC312C
{
	if (iParam0 == 1)
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xF613 Hash - 0x77F66043 ^0x77F66043
{
...
Vehicle func_198(float fParam0, float fParam1, float fParam2, float fParam3) // Position - 0xF637 Hash - 0x8B428079 ^0x8B428079
{
	return func_199(&(Global_107917.f_2890), fParam0, fParam3, false);
}

Vehicle func_199(var uParam0, float fParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5) // Position - 0xF651 Hash - 0xD821241F ^0x8968603D
{
	Vehicle vehicle;
	Vector3 entityCoords;
	BOOL flag;
	...
	if (func_238(uParam0))
	{
		if (func_158(fParam1, 0f, 0f, 0f, false))
		{
			fParam1 = { *uParam0 };
			fParam4 = uParam0->f_6;
		}
		...
		if (func_237(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(vehicle))
			{
				...
				func_208(vehicle, &(uParam0->f_12), false, true);
				flag = true;
				...
				if (uParam0->f_7 == 1)
				{
					...
					func_206(vehicle, uParam0->f_11);
				}
				else if (!func_204(vehicle, uParam0->f_3, uParam0->f_8) && uParam0->f_10 && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
					num = func_203(vehicle);
...
void func_200(int iParam0) // Position - 0xF903 Hash - 0xF3C009B6 ^0xC702DC05
{
	BOOL flag;
	...
	if (func_147(&Global_78038.f_555[0 /*21*/], iParam0))
	{
		...
		if (IS_BIT_SET(Global_78038.f_555[0 /*21*/].f_9, 13))
		{
			if (iParam0 == 24 && func_154(iParam0, 0) && Global_78947.f_66 == 0 && Global_114370.f_32752.f_1958[Global_78038.f_555[0 /*21*/].f_14] != 0 && Global_114370.f_32752.f_1958[Global_78038.f_555[0 /*21*/].f_14] > 3 && !func_201(0, Global_78038.f_555[0 /*21*/].f_12) || !func_201(1, Global_78038.f_555[0 /*21*/].f_12))
			{
				func_155(&Global_114370.f_32752.f_69[Global_78038.f_555[0 /*21*/].f_14 /*78*/], &Global_78947);
...
BOOL func_201(int iParam0, int iParam1) // Position - 0xFA72 Hash - 0x5855B2D ^0x5855B2D
{
	int num;
	...
	if (iParam0 < 0 || iParam0 >= func_202(&Global_114370.f_32752.f_5038[num /*157*/]))
		return false;

	return func_118(Global_114370.f_32752.f_5038[num /*157*/][iParam0 /*78*/].f_66, false, -1);
}

int func_202(var uParam0) // Position - 0xFAE5 Hash - 0x51136ED0 ^0x51136ED0
{
	return *uParam0;
}

int func_203(Vehicle veParam0) // Position - 0xFAF0 Hash - 0x91E46476 ^0x7754CEB4
{
	int i;
	var colorPrimary;
	var colorSecondary;
...
BOOL func_204(Vehicle veParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xFBB3 Hash - 0xD8B487B8 ^0x163806E1
{
	Hash entityModel;
	var sizeAndVehs;
	...
	{
		case joaat("cargobob"):
			if (func_205(veParam0, Global_78038.f_139[38], false))
			{
				func_200(38);
				return true;
			}
		...
		case joaat("firetruk"):
			if (func_205(veParam0, Global_78038.f_139[43], true))
			{
				func_200(43);
				return true;
			}
		...
		case joaat("cuban800"):
			...
			{
				if (func_205(veParam0, sizeAndVehs[i], true) && func_66(ENTITY::GET_ENTITY_COORDS(sizeAndVehs[i], true), 2136.133f, 4780.5635f, 39.9702f, 5f, false))
				{
					if (!bParam4 || func_158(uParam1, 0f, 0f, 0f, false) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(veParam0, true), ENTITY::GET_ENTITY_COORDS(sizeAndVehs[i], true), true) < 10f)
					{
...
BOOL func_205(Vehicle veParam0, Vehicle veParam1, BOOL bParam2) // Position - 0xFDBB Hash - 0xFE15FF6A ^0xF2D270E5
{
	var colorPrimary;
	var colorSecondary;
	var colorPrimary2;
...
void func_206(Vehicle veParam0, eCharacter echParam1) // Position - 0xFE1C Hash - 0xC9E7D414 ^0xEA9F91AF
{
	int i;
...
void func_207(eCharacter echParam0, int iParam1) // Position - 0xFE9E Hash - 0xBF4A23B8 ^0xB5698C5
{
	int i;
	...
	for (i = 0; i < 9; i = i + 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_98703[i]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_98703[i]) == func_148(echParam0, iParam1))
				{
...
void func_208(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0xFF3C Hash - 0x3234A2AB ^0xBABA9C12
{
	int num;
	int num2;
	int i;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		else if (uParam1->f_66 == joaat("casco"))
		{
			...
			if (IS_BIT_SET(uParam1->f_77, func_160(num + 1)))
			{
			}
			else
			{
				MISC::SET_BIT(&(uParam1->f_77), func_160(num + 1));
			}
		}
		else if (uParam1->f_66 == joaat("sandking") || uParam1->f_66 == joaat("sandking2"))
		{
			...
			if (IS_BIT_SET(uParam1->f_77, func_160(num2 + 1)))
			{
			}
			else
			{
				MISC::SET_BIT(&(uParam1->f_77), func_160(num2 + 1));
			}
		}
		else if (uParam1->f_66 == joaat("formula") || uParam1->f_66 == joaat("formula2"))
		{
			for (i = 1; i <= 9; i = i + 1)
			{
				if (IS_BIT_SET(uParam1->f_77, func_160(i)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_160(i));
				}
			}
		}
		else if (uParam1->f_66 == joaat("openwheel1"))
		{
			for (j = 1; j <= 6; j = j + 1)
			{
				if (IS_BIT_SET(uParam1->f_77, func_160(j)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_160(j));
				}
			}
		}
		else if (uParam1->f_66 == joaat("openwheel2"))
		{
			for (k = 1; k <= 11; k = k + 1)
			{
				if (k != 9 && k != 10)
				{
					if (IS_BIT_SET(uParam1->f_77, func_160(k)))
					{
					}
					else
					{
						MISC::SET_BIT(&(uParam1->f_77), func_160(k));
					}
				}
			}
		}
		else if (uParam1->f_66 == -1035489563)
		{
			for (l = 1; l <= 2; l = l + 1)
			{
				if (IS_BIT_SET(uParam1->f_77, func_160(l)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_160(l));
				}
			}
		}
		else if (uParam1->f_66 == joaat("dinghy5"))
		{
			if (IS_BIT_SET(uParam1->f_77, func_160(4)))
			{
			}
			else
			{
				MISC::SET_BIT(&(uParam1->f_77), func_160(4));
			}
		}
		...
		{
			MISC::SET_BIT(&(uParam1->f_77), func_160(1));
		}
		else if (uParam1->f_66 == joaat("hotknife"))
		{
			for (m = 1; m <= 2; m = m + 1)
			{
				if (IS_BIT_SET(uParam1->f_77, func_160(m)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_160(m));
				}
			}
		}
		...
		{
			if (func_225(uParam1->f_5) || func_225(uParam1->f_6))
			{
			}
			else
			{
		...
		if (IS_BIT_SET(uParam1->f_77, 15) || func_224(veParam0) || uParam1->f_62 == 0 && uParam1->f_63 == 0 && uParam1->f_64 == 0 && uParam1->f_9[20] > 0 && func_223())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (uParam1->f_69 > -1 && uParam1->f_69 < 255)
			if (!VEHICLE::IS_THIS_MODEL_A_BICYCLE(ENTITY::GET_ENTITY_MODEL(veParam0)))
				if (VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(veParam0)))
					if (uParam1->f_69 == 6)
						func_222(veParam0, uParam1->f_69);
				else
					func_222(veParam0, uParam1->f_69);
		...
		if (bParam3)
			func_214(&veParam0, &(uParam1->f_9), &(uParam1->f_59));
	
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			for (n = 0; n <= 11; n = n + 1)
			{
				if (IS_BIT_SET(uParam1->f_77, func_160(n + 1)))
		...
		if (func_209() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(veParam0) && !VEHICLE::IS_VEHICLE_MODEL(veParam0, joaat("avenger")) && !VEHICLE::IS_VEHICLE_MODEL(veParam0, func_122(true)))
...
BOOL func_209() // Position - 0x10635 Hash - 0x599C0723 ^0x980C0743
{
	...
	if (func_212(7))
		if (func_211(Global_2672741.f_4.f_16) || func_210(Global_2672741.f_4.f_16))
			return false;

	return true;
}

BOOL func_210(ePedComponentType epctParam0) // Position - 0x106C4 Hash - 0x16FCD261 ^0x4AD3E458
{
...
BOOL func_211(ePedComponentType epctParam0) // Position - 0x106E8 Hash - 0xE40D6326 ^0xE40D6326
{
	ePedComponentType type;
	...
	if (type != PV_COMP_INVALID)
		return func_33(epctParam0, 9);

	return false;
}

BOOL func_212(int iParam0) // Position - 0x10706 Hash - 0x7F5F619C ^0x3336F8CC
{
	return func_213(&(Global_2672741.f_188), iParam0);
}

BOOL func_213(var uParam0, int iParam1) // Position - 0x1071A Hash - 0x1995C9E6 ^0x1995C9E6
{
	int num;
	int num2;
	int num3;
...
int func_214(var uParam0, var uParam1, var uParam2) // Position - 0x1073D Hash - 0x5C9EC0F7 ^0xAEA0C62F
{
	int i;
	int modType;
	...
	for (i = 0; i < *uParam1; i = i + 1)
	{
		...
		else if (VEHICLE::GET_VEHICLE_MOD(*uParam0, modType) != uParam1->[i] - 1)
		{
			...
			if (uParam1->[i] > 0)
			{
				...
				else if (func_220(*uParam0, modType, uParam1->[i] - 1))
				{
				}
				else
				{
	...
	if (func_219(ENTITY::GET_ENTITY_MODEL(*uParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*uParam0, 24) != func_217(*uParam0, uParam1->[38] - 1))
		VEHICLE::SET_VEHICLE_MOD(*uParam0, 24, func_217(*uParam0, uParam1->[38] - 1), false);
...
BOOL func_215(Vehicle veParam0) // Position - 0x10917 Hash - 0x4E83583B ^0x79F702A8
{
	int i;
	int modType;
	Hash hashKey;
...
void func_216(var uParam0) // Position - 0x109F3 Hash - 0x2806D680 ^0xEA5BC67
{
...
int func_217(Vehicle veParam0, int iParam1) // Position - 0x10A4A Hash - 0xFE64EDC0 ^0x4504AA95
{
	int value;
	int value2;
	float num;
	...
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		value = func_218(veParam0, 38) + 1;
		value2 = func_218(veParam0, 24) + 1;
...
ePedComponentType func_218(Vehicle veParam0, int iParam1) // Position - 0x10B33 Hash - 0x51ABE917 ^0xA6E9215C
{
	ePedComponentType i;
	...
	for (i = VEHICLE::GET_NUM_VEHICLE_MODS(veParam0, iParam1) - 1; i >= 0 && func_220(veParam0, iParam1, i); i = i - 1)
	{
	}
...
BOOL func_219(Hash hParam0, int iParam1) // Position - 0x10B95 Hash - 0xFE274898 ^0xFE274898
{
	switch (hParam0)
	{
		case joaat("faction2"):
...
BOOL func_220(Vehicle veParam0, int iParam1, int iParam2) // Position - 0x10F74 Hash - 0x206208ED ^0x243B2D10
{
	if (!func_221() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(veParam0, iParam1, iParam2))
		return true;

	return false;
}

BOOL func_221() // Position - 0x10F98 Hash - 0x98B7EFDD ^0x98B7EFDD
{
	return false;
}

void func_222(Vehicle veParam0, int iParam1) // Position - 0x10FA1 Hash - 0x4F43FC2B ^0x7F7B0D9C
{
	int vehicleMod;
...
BOOL func_223() // Position - 0x11019 Hash - 0x11DC3931 ^0x2E8F2A7A
{
	return DLC::IS_DLC_PRESENT(joaat("mpindependence"));
}

BOOL func_224(Vehicle veParam0) // Position - 0x1102A Hash - 0xB4BAF94A ^0x269BA904
{
	int _int;
...
int func_225(var uParam0) // Position - 0x11072 Hash - 0xF0601AB8 ^0xF0601AB8
{
	if (!func_221() && func_226(uParam0))
		return 1;

	return 0;
}

BOOL func_226(int iParam0) // Position - 0x11092 Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
		case 161:
...
BOOL func_227(Vehicle veParam0) // Position - 0x110E5 Hash - 0x57A74E37 ^0x4772878C
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	...
	if (func_229(PLAYER::PLAYER_ID()) == 3)
		if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
			if (func_228(veParam0) != -1)
				return true;

	return false;
}

int func_228(Vehicle veParam0) // Position - 0x1116C Hash - 0x2BB30050 ^0xA6E414DD
{
...
int func_229(Player plParam0) // Position - 0x1119B Hash - 0xE627570A ^0xE627570A
{
	if (func_233(plParam0) == 233)
		return func_230(plParam0);

	return -1;
}

int func_230(Player plParam0) // Position - 0x111B8 Hash - 0x48014DA ^0xC49B9410
{
	if (func_231(plParam0, false))
		return Global_1886967[plParam0 /*609*/].f_10.f_182;

	return -1;
}

BOOL func_231(Player plParam0, BOOL bParam1) // Position - 0x111DB Hash - 0x3654624B ^0x97E7BA1
{
	if (func_232(plParam0))
...
BOOL func_232(Player plParam0) // Position - 0x1121F Hash - 0x6A46C9B4 ^0x6A46C9B4
{
	Player player;
...
ePedComponentType func_233(Player plParam0) // Position - 0x11241 Hash - 0x5EA8DF5A ^0xEE8D593B
{
	if (func_232(plParam0))
		if (func_231(plParam0, false))
...
BOOL _IS_PLAYER_IN_VEHICLE_SEAT(Player plParam0, int iParam1) // Position - 0x1126D Hash - 0x1C7D021F ^0xC08A6119
{
	Vehicle vehiclePedIsIn;
...
BOOL _NETWORK_IS_PLAYER_VALID(ePedComponentType player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x112BA Hash - 0x3FF6E4CA ^0xE6B59972
{
	ePedComponentType type;
...
void func_236(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4) // Position - 0x1131A Hash - 0x1C589E88 ^0xAB2FCAED
{
	int i;

	for (i = 0; i < 68; i = i + 1)
	{
		if (func_147(&Global_78038.f_555[0 /*21*/], i))
...
BOOL func_237(var uParam0) // Position - 0x1136A Hash - 0x79226296 ^0xA9806D0C
{
	if (func_238(uParam0))
	{
...
BOOL func_238(var uParam0) // Position - 0x1139F Hash - 0x250242CC ^0x9A8D76D5
{
	if (uParam0->f_12.f_66 == 0)
		return 0;

	if (!func_118(uParam0->f_12.f_66, false, -1))
		return 0;

	if (uParam0->f_12.f_66 == joaat("stunt") && func_66(*uParam0, 1694.62f, 3276.27f, 41.31f, 1056964608, false))
		return 0;

	return 1;
}

BOOL func_239() // Position - 0x113FF Hash - 0x4D7C1290 ^0x4D7C1290
{
	return func_237(&(Global_107917.f_2890));
}

BOOL func_240(var uParam0) // Position - 0x11412 Hash - 0x8CA9AA52 ^0x8CA9AA52
{
	if (func_251(uParam0))
		return true;
...
Hash func_241() // Position - 0x1142B Hash - 0x8AFFA48 ^0xD76B3745
{
	return Global_107917.f_2890.f_12.f_66;
}

BOOL func_242() // Position - 0x1143E Hash - 0x4D7C1290 ^0x4D7C1290
{
	return func_238(&(Global_107917.f_2890));
}

int func_243(var uParam0, Interior inParam1) // Position - 0x11451 Hash - 0x450DB9C4 ^0x70FA87FF
{
	int i;
	int num;

	if (!INTERIOR::IS_VALID_INTERIOR(inParam1))
		return 0;

	num = -1;

	for (i = 0; i < uParam0->f_763; i = i + 1)
	{
		if (uParam0->f_763[i /*5*/])
		{
			if (uParam0->f_763[i /*5*/].f_4 == inParam1)
			{
				uParam0->f_763[i /*5*/].f_2 = 0;
	...
	if (num >= 0)
	{
		INTERIOR::PIN_INTERIOR_IN_MEMORY(inParam1);
		uParam0->f_763[num /*5*/] = 1;
		uParam0->f_763[num /*5*/].f_3 = MISC::GET_GAME_TIMER();
		uParam0->f_763[num /*5*/].f_4 = inParam1;
		uParam0->f_1012 = 1;
		return 1;
	}
...
int func_244(var uParam0, char* sParam1) // Position - 0x11515 Hash - 0xB9CC4494 ^0x4D0C916E
{
	int i;
	int num;
...
int func_245(var uParam0, const char* sParam1) // Position - 0x115DC Hash - 0xB9CC4494 ^0x4D0C916E
{
	int i;
	int num;
...
void func_246(var uParam0) // Position - 0x116A3 Hash - 0x9BBCEDE1 ^0x6078C21
{
	int i;
...
int func_247(var uParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0x118FB Hash - 0xEF375ADA ^0x224D92B4
{
	...
	if (uParam0->f_898)
	{
		if (func_158(uParam0->f_898.f_4, vParam1, false) && uParam0->f_898.f_10 == fParam4)
		{
			uParam0->f_898.f_2 = 0;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x119B3 Hash - 0x16E871AD ^0x10C54C39
{
...
void func_249(int iParam0, var uParam1, var uParam2) // Position - 0x119DD Hash - 0x9E1BADF3 ^0x9E1BADF3
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_250() // Position - 0x11A34 Hash - 0xDB96C64C ^0xAB601103
{
	return IS_BIT_SET(Global_101392.f_20, 13);
}

BOOL func_251(var uParam0) // Position - 0x11A45 Hash - 0xA8C85F92 ^0x812A968A
{
	BOOL flag;
	int i;
	int num;
...
void func_252(var uParam0) // Position - 0x12415 Hash - 0xD78C55F0 ^0x8F69EA0F
{
...
void func_253(var uParam0) // Position - 0x12431 Hash - 0x8FC3F516 ^0x6D765E4B
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_254() // Position - 0x1244C Hash - 0xB3F9B4CE ^0x4C4A6365
{
	if (func_255())
	{
		func_8(true);
...
BOOL func_255() // Position - 0x12464 Hash - 0x56F647A6 ^0x56F647A6
{
	if (Global_4)
		return true;
...
void func_256() // Position - 0x12491 Hash - 0xF3206A1E ^0x7F113C7C
{
	func_274(&uLocal_1696[1 /*8*/], &func_275, "AI Controller");
	func_274(&uLocal_1696[0 /*8*/], &func_266, "Dialogue");
	func_274(&uLocal_1696[3 /*8*/], &func_261, "Alarms & Wanted Level");
	func_274(&uLocal_1696[4 /*8*/], &func_257, "Music Manager");
	return;
}

void func_257(var uParam0) // Position - 0x124E5 Hash - 0x33FAE68F ^0x5C334A8B
{
	if (!func_260(uParam0))
	{
		if (uParam0->f_1 <= 4)
		{
			if (AUDIO::IS_ALARM_PLAYING(&uLocal_624) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) || func_22(&uLocal_1696[3 /*8*/]))
			{
				AUDIO::TRIGGER_MUSIC_EVENT("JHP1A_ATTACK");
				func_259(uParam0, 5, 0);
			}
		}
		...
		{
			case 1:
				if (func_109(PLAYER::PLAYER_PED_ID(), 137.7f, -3092.81f, 4.9f, true) < 60f)
				{
					AUDIO::TRIGGER_MUSIC_EVENT("JHP1A_START");
					func_259(uParam0, 2, 0);
				}
				break;
			...
			case 4:
				if (!PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
				{
					if (iLocal_2601 == 9 && func_109(PLAYER::PLAYER_PED_ID(), 137.7f, -3092.81f, 4.9f, true) >= 500f)
					{
			...
			case 5:
				if (AUDIO::IS_ALARM_PLAYING(&uLocal_624) && PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) && bLocal_2597)
					func_259(uParam0, 6, 0);
				break;
...
void func_258(var uParam0) // Position - 0x126AB Hash - 0x6D921BFC ^0x5864A567
{
	if (*uParam0 != 4)
	{
		*uParam0 = 4;
...
void func_259(var uParam0, int iParam1, int iParam2) // Position - 0x126D0 Hash - 0x3A92983E ^0xB490AC46
{
	if (iParam2 > 0)
	{
		*uParam0 = 2;
...
BOOL func_260(var uParam0) // Position - 0x126F6 Hash - 0x7AACBCDB ^0x7AACBCDB
{
	if (*uParam0 == 4)
		return true;
...
void func_261(var uParam0) // Position - 0x1270D Hash - 0x2CBD1A11 ^0x8BBB5A20
{
	if (!func_260(uParam0))
	{
		switch (uParam0->f_1)
		{
			case 1:
				func_259(uParam0, 2, 2000);
				break;
		
			case 2:
				if (AUDIO::PREPARE_ALARM(&uLocal_624))
				{
					AUDIO::START_ALARM(&uLocal_624, false);
					func_264(&uLocal_2378, uLocal_640, 30f, -1, 500, 1, 0);
					TEXT_LABEL_ASSIGN_STRING(&uLocal_2378, "", 32);
					func_259(uParam0, 3, 5000);
				}
				break;
		
			case 3:
				func_262(&pedLocal_467, 3, true, "ALARM EVENT SET IT", 1, false);
...
int func_262(var uParam0, int iParam1, BOOL bParam2, char* sParam3, int iParam4, BOOL bParam5) // Position - 0x12822 Hash - 0xD7A94623 ^0xD7A94623
{
	return func_263(uParam0, iParam1, sParam3, 0f, 0f, 0f, 0, bParam2, iParam4, bParam5);
}

int func_263(var uParam0, int iParam1, char* sParam2, float fParam3, float fParam4, float fParam5, Entity eParam6, BOOL bParam7, int iParam8, BOOL bParam9) // Position - 0x1283E Hash - 0x105C240D ^0xCFD1F573
{
	if (func_183(*uParam0))
	{
		if (!bParam7 || iParam1 >= uParam0->f_5)
		{
			...
			if (iParam1 != uParam0->f_5 || !MISC::ARE_STRINGS_EQUAL(&(uParam0->f_9), sParam2))
			{
				...
				TEXT_LABEL_ASSIGN_STRING(&(uParam0->f_9), sParam2, 32);
				...
				if (!_IS_NULL_VECTOR(fParam3))
					uParam0->f_88 = { fParam3 };
			
				if (eParam6 != 0 && ENTITY::DOES_ENTITY_EXIST(eParam6))
					uParam0->f_91 = eParam6;
...
void func_264(char* sParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x12911 Hash - 0xD33AB1C3 ^0xF54C4F15
{
	int num;

	num = -1;
	TEXT_LABEL_ASSIGN_STRING(&(num.f_1), sParam0, 64);
	TEXT_LABEL_ASSIGN_STRING(&(num.f_17), "", 24);
	num.f_28 = iParam5;
	num.f_26 = fParam4;
	num.f_29 = iParam6;
	num.f_30 = iParam7;
...
int func_265(var uParam0, const char* sParam1) // Position - 0x1295D Hash - 0x68AF6955 ^0xB8B1AC87
{
	int num;
	int num2;

	if (MISC::IS_STRING_NULL_OR_EMPTY(&(uParam0->f_1)) && *uParam0 != -1 && !ENTITY::DOES_ENTITY_EXIST(iLocal_26[*uParam0 /*110*/]) || PED::IS_PED_INJURED(iLocal_26[*uParam0 /*110*/]))
		return 0;

	while (num != -1 && !MISC::IS_STRING_NULL_OR_EMPTY(&(iLocal_1737[num /*32*/].f_1)))
	{
		num = num + 1;
	
		if (num > iLocal_1737 - 1)
			num = -1;
	}
	...
	if (num != -1)
	{
		...
		{
			iLocal_1737[num /*32*/] = *uParam0;
			iLocal_1737[num /*32*/].f_1 = { uParam0->f_1 };
		
			if (*uParam0 != -1)
				iLocal_1737[num /*32*/].f_23 = { ENTITY::GET_ENTITY_COORDS(iLocal_26[*uParam0 /*110*/], true) };
			else
				iLocal_1737[num /*32*/].f_23 = { uParam0->f_23 };
		
			iLocal_1737[num /*32*/].f_26 = uParam0->f_26;
			iLocal_1737[num /*32*/].f_28 = uParam0->f_28;
			iLocal_1737[num /*32*/].f_29 = uParam0->f_29;
			iLocal_1737[num /*32*/].f_27 = MISC::GET_GAME_TIMER();
			iLocal_1737[num /*32*/].f_30 = uParam0->f_30;
			iLocal_1737[num /*32*/].f_31 = uParam0->f_31;
			num2 = 1;
		}
		else
		{
		...
		*uParam0 = -1;
		TEXT_LABEL_ASSIGN_STRING(&(uParam0->f_1), "", 64);
...
void func_266(var uParam0) // Position - 0x12ADA Hash - 0x3768F3EE ^0xA76D0F11
{
	var unk;
	BOOL flag;
	var entityCoords;
	...
	if (!func_260(uParam0))
	{
		...
		if (iLocal_2556 != -1 && !MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_2558))
		{
			if (iLocal_26[iLocal_2556 /*110*/] != 0 && ENTITY::DOES_ENTITY_EXIST(iLocal_26[iLocal_2556 /*110*/]) && !PED::IS_PED_INJURED(iLocal_26[iLocal_2556 /*110*/]) && !PED::IS_CONVERSATION_PED_DEAD(iLocal_26[iLocal_2556 /*110*/]))
			{
				if (!PED::IS_PED_RAGDOLL(iLocal_26[iLocal_2556 /*110*/]))
				{
					if (_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
					{
						if (bLocal_2568 && bLocal_2579 || iLocal_2557 > iLocal_2578)
						{
							if (bLocal_2580)
							{
								iLocal_2583 = iLocal_2573;
								iLocal_2584 = iLocal_2578;
								TEXT_LABEL_COPY(&uLocal_2585, { func_273() }, 4);
								TEXT_LABEL_COPY(&uLocal_2589, { func_272() }, 4);
								bLocal_2593 = bLocal_2579;
								bLocal_2594 = bLocal_2581;
							}
					...
					if (func_48())
					{
						...
						{
							if (func_271(iLocal_2556))
								TEXT_LABEL_COPY(&unk, { uLocal_620 }, 6);
							else
								TEXT_LABEL_ASSIGN_STRING(&unk, "SOL1AUD", 24);
						
							switch (iLocal_2556)
							{
								case 0:
									_CONVERSATION_INITIALIZE_ACTOR(&uLocal_2386, 4, iLocal_26[0 /*110*/], "JHP1A_FOREMAN", 0, 1);
									break;
							
								case 1:
									_CONVERSATION_INITIALIZE_ACTOR(&uLocal_2386, 5, iLocal_26[1 /*110*/], "JHP1A_FOREMAN2", 0, 1);
									break;
							
								case 2:
									_CONVERSATION_INITIALIZE_ACTOR(&uLocal_2386, 4, iLocal_26[2 /*110*/], "CONSTRUCTION1", 0, 1);
									break;
							
								case 3:
									_CONVERSATION_INITIALIZE_ACTOR(&uLocal_2386, 3, iLocal_26[3 /*110*/], "CONSTRUCTION2", 0, 1);
									break;
							}
						
							if (MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_2562))
								if (_CONVERSATION_ADD_LINE(&uLocal_2386, &unk, &uLocal_2558, 8, 0, 0, 0))
									flag = true;
							else if (func_269(&uLocal_2386, &unk, &uLocal_2558, &uLocal_2562, 8, 0, 0))
								flag = true;
						
							if (flag)
							{
								func_265(&(iLocal_26[iLocal_2556 /*110*/].f_50), &uLocal_2558);
								iLocal_2578 = iLocal_2557;
								bLocal_2579 = bLocal_2570;
								bLocal_2580 = bLocal_2572;
								bLocal_2581 = bLocal_2571;
								iLocal_2556 = -1;
								iLocal_2557 = -1;
								TEXT_LABEL_ASSIGN_STRING(&uLocal_2558, "", 16);
								iLocal_2566 = 0;
		...
		if (_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && iLocal_2573 != -1 && bLocal_2581 && !MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_2574))
		{
			entityCoords = { ENTITY::GET_ENTITY_COORDS(iLocal_26[iLocal_2573 /*110*/], true) };
		
			if (func_109(PLAYER::PLAYER_PED_ID(), entityCoords, true) >= 25f)
			{
				iLocal_2583 = iLocal_2573;
				iLocal_2584 = iLocal_2578;
				TEXT_LABEL_COPY(&uLocal_2585, { func_273() }, 4);
		...
		if (iLocal_2583 != -1 && !MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_2585))
		{
			if (iLocal_26[iLocal_2583 /*110*/].f_5 > iLocal_2584)
			{
				iLocal_2583 = -1;
				iLocal_2584 = -1;
				TEXT_LABEL_ASSIGN_STRING(&uLocal_2585, "", 16);
		...
		if (iLocal_2556 == -1 && MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_2558))
		{
			if (func_48() && MISC::GET_GAME_TIMER() - iLocal_2552 > 10000)
			{
				if (iLocal_2583 != -1 && !MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_2585))
				{
					func_268(iLocal_2583, &uLocal_2585, iLocal_2584, 0, 0, bLocal_2593, 0, 1, &uLocal_2589, bLocal_2594);
					iLocal_2583 = -1;
					iLocal_2584 = -1;
					TEXT_LABEL_ASSIGN_STRING(&uLocal_2585, "", 16);
					TEXT_LABEL_ASSIGN_STRING(&uLocal_2589, "", 16);
	...
	func_267(bLocal_2594);
	return;
}

void func_267(BOOL bParam0) // Position - 0x12EA0 Hash - 0x2B3AC4E8 ^0x2B3AC4E8
{
	bParam0;
	return;
}

BOOL func_268(int iParam0, char* sParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, int iParam6, BOOL bParam7, char* sParam8, BOOL bParam9) // Position - 0x12EAD Hash - 0x22576F0B ^0x9E248305
{
	float num;
	BOOL flag;

	num = func_108(iLocal_26[iParam0 /*110*/], PLAYER::PLAYER_PED_ID(), true);

	if (iParam2 > iLocal_2557 || iParam2 == 4 || iParam2 == iLocal_2557 && num < fLocal_2567 || func_271(iParam0) && !func_271(iLocal_2556) && iParam2 != 5)
	{
		switch (iParam2)
		{
			case 0:
		...
		if (flag)
		{
			iLocal_2556 = iParam0;
			iLocal_2557 = iParam2;
			TEXT_LABEL_ASSIGN_STRING(&uLocal_2558, sParam1, 16);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_2562, sParam8, 16);
			fLocal_2567 = num;
			bLocal_2568 = bParam3;
			bLocal_2569 = bParam4;
			iLocal_2566 = iParam6;
...
BOOL func_269(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6) // Position - 0x12F86 Hash - 0xF7B25BD8 ^0xF7B25BD8
{
	func_44(uParam0, _CHAR_NULL, sParam1, iParam5, iParam6, 0);
	...
	Global_2883585 = 0;
	return func_29(sParam2, iParam4, false);
}

BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x12FDA Hash - 0x384540C1 ^0x384540C1
{
	func_44(uParam0, _CHAR_NULL, sParam1, iParam4, iParam5, iParam6);
	...
	Global_23163 = 0;
	Global_2883585 = 0;
	return func_29(sParam2, iParam3, false);
}

BOOL func_271(int iParam0) // Position - 0x13028 Hash - 0xA9F26FD ^0xA9F26FD
{
...
struct<6> func_272() // Position - 0x13046 Hash - 0xCCBE0ECE ^0x7E0543A0
{
	var unk;
...
struct<6> func_273() // Position - 0x130F2 Hash - 0xB37EF8EF ^0xB37EF8EF
{
	var unk;
...
int func_274(var uParam0, int iParam1, char* sParam2) // Position - 0x13116 Hash - 0x329ACA27 ^0xB3DA0A9
{
	if (*uParam0 != -1)
		return 0;
...
void func_275(var uParam0) // Position - 0x1313D Hash - 0xFD0D4431 ^0x1D9A796D
{
	int i;
	int j;
	Vector3 entityCoords;
	...
	if (!func_260(uParam0))
	{
		...
		{
			if (func_183(iLocal_26[i /*110*/]))
				func_295(&iLocal_26[i /*110*/]);
		}
	
		if (func_183(pedLocal_467))
			func_295(&pedLocal_467);
	
		for (j = 0; j < iLocal_1737; j = j + 1)
		{
			if (!MISC::IS_STRING_NULL_OR_EMPTY(&(iLocal_1737[j /*32*/].f_1)) && iLocal_1737[j /*32*/].f_27 != -1)
			{
				if (iLocal_1737[j /*32*/].f_28 == -1 || MISC::GET_GAME_TIMER() - iLocal_1737[j /*32*/].f_27 < iLocal_1737[j /*32*/].f_28)
				{
					if (iLocal_1737[j /*32*/].f_29 <= 0 || MISC::GET_GAME_TIMER() - iLocal_1737[j /*32*/].f_27 > iLocal_1737[j /*32*/].f_29)
					{
						if (iLocal_1737[j /*32*/] != -1 && func_183(iLocal_26[iLocal_1737[j /*32*/] /*110*/]))
						{
							entityCoords = { ENTITY::GET_ENTITY_COORDS(iLocal_26[iLocal_1737[j /*32*/] /*110*/], true) };
							iLocal_1737[j /*32*/].f_23 = { entityCoords };
						}
						else
						{
							entityCoords = { iLocal_1737[j /*32*/].f_23 };
						}
					
						if (!func_22(&uLocal_1696[3 /*8*/]))
							if (iLocal_1737[j /*32*/].f_31 && MISC::GET_DISTANCE_BETWEEN_COORDS(entityCoords, uLocal_640, true) < 35f)
								func_174(&uLocal_1696[3 /*8*/], 0, false, 1);
					
						for (i = 0; i < iLocal_26; i = i + 1)
						{
							if (iLocal_1737[j /*32*/] == -1 || i != iLocal_1737[j /*32*/] && iLocal_26[iLocal_1737[j /*32*/] /*110*/].f_5 >= iLocal_26[i /*110*/].f_5)
							{
								if (ENTITY::DOES_ENTITY_EXIST(iLocal_26[i /*110*/]) && !PED::IS_PED_INJURED(iLocal_26[i /*110*/]))
								{
									if (func_109(iLocal_26[i /*110*/], entityCoords, true) < iLocal_1737[j /*32*/].f_26 + iLocal_26[i /*110*/].f_42)
									{
										iLocal_26[i /*110*/].f_34 = j;
									
										if (iLocal_1737[j /*32*/].f_30)
										{
											if (!func_22(&uLocal_1696[3 /*8*/]))
											{
												func_174(&uLocal_1696[3 /*8*/], 0, false, 1);
												TEXT_LABEL_COPY(&uLocal_2378, { iLocal_1737[j /*32*/].f_1 }, 8);
											}
										}
									}
								}
				...
				else if (MISC::GET_GAME_TIMER() - iLocal_1737[j /*32*/].f_27 > iLocal_1737[j /*32*/].f_28 + 2000)
				{
					TEXT_LABEL_ASSIGN_STRING(&(iLocal_1737[j /*32*/].f_1), "", 64);
					iLocal_1737[j /*32*/] = -1;
					iLocal_1737[j /*32*/].f_23 = { 0f, 0f, 0f };
					iLocal_1737[j /*32*/].f_26 = 0f;
					iLocal_1737[j /*32*/].f_27 = -1;
					iLocal_1737[j /*32*/].f_28 = -1;
					iLocal_1737[j /*32*/].f_29 = -1;
				}
			}
		}
		...
		{
			if (func_183(iLocal_26[i /*110*/]))
				func_289(&iLocal_26[i /*110*/]);
		}
	
		if (func_183(pedLocal_467))
			func_280(&pedLocal_467);
	
		for (i = 0; i < iLocal_26; i = i + 1)
		{
			if (func_183(iLocal_26[i /*110*/]))
				func_279(&iLocal_26[i /*110*/]);
		}
	
		if (func_183(pedLocal_467))
			func_277(&pedLocal_467);
	
		for (i = 0; i < iLocal_26; i = i + 1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_26[i /*110*/].f_105))
			{
				if (!ENTITY::DOES_ENTITY_EXIST(iLocal_26[i /*110*/]) || PED::IS_PED_INJURED(iLocal_26[i /*110*/]) || PED::IS_PED_RUNNING_RAGDOLL_TASK(iLocal_26[i /*110*/]) || iLocal_26[i /*110*/].f_108 && iLocal_26[i /*110*/].f_5 != 0)
					flag = true;
				else if (iLocal_26[i /*110*/].f_5 != 0)
					flag2 = 1;
			
				if (flag || flag2)
				{
					if (ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(iLocal_26[i /*110*/].f_105, iLocal_26[i /*110*/]))
						ENTITY::DETACH_ENTITY(iLocal_26[i /*110*/].f_105, true, true);
				
					if (flag)
						ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&(iLocal_26[i /*110*/].f_105));
					else if (flag2)
						OBJECT::DELETE_OBJECT(&(iLocal_26[i /*110*/].f_105));
				
					iLocal_26[i /*110*/].f_109 = 0;
				}
			}
			else if (iLocal_26[i /*110*/].f_107 != 0 && iLocal_26[i /*110*/].f_106 != -1)
			{
				if (iLocal_26[i /*110*/].f_109 && STREAMING::HAS_MODEL_LOADED(iLocal_26[i /*110*/].f_107))
				{
					iLocal_26[i /*110*/].f_105 = OBJECT::CREATE_OBJECT(iLocal_26[i /*110*/].f_107, PED::GET_PED_BONE_COORDS(iLocal_26[i /*110*/], iLocal_26[i /*110*/].f_106, 0f, 0f, 0f), true, true, false);
					ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_26[i /*110*/].f_105, iLocal_26[i /*110*/], PED::GET_PED_BONE_INDEX(iLocal_26[i /*110*/], iLocal_26[i /*110*/].f_106), 0f, 0f, 0f, 0f, 0f, 0f, true, true, true, false, 2, true, 0);
					iLocal_26[i /*110*/].f_109 = 0;
				}
			}
		}
		...
		for (j = 0; j < iLocal_26; j = j + 1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_26[j /*110*/]) && !PED::IS_PED_INJURED(iLocal_26[j /*110*/]))
			{
				ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(iLocal_26[j /*110*/]);
				WEAPON::CLEAR_ENTITY_LAST_WEAPON_DAMAGE(iLocal_26[j /*110*/]);
			}
		}
...
void func_276() // Position - 0x13668 Hash - 0xCEEA3D00 ^0xF929048B
{
	int i;
	...
	{
		if (func_183(iLocal_577[i /*8*/]))
			ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(iLocal_577[i /*8*/]);
	}

	return;
}

void func_277(var uParam0) // Position - 0x1369B Hash - 0xA89BC250 ^0xC811C6C5
{
	int weaponHash;
	BOOL flag;
	...
	switch (uParam0->f_5)
	{
		case 0:
			if (CLOCK::GET_CLOCK_HOURS() >= 5 && CLOCK::GET_CLOCK_HOURS() < 21)
			{
				if (!func_193(*uParam0, SCRIPT_TASK_USE_NEAREST_SCENARIO_TO_POS, true) && !func_193(*uParam0, SCRIPT_TASK_PERFORM_SEQUENCE, true) || bLocal_2605)
				{
					if (TASK::DOES_SCENARIO_EXIST_IN_AREA(203.68f, -3132.46f, 4.79f, 1f, true))
					{
						TASK::TASK_USE_NEAREST_SCENARIO_TO_COORD(*uParam0, 203.68f, -3132.46f, 4.79f, 1f, 0);
						bLocal_2605 = false;
					}
				}
			}
			else if (!func_193(*uParam0, SCRIPT_TASK_USE_NEAREST_SCENARIO_CHAIN_TO_POS, true) || !bLocal_2605)
			{
				if (TASK::DOES_SCENARIO_EXIST_IN_AREA(162.69f, -3115.67f, 4.95f, 1f, true))
				{
					TASK::TASK_USE_NEAREST_SCENARIO_CHAIN_TO_COORD(*uParam0, 162.69f, -3115.67f, 4.95f, 1f, 0);
					bLocal_2605 = true;
				}
			}
			break;
		...
		case 3:
			...
			switch (MISC::GET_HASH_KEY(&(uParam0->f_9)))
			{
				...
				case joaat("RAN_OVER"):
					if (WEAPON::HAS_PED_GOT_WEAPON(*uParam0, joaat("WEAPON_PISTOL"), false))
						WEAPON::REMOVE_WEAPON_FROM_PED(*uParam0, joaat("WEAPON_PISTOL"));
				
					if (!WEAPON::HAS_PED_GOT_WEAPON(*uParam0, joaat("WEAPON_NIGHTSTICK"), false))
						WEAPON::GIVE_WEAPON_TO_PED(*uParam0, joaat("WEAPON_NIGHTSTICK"), -1, true, true);
				
					if (WEAPON::GET_CURRENT_PED_WEAPON(*uParam0, &weaponHash, true))
						if (weaponHash != joaat("WEAPON_NIGHTSTICK"))
							WEAPON::SET_CURRENT_PED_WEAPON(*uParam0, joaat("WEAPON_NIGHTSTICK"), false);
					break;
				...
				case joaat("STEALING_SEC_CAR"):
					if (WEAPON::HAS_PED_GOT_WEAPON(*uParam0, joaat("WEAPON_NIGHTSTICK"), false))
						WEAPON::REMOVE_WEAPON_FROM_PED(*uParam0, joaat("WEAPON_NIGHTSTICK"));
				
					if (!WEAPON::HAS_PED_GOT_WEAPON(*uParam0, joaat("WEAPON_PISTOL"), false))
						WEAPON::GIVE_WEAPON_TO_PED(*uParam0, joaat("WEAPON_PISTOL"), -1, true, true);
				
					if (WEAPON::GET_CURRENT_PED_WEAPON(*uParam0, &weaponHash, true))
						if (weaponHash != joaat("WEAPON_PISTOL"))
							WEAPON::SET_CURRENT_PED_WEAPON(*uParam0, joaat("WEAPON_PISTOL"), false);
					break;
			}
		
			if (!func_193(*uParam0, SCRIPT_TASK_COMBAT, true) || func_278(*uParam0))
			{
				TASK::TASK_COMBAT_PED(*uParam0, PLAYER::PLAYER_PED_ID(), 0, 16);
				TASK::TASK_LOOK_AT_ENTITY(*uParam0, PLAYER::PLAYER_PED_ID(), -1, SLF_WHILE_NOT_IN_FOV, 2);
			}
			break;
			...
			switch (MISC::GET_HASH_KEY(&(uParam0->f_9)))
			{
				case joaat("HEARD_SEC_CAR"):
					if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_91))
					{
						...
						{
							if (!func_193(*uParam0, SCRIPT_TASK_TURN_PED_TO_FACE_ENTITY, true) || func_278(*uParam0))
							{
								TASK::TASK_TURN_PED_TO_FACE_ENTITY(*uParam0, uParam0->f_91, -1);
								TASK::TASK_LOOK_AT_ENTITY(*uParam0, uParam0->f_91, -1, SLF_WHILE_NOT_IN_FOV, 2);
							}
						}
						else if (!func_193(*uParam0, SCRIPT_TASK_GOTO_ENTITY_OFFSET, true) || func_278(*uParam0))
						{
				...
				case joaat("HEARD_PLAYER"):
					if (uParam0->f_41 && !func_66(uParam0->f_88, uParam0->f_43, 1f, false))
					{
						uParam0->f_88 = { uParam0->f_43 };
						flag = true;
					}
				
					if (!_IS_NULL_VECTOR(uParam0->f_88))
					{
						if (!PED::IS_PED_HEADING_TOWARDS_POSITION(*uParam0, uParam0->f_88, 90f) && MISC::GET_GAME_TIMER() - uParam0->f_37 < 5000)
						{
							if (!func_193(*uParam0, SCRIPT_TASK_TURN_PED_TO_FACE_COORD, true) || func_278(*uParam0) || flag)
							{
								TASK::TASK_TURN_PED_TO_FACE_COORD(*uParam0, uParam0->f_88, 0);
								TASK::TASK_LOOK_AT_COORD(*uParam0, uParam0->f_88, -1, SLF_WHILE_NOT_IN_FOV, 2);
							}
						}
						else if (!func_193(*uParam0, SCRIPT_TASK_FOLLOW_NAV_MESH_TO_COORD, true) || func_278(*uParam0) || flag)
						{
				...
				case joaat("SOUND_LOST"):
					if (!_IS_NULL_VECTOR(uParam0->f_88))
					{
						if (!func_193(*uParam0, SCRIPT_TASK_TURN_PED_TO_FACE_COORD, true) || func_278(*uParam0))
						{
	...
	switch (uParam0->f_5)
	{
		case 0:
			...
			if (num != -1)
			{
				...
				{
					case 0:
						if (!func_193(*uParam0, SCRIPT_TASK_USE_NEAREST_SCENARIO_TO_POS, true))
					...
					case 1:
						if (!func_193(*uParam0, SCRIPT_TASK_PERFORM_SEQUENCE, true) || func_278(*uParam0) && STREAMING::HAS_ANIM_DICT_LOADED("misslsdhsclipboard@base"))
						{
							if (!ENTITY::IS_ENTITY_PLAYING_ANIM(*uParam0, "misslsdhsclipboard@base", "base", 3))
							{
								TASK::OPEN_SEQUENCE_TASK(&iLocal_2554);
							
								if (!func_66(ENTITY::GET_ENTITY_COORDS(*uParam0, true), 126.8496f, -3089.2493f, 4.9141f, 0.75f, false))
								...
								TASK::TASK_PLAY_ANIM(0, "misslsdhsclipboard@base", "base", 8f, -8f, -1, 1, 0, false, false, false);
							...
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_577[2 /*8*/]))
								TASK::TASK_LOOK_AT_COORD(*uParam0, ENTITY::GET_WORLD_POSITION_OF_ENTITY_BONE(iLocal_577[2 /*8*/], ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_577[2 /*8*/], "engine")), -1, 0, 2);
							...
							switch (uParam0->f_46)
							{
								...
								case 2:
									...
									if (uParam0->f_46 == 0 && TASK::GET_SEQUENCE_PROGRESS(*uParam0) == 2 || uParam0->f_46 == 2 && MISC::GET_GAME_TIMER() > uParam0->f_37)
									{
										...
										{
											case 0:
												TEXT_LABEL_ASSIGN_STRING(&animationName, "idle_a", 24);
												break;
										
											case 1:
												TEXT_LABEL_ASSIGN_STRING(&animationName, "idle_b", 24);
												break;
										
											case 2:
												TEXT_LABEL_ASSIGN_STRING(&animationName, "idle_c", 24);
												break;
										}
									
										TASK::TASK_PLAY_ANIM(0, "misslsdhsclipboard@idle_a", &animationName, 8f, -8f, -1, 0, 0, false, false, false);
										TASK::TASK_PLAY_ANIM(0, "misslsdhsclipboard@base", "base", 8f, -8f, -1, 1, 0, false, false, false);
										TASK::CLOSE_SEQUENCE_TASK(iLocal_2554);
										TASK::TASK_PERFORM_SEQUENCE(*uParam0, iLocal_2554);
										TASK::CLEAR_SEQUENCE_TASK(&iLocal_2554);
		...
		case 2:
			...
			{
				if (!func_193(*uParam0, SCRIPT_TASK_PERFORM_SEQUENCE, true) || !PED::IS_PED_FACING_PED(*uParam0, PLAYER::PLAYER_PED_ID(), 90f) || func_278(*uParam0))
				{
					TASK::OPEN_SEQUENCE_TASK(&iLocal_2554);
			...
			{
				if (ENTITY::DOES_ENTITY_EXIST(pedLocal_2604) && VEHICLE::IS_VEHICLE_DRIVEABLE(pedLocal_2604, false))
					num3 = func_108(PLAYER::PLAYER_PED_ID(), pedLocal_2604, true);
				...
				else if (iLocal_2601 == 5 && ENTITY::DOES_ENTITY_EXIST(pedLocal_2604))
				{
					if (num3 > 10f)
					{
						target = PLAYER::PLAYER_PED_ID();
					...
					{
						target = pedLocal_2604;
						moveBlendRatio = 2f;
					}
				}
				else if (iLocal_2601 == 4 && ENTITY::DOES_ENTITY_EXIST(pedLocal_2604))
				{
					target = pedLocal_2604;
					moveBlendRatio = 1f;
				}
				...
				if (ENTITY::DOES_ENTITY_EXIST(target))
					num2 = func_108(*uParam0, target, true);
			
				if (num2 <= 7.5f)
				{
					if (!func_193(*uParam0, SCRIPT_TASK_PERFORM_SEQUENCE, true) && !func_193(*uParam0, SCRIPT_TASK_GO_TO_ENTITY, true) || !PED::IS_PED_FACING_PED(*uParam0, PLAYER::PLAYER_PED_ID(), 90f) || func_278(*uParam0))
					{
						TASK::OPEN_SEQUENCE_TASK(&iLocal_2554);
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 0);
						TASK::TASK_STAND_STILL(0, 2000);
				...
				else if (!func_193(*uParam0, SCRIPT_TASK_GO_TO_ENTITY, true) || func_278(*uParam0))
				{
					if (moveBlendRatio > 1f)
						distance = 6f;
					else
						distance = 3f;
				
					TASK::TASK_GO_TO_ENTITY(*uParam0, target, -1, distance, moveBlendRatio, 1073741824, 0);
					TASK::TASK_LOOK_AT_ENTITY(*uParam0, PLAYER::PLAYER_PED_ID(), -1, SLF_WHILE_NOT_IN_FOV, 2);
				}
			}
			break;
		...
		case 3:
			switch (MISC::GET_HASH_KEY(&(uParam0->f_9)))
			{
				...
				case joaat("PLAYER_KO"):
					...
					if (!func_193(*uParam0, SCRIPT_TASK_COMBAT, true))
						TASK::TASK_COMBAT_PED(*uParam0, PLAYER::PLAYER_PED_ID(), 0, 16);
					break;
		...
		case 5:
			if (func_109(*uParam0, 177.7484f, -3240.8967f, 4.6079f, true) < 15f)
				if (!func_193(*uParam0, SCRIPT_TASK_SMART_FLEE_PED, true))
					TASK::TASK_SMART_FLEE_PED(*uParam0, PLAYER::PLAYER_PED_ID(), 1000f, -1, false, false);
			else if (!func_193(*uParam0, SCRIPT_TASK_SMART_FLEE_PED, true) && !func_193(*uParam0, SCRIPT_TASK_FOLLOW_NAV_MESH_TO_COORD, true) || func_278(*uParam0))
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, 177.7484f, -3240.8967f, 4.6079f, 3f, -1, 1048576000, 1, 1193033728);
			break;
		...
		case 4:
			...
			{
				case joaat("GUN_AIMED_AT"):
					if (!func_193(*uParam0, SCRIPT_TASK_HANDS_UP, true) || func_278(*uParam0))
...
void func_280(var uParam0) // Position - 0x146AD Hash - 0xE8561922 ^0x53D436AC
{
	var weaponHash;
	float num;
	BOOL flag;
	...
	WEAPON::GET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), &weaponHash, true);
	num = func_108(PLAYER::PLAYER_PED_ID(), *uParam0, true);
	...
	flag3 = func_287(*uParam0, &flag4, &flag5, &flag6);

	if (flag3 && flag4 && !flag6)
		if (flag5)
			func_262(uParam0, 3, true, "PLAYER_KILLED", 1, false);
		else
			func_262(uParam0, 3, true, "KILLED", 1, false);
	else if (PED::HAS_PED_RECEIVED_EVENT(*uParam0, 124) || PED::HAS_PED_RECEIVED_EVENT(*uParam0, 125) || PED::HAS_PED_RECEIVED_EVENT(*uParam0, 126) || PED::HAS_PED_RECEIVED_EVENT(*uParam0, 22) || PED::HAS_PED_RECEIVED_EVENT(*uParam0, 23) || PED::HAS_PED_RECEIVED_EVENT(*uParam0, 88))
		func_262(uParam0, 3, true, "GUNSHOT", 1, false);
	else if (uParam0->f_39 && func_286(4))
		func_262(uParam0, 3, true, "GUN_AIMED", 1, false);
	else if (uParam0->f_39 && func_285(*uParam0, 2))
		func_262(uParam0, 3, true, "PROJ_AIMED", 1, false);
	else if (uParam0->f_39 && num < 8f && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) && WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 5))
		func_262(uParam0, 3, true, "SEEN_WEAPON", 1, false);
	else if (uParam0->f_39 || uParam0->f_41 && iLocal_2601 == 11)
		if (uParam0->f_39)
			func_262(uParam0, 3, true, "STEALING_SEC_CAR", 1, false);
		else if (uParam0->f_41)
			func_284(uParam0, 1, "HEARD_SEC_CAR", iLocal_577[3 /*8*/], true, 1, false);
	else if (uParam0->f_39 || uParam0->f_41 && iLocal_2601 == 6)
		if (uParam0->f_39)
			func_262(uParam0, 3, true, "GET_IN_VAN", 1, false);
		else if (uParam0->f_41)
			func_284(uParam0, 1, "HEARD_VAN", iLocal_577[func_103() /*8*/], true, 1, false);
	else if (uParam0->f_39 || uParam0->f_41 && iLocal_2601 == 10)
		if (uParam0->f_39)
			func_284(uParam0, 3, "STEALING_VAN", iLocal_577[func_55() /*8*/], true, 1, false);
		else if (uParam0->f_41)
			func_284(uParam0, 1, "HEARD_VAN", iLocal_577[func_55() /*8*/], true, 1, false);
	else if (flag || PED::HAS_PED_RECEIVED_EVENT(*uParam0, 42) || PED::HAS_PED_RECEIVED_EVENT(*uParam0, 114) || func_282(*uParam0, false))
		func_262(uParam0, 3, true, "FIGHT", 1, false);
	else if (flag2 || PED::HAS_PED_RECEIVED_EVENT(*uParam0, 103) || func_282(*uParam0, true))
		func_262(uParam0, 3, true, "RAN_OVER", 1, false);
	else if (uParam0->f_5 != 3 && uParam0->f_84 && uParam0->f_39 || uParam0->f_41 && num < 8f || func_109(PLAYER::PLAYER_PED_ID(), uLocal_640, true) < 40f)
		if (uParam0->f_39)
			func_262(uParam0, 3, true, "FIGHT_RETURN", 1, false);
		else if (uParam0->f_41)
			func_281(uParam0, 1, "HEARD_PLAYER", ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), true, 1, false);
	else if (uParam0->f_5 != 5 && flag3)
		if (flag4 && flag5 && flag6)
			func_262(uParam0, 3, true, "PLAYER_KO", 1, false);
		else if (!flag5)
			func_262(uParam0, 3, true, "DEAD_BODY", 1, false);

	if (uParam0->f_34 > -1 && uParam0->f_34 < iLocal_1737 - 1)
	{
		flag7 = iLocal_1737[uParam0->f_34 /*32*/].f_30;
	
		switch (MISC::GET_HASH_KEY(&(iLocal_1737[uParam0->f_34 /*32*/].f_1)))
		{
			case joaat("killed"):
			case joaat("PLAYER_KILLED"):
			case joaat("DEAD_BODY"):
			...
			case joaat("gunshot"):
			case joaat("STEALING_SEC_CAR"):
				func_262(uParam0, 3, true, &(iLocal_1737[uParam0->f_34 /*32*/].f_1), 0, flag7);
				break;
		
			case joaat("HEARD_PLAYER"):
				func_281(uParam0, 1, &(iLocal_1737[uParam0->f_34 /*32*/].f_1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), true, 0, flag7);
				break;
		
			case joaat("HEARD_VAN"):
			case joaat("HEARD_SEC_CAR"):
				func_284(uParam0, 1, &(iLocal_1737[uParam0->f_34 /*32*/].f_1), iLocal_577[func_103() /*8*/], true, 0, flag7);
				break;
		}
	}
	...
	if (!MISC::ARE_STRINGS_EQUAL(&(uParam0->f_25), &(uParam0->f_9)))
		uParam0->f_33 = 1;
	else
		uParam0->f_33 = 0;
	...
	switch (uParam0->f_5)
	{
		...
		case 1:
			...
			{
				case joaat("VAN_LOST"):
					if (MISC::GET_GAME_TIMER() - uParam0->f_37 > 3000)
						func_262(uParam0, 0, false, "BACK_TO_WORK", 1, false);
					break;
			
				case joaat("HEARD_PLAYER"):
					if (MISC::GET_GAME_TIMER() - uParam0->f_37 > 4000 && func_109(*uParam0, uParam0->f_88, true) < 3f && TASK::IS_PED_STILL(*uParam0))
						func_262(uParam0, 1, false, "SOUND_LOST", 1, false);
					break;
			
				case joaat("SOUND_LOST"):
					if (MISC::GET_GAME_TIMER() - uParam0->f_37 > 4000 && !AUDIO::IS_PED_IN_CURRENT_CONVERSATION(*uParam0))
						func_262(uParam0, 0, false, "BACK_TO_WORK", 1, false);
					break;
			}
			break;
		...
		case 3:
			switch (MISC::GET_HASH_KEY(&(uParam0->f_9)))
			{
				...
				case joaat("FIGHT_RETURN"):
				case joaat("RAN_OVER"):
					if (MISC::GET_GAME_TIMER() - uParam0->f_38 > 8000 && func_109(PLAYER::PLAYER_PED_ID(), uLocal_640, true) > 65f && func_108(PLAYER::PLAYER_PED_ID(), *uParam0, true) > 10f || MISC::GET_GAME_TIMER() - uParam0->f_38 > 16000 && !AUDIO::IS_PED_IN_CURRENT_CONVERSATION(*uParam0))
						func_262(uParam0, 3, false, "FIGHT_ESC", 1, false);
					break;
				...
				case joaat("GET_IN_VAN"):
				case joaat("STEALING_SEC_CAR"):
					if (func_109(PLAYER::PLAYER_PED_ID(), uLocal_640, true) > 300f && func_108(PLAYER::PLAYER_PED_ID(), *uParam0, true) > 150f)
						func_262(uParam0, 3, false, "FIGHT_ESC", 1, false);
					break;
			}
			break;
...
int func_281(var uParam0, int iParam1, char* sParam2, var uParam3, var uParam4, var uParam5, BOOL bParam6, int iParam7, BOOL bParam8) // Position - 0x14DD1 Hash - 0x32A073B1 ^0x32A073B1
{
	return func_263(uParam0, iParam1, sParam2, uParam3, 0, bParam6, iParam7, bParam8);
}

BOOL func_282(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30, var uParam31, var uParam32, var uParam33, var uParam34, var uParam35, var uParam36, var uParam37, var uParam38, var uParam39, var uParam40, var uParam41, var uParam42, var uParam43, var uParam44, var uParam45, var uParam46, var uParam47, var uParam48, var uParam49, var uParam50, var uParam51, var uParam52, var uParam53, var uParam54, var uParam55, var uParam56, var uParam57, var uParam58, var uParam59, var uParam60, var uParam61, var uParam62, var uParam63, var uParam64, var uParam65, var uParam66, var uParam67, var uParam68, var uParam69, var uParam70, var uParam71, var uParam72, var uParam73, var uParam74, var uParam75, var uParam76, var uParam77, var uParam78, var uParam79, var uParam80, var uParam81, var uParam82, var uParam83, var uParam84, var uParam85, var uParam86, var uParam87, var uParam88, var uParam89, var uParam90, var uParam91, var uParam92, var uParam93, var uParam94, var uParam95, var uParam96, var uParam97, var uParam98, var uParam99, var uParam100, var uParam101, var uParam102, var uParam103, var uParam104, var uParam105, var uParam106, var uParam107, var uParam108, var uParam109, BOOL bParam110) // Position - 0x14DEE Hash - 0xEA0FF1F4 ^0xEA0FF1F4
{
	int i;

	for (i = 0; i < iLocal_26; i = i + 1)
	{
		if (func_283(uParam0, iLocal_26[i /*110*/], bParam110))
			return true;
	}
...
BOOL func_283(Ped pedParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30, var uParam31, var uParam32, var uParam33, var uParam34, var uParam35, var uParam36, var uParam37, var uParam38, var uParam39, var uParam40, var uParam41, var uParam42, var uParam43, var uParam44, var uParam45, var uParam46, var uParam47, var uParam48, var uParam49, var uParam50, var uParam51, var uParam52, var uParam53, var uParam54, var uParam55, var uParam56, var uParam57, var uParam58, var uParam59, var uParam60, var uParam61, var uParam62, var uParam63, var uParam64, var uParam65, var uParam66, var uParam67, var uParam68, var uParam69, var uParam70, var uParam71, var uParam72, var uParam73, var uParam74, var uParam75, var uParam76, var uParam77, var uParam78, var uParam79, var uParam80, var uParam81, var uParam82, var uParam83, var uParam84, var uParam85, var uParam86, var uParam87, var uParam88, var uParam89, var uParam90, var uParam91, var uParam92, var uParam93, var uParam94, var uParam95, var uParam96, var uParam97, var uParam98, var uParam99, var uParam100, var uParam101, var uParam102, var uParam103, var uParam104, var uParam105, var uParam106, var uParam107, var uParam108, var uParam109, Ped pedParam110, var uParam111, var uParam112, var uParam113, var uParam114, var uParam115, var uParam116, var uParam117, var uParam118, var uParam119, var uParam120, var uParam121, var uParam122, var uParam123, var uParam124, var uParam125, var uParam126, var uParam127, var uParam128, var uParam129, var uParam130, var uParam131, var uParam132, var uParam133, var uParam134, var uParam135, var uParam136, var uParam137, var uParam138, var uParam139, var uParam140, var uParam141, var uParam142, var uParam143, var uParam144, var uParam145, var uParam146, var uParam147, var uParam148, var uParam149, var uParam150, var uParam151, var uParam152, var uParam153, var uParam154, var uParam155, var uParam156, var uParam157, var uParam158, var uParam159, var uParam160, var uParam161, var uParam162, var uParam163, var uParam164, var uParam165, var uParam166, var uParam167, var uParam168, var uParam169, var uParam170, var uParam171, var uParam172, var uParam173, var uParam174, var uParam175, var uParam176, var uParam177, var uParam178, var uParam179, var uParam180, var uParam181, var uParam182, var uParam183, var uParam184, var uParam185, var uParam186, var uParam187, var uParam188, var uParam189, var uParam190, var uParam191, var uParam192, var uParam193, var uParam194, var uParam195, var uParam196, var uParam197, var uParam198, var uParam199, var uParam200, var uParam201, var uParam202, var uParam203, var uParam204, var uParam205, var uParam206, var uParam207, var uParam208, var uParam209, var uParam210, var uParam211, var uParam212, var uParam213, var uParam214, var uParam215, var uParam216, var uParam217, var uParam218, var uParam219, BOOL bParam220) // Position - 0x14E25 Hash - 0x1EBF9A2F ^0xA6E0D9B3
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam110) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam110, PLAYER::PLAYER_PED_ID(), bParam220))
		if (func_108(pedParam0, pedParam110, true) < 15f)
			if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(pedParam0, pedParam110))
				return true;

	return false;
}

int func_284(var uParam0, int iParam1, char* sParam2, Entity eParam3, BOOL bParam4, int iParam5, BOOL bParam6) // Position - 0x14E69 Hash - 0x82511F37 ^0x82511F37
{
	return func_263(uParam0, iParam1, sParam2, 0f, 0f, 0f, eParam3, bParam4, iParam5, bParam6);
}

BOOL func_285(Ped pedParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30, var uParam31, var uParam32, var uParam33, var uParam34, var uParam35, var uParam36, var uParam37, var uParam38, var uParam39, var uParam40, var uParam41, var uParam42, var uParam43, var uParam44, var uParam45, var uParam46, var uParam47, var uParam48, var uParam49, var uParam50, var uParam51, var uParam52, var uParam53, var uParam54, var uParam55, var uParam56, var uParam57, var uParam58, var uParam59, var uParam60, var uParam61, var uParam62, var uParam63, var uParam64, var uParam65, var uParam66, var uParam67, var uParam68, var uParam69, var uParam70, var uParam71, var uParam72, var uParam73, var uParam74, var uParam75, var uParam76, var uParam77, var uParam78, var uParam79, var uParam80, var uParam81, var uParam82, var uParam83, var uParam84, var uParam85, var uParam86, var uParam87, var uParam88, var uParam89, var uParam90, var uParam91, var uParam92, var uParam93, var uParam94, var uParam95, var uParam96, var uParam97, var uParam98, var uParam99, var uParam100, var uParam101, var uParam102, var uParam103, var uParam104, var uParam105, var uParam106, var uParam107, var uParam108, var uParam109, int iParam110) // Position - 0x14E86 Hash - 0x31A41D36 ^0x7242409A
{
	if (pedParam0 != 0 && ENTITY::DOES_ENTITY_EXIST(pedParam0) && !PED::IS_PED_INJURED(pedParam0))
		if (WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), iParam110) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), pedParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), pedParam0))
			return 1;

	return 0;
}

BOOL func_286(int iParam0) // Position - 0x14EDD Hash - 0x31AADF04 ^0x4C733334
{
...
BOOL func_287(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30, var uParam31, var uParam32, var uParam33, var uParam34, var uParam35, var uParam36, var uParam37, var uParam38, var uParam39, var uParam40, var uParam41, var uParam42, var uParam43, var uParam44, var uParam45, var uParam46, var uParam47, var uParam48, var uParam49, var uParam50, var uParam51, var uParam52, var uParam53, var uParam54, var uParam55, var uParam56, var uParam57, var uParam58, var uParam59, var uParam60, var uParam61, var uParam62, var uParam63, var uParam64, var uParam65, var uParam66, var uParam67, var uParam68, var uParam69, var uParam70, var uParam71, var uParam72, var uParam73, var uParam74, var uParam75, var uParam76, var uParam77, var uParam78, var uParam79, var uParam80, var uParam81, var uParam82, var uParam83, var uParam84, var uParam85, var uParam86, var uParam87, var uParam88, var uParam89, var uParam90, var uParam91, var uParam92, var uParam93, var uParam94, var uParam95, var uParam96, var uParam97, var uParam98, var uParam99, var uParam100, var uParam101, var uParam102, var uParam103, var uParam104, var uParam105, var uParam106, var uParam107, var uParam108, var uParam109, var uParam110, var uParam111, var uParam112) // Position - 0x14F12 Hash - 0x29BCDF05 ^0x29BCDF05
{
	int i;
	BOOL flag;
	BOOL flag2;
	...
	for (i = 0; i < iLocal_26; i = i + 1)
	{
		if (func_288(uParam0, iLocal_26[i /*110*/], &flag2, &flag3, &flag4))
		{
			if (flag2 && flag4)
				iLocal_26[i /*110*/].f_85 = 1;
...
BOOL func_288(Entity eParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30, var uParam31, var uParam32, var uParam33, var uParam34, var uParam35, var uParam36, var uParam37, var uParam38, var uParam39, var uParam40, var uParam41, var uParam42, var uParam43, var uParam44, var uParam45, var uParam46, var uParam47, var uParam48, var uParam49, var uParam50, var uParam51, var uParam52, var uParam53, var uParam54, var uParam55, var uParam56, var uParam57, var uParam58, var uParam59, var uParam60, var uParam61, var uParam62, var uParam63, var uParam64, var uParam65, var uParam66, var uParam67, var uParam68, var uParam69, var uParam70, var uParam71, var uParam72, var uParam73, var uParam74, var uParam75, var uParam76, var uParam77, var uParam78, var uParam79, var uParam80, var uParam81, var uParam82, var uParam83, var uParam84, var uParam85, var uParam86, var uParam87, var uParam88, var uParam89, var uParam90, var uParam91, var uParam92, var uParam93, var uParam94, var uParam95, var uParam96, var uParam97, var uParam98, var uParam99, var uParam100, var uParam101, var uParam102, var uParam103, var uParam104, var uParam105, var uParam106, var uParam107, var uParam108, var uParam109, Ped pedParam110, var uParam111, var uParam112, var uParam113, var uParam114, var uParam115, var uParam116, var uParam117, var uParam118, var uParam119, var uParam120, var uParam121, var uParam122, var uParam123, var uParam124, var uParam125, var uParam126, var uParam127, var uParam128, var uParam129, var uParam130, var uParam131, var uParam132, var uParam133, var uParam134, var uParam135, var uParam136, var uParam137, var uParam138, var uParam139, var uParam140, var uParam141, var uParam142, var uParam143, var uParam144, var uParam145, var uParam146, var uParam147, var uParam148, var uParam149, var uParam150, var uParam151, var uParam152, var uParam153, var uParam154, var uParam155, var uParam156, var uParam157, var uParam158, var uParam159, var uParam160, var uParam161, var uParam162, var uParam163, var uParam164, var uParam165, var uParam166, var uParam167, var uParam168, var uParam169, var uParam170, var uParam171, var uParam172, var uParam173, var uParam174, var uParam175, var uParam176, var uParam177, var uParam178, var uParam179, var uParam180, var uParam181, var uParam182, var uParam183, var uParam184, var uParam185, var uParam186, var uParam187, var uParam188, var uParam189, var uParam190, var uParam191, var uParam192, var uParam193, var uParam194, var uParam195, var uParam196, var uParam197, var uParam198, var uParam199, var uParam200, var uParam201, var uParam202, var uParam203, var uParam204, var uParam205, var uParam206, var uParam207, var uParam208, var uParam209, var uParam210, var uParam211, var uParam212, var uParam213, var uParam214, var uParam215, var uParam216, var uParam217, var uParam218, var uParam219, var uParam220, var uParam221, var uParam222) // Position - 0x14FBB Hash - 0xB46A3087 ^0x739288B9
{
	Vector3 entityCoords;
	...
	if (ENTITY::DOES_ENTITY_EXIST(pedParam110) && PED::IS_PED_INJURED(pedParam110))
	{
		entityCoords = { ENTITY::GET_ENTITY_COORDS(pedParam110, false) };
	
		if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(eParam0, true), entityCoords, true) < 10f)
		{
			if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(eParam0, pedParam110))
			{
				if (MISC::GET_GAME_TIMER() - pedParam110.f_103 < 3000)
					*uParam220 = 1;
				else
					*uParam220 = 0;
				...
				if (*uParam220)
				{
					pedSourceOfDeath = PED::GET_PED_SOURCE_OF_DEATH(pedParam110);
					...
					if (ENTITY::IS_ENTITY_A_PED(pedSourceOfDeath))
					{
						...
						if (pedIndexFromEntityIndex == PLAYER::PLAYER_PED_ID() && !PED::IS_PED_INJURED(pedIndexFromEntityIndex) && eParam0.f_39)
							*uParam221 = 1;
						else
							*uParam221 = 0;
					}
				...
				pedCauseOfDeath = PED::GET_PED_CAUSE_OF_DEATH(pedParam110);
			
				if (pedCauseOfDeath == joaat("WEAPON_UNARMED") || pedCauseOfDeath != joaat("WEAPON_UNARMED") && WEAPON::GET_WEAPON_DAMAGE_TYPE(pedCauseOfDeath) == 2)
					*uParam222 = 1;
...
void func_289(var uParam0) // Position - 0x150AE Hash - 0xE8561922 ^0x53D436AC
{
	var weaponHash;
	float num;
	BOOL flag;
	...
	if (uParam0->f_5 != 5 && flag3 && flag4 && !flag6)
	{
		if (flag5)
			func_262(uParam0, 5, true, "PLAYER_KILLED", 1, false);
		else
			func_262(uParam0, 5, true, "KILLED", 1, false);
	}
	else if (PED::HAS_PED_RECEIVED_EVENT(*uParam0, 124) || PED::HAS_PED_RECEIVED_EVENT(*uParam0, 125) || PED::HAS_PED_RECEIVED_EVENT(*uParam0, 126) || PED::HAS_PED_RECEIVED_EVENT(*uParam0, 22) || PED::HAS_PED_RECEIVED_EVENT(*uParam0, 23) || PED::HAS_PED_RECEIVED_EVENT(*uParam0, 88))
	{
		func_262(uParam0, 5, true, "GUNSHOT", 1, false);
	}
	else if (uParam0->f_39 && uParam0->f_5 != 4 && func_286(4))
	{
		func_262(uParam0, 4, true, "GUN_AIMED", 1, false);
	}
	else if (uParam0->f_39 && func_285(*uParam0, 2))
	{
		func_262(uParam0, 5, true, "PROJ_AIMED", 1, false);
	}
	else if (uParam0->f_39 && num < 8f && uParam0->f_5 != 4 && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) && WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 5))
	{
		func_262(uParam0, 5, true, "SEEN_WEAPON", 1, false);
	}
	else if (uParam0->f_39 || uParam0->f_41 && iLocal_2601 == 7)
	{
		if (uParam0->f_39)
			func_262(uParam0, 3, true, "EXIT_VAN", 1, false);
		else if (uParam0->f_41)
			func_281(uParam0, 1, "HEARD_PLAYER", ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), true, 1, false);
	}
	else if (uParam0->f_39 || uParam0->f_41 && iLocal_2601 == 6)
	...
	else if (uParam0->f_5 != 5 && flag3)
	{
		if (flag4 && flag5 && flag6)
			...
			func_262(uParam0, 5, true, "DEAD_BODY", 1, false);
	}
	else if (uParam0->f_39 || uParam0->f_41 && uParam0->f_86 || uParam0->f_87 && iLocal_2601 == 9 && !MISC::ARE_STRINGS_EQUAL(&(uParam0->f_9), "SEE_VAN_LEAVING") && !MISC::ARE_STRINGS_EQUAL(&(uParam0->f_9), "SEE_VAN_LEAVING_1") && !MISC::ARE_STRINGS_EQUAL(&(uParam0->f_9), "CHECK_DRIVER") && func_109(PLAYER::PLAYER_PED_ID(), uLocal_640, true) < 15f)
	{
		if (uParam0->f_39)
			func_284(uParam0, 1, "SEE_VAN_LEAVING", iLocal_577[func_103() /*8*/], true, 1, false);
		else if (uParam0->f_41)
			func_284(uParam0, 1, "HEARD_VAN", iLocal_577[func_103() /*8*/], true, 1, false);
	}
	else if (iLocal_2601 != 9)
	{
		if (uParam0->f_86 && iLocal_2601 == 0 || iLocal_2601 == 1 || iLocal_2601 == 4 || uParam0->f_5 == 1 || uParam0->f_87 && iLocal_2601 == 3 || iLocal_2601 == 2 || iLocal_2601 == 5)
		{
			if (iLocal_2601 == 5 || iLocal_2601 == 4 && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(*uParam0, pedLocal_2604, 19))
			{
				switch (iLocal_2601)
				{
					case 5:
						TEXT_LABEL_ASSIGN_STRING(&unk, "WH_DITCH_VEH", 64);
						break;
				
					case 4:
						TEXT_LABEL_ASSIGN_STRING(&unk, "ENT_DITCH_VEH", 64);
						break;
				}
			
				func_262(uParam0, 2, true, &unk, 1, false);
			}
			else if (uParam0->f_39)
			{
				...
				{
					case 0:
						TEXT_LABEL_ASSIGN_STRING(&unk, "ENT_FOOT", 64);
						break;
				
					case 1:
						TEXT_LABEL_ASSIGN_STRING(&unk, "ENT_VEH", 64);
						break;
				
					case 2:
						TEXT_LABEL_ASSIGN_STRING(&unk, "WH_FOOT", 64);
						break;
				
					case 3:
						TEXT_LABEL_ASSIGN_STRING(&unk, "WH_VEH", 64);
						break;
	...
	if (uParam0->f_34 > -1 && uParam0->f_34 < iLocal_1737 - 1)
	{
		...
		switch (MISC::GET_HASH_KEY(&(iLocal_1737[uParam0->f_34 /*32*/].f_1)))
		{
			...
			case joaat("DEAD_BODY"):
				if (uParam0->f_5 != 4)
					func_262(uParam0, 5, true, &(iLocal_1737[uParam0->f_34 /*32*/].f_1), 0, flag7);
				break;
			...
			case joaat("GUN_AIMED_AT"):
				if (uParam0->f_5 != 4)
					if (func_109(*uParam0, iLocal_1737[uParam0->f_34 /*32*/].f_23, true) < 5f)
						func_262(uParam0, 4, true, "GUN_AIMED_AT", 0, flag7);
					else
						func_262(uParam0, 5, true, "SEEN_WEAPON", 0, flag7);
				break;
			...
			case joaat("GET_IN_VAN"):
			case joaat("EXIT_VAN"):
				if (uParam0->f_5 != 4 && !MISC::ARE_STRINGS_EQUAL(&(uParam0->f_9), "STEALING_VAN") && !MISC::ARE_STRINGS_EQUAL(&(uParam0->f_9), "GET_IN_VAN") && !MISC::ARE_STRINGS_EQUAL(&(uParam0->f_9), "EXIT_VAN"))
					func_262(uParam0, 3, true, &(iLocal_1737[uParam0->f_34 /*32*/].f_1), 0, flag7);
				break;
			...
			case joaat("ENT_FOOT"):
				if (uParam0->f_86)
					func_262(uParam0, 2, true, &(iLocal_1737[uParam0->f_34 /*32*/].f_1), 0, flag7);
				break;
	...
	switch (uParam0->f_5)
	{
		case 5:
			switch (MISC::GET_HASH_KEY(&(uParam0->f_9)))
			{
				...
				case joaat("PLAYER_KILLED"):
				case joaat("DEAD_BODY"):
					if (func_294(*uParam0) || uParam0->f_48 % 2 == 0 || !func_183(pedLocal_467))
					{
						if (MISC::GET_HASH_KEY(&(uParam0->f_9)) == joaat("gunshot") || MISC::GET_HASH_KEY(&(uParam0->f_9)) == joaat("SEEN_WEAPON") || MISC::GET_HASH_KEY(&(uParam0->f_9)) == joaat("PROJ_AIMED"))
						{
							if (func_271(num2))
							{
								unk17 = { func_293(num2, "JS_GUN1") };
							
								if (func_268(num2, &unk17, uParam0->f_5, true, true, false, 1000, false, 0, false))
									func_292(uParam0, &(uParam0->f_9), &unk17, 15f, 3000, 250, false, 1, 0);
								else if (uParam0->f_48 == 0)
									func_292(uParam0, &(uParam0->f_9), "", 15f, 3000, 250, true, 1, 0);
							}
							else
							{
								switch (num2)
								{
									case 2:
										TEXT_LABEL_ASSIGN_STRING(&unk17, "SOL1_ARM1", 24);
										break;
								
									case 3:
										TEXT_LABEL_ASSIGN_STRING(&unk17, "SOL1_ARM2", 24);
										break;
								}
						...
						else if (MISC::GET_HASH_KEY(&(uParam0->f_9)) == joaat("killed") || MISC::GET_HASH_KEY(&(uParam0->f_9)) == joaat("PLAYER_KILLED") || MISC::GET_HASH_KEY(&(uParam0->f_9)) == joaat("DEAD_BODY"))
						{
							if (func_271(num2))
							{
								unk17 = { func_293(num2, "JS_KILL") };
							
								if (func_268(num2, &unk17, uParam0->f_5, true, true, false, 2000, false, 0, false))
									func_292(uParam0, &(uParam0->f_9), &unk17, 15f, 3000, 250, false, 1, 0);
								else if (uParam0->f_48 == 0)
									func_292(uParam0, &(uParam0->f_9), "", 15f, 3000, 250, true, 1, 0);
							}
					...
					else
					{
						if (func_271(num2))
						{
							unk17 = { func_293(num2, "JS_GETSEC") };
						
							if (func_268(num2, &unk17, uParam0->f_5, true, true, false, 2000, false, 0, false))
								func_292(uParam0, &(uParam0->f_9), &unk17, 15f, 3000, 250, false, 1, 1);
							else if (uParam0->f_48 == 0)
								func_292(uParam0, &(uParam0->f_9), "", 15f, 3000, 250, true, 1, 1);
						}
						else
						{
							switch (num2)
							{
								case 2:
									TEXT_LABEL_ASSIGN_STRING(&unk17, "SOL1_SECIN1", 24);
									break;
							
								case 3:
									TEXT_LABEL_ASSIGN_STRING(&unk17, "SOL1_SECIN2", 24);
									break;
							}
			...
			switch (MISC::GET_HASH_KEY(&(uParam0->f_9)))
			{
				case joaat("GUN_AIMED"):
					if (func_285(*uParam0, 4))
						func_262(uParam0, 4, false, "GUN_AIMED_AT", 1, false);
					else if (MISC::GET_GAME_TIMER() - uParam0->f_37 > 1000)
						func_262(uParam0, 5, true, "SEEN_WEAPON", 1, false);
					break;
			
				case joaat("GUN_AIMED_AT"):
					if (func_285(*uParam0, 4))
						func_262(uParam0, 4, true, "GUN_AIMED_AT", 1, false);
				
					if (MISC::GET_GAME_TIMER() - uParam0->f_37 > 15000 || MISC::GET_GAME_TIMER() - uParam0->f_38 > 3000 && !AUDIO::IS_PED_IN_CURRENT_CONVERSATION(*uParam0))
					{
						func_262(uParam0, 5, true, "SEEN_WEAPON", 1, false);
					}
					else if (func_294(*uParam0) || uParam0->f_48 == 0)
					{
						if (func_271(num2))
						{
							unk17 = { func_293(num2, "JS_HND1") };
						
							if (func_268(num2, &unk17, uParam0->f_5, true, true, false, 500, false, 0, false))
								func_292(uParam0, &(uParam0->f_9), &unk17, 5f, 3000, 500, false, 1, 0);
							else if (uParam0->f_48 == 0)
								func_292(uParam0, &(uParam0->f_9), "", 5f, 3000, 500, true, 1, 0);
						}
						else
						{
							switch (num2)
							{
								case 2:
									TEXT_LABEL_ASSIGN_STRING(&unk17, "SOL1_SCAR1", 24);
									break;
							
								case 3:
									TEXT_LABEL_ASSIGN_STRING(&unk17, "SOL1_SCAR2", 24);
									break;
							}
					...
					else
					{
						if (func_271(num2))
						{
							...
							if (func_268(num2, &unk17, uParam0->f_5, false, false, true, 2000, false, 0, false))
								func_292(uParam0, &(uParam0->f_9), &unk17, 5f, 3000, 500, false, 1, 0);
							else if (uParam0->f_48 == 0)
								func_292(uParam0, &(uParam0->f_9), "", 5f, 3000, 500, true, 1, 0);
						}
			...
			switch (num2)
			{
				case 1:
					if (func_48() && MISC::GET_GAME_TIMER() - iLocal_2552 > 5000)
					{
						...
						{
							case 0:
								func_268(num2, "JS_STOCK", uParam0->f_5, false, false, true, 0, false, 0, false);
								iLocal_2582 = iLocal_2582 + 1;
								break;
						
							case 1:
								func_268(num2, "JS_STOCKb", uParam0->f_5, false, false, true, 0, false, 0, false);
								iLocal_2582 = iLocal_2582 + 1;
								break;
						
							case 2:
								func_268(num2, "JS_STOCKc", uParam0->f_5, false, false, true, 0, false, 0, false);
								iLocal_2582 = iLocal_2582 + 1;
								break;
						
							case 3:
								func_268(num2, "JS_STOCKd", uParam0->f_5, false, false, true, 0, false, 0, false);
								iLocal_2582 = iLocal_2582 + 1;
								break;
						
							case 4:
								func_268(num2, "JS_STOCKe", uParam0->f_5, false, false, true, 0, false, 0, false);
								iLocal_2582 = iLocal_2582 + 1;
								break;
						
							case 5:
								func_268(num2, "JS_STOCKf", uParam0->f_5, false, false, true, 0, false, 0, false);
								iLocal_2582 = iLocal_2582 + 1;
								break;
						
							case 6:
								func_268(num2, "JS_STOCKg", uParam0->f_5, false, false, true, 0, false, 0, false);
								iLocal_2582 = iLocal_2582 + 1;
								break;
						
							case 7:
								func_268(num2, "JS_STOCKh", uParam0->f_5, false, false, true, 0, false, 0, false);
								iLocal_2582 = iLocal_2582 + 1;
								break;
						
							case 8:
								func_268(num2, "JS_STOCKi", uParam0->f_5, false, false, true, 0, false, 0, false);
								iLocal_2582 = iLocal_2582 + 1;
								break;
						
							case 9:
								func_268(num2, "JS_STOCKj", uParam0->f_5, false, false, true, 0, false, 0, false);
								iLocal_2582 = iLocal_2582 + 1;
								break;
						
							case 10:
								func_268(num2, "JS_STOCKk", uParam0->f_5, false, false, true, 0, false, 0, false);
								iLocal_2582 = 0;
								break;
						}
					}
				...
				case 2:
					if (!uParam0->f_49)
					{
						if (func_268(num2, "SOL1_AMB1", uParam0->f_5, false, false, true, 0, true, 0, true))
						{
							_CONVERSATION_INITIALIZE_ACTOR(&uLocal_2386, 4, iLocal_26[2 /*110*/], "CONSTRUCTION1", 0, 1);
							_CONVERSATION_INITIALIZE_ACTOR(&uLocal_2386, 3, iLocal_26[3 /*110*/], "CONSTRUCTION2", 0, 1);
							uParam0->f_49 = 1;
		...
		case 1:
			if (MISC::ARE_STRINGS_EQUAL(&(uParam0->f_9), "SEE_VAN_LEAVING") || MISC::ARE_STRINGS_EQUAL(&(uParam0->f_9), "CHECK_DRIVER"))
			{
				unk23 = { func_291(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(PLAYER::PLAYER_PED_ID(), 0f, 1f, 0f) - ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)) };
				unk26 = { func_291(ENTITY::GET_ENTITY_COORDS(iLocal_26[num2 /*110*/], true) - ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)) };
				num3 = func_290(unk23, unk26);
				num4 = MISC::ACOS(num3);
			
				if (num4 < 90f && num < 8f && ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) < 1f)
					flag8 = true;
			}
			...
			switch (MISC::GET_HASH_KEY(&(uParam0->f_9)))
			{
				case joaat("SEE_VAN_LEAVING"):
				case joaat("SEE_VAN_LEAVING_1"):
					if (func_294(*uParam0) && MISC::ARE_STRINGS_EQUAL(&(uParam0->f_9), "SEE_VAN_LEAVING"))
					{
						if (func_271(num2))
						{
							unk17 = { func_293(num2, "JS_VAN_LVE1") };
							func_268(num2, &unk17, uParam0->f_5, true, false, true, 1000, false, 0, false);
						}
					}
					else if (flag8)
					{
						func_284(uParam0, 1, "CHECK_DRIVER", iLocal_577[func_103() /*8*/], false, 1, false);
					}
					else if (func_109(PLAYER::PLAYER_PED_ID(), uLocal_640, true) >= 20f)
					{
						if (num > 5f)
							func_262(uParam0, 1, false, "VAN_LOST", 1, false);
					}
					break;
				...
				case joaat("VAN_LOST"):
					if (func_294(*uParam0))
					{
						unk17 = { func_293(num2, "JS_VAN_LVE2") };
						func_268(num2, &unk17, uParam0->f_5, true, false, true, 0, false, 0, false);
					}
					else if (MISC::GET_GAME_TIMER() - uParam0->f_37 > 3000)
					{
						func_262(uParam0, 0, false, "BACK_TO_WORK", 1, false);
					}
					break;
				...
				case joaat("CHECK_DRIVER"):
					if (flag8)
						if (MISC::GET_GAME_TIMER() - uParam0->f_37 > 2000 && !AUDIO::IS_PED_IN_CURRENT_CONVERSATION(*uParam0))
							func_262(uParam0, 3, true, "STEALING_VAN", 1, false);
					else
						func_284(uParam0, 1, "SEE_VAN_LEAVING_1", iLocal_577[func_103() /*8*/], false, 1, false);
					break;
				...
				case joaat("HEARD_PLAYER"):
					...
					else if (func_294(*uParam0))
					{
						if (func_271(num2))
						{
							unk17 = { func_293(num2, "JS_SND_INV") };
						
							if (func_268(num2, &unk17, uParam0->f_5, true, true, true, 0, false, 0, false))
								func_292(uParam0, &(uParam0->f_9), &unk17, 3f, 3000, 500, false, 0, 0);
						}
					}
					break;
				...
				case joaat("SOUND_LOST"):
					if (MISC::GET_GAME_TIMER() - uParam0->f_37 > 4000 && !AUDIO::IS_PED_IN_CURRENT_CONVERSATION(*uParam0))
					{
						if (func_271(num2))
						{
							unk17 = { func_293(num2, "JS_SNDLOST2") };
							func_268(num2, &unk17, uParam0->f_5, false, false, true, 1000, false, 0, false);
						}
					...
					else if (func_294(*uParam0))
					{
						if (func_271(num2))
						{
							unk17 = { func_293(num2, "JS_SNDLOST1") };
							func_268(num2, &unk17, uParam0->f_5, false, false, true, 1000, false, 0, false);
						}
					}
					break;
		...
		case 3:
			switch (MISC::GET_HASH_KEY(&(uParam0->f_9)))
			{
				...
				case -419867425:
					...
					else if (func_294(*uParam0) && uParam0->f_35)
					{
						if (!uParam0->f_84)
						{
							if (func_271(num2))
							{
								unk17 = { func_293(num2, "JS_MELE_1") };
							
								if (func_268(num2, &unk17, uParam0->f_5, true, true, false, 500, false, 0, false))
									func_292(uParam0, &(uParam0->f_9), &unk17, 25f, 3000, 1000, false, 0, 0);
							}
							else
							{
								switch (num2)
								{
									case 2:
										TEXT_LABEL_ASSIGN_STRING(&unk17, "SOL1_FIGHT1", 24);
										break;
								
									case 3:
										TEXT_LABEL_ASSIGN_STRING(&unk17, "SOL1_FIGHT2", 24);
										break;
								}
						...
						else if (func_271(num2))
						{
							unk17 = { func_293(num2, "JS_MELE_2") };
				...
				case joaat("FIGHT_ESC"):
					if (MISC::GET_GAME_TIMER() - uParam0->f_37 > 4000)
						func_262(uParam0, 0, false, "BACK_TO_WORK", 1, false);
					...
					if (func_294(*uParam0))
					{
						if (func_271(num2))
						{
							unk17 = { func_293(num2, "JS_MELE_ESC") };
							func_268(num2, &unk17, uParam0->f_5, true, true, false, 500, false, 0, false);
						}
					}
					break;
			
				case joaat("STEALING_VAN"):
					if (MISC::GET_GAME_TIMER() - uParam0->f_37 > 2000 && uParam0->f_39 && !AUDIO::IS_PED_IN_CURRENT_CONVERSATION(*uParam0) && iLocal_2601 != 9 && iLocal_2601 != 10)
						func_262(uParam0, 3, false, "EXIT_VAN", 1, false);
				
					if (func_294(*uParam0))
					{
						if (func_271(num2))
						{
							unk17 = { func_293(num2, "JS_VAN_IN2") };
						
							if (func_268(num2, &unk17, uParam0->f_5, true, true, false, 0, false, 0, false))
								func_292(uParam0, &(uParam0->f_9), &unk17, 25f, 3000, 1000, false, 1, 0);
							else
								func_292(uParam0, &(uParam0->f_9), &unk17, 25f, 3000, 1000, true, 1, 0);
						}
						else
						{
							switch (num2)
							{
								case 2:
									TEXT_LABEL_ASSIGN_STRING(&unk17, "SOL1_VAN1", 24);
									break;
							
								case 3:
									TEXT_LABEL_ASSIGN_STRING(&unk17, "SOL1_VAN2", 24);
									break;
							}
				...
				case joaat("GET_IN_VAN"):
					if (func_294(*uParam0))
					{
						if (func_271(num2))
						{
							unk17 = { func_293(num2, "JS_VAN_IN1") };
		...
		case 2:
			if (MISC::GET_GAME_TIMER() - uParam0->f_38 > 5000 && !AUDIO::IS_PED_IN_CURRENT_CONVERSATION(*uParam0))
			{
				if (num2 == 1)
				{
					func_268(num2, "JS_STOCK2", 0, false, false, true, 1000, false, 0, false);
					iLocal_2582 = 0;
				}
			...
			else
			{
				if (uParam0->f_39)
				{
					if (MISC::GET_GAME_TIMER() - uParam0->f_38 > 1000 && !AUDIO::IS_PED_IN_CURRENT_CONVERSATION(*uParam0))
					{
						if (MISC::ARE_STRINGS_EQUAL(&(uParam0->f_9), "ENT_FOOT") || MISC::ARE_STRINGS_EQUAL(&(uParam0->f_9), "ENT_VEH") || MISC::ARE_STRINGS_EQUAL(&(uParam0->f_9), "WH_FOOT") || MISC::ARE_STRINGS_EQUAL(&(uParam0->f_9), "WH_VEH"))
						{
							unk29 = { uParam0->f_9 };
							TEXT_LABEL_APPEND_STRING(&unk29, "_LEAVE", 32);
							func_262(uParam0, 2, false, &unk29, 1, false);
						}
					}
				
					if (MISC::ARE_STRINGS_EQUAL(&(uParam0->f_9), "WH_FOOT") || MISC::ARE_STRINGS_EQUAL(&(uParam0->f_9), "WH_VEH") || MISC::ARE_STRINGS_EQUAL(&(uParam0->f_9), "WH_DITCH_VEH") && !AUDIO::IS_PED_IN_CURRENT_CONVERSATION(*uParam0))
						if (uParam0->f_104 >= 6 && iLocal_2552 != -1 && MISC::GET_GAME_TIMER() - iLocal_2552 > 7000 && MISC::GET_GAME_TIMER() - uParam0->f_38 == 0)
							func_262(uParam0, 3, false, "WH_FAILED_LEAVE", 1, false);
				}
				...
				switch (MISC::GET_HASH_KEY(&(uParam0->f_9)))
				{
					case joaat("ENT_FOOT"):
						if (func_294(*uParam0))
						{
							if (!uParam0->f_82)
							{
								if (func_271(num2))
								{
									if (!uParam0->f_83)
									{
										unk17 = { func_293(num2, "JS_ENT_F1") };
										func_268(num2, &unk17, uParam0->f_5, true, false, false, 500, false, 0, false);
									}
									else
									{
										unk17 = { func_293(num2, "JS_ENT_F1_P") };
										func_268(num2, &unk17, uParam0->f_5, true, false, false, 500, false, 0, false);
									}
								}
							}
							else if (func_271(num2))
							{
								if (!uParam0->f_83)
								{
									unk17 = { func_293(num2, "JS_ENT_F2") };
									func_268(num2, &unk17, uParam0->f_5, true, true, false, 500, false, 0, false);
								}
								else
								{
									unk17 = { func_293(num2, "JS_ENT_F2_P") };
									func_268(num2, &unk17, uParam0->f_5, true, true, false, 500, false, 0, false);
								}
							}
						...
						else if (func_48() && MISC::GET_GAME_TIMER() - iLocal_2552 > 5000)
						{
							if (func_271(num2))
							{
								if (!uParam0->f_83)
								{
									unk17 = { func_293(num2, "JS_ENT_F") };
									func_268(num2, &unk17, uParam0->f_5, false, false, true, 0, false, 0, false);
								}
								else
								{
									unk17 = { func_293(num2, "JS_ENT_F_P") };
									func_268(num2, &unk17, uParam0->f_5, false, false, true, 0, false, 0, false);
								}
							}
						}
					...
					case joaat("ENT_VEH"):
						if (func_294(*uParam0) || uParam0->f_48 == 0)
						{
							if (!uParam0->f_82)
							{
								if (func_271(num2))
								{
									unk17 = { func_293(num2, "JS_ENT_V1") };
							...
							else if (MISC::ARE_STRINGS_EQUAL(&(uParam0->f_17), "WH_VEH"))
							{
								if (func_271(num2))
								{
									unk17 = { func_293(num2, "JS_ENT_V") };
					...
					case joaat("WH_FOOT"):
						if (func_294(*uParam0))
						{
							if (uParam0->f_104 == 0)
							{
								if (func_271(num2))
								{
									unk17 = { func_293(num2, "JS_WH1") };
								
									if (func_268(num2, &unk17, uParam0->f_5, true, true, true, 0, false, 0, false))
										func_292(uParam0, &(uParam0->f_9), &unk17, 5f, 3000, 500, false, 0, 0);
									else
										func_292(uParam0, &(uParam0->f_9), "", 5f, 3000, 500, true, 0, 0);
								
									uParam0->f_104 = uParam0->f_104 + 1;
								}
							}
						...
						else if (uParam0->f_104 < 6)
						{
							if (func_48() && MISC::GET_GAME_TIMER() - iLocal_2552 > 5000)
							{
								...
								{
									if (uParam0->f_104 < 5)
										unk17 = { func_293(num2, "JS_WH") };
									else
										unk17 = { func_293(num2, "JS_WH_F") };
								
									if (func_268(num2, &unk17, uParam0->f_5, true, true, true, 0, false, 0, false))
										func_292(uParam0, &(uParam0->f_9), &unk17, 10f, 3000, 500, false, 0, 0);
									else
										func_292(uParam0, &(uParam0->f_9), "", 10f, 3000, 500, true, 0, 0);
						...
						if (uParam0->f_48 == 0)
						{
							if (func_48() && MISC::GET_GAME_TIMER() - iLocal_2552 > 1000)
							{
								if (func_271(num2))
								{
									if (!uParam0->f_83)
									{
										unk17 = { func_293(num2, "JS_ENT_F3") };
										func_268(num2, &unk17, uParam0->f_5, false, false, true, 0, false, 0, false);
									}
									else
									{
										unk17 = { func_293(num2, "JS_ENT_F3_P") };
										func_268(num2, &unk17, uParam0->f_5, false, false, true, 0, false, 0, false);
									}
								}
...
float func_290(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0x17780 Hash - 0x596BEA29 ^0x5FBCDBE5
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_291(float fParam0, var uParam1, var uParam2) // Position - 0x177A1 Hash - 0xFB6A39D2 ^0x80C9C759
{
	float num;
	float num2;
...
void func_292(var uParam0, char* sParam1, char* sParam2, float fParam3, int iParam4, int iParam5, BOOL bParam6, int iParam7, int iParam8) // Position - 0x177E0 Hash - 0xC7127BC8 ^0x1A9C0CB5
{
	int i;
	int num;
	...
	uParam0->f_50 = num;
	TEXT_LABEL_ASSIGN_STRING(&(uParam0->f_50.f_1), sParam1, 64);
	TEXT_LABEL_ASSIGN_STRING(&(uParam0->f_50.f_17), sParam2, 24);
	...
	if (bParam6)
		func_265(&(uParam0->f_50), 0);

	return;
}

struct<6> func_293(int iParam0, char* sParam1) // Position - 0x1785C Hash - 0xC2E9D9F6 ^0x487091D3
{
	var unk;
	...
	if (iParam0 == 1)
		TEXT_LABEL_APPEND_STRING(&unk, "b", 24);

	return unk;
}

BOOL func_294(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30, var uParam31, var uParam32, var uParam33, var uParam34, var uParam35, var uParam36, var uParam37, var uParam38, var uParam39, var uParam40, var uParam41, var uParam42, var uParam43, var uParam44, var uParam45, var uParam46, var uParam47, var uParam48, var uParam49, var uParam50, var uParam51, var uParam52, var uParam53, var uParam54, var uParam55, var uParam56, var uParam57, var uParam58, var uParam59, var uParam60, var uParam61, var uParam62, var uParam63, var uParam64, var uParam65, var uParam66, var uParam67, var uParam68, var uParam69, var uParam70, var uParam71, var uParam72, var uParam73, var uParam74, var uParam75, var uParam76, var uParam77, var uParam78, var uParam79, var uParam80, var uParam81, var uParam82, var uParam83, var uParam84, var uParam85, var uParam86, var uParam87, var uParam88, var uParam89, var uParam90, var uParam91, var uParam92, var uParam93, var uParam94, var uParam95, var uParam96, var uParam97, var uParam98, var uParam99, var uParam100, var uParam101, var uParam102, var uParam103, var uParam104, var uParam105, var uParam106, var uParam107, var uParam108, var uParam109) // Position - 0x1787C Hash - 0xE37E99C9 ^0x319F02BD
{
	if (uParam0.f_8 || uParam0.f_33)
		return true;

	return false;
}

void func_295(var uParam0) // Position - 0x1789A Hash - 0x6675067C ^0x1A9B13B7
{
	...
	else if (MISC::GET_GAME_TIMER() - uParam0->f_40 > 2000 || !PED::IS_PED_FACING_PED(*uParam0, PLAYER::PLAYER_PED_ID(), 90f))
	{
		uParam0->f_40 = MISC::GET_GAME_TIMER();
		uParam0->f_39 = 0;
	}
	...
	if (bLocal_2598)
		PED::SET_PED_RESET_FLAG(*uParam0, 188, true);

	if (!func_296())
	{
		uParam0->f_41 = PLAYER::CAN_PED_HEAR_PLAYER(PLAYER::PLAYER_ID(), *uParam0);
	
		if (uParam0->f_41)
			uParam0->f_43 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
	}
	else
	{
		uParam0->f_41 = 0;
...
BOOL func_296() // Position - 0x1796F Hash - 0xFB2DE584 ^0xE720D737
{
	int i;
	...
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_577[i /*8*/]) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_577[i /*8*/], false))
			if (VEHICLE::IS_VEHICLE_ALARM_ACTIVATED(iLocal_577[i /*8*/]))
				return true;
	}
...
void func_297() // Position - 0x179BB Hash - 0xB063D077 ^0xA20FCC84
{
	var unk;
	var unk4;

	PED::ADD_RELATIONSHIP_GROUP("BUGSTAR", &hLocal_2553);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(3, joaat("PLAYER"), hLocal_2553);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, hLocal_2553, joaat("PLAYER"));
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, joaat("COP"), hLocal_2553);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, hLocal_2553, joaat("COP"));
	VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA({ 8.64631f, -3092.9624f, 139.57953f } - { 4.1875f, 24f, 33.3125f }, { 8.64631f, -3092.9624f, 139.57953f } + { 4.1875f, 24f, 33.3125f }, false, true);
	VEHICLE::REMOVE_VEHICLES_FROM_GENERATORS_IN_AREA({ 7.27131f, -3092.467f, 138.42677f } - { 2.375f, 22.75f, 19.4375f }, { 7.27131f, -3092.467f, 138.42677f } + { 2.375f, 22.75f, 19.4375f }, 0);
	...
	if (_IS_MISSION_REPLAY_IN_PROGRESS() || _IS_MISSION_REPEAT_ACTIVE(false))
	{
		...
		if (_IS_MISSION_REPLAY_IN_PROGRESS())
		{
			func_249(iLocal_653, &unk, &unk4);
			func_303(unk, unk4, 1, 0);
		}
	...
	func_299(87);
	_CONVERSATION_INITIALIZE_ACTOR(&uLocal_2386, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
	_CONVERSATION_INITIALIZE_ACTOR(&uLocal_2386, 3, 0, "LESTER", 0, 1);
	func_267(bLocal_2551);
	func_298();
	inLocal_2555 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(uLocal_640, "po1_08_warehouseint1");
	AUDIO::PREPARE_ALARM(&uLocal_624);
...
void func_298() // Position - 0x17BF4 Hash - 0xEB0D43DD ^0xEB0D43DD
{
	Global_95550 = 1;
	return;
}

void func_299(int iParam0) // Position - 0x17C01 Hash - 0x6F0ACC58 ^0x6F0ACC58
{
	Global_97227 = 0;
...
void func_300(int iParam0) // Position - 0x17C8F Hash - 0x53D7F035 ^0x7451626F
{
	MISC::SET_BIT(&Global_97227, iParam0);
	return;
}

int func_301(var uParam0, char* sParam1, int iParam2) // Position - 0x17CA1 Hash - 0x4E4AD52A ^0xB20C074B
{
...
void func_302(var uParam0) // Position - 0x17D45 Hash - 0x88F72D12 ^0x88F72D12
{
	func_251(uParam0);
	return;
}

void func_303(var uParam0, var uParam1, var uParam2, float fParam3, int iParam4, int iParam5) // Position - 0x17D54 Hash - 0xF88978B9 ^0xA249DBD8
{
	if (_IS_MISSION_REPLAY_IN_PROGRESS())
	{
...
void func_304(int iParam0) // Position - 0x17DE9 Hash - 0xB7DCD341 ^0x72122681
{
	var unk;
	var unk7;
	...
	else if (!bLocal_654)
	{
		...
		{
			case 1:
				TEXT_LABEL_ASSIGN_STRING(&unk, "JHP1A_VAN_DEAD", 24);
				break;
		
			case 3:
				TEXT_LABEL_ASSIGN_STRING(&unk, "JHP1A_VAN_STUCK", 24);
				break;
		
			case 2:
				TEXT_LABEL_ASSIGN_STRING(&unk, "JHP1A_VANS_DEAD", 24);
				break;
		
			case 4:
				TEXT_LABEL_ASSIGN_STRING(&unk, "JHP1A_VAN_ABAN", 24);
				break;
		
			case 5:
				TEXT_LABEL_ASSIGN_STRING(&unk, "JHP1A_ABAN", 24);
				break;
		
			case 0:
			default:
				TEXT_LABEL_ASSIGN_STRING(&unk, "JHP1A_FF", 24);
				break;
		}
	
		if (MISC::IS_STRING_NULL_OR_EMPTY(&unk7))
			func_314(&unk);
		else
			func_305(&unk, &unk7);
...
void func_305(const char* sParam0, const char* sParam1) // Position - 0x17EAF Hash - 0xB976F0ED ^0xB976F0ED
{
	func_313(sParam0, sParam1);
	_TRIGGER_MISSION_FAIL(0);
	return;
}

void _TRIGGER_MISSION_FAIL(int iParam0) // Position - 0x17EC4 Hash - 0x2E198DBD ^0xE0E1C260
{
	int num;
...
BOOL func_307(int iParam0) // Position - 0x17F09 Hash - 0x9665C8BC ^0x4EE2CF72
{
	int num;
	eCharacter character;
	...
	func_311(character, true);
	PLAYER::SPECIAL_ABILITY_CHARGE_ON_MISSION_FAILED(PLAYER::PLAYER_ID(), 0);
	PLAYER::SPECIAL_ABILITY_DEACTIVATE(PLAYER::PLAYER_ID(), 0);
	func_308(&(Global_114370.f_2366.f_539), character);
...
void func_308(var uParam0, eCharacter echParam1) // Position - 0x1801A Hash - 0x604FE9F ^0x604FE9F
{
	int i;
	eCharacter character;
	var unk;
	...
	for (i = 0; i < 3; i = i + 1)
	{
		...
		else
		{
			...
			if (!func_310(Global_114370.f_18536[i], &unk, &num))
			{
				Global_114370.f_18536[i] = 318;
				func_309(&uParam0->f_2296[i]);
...
void func_309(var uParam0) // Position - 0x181E0 Hash - 0xEE73B491 ^0xBDB3BDC2
{
	*uParam0 = -15;
	return;
}

BOOL func_310(eCharacter echParam0, var uParam1, var uParam2) // Position - 0x181EE Hash - 0x6BF2FA05 ^0x6BF2FA05
{
	switch (echParam0)
	{
		...
		case CHAR_MIKE_TREV_CONF:
			return func_310(CHAR_MIKE_FRANK_CONF, uParam1, uParam2);
...
void func_311(eCharacter echParam0, BOOL bParam1) // Position - 0x18B5D Hash - 0x2E8A8CC9 ^0x2E8A8CC9
{
	if (bParam1)
...
void func_312() // Position - 0x18B9B Hash - 0xA374022B ^0xCC1E257F
{
	Global_101427 = 1;
...
void func_313(const char* sParam0, const char* sParam1) // Position - 0x18C88 Hash - 0xFD6A2DD0 ^0xF8FEA40C
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
		if (HUD::GET_LENGTH_OF_LITERAL_STRING(sParam0) <= 16)
		{
			if (HUD::GET_LENGTH_OF_LITERAL_STRING(sParam1) <= 16)
			{
				...
				TEXT_LABEL_ASSIGN_STRING(&Global_79485, sParam1, 16);
			}
		}
	}
...
void func_314(const char* sParam0) // Position - 0x18CC6 Hash - 0x60B9B067 ^0x60B9B067
{
	func_315(sParam0);
	_TRIGGER_MISSION_FAIL(0);
	return;
...
void func_315(const char* sParam0) // Position - 0x18CD9 Hash - 0x7A7E68B9 ^0xF1223ACA
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
		if (HUD::GET_LENGTH_OF_LITERAL_STRING(sParam0) <= 16)
...
void func_316() // Position - 0x18D18 Hash - 0x56F5D62B ^0xDF02657B
{
	int num;
...
BOOL func_317() // Position - 0x18D89 Hash - 0x25806CBF ^0x25806CBF
{
	if (Global_101392 == 13 || Global_101392 == 10 || Global_101392 == 11 || Global_101392 == 12)
		return false;
