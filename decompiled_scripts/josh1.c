...
void main() // Position - 0x0 Hash - 0x5D84F89F ^0x5D84F89F
{
	...
	fLocal_30 = 180f;
	iLocal_33 = 3;
	iLocal_78 = func_351(CHAR_JOSH);
	hLocal_79 = joaat("felon2");
	uLocal_148 = { -1106.999f, 288.96f, 63.4f };
	uLocal_151 = { 0f, 0f, 12.06f };
	...
	{
		func_348("Force cleanup [TERMINATING]");
		func_329(true);
		func_315();
	}
	...
	if (_IS_MISSION_REPLAY_IN_PROGRESS())
	{
		...
		while (!func_302(&uLocal_81))
		{
			SYSTEM::WAIT(0);
		}
	
		func_301(&uLocal_81, false, true);
		Global_79494 = false;
	}

	if (func_300(PLAYER::PLAYER_PED_ID()))
		hLocal_326 = PED::GET_PED_RELATIONSHIP_GROUP_HASH(PLAYER::PLAYER_PED_ID());

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_81.f_28[0]))
	{
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_81.f_28[0], hLocal_326);
	...
	while (true)
	{
		...
		SYSTEM::WAIT(0);
		func_283(uLocal_81.f_9, 0, 0, 0, 0, 0);
...
void func_1() // Position - 0x17C Hash - 0xBBA0D7E2 ^0x2E9B9855
{
	switch (iLocal_143)
	{
		case 0:
			_DEBUG_PRINT("Doing setup for leadout");
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED("rcmjosh1leadinout") && STREAMING::HAS_MODEL_LOADED(joaat("p_amb_phone_01")))
			{
				if (!ENTITY::DOES_ENTITY_EXIST(obLocal_145))
				{
					...
					obLocal_145 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), true, false, true);
				}
		...
		case 1:
			if (iLocal_156 == 1)
			{
				_DEBUG_PRINT("Skip detected, waiting 500ms...");
			
				if (MISC::GET_GAME_TIMER() - iLocal_157 >= 500)
				{
					func_236(1, 1, 1);
					iLocal_156 = 0;
				}
			...
			if (!bLocal_158)
			{
				if (func_300(uLocal_81.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(obLocal_145))
				{
					iLocal_147 = PED::CREATE_SYNCHRONIZED_SCENE(uLocal_148, uLocal_151, 2);
					TASK::TASK_SYNCHRONIZED_SCENE(uLocal_81.f_28[0], iLocal_147, "rcmjosh1leadinout", "leadout_josh", 8f, -4f, 27, 0, 1000f, 16);
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(obLocal_145, iLocal_147, "leadout_gate", "rcmjosh1leadinout", 8f, 1090519040, 0, 1148846080);
					ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(obLocal_145);
					PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(uLocal_81.f_28[0], true, false);
					_DEBUG_PRINT("Done Josh leadout anim");
					bLocal_158 = true;
				}
			}
			else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_147))
			{
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_147) > 0.29f)
				{
					if (!bLocal_159)
					{
						_CONVERSATION_INITIALIZE_ACTOR(&uLocal_161, 2, PLAYER::PLAYER_PED_ID(), "Trevor", 0, 1);
						_CONVERSATION_INITIALIZE_ACTOR(&uLocal_161, 5, uLocal_81.f_28[0], "Josh", 0, 1);
					
						if (_CONVERSATION_ADD_LINE(&uLocal_161, "JOSH1AU", "JOSH1_OUT", 8, 0, 0, 0))
						{
							_DEBUG_PRINT("Leadout convo done");
							bLocal_159 = true;
						}
					}
				}
				...
				{
					_DEBUG_PRINT("Leadout done, end mission");
					iLocal_143 = 2;
				}
				...
				{
					_DEBUG_PRINT("Too close, stopping scene");
				
					if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_81.f_28[0]))
					{
						TASK::CLEAR_PED_TASKS(uLocal_81.f_28[0]);
						_DEBUG_PRINT("Stopping Josh?");
					}
				
					if (ENTITY::DOES_ENTITY_EXIST(obLocal_145))
						ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(obLocal_145, -8f, true);
				
					iLocal_160 = 1;
				}
			
				if (func_219(uLocal_81.f_28[0], PLAYER::PLAYER_PED_ID(), true) > 17.5f)
				{
					if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_81.f_28[0]))
					{
						ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(uLocal_81.f_28[0], -8f, true);
						TASK::CLEAR_PED_TASKS(uLocal_81.f_28[0]);
					}
				...
				if (PED::IS_PED_INJURED(uLocal_81.f_28[0]) || FIRE::IS_ENTITY_ON_FIRE(uLocal_81.f_28[0]) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(uLocal_81.f_28[0], true), 5f))
				{
					if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_81.f_28[0]))
					{
						ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(uLocal_81.f_28[0], -8f, true);
			...
			{
				_DEBUG_PRINT("Leadout ended early, end mission");
				iLocal_143 = 2;
			}
			break;
	
		case 2:
			func_301(&uLocal_81, false, false);
			...
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_81.f_28[0]))
			{
				if (iLocal_160 == 1)
				{
					...
					TASK::TASK_PLAY_ANIM(0, "rcmjosh1@impatient", "enter", 1090519040, -1056964608, -1, 0, 0, false, false, false);
					TASK::TASK_PLAY_ANIM(0, "rcmjosh1@impatient", "idle_b", 1090519040, -1056964608, -1, 1, 0, false, false, false);
				...
				TASK::TASK_PERFORM_SEQUENCE(uLocal_81.f_28[0], iLocal_144);
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_144);
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_81.f_28[0], false);
			
				if (iLocal_160 == 0)
					PED::FORCE_PED_MOTION_STATE(uLocal_81.f_28[0], joaat("MotionState_Walk"), false, 0, true);
			}
			...
			if (iLocal_160 == 0)
			{
				...
				_DEBUG_PRINT("Josh 4: PROP_LRGGATE_01c_L - Closed");
			}
...
void func_2() // Position - 0x63C Hash - 0xCA629275 ^0xFFCB07BE
{
	func_210(58, 2, true);

	while (!func_207(-1816533207, 0, 4, 58, 6000, 6000, 65, 0, -1, 17, 1))
	{
		SYSTEM::WAIT(0);
	}
...
void func_3(int iParam0, BOOL bParam1) // Position - 0x67E Hash - 0x3FCC5D82 ^0x93BAFA48
{
	int num;
	var unk;
...
int func_4() // Position - 0x7B2 Hash - 0x9482CBBF ^0x8B17A994
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x7FD Hash - 0x15889021 ^0xE7262364
{
...
void func_6(int iParam0, int iParam1, int iParam2) // Position - 0x825 Hash - 0xEC2439E7 ^0x1B67A713
{
	BOOL flag;
...
void func_7() // Position - 0x90B Hash - 0x9F269E94 ^0x9F269E94
{
	int num;
	float num2;
	float num3;
...
int func_8() // Position - 0xDC9 Hash - 0x21D64237 ^0x21D64237
{
	return Global_32828;
}

BOOL func_9(int iParam0, int iParam1) // Position - 0xDD4 Hash - 0x77E0C72A ^0x80DA2A54
{
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0xE25 Hash - 0xCF91FBA1 ^0xAE1D9C41
{
	if (iParam2 == -1)
		iParam2 = func_11();
...
int func_11() // Position - 0xE43 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1574925;
}

void func_12() // Position - 0xE4F Hash - 0x21D73E90 ^0xBFBA56A9
{
	func_29();
	func_21();
	func_17();
...
void func_13(int iParam0) // Position - 0xEA8 Hash - 0x7BC1D73E ^0x69FC312C
{
	if (iParam0 == 1)
...
void func_14() // Position - 0xED1 Hash - 0x2D183413 ^0x53DF279A
{
...
void func_15() // Position - 0xEEF Hash - 0xDE5D7F64 ^0x592D09DF
{
...
void func_16() // Position - 0xF0B Hash - 0x6D3C3E0B ^0x29698AD2
{
	int i;
...
void func_17() // Position - 0xF30 Hash - 0x640F0DB2 ^0x6312FFED
{
	Global_101392 = 13;
	Global_101392.f_1 = -1;
	Global_101392.f_2 = 0;
...
void func_18() // Position - 0xF7F Hash - 0x9CDA93C5 ^0x9D13FE10
{
...
void func_19() // Position - 0xF9F Hash - 0x25C54BA4 ^0xBB7B0D50
{
...
void func_20(int iParam0) // Position - 0xFDD Hash - 0x42A5A26 ^0x42A5A26
{
	if (iParam0 == 1)
		Global_44471 = 1;
	else
...
void func_21() // Position - 0xFF6 Hash - 0xB32E3D0E ^0xB32E3D0E
{
	func_22(&Global_107917);
	return;
}

void func_22(int iParam0) // Position - 0x1006 Hash - 0x6B1DFD44 ^0x8A9E401E
{
	int i;
	int j;
...
void func_23(var uParam0) // Position - 0x1596 Hash - 0xF73DF469 ^0x8FEB8393
{
	*uParam0 = -1;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_24(var uParam0) // Position - 0x15B1 Hash - 0xCD56C133 ^0xC692BD1A
{
...
void func_25(var uParam0) // Position - 0x15E0 Hash - 0xB95AF921 ^0x4DC7C61C
{
	int i;
...
void func_26(var uParam0) // Position - 0x1691 Hash - 0x69C08C2 ^0x2D922D7C
{
	*uParam0 = { 0f, 0f, 0f };
	uParam0->f_3 = 0f;
	uParam0->f_4 = 0;
...
void func_27(var uParam0) // Position - 0x16AF Hash - 0x723850B4 ^0xE9C4F6A8
{
	int i;
...
void func_28(var uParam0) // Position - 0x1790 Hash - 0xEE73B491 ^0xBDB3BDC2
{
	*uParam0 = -15;
	return;
}

void func_29() // Position - 0x179E Hash - 0x38EA79BE ^0xF2FFC8B2
{
...
void func_30() // Position - 0x17B8 Hash - 0xC6C55AD9 ^0xC6C55AD9
{
...
void func_31() // Position - 0x1835 Hash - 0x199B5FA7 ^0xB0F19AB8
{
	int i;
	Ped ped;
...
BOOL func_32(Ped pedParam0, ePedComponentType epctParam1, ePedComponentType epctParam2) // Position - 0x18F6 Hash - 0x42ECC7CD ^0x7567053A
{
	Hash entityModel;
	ePedComponentType i;
	var unk;
...
BOOL func_33(Ped pedParam0, Hash hParam1, var uParam2) // Position - 0x1AB3 Hash - 0xA81FB6AC ^0x11DBFE4A
{
	int num;
...
int func_34(Hash hParam0) // Position - 0x1B54 Hash - 0x389E0506 ^0x389E0506
{
	switch (hParam0)
	{
...
int func_35(Ped pedParam0, int iParam1, ePedComponentType epctParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x1B8F Hash - 0x2F89DA4B ^0xC114075C
{
	int i;
	int j;
	int k;
...
void func_36(Hash hParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x23A0 Hash - 0x193E1C5C ^0xBF5A02F8
{
	ePedComponentType type;
	int num;
...
BOOL func_37(Hash hParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x242A Hash - 0x2BE7FB4 ^0x1D60B8BA
{
	if (hParam0 == joaat("Player_Zero"))
		if (iParam1 == 4)
...
BOOL func_38(Hash hParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x2508 Hash - 0xCA8B24F3 ^0x4C678A52
{
	Global_79031[1 /*14*/] = { func_85(hParam0, iParam1, epctParam2, -1) };
	return IS_BIT_SET(Global_79031[1 /*14*/].f_6, 2);
}

BOOL func_39(Hash hParam0, ePedComponentType epctParam1, int iParam2, ePedComponentType epctParam3, var uParam4, int iParam5) // Position - 0x2530 Hash - 0x4EAC6644 ^0x84ED5CC8
{
	var unk;
	int i;
...
BOOL func_40(Hash hParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x2B34 Hash - 0x1194ADFB ^0x1194ADFB
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
ePedComponentType func_41(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0x2BCD Hash - 0x6AEB8E24 ^0x393FEB8F
{
	ePedComponentType i;
	ePedComponentType j;
...
int func_42(Hash hParam0, int iParam1, ePedComponentType epctParam2, var uParam3) // Position - 0x2C6E Hash - 0x66694B65 ^0x9B4A4885
{
	int num;
...
ePedComponentType func_43(Ped pedParam0, Hash hParam1, int iParam2, ePedComponentType epctParam3, int iParam4, int iParam5) // Position - 0x2F75 Hash - 0x13FAC17C ^0xAC271D21
{
	ePedComponentType type;
	ePedComponentType type2;
	ePedComponentType type3;
...
BOOL func_44(int iParam0, ePedComponentType epctParam1, ePedComponentType epctParam2, ePedComponentType epctParam3, var uParam4) // Position - 0x3B28 Hash - 0x9B2DB9BF ^0x887A15B9
{
	int num;
...
ePedComponentType func_45(Hash hParam0, ePedComponentType epctParam1, ePedComponentType epctParam2, int iParam3) // Position - 0x3E0C Hash - 0x243669A7 ^0x243669A7
{
	int num;
...
ePedComponentType func_46(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x40D5 Hash - 0x836A6BCB ^0x1BDA295A
{
	ePedComponentType i;
	ePedComponentType type;
...
BOOL func_47(Ped pedParam0, int iParam1, ePedComponentType epctParam2, ePedComponentType epctParam3) // Position - 0x410C Hash - 0x181F6657 ^0x181F6657
{
	ePedComponentType type;
...
BOOL func_48(Hash hParam0, ePedComponentType epctParam1, var uParam2) // Position - 0x4135 Hash - 0x9FD3CF97 ^0x79A65971
{
	*uParam2 = -99;
...
int func_49(Hash hParam0, int iParam1, ePedComponentType epctParam2, var uParam3) // Position - 0x43FF Hash - 0x6C977D30 ^0xDCB1D2AD
{
	int num;
...
ePedComponentType func_50(Hash hParam0, ePedComponentType epctParam1, ePedComponentType epctParam2) // Position - 0x4689 Hash - 0x678DE6D2 ^0x678DE6D2
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
void func_51(Ped pedParam0, ePedComponentType epctParam1, ePedComponentType epctParam2, ePedComponentType epctParam3) // Position - 0x47E0 Hash - 0x64D2154E ^0x9C1670D6
{
	ePedComponentType type;
...
BOOL func_52(Hash hParam0, int iParam1, ePedComponentType epctParam2, Hash hParam3) // Position - 0x487A Hash - 0xC42704DB ^0xC42704DB
{
	switch (hParam0)
	{
...
Hash func_53(Hash hParam0, ePedComponentType epctParam1, int iParam2, int iParam3) // Position - 0x4948 Hash - 0x3B4EF0B2 ^0x11322F71
{
	var outProp;
	int componentId;
	int num;
...
int func_54(Hash hParam0, int iParam1) // Position - 0x4A62 Hash - 0x765E2190 ^0x765E2190
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_55(Hash hParam0) // Position - 0x4E09 Hash - 0xC0824942 ^0x8EB5258
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
ePedComponentType func_56(Ped pedParam0, ePedComponentType epctParam1, ePedComponentType epctParam2, ePedComponentType epctParam3) // Position - 0x4E6A Hash - 0x3F809B31 ^0x8E48393
{
	Hash entityModel;
...
int func_57(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x4F66 Hash - 0xB8AC6F7F ^0x2249C2B3
{
	Hash entityModel;
...
int func_58(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x50A4 Hash - 0x37A3B7AE ^0x8CDB7FD1
{
	var outfit;
	int i;
	int num;
...
int func_59(Hash hParam0) // Position - 0x515F Hash - 0x3694542E ^0xA74289BE
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_60(ePedComponentType epctParam0) // Position - 0x51BE Hash - 0xEE599357 ^0xEE599357
{
	switch (epctParam0)
	{
		case PV_COMP_HEAD:
...
BOOL func_61(Hash hParam0, int iParam1, ePedComponentType epctParam2, Hash hParam3) // Position - 0x5244 Hash - 0xCC83E9BC ^0xCC83E9BC
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_62(Hash hParam0, int iParam1, ePedComponentType epctParam2, Hash hParam3) // Position - 0x54C1 Hash - 0x261C127A ^0x57548E07
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_63(Hash hParam0, int iParam1, ePedComponentType epctParam2, Hash hParam3) // Position - 0x58E6 Hash - 0xAC33D304 ^0xAC33D304
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
ePedComponentType func_64(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x5BD9 Hash - 0xA9FF3076 ^0xC030B76B
{
	int pedPropIndex;
...
ePedComponentType func_65(Ped pedParam0, int iParam1) // Position - 0x5C20 Hash - 0x5DC76C2F ^0x122A4DD3
{
...
int func_66(Ped pedParam0, int iParam1, int iParam2, int iParam3) // Position - 0x5C80 Hash - 0x8F4AAD60 ^0xD2AF7F3D
{
	ePedComponentType componentId;
...
void func_67(int iParam0) // Position - 0x5CD7 Hash - 0xE5A1F74D ^0x61D497DD
{
...
void func_68(ePedComponentType epctParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x5D83 Hash - 0x302FBF28 ^0x92BCD54A
{
	int num;
	int offset;
	int num2;
...
void func_69(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x5DCB Hash - 0x99A9B13C ^0x9ABF46
{
	Hash statName;
...
Hash func_70(int iParam0, int iParam1) // Position - 0x5DF9 Hash - 0x505A9F99 ^0x8B00E935
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_71(iParam1));
}

int func_71(int iParam0) // Position - 0x5E0E Hash - 0x1A3F3220 ^0x1A3F3220
{
	int num;
	int num2;
...
int func_72(int iParam0, int iParam1) // Position - 0x5E42 Hash - 0x744E461C ^0x94D7C845
{
	Hash statHash;
	int outValue;
...
BOOL func_73(ePedComponentType epctParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x5E71 Hash - 0x1B8A3878 ^0xAE12BCDE
{
	...
	switch (iParam1)
	{
		...
		case 2:
			switch (SYSTEM::FLOOR(SYSTEM::TO_FLOAT(fmMaleShopPedApparelItemIndex) / 32f))
			{
				...
				case 23:
					*uParam2 = &_IS_MISSION_REPEAT_ACTIVE;
					break;
...
BOOL func_74(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x8960 Hash - 0xDF4F0B01 ^0xAAD287D4
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
BOOL func_75(int iParam0) // Position - 0x9803 Hash - 0x972D67C7 ^0x6B327493
{
	if (!IS_BIT_SET(Global_79031[1 /*14*/].f_6, 0))
		return false;
...
BOOL func_76(Ped pedParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x984B Hash - 0x490228A8 ^0xCA034CC2
{
	int num;
...
ePedComponentType func_77(ePedComponentType epctParam0) // Position - 0x98F6 Hash - 0xF91DA7A7 ^0xF91DA7A7
{
	switch (epctParam0)
	{
		case 0:
...
struct<10> func_78(Hash hParam0, ePedComponentType epctParam1) // Position - 0x99A6 Hash - 0x2A30F768 ^0x18171033
{
	int i;
	var unk;
...
void func_79(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0xA2D5 Hash - 0xE5FA3D79 ^0xC01023AA
{
	int num;
	Hash itemHash;
	Hash outPropVariant;
...
void func_80(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0xA3FF Hash - 0xF7320378 ^0xF7320378
{
	uParam0->[0] = iParam1;
	uParam0->[1] = iParam2;
	uParam0->[2] = iParam3;
...
struct<17> func_81(Hash hParam0, ePedComponentType epctParam1) // Position - 0xA447 Hash - 0x10D20E1D ^0x38BDAFC5
{
	int i;
	var unk;
...
void func_82(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0xC290 Hash - 0xD805D094 ^0x25EDFC78
{
	int num;
	Hash outfit;
...
int func_83(int iParam0) // Position - 0xC47A Hash - 0xF91DA7A7 ^0xF91DA7A7
{
	switch (iParam0)
	{
		case 0:
...
void func_84(var uParam0, int iParam1, int iParam2, ePedComponentType epctParam3, ePedComponentType epctParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0xC52A Hash - 0xEC425A3E ^0xEC425A3E
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
...
struct<14> func_85(Hash hParam0, ePedComponentType epctParam1, ePedComponentType epctParam2, int iParam3) // Position - 0xC59B Hash - 0x7D5AC326 ^0xB460D68E
{
	func_149();
...
void func_86(int iParam0, int iParam1) // Position - 0xC5ED Hash - 0x2A09B983 ^0x2A09B983
{
	switch (iParam0)
	{
		case 0:
...
void func_87(int iParam0) // Position - 0xC6DD Hash - 0x3D2B806B ^0xAC333F0A
{
	BOOL flag;
	int num;
	var unk;
...
void func_88(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0xD954 Hash - 0xA2DFD38C ^0xCA7EA132
{
	int num;
	int num2;
...
BOOL func_89(int iParam0, int iParam1, var uParam2) // Position - 0xDCF6 Hash - 0x805F0D09 ^0xD5FF8259
{
	*uParam2 = 979;
...
int func_90(int iParam0, int iParam1) // Position - 0xE0FB Hash - 0x4CEDF2DA ^0xD4A47B95
{
	switch (iParam1)
	{
		case 0:
...
int func_91(int iParam0, int iParam1) // Position - 0xE4F6 Hash - 0x4CEDF2DA ^0x7536052F
{
	switch (iParam1)
	{
		case 0:
...
BOOL func_92(ePedComponentType epctParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xE8F1 Hash - 0x8D68F96D ^0x8D68F96D
{
	int num;
	int num2;
	int num3;
...
BOOL func_93(int iParam0) // Position - 0xE92F Hash - 0x937D8816 ^0x937D8816
{
	return Global_43922 == iParam0;
}

int func_94(int iParam0) // Position - 0xE93D Hash - 0xE4C61EBD ^0xE4C61EBD
{
	switch (iParam0)
	{
		case -1:
...
void func_95(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0xEA11 Hash - 0xE3509264 ^0xCA79B364
{
	int num;
	int num2;
	Hash outfit;
...
void func_96(int iParam0) // Position - 0xEC98 Hash - 0xE86AB6A5 ^0x4D749723
{
	BOOL flag;
	int num;
	var unk;
...
void func_97(int iParam0) // Position - 0xEDEF Hash - 0x7D56211F ^0x77616D19
{
	BOOL flag;
	int num;
	var unk;
...
void func_98(int iParam0) // Position - 0xF2FD Hash - 0x2A6B1214 ^0xDBF14C07
{
	BOOL flag;
	int num;
	var unk;
...
void func_99(int iParam0) // Position - 0xF372 Hash - 0xC574A0D9 ^0x296D7514
{
	BOOL flag;
	int num;
	var unk;
...
void func_100(int iParam0) // Position - 0xF3E6 Hash - 0xC290E725 ^0x6FA2EDB
{
	BOOL flag;
	int num;
	var unk;
...
void func_101(int iParam0) // Position - 0xF4CD Hash - 0x7C005293 ^0x42E3721E
{
	BOOL flag;
	int num;
	var unk;
...
void func_102(int iParam0) // Position - 0xF830 Hash - 0xF13F6389 ^0x671FC57B
{
	BOOL flag;
	int num;
	var unk;
...
void func_103(int iParam0) // Position - 0xFA41 Hash - 0xDDFE7744 ^0x717E4CA0
{
	BOOL flag;
	int num;
	var unk;
...
void func_104(int iParam0) // Position - 0xFC71 Hash - 0xE02531F3 ^0xDC1C975
{
	BOOL flag;
	int num;
	var unk;
...
void func_105(int iParam0) // Position - 0xFD81 Hash - 0xEF2456FB ^0x6176A26E
{
	BOOL flag;
	int num;
	var unk;
...
void func_106(int iParam0) // Position - 0x10722 Hash - 0xD968CB7E ^0xC883993B
{
	BOOL flag;
	int num;
	var unk;
...
void func_107(int iParam0) // Position - 0x11295 Hash - 0x2732DFB2 ^0x9C99461
{
	if (iParam0 < 136)
		func_109(iParam0);
	else
...
void func_108(int iParam0) // Position - 0x112CA Hash - 0x7B542CFB ^0x70B6BD31
{
	BOOL flag;
	int num;
	var unk;
...
void func_109(int iParam0) // Position - 0x11ECE Hash - 0x7B542CFB ^0xF9047132
{
	BOOL flag;
	int num;
	var unk;
...
void func_110(int iParam0) // Position - 0x12DDC Hash - 0xC2F9B35A ^0x790FAF10
{
	BOOL flag;
	int num;
	var unk;
...
void func_111(int iParam0) // Position - 0x12F09 Hash - 0x6F21AA63 ^0xEFDF79B6
{
	BOOL flag;
	int num;
	var unk;
...
void func_112(int iParam0, int iParam1) // Position - 0x13007 Hash - 0x2A09B983 ^0x2A09B983
{
	switch (iParam0)
	{
		case 0:
...
void func_113(int iParam0) // Position - 0x130F7 Hash - 0xF89A8F55 ^0x5B50F02E
{
	BOOL flag;
	int num;
	var unk;
...
void func_114(int iParam0) // Position - 0x145E9 Hash - 0xB52E315 ^0x215C5558
{
	BOOL flag;
	int num;
	var unk;
...
void func_115(int iParam0) // Position - 0x1473A Hash - 0x4B9467AD ^0x774743B6
{
	BOOL flag;
	int num;
	var unk;
...
void func_116(int iParam0) // Position - 0x14C45 Hash - 0x7A2850A5 ^0x7B64A716
{
	BOOL flag;
	int num;
	var unk;
...
void func_117(int iParam0) // Position - 0x152B3 Hash - 0x8F4A4D12 ^0xF916648D
{
	BOOL flag;
	int num;
	var unk;
...
void func_118(int iParam0) // Position - 0x15327 Hash - 0xCB73BC76 ^0x832135AE
{
	BOOL flag;
	int num;
	var unk;
...
void func_119(int iParam0) // Position - 0x153F7 Hash - 0x27512C31 ^0x5C61D26D
{
	BOOL flag;
	int num;
	var unk;
...
void func_120(int iParam0) // Position - 0x15927 Hash - 0xDD9ED658 ^0xF814F196
{
	BOOL flag;
	int num;
	var unk;
...
void func_121(int iParam0) // Position - 0x15ABE Hash - 0xE27765D3 ^0xDF6B42DD
{
	BOOL flag;
	int num;
	var unk;
...
void func_122(int iParam0) // Position - 0x162BC Hash - 0xA3AE1C2 ^0xBF83D3DC
{
	BOOL flag;
	int num;
	var unk;
...
void func_123(int iParam0) // Position - 0x163CC Hash - 0xE2721790 ^0x23DAE0B9
{
	BOOL flag;
	int num;
	var unk;
...
void func_124(int iParam0) // Position - 0x172F7 Hash - 0xBC068BE9 ^0x44DA70F5
{
	BOOL flag;
	int num;
	var unk;
...
void func_125(int iParam0) // Position - 0x17FB4 Hash - 0x905863CF ^0x4D59FCB8
{
	if (iParam0 < 107)
		func_128(iParam0);
	else if (iParam0 < 227)
...
void func_126(int iParam0) // Position - 0x17FFA Hash - 0xF49D8959 ^0x166D2BD5
{
	BOOL flag;
	int num;
	var unk;
...
void func_127(int iParam0) // Position - 0x18AA0 Hash - 0x6B1EB2DB ^0xA3E9422B
{
	BOOL flag;
	int num;
	var unk;
...
void func_128(int iParam0) // Position - 0x1988F Hash - 0x6B1EB2DB ^0xA54A1F4
{
	BOOL flag;
	int num;
	var unk;
...
void func_129(int iParam0) // Position - 0x1A4D8 Hash - 0xD1DB443F ^0xFC631351
{
	BOOL flag;
	int num;
	var unk;
...
void func_130(int iParam0) // Position - 0x1A751 Hash - 0x501F1CEE ^0xB3930749
{
	BOOL flag;
	int num;
	var unk;
...
void func_131(int iParam0, int iParam1) // Position - 0x1A897 Hash - 0x2A09B983 ^0x2A09B983
{
	switch (iParam0)
	{
		case 0:
...
void func_132(int iParam0) // Position - 0x1A987 Hash - 0x65772392 ^0x12029A09
{
	BOOL flag;
	int num;
	var unk;
...
void func_133(int iParam0) // Position - 0x1B711 Hash - 0x3B9C736A ^0xBAAD91F
{
	BOOL flag;
	int num;
	var unk;
...
void func_134(int iParam0) // Position - 0x1B88B Hash - 0x7AE9DF25 ^0x8BC892E6
{
	BOOL flag;
	int num;
	var unk;
...
void func_135(int iParam0) // Position - 0x1BE02 Hash - 0xD847BAA9 ^0x1EBB1BC9
{
	BOOL flag;
	int num;
	var unk;
...
void func_136(int iParam0) // Position - 0x1C32D Hash - 0x84875CF4 ^0x48FD9119
{
	BOOL flag;
	int num;
	var unk;
...
void func_137(int iParam0) // Position - 0x1C3A1 Hash - 0xBC3ED9F1 ^0xBFF87F8
{
	BOOL flag;
	int num;
	var unk;
...
void func_138(int iParam0) // Position - 0x1C471 Hash - 0x6BA8FE21 ^0x4C3EECF1
{
	BOOL flag;
	int num;
	var unk;
...
void func_139(int iParam0) // Position - 0x1C949 Hash - 0x2912A97A ^0xC8BCEE1C
{
	BOOL flag;
	int num;
	var unk;
...
void func_140(int iParam0) // Position - 0x1CBB2 Hash - 0xC1E4B88B ^0xDE51A4E4
{
	BOOL flag;
	int num;
	var unk;
...
void func_141(int iParam0) // Position - 0x1CE88 Hash - 0x3AEA7A34 ^0xEEED2D65
{
	BOOL flag;
	int num;
	var unk;
...
void func_142(int iParam0) // Position - 0x1D051 Hash - 0xE4934E8C ^0x54195450
{
	BOOL flag;
	int num;
	var unk;
...
void func_143(int iParam0) // Position - 0x1DBA5 Hash - 0xC75B5564 ^0x7CB5DD2A
{
	BOOL flag;
	int num;
	var unk;
...
void func_144(int iParam0) // Position - 0x1E7EF Hash - 0xA5A40372 ^0xCEFC4EDB
{
	if (iParam0 < 60)
		func_146(iParam0);
	else
...
void func_145(int iParam0) // Position - 0x1E824 Hash - 0x8425A109 ^0x4852D4F3
{
	BOOL flag;
	int num;
	var unk;
...
void func_146(int iParam0) // Position - 0x1F5C4 Hash - 0x8425A109 ^0xB0F856B9
{
	BOOL flag;
	int num;
	var unk;
...
void func_147(int iParam0) // Position - 0x1FC50 Hash - 0x646F46FD ^0x1A760B2B
{
	BOOL flag;
	int num;
	var unk;
...
void func_148(int iParam0) // Position - 0x1FD37 Hash - 0x17A3D842 ^0x1F1ED1C5
{
	BOOL flag;
	int num;
	var unk;
...
void func_149() // Position - 0x1FE35 Hash - 0xE5F61993 ^0xEFD41040
{
...
BOOL func_150(Ped pedParam0, ePedComponentType epctParam1, ePedComponentType epctParam2) // Position - 0x1FEAE Hash - 0x1B00EC8E ^0x386C7313
{
	Hash entityModel;
	ePedComponentType type;
	int i;
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x20108 Hash - 0xAC4E9801 ^0xB379A75F
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x20145 Hash - 0xADCB9755 ^0xADCB9755
{
...
Hash func_153(eCharacter echParam0) // Position - 0x2016A Hash - 0xE4CEEC2C ^0xE4CEEC2C
{
	return Global_2139[echParam0 /*29*/];
}

BOOL func_154(eCharacter echParam0) // Position - 0x20179 Hash - 0x8907F004 ^0x8907F004
{
	return echParam0 < CHAR_MULTIPLAYER;
}

void func_155(const char* sParam0, int iParam1) // Position - 0x20185 Hash - 0x2EC06FB2 ^0xEBDB73F8
{
...
int func_156() // Position - 0x201D6 Hash - 0x35BC7314 ^0x35BC7314
{
	func_157();
...
void func_157() // Position - 0x2021C Hash - 0xD1F2D853 ^0xF9F5FD4D
{
	eCharacter character;
...
struct<2> func_158(int iParam0) // Position - 0x20319 Hash - 0x323E6781 ^0x888C7DC2
{
	var unk;
	var unk3;
...
struct<2> func_159(int iParam0) // Position - 0x20351 Hash - 0x975AC8C9 ^0x6CC39450
{
	var unk;
...
void func_160(int iParam0, BOOL bParam1) // Position - 0x2079E Hash - 0x91747301 ^0x6F31F55
{
...
void func_161(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x207E8 Hash - 0xCD53339A ^0x850B1A98
{
...
void func_162(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x20885 Hash - 0x7B81EE40 ^0xF76D595D
{
	var unk;
	var unk33;
...
void func_163(const char* sParam0, Any anParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x208C4 Hash - 0xF9BCAC8 ^0xD12A7092
{
...
void func_164(int iParam0, var uParam1) // Position - 0x20909 Hash - 0x2D8E3F8 ^0xCF1651AA
{
	switch (iParam0)
	{
		case 0:
...
int func_166(int iParam0) // Position - 0x21BE1 Hash - 0xC999F6B2 ^0xC999F6B2
{
	switch (iParam0)
	{
		case 0:
...
void func_167(int iParam0) // Position - 0x21F27 Hash - 0xC0234809 ^0x4FD853DC
{
	Global_44473 = MISC::GET_GAME_TIMER() + iParam0;
	return;
}

void func_168() // Position - 0x21F39 Hash - 0xA8C971C ^0xCE7645F
{
	if (Global_98684)
	{
		func_157();
...
char* func_169(eCharacter echParam0) // Position - 0x21F6C Hash - 0x8856B050 ^0x25F9EB2E
{
	echParam0 = echParam0;
	return "";
}

void func_170() // Position - 0x21F7C Hash - 0x65F656DA ^0x37BB7DE5
{
	var textLabel;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x21FBF Hash - 0x4C81F065 ^0x79C65D03
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x21FD5 Hash - 0x4C81F065 ^0xB17A9745
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_173(int iParam0, int iParam1) // Position - 0x21FEB Hash - 0x53BDC649 ^0x53BDC649
{
...
void func_174() // Position - 0x21FFF Hash - 0xD5DFA716 ^0xD54995D4
{
	Global_79503 != 6;
...
void func_175(int iParam0) // Position - 0x22037 Hash - 0x995C9E2 ^0x995C9E2
{
	if (*iParam0 == -1)
		return;
...
void func_176(int iParam0, BOOL bParam1) // Position - 0x22074 Hash - 0x2A85F27B ^0x9DA29B9C
{
	var unk;
	int newsStory;
	BOOL flag;
...
int func_177(int iParam0) // Position - 0x221F2 Hash - 0x957CB64C ^0xEA59BAC2
{
	switch (iParam0)
	{
		case 0:
...
void func_178(int iParam0) // Position - 0x22579 Hash - 0xDDB71E45 ^0x3573EEDB
{
...
int func_179() // Position - 0x225AF Hash - 0xC3538935 ^0x25088A4A
{
	return Global_114370.f_10019.f_21 + Global_114370.f_18577.f_380;
}

void func_180(int iParam0, BOOL bParam1) // Position - 0x225CB Hash - 0xC86A28AA ^0xC86A28AA
{
	int num;
	int num2;
	int num3;
...
void func_181(int iParam0) // Position - 0x228EF Hash - 0xA7DEABE8 ^0x629FB868
{
...
void func_182(int iParam0) // Position - 0x22922 Hash - 0x477E672 ^0x477E672
{
	switch (iParam0)
	{
		case 30:
...
void func_183(int iParam0, BOOL bParam1) // Position - 0x22957 Hash - 0xF45B4890 ^0xF45B4890
{
	if (iParam0 == -1)
		return;
...
void func_184(int iParam0, int iParam1, BOOL bParam2) // Position - 0x229B4 Hash - 0xDEF0CB8B ^0x421AAE37
{
	if (iParam0 == -1)
		return;
...
BOOL func_185(int iParam0, int iParam1) // Position - 0x229EF Hash - 0x9EA0654 ^0x9EA0654
{
	if (iParam0 == -1)
		return false;
...
void func_186(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x22A0F Hash - 0xECB6BFBA ^0x4A87976F
{
	if (iParam0 != 198)
	{
		if (Global_79248)
...
void func_187(int iParam0, int iParam1) // Position - 0x22A67 Hash - 0xF488CE34 ^0x554DA851
{
	switch (iParam0)
	{
		case 12:
...
void func_188(int iParam0, BOOL bParam1) // Position - 0x22B50 Hash - 0xF0703301 ^0x756A9364
{
	if (bParam1)
...
BOOL func_189(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x22B79 Hash - 0x72F8706 ^0xBE0DD95D
{
	BOOL flag;
	int num;
	int num2;
...
BOOL func_190() // Position - 0x234DE Hash - 0x6134FBB2 ^0x82030B41
{
...
int func_191() // Position - 0x2350E Hash - 0x21D64237 ^0x21D64237
{
	return Global_32829;
}

int func_192(var uParam0, int iParam1) // Position - 0x23519 Hash - 0x5A2CB71 ^0xD57F379E
{
	int i;
...
int func_193(int iParam0) // Position - 0x26D58 Hash - 0xAA837AEF ^0xAA837AEF
{
	switch (iParam0)
	{
		case 46:
...
void func_194(int iParam0, BOOL bParam1) // Position - 0x26E47 Hash - 0x9EF3CEFE ^0x9EF3CEFE
{
	switch (iParam0)
	{
		case 46:
...
void func_195(int iParam0, BOOL bParam1) // Position - 0x26E98 Hash - 0x856D02E3 ^0xCCD7C4A8
{
	int offset;
...
void func_196(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x26EFE Hash - 0x2B872DAE ^0x4022D9A2
{
	func_197(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
	return;
}

void func_197(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x26F20 Hash - 0x7C3327C8 ^0x63BE699B
{
	int i;
...
void func_198() // Position - 0x270F4 Hash - 0xCF8881D1 ^0x40507183
{
	int i;
...
BOOL func_199(int iParam0) // Position - 0x2720B Hash - 0x3F44A899 ^0x7041C53
{
	int num;
	int i;
...
void func_200(char* sParam0) // Position - 0x2724B Hash - 0xB51D2EB3 ^0x4F57CE74
{
...
char* func_201(int iParam0) // Position - 0x27270 Hash - 0xE6862179 ^0x3CEB799
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_202(int iParam0) // Position - 0x27443 Hash - 0x156C351F ^0x156C351F
{
...
void func_203(int iParam0, int iParam1) // Position - 0x2746D Hash - 0xEFDF2B54 ^0x1CE7BA3B
{
...
BOOL func_204(const char* sParam0) // Position - 0x274AA Hash - 0xEC346BB4 ^0x86E03AE6
{
...
int func_205() // Position - 0x2750A Hash - 0x613FC6AD ^0xDC7835B3
{
	return func_206(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_206(const char* sParam0, int iParam1) // Position - 0x2751B Hash - 0x76A2E0AF ^0x8A5231BB
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL func_207(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10) // Position - 0x27564 Hash - 0x7F671285 ^0x7F671285
{
	int num;
	...
	if (Global_114370.f_7691.f_764 < CHAR_MIKE_FRANK_CONF)
	{
		...
		func_208(CHAR_MICHAEL);
		func_208(CHAR_FRANKLIN);
		func_208(CHAR_TREVOR);
		return true;
	}
...
void func_208(eCharacter echParam0) // Position - 0x2767C Hash - 0xDBA91FA2 ^0x62041168
{
	eCharacter i;
	int num;
	eCharacter j;
...
int func_209(int iParam0) // Position - 0x2773A Hash - 0x17C68833 ^0x17C68833
{
	switch (iParam0)
	{
		case 0:
...
void func_210(eCharacter echParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x277A4 Hash - 0x95F9A85C ^0xCFF8B9F9
{
	int num;
	...
	if (Global_118[echParam0 /*10*/].f_8 != 178)
	{
		...
		if (echParam1 == 4)
		{
			func_216(echParam0, 0, 1);
			func_216(echParam0, 1, 1);
			func_216(echParam0, 2, 1);
			func_215(echParam0, 0, 1);
			func_215(echParam0, 1, 1);
			func_215(echParam0, 2, 1);
		}
		else
		{
			if (func_214(echParam0, echParam1) == 1 && func_213(echParam0, echParam1) == 1)
				bParam2 = false;
		
			num = echParam1;
			func_216(echParam0, num, 1);
			func_215(echParam0, num, 1);
...
void func_211() // Position - 0x27922 Hash - 0x83496B34 ^0xB9E3F78F
{
	var txdName;
	var subject;
...
struct<4> _GET_CHARACTER_NAME(eCharacter character) // Position - 0x2799F Hash - 0x5D6A4A13 ^0x32291975
{
	return Global_2139[character /*29*/].f_3;
}

int func_213(eCharacter echParam0, int iParam1) // Position - 0x279B2 Hash - 0x97DCD8A1 ^0xF8178EDD
{
...
int func_214(eCharacter echParam0, int iParam1) // Position - 0x279DC Hash - 0x97DCD8A1 ^0x5A8D70D2
{
	if (iParam1 < 0 || iParam1 > 4)
		return 0;
...
void func_215(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x27A06 Hash - 0xAB9B6CC ^0x1B5EEB55
{
	if (iParam1 < 0 || iParam1 > 4)
		return;
...
void func_216(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x27A4B Hash - 0xAB9B6CC ^0x80AE0F15
{
	if (iParam1 < 0 || iParam1 > 4)
		return;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x27A90 Hash - 0x98476CE1 ^0x250FEB7C
{
	if (func_93(14))
	{
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x27B32 Hash - 0x3C5423D7 ^0x3C5423D7
{
	func_157();
	return Global_114370.f_2366.f_539.f_4321;
}

float func_219(Ped pedParam0, Ped pedParam1, BOOL bParam2) // Position - 0x27B4B Hash - 0x7B2C17A2 ^0xDF922C6D
{
...
BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x27BA9 Hash - 0x384540C1 ^0x384540C1
{
	...
	Global_23163 = 0;
	Global_2883585 = 0;
	return func_221(sParam2, iParam3, false);
}

BOOL func_221(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x27BF7 Hash - 0x77297D51 ^0x40DC584A
{
	Global_22167 = 0;
...
void func_222() // Position - 0x27EC5 Hash - 0xF42BEB19 ^0xA29557DA
{
	if (!func_223())
		return;
...
BOOL func_223() // Position - 0x27EFC Hash - 0x7B74B45F ^0xCE052A5D
{
...
BOOL func_224(Player plParam0) // Position - 0x27F5F Hash - 0x6E46BC72 ^0x6E46BC72
{
	return func_225(plParam0, 20);
}

BOOL func_225(Player plParam0, int iParam1) // Position - 0x27F6F Hash - 0x7CD5054C ^0x870BEA81
{
	return IS_BIT_SET(Global_1886967[plParam0 /*609*/].f_10.f_4, iParam1);
}

Player _INVALID_PLAYER_INDEX() // Position - 0x27F87 Hash - 0x478900E4 ^0x478900E4
{
	return -1;
}

void func_227() // Position - 0x27F90 Hash - 0xDB58E314 ^0xA65EDD2B
{
	int i;
...
void func_228() // Position - 0x27FC2 Hash - 0xCD8A4D28 ^0xCD8A4D28
{
...
BOOL func_229() // Position - 0x2805A Hash - 0xD140D54A ^0xE638D98F
{
...
BOOL func_230() // Position - 0x28081 Hash - 0x9A999369 ^0x4033F7BF
{
	int num;
	int weaponHash;
...
void func_231() // Position - 0x2811A Hash - 0xBE88A374 ^0xE25C066
{
	int i;
...
BOOL func_232(int iParam0, int iParam1) // Position - 0x28172 Hash - 0xA14C4D3F ^0xA6034F77
{
	switch (iParam0)
	{
		case 5:
...
void func_233() // Position - 0x281AA Hash - 0xE32CF1EF ^0xB9A7BEB2
{
...
void func_234(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x28201 Hash - 0xC6B752B2 ^0xC6B752B2
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x28257 Hash - 0x6C235EE0 ^0x9E57F206
{
...
void func_236(int iParam0, int iParam1, int iParam2) // Position - 0x282F2 Hash - 0x6642E4D8 ^0xFA541DE7
{
	func_238(0, 0, iParam2, true);
...
void func_237(int iParam0, BOOL bParam1) // Position - 0x28326 Hash - 0xE7B2CDD3 ^0xC2D0D6D9
{
...
void func_238(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x28362 Hash - 0xD5DA5E14 ^0x5BD94F24
{
	Player playerIndex;
	...
	func_239(false, true, false, false, false, false, false);
...
void func_239(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x2840C Hash - 0x787E640E ^0x67C15509
{
	if (bParam0)
	{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_244(PLAYER::PLAYER_ID()) && !func_241(PLAYER::PLAYER_ID(), 0) && !func_240() && !bParam4 && !bParam5 && !NETWORK::NETWORK_IS_IN_SPECTATOR_MODE())
...
BOOL func_240() // Position - 0x28559 Hash - 0xAA7793E3 ^0x3F62CDC8
{
	return IS_BIT_SET(Global_1845263[PLAYER::PLAYER_ID() /*877*/].f_36.f_18, 14);
}

BOOL func_241(Player plParam0, int iParam1) // Position - 0x28573 Hash - 0x1A32E11A ^0x6AADE226
{
	BOOL flag;

	if (!func_243(plParam0))
		return false;

	if (plParam0 == PLAYER::PLAYER_ID())
		flag = func_242(-1, false) == 8;
	else
...
int func_242(int iParam0, BOOL bParam1) // Position - 0x285CC Hash - 0x1DCD393E ^0x1DCD393E
{
	int num;
	int num2;
...
BOOL func_243(Player plParam0) // Position - 0x2860D Hash - 0x6A46C9B4 ^0x6A46C9B4
{
	Player player;
...
BOOL func_244(Player plParam0) // Position - 0x2862F Hash - 0x68897CDD ^0x62820466
{
	if (func_241(plParam0, 0))
		return true;
...
BOOL func_245() // Position - 0x2866E Hash - 0xA525B2F4 ^0xA525B2F4
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_246(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x2867C Hash - 0x3167F4C7 ^0xCE6B9B6A
{
	int num;
...
void func_247(int iParam0) // Position - 0x286AF Hash - 0x1B2EEE72 ^0xEDBC1F9D
{
	if (iParam0 == 1)
...
void _DEBUG_PRINT(char* sParam0) // Position - 0x286D2 Hash - 0x6EF28A6B ^0x6EF28A6B
{
	sParam0 = sParam0;
	return;
}

void func_249() // Position - 0x286DE Hash - 0x141AF9FB ^0xF1279C45
{
	...
	{
		_DEBUG_PRINT("Trying to set Josh component variation");
	
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_81.f_28[0]))
			CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED("Josh", uLocal_81.f_28[0], 0);
	}

	switch (iLocal_143)
	{
		case 0:
			if (func_265(1, 1093140480, 0))
			{
				STREAMING::REQUEST_ANIM_DICT("rcmjosh1@impatient");
				VEHICLE::REQUEST_VEHICLE_RECORDING(500, "Josh1Driveaway");
			
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_81.f_28[0]))
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_81.f_28[0], "Josh", 0, 0, 0);
				...
				if (func_264(playersLastVehicle))
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(playersLastVehicle, -1115.9844f, 285.59244f, 61.942406f, -1097.5992f, 285.1346f, 66.346695f, 33f, false, true, 0))
					{
						unk = { -1098.87f, 280.88f, 63.47f };
						num = 85.98f;
					}
					else
					{
				...
				if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), false))
				{
					_DEBUG_PRINT("Locked left gate open?");
					OBJECT::SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(joaat("prop_lrggate_01c_l"), -1107.01f, 289.38f, 64.76f, true, 90f, false);
				}
			
				func_254(-1115.9844f, 285.59244f, 61.942406f, -1097.5992f, 285.1346f, 66.346695f, 33f, unk, num, 3f, 6f, 3f, true, true, true, false, false);
				func_251(-1104.93f, 291.25f, 64.3f, 1, 1, 1, 1, 1, true, true, true, 1, true);
				iLocal_143 = 1;
			}
			break;
		...
		case 1:
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Trevor", 0))
			{
				...
				_DEBUG_PRINT("Done Trevor exit");
			}
		
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Josh", 0))
			{
				_DEBUG_PRINT("Exit state for Josh...");
			
				if (!bLocal_158)
				{
					_DEBUG_PRINT("Played lead-out on Josh exit state");
					func_250(PLAYER::PLAYER_PED_ID(), -1104.65f, 289.02f, 63.25f, 16.6717f, false, true);
					CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
					CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
					...
					{
						iLocal_147 = PED::CREATE_SYNCHRONIZED_SCENE(uLocal_148, uLocal_151, 2);
						TASK::TASK_SYNCHRONIZED_SCENE(uLocal_81.f_28[0], iLocal_147, "rcmjosh1leadinout", "leadout_josh", 1000f, -8f, 25, 0, 1000f, 16);
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(obLocal_145, iLocal_147, "leadout_gate", "rcmjosh1leadinout", 8f, 1090519040, 0, 1148846080);
						_DEBUG_PRINT("Done Josh leadout anim on Josh exit state");
						ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(obLocal_145);
						PED::FORCE_PED_MOTION_STATE(uLocal_81.f_28[0], joaat("MotionState_Idle"), false, 1, true);
						bLocal_158 = true;
					}
				}
			}
			...
			{
				_DEBUG_PRINT("Exit state for camera...");
			
				if (!bLocal_158)
				{
					_DEBUG_PRINT("Played lead-out on camera exit state");
					func_250(PLAYER::PLAYER_PED_ID(), -1104.65f, 289.02f, 63.25f, 16.6717f, false, true);
					CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
					CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
					...
					if (func_300(uLocal_81.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(obLocal_145))
					{
						...
						TASK::TASK_SYNCHRONIZED_SCENE(uLocal_81.f_28[0], iLocal_147, "rcmjosh1leadinout", "leadout_josh", 1000f, -8f, 25, 0, 1000f, 16);
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(obLocal_145, iLocal_147, "leadout_gate", "rcmjosh1leadinout", 8f, 1090519040, 0, 1148846080);
						_DEBUG_PRINT("Done Josh leadout anim on cam exit state cutscene");
						ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(obLocal_145);
						PED::FORCE_PED_MOTION_STATE(uLocal_81.f_28[0], joaat("MotionState_Idle"), false, 1, true);
						bLocal_158 = true;
					}
			...
			{
				_DEBUG_PRINT("cutscene not active...");
			
				if (!bLocal_158)
				{
					_DEBUG_PRINT("Played lead-out on not cutscene active");
					func_250(PLAYER::PLAYER_PED_ID(), -1104.65f, 289.02f, 63.25f, 16.6717f, false, true);
					CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
					CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
					...
					{
						iLocal_147 = PED::CREATE_SYNCHRONIZED_SCENE(uLocal_148, uLocal_151, 2);
						TASK::TASK_SYNCHRONIZED_SCENE(uLocal_81.f_28[0], iLocal_147, "rcmjosh1leadinout", "leadout_josh", 8f, -8f, 25, 0, 1000f, 16);
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(obLocal_145, iLocal_147, "leadout_gate", "rcmjosh1leadinout", 8f, 1090519040, 0, 1148846080);
						_DEBUG_PRINT("Done Josh leadout anim on non active cutscene");
						ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(obLocal_145);
						PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(uLocal_81.f_28[0], false, false);
						bLocal_158 = true;
					}
				}
...
BOOL func_250(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4, BOOL bParam5, BOOL bParam6) // Position - 0x28D65 Hash - 0x5FA2F2C9 ^0x1375335B
{
...
void func_251(float fParam0, float fParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, int iParam11, BOOL bParam12) // Position - 0x28DC1 Hash - 0x394D5546 ^0xF43EBD07
{
	Player playerIndex;
...
Vector3 _GET_PLAYER_COORDS(Player plParam0) // Position - 0x28F7F Hash - 0x6712BF53 ^0x688D5BEC
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(plParam0), false);
}

void func_253(BOOL bParam0) // Position - 0x28F92 Hash - 0xD10400C0 ^0xB6845444
{
	Player playerIndex;
	...
	func_239(true, true, false, false, false, false, false);
	return;
}

void func_254(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, var uParam7, var uParam8, var uParam9, float fParam10, float fParam11, float fParam12, float fParam13, BOOL bParam14, BOOL bParam15, BOOL bParam16, BOOL bParam17, BOOL bParam18) // Position - 0x28FD1 Hash - 0xC60077FB ^0xC60077FB
{
	func_255(fParam0, fParam3, fParam6, uParam7, fParam10, fParam11, bParam14, bParam15, bParam16, bParam17, bParam18);
	return;
}

void func_255(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5, float fParam6, Vector3 vParam7, var uParam8, var uParam9, float fParam10, float fParam11, var uParam12, var uParam13, BOOL bParam14, BOOL bParam15, BOOL bParam16, BOOL bParam17, BOOL bParam18) // Position - 0x28FFB Hash - 0xFD52326E ^0x1AB3EC4D
{
	Vehicle playersLastVehicle;
	BOOL flag;
	BOOL flag2;
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(playersLastVehicle, false))
		{
			...
			else
			{
				...
				if (entityCoords.f_2 > vParam0.f_2 && entityCoords.f_2 < vParam3.f_2 || entityCoords.f_2 > vParam3.f_2 && entityCoords.f_2 < vParam0.f_2)
					if (func_259(playersLastVehicle, vParam0, vParam3, fParam6))
						flag = true;
			}
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x293F1 Hash - 0x16E871AD ^0x10C54C39
{
...
BOOL func_257(Vehicle veParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x2941B Hash - 0xBCC62924 ^0x77695844
{
	int i;
	var garageName;
	int num;
...
BOOL func_258(eCharacter echParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x29489 Hash - 0x8E372EAA ^0xA0AFE448
{
...
BOOL func_259(Vehicle veParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7) // Position - 0x29562 Hash - 0x54559876 ^0xE4811CB1
{
	float num;
	var unk3;
	var unk6;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		if (func_260(unk18[0 /*3*/], unk18[1 /*3*/], unk6, unk9) || func_260(unk18[0 /*3*/], unk18[1 /*3*/], unk9, unk15) || func_260(unk18[0 /*3*/], unk18[1 /*3*/], unk12, unk15) || func_260(unk18[0 /*3*/], unk18[1 /*3*/], unk6, unk12) || func_260(unk18[1 /*3*/], unk18[3 /*3*/], unk6, unk9) || func_260(unk18[1 /*3*/], unk18[3 /*3*/], unk9, unk15) || func_260(unk18[1 /*3*/], unk18[3 /*3*/], unk12, unk15) || func_260(unk18[1 /*3*/], unk18[3 /*3*/], unk6, unk12) || func_260(unk18[3 /*3*/], unk18[2 /*3*/], unk6, unk9) || func_260(unk18[3 /*3*/], unk18[2 /*3*/], unk9, unk15) || func_260(unk18[3 /*3*/], unk18[2 /*3*/], unk12, unk15) || func_260(unk18[3 /*3*/], unk18[2 /*3*/], unk6, unk12) || func_260(unk18[2 /*3*/], unk18[0 /*3*/], unk6, unk9) || func_260(unk18[2 /*3*/], unk18[0 /*3*/], unk9, unk15) || func_260(unk18[2 /*3*/], unk18[0 /*3*/], unk12, unk15) || func_260(unk18[2 /*3*/], unk18[0 /*3*/], unk6, unk12))
			return true;
	}
...
BOOL func_260(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, float fParam9, var uParam10, var uParam11) // Position - 0x29858 Hash - 0x3823BB3 ^0xD0DFB98E
{
	float num;
	float num2;
	float num3;
...
Vector3 func_261(float fParam0, var uParam1, var uParam2) // Position - 0x2990C Hash - 0xFB6A39D2 ^0x80C9C759
{
	float num;
	float num2;
...
void func_262(Vehicle veParam0) // Position - 0x2994B Hash - 0xE71E0364 ^0xCB8720DC
{
...
void func_263() // Position - 0x299B0 Hash - 0x9F2F2451 ^0x9F2F2451
{
	int num;
...
BOOL func_264(Vehicle veParam0) // Position - 0x299D0 Hash - 0x7E47BB06 ^0x692E6B64
{
...
BOOL func_265(int iParam0, int iParam1, int iParam2) // Position - 0x299FA Hash - 0x45E861F0 ^0xB70C2EC3
{
	int num;
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		{
			if (!func_271(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), iParam1, 1, 1056964608, false, true, false))
			{
				num = 0;
			}
			else if (iParam2 == 1)
			{
				...
				if (!func_270(PLAYER::PLAYER_PED_ID(), SCRIPT_TASK_LEAVE_ANY_VEHICLE))
...
BOOL func_266() // Position - 0x29ACE Hash - 0x7E48580B ^0x77F2F890
{
...
void func_267() // Position - 0x29AF1 Hash - 0xC536DD5 ^0xC536DD5
{
	Global_21032 = 0;
	func_233();
	return;
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x29B01 Hash - 0x152DA0B2 ^0x220E93E9
{
...
void func_269() // Position - 0x29B23 Hash - 0x2A0AC5B7 ^0xAF27577A
{
...
BOOL func_270(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x29B74 Hash - 0x5CB13EA9 ^0x50B73240
{
	if (func_300(pedParam0))
...
BOOL func_271(Vehicle veParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x29BA7 Hash - 0xEF9D4F61 ^0xC848BDEA
{
	func_273(bParam5, bParam6);
	func_272(veParam0);
...
void func_272(Vehicle veParam0) // Position - 0x29BFE Hash - 0x94E8CB0B ^0x47923A23
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_273(BOOL bParam0, BOOL bParam1) // Position - 0x29C2A Hash - 0xC86614C6 ^0xCD39041A
{
...
void func_274() // Position - 0x29D7B Hash - 0xF5BBA48B ^0x583358AC
{
	func_275();
	...
	{
		case 0:
			if (!_IS_MISSION_REPEAT_ACTIVE(false) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1115.0707f, 279.6581f, 62.421844f, -1092.4285f, 284.13983f, 67.31652f, 15.75f, false, true, 0))
			{
			...
			{
				_DEBUG_PRINT("Skipping setup for leadin (wrong area)");
				STREAMING::REQUEST_ANIM_DICT("rcmjosh1leadinout");
			...
			if (!_IS_MISSION_REPEAT_ACTIVE(false))
			{
				if (!bLocal_154)
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1115.0707f, 279.6581f, 62.421844f, -1092.4285f, 284.13983f, 67.31652f, 15.75f, false, true, 0))
					{
						if (func_300(uLocal_81.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(obLocal_145))
						{
							iLocal_146 = PED::CREATE_SYNCHRONIZED_SCENE(uLocal_148, uLocal_151, 2);
							TASK::TASK_SYNCHRONIZED_SCENE(uLocal_81.f_28[0], iLocal_146, "rcmjosh1leadinout", "leadin_josh", 8f, -8f, 25, 0, 1148846080, 0);
							ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(obLocal_145, iLocal_146, "leadin_gate", "rcmjosh1leadinout", 8f, 1090519040, 0, 1148846080);
							TASK::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), uLocal_81.f_28[0], -1, 0, 2);
							TASK::TASK_LOOK_AT_ENTITY(uLocal_81.f_28[0], PLAYER::PLAYER_PED_ID(), 4000, SLF_EXTEND_YAW_LIMIT | 8 | 2048, 2);
					...
					{
						if (!_IS_MISSION_REPEAT_ACTIVE(false) && !bLocal_154)
						{
							_DEBUG_PRINT("Cannot play lead-in, re-requesting cutscene with new sections");
							CUTSCENE::REMOVE_CUTSCENE();
							CUTSCENE::REQUEST_CUTSCENE_WITH_PLAYBACK_LIST("JOSH_1_INT_CONCAT", 13, 8);
						}
					
						_DEBUG_PRINT("Replay in progress, skipping leadin");
						iLocal_143 = 2;
					}
				}
				else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_146))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_146) > 0.15f)
					{
						if (!bLocal_155)
						{
							if (_CONVERSATION_ADD_LINE(&uLocal_161, "JOSH1AU", "JOSH1_LEADIN", 8, 0, 0, 0))
							{
					...
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_146) > 0.9f)
					{
						_DEBUG_PRINT("Leadin anim done, launch cutscene");
						iLocal_143 = 2;
					}
				
					if (func_219(PLAYER::PLAYER_PED_ID(), uLocal_81.f_28[0], true) <= 2.5f)
					{
				...
				{
					_DEBUG_PRINT("Leadin not playing, launch cutscene");
					iLocal_143 = 2;
				}
			}
			else
...
void func_275() // Position - 0x2A10B Hash - 0xE60F63BE ^0xE60F63BE
{
	func_277(0);
	func_269();
	func_276();
...
void func_276() // Position - 0x2A120 Hash - 0xC95798F1 ^0x61ADB9D7
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			if (func_271(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 10.5f, 1, 1056964608, false, true, false))
...
void func_277(int iParam0) // Position - 0x2A178 Hash - 0x7E11E9C ^0x544BF257
{
	if (func_282())
		return;
...
void func_278(int iParam0) // Position - 0x2A1AB Hash - 0x4066FEF5 ^0x9787FBDA
{
	if (func_282())
		return;
...
void func_279(BOOL bParam0, BOOL bParam1) // Position - 0x2A235 Hash - 0xF40FC178 ^0xA6F60F17
{
	if (bParam0)
	{
		if (func_281(0))
...
BOOL func_280() // Position - 0x2A2A9 Hash - 0x8DF3D75D ^0x8DF3D75D
{
	return IS_BIT_SET(Global_1956030, 5);
}

BOOL func_281(int iParam0) // Position - 0x2A2B7 Hash - 0xE8921B44 ^0x4F063755
{
	if (iParam0 == 1)
		if (Global_20813.f_1 > 3)
...
BOOL func_282() // Position - 0x2A30E Hash - 0xC41437CB ^0xC41437CB
{
	return IS_BIT_SET(Global_1956030, 19);
}

void func_283(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10) // Position - 0x2A31D Hash - 0x91EBF9FE ^0x91EBF9FE
{
	float num;
	int value;
	int alpha;
	...
	if (Global_79503 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				text = { func_285(Global_79504, Global_79506, iParam10) };
				y == -0.014f;
...
float func_284(const char* sParam0) // Position - 0x2A602 Hash - 0x8E5AA519 ^0xD17CA0B4
{
	HUD::BEGIN_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(sParam0);
	return HUD::END_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(true);
}

struct<2> func_285(int iParam0, int iParam1, int iParam2) // Position - 0x2A615 Hash - 0x61DFCF06 ^0xBA974B11
{
	var unk;
	int num;
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (num)
			{
				...
				case 7:
					unk = { func_290(iParam2) };
					break;
			
				case 10:
					unk = { func_289(iParam2) };
					break;
			
				case 5:
					unk = { func_288(iParam2) };
					break;
			
				case 4:
					unk = { func_287(iParam2) };
					break;
			
				default:
					TEXT_LABEL_ASSIGN_STRING(&unk, func_286(num), 8);
					break;
			}
			break;
...
char* func_286(int iParam0) // Position - 0x2A6EC Hash - 0xE6862179 ^0xC8F08943
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_287(int iParam0) // Position - 0x2A83F Hash - 0x33B2BCB2 ^0x65B29404
{
	var unk;
	var unk3;
...
struct<2> func_288(int iParam0) // Position - 0x2A873 Hash - 0x33B2BCB2 ^0x9EC9FFB1
{
	var unk;
	var unk3;
...
struct<2> func_289(int iParam0) // Position - 0x2A8A7 Hash - 0x33B2BCB2 ^0x39D3A2CF
{
	var unk;
	var unk3;
...
struct<2> func_290(int iParam0) // Position - 0x2A8DB Hash - 0x33B2BCB2 ^0xC56C5A4E
{
	var unk;
	var unk3;
...
struct<2> func_291(int iParam0) // Position - 0x2A90F Hash - 0xCAEEFDDC ^0xF5CF9ACB
{
	var unk;
	var unk3;
...
struct<2> func_292(int iParam0) // Position - 0x2A94D Hash - 0x33B2BCB2 ^0x8B842CDA
{
	var unk;
	var unk3;
...
struct<2> func_293(int iParam0) // Position - 0x2A981 Hash - 0xD7A7FF9F ^0xACF5656F
{
	var unk;
...
BOOL func_294(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x2A9EA Hash - 0xBDE8E122 ^0x11134AEA
{
	if (!func_296(0) || Global_79519 || Global_79507 == 1 || !CAM::IS_SCREEN_FADED_IN())
		return false;
	...
	switch (Global_79503)
	{
		...
		case 5:
			if (CUTSCENE::IS_CUTSCENE_PLAYING() || func_281(0) || func_295(true))
			{
			}
			else
			{
...
BOOL func_295(BOOL bParam0) // Position - 0x2AB02 Hash - 0x1F743529 ^0xDFDFCA73
{
	if (bParam0)
...
BOOL func_296(int iParam0) // Position - 0x2AB2B Hash - 0x3BAB94E9 ^0x3BAB94E9
{
	if (Global_43922 == 15)
		return false;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0x2AB4D Hash - 0xECB6C71B ^0xECB6C71B
{
	return func_298(iParam0, Global_43922);
}

BOOL func_298(int iParam0, int iParam1) // Position - 0x2AB5E Hash - 0x1FD727E0 ^0x1FD727E0
{
	if (iParam1 == 15)
		return 1;
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0x2AD3F Hash - 0x3D210083 ^0xF7E7C389
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
		if (!ENTITY::IS_ENTITY_DEAD(pedParam0, false))
			return true;
...
BOOL func_300(Ped pedParam0) // Position - 0x2AD60 Hash - 0x7E48B415 ^0x126328AB
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam0))
		if (!PED::IS_PED_INJURED(pedParam0))
			return true;
...
void func_301(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2AD80 Hash - 0x50B95D9E ^0x1806B4C4
{
	int i;
...
BOOL func_302(var uParam0) // Position - 0x2AE75 Hash - 0x2BA3A0FA ^0xC7365863
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_77)
	{
		case 0:
			...
			uParam0->f_27 = 1;
			uParam0->f_15 = 9f;
			TEXT_LABEL_ASSIGN_STRING(&(uParam0->f_9), "JOSH_1_INT_CONCAT", 24);
			...
			func_313(&(uParam0->f_48), "rcmjosh1", "idle", 0);
			iLocal_77 = 1;
			break;
	
		case 1:
			if (!func_312(&num) || !func_310(&(uParam0->f_48)))
				return false;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				if (!func_307(&uParam0->f_28[0], CHAR_JOSH, -1104.72f, 291.02f, 64.39f, 138.35f, "JOSH LAUNCHER RC", 1))
					flag = false;
		
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
				func_304(&uParam0->f_35[0], true);
		
			if (!func_303(true, true))
				flag = false;
...
BOOL func_303(BOOL bParam0, BOOL bParam1) // Position - 0x2AFE2 Hash - 0xD0FD5EC9 ^0x4AC1AE5E
{
	int num;
...
void func_304(Vehicle* pveParam0, BOOL bParam1) // Position - 0x2B050 Hash - 0x73DACAF1 ^0x73DACAF1
{
	var unk;
	float num;
	...
	func_305(pveParam0, hLocal_79, unk, num);
...
void func_305(Vehicle* pveParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5) // Position - 0x2B0C4 Hash - 0x60B41505 ^0x2C4B5209
{
	func_306(pveParam0);
...
void func_306(Vehicle* pveParam0) // Position - 0x2B107 Hash - 0x8D18F713 ^0xF71A18A8
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_307(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x2B1A3 Hash - 0x5E27D69A ^0xE8A3C3CE
{
	if (func_308(ppedParam0, echParam1, fParam2, fParam5, true))
	{
...
BOOL func_308(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x2B1FF Hash - 0xC57592AD ^0x9AA0BE7
{
	Hash model;

	if (!func_154(echParam1))
	{
		model = func_351(echParam1);
...
int func_309(Ped pedParam0, eCharacter echParam1) // Position - 0x2B28D Hash - 0x5AC42C11 ^0x5AC42C11
{
	int num;
...
BOOL func_310(var uParam0) // Position - 0x2B2D3 Hash - 0xB319BDFA ^0xA1F4DAFB
{
	if (func_311(uParam0))
	{
...
BOOL func_311(var uParam0) // Position - 0x2B2FD Hash - 0x6329B93C ^0xCBBB8D92
{
...
BOOL func_312(var uParam0) // Position - 0x2B322 Hash - 0xC42B20E0 ^0x728F1DAE
{
	int i;
...
void func_313(var uParam0, char* sParam1, char* sParam2, int iParam3) // Position - 0x2B353 Hash - 0x6EEDFC2 ^0xD51569DC
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0x2B38F Hash - 0x77F66043 ^0x77F66043
{
...
void func_315() // Position - 0x2B3B3 Hash - 0xB89F9AC8 ^0x51E024A4
{
	func_263();
	...
	func_327(&uLocal_81.f_28[0], true, 1, 1);
	func_316(&uLocal_81, 1, false, false);
...
void func_316(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x2B43D Hash - 0x5BE1D1E3 ^0x5BE1D1E3
{
	func_324(uParam0, iParam1);
	func_321(uParam0, bParam2);
	func_317(uParam0, bParam3);
	return;
}

void func_317(var uParam0, BOOL bParam1) // Position - 0x2B45D Hash - 0xEDC3BD2D ^0xE0B6F056
{
	func_318(&(uParam0->f_41), bParam1);
	return;
}

void func_318(var uParam0, BOOL bParam1) // Position - 0x2B46F Hash - 0x9E80EA71 ^0x9E80EA71
{
	int i;
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (bParam1)
			...
			func_319(&uParam0->[i], false);
	}

	return;
}

void func_319(Object* pobParam0, BOOL bParam1) // Position - 0x2B4AD Hash - 0xD7EE3E27 ^0xC5769B29
{
...
void func_320(Object* pobParam0) // Position - 0x2B4E8 Hash - 0x4EAFEE58 ^0x34D7ECA6
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_321(var uParam0, BOOL bParam1) // Position - 0x2B513 Hash - 0xEDC3BD2D ^0xE2474F74
{
	func_322(&(uParam0->f_35), bParam1);
	return;
}

void func_322(var uParam0, BOOL bParam1) // Position - 0x2B525 Hash - 0xA98F6284 ^0xA98F6284
{
	int i;
...
void func_323(Vehicle* pveParam0) // Position - 0x2B562 Hash - 0xC50F9886 ^0x638B6124
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_324(var uParam0, int iParam1) // Position - 0x2B59A Hash - 0xEDC3BD2D ^0xA9A19095
{
	func_325(&(uParam0->f_28), iParam1);
	return;
}

void func_325(var uParam0, int iParam1) // Position - 0x2B5AC Hash - 0xB72ACFD2 ^0xB72ACFD2
{
	int i;
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_327(&uParam0->[i], false, 1, 0);
	}

	return;
}

void func_326(Ped* ppedParam0) // Position - 0x2B5ED Hash - 0xCA79453F ^0x7BA88177
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
void func_327(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x2B62E Hash - 0x34362197 ^0xC592197
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
BOOL func_328() // Position - 0x2B67E Hash - 0xBE5BC0C3 ^0x39FB8F89
{
	int num;
...
void func_329(BOOL bParam0) // Position - 0x2B71F Hash - 0x7B759B34 ^0x4EF237EA
{
	int num;
	...
	if (!func_346())
	{
		...
		if (bParam0)
		{
			...
			func_330(SCRIPT::GET_THIS_SCRIPT_NAME(), num);
		}
		else
		{
			if (Global_113457[num /*10*/].f_9 == -1)
...
void func_330(const char* sParam0, int iParam1) // Position - 0x2B7EF Hash - 0xF8D2A766 ^0x5740ACF1
{
	if (Global_101392 != 12)
...
BOOL func_331(const char* sParam0, int iParam1, int iParam2) // Position - 0x2B817 Hash - 0x71022A4D ^0x7DE21930
{
	...
	if (func_337())
	{
		...
		{
			num = func_332(SCRIPT::GET_THIS_SCRIPT_NAME());
...
int func_332(char* sParam0) // Position - 0x2B9A6 Hash - 0x76B99CC6 ^0xBE4E1D5A
{
...
int func_333() // Position - 0x2B9FC Hash - 0x2618AC69 ^0x91ED0F4F
{
	int num;
	int num2;

	num = func_334(&(Global_101392.f_3), false);
	num2 = 0;
...
int func_334(char* sParam0, BOOL bParam1) // Position - 0x2BA20 Hash - 0xB77E1B23 ^0xEB3CA535
{
	Hash hashKey;
	int num;
...
int func_335(Hash hParam0, BOOL bParam1) // Position - 0x2BA4A Hash - 0x486E1959 ^0x3A81F66C
{
	int i;
...
BOOL func_336() // Position - 0x2BA80 Hash - 0x4DEF90DC ^0x5BCA2C2E
{
...
BOOL func_337() // Position - 0x2BAD0 Hash - 0x5C8B3FB8 ^0x45F2ABEA
{
	...
	if (Global_101392.f_11 == 5)
		if (func_332(&(Global_101392.f_3)) > -1)
			return true;

	return false;
}

void func_338(BOOL bParam0) // Position - 0x2BB3C Hash - 0x7936EEB2 ^0x2BE2E139
{
...
void func_339(int iParam0) // Position - 0x2BB50 Hash - 0x3208FCBD ^0xBA877D65
{
	if (iParam0 == 1)
	{
		HUD::THEFEED_PAUSE();
...
void func_340(int iParam0) // Position - 0x2BB8A Hash - 0xFA45F741 ^0xA5B13A23
{
	if (iParam0 == 1)
	{
...
void func_341() // Position - 0x2BBC4 Hash - 0x9A142650 ^0x4D0752C1
{
	Global_23572.f_5 = 1;
	return;
}

void func_342() // Position - 0x2BBD2 Hash - 0xC30A8265 ^0x139DE662
{
	Global_23572.f_5 = 0;
	return;
}

void func_343(BOOL bParam0) // Position - 0x2BBE0 Hash - 0x5FE88D2A ^0xA22C291D
{
	if (bParam0)
	{
		func_344();
...
void func_344() // Position - 0x2BC43 Hash - 0xF8FE2348 ^0xA77911B2
{
...
void func_345() // Position - 0x2BC6C Hash - 0xA68B3BE7 ^0xA68B3BE7
{
	Global_95548 = 0;
	Global_95549 = false;
	return;
...
BOOL func_346() // Position - 0x2BC7E Hash - 0x25806CBF ^0x25806CBF
{
...
void func_347() // Position - 0x2BCBC Hash - 0xA374022B ^0xD7C19AE5
{
	Global_101427 = 1;
...
void func_348(char* sParam0) // Position - 0x2BDAB Hash - 0x54B64147 ^0x56EEAFB9
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_349(var uParam0) // Position - 0x2BDBD Hash - 0x23409181 ^0x17F55207
{
	func_350(&(uParam0->f_28));
	func_350(&(uParam0->f_35));
	func_350(&(uParam0->f_41));
	return;
}

void func_350(var uParam0) // Position - 0x2BDDD Hash - 0x9B320D7B ^0x189EAC80
{
	int i;
...
Hash func_351(eCharacter echParam0) // Position - 0x2BE17 Hash - 0xBF0B24A5 ^0xBF0B24A5
{
	if (!func_154(echParam0))
