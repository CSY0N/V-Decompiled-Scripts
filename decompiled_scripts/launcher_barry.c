...
void main() // Position - 0x0 Hash - 0x5D84F89F ^0x5D84F89F
{
	...
	{
		func_322("Force cleanup [TERMINATING]");
	
		if (num != -1)
		{
			if (Global_113457[num /*10*/].f_9 != -1)
			{
				func_322("Relinquishing candidate id...");
				func_321(&(Global_113457[num /*10*/].f_9));
			}
		}
	...
	if (!func_301(&num, vector, 1f))
	{
		func_300();
		func_322("SCRIPT TERMINATED");
	...
	while (!func_269(&num))
	{
		...
		{
			func_322("Player out of range [TERMINATING]");
			func_304(&num, true);
		}
	}
	...
	if (num == 4)
	{
		_CONVERSATION_INITIALIZE_ACTOR(&uLocal_104, 3, num.f_28[0], "BARRY", 0, 1);
	...
	while (true)
	{
		...
		if (!IS_RC_FINE_AND_IN_RANGE(&num, num != 2))
			func_304(&num, true);
	
		func_224(num);
		func_217(&iLocal_91, &(num.f_9), vector);
	
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(num.f_28[0]))
			if (num == 2)
				if (func_214(&num, ENTITY::GET_ENTITY_COORDS(num.f_28[0], true), "BARY1AU", "BARY1_PRELEA", 5, "BARRY", 10000, 23f))
					func_213(&num, uLocal_95, true, 0);
			else if (num == 3)
				func_214(&num, ENTITY::GET_ENTITY_COORDS(num.f_28[0], true), "BARY2AU", "BARY2_AMB", 3, "BARRY", 10000, 23f);
			else if (num == 4)
				func_199(&uLocal_103, ENTITY::GET_ENTITY_COORDS(num.f_28[0], true), "BARR3AU", "BARRY3_AMB");
		...
		if (func_183(&num, num2))
		{
			if (func_182(num))
				func_179(num, &blLocal_94);
...
BOOL func_1(var uParam0) // Position - 0x32E Hash - 0x5CBE5B62 ^0x13861C41
{
...
BOOL func_2(Any* panParam0) // Position - 0x34C Hash - 0x93FB423A ^0x93FB423A
{
	const char* str;
	var unk32;
	...
	if (!_IS_MISSION_REPLAY_IN_PROGRESS())
	{
		while (!func_169(*panParam0))
		{
			...
			{
				func_322("LAUNCH_RC_MISSION - NOT IS_RC_FINE_AND_IN_RANGE() [TERMINATING]");
				return false;
			}
	...
	{
		func_322("STEP_7_COMMON_LaunchMission - Trying to launch a null script string name");
		return false;
	}
...
void func_3(int iParam0, const char* sParam1) // Position - 0x40D Hash - 0xA9A7342A ^0xA9284257
{
	func_21(sParam1);
...
void func_4(int iParam0) // Position - 0x4C9 Hash - 0x74C873D2 ^0x74C873D2
{
	int num;
	int num2;
...
void func_5() // Position - 0x623 Hash - 0x6EF841A5 ^0x6EF841A5
{
	int i;
...
void func_6(int iParam0) // Position - 0x6D6 Hash - 0xB8CA5CA7 ^0x96AAFF46
{
	switch (iParam0)
	{
		case 2:
...
void func_7(int iParam0) // Position - 0xABE Hash - 0xA84FABDE ^0xA84FABDE
{
	Global_64031 = true;
	Global_64034 = 1;
...
void func_8(int iParam0) // Position - 0xB09 Hash - 0x4878B614 ^0x92338679
{
...
struct<2> func_9(int iParam0) // Position - 0xB3D Hash - 0x323E6781 ^0x9D2D032F
{
	var unk;
	var unk3;
...
void func_10() // Position - 0xB75 Hash - 0xDE0A4F6 ^0xDE0A4F6
{
	if (Global_64038)
		return;
...
void func_11() // Position - 0xBCB Hash - 0x49CBF5B6 ^0x790810FF
{
	int i;
...
void func_12() // Position - 0xBF8 Hash - 0x45508BA8 ^0x301C64C9
{
	int i;
...
void func_13() // Position - 0xC2F Hash - 0x8D222CF ^0x8D222CF
{
	Global_64197 = 0;
	return;
}

void func_14() // Position - 0xC3B Hash - 0xCEA3FAB3 ^0xBE2318F
{
	Global_64057 = 0;
...
var func_15(Hash hParam0) // Position - 0xC8F Hash - 0x4A0C678B ^0x403B983B
{
	var outValue;
...
void func_16() // Position - 0xCA3 Hash - 0x43632AFE ^0x43632AFE
{
	int i;
...
void func_17(BOOL bParam0) // Position - 0xCCD Hash - 0xFFF39126 ^0xFFF39126
{
...
void func_18() // Position - 0xCE1 Hash - 0xFC34B768 ^0xE1D0CFD9
{
	int i;
...
void func_19() // Position - 0xD1A Hash - 0x429A4038 ^0x35B7C581
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("mission_stat_watcher")) > 0)
	{
		if (func_20())
...
BOOL func_20() // Position - 0xD5C Hash - 0x46E5692F ^0xA798242F
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("mission_stat_watcher")) < 1)
		return false;
...
void func_21(const char* sParam0) // Position - 0xD86 Hash - 0xF54A2398 ^0xC5887C42
{
	MISC::ARE_STRINGS_EQUAL(sParam0, sParam0);
	return;
}

void func_22(char* sParam0, int iParam1) // Position - 0xD99 Hash - 0x1166ABB2 ^0x89B55D9D
{
...
void func_23(char* sParam0, int iParam1, Ped pedParam2) // Position - 0xDB6 Hash - 0xB566D143 ^0x35A2AF7A
{
...
void func_24() // Position - 0xDFB Hash - 0x59B932B3 ^0xFC5559FC
{
	int i;
	int j;
...
void func_25(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0x1A8F Hash - 0x53B0865D ^0xC434A1E8
{
	int i;
	eCharacter j;
...
int func_26(var uParam0) // Position - 0x2918 Hash - 0x56C64BA4 ^0xCAE61007
{
...
void func_27(var uParam0, int iParam1, Ped pedParam2, int iParam3, int iParam4, int iParam5) // Position - 0x293A Hash - 0x4709079E ^0x71C884C9
{
	Vehicle vehicle;
...
int func_28(var uParam0, int iParam1, Vehicle veParam2, int iParam3) // Position - 0x29C2 Hash - 0x6BF8E630 ^0xF655D74B
{
...
BOOL func_29(Vehicle veParam0) // Position - 0x2A02 Hash - 0x8CDF26D5 ^0xCE04F037
{
	int i;
...
void func_30(var uParam0, Vehicle veParam1, int iParam2) // Position - 0x2A30 Hash - 0x9B217A45 ^0xEE9A0448
{
...
int func_31(Vehicle veParam0) // Position - 0x2B0C Hash - 0xDEF2B534 ^0x25A18686
{
	int i;
...
eCharacter func_32(Vehicle veParam0) // Position - 0x2B4E Hash - 0x593067C2 ^0x2918B7DD
{
	int i;
...
int func_33(Vehicle veParam0, eCharacter echParam1, int iParam2) // Position - 0x2BB1 Hash - 0xC883A039 ^0x6D45755E
{
	int i;
...
Hash func_34(eCharacter echParam0, int iParam1) // Position - 0x2C3F Hash - 0x3C1119CD ^0x1010ECAE
{
	Hash num;
...
void func_35(eCharacter echParam0, var uParam1, int iParam2) // Position - 0x2C81 Hash - 0xF92B8944 ^0xD11BCD5C
{
	int num;
...
BOOL func_36(eCharacter echParam0) // Position - 0x2EDD Hash - 0x8907F004 ^0x8907F004
{
	return echParam0 < CHAR_MULTIPLAYER;
}

void func_37(Vehicle veParam0, var uParam1) // Position - 0x2EE9 Hash - 0x5E84B52A ^0xEF20F807
{
	int i;
...
int func_38(int iParam0) // Position - 0x3194 Hash - 0xEE599357 ^0xEE599357
{
	switch (iParam0)
	{
		case 1:
...
int func_39(var uParam0, var uParam1, var uParam2) // Position - 0x3244 Hash - 0x4455160E ^0x8E5B3F28
{
	int i;
	int modType;
...
BOOL func_40(int iParam0) // Position - 0x3437 Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_41(var uParam0) // Position - 0x3457 Hash - 0xB95AF921 ^0x4DC7C61C
{
	int i;
...
BOOL func_42(Ped pedParam0, var uParam1, int iParam2, int iParam3) // Position - 0x3508 Hash - 0x6795F6D3 ^0x3A08E8AF
{
...
BOOL func_43(Vehicle veParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x3637 Hash - 0xBCC62924 ^0x77695844
{
	int i;
	var garageName;
	int num;
...
BOOL func_44(eCharacter echParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x36A5 Hash - 0x8E372EAA ^0xD47E44F6
{
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x377E Hash - 0xAC4E9801 ^0xB379A75F
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x37BB Hash - 0xADCB9755 ^0xADCB9755
{
...
Hash func_47(eCharacter echParam0) // Position - 0x37E0 Hash - 0xE4CEEC2C ^0xE4CEEC2C
{
	return Global_2139[echParam0 /*29*/];
}

void func_48(Ped pedParam0, var uParam1, int iParam2, int iParam3) // Position - 0x37EF Hash - 0x4CE94407 ^0xC863C983
{
...
int func_49(int iParam0, int iParam1) // Position - 0x3989 Hash - 0x744E461C ^0x94D7C845
{
	Hash statHash;
	int outValue;
...
Hash func_50(int iParam0, int iParam1) // Position - 0x39B8 Hash - 0x505A9F99 ^0x8B00E935
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_51(iParam1));
}

int func_51(int iParam0) // Position - 0x39CD Hash - 0x1A3F3220 ^0x1A3F3220
{
	int num;
	int num2;
...
int func_52() // Position - 0x3A01 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1574925;
}

BOOL func_53(int iParam0, int iParam1) // Position - 0x3A0D Hash - 0x5137F6D6 ^0x3B535546
{
	Hash statHash;
	BOOL outValue;
...
Hash func_54(int iParam0, int iParam1) // Position - 0x3A31 Hash - 0x1D62A43E ^0x33D7B335
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_51(iParam1));
}

void func_55(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x3A46 Hash - 0x65821445 ^0x4849EA55
{
	eCharacter character;
...
void func_56(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3F8F Hash - 0x10358CC6 ^0xCC2A186D
{
	eCharacter character;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x41D2 Hash - 0x3C5423D7 ^0x3C5423D7
{
	func_58();
	return Global_114370.f_2366.f_539.f_4321;
}

void func_58() // Position - 0x41EB Hash - 0xD1F2D853 ^0xF9F5FD4D
{
	eCharacter character;
...
BOOL func_59(int iParam0) // Position - 0x42E8 Hash - 0x937D8816 ^0x937D8816
{
	return Global_43922 == iParam0;
}

void func_60(Ped pedParam0, BOOL bParam1) // Position - 0x42F6 Hash - 0xC106EC1D ^0x74ED6306
{
	eCharacter character;
...
void func_61(Ped pedParam0, var uParam1) // Position - 0x43E9 Hash - 0xDEAAD761 ^0xB2E3A390
{
	int i;
	int j;
	Hash k;
...
BOOL func_62(int iParam0) // Position - 0x4671 Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
...
BOOL func_63(int iParam0) // Position - 0x4712 Hash - 0xD9D843D5 ^0xF9D91FBE
{
...
Hash func_64(Hash hParam0, int iParam1) // Position - 0x48FE Hash - 0x6010BC66 ^0x1DFF9FB7
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_65(Hash hParam0, Any* panParam1) // Position - 0x561F Hash - 0x539D27DB ^0xB7B7AD25
{
	int i;
	int numDlcWeapons;
...
Hash func_66(int iParam0) // Position - 0x565A Hash - 0x5FB59AC3 ^0x9BC6B2ED
{
	int num;
...
void func_67(Ped pedParam0) // Position - 0x58CE Hash - 0x27D5295B ^0xD1A82444
{
	eCharacter character;
...
void func_68(var uParam0, int iParam1) // Position - 0x590A Hash - 0x635FFA34 ^0xAE461588
{
	var unk;
	var unk2;
	var unk5;
...
BOOL func_69(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5E59 Hash - 0xA7FD254F ^0xFF9CDA51
{
...
BOOL func_70(int iParam0, var uParam1, var uParam2) // Position - 0x5E9D Hash - 0xE3586C79 ^0xE3586C79
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x661C Hash - 0x2D46096D ^0xEA41378F
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x6663 Hash - 0xDB33C708 ^0xF5B91AC7
{
...
BOOL func_73(int iParam0) // Position - 0x66BE Hash - 0xCAEAF99E ^0xCAEAF99E
{
	return func_74(iParam0, 0, true);
}

BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x66CE Hash - 0xA45BEB30 ^0x6033D2A2
{
	if (iParam0 == -1)
		return false;
...
int func_75(int iParam0) // Position - 0x672E Hash - 0x28E83966 ^0x9E37924F
{
	switch (iParam0)
	{
		case 0:
...
int func_76() // Position - 0x6AD6 Hash - 0x21D64237 ^0x21D64237
{
	return Global_32828;
}

BOOL func_77(int iParam0) // Position - 0x6AE1 Hash - 0xBE61F0FD ^0xBE61F0FD
{
	return func_74(iParam0, 5, true);
}

int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6AF1 Hash - 0x4E8D2C12 ^0x4E8D2C12
{
	int i;
...
Vector3 func_79(int iParam0, BOOL bParam1) // Position - 0x6B93 Hash - 0x4894642D ^0x4894642D
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_80() // Position - 0x72FE Hash - 0x6E37375C ^0x6E37375C
{
...
int func_81() // Position - 0x75F9 Hash - 0x974E48B4 ^0x974E48B4
{
	return Global_2652572.f_2650;
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x7608 Hash - 0x16E871AD ^0x10C54C39
{
...
Vector3 func_83(float fParam0, float fParam1, float fParam2) // Position - 0x7632 Hash - 0xD52A1F8B ^0x5D514503
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_84(), 0f, fParam0);
}

Vector3 func_84() // Position - 0x7647 Hash - 0x21158019 ^0x21158019
{
	return -880f, -2770f, -50f;
}

BOOL func_85(ePedComponentType epctParam0) // Position - 0x765E Hash - 0x78AB9EAC ^0x78AB9EAC
{
...
Vector3 func_86(int iParam0, int iParam1) // Position - 0x76B6 Hash - 0x7E203DFC ^0x7E203DFC
{
	var unk;
	var unk7;
...
BOOL func_87(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x7760 Hash - 0x5642A5C0 ^0x5642A5C0
{
	var unk;
	Vector3 vector;
	var unk12;
...
Vector3 func_88(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x77F5 Hash - 0x8959C4D1 ^0x8922A2E2
{
	float num;
	float num2;
	float num3;
...
struct<6> func_89(int iParam0) // Position - 0x7839 Hash - 0xC73C1158 ^0x2A6D4A6F
{
	var unk;
...
struct<6> func_90(int iParam0) // Position - 0x79BD Hash - 0x2623C81B ^0x2623C81B
{
	return func_91(iParam0);
}

struct<6> func_91(int iParam0) // Position - 0x79CB Hash - 0x7684F11 ^0xD37BE1E4
{
	var unk;
...
BOOL func_92(int iParam0, var uParam1) // Position - 0x8494 Hash - 0x31632D18 ^0xF002B35A
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_93(ePedComponentType epctParam0) // Position - 0x8516 Hash - 0x9D5E1610 ^0x9D5E1610
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x856E Hash - 0x478900E4 ^0x478900E4
{
	return -1;
}

Vector3 func_95(int iParam0) // Position - 0x8577 Hash - 0xCBED323 ^0xCBED323
{
	switch (iParam0)
	{
		case 1:
...
int func_96() // Position - 0x87E3 Hash - 0x5976C0FC ^0xC3C6644E
{
	return func_97(PLAYER::PLAYER_ID());
}

int func_97(Player plParam0) // Position - 0x87F3 Hash - 0x1A54F100 ^0x35DB7B9D
{
	return MISC::GET_BITS_IN_RANGE(Global_2657921[plParam0 /*463*/].f_321.f_3, 28, 31);
}

BOOL func_98(int iParam0) // Position - 0x8810 Hash - 0xA85A6891 ^0xA85A6891
{
	return func_74(iParam0, 0, false);
}

int func_99(int iParam0) // Position - 0x8820 Hash - 0x1BE0B176 ^0x1BE0B176
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_100() // Position - 0x8B56 Hash - 0xD56328D2 ^0xD56328D2
{
	return Global_101444.f_393 > 0;
}

var func_101() // Position - 0x8B67 Hash - 0x9E44C35 ^0xB9993D58
{
	var unk;
...
void func_102(var uParam0, int iParam1) // Position - 0x8BAD Hash - 0x15B9927E ^0x4A4674
{
	if (iParam1 <= 0)
		return;
...
void func_103(var uParam0, int iParam1) // Position - 0x8C33 Hash - 0x4C70B2C3 ^0x4C70B2C3
{
...
void func_104(var uParam0, int iParam1) // Position - 0x8C66 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
int func_105(int iParam0, int iParam1) // Position - 0x8CB7 Hash - 0xD3EBACB3 ^0xD3EBACB3
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_106(int iParam0) // Position - 0x8D59 Hash - 0xE1B0542C ^0x127A471E
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_107(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8D7B Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
int func_108(int iParam0) // Position - 0x8D92 Hash - 0x2D4DB85F ^0x2D4DB85F
{
	return iParam0 & 15;
}

void func_109(var uParam0, int iParam1) // Position - 0x8D9F Hash - 0x864304A8 ^0x1F5003E2
{
...
void func_110(var uParam0, int iParam1) // Position - 0x8DD9 Hash - 0x76860AE7 ^0x32308FFF
{
...
void func_111(var uParam0, int iParam1) // Position - 0x8E14 Hash - 0xDB8A72C0 ^0x4F6D426D
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8E50 Hash - 0x3C5423D7 ^0x3C5423D7
{
	func_58();
	return Global_114370.f_2366.f_539.f_4321;
}

void func_113(int iParam0) // Position - 0x8E69 Hash - 0x35AC36F2 ^0x8450D910
{
	int num;
	var textLabel;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8EC2 Hash - 0x4C81F065 ^0x79C65D03
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x8ED8 Hash - 0x4C81F065 ^0xB17A9745
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_116(char* sParam0, Any anParam1, int iParam2) // Position - 0x8EEE Hash - 0x817AB180 ^0x6F5F76F0
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8F30 Hash - 0x15889021 ^0xE7262364
{
...
struct<2> func_118(int iParam0) // Position - 0x8F58 Hash - 0x975AC8C9 ^0x81C2BE1C
{
	var unk;
...
void func_119(int iParam0, var uParam1) // Position - 0x93A5 Hash - 0x2D8E3F8 ^0x13AB47AA
{
	switch (iParam0)
	{
		case 0:
...
int func_121(int iParam0) // Position - 0xA67D Hash - 0xC999F6B2 ^0xC999F6B2
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_122(Any* panParam0) // Position - 0xA9C3 Hash - 0x1D39FD6 ^0xAFEDDB74
{
	int threadId;
	...
	if (func_152(&(panParam0->f_1)))
	{
		...
		{
			func_322("Initial cutscene loaded and passing to RC mission.");
			CUTSCENE::SET_SCRIPT_CAN_START_CUTSCENE(threadId);
		}
		else
		{
			func_322("Initial cutscene wasn't loaded in time to pass to RC mission.");
...
void func_123(int iParam0) // Position - 0xAA68 Hash - 0xE0445FFC ^0x204FFA11
{
	var name;
...
void func_124(int iParam0) // Position - 0xAB03 Hash - 0xE70A4F17 ^0xE70A4F17
{
	if (iParam0 < 63)
	{
		func_125();
...
void func_125() // Position - 0xAB29 Hash - 0xD5DFA716 ^0xD54995D4
{
	Global_79503 != 6;
...
void func_126(Ped pedParam0) // Position - 0xAB61 Hash - 0x91438920 ^0xDA692F14
{
	int num;
	int num2;
	int num3;
...
void func_127(int iParam0) // Position - 0xABBA Hash - 0xBB510F32 ^0xE77AE77B
{
...
int func_128(Ped pedParam0) // Position - 0xAC3D Hash - 0x14AF2EDD ^0xC5BC7CD2
{
	int i;
...
void func_129(int iParam0, int iParam1, int iParam2) // Position - 0xAC6E Hash - 0xF54D70EF ^0xF54D70EF
{
	func_130(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_130(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xAC83 Hash - 0x9F3D8BA2 ^0x9F3D8BA2
{
	int num;
...
int func_131() // Position - 0xAD05 Hash - 0x11506CC4 ^0x2E9F5641
{
	int i;
...
BOOL func_132(int iParam0, int iParam1, int iParam2) // Position - 0xAD36 Hash - 0x3A30B8C2 ^0x3A30B8C2
{
...
int func_133(int iParam0, int iParam1, int iParam2) // Position - 0xAD51 Hash - 0x61F8C119 ^0x1C9B84EC
{
	int i;
...
int func_134(Ped pedParam0) // Position - 0xAD9D Hash - 0xDCBB968F ^0xDCBB968F
{
	int i;
...
BOOL func_135(Ped pedParam0) // Position - 0xADE6 Hash - 0x7E48B415 ^0x126328AB
{
...
BOOL func_136(int iParam0) // Position - 0xAE06 Hash - 0xBF3EFB31 ^0xBF3EFB31
{
	switch (iParam0)
	{
		case 5:
...
void func_137() // Position - 0xAE59 Hash - 0x53295875 ^0x53295875
{
...
BOOL func_138(int iParam0) // Position - 0xAED6 Hash - 0xBF3EFB31 ^0xBF3EFB31
{
	switch (iParam0)
	{
		case 5:
...
void func_139(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xAF29 Hash - 0x50B95D9E ^0x1806B4C4
{
	int i;
...
BOOL func_140(int iParam0) // Position - 0xB01E Hash - 0xBF3EFB31 ^0xBF3EFB31
{
	switch (iParam0)
	{
		case 5:
...
void func_141(BOOL bParam0) // Position - 0xB089 Hash - 0xD10400C0 ^0xB6845444
{
	Player playerIndex;
...
void func_142(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB0C8 Hash - 0x787E640E ^0x67C15509
{
	if (bParam0)
	{
...
BOOL func_143() // Position - 0xB215 Hash - 0xAA7793E3 ^0x3F62CDC8
{
	return IS_BIT_SET(Global_1845263[PLAYER::PLAYER_ID() /*877*/].f_36.f_18, 14);
}

BOOL func_144(Player plParam0, int iParam1) // Position - 0xB22F Hash - 0x1A32E11A ^0x6AADE226
{
	BOOL flag;
...
int func_145(int iParam0, BOOL bParam1) // Position - 0xB288 Hash - 0x1DCD393E ^0x1DCD393E
{
	int num;
	int num2;
...
BOOL func_146(Player plParam0) // Position - 0xB2C9 Hash - 0x6A46C9B4 ^0x6A46C9B4
{
	Player player;
...
BOOL func_147(Player plParam0) // Position - 0xB2EB Hash - 0x68897CDD ^0x62820466
{
...
BOOL func_148() // Position - 0xB32A Hash - 0xA525B2F4 ^0xA525B2F4
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_149(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB338 Hash - 0x3167F4C7 ^0xCE6B9B6A
{
	int num;
...
BOOL func_150() // Position - 0xB36B Hash - 0xD140D54A ^0xE638D98F
{
...
void func_151(int iParam0) // Position - 0xB392 Hash - 0x1B2EEE72 ^0xEDBC1F9D
{
	if (iParam0 == 1)
...
BOOL func_152(const char* sParam0) // Position - 0xB3B5 Hash - 0x16488C7A ^0x166F3418
{
	...
	func_322("Attempting to launch invalid script file [TERMINATING]");
	return false;
}

void func_153() // Position - 0xB3F2 Hash - 0xC536DD5 ^0xC536DD5
{
	Global_21032 = 0;
	func_154();
	return;
...
void func_154() // Position - 0xB402 Hash - 0xE32CF1EF ^0xB9A7BEB2
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB459 Hash - 0x152DA0B2 ^0x220E93E9
{
...
void func_156() // Position - 0xB47B Hash - 0xE60F63BE ^0xE60F63BE
{
	func_162(0);
	func_161();
	func_157();
...
void func_157() // Position - 0xB490 Hash - 0xC95798F1 ^0x61ADB9D7
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
...
BOOL func_158(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB4E8 Hash - 0xEF9D4F61 ^0xC848BDEA
{
...
void func_159(Vehicle veParam0) // Position - 0xB53F Hash - 0x94E8CB0B ^0x47923A23
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_160(BOOL bParam0, BOOL bParam1) // Position - 0xB56B Hash - 0xC86614C6 ^0xCD39041A
{
...
void func_161() // Position - 0xB6BC Hash - 0x2A0AC5B7 ^0xAF27577A
{
...
void func_162(int iParam0) // Position - 0xB70D Hash - 0x7E11E9C ^0x544BF257
{
	if (func_167())
		return;
...
void func_163(int iParam0) // Position - 0xB740 Hash - 0x4066FEF5 ^0x9787FBDA
{
	if (func_167())
		return;
...
void func_164(BOOL bParam0, BOOL bParam1) // Position - 0xB7CA Hash - 0xF40FC178 ^0xA6F60F17
{
	if (bParam0)
	{
		if (func_166(0))
...
BOOL func_165() // Position - 0xB83E Hash - 0x8DF3D75D ^0x8DF3D75D
{
	return IS_BIT_SET(Global_1956030, 5);
}

BOOL func_166(int iParam0) // Position - 0xB84C Hash - 0xE8921B44 ^0x4F063755
{
	if (iParam0 == 1)
...
BOOL func_167() // Position - 0xB8A3 Hash - 0xC41437CB ^0xC41437CB
{
	return IS_BIT_SET(Global_1956030, 19);
}

BOOL func_168(int iParam0) // Position - 0xB8B2 Hash - 0x2BFED607 ^0x2BFED607
{
...
BOOL func_169(int iParam0) // Position - 0xB8F3 Hash - 0x5C21BF6B ^0xB5545E1F
{
	int num;
...
void func_170(int iParam0) // Position - 0xB938 Hash - 0xF49E441F ^0xE21552CB
{
...
int func_171(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB96A Hash - 0x8F9349A ^0xC5C097C1
{
	int i;
...
void func_172(int iParam0, int iParam1) // Position - 0xBAA1 Hash - 0x6AC97785 ^0x6AC97785
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBAF0 Hash - 0xECB6C71B ^0xECB6C71B
{
	return func_174(iParam0, Global_43922);
}

BOOL func_174(int iParam0, int iParam1) // Position - 0xBB01 Hash - 0x1FD727E0 ^0x1FD727E0
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_175(int iParam0) // Position - 0xBCE2 Hash - 0x3BAB94E9 ^0x3BAB94E9
{
	if (Global_43922 == 15)
		return false;
...
int func_176() // Position - 0xBD04 Hash - 0x613FC6AD ^0xDC7835B3
{
	return func_177(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_177(char* sParam0, int iParam1) // Position - 0xBD15 Hash - 0x76A2E0AF ^0x8A5231BB
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBD5E Hash - 0x77F66043 ^0x77F66043
{
	if (Global_101392 == 10 || Global_101392 == 9)
		return true;
...
void func_179(int iParam0, var uParam1) // Position - 0xBD82 Hash - 0x4DABA5AB ^0x5B086A56
{
	switch (iParam0)
	{
		case 0:
...
Blip func_180(float fParam0, float fParam1, float fParam2, BOOL bParam3) // Position - 0xC1F5 Hash - 0xF4E99477 ^0x29669E98
{
	Blip blip;
...
var func_181(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC221 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
BOOL func_182(int iParam0) // Position - 0xC238 Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_183(var uParam0, int iParam1) // Position - 0xC2C7 Hash - 0x4C332810 ^0xCFFAAA23
{
	switch (uParam0->f_16)
	{
		case 0:
						...
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(uParam0->f_28[0], true), true) < 3f)
						{
							if (func_189(2))
							{
								if (func_187(uParam0->f_27))
								{
									...
									func_322("ARE_RC_TRIGGER_CONDITIONS_MET: RC_TRIG_CHAR - Used special case Eps 4 trigger.");
									return true;
								}
							}
						}
				...
				if (TASK::GET_PED_DESIRED_MOVE_BLEND_RATIO(PLAYER::PLAYER_PED_ID()) >= 2f)
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 245.88849f, 371.9034f, 103.98843f, 241.58984f, 359.64575f, 107.34612f, 1.25f, false, true, 0))
					{
						if (func_189(2))
						{
							...
							{
								func_186(uParam0->f_27, *uParam0);
								func_322("RC5_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - Eps 2 special case trigger used");
								return true;
							}
						}
					}
			...
			else if (*uParam0 == 31)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 2728.9482f, 4143.44f, 42.292946f, 2722.2134f, 4144.5215f, 45.431824f, 10f, false, true, 0))
				{
					if (func_189(2))
					{
						...
						{
							func_186(1, *uParam0);
							func_322("RC_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - RC_MAUDE_1 special case vehicle launch area");
							return true;
						}
					}
				}
					...
					if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -983.5426f, 369.11035f, 68.460175f, -1028.5663f, 395.46133f, 94.57245f, 15f, false, true, 0))
					{
						if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -983.875f, 346.75565f, 68.02096f, -1021.4514f, 336.34583f, 93.18714f, 14.5f, false, true, 0))
						{
							if (func_189(2))
							{
								...
								{
									func_186(uParam0->f_27, *uParam0);
									func_322("RC_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - RC_NIGEL_1B special case vehicle launch area");
									return true;
								}
							}
						}
...
void func_184() // Position - 0xCAAA Hash - 0x1DF115D ^0x1DF115D
{
	func_27(&(Global_104933.f_2890), &Global_104933, 0, 1, 1, 0);
	return;
}

BOOL func_185(var uParam0) // Position - 0xCAC5 Hash - 0xBE0C612E ^0xC181C5F3
{
	float num;
...
void func_186(int iParam0, var uParam1) // Position - 0xCB53 Hash - 0x16CCAA18 ^0xC0E5B981
{
	if (iParam0 == 1)
	{
		if (!func_138(uParam1))
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			func_322("RC_STOP_PLAYER_VEHICLE_CHECK: Stopping player's vehicle.");
		
			if (PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()))
			{
				func_322("RC_STOP_PLAYER_VEHICLE_CHECK: Turning off engine for plane or helicopter.");
...
BOOL func_187(BOOL bParam0) // Position - 0xCBB7 Hash - 0x328D4447 ^0x90410402
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::GET_PLAYER_INDEX()))
	{
		...
		else if (bParam0)
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
				...
				if (func_188(playersLastVehicle))
					if (PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()))
...
BOOL func_188(Vehicle veParam0) // Position - 0xCC4E Hash - 0x7E47BB06 ^0x692E6B64
{
...
BOOL func_189(int iParam0) // Position - 0xCC78 Hash - 0x97844555 ^0xADCD6DAA
{
	eCharacter character;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_197() || Global_113417 || Global_32831 || func_196() || func_195(8, -1) || func_100() || func_194() || func_193() || func_192() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_197() || Global_32831 || func_196() || func_195(8, -1) || func_193() || func_100() || func_194() || func_192() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_197() || Global_113417 || Global_32831 || func_196() || func_195(8, -1) || func_193() || func_100() || func_194() || func_192() || Global_114370.f_7691.f_919[character] == 5 || Global_44469 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_197() || Global_113417 || Global_32831 || func_196() || func_195(8, -1) || func_100() || func_194() || func_192() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_197() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_195(8, -1) || func_192() || func_191() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_197() || Global_32831 || func_196() || func_195(8, -1) || func_194() || func_193() || func_192() || Global_114370.f_7691.f_919[character] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_197() || func_194() || Global_113417 || Global_32831 || func_196() || Global_45122 || func_195(8, -1) || func_193() || func_191() || func_192() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 8:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_197() || Global_113417 || Global_32831 || func_196() || func_195(8, -1) || func_193() || func_191() || func_100() || func_194() || func_192())
							return false;
						break;
				}
			}
...
BOOL func_190() // Position - 0xD395 Hash - 0x4228A1C2 ^0x952FE30F
{
	return Global_101431.f_1;
}

BOOL func_191() // Position - 0xD3A3 Hash - 0xC20DBA70 ^0xAC4006FB
{
	if (Global_98294 != -1)
...
BOOL func_192() // Position - 0xD3C6 Hash - 0x3CA1BB47 ^0xB78A1ACB
{
...
BOOL func_193() // Position - 0xD3E0 Hash - 0xE663B8F6 ^0xE663B8F6
{
	if (Global_79509)
		return true;
...
BOOL func_194() // Position - 0xD40A Hash - 0xD56328D2 ^0xD56328D2
{
	return Global_101444.f_394 > 0;
}

BOOL func_195(int iParam0, int iParam1) // Position - 0xD41B Hash - 0xA14C4D3F ^0xA6034F77
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_196() // Position - 0xD453 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1575079;
}

BOOL func_197() // Position - 0xD45F Hash - 0x7FE517FE ^0x128A3BC8
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
BOOL func_198(int iParam0) // Position - 0xD47B Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
		case 5:
...
void func_199(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5) // Position - 0xD49E Hash - 0x9F3CA854 ^0x2E5916D2
{
	switch (*uParam0)
	{
		case 0:
			if (MISC::GET_GAME_TIMER() - iLocal_269 > 5000)
				*uParam0 = 1;
			break;
	
		case 1:
			if (func_212(PLAYER::PLAYER_PED_ID(), uParam1, true) <= 20f)
				if (_CONVERSATION_ADD_LINE(&uLocal_104, sParam4, sParam5, 8, 0, 0, 0))
					*uParam0 = 2;
			break;
		...
		case 2:
			...
			else if (func_212(PLAYER::PLAYER_PED_ID(), uParam1, true) >= 25f)
			{
				func_153();
				*uParam0 = 0;
			}
...
BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xD53B Hash - 0x384540C1 ^0x384540C1
{
	func_211(uParam0, _CHAR_NULL, sParam1, iParam4, iParam5, iParam6);
	...
	Global_23163 = 0;
	Global_2883585 = 0;
	return func_201(sParam2, iParam3, false);
}

BOOL func_201(char* sParam0, int iParam1, BOOL bParam2) // Position - 0xD589 Hash - 0x77297D51 ^0x40DC584A
{
	Global_22167 = 0;
...
void func_202() // Position - 0xD857 Hash - 0xF42BEB19 ^0xA29557DA
{
	if (!func_203())
		return;
...
BOOL func_203() // Position - 0xD88E Hash - 0x7B74B45F ^0xCE052A5D
{
...
BOOL func_204(Player plParam0) // Position - 0xD8F1 Hash - 0x6E46BC72 ^0x6E46BC72
{
	return func_205(plParam0, 20);
}

BOOL func_205(Player plParam0, int iParam1) // Position - 0xD901 Hash - 0x7CD5054C ^0x870BEA81
{
	return IS_BIT_SET(Global_1886967[plParam0 /*609*/].f_10.f_4, iParam1);
}

void func_206() // Position - 0xD919 Hash - 0xDB58E314 ^0x7207A618
{
	int i;
...
void func_207() // Position - 0xD94B Hash - 0xCD8A4D28 ^0xCD8A4D28
{
...
BOOL func_208() // Position - 0xD9E0 Hash - 0x9A999369 ^0x4033F7BF
{
	int num;
	int weaponHash;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0xDA79 Hash - 0x98476CE1 ^0x250FEB7C
{
	if (func_59(14))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
...
void func_210() // Position - 0xDB1B Hash - 0xBE88A374 ^0xEFB5755B
{
	int i;
...
void func_211(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDB73 Hash - 0xC6B752B2 ^0xC6B752B2
{
...
float func_212(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xDBC9 Hash - 0xC22B942A ^0xE0DB8793
{
...
void func_213(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, BOOL bParam9, int iParam10) // Position - 0xDC03 Hash - 0x4E1C0216 ^0xB00E8C6B
{
	int taskSequenceId;
	int num;
	...
	if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[iParam10]))
		return;
	...
	TASK::TASK_PLAY_ANIM(0, uParam0->f_48, uParam1[uParam1.f_7], 4f, -4f, -1, 0 | num, 0, false, false, false);
	TASK::TASK_PLAY_ANIM(0, uParam0->f_48, uParam0->f_48.f_1, 8f, -8f, -1, 1 | num, 0, false, false, false);
	TASK::CLOSE_SEQUENCE_TASK(taskSequenceId);
	TASK::TASK_PERFORM_SEQUENCE(uParam0->f_28[iParam10], taskSequenceId);
	TASK::CLEAR_SEQUENCE_TASK(&taskSequenceId);
	return;
}

BOOL func_214(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9) // Position - 0xDCA0 Hash - 0xA74186BF ^0x512FC932
{
	var unk;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && MISC::GET_GAME_TIMER() - uParam0->f_60 > iParam8 && func_212(PLAYER::PLAYER_PED_ID(), uParam1, true) < fParam9)
	{
		unk = 16;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDD28 Hash - 0xF7ECDFD9 ^0x6B079C3E
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xDD63 Hash - 0x3D210083 ^0xF7E7C389
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
		if (!ENTITY::IS_ENTITY_DEAD(pedParam0, false))
			return true;
...
void func_217(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xDD84 Hash - 0xA38693DA ^0xBAAA90B1
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_212(PLAYER::PLAYER_PED_ID(), uParam2, true) <= 100f)
					func_220(uParam0, 1);
			}
			else
			{
				...
				if (func_212(PLAYER::PLAYER_PED_ID(), uParam2, true) > 120f)
					func_222(uParam0);
			}
		}
	}
...
void func_218(int iParam0, BOOL bParam1) // Position - 0xDE75 Hash - 0x3ABFF97A ^0x3ABFF97A
{
	if (iParam0 == -1)
		return;
...
int func_219(int iParam0) // Position - 0xDEB1 Hash - 0x3F6843D0 ^0x973F28A6
{
	if (Global_79244 == iParam0)
		if (Global_79245 == -1)
...
void func_220(var uParam0, int iParam1) // Position - 0xDEEA Hash - 0xA189769D ^0xD7591C4B
{
	BOOL flag;
	int i;
...
BOOL func_221() // Position - 0xDF88 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_98681;
}

void func_222(var uParam0) // Position - 0xDF94 Hash - 0x8EEB5116 ^0x2325FF68
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_223(uParam0);
...
void func_223(var uParam0) // Position - 0xDFAB Hash - 0x1C509C5B ^0x1C509C5B
{
	BOOL flag;
	int num;
	int i;
...
void func_224(int iParam0) // Position - 0xE093 Hash - 0xD347101A ^0xCC220E7F
{
	if (iParam0 == -1)
		iParam0 = func_176();
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xE0BB Hash - 0x7D86F6E4 ^0x2F0EA7CC
{
	var unk;

	if (Global_79248)
	{
		func_322("IS_RC_FINE_AND_IN_RANGE(): The game is running Multiplayer [TERMINATING]");
		return false;
	}

	func_119(*panParam0, &unk);

	if (func_262(*panParam0) || func_260(*panParam0) || Global_79494 == true)
		return true;

	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	{
		func_322("IS_RC_FINE_AND_IN_RANGE(): Player out of range [TERMINATING]");
		return false;
	}

	if (func_256(*panParam0))
	{
		if (*panParam0 == 19)
			func_255(panParam0->f_28[0]);
	
		func_322("IS_RC_FINE_AND_IN_RANGE(): Script denied by RC Controller [TERMINATING]");
		return false;
	}

	if (panParam0->f_25 == 1)
		if (!func_235(panParam0, true, 0))
			return false;
	else if (panParam0->f_16 == 0)
		if (!func_235(panParam0, false, 0))
			return false;
	...
	if (*panParam0 == 10)
	{
		...
		{
			func_322("IS_RC_FINE_AND_IN_RANGE(): Explosion near mission trigger [TERMINATING]");
			return false;
		}
	}
	...
	if (unk.f_4 != 17)
	{
		...
		{
			func_322("IS_RC_FINE_AND_IN_RANGE(): No longer a valid player character to launch mission");
			return false;
		}
	}

	if (func_229(&(panParam0->f_48)) && bParam1)
		func_226(panParam0->f_28[0], &(panParam0->f_48), *panParam0);

	return true;
}

void func_226(Ped pedParam0, var uParam1, int iParam2) // Position - 0xE32B Hash - 0xD4C7D099 ^0x162C1E9
{
	int taskSequenceId;
	int taskSequenceId2;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_228(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(pedParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_227(iParam2) && !PED::IS_PED_FACING_PED(pedParam0, PLAYER::PLAYER_PED_ID(), 25f))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(pedParam0, PLAYER::PLAYER_PED_ID(), 0);
						uParam1->f_3 = 5;
					}
					else if (func_228(uParam1) && uParam1->f_4 == 0 && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(pedParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_227(iParam2) || PED::IS_PED_FACING_PED(pedParam0, PLAYER::PLAYER_PED_ID(), 10f))
				{
					if (func_71(uParam1->f_5, 0f, 0f, 0f, false))
						TASK::TASK_PLAY_ANIM(pedParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, false, false, false);
					else
...
BOOL func_227(int iParam0) // Position - 0xE683 Hash - 0xD681AEF7 ^0xD681AEF7
{
...
BOOL func_228(var uParam0) // Position - 0xE6A3 Hash - 0x42F869D4 ^0xFFADB180
{
...
BOOL func_229(var uParam0) // Position - 0xE6BB Hash - 0x6329B93C ^0xCBBB8D92
{
...
void func_230(var uParam0) // Position - 0xE6E0 Hash - 0x2E98ABB1 ^0xFF31A41F
{
	int i;
	int taskSequenceId;
	...
	if (*uParam0 == 52)
	{
		func_231(&uParam0->f_41[1]);
		func_231(&uParam0->f_41[2]);
	}
...
void func_231(Object* pobParam0) // Position - 0xE9E4 Hash - 0x4EAFEE58 ^0x34D7ECA6
{
...
void func_232(var uParam0) // Position - 0xEA0F Hash - 0x5209F824 ^0xCFA0F1CA
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xEA8F Hash - 0x53567DCF ^0x584F6887
{
	int i;
	int num;
	Vehicle playersLastVehicle;
	...
	if (func_135(PLAYER::PLAYER_PED_ID()))
	{
		for (i = 0; i <= num; i = i + 1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[i]))
			{
				...
				{
					func_322("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is dead [TERMINATING]");
					return false;
				}
			
				if (!VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_35[i], false))
				{
					func_322("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is not driveable [TERMINATING]");
					return false;
				}
			
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uParam0->f_35[i], PLAYER::PLAYER_PED_ID(), false))
				{
					func_322("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has been damaged by player [TERMINATING]");
					return false;
				}
			
				if (ENTITY::GET_ENTITY_HEALTH(uParam0->f_35[i]) < 850)
				{
					func_322("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle health is less than 850 [TERMINATING]");
					return false;
				}
				...
				if (bParam2)
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
					{
						...
						{
							func_322("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has collided with the player vehicle at speed [TERMINATING]");
							return false;
						}
						...
						if (func_188(playersLastVehicle))
						{
							...
							{
								if (func_188(uParam0->f_35[i]))
								{
									if (VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(playersLastVehicle, uParam0->f_35[i]))
									{
										func_322("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is being towed by player [TERMINATING]");
										return false;
									}
								}
							}
					...
					else
					{
						...
						if (func_188(playersLastVehicle2))
						{
							if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(uParam0->f_35[i], playersLastVehicle2) && ENTITY::GET_ENTITY_SPEED(playersLastVehicle2) > 6f)
							{
								func_322("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has collided with the player's last known vehicle at speed (player bailed out?) [TERMINATING]");
								return false;
							}
						}
						...
						if (*uParam0 == 16)
						{
							if (func_234(PLAYER::PLAYER_PED_ID(), uParam0->f_35[i]))
							{
								func_322("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Player attempting to jack Epsilon vehicle [TERMINATING]");
								return false;
							}
						}
					}
...
BOOL func_234(Ped pedParam0, Vehicle veParam1) // Position - 0xEC4D Hash - 0xFB12ABF0 ^0x730FD205
{
...
BOOL func_235(var uParam0, BOOL bParam1, int iParam2) // Position - 0xEC7D Hash - 0xE9BDE167 ^0x20C575FA
{
	int i;
	int num;
	...
	if (func_135(PLAYER::PLAYER_PED_ID()))
	{
		for (i = 0; i <= num; i = i + 1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[i]))
			{
				if (!PED::IS_PED_INJURED(uParam0->f_28[i]))
				{
					if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
					{
						if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), uParam0->f_28[i]))
						{
							...
							func_322("STEP_5_COMMON_RCfineAndInRange - Random character is being pushed by car [TERMINATING]");
							return false;
						}
					}
					...
					if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(uParam0->f_28[i]) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(uParam0->f_28[i]) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_OBJECT(uParam0->f_28[i]))
					{
						...
						func_322("STEP_5_COMMON_RCfineAndInRange - Random character has been damaged by something [TERMINATING]");
						return false;
					}
					...
					if (PED::IS_PED_RAGDOLL(uParam0->f_28[i]))
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(uParam0->f_28[i], PLAYER::PLAYER_PED_ID(), 3f, 3f, 3f, false, true, 0))
						{
							...
							func_322("STEP_5_COMMON_RCfineAndInRange - Random character is in ragdoll [TERMINATING]");
							return false;
						}
					}
					...
					if (func_254(*uParam0))
					{
						if (!func_168(*uParam0))
						{
							if (func_249(uParam0->f_28[i], true, false, false, false))
							{
								if (iParam2 == 0)
									func_230(uParam0);
								else
								...
								func_322("STEP_5_COMMON_RCfineAndInRange - Player is shooting near the Random Character [TERMINATING]");
								return false;
							}
						}
						...
						if (FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(uParam0->f_28[i], true), 15f))
						{
							...
							func_322("STEP_5_COMMON_RCfineAndInRange - There was an explosion near the Random Character [TERMINATING]");
							return false;
						}
					
						if (func_237(uParam0->f_28[i], 1126825984))
						{
							if (iParam2 == 0)
								func_230(uParam0);
							else
							...
							func_322("STEP_5_COMMON_RCfineAndInRange - Random character is in combat [TERMINATING]");
							return false;
						}
					}
					...
					if (!func_236(*uParam0))
					{
						...
						if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0)
						{
							...
							func_322("STEP_5_COMMON_RCfineAndInRange - Player has a wanted level [TERMINATING]");
							return false;
						}
					}
				}
				...
				{
					func_322("STEP_5_COMMON_RCfineAndInRange - Random character injured / dead [TERMINATING]");
...
BOOL func_236(int iParam0) // Position - 0xEF39 Hash - 0x9E3DCA43 ^0x9E3DCA43
{
...
BOOL func_237(Ped pedParam0, int iParam1) // Position - 0xEF6D Hash - 0x5EA05E45 ^0x7984EB04
{
	float xSize;
...
BOOL func_238(Ped pedParam0, int iParam1) // Position - 0xEFE3 Hash - 0xF1789D04 ^0x3F9D1900
{
	return func_239(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_239(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xEFFB Hash - 0x275BB58B ^0x275BB58B
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_240(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xF0BC Hash - 0xBBBECF07 ^0xBBBECF07
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_241(Ped pedParam0, int iParam1) // Position - 0xF1E8 Hash - 0xA6273130 ^0xF7D9CDEA
{
...
int func_242() // Position - 0xF2AD Hash - 0x1398F041 ^0xCD84FF69
{
	int i;
...
BOOL func_243(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xF2F7 Hash - 0x6EF1707D ^0x8C069CF9
{
	var unk;
...
float func_244(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xF388 Hash - 0x596BEA29 ^0x5FBCDBE5
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_245(float fParam0, var uParam1, var uParam2) // Position - 0xF3A9 Hash - 0xFB6A39D2 ^0x80C9C759
{
	float num;
	float num2;
...
void func_246(var uParam0) // Position - 0xF3E8 Hash - 0xA4B72113 ^0x62A5EAE1
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_247(Ped pedParam0, Ped pedParam1) // Position - 0xF403 Hash - 0xAA445031 ^0xEBA3F8CF
{
	int i;
...
BOOL func_248(Ped pedParam0) // Position - 0xF442 Hash - 0xEC80536A ^0x2D4CF2B0
{
...
BOOL func_249(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF46A Hash - 0x5B46DA49 ^0x44F718
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_250(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF565 Hash - 0x1310B579 ^0x2AAFC0CC
{
	float entityCoords;
	float num;
...
BOOL func_251(Ped pedParam0, float fParam1) // Position - 0xF671 Hash - 0xFA3D7088 ^0x33A74060
{
	var outProjectile;
	var outCoords;
...
BOOL func_252(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF706 Hash - 0x3F40E5FA ^0xC3BEFE6A
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_253(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF794 Hash - 0x18BAE105 ^0x60D3B20E
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_254(int iParam0) // Position - 0xF7DC Hash - 0x5B443B41 ^0x5B443B41
{
...
void func_255(Vehicle veParam0) // Position - 0xF826 Hash - 0xAD821AF8 ^0x3A9158E6
{
	int taskSequenceId;
...
BOOL func_256(int iParam0) // Position - 0xF8C3 Hash - 0x6F2BC7EE ^0x6F2BC7EE
{
	if (iParam0 == -1)
		iParam0 = func_176();
...
BOOL func_257(int iParam0) // Position - 0xF958 Hash - 0xDE7BA54D ^0xDE7BA54D
{
...
BOOL func_258() // Position - 0xF997 Hash - 0x29CB2928 ^0xE369A18D
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_259() // Position - 0xF9B4 Hash - 0x98CCC132 ^0x97B0D6ED
{
	if (Global_98294 != -1)
...
BOOL func_260(int iParam0) // Position - 0xF9D7 Hash - 0xC2630182 ^0xFBD23031
{
	if (func_261() && Global_101392.f_11 == 6 && iParam0 == func_177(&(Global_101392.f_3), 0))
		return true;

	return false;
}

BOOL func_261() // Position - 0xFA0B Hash - 0x25806CBF ^0x25806CBF
{
...
BOOL func_262(int iParam0) // Position - 0xFA49 Hash - 0x1156B580 ^0x34C7FA05
{
...
void func_263() // Position - 0xFA71 Hash - 0xB70CD18F ^0x7CAF6F30
{
	var unk;
	float num;

	unk = { 190.2424f, -956.479f, 29.08f };
	num = 12f;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()))
		if (func_264(PLAYER::PLAYER_PED_ID(), unk, num, true))
			func_161();

	return;
}

BOOL func_264(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5) // Position - 0xFAB4 Hash - 0x9A4C1B16 ^0x6EACDAB9
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(pedParam0, bParam5), vParam1) <= fParam4 * fParam4;
}

void func_265(var uParam0) // Position - 0xFAD2 Hash - 0x8F495B9C ^0xA1B71726
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]))
	{
		PED::SET_PED_RESET_FLAG(uParam0->f_28[0], 64, true);
		PED::SET_PED_RESET_FLAG(uParam0->f_28[0], 249, true);
...
void func_266(var uParam0) // Position - 0xFB42 Hash - 0x25247C40 ^0x3EB44957
{
	int i;
	...
	if (*uParam0 == 2 || *uParam0 == 3)
	{
		for (i = 0; i <= 5; i = i + 1)
		{
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_41[i]))
				ENTITY::FREEZE_ENTITY_POSITION(uParam0->f_41[i], false);
		}
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xFBDC Hash - 0x6C235EE0 ^0x9E57F206
{
...
int func_268() // Position - 0xFC77 Hash - 0x5A4670E ^0xE582B183
{
	return PED::ADD_SCENARIO_BLOCKING_AREA(-564f, -1758.1f, 16.5f, -419.31f, -1649f, 23f, false, true, true, true, 1);
}

BOOL func_269(var uParam0) // Position - 0xFCA6 Hash - 0x24D26100 ^0x24D26100
{
	switch (*uParam0)
	{
		case 2:
	...
	{
		func_271(&uLocal_95);
		func_270(&uLocal_95, "democ_only_works");
		func_270(&uLocal_95, "gift_from_god");
		func_270(&uLocal_95, "rigged_vote");
		func_270(&uLocal_95, "suck_my");
		func_270(&uLocal_95, "tyranny");
	}

	func_322("Created initial scene");
	return true;
}

void func_270(var uParam0, char* sParam1) // Position - 0xFD88 Hash - 0x92325A63 ^0xF754EA24
{
...
void func_271(var uParam0) // Position - 0xFDB1 Hash - 0x2F6A3876 ^0xD68C672F
{
	int i;
...
BOOL func_272(var uParam0) // Position - 0xFDDE Hash - 0x71136E5B ^0x964217D2
{
	uParam0->f_16 = 3;
...
BOOL func_273(var uParam0) // Position - 0xFE09 Hash - 0x3ECE7523 ^0x3ECE7523
{
	int num;
	var unk4;
	var unk7;
	...
	num = 3;
	unk4 = { -468.9f, -1713.06f, 18.21f };
	unk7 = { -426.56f, -1717.89f, 18.2f };
	vector = { -0.1f, -0.85f, 0.23f };
	vector2 = { 8f, 0.5f, 0f };
	num2 = -76.2f;
	num3 = 43.5f;
	num[0] = joaat("emperor2");
	num[1] = joaat("prop_weed_tub_01");
	num[2] = joaat("towtruck");
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_275(&uParam0->f_35[0], num[0], unk4, num2);
			...
			{
				func_274(&uParam0->f_41[0], num[1], unk4 + vector, 0f);
			
				if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
					ENTITY::ATTACH_ENTITY_TO_ENTITY(uParam0->f_41[0], uParam0->f_35[0], 0, vector, vector2, false, false, false, false, 2, true, 0);
				else
					flag = false;
			}
			...
			{
				func_275(&uParam0->f_35[1], num[2], unk7, num3);
...
void func_274(Object* pobParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0x10090 Hash - 0x61F651EE ^0x2FE58679
{
	func_231(pobParam0);
...
void func_275(Vehicle* pveParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5) // Position - 0x100B7 Hash - 0x60B41505 ^0x2C4B5209
{
	func_276(pveParam0);
...
void func_276(Vehicle* pveParam0) // Position - 0x100FA Hash - 0x8D18F713 ^0xF71A18A8
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_277(var uParam0) // Position - 0x10196 Hash - 0xC42B20E0 ^0x728F1DAE
{
	int i;
...
BOOL func_278(var uParam0) // Position - 0x101C7 Hash - 0x8F06113E ^0x8F06113E
{
	int num;
	var unk5;
	Vector3 vector;
	...
	num = 4;
	unk5 = { 1199.8f, -1259.22f, 34.23f };
	vector = { 0f, -1f, 0.64f };
	unk10 = { 1195.3f, -1312.74f, 34.75f };
	num2 = 174.7f;
	num3 = 282.4f;
	num[0] = joaat("dloader");
	num[1] = joaat("prop_weed_tub_01b");
	num[2] = joaat("police4");
	num[3] = joaat("A_M_Y_Business_01");
	...
	switch (iLocal_89)
	{
		...
		case 2:
			flag = true;
			func_275(&uParam0->f_35[0], num[0], unk5, num2);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
			{
				func_274(&uParam0->f_41[0], num[1], unk5 + vector, 0f);
			
				if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
					ENTITY::ATTACH_ENTITY_TO_ENTITY(uParam0->f_41[0], uParam0->f_35[0], 0, vector, 0f, 0f, 0f, false, false, true, false, 2, true, 0);
				else
					flag = false;
			}
		
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[1]))
				func_275(&uParam0->f_35[1], num[2], unk10, num3);
		
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				func_279(&uParam0->f_28[0], num[3], unk10, num3, PED_TYPE_COP);
		
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[1]))
				func_279(&uParam0->f_28[1], num[3], unk10, num3, PED_TYPE_COP);
...
void func_279(Ped* ppedParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, ePedType eptParam6) // Position - 0x10517 Hash - 0x616C5024 ^0x190F8C82
{
	func_280(ppedParam0);
...
void func_280(Ped* ppedParam0) // Position - 0x10538 Hash - 0xCA79453F ^0x7BA88177
{
...
BOOL func_281(var uParam0) // Position - 0x10579 Hash - 0xAB8D0D1E ^0xD2836496
{
	int num;
	var unk3;
	float num2;
	...
	switch (iLocal_89)
	{
		case 0:
			...
			func_286(&(uParam0->f_48), "rcm_barry3", "bar_3_rcm_barry_standing_on_street_base", "bar_3_rcm_barry_standing_on_street_fidget");
			iLocal_89 = 1;
			break;
	
		case 1:
			if (!func_277(&num) || !func_285(&(uParam0->f_48)))
				return false;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				if (func_282(&uParam0->f_28[0], CHAR_BARRY, unk3, num2, "RC LAUNCHER: BARRY 3", 1))
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
			{
				func_274(&uParam0->f_41[0], num[1], unk3 + { 0f, 0f, 5f }, -115.18f);
...
BOOL func_282(Ped* ppedParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x10771 Hash - 0x5E27D69A ^0xE8A3C3CE
{
	if (func_283(ppedParam0, echParam1, uParam2, fParam5, true))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
BOOL func_283(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x107CD Hash - 0xC57592AD ^0x9AA0BE7
{
	Hash model;

	if (!func_36(echParam1))
	{
		model = func_325(echParam1);
...
int func_284(Ped pedParam0, eCharacter echParam1) // Position - 0x1085B Hash - 0x5AC42C11 ^0x5AC42C11
{
	int num;
...
BOOL func_285(var uParam0) // Position - 0x108A1 Hash - 0xB319BDFA ^0xA1F4DAFB
{
	if (func_229(uParam0))
	{
...
void func_286(var uParam0, char* sParam1, char* sParam2, char* sParam3) // Position - 0x108CB Hash - 0x6EEDFC2 ^0xD51569DC
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
BOOL func_287(var uParam0) // Position - 0x10907 Hash - 0xB788BF34 ^0x2047409E
{
	int num;
	Vector3 vector;
	float heading;
	...
	num = 5;
	vector = { 190.2424f, -956.479f, 29.08f };
	heading = 69.171f;
	num[0] = iLocal_90;
	num[1] = joaat("prop_protest_table_01");
	num[2] = joaat("prop_chair_08");
	num[3] = joaat("p_a4_sheets_s");
	num[4] = joaat("prop_protest_sign_01");

	switch (iLocal_89)
	{
		case 0:
			uParam0->f_16 = 5;
			TEXT_LABEL_ASSIGN_STRING(&(uParam0->f_9), "BAR_3_RCM", 24);
			uParam0->f_25 = 1;
			uParam0->f_27 = 0;
			...
			func_286(&(uParam0->f_48), "rcm_barry2", "lead_in_loop", "lead_in_loop");
			iLocal_89 = 1;
			break;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				if (func_282(&uParam0->f_28[0], CHAR_BARRY, vector, heading, "RC LAUNCHER: BARRY 2", 1))
					PED::SET_PED_PROP_INDEX(uParam0->f_28[0], 1, 0, 0, false, 1);
				else
					flag = false;
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
			{
				...
				func_274(&uParam0->f_41[0], num[1], 189.5964f, -956.0344f, 29.09179f, func_289(-2.01f));
			
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_41[0]))
				{
					ENTITY::FREEZE_ENTITY_POSITION(uParam0->f_41[0], true);
					func_274(&uParam0->f_41[2], num[3], 189.79015f, -956.1675f, 29.8229f, func_289(-2.01f));
			...
			{
				func_274(&uParam0->f_41[1], num[2], 190.417f, -956.511f, 29.09179f, -99.157f);
		...
		case 3:
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]))
			{
				...
				ENTITY::SET_ENTITY_COORDS(uParam0->f_28[0], vector, true, false, false, true);
				ENTITY::SET_ENTITY_HEADING(uParam0->f_28[0], heading);
				ENTITY::FREEZE_ENTITY_POSITION(uParam0->f_28[0], true);
				TASK::TASK_PLAY_ANIM(uParam0->f_28[0], uParam0->f_48, uParam0->f_48.f_1, 8f, -8f, -1, 9, 0, false, false, false);
...
void func_288(Object* pobParam0, Hash hParam1) // Position - 0x10CA6 Hash - 0xB32708AF ^0xB32708AF
{
	var unk;
	float num;

	unk = { 192.4462f, -953.5946f, 29.0919f };
	num = 23.45f;
	func_274(pobParam0, hParam1, unk, num);
	return;
}

float func_289(float fParam0) // Position - 0x10CD6 Hash - 0xC531A009 ^0xC531A009
{
	return fParam0 * 57.29578f;
}

BOOL func_290(var uParam0) // Position - 0x10CE6 Hash - 0x3856D533 ^0xE408A0A9
{
	int num;
	Vector3 vector;
	float heading;
	...
	num = 7;
	vector = { 190.2424f, -956.379f, 28.63f };
	heading = func_289(1.12f);
	num[0] = iLocal_90;
	num[1] = joaat("prop_protest_table_01");
	num[2] = joaat("prop_chair_08");
	num[3] = joaat("p_a4_sheets_s");
	num[4] = joaat("p_cs_lighter_01");
	num[5] = joaat("p_cs_joint_01");
	num[6] = joaat("prop_protest_sign_01");

	switch (iLocal_89)
	{
		case 0:
			uParam0->f_16 = 5;
			TEXT_LABEL_ASSIGN_STRING(&(uParam0->f_9), "BAR_1_RCM_P2", 24);
			uParam0->f_25 = 1;
			uParam0->f_27 = 0;
			uParam0->f_17[0 /*3*/] = { 190.03151f, -956.3355f, 29.091919f };
			uParam0->f_17[1 /*3*/] = { 178.04579f, -950.6594f, 31.093576f };
			...
			func_286(&(uParam0->f_48), "RCMBarryLeadInOut", "idle", "fidget");
			iLocal_89 = 1;
			break;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				if (func_282(&uParam0->f_28[0], CHAR_BARRY, vector, heading, "RC LAUNCHER: BARRY 1", 1))
					PED::SET_PED_PROP_INDEX(uParam0->f_28[0], 1, 0, 0, false, 1);
				else
					flag = false;
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[1]))
			{
				func_274(&uParam0->f_41[1], num[2], 190.2574f, -956.3513f, 29.09179f, func_289(-1.68f));
		...
		case 3:
			...
			func_274(&uParam0->f_41[4], num[5], 189.895f, -955.945f, 29.818f, 0f);
		
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_41[4]))
			{
				ENTITY::SET_ENTITY_ROTATION(uParam0->f_41[4], -90f, 0f, -30.8f, 2, true);
				ENTITY::FREEZE_ENTITY_POSITION(uParam0->f_41[4], true);
			}
		
			func_274(&uParam0->f_41[3], num[4], 189.783f, -956.015f, 29.79f, 0f);
...
BOOL func_291(int iParam0) // Position - 0x11145 Hash - 0x59D2F680 ^0x59D2F680
{
	var unk;
	eCharacter character;
...
BOOL func_292(int iParam0) // Position - 0x11196 Hash - 0xC6B32843 ^0xDD5D54EC
{
	const char* string2;

	if (Global_79248)
	{
		func_322("STEP_3_COMMON_CanRCLaunch - Script denied. Multiplayer is running [TERMINATING]");
		return false;
	}

	if (!Global_114370.f_9088 && !_IS_MISSION_REPEAT_ACTIVE(true))
	{
		func_322("STEP_3_COMMON_CanRCLaunch - Script denied, game flow is not active");
		return false;
	}
	...
	{
		Global_113457[iParam0 /*10*/].f_1 = 1;
		func_322("STEP_3_COMMON_CanRCLaunch - Script denied by RC Controller [TERMINATING]");
		return false;
	}
	...
	if (Global_101392.f_11 == 6)
	{
		if (Global_101392 < 9)
		{
			...
			{
				func_322("STEP_3_COMMON_CanRCLaunch - Script denied as a replay for this RC is being configured. [TERMINATING]");
				return false;
			}
		}
	}
	...
	{
		Global_113457[iParam0 /*10*/].f_1 = 1;
		func_322("STEP_3_COMMON_CanRCLaunch - Script denied as candidate_controller is not running. [TERMINATING]");
		return false;
	}
...
BOOL func_293(int iParam0) // Position - 0x1124F Hash - 0x791D84F4 ^0x791D84F4
{
	var unk;
...
BOOL func_294(int iParam0) // Position - 0x11310 Hash - 0xDEAD9A68 ^0xDEAD9A68
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_295(int iParam0, char* sParam1) // Position - 0x11395 Hash - 0xC64245F ^0x76D9DBC9
{
...
BOOL func_296(int iParam0) // Position - 0x11477 Hash - 0x5ADD7F05 ^0x5ADD7F05
{
...
BOOL func_297(int iParam0) // Position - 0x114A2 Hash - 0xBB053D24 ^0xBB053D24
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_298(int iParam0) // Position - 0x114CD Hash - 0x5D95A044 ^0x5D95A044
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_299(int iParam0) // Position - 0x114F8 Hash - 0x9FFC81CD ^0x47A2AB8B
{
	if (func_257(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
void func_300() // Position - 0x1152D Hash - 0x5631C87C ^0xC54F1B57
{
	func_322("Running end routines.");
	Global_114088 = Global_114088 - 1;
	return;
}

BOOL func_301(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x11547 Hash - 0x95B98194 ^0x95B98194
{
	int num;
	int i;

	if (_GET_CURRENT_PLAYER_CHARACTER_0() == CHAR_MICHAEL)
		if (func_302(2, uParam1, fParam4, uParam0))
			return true;
	else if (_GET_CURRENT_PLAYER_CHARACTER_0() == CHAR_TREVOR)
		if (func_302(3, uParam1, fParam4, uParam0))
			return true;
	...
	for (i = 0; i < num; i = i + 1)
	{
		if (func_302(num[i], uParam1, fParam4, uParam0))
		{
			i = num;
			return true;
		}
...
BOOL func_302(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x115D8 Hash - 0xC6B7068B ^0xB9A971A4
{
	int num;
	char* str;
	...
	if (func_303(str.f_6, uParam1, fParam4, false))
	{
...
BOOL func_303(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x11650 Hash - 0x1FB736D4 ^0x234AEAB7
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_304(var uParam0, BOOL bParam1) // Position - 0x116CB Hash - 0x998A732A ^0x8E06AC2
{
	char* str;

	if (bParam1)
	{
		func_322("SCRIPT TERMINATING: Cleaning up entities in Launcher");
		func_266(uParam0);
		func_311(uParam0, 0, false, false);
	}

	if (HUD::DOES_BLIP_EXIST(blLocal_94))
		HUD::REMOVE_BLIP(&blLocal_94);

	if (iLocal_91 != -1)
	{
		func_322("SCRIPT TERMINATING: Ending off-mission cutscene request");
		func_223(&iLocal_91);
	}
...
void func_305(char* sParam0) // Position - 0x11760 Hash - 0xA52CF679 ^0xC94F8C8B
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
		if (func_308(sParam0))
			func_306();
...
void func_306() // Position - 0x1177F Hash - 0xC536DD5 ^0xC536DD5
{
	Global_21032 = 0;
	func_307();
	return;
...
void func_307() // Position - 0x1178F Hash - 0xF6D04E68 ^0x80AE5309
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_23177 = 0;
...
BOOL func_308(char* sParam0) // Position - 0x117B0 Hash - 0x5CF3EDA6 ^0x878C8302
{
	var string1;
...
struct<6> func_309() // Position - 0x117D0 Hash - 0xB37EF8EF ^0xB37EF8EF
{
	var unk;
...
int func_310(var uParam0) // Position - 0x117F4 Hash - 0x86633390 ^0xD72DCD71
{
	if (func_229(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_311(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1182A Hash - 0x5BE1D1E3 ^0x5BE1D1E3
{
	func_318(uParam0, iParam1);
	func_315(uParam0, bParam2);
	func_312(uParam0, bParam3);
	return;
}

void func_312(var uParam0, BOOL bParam1) // Position - 0x1184A Hash - 0xEDC3BD2D ^0xE0B6F056
{
	func_313(&(uParam0->f_41), bParam1);
	return;
}

void func_313(var uParam0, BOOL bParam1) // Position - 0x1185C Hash - 0x9E80EA71 ^0x9E80EA71
{
	int i;
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (bParam1)
			...
			func_314(&uParam0->[i], false);
	}

	return;
}

void func_314(Object* pobParam0, BOOL bParam1) // Position - 0x1189A Hash - 0xD7EE3E27 ^0xC5769B29
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_315(var uParam0, BOOL bParam1) // Position - 0x118D5 Hash - 0xEDC3BD2D ^0xE2474F74
{
	func_316(&(uParam0->f_35), bParam1);
	return;
}

void func_316(var uParam0, BOOL bParam1) // Position - 0x118E7 Hash - 0xA98F6284 ^0xA98F6284
{
	int i;
...
void func_317(Vehicle* pveParam0) // Position - 0x11924 Hash - 0xC50F9886 ^0x638B6124
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_318(var uParam0, int iParam1) // Position - 0x1195C Hash - 0xEDC3BD2D ^0xA9A19095
{
	func_319(&(uParam0->f_28), iParam1);
	return;
}

void func_319(var uParam0, int iParam1) // Position - 0x1196E Hash - 0xB72ACFD2 ^0xB72ACFD2
{
	int i;
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_320(&uParam0->[i], false, 1, 0);
	}

	return;
}

void func_320(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x119AF Hash - 0x34362197 ^0xC592197
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_321(int iParam0) // Position - 0x119FF Hash - 0x995C9E2 ^0x995C9E2
{
	if (*iParam0 == -1)
		return;
...
void func_322(char* sParam0) // Position - 0x11A3C Hash - 0x54B64147 ^0x56EEAFB9
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_323(var uParam0) // Position - 0x11A4E Hash - 0x4CD8BCE8 ^0xBF7578E7
{
	*uParam0 = -1;
...
void func_324() // Position - 0x11A81 Hash - 0x554DA35 ^0xCE75B5F6
{
	func_322("Running start routines.");
	Global_114088 = Global_114088 + 1;
	return;
}

Hash func_325(eCharacter echParam0) // Position - 0x11A9B Hash - 0xBF0B24A5 ^0xBF0B24A5
{
	if (!func_36(echParam0))
