...
void main() // Position - 0x0
{
	...
	iLocal_90 = func_303(CHAR_DREYFUSS);
	...
	{
		func_300("Force cleanup [TERMINATING]");
	
		if (num != -1)
		{
			if (Global_113056[num /*10*/].f_9 != -1)
			{
				func_300("Relinquishing candidate id...");
				func_299(&(Global_113056[num /*10*/].f_9));
			}
		}
	...
	if (!func_278(&unk63, &num, vector, 1f))
	{
		func_277();
		func_300("SCRIPT TERMINATED");
	...
	while (!func_250(&num))
	{
		...
		{
			func_300("Player out of range [TERMINATING]");
			func_281(&num, true);
		}
	}
	...
	while (true)
	{
		...
		func_210(num);
		func_203(&iLocal_96, &(num.f_9), vector);
	
		if (num == 8)
			func_199(&num, vector, "DREY1AU", "DREY1_IDLE", 3, "DREYFUSS", 5000, 1101004800);
	
		if (func_193(&num, 0) || func_181())
		{
			if (!func_2(&num))
				func_281(&num, true);
...
BOOL func_2(Any* panParam0) // Position - 0x271
{
	...
	if (!_IS_MISSION_REPLAY_IN_PROGRESS())
	{
		while (!func_171(*panParam0))
		{
			...
			{
				func_300("LAUNCH_RC_MISSION - NOT IS_RC_FINE_AND_IN_RANGE() [TERMINATING]");
				return false;
			}
	...
	{
		func_300("STEP_7_COMMON_LaunchMission - Trying to launch a null script string name");
		return false;
	}
...
var func_15(Hash hParam0) // Position - 0xBB4
{
	var outValue;
...
void func_25(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0x19B4
{
	int i;
	eCharacter j;
...
void func_27(var uParam0, int iParam1, Ped pedParam2, int iParam3, int iParam4, int iParam5) // Position - 0x285F
{
	Vehicle vehicle;
...
int func_28(var uParam0, int iParam1, Vehicle veParam2, int iParam3) // Position - 0x28E7
{
...
int func_49(int iParam0, int iParam1) // Position - 0x38AE
{
	Hash statHash;
	int outValue;
...
Hash func_50(int iParam0, int iParam1) // Position - 0x38DD
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_51(iParam1));
}

int func_51(int iParam0) // Position - 0x38F2
{
	int num;
	int num2;
...
int func_52() // Position - 0x3926
{
	return Global_1574926;
}

BOOL func_53(int iParam0, int iParam1) // Position - 0x3932
{
	Hash statHash;
	BOOL outValue;
...
Hash func_54(int iParam0, int iParam1) // Position - 0x3956
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_51(iParam1));
}

void func_55(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x396B
{
	eCharacter character;
...
void func_56(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3EB4
{
	eCharacter character;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x40F6
{
	func_58();
	return Global_113969.f_2366.f_539.f_4321;
}

void func_58() // Position - 0x410F
{
	eCharacter character;
...
BOOL func_59(int iParam0) // Position - 0x420C
{
	return Global_44042 == iParam0;
}

void func_60(Ped pedParam0, BOOL bParam1) // Position - 0x421A
{
	eCharacter character;
...
void func_61(Ped pedParam0, var uParam1) // Position - 0x430D
{
	int i;
	int j;
	Hash k;
...
BOOL func_62(int iParam0) // Position - 0x4595
{
	switch (iParam0)
	{
...
BOOL func_63(int iParam0) // Position - 0x4636
{
...
Hash func_64(Hash hParam0, int iParam1) // Position - 0x4828
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_65(Hash hParam0, Any* panParam1) // Position - 0x5569
{
	int i;
	int numDlcWeapons;
...
Hash func_66(int iParam0) // Position - 0x55A4
{
	int num;
...
void func_67(Ped pedParam0) // Position - 0x5818
{
	eCharacter character;
...
void func_68(var uParam0, int iParam1) // Position - 0x5854
{
	var unk;
	var unk2;
	var unk5;
...
BOOL func_69(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5DA3
{
...
BOOL func_70(int iParam0, var uParam1, var uParam2) // Position - 0x5DE7
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x6566
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x65AD
{
...
BOOL func_73(int iParam0) // Position - 0x6608
{
	return func_74(iParam0, 0, true);
}

BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x6618
{
	if (iParam0 == -1)
		return false;
...
int func_75(int iParam0) // Position - 0x6678
{
	switch (iParam0)
	{
		case 0:
...
int func_76() // Position - 0x6A20
{
	return Global_32948;
}

BOOL func_77(int iParam0) // Position - 0x6A2B
{
	return func_74(iParam0, 5, true);
}

int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6A3B
{
	int i;
...
Vector3 func_79(int iParam0, BOOL bParam1) // Position - 0x6ADD
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_80() // Position - 0x723C
{
...
int func_81() // Position - 0x7537
{
	return Global_2652592.f_2671;
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x7546
{
...
ePedComponentType func_83() // Position - 0x7570
{
	return Global_2657971[PLAYER::PLAYER_ID() /*465*/].f_322.f_8;
}

Vector3 func_84(float fParam0, float fParam1, float fParam2) // Position - 0x7588
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_85(), 0f, fParam0);
}

Vector3 func_85() // Position - 0x759D
{
	return -880f, -2770f, -50f;
}

BOOL func_86(ePedComponentType epctParam0) // Position - 0x75B4
{
...
Vector3 func_87(int iParam0, int iParam1) // Position - 0x760C
{
	var unk;
	var unk7;
...
BOOL func_88(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x76B6
{
	var unk;
	Vector3 vector;
	var unk12;
...
Vector3 func_89(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x774B
{
	float num;
	float num2;
	float num3;
...
struct<6> func_90(int iParam0) // Position - 0x778F
{
	var unk;
...
struct<6> func_91(int iParam0) // Position - 0x7913
{
	return func_92(iParam0);
}

struct<6> func_92(int iParam0) // Position - 0x7921
{
	var unk;
...
BOOL func_93(int iParam0, var uParam1) // Position - 0x83E9
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_94(ePedComponentType epctParam0) // Position - 0x846B
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x84C3
{
	return -1;
}

Vector3 func_96(int iParam0) // Position - 0x84CC
{
	switch (iParam0)
	{
		case 1:
...
int func_97() // Position - 0x8738
{
	return func_98(PLAYER::PLAYER_ID());
}

int func_98(Player plParam0) // Position - 0x8748
{
	return MISC::GET_BITS_IN_RANGE(Global_2657971[plParam0 /*465*/].f_322.f_3, 28, 31);
}

BOOL func_99(int iParam0) // Position - 0x8765
{
	return func_74(iParam0, 0, false);
}

int func_100(int iParam0) // Position - 0x8775
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_101() // Position - 0x8AAB
{
	return Global_101585.f_393 > 0;
}

var func_102() // Position - 0x8ABC
{
	var unk;
...
void func_103(var uParam0, int iParam1) // Position - 0x8B02
{
	if (iParam1 <= 0)
		return;
...
void func_104(var uParam0, int iParam1) // Position - 0x8B88
{
...
void func_105(var uParam0, int iParam1) // Position - 0x8BBB
{
	int num;
	int num2;
...
int func_106(int iParam0, int iParam1) // Position - 0x8C0C
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_107(int iParam0) // Position - 0x8CAE
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_108(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8CD0
{
	if (bParam0)
		return uParam1;
...
int func_109(int iParam0) // Position - 0x8CE7
{
	return iParam0 & 15;
}

void func_110(var uParam0, int iParam1) // Position - 0x8CF4
{
...
void func_111(var uParam0, int iParam1) // Position - 0x8D2E
{
...
void func_112(var uParam0, int iParam1) // Position - 0x8D69
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8DA5
{
	func_58();
	return Global_113969.f_2366.f_539.f_4321;
}

void func_114(int iParam0) // Position - 0x8DBE
{
	int num;
	var textLabel;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8E17
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x8E2D
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_117(char* sParam0, Any anParam1, int iParam2) // Position - 0x8E43
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8E85
{
...
struct<2> func_119(int iParam0) // Position - 0x8EAD
{
	var unk;
...
void func_120(int iParam0, var uParam1) // Position - 0x92FA
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0) // Position - 0xA5D2
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_123(Any* panParam0) // Position - 0xA918
{
	int threadId;
	...
	if (func_154(&(panParam0->f_1)))
	{
		...
		{
			func_300("Initial cutscene loaded and passing to RC mission.");
			CUTSCENE::SET_SCRIPT_CAN_START_CUTSCENE(threadId);
		}
		else
		{
			func_300("Initial cutscene wasn't loaded in time to pass to RC mission.");
...
void func_124(int iParam0) // Position - 0xA9BD
{
	var name;
...
void func_125(int iParam0) // Position - 0xAA58
{
	if (iParam0 < 63)
	{
		func_126();
...
void func_127(Ped pedParam0) // Position - 0xAAB6
{
	int num;
	int num2;
	int num3;
...
void func_128(int iParam0) // Position - 0xAB0F
{
...
int func_129(Ped pedParam0) // Position - 0xAB92
{
	int i;
...
void func_130(int iParam0, int iParam1, int iParam2) // Position - 0xABC3
{
	func_131(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_131(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xABD8
{
	int num;
...
BOOL func_133(int iParam0, int iParam1, int iParam2) // Position - 0xAC8B
{
...
int func_134(int iParam0, int iParam1, int iParam2) // Position - 0xACA6
{
	int i;
...
int func_135(Ped pedParam0) // Position - 0xACF2
{
	int i;
...
BOOL func_136(Ped pedParam0) // Position - 0xAD3B
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xAD5B
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_138(int iParam0) // Position - 0xAD7C
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_140(int iParam0) // Position - 0xAE4C
{
	switch (iParam0)
	{
		case 5:
...
void func_141(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xAE9F
{
	int i;
...
BOOL func_142(int iParam0) // Position - 0xAF94
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0) // Position - 0xAFFF
{
	Player playerIndex;
...
void func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB03E
{
	if (bParam0)
	{
...
BOOL func_145() // Position - 0xB18B
{
	return IS_BIT_SET(Global_1845281[PLAYER::PLAYER_ID() /*883*/].f_36.f_18, 14);
}

BOOL func_146(Player plParam0, int iParam1) // Position - 0xB1A5
{
	BOOL flag;
...
int func_147(int iParam0, BOOL bParam1) // Position - 0xB1FE
{
	int num;
	int num2;
...
BOOL func_148(Player plParam0) // Position - 0xB23F
{
	Player player;
...
BOOL func_149(Player plParam0) // Position - 0xB261
{
...
BOOL func_150() // Position - 0xB2A0
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_151(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB2AE
{
	int num;
...
void func_153(int iParam0) // Position - 0xB308
{
	if (iParam0 == 1)
...
BOOL func_154(const char* sParam0) // Position - 0xB32B
{
	...
	func_300("Attempting to launch invalid script file [TERMINATING]");
	return false;
}

void func_155() // Position - 0xB368
{
	Global_21152 = 0;
	func_156();
	return;
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB3CF
{
...
BOOL func_160(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB45E
{
...
void func_161(Vehicle veParam0) // Position - 0xB4B5
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_162(BOOL bParam0, BOOL bParam1) // Position - 0xB4E1
{
...
void func_164(int iParam0) // Position - 0xB683
{
	if (func_169())
		return;
...
void func_165(int iParam0) // Position - 0xB6B6
{
	if (func_169())
		return;
...
void func_166(BOOL bParam0, BOOL bParam1) // Position - 0xB740
{
	if (bParam0)
	{
		if (func_168(0))
...
BOOL func_167() // Position - 0xB7B4
{
	return IS_BIT_SET(Global_1956920, 5);
}

BOOL func_168(int iParam0) // Position - 0xB7C2
{
	if (iParam0 == 1)
...
BOOL func_169() // Position - 0xB819
{
	return IS_BIT_SET(Global_1956920, 19);
}

BOOL func_170(int iParam0) // Position - 0xB828
{
...
BOOL func_171(int iParam0) // Position - 0xB869
{
	int num;
...
void func_172(int iParam0) // Position - 0xB8AE
{
...
int func_173(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB8E0
{
	int i;
...
void func_174(int iParam0, int iParam1) // Position - 0xBA17
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBA66
{
	return func_176(iParam0, Global_44042);
}

BOOL func_176(int iParam0, int iParam1) // Position - 0xBA77
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_177(int iParam0) // Position - 0xBC58
{
	if (Global_44042 == 15)
		return false;
...
int func_178() // Position - 0xBC7A
{
	return func_179(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_179(const char* sParam0, int iParam1) // Position - 0xBC8B
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBCD4
{
	if (Global_101533 == 10 || Global_101533 == 9)
		return true;
...
int func_181() // Position - 0xBCF8
{
	if (func_184(2))
	{
		if (func_183(PLAYER::PLAYER_PED_ID(), -1459.68f, 485.26f, 116.22f, true) < 6f && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
				func_300("Special launching Dreyfuss1");
				return 1;
			}
			else if (!func_182(PLAYER::PLAYER_PED_ID(), SCRIPT_TASK_LEAVE_ANY_VEHICLE) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)) && func_160(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 1f, 1, 1056964608, false, true, false))
			{
				TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
			}
		}
...
BOOL func_182(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0xBD99
{
...
float func_183(Ped pedParam0, float fParam1, float fParam2, float fParam3, BOOL bParam4) // Position - 0xBDCC
{
...
BOOL func_184(int iParam0) // Position - 0xBE06
{
	eCharacter character;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_192() || Global_113016 || Global_32951 || func_191() || func_190(8, -1) || func_101() || func_189() || func_188() || func_187() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_192() || Global_32951 || func_191() || func_190(8, -1) || func_188() || func_101() || func_189() || func_187() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_192() || Global_113016 || Global_32951 || func_191() || func_190(8, -1) || func_188() || func_101() || func_189() || func_187() || Global_113969.f_7691.f_919[character] == 5 || Global_44589 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_192() || Global_113016 || Global_32951 || func_191() || func_190(8, -1) || func_101() || func_189() || func_187() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_192() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_190(8, -1) || func_187() || func_186() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 5:
						if (func_190(8, -1) || func_101() || func_189() || func_186() || func_185())
							return false;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_192() || Global_32951 || func_191() || func_190(8, -1) || func_189() || func_188() || func_187() || Global_113969.f_7691.f_919[character] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_192() || func_189() || Global_113016 || Global_32951 || func_191() || Global_45250 || func_190(8, -1) || func_188() || func_186() || func_187() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 8:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_192() || Global_113016 || Global_32951 || func_191() || func_190(8, -1) || func_188() || func_186() || func_101() || func_189() || func_187())
							return false;
						break;
				}
			}
...
BOOL func_185() // Position - 0xC524
{
	return Global_101572.f_1;
}

BOOL func_186() // Position - 0xC532
{
	if (Global_98435 != -1)
...
BOOL func_189() // Position - 0xC599
{
	return Global_101585.f_394 > 0;
}

BOOL func_190(int iParam0, int iParam1) // Position - 0xC5AA
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_191() // Position - 0xC5E2
{
	return Global_1575083;
}

BOOL func_192() // Position - 0xC5EE
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
int func_193(var uParam0, int iParam1) // Position - 0xC60A
{
	switch (uParam0->f_16)
	{
		case 0:
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1826.6306f, 4699.115f, 35.38089f, 1812.8776f, 4710.457f, 42.053535f, 23.75f, false, true, 0))
				{
					if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]))
					{
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(uParam0->f_28[0], true), true) < 3f)
						{
							if (func_184(2))
							{
								if (func_197(uParam0->f_27))
								{
									func_196(uParam0->f_27, *uParam0);
									func_300("ARE_RC_TRIGGER_CONDITIONS_MET: RC_TRIG_CHAR - Used special case Eps 4 trigger.");
									return 1;
								}
							}
						}
				...
				if (TASK::GET_PED_DESIRED_MOVE_BLEND_RATIO(PLAYER::PLAYER_PED_ID()) >= 2f)
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 245.88849f, 371.9034f, 103.98843f, 241.58984f, 359.64575f, 107.34612f, 1.25f, false, true, 0))
					{
						if (func_184(2))
						{
							...
							{
								func_196(uParam0->f_27, *uParam0);
								func_300("RC5_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - Eps 2 special case trigger used");
								return 1;
							}
						}
					}
			...
			else if (*uParam0 == 31)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 2728.9482f, 4143.44f, 42.292946f, 2722.2134f, 4144.5215f, 45.431824f, 10f, false, true, 0))
				{
					if (func_184(2))
					{
						...
						{
							func_196(1, *uParam0);
							func_300("RC_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - RC_MAUDE_1 special case vehicle launch area");
							return 1;
						}
					}
				}
					...
					if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -983.5426f, 369.11035f, 68.460175f, -1028.5663f, 395.46133f, 94.57245f, 15f, false, true, 0))
					{
						if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -983.875f, 346.75565f, 68.02096f, -1021.4514f, 336.34583f, 93.18714f, 14.5f, false, true, 0))
						{
							if (func_184(2))
							{
								...
								{
									func_196(uParam0->f_27, *uParam0);
									func_300("RC_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - RC_NIGEL_1B special case vehicle launch area");
									return 1;
								}
							}
						}
...
void func_194() // Position - 0xCDED
{
	func_27(&(Global_104530.f_2890), &Global_104530, 0, 1, 1, 0);
	return;
}

BOOL func_195(var uParam0) // Position - 0xCE08
{
	float num;
...
void func_196(int iParam0, var uParam1) // Position - 0xCE96
{
	if (iParam0 == 1)
	{
		if (!func_140(uParam1))
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			func_300("RC_STOP_PLAYER_VEHICLE_CHECK: Stopping player's vehicle.");
		
			if (PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()))
			{
				func_300("RC_STOP_PLAYER_VEHICLE_CHECK: Turning off engine for plane or helicopter.");
...
BOOL func_197(BOOL bParam0) // Position - 0xCEFA
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::GET_PLAYER_INDEX()))
	{
		...
		else if (bParam0)
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
				...
				if (func_198(playersLastVehicle))
					if (PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()))
...
BOOL func_198(Vehicle veParam0) // Position - 0xCF91
{
...
int func_199(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xCFBB
{
	var unk;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && MISC::GET_GAME_TIMER() - uParam0->f_60 > iParam8 && func_183(PLAYER::PLAYER_PED_ID(), uParam1, true) < iParam9)
	{
		unk = 16;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD043
{
	func_201(uParam0, 145, sParam1, iParam4, iParam5, 0);
...
void func_201(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD07E
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD0D4
{
...
void func_203(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD16F
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_183(PLAYER::PLAYER_PED_ID(), uParam2, true) <= 100f)
					func_206(uParam0, 1);
			}
			else
			{
				switch (func_205(*uParam0))
				{
					...
					case 2:
						...
						func_204(*uParam0, false);
						break;
				}
			
				if (func_183(PLAYER::PLAYER_PED_ID(), uParam2, true) > 120f)
					func_208(uParam0);
			}
		}
	}
...
void func_204(int iParam0, BOOL bParam1) // Position - 0xD260
{
	if (iParam0 == -1)
		return;
...
int func_205(int iParam0) // Position - 0xD29C
{
	if (Global_79385 == iParam0)
		if (Global_79386 == -1)
...
void func_206(var uParam0, int iParam1) // Position - 0xD2D5
{
	BOOL flag;
	int i;
...
BOOL func_207() // Position - 0xD373
{
	return Global_98822;
}

void func_208(var uParam0) // Position - 0xD37F
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_209(uParam0);
...
void func_209(var uParam0) // Position - 0xD396
{
	BOOL flag;
	int num;
	int i;
...
void func_210(int iParam0) // Position - 0xD47E
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD4A6
{
	var unk;

	if (Global_79389)
	{
		func_300("IS_RC_FINE_AND_IN_RANGE(): The game is running Multiplayer [TERMINATING]");
		return false;
	}

	func_120(*panParam0, &unk);

	if (func_248(*panParam0) || func_246(*panParam0) || Global_79635 == true)
		return true;

	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	{
		func_300("IS_RC_FINE_AND_IN_RANGE(): Player out of range [TERMINATING]");
		return false;
	}

	if (func_242(*panParam0))
	{
		if (*panParam0 == 19)
			func_241(panParam0->f_28[0]);
	
		func_300("IS_RC_FINE_AND_IN_RANGE(): Script denied by RC Controller [TERMINATING]");
		return false;
	}

	if (panParam0->f_25 == 1)
		if (!func_221(panParam0, true, 0))
			return false;
	else if (panParam0->f_16 == 0)
		if (!func_221(panParam0, false, 0))
			return false;
	...
	if (*panParam0 == 10)
	{
		...
		{
			func_300("IS_RC_FINE_AND_IN_RANGE(): Explosion near mission trigger [TERMINATING]");
			return false;
		}
	}
	...
	if (unk.f_4 != 17)
	{
		...
		{
			func_300("IS_RC_FINE_AND_IN_RANGE(): No longer a valid player character to launch mission");
			return false;
		}
	}

	if (func_215(&(panParam0->f_48)) && bParam1)
		func_212(panParam0->f_28[0], &(panParam0->f_48), *panParam0);

	return true;
}

void func_212(Ped pedParam0, var uParam1, int iParam2) // Position - 0xD716
{
	int taskSequenceId;
	int taskSequenceId2;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_214(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(pedParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_213(iParam2) && !PED::IS_PED_FACING_PED(pedParam0, PLAYER::PLAYER_PED_ID(), 25f))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(pedParam0, PLAYER::PLAYER_PED_ID(), 0);
						uParam1->f_3 = 5;
					}
					else if (func_214(uParam1) && uParam1->f_4 == 0 && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(pedParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_213(iParam2) || PED::IS_PED_FACING_PED(pedParam0, PLAYER::PLAYER_PED_ID(), 10f))
				{
					if (func_71(uParam1->f_5, 0f, 0f, 0f, false))
						TASK::TASK_PLAY_ANIM(pedParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, false, false, false);
					else
...
BOOL func_213(int iParam0) // Position - 0xDA6E
{
...
BOOL func_214(var uParam0) // Position - 0xDA8E
{
...
BOOL func_215(var uParam0) // Position - 0xDAA6
{
...
void func_216(var uParam0) // Position - 0xDACB
{
	int i;
	int taskSequenceId;
...
void func_217(Object* pobParam0) // Position - 0xDDCF
{
...
void func_218(var uParam0) // Position - 0xDDFA
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xDE7A
{
	int i;
	int num;
	Vehicle playersLastVehicle;
	...
	if (func_136(PLAYER::PLAYER_PED_ID()))
	{
		for (i = 0; i <= num; i = i + 1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[i]))
			{
				...
				{
					func_300("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is dead [TERMINATING]");
					return false;
				}
			
				if (!VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_35[i], false))
				{
					func_300("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is not driveable [TERMINATING]");
					return false;
				}
			
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uParam0->f_35[i], PLAYER::PLAYER_PED_ID(), false))
				{
					func_300("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has been damaged by player [TERMINATING]");
					return false;
				}
			
				if (ENTITY::GET_ENTITY_HEALTH(uParam0->f_35[i]) < 850)
				{
					func_300("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle health is less than 850 [TERMINATING]");
					return false;
				}
				...
				if (bParam2)
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
					{
						...
						{
							func_300("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has collided with the player vehicle at speed [TERMINATING]");
							return false;
						}
						...
						if (func_198(playersLastVehicle))
						{
							...
							{
								if (func_198(uParam0->f_35[i]))
								{
									if (VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(playersLastVehicle, uParam0->f_35[i]))
									{
										func_300("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is being towed by player [TERMINATING]");
										return false;
									}
								}
							}
					...
					else
					{
						...
						if (func_198(playersLastVehicle2))
						{
							if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(uParam0->f_35[i], playersLastVehicle2) && ENTITY::GET_ENTITY_SPEED(playersLastVehicle2) > 6f)
							{
								func_300("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has collided with the player's last known vehicle at speed (player bailed out?) [TERMINATING]");
								return false;
							}
						}
						...
						if (*uParam0 == 16)
						{
							if (func_220(PLAYER::PLAYER_PED_ID(), uParam0->f_35[i]))
							{
								func_300("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Player attempting to jack Epsilon vehicle [TERMINATING]");
								return false;
							}
						}
					}
...
BOOL func_220(Ped pedParam0, Vehicle veParam1) // Position - 0xE038
{
...
BOOL func_221(var uParam0, BOOL bParam1, int iParam2) // Position - 0xE068
{
	int i;
	int num;
	...
	if (func_136(PLAYER::PLAYER_PED_ID()))
	{
		for (i = 0; i <= num; i = i + 1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[i]))
			{
				if (!PED::IS_PED_INJURED(uParam0->f_28[i]))
				{
					if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
					{
						if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), uParam0->f_28[i]))
						{
							...
							func_300("STEP_5_COMMON_RCfineAndInRange - Random character is being pushed by car [TERMINATING]");
							return false;
						}
					}
					...
					if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(uParam0->f_28[i]) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(uParam0->f_28[i]) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_OBJECT(uParam0->f_28[i]))
					{
						...
						func_300("STEP_5_COMMON_RCfineAndInRange - Random character has been damaged by something [TERMINATING]");
						return false;
					}
					...
					if (PED::IS_PED_RAGDOLL(uParam0->f_28[i]))
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(uParam0->f_28[i], PLAYER::PLAYER_PED_ID(), 3f, 3f, 3f, false, true, 0))
						{
							...
							func_300("STEP_5_COMMON_RCfineAndInRange - Random character is in ragdoll [TERMINATING]");
							return false;
						}
					}
					...
					if (func_240(*uParam0))
					{
						if (!func_170(*uParam0))
						{
							if (func_235(uParam0->f_28[i], true, false, false, false))
							{
								if (iParam2 == 0)
									func_216(uParam0);
								else
								...
								func_300("STEP_5_COMMON_RCfineAndInRange - Player is shooting near the Random Character [TERMINATING]");
								return false;
							}
						}
						...
						if (FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(uParam0->f_28[i], true), 15f))
						{
							...
							func_300("STEP_5_COMMON_RCfineAndInRange - There was an explosion near the Random Character [TERMINATING]");
							return false;
						}
					
						if (func_223(uParam0->f_28[i], 1126825984))
						{
							if (iParam2 == 0)
								func_216(uParam0);
							else
							...
							func_300("STEP_5_COMMON_RCfineAndInRange - Random character is in combat [TERMINATING]");
							return false;
						}
					}
					...
					if (!func_222(*uParam0))
					{
						...
						if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0)
						{
							...
							func_300("STEP_5_COMMON_RCfineAndInRange - Player has a wanted level [TERMINATING]");
							return false;
						}
					}
				}
				...
				{
					func_300("STEP_5_COMMON_RCfineAndInRange - Random character injured / dead [TERMINATING]");
...
BOOL func_222(int iParam0) // Position - 0xE324
{
...
BOOL func_223(Ped pedParam0, int iParam1) // Position - 0xE358
{
	float xSize;
...
BOOL func_224(Ped pedParam0, int iParam1) // Position - 0xE3CE
{
	return func_225(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_225(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE3E6
{
	BOOL flag;
	var pedBoneCoords;
	int num;

	num = func_233(pedParam0, pedParam1);

	if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam0) || !_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam1))
	{
		if (num != -1)
			func_232(&iLocal_35[num /*4*/]);
	
		return false;
	}

	if (!func_229(pedParam0, pedParam1, iParam2, iParam3))
		return false;
	...
	flag = func_226(&iLocal_35[num /*4*/], pedBoneCoords, pedParam1, &(iLocal_35[num /*4*/].f_3), pedParam0, iParam5);
	return flag || MISC::GET_GAME_TIMER() - iLocal_35[num /*4*/].f_3 < iParam4;
}

BOOL func_226(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xE4A7
{
	var hit;
	var endCoords;
	var surfaceNormal;
	...
	if (*uParam0 == 0)
	{
		endCoords = { func_227(pedParam4, iParam7) };
...
Vector3 func_227(Ped pedParam0, int iParam1) // Position - 0xE5D3
{
...
BOOL func_229(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xE6E2
{
	var unk;
	var entityForwardVector;
	float num;

	unk = { func_231(ENTITY::GET_ENTITY_COORDS(pedParam1, true) - ENTITY::GET_ENTITY_COORDS(pedParam0, true)) };
	...
	if (iParam3 == 0)
		...
		entityForwardVector = { func_231(PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 0f, 0f)) };

	num = func_230(entityForwardVector, unk);
...
float func_230(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xE773
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_231(float fParam0, var uParam1, var uParam2) // Position - 0xE794
{
	float num;
	float num2;
...
void func_232(var uParam0) // Position - 0xE7D3
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_233(Ped pedParam0, Ped pedParam1) // Position - 0xE7EE
{
	int i;
...
BOOL func_234(Ped pedParam0) // Position - 0xE82D
{
...
BOOL func_235(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE855
{
	float radius;
	float num;
	int weaponHash;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam0))
	{
		...
		if (!bParam2)
		{
			if (func_239(pedParam0, bParam1, radius, num))
				return true;
		
			if (func_236(pedParam0, num, bParam3, bParam4))
				return true;
		}
		else
		{
...
BOOL func_236(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE950
{
	float entityCoords;
	float num;
...
BOOL func_237(Ped pedParam0, float fParam1) // Position - 0xEA5C
{
	var outProjectile;
	var outCoords;
	...
	if (MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(pedParam0, joaat("WEAPON_GRENADE"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(pedParam0, joaat("WEAPON_SMOKEGRENADE"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(pedParam0, joaat("WEAPON_BZGAS"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(pedParam0, joaat("WEAPON_STICKYBOMB"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(pedParam0, joaat("WEAPON_MOLOTOV"), fParam1, &outCoords, &outProjectile, false))
		if (func_238(pedParam0, outCoords, 90f, 0))
			return true;

	return false;
}

BOOL func_238(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xEAF1
{
	var unk;
	var entityForwardVector;
	float num;

	unk = { func_231(uParam1 - ENTITY::GET_ENTITY_COORDS(pedParam0, true)) };
...
BOOL func_239(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xEB7F
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_240(int iParam0) // Position - 0xEBC7
{
...
void func_241(Vehicle veParam0) // Position - 0xEC11
{
	int taskSequenceId;
...
BOOL func_242(int iParam0) // Position - 0xECAE
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL func_243(int iParam0) // Position - 0xED43
{
...
BOOL func_246(int iParam0) // Position - 0xEDC2
{
	if (func_247() && Global_101533.f_11 == 6 && iParam0 == func_179(&(Global_101533.f_3), 0))
		return true;

	return false;
}

BOOL func_247() // Position - 0xEDF6
{
...
BOOL func_248(int iParam0) // Position - 0xEE34
{
...
BOOL func_250(var uParam0) // Position - 0xEE8B
{
	if (!func_251(uParam0))
		return false;

	func_300("Created initial scene");
	return true;
}

BOOL func_251(var uParam0) // Position - 0xEEAA
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		case 0:
			...
			func_267(&(uParam0->f_48), "rcmcollect_paperleadinout@", "meditiate_idle", 0);
			iLocal_89 = 1;
			break;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				if (!func_262(&uParam0->f_28[0], CHAR_DREYFUSS, -1459.68f, 485.26f, 116.22f, -131.3f, "DREYFUSS LAUNCHER RC", 1))
					flag = false;
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_260(&uParam0->f_35[0], num[1], uLocal_92, fLocal_95);
...
void func_252(BOOL bParam0) // Position - 0xF0C5
{
...
void func_253(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xF117
{
	if (iParam0 != 198)
	{
		if (Global_79389)
		...
		func_256(iParam0, bParam3, iParam4, false);
...
void func_254(int iParam0, int iParam1) // Position - 0xF16F
{
	switch (iParam0)
	{
		case 12:
...
void func_255(int iParam0, BOOL bParam1) // Position - 0xF258
{
	if (bParam1)
...
BOOL func_256(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0xF281
{
	BOOL flag;
	int num;
	int num2;
...
BOOL func_257() // Position - 0xFBE6
{
	if (func_76() == -1 || func_76() == 999 && !(func_258() == 0))
		return true;

	return false;
}

int func_258() // Position - 0xFC16
{
	return Global_32949;
}

int func_259(var uParam0, int iParam1) // Position - 0xFC21
{
	int i;
...
void func_260(Vehicle* pveParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5) // Position - 0x13777
{
	func_261(pveParam0);
...
void func_261(Vehicle* pveParam0) // Position - 0x137BA
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_262(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x13856
{
	if (func_263(ppedParam0, echParam1, fParam2, fParam5, true))
	{
...
BOOL func_263(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x138B2
{
	Hash model;

	if (!func_36(echParam1))
	{
		model = func_303(echParam1);
...
int func_264(Ped pedParam0, eCharacter echParam1) // Position - 0x13940
{
	int num;
...
BOOL func_265(var uParam0) // Position - 0x13986
{
	if (func_215(uParam0))
	{
...
BOOL func_266(var uParam0) // Position - 0x139B0
{
	int i;
...
void func_267(var uParam0, char* sParam1, char* sParam2, int iParam3) // Position - 0x139E1
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
BOOL func_268(int iParam0) // Position - 0x13A1D
{
	var unk;
	eCharacter character;
...
BOOL func_269(int iParam0) // Position - 0x13A6E
{
	const char* string2;

	if (Global_79389)
	{
		func_300("STEP_3_COMMON_CanRCLaunch - Script denied. Multiplayer is running [TERMINATING]");
		return false;
	}

	if (!Global_113969.f_9088 && !_IS_MISSION_REPEAT_ACTIVE(true))
	{
		func_300("STEP_3_COMMON_CanRCLaunch - Script denied, game flow is not active");
		return false;
	}
	...
	{
		Global_113056[iParam0 /*10*/].f_1 = 1;
		func_300("STEP_3_COMMON_CanRCLaunch - Script denied by RC Controller [TERMINATING]");
		return false;
	}
	...
	if (Global_101533.f_11 == 6)
	{
		if (Global_101533 < 9)
		{
			...
			{
				func_300("STEP_3_COMMON_CanRCLaunch - Script denied as a replay for this RC is being configured. [TERMINATING]");
				return false;
			}
		}
	}
	...
	{
		Global_113056[iParam0 /*10*/].f_1 = 1;
		func_300("STEP_3_COMMON_CanRCLaunch - Script denied as candidate_controller is not running. [TERMINATING]");
		return false;
	}
...
BOOL func_270(int iParam0) // Position - 0x13B27
{
	var unk;
...
BOOL func_271(int iParam0) // Position - 0x13BE8
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_272(int iParam0, char* sParam1) // Position - 0x13C6D
{
...
BOOL func_273(int iParam0) // Position - 0x13D4F
{
...
BOOL func_274(int iParam0) // Position - 0x13D7A
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_275(int iParam0) // Position - 0x13DA5
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_276(int iParam0) // Position - 0x13DD0
{
	if (func_243(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
void func_277() // Position - 0x13E05
{
	func_300("Running end routines.");
	Global_113687 = Global_113687 - 1;
	return;
}

BOOL func_278(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x13E1F
{
	int i;
	...
	func_300("DETERMINE_RC_TO_LAUNCH - Unable to find mission to launch [TERMINATING]");
	return false;
}

BOOL func_279(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x13E84
{
	int num;
	char* str;
...
BOOL func_280(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x13EFC
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_281(var uParam0, BOOL bParam1) // Position - 0x13F77
{
	char* str;

	if (bParam1)
	{
		func_300("SCRIPT TERMINATING: Cleaning up entities in Launcher");
		func_288(uParam0, 0, false, false);
	}

	func_287(&(uParam0->f_48));

	if (iLocal_96 != -1)
	{
		func_300("SCRIPT TERMINATING: Ending off-mission cutscene request");
		func_209(&iLocal_96);
	}
...
void func_282(char* sParam0) // Position - 0x13FFC
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
		if (func_285(sParam0))
			func_283();
...
void func_283() // Position - 0x1401F
{
	Global_21152 = 0;
	func_284();
	return;
...
void func_284() // Position - 0x1402F
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_23297 = 0;
...
BOOL func_285(char* sParam0) // Position - 0x14050
{
	var string1;
...
struct<6> func_286() // Position - 0x14070
{
	var unk;
...
int func_287(var uParam0) // Position - 0x14094
{
	if (func_215(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_288(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x140CA
{
	func_295(uParam0, iParam1);
	func_292(uParam0, bParam2);
	func_289(uParam0, bParam3);
	return;
}

void func_289(var uParam0, BOOL bParam1) // Position - 0x140EA
{
	func_290(&(uParam0->f_41), bParam1);
	return;
}

void func_290(var uParam0, BOOL bParam1) // Position - 0x140FC
{
	int i;
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (bParam1)
			...
			func_291(&uParam0->[i], false);
	}

	return;
}

void func_291(Object* pobParam0, BOOL bParam1) // Position - 0x1413A
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_292(var uParam0, BOOL bParam1) // Position - 0x14175
{
	func_293(&(uParam0->f_35), bParam1);
	return;
}

void func_293(var uParam0, BOOL bParam1) // Position - 0x14187
{
	int i;
...
void func_294(Vehicle* pveParam0) // Position - 0x141C4
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_295(var uParam0, int iParam1) // Position - 0x141FC
{
	func_296(&(uParam0->f_28), iParam1);
	return;
}

void func_296(var uParam0, int iParam1) // Position - 0x1420E
{
	int i;
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_297(&uParam0->[i], false, 1, 0);
	}

	return;
}

void func_297(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x1424F
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_298(Ped* ppedParam0) // Position - 0x1429F
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
void func_299(int iParam0) // Position - 0x142E0
{
	if (*iParam0 == -1)
		return;
...
void func_300(char* sParam0) // Position - 0x1431D
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_301(var uParam0) // Position - 0x1432F
{
	*uParam0 = -1;
...
void func_302() // Position - 0x14362
{
	func_300("Running start routines.");
	Global_113687 = Global_113687 + 1;
	return;
}

Hash func_303(eCharacter echParam0) // Position - 0x1437C
{
	if (!func_36(echParam0))
