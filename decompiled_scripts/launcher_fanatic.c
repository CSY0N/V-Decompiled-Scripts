...
void main() // Position - 0x0 Hash - 0x5D84F89F ^0x5D84F89F
{
	...
	iLocal_90 = func_304(CHAR_MARY_ANN);
	iLocal_92 = -1;
	iLocal_95 = -1;
	...
	{
		func_301("Force cleanup [TERMINATING]");
	
		if (num != -1)
		{
			if (Global_113457[num /*10*/].f_9 != -1)
			{
				func_301("Relinquishing candidate id...");
				func_300(&(Global_113457[num /*10*/].f_9));
			}
		}
	...
	if (!func_282(&unk63, &num, vector, 1f))
	{
		func_281();
		func_301("SCRIPT TERMINATED");
	...
	while (!func_256(&num))
	{
		...
		{
			func_301("Player out of range [TERMINATING]");
			func_285(&num, true);
		}
	}
	...
	while (true)
	{
		...
		func_217(num);
		func_210(&iLocal_92, &(num.f_9), vector);
		...
		if (iLocal_93 == 0)
		{
			if (num == 22)
			{
				if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
				{
					...
					{
						func_301("Trying to set Mary Ann boyfriend component variation");
						CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED("MaryAnnes_Friend", num.f_28[1], 0);
		...
		if (num == 21)
			func_206(&num, vector, "FAN1AU", "FAN1_AMB", 3, "MARYANN", 1500);
		else if (num == 22)
			func_201(&num, vector, "FAN2AU", "FAN2_AMB", 3, "MARYANN", 5000, 1101004800);
		else if (num == 23)
			if (iLocal_94 == 0)
				if (func_206(&num, vector, "FAN3AUD", "FAN3_AMB", 3, "MARYANN", 50))
					iLocal_94 = 1;
			else
				func_198(&num);
...
BOOL func_1(var uParam0) // Position - 0x2DA Hash - 0x5CBE5B62 ^0x13861C41
{
...
BOOL func_2(Any* panParam0) // Position - 0x2F8 Hash - 0x8112DE5 ^0x8112DE5
{
	const char* str;
	var unk32;
	...
	if (!_IS_MISSION_REPLAY_IN_PROGRESS())
	{
		while (!func_169(*panParam0))
		{
			...
			{
				func_301("LAUNCH_RC_MISSION - NOT IS_RC_FINE_AND_IN_RANGE() [TERMINATING]");
				return false;
			}
	...
	{
		func_301("STEP_7_COMMON_LaunchMission - Trying to launch a null script string name");
		return false;
	}
...
void func_3(int iParam0, const char* sParam1) // Position - 0x3BA Hash - 0xA9A7342A ^0xA9284257
{
	func_21(sParam1);
...
void func_4(int iParam0) // Position - 0x476 Hash - 0x74C873D2 ^0x74C873D2
{
	int num;
	int num2;
...
void func_5() // Position - 0x5D0 Hash - 0x6EF841A5 ^0x6EF841A5
{
	int i;
...
void func_6(int iParam0) // Position - 0x683 Hash - 0xB8CA5CA7 ^0x96AAFF46
{
	switch (iParam0)
	{
		case 2:
...
void func_7(int iParam0) // Position - 0xA6B Hash - 0xA84FABDE ^0xA84FABDE
{
	Global_64031 = true;
	Global_64034 = 1;
...
void func_8(int iParam0) // Position - 0xAB6 Hash - 0x4878B614 ^0x92338679
{
...
struct<2> func_9(int iParam0) // Position - 0xAEA Hash - 0x323E6781 ^0xC721105
{
	var unk;
	var unk3;
...
void func_10() // Position - 0xB22 Hash - 0xDE0A4F6 ^0xDE0A4F6
{
	if (Global_64038)
		return;
...
void func_11() // Position - 0xB78 Hash - 0x49CBF5B6 ^0x790810FF
{
	int i;
...
void func_12() // Position - 0xBA5 Hash - 0x45508BA8 ^0x301C64C9
{
	int i;
...
void func_13() // Position - 0xBDC Hash - 0x8D222CF ^0x8D222CF
{
	Global_64197 = 0;
	return;
}

void func_14() // Position - 0xBE8 Hash - 0xCEA3FAB3 ^0xBE2318F
{
	Global_64057 = 0;
...
var func_15(Hash hParam0) // Position - 0xC3C Hash - 0x4A0C678B ^0x403B983B
{
	var outValue;
...
void func_16() // Position - 0xC50 Hash - 0x43632AFE ^0x43632AFE
{
	int i;
...
void func_17(BOOL bParam0) // Position - 0xC7A Hash - 0xFFF39126 ^0xFFF39126
{
...
void func_18() // Position - 0xC8E Hash - 0xFC34B768 ^0xE1D0CFD9
{
	int i;
...
void func_19() // Position - 0xCC7 Hash - 0x429A4038 ^0x85B0838F
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("mission_stat_watcher")) > 0)
	{
		if (func_20())
...
BOOL func_20() // Position - 0xD09 Hash - 0x46E5692F ^0xA798242F
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("mission_stat_watcher")) < 1)
		return false;
...
void func_21(const char* sParam0) // Position - 0xD33 Hash - 0xF54A2398 ^0xC5887C42
{
	MISC::ARE_STRINGS_EQUAL(sParam0, sParam0);
	return;
}

void func_22(char* sParam0, int iParam1) // Position - 0xD46 Hash - 0x1166ABB2 ^0x89B55D9D
{
...
void func_23(char* sParam0, int iParam1, Ped pedParam2) // Position - 0xD63 Hash - 0xB566D143 ^0xF40A92E3
{
...
void func_24() // Position - 0xDA8 Hash - 0x59B932B3 ^0xFC5559FC
{
	int i;
	int j;
...
void func_25(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0x1A3C Hash - 0x53B0865D ^0xC434A1E8
{
	int i;
	eCharacter j;
...
int func_26(var uParam0) // Position - 0x28C5 Hash - 0x56C64BA4 ^0xCAE61007
{
...
void func_27(var uParam0, int iParam1, Ped pedParam2, int iParam3, int iParam4, int iParam5) // Position - 0x28E7 Hash - 0x4709079E ^0x71C884C9
{
	Vehicle vehicle;
...
int func_28(var uParam0, int iParam1, Vehicle veParam2, int iParam3) // Position - 0x296F Hash - 0x6BF8E630 ^0xF655D74B
{
...
BOOL func_29(Vehicle veParam0) // Position - 0x29AF Hash - 0x8CDF26D5 ^0xCE04F037
{
	int i;
...
void func_30(var uParam0, Vehicle veParam1, int iParam2) // Position - 0x29DD Hash - 0x9B217A45 ^0xEE9A0448
{
...
int func_31(Vehicle veParam0) // Position - 0x2AB9 Hash - 0xDEF2B534 ^0x25A18686
{
	int i;
...
eCharacter func_32(Vehicle veParam0) // Position - 0x2AFB Hash - 0x593067C2 ^0x2918B7DD
{
	int i;
...
int func_33(Vehicle veParam0, eCharacter echParam1, int iParam2) // Position - 0x2B5E Hash - 0xC883A039 ^0x6D45755E
{
	int i;
...
Hash func_34(eCharacter echParam0, int iParam1) // Position - 0x2BEC Hash - 0x3C1119CD ^0x1010ECAE
{
	Hash num;
...
void func_35(eCharacter echParam0, var uParam1, int iParam2) // Position - 0x2C2E Hash - 0xF92B8944 ^0xD11BCD5C
{
	int num;
...
BOOL func_36(eCharacter echParam0) // Position - 0x2E8A Hash - 0x8907F004 ^0x8907F004
{
	return echParam0 < CHAR_MULTIPLAYER;
}

void func_37(Vehicle veParam0, var uParam1) // Position - 0x2E96 Hash - 0x5E84B52A ^0xEF20F807
{
	int i;
...
int func_38(int iParam0) // Position - 0x3141 Hash - 0xEE599357 ^0xEE599357
{
	switch (iParam0)
	{
		case 1:
...
int func_39(var uParam0, var uParam1, var uParam2) // Position - 0x31F1 Hash - 0x4455160E ^0x8E5B3F28
{
	int i;
	int modType;
...
BOOL func_40(int iParam0) // Position - 0x33E4 Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_41(var uParam0) // Position - 0x3404 Hash - 0xB95AF921 ^0x4DC7C61C
{
	int i;
...
BOOL func_42(Ped pedParam0, var uParam1, int iParam2, int iParam3) // Position - 0x34B5 Hash - 0x6795F6D3 ^0x3A08E8AF
{
...
BOOL func_43(Vehicle veParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x35E4 Hash - 0xBCC62924 ^0x77695844
{
	int i;
	var garageName;
	int num;
...
BOOL func_44(eCharacter echParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x3652 Hash - 0x8E372EAA ^0xD989726E
{
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x372B Hash - 0xAC4E9801 ^0xB379A75F
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x3768 Hash - 0xADCB9755 ^0xADCB9755
{
...
Hash func_47(eCharacter echParam0) // Position - 0x378D Hash - 0xE4CEEC2C ^0xE4CEEC2C
{
	return Global_2139[echParam0 /*29*/];
}

void func_48(Ped pedParam0, var uParam1, int iParam2, int iParam3) // Position - 0x379C Hash - 0x4CE94407 ^0xC863C983
{
...
int func_49(int iParam0, int iParam1) // Position - 0x3936 Hash - 0x744E461C ^0x94D7C845
{
	Hash statHash;
	int outValue;
...
Hash func_50(int iParam0, int iParam1) // Position - 0x3965 Hash - 0x505A9F99 ^0x8B00E935
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_51(iParam1));
}

int func_51(int iParam0) // Position - 0x397A Hash - 0x1A3F3220 ^0x1A3F3220
{
	int num;
	int num2;
...
int func_52() // Position - 0x39AE Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1574925;
}

BOOL func_53(int iParam0, int iParam1) // Position - 0x39BA Hash - 0x5137F6D6 ^0x3B535546
{
	Hash statHash;
	BOOL outValue;
...
Hash func_54(int iParam0, int iParam1) // Position - 0x39DE Hash - 0x1D62A43E ^0x33D7B335
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_51(iParam1));
}

void func_55(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x39F3 Hash - 0x65821445 ^0x4849EA55
{
	eCharacter character;
...
void func_56(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3F3C Hash - 0x10358CC6 ^0xCC2A186D
{
	eCharacter character;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x417E Hash - 0x3C5423D7 ^0x3C5423D7
{
	func_58();
	return Global_114370.f_2366.f_539.f_4321;
}

void func_58() // Position - 0x4197 Hash - 0xD1F2D853 ^0xF9F5FD4D
{
	eCharacter character;
...
BOOL func_59(int iParam0) // Position - 0x4294 Hash - 0x937D8816 ^0x937D8816
{
	return Global_43922 == iParam0;
}

void func_60(Ped pedParam0, BOOL bParam1) // Position - 0x42A2 Hash - 0xC106EC1D ^0x74ED6306
{
	eCharacter character;
...
void func_61(Ped pedParam0, var uParam1) // Position - 0x4395 Hash - 0xDEAAD761 ^0xB2E3A390
{
	int i;
	int j;
	Hash k;
...
BOOL func_62(int iParam0) // Position - 0x461D Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
...
BOOL func_63(int iParam0) // Position - 0x46BE Hash - 0xD9D843D5 ^0xF9D91FBE
{
...
Hash func_64(Hash hParam0, int iParam1) // Position - 0x48AA Hash - 0x6010BC66 ^0x1DFF9FB7
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_65(Hash hParam0, Any* panParam1) // Position - 0x55CB Hash - 0x539D27DB ^0xB7B7AD25
{
	int i;
	int numDlcWeapons;
...
Hash func_66(int iParam0) // Position - 0x5606 Hash - 0x5FB59AC3 ^0x9BC6B2ED
{
	int num;
...
void func_67(Ped pedParam0) // Position - 0x587A Hash - 0x27D5295B ^0xD1A82444
{
	eCharacter character;
...
void func_68(var uParam0, int iParam1) // Position - 0x58B6 Hash - 0x635FFA34 ^0xAE461588
{
	var unk;
	var unk2;
	var unk5;
...
BOOL func_69(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5E05 Hash - 0xA7FD254F ^0xFF9CDA51
{
...
BOOL func_70(int iParam0, var uParam1, var uParam2) // Position - 0x5E49 Hash - 0xE3586C79 ^0xE3586C79
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x65C8 Hash - 0x2D46096D ^0xEA41378F
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x660F Hash - 0xDB33C708 ^0xF5B91AC7
{
...
BOOL func_73(int iParam0) // Position - 0x666A Hash - 0xCAEAF99E ^0xCAEAF99E
{
	return func_74(iParam0, 0, true);
}

BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x667A Hash - 0xA45BEB30 ^0x6033D2A2
{
	if (iParam0 == -1)
		return false;
...
int func_75(int iParam0) // Position - 0x66DA Hash - 0x28E83966 ^0x9E37924F
{
	switch (iParam0)
	{
		case 0:
...
int func_76() // Position - 0x6A82 Hash - 0x21D64237 ^0x21D64237
{
	return Global_32828;
}

BOOL func_77(int iParam0) // Position - 0x6A8D Hash - 0xBE61F0FD ^0xBE61F0FD
{
	return func_74(iParam0, 5, true);
}

int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6A9D Hash - 0x4E8D2C12 ^0x4E8D2C12
{
	int i;
...
Vector3 func_79(int iParam0, BOOL bParam1) // Position - 0x6B3F Hash - 0x4894642D ^0x4894642D
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_80() // Position - 0x72AA Hash - 0x6E37375C ^0x6E37375C
{
...
int func_81() // Position - 0x75A5 Hash - 0x974E48B4 ^0x974E48B4
{
	return Global_2652572.f_2650;
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x75B4 Hash - 0x16E871AD ^0x10C54C39
{
...
Vector3 func_83(float fParam0, float fParam1, float fParam2) // Position - 0x75DE Hash - 0xD52A1F8B ^0x5D514503
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_84(), 0f, fParam0);
}

Vector3 func_84() // Position - 0x75F3 Hash - 0x21158019 ^0x21158019
{
	return -880f, -2770f, -50f;
}

BOOL func_85(ePedComponentType epctParam0) // Position - 0x760A Hash - 0x78AB9EAC ^0x78AB9EAC
{
...
Vector3 func_86(int iParam0, int iParam1) // Position - 0x7662 Hash - 0x7E203DFC ^0x7E203DFC
{
	var unk;
	var unk7;
...
BOOL func_87(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x770C Hash - 0x5642A5C0 ^0x5642A5C0
{
	var unk;
	Vector3 vector;
	var unk12;
...
Vector3 func_88(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x77A1 Hash - 0x8959C4D1 ^0x8922A2E2
{
	float num;
	float num2;
	float num3;
...
struct<6> func_89(int iParam0) // Position - 0x77E5 Hash - 0xC73C1158 ^0x2A6D4A6F
{
	var unk;
...
struct<6> func_90(int iParam0) // Position - 0x7969 Hash - 0x2623C81B ^0x2623C81B
{
	return func_91(iParam0);
}

struct<6> func_91(int iParam0) // Position - 0x7977 Hash - 0x7684F11 ^0xD37BE1E4
{
	var unk;
...
BOOL func_92(int iParam0, var uParam1) // Position - 0x843F Hash - 0x31632D18 ^0xF002B35A
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_93(ePedComponentType epctParam0) // Position - 0x84C1 Hash - 0x9D5E1610 ^0x9D5E1610
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x8519 Hash - 0x478900E4 ^0x478900E4
{
	return -1;
}

Vector3 func_95(int iParam0) // Position - 0x8522 Hash - 0xCBED323 ^0xCBED323
{
	switch (iParam0)
	{
		case 1:
...
int func_96() // Position - 0x878E Hash - 0x5976C0FC ^0xC3C6644E
{
	return func_97(PLAYER::PLAYER_ID());
}

int func_97(Player plParam0) // Position - 0x879E Hash - 0x1A54F100 ^0x35DB7B9D
{
	return MISC::GET_BITS_IN_RANGE(Global_2657921[plParam0 /*463*/].f_321.f_3, 28, 31);
}

BOOL func_98(int iParam0) // Position - 0x87BB Hash - 0xA85A6891 ^0xA85A6891
{
	return func_74(iParam0, 0, false);
}

int func_99(int iParam0) // Position - 0x87CB Hash - 0x1BE0B176 ^0x1BE0B176
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_100() // Position - 0x8B01 Hash - 0xD56328D2 ^0xD56328D2
{
	return Global_101444.f_393 > 0;
}

var func_101() // Position - 0x8B12 Hash - 0x9E44C35 ^0xB9993D58
{
	var unk;
...
void func_102(var uParam0, int iParam1) // Position - 0x8B58 Hash - 0x15B9927E ^0x4A4674
{
	if (iParam1 <= 0)
		return;
...
void func_103(var uParam0, int iParam1) // Position - 0x8BDE Hash - 0x4C70B2C3 ^0x4C70B2C3
{
...
void func_104(var uParam0, int iParam1) // Position - 0x8C11 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
int func_105(int iParam0, int iParam1) // Position - 0x8C62 Hash - 0xD3EBACB3 ^0xD3EBACB3
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_106(int iParam0) // Position - 0x8D04 Hash - 0xE1B0542C ^0x127A471E
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_107(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8D26 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
int func_108(int iParam0) // Position - 0x8D3D Hash - 0x2D4DB85F ^0x2D4DB85F
{
	return iParam0 & 15;
}

void func_109(var uParam0, int iParam1) // Position - 0x8D4A Hash - 0x864304A8 ^0x1F5003E2
{
...
void func_110(var uParam0, int iParam1) // Position - 0x8D84 Hash - 0x76860AE7 ^0x32308FFF
{
...
void func_111(var uParam0, int iParam1) // Position - 0x8DBF Hash - 0xDB8A72C0 ^0x4F6D426D
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8DFB Hash - 0x3C5423D7 ^0x3C5423D7
{
	func_58();
	return Global_114370.f_2366.f_539.f_4321;
}

void func_113(int iParam0) // Position - 0x8E14 Hash - 0x35AC36F2 ^0xBB1E15AC
{
	int num;
	var textLabel;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8E6D Hash - 0x4C81F065 ^0x79C65D03
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x8E83 Hash - 0x4C81F065 ^0xB17A9745
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_116(char* sParam0, Any anParam1, int iParam2) // Position - 0x8E99 Hash - 0x817AB180 ^0x223E95D0
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8EDB Hash - 0x15889021 ^0xE7262364
{
...
struct<2> func_118(int iParam0) // Position - 0x8F03 Hash - 0x975AC8C9 ^0x9CF4C697
{
	var unk;
...
void func_119(int iParam0, var uParam1) // Position - 0x9350 Hash - 0x2D8E3F8 ^0x3811FB34
{
	switch (iParam0)
	{
		case 0:
...
int func_121(int iParam0) // Position - 0xA628 Hash - 0xC999F6B2 ^0xC999F6B2
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_122(Any* panParam0) // Position - 0xA96E Hash - 0x1D39FD6 ^0xAFEDDB74
{
	int threadId;
	...
	if (func_152(&(panParam0->f_1)))
	{
		...
		{
			func_301("Initial cutscene loaded and passing to RC mission.");
			CUTSCENE::SET_SCRIPT_CAN_START_CUTSCENE(threadId);
		}
		else
		{
			func_301("Initial cutscene wasn't loaded in time to pass to RC mission.");
...
void func_123(int iParam0) // Position - 0xAA13 Hash - 0xE0445FFC ^0x204FFA11
{
	var name;
...
void func_124(int iParam0) // Position - 0xAAAE Hash - 0xE70A4F17 ^0xE70A4F17
{
	if (iParam0 < 63)
	{
		func_125();
...
void func_125() // Position - 0xAAD4 Hash - 0xD5DFA716 ^0xD54995D4
{
	Global_79503 != 6;
...
void func_126(Ped pedParam0) // Position - 0xAB0C Hash - 0x91438920 ^0xDA692F14
{
	int num;
	int num2;
	int num3;
...
void func_127(int iParam0) // Position - 0xAB65 Hash - 0xBB510F32 ^0xE77AE77B
{
...
int func_128(Ped pedParam0) // Position - 0xABE8 Hash - 0x14AF2EDD ^0xC5BC7CD2
{
	int i;
...
void func_129(int iParam0, int iParam1, int iParam2) // Position - 0xAC19 Hash - 0xF54D70EF ^0xF54D70EF
{
	func_130(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_130(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xAC2E Hash - 0x9F3D8BA2 ^0x9F3D8BA2
{
	int num;
...
int func_131() // Position - 0xACB0 Hash - 0x11506CC4 ^0x2E9F5641
{
	int i;
...
BOOL func_132(int iParam0, int iParam1, int iParam2) // Position - 0xACE1 Hash - 0x3A30B8C2 ^0x3A30B8C2
{
...
int func_133(int iParam0, int iParam1, int iParam2) // Position - 0xACFC Hash - 0x61F8C119 ^0x1C9B84EC
{
	int i;
...
int func_134(Ped pedParam0) // Position - 0xAD48 Hash - 0xDCBB968F ^0xDCBB968F
{
	int i;
...
BOOL func_135(Ped pedParam0) // Position - 0xAD91 Hash - 0x7E48B415 ^0x126328AB
{
...
BOOL func_136(int iParam0) // Position - 0xADB1 Hash - 0xBF3EFB31 ^0xBF3EFB31
{
	switch (iParam0)
	{
		case 5:
...
void func_137() // Position - 0xAE04 Hash - 0x53295875 ^0x53295875
{
...
BOOL func_138(int iParam0) // Position - 0xAE81 Hash - 0xBF3EFB31 ^0xBF3EFB31
{
	switch (iParam0)
	{
		case 5:
...
void func_139(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xAED4 Hash - 0x50B95D9E ^0x1806B4C4
{
	int i;
...
BOOL func_140(int iParam0) // Position - 0xAFC9 Hash - 0xBF3EFB31 ^0xBF3EFB31
{
	switch (iParam0)
	{
		case 5:
...
void func_141(BOOL bParam0) // Position - 0xB034 Hash - 0xD10400C0 ^0xB6845444
{
	Player playerIndex;
...
void func_142(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB073 Hash - 0x787E640E ^0x67C15509
{
	if (bParam0)
	{
...
BOOL func_143() // Position - 0xB1C0 Hash - 0xAA7793E3 ^0x3F62CDC8
{
	return IS_BIT_SET(Global_1845263[PLAYER::PLAYER_ID() /*877*/].f_36.f_18, 14);
}

BOOL func_144(Player plParam0, int iParam1) // Position - 0xB1DA Hash - 0x1A32E11A ^0x6AADE226
{
	BOOL flag;
...
int func_145(int iParam0, BOOL bParam1) // Position - 0xB233 Hash - 0x1DCD393E ^0x1DCD393E
{
	int num;
	int num2;
...
BOOL func_146(Player plParam0) // Position - 0xB274 Hash - 0x6A46C9B4 ^0x6A46C9B4
{
	Player player;
...
BOOL func_147(Player plParam0) // Position - 0xB296 Hash - 0x68897CDD ^0x62820466
{
...
BOOL func_148() // Position - 0xB2D5 Hash - 0xA525B2F4 ^0xA525B2F4
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_149(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB2E3 Hash - 0x3167F4C7 ^0xCE6B9B6A
{
	int num;
...
BOOL func_150() // Position - 0xB316 Hash - 0xD140D54A ^0xE638D98F
{
...
void func_151(int iParam0) // Position - 0xB33D Hash - 0x1B2EEE72 ^0xEDBC1F9D
{
	if (iParam0 == 1)
...
BOOL func_152(const char* sParam0) // Position - 0xB360 Hash - 0x16488C7A ^0x49CDDCBA
{
	...
	func_301("Attempting to launch invalid script file [TERMINATING]");
	return false;
}

void func_153() // Position - 0xB39D Hash - 0xC536DD5 ^0xC536DD5
{
	Global_21032 = 0;
	func_154();
	return;
...
void func_154() // Position - 0xB3AD Hash - 0xE32CF1EF ^0xB9A7BEB2
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB404 Hash - 0x152DA0B2 ^0x220E93E9
{
...
void func_156() // Position - 0xB426 Hash - 0xE60F63BE ^0xE60F63BE
{
	func_162(0);
	func_161();
	func_157();
...
void func_157() // Position - 0xB43B Hash - 0xC95798F1 ^0x61ADB9D7
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
...
BOOL func_158(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB493 Hash - 0xEF9D4F61 ^0xC848BDEA
{
...
void func_159(Vehicle veParam0) // Position - 0xB4EA Hash - 0x94E8CB0B ^0x47923A23
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_160(BOOL bParam0, BOOL bParam1) // Position - 0xB516 Hash - 0xC86614C6 ^0xCD39041A
{
...
void func_161() // Position - 0xB667 Hash - 0x2A0AC5B7 ^0xAF27577A
{
...
void func_162(int iParam0) // Position - 0xB6B8 Hash - 0x7E11E9C ^0x544BF257
{
	if (func_167())
		return;
...
void func_163(int iParam0) // Position - 0xB6EB Hash - 0x4066FEF5 ^0x9787FBDA
{
	if (func_167())
		return;
...
void func_164(BOOL bParam0, BOOL bParam1) // Position - 0xB775 Hash - 0xF40FC178 ^0xA6F60F17
{
	if (bParam0)
	{
		if (func_166(0))
...
BOOL func_165() // Position - 0xB7E9 Hash - 0x8DF3D75D ^0x8DF3D75D
{
	return IS_BIT_SET(Global_1956030, 5);
}

BOOL func_166(int iParam0) // Position - 0xB7F7 Hash - 0xE8921B44 ^0x4F063755
{
	if (iParam0 == 1)
...
BOOL func_167() // Position - 0xB84E Hash - 0xC41437CB ^0xC41437CB
{
	return IS_BIT_SET(Global_1956030, 19);
}

BOOL func_168(int iParam0) // Position - 0xB85D Hash - 0x2BFED607 ^0x2BFED607
{
...
BOOL func_169(int iParam0) // Position - 0xB89E Hash - 0x5C21BF6B ^0xB5545E1F
{
	int num;
...
void func_170(int iParam0) // Position - 0xB8E3 Hash - 0xF49E441F ^0xE21552CB
{
...
int func_171(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB915 Hash - 0x8F9349A ^0xC5C097C1
{
	int i;
...
void func_172(int iParam0, int iParam1) // Position - 0xBA4C Hash - 0x6AC97785 ^0x6AC97785
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBA9B Hash - 0xECB6C71B ^0xECB6C71B
{
	return func_174(iParam0, Global_43922);
}

BOOL func_174(int iParam0, int iParam1) // Position - 0xBAAC Hash - 0x1FD727E0 ^0x1FD727E0
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_175(int iParam0) // Position - 0xBC8D Hash - 0x3BAB94E9 ^0x3BAB94E9
{
	if (Global_43922 == 15)
		return false;
...
int func_176() // Position - 0xBCAF Hash - 0x613FC6AD ^0xDC7835B3
{
	return func_177(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_177(char* sParam0, int iParam1) // Position - 0xBCC0 Hash - 0x76A2E0AF ^0x8A5231BB
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBD09 Hash - 0x77F66043 ^0x77F66043
{
	if (Global_101392 == 10 || Global_101392 == 9)
		return true;
...
void func_179(int iParam0, var uParam1) // Position - 0xBD2D Hash - 0x4DABA5AB ^0x5B086A56
{
	switch (iParam0)
	{
		case 0:
...
Blip func_180(float fParam0, float fParam1, float fParam2, BOOL bParam3) // Position - 0xC19D Hash - 0xF4E99477 ^0x29669E98
{
	Blip blip;
...
var func_181(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC1C9 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
BOOL func_182(int iParam0) // Position - 0xC1E0 Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_183(var uParam0, int iParam1) // Position - 0xC26F Hash - 0x4C332810 ^0xCFFAAA23
{
	switch (uParam0->f_16)
	{
		case 0:
						...
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(uParam0->f_28[0], true), true) < 3f)
						{
							if (func_189(2))
							{
								if (func_187(uParam0->f_27))
								{
									...
									func_301("ARE_RC_TRIGGER_CONDITIONS_MET: RC_TRIG_CHAR - Used special case Eps 4 trigger.");
									return true;
								}
							}
						}
				...
				if (TASK::GET_PED_DESIRED_MOVE_BLEND_RATIO(PLAYER::PLAYER_PED_ID()) >= 2f)
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 245.88849f, 371.9034f, 103.98843f, 241.58984f, 359.64575f, 107.34612f, 1.25f, false, true, 0))
					{
						if (func_189(2))
						{
							...
							{
								func_186(uParam0->f_27, *uParam0);
								func_301("RC5_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - Eps 2 special case trigger used");
								return true;
							}
						}
					}
			...
			else if (*uParam0 == 31)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 2728.9482f, 4143.44f, 42.292946f, 2722.2134f, 4144.5215f, 45.431824f, 10f, false, true, 0))
				{
					if (func_189(2))
					{
						...
						{
							func_186(1, *uParam0);
							func_301("RC_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - RC_MAUDE_1 special case vehicle launch area");
							return true;
						}
					}
				}
					...
					if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -983.5426f, 369.11035f, 68.460175f, -1028.5663f, 395.46133f, 94.57245f, 15f, false, true, 0))
					{
						if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -983.875f, 346.75565f, 68.02096f, -1021.4514f, 336.34583f, 93.18714f, 14.5f, false, true, 0))
						{
							if (func_189(2))
							{
								...
								{
									func_186(uParam0->f_27, *uParam0);
									func_301("RC_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - RC_NIGEL_1B special case vehicle launch area");
									return true;
								}
							}
						}
...
void func_184() // Position - 0xCA52 Hash - 0x1DF115D ^0x1DF115D
{
	func_27(&(Global_104933.f_2890), &Global_104933, 0, 1, 1, 0);
	return;
}

BOOL func_185(var uParam0) // Position - 0xCA6D Hash - 0xBE0C612E ^0xC181C5F3
{
	float num;
...
void func_186(int iParam0, var uParam1) // Position - 0xCAFB Hash - 0x16CCAA18 ^0xAACCE127
{
	if (iParam0 == 1)
	{
		if (!func_138(uParam1))
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			func_301("RC_STOP_PLAYER_VEHICLE_CHECK: Stopping player's vehicle.");
		
			if (PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()))
			{
				func_301("RC_STOP_PLAYER_VEHICLE_CHECK: Turning off engine for plane or helicopter.");
...
BOOL func_187(BOOL bParam0) // Position - 0xCB5F Hash - 0x328D4447 ^0x90410402
{
...
BOOL func_188(Vehicle veParam0) // Position - 0xCBF6 Hash - 0x7E47BB06 ^0x692E6B64
{
...
BOOL func_189(int iParam0) // Position - 0xCC20 Hash - 0x97844555 ^0xADCD6DAA
{
	eCharacter character;
...
BOOL func_190() // Position - 0xD33D Hash - 0x4228A1C2 ^0x952FE30F
{
	return Global_101431.f_1;
}

BOOL func_191() // Position - 0xD34B Hash - 0xC20DBA70 ^0xAC4006FB
{
	if (Global_98294 != -1)
...
BOOL func_192() // Position - 0xD36E Hash - 0x3CA1BB47 ^0xB78A1ACB
{
...
BOOL func_193() // Position - 0xD388 Hash - 0xE663B8F6 ^0xE663B8F6
{
	if (Global_79509)
		return true;
...
BOOL func_194() // Position - 0xD3B2 Hash - 0xD56328D2 ^0xD56328D2
{
	return Global_101444.f_394 > 0;
}

BOOL func_195(int iParam0, int iParam1) // Position - 0xD3C3 Hash - 0xA14C4D3F ^0xA6034F77
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_196() // Position - 0xD3FB Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1575079;
}

BOOL func_197() // Position - 0xD407 Hash - 0x7FE517FE ^0x128A3BC8
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void func_198(var uParam0) // Position - 0xD423 Hash - 0xC7809B5 ^0x39FA79A
{
	if (iLocal_95 == -1)
		iLocal_95 = MISC::GET_GAME_TIMER();

	if (MISC::GET_GAME_TIMER() - iLocal_95 >= 900)
	{
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]))
		{
			if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
			{
				func_199(uParam0->f_28[0], "PUSHUP_BREATH", "MARYANN", 6);
				iLocal_95 = MISC::GET_GAME_TIMER();
			}
		}
	}
...
void func_199(Ped pedParam0, char* sParam1, char* sParam2, int iParam3) // Position - 0xD473 Hash - 0xB310831B ^0x96265DAC
{
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0xD48C Hash - 0xA17D549C ^0x1471865
{
	char* str;
...
int func_201(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xD681 Hash - 0xA74186BF ^0x512FC932
{
	var unk;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && MISC::GET_GAME_TIMER() - uParam0->f_60 > iParam8 && func_205(PLAYER::PLAYER_PED_ID(), uParam1, true) < iParam9)
	{
		unk = 16;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD709 Hash - 0xF7ECDFD9 ^0x6B079C3E
{
	func_203(uParam0, 145, sParam1, iParam4, iParam5, 0);
...
void func_203(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD744 Hash - 0xC6B752B2 ^0xC6B752B2
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD79A Hash - 0x6C235EE0 ^0x9E57F206
{
...
float func_205(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xD835 Hash - 0xC22B942A ^0xE0DB8793
{
...
BOOL func_206(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8) // Position - 0xD86F Hash - 0x4C584A2 ^0xFFF25B04
{
	var unk;
	...
	if (func_189(2))
	{
		if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
		{
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && MISC::GET_GAME_TIMER() - uParam0->f_60 > iParam8 && func_205(PLAYER::PLAYER_PED_ID(), uParam1, true) < 20f)
			{
				unk = 16;
				_CONVERSATION_INITIALIZE_ACTOR(&unk, iParam6, uParam0->f_28[0], sParam7, 0, 1);
				_CONVERSATION_ADD_LINE_NO_SUBTITLE(&unk, sParam4, sParam5, 7, 0, 0);
		...
		else if (func_207(sParam5))
		{
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()))
				if (func_205(PLAYER::PLAYER_PED_ID(), uParam1, true) >= 20f)
					func_153();
		}
	}
...
BOOL func_207(char* sParam0) // Position - 0xD931 Hash - 0x5CF3EDA6 ^0x878C8302
{
	var string1;
...
struct<6> func_208() // Position - 0xD951 Hash - 0xB37EF8EF ^0xB37EF8EF
{
	var unk;
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xD975 Hash - 0x3D210083 ^0xF7E7C389
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
		if (!ENTITY::IS_ENTITY_DEAD(pedParam0, false))
			return true;
...
void func_210(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD996 Hash - 0xA38693DA ^0xBAAA90B1
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_205(PLAYER::PLAYER_PED_ID(), uParam2, true) <= 100f)
					func_213(uParam0, 1);
			}
			else
			{
				...
				if (func_205(PLAYER::PLAYER_PED_ID(), uParam2, true) > 120f)
					func_215(uParam0);
			}
		}
	}
...
void func_211(int iParam0, BOOL bParam1) // Position - 0xDA87 Hash - 0x3ABFF97A ^0x3ABFF97A
{
	if (iParam0 == -1)
		return;
...
int func_212(int iParam0) // Position - 0xDAC3 Hash - 0x3F6843D0 ^0x973F28A6
{
	if (Global_79244 == iParam0)
		if (Global_79245 == -1)
...
void func_213(var uParam0, int iParam1) // Position - 0xDAFC Hash - 0xA189769D ^0xD7591C4B
{
	BOOL flag;
	int i;
...
BOOL func_214() // Position - 0xDB9A Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_98681;
}

void func_215(var uParam0) // Position - 0xDBA6 Hash - 0x8EEB5116 ^0x2325FF68
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_216(uParam0);
...
void func_216(var uParam0) // Position - 0xDBBD Hash - 0x1C509C5B ^0x1C509C5B
{
	BOOL flag;
	int num;
	int i;
...
void func_217(int iParam0) // Position - 0xDCA5 Hash - 0xD347101A ^0xCC220E7F
{
	if (iParam0 == -1)
		iParam0 = func_176();
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xDCCD Hash - 0x7D86F6E4 ^0x652646B2
{
	var unk;

	if (Global_79248)
	{
		func_301("IS_RC_FINE_AND_IN_RANGE(): The game is running Multiplayer [TERMINATING]");
		return false;
	}

	func_119(*panParam0, &unk);

	if (func_255(*panParam0) || func_253(*panParam0) || Global_79494 == true)
		return true;

	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	{
		func_301("IS_RC_FINE_AND_IN_RANGE(): Player out of range [TERMINATING]");
		return false;
	}
	...
	{
		if (*panParam0 == 19)
			func_248(panParam0->f_28[0]);
	
		func_301("IS_RC_FINE_AND_IN_RANGE(): Script denied by RC Controller [TERMINATING]");
		return false;
	}

	if (panParam0->f_25 == 1)
		if (!func_228(panParam0, true, 0))
			return false;
	else if (panParam0->f_16 == 0)
		if (!func_228(panParam0, false, 0))
			return false;
	...
	if (*panParam0 == 10)
	{
		...
		{
			func_301("IS_RC_FINE_AND_IN_RANGE(): Explosion near mission trigger [TERMINATING]");
			return false;
		}
	}
	...
	if (unk.f_4 != 17)
	{
		...
		{
			func_301("IS_RC_FINE_AND_IN_RANGE(): No longer a valid player character to launch mission");
			return false;
		}
	}

	if (func_222(&(panParam0->f_48)) && bParam1)
		func_219(panParam0->f_28[0], &(panParam0->f_48), *panParam0);

	return true;
}

void func_219(Ped pedParam0, var uParam1, int iParam2) // Position - 0xDF3D Hash - 0xD4C7D099 ^0x162C1E9
{
	int taskSequenceId;
	int taskSequenceId2;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_221(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(pedParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_220(iParam2) && !PED::IS_PED_FACING_PED(pedParam0, PLAYER::PLAYER_PED_ID(), 25f))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(pedParam0, PLAYER::PLAYER_PED_ID(), 0);
						uParam1->f_3 = 5;
					}
					else if (func_221(uParam1) && uParam1->f_4 == 0 && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(pedParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_220(iParam2) || PED::IS_PED_FACING_PED(pedParam0, PLAYER::PLAYER_PED_ID(), 10f))
				{
					if (func_71(uParam1->f_5, 0f, 0f, 0f, false))
						TASK::TASK_PLAY_ANIM(pedParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, false, false, false);
					else
...
BOOL func_220(int iParam0) // Position - 0xE295 Hash - 0xD681AEF7 ^0xD681AEF7
{
...
BOOL func_221(var uParam0) // Position - 0xE2B5 Hash - 0x42F869D4 ^0xFFADB180
{
...
BOOL func_222(var uParam0) // Position - 0xE2CD Hash - 0x6329B93C ^0xCBBB8D92
{
...
void func_223(var uParam0) // Position - 0xE2F2 Hash - 0x2E98ABB1 ^0xFF31A41F
{
	int i;
	int taskSequenceId;
...
void func_224(Object* pobParam0) // Position - 0xE5F6 Hash - 0x4EAFEE58 ^0x34D7ECA6
{
...
void func_225(var uParam0) // Position - 0xE621 Hash - 0x5209F824 ^0xCFA0F1CA
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE6A1 Hash - 0x53567DCF ^0x584F6887
{
	int i;
	int num;
	Vehicle playersLastVehicle;
	...
	if (func_135(PLAYER::PLAYER_PED_ID()))
	{
		for (i = 0; i <= num; i = i + 1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[i]))
			{
				...
				{
					func_301("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is dead [TERMINATING]");
					return false;
				}
			
				if (!VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_35[i], false))
				{
					func_301("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is not driveable [TERMINATING]");
					return false;
				}
			
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uParam0->f_35[i], PLAYER::PLAYER_PED_ID(), false))
				{
					func_301("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has been damaged by player [TERMINATING]");
					return false;
				}
			
				if (ENTITY::GET_ENTITY_HEALTH(uParam0->f_35[i]) < 850)
				{
					func_301("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle health is less than 850 [TERMINATING]");
					return false;
				}
				...
				if (bParam2)
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
					{
						...
						{
							func_301("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has collided with the player vehicle at speed [TERMINATING]");
							return false;
						}
						...
						if (func_188(playersLastVehicle))
						{
							if (ENTITY::GET_ENTITY_MODEL(playersLastVehicle) == joaat("towtruck") || ENTITY::GET_ENTITY_MODEL(playersLastVehicle) == joaat("towtruck2"))
							{
								if (func_188(uParam0->f_35[i]))
								{
									...
									{
										func_301("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is being towed by player [TERMINATING]");
										return false;
									}
								}
							}
					...
					else
					{
						...
						if (func_188(playersLastVehicle2))
						{
							...
							{
								func_301("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has collided with the player's last known vehicle at speed (player bailed out?) [TERMINATING]");
								return false;
							}
						}
						...
						if (*uParam0 == 16)
						{
							if (func_227(PLAYER::PLAYER_PED_ID(), uParam0->f_35[i]))
							{
								func_301("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Player attempting to jack Epsilon vehicle [TERMINATING]");
								return false;
							}
						}
					}
...
BOOL func_227(Ped pedParam0, Vehicle veParam1) // Position - 0xE85F Hash - 0xFB12ABF0 ^0x730FD205
{
...
BOOL func_228(var uParam0, BOOL bParam1, int iParam2) // Position - 0xE88F Hash - 0xE9BDE167 ^0x20C575FA
{
	int i;
	int num;
	...
	if (func_135(PLAYER::PLAYER_PED_ID()))
	{
		for (i = 0; i <= num; i = i + 1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[i]))
			{
				if (!PED::IS_PED_INJURED(uParam0->f_28[i]))
				{
					if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
					{
						if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), uParam0->f_28[i]))
						{
							...
							func_301("STEP_5_COMMON_RCfineAndInRange - Random character is being pushed by car [TERMINATING]");
							return false;
						}
					}
					...
					if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(uParam0->f_28[i]) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(uParam0->f_28[i]) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_OBJECT(uParam0->f_28[i]))
					{
						...
						func_301("STEP_5_COMMON_RCfineAndInRange - Random character has been damaged by something [TERMINATING]");
						return false;
					}
					...
					if (PED::IS_PED_RAGDOLL(uParam0->f_28[i]))
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(uParam0->f_28[i], PLAYER::PLAYER_PED_ID(), 3f, 3f, 3f, false, true, 0))
						{
							...
							func_301("STEP_5_COMMON_RCfineAndInRange - Random character is in ragdoll [TERMINATING]");
							return false;
						}
					}
					...
					if (func_247(*uParam0))
					{
						if (!func_168(*uParam0))
						{
							if (func_242(uParam0->f_28[i], true, false, false, false))
							{
								if (iParam2 == 0)
									func_223(uParam0);
								else
								...
								func_301("STEP_5_COMMON_RCfineAndInRange - Player is shooting near the Random Character [TERMINATING]");
								return false;
							}
						}
						...
						if (FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(uParam0->f_28[i], true), 15f))
						{
							...
							func_301("STEP_5_COMMON_RCfineAndInRange - There was an explosion near the Random Character [TERMINATING]");
							return false;
						}
					
						if (func_230(uParam0->f_28[i], 1126825984))
						{
							if (iParam2 == 0)
								func_223(uParam0);
							else
							...
							func_301("STEP_5_COMMON_RCfineAndInRange - Random character is in combat [TERMINATING]");
							return false;
						}
					}
					...
					if (!func_229(*uParam0))
					{
						...
						if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0)
						{
							...
							func_301("STEP_5_COMMON_RCfineAndInRange - Player has a wanted level [TERMINATING]");
							return false;
						}
					}
				}
				...
				{
					func_301("STEP_5_COMMON_RCfineAndInRange - Random character injured / dead [TERMINATING]");
...
BOOL func_229(int iParam0) // Position - 0xEB4B Hash - 0x9E3DCA43 ^0x9E3DCA43
{
...
BOOL func_230(Ped pedParam0, int iParam1) // Position - 0xEB7F Hash - 0x5EA05E45 ^0x7984EB04
{
	float xSize;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam0))
	{
		if (func_241(pedParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), pedParam0))
		{
...
BOOL func_231(Ped pedParam0, int iParam1) // Position - 0xEBF5 Hash - 0xF1789D04 ^0x3F9D1900
{
	return func_232(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_232(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xEC0D Hash - 0x275BB58B ^0x275BB58B
{
	BOOL flag;
	var pedBoneCoords;
	int num;

	num = func_240(pedParam0, pedParam1);

	if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam0) || !_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam1))
	{
		if (num != -1)
			func_239(&iLocal_35[num /*4*/]);
	
		return false;
	}

	if (!func_236(pedParam0, pedParam1, iParam2, iParam3))
		return false;
	...
	flag = func_233(&iLocal_35[num /*4*/], pedBoneCoords, pedParam1, &(iLocal_35[num /*4*/].f_3), pedParam0, iParam5);
	return flag || MISC::GET_GAME_TIMER() - iLocal_35[num /*4*/].f_3 < iParam4;
}

BOOL func_233(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xECCE Hash - 0xBBBECF07 ^0xBBBECF07
{
	var hit;
	var endCoords;
	var surfaceNormal;
	...
	if (*uParam0 == 0)
	{
		endCoords = { func_234(pedParam4, iParam7) };
...
Vector3 func_234(Ped pedParam0, int iParam1) // Position - 0xEDFA Hash - 0xA6273130 ^0xF7D9CDEA
{
...
int func_235() // Position - 0xEEBF Hash - 0x1398F041 ^0xCD84FF69
{
	int i;
...
BOOL func_236(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xEF09 Hash - 0x6EF1707D ^0x8C069CF9
{
	var unk;
	var entityForwardVector;
	float num;

	unk = { func_238(ENTITY::GET_ENTITY_COORDS(pedParam1, true) - ENTITY::GET_ENTITY_COORDS(pedParam0, true)) };
	...
	if (iParam3 == 0)
		...
		entityForwardVector = { func_238(PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 0f, 0f)) };

	num = func_237(entityForwardVector, unk);
...
float func_237(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xEF9A Hash - 0x596BEA29 ^0x5FBCDBE5
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_238(float fParam0, var uParam1, var uParam2) // Position - 0xEFBB Hash - 0xFB6A39D2 ^0x80C9C759
{
	float num;
	float num2;
...
void func_239(var uParam0) // Position - 0xEFFA Hash - 0xA4B72113 ^0x62A5EAE1
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_240(Ped pedParam0, Ped pedParam1) // Position - 0xF015 Hash - 0xAA445031 ^0xEBA3F8CF
{
	int i;
...
BOOL func_241(Ped pedParam0) // Position - 0xF054 Hash - 0xEC80536A ^0x2D4CF2B0
{
...
BOOL func_242(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF07C Hash - 0x5B46DA49 ^0x44F718
{
	float radius;
	float num;
	int weaponHash;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam0))
	{
		...
		if (!bParam2)
		{
			if (func_246(pedParam0, bParam1, radius, num))
				return true;
		
			if (func_243(pedParam0, num, bParam3, bParam4))
				return true;
		}
		else
		{
...
BOOL func_243(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF177 Hash - 0x1310B579 ^0x2AAFC0CC
{
	float entityCoords;
	float num;
...
BOOL func_244(Ped pedParam0, float fParam1) // Position - 0xF283 Hash - 0xFA3D7088 ^0x33A74060
{
	var outProjectile;
	var outCoords;
	...
	if (MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(pedParam0, joaat("WEAPON_GRENADE"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(pedParam0, joaat("WEAPON_SMOKEGRENADE"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(pedParam0, joaat("WEAPON_BZGAS"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(pedParam0, joaat("WEAPON_STICKYBOMB"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(pedParam0, joaat("WEAPON_MOLOTOV"), fParam1, &outCoords, &outProjectile, false))
		if (func_245(pedParam0, outCoords, 90f, 0))
			return true;

	return false;
}

BOOL func_245(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF318 Hash - 0x3F40E5FA ^0xC3BEFE6A
{
	var unk;
	var entityForwardVector;
	float num;

	unk = { func_238(uParam1 - ENTITY::GET_ENTITY_COORDS(pedParam0, true)) };
...
BOOL func_246(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF3A6 Hash - 0x18BAE105 ^0x60D3B20E
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_247(int iParam0) // Position - 0xF3EE Hash - 0x5B443B41 ^0x5B443B41
{
...
void func_248(Vehicle veParam0) // Position - 0xF438 Hash - 0xAD821AF8 ^0xC6AD5B6C
{
	int taskSequenceId;
...
BOOL func_249(int iParam0) // Position - 0xF4D5 Hash - 0x6F2BC7EE ^0x6F2BC7EE
{
	if (iParam0 == -1)
		iParam0 = func_176();
...
BOOL func_250(int iParam0) // Position - 0xF56A Hash - 0xDE7BA54D ^0xDE7BA54D
{
...
BOOL func_251() // Position - 0xF5A9 Hash - 0x29CB2928 ^0xE369A18D
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_252() // Position - 0xF5C6 Hash - 0x98CCC132 ^0x97B0D6ED
{
	if (Global_98294 != -1)
...
BOOL func_253(int iParam0) // Position - 0xF5E9 Hash - 0xC2630182 ^0xFBD23031
{
	if (func_254() && Global_101392.f_11 == 6 && iParam0 == func_177(&(Global_101392.f_3), 0))
		return true;

	return false;
}

BOOL func_254() // Position - 0xF61D Hash - 0x25806CBF ^0x25806CBF
{
...
BOOL func_255(int iParam0) // Position - 0xF65B Hash - 0x1156B580 ^0x34C7FA05
{
...
BOOL func_256(var uParam0) // Position - 0xF683 Hash - 0x24D26100 ^0x24D26100
{
	switch (*uParam0)
	{
		case 21:
	...
	func_301("Created initial scene");
	return true;
}

int func_257() // Position - 0xF708 Hash - 0x5A4670E ^0xE582B183
{
...
BOOL func_258(var uParam0) // Position - 0xF737 Hash - 0x1B2F2BDF ^0x2ABCCCDA
{
	int num;
	int i;
	BOOL flag;
	...
	num = 5;
	num[0] = iLocal_90;
	num[1] = joaat("prop_beach_towel_01");
	num[2] = joaat("prop_energy_drink");
	num[3] = joaat("prop_freeweight_01");
	num[4] = joaat("prop_freeweight_02");
	...
	switch (iLocal_89)
	{
		case 0:
			...
			uParam0->f_15 = 14f;
			uParam0->f_27 = 1;
			TEXT_LABEL_ASSIGN_STRING(&(uParam0->f_9), "EF_3_RCM_CONCAT", 24);
			...
			func_264(&(uParam0->f_48), "rcmfanatic3", "ef_3_rcm_loop_maryann", 0);
			iLocal_89 = 1;
			break;
	
		case 1:
			if (!func_263(&num) || !func_262(&(uParam0->f_48)))
				return false;
		...
		case 2:
			...
			{
				if (func_259(&uParam0->f_28[0], CHAR_MARY_ANN, -915.6f, 6139.192f, 5.525f, 111.24f, "FANATIC LAUNCHER RC", 1))
				{
			...
			{
				vector = { -916.6389f, 6137.046f, 4.7157f };
				uParam0->f_41[0] = OBJECT::CREATE_OBJECT(num[1], vector, true, true, false);
			...
			{
				vector = { -917.7f, 6138.89f, 4.72f };
				MISC::GET_GROUND_Z_FOR_3D_COORD(vector, &(vector.f_2), false, false);
				uParam0->f_41[1] = OBJECT::CREATE_OBJECT(num[2], vector, true, true, false);
			...
			{
				vector = { -915.6122f, 6137.662f, 4.6129f };
				uParam0->f_41[2] = OBJECT::CREATE_OBJECT(num[3], vector, true, true, false);
			...
			{
				vector = { -915.4199f, 6137.8555f, 4.6221f };
				uParam0->f_41[3] = OBJECT::CREATE_OBJECT(num[4], vector, true, true, false);
...
BOOL func_259(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xFAF7 Hash - 0x5E27D69A ^0xE8A3C3CE
{
...
BOOL func_260(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xFB53 Hash - 0xC57592AD ^0x9AA0BE7
{
	Hash model;

	if (!func_36(echParam1))
	{
		model = func_304(echParam1);
...
int func_261(Ped pedParam0, eCharacter echParam1) // Position - 0xFBE1 Hash - 0x5AC42C11 ^0x5AC42C11
{
	int num;
...
BOOL func_262(var uParam0) // Position - 0xFC27 Hash - 0xB319BDFA ^0xA1F4DAFB
{
	if (func_222(uParam0))
	{
...
BOOL func_263(var uParam0) // Position - 0xFC51 Hash - 0xC42B20E0 ^0x728F1DAE
{
	int i;
...
void func_264(var uParam0, char* sParam1, char* sParam2, int iParam3) // Position - 0xFC82 Hash - 0x6EEDFC2 ^0xD51569DC
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
BOOL func_265(var uParam0) // Position - 0xFCBE Hash - 0xA9AD80D1 ^0x4A7EB84D
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		case 0:
			...
			func_264(&(uParam0->f_48), "rcm_fanatic2", "ef_2_rcm__maryann_biking_maryann", 0);
			iLocal_89 = 1;
			break;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				if (!func_259(&uParam0->f_28[0], CHAR_MARY_ANN, 809.66f, 1279.76f, 360.49f, 122.53f, "FANATIC LAUNCHER RC", 1))
					flag = false;
		
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[1]))
			{
				func_269(&uParam0->f_28[1], num[1], 808.43f, 1279.16f, 360.47f, -79.11f, PED_TYPE_MISSION);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
				func_267(&uParam0->f_35[0], num[2], 808.35f, 1277.2f, 360.15f, 216.5f);
		
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[1]))
				func_267(&uParam0->f_35[1], num[2], 807.89f, 1275.73f, 360.18f, 208.2f);
		...
		case 3:
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED("rcm_fanatic2"))
			{
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[1]))
				{
					...
					func_301("Playing Mary Ann's friend anim...");
				}
			}
...
int func_266() // Position - 0xFF71 Hash - 0x1E48A9C8 ^0x52E61C94
{
	int num;
...
void func_267(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0x10004 Hash - 0x60B41505 ^0x2C4B5209
{
	func_268(pveParam0);
...
void func_268(Vehicle* pveParam0) // Position - 0x10047 Hash - 0x8D18F713 ^0xF71A18A8
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_269(Ped* ppedParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5, ePedType eptParam6) // Position - 0x100E3 Hash - 0x616C5024 ^0x190F8C82
{
	func_270(ppedParam0);
...
void func_270(Ped* ppedParam0) // Position - 0x10104 Hash - 0xCA79453F ^0x7BA88177
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
BOOL func_271(var uParam0) // Position - 0x10145 Hash - 0x79049BC3 ^0xB318A1
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		case 0:
			...
			func_264(&(uParam0->f_48), "rcmfanatic1", "ef_1_rcm_mary_ann_streching_base", 0);
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_259(&uParam0->f_28[0], CHAR_MARY_ANN, -1878.27f, -440.55f, 46.23f, 165.94f, "FANATIC LAUNCHER RC", 1))
				{
...
BOOL func_272(int iParam0) // Position - 0x102A0 Hash - 0x59D2F680 ^0x59D2F680
{
	var unk;
	eCharacter character;
...
BOOL func_273(int iParam0) // Position - 0x102F1 Hash - 0xC6B32843 ^0xC091A874
{
	const char* string2;

	if (Global_79248)
	{
		func_301("STEP_3_COMMON_CanRCLaunch - Script denied. Multiplayer is running [TERMINATING]");
		return false;
	}

	if (!Global_114370.f_9088 && !_IS_MISSION_REPEAT_ACTIVE(true))
	{
		func_301("STEP_3_COMMON_CanRCLaunch - Script denied, game flow is not active");
		return false;
	}
	...
	{
		Global_113457[iParam0 /*10*/].f_1 = 1;
		func_301("STEP_3_COMMON_CanRCLaunch - Script denied by RC Controller [TERMINATING]");
		return false;
	}
	...
	if (Global_101392.f_11 == 6)
	{
		if (Global_101392 < 9)
		{
			...
			{
				func_301("STEP_3_COMMON_CanRCLaunch - Script denied as a replay for this RC is being configured. [TERMINATING]");
				return false;
			}
		}
	}
	...
	{
		Global_113457[iParam0 /*10*/].f_1 = 1;
		func_301("STEP_3_COMMON_CanRCLaunch - Script denied as candidate_controller is not running. [TERMINATING]");
		return false;
	}
...
BOOL func_274(int iParam0) // Position - 0x103AA Hash - 0x791D84F4 ^0x791D84F4
{
	var unk;
...
BOOL func_275(int iParam0) // Position - 0x1046B Hash - 0xDEAD9A68 ^0xDEAD9A68
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_276(int iParam0, char* sParam1) // Position - 0x104F0 Hash - 0xC64245F ^0xA5ACD231
{
...
BOOL func_277(int iParam0) // Position - 0x105D2 Hash - 0x5ADD7F05 ^0x5ADD7F05
{
...
BOOL func_278(int iParam0) // Position - 0x105FD Hash - 0xBB053D24 ^0xBB053D24
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_279(int iParam0) // Position - 0x10628 Hash - 0x5D95A044 ^0x5D95A044
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_280(int iParam0) // Position - 0x10653 Hash - 0x9FFC81CD ^0x47A2AB8B
{
	if (func_250(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
void func_281() // Position - 0x10688 Hash - 0x5631C87C ^0x45F776E4
{
	func_301("Running end routines.");
	Global_114088 = Global_114088 - 1;
	return;
}

BOOL func_282(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x106A2 Hash - 0x5B983661 ^0x5B983661
{
	int i;

	if (*uParam0 == 1)
	{
		if (func_283(uParam0->[0], uParam2, fParam5, uParam1))
			return true;
	}
	else
	{
		...
		{
			if (func_283(uParam0->[i], uParam2, fParam5, uParam1))
			{
				i = *uParam0;
				return true;
			}
	...
	func_301("DETERMINE_RC_TO_LAUNCH - Unable to find mission to launch [TERMINATING]");
	return false;
}

BOOL func_283(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x10707 Hash - 0xC6B7068B ^0xB9A971A4
{
	int num;
	char* str;
	...
	if (func_284(str.f_6, uParam1, fParam4, false))
	{
...
BOOL func_284(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x1077F Hash - 0x1FB736D4 ^0x234AEAB7
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_285(var uParam0, BOOL bParam1) // Position - 0x107FA Hash - 0xB8166636 ^0xD68EF09B
{
	char* str;

	if (bParam1)
		func_290(uParam0, 0, false, false);

	if (HUD::DOES_BLIP_EXIST(blLocal_96))
		HUD::REMOVE_BLIP(&blLocal_96);

	func_289(&(uParam0->f_48));
	...
	if (iLocal_92 != -1)
	{
		func_301("SCRIPT TERMINATING: Ending off-mission cutscene request");
		func_216(&iLocal_92);
	}
...
void func_286(char* sParam0) // Position - 0x1089E Hash - 0xA52CF679 ^0xC94F8C8B
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
		if (func_207(sParam0))
			func_287();
...
void func_287() // Position - 0x108BD Hash - 0xC536DD5 ^0xC536DD5
{
	Global_21032 = 0;
	func_288();
	return;
...
void func_288() // Position - 0x108CD Hash - 0xF6D04E68 ^0x80AE5309
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_23177 = 0;
...
int func_289(var uParam0) // Position - 0x108EE Hash - 0x86633390 ^0x948D65D9
{
	if (func_222(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_290(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x10924 Hash - 0x5BE1D1E3 ^0x5BE1D1E3
{
	func_297(uParam0, iParam1);
	func_294(uParam0, bParam2);
	func_291(uParam0, bParam3);
	return;
}

void func_291(var uParam0, BOOL bParam1) // Position - 0x10944 Hash - 0xEDC3BD2D ^0xE0B6F056
{
	func_292(&(uParam0->f_41), bParam1);
	return;
}

void func_292(var uParam0, BOOL bParam1) // Position - 0x10956 Hash - 0x9E80EA71 ^0x9E80EA71
{
	int i;
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (bParam1)
			...
			func_293(&uParam0->[i], false);
	}

	return;
}

void func_293(Object* pobParam0, BOOL bParam1) // Position - 0x10994 Hash - 0xD7EE3E27 ^0xC5769B29
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_294(var uParam0, BOOL bParam1) // Position - 0x109CF Hash - 0xEDC3BD2D ^0xE2474F74
{
	func_295(&(uParam0->f_35), bParam1);
	return;
}

void func_295(var uParam0, BOOL bParam1) // Position - 0x109E1 Hash - 0xA98F6284 ^0xA98F6284
{
	int i;
...
void func_296(Vehicle* pveParam0) // Position - 0x10A1E Hash - 0xC50F9886 ^0x638B6124
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_297(var uParam0, int iParam1) // Position - 0x10A56 Hash - 0xEDC3BD2D ^0xA9A19095
{
	func_298(&(uParam0->f_28), iParam1);
	return;
}

void func_298(var uParam0, int iParam1) // Position - 0x10A68 Hash - 0xB72ACFD2 ^0xB72ACFD2
{
	int i;
...
void func_299(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x10AA9 Hash - 0x34362197 ^0xC592197
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_300(int iParam0) // Position - 0x10AF9 Hash - 0x995C9E2 ^0x995C9E2
{
	if (*iParam0 == -1)
		return;
...
void func_301(char* sParam0) // Position - 0x10B36 Hash - 0x54B64147 ^0x56EEAFB9
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_302(var uParam0) // Position - 0x10B48 Hash - 0x4CD8BCE8 ^0x3E26386C
{
	*uParam0 = -1;
...
void func_303() // Position - 0x10B7B Hash - 0x554DA35 ^0x5C0D5CF1
{
	func_301("Running start routines.");
	Global_114088 = Global_114088 + 1;
	return;
}

Hash func_304(eCharacter echParam0) // Position - 0x10B95 Hash - 0xBF0B24A5 ^0xBF0B24A5
{
	if (!func_36(echParam0))
