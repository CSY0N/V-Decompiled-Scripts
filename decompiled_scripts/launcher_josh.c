...
void main() // Position - 0x0
{
	...
	{
		func_319("Force cleanup [TERMINATING]");
	
		if (num != -1)
		{
			if (Global_113056[num /*10*/].f_9 != -1)
			{
				func_319("Relinquishing candidate id...");
				func_318(&(Global_113056[num /*10*/].f_9));
			}
		}
	...
	if (!func_298(&unk63, &num, vector, 1f))
	{
		func_297();
		func_319("SCRIPT TERMINATED");
	...
	while (!func_268(&num))
	{
		...
		{
			func_319("Player out of range [TERMINATING]");
			func_301(&num, true);
		}
	}
	...
	while (true)
	{
		...
		if (!IS_RC_FINE_AND_IN_RANGE(&num, 1))
		{
			if (num == 30)
			{
				if (func_229(PLAYER::PLAYER_PED_ID(), -1102.7241f, 290.1463f, 63.23002f, true) < 200f)
				{
					PLAYER::SET_PLAYER_WANTED_LEVEL_NO_DROP(PLAYER::PLAYER_ID(), 1, false);
					func_228(&num);
					func_319("Making Josh cops attack");
				}
			}
		...
		func_227(num);
		func_220(&iLocal_93, &(num.f_9), vector);
	
		if (num == 27)
		{
			func_218(&num, vector, "JOSH1AU", "JOSH1_AMB1", 5, "JOSH", 5000, 14f);
		}
		else if (num == 28)
		{
			func_218(&num, vector, "JOSH2AU", "JOSH2_AMB", 5, "JOSH", 5000, 1101004800);
		}
		else if (num == 29)
		{
			func_218(&num, vector, "JOSH3AU", "JOSH3_AMB", 3, "JOSH", 5000, 1101004800);
		}
		else if (num == 30)
		{
			if (iLocal_263 == 0)
			{
				if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
				{
					...
					{
						func_319("Josh 4: Trying to set Cop 1 component variation");
					...
					{
						func_319("Josh 4: Trying to set Cop 2 component variation");
		...
		if (func_189(&num, 0) || func_188(&num) || func_186(&num) || func_184(&num))
		{
			if (func_183(num))
				func_180(num, &blLocal_262);
...
BOOL func_1(var uParam0) // Position - 0x3B6
{
...
BOOL func_2(Any* panParam0) // Position - 0x3D4
{
	const char* str;
	var unk32;
	...
	if (!_IS_MISSION_REPLAY_IN_PROGRESS())
	{
		while (!func_170(*panParam0))
		{
			...
			{
				func_319("LAUNCH_RC_MISSION - NOT IS_RC_FINE_AND_IN_RANGE() [TERMINATING]");
				return false;
			}
	...
	{
		func_319("STEP_7_COMMON_LaunchMission - Trying to launch a null script string name");
		return false;
	}
...
void func_3(int iParam0, const char* sParam1) // Position - 0x497
{
	func_21(sParam1);
...
void func_6(int iParam0) // Position - 0x760
{
	switch (iParam0)
	{
		case 2:
...
void func_7(int iParam0) // Position - 0xB48
{
	Global_64159 = true;
	Global_64162 = 1;
...
void func_8(int iParam0) // Position - 0xB93
{
...
struct<2> func_9(int iParam0) // Position - 0xBC7
{
	var unk;
	var unk3;
...
void func_13() // Position - 0xCB9
{
	Global_64325 = 0;
	return;
}

void func_14() // Position - 0xCC5
{
	Global_64185 = 0;
...
var func_15(Hash hParam0) // Position - 0xD19
{
	var outValue;
...
void func_17(BOOL bParam0) // Position - 0xD57
{
...
void func_21(const char* sParam0) // Position - 0xE10
{
	MISC::ARE_STRINGS_EQUAL(sParam0, sParam0);
	return;
}

void func_22(char* sParam0, int iParam1) // Position - 0xE23
{
...
void func_23(char* sParam0, int iParam1, Ped pedParam2) // Position - 0xE40
{
...
void func_25(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0x1B19
{
	int i;
	eCharacter j;
...
int func_26(var uParam0) // Position - 0x29A2
{
...
void func_27(var uParam0, int iParam1, Ped pedParam2, int iParam3, int iParam4, int iParam5) // Position - 0x29C4
{
	Vehicle vehicle;
...
int func_28(var uParam0, int iParam1, Vehicle veParam2, int iParam3) // Position - 0x2A4C
{
...
BOOL func_29(Vehicle veParam0) // Position - 0x2A8C
{
	int i;
...
void func_30(var uParam0, Vehicle veParam1, int iParam2) // Position - 0x2ABA
{
...
int func_31(Vehicle veParam0) // Position - 0x2B96
{
	int i;
...
eCharacter func_32(Vehicle veParam0) // Position - 0x2BD8
{
	int i;
...
int func_33(Vehicle veParam0, eCharacter echParam1, int iParam2) // Position - 0x2C3B
{
	int i;
...
Hash func_34(eCharacter echParam0, int iParam1) // Position - 0x2CC9
{
	Hash num;
...
void func_35(eCharacter echParam0, var uParam1, int iParam2) // Position - 0x2D0B
{
	int num;
...
BOOL func_36(eCharacter echParam0) // Position - 0x2F67
{
	return echParam0 < CHAR_MULTIPLAYER;
}

void func_37(Vehicle veParam0, var uParam1) // Position - 0x2F73
{
	int i;
...
int func_38(int iParam0) // Position - 0x321E
{
	switch (iParam0)
	{
		case 1:
...
int func_39(var uParam0, var uParam1, var uParam2) // Position - 0x32CE
{
	int i;
	int modType;
...
BOOL func_40(int iParam0) // Position - 0x34C1
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_41(var uParam0) // Position - 0x34E1
{
	int i;
...
BOOL func_42(Ped pedParam0, var uParam1, int iParam2, int iParam3) // Position - 0x3592
{
...
BOOL func_43(Vehicle veParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x36C1
{
	int i;
	var garageName;
	int num;
...
BOOL func_44(eCharacter echParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x372F
{
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x3808
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x3845
{
...
Hash func_47(eCharacter echParam0) // Position - 0x386A
{
	return Global_2169[echParam0 /*29*/];
}

void func_48(Ped pedParam0, var uParam1, int iParam2, int iParam3) // Position - 0x3879
{
...
int func_49(int iParam0, int iParam1) // Position - 0x3A13
{
	Hash statHash;
	int outValue;
...
Hash func_50(int iParam0, int iParam1) // Position - 0x3A42
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_51(iParam1));
}

int func_51(int iParam0) // Position - 0x3A57
{
	int num;
	int num2;
...
int func_52() // Position - 0x3A8B
{
	return Global_1574926;
}

BOOL func_53(int iParam0, int iParam1) // Position - 0x3A97
{
	Hash statHash;
	BOOL outValue;
...
Hash func_54(int iParam0, int iParam1) // Position - 0x3ABB
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_51(iParam1));
}

void func_55(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x3AD0
{
	eCharacter character;
...
void func_56(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x401B
{
	eCharacter character;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x425C
{
	func_58();
	return Global_113969.f_2366.f_539.f_4321;
}

void func_58() // Position - 0x4275
{
	eCharacter character;
...
BOOL func_59(int iParam0) // Position - 0x4372
{
	return Global_44042 == iParam0;
}

void func_60(Ped pedParam0, BOOL bParam1) // Position - 0x4380
{
	eCharacter character;
...
void func_61(Ped pedParam0, var uParam1) // Position - 0x4473
{
	int i;
	int j;
	Hash k;
...
BOOL func_62(int iParam0) // Position - 0x46FB
{
	switch (iParam0)
	{
...
BOOL func_63(int iParam0) // Position - 0x479C
{
...
Hash func_64(Hash hParam0, int iParam1) // Position - 0x498E
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_65(Hash hParam0, Any* panParam1) // Position - 0x56CF
{
	int i;
	int numDlcWeapons;
...
Hash func_66(int iParam0) // Position - 0x570A
{
	int num;
...
void func_67(Ped pedParam0) // Position - 0x597E
{
	eCharacter character;
...
void func_68(var uParam0, int iParam1) // Position - 0x59BA
{
	var unk;
	var unk2;
	var unk5;
...
BOOL func_69(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5F09
{
...
BOOL func_70(int iParam0, var uParam1, var uParam2) // Position - 0x5F4D
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x66CC
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x6713
{
...
BOOL func_73(int iParam0) // Position - 0x676E
{
	return func_74(iParam0, 0, true);
}

BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x677E
{
	if (iParam0 == -1)
		return false;
...
int func_75(int iParam0) // Position - 0x67DE
{
	switch (iParam0)
	{
		case 0:
...
int func_76() // Position - 0x6B86
{
	return Global_32948;
}

BOOL func_77(int iParam0) // Position - 0x6B91
{
	return func_74(iParam0, 5, true);
}

int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6BA1
{
	int i;
...
Vector3 func_79(int iParam0, BOOL bParam1) // Position - 0x6C43
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_80() // Position - 0x73A2
{
...
int func_81() // Position - 0x769D
{
	return Global_2652592.f_2671;
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x76AC
{
...
ePedComponentType func_83() // Position - 0x76D6
{
	return Global_2657971[PLAYER::PLAYER_ID() /*465*/].f_322.f_8;
}

Vector3 func_84(float fParam0, float fParam1, float fParam2) // Position - 0x76EE
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_85(), 0f, fParam0);
}

Vector3 func_85() // Position - 0x7703
{
	return -880f, -2770f, -50f;
}

BOOL func_86(ePedComponentType epctParam0) // Position - 0x771A
{
...
Vector3 func_87(int iParam0, int iParam1) // Position - 0x7772
{
	var unk;
	var unk7;
...
BOOL func_88(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x781C
{
	var unk;
	Vector3 vector;
	var unk12;
...
Vector3 func_89(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x78B1
{
	float num;
	float num2;
	float num3;
...
struct<6> func_90(int iParam0) // Position - 0x78F5
{
	var unk;
...
struct<6> func_91(int iParam0) // Position - 0x7A79
{
	return func_92(iParam0);
}

struct<6> func_92(int iParam0) // Position - 0x7A87
{
	var unk;
...
BOOL func_93(int iParam0, var uParam1) // Position - 0x854F
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_94(ePedComponentType epctParam0) // Position - 0x85D1
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x8629
{
	return -1;
}

Vector3 func_96(int iParam0) // Position - 0x8632
{
	switch (iParam0)
	{
		case 1:
...
int func_97() // Position - 0x889E
{
	return func_98(PLAYER::PLAYER_ID());
}

int func_98(Player plParam0) // Position - 0x88AE
{
	return MISC::GET_BITS_IN_RANGE(Global_2657971[plParam0 /*465*/].f_322.f_3, 28, 31);
}

BOOL func_99(int iParam0) // Position - 0x88CB
{
	return func_74(iParam0, 0, false);
}

int func_100(int iParam0) // Position - 0x88DB
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_101() // Position - 0x8C11
{
	return Global_101585.f_393 > 0;
}

var func_102() // Position - 0x8C22
{
	var unk;
...
void func_103(var uParam0, int iParam1) // Position - 0x8C68
{
	if (iParam1 <= 0)
		return;
...
void func_104(var uParam0, int iParam1) // Position - 0x8CEE
{
...
void func_105(var uParam0, int iParam1) // Position - 0x8D21
{
	int num;
	int num2;
...
int func_106(int iParam0, int iParam1) // Position - 0x8D72
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_107(int iParam0) // Position - 0x8E14
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_108(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8E36
{
	if (bParam0)
		return uParam1;
...
int func_109(int iParam0) // Position - 0x8E4D
{
	return iParam0 & 15;
}

void func_110(var uParam0, int iParam1) // Position - 0x8E5A
{
...
void func_111(var uParam0, int iParam1) // Position - 0x8E94
{
...
void func_112(var uParam0, int iParam1) // Position - 0x8ECF
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8F0B
{
	func_58();
	return Global_113969.f_2366.f_539.f_4321;
}

void func_114(int iParam0) // Position - 0x8F24
{
	int num;
	var textLabel;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8F7D
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x8F93
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_117(char* sParam0, Any anParam1, int iParam2) // Position - 0x8FA9
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8FEB
{
...
struct<2> func_119(int iParam0) // Position - 0x9013
{
	var unk;
...
void func_120(int iParam0, var uParam1) // Position - 0x9460
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0) // Position - 0xA738
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_123(Any* panParam0) // Position - 0xAA7E
{
	int threadId;
	...
	if (func_153(&(panParam0->f_1)))
	{
		...
		{
			func_319("Initial cutscene loaded and passing to RC mission.");
			CUTSCENE::SET_SCRIPT_CAN_START_CUTSCENE(threadId);
		}
		else
		{
			func_319("Initial cutscene wasn't loaded in time to pass to RC mission.");
...
void func_124(int iParam0) // Position - 0xAB23
{
	var name;
...
void func_125(int iParam0) // Position - 0xABBE
{
	if (iParam0 < 63)
	{
		func_126();
...
void func_127(Ped pedParam0) // Position - 0xAC1C
{
	int num;
	int num2;
	int num3;
...
void func_128(int iParam0) // Position - 0xAC75
{
...
int func_129(Ped pedParam0) // Position - 0xACF8
{
	int i;
...
void func_130(int iParam0, int iParam1, int iParam2) // Position - 0xAD29
{
	func_131(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_131(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xAD3E
{
	int num;
...
BOOL func_133(int iParam0, int iParam1, int iParam2) // Position - 0xADF1
{
...
int func_134(int iParam0, int iParam1, int iParam2) // Position - 0xAE0C
{
	int i;
...
int func_135(Ped pedParam0) // Position - 0xAE58
{
	int i;
...
BOOL func_136(Ped pedParam0) // Position - 0xAEA1
{
...
BOOL func_137(int iParam0) // Position - 0xAEC1
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_139(int iParam0) // Position - 0xAF91
{
	switch (iParam0)
	{
		case 5:
...
void func_140(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xAFE4
{
	int i;
...
BOOL func_141(int iParam0) // Position - 0xB0D9
{
	switch (iParam0)
	{
		case 5:
...
void func_142(BOOL bParam0) // Position - 0xB144
{
	Player playerIndex;
...
void func_143(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB183
{
	if (bParam0)
	{
...
BOOL func_144() // Position - 0xB2D0
{
	return IS_BIT_SET(Global_1845281[PLAYER::PLAYER_ID() /*883*/].f_36.f_18, 14);
}

BOOL func_145(Player plParam0, int iParam1) // Position - 0xB2EA
{
	BOOL flag;
...
int func_146(int iParam0, BOOL bParam1) // Position - 0xB343
{
	int num;
	int num2;
...
BOOL func_147(Player plParam0) // Position - 0xB384
{
	Player player;
...
BOOL func_148(Player plParam0) // Position - 0xB3A6
{
...
BOOL func_149() // Position - 0xB3E5
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_150(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB3F3
{
	int num;
...
void func_152(int iParam0) // Position - 0xB44D
{
	if (iParam0 == 1)
...
BOOL func_153(const char* sParam0) // Position - 0xB470
{
	...
	func_319("Attempting to launch invalid script file [TERMINATING]");
	return false;
}

void func_154() // Position - 0xB4AD
{
	Global_21152 = 0;
	func_155();
	return;
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB514
{
...
BOOL func_159(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB5A3
{
...
void func_160(Vehicle veParam0) // Position - 0xB5FA
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_161(BOOL bParam0, BOOL bParam1) // Position - 0xB626
{
...
void func_163(int iParam0) // Position - 0xB7C8
{
	if (func_168())
		return;
...
void func_164(int iParam0) // Position - 0xB7FB
{
	if (func_168())
		return;
...
void func_165(BOOL bParam0, BOOL bParam1) // Position - 0xB885
{
	if (bParam0)
	{
		if (func_167(0))
...
BOOL func_166() // Position - 0xB8F9
{
	return IS_BIT_SET(Global_1956920, 5);
}

BOOL func_167(int iParam0) // Position - 0xB907
{
	if (iParam0 == 1)
...
BOOL func_168() // Position - 0xB95E
{
	return IS_BIT_SET(Global_1956920, 19);
}

BOOL func_169(int iParam0) // Position - 0xB96D
{
...
BOOL func_170(int iParam0) // Position - 0xB9AE
{
	int num;
...
void func_171(int iParam0) // Position - 0xB9F3
{
...
int func_172(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xBA25
{
	int i;
...
void func_173(int iParam0, int iParam1) // Position - 0xBB5C
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBBAB
{
	return func_175(iParam0, Global_44042);
}

BOOL func_175(int iParam0, int iParam1) // Position - 0xBBBC
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_176(int iParam0) // Position - 0xBD9D
{
	if (Global_44042 == 15)
		return false;
...
int func_177() // Position - 0xBDBF
{
	return func_178(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_178(const char* sParam0, int iParam1) // Position - 0xBDD0
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBE19
{
	if (Global_101533 == 10 || Global_101533 == 9)
		return true;
...
void func_180(int iParam0, var uParam1) // Position - 0xBE3D
{
	switch (iParam0)
	{
		case 0:
...
Blip func_181(float fParam0, float fParam1, float fParam2, BOOL bParam3) // Position - 0xC2B0
{
	Blip blip;
...
var func_182(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC2DC
{
	if (bParam0)
		return uParam1;
...
BOOL func_183(int iParam0) // Position - 0xC2F3
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_184(var uParam0) // Position - 0xC382
{
	if (*uParam0 == 30)
	{
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]))
		{
			if (bLocal_261)
			{
				if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
				{
					if (func_185(PLAYER::PLAYER_PED_ID(), uParam0->f_28[0], true) <= 15f)
					{
						func_319("Special launching Josh 4 (not in vehicle)");
						return true;
					}
				}
				else if (func_185(PLAYER::PLAYER_PED_ID(), uParam0->f_28[0], true) <= 10f)
				{
					func_319("Special launching Josh 4 (in vehicle)");
					return true;
				}
			}
		}
...
float func_185(Ped pedParam0, Entity eParam1, BOOL bParam2) // Position - 0xC401
{
...
BOOL func_186(var uParam0) // Position - 0xC45F
{
	if (*uParam0 == 29)
	{
		if (func_229(PLAYER::PLAYER_PED_ID(), 566.7472f, -1771.875f, 28.35786f, true) < 6f)
		{
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
				func_319("Special launching Josh 3");
				return true;
			}
			else if (!func_187(PLAYER::PLAYER_PED_ID(), SCRIPT_TASK_LEAVE_ANY_VEHICLE) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)) && func_159(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 1f, 1, 1056964608, false, true, false))
			{
				TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
			}
		}
...
BOOL func_187(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0xC4F2
{
...
int func_188(var uParam0) // Position - 0xC525
{
	if (*uParam0 == 28)
	{
		if (func_229(PLAYER::PLAYER_PED_ID(), 566.7472f, -1771.875f, 28.35786f, true) < 9f)
		{
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
				func_319("Special launching Josh 2");
				return 1;
			}
			else if (!func_187(PLAYER::PLAYER_PED_ID(), SCRIPT_TASK_LEAVE_ANY_VEHICLE) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)) && func_159(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 4f, 1, 1056964608, false, true, false))
			{
				TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
			}
		}
...
int func_189(var uParam0, int iParam1) // Position - 0xC5BC
{
	switch (uParam0->f_16)
	{
		case 0:
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1826.6306f, 4699.115f, 35.38089f, 1812.8776f, 4710.457f, 42.053535f, 23.75f, false, true, 0))
				{
					if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]))
					{
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(uParam0->f_28[0], true), true) < 3f)
						{
							if (func_195(2))
							{
								if (func_193(uParam0->f_27))
								{
									func_192(uParam0->f_27, *uParam0);
									func_319("ARE_RC_TRIGGER_CONDITIONS_MET: RC_TRIG_CHAR - Used special case Eps 4 trigger.");
									return 1;
								}
							}
						}
				...
				if (TASK::GET_PED_DESIRED_MOVE_BLEND_RATIO(PLAYER::PLAYER_PED_ID()) >= 2f)
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 245.88849f, 371.9034f, 103.98843f, 241.58984f, 359.64575f, 107.34612f, 1.25f, false, true, 0))
					{
						if (func_195(2))
						{
							...
							{
								func_192(uParam0->f_27, *uParam0);
								func_319("RC5_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - Eps 2 special case trigger used");
								return 1;
							}
						}
					}
			...
			else if (*uParam0 == 31)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 2728.9482f, 4143.44f, 42.292946f, 2722.2134f, 4144.5215f, 45.431824f, 10f, false, true, 0))
				{
					if (func_195(2))
					{
						...
						{
							func_192(1, *uParam0);
							func_319("RC_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - RC_MAUDE_1 special case vehicle launch area");
							return 1;
						}
					}
				}
					...
					if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -983.5426f, 369.11035f, 68.460175f, -1028.5663f, 395.46133f, 94.57245f, 15f, false, true, 0))
					{
						if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -983.875f, 346.75565f, 68.02096f, -1021.4514f, 336.34583f, 93.18714f, 14.5f, false, true, 0))
						{
							if (func_195(2))
							{
								...
								{
									func_192(uParam0->f_27, *uParam0);
									func_319("RC_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - RC_NIGEL_1B special case vehicle launch area");
									return 1;
								}
							}
						}
...
void func_190() // Position - 0xCD9F
{
	func_27(&(Global_104530.f_2890), &Global_104530, 0, 1, 1, 0);
	return;
}

BOOL func_191(var uParam0) // Position - 0xCDBA
{
	float num;
...
void func_192(int iParam0, var uParam1) // Position - 0xCE48
{
	if (iParam0 == 1)
	{
		if (!func_139(uParam1))
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			func_319("RC_STOP_PLAYER_VEHICLE_CHECK: Stopping player's vehicle.");
		
			if (PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()))
			{
				func_319("RC_STOP_PLAYER_VEHICLE_CHECK: Turning off engine for plane or helicopter.");
...
BOOL func_193(BOOL bParam0) // Position - 0xCEAC
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::GET_PLAYER_INDEX()))
	{
		...
		else if (bParam0)
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
				...
				if (func_194(playersLastVehicle))
					if (PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()))
...
BOOL func_194(Vehicle veParam0) // Position - 0xCF43
{
...
BOOL func_195(int iParam0) // Position - 0xCF6D
{
	eCharacter character;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_203() || Global_113016 || Global_32951 || func_202() || func_201(8, -1) || func_101() || func_200() || func_199() || func_198() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_203() || Global_32951 || func_202() || func_201(8, -1) || func_199() || func_101() || func_200() || func_198() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_203() || Global_113016 || Global_32951 || func_202() || func_201(8, -1) || func_199() || func_101() || func_200() || func_198() || Global_113969.f_7691.f_919[character] == 5 || Global_44589 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_203() || Global_113016 || Global_32951 || func_202() || func_201(8, -1) || func_101() || func_200() || func_198() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_203() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_201(8, -1) || func_198() || func_197() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 5:
						if (func_201(8, -1) || func_101() || func_200() || func_197() || func_196())
							return false;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_203() || Global_32951 || func_202() || func_201(8, -1) || func_200() || func_199() || func_198() || Global_113969.f_7691.f_919[character] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_203() || func_200() || Global_113016 || Global_32951 || func_202() || Global_45250 || func_201(8, -1) || func_199() || func_197() || func_198() || Global_113969.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 8:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_203() || Global_113016 || Global_32951 || func_202() || func_201(8, -1) || func_199() || func_197() || func_101() || func_200() || func_198())
							return false;
						break;
				}
			}
...
BOOL func_196() // Position - 0xD68A
{
	return Global_101572.f_1;
}

BOOL func_197() // Position - 0xD698
{
	if (Global_98435 != -1)
...
BOOL func_200() // Position - 0xD6FF
{
	return Global_101585.f_394 > 0;
}

BOOL func_201(int iParam0, int iParam1) // Position - 0xD710
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_202() // Position - 0xD748
{
	return Global_1575083;
}

BOOL func_203() // Position - 0xD754
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void func_204() // Position - 0xD770
{
	switch (iLocal_94)
	{
		...
		case 1:
			if (func_229(PLAYER::PLAYER_PED_ID(), -1103.44f, 290.18f, 63.28f, true) <= 20f)
		...
		case 2:
			if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
			{
				...
				iLocal_94 = 0;
				bLocal_261 = true;
				func_319("Josh 4 conversation finished and will not loop");
			}
			else if (func_229(PLAYER::PLAYER_PED_ID(), -1103.44f, 290.18f, 63.28f, true) >= 25f)
			{
				func_154();
				bLocal_261 = true;
				iLocal_94 = 0;
...
BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xD83C
{
	func_216(uParam0, _CHAR_NULL, sParam1, iParam4, iParam5, iParam6);
...
BOOL func_206(char* sParam0, int iParam1, BOOL bParam2) // Position - 0xD88A
{
	Global_22287 = 0;
...
BOOL func_209(Player plParam0) // Position - 0xDBF2
{
	return func_210(plParam0, 20);
}

BOOL func_210(Player plParam0, int iParam1) // Position - 0xDC02
{
	return IS_BIT_SET(Global_1887305[plParam0 /*610*/].f_10.f_4, iParam1);
}

void func_211() // Position - 0xDC1A
{
	int i;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0xDD7A
{
	if (func_59(14))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
...
void func_216(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDE74
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xDECA
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
		if (!ENTITY::IS_ENTITY_DEAD(pedParam0, false))
			return true;
...
int func_218(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xDEEB
{
	var unk;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && MISC::GET_GAME_TIMER() - uParam0->f_60 > iParam8 && func_229(PLAYER::PLAYER_PED_ID(), uParam1, true) < iParam9)
	{
		unk = 16;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDF73
{
	func_216(uParam0, 145, sParam1, iParam4, iParam5, 0);
...
void func_220(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xDFAE
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_229(PLAYER::PLAYER_PED_ID(), uParam2, true) <= 100f)
					func_223(uParam0, 1);
			}
			else
			{
				...
				if (func_229(PLAYER::PLAYER_PED_ID(), uParam2, true) > 120f)
					func_225(uParam0);
			}
		}
	}
...
void func_221(int iParam0, BOOL bParam1) // Position - 0xE09F
{
	if (iParam0 == -1)
		return;
...
int func_222(int iParam0) // Position - 0xE0DB
{
	if (Global_79385 == iParam0)
		if (Global_79386 == -1)
...
void func_223(var uParam0, int iParam1) // Position - 0xE114
{
	BOOL flag;
	int i;
...
BOOL func_224() // Position - 0xE1B2
{
	return Global_98822;
}

void func_225(var uParam0) // Position - 0xE1BE
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_226(uParam0);
...
void func_226(var uParam0) // Position - 0xE1D5
{
	BOOL flag;
	int num;
	int i;
...
void func_227(int iParam0) // Position - 0xE2BD
{
	if (iParam0 == -1)
		iParam0 = func_177();
...
void func_228(var uParam0) // Position - 0xE2E5
{
	int i;
...
float func_229(Ped pedParam0, float fParam1, float fParam2, float fParam3, BOOL bParam4) // Position - 0xE365
{
	Vector3 entityCoords;
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xE39F
{
	var unk;

	if (Global_79389)
	{
		func_319("IS_RC_FINE_AND_IN_RANGE(): The game is running Multiplayer [TERMINATING]");
		return false;
	}

	func_120(*panParam0, &unk);

	if (func_266(*panParam0) || func_264(*panParam0) || Global_79635 == true)
		return true;

	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	{
		func_319("IS_RC_FINE_AND_IN_RANGE(): Player out of range [TERMINATING]");
		return false;
	}

	if (func_260(*panParam0))
	{
		if (*panParam0 == 19)
			func_259(panParam0->f_28[0]);
	
		func_319("IS_RC_FINE_AND_IN_RANGE(): Script denied by RC Controller [TERMINATING]");
		return false;
	}

	if (panParam0->f_25 == 1)
		if (!func_239(panParam0, true, 0))
			return false;
	else if (panParam0->f_16 == 0)
		if (!func_239(panParam0, false, 0))
			return false;
	...
	if (*panParam0 == 10)
	{
		...
		{
			func_319("IS_RC_FINE_AND_IN_RANGE(): Explosion near mission trigger [TERMINATING]");
			return false;
		}
	}
	...
	if (unk.f_4 != 17)
	{
		...
		{
			func_319("IS_RC_FINE_AND_IN_RANGE(): No longer a valid player character to launch mission");
			return false;
		}
	}

	if (func_234(&(panParam0->f_48)) && bParam1)
		func_231(panParam0->f_28[0], &(panParam0->f_48), *panParam0);

	return true;
}

void func_231(Ped pedParam0, var uParam1, int iParam2) // Position - 0xE60F
{
	int taskSequenceId;
	int taskSequenceId2;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_233(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(pedParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_232(iParam2) && !PED::IS_PED_FACING_PED(pedParam0, PLAYER::PLAYER_PED_ID(), 25f))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(pedParam0, PLAYER::PLAYER_PED_ID(), 0);
						uParam1->f_3 = 5;
					}
					else if (func_233(uParam1) && uParam1->f_4 == 0 && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(pedParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_232(iParam2) || PED::IS_PED_FACING_PED(pedParam0, PLAYER::PLAYER_PED_ID(), 10f))
				{
					if (func_71(uParam1->f_5, 0f, 0f, 0f, false))
						TASK::TASK_PLAY_ANIM(pedParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, false, false, false);
					else
...
BOOL func_232(int iParam0) // Position - 0xE967
{
...
BOOL func_233(var uParam0) // Position - 0xE987
{
...
BOOL func_234(var uParam0) // Position - 0xE99F
{
...
void func_235(var uParam0) // Position - 0xE9C4
{
	int i;
	int taskSequenceId;
	...
	if (*uParam0 == 52)
	{
		func_236(&uParam0->f_41[1]);
		func_236(&uParam0->f_41[2]);
	}
...
void func_236(Object* pobParam0) // Position - 0xECC8
{
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xECF3
{
	int i;
	int num;
	Vehicle playersLastVehicle;
	...
	if (func_136(PLAYER::PLAYER_PED_ID()))
	{
		for (i = 0; i <= num; i = i + 1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[i]))
			{
				...
				{
					func_319("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is dead [TERMINATING]");
					return false;
				}
			
				if (!VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_35[i], false))
				{
					func_319("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is not driveable [TERMINATING]");
					return false;
				}
			
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uParam0->f_35[i], PLAYER::PLAYER_PED_ID(), false))
				{
					func_319("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has been damaged by player [TERMINATING]");
					return false;
				}
			
				if (ENTITY::GET_ENTITY_HEALTH(uParam0->f_35[i]) < 850)
				{
					func_319("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle health is less than 850 [TERMINATING]");
					return false;
				}
				...
				if (bParam2)
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
					{
						...
						{
							func_319("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has collided with the player vehicle at speed [TERMINATING]");
							return false;
						}
						...
						if (func_194(playersLastVehicle))
						{
							...
							{
								if (func_194(uParam0->f_35[i]))
								{
									if (VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(playersLastVehicle, uParam0->f_35[i]))
									{
										func_319("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is being towed by player [TERMINATING]");
										return false;
									}
								}
							}
					...
					else
					{
						...
						if (func_194(playersLastVehicle2))
						{
							if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(uParam0->f_35[i], playersLastVehicle2) && ENTITY::GET_ENTITY_SPEED(playersLastVehicle2) > 6f)
							{
								func_319("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has collided with the player's last known vehicle at speed (player bailed out?) [TERMINATING]");
								return false;
							}
						}
						...
						if (*uParam0 == 16)
						{
							if (func_238(PLAYER::PLAYER_PED_ID(), uParam0->f_35[i]))
							{
								func_319("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Player attempting to jack Epsilon vehicle [TERMINATING]");
								return false;
							}
						}
					}
...
BOOL func_238(Ped pedParam0, Vehicle veParam1) // Position - 0xEEB1
{
...
BOOL func_239(var uParam0, BOOL bParam1, int iParam2) // Position - 0xEEE1
{
	int i;
	int num;
	...
	if (func_136(PLAYER::PLAYER_PED_ID()))
	{
		for (i = 0; i <= num; i = i + 1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[i]))
			{
				if (!PED::IS_PED_INJURED(uParam0->f_28[i]))
				{
					if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
					{
						if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), uParam0->f_28[i]))
						{
							...
							func_319("STEP_5_COMMON_RCfineAndInRange - Random character is being pushed by car [TERMINATING]");
							return false;
						}
					}
					...
					if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(uParam0->f_28[i]) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(uParam0->f_28[i]) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_OBJECT(uParam0->f_28[i]))
					{
						...
						func_319("STEP_5_COMMON_RCfineAndInRange - Random character has been damaged by something [TERMINATING]");
						return false;
					}
					...
					if (PED::IS_PED_RAGDOLL(uParam0->f_28[i]))
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(uParam0->f_28[i], PLAYER::PLAYER_PED_ID(), 3f, 3f, 3f, false, true, 0))
						{
							...
							func_319("STEP_5_COMMON_RCfineAndInRange - Random character is in ragdoll [TERMINATING]");
							return false;
						}
					}
					...
					if (func_258(*uParam0))
					{
						if (!func_169(*uParam0))
						{
							if (func_253(uParam0->f_28[i], true, false, false, false))
							{
								if (iParam2 == 0)
									func_235(uParam0);
								else
								...
								func_319("STEP_5_COMMON_RCfineAndInRange - Player is shooting near the Random Character [TERMINATING]");
								return false;
							}
						}
						...
						if (FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(uParam0->f_28[i], true), 15f))
						{
							...
							func_319("STEP_5_COMMON_RCfineAndInRange - There was an explosion near the Random Character [TERMINATING]");
							return false;
						}
					
						if (func_241(uParam0->f_28[i], 1126825984))
						{
							if (iParam2 == 0)
								func_235(uParam0);
							else
							...
							func_319("STEP_5_COMMON_RCfineAndInRange - Random character is in combat [TERMINATING]");
							return false;
						}
					}
					...
					if (!func_240(*uParam0))
					{
						...
						if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0)
						{
							...
							func_319("STEP_5_COMMON_RCfineAndInRange - Player has a wanted level [TERMINATING]");
							return false;
						}
					}
				}
				...
				{
					func_319("STEP_5_COMMON_RCfineAndInRange - Random character injured / dead [TERMINATING]");
...
BOOL func_240(int iParam0) // Position - 0xF19D
{
...
BOOL func_241(Ped pedParam0, int iParam1) // Position - 0xF1D1
{
	float xSize;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam0))
	{
		if (func_252(pedParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), pedParam0))
		{
...
BOOL func_242(Ped pedParam0, int iParam1) // Position - 0xF247
{
	return func_243(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_243(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xF25F
{
	BOOL flag;
	var pedBoneCoords;
	int num;

	num = func_251(pedParam0, pedParam1);

	if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam0) || !_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam1))
	{
		if (num != -1)
			func_250(&iLocal_35[num /*4*/]);
	
		return false;
	}

	if (!func_247(pedParam0, pedParam1, iParam2, iParam3))
		return false;
	...
	flag = func_244(&iLocal_35[num /*4*/], pedBoneCoords, pedParam1, &(iLocal_35[num /*4*/].f_3), pedParam0, iParam5);
	return flag || MISC::GET_GAME_TIMER() - iLocal_35[num /*4*/].f_3 < iParam4;
}

BOOL func_244(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xF320
{
	var hit;
	var endCoords;
	var surfaceNormal;
	...
	if (*uParam0 == 0)
	{
		endCoords = { func_245(pedParam4, iParam7) };
...
Vector3 func_245(Ped pedParam0, int iParam1) // Position - 0xF44C
{
...
BOOL func_247(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xF55B
{
	var unk;
	var entityForwardVector;
	float num;

	unk = { func_249(ENTITY::GET_ENTITY_COORDS(pedParam1, true) - ENTITY::GET_ENTITY_COORDS(pedParam0, true)) };
	...
	if (iParam3 == 0)
		...
		entityForwardVector = { func_249(PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 0f, 0f)) };

	num = func_248(entityForwardVector, unk);
...
float func_248(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xF5EC
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_249(float fParam0, var uParam1, var uParam2) // Position - 0xF60D
{
	float num;
	float num2;
...
void func_250(var uParam0) // Position - 0xF64C
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_251(Ped pedParam0, Ped pedParam1) // Position - 0xF667
{
	int i;
...
BOOL func_252(Ped pedParam0) // Position - 0xF6A6
{
...
BOOL func_253(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF6CE
{
	float radius;
	float num;
	int weaponHash;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam0))
	{
		...
		if (!bParam2)
		{
			if (func_257(pedParam0, bParam1, radius, num))
				return true;
		
			if (func_254(pedParam0, num, bParam3, bParam4))
				return true;
		}
		else
		{
...
BOOL func_254(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF7C9
{
	float entityCoords;
	float num;
...
BOOL func_255(Ped pedParam0, float fParam1) // Position - 0xF8D5
{
	var outProjectile;
	var outCoords;
	...
	if (MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(pedParam0, joaat("WEAPON_GRENADE"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(pedParam0, joaat("WEAPON_SMOKEGRENADE"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(pedParam0, joaat("WEAPON_BZGAS"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(pedParam0, joaat("WEAPON_STICKYBOMB"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(pedParam0, joaat("WEAPON_MOLOTOV"), fParam1, &outCoords, &outProjectile, false))
		if (func_256(pedParam0, outCoords, 90f, 0))
			return true;

	return false;
}

BOOL func_256(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF96A
{
	var unk;
	var entityForwardVector;
	float num;

	unk = { func_249(uParam1 - ENTITY::GET_ENTITY_COORDS(pedParam0, true)) };
...
BOOL func_257(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF9F8
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_258(int iParam0) // Position - 0xFA40
{
...
void func_259(Vehicle veParam0) // Position - 0xFA8A
{
	int taskSequenceId;
...
BOOL func_260(int iParam0) // Position - 0xFB27
{
	if (iParam0 == -1)
		iParam0 = func_177();
...
BOOL func_261(int iParam0) // Position - 0xFBBC
{
...
BOOL func_264(int iParam0) // Position - 0xFC3B
{
	if (func_265() && Global_101533.f_11 == 6 && iParam0 == func_178(&(Global_101533.f_3), 0))
		return true;

	return false;
}

BOOL func_265() // Position - 0xFC6F
{
...
BOOL func_266(int iParam0) // Position - 0xFCAD
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xFCD5
{
...
BOOL func_268(var uParam0) // Position - 0xFD70
{
	switch (*uParam0)
	{
		case 27:
	...
	func_319("Created initial scene");
	return true;
}

BOOL func_269(var uParam0) // Position - 0xFDE5
{
	int num;
	int i;
	...
	switch (iLocal_89)
	{
		case 0:
			...
			func_282(&(uParam0->f_48), "rcmjosh4", "beckon_a_josh", 0);
			iLocal_89 = 1;
			break;
	
		case 1:
			if (!func_281(&num) || !func_280(&(uParam0->f_48)))
				return false;
		
			if (!func_279(false, true))
			{
			}
		
			if (!func_278(true, true))
			{
			}
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				if (func_275(&uParam0->f_28[0], CHAR_JOSH, -1103.6f, 290.81f, 64.31f, -99.24f, "JOSH LAUNCHER RC", 1))
			...
			{
				func_273(&uParam0->f_28[1], num[2], -1102.92f, 290.12f, 64.28f, 40.46f, PED_TYPE_COP);
			...
			{
				func_273(&uParam0->f_28[2], num[2], -1102.73f, 290.91f, 64.28f, 92.06f, PED_TYPE_COP);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
				func_271(&uParam0->f_35[0], num[3], -1107.5f, 280.33f, 64.01f, 97.97f);
		
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[1]))
			{
				func_270(&uParam0->f_35[1], false);
			
				if (func_194(uParam0->f_35[1]))
				{
...
void func_270(Vehicle* pveParam0, BOOL bParam1) // Position - 0x101DB
{
	var unk;
	float num;
	...
	func_271(pveParam0, hLocal_91, unk, num);
...
void func_271(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0x1024F
{
	func_272(pveParam0);
...
void func_272(Vehicle* pveParam0) // Position - 0x10292
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_273(Ped* ppedParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5, ePedType eptParam6) // Position - 0x1032E
{
	func_274(ppedParam0);
...
void func_274(Ped* ppedParam0) // Position - 0x1034F
{
...
BOOL func_275(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x10390
{
	if (func_276(ppedParam0, echParam1, fParam2, fParam5, true))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
BOOL func_276(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x103EC
{
	Hash model;

	if (!func_36(echParam1))
	{
		model = func_322(echParam1);
...
int func_277(Ped pedParam0, eCharacter echParam1) // Position - 0x1047A
{
	int num;
...
BOOL func_278(BOOL bParam0, BOOL bParam1) // Position - 0x104C0
{
	int num;
...
BOOL func_279(BOOL bParam0, BOOL bParam1) // Position - 0x1052E
{
	int num;
...
BOOL func_280(var uParam0) // Position - 0x105D4
{
	if (func_234(uParam0))
	{
...
BOOL func_281(var uParam0) // Position - 0x105FE
{
	int i;
...
void func_282(var uParam0, char* sParam1, char* sParam2, int iParam3) // Position - 0x1062F
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
BOOL func_283(var uParam0) // Position - 0x1066B
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_281(&num) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmjosh3"))
				return false;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				if (!func_275(&uParam0->f_28[0], CHAR_JOSH, 566.1639f, -1773.8171f, 29f, 14.4f, "JOSH LAUNCHER RC", 1))
					flag = false;
		
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
				func_284(&uParam0->f_35[0]);
...
void func_284(Vehicle* pveParam0) // Position - 0x10853
{
	func_271(pveParam0, hLocal_91, 558.09f, -1765.39f, 28.86f, 335.3252f);
	VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(*pveParam0, 4);
...
BOOL func_285(var uParam0) // Position - 0x10899
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_281(&num) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmjosh2"))
				return false;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				if (!func_275(&uParam0->f_28[0], CHAR_JOSH, 565.3901f, -1772.8378f, 29.80087f, 62.501556f, "JOSH LAUNCHER RC", 1))
					flag = false;
...
BOOL func_286(var uParam0) // Position - 0x10ABC
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		case 0:
			...
			func_282(&(uParam0->f_48), "rcmjosh1", "idle", 0);
			iLocal_89 = 1;
			break;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				if (!func_275(&uParam0->f_28[0], CHAR_JOSH, -1104.72f, 291.02f, 64.39f, 138.35f, "JOSH LAUNCHER RC", 1))
					flag = false;
		
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
				func_270(&uParam0->f_35[0], true);
		
			if (!func_287(true, true))
				flag = false;
...
BOOL func_287(BOOL bParam0, BOOL bParam1) // Position - 0x10C29
{
	int num;
...
BOOL func_288(int iParam0) // Position - 0x10C97
{
	var unk;
	eCharacter character;
...
BOOL func_289(int iParam0) // Position - 0x10CE8
{
	const char* string2;

	if (Global_79389)
	{
		func_319("STEP_3_COMMON_CanRCLaunch - Script denied. Multiplayer is running [TERMINATING]");
		return false;
	}

	if (!Global_113969.f_9088 && !_IS_MISSION_REPEAT_ACTIVE(true))
	{
		func_319("STEP_3_COMMON_CanRCLaunch - Script denied, game flow is not active");
		return false;
	}
	...
	{
		Global_113056[iParam0 /*10*/].f_1 = 1;
		func_319("STEP_3_COMMON_CanRCLaunch - Script denied by RC Controller [TERMINATING]");
		return false;
	}
	...
	if (Global_101533.f_11 == 6)
	{
		if (Global_101533 < 9)
		{
			...
			{
				func_319("STEP_3_COMMON_CanRCLaunch - Script denied as a replay for this RC is being configured. [TERMINATING]");
				return false;
			}
		}
	}
	...
	{
		Global_113056[iParam0 /*10*/].f_1 = 1;
		func_319("STEP_3_COMMON_CanRCLaunch - Script denied as candidate_controller is not running. [TERMINATING]");
		return false;
	}
...
BOOL func_290(int iParam0) // Position - 0x10DA1
{
	var unk;
...
BOOL func_291(int iParam0) // Position - 0x10E62
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_292(int iParam0, char* sParam1) // Position - 0x10EE7
{
...
BOOL func_293(int iParam0) // Position - 0x10FC9
{
...
BOOL func_294(int iParam0) // Position - 0x10FF4
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_295(int iParam0) // Position - 0x1101F
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_296(int iParam0) // Position - 0x1104A
{
	if (func_261(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
void func_297() // Position - 0x1107F
{
	func_319("Running end routines.");
	Global_113687 = Global_113687 - 1;
	return;
}

BOOL func_298(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x11099
{
	int i;

	if (*uParam0 == 1)
	{
		if (func_299(uParam0->[0], uParam2, fParam5, uParam1))
			return true;
	}
	else
	{
		...
		{
			if (func_299(uParam0->[i], uParam2, fParam5, uParam1))
			{
				i = *uParam0;
				return true;
			}
	...
	func_319("DETERMINE_RC_TO_LAUNCH - Unable to find mission to launch [TERMINATING]");
	return false;
}

BOOL func_299(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x110FE
{
	int num;
	char* str;
	...
	if (func_300(str.f_6, uParam1, fParam4, false))
	{
...
BOOL func_300(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x11176
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_301(var uParam0, BOOL bParam1) // Position - 0x111F1
{
	char* str;

	if (bParam1)
	{
		func_319("SCRIPT TERMINATING: Cleaning up entities in Launcher");
		func_308(uParam0, 0, false, false);
	}

	if (HUD::DOES_BLIP_EXIST(blLocal_262))
		HUD::REMOVE_BLIP(&blLocal_262);

	func_307(&(uParam0->f_48));

	if (iLocal_93 != -1)
	{
		func_319("SCRIPT TERMINATING: Ending off-mission cutscene request");
		func_226(&iLocal_93);
	}
...
void func_302(char* sParam0) // Position - 0x1129F
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
		if (func_305(sParam0))
			func_303();
...
void func_303() // Position - 0x112BE
{
	Global_21152 = 0;
	func_304();
	return;
...
void func_304() // Position - 0x112CE
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_23297 = 0;
...
BOOL func_305(char* sParam0) // Position - 0x112EF
{
	var string1;
...
struct<6> func_306() // Position - 0x1130F
{
	var unk;
...
int func_307(var uParam0) // Position - 0x11333
{
	if (func_234(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_308(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x11369
{
	func_315(uParam0, iParam1);
	func_312(uParam0, bParam2);
	func_309(uParam0, bParam3);
	return;
}

void func_309(var uParam0, BOOL bParam1) // Position - 0x11389
{
	func_310(&(uParam0->f_41), bParam1);
	return;
}

void func_310(var uParam0, BOOL bParam1) // Position - 0x1139B
{
	int i;
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (bParam1)
			...
			func_311(&uParam0->[i], false);
	}

	return;
}

void func_311(Object* pobParam0, BOOL bParam1) // Position - 0x113D9
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_312(var uParam0, BOOL bParam1) // Position - 0x11414
{
	func_313(&(uParam0->f_35), bParam1);
	return;
}

void func_313(var uParam0, BOOL bParam1) // Position - 0x11426
{
	int i;
...
void func_314(Vehicle* pveParam0) // Position - 0x11463
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_315(var uParam0, int iParam1) // Position - 0x1149B
{
	func_316(&(uParam0->f_28), iParam1);
	return;
}

void func_316(var uParam0, int iParam1) // Position - 0x114AD
{
	int i;
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_317(&uParam0->[i], false, 1, 0);
	}

	return;
}

void func_317(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x114EE
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_318(int iParam0) // Position - 0x1153E
{
	if (*iParam0 == -1)
		return;
...
void func_319(char* sParam0) // Position - 0x1157B
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_320(var uParam0) // Position - 0x1158D
{
	*uParam0 = -1;
...
void func_321() // Position - 0x115C0
{
	func_319("Running start routines.");
	Global_113687 = Global_113687 + 1;
	return;
}

Hash func_322(eCharacter echParam0) // Position - 0x115DA
{
	if (!func_36(echParam0))
