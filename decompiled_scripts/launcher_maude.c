...
void main() // Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_113056[num /*10*/].f_9 != -1)
			{
				...
				func_281(&(Global_113056[num /*10*/].f_9));
			}
		}
	...
	if (!func_262(&unk63, &num, vector, 1f))
	{
		func_261();
	...
	while (true)
	{
		...
		func_204(num);
		func_196(&iLocal_91, &(num.f_9), vector);
...
BOOL func_1(var uParam0) // Position - 0x1EF
{
...
BOOL func_2(Any* panParam0) // Position - 0x20D
{
	const char* str;
	var unk32;
...
void func_3(int iParam0, const char* sParam1) // Position - 0x2CE
{
	func_21(sParam1);
...
var func_15(Hash hParam0) // Position - 0xB4C
{
	var outValue;
...
void func_17(BOOL bParam0) // Position - 0xB8A
{
...
void func_21(const char* sParam0) // Position - 0xC41
{
	MISC::ARE_STRINGS_EQUAL(sParam0, sParam0);
	return;
}

void func_22(char* sParam0, int iParam1) // Position - 0xC54
{
...
void func_23(char* sParam0, int iParam1, Ped pedParam2) // Position - 0xC71
{
...
void func_25(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0x194A
{
	int i;
	eCharacter j;
...
void func_27(var uParam0, int iParam1, Ped pedParam2, int iParam3, int iParam4, int iParam5) // Position - 0x27F5
{
	Vehicle vehicle;
...
int func_28(var uParam0, int iParam1, Vehicle veParam2, int iParam3) // Position - 0x287D
{
...
BOOL func_29(Vehicle veParam0) // Position - 0x28BD
{
	int i;
...
void func_30(var uParam0, Vehicle veParam1, int iParam2) // Position - 0x28EB
{
...
int func_31(Vehicle veParam0) // Position - 0x29C7
{
	int i;
...
eCharacter func_32(Vehicle veParam0) // Position - 0x2A09
{
	int i;
...
int func_33(Vehicle veParam0, eCharacter echParam1, int iParam2) // Position - 0x2A6C
{
	int i;
...
Hash func_34(eCharacter echParam0, int iParam1) // Position - 0x2AFA
{
	Hash num;
...
void func_35(eCharacter echParam0, var uParam1, int iParam2) // Position - 0x2B3C
{
	int num;
...
BOOL func_36(eCharacter echParam0) // Position - 0x2D98
{
	return echParam0 < CHAR_MULTIPLAYER;
}

void func_37(Vehicle veParam0, var uParam1) // Position - 0x2DA4
{
	int i;
...
int func_39(var uParam0, var uParam1, var uParam2) // Position - 0x30FF
{
	int i;
	int modType;
...
BOOL func_40(int iParam0) // Position - 0x32F2
{
	switch (iParam0)
	{
		case joaat("granger"):
...
BOOL func_42(Ped pedParam0, var uParam1, int iParam2, int iParam3) // Position - 0x33C3
{
...
BOOL func_43(Vehicle veParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x34F2
{
	int i;
	var garageName;
	int num;
...
BOOL func_44(eCharacter echParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x3560
{
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x3639
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x3676
{
...
Hash func_47(eCharacter echParam0) // Position - 0x369B
{
	return Global_2169[echParam0 /*29*/];
}

void func_48(Ped pedParam0, var uParam1, int iParam2, int iParam3) // Position - 0x36AA
{
...
int func_49(int iParam0, int iParam1) // Position - 0x3844
{
	Hash statHash;
	int outValue;
...
Hash func_50(int iParam0, int iParam1) // Position - 0x3873
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_51(iParam1));
}

int func_51(int iParam0) // Position - 0x3888
{
	int num;
	int num2;
...
int func_52() // Position - 0x38BC
{
	return Global_1574926;
}

BOOL func_53(int iParam0, int iParam1) // Position - 0x38C8
{
	Hash statHash;
	BOOL outValue;
...
Hash func_54(int iParam0, int iParam1) // Position - 0x38EC
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_51(iParam1));
}

void func_55(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x3901
{
	eCharacter character;
...
void func_56(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3E4A
{
	eCharacter character;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x408D
{
	func_58();
	return Global_113969.f_2366.f_539.f_4321;
}

void func_58() // Position - 0x40A6
{
	eCharacter character;
...
BOOL func_59(int iParam0) // Position - 0x41A3
{
	return Global_44042 == iParam0;
}

void func_60(Ped pedParam0, BOOL bParam1) // Position - 0x41B1
{
	eCharacter character;
...
void func_61(Ped pedParam0, var uParam1) // Position - 0x42A4
{
	int i;
	int j;
	Hash k;
...
BOOL func_62(int iParam0) // Position - 0x452C
{
	switch (iParam0)
	{
...
BOOL func_63(int iParam0) // Position - 0x45CD
{
...
Hash func_64(Hash hParam0, int iParam1) // Position - 0x47BF
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_65(Hash hParam0, Any* panParam1) // Position - 0x5500
{
	int i;
	int numDlcWeapons;
...
Hash func_66(int iParam0) // Position - 0x553B
{
	int num;
...
void func_67(Ped pedParam0) // Position - 0x57AF
{
	eCharacter character;
...
void func_68(var uParam0, int iParam1) // Position - 0x57EB
{
	var unk;
	var unk2;
	var unk5;
...
BOOL func_69(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5D3A
{
...
BOOL func_70(int iParam0, var uParam1, var uParam2) // Position - 0x5D7E
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x64FD
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x6544
{
...
BOOL func_73(int iParam0) // Position - 0x659F
{
	return func_74(iParam0, 0, true);
}

BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x65AF
{
	if (iParam0 == -1)
		return false;
...
int func_75(int iParam0) // Position - 0x660F
{
	switch (iParam0)
	{
		case 0:
...
int func_76() // Position - 0x69B7
{
	return Global_32948;
}

BOOL func_77(int iParam0) // Position - 0x69C2
{
	return func_74(iParam0, 5, true);
}

int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x69D2
{
	int i;
...
Vector3 func_79(int iParam0, BOOL bParam1) // Position - 0x6A74
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_80() // Position - 0x71D3
{
...
int func_81() // Position - 0x74CE
{
	return Global_2652592.f_2671;
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x74DD
{
...
ePedComponentType func_83() // Position - 0x7507
{
	return Global_2657971[PLAYER::PLAYER_ID() /*465*/].f_322.f_8;
}

Vector3 func_84(float fParam0, float fParam1, float fParam2) // Position - 0x751F
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_85(), 0f, fParam0);
}

Vector3 func_85() // Position - 0x7534
{
	return -880f, -2770f, -50f;
}

BOOL func_86(ePedComponentType epctParam0) // Position - 0x754B
{
...
Vector3 func_87(int iParam0, int iParam1) // Position - 0x75A3
{
	var unk;
	var unk7;
...
BOOL func_88(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x764D
{
	var unk;
	Vector3 vector;
	var unk12;
...
Vector3 func_89(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x76E2
{
	float num;
	float num2;
	float num3;
...
struct<6> func_90(int iParam0) // Position - 0x7726
{
	var unk;
...
struct<6> func_91(int iParam0) // Position - 0x78AA
{
	return func_92(iParam0);
}

struct<6> func_92(int iParam0) // Position - 0x78B8
{
	var unk;
...
BOOL func_93(int iParam0, var uParam1) // Position - 0x8380
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_94(ePedComponentType epctParam0) // Position - 0x8402
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x845A
{
	return -1;
}

Vector3 func_96(int iParam0) // Position - 0x8463
{
	switch (iParam0)
	{
		case 1:
...
int func_97() // Position - 0x86CF
{
	return func_98(PLAYER::PLAYER_ID());
}

int func_98(Player plParam0) // Position - 0x86DF
{
	return MISC::GET_BITS_IN_RANGE(Global_2657971[plParam0 /*465*/].f_322.f_3, 28, 31);
}

BOOL func_99(int iParam0) // Position - 0x86FC
{
	return func_74(iParam0, 0, false);
}

int func_100(int iParam0) // Position - 0x870C
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_101() // Position - 0x8A42
{
	return Global_101585.f_393 > 0;
}

var func_102() // Position - 0x8A53
{
	var unk;
...
void func_103(var uParam0, int iParam1) // Position - 0x8A99
{
	if (iParam1 <= 0)
		return;
...
void func_104(var uParam0, int iParam1) // Position - 0x8B1F
{
...
void func_105(var uParam0, int iParam1) // Position - 0x8B52
{
	int num;
	int num2;
...
int func_106(int iParam0, int iParam1) // Position - 0x8BA3
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_107(int iParam0) // Position - 0x8C45
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_108(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8C67
{
	if (bParam0)
		return uParam1;
...
int func_109(int iParam0) // Position - 0x8C7E
{
	return iParam0 & 15;
}

void func_110(var uParam0, int iParam1) // Position - 0x8C8B
{
...
void func_111(var uParam0, int iParam1) // Position - 0x8CC5
{
...
void func_112(var uParam0, int iParam1) // Position - 0x8D00
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8D3C
{
	func_58();
	return Global_113969.f_2366.f_539.f_4321;
}

void func_114(int iParam0) // Position - 0x8D55
{
	int num;
	var textLabel;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8DAE
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x8DC4
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_117(char* sParam0, Any anParam1, int iParam2) // Position - 0x8DDA
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8E1C
{
...
struct<2> func_119(int iParam0) // Position - 0x8E44
{
	var unk;
...
void func_120(int iParam0, var uParam1) // Position - 0x9291
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0) // Position - 0xA569
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_123(Any* panParam0) // Position - 0xA8AF
{
	int threadId;
...
void func_124(int iParam0) // Position - 0xA954
{
	var name;
...
void func_125(int iParam0) // Position - 0xA9EF
{
	if (iParam0 < 63)
	{
		func_126();
...
void func_127(Ped pedParam0) // Position - 0xAA4D
{
	int num;
	int num2;
	int num3;
...
void func_128(int iParam0) // Position - 0xAAA6
{
...
int func_129(Ped pedParam0) // Position - 0xAB29
{
	int i;
...
void func_130(int iParam0, int iParam1, int iParam2) // Position - 0xAB5A
{
	func_131(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_131(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xAB6F
{
	int num;
...
BOOL func_133(int iParam0, int iParam1, int iParam2) // Position - 0xAC22
{
...
int func_134(int iParam0, int iParam1, int iParam2) // Position - 0xAC3D
{
	int i;
...
int func_135(Ped pedParam0) // Position - 0xAC89
{
	int i;
...
BOOL func_136(Ped pedParam0) // Position - 0xACD2
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xACF2
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_138(int iParam0) // Position - 0xAD13
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_140(int iParam0) // Position - 0xADE3
{
	switch (iParam0)
	{
		case 5:
...
void func_141(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xAE36
{
	int i;
...
BOOL func_142(int iParam0) // Position - 0xAF2B
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0) // Position - 0xAF96
{
	Player playerIndex;
...
void func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xAFD5
{
	if (bParam0)
	{
...
BOOL func_145() // Position - 0xB122
{
	return IS_BIT_SET(Global_1845281[PLAYER::PLAYER_ID() /*883*/].f_36.f_18, 14);
}

BOOL func_146(Player plParam0, int iParam1) // Position - 0xB13C
{
	BOOL flag;
...
int func_147(int iParam0, BOOL bParam1) // Position - 0xB195
{
	int num;
	int num2;
...
BOOL func_148(Player plParam0) // Position - 0xB1D6
{
	Player player;
...
BOOL func_149(Player plParam0) // Position - 0xB1F8
{
...
BOOL func_150() // Position - 0xB237
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_151(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB245
{
	int num;
...
void func_153(int iParam0) // Position - 0xB29F
{
	if (iParam0 == 1)
...
BOOL func_154(const char* sParam0) // Position - 0xB2C2
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB366
{
...
BOOL func_160(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB3F5
{
...
void func_161(Vehicle veParam0) // Position - 0xB44C
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_162(BOOL bParam0, BOOL bParam1) // Position - 0xB478
{
...
void func_164(int iParam0) // Position - 0xB61A
{
	if (func_169())
		return;
...
void func_165(int iParam0) // Position - 0xB64D
{
	if (func_169())
		return;
...
void func_166(BOOL bParam0, BOOL bParam1) // Position - 0xB6D7
{
	if (bParam0)
	{
		if (func_168(0))
...
BOOL func_167() // Position - 0xB74B
{
	return IS_BIT_SET(Global_1956920, 5);
}

BOOL func_168(int iParam0) // Position - 0xB759
{
	if (iParam0 == 1)
...
BOOL func_169() // Position - 0xB7B0
{
	return IS_BIT_SET(Global_1956920, 19);
}

BOOL func_170(int iParam0) // Position - 0xB7BF
{
...
BOOL func_171(int iParam0) // Position - 0xB800
{
	int num;
...
void func_172(int iParam0) // Position - 0xB845
{
...
int func_173(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB877
{
	int i;
...
void func_174(int iParam0, int iParam1) // Position - 0xB9AE
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xB9FD
{
	return func_176(iParam0, Global_44042);
}

BOOL func_176(int iParam0, int iParam1) // Position - 0xBA0E
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_177(int iParam0) // Position - 0xBBEF
{
	if (Global_44042 == 15)
		return false;
...
int func_178() // Position - 0xBC11
{
	return func_179(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_179(const char* sParam0, int iParam1) // Position - 0xBC22
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBC6B
{
	if (Global_101533 == 10 || Global_101533 == 9)
		return true;
...
BOOL func_181(var uParam0, int iParam1) // Position - 0xBC8F
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_182() // Position - 0xC475
{
	func_27(&(Global_104530.f_2890), &Global_104530, 0, 1, 1, 0);
	return;
}

BOOL func_183(var uParam0) // Position - 0xC490
{
	float num;
...
void func_184(int iParam0, var uParam1) // Position - 0xC51E
{
	if (iParam0 == 1)
	{
		if (!func_140(uParam1))
...
BOOL func_185(BOOL bParam0) // Position - 0xC582
{
...
BOOL func_186(Vehicle veParam0) // Position - 0xC619
{
...
BOOL func_187(int iParam0) // Position - 0xC643
{
	eCharacter character;
...
BOOL func_188() // Position - 0xCD60
{
	return Global_101572.f_1;
}

BOOL func_189() // Position - 0xCD6E
{
	if (Global_98435 != -1)
...
BOOL func_192() // Position - 0xCDD5
{
	return Global_101585.f_394 > 0;
}

BOOL func_193(int iParam0, int iParam1) // Position - 0xCDE6
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_194() // Position - 0xCE1E
{
	return Global_1575083;
}

BOOL func_195() // Position - 0xCE2A
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void func_196(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xCE46
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_197(int iParam0, BOOL bParam1) // Position - 0xCF37
{
	if (iParam0 == -1)
		return;
...
int func_198(int iParam0) // Position - 0xCF73
{
	if (Global_79385 == iParam0)
		if (Global_79386 == -1)
...
void func_199(var uParam0, int iParam1) // Position - 0xCFAC
{
	BOOL flag;
	int i;
...
float func_200(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xD04A
{
...
BOOL func_201() // Position - 0xD084
{
	return Global_98822;
}

void func_202(var uParam0) // Position - 0xD090
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_203(uParam0);
...
void func_203(var uParam0) // Position - 0xD0A7
{
	BOOL flag;
	int num;
	int i;
...
void func_204(int iParam0) // Position - 0xD18F
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD1B7
{
	var unk;
...
void func_206(Ped pedParam0, var uParam1, int iParam2) // Position - 0xD427
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_207(int iParam0) // Position - 0xD77F
{
...
BOOL func_208(var uParam0) // Position - 0xD79F
{
...
BOOL func_209(var uParam0) // Position - 0xD7B7
{
...
void func_210(var uParam0) // Position - 0xD7DC
{
	int i;
	int taskSequenceId;
...
void func_211(Object* pobParam0) // Position - 0xDAE0
{
...
void func_212(var uParam0) // Position - 0xDB0B
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xDB8B
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_214(Ped pedParam0, Vehicle veParam1) // Position - 0xDD49
{
...
BOOL func_215(var uParam0, BOOL bParam1, int iParam2) // Position - 0xDD79
{
	int i;
	int num;
...
BOOL func_216(int iParam0) // Position - 0xE035
{
...
BOOL func_217(Ped pedParam0, int iParam1) // Position - 0xE069
{
	float xSize;
...
BOOL func_218(Ped pedParam0, int iParam1) // Position - 0xE0DF
{
	return func_219(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_219(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE0F7
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_220(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xE1B8
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_221(Ped pedParam0, int iParam1) // Position - 0xE2E4
{
...
BOOL func_223(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xE3F3
{
	var unk;
...
float func_224(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xE484
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_225(float fParam0, var uParam1, var uParam2) // Position - 0xE4A5
{
	float num;
	float num2;
...
void func_226(var uParam0) // Position - 0xE4E4
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_227(Ped pedParam0, Ped pedParam1) // Position - 0xE4FF
{
	int i;
...
BOOL func_228(Ped pedParam0) // Position - 0xE53E
{
...
BOOL func_229(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE566
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_230(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE661
{
	float entityCoords;
	float num;
...
BOOL func_231(Ped pedParam0, float fParam1) // Position - 0xE76D
{
	var outProjectile;
	var outCoords;
...
BOOL func_232(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xE802
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_233(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xE890
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_234(int iParam0) // Position - 0xE8D8
{
...
void func_235(Ped pedParam0) // Position - 0xE922
{
	int taskSequenceId;
...
BOOL func_236(int iParam0) // Position - 0xE9BF
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL func_237(int iParam0) // Position - 0xEA54
{
...
BOOL func_240(int iParam0) // Position - 0xEAD3
{
...
BOOL func_242(int iParam0) // Position - 0xEB45
{
...
BOOL func_243(var uParam0) // Position - 0xEB6D
{
	if (!func_244(uParam0))
		return false;
...
BOOL func_244(var uParam0) // Position - 0xEB8C
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_249(&num) || !STREAMING::HAS_ANIM_DICT_LOADED("special_ped@maude@base"))
				return false;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
				func_248(&uParam0->f_41[0], num[1], 2728.35f, 4145.59f, 43.3f, -91.28f);
		
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[1]))
				func_248(&uParam0->f_41[1], num[2], 2727.686f, 4145.715f, 44.08f, 71f);
		
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				if (!func_245(&uParam0->f_28[0], CHAR_MAUDE, 2728.33f, 4145.6f, 43.89f, 89.19f, "RC MAUDE 1", 1))
					flag = false;
		...
		case 3:
			if (func_136(uParam0->f_28[0]) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_41[0]))
			{
...
BOOL func_245(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xEE24
{
	if (func_246(ppedParam0, echParam1, fParam2, fParam5, true))
	{
...
BOOL func_246(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xEE80
{
	Hash model;

	if (!func_36(echParam1))
	{
		model = func_251(echParam1);
...
int func_247(Ped pedParam0, eCharacter echParam1) // Position - 0xEF0E
{
	int num;
...
void func_248(Object* pobParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xEF54
{
	func_211(pobParam0);
...
BOOL func_249(var uParam0) // Position - 0xEF7B
{
	int i;
...
void func_250(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0xEFAC
{
	Vector3 vector;
	Vector3 vector2;
...
Hash func_251(eCharacter echParam0) // Position - 0xF0AD
{
	if (!func_36(echParam0))
...
BOOL func_252(int iParam0) // Position - 0xF0D3
{
	var unk;
	eCharacter character;
...
BOOL func_253(int iParam0) // Position - 0xF124
{
	const char* string2;
...
BOOL func_254(int iParam0) // Position - 0xF1DD
{
	var unk;
...
BOOL func_255(int iParam0) // Position - 0xF29E
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_256(int iParam0, char* sParam1) // Position - 0xF323
{
...
BOOL func_257(int iParam0) // Position - 0xF405
{
...
BOOL func_258(int iParam0) // Position - 0xF430
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_259(int iParam0) // Position - 0xF45B
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_260(int iParam0) // Position - 0xF486
{
	if (func_237(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
BOOL func_262(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0xF4D5
{
	int i;

	if (*uParam0 == 1)
	{
		if (func_263(uParam0->[0], uParam2, fParam5, uParam1))
			return true;
	}
	else
	{
		...
		{
			if (func_263(uParam0->[i], uParam2, fParam5, uParam1))
			{
				i = *uParam0;
				return true;
			}
...
BOOL func_263(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0xF53A
{
	int num;
	char* str;
	...
	if (func_264(str.f_6, uParam1, fParam4, false))
	{
...
BOOL func_264(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0xF5B2
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_265(var uParam0, BOOL bParam1) // Position - 0xF62D
{
	if (bParam1)
	{
		func_282("SCRIPT TERMINATING: Cleaning up entities in Launcher");
		func_250(*uParam0, false, true);
		func_279(uParam0);
		func_267(uParam0, 0, false, false);
	}
...
int func_266(var uParam0) // Position - 0xF692
{
	if (func_209(uParam0))
	{
...
void func_267(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF6C8
{
...
void func_268(var uParam0, BOOL bParam1) // Position - 0xF6E8
{
	func_269(&(uParam0->f_41), bParam1);
	return;
}

void func_269(var uParam0, BOOL bParam1) // Position - 0xF6FA
{
	int i;
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (bParam1)
			...
			func_270(&uParam0->[i], false);
	}

	return;
}

void func_270(Object* pobParam0, BOOL bParam1) // Position - 0xF738
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_271(var uParam0, BOOL bParam1) // Position - 0xF773
{
	func_272(&(uParam0->f_35), bParam1);
	return;
}

void func_272(var uParam0, BOOL bParam1) // Position - 0xF785
{
	int i;
...
void func_273(Vehicle* pveParam0) // Position - 0xF7C2
{
...
void func_274(Vehicle* pveParam0) // Position - 0xF7FA
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_275(var uParam0, int iParam1) // Position - 0xF896
{
	func_276(&(uParam0->f_28), iParam1);
	return;
}

void func_276(var uParam0, int iParam1) // Position - 0xF8A8
{
	int i;
...
void func_277(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0xF8E9
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_278(Ped* ppedParam0) // Position - 0xF939
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
void func_279(var uParam0) // Position - 0xF97A
{
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uParam0->f_59))
	{
		if (func_136(uParam0->f_28[0]))
		{
			if (func_280(uParam0->f_28[0], SCRIPT_TASK_SYNCHRONIZED_SCENE))
...
BOOL func_280(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0xF9EB
{
...
void func_281(int iParam0) // Position - 0xFA1E
{
	if (*iParam0 == -1)
		return;
...
void func_282(char* sParam0) // Position - 0xFA5B
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_283(var uParam0) // Position - 0xFA6D
{
	*uParam0 = -1;
