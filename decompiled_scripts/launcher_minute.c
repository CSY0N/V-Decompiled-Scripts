...
void main() // Position - 0x0 Hash - 0x5D84F89F ^0x5D84F89F
{
	...
	iLocal_90 = func_304(CHAR_JOE);
	iLocal_91 = func_304(57);
	iLocal_92 = func_304(59);
	iLocal_93 = joaat("pranger");
	iLocal_94 = -1;
	...
	if (!func_281(&unk63, &num, vector, 1f))
	{
		func_280();
	...
	if (num == 32)
	{
		VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA({ 35f, 3409f, 322f } - { 20f, 20f, 20f }, { 35f, 3409f, 322f } + { 20f, 20f, 20f }, false, true);
		VEHICLE::REMOVE_VEHICLES_FROM_GENERATORS_IN_AREA({ 35f, 3409f, 322f } - { 20f, 20f, 20f }, { 35f, 3409f, 322f } + { 20f, 20f, 20f }, 0);
		MISC::CLEAR_AREA(vector, 40f, true, false, false, false);
	}
	else if (num == 34)
	{
		iLocal_95 = func_256();
	...
	while (true)
	{
		...
		if (num == 32)
		{
			...
			if (func_219(num.f_35[1]))
			{
				if (!func_218(329.513f, 3402.691f, 36.258f, ENTITY::GET_ENTITY_COORDS(num.f_35[1], true), 1056964608))
				{
					func_301("Player has moved SURFER2 vehicle [TERMINATING]");
					func_215(&num);
					func_284(&num, true);
				}
			}
		...
		func_214(num);
		func_207(&iLocal_94, &(num.f_9), vector);
	
		if (num == 32)
			func_203(&num, vector, "MIN1AUD", "MIN1_AMB", 3, "JOE", 4, "JOSEF", &uLocal_97);
		else if (num == 34)
			func_198(&num, vector, "MIN3AUD", "MIN3_AMB", 3, "MANUEL", 5000, 1101004800);
	
		if (func_184(&num, 0))
		{
			if (func_183(num))
				func_180(num, &blLocal_96);
...
BOOL func_1(var uParam0) // Position - 0x37A Hash - 0x5CBE5B62 ^0x13861C41
{
...
BOOL func_2(Any* panParam0) // Position - 0x398 Hash - 0xAA14BFA9 ^0xAA14BFA9
{
	const char* str;
	var unk32;
...
void func_3(int iParam0, const char* sParam1) // Position - 0x45A Hash - 0xA9A7342A ^0xA9284257
{
	func_21(sParam1);
...
void func_4(int iParam0) // Position - 0x516 Hash - 0x74C873D2 ^0x74C873D2
{
	int num;
	int num2;
...
void func_5() // Position - 0x670 Hash - 0x6EF841A5 ^0x6EF841A5
{
	int i;
...
void func_6(int iParam0) // Position - 0x723 Hash - 0xB8CA5CA7 ^0x96AAFF46
{
	switch (iParam0)
	{
		case 2:
...
void func_7(int iParam0) // Position - 0xB0B Hash - 0xA84FABDE ^0xA84FABDE
{
	Global_64031 = true;
	Global_64034 = 1;
...
void func_8(int iParam0) // Position - 0xB56 Hash - 0x4878B614 ^0x92338679
{
...
struct<2> func_9(int iParam0) // Position - 0xB8A Hash - 0x323E6781 ^0x1556DF7C
{
	var unk;
	var unk3;
...
void func_10() // Position - 0xBC2 Hash - 0xDE0A4F6 ^0xDE0A4F6
{
	if (Global_64038)
		return;
...
void func_11() // Position - 0xC18 Hash - 0x49CBF5B6 ^0x790810FF
{
	int i;
...
void func_12() // Position - 0xC45 Hash - 0x45508BA8 ^0x301C64C9
{
	int i;
...
void func_13() // Position - 0xC7C Hash - 0x8D222CF ^0x8D222CF
{
	Global_64197 = 0;
	return;
}

void func_14() // Position - 0xC88 Hash - 0xCEA3FAB3 ^0xBE2318F
{
	Global_64057 = 0;
...
var func_15(Hash hParam0) // Position - 0xCDC Hash - 0x4A0C678B ^0x403B983B
{
	var outValue;
...
void func_16() // Position - 0xCF0 Hash - 0x43632AFE ^0x43632AFE
{
	int i;
...
void func_17(BOOL bParam0) // Position - 0xD1A Hash - 0xFFF39126 ^0xFFF39126
{
...
void func_18() // Position - 0xD2E Hash - 0xFC34B768 ^0xE1D0CFD9
{
	int i;
...
void func_19() // Position - 0xD67 Hash - 0x429A4038 ^0x7C14CDBC
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("mission_stat_watcher")) > 0)
	{
		if (func_20())
...
BOOL func_20() // Position - 0xDA9 Hash - 0x46E5692F ^0xA798242F
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("mission_stat_watcher")) < 1)
		return false;
...
void func_21(const char* sParam0) // Position - 0xDD3 Hash - 0xF54A2398 ^0xC5887C42
{
	MISC::ARE_STRINGS_EQUAL(sParam0, sParam0);
	return;
}

void func_22(char* sParam0, int iParam1) // Position - 0xDE6 Hash - 0x1166ABB2 ^0x89B55D9D
{
...
void func_23(char* sParam0, int iParam1, Ped pedParam2) // Position - 0xE03 Hash - 0xB566D143 ^0xE410AB25
{
...
void func_24() // Position - 0xE48 Hash - 0x59B932B3 ^0xFC5559FC
{
	int i;
	int j;
...
void func_25(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0x1ADC Hash - 0x53B0865D ^0xC434A1E8
{
	int i;
	eCharacter j;
...
int func_26(var uParam0) // Position - 0x2965 Hash - 0x56C64BA4 ^0xCAE61007
{
...
void func_27(var uParam0, int iParam1, Ped pedParam2, int iParam3, int iParam4, int iParam5) // Position - 0x2987 Hash - 0x4709079E ^0x71C884C9
{
	Vehicle vehicle;
...
int func_28(var uParam0, int iParam1, Vehicle veParam2, int iParam3) // Position - 0x2A0F Hash - 0x6BF8E630 ^0xF655D74B
{
...
BOOL func_29(Vehicle veParam0) // Position - 0x2A4F Hash - 0x8CDF26D5 ^0xCE04F037
{
	int i;
...
void func_30(var uParam0, Vehicle veParam1, int iParam2) // Position - 0x2A7D Hash - 0x9B217A45 ^0xEE9A0448
{
...
int func_31(Vehicle veParam0) // Position - 0x2B59 Hash - 0xDEF2B534 ^0x25A18686
{
	int i;
...
eCharacter func_32(Vehicle veParam0) // Position - 0x2B9B Hash - 0x593067C2 ^0x2918B7DD
{
	int i;
...
int func_33(Vehicle veParam0, eCharacter echParam1, int iParam2) // Position - 0x2BFE Hash - 0xC883A039 ^0x6D45755E
{
	int i;
...
Hash func_34(eCharacter echParam0, int iParam1) // Position - 0x2C8C Hash - 0x3C1119CD ^0x1010ECAE
{
	Hash num;
...
void func_35(eCharacter echParam0, var uParam1, int iParam2) // Position - 0x2CCE Hash - 0xF92B8944 ^0xD11BCD5C
{
	int num;
...
BOOL func_36(eCharacter echParam0) // Position - 0x2F2A Hash - 0x8907F004 ^0x8907F004
{
	return echParam0 < CHAR_MULTIPLAYER;
}

void func_37(Vehicle veParam0, var uParam1) // Position - 0x2F36 Hash - 0x5E84B52A ^0xEF20F807
{
	int i;
...
int func_38(int iParam0) // Position - 0x31E1 Hash - 0xEE599357 ^0xEE599357
{
	switch (iParam0)
	{
		case 1:
...
int func_39(var uParam0, var uParam1, var uParam2) // Position - 0x3291 Hash - 0x4455160E ^0x8E5B3F28
{
	int i;
	int modType;
...
BOOL func_40(int iParam0) // Position - 0x3484 Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_41(var uParam0) // Position - 0x34A4 Hash - 0xB95AF921 ^0x4DC7C61C
{
	int i;
...
BOOL func_42(Ped pedParam0, var uParam1, int iParam2, int iParam3) // Position - 0x3555 Hash - 0x6795F6D3 ^0x3A08E8AF
{
...
BOOL func_43(Vehicle veParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x3684 Hash - 0xBCC62924 ^0x77695844
{
	int i;
	var garageName;
	int num;
...
BOOL func_44(eCharacter echParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x36F2 Hash - 0x8E372EAA ^0xBA705D1D
{
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x37CB Hash - 0xAC4E9801 ^0xB379A75F
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x3808 Hash - 0xADCB9755 ^0xADCB9755
{
...
Hash func_47(eCharacter echParam0) // Position - 0x382D Hash - 0xE4CEEC2C ^0xE4CEEC2C
{
	return Global_2139[echParam0 /*29*/];
}

void func_48(Ped pedParam0, var uParam1, int iParam2, int iParam3) // Position - 0x383C Hash - 0x4CE94407 ^0xC863C983
{
...
int func_49(int iParam0, int iParam1) // Position - 0x39D6 Hash - 0x744E461C ^0x94D7C845
{
	Hash statHash;
	int outValue;
...
Hash func_50(int iParam0, int iParam1) // Position - 0x3A05 Hash - 0x505A9F99 ^0x8B00E935
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_51(iParam1));
}

int func_51(int iParam0) // Position - 0x3A1A Hash - 0x1A3F3220 ^0x1A3F3220
{
	int num;
	int num2;
...
int func_52() // Position - 0x3A4E Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1574925;
}

BOOL func_53(int iParam0, int iParam1) // Position - 0x3A5A Hash - 0x5137F6D6 ^0x3B535546
{
	Hash statHash;
	BOOL outValue;
...
Hash func_54(int iParam0, int iParam1) // Position - 0x3A7E Hash - 0x1D62A43E ^0x33D7B335
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_51(iParam1));
}

void func_55(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x3A93 Hash - 0x65821445 ^0x4849EA55
{
	eCharacter character;
...
void func_56(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3FDC Hash - 0xFAA4A0BE ^0xC9D033B1
{
	eCharacter character;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x421F Hash - 0x3C5423D7 ^0x3C5423D7
{
	func_58();
	return Global_114370.f_2366.f_539.f_4321;
}

void func_58() // Position - 0x4238 Hash - 0xD1F2D853 ^0xF9F5FD4D
{
	eCharacter character;
...
BOOL func_59(int iParam0) // Position - 0x4335 Hash - 0x937D8816 ^0x937D8816
{
	return Global_43922 == iParam0;
}

void func_60(Ped pedParam0, BOOL bParam1) // Position - 0x4343 Hash - 0xC106EC1D ^0x74ED6306
{
	eCharacter character;
...
void func_61(Ped pedParam0, var uParam1) // Position - 0x4436 Hash - 0xDEAAD761 ^0xB2E3A390
{
	int i;
	int j;
	Hash k;
...
BOOL func_62(int iParam0) // Position - 0x46BE Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
...
BOOL func_63(int iParam0) // Position - 0x475F Hash - 0xD9D843D5 ^0xF9D91FBE
{
...
Hash func_64(Hash hParam0, int iParam1) // Position - 0x494B Hash - 0x6010BC66 ^0x1DFF9FB7
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_65(Hash hParam0, Any* panParam1) // Position - 0x566C Hash - 0x539D27DB ^0xB7B7AD25
{
	int i;
	int numDlcWeapons;
...
Hash func_66(int iParam0) // Position - 0x56A7 Hash - 0x5FB59AC3 ^0x9BC6B2ED
{
	int num;
...
void func_67(Ped pedParam0) // Position - 0x591B Hash - 0x27D5295B ^0xD1A82444
{
	eCharacter character;
...
void func_68(var uParam0, int iParam1) // Position - 0x5957 Hash - 0x635FFA34 ^0xAE461588
{
	var unk;
	var unk2;
	var unk5;
...
BOOL func_69(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5EA6 Hash - 0xA7FD254F ^0xFF9CDA51
{
...
BOOL func_70(int iParam0, var uParam1, var uParam2) // Position - 0x5EEA Hash - 0xE3586C79 ^0xE3586C79
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x6669 Hash - 0x2D46096D ^0xEA41378F
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x66B0 Hash - 0xDB33C708 ^0xF5B91AC7
{
...
BOOL func_73(int iParam0) // Position - 0x670B Hash - 0xCAEAF99E ^0xCAEAF99E
{
	return func_74(iParam0, 0, true);
}

BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x671B Hash - 0xA45BEB30 ^0x6033D2A2
{
	if (iParam0 == -1)
		return false;
...
int func_75(int iParam0) // Position - 0x677B Hash - 0x28E83966 ^0x9E37924F
{
	switch (iParam0)
	{
		case 0:
...
int func_76() // Position - 0x6B23 Hash - 0x21D64237 ^0x21D64237
{
	return Global_32828;
}

BOOL func_77(int iParam0) // Position - 0x6B2E Hash - 0xBE61F0FD ^0xBE61F0FD
{
	return func_74(iParam0, 5, true);
}

int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6B3E Hash - 0x4E8D2C12 ^0x4E8D2C12
{
	int i;
...
Vector3 func_79(int iParam0, BOOL bParam1) // Position - 0x6BE0 Hash - 0x4894642D ^0x4894642D
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_80() // Position - 0x734B Hash - 0x6E37375C ^0x6E37375C
{
...
int func_81() // Position - 0x7646 Hash - 0x974E48B4 ^0x974E48B4
{
	return Global_2652572.f_2650;
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x7655 Hash - 0x16E871AD ^0x10C54C39
{
...
Vector3 func_83(float fParam0, float fParam1, float fParam2) // Position - 0x767F Hash - 0xD52A1F8B ^0x5D514503
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_84(), 0f, fParam0);
}

Vector3 func_84() // Position - 0x7694 Hash - 0x21158019 ^0x21158019
{
	return -880f, -2770f, -50f;
}

BOOL func_85(ePedComponentType epctParam0) // Position - 0x76AB Hash - 0x78AB9EAC ^0x78AB9EAC
{
...
Vector3 func_86(int iParam0, int iParam1) // Position - 0x7703 Hash - 0x7E203DFC ^0x7E203DFC
{
	var unk;
	var unk7;
...
BOOL func_87(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x77AD Hash - 0x5642A5C0 ^0x5642A5C0
{
	var unk;
	Vector3 vector;
	var unk12;
...
Vector3 func_88(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x7842 Hash - 0x8959C4D1 ^0x8922A2E2
{
	float num;
	float num2;
	float num3;
...
struct<6> func_89(int iParam0) // Position - 0x7886 Hash - 0xC73C1158 ^0x2A6D4A6F
{
	var unk;
...
struct<6> func_90(int iParam0) // Position - 0x7A0A Hash - 0x2623C81B ^0x2623C81B
{
	return func_91(iParam0);
}

struct<6> func_91(int iParam0) // Position - 0x7A18 Hash - 0x7684F11 ^0xD37BE1E4
{
	var unk;
...
BOOL func_92(int iParam0, var uParam1) // Position - 0x84E0 Hash - 0x31632D18 ^0xF002B35A
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_93(ePedComponentType epctParam0) // Position - 0x8562 Hash - 0x9D5E1610 ^0x9D5E1610
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x85BA Hash - 0x478900E4 ^0x478900E4
{
	return -1;
}

Vector3 func_95(int iParam0) // Position - 0x85C3 Hash - 0xCBED323 ^0xCBED323
{
	switch (iParam0)
	{
		case 1:
...
int func_96() // Position - 0x882F Hash - 0x5976C0FC ^0xC3C6644E
{
	return func_97(PLAYER::PLAYER_ID());
}

int func_97(Player plParam0) // Position - 0x883F Hash - 0x1A54F100 ^0x35DB7B9D
{
	return MISC::GET_BITS_IN_RANGE(Global_2657921[plParam0 /*463*/].f_321.f_3, 28, 31);
}

BOOL func_98(int iParam0) // Position - 0x885C Hash - 0xA85A6891 ^0xA85A6891
{
	return func_74(iParam0, 0, false);
}

int func_99(int iParam0) // Position - 0x886C Hash - 0x1BE0B176 ^0x1BE0B176
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_100() // Position - 0x8BA2 Hash - 0xD56328D2 ^0xD56328D2
{
	return Global_101444.f_393 > 0;
}

var func_101() // Position - 0x8BB3 Hash - 0x9E44C35 ^0xB9993D58
{
	var unk;
...
void func_102(var uParam0, int iParam1) // Position - 0x8BF9 Hash - 0x15B9927E ^0x4A4674
{
	if (iParam1 <= 0)
		return;
...
void func_103(var uParam0, int iParam1) // Position - 0x8C7F Hash - 0x4C70B2C3 ^0x4C70B2C3
{
...
void func_104(var uParam0, int iParam1) // Position - 0x8CB2 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
int func_105(int iParam0, int iParam1) // Position - 0x8D03 Hash - 0xD3EBACB3 ^0xD3EBACB3
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_106(int iParam0) // Position - 0x8DA5 Hash - 0xE1B0542C ^0x127A471E
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_107(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8DC7 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
int func_108(int iParam0) // Position - 0x8DDE Hash - 0x2D4DB85F ^0x2D4DB85F
{
	return iParam0 & 15;
}

void func_109(var uParam0, int iParam1) // Position - 0x8DEB Hash - 0x864304A8 ^0x1F5003E2
{
...
void func_110(var uParam0, int iParam1) // Position - 0x8E25 Hash - 0x76860AE7 ^0x32308FFF
{
...
void func_111(var uParam0, int iParam1) // Position - 0x8E60 Hash - 0xDB8A72C0 ^0x4F6D426D
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8E9C Hash - 0x3C5423D7 ^0x3C5423D7
{
	func_58();
	return Global_114370.f_2366.f_539.f_4321;
}

void func_113(int iParam0) // Position - 0x8EB5 Hash - 0x35AC36F2 ^0xBE25C349
{
	int num;
	var textLabel;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8F0E Hash - 0x4C81F065 ^0x79C65D03
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x8F24 Hash - 0x4C81F065 ^0xB17A9745
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_116(char* sParam0, Any anParam1, int iParam2) // Position - 0x8F3A Hash - 0x817AB180 ^0xE4B855BC
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8F7C Hash - 0x15889021 ^0xE7262364
{
...
struct<2> func_118(int iParam0) // Position - 0x8FA4 Hash - 0x975AC8C9 ^0xD6C1C329
{
	var unk;
...
void func_119(int iParam0, var uParam1) // Position - 0x93F1 Hash - 0x2D8E3F8 ^0x37CA98A
{
	switch (iParam0)
	{
		case 0:
...
int func_121(int iParam0) // Position - 0xA6C9 Hash - 0xC999F6B2 ^0xC999F6B2
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_122(Any* panParam0) // Position - 0xAA0F Hash - 0x1D39FD6 ^0xAFEDDB74
{
	int threadId;
...
void func_123(int iParam0) // Position - 0xAAB4 Hash - 0xE0445FFC ^0x204FFA11
{
	var name;
...
void func_124(int iParam0) // Position - 0xAB4F Hash - 0xE70A4F17 ^0xE70A4F17
{
	if (iParam0 < 63)
	{
		func_125();
...
void func_125() // Position - 0xAB75 Hash - 0xD5DFA716 ^0xD54995D4
{
	Global_79503 != 6;
...
void func_126(Ped pedParam0) // Position - 0xABAD Hash - 0x91438920 ^0xDA692F14
{
	int num;
	int num2;
	int num3;
...
void func_127(int iParam0) // Position - 0xAC06 Hash - 0xBB510F32 ^0xE77AE77B
{
...
int func_128(Ped pedParam0) // Position - 0xAC89 Hash - 0x14AF2EDD ^0xC5BC7CD2
{
	int i;
...
void func_129(int iParam0, int iParam1, int iParam2) // Position - 0xACBA Hash - 0xF54D70EF ^0xF54D70EF
{
	func_130(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_130(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xACCF Hash - 0x9F3D8BA2 ^0x9F3D8BA2
{
	int num;
...
int func_131() // Position - 0xAD51 Hash - 0x11506CC4 ^0x2E9F5641
{
	int i;
...
BOOL func_132(int iParam0, int iParam1, int iParam2) // Position - 0xAD82 Hash - 0x3A30B8C2 ^0x3A30B8C2
{
...
int func_133(int iParam0, int iParam1, int iParam2) // Position - 0xAD9D Hash - 0x61F8C119 ^0x1C9B84EC
{
	int i;
...
int func_134(Ped pedParam0) // Position - 0xADE9 Hash - 0xDCBB968F ^0xDCBB968F
{
	int i;
...
BOOL func_135(Ped pedParam0) // Position - 0xAE32 Hash - 0x7E48B415 ^0x126328AB
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xAE52 Hash - 0x3D210083 ^0xF7E7C389
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_137(int iParam0) // Position - 0xAE73 Hash - 0xBF3EFB31 ^0xBF3EFB31
{
	switch (iParam0)
	{
		case 5:
...
void func_138() // Position - 0xAEC6 Hash - 0x53295875 ^0x53295875
{
...
BOOL func_139(int iParam0) // Position - 0xAF43 Hash - 0xBF3EFB31 ^0xBF3EFB31
{
	switch (iParam0)
	{
		case 5:
...
void func_140(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xAF96 Hash - 0x50B95D9E ^0x1806B4C4
{
	int i;
...
BOOL func_141(int iParam0) // Position - 0xB08B Hash - 0xBF3EFB31 ^0xBF3EFB31
{
	switch (iParam0)
	{
		case 5:
...
void func_142(BOOL bParam0) // Position - 0xB0F6 Hash - 0xD10400C0 ^0xB6845444
{
	Player playerIndex;
...
void func_143(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB135 Hash - 0x787E640E ^0x67C15509
{
	if (bParam0)
	{
...
BOOL func_144() // Position - 0xB282 Hash - 0xAA7793E3 ^0x3F62CDC8
{
	return IS_BIT_SET(Global_1845263[PLAYER::PLAYER_ID() /*877*/].f_36.f_18, 14);
}

BOOL func_145(Player plParam0, int iParam1) // Position - 0xB29C Hash - 0x1A32E11A ^0x6AADE226
{
	BOOL flag;
...
int func_146(int iParam0, BOOL bParam1) // Position - 0xB2F5 Hash - 0x1DCD393E ^0x1DCD393E
{
	int num;
	int num2;
...
BOOL func_147(Player plParam0) // Position - 0xB336 Hash - 0x6A46C9B4 ^0x6A46C9B4
{
	Player player;
...
BOOL func_148(Player plParam0) // Position - 0xB358 Hash - 0x68897CDD ^0x62820466
{
...
BOOL func_149() // Position - 0xB397 Hash - 0xA525B2F4 ^0xA525B2F4
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_150(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB3A5 Hash - 0x3167F4C7 ^0xCE6B9B6A
{
	int num;
...
BOOL func_151() // Position - 0xB3D8 Hash - 0xD140D54A ^0xE638D98F
{
...
void func_152(int iParam0) // Position - 0xB3FF Hash - 0x1B2EEE72 ^0xEDBC1F9D
{
	if (iParam0 == 1)
...
BOOL func_153(const char* sParam0) // Position - 0xB422 Hash - 0x16488C7A ^0x873534BB
{
...
void func_154() // Position - 0xB45F Hash - 0xC536DD5 ^0xC536DD5
{
	Global_21032 = 0;
	func_155();
	return;
...
void func_155() // Position - 0xB46F Hash - 0xE32CF1EF ^0xB9A7BEB2
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB4C6 Hash - 0x152DA0B2 ^0x220E93E9
{
...
void func_157() // Position - 0xB4E8 Hash - 0xE60F63BE ^0xE60F63BE
{
	func_163(0);
	func_162();
	func_158();
...
void func_158() // Position - 0xB4FD Hash - 0xC95798F1 ^0x61ADB9D7
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
...
BOOL func_159(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB555 Hash - 0xEF9D4F61 ^0xC848BDEA
{
...
void func_160(Vehicle veParam0) // Position - 0xB5AC Hash - 0x94E8CB0B ^0x47923A23
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_161(BOOL bParam0, BOOL bParam1) // Position - 0xB5D8 Hash - 0xC86614C6 ^0xCD39041A
{
...
void func_162() // Position - 0xB729 Hash - 0x2A0AC5B7 ^0xAF27577A
{
...
void func_163(int iParam0) // Position - 0xB77A Hash - 0x7E11E9C ^0x544BF257
{
	if (func_168())
		return;
...
void func_164(int iParam0) // Position - 0xB7AD Hash - 0x4066FEF5 ^0x9787FBDA
{
	if (func_168())
		return;
...
void func_165(BOOL bParam0, BOOL bParam1) // Position - 0xB837 Hash - 0xF40FC178 ^0xA6F60F17
{
	if (bParam0)
	{
		if (func_167(0))
...
BOOL func_166() // Position - 0xB8AB Hash - 0x8DF3D75D ^0x8DF3D75D
{
	return IS_BIT_SET(Global_1956030, 5);
}

BOOL func_167(int iParam0) // Position - 0xB8B9 Hash - 0xE8921B44 ^0x4F063755
{
	if (iParam0 == 1)
...
BOOL func_168() // Position - 0xB910 Hash - 0xC41437CB ^0xC41437CB
{
	return IS_BIT_SET(Global_1956030, 19);
}

BOOL func_169(int iParam0) // Position - 0xB91F Hash - 0x2BFED607 ^0x2BFED607
{
...
BOOL func_170(int iParam0) // Position - 0xB960 Hash - 0x5C21BF6B ^0xB5545E1F
{
	int num;
	...
	num = func_172(&(Global_113457[iParam0 /*10*/].f_9), 1, 4, false, 0);
...
void func_171(int iParam0) // Position - 0xB9A5 Hash - 0xF49E441F ^0xE21552CB
{
...
int func_172(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB9D7 Hash - 0x8F9349A ^0xC5C097C1
{
	int i;
...
void func_173(int iParam0, int iParam1) // Position - 0xBB0E Hash - 0x6AC97785 ^0x6AC97785
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBB5D Hash - 0xECB6C71B ^0xECB6C71B
{
	return func_175(iParam0, Global_43922);
}

BOOL func_175(int iParam0, int iParam1) // Position - 0xBB6E Hash - 0x1FD727E0 ^0x1FD727E0
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_176(int iParam0) // Position - 0xBD4F Hash - 0x3BAB94E9 ^0x3BAB94E9
{
	if (Global_43922 == 15)
		return false;
...
int func_177() // Position - 0xBD71 Hash - 0x613FC6AD ^0xDC7835B3
{
	return func_178(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_178(char* sParam0, int iParam1) // Position - 0xBD82 Hash - 0x76A2E0AF ^0x8A5231BB
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBDCB Hash - 0x77F66043 ^0x77F66043
{
	if (Global_101392 == 10 || Global_101392 == 9)
		return true;
...
void func_180(int iParam0, var uParam1) // Position - 0xBDEF Hash - 0x4DABA5AB ^0x5B086A56
{
	switch (iParam0)
	{
		case 0:
...
Blip func_181(float fParam0, float fParam1, float fParam2, BOOL bParam3) // Position - 0xC261 Hash - 0xF4E99477 ^0x29669E98
{
	Blip blip;
...
var func_182(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC28D Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
BOOL func_183(int iParam0) // Position - 0xC2A4 Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_184(var uParam0, int iParam1) // Position - 0xC333 Hash - 0x4C332810 ^0xCFFAAA23
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_185() // Position - 0xCB16 Hash - 0x1DF115D ^0x1DF115D
{
	func_27(&(Global_104933.f_2890), &Global_104933, 0, 1, 1, 0);
	return;
}

BOOL func_186(var uParam0) // Position - 0xCB31 Hash - 0xBE0C612E ^0xC181C5F3
{
	float num;
...
void func_187(int iParam0, var uParam1) // Position - 0xCBBF Hash - 0x16CCAA18 ^0xDEACEA81
{
	if (iParam0 == 1)
	{
		if (!func_139(uParam1))
...
BOOL func_188(BOOL bParam0) // Position - 0xCC23 Hash - 0x328D4447 ^0x90410402
{
...
BOOL func_189(int iParam0) // Position - 0xCCBA Hash - 0x97844555 ^0xADCD6DAA
{
	eCharacter character;
...
BOOL func_190() // Position - 0xD3D7 Hash - 0x4228A1C2 ^0x952FE30F
{
	return Global_101431.f_1;
}

BOOL func_191() // Position - 0xD3E5 Hash - 0xC20DBA70 ^0xAC4006FB
{
	if (Global_98294 != -1)
...
BOOL func_192() // Position - 0xD408 Hash - 0x3CA1BB47 ^0xB78A1ACB
{
...
BOOL func_193() // Position - 0xD422 Hash - 0xE663B8F6 ^0xE663B8F6
{
	if (Global_79509)
		return true;
...
BOOL func_194() // Position - 0xD44C Hash - 0xD56328D2 ^0xD56328D2
{
	return Global_101444.f_394 > 0;
}

BOOL func_195(int iParam0, int iParam1) // Position - 0xD45D Hash - 0xA14C4D3F ^0xA6034F77
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_196() // Position - 0xD495 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1575079;
}

BOOL func_197() // Position - 0xD4A1 Hash - 0x7FE517FE ^0x128A3BC8
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
int func_198(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xD4BD Hash - 0xA74186BF ^0x512FC932
{
	var unk;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() && MISC::GET_GAME_TIMER() - uParam0->f_60 > iParam8 && func_202(PLAYER::PLAYER_PED_ID(), uParam1, true) < iParam9)
	{
		unk = 16;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD545 Hash - 0xF7ECDFD9 ^0x6B079C3E
{
...
void func_200(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD580 Hash - 0xC6B752B2 ^0xC6B752B2
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD5D6 Hash - 0x6C235EE0 ^0x9E57F206
{
...
float func_202(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xD671 Hash - 0xC22B942A ^0xE0DB8793
{
...
int func_203(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10) // Position - 0xD6AB Hash - 0x42D237C6 ^0x6AD55B68
{
	var unk;
		...
		if (func_189(2))
		{
			if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
			{
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[1]) && func_202(PLAYER::PLAYER_PED_ID(), uParam1, true) < 20f)
				{
					...
					{
						func_301("conversation ended");
						*uParam10 = 3;
						return 1;
					}
				}
			}
			else if (func_205(sParam5) && !(*uParam10 == 1) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && func_202(PLAYER::PLAYER_PED_ID(), uParam1, true) >= 20f)
			{
				func_301("pause conversation");
				func_204(1);
				*uParam10 = 1;
			}
...
void func_204(int iParam0) // Position - 0xD7F6 Hash - 0x67413911 ^0x67413911
{
	Global_23177 = iParam0;
	return;
}

BOOL func_205(char* sParam0) // Position - 0xD803 Hash - 0x5CF3EDA6 ^0x878C8302
{
	var string1;
...
struct<6> func_206() // Position - 0xD823 Hash - 0xB37EF8EF ^0xB37EF8EF
{
	var unk;
...
void func_207(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD847 Hash - 0xA38693DA ^0xBAAA90B1
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_202(PLAYER::PLAYER_PED_ID(), uParam2, true) <= 100f)
					func_210(uParam0, 1);
			}
			else
			{
				switch (func_209(*uParam0))
				{
					...
					case 2:
						...
						func_208(*uParam0, false);
						break;
				}
			
				if (func_202(PLAYER::PLAYER_PED_ID(), uParam2, true) > 120f)
					func_212(uParam0);
			}
		}
	}
...
void func_208(int iParam0, BOOL bParam1) // Position - 0xD938 Hash - 0x3ABFF97A ^0x3ABFF97A
{
	if (iParam0 == -1)
		return;
...
int func_209(int iParam0) // Position - 0xD974 Hash - 0x3F6843D0 ^0x973F28A6
{
	if (Global_79244 == iParam0)
		if (Global_79245 == -1)
...
void func_210(var uParam0, int iParam1) // Position - 0xD9AD Hash - 0xA189769D ^0xD7591C4B
{
	BOOL flag;
	int i;
...
BOOL func_211() // Position - 0xDA4B Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_98681;
}

void func_212(var uParam0) // Position - 0xDA57 Hash - 0x8EEB5116 ^0x2325FF68
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_213(uParam0);
...
void func_213(var uParam0) // Position - 0xDA6E Hash - 0x1C509C5B ^0x1C509C5B
{
	BOOL flag;
	int num;
	int i;
...
void func_214(int iParam0) // Position - 0xDB56 Hash - 0xD347101A ^0xCC220E7F
{
	if (iParam0 == -1)
		iParam0 = func_177();
...
void func_215(var uParam0) // Position - 0xDB7E Hash - 0x2E98ABB1 ^0xFF31A41F
{
	int i;
	int taskSequenceId;
	...
	if (*uParam0 == 52)
	{
		func_217(&uParam0->f_41[1]);
		func_217(&uParam0->f_41[2]);
	}
...
void func_216(Ped pedParam0) // Position - 0xDE82 Hash - 0xAD821AF8 ^0xF5E6DE0
{
	int taskSequenceId;
...
void func_217(Object* pobParam0) // Position - 0xDF1F Hash - 0x4EAFEE58 ^0x34D7ECA6
{
...
BOOL func_218(float fParam0, float fParam1, float fParam2, var uParam3, var uParam4, var uParam5, int iParam6) // Position - 0xDF4A Hash - 0xBD36EF52 ^0x26B42458
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
BOOL func_219(Vehicle veParam0) // Position - 0xDF83 Hash - 0x7E47BB06 ^0x692E6B64
{
...
void func_220() // Position - 0xDFAD Hash - 0xE9F8C960 ^0x53DA8CD1
{
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xDFE0 Hash - 0x7D86F6E4 ^0xA3B67CB5
{
	var unk;
	...
	if (panParam0->f_25 == 1)
		if (!func_229(panParam0, true, 0))
			return false;
	else if (panParam0->f_16 == 0)
		if (!func_229(panParam0, false, 0))
			return false;
	...
	if (func_225(&(panParam0->f_48)) && bParam1)
		func_222(panParam0->f_28[0], &(panParam0->f_48), *panParam0);

	return true;
}

void func_222(Ped pedParam0, var uParam1, int iParam2) // Position - 0xE250 Hash - 0xD4C7D099 ^0x162C1E9
{
	int taskSequenceId;
	int taskSequenceId2;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_224(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(pedParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_223(iParam2) && !PED::IS_PED_FACING_PED(pedParam0, PLAYER::PLAYER_PED_ID(), 25f))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(pedParam0, PLAYER::PLAYER_PED_ID(), 0);
						uParam1->f_3 = 5;
					}
					else if (func_224(uParam1) && uParam1->f_4 == 0 && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(pedParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_223(iParam2) || PED::IS_PED_FACING_PED(pedParam0, PLAYER::PLAYER_PED_ID(), 10f))
				{
					if (func_71(uParam1->f_5, 0f, 0f, 0f, false))
						TASK::TASK_PLAY_ANIM(pedParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, false, false, false);
					else
...
BOOL func_223(int iParam0) // Position - 0xE5A8 Hash - 0xD681AEF7 ^0xD681AEF7
{
...
BOOL func_224(var uParam0) // Position - 0xE5C8 Hash - 0x42F869D4 ^0xFFADB180
{
...
BOOL func_225(var uParam0) // Position - 0xE5E0 Hash - 0x6329B93C ^0xCBBB8D92
{
...
void func_226(var uParam0) // Position - 0xE605 Hash - 0x5209F824 ^0xCFA0F1CA
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE685 Hash - 0x53567DCF ^0x584F6887
{
	int i;
	int num;
	Vehicle playersLastVehicle;
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[i]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (func_219(playersLastVehicle2))
						{
						...
						if (*uParam0 == 16)
						{
							if (func_228(PLAYER::PLAYER_PED_ID(), uParam0->f_35[i]))
							{
...
BOOL func_228(Ped pedParam0, Vehicle veParam1) // Position - 0xE843 Hash - 0xFB12ABF0 ^0x730FD205
{
...
BOOL func_229(var uParam0, BOOL bParam1, int iParam2) // Position - 0xE873 Hash - 0xE9BDE167 ^0x20C575FA
{
	int i;
	int num;
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[i]))
			{
				if (!PED::IS_PED_INJURED(uParam0->f_28[i]))
				{
					...
					if (func_248(*uParam0))
					{
						if (!func_169(*uParam0))
						{
							if (func_243(uParam0->f_28[i], true, false, false, false))
							{
								if (iParam2 == 0)
									func_215(uParam0);
								else
						...
						if (func_231(uParam0->f_28[i], 1126825984))
						{
							if (iParam2 == 0)
								func_215(uParam0);
							else
...
BOOL func_230(int iParam0) // Position - 0xEB2F Hash - 0x9E3DCA43 ^0x9E3DCA43
{
...
BOOL func_231(Ped pedParam0, int iParam1) // Position - 0xEB63 Hash - 0x5EA05E45 ^0x7984EB04
{
	float xSize;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam0))
	{
		if (func_242(pedParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), pedParam0))
		{
...
BOOL func_232(Ped pedParam0, int iParam1) // Position - 0xEBD9 Hash - 0xF1789D04 ^0x3F9D1900
{
	return func_233(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_233(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xEBF1 Hash - 0x275BB58B ^0x275BB58B
{
	BOOL flag;
	var pedBoneCoords;
	int num;

	num = func_241(pedParam0, pedParam1);

	if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam0) || !_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam1))
	{
		if (num != -1)
			func_240(&iLocal_35[num /*4*/]);
	
		return false;
	}

	if (!func_237(pedParam0, pedParam1, iParam2, iParam3))
		return false;
	...
	flag = func_234(&iLocal_35[num /*4*/], pedBoneCoords, pedParam1, &(iLocal_35[num /*4*/].f_3), pedParam0, iParam5);
	return flag || MISC::GET_GAME_TIMER() - iLocal_35[num /*4*/].f_3 < iParam4;
}

BOOL func_234(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xECB2 Hash - 0xBBBECF07 ^0xBBBECF07
{
	var hit;
	var endCoords;
	var surfaceNormal;
	...
	if (*uParam0 == 0)
	{
		endCoords = { func_235(pedParam4, iParam7) };
...
Vector3 func_235(Ped pedParam0, int iParam1) // Position - 0xEDDE Hash - 0xA6273130 ^0xF7D9CDEA
{
...
int func_236() // Position - 0xEEA3 Hash - 0x1398F041 ^0xCD84FF69
{
	int i;
...
BOOL func_237(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xEEED Hash - 0x6EF1707D ^0x8C069CF9
{
	var unk;
	var entityForwardVector;
	float num;

	unk = { func_239(ENTITY::GET_ENTITY_COORDS(pedParam1, true) - ENTITY::GET_ENTITY_COORDS(pedParam0, true)) };
	...
	if (iParam3 == 0)
		...
		entityForwardVector = { func_239(PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 0f, 0f)) };

	num = func_238(entityForwardVector, unk);
...
float func_238(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xEF7E Hash - 0x596BEA29 ^0x5FBCDBE5
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_239(float fParam0, var uParam1, var uParam2) // Position - 0xEF9F Hash - 0xFB6A39D2 ^0x80C9C759
{
	float num;
	float num2;
...
void func_240(var uParam0) // Position - 0xEFDE Hash - 0xA4B72113 ^0x62A5EAE1
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_241(Ped pedParam0, Ped pedParam1) // Position - 0xEFF9 Hash - 0xAA445031 ^0xEBA3F8CF
{
	int i;
...
BOOL func_242(Ped pedParam0) // Position - 0xF038 Hash - 0xEC80536A ^0x2D4CF2B0
{
...
BOOL func_243(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF060 Hash - 0x5B46DA49 ^0x44F718
{
	float radius;
	float num;
	int weaponHash;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam0))
	{
		...
		if (!bParam2)
		{
			if (func_247(pedParam0, bParam1, radius, num))
				return true;
		
			if (func_244(pedParam0, num, bParam3, bParam4))
				return true;
		}
		else
		{
...
BOOL func_244(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF15B Hash - 0x1310B579 ^0x2AAFC0CC
{
	float entityCoords;
	float num;
...
BOOL func_245(Ped pedParam0, float fParam1) // Position - 0xF267 Hash - 0xFA3D7088 ^0x33A74060
{
	var outProjectile;
	var outCoords;
	...
	if (MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(pedParam0, joaat("WEAPON_GRENADE"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(pedParam0, joaat("WEAPON_SMOKEGRENADE"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(pedParam0, joaat("WEAPON_BZGAS"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(pedParam0, joaat("WEAPON_STICKYBOMB"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(pedParam0, joaat("WEAPON_MOLOTOV"), fParam1, &outCoords, &outProjectile, false))
		if (func_246(pedParam0, outCoords, 90f, 0))
			return true;

	return false;
}

BOOL func_246(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF2FC Hash - 0x3F40E5FA ^0xC3BEFE6A
{
	var unk;
	var entityForwardVector;
	float num;

	unk = { func_239(uParam1 - ENTITY::GET_ENTITY_COORDS(pedParam0, true)) };
...
BOOL func_247(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF38A Hash - 0x18BAE105 ^0x60D3B20E
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_248(int iParam0) // Position - 0xF3D2 Hash - 0x5B443B41 ^0x5B443B41
{
...
BOOL func_249(int iParam0) // Position - 0xF41C Hash - 0x6F2BC7EE ^0x6F2BC7EE
{
	if (iParam0 == -1)
		iParam0 = func_177();
...
BOOL func_250(int iParam0) // Position - 0xF4B1 Hash - 0xDE7BA54D ^0xDE7BA54D
{
...
BOOL func_251() // Position - 0xF4F0 Hash - 0x29CB2928 ^0xE369A18D
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_252() // Position - 0xF50D Hash - 0x98CCC132 ^0x97B0D6ED
{
	if (Global_98294 != -1)
...
BOOL func_253(int iParam0) // Position - 0xF530 Hash - 0xC2630182 ^0xFBD23031
{
	if (func_254() && Global_101392.f_11 == 6 && iParam0 == func_178(&(Global_101392.f_3), 0))
		return true;

	return false;
}

BOOL func_254() // Position - 0xF564 Hash - 0x25806CBF ^0x25806CBF
{
...
BOOL func_255(int iParam0) // Position - 0xF5A2 Hash - 0x1156B580 ^0x34C7FA05
{
...
int func_256() // Position - 0xF5CA Hash - 0x5A4670E ^0xE582B183
{
	return PED::ADD_SCENARIO_BLOCKING_AREA(-309.1f, 6205.4f, 30f, -279.33f, 6217.98f, 40f, false, true, true, true, 1);
}

BOOL func_257(var uParam0) // Position - 0xF5F9 Hash - 0x24D26100 ^0x24D26100
{
	switch (*uParam0)
	{
		case 32:
...
BOOL func_258(var uParam0) // Position - 0xF657 Hash - 0xCEE031 ^0xB324F0F5
{
	int num;
	int i;
	BOOL flag;
	...
	num[1] = joaat("bison");
	num[2] = iLocal_92;
	num[3] = joaat("prop_table_03_chr");
	num[4] = joaat("prop_cs_rolled_paper");
	...
	switch (iLocal_89)
	{
		case 0:
			uParam0->f_16 = 4;
			uParam0->f_27 = 0;
			TEXT_LABEL_ASSIGN_STRING(&(uParam0->f_9), "MMB_3_RCM", 24);
			uParam0->f_25 = 1;
			uParam0->f_17[0 /*3*/] = { -303.51196f, 6211.8096f, 30.487585f };
			uParam0->f_17[1 /*3*/] = { 20f, 20f, 3f };
			func_267(&(uParam0->f_48), "rcmminute3base", "base", "beckon");
		...
		case 1:
			if (!func_266(&num) || !func_265(&(uParam0->f_48)))
				return false;
		...
		case 2:
			...
			{
				func_264(&uParam0->f_41[0], num[3], -303.74f, 6211.56f, 30.49f, -176.77f);
			...
			{
				if (func_261(&uParam0->f_28[0], CHAR_MANUEL, uParam0->f_48.f_5, -2.8f, "RCM MINUTE - MANUEL", 1))
				{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_259(&uParam0->f_35[0], num[0], -281.93f, 6198.32f, 30.77f, -135.32f);
			...
			{
				func_259(&uParam0->f_35[1], num[1], -291.72f, 6208.33f, 30.87f, -134.50163f);
			...
			{
				func_264(&uParam0->f_41[1], num[4], -303.74f, 6211.56f, 30.49f, -176.77f);
...
void func_259(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF97A Hash - 0x60B41505 ^0x2C4B5209
{
	func_260(pveParam0);
...
void func_260(Vehicle* pveParam0) // Position - 0xF9BD Hash - 0x8D18F713 ^0xF71A18A8
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_261(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xFA59 Hash - 0x5E27D69A ^0xE8A3C3CE
{
	if (func_262(ppedParam0, echParam1, fParam2, fParam5, true))
	{
...
BOOL func_262(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xFAB5 Hash - 0xC57592AD ^0x9AA0BE7
{
	Hash model;
...
int func_263(Ped pedParam0, eCharacter echParam1) // Position - 0xFB43 Hash - 0x5AC42C11 ^0x5AC42C11
{
	int num;
...
void func_264(Object* pobParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xFB89 Hash - 0x61F651EE ^0x2FE58679
{
	func_217(pobParam0);
...
BOOL func_265(var uParam0) // Position - 0xFBB0 Hash - 0xB319BDFA ^0xA1F4DAFB
{
	if (func_225(uParam0))
	{
...
BOOL func_266(var uParam0) // Position - 0xFBDA Hash - 0xC42B20E0 ^0x728F1DAE
{
	int i;
...
void func_267(var uParam0, char* sParam1, char* sParam2, char* sParam3) // Position - 0xFC0B Hash - 0x6EEDFC2 ^0xD51569DC
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
BOOL func_268(var uParam0) // Position - 0xFC47 Hash - 0x2A804246 ^0xE0B14C12
{
	int num;
	int i;
	...
	switch (iLocal_89)
	{
		case 0:
			...
			uParam0->f_15 = 7f;
			uParam0->f_27 = 0;
			TEXT_LABEL_ASSIGN_STRING(&(uParam0->f_9), "MMB_2_RCM", 24);
		...
		case 2:
			func_259(&uParam0->f_35[0], num[0], 20.8f, 4532.65f, 104.66f, 284.7f);
...
BOOL func_269(var uParam0) // Position - 0xFD5A Hash - 0xF94EB768 ^0x91238E41
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		case 0:
			...
			uParam0->f_25 = 1;
			uParam0->f_26 = 1;
			TEXT_LABEL_ASSIGN_STRING(&(uParam0->f_9), "MMB_1_RCM", 24);
		...
		case 1:
			...
			if (!func_266(&num) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmminute1"))
				return false;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				if (func_261(&uParam0->f_28[0], CHAR_JOE, 329.3f, 3404.2f, 35.8f, -174.9f, "RCM MINUTE - JOE", 1))
			...
			{
				if (func_261(&uParam0->f_28[1], CHAR_JOSEF, 328.1f, 3403.8f, 35.8f, -149.6f, "RCM MINUTE - JOSEF", 1))
				{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_259(&uParam0->f_35[0], num[0], 321.69f, 3408.64f, 35.34f, -105.8f);
				func_270(uParam0->f_35[0], num[0]);
			}
		
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[1]))
			{
				func_259(&uParam0->f_35[1], num[1], 329.49f, 3402.71f, 36.29f, 284.36f);
				func_270(uParam0->f_35[1], num[1]);
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED("rcmminute1"))
			{
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]))
				{
					if (!ENTITY::IS_ENTITY_PLAYING_ANIM(uParam0->f_28[0], "rcmminute1", "base_joe", 3))
					{
						...
						TASK::TASK_PLAY_ANIM(uParam0->f_28[0], "rcmminute1", "base_joe", 8f, -8f, -1, 1, 0, false, false, false);
				...
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[1]))
				{
					...
					TASK::TASK_PLAY_ANIM(uParam0->f_28[1], "rcmminute1", "base_josef", 8f, -8f, -1, 1, 0, false, false, false);
...
void func_270(Vehicle veParam0, Hash hParam1) // Position - 0x1007F Hash - 0xCC689680 ^0x1E3B80B4
{
	if (ENTITY::DOES_ENTITY_EXIST(veParam0))
	{
		VEHICLE::SET_VEHICLE_ALARM(veParam0, false);
		VEHICLE::SET_VEHICLE_DOORS_LOCKED(veParam0, 2);
		VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(hParam1, true);
		VEHICLE::SET_VEHICLE_AUTOMATICALLY_ATTACHES(veParam0, false, 0);
		VEHICLE::SET_VEHICLE_DISABLE_TOWING(veParam0, true);
	}

	return;
}

BOOL func_271(int iParam0) // Position - 0x100B5 Hash - 0x59D2F680 ^0x59D2F680
{
	var unk;
	eCharacter character;
...
BOOL func_272(int iParam0) // Position - 0x10106 Hash - 0xC6B32843 ^0x87822337
{
	const char* string2;
...
BOOL func_273(int iParam0) // Position - 0x101BF Hash - 0x791D84F4 ^0x791D84F4
{
	var unk;
...
BOOL func_274(int iParam0) // Position - 0x10280 Hash - 0xDEAD9A68 ^0xDEAD9A68
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_275(int iParam0, char* sParam1) // Position - 0x10305 Hash - 0xC64245F ^0x37CD7827
{
...
BOOL func_276(int iParam0) // Position - 0x103E7 Hash - 0x5ADD7F05 ^0x5ADD7F05
{
...
BOOL func_277(int iParam0) // Position - 0x10412 Hash - 0xBB053D24 ^0xBB053D24
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_278(int iParam0) // Position - 0x1043D Hash - 0x5D95A044 ^0x5D95A044
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_279(int iParam0) // Position - 0x10468 Hash - 0x9FFC81CD ^0x47A2AB8B
{
	if (func_250(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
void func_280() // Position - 0x1049D Hash - 0x5631C87C ^0x88FEF610
{
...
BOOL func_281(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x104B7 Hash - 0x5B983661 ^0x5B983661
{
	int i;

	if (*uParam0 == 1)
	{
		if (func_282(uParam0->[0], uParam2, fParam5, uParam1))
			return true;
	}
	else
	{
		...
		{
			if (func_282(uParam0->[i], uParam2, fParam5, uParam1))
			{
				i = *uParam0;
				return true;
			}
...
BOOL func_282(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x1051C Hash - 0xC6B7068B ^0xB9A971A4
{
	int num;
	char* str;
	...
	if (func_283(str.f_6, uParam1, fParam4, false))
	{
...
BOOL func_283(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x10594 Hash - 0x1FB736D4 ^0x234AEAB7
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_284(var uParam0, BOOL bParam1) // Position - 0x1060F Hash - 0xB95D9CC7 ^0x6A56FDF8
{
	char* str;

	if (bParam1)
	{
		func_301("SCRIPT TERMINATING: Cleaning up entities in Launcher");
		func_289(uParam0, 0, false, false);
	}
	...
	if (*uParam0 == 32)
		VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA({ 35f, 3409f, 322f } - { 20f, 20f, 20f }, { 35f, 3409f, 322f } + { 20f, 20f, 20f }, true, true);
	else if (*uParam0 == 34)
		PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_95, false);

	func_288(&(uParam0->f_48));
...
void func_285(char* sParam0) // Position - 0x106FC Hash - 0xA52CF679 ^0xC94F8C8B
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
		if (func_205(sParam0))
			func_286();
...
void func_286() // Position - 0x1071B Hash - 0xC536DD5 ^0xC536DD5
{
	Global_21032 = 0;
	func_287();
	return;
...
void func_287() // Position - 0x1072B Hash - 0xF6D04E68 ^0x80AE5309
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_23177 = 0;
...
int func_288(var uParam0) // Position - 0x1074C Hash - 0x86633390 ^0xB4AC09BB
{
	if (func_225(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_289(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x10782 Hash - 0x5BE1D1E3 ^0x5BE1D1E3
{
	func_296(uParam0, iParam1);
	func_293(uParam0, bParam2);
	func_290(uParam0, bParam3);
	return;
}

void func_290(var uParam0, BOOL bParam1) // Position - 0x107A2 Hash - 0xEDC3BD2D ^0xE0B6F056
{
	func_291(&(uParam0->f_41), bParam1);
	return;
}

void func_291(var uParam0, BOOL bParam1) // Position - 0x107B4 Hash - 0x9E80EA71 ^0x9E80EA71
{
	int i;
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (bParam1)
			...
			func_292(&uParam0->[i], false);
	}

	return;
}

void func_292(Object* pobParam0, BOOL bParam1) // Position - 0x107F2 Hash - 0xD7EE3E27 ^0xC5769B29
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_293(var uParam0, BOOL bParam1) // Position - 0x1082D Hash - 0xEDC3BD2D ^0xE2474F74
{
	func_294(&(uParam0->f_35), bParam1);
	return;
}

void func_294(var uParam0, BOOL bParam1) // Position - 0x1083F Hash - 0xA98F6284 ^0xA98F6284
{
	int i;
...
void func_295(Vehicle* pveParam0) // Position - 0x1087C Hash - 0xC50F9886 ^0x638B6124
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_296(var uParam0, int iParam1) // Position - 0x108B4 Hash - 0xEDC3BD2D ^0xA9A19095
{
	func_297(&(uParam0->f_28), iParam1);
	return;
}

void func_297(var uParam0, int iParam1) // Position - 0x108C6 Hash - 0xB72ACFD2 ^0xB72ACFD2
{
	int i;
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_298(&uParam0->[i], false, 1, 0);
	}

	return;
}

void func_298(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x10907 Hash - 0x34362197 ^0xC592197
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_299(Ped* ppedParam0) // Position - 0x10957 Hash - 0xCA79453F ^0x7BA88177
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
void func_300(int iParam0) // Position - 0x10998 Hash - 0x995C9E2 ^0x995C9E2
{
	if (*iParam0 == -1)
		return;
...
void func_301(char* sParam0) // Position - 0x109D5 Hash - 0x54B64147 ^0x56EEAFB9
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_302(var uParam0) // Position - 0x109E7 Hash - 0x4CD8BCE8 ^0xC5EC9D86
{
	*uParam0 = -1;
...
void func_303() // Position - 0x10A1A Hash - 0x554DA35 ^0xEB320625
{
...
Hash func_304(eCharacter echParam0) // Position - 0x10A34 Hash - 0xBF0B24A5 ^0xBF0B24A5
{
	if (!func_36(echParam0))
