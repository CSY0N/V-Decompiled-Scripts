...
BOOL func_1(var uParam0) // Position - 0x262
{
...
BOOL func_2(Any* panParam0) // Position - 0x280
{
	const char* str;
	var unk32;
...
void func_3(int iParam0, const char* sParam1) // Position - 0x341
{
	func_21(sParam1);
...
void func_4(int iParam0) // Position - 0x3F9
{
	int num;
	int num2;
...
void func_6(int iParam0) // Position - 0x606
{
	switch (iParam0)
	{
		case 2:
...
void func_7(int iParam0) // Position - 0x9EE
{
	Global_64159 = true;
	Global_64162 = 1;
...
void func_8(int iParam0) // Position - 0xA39
{
...
struct<2> func_9(int iParam0) // Position - 0xA6D
{
	var unk;
	var unk3;
...
void func_13() // Position - 0xB5D
{
	Global_64325 = 0;
	return;
}

void func_14() // Position - 0xB69
{
	Global_64185 = 0;
...
var func_15(Hash hParam0) // Position - 0xBBD
{
	var outValue;
...
void func_17(BOOL bParam0) // Position - 0xBFB
{
...
void func_21(const char* sParam0) // Position - 0xCB2
{
	MISC::ARE_STRINGS_EQUAL(sParam0, sParam0);
	return;
}

void func_22(char* sParam0, int iParam1) // Position - 0xCC5
{
...
void func_23(char* sParam0, int iParam1, Ped pedParam2) // Position - 0xCE2
{
...
void func_25(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0x19BA
{
	int i;
	eCharacter j;
...
int func_26(var uParam0) // Position - 0x2843
{
...
void func_27(var uParam0, int iParam1, Ped pedParam2, int iParam3, int iParam4, int iParam5) // Position - 0x2865
{
	Vehicle vehicle;
...
int func_28(var uParam0, int iParam1, Vehicle veParam2, int iParam3) // Position - 0x28ED
{
...
BOOL func_29(Vehicle veParam0) // Position - 0x292D
{
	int i;
...
void func_30(var uParam0, Vehicle veParam1, int iParam2) // Position - 0x295B
{
...
int func_31(Vehicle veParam0) // Position - 0x2A37
{
	int i;
...
eCharacter func_32(Vehicle veParam0) // Position - 0x2A79
{
	int i;
...
int func_33(Vehicle veParam0, eCharacter echParam1, int iParam2) // Position - 0x2ADC
{
	int i;
...
Hash func_34(eCharacter echParam0, int iParam1) // Position - 0x2B6A
{
	Hash num;
...
void func_35(eCharacter echParam0, var uParam1, int iParam2) // Position - 0x2BAC
{
	int num;
...
BOOL func_36(eCharacter echParam0) // Position - 0x2E07
{
	return echParam0 < CHAR_MULTIPLAYER;
}

void func_37(Vehicle veParam0, var uParam1) // Position - 0x2E13
{
	int i;
...
int func_38(int iParam0) // Position - 0x30BE
{
	switch (iParam0)
	{
		case 1:
...
int func_39(var uParam0, var uParam1, var uParam2) // Position - 0x316E
{
	int i;
	int modType;
...
BOOL func_40(int iParam0) // Position - 0x3361
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_41(var uParam0) // Position - 0x3381
{
	int i;
...
BOOL func_42(Ped pedParam0, var uParam1, int iParam2, int iParam3) // Position - 0x3431
{
...
BOOL func_43(Vehicle veParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x3560
{
	int i;
	var garageName;
	int num;
...
BOOL func_44(eCharacter echParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x35CE
{
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x36A6
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x36E3
{
...
Hash func_47(eCharacter echParam0) // Position - 0x3708
{
	return Global_2169[echParam0 /*29*/];
}

void func_48(Ped pedParam0, var uParam1, int iParam2, int iParam3) // Position - 0x3717
{
...
int func_49(int iParam0, int iParam1) // Position - 0x38B1
{
	Hash statHash;
	int outValue;
...
Hash func_50(int iParam0, int iParam1) // Position - 0x38E0
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_51(iParam1));
}

int func_51(int iParam0) // Position - 0x38F5
{
	int num;
	int num2;
...
int func_52() // Position - 0x3929
{
	return Global_1574926;
}

BOOL func_53(int iParam0, int iParam1) // Position - 0x3935
{
	Hash statHash;
	BOOL outValue;
...
Hash func_54(int iParam0, int iParam1) // Position - 0x3959
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_51(iParam1));
}

void func_55(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x396E
{
	eCharacter character;
...
void func_56(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3EB7
{
	eCharacter character;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x40F8
{
	func_58();
	return Global_113969.f_2366.f_539.f_4321;
}

void func_58() // Position - 0x4111
{
	eCharacter character;
...
BOOL func_59(int iParam0) // Position - 0x420E
{
	return Global_44042 == iParam0;
}

void func_60(Ped pedParam0, BOOL bParam1) // Position - 0x421C
{
	eCharacter character;
...
void func_61(Ped pedParam0, var uParam1) // Position - 0x430F
{
	int i;
	int j;
	Hash k;
...
BOOL func_62(int iParam0) // Position - 0x4597
{
	switch (iParam0)
	{
...
BOOL func_63(int iParam0) // Position - 0x4638
{
...
Hash func_64(Hash hParam0, int iParam1) // Position - 0x482A
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_65(Hash hParam0, Any* panParam1) // Position - 0x556B
{
	int i;
	int numDlcWeapons;
...
Hash func_66(int iParam0) // Position - 0x55A6
{
	int num;
...
void func_67(Ped pedParam0) // Position - 0x581A
{
	eCharacter character;
...
void func_68(var uParam0, int iParam1) // Position - 0x5856
{
	var unk;
	var unk2;
	var unk5;
...
BOOL func_69(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5DA5
{
...
BOOL func_70(int iParam0, var uParam1, var uParam2) // Position - 0x5DE9
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x6568
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x65AF
{
...
BOOL func_73(int iParam0) // Position - 0x660A
{
	return func_74(iParam0, 0, true);
}

BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x661A
{
	if (iParam0 == -1)
		return false;
...
int func_75(int iParam0) // Position - 0x667A
{
	switch (iParam0)
	{
		case 0:
...
int func_76() // Position - 0x6A22
{
	return Global_32948;
}

BOOL func_77(int iParam0) // Position - 0x6A2D
{
	return func_74(iParam0, 5, true);
}

int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6A3D
{
	int i;
...
Vector3 func_79(int iParam0, BOOL bParam1) // Position - 0x6ADF
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_80() // Position - 0x723E
{
...
int func_81() // Position - 0x7539
{
	return Global_2652592.f_2671;
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x7548
{
...
ePedComponentType func_83() // Position - 0x7572
{
	return Global_2657971[PLAYER::PLAYER_ID() /*465*/].f_322.f_8;
}

Vector3 func_84(float fParam0, float fParam1, float fParam2) // Position - 0x758A
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_85(), 0f, fParam0);
}

Vector3 func_85() // Position - 0x759F
{
	return -880f, -2770f, -50f;
}

BOOL func_86(ePedComponentType epctParam0) // Position - 0x75B6
{
...
Vector3 func_87(int iParam0, int iParam1) // Position - 0x760E
{
	var unk;
	var unk7;
...
BOOL func_88(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x76B8
{
	var unk;
	Vector3 vector;
	var unk12;
...
Vector3 func_89(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x774D
{
	float num;
	float num2;
	float num3;
...
struct<6> func_90(int iParam0) // Position - 0x7791
{
	var unk;
...
struct<6> func_91(int iParam0) // Position - 0x7915
{
	return func_92(iParam0);
}

struct<6> func_92(int iParam0) // Position - 0x7923
{
	var unk;
...
BOOL func_93(int iParam0, var uParam1) // Position - 0x83EB
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_94(ePedComponentType epctParam0) // Position - 0x846D
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x84C5
{
	return -1;
}

Vector3 func_96(int iParam0) // Position - 0x84CE
{
	switch (iParam0)
	{
		case 1:
...
int func_97() // Position - 0x873A
{
	return func_98(PLAYER::PLAYER_ID());
}

int func_98(Player plParam0) // Position - 0x874A
{
	return MISC::GET_BITS_IN_RANGE(Global_2657971[plParam0 /*465*/].f_322.f_3, 28, 31);
}

BOOL func_99(int iParam0) // Position - 0x8767
{
	return func_74(iParam0, 0, false);
}

int func_100(int iParam0) // Position - 0x8777
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_101() // Position - 0x8AAD
{
	return Global_101585.f_393 > 0;
}

var func_102() // Position - 0x8ABE
{
	var unk;
...
void func_103(var uParam0, int iParam1) // Position - 0x8B04
{
	if (iParam1 <= 0)
		return;
...
void func_104(var uParam0, int iParam1) // Position - 0x8B8A
{
...
void func_105(var uParam0, int iParam1) // Position - 0x8BBD
{
	int num;
	int num2;
...
int func_106(int iParam0, int iParam1) // Position - 0x8C0E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_107(int iParam0) // Position - 0x8CB0
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_108(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8CD2
{
	if (bParam0)
		return uParam1;
...
int func_109(int iParam0) // Position - 0x8CE9
{
	return iParam0 & 15;
}

void func_110(var uParam0, int iParam1) // Position - 0x8CF6
{
...
void func_111(var uParam0, int iParam1) // Position - 0x8D30
{
...
void func_112(var uParam0, int iParam1) // Position - 0x8D6B
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x8DA7
{
	func_58();
	return Global_113969.f_2366.f_539.f_4321;
}

void func_114(int iParam0) // Position - 0x8DC0
{
	int num;
	var textLabel;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8E19
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x8E2F
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_117(char* sParam0, Any anParam1, int iParam2) // Position - 0x8E45
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x8E86
{
...
struct<2> func_119(int iParam0) // Position - 0x8EAE
{
	var unk;
...
int func_122(int iParam0) // Position - 0xA540
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_123(Any* panParam0) // Position - 0xA886
{
	int threadId;
...
void func_124(int iParam0) // Position - 0xA92B
{
	var name;
...
void func_125(int iParam0) // Position - 0xA9C6
{
	if (iParam0 < 63)
	{
		func_126();
...
void func_127(Ped pedParam0) // Position - 0xAA24
{
	int num;
	int num2;
	int num3;
...
void func_128(int iParam0) // Position - 0xAA7D
{
...
int func_129(Ped pedParam0) // Position - 0xAB00
{
	int i;
...
void func_130(int iParam0, int iParam1, int iParam2) // Position - 0xAB31
{
	func_131(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_131(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xAB46
{
	int num;
...
BOOL func_133(int iParam0, int iParam1, int iParam2) // Position - 0xABF9
{
...
int func_134(int iParam0, int iParam1, int iParam2) // Position - 0xAC14
{
	int i;
...
int func_135(Ped pedParam0) // Position - 0xAC60
{
	int i;
...
BOOL func_136(Ped pedParam0) // Position - 0xACA9
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xACC9
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_138(int iParam0) // Position - 0xACEA
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_140(int iParam0) // Position - 0xADBA
{
	switch (iParam0)
	{
		case 5:
...
void func_141(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xAE0D
{
	int i;
...
BOOL func_142(int iParam0) // Position - 0xAF02
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0) // Position - 0xAF6D
{
	Player playerIndex;
...
void func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xAFAC
{
	if (bParam0)
	{
...
BOOL func_145() // Position - 0xB0F9
{
	return IS_BIT_SET(Global_1845281[PLAYER::PLAYER_ID() /*883*/].f_36.f_18, 14);
}

BOOL func_146(Player plParam0, int iParam1) // Position - 0xB113
{
	BOOL flag;
...
int func_147(int iParam0, BOOL bParam1) // Position - 0xB16C
{
	int num;
	int num2;
...
BOOL func_148(Player plParam0) // Position - 0xB1AD
{
	Player player;
...
BOOL func_149(Player plParam0) // Position - 0xB1CF
{
...
BOOL func_150() // Position - 0xB20E
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_151(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB21C
{
	int num;
...
void func_153(int iParam0) // Position - 0xB276
{
	if (iParam0 == 1)
...
BOOL func_154(const char* sParam0) // Position - 0xB299
{
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0xB33D
{
...
BOOL func_160(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB3CC
{
...
void func_161(Vehicle veParam0) // Position - 0xB423
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_162(BOOL bParam0, BOOL bParam1) // Position - 0xB44F
{
...
void func_164(int iParam0) // Position - 0xB5F1
{
	if (func_169())
		return;
...
void func_165(int iParam0) // Position - 0xB624
{
	if (func_169())
		return;
...
void func_166(BOOL bParam0, BOOL bParam1) // Position - 0xB6AE
{
	if (bParam0)
	{
		if (func_168(0))
...
BOOL func_167() // Position - 0xB722
{
	return IS_BIT_SET(Global_1956920, 5);
}

BOOL func_168(int iParam0) // Position - 0xB730
{
	if (iParam0 == 1)
...
BOOL func_169() // Position - 0xB787
{
	return IS_BIT_SET(Global_1956920, 19);
}

BOOL func_170(int iParam0) // Position - 0xB796
{
...
BOOL func_171(int iParam0) // Position - 0xB7D7
{
	int num;
...
void func_172(int iParam0) // Position - 0xB81C
{
...
int func_173(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB84E
{
	int i;
...
void func_174(int iParam0, int iParam1) // Position - 0xB985
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xB9D4
{
	return func_176(iParam0, Global_44042);
}

BOOL func_176(int iParam0, int iParam1) // Position - 0xB9E5
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_177(int iParam0) // Position - 0xBBC6
{
	if (Global_44042 == 15)
		return false;
...
int func_178() // Position - 0xBBE8
{
	return func_179(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_179(const char* sParam0, int iParam1) // Position - 0xBBF9
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL _IS_MISSION_REPLAY_IN_PROGRESS() // Position - 0xBC42
{
	if (Global_101533 == 10 || Global_101533 == 9)
		return true;
...
BOOL func_181(var uParam0, int iParam1) // Position - 0xBC66
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_182() // Position - 0xC44A
{
	func_27(&(Global_104530.f_2890), &Global_104530, 0, 1, 1, 0);
	return;
}

BOOL func_183(var uParam0) // Position - 0xC465
{
	float num;
...
void func_184(int iParam0, var uParam1) // Position - 0xC4F3
{
	if (iParam0 == 1)
	{
		if (!func_140(uParam1))
...
BOOL func_185(BOOL bParam0) // Position - 0xC557
{
...
BOOL func_186(Vehicle veParam0) // Position - 0xC5EE
{
...
BOOL func_187(int iParam0) // Position - 0xC618
{
	eCharacter character;
...
BOOL func_188() // Position - 0xCD35
{
	return Global_101572.f_1;
}

BOOL func_189() // Position - 0xCD43
{
	if (Global_98435 != -1)
...
BOOL func_192() // Position - 0xCDAA
{
	return Global_101585.f_394 > 0;
}

BOOL func_193(int iParam0, int iParam1) // Position - 0xCDBB
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_194() // Position - 0xCDF3
{
	return Global_1575083;
}

BOOL func_195() // Position - 0xCDFF
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void func_196(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xCE1B
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_197(int iParam0, BOOL bParam1) // Position - 0xCF0C
{
	if (iParam0 == -1)
		return;
...
int func_198(int iParam0) // Position - 0xCF48
{
	if (Global_79385 == iParam0)
		if (Global_79386 == -1)
...
void func_199(var uParam0, int iParam1) // Position - 0xCF81
{
	BOOL flag;
	int i;
...
float func_200(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xD01F
{
...
BOOL func_201() // Position - 0xD059
{
	return Global_98822;
}

void func_202(var uParam0) // Position - 0xD065
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_203(uParam0);
...
void func_203(var uParam0) // Position - 0xD07C
{
	BOOL flag;
	int num;
	int i;
...
void func_204(int iParam0) // Position - 0xD164
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD18C
{
	var unk;
...
void func_206(Ped pedParam0, var uParam1, int iParam2) // Position - 0xD3FC
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_207(int iParam0) // Position - 0xD754
{
...
BOOL func_208(var uParam0) // Position - 0xD774
{
...
BOOL func_209(var uParam0) // Position - 0xD78C
{
...
void func_210(var uParam0) // Position - 0xD7B1
{
	int i;
	int taskSequenceId;
...
void func_211(Object* pobParam0) // Position - 0xDAB5
{
...
void func_212(var uParam0) // Position - 0xDAE0
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xDB60
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_214(Ped pedParam0, Vehicle veParam1) // Position - 0xDD1E
{
...
BOOL func_215(var uParam0, BOOL bParam1, int iParam2) // Position - 0xDD4E
{
	int i;
	int num;
...
BOOL func_216(int iParam0) // Position - 0xE00A
{
...
BOOL func_217(Ped pedParam0, int iParam1) // Position - 0xE03E
{
	float xSize;
...
BOOL func_218(Ped pedParam0, int iParam1) // Position - 0xE0B4
{
	return func_219(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_219(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE0CC
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_220(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xE18D
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_221(Ped pedParam0, int iParam1) // Position - 0xE2B9
{
...
BOOL func_223(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xE3C8
{
	var unk;
...
float func_224(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xE459
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_225(float fParam0, var uParam1, var uParam2) // Position - 0xE47A
{
	float num;
	float num2;
...
void func_226(var uParam0) // Position - 0xE4B9
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_227(Ped pedParam0, Ped pedParam1) // Position - 0xE4D4
{
	int i;
...
BOOL func_228(Ped pedParam0) // Position - 0xE513
{
...
BOOL func_229(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE53B
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_230(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE636
{
	float entityCoords;
	float num;
...
BOOL func_231(Ped pedParam0, float fParam1) // Position - 0xE742
{
	var outProjectile;
	var outCoords;
...
BOOL func_232(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xE7D7
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_233(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xE865
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_234(int iParam0) // Position - 0xE8AD
{
...
void func_235(Vehicle veParam0) // Position - 0xE8F7
{
	int taskSequenceId;
...
BOOL func_236(int iParam0) // Position - 0xE994
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL func_237(int iParam0) // Position - 0xEA29
{
...
BOOL func_240(int iParam0) // Position - 0xEAA8
{
...
BOOL func_242(int iParam0) // Position - 0xEB1A
{
...
void func_243(var uParam0) // Position - 0xEB42
{
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	{
...
void func_244(var uParam0) // Position - 0xEB6F
{
	uParam0->f_16 = 5;
...
BOOL func_245(int iParam0) // Position - 0xEBC4
{
	var unk;
	eCharacter character;
...
BOOL func_246(int iParam0) // Position - 0xEC15
{
	const char* string2;
...
BOOL func_247(int iParam0) // Position - 0xECCE
{
	var unk;
...
BOOL func_248(int iParam0) // Position - 0xED8F
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_249(int iParam0, char* sParam1) // Position - 0xEE14
{
...
BOOL func_250(int iParam0) // Position - 0xEEF4
{
...
BOOL func_251(int iParam0) // Position - 0xEF1F
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_252(int iParam0) // Position - 0xEF4A
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_253(int iParam0) // Position - 0xEF75
{
	if (func_237(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
BOOL func_255(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0xEFC4
{
	int i;
...
BOOL func_256(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0xF029
{
	int num;
	char* str;
...
BOOL func_257(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0xF0A1
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_258(var uParam0, BOOL bParam1) // Position - 0xF11C
{
	if (bParam1)
	{
...
void func_259(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF170
{
...
void func_260(var uParam0, BOOL bParam1) // Position - 0xF190
{
	func_261(&(uParam0->f_41), bParam1);
	return;
}

void func_261(var uParam0, BOOL bParam1) // Position - 0xF1A2
{
	int i;
...
void func_262(Object* pobParam0, BOOL bParam1) // Position - 0xF1E0
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_263(var uParam0, BOOL bParam1) // Position - 0xF21B
{
	func_264(&(uParam0->f_35), bParam1);
	return;
}

void func_264(var uParam0, BOOL bParam1) // Position - 0xF22D
{
	int i;
...
void func_265(Vehicle* pveParam0) // Position - 0xF26A
{
...
void func_266(Vehicle* pveParam0) // Position - 0xF2A2
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_267(var uParam0, int iParam1) // Position - 0xF33E
{
	func_268(&(uParam0->f_28), iParam1);
	return;
}

void func_268(var uParam0, int iParam1) // Position - 0xF350
{
	int i;
...
void func_269(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0xF391
{
...
void func_270(Ped* ppedParam0) // Position - 0xF3E1
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_271(int iParam0) // Position - 0xF422
{
	if (*iParam0 == -1)
		return;
...
void func_272(char* sParam0) // Position - 0xF45F
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_273(var uParam0) // Position - 0xF471
{
	*uParam0 = -1;
