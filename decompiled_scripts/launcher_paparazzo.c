...
void main() // Position - 0x0 Hash - 0x5D84F89F ^0x5D84F89F
{
	...
	iLocal_90 = func_297(CHAR_BEVERLY);
	hLocal_91 = joaat("pcj");
	iLocal_93 = -1;
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			...
			{
				func_294("Relinquishing candidate id...");
				func_293(&(Global_113457[num /*10*/].f_9));
			}
		}
	...
	if (!func_278(&unk63, &num, vector, 5f))
	{
		func_277();
	...
	while (!func_251(&num))
	{
		...
		{
			func_294("Player out of range [TERMINATING]");
			func_281(&num, true);
		}
	}
	...
	while (true)
	{
		...
		if (num == 47)
			func_208(&num, vector, "PAP2AUD", "PAP2_AMB", 3, "BEVERLY", 5000, 1101004800);
		else if (num == 51)
			func_208(&num, vector, "PAP4AUD", "PAP4_AMB", 3, "BEVERLY", 5000, 1101004800);
	
		func_207(num);
		func_199(&iLocal_93, &(num.f_9), vector);
	
		if (func_184(&num, 0))
		{
			if (func_183(num))
				func_180(num, &blLocal_95);
...
BOOL func_1(var uParam0) // Position - 0x29C Hash - 0x5CBE5B62 ^0x13861C41
{
...
BOOL func_2(Any* panParam0) // Position - 0x2BA Hash - 0xA1E62C19 ^0xA1E62C19
{
	const char* str;
	var unk32;
...
void func_3(int iParam0, const char* sParam1) // Position - 0x37B Hash - 0xA9A7342A ^0xA9284257
{
	func_21(sParam1);
...
void func_4(int iParam0) // Position - 0x437 Hash - 0x74C873D2 ^0x74C873D2
{
	int num;
	int num2;
...
void func_5() // Position - 0x591 Hash - 0x6EF841A5 ^0x6EF841A5
{
	int i;
...
void func_6(int iParam0) // Position - 0x644 Hash - 0xB8CA5CA7 ^0x96AAFF46
{
	switch (iParam0)
	{
		case 2:
...
void func_7(int iParam0) // Position - 0xA2C Hash - 0xA84FABDE ^0xA84FABDE
{
	Global_64031 = true;
	Global_64034 = 1;
...
void func_8(int iParam0) // Position - 0xA77 Hash - 0x4878B614 ^0x92338679
{
...
struct<2> func_9(int iParam0) // Position - 0xAAB Hash - 0x323E6781 ^0x44A38978
{
	var unk;
	var unk3;
...
void func_10() // Position - 0xAE3 Hash - 0xDE0A4F6 ^0xDE0A4F6
{
	if (Global_64038)
		return;
...
void func_11() // Position - 0xB39 Hash - 0x49CBF5B6 ^0x790810FF
{
	int i;
...
void func_12() // Position - 0xB66 Hash - 0x45508BA8 ^0x301C64C9
{
	int i;
...
void func_13() // Position - 0xB9D Hash - 0x8D222CF ^0x8D222CF
{
	Global_64197 = 0;
	return;
}

void func_14() // Position - 0xBA9 Hash - 0xCEA3FAB3 ^0xBE2318F
{
	Global_64057 = 0;
...
var func_15(Hash hParam0) // Position - 0xBFD Hash - 0x4A0C678B ^0x403B983B
{
	var outValue;
...
void func_16() // Position - 0xC11 Hash - 0x43632AFE ^0x43632AFE
{
	int i;
...
void func_17(BOOL bParam0) // Position - 0xC3B Hash - 0xFFF39126 ^0xFFF39126
{
...
void func_18() // Position - 0xC4F Hash - 0xFC34B768 ^0xE1D0CFD9
{
	int i;
...
void func_19() // Position - 0xC88 Hash - 0x429A4038 ^0xDAAA4480
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("mission_stat_watcher")) > 0)
	{
		if (func_20())
...
BOOL func_20() // Position - 0xCCA Hash - 0x46E5692F ^0xA798242F
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("mission_stat_watcher")) < 1)
		return false;
...
void func_21(const char* sParam0) // Position - 0xCF4 Hash - 0xF54A2398 ^0xC5887C42
{
	MISC::ARE_STRINGS_EQUAL(sParam0, sParam0);
	return;
}

void func_22(char* sParam0, int iParam1) // Position - 0xD07 Hash - 0x1166ABB2 ^0x89B55D9D
{
...
void func_23(char* sParam0, int iParam1, Ped pedParam2) // Position - 0xD24 Hash - 0xB566D143 ^0x25FF58E5
{
...
void func_24() // Position - 0xD69 Hash - 0x59B932B3 ^0xFC5559FC
{
	int i;
	int j;
...
void func_25(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0x19FD Hash - 0x53B0865D ^0xC434A1E8
{
	int i;
	eCharacter j;
...
int func_26(var uParam0) // Position - 0x2886 Hash - 0x56C64BA4 ^0xCAE61007
{
...
void func_27(var uParam0, int iParam1, Ped pedParam2, int iParam3, int iParam4, int iParam5) // Position - 0x28A8 Hash - 0x4709079E ^0x71C884C9
{
	Vehicle vehicle;
...
int func_28(var uParam0, int iParam1, Vehicle veParam2, int iParam3) // Position - 0x2930 Hash - 0x6BF8E630 ^0xF655D74B
{
...
BOOL func_29(Vehicle veParam0) // Position - 0x2970 Hash - 0x8CDF26D5 ^0xCE04F037
{
	int i;
...
void func_30(var uParam0, Vehicle veParam1, int iParam2) // Position - 0x299E Hash - 0x9B217A45 ^0xEE9A0448
{
...
int func_31(Vehicle veParam0) // Position - 0x2A7A Hash - 0xDEF2B534 ^0x25A18686
{
	int i;
...
eCharacter func_32(Vehicle veParam0) // Position - 0x2ABC Hash - 0x593067C2 ^0x2918B7DD
{
	int i;
...
int func_33(Vehicle veParam0, eCharacter echParam1, int iParam2) // Position - 0x2B1F Hash - 0xC883A039 ^0x6D45755E
{
	int i;
...
Hash func_34(eCharacter echParam0, int iParam1) // Position - 0x2BAD Hash - 0x3C1119CD ^0x1010ECAE
{
	Hash num;
...
void func_35(eCharacter echParam0, var uParam1, int iParam2) // Position - 0x2BEF Hash - 0xF92B8944 ^0xD11BCD5C
{
	int num;
...
BOOL func_36(eCharacter echParam0) // Position - 0x2E4B Hash - 0x8907F004 ^0x8907F004
{
	return echParam0 < CHAR_MULTIPLAYER;
}

void func_37(Vehicle veParam0, var uParam1) // Position - 0x2E57 Hash - 0x5E84B52A ^0xEF20F807
{
	int i;
...
int func_38(int iParam0) // Position - 0x3102 Hash - 0xEE599357 ^0xEE599357
{
	switch (iParam0)
	{
		case 1:
...
int func_39(var uParam0, var uParam1, var uParam2) // Position - 0x31B2 Hash - 0x4455160E ^0x8E5B3F28
{
	int i;
	int modType;
...
BOOL func_40(int iParam0) // Position - 0x33A5 Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_41(var uParam0) // Position - 0x33C5 Hash - 0xB95AF921 ^0x4DC7C61C
{
	int i;
...
BOOL func_42(Ped pedParam0, var uParam1, int iParam2, int iParam3) // Position - 0x3476 Hash - 0x6795F6D3 ^0x3A08E8AF
{
...
BOOL func_43(Vehicle veParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x35A5 Hash - 0xBCC62924 ^0x77695844
{
	int i;
	var garageName;
	int num;
...
BOOL func_44(eCharacter echParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x3613 Hash - 0x8E372EAA ^0xDEA14D7C
{
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x36EC Hash - 0xAC4E9801 ^0xB379A75F
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x3729 Hash - 0xADCB9755 ^0xADCB9755
{
...
Hash func_47(eCharacter echParam0) // Position - 0x374E Hash - 0xE4CEEC2C ^0xE4CEEC2C
{
	return Global_2139[echParam0 /*29*/];
}

void func_48(Ped pedParam0, var uParam1, int iParam2, int iParam3) // Position - 0x375D Hash - 0x4CE94407 ^0xC863C983
{
...
int func_49(int iParam0, int iParam1) // Position - 0x38F7 Hash - 0x744E461C ^0x94D7C845
{
	Hash statHash;
	int outValue;
...
Hash func_50(int iParam0, int iParam1) // Position - 0x3926 Hash - 0x505A9F99 ^0x8B00E935
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_51(iParam1));
}

int func_51(int iParam0) // Position - 0x393B Hash - 0x1A3F3220 ^0x1A3F3220
{
	int num;
	int num2;
...
int func_52() // Position - 0x396F Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1574925;
}

BOOL func_53(int iParam0, int iParam1) // Position - 0x397B Hash - 0x5137F6D6 ^0x3B535546
{
	Hash statHash;
	BOOL outValue;
...
Hash func_54(int iParam0, int iParam1) // Position - 0x399F Hash - 0x1D62A43E ^0x33D7B335
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_51(iParam1));
}

void func_55(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x39B4 Hash - 0x65821445 ^0x4849EA55
{
	eCharacter character;
...
void func_56(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3EFD Hash - 0x10358CC6 ^0xCC2A186D
{
	eCharacter character;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x413F Hash - 0x3C5423D7 ^0x3C5423D7
{
	func_58();
	return Global_114370.f_2366.f_539.f_4321;
}

void func_58() // Position - 0x4158 Hash - 0xD1F2D853 ^0xF9F5FD4D
{
	eCharacter character;
...
BOOL func_59(int iParam0) // Position - 0x4255 Hash - 0x937D8816 ^0x937D8816
{
	return Global_43922 == iParam0;
}

void func_60(Ped pedParam0, BOOL bParam1) // Position - 0x4263 Hash - 0xC106EC1D ^0x74ED6306
{
	eCharacter character;
...
void func_61(Ped pedParam0, var uParam1) // Position - 0x4356 Hash - 0xDEAAD761 ^0xB2E3A390
{
	int i;
	int j;
	Hash k;
...
BOOL func_62(int iParam0) // Position - 0x45DE Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
...
BOOL func_63(int iParam0) // Position - 0x467F Hash - 0xD9D843D5 ^0xF9D91FBE
{
...
Hash func_64(Hash hParam0, int iParam1) // Position - 0x486B Hash - 0x6010BC66 ^0x1DFF9FB7
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_65(Hash hParam0, Any* panParam1) // Position - 0x558C Hash - 0x539D27DB ^0xB7B7AD25
{
	int i;
	int numDlcWeapons;
...
Hash func_66(int iParam0) // Position - 0x55C7 Hash - 0x5FB59AC3 ^0x9BC6B2ED
{
	int num;
...
void func_67(Ped pedParam0) // Position - 0x583B Hash - 0x27D5295B ^0xD1A82444
{
	eCharacter character;
...
void func_68(var uParam0, int iParam1) // Position - 0x5877 Hash - 0x635FFA34 ^0xAE461588
{
	var unk;
	var unk2;
	var unk5;
...
BOOL func_69(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5DC6 Hash - 0xA7FD254F ^0xFF9CDA51
{
...
BOOL func_70(int iParam0, var uParam1, var uParam2) // Position - 0x5E0A Hash - 0xE3586C79 ^0xE3586C79
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x6589 Hash - 0x2D46096D ^0xEA41378F
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x65D0 Hash - 0xDB33C708 ^0xF5B91AC7
{
...
BOOL func_73(int iParam0) // Position - 0x662B Hash - 0xCAEAF99E ^0xCAEAF99E
{
	return func_74(iParam0, 0, true);
}

BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x663B Hash - 0xA45BEB30 ^0x6033D2A2
{
	if (iParam0 == -1)
		return false;
...
int func_75(int iParam0) // Position - 0x669B Hash - 0x28E83966 ^0x9E37924F
{
	switch (iParam0)
	{
		case 0:
...
int func_76() // Position - 0x6A43 Hash - 0x21D64237 ^0x21D64237
{
	return Global_32828;
}

BOOL func_77(int iParam0) // Position - 0x6A4E Hash - 0xBE61F0FD ^0xBE61F0FD
{
	return func_74(iParam0, 5, true);
}

int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6A5E Hash - 0x4E8D2C12 ^0x4E8D2C12
{
	int i;
...
Vector3 func_79(int iParam0, BOOL bParam1) // Position - 0x6B00 Hash - 0x4894642D ^0x4894642D
{
	switch (iParam0)
	{
		case -1:
...
Vector3 func_80() // Position - 0x726B Hash - 0x6E37375C ^0x6E37375C
{
...
int func_81() // Position - 0x7566 Hash - 0x974E48B4 ^0x974E48B4
{
	return Global_2652572.f_2650;
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x7575 Hash - 0x16E871AD ^0x10C54C39
{
...
Vector3 func_83(float fParam0, float fParam1, float fParam2) // Position - 0x759F Hash - 0xD52A1F8B ^0x5D514503
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_84(), 0f, fParam0);
}

Vector3 func_84() // Position - 0x75B4 Hash - 0x21158019 ^0x21158019
{
	return -880f, -2770f, -50f;
}

BOOL func_85(ePedComponentType epctParam0) // Position - 0x75CB Hash - 0x78AB9EAC ^0x78AB9EAC
{
...
Vector3 func_86(int iParam0, int iParam1) // Position - 0x7623 Hash - 0x7E203DFC ^0x7E203DFC
{
	var unk;
	var unk7;
...
BOOL func_87(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x76CD Hash - 0x5642A5C0 ^0x5642A5C0
{
	var unk;
	Vector3 vector;
	var unk12;
...
Vector3 func_88(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x7762 Hash - 0x8959C4D1 ^0x8922A2E2
{
	float num;
	float num2;
	float num3;
...
struct<6> func_89(int iParam0) // Position - 0x77A6 Hash - 0xC73C1158 ^0x2A6D4A6F
{
	var unk;
...
struct<6> func_90(int iParam0) // Position - 0x792A Hash - 0x2623C81B ^0x2623C81B
{
	return func_91(iParam0);
}

struct<6> func_91(int iParam0) // Position - 0x7938 Hash - 0x7684F11 ^0xD37BE1E4
{
	var unk;
...
void func_113(int iParam0) // Position - 0x8DD8 Hash - 0x35AC36F2 ^0x4097C4
{
	int num;
	var textLabel;
...
void func_116(char* sParam0, Any anParam1, int iParam2) // Position - 0x8E5D Hash - 0x817AB180 ^0x870ED5F4
{
...
struct<2> func_118(int iParam0) // Position - 0x8EC7 Hash - 0x975AC8C9 ^0x5DE5C2CC
{
	var unk;
...
void func_119(int iParam0, var uParam1) // Position - 0x9314 Hash - 0x2D8E3F8 ^0xB959672E
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_135(Vehicle veParam0) // Position - 0xAD55 Hash - 0x7E48B415 ^0x126328AB
{
...
BOOL func_153(const char* sParam0) // Position - 0xB345 Hash - 0x16488C7A ^0x673FB34D
{
...
void func_187(int iParam0, var uParam1) // Position - 0xCAE0 Hash - 0x16CCAA18 ^0x462A310F
{
	if (iParam0 == 1)
	{
		if (!func_139(uParam1))
...
void func_199(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD408 Hash - 0xA38693DA ^0xBAAA90B1
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_200(int iParam0, BOOL bParam1) // Position - 0xD4F9 Hash - 0x3ABFF97A ^0x3ABFF97A
{
	if (iParam0 == -1)
		return;
...
int func_201(int iParam0) // Position - 0xD535 Hash - 0x3F6843D0 ^0x973F28A6
{
	if (Global_79244 == iParam0)
		if (Global_79245 == -1)
...
void func_202(var uParam0, int iParam1) // Position - 0xD56E Hash - 0xA189769D ^0xD7591C4B
{
	BOOL flag;
	int i;
...
float func_203(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xD60C Hash - 0xC22B942A ^0xE0DB8793
{
...
BOOL func_204() // Position - 0xD646 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_98681;
}

void func_205(var uParam0) // Position - 0xD652 Hash - 0x8EEB5116 ^0x2325FF68
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_206(uParam0);
...
void func_206(var uParam0) // Position - 0xD669 Hash - 0x1C509C5B ^0x1C509C5B
{
	BOOL flag;
	int num;
	int i;
...
void func_207(int iParam0) // Position - 0xD751 Hash - 0xD347101A ^0xCC220E7F
{
	if (iParam0 == -1)
		iParam0 = func_177();
...
int func_208(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xD779 Hash - 0xA74186BF ^0x512FC932
{
	var unk;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD801 Hash - 0xF7ECDFD9 ^0x6B079C3E
{
	func_210(uParam0, 145, sParam1, iParam4, iParam5, 0);
...
void func_210(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD83C Hash - 0xC6B752B2 ^0xC6B752B2
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD892 Hash - 0x6C235EE0 ^0x9E57F206
{
...
BOOL IS_RC_FINE_AND_IN_RANGE(Any* panParam0, BOOL bParam1) // Position - 0xD92D Hash - 0x7D86F6E4 ^0xBA1DA4F8
{
	var unk;
	...
	if (func_249(*panParam0) || func_247(*panParam0) || Global_79494 == true)
		return true;
	...
	if (func_243(*panParam0))
	{
		if (*panParam0 == 19)
			func_242(panParam0->f_28[0]);
	...
	if (panParam0->f_25 == 1)
		if (!func_222(panParam0, true, 0))
			return false;
	else if (panParam0->f_16 == 0)
		if (!func_222(panParam0, false, 0))
			return false;
...
void func_213(Ped pedParam0, var uParam1, int iParam2) // Position - 0xDB9D Hash - 0xD4C7D099 ^0x162C1E9
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_214(int iParam0) // Position - 0xDEF5 Hash - 0xD681AEF7 ^0xD681AEF7
{
...
BOOL func_215(var uParam0) // Position - 0xDF15 Hash - 0x42F869D4 ^0xFFADB180
{
...
BOOL func_216(var uParam0) // Position - 0xDF2D Hash - 0x6329B93C ^0xCBBB8D92
{
...
void func_217(var uParam0) // Position - 0xDF52 Hash - 0x2E98ABB1 ^0xFF31A41F
{
	int i;
	int taskSequenceId;
...
void func_218(Object* pobParam0) // Position - 0xE256 Hash - 0x4EAFEE58 ^0x34D7ECA6
{
...
void func_219(var uParam0) // Position - 0xE281 Hash - 0x5209F824 ^0xCFA0F1CA
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE301 Hash - 0x53567DCF ^0x584F6887
{
	int i;
	int num;
	Vehicle playersLastVehicle;
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[i]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_221(PLAYER::PLAYER_PED_ID(), uParam0->f_35[i]))
							{
...
BOOL func_221(Ped pedParam0, Vehicle veParam1) // Position - 0xE4BF Hash - 0xFB12ABF0 ^0x730FD205
{
...
BOOL func_222(var uParam0, BOOL bParam1, int iParam2) // Position - 0xE4EF Hash - 0xE9BDE167 ^0x20C575FA
{
	int i;
	int num;
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[i]))
			{
				if (!PED::IS_PED_INJURED(uParam0->f_28[i]))
				{
					...
					if (func_241(*uParam0))
					{
						if (!func_169(*uParam0))
						{
							if (func_236(uParam0->f_28[i], true, false, false, false))
							{
								if (iParam2 == 0)
									func_217(uParam0);
								else
						...
						if (func_224(uParam0->f_28[i], 1126825984))
						{
							if (iParam2 == 0)
								func_217(uParam0);
							else
...
BOOL func_223(int iParam0) // Position - 0xE7AB Hash - 0x9E3DCA43 ^0x9E3DCA43
{
...
BOOL func_224(Vehicle veParam0, int iParam1) // Position - 0xE7DF Hash - 0x5EA05E45 ^0x7984EB04
{
	float xSize;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(veParam0))
	{
		if (func_235(veParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), veParam0))
		{
...
BOOL func_225(Vehicle veParam0, int iParam1) // Position - 0xE855 Hash - 0xF1789D04 ^0x3F9D1900
{
	return func_226(veParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_226(Vehicle veParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE86D Hash - 0x275BB58B ^0x275BB58B
{
	BOOL flag;
	var pedBoneCoords;
	int num;

	num = func_234(veParam0, pedParam1);

	if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(veParam0) || !_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam1))
	{
		if (num != -1)
			func_233(&iLocal_35[num /*4*/]);
	
		return false;
	}

	if (!func_230(veParam0, pedParam1, iParam2, iParam3))
		return false;
	...
	flag = func_227(&iLocal_35[num /*4*/], pedBoneCoords, pedParam1, &(iLocal_35[num /*4*/].f_3), veParam0, iParam5);
	return flag || MISC::GET_GAME_TIMER() - iLocal_35[num /*4*/].f_3 < iParam4;
}

BOOL func_227(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Vehicle veParam6, int iParam7) // Position - 0xE92E Hash - 0xBBBECF07 ^0xBBBECF07
{
	var hit;
	var endCoords;
	var surfaceNormal;
	...
	if (*uParam0 == 0)
	{
		endCoords = { func_228(pedParam4, iParam7) };
...
Vector3 func_228(Ped pedParam0, int iParam1) // Position - 0xEA5A Hash - 0xA6273130 ^0xF7D9CDEA
{
...
int func_229() // Position - 0xEB1F Hash - 0x1398F041 ^0xCD84FF69
{
	int i;
...
BOOL func_230(Vehicle veParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xEB69 Hash - 0x6EF1707D ^0x8C069CF9
{
	var unk;
	var entityForwardVector;
	float num;

	unk = { func_232(ENTITY::GET_ENTITY_COORDS(pedParam1, true) - ENTITY::GET_ENTITY_COORDS(veParam0, true)) };
	...
	if (iParam3 == 0)
		...
		entityForwardVector = { func_232(PED::GET_PED_BONE_COORDS(veParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(veParam0, 31086, 0f, 0f, 0f)) };

	num = func_231(entityForwardVector, unk);
...
float func_231(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xEBFA Hash - 0x596BEA29 ^0x5FBCDBE5
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_232(float fParam0, var uParam1, var uParam2) // Position - 0xEC1B Hash - 0xFB6A39D2 ^0x80C9C759
{
	float num;
	float num2;
...
void func_233(var uParam0) // Position - 0xEC5A Hash - 0xA4B72113 ^0x62A5EAE1
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_234(Vehicle veParam0, Ped pedParam1) // Position - 0xEC75 Hash - 0xAA445031 ^0xEBA3F8CF
{
	int i;
...
BOOL func_235(Vehicle veParam0) // Position - 0xECB4 Hash - 0xEC80536A ^0x2D4CF2B0
{
...
BOOL func_236(Vehicle veParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xECDC Hash - 0x5B46DA49 ^0x44F718
{
	float radius;
	float num;
	int weaponHash;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(veParam0))
	{
		...
		if (!bParam2)
		{
			if (func_240(veParam0, bParam1, radius, num))
				return true;
		
			if (func_237(veParam0, num, bParam3, bParam4))
				return true;
		}
		else
		{
...
BOOL func_237(Vehicle veParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xEDD7 Hash - 0x1310B579 ^0x2AAFC0CC
{
	float entityCoords;
	float num;
...
BOOL func_238(Vehicle veParam0, float fParam1) // Position - 0xEEE3 Hash - 0xFA3D7088 ^0x33A74060
{
	var outProjectile;
	var outCoords;
	...
	if (MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(veParam0, joaat("WEAPON_GRENADE"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(veParam0, joaat("WEAPON_SMOKEGRENADE"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(veParam0, joaat("WEAPON_BZGAS"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(veParam0, joaat("WEAPON_STICKYBOMB"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(veParam0, joaat("WEAPON_MOLOTOV"), fParam1, &outCoords, &outProjectile, false))
		if (func_239(veParam0, outCoords, 90f, 0))
			return true;

	return false;
}

BOOL func_239(Vehicle veParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xEF78 Hash - 0x3F40E5FA ^0xC3BEFE6A
{
	var unk;
	var entityForwardVector;
	float num;

	unk = { func_232(uParam1 - ENTITY::GET_ENTITY_COORDS(veParam0, true)) };
...
BOOL func_240(Vehicle veParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF006 Hash - 0x18BAE105 ^0x60D3B20E
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_241(int iParam0) // Position - 0xF04E Hash - 0x5B443B41 ^0x5B443B41
{
...
void func_242(Vehicle veParam0) // Position - 0xF098 Hash - 0xAD821AF8 ^0x2F1DDA73
{
	int taskSequenceId;
...
BOOL func_243(int iParam0) // Position - 0xF135 Hash - 0x6F2BC7EE ^0x6F2BC7EE
{
	if (iParam0 == -1)
		iParam0 = func_177();
...
BOOL func_244(int iParam0) // Position - 0xF1CA Hash - 0xDE7BA54D ^0xDE7BA54D
{
...
BOOL func_245() // Position - 0xF209 Hash - 0x29CB2928 ^0xE369A18D
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_246() // Position - 0xF226 Hash - 0x98CCC132 ^0x97B0D6ED
{
	if (Global_98294 != -1)
...
BOOL func_247(int iParam0) // Position - 0xF249 Hash - 0xC2630182 ^0xFBD23031
{
	if (func_248() && Global_101392.f_11 == 6 && iParam0 == func_178(&(Global_101392.f_3), 0))
		return true;

	return false;
}

BOOL func_248() // Position - 0xF27D Hash - 0x25806CBF ^0x25806CBF
{
...
BOOL func_249(int iParam0) // Position - 0xF2BB Hash - 0x1156B580 ^0x34C7FA05
{
...
int func_250() // Position - 0xF2E3 Hash - 0x5A4670E ^0xE582B183
{
	return PED::ADD_SCENARIO_BLOCKING_AREA(-74.8392f, 300.5241f, 104f, -62.467f, 318.6961f, 109f, false, true, true, true, 1);
}

BOOL func_251(var uParam0) // Position - 0xF312 Hash - 0x24D26100 ^0x24D26100
{
	switch (*uParam0)
	{
		case 46:
	...
	func_294("Created initial scene");
	return true;
}

BOOL func_252(var uParam0) // Position - 0xF3B5 Hash - 0x2F2FDD92 ^0xC7ACDBD7
{
	int num;
	char* animDict;
	int i;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_261(&num) || !STREAMING::HAS_ANIM_DICT_LOADED(animDict))
				return false;
		...
		case 2:
			...
			{
				if (func_258(&uParam0->f_28[0], CHAR_BEVERLY, -490.809f, 232.39f, 82.018f, 33.84f, "PAPARAZZO LAUNCHER RC", 0))
				{
			...
			{
				func_256(&uParam0->f_28[1], num[3], -498.16565f, 228.62839f, 82.09948f, 292.9763f, PED_TYPE_MISSION);
			...
			{
				func_256(&uParam0->f_28[2], num[4], -498.30902f, 227.91116f, 82.105995f, 296.4216f, PED_TYPE_MISSION);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_254(&uParam0->f_35[0], num[1], -497.99f, 224.97f, 82.67f, 266.5f);
			...
			{
				func_254(&uParam0->f_35[1], num[2], -501.55f, 230.7f, 83.1f, 233.93f);
			
				if (func_189(uParam0->f_35[1]))
				{
			...
			{
				func_253(&uParam0->f_41[0], num[5], -490.11f, 233.15f, 82.1f, 0f);
			...
			{
				func_253(&uParam0->f_41[1], num[6], -490.11f, 233.15f, 82.1f, 0f);
...
void func_253(Object* pobParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF97A Hash - 0x61F651EE ^0x2FE58679
{
	func_218(pobParam0);
...
void func_254(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF9A1 Hash - 0x60B41505 ^0x2C4B5209
{
	func_255(pveParam0);
...
void func_255(Vehicle* pveParam0) // Position - 0xF9E4 Hash - 0x8D18F713 ^0xF71A18A8
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_256(Ped* ppedParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5, ePedType eptParam6) // Position - 0xFA80 Hash - 0x616C5024 ^0x190F8C82
{
	func_257(ppedParam0);
...
void func_257(Ped* ppedParam0) // Position - 0xFAA1 Hash - 0xCA79453F ^0x7BA88177
{
...
BOOL func_258(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xFAE2 Hash - 0x5E27D69A ^0xE8A3C3CE
{
	if (func_259(ppedParam0, echParam1, fParam2, fParam5, true))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
BOOL func_259(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xFB3E Hash - 0xC57592AD ^0x9AA0BE7
{
	Hash model;

	if (!func_36(echParam1))
	{
		model = func_297(echParam1);
...
int func_260(Ped pedParam0, eCharacter echParam1) // Position - 0xFBCC Hash - 0x5AC42C11 ^0x5AC42C11
{
	int num;
...
BOOL func_261(var uParam0) // Position - 0xFC12 Hash - 0xC42B20E0 ^0x728F1DAE
{
	int i;
...
BOOL func_262(var uParam0) // Position - 0xFC43 Hash - 0x39224587 ^0x13AE806
{
	uParam0->f_16 = 3;
...
BOOL func_263(var uParam0) // Position - 0xFC77 Hash - 0x6EE7E90E ^0x5970C674
{
	int num;
	int i;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			func_254(&uParam0->f_35[0], num[0], 307.02f, 143.17f, 103.3f, 250.08f);
...
BOOL func_264(var uParam0) // Position - 0xFD62 Hash - 0xB668C784 ^0x14199209
{
	int num;
	var unk6;
	var unk10;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_258(&uParam0->f_28[0], CHAR_BEVERLY, -261f, 292.22f, 90.89f, 10.53f, "PAPARAZZO LAUNCHER RC", 1))
				{
					PED::SET_PED_DEFAULT_COMPONENT_VARIATION(uParam0->f_28[0]);
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[0], PV_COMP_TASK, 1, 0, 0);
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uParam0->f_28[0], true);
			...
			if (func_135(uParam0->f_28[0]))
			{
				...
				{
					func_253(&uParam0->f_41[3], num[1], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
			...
			if (flag)
			{
				...
				uParam0->f_41[0] = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_cs_dumpster_01a"), unk10[0 /*3*/], true, true, false);
				ENTITY::SET_ENTITY_ROTATION(uParam0->f_41[0], unk20[0 /*3*/], 2, true);
				ENTITY::SET_CAN_CLIMB_ON_ENTITY(uParam0->f_41[0], false);
				uParam0->f_41[1] = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_cs_dumpster_lidl"), unk10[1 /*3*/], true, true, false);
				ENTITY::SET_ENTITY_ROTATION(uParam0->f_41[1], unk20[1 /*3*/], 2, true);
				ENTITY::SET_CAN_CLIMB_ON_ENTITY(uParam0->f_41[1], false);
				uParam0->f_41[2] = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_cs_dumpster_lidr"), unk10[2 /*3*/], true, true, false);
...
BOOL func_265(var uParam0) // Position - 0x102A6 Hash - 0xAFCF3DC5 ^0xECEF635B
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_261(&num) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmpaparazzo_2"))
				return false;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_258(&uParam0->f_28[0], CHAR_BEVERLY, -71.283f, 301.557f, 106.711f, 4.659f, "PAPARAZZO LAUNCHER RC", 1))
				{
					PED::SET_PED_DEFAULT_COMPONENT_VARIATION(uParam0->f_28[0]);
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[0], PV_COMP_TASK, 1, 0, 0);
				}
			...
			if (func_135(uParam0->f_28[0]))
			{
				if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
				{
					func_253(&uParam0->f_41[0], num[2], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_254(&uParam0->f_35[0], num[1], -78.0873f, 299.0679f, 105.3972f, 249.8696f);
...
BOOL func_266(var uParam0) // Position - 0x105E8 Hash - 0xD6E096B8 ^0x93EDFEAF
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_258(&uParam0->f_28[0], CHAR_BEVERLY, -149.75f, 285.81f, 93.67f, 135f, "PAPARAZZO LAUNCHER RC", 1))
				{
					PED::SET_PED_DEFAULT_COMPONENT_VARIATION(uParam0->f_28[0]);
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[0], PV_COMP_TASK, 1, 0, 0);
				}
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_254(&uParam0->f_35[0], num[1], -159.56f, 275.41f, 93.14f, 102.75f);
...
void func_267(int iParam0, BOOL bParam1) // Position - 0x1090C Hash - 0x5DA05E35 ^0xF6D7A4C9
{
	switch (iParam0)
	{
		case 46:
...
BOOL func_268(int iParam0) // Position - 0x10997 Hash - 0x59D2F680 ^0x59D2F680
{
	var unk;
	eCharacter character;
...
BOOL func_269(int iParam0) // Position - 0x109E8 Hash - 0xC6B32843 ^0x7051AD59
{
	const char* string2;
	...
	{
		func_294("STEP_3_COMMON_CanRCLaunch - Script denied, game flow is not active");
		return false;
	}
...
BOOL func_270(int iParam0) // Position - 0x10AA1 Hash - 0x791D84F4 ^0x791D84F4
{
	var unk;
...
BOOL func_271(int iParam0) // Position - 0x10B62 Hash - 0xDEAD9A68 ^0xDEAD9A68
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_272(int iParam0, char* sParam1) // Position - 0x10BE7 Hash - 0xC64245F ^0x17D814E6
{
...
BOOL func_273(int iParam0) // Position - 0x10CC9 Hash - 0x5ADD7F05 ^0x5ADD7F05
{
...
BOOL func_274(int iParam0) // Position - 0x10CF4 Hash - 0xBB053D24 ^0xBB053D24
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_275(int iParam0) // Position - 0x10D1F Hash - 0x5D95A044 ^0x5D95A044
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_276(int iParam0) // Position - 0x10D4A Hash - 0x9FFC81CD ^0x47A2AB8B
{
	if (func_244(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
void func_277() // Position - 0x10D7F Hash - 0x5631C87C ^0x8AED484B
{
...
BOOL func_278(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x10D99 Hash - 0x5B983661 ^0x5B983661
{
	int i;

	if (*uParam0 == 1)
	{
		if (func_279(uParam0->[0], uParam2, fParam5, uParam1))
			return true;
	}
	else
	{
		...
		{
			if (func_279(uParam0->[i], uParam2, fParam5, uParam1))
			{
				i = *uParam0;
				return true;
			}
...
BOOL func_279(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x10DFE Hash - 0xC6B7068B ^0xB9A971A4
{
	int num;
	char* str;
	...
	if (func_280(str.f_6, uParam1, fParam4, false))
	{
...
BOOL func_280(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x10E76 Hash - 0x1FB736D4 ^0x234AEAB7
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_281(var uParam0, BOOL bParam1) // Position - 0x10EF1 Hash - 0xE17A8B40 ^0x11102BAB
{
	if (bParam1)
	{
		...
		switch (*uParam0)
		{
			case 46:
				...
				func_283(uParam0, 0, false, false);
				break;
			...
			case 48:
				...
				func_218(&uParam0->f_41[3]);
				func_283(uParam0, 1, false, false);
				TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_PAPARAZZI", true);
				break;
	...
	if (!bParam1)
	{
		if (*uParam0 == 48)
		{
			func_294("SCRIPT TERMINATING: Holding on to launcher until Paparazzo 3 cleans up...");
...
int func_282(var uParam0) // Position - 0x1105F Hash - 0x86633390 ^0x2E35CBFB
{
	if (func_216(uParam0))
	{
...
void func_283(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x11095 Hash - 0x5BE1D1E3 ^0x5BE1D1E3
{
...
void func_284(var uParam0, BOOL bParam1) // Position - 0x110B5 Hash - 0xEDC3BD2D ^0xE0B6F056
{
	func_285(&(uParam0->f_41), bParam1);
	return;
}

void func_285(var uParam0, BOOL bParam1) // Position - 0x110C7 Hash - 0x9E80EA71 ^0x9E80EA71
{
	int i;
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (bParam1)
			...
			func_286(&uParam0->[i], false);
	}

	return;
}

void func_286(Object* pobParam0, BOOL bParam1) // Position - 0x11105 Hash - 0xD7EE3E27 ^0xC5769B29
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_287(var uParam0, BOOL bParam1) // Position - 0x11140 Hash - 0xEDC3BD2D ^0xE2474F74
{
	func_288(&(uParam0->f_35), bParam1);
	return;
}

void func_288(var uParam0, BOOL bParam1) // Position - 0x11152 Hash - 0xA98F6284 ^0xA98F6284
{
	int i;
...
void func_289(Vehicle* pveParam0) // Position - 0x1118F Hash - 0xC50F9886 ^0x638B6124
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_290(var uParam0, int iParam1) // Position - 0x111C7 Hash - 0xEDC3BD2D ^0xA9A19095
{
	func_291(&(uParam0->f_28), iParam1);
	return;
}

void func_291(var uParam0, int iParam1) // Position - 0x111D9 Hash - 0xB72ACFD2 ^0xB72ACFD2
{
	int i;
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_292(&uParam0->[i], false, 1, 0);
	}

	return;
}

void func_292(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x1121A Hash - 0x34362197 ^0xC592197
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_293(int iParam0) // Position - 0x1126A Hash - 0x995C9E2 ^0x995C9E2
{
	if (*iParam0 == -1)
		return;
...
void func_294(char* sParam0) // Position - 0x112A7 Hash - 0x54B64147 ^0x56EEAFB9
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_295(var uParam0) // Position - 0x112B9 Hash - 0x4CD8BCE8 ^0x130287E3
{
	*uParam0 = -1;
...
void func_296() // Position - 0x112EC Hash - 0x554DA35 ^0x916648A
{
...
Hash func_297(eCharacter echParam0) // Position - 0x11306 Hash - 0xBF0B24A5 ^0xBF0B24A5
{
	if (!func_36(echParam0))
