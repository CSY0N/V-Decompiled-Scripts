...
BOOL IS_XBOX_PLATFORM() // Position - 0x4EF
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x505
{
...
void func_8(var uParam0, var uParam1, var uParam2) // Position - 0x58C
{
...
void func_12() // Position - 0x66F
{
	if (!_IS_MISSION_REPEAT_ACTIVE(false))
	{
		...
		SYSTEM::START_NEW_SCRIPT_WITH_ARGS("mission_Race", &iLocal_81, 6, 62500);
	}
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x6C4
{
...
BOOL func_14(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x6EC
{
...
void func_15(Vehicle veParam0) // Position - 0x743
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
BOOL func_17(Vehicle veParam0) // Position - 0x8C0
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Vehicle veParam0) // Position - 0x8EA
{
...
int func_19(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x90B
{
...
void func_23(int iParam0) // Position - 0x121A
{
	BOOL flag;
	var txdName;
	...
	else if (IS_BIT_SET(Global_113969.f_20567.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_25() /*5570*/].f_681.f_10, iParam0))
	{
		flag = true;
		MISC::CLEAR_BIT(&(Global_113969.f_20567.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2359296[func_25() /*5570*/].f_681.f_10), iParam0);
	}
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x1394
{
	switch (iParam0)
	{
		case 0:
...
Hash func_27(int iParam0, int iParam1) // Position - 0x14D2
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_28(iParam1));
}

int func_28(int iParam0) // Position - 0x14E7
{
	int num;
	int num2;
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x1527
{
	if (iParam2 == -1)
		iParam2 = func_29();
...
BOOL func_32(int iParam0) // Position - 0x1565
{
	int cloudTimeAsInt;
	int num;
	int cloudTimeAsInt2;
	...
	return IS_BIT_SET(Global_2359296[func_25() /*5570*/].f_681.f_10, iParam0);
}
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x1734
{
	if (iParam1 == -1)
		iParam1 = func_29();
...
BOOL func_38(var uParam0, int iParam1) // Position - 0x18BF
{
	int i;
	var unk;
...
void func_43(var uParam0, int iParam1) // Position - 0x1A40
{
	if (iParam1 == 0f)
		uParam0->f_80 = 0f;
	else
...
BOOL func_48(int iParam0) // Position - 0x1AB6
{
	switch (iParam0)
	{
		case 60:
...
BOOL func_50(int iParam0, int iParam1) // Position - 0x1B14
{
...
void func_51(Hash hParam0, int iParam1) // Position - 0x1B65
{
	int outValue;
...
int func_54(eCharacter echParam0) // Position - 0x1C5A
{
	return Global_2169[echParam0 /*29*/].f_17;
}

eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x1C6B
{
	func_56();
...
void func_56() // Position - 0x1C84
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_113969.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_57(character) && !func_49(14) || Global_112917)
			{
				if (Global_113969.f_2366.f_539.f_4321 != character && func_57(Global_113969.f_2366.f_539.f_4321))
...
BOOL func_57(eCharacter echParam0) // Position - 0x1D81
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x1D8D
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x1DCA
{
...
Hash func_60(eCharacter echParam0) // Position - 0x1DEF
{
	return Global_2169[echParam0 /*29*/];
}

BOOL func_61() // Position - 0x1DFE
{
	int num;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0x1FA8
{
	return func_65(iParam0, Global_44042);
}

BOOL func_65(int iParam0, int iParam1) // Position - 0x1FB9
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_66(int iParam0) // Position - 0x219A
{
	if (Global_44042 == 15)
		return false;
...
BOOL func_67(Ped pedParam0) // Position - 0x21BC
{
...
void func_69(BOOL bParam0, int iParam1) // Position - 0x2270
{
	...
	if (bParam0)
	{
		func_70(&Global_23831.f_6263[num /*10*/]);
...
void func_70(int* piParam0) // Position - 0x2336
{
	if (piParam0->f_9 != 0)
	{
...
BOOL func_71(var uParam0, BOOL bParam1, int iParam2) // Position - 0x2362
{
	var unk;
	Hash hashKey;
	int i;
...
void func_72(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x23FF
{
	if (bParam0)
	{
...
BOOL func_74(Player plParam0, int iParam1) // Position - 0x2566
{
	BOOL flag;
...
BOOL func_76(Player plParam0) // Position - 0x2600
{
	Player player;
...
BOOL func_77(Player plParam0) // Position - 0x2622
{
...
int func_79(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x266F
{
	int num;
...
void func_83(BOOL bParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8) // Position - 0x2848
{
	int num;
	int r;
	int g;
	...
	num31 = 1f;
	func_117(bParam7, &unk3, &unk4, &num31);

	if (bParam3)
	{
		if (Global_23831.f_5821 <= PV_COMP_BERD)
		{
			func_113(Global_23831.f_5821 + 1, "DFLT_MNU_OPT" /*Exit*/, 0, true, false, false, false);
		...
		if (i == 1 && Global_23831.f_6331)
		{
			...
			else
			{
				if (Global_23831)
				{
					...
					{
						func_108(Global_23828, Global_23829, iParam5, height3, 0, 0, 0, 255);
				...
				func_108(Global_23828, Global_23829 + height3, iParam5, 0.034722f, r, g, b, a);
				...
				{
					func_107();
					func_105((Global_23828 + iParam5) - 0.00390625f - func_106("CM_ITEM_COUNT" /*~1~ / ~1~*/, Global_23831.f_6339, Global_23831.f_6340), Global_23829 + height3 + 0.00416664f, "CM_ITEM_COUNT" /*~1~ / ~1~*/, Global_23831.f_6339, Global_23831.f_6340);
				}
				else if (Global_23831.f_6334 > Global_23831.f_5828)
				{
					...
					{
						func_107();
						func_105((Global_23828 + iParam5) - 0.00390625f - func_106("CM_ITEM_COUNT" /*~1~ / ~1~*/, Global_23831.f_6337, Global_23831.f_6336), Global_23829 + height3 + 0.00416664f, "CM_ITEM_COUNT" /*~1~ / ~1~*/, Global_23831.f_6337, Global_23831.f_6336);
					}
				}
			}
			...
			if (Global_23831.f_6334 > Global_23831.f_5828)
			{
				...
				func_108(Global_23828, num28 + 0f, iParam5, 0.034722f, r, g, b, a);
			...
			if (MISC::GET_HASH_KEY(&(Global_23831.f_5241)) != 0 && Global_23831.f_5323 != -1)
			{
				...
				{
					func_119(Global_23831.f_5325, true, true, &width, &height, bParam7);
				...
				func_108(Global_23828, num28 - 0.00277776f, iParam5, 0.00277776f, r, g, b, a);
				...
				{
					func_119(Global_23831.f_5325, true, true, &width, &height, bParam7);
					func_103(Global_23831.f_5325, true, &red, &green, &blue, &alpha);
					GRAPHICS::DRAW_SPRITE(func_112(Global_23831.f_5325), func_109(Global_23831.f_5325, true), Global_23828 + (width * 0.5f) + (0.00078125f * 2f), (num28 + (height * 0.5f)) - (0.00138888f * 4f), width, height, 0f, red, green, blue, alpha, false, 0);
				}
			...
			if (MISC::GET_HASH_KEY(&(Global_4541740.f_21)) != 0 && Global_4541740.f_65 != -1)
			{
				...
				{
					func_119(Global_4541740.f_67, true, true, &width, &height, bParam7);
					x = (Global_23828 + width + (0.00078125f * 4f)) - (0.00078125f * 1f);
				}
				...
				{
					func_119(Global_4541740.f_67, true, true, &width, &height, bParam7);
					func_103(Global_4541740.f_67, true, &red, &green, &blue, &alpha);
					GRAPHICS::DRAW_SPRITE(func_112(Global_4541740.f_67), func_109(Global_4541740.f_67, true), Global_23828 + (width * 0.5f) + (0.00078125f * 2f), (num28 + (height * 0.5f)) - (0.00138888f * 4f), width, height, 0f, red, green, blue, alpha, false, 0);
				}
						...
						switch (Global_23831.f_5659[k])
						{
								...
								if (flag2)
								{
									if (!Global_23831.f_6332)
									{
										...
										if (MISC::GET_HASH_KEY(&Global_23831.f_79[num16 /*6*/]) != 0)
										{
											...
											func_96(flag, Global_23831.f_1616[num16], Global_23831.f_1873[num16], flag7, num35, flag5, flag4);
										...
										if (num20 > 0)
										{
											...
											{
												if (func_119(Global_23831.f_4984[num14 + l], flag, false, &width, &height, bParam7))
												{
													num25 = num25 + width;
									...
									if (flag6)
									{
										if (func_119(26, true, false, &width, &height, bParam7))
										{
											...
											if (func_119(26, true, true, &width, &height, bParam7))
											{
												...
												if (i == 1)
													GRAPHICS::DRAW_SPRITE(func_112(26), func_109(26, true), num24 + x + num26, (y - 0.00277776f) + (height2 * 0.5f), width, height, 0f, red, green, blue, alpha, false, 0);
											}
										}
										...
										if (func_119(27, true, false, &width, &height, bParam7))
										{
											...
											if (func_119(27, true, true, &width, &height, bParam7))
											{
												...
												if (i == 1)
													GRAPHICS::DRAW_SPRITE(func_112(27), func_109(27, true), num24 + x + num26 + screenWidthOfDisplayText + num25, (y - 0.00277776f) + (height2 * 0.5f), width, height, 0f, red, green, blue, alpha, false, 0);
											}
										}
									}
									...
									if (MISC::GET_HASH_KEY(&Global_23831.f_79[num16 /*6*/]) != 0 && i == 1)
									{
										...
										func_96(flag, Global_23831.f_1616[num16], Global_23831.f_1873[num16], flag7, 0, flag5, flag4);
									...
									for (l = 0; l < 4; l = l + 1)
									{
										...
										else if (Global_23831.f_2387[num16 /*5*/][l] == 4)
										{
											...
											{
												if (func_119(Global_23831.f_4984[num14 + num20], flag, false, &width, &height, bParam7))
												{
													x = x + (width * 0.5f);
												
													if (func_119(Global_23831.f_4984[num14 + num20], flag, true, &width, &height, bParam7))
													{
														func_103(Global_23831.f_4984[num14 + num20], flag, &red, &green, &blue, &alpha);
													
														if (i == 1)
															if (Global_23831.f_5686[k] == 2)
																GRAPHICS::DRAW_SPRITE(func_112(Global_23831.f_4984[num14 + num20]), func_109(Global_23831.f_4984[num14 + num20], flag), ((num24 + x) - (0.00078125f * 8f)) + (0.00078125f * 4f), (y - 0.00277776f) + (height2 * 0.5f), width, height, 0f, red, green, blue, alpha, false, 0);
															else
																GRAPHICS::DRAW_SPRITE(func_112(Global_23831.f_4984[num14 + num20]), func_109(Global_23831.f_4984[num14 + num20], flag), (num24 + x) - (0.00078125f * 8f), (y - 0.00277776f) + (height2 * 0.5f), width, height, 0f, red, green, blue, alpha, false, 0);
										...
										else
										{
											...
											if (IS_ROCKSTAR_DEV() && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("fm_mission_creator")) > 0)
											{
												if (k == 0)
												{
													...
													func_96(false, Global_23831.f_1616[num16], Global_23831.f_1873[num16], flag7, 0, flag5, flag4);
										...
										for (l = 0; l < num20; l = l + 1)
										{
											if (Global_23831.f_4984[num14 + l] != 2 && Global_23831.f_4984[num14 + l] != 54 && Global_23831.f_4984[num14 + l] != 64)
											{
												if (func_119(Global_23831.f_4984[num14 + l], flag, false, &width, &height, bParam7))
												{
													...
													if (i == 1)
													{
														if (func_119(Global_23831.f_4984[num14 + l], flag, true, &width, &height, bParam7))
														{
															func_103(Global_23831.f_4984[num14 + l], flag, &red, &green, &blue, &alpha);
														
															if (Global_23831.f_4984[num14 + l] == 30)
																GRAPHICS::DRAW_SPRITE(func_112(Global_23831.f_4984[num14 + l]), func_109(Global_23831.f_4984[num14 + l], flag), Global_23828 + (width * 0.5f), (y + 0.00277776f + (height * 0.5f)) - (0.00078125f * 11f), width, height, 0f, red, green, blue, alpha, false, 0);
															else if (Global_23831.f_5686[k] == 2)
																GRAPHICS::DRAW_SPRITE(func_112(Global_23831.f_4984[num14 + l]), func_109(Global_23831.f_4984[num14 + l], flag), ((num24 + x + screenWidthOfDisplayText) - (0.00078125f * 8f)) + (0.00078125f * 4f), (y - 0.00277776f) + (height2 * 0.5f), width, height, 0f, red, green, blue, alpha, false, 0);
															else
																GRAPHICS::DRAW_SPRITE(func_112(Global_23831.f_4984[num14 + l]), func_109(Global_23831.f_4984[num14 + l], flag), (num24 + x + screenWidthOfDisplayText) - (0.00078125f * 12f), (y - 0.00277776f) + (height2 * 0.5f), width, height, 0f, red, green, blue, alpha, false, 0);
														}
													}
							...
							case 2:
								if (flag2)
								{
									if (!Global_23831.f_6332)
									{
										func_96(flag, Global_23831.f_1616[num16], Global_23831.f_1873[num16], flag7, 0, false, false);
									...
									{
										func_96(flag, Global_23831.f_1616[num16], Global_23831.f_1873[num16], flag7, 0, false, false);
										func_93(num24 + x, y, "NUMBER" /*~1~*/, Global_23831.f_4469[num12], 0);
									}
								}
							...
							case 3:
								if (flag2)
								{
									...
									func_96(flag, Global_23831.f_1616[num16], Global_23831.f_1873[num16], flag7, 0, false, false);
									func_92(num24 + x, y, "NUMBER" /*~1~*/, Global_23831.f_4726[num13], Global_23831.f_4855[num13]);
								}
							...
							case 4:
								if (flag2)
								{
									if (func_119(Global_23831.f_4984[num14], flag, false, &width, &height, bParam7))
									{
										if (!Global_23831.f_6332)
										{
											num25 = width;
										...
										if (i == 1)
										{
											if (func_119(Global_23831.f_4984[num14], flag, true, &width, &height, bParam7))
											{
												func_103(Global_23831.f_4984[num14], flag, &red, &green, &blue, &alpha);
												GRAPHICS::DRAW_SPRITE(func_112(Global_23831.f_4984[num14]), func_109(Global_23831.f_4984[num14], flag), num24 + x + (width * 0.5f), (y - 0.00277776f) + (height2 * 0.5f), width * func_91(Global_23831.f_4984[num14]), height * func_91(Global_23831.f_4984[num14]), 0f, red, green, blue, alpha, false, 0);
											}
										}
									}
								}
...
BOOL func_89(int iParam0) // Position - 0x5B56
{
	if (iParam0 == 1)
...
void func_93(float fParam0, float fParam1, char* sParam2, ePedComponentType epctParam3, int iParam4) // Position - 0x5C4A
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
...
BOOL IS_ROCKSTAR_DEV() // Position - 0x5C68
{
...
void func_96(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x5CBF
{
	...
	if (bParam2)
	{
		if (bParam3)
		{
			func_97(Global_23831.f_6614[iParam4], &r, &g, &b);
...
void func_98(var uParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8) // Position - 0x60F7
{
	int num;
	int i;
	int j;
...
void func_103(int iParam0, BOOL bParam1, int* piParam2, int* piParam3, int* piParam4, int* piParam5) // Position - 0x66A4
{
...
void func_105(float fParam0, float fParam1, char* sParam2, ePedComponentType epctParam3, int iParam4) // Position - 0x6824
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
	HUD::ADD_TEXT_COMPONENT_INTEGER(epctParam3);
...
float func_106(char* sParam0, ePedComponentType epctParam1, int iParam2) // Position - 0x6847
{
...
void func_108(float fParam0, float fParam1, int iParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7) // Position - 0x6913
{
	GRAPHICS::DRAW_RECT(fParam0 + (iParam2 * 0.5f), fParam1 + (fParam3 * 0.5f), iParam2, fParam3, iParam4, iParam5, iParam6, iParam7, false);
	return;
}

char* func_109(int iParam0, BOOL bParam1) // Position - 0x6942
{
	var unk;
	var txdName;
	var netHandle;
...
char* func_110(char* sParam0) // Position - 0x6E6C
{
	return sParam0;
}

struct<13> GET_GAMER_HANDLE_PLAYER(Player plParam0) // Position - 0x6E76
{
	var gamerHandle;
...
void func_113(ePedComponentType epctParam0, char* sParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x6F02
{
	int num;
	float num2;
	float num3;
	...
	if (!bParam3)
		func_116(Global_23831.f_5821, true);
	else
		func_116(Global_23831.f_5821, false);

	if (iParam2 == 0)
	{
		num2 = func_115(&Global_23831.f_79[Global_23831.f_5823 /*6*/]);
	...
	if (bParam5)
	{
		if (iParam2 == 0)
		{
			num4 = func_114(&Global_23831.f_79[Global_23831.f_5823 /*6*/]);
...
void func_116(ePedComponentType epctParam0, BOOL bParam1) // Position - 0x7177
{
	int num;
...
void func_117(BOOL bParam0, int* piParam1, int* piParam2, var uParam3) // Position - 0x71C3
{
	float num;
	float value;
	float aspectRatio;
...
BOOL func_119(int iParam0, BOOL bParam1, BOOL bParam2, var uParam3, var uParam4, BOOL bParam5) // Position - 0x7266
{
	var textureDict;
	var textureName;
	int num;
...
BOOL func_121(BOOL bParam0, BOOL bParam1) // Position - 0x7466
{
	if (Global_2672855.f_1728.f_701 != 0)
		return true;

	if (!CAM::IS_SCREEN_FADED_IN() || func_123(8, -1) && func_122() != TRANSITION_STATE_WAITING_FOR_EXTERNAL_TERMINATION_CALL || HUD::GET_PAUSE_MENU_STATE() != 0 && !bParam1 || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() && !bParam0 || NETWORK::IS_COMMERCE_STORE_OPEN() || Global_79650 || Global_23831.f_9115 || HUD::IS_WARNING_MESSAGE_ACTIVE() || Global_101585.f_1482)
		return false;

	return true;
}

eTransitionState func_122() // Position - 0x7503
{
	return Global_1575011;
}

BOOL func_123(int iParam0, int iParam1) // Position - 0x750F
{
	switch (iParam0)
	{
		case 5:
...
void func_129(eControlAction ecaParam0, char* sParam1, int iParam2) // Position - 0x78B5
{
...
BOOL func_134(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x7F8B
{
	...
	flag2 = func_135(&Global_23831.f_6263[num /*10*/]);
	!flag || !flag2;
	return flag && flag2;
}

BOOL func_135(int* piParam0) // Position - 0x809A
{
	switch (piParam0->f_9)
	{
		case 0:
		...
		switch (iLocal_193)
		{
			...
			case 2:
				if (TASK::GET_SCRIPT_TASK_STATUS(uLocal_101[iParam0], SCRIPT_TASK_PERFORM_SEQUENCE) != 1 || PED::IS_PED_FACING_PED(uLocal_101[iParam0], PLAYER::PLAYER_PED_ID(), 20f))
				{
					...
					if (!bLocal_195)
						func_145(uLocal_101[iParam0], "PRERACE_CHAT", "A_M_Y_RACER_01_WHITE_MINI_01", 11, false);
					else
						func_145(uLocal_101[iParam0], "PRERACE_TAUNT", "A_M_Y_RACER_01_WHITE_MINI_01", 11, false);
...
float func_139(var uParam0) // Position - 0x83D7
{
	if (func_142(uParam0))
		if (func_141(uParam0))
			return uParam0->f_2;
...
void func_143(int* piParam0) // Position - 0x8485
{
	func_144(piParam0, 0f);
	return;
}

void func_144(int* piParam0, float fParam1) // Position - 0x8494
{
...
void func_145(Ped pedParam0, char* sParam1, char* sParam2, int iParam3, BOOL bParam4) // Position - 0x84BF
{
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0(int iParam0) // Position - 0x84D9
{
	char* str;
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0x895E
{
...
BOOL func_158(Hash hParam0) // Position - 0x8F9B
{
	switch (hParam0)
	{
		case joaat("police"):
...
void func_160(Vehicle* pveParam0) // Position - 0x9077
{
...
int _GET_PLAYER_CASH(eCharacter echParam0) // Position - 0x9100
{
	int outValue;
...
BOOL func_168(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x992C
{
...
BOOL func_170(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5) // Position - 0x99A3
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(pedParam0, bParam5), vParam1) <= fParam4 * fParam4;
}

BOOL func_171() // Position - 0x99C1
{
	if (iLocal_81.f_1 == 3)
		return true;
...
BOOL func_172(var uParam0) // Position - 0x9A0F
{
	int i;
...
BOOL func_174(int iParam0, const char* sParam1, Hash hParam2) // Position - 0x9A82
{
...
int func_175(int iParam0) // Position - 0x9B6D
{
	int i;
...
void func_177(int* piParam0) // Position - 0x9C14
{
	func_178(piParam0, &(piParam0->f_2), piParam0->f_1);
	return;
}

void func_178(int* piParam0, const char* sParam1, Hash hParam2) // Position - 0x9C2A
{
...
void func_181(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4) // Position - 0xA699
{
	int i;
...
Hash func_182(int iParam0) // Position - 0xA778
{
	int num;
...
void func_184(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0xA7CD
{
	switch (iParam0)
	{
		case 0:
...
void func_186(Ped pedParam0, BOOL bParam1) // Position - 0xAE43
{
	char* str;
	int endRange;
	...
	if (func_67(pedParam0))
	{
		...
		if (PED::IS_PED_MALE(pedParam0))
			func_145(pedParam0, str, "WAVELOAD_PAIN_MALE", 24, false);
		else
			func_145(pedParam0, str, "WAVELOAD_PAIN_FEMALE", 24, false);
	}

	return;
}

BOOL func_187() // Position - 0xAEB6
{
	int i;
...
BOOL func_188(Ped pedParam0, BOOL bParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0xB109
{
	float num;
...
BOOL func_189(Vehicle veParam0, int iParam1) // Position - 0xB1C4
{
	float xSize;
...
BOOL func_190(Vehicle veParam0, int iParam1) // Position - 0xB23A
{
	return func_191(veParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_191(Vehicle veParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xB252
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_192(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Vehicle veParam6, int iParam7) // Position - 0xB313
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_193(Ped pedParam0, int iParam1) // Position - 0xB43F
{
	int randomIntInRange;
...
BOOL func_195(Vehicle veParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xB54E
{
	var unk;
...
float func_196(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xB5DF
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_197(float fParam0, var uParam1, var uParam2) // Position - 0xB600
{
	float num;
	float num2;
...
int func_199(Vehicle veParam0, Ped pedParam1) // Position - 0xB65A
{
	int i;
...
BOOL func_200(Vehicle veParam0) // Position - 0xB699
{
...
BOOL func_201(Ped pedParam0, Vehicle veParam1, int iParam2) // Position - 0xB6C1
{
...
BOOL func_202(Vehicle veParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xB708
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_203(Vehicle veParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB803
{
	float entityCoords;
	float num;
...
BOOL func_204(Vehicle veParam0, float fParam1) // Position - 0xB90F
{
	var outProjectile;
	var outCoords;
...
BOOL func_205(Vehicle veParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xB9A4
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_206(Vehicle veParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xBA32
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_207(Ped pedParam0, Vehicle veParam1, int iParam2) // Position - 0xBA7A
{
...
BOOL func_208() // Position - 0xBAB8
{
	switch (iLocal_81)
	{
		case 5:
			return IS_BIT_SET(Global_113969.f_24979.f_2, 0);
	
		case 6:
			return IS_BIT_SET(Global_113969.f_24979.f_2, 1);
	
		case 7:
			return IS_BIT_SET(Global_113969.f_24979.f_2, 2);
	
		case 8:
			return IS_BIT_SET(Global_113969.f_24979.f_2, 3);
	
		case 0:
			return IS_BIT_SET(Global_113969.f_24982.f_3, 0);
	
		case 1:
			return IS_BIT_SET(Global_113969.f_24982.f_3, 1);
	
		case 2:
			return IS_BIT_SET(Global_113969.f_24982.f_3, 2);
	
		case 3:
			return IS_BIT_SET(Global_113969.f_24982.f_3, 3);
	
		case 4:
			return IS_BIT_SET(Global_113969.f_24982.f_3, 4);
	}
...
int func_210(float fParam0, float fParam1, float fParam2, float fParam3) // Position - 0xBC2E
{
	var unk;
...
void func_214(int iParam0, const char* sParam1, Hash hParam2) // Position - 0xBD4C
{
	if (IS_BIT_SET(iParam0, 30))
	{
		switch (func_175(iParam0))
...
BOOL func_215(int iParam0) // Position - 0xBE06
{
	switch (iParam0)
	{
		case 0:
			return IS_BIT_SET(Global_113969.f_24982.f_1, 0);
	
		case 1:
			return IS_BIT_SET(Global_113969.f_24982.f_1, 1);
	
		case 2:
			return IS_BIT_SET(Global_113969.f_24982.f_1, 2);
	
		case 3:
			return IS_BIT_SET(Global_113969.f_24982.f_1, 3);
	
		case 4:
			return IS_BIT_SET(Global_113969.f_24982.f_1, 4);
	}

	return false;
}

BOOL func_216(int iParam0, int iParam1) // Position - 0xBE89
{
	BOOL flag;
...
BOOL func_218(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0xC06C
{
	if (fParam6 < 0f)
		fParam6 = 0f;
