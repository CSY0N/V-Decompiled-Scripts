...
void main() // Position - 0x0 Hash - 0x5D84F89F ^0x5D84F89F
{
	...
	iLocal_39 = 49;
	iLocal_40 = 64;
	uLocal_44 = { 500f, 500f, 500f };
	iLocal_95 = -1;
	essLocal_96 = FRIEND;
	iLocal_97 = -1;
	iLocal_98 = -1;
	sLocal_100 = "CC_SUBSTR" /*~INPUT_CONTEXT~*/;
	fLocal_101 = 125f;
	iLocal_102 = 1;
	iLocal_104 = 263;
	fLocal_123 = 0f;
	...
	pedLocal_84 = PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID());
	iLocal_94 = 0;
	func_190(&Global_113020, 0);
	func_185();

	if (func_184(iLocal_93, 1))
		iLocal_99 = 10;
	else
		iLocal_99 = 9;
	...
	if (!func_184(iLocal_93, 8))
		if (!_CAN_ENTER_FREEROAM_STATE(iLocal_99))
			if (func_181(0, iLocal_98))
				func_192(false);
			else
				func_192(true);
	...
	if (func_184(iLocal_93, 8388608))
		func_192(true);

	if (func_184(iLocal_93, 524288) && func_180() && !func_179())
		func_192(true);

	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_184(iLocal_93, 4194304))
	{
		if (iLocal_104 != 263)
		{
			func_178(iLocal_104, true, false);
			iLocal_104 = 263;
		}
	...
	while (true)
	{
		...
		if (func_184(iLocal_93, 1048576))
			if (ENTITY::IS_ENTITY_DEAD(pedLocal_84, false))
				func_192(true);
	
		if (ENTITY::DOES_ENTITY_EXIST(pedLocal_84) && !ENTITY::IS_ENTITY_DEAD(pedLocal_84, false))
		{
			uLocal_86 = { ENTITY::GET_ENTITY_COORDS(pedLocal_84, true) };
			fLocal_92 = SYSTEM::VDIST2(uLocal_86, uScriptParam_0.f_1[0 /*3*/]);
			fLocal_92 = fLocal_92;
			uLocal_110 = { uLocal_86 };
			uLocal_113 = { uScriptParam_0.f_1[0 /*3*/] };
			uLocal_110.f_2 = 0f;
			uLocal_113.f_2 = 0f;
			fLocal_109 = SYSTEM::VDIST2(uLocal_110, uLocal_113);
		
			switch (iLocal_94)
			{
				case 0:
					if (_CAN_ENTER_FREEROAM_STATE(iLocal_99) || func_184(iLocal_93, 16) && !func_184(iLocal_93, 524288))
					{
						iLocal_97 = -1;
						func_176();
						func_177(1);
					...
					else
					{
						...
						uLocal_86.f_2 - uScriptParam_0.f_1[0 /*3*/].f_2 > 500f;
					}
					break;
				...
				case 3:
					...
					if (!_CAN_ENTER_FREEROAM_STATE(iLocal_99))
					{
						if (!func_184(iLocal_93, 8))
						{
							...
							if (MISC::ARE_STRINGS_EQUAL(&(Global_101392.f_3), &uLocal_68))
							{
								uLocal_68 = { uLocal_52 };
								flag2 = false;
							}
					...
					if (!func_184(iLocal_93, 4))
					{
						func_173();
						func_172(&iLocal_93, 4);
					}
				
					if (fLocal_109 > fLocal_101 * fLocal_101 && !Global_101426)
					{
						if (iLocal_104 != 263)
						{
							if (func_171(6) && !func_170(iLocal_104))
							{
							}
							else
							{
					...
					{
						uLocal_68 = { uLocal_52 };
						flag3 = !func_184(iLocal_93, 64);
						func_190(&iLocal_93, 128);
					
						if (!func_169(3) && !Global_101426)
						{
							if (func_184(iLocal_93, 2097152))
							{
								if (!func_184(iLocal_93, 1) || !ENTITY::DOES_ENTITY_EXIST(func_168()) && !Global_101426)
								{
									func_177(10);
									break;
								}
						...
						if (!func_157(6) || Global_113417 || func_156())
							flag3 = false;
					
						if (!bLocal_125)
						{
							func_154(&iLocal_93, 128);
							flag3 = false;
						}
						...
						if (func_145(0) || func_144())
							flag3 = false;
					
						if (flag3)
						{
							if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), uLocal_116, uLocal_119, fLocal_122, true, false, iLocal_102) || fLocal_124 > 0f && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), func_143(uLocal_116, uLocal_119, 0.5f), false) > fLocal_124)
								flag3 = false;
							else if (fLocal_123 > 0f)
								if (MISC::ABSF(uLocal_86.f_2 - uLocal_116.f_2) > fLocal_123)
									flag3 = false;
							...
							if (flag3)
							{
								...
								if (func_142(uLocal_85))
								{
									if (iLocal_95 == -1)
									{
										_CONTEXT_ADD_HELP_TEXT(&iLocal_95, 4, sLocal_100, 0, 0, 0, 0);
										func_154(&iLocal_93, 2048);
									}
									else if (!func_184(iLocal_93, 2048) || !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED())
									{
										_CONTEXT_REMOVE_HELP_TEXT(&iLocal_95);
										func_190(&iLocal_93, 2048);
									}
								
									if (func_138(iLocal_95, true))
									{
										sLocal_100 = sLocal_100;
										_CONTEXT_REMOVE_HELP_TEXT(&iLocal_95);
										func_190(&iLocal_93, 2048);
										SCRIPT::REQUEST_SCRIPT(&uLocal_68);
				...
				case 5:
					...
					if (SCRIPT::HAS_SCRIPT_LOADED(&uLocal_68))
					{
						if (iLocal_95 != -1)
							_CONTEXT_REMOVE_HELP_TEXT(&iLocal_95);
						...
						if (num != 1)
							num = func_37(&iLocal_97, 6, iLocal_99, false, 0);
						...
						if (num == 1)
						{
							...
							iLocal_51 = SYSTEM::START_NEW_SCRIPT(&uLocal_68, essLocal_96);
							SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED(&uLocal_68);
							uLocal_52 = { uLocal_68 };
							TEXT_LABEL_ASSIGN_STRING(&uLocal_68, "", 64);
							func_154(&iLocal_93, 2);
							func_177(6);
							func_23(&uLocal_106);
				...
				case 6:
					if (func_184(Global_113020, 262144))
					{
						func_190(&Global_113020, 262144);
						func_17();
					}
				
					if (func_184(iLocal_93, 2097152))
						if (!func_169(3) && !SCRIPT::IS_THREAD_ACTIVE(iLocal_51))
							func_177(10);
				
					if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_51))
					{
						STATS::PLAYSTATS_ODDJOB_DONE(SYSTEM::ROUND(func_13(&uLocal_106) * 1000f), iLocal_98, false);
						func_12(&uLocal_106);
						func_190(&iLocal_93, 256);
						func_9();
					
						if (flag)
						{
							func_190(&iLocal_93, 2);
						}
						else if (func_184(iLocal_93, 2))
						{
							if (func_184(Global_113020, 0))
							{
								func_8(&iLocal_97);
								iLocal_97 = -1;
								func_190(&iLocal_93, 2);
						...
						if (iLocal_98 != -1)
						{
							if (func_184(Global_113020, 0))
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_21(iLocal_98), 0, Global_101429, 0);
								func_7(func_21(iLocal_98), 0, Global_101429, true, false);
							}
							else
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_21(iLocal_98), 0, Global_101429, 0);
								func_7(func_21(iLocal_98), 0, Global_101429, false, false);
							}
						}
						...
						if (func_184(iLocal_93, 16777216))
							func_192(true);
				...
				case 7:
					...
					if (iLocal_104 != 263)
						func_178(iLocal_104, false, false);
				
					if (iLocal_95 != -1)
						_CONTEXT_REMOVE_HELP_TEXT(&iLocal_95);
				
					if (!MISC::IS_STRING_NULL_OR_EMPTY(sLocal_100))
						if (_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sLocal_100))
							HUD::CLEAR_HELP(true);
					...
					if (iLocal_103 % 150 == 0)
					{
						if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
						{
							if (iLocal_105 == 2)
							{
								if (iLocal_105 == 2)
								{
									if (_CAN_ENTER_FREEROAM_STATE(iLocal_99) && func_181(0, iLocal_98))
									{
										func_185();
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0xA60 Hash - 0xCD6A3595 ^0xB0E86AA0
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(message);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_2() // Position - 0xA73 Hash - 0x9F8B860F ^0x71E396DC
{
	func_4(128);
...
void func_3(Ped pedParam0) // Position - 0xA95 Hash - 0x7936EEB2 ^0xA6D00E43
{
	PED::RELEASE_PED_PRELOAD_VARIATION_DATA(pedParam0);
	PED::RELEASE_PED_PRELOAD_PROP_DATA(pedParam0);
	return;
}

void func_4(BOOL bParam0) // Position - 0xAA9 Hash - 0xBBD3AFCB ^0xBBD3AFCB
{
	Global_113456 = Global_113456 - Global_113456 && bParam0;
	return;
}

void func_5() // Position - 0xAC1 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_6() // Position - 0xAC9 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_7(char* sParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0xAD1 Hash - 0xE9AC9AEE ^0xA4AB7C48
{
...
void func_8(var uParam0) // Position - 0xB15 Hash - 0x995C9E2 ^0x995C9E2
{
	if (*uParam0 == -1)
		return;
...
void func_9() // Position - 0xB52 Hash - 0xE9E439A3 ^0x7AD2C7C7
{
	var textLabel;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0xB94 Hash - 0x4C81F065 ^0x79C65D03
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0xBAA Hash - 0x4C81F065 ^0xB17A9745
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_12(var uParam0) // Position - 0xBC0 Hash - 0x4ECF353C ^0xF00161
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
float func_13(int* piParam0) // Position - 0xBD6 Hash - 0x4CA081DF ^0xE7D9DC6
{
	if (func_16(piParam0))
		if (func_15(piParam0))
			return piParam0->f_2;
...
float func_14(BOOL bParam0) // Position - 0xC12 Hash - 0xB0FB4432 ^0x9D798691
{
	float num;
	float num2;
	int networkTime;
...
BOOL func_15(int* piParam0) // Position - 0xC6A Hash - 0x58F53CD ^0x58F53CD
{
	return IS_BIT_SET(*piParam0, 2);
}

BOOL func_16(int* piParam0) // Position - 0xC77 Hash - 0xA8A91C80 ^0xA8A91C80
{
	return IS_BIT_SET(*piParam0, 1);
}

int func_17() // Position - 0xC84 Hash - 0xFD255207 ^0xFD255207
{
	return 1;
}

void func_18() // Position - 0xC8D Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_19(char* sParam0, int iParam1, int iParam2) // Position - 0xC95 Hash - 0x8572F920 ^0xA7259CBD
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&Global_98442))
	{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0xCD6 Hash - 0x15889021 ^0xE7262364
{
...
char* func_21(int iParam0) // Position - 0xCFE Hash - 0x4E453EBF ^0x4E453EBF
{
	switch (iParam0)
	{
		case 0:
...
void func_22(int iParam0) // Position - 0xE3C Hash - 0x6F25AF03 ^0xBE6FE336
{
	int num;
	var textLabel;
...
void func_23(int* piParam0) // Position - 0xE93 Hash - 0xF9B0CE5A ^0xF9B0CE5A
{
	if (!func_16(piParam0))
		func_26(piParam0);
	else
...
void func_24(int* piParam0) // Position - 0xEB4 Hash - 0x879BC8E8 ^0x879BC8E8
{
	func_25(piParam0, 0f);
	return;
}

void func_25(int* piParam0, float fParam1) // Position - 0xEC3 Hash - 0xED66BE55 ^0x9F6586C1
{
...
void func_26(int* piParam0) // Position - 0xEEE Hash - 0x227D76A6 ^0x227D76A6
{
	if (!func_16(piParam0))
		func_24(piParam0);
...
void func_27(Ped pedParam0) // Position - 0xF06 Hash - 0x91438920 ^0xDA692F14
{
	int num;
	int num2;
	int num3;
...
void func_28(int iParam0) // Position - 0xF5F Hash - 0xBB510F32 ^0xE77AE77B
{
...
int func_29(Ped pedParam0) // Position - 0xFE2 Hash - 0x14AF2EDD ^0xC5BC7CD2
{
	int i;
...
void func_30(int iParam0, int iParam1, int iParam2) // Position - 0x1013 Hash - 0xF54D70EF ^0xF54D70EF
{
	func_31(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_31(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x1028 Hash - 0x9F3D8BA2 ^0x9F3D8BA2
{
	int num;
...
int func_32() // Position - 0x10AA Hash - 0x11506CC4 ^0x2E9F5641
{
	int i;
...
BOOL func_33(int iParam0, int iParam1, int iParam2) // Position - 0x10DB Hash - 0x3A30B8C2 ^0x3A30B8C2
{
...
int func_34(int iParam0, int iParam1, int iParam2) // Position - 0x10F6 Hash - 0x61F8C119 ^0x1C9B84EC
{
	int i;
...
int func_35(Ped pedParam0) // Position - 0x1142 Hash - 0xDCBB968F ^0xDCBB968F
{
	int i;
...
void func_36() // Position - 0x118B Hash - 0x53295875 ^0x53295875
{
...
int func_37(var uParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0x1208 Hash - 0x8F9349A ^0xC5C097C1
{
	int i;
...
void func_38(var uParam0, int iParam1) // Position - 0x133F Hash - 0x6AC97785 ^0x6AC97785
{
	int i;
...
BOOL func_39(int iParam0) // Position - 0x138E Hash - 0x3BAB94E9 ^0x3BAB94E9
{
	if (Global_43922 == 15)
		return false;
...
void func_40() // Position - 0x13B0 Hash - 0x6679F241 ^0xEEB94580
{
	...
	else if (character == CHAR_MICHAEL)
	{
		...
		{
			func_130(128);
			func_45(PLAYER::PLAYER_PED_ID(), 9);
		}
	}
	else if (character == CHAR_TREVOR)
	{
		...
		{
			func_130(128);
			func_45(PLAYER::PLAYER_PED_ID(), 5);
		}
	}
	...
	if (iLocal_126 == 2)
	{
		if (!bLocal_128)
		{
			if (func_44(2) == 49)
			{
				...
				{
					SYSTEM::START_NEW_SCRIPT("tennis_family", MULTIPLAYER_MISSION);
					SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED("tennis_family");
					bLocal_128 = true;
				}
			}
		}
		else if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("tennis_family")) == 0)
		{
			bLocal_128 = false;
			bLocal_129 = false;
		}
	...
	!PED::HAS_PED_PRELOAD_VARIATION_DATA_FINISHED(PLAYER::PLAYER_PED_ID());
	return;
}

int func_41() // Position - 0x14A9 Hash - 0x949B0B8E ^0x949B0B8E
{
	if (!func_42(22))
		return 1;
...
BOOL func_42(int iParam0) // Position - 0x14C0 Hash - 0x35F9F9C ^0x35F9F9C
{
...
int func_43() // Position - 0x14EC Hash - 0x4E53F5D6 ^0x4E53F5D6
{
	if (func_42(21))
		return 1;
...
int func_44(int iParam0) // Position - 0x1502 Hash - 0xD64AD64C ^0xD64AD64C
{
	return Global_96378[iParam0];
}

void func_45(Ped pedParam0, int iParam1) // Position - 0x1512 Hash - 0x632A02CE ^0x61908FBB
{
	Hash entityModel;
	var unk;

	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	unk = { func_127(entityModel, iParam1) };
	func_46(pedParam0, entityModel, &unk);
	return;
}

void func_46(Ped pedParam0, Hash hParam1, var uParam2) // Position - 0x1539 Hash - 0xF7BF8600 ^0xB90F19A7
{
	ePedComponentType i;
	var unk;
	int j;
	...
	{
		unk = { func_57(hParam1, func_126(i), uParam2->[func_126(i)], -1) };
	
		if (unk.f_3 != -1 && unk.f_4 != -1)
			PED::SET_PED_PRELOAD_VARIATION_DATA(pedParam0, i, unk.f_3, unk.f_4);
	}

	unk15 = { func_49(hParam1, uParam2->[13]) };

	for (j = 0; j <= 8; j = j + 1)
	{
		num = j;
		componentId = func_48(num);
		num2 = func_47(componentId);
	
		if (unk15[j] != num2)
		{
			unk = { func_57(hParam1, 14, unk15[j], -1) };
		
			if (unk.f_3 != -1 && unk.f_3 != 255)
				PED::SET_PED_PRELOAD_PROP_DATA(pedParam0, componentId, unk.f_3, unk.f_4);
		}
	}
...
int func_47(int iParam0) // Position - 0x1615 Hash - 0xEE599357 ^0xEE599357
{
	switch (iParam0)
	{
		case 0:
...
ePedComponentType func_48(int iParam0) // Position - 0x169B Hash - 0xE4C61EBD ^0xE4C61EBD
{
	switch (iParam0)
	{
		case -1:
...
struct<10> func_49(Hash hParam0, int iParam1) // Position - 0x176F Hash - 0x2A30F768 ^0x18171033
{
	int i;
	var unk;
	...
	switch (hParam0)
	{
		case joaat("Player_Zero"):
			...
			{
				case 31:
					func_56(&unk, 0, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 0:
					func_56(&unk, 10, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 1:
					func_56(&unk, 19, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 2:
					func_56(&unk, 14, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 3:
					func_56(&unk, 18, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 4:
					func_56(&unk, 0, 59, 112, 3, 4, 5, 6, 7, 8);
					break;
			
				case 5:
					func_56(&unk, 0, 60, 112, 3, 4, 5, 6, 7, 8);
					break;
			
				case 6:
					func_56(&unk, 15, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 7:
					func_56(&unk, 0, 60, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 8:
					func_56(&unk, 55, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 9:
					func_56(&unk, 0, 1, 112, 3, 4, 5, 6, 7, 8);
					break;
			
				default:
					func_50(&unk, hParam0, iParam1, 10);
					break;
			}
			break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 1:
					func_56(&unk, 0, 82, 158, 3, 4, 5, 6, 7, 8);
					break;
			
				case 2:
					func_56(&unk, 0, 1, 158, 3, 4, 5, 6, 7, 8);
					break;
				...
				case 4:
					func_56(&unk, 41, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 5:
					func_56(&unk, 40, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 6:
					func_56(&unk, 41, 95, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 7:
					func_56(&unk, 0, 95, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 8:
					func_56(&unk, 69, 95, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				default:
					func_50(&unk, hParam0, iParam1, 9);
					break;
			}
			break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				case 0:
					func_56(&unk, 11, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 1:
					func_56(&unk, 17, 90, 2, 3, 4, 5, 6, 7, 8);
					break;
				...
				case 3:
					func_56(&unk, 0, 88, 154, 3, 4, 5, 6, 7, 8);
					break;
			
				case 4:
					func_56(&unk, 0, 1, 154, 3, 4, 5, 6, 7, 8);
					break;
			
				case 5:
					func_56(&unk, 16, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 6:
					func_56(&unk, 36, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 7:
					func_56(&unk, 0, 123, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 8:
					func_56(&unk, 69, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
		...
		case joaat("MP_M_Freemode_01"):
			switch (iParam1)
			{
				...
				case 0:
					func_56(&unk, 129, 167, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 1:
					func_56(&unk, 90, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 2:
					func_56(&unk, 23, 251, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 3:
					func_56(&unk, 36, 262, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 4:
					func_56(&unk, 88, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 5:
					func_56(&unk, 125, 175, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 6:
					func_56(&unk, 35, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 7:
					func_56(&unk, 44, 208, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 8:
					func_56(&unk, 52, 189, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 9:
					func_56(&unk, 0, 261, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 10:
					func_56(&unk, 0, 243, 2, 3, 4, 5, 6, 7, 8);
					break;
				...
				case 12:
					func_56(&unk, 0, 212, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 13:
					func_56(&unk, 64, 291, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 14:
					func_56(&unk, 61, 207, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 15:
					func_56(&unk, 0, 291, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 16:
					func_56(&unk, 0, 208, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 17:
					func_56(&unk, 0, 229, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 18:
					func_56(&unk, 36, 249, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 19:
					func_56(&unk, 0, 259, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 20:
					func_56(&unk, 0, 174, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 21:
					func_56(&unk, 35, 180, 2, 3, 4, 5, 6, 7, 8);
					break;
				...
				default:
					func_50(&unk, hParam0, iParam1, 25);
					break;
			}
			break;
		...
		case joaat("MP_F_Freemode_01"):
			switch (iParam1)
			{
				...
				case 0:
					func_56(&unk, 35, 233, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 1:
					func_56(&unk, 36, 178, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 2:
					func_56(&unk, 53, 221, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 3:
					func_56(&unk, 38, 170, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 4:
					func_56(&unk, 37, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 5:
					func_56(&unk, 113, 203, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 6:
					func_56(&unk, 114, 183, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 7:
					func_56(&unk, 0, 221, 2, 3, 4, 5, 6, 7, 8);
					break;
				...
				case 9:
					func_56(&unk, 0, 199, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 10:
					func_56(&unk, 0, 182, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 11:
					func_56(&unk, 0, 233, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 12:
					func_56(&unk, 107, 167, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 13:
					func_56(&unk, 109, 170, 2, 3, 4, 5, 323, 7, 8);
					break;
			
				case 14:
					func_56(&unk, 119, 237, 2, 3, 4, 5, 6, 7, 8);
					break;
				...
				case 16:
					func_56(&unk, 114, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 17:
					func_56(&unk, 35, 268, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 18:
					func_56(&unk, 0, 266, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 19:
					func_56(&unk, 42, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 20:
					func_56(&unk, 76, 1, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 21:
					func_56(&unk, 39, 235, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 22:
					func_56(&unk, 41, 183, 2, 3, 4, 5, 6, 7, 8);
					break;
			
				case 23:
					func_56(&unk, 111, 194, 2, 3, 4, 5, 6, 7, 8);
					break;
...
void func_50(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x209E Hash - 0xE5FA3D79 ^0xC01023AA
{
	int num;
	Hash itemHash;
	Hash outPropVariant;
			...
			for (i = 0; i < itemHash.f_3; i = i + 1)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(itemHash.f_1, i, &outPropVariant) && outPropVariant.f_2 != -1)
					if (outPropVariant != 0 && outPropVariant != -1 && outPropVariant != joaat("0"))
						uParam0->[outPropVariant.f_2] = func_51(hParam1, outPropVariant, 14, num);
...
int func_51(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x21C8 Hash - 0x37A3B7AE ^0x8CDB7FD1
{
	var outfit;
	int i;
	int num;
	...
	{
		FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, false, -1, func_53(iParam2));
		shopPedQueryComponentIndex = FILES::GET_SHOP_PED_QUERY_COMPONENT_INDEX(hParam1);
	
		if (shopPedQueryComponentIndex != -1)
			return func_52(hParam0, func_53(iParam2)) + shopPedQueryComponentIndex;
	}

	return -99;
}

int func_52(Hash hParam0, int iParam1) // Position - 0x2283 Hash - 0x765E2190 ^0x765E2190
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_53(int iParam0) // Position - 0x262A Hash - 0xF91DA7A7 ^0xF91DA7A7
{
	switch (iParam0)
	{
		case 0:
...
int func_54(Hash hParam0) // Position - 0x26DA Hash - 0xC0824942 ^0x8EB5258
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_55(Hash hParam0) // Position - 0x273B Hash - 0x3694542E ^0xA74289BE
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
void func_56(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x279A Hash - 0xF7320378 ^0xF7320378
{
	uParam0->[0] = iParam1;
	uParam0->[1] = iParam2;
	uParam0->[2] = iParam3;
...
struct<14> func_57(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x27E2 Hash - 0x7D5AC326 ^0xB460D68E
{
	func_125();
...
void func_58(int iParam0, int iParam1) // Position - 0x2834 Hash - 0x2A09B983 ^0x2A09B983
{
	switch (iParam0)
	{
		case 0:
...
void func_59(int iParam0) // Position - 0x2924 Hash - 0xFE2D9DFB ^0xD8B96671
{
	BOOL flag;
	int num;
	var unk;
	...
	switch (iParam0)
	{
		...
		default:
			func_71(num6, iParam0, 155, -1);
			return;
	}

	func_60(&Global_79031[0 /*14*/], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}

void func_60(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x3B59 Hash - 0xA2DFD38C ^0xCA7EA132
{
	int num;
	int num2;
	...
	*iParam0 = iParam9;
	...
	if (bParam10)
	{
		...
		if (iParam1 == 12)
		{
			if (!func_69(Global_2883588, 1, true, true, -1))
				MISC::CLEAR_BIT(&(iParam0->f_6), 2);
		
			if (!func_69(Global_2883588, 2, true, true, -1))
	...
	else if (iParam0->f_5 >= 0 && iParam0->f_5 < 3)
	{
		...
		if (func_68(iParam1, iParam0->f_5, iParam0->f_2, 0, iParam0->f_1, 0, 0))
			MISC::SET_BIT(&(iParam0->f_6), 1);
	
		if (func_68(iParam1, iParam0->f_5, iParam0->f_2, 1, iParam0->f_1, 0, 0))
			MISC::SET_BIT(&(iParam0->f_6), 2);
	
		if (!func_68(iParam1, iParam0->f_5, iParam0->f_2, 2, iParam0->f_1, 0, 0))
			MISC::SET_BIT(&(iParam0->f_6), 4);
	}
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			num = func_63(func_67(iParam1, iParam0->f_2), Global_79028);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 1);
		
			num = func_63(func_62(iParam1, iParam0->f_2), Global_79028);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 2);
		
			if (func_61(iParam1, iParam0->f_2, &num2))
			{
				num = func_63(num2, Global_79028);
...
BOOL func_61(int iParam0, int iParam1, var uParam2) // Position - 0x3EFA Hash - 0x805F0D09 ^0xD5FF8259
{
	*uParam2 = 979;
...
int func_62(int iParam0, int iParam1) // Position - 0x42FF Hash - 0x4CEDF2DA ^0xD4A47B95
{
	switch (iParam1)
	{
		case 0:
...
int func_63(int iParam0, int iParam1) // Position - 0x46FA Hash - 0x744E461C ^0x94D7C845
{
	Hash statHash;
	int outValue;
...
Hash func_64(int iParam0, int iParam1) // Position - 0x4729 Hash - 0x505A9F99 ^0x8B00E935
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_65(iParam1));
}

int func_65(int iParam0) // Position - 0x473E Hash - 0x1A3F3220 ^0x1A3F3220
{
	int num;
	int num2;
...
int func_66() // Position - 0x4772 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1574925;
}

int func_67(int iParam0, int iParam1) // Position - 0x477E Hash - 0x4CEDF2DA ^0x7536052F
{
	switch (iParam1)
	{
		case 0:
...
BOOL func_68(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x4B79 Hash - 0xDF4F0B01 ^0xAAD287D4
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
BOOL func_69(ePedComponentType epctParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x5A1C Hash - 0x8D68F96D ^0x8D68F96D
{
	int num;
	int num2;
	int num3;
	...
	if (func_70(epctParam0, iParam1, &num3, &num2, bParam2, bParam3))
	{
		num4 = func_63(num3, num);
...
BOOL func_70(ePedComponentType epctParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x5A5A Hash - 0x1B8A3878 ^0xAE12BCDE
{
...
void func_71(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x8549 Hash - 0xE3509264 ^0xCA79B364
{
	int num;
	int num2;
	Hash outfit;
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_60(&Global_79031[0 /*14*/], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_60(&Global_79031[0 /*14*/], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_60(&Global_79031[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_79229)
		{
			...
			func_60(&Global_79031[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
		...
		if (componentId2 >= 0)
		{
			num6 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(num2, 10, -1, false, -1, func_53(iParam0));
...
void func_72(int iParam0) // Position - 0x87CF Hash - 0xD09D56A4 ^0x6A3AF790
{
	BOOL flag;
	int num;
	var unk;
...
void func_73(int iParam0) // Position - 0x891C Hash - 0x7D56211F ^0x66522BED
{
	BOOL flag;
	int num;
	var unk;
...
void func_74(int iParam0) // Position - 0x8E29 Hash - 0xB37239BA ^0xF89CE01C
{
	BOOL flag;
	int num;
	var unk;
...
void func_75(int iParam0) // Position - 0x8E9D Hash - 0x8ECA6773 ^0xEB4EB400
{
	BOOL flag;
	int num;
	var unk;
...
void func_76(int iParam0) // Position - 0x8F10 Hash - 0xC290E725 ^0xF579B7F4
{
	BOOL flag;
	int num;
	var unk;
...
void func_77(int iParam0) // Position - 0x8FF7 Hash - 0x889D4C3 ^0x508B81D2
{
	BOOL flag;
	int num;
	var unk;
...
void func_78(int iParam0) // Position - 0x9339 Hash - 0xCFE2AA8 ^0x8435A798
{
	BOOL flag;
	int num;
	var unk;
...
void func_79(int iParam0) // Position - 0x9541 Hash - 0xDDFE7744 ^0x6749E613
{
	BOOL flag;
	int num;
	var unk;
...
void func_80(int iParam0) // Position - 0x9761 Hash - 0xEACDCC23 ^0xA22B306B
{
	BOOL flag;
	int num;
	var unk;
...
void func_81(int iParam0) // Position - 0x986A Hash - 0xEF2456FB ^0x50D2727A
{
	BOOL flag;
	int num;
	var unk;
...
void func_82(int iParam0) // Position - 0xA1FC Hash - 0xD968CB7E ^0x4A568BA
{
	BOOL flag;
	int num;
	var unk;
...
void func_83(int iParam0) // Position - 0xAD54 Hash - 0x2732DFB2 ^0x9C99461
{
	if (iParam0 < 136)
		func_85(iParam0);
	else
...
void func_84(int iParam0) // Position - 0xAD89 Hash - 0x7B542CFB ^0xD5CCAE71
{
	BOOL flag;
	int num;
	var unk;
...
void func_85(int iParam0) // Position - 0xB98D Hash - 0x7B542CFB ^0x83517761
{
	BOOL flag;
	int num;
	var unk;
...
void func_86(int iParam0) // Position - 0xC88E Hash - 0xC2F9B35A ^0xDFE156E8
{
	BOOL flag;
	int num;
	var unk;
...
void func_87(int iParam0) // Position - 0xC9BB Hash - 0x9F76E3C5 ^0xD7DE5268
{
	BOOL flag;
	int num;
	var unk;
...
void func_88(int iParam0, int iParam1) // Position - 0xCAB2 Hash - 0x2A09B983 ^0x2A09B983
{
	switch (iParam0)
	{
		case 0:
...
void func_89(int iParam0) // Position - 0xCBA2 Hash - 0x32C7F3A5 ^0xBE86944D
{
	BOOL flag;
	int num;
	var unk;
...
void func_90(int iParam0) // Position - 0xE06F Hash - 0x1D618A70 ^0x58A7578C
{
	BOOL flag;
	int num;
	var unk;
...
void func_91(int iParam0) // Position - 0xE1B6 Hash - 0x4B9467AD ^0xBB440D3
{
	BOOL flag;
	int num;
	var unk;
...
void func_92(int iParam0) // Position - 0xE6C0 Hash - 0x8C1B03AF ^0xF107D099
{
	BOOL flag;
	int num;
	var unk;
...
void func_93(int iParam0) // Position - 0xED29 Hash - 0x658CB384 ^0xBED9182
{
	BOOL flag;
	int num;
	var unk;
...
void func_94(int iParam0) // Position - 0xED9C Hash - 0xCB73BC76 ^0x4DD3C695
{
	BOOL flag;
	int num;
	var unk;
...
void func_95(int iParam0) // Position - 0xEE6C Hash - 0x75162CFC ^0xB051D2AE
{
	BOOL flag;
	int num;
	var unk;
...
void func_96(int iParam0) // Position - 0xF367 Hash - 0x160B5EE0 ^0x4E4A57F4
{
	BOOL flag;
	int num;
	var unk;
...
void func_97(int iParam0) // Position - 0xF4F8 Hash - 0xDDB76F9C ^0xD59EB6AF
{
	BOOL flag;
	int num;
	var unk;
...
void func_98(int iParam0) // Position - 0xFCE7 Hash - 0x2DF05F5D ^0xC0D6E4B4
{
	BOOL flag;
	int num;
	var unk;
...
void func_99(int iParam0) // Position - 0xFDF0 Hash - 0x74F148EF ^0xADE8BB26
{
	BOOL flag;
	int num;
	var unk;
...
void func_100(int iParam0) // Position - 0x10EFC Hash - 0xBC068BE9 ^0x7246C1D7
{
	BOOL flag;
	int num;
	var unk;
...
void func_101(int iParam0) // Position - 0x11BA9 Hash - 0x905863CF ^0x4D59FCB8
{
	if (iParam0 < 107)
		func_104(iParam0);
	else if (iParam0 < 227)
...
void func_102(int iParam0) // Position - 0x11BEF Hash - 0x6B1EB2DB ^0x69D54C01
{
	BOOL flag;
	int num;
	var unk;
...
void func_103(int iParam0) // Position - 0x12693 Hash - 0x6B1EB2DB ^0x494955AA
{
	BOOL flag;
	int num;
	var unk;
...
void func_104(int iParam0) // Position - 0x13481 Hash - 0x6B1EB2DB ^0xEE917740
{
	BOOL flag;
	int num;
	var unk;
...
void func_105(int iParam0) // Position - 0x140C2 Hash - 0xD1DB443F ^0x606ECD70
{
	BOOL flag;
	int num;
	var unk;
...
void func_106(int iParam0) // Position - 0x1433A Hash - 0x60A21891 ^0x62E708E
{
	BOOL flag;
	int num;
	var unk;
...
void func_107(int iParam0, int iParam1) // Position - 0x14476 Hash - 0x2A09B983 ^0x2A09B983
{
	switch (iParam0)
	{
		case 0:
...
void func_108(int iParam0) // Position - 0x14566 Hash - 0x20784F07 ^0xB28E5CF5
{
	BOOL flag;
	int num;
	var unk;
...
void func_109(int iParam0) // Position - 0x152C4 Hash - 0x7C9B0491 ^0x808E821B
{
	BOOL flag;
	int num;
	var unk;
...
void func_110(int iParam0) // Position - 0x15433 Hash - 0x7AE9DF25 ^0xC431E5CA
{
	BOOL flag;
	int num;
	var unk;
...
void func_111(int iParam0) // Position - 0x159A4 Hash - 0xB7E94CEE ^0x72EA1D65
{
	BOOL flag;
	int num;
	var unk;
...
void func_112(int iParam0) // Position - 0x15ECC Hash - 0x1A91C007 ^0xC99056DD
{
	BOOL flag;
	int num;
	var unk;
...
void func_113(int iParam0) // Position - 0x15F3F Hash - 0xBC3ED9F1 ^0x702C7E63
{
	BOOL flag;
	int num;
	var unk;
...
void func_114(int iParam0) // Position - 0x1600F Hash - 0x858711F7 ^0x3A46391E
{
	BOOL flag;
	int num;
	var unk;
...
void func_115(int iParam0) // Position - 0x164BF Hash - 0x17049DDD ^0x856D1459
{
	BOOL flag;
	int num;
	var unk;
...
void func_116(int iParam0) // Position - 0x1671A Hash - 0x5FAADAD ^0xD207B636
{
	BOOL flag;
	int num;
	var unk;
...
void func_117(int iParam0) // Position - 0x169DA Hash - 0xDFFD79CC ^0xE28B295
{
	BOOL flag;
	int num;
	var unk;
...
void func_118(int iParam0) // Position - 0x16B95 Hash - 0xE4934E8C ^0x7F191DFD
{
	BOOL flag;
	int num;
	var unk;
...
void func_119(int iParam0) // Position - 0x176DB Hash - 0xC75B5564 ^0xB161E3A2
{
	BOOL flag;
	int num;
	var unk;
...
void func_120(int iParam0) // Position - 0x1830D Hash - 0xA5A40372 ^0xCEFC4EDB
{
	if (iParam0 < 60)
		func_122(iParam0);
	else
...
void func_121(int iParam0) // Position - 0x18342 Hash - 0xE98C41DE ^0x876F6F41
{
	BOOL flag;
	int num;
	var unk;
...
void func_122(int iParam0) // Position - 0x190D5 Hash - 0x8425A109 ^0xF77CA465
{
	BOOL flag;
	int num;
	var unk;
...
void func_123(int iParam0) // Position - 0x19757 Hash - 0x646F46FD ^0xD60988D5
{
	BOOL flag;
	int num;
	var unk;
...
void func_124(int iParam0) // Position - 0x1983D Hash - 0xEBF6C28D ^0x8F4CF5E4
{
	BOOL flag;
	int num;
	var unk;
...
void func_125() // Position - 0x19934 Hash - 0xE5F61993 ^0xEFD41040
{
...
int func_126(ePedComponentType epctParam0) // Position - 0x199AC Hash - 0xF91DA7A7 ^0xF91DA7A7
{
	switch (epctParam0)
	{
		case 0:
...
struct<17> func_127(Hash hParam0, int iParam1) // Position - 0x19A5C Hash - 0x10D20E1D ^0x38BDAFC5
{
	int i;
	var unk;
	...
	switch (hParam0)
	{
			...
			switch (iParam1)
			{
				case 0:
					if (Global_114370.f_9088.f_99.f_58[120])
						func_129(&unk, -99, -99, 1, 1, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					else
						func_129(&unk, -99, -99, 0, 0, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 1:
					func_129(&unk, -99, -99, 16, 16, 6, 1, 1, 0, 1, -99, 0, 0, 0);
					break;
			
				case 2:
					func_129(&unk, -99, -99, 36, 21, 6, 1, 5, 0, 0, -99, 0, 0, 8);
					break;
			
				case 3:
					func_129(&unk, -99, -99, 65, 36, 6, 0, 2, 0, 0, -99, 0, 0, 31);
					break;
			
				case 4:
					func_129(&unk, -99, -99, 61, 32, 6, 0, 0, 7, 3, -99, 0, 0, 2);
					break;
			
				case 5:
					func_129(&unk, -99, -99, Global_114370.f_2366.f_539.f_196[0], Global_114370.f_2366.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
			
				case 6:
					func_129(&unk, -99, -99, 92, 72, 7, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 7:
					func_129(&unk, -99, -99, 85, 95, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 8:
					func_129(&unk, -99, -99, 170, 80, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 9:
					func_129(&unk, -99, -99, 171, 89, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 10:
					func_129(&unk, -99, -99, 33, 18, 8, 10, 3, 8, 0, -99, 0, 0, 4);
					break;
			
				case 11:
					func_129(&unk, -99, -99, 33, 18, 17, 10, 4, 8, 0, -99, 0, 0, 5);
					break;
			
				case 12:
					func_129(&unk, -99, -99, 35, 20, 9, 10, 23, 0, 0, -99, 0, 0, 31);
					break;
			
				case 13:
					func_129(&unk, -99, -99, 69, 40, 13, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 14:
					func_129(&unk, -99, -99, 62, 33, 38, 0, 8, 0, 0, -99, 0, 0, 6);
					break;
			
				case 15:
					func_129(&unk, -99, -99, 63, 34, 6, 10, 0, 0, 4, -99, 0, 0, 31);
					break;
			
				case 16:
					func_129(&unk, -99, -99, 174, 93, 18, 0, 18, 0, 0, -99, 0, 0, 31);
					break;
			
				case 17:
					func_129(&unk, -99, -99, 76, 46, 6, 10, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 18:
					func_129(&unk, -99, -99, 35, 20, 9, 10, 0, 4, 0, -99, 0, 0, 7);
					break;
			
				case 19:
					func_129(&unk, -99, -99, 64, 35, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 20:
					func_129(&unk, -99, -99, 66, 37, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 21:
					func_129(&unk, -99, -99, 67, 38, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 22:
					func_129(&unk, -99, -99, 68, 39, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 23:
					func_129(&unk, -99, -99, 177, 94, 19, 9, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 24:
					func_129(&unk, -99, -99, 35, 20, 9, 10, 4, 0, 0, -99, 0, 0, 31);
					break;
			
				case 25:
					func_129(&unk, -99, -99, 97, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 26:
					func_129(&unk, -99, -99, PV_COMP_UPPR, PV_COMP_UPPR, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 27:
					func_129(&unk, -99, -99, 129, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 28:
					func_129(&unk, -99, -99, 170, 80, 6, 0, 13, 0, 0, -99, 0, 0, 31);
					break;
			
				case 29:
					func_129(&unk, -99, -99, PV_COMP_HAIR, PV_COMP_HAIR, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 30:
					func_129(&unk, -99, -99, 161, PV_COMP_UPPR, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 31:
					func_129(&unk, -99, -99, PV_COMP_UPPR, PV_COMP_UPPR, 0, 12, 0, 0, 0, -99, 0, 1, 31);
					break;
			
				case 32:
					func_129(&unk, -99, -99, 85, 55, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 33:
					func_129(&unk, -99, -99, 86, PV_COMP_LOWR, 20, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 34:
					func_129(&unk, -99, -99, 44, 97, 6, 0, 0, 0, 0, -99, 0, 2, 31);
					break;
			
				case 35:
					func_129(&unk, -99, -99, 85, 81, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 36:
					func_129(&unk, -99, -99, PV_COMP_LOWR, PV_COMP_LOWR, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 37:
					func_129(&unk, -99, -99, PV_COMP_HAND, PV_COMP_HAND, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 38:
					func_129(&unk, -99, -99, PV_COMP_FEET, PV_COMP_FEET, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 39:
					func_129(&unk, -99, -99, PV_COMP_TEEF, PV_COMP_TEEF, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 40:
					func_129(&unk, -99, -99, PV_COMP_ACCS, PV_COMP_ACCS, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 41:
					func_129(&unk, -99, -99, PV_COMP_TASK, PV_COMP_TASK, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 42:
					func_129(&unk, -99, -99, PV_COMP_DECL, PV_COMP_DECL, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 43:
					func_129(&unk, -99, -99, PV_COMP_JBIB, PV_COMP_JBIB, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 44:
					func_129(&unk, -99, -99, PV_COMP_MAX, PV_COMP_MAX, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 45:
					func_129(&unk, -99, -99, 13, 13, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 46:
					func_129(&unk, -99, -99, 14, 14, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 47:
					func_129(&unk, -99, -99, 15, 15, 0, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 48:
					func_129(&unk, -99, -99, 91, 71, 14, 13, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 49:
					func_129(&unk, -99, -99, 35, 20, 9, 10, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 50:
					func_129(&unk, -99, -99, 33, 18, 8, 10, 3, 8, 0, -99, 0, 0, 9);
					break;
			
				case 51:
					func_129(&unk, -99, -99, 169, 95, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 52:
					func_129(&unk, -99, -99, 169, 72, 6, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				default:
					func_128(&unk, hParam0, iParam1, 53);
					break;
			}
			break;
		...
		case joaat("Player_One"):
			...
			{
				case 0:
					func_129(&unk, -99, -99, 73, 24, 18, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
			
				case 1:
					func_129(&unk, -99, -99, 22, PV_COMP_DECL, 64, 0, 24, 0, 0, -99, 0, 43, 31);
					break;
			
				case 2:
					func_129(&unk, -99, -99, Global_114370.f_2366.f_539.f_196[1], Global_114370.f_2366.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
			
				case 3:
					func_129(&unk, -99, -99, 23, PV_COMP_JBIB, 13, 5, 2, 4, 0, -99, 0, 0, 1);
					break;
			
				case 4:
					func_129(&unk, -99, -99, 23, PV_COMP_JBIB, 34, 5, 26, 0, 0, -99, 0, 0, 2);
					break;
			
				case 5:
					func_129(&unk, -99, 20, 159, 69, 17, 5, 26, 0, 0, -99, 0, 0, 31);
					break;
			
				case 6:
					func_129(&unk, -99, -99, 40, 13, 14, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 7:
					func_129(&unk, -99, -99, 90, 32, 17, 1, 8, 0, 1, -99, 0, 0, 3);
					break;
			
				case 8:
					func_129(&unk, -99, -99, 17, PV_COMP_HAND, 12, 0, 26, 0, 2, -99, 0, 0, 5);
					break;
			
				case 9:
					func_129(&unk, -99, -99, 16, PV_COMP_LOWR, 12, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
			
				case 10:
					func_129(&unk, -99, -99, 208, 71, 17, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
			
				case 11:
					func_129(&unk, -99, -99, 259, PV_COMP_DECL, 35, 0, 24, 0, 0, -99, 0, 43, 31);
					break;
			
				case 12:
					func_129(&unk, -99, -99, 18, PV_COMP_FEET, 12, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
			
				case 13:
					func_129(&unk, -99, -99, 19, PV_COMP_TEEF, 12, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
			
				case 14:
					func_129(&unk, -99, -99, 20, PV_COMP_ACCS, 12, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
			
				case 15:
					func_129(&unk, -99, -99, 21, PV_COMP_TASK, 12, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
			
				case 16:
					func_129(&unk, -99, -99, 135, 40, 0, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
			
				case 17:
					func_129(&unk, -99, -99, 74, 24, 52, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
			
				case 18:
					func_129(&unk, -99, -99, 176, 53, 26, 5, 26, 0, 0, -99, 0, 41, 31);
					break;
			
				case 19:
					func_129(&unk, -99, -99, 125, 24, 18, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
			
				case 20:
					func_129(&unk, -99, -99, 162, 24, 36, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
			
				case 21:
					func_129(&unk, -99, -99, 75, 24, 36, 0, 26, 0, 0, -99, 0, 0, 4);
					break;
			
				case 22:
					func_129(&unk, -99, -99, 227, 53, 25, 0, 27, 0, 0, -99, 0, 25, 31);
					break;
			
				case 23:
					func_129(&unk, -99, -99, 228, 54, 25, 0, 28, 0, 0, -99, 0, 26, 31);
					break;
			
				case 24:
					func_129(&unk, -99, -99, 229, 55, 25, 0, 29, 0, 0, -99, 0, 27, 31);
					break;
			
				case 25:
					func_129(&unk, -99, -99, 230, 56, 25, 0, 30, 0, 0, -99, 0, 28, 31);
					break;
			
				case 26:
					func_129(&unk, -99, -99, 231, 57, 25, 0, 31, 0, 0, -99, 0, 29, 31);
					break;
			
				case 27:
					func_129(&unk, -99, -99, 232, 58, 25, 0, 32, 0, 0, -99, 0, 30, 31);
					break;
			
				case 28:
					func_129(&unk, -99, -99, 233, 59, 25, 0, 33, 0, 0, -99, 0, 31, 31);
					break;
			
				case 29:
					func_129(&unk, -99, -99, 234, 60, 25, 0, 34, 0, 0, -99, 0, 32, 31);
					break;
			
				case 30:
					func_129(&unk, -99, -99, 235, 61, 25, 0, 35, 0, 0, -99, 0, 33, 31);
					break;
			
				case 31:
					func_129(&unk, -99, -99, 236, 62, 25, 0, 36, 0, 0, -99, 0, 34, 31);
					break;
			
				case 32:
					func_129(&unk, -99, -99, 237, 63, 25, 0, 37, 0, 0, -99, 0, 35, 31);
					break;
			
				case 33:
					func_129(&unk, -99, -99, 238, 64, 25, 0, 38, 0, 0, -99, 0, 36, 31);
					break;
			
				case 34:
					func_129(&unk, -99, -99, 239, 65, 25, 0, 39, 0, 0, -99, 0, 37, 31);
					break;
			
				case 35:
					func_129(&unk, -99, -99, 240, 66, 25, 0, 40, 0, 0, -99, 0, 38, 31);
					break;
			
				case 36:
					func_129(&unk, -99, -99, 241, 67, 25, 0, 41, 0, 0, -99, 0, 39, 31);
					break;
			
				case 37:
					func_129(&unk, -99, -99, 242, 68, 25, 0, 42, 0, 0, -99, 0, 40, 31);
					break;
			
				case 38:
					func_129(&unk, -99, -99, 260, 72, 17, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
			
				case 39:
					func_129(&unk, -99, -99, 125, 24, 0, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
			
				case 40:
					func_129(&unk, -99, -99, 123, 24, 0, 0, 26, 0, 0, -99, 0, 0, 31);
					break;
			
				case 41:
					func_129(&unk, -99, -99, 159, 69, 17, 5, 26, 0, 0, -99, 0, 0, 31);
					break;
			
				case 42:
					func_129(&unk, -99, -99, 89, 22, 15, 6, 26, 0, 0, -99, 0, 0, 31);
					break;
			
				case 43:
					func_129(&unk, -99, -99, 317, 69, 17, 0, 0, 0, 51, -99, 0, 0, 6);
					break;
			
				case 44:
					func_129(&unk, -99, -99, 30, 23, 16, 0, 0, 0, 0, -99, 0, 0, 7);
					break;
			
				case 45:
					func_129(&unk, -99, -99, 106, 70, 17, 5, 26, 0, 0, -99, 0, 0, 8);
					break;
			
				case 46:
					func_129(&unk, -99, -99, 117, 24, 20, 5, 26, 0, 52, -99, 0, 0, 31);
					break;
			
				default:
					func_128(&unk, hParam0, iParam1, 47);
					break;
			}
			break;
		...
		case joaat("Player_Two"):
			...
			{
				case 0:
					func_129(&unk, -99, -99, PV_COMP_HEAD, 91, 28, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 1:
					func_129(&unk, -99, -99, 17, PV_COMP_HAND, 8, 2, 3, 0, 0, -99, 0, 0, 8);
					break;
			
				case 2:
					func_129(&unk, -99, -99, 43, PV_COMP_ACCS, 12, 3, 5, 0, 0, -99, 0, 0, 1);
					break;
			
				case 3:
					func_129(&unk, -99, -99, 50, 14, 8, 0, 15, 6, 3, -99, 0, 0, 2);
					break;
			
				case 4:
					func_129(&unk, -99, -99, Global_114370.f_2366.f_539.f_196[2], Global_114370.f_2366.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 5:
					func_129(&unk, -99, -99, 95, 33, 8, 0, 15, 0, 0, -99, 0, 0, 6);
					break;
			
				case 6:
					func_129(&unk, -99, -99, 49, 13, 10, 4, 6, 0, 0, -99, 0, 0, 3);
					break;
			
				case 7:
					func_129(&unk, -99, -99, 49, 13, 14, 4, 15, 0, 0, -99, 0, 0, 4);
					break;
			
				case 8:
					func_129(&unk, -99, -99, 79, 32, 8, 5, 7, 0, 0, -99, 0, 0, 31);
					break;
			
				case 9:
					func_129(&unk, -99, -99, 53, 17, 11, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 10:
					func_129(&unk, -99, -99, 96, 81, 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 11:
					func_129(&unk, -99, -99, 51, 15, 33, 0, 8, 0, 0, -99, 0, 0, 5);
					break;
			
				case 12:
					func_129(&unk, -99, -99, PV_COMP_HEAD, 93, 29, 0, 13, 0, 0, -99, 0, 0, 31);
					break;
			
				case 13:
					func_129(&unk, -99, -99, 52, 16, 30, 5, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 14:
					func_129(&unk, -99, -99, 241, 92, 16, 0, 12, 0, 0, -99, 0, 0, 31);
					break;
			
				case 15:
					func_129(&unk, -99, -99, 97, 34, 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 16:
					func_129(&unk, -99, -99, 44, PV_COMP_TASK, 12, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 17:
					func_129(&unk, -99, -99, 45, PV_COMP_DECL, 12, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 18:
					func_129(&unk, -99, -99, 46, PV_COMP_JBIB, 12, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 19:
					func_129(&unk, -99, -99, 47, PV_COMP_MAX, 12, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 20:
					func_129(&unk, -99, -99, 161, 53, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 21:
					func_129(&unk, -99, -99, PV_COMP_HEAD, 44, 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 22:
					func_129(&unk, -99, -99, 98, PV_COMP_HEAD, 28, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 23:
					func_129(&unk, -99, -99, 27, PV_COMP_HEAD, 31, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 24:
					func_129(&unk, -99, -99, 190, 71, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 25:
					func_129(&unk, -99, -99, 191, 72, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 26:
					func_129(&unk, -99, -99, 192, 73, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 27:
					func_129(&unk, -99, -99, 193, 74, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 28:
					func_129(&unk, -99, -99, 194, 75, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 29:
					func_129(&unk, -99, -99, 195, 76, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 30:
					func_129(&unk, -99, -99, 196, 77, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 31:
					func_129(&unk, -99, -99, 197, 78, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 32:
					func_129(&unk, -99, -99, 198, 79, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 33:
					func_129(&unk, -99, -99, 199, 80, 8, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 34:
					func_129(&unk, -99, -99, 200, 62, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 35:
					func_129(&unk, -99, -99, 201, 63, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 36:
					func_129(&unk, -99, -99, 202, 64, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 37:
					func_129(&unk, -99, -99, 203, 65, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 38:
					func_129(&unk, -99, -99, 204, 66, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 39:
					func_129(&unk, -99, -99, 205, 67, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 40:
					func_129(&unk, -99, -99, 206, 68, 16, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 41:
					func_129(&unk, -99, -99, PV_COMP_HAIR, 43, 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 42:
					func_129(&unk, -99, -99, 55, PV_COMP_HEAD, 28, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 43:
					func_129(&unk, -99, -99, PV_COMP_HEAD, 52, 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 44:
					func_129(&unk, -99, -99, 70, 30, 32, 6, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 45:
					func_129(&unk, -99, -99, 19, 91, 28, 0, 0, 0, 0, -99, 0, 0, 7);
					break;
			
				case 46:
					func_129(&unk, -99, -99, PV_COMP_HEAD, PV_COMP_HEAD, 28, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 47:
					func_129(&unk, -99, -99, 79, 32, 8, 5, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				default:
					func_128(&unk, hParam0, iParam1, 48);
					break;
			}
			break;
		...
		case joaat("MP_M_Freemode_01"):
			...
			{
				case 0:
					func_129(&unk, -99, -99, PV_COMP_HEAD, PV_COMP_HEAD, 10, -99, 0, -99, -99, 0, 0, 0, 31);
					break;
			
				case 1:
					func_129(&unk, -99, -99, PV_COMP_BERD, 127, 38, -99, 2, 0, 0, 0, 0, 62, 0);
					break;
			
				case 2:
					func_129(&unk, -99, -99, PV_COMP_HEAD, 248, 45, -99, 240, 0, 0, 0, 0, 144, 1);
					break;
			
				case 3:
					func_129(&unk, -99, -99, PV_COMP_LOWR, 31, 25, -99, 240, 0, 0, 0, 0, 231, 2);
					break;
			
				case 4:
					func_129(&unk, -99, -99, PV_COMP_BERD, 66, 10, -99, 21, 0, 0, 0, 0, 123, 3);
					break;
			
				case 5:
					func_129(&unk, -99, -99, PV_COMP_BERD, 93, 141, -99, 3, 0, 0, 0, 0, 114, 4);
					break;
			
				case 6:
					func_129(&unk, -99, -99, PV_COMP_BERD, 116, 113, -99, 7, 0, 0, 0, 0, 113, 5);
					break;
			
				case 7:
					func_129(&unk, -99, -99, PV_COMP_BERD, 61, 136, -99, 27, 0, 0, 0, 0, 61, 6);
					break;
			
				case 8:
					func_129(&unk, -99, -99, PV_COMP_HEAD, 112, 10, -99, 240, 0, 0, 0, 0, 8, 7);
					break;
			
				case 9:
					func_129(&unk, -99, -99, PV_COMP_LOWR, 131, 24, -99, 240, 0, 0, 0, 0, 223, 8);
					break;
			
				case 10:
					func_129(&unk, -99, -99, PV_COMP_BERD, 209, 188, -99, 208, 0, 0, 0, 0, 64, 9);
					break;
			
				case 11:
					func_129(&unk, -99, -99, PV_COMP_BERD, 209, 160, -99, 211, 0, 0, 0, 43, 157, 10);
					break;
			
				case 12:
					func_129(&unk, -99, -99, PV_COMP_BERD, 162, 174, -99, 201, 0, 0, 0, 0, 158, 11);
					break;
			
				case 13:
					func_129(&unk, -99, -99, PV_COMP_BERD, PV_COMP_LOWR, 240, -99, 34, 0, 0, 0, 0, 97, 12);
					break;
			
				case 14:
					func_129(&unk, -99, -99, PV_COMP_BERD, 128, 232, -99, 43, 0, 0, 0, 0, 102, 13);
					break;
			
				case 15:
					func_129(&unk, -99, -99, PV_COMP_BERD, 66, 65, -99, 224, 0, 0, 0, 0, 100, 14);
					break;
			
				case 16:
					func_129(&unk, -99, -99, PV_COMP_BERD, 65, 172, -99, 202, 0, 0, 0, 0, 64, 15);
					break;
			
				case 17:
					func_129(&unk, -99, -99, PV_COMP_BERD, 64, 10, -99, 1, 0, 0, 0, 0, 66, 16);
					break;
			
				case 18:
					func_129(&unk, -99, -99, PV_COMP_HAND, 98, 80, -99, 240, 0, 0, 0, 0, 87, 17);
					break;
			
				case 19:
					func_129(&unk, -99, -99, PV_COMP_HAND, 192, 96, -99, 240, 0, 0, 0, 0, 80, 18);
					break;
			
				case 20:
					func_129(&unk, -99, -99, PV_COMP_BERD, 124, 96, -99, 11, 0, 0, 0, 0, 110, 19);
					break;
			
				case 21:
					func_129(&unk, -99, -99, PV_COMP_HEAD, 80, 114, -99, 240, 0, 0, 0, 0, 2, 20);
					break;
			
				case 22:
					func_129(&unk, -99, -99, PV_COMP_FEET, 43, 112, -99, 82, 0, 0, 0, 0, 48, 21);
					break;
			
				case 23:
					func_129(&unk, -99, -99, PV_COMP_BERD, 116, 144, -99, 2, 0, 0, 0, 0, 108, 22);
					break;
			
				case 24:
					func_129(&unk, -99, -99, PV_COMP_BERD, 63, 38, -99, 3, 0, 0, 0, 0, 63, 23);
					break;
			
				case 25:
					func_129(&unk, -99, -99, PV_COMP_HAIR, 64, 10, -99, 240, 0, 0, 0, 0, 41, 24);
					break;
			
				default:
					func_128(&unk, hParam0, iParam1, 26);
					break;
			}
			break;
		...
		case joaat("MP_F_Freemode_01"):
			...
			{
				case 0:
					func_129(&unk, -99, -99, PV_COMP_HEAD, PV_COMP_HEAD, 0, -99, 0, -99, -99, 0, -99, 0, 31);
					break;
			
				case 1:
					func_129(&unk, -99, -99, PV_COMP_HAND, 136, 241, -99, 47, 0, 0, 0, 0, 21, 31);
					break;
			
				case 2:
					func_129(&unk, -99, -99, PV_COMP_LOWR, PV_COMP_BERD, 96, -99, 32, 0, 0, 0, 7, 215, 0);
					break;
			
				case 3:
					func_129(&unk, -99, -99, PV_COMP_BERD, 73, 241, -99, 3, 0, 0, 0, 0, 25, 1);
					break;
			
				case 4:
					func_129(&unk, -99, -99, PV_COMP_HAIR, 88, 217, -99, 32, 0, 0, 0, 0, 33, 2);
					break;
			
				case 5:
					func_129(&unk, -99, -99, PV_COMP_TASK, PV_COMP_TEEF, 98, -99, 32, 0, 0, 0, 7, 153, 3);
					break;
			
				case 6:
					func_129(&unk, -99, -99, PV_COMP_BERD, 140, 241, -99, 7, 0, 0, 0, 31, 16, 4);
					break;
			
				case 7:
					func_129(&unk, -99, -99, PV_COMP_LOWR, 139, 112, -99, 32, 0, 0, 0, 49, 78, 5);
					break;
			
				case 8:
					func_129(&unk, -99, -99, PV_COMP_BERD, 193, 48, -99, 108, 0, 0, 0, 0, 17, 6);
					break;
			
				case 9:
					func_129(&unk, -99, -99, PV_COMP_HAND, 114, 97, -99, 103, 0, 0, 0, 0, 98, 7);
					break;
			
				case 10:
					func_129(&unk, -99, -99, PV_COMP_TASK, 134, 239, -99, 32, 0, 0, 0, 2, 144, 8);
					break;
			
				case 11:
					func_129(&unk, -99, -99, PV_COMP_HAND, 152, 96, -99, 10, 0, 0, 0, 31, 96, 9);
					break;
			
				case 12:
					func_129(&unk, -99, -99, PV_COMP_FEET, 129, 1, -99, 96, 0, 0, 0, 5, 120, 10);
					break;
			
				case 13:
					func_129(&unk, -99, -99, PV_COMP_HAND, PV_COMP_HEAD, 0, -99, 10, 0, 0, 0, 0, 130, 31);
					break;
			
				case 14:
					func_129(&unk, -99, -99, PV_COMP_LOWR, 159, 96, -99, 32, 0, 0, 0, 22, 214, 11);
					break;
			
				case 15:
					func_129(&unk, -99, -99, PV_COMP_TASK, 232, 213, -99, 32, 0, 0, 0, 22, 147, 12);
					break;
			
				case 16:
					func_129(&unk, -99, -99, PV_COMP_HAIR, PV_COMP_ACCS, 98, -99, 32, 0, 0, 0, 33, 39, 13);
					break;
			
				case 17:
					func_129(&unk, -99, -99, PV_COMP_HAND, 150, 235, -99, 106, 0, 0, 0, 0, 128, 14);
					break;
			
				case 18:
					func_129(&unk, -99, -99, PV_COMP_FEET, 96, 97, -99, 7, 0, 0, 0, 32, 114, 15);
					break;
			
				case 19:
					func_129(&unk, -99, -99, PV_COMP_LOWR, 48, 64, -99, 32, 0, 0, 0, 0, 89, 16);
					break;
			
				case 20:
					func_129(&unk, -99, -99, PV_COMP_LOWR, 62, 64, -99, 32, 0, 0, 0, 0, 78, 17);
					break;
			
				case 21:
					func_129(&unk, -99, -99, PV_COMP_LOWR, 49, 65, -99, 32, 0, 0, 0, 8, 80, 31);
					break;
			
				case 22:
					func_129(&unk, -99, -99, PV_COMP_UPPR, 20, 16, -99, 32, 0, 0, 0, 0, 49, 18);
					break;
			
				case 23:
					func_129(&unk, -99, -99, PV_COMP_HEAD, 73, 178, -99, 32, 0, 0, 0, 38, 11, 19);
					break;
			
				case 24:
					func_129(&unk, -99, -99, PV_COMP_HAND, 135, 53, -99, 9, 0, 0, 0, 29, 27, 20);
					break;
			
				case 25:
					func_129(&unk, -99, -99, PV_COMP_TEEF, 233, 176, -99, 120, 0, 0, 0, 11, 160, 21);
					break;
			
				case 26:
					func_129(&unk, -99, -99, PV_COMP_LOWR, 34, 179, -99, 32, 0, 0, 0, 0, 77, 22);
					break;
			
				case 27:
					func_129(&unk, -99, -99, 15, 131, 93, -99, 32, 0, 0, 0, 0, 250, 23);
					break;
			
				default:
					func_128(&unk, hParam0, iParam1, 28);
					break;
			}
			break;
	}
...
void func_128(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x1B8A4 Hash - 0xD805D094 ^0x25EDFC78
{
	int num;
	Hash outfit;
		...
		for (i = 0; i < outfit.f_4; i = i + 1)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(outfit.f_1, i, &outComponentVariant))
			{
				if (outComponentVariant != 0 && outComponentVariant != -1 && outComponentVariant != joaat("0"))
				{
					...
					{
						uParam0->[func_126(outComponentVariant.f_2)] = outComponentVariant;
						uParam0->f_16 = 1;
					}
					else
					{
						uParam0->[func_126(outComponentVariant.f_2)] = func_51(hParam1, outComponentVariant, func_126(outComponentVariant.f_2), num);
					}
				}
				else if (outComponentVariant.f_1 != -1)
				{
					uParam0->[func_126(outComponentVariant.f_2)] = outComponentVariant.f_1;
				}
			}
		}
...
void func_129(var uParam0, int iParam1, int iParam2, ePedComponentType epctParam3, ePedComponentType epctParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x1BA8E Hash - 0xEC425A3E ^0xEC425A3E
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
...
void func_130(BOOL bParam0) // Position - 0x1BAFF Hash - 0xB6AD8D7C ^0xB6AD8D7C
{
	Global_113456 = Global_113456 || bParam0;
	return;
}

BOOL func_131(BOOL bParam0) // Position - 0x1BB12 Hash - 0x9B2B80BE ^0x9B2B80BE
{
	return Global_113456 && bParam0 != false;
}

void func_132(int iParam0) // Position - 0x1BB23 Hash - 0x3D41FECE ^0xA01CFE9B
{
	if (iLocal_94 < 5)
	{
		if (iParam0 != 263)
...
BOOL func_133() // Position - 0x1BB66 Hash - 0x628AB380 ^0x628AB380
{
	if (func_171(6) || func_171(7))
		return true;
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x1BB86 Hash - 0xAC4E9801 ^0xB379A75F
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x1BBC3 Hash - 0xADCB9755 ^0xADCB9755
{
...
Hash func_136(eCharacter echParam0) // Position - 0x1BBE8 Hash - 0xE4CEEC2C ^0xE4CEEC2C
{
	return Global_2139[echParam0 /*29*/];
}

BOOL func_137(eCharacter echParam0) // Position - 0x1BBF7 Hash - 0x8907F004 ^0x8907F004
{
	return echParam0 < CHAR_MULTIPLAYER;
}

BOOL func_138(int iParam0, BOOL bParam1) // Position - 0x1BC03 Hash - 0xE8E8EFB4 ^0x98461D05
{
	int num;
...
int func_139(int iParam0) // Position - 0x1BCBB Hash - 0x7F0E29AD ^0x84091235
{
	int i;
...
void _CONTEXT_REMOVE_HELP_TEXT(var uParam0) // Position - 0x1BCF6 Hash - 0xFE5630E8 ^0xFE5630E8
{
	int num;
...
void _CONTEXT_ADD_HELP_TEXT(var uParam0, int iParam1, char* sParam2, int iParam3, const char* sParam4, int iParam5, int iParam6) // Position - 0x1BD4D Hash - 0xC67F23A2 ^0xEFF6309F
{
	int i;
...
BOOL func_142(var uParam0) // Position - 0x1BE78 Hash - 0x2DF5A077 ^0x2DF5A077
{
	return true;
}

Vector3 func_143(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6) // Position - 0x1BE81 Hash - 0x4C194BC9 ^0x4C194BC9
{
	return ({ 1f - fParam6, 1f - fParam6, 1f - fParam6 } * uParam0) + ({ fParam6, fParam6, fParam6 } * uParam3);
}

BOOL func_144() // Position - 0x1BE9C Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_76369;
}

BOOL func_145(int iParam0) // Position - 0x1BEA8 Hash - 0xE8921B44 ^0x4F063755
{
	if (iParam0 == 1)
...
BOOL func_146(int iParam0, int iParam1) // Position - 0x1BEFF Hash - 0xA14C4D3F ^0xA6034F77
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_147() // Position - 0x1BF37 Hash - 0x44A439DC ^0x3D5209CD
{
	return MISC::GET_GAME_TIMER() <= Global_23711.f_6481 + 100;
}

BOOL func_148() // Position - 0x1BF4C Hash - 0x3CA1BB47 ^0xB78A1ACB
{
...
BOOL func_149(BOOL bParam0) // Position - 0x1BF66 Hash - 0x1F743529 ^0xDFDFCA73
{
	if (bParam0)
...
BOOL func_150() // Position - 0x1BF8F Hash - 0x9DF93445 ^0x9FBF2B84
{
	if (func_171(6) || func_171(7))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
		{
			switch (func_151(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)))
			{
				case 1:
					return func_170(96);
...
int func_151(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x1C05F Hash - 0x95A15781 ^0xCAB8DFEE
{
	float num;
	float num2;
	int num3;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		num2 = SYSTEM::VDIST2(vParam0, func_152(i));
...
Vector3 func_152(int iParam0) // Position - 0x1C0A3 Hash - 0xFBB743EA ^0xFBB743EA
{
	int num;
	...
	{
		case 1:
			return func_153(96, 0);
	
		case 2:
			return func_153(97, 0);
...
Vector3 func_153(int iParam0, int iParam1) // Position - 0x1C181 Hash - 0xF209984A ^0xE2BBE156
{
	int num;
...
void func_154(var uParam0, int iParam1) // Position - 0x1C1BF Hash - 0xF55E891F ^0xF55E891F
{
	func_155(uParam0, iParam1);
	return;
}

void func_155(var uParam0, int iParam1) // Position - 0x1C1CF Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_156() // Position - 0x1C1E0 Hash - 0xC7110B3 ^0x51D25EBB
{
	int weaponHash;
	BOOL flag;
...
BOOL func_157(int iParam0) // Position - 0x1C2EA Hash - 0x97844555 ^0xADCD6DAA
{
	eCharacter character;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_164() || Global_113417 || Global_32831 || func_163() || func_146(8, -1) || func_162() || func_161() || func_160() || func_148() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_164() || Global_32831 || func_163() || func_146(8, -1) || func_160() || func_162() || func_161() || func_148() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_164() || Global_113417 || Global_32831 || func_163() || func_146(8, -1) || func_160() || func_162() || func_161() || func_148() || Global_114370.f_7691.f_919[character] == 5 || Global_44469 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_164() || Global_113417 || Global_32831 || func_163() || func_146(8, -1) || func_162() || func_161() || func_148() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_164() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_146(8, -1) || func_148() || func_159() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 5:
						if (func_146(8, -1) || func_162() || func_161() || func_159() || func_158())
							return false;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_164() || Global_32831 || func_163() || func_146(8, -1) || func_161() || func_160() || func_148() || Global_114370.f_7691.f_919[character] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_164() || func_161() || Global_113417 || Global_32831 || func_163() || Global_45122 || func_146(8, -1) || func_160() || func_159() || func_148() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 8:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_164() || Global_113417 || Global_32831 || func_163() || func_146(8, -1) || func_160() || func_159() || func_162() || func_161() || func_148())
							return false;
						break;
				}
			}
...
BOOL func_158() // Position - 0x1CA07 Hash - 0x4228A1C2 ^0x952FE30F
{
	return Global_101431.f_1;
}

BOOL func_159() // Position - 0x1CA15 Hash - 0xC20DBA70 ^0xAC4006FB
{
	if (Global_98294 != -1)
...
BOOL func_160() // Position - 0x1CA38 Hash - 0xE663B8F6 ^0xE663B8F6
{
	if (Global_79509)
		return true;
...
BOOL func_161() // Position - 0x1CA62 Hash - 0xD56328D2 ^0xD56328D2
{
	return Global_101444.f_394 > 0;
}

BOOL func_162() // Position - 0x1CA73 Hash - 0xD56328D2 ^0xD56328D2
{
	return Global_101444.f_393 > 0;
}

BOOL func_163() // Position - 0x1CA84 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1575079;
}

BOOL func_164() // Position - 0x1CA90 Hash - 0x7FE517FE ^0x128A3BC8
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x1CAAC Hash - 0x3C5423D7 ^0x3C5423D7
{
	func_166();
	return Global_114370.f_2366.f_539.f_4321;
}

void func_166() // Position - 0x1CAC5 Hash - 0xD1F2D853 ^0xF9F5FD4D
{
	eCharacter character;
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114370.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_137(character) && !func_171(14) || Global_113320)
			{
				if (Global_114370.f_2366.f_539.f_4321 != character && func_137(Global_114370.f_2366.f_539.f_4321))
...
BOOL func_167() // Position - 0x1CBC2 Hash - 0x3CA1BB47 ^0x4BFFF917
{
...
Ped func_168() // Position - 0x1CBDC Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_97204;
}

BOOL func_169(int iParam0) // Position - 0x1CBE8 Hash - 0x6ACD7BFA ^0x6ACD7BFA
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_170(int iParam0) // Position - 0x1CC5A Hash - 0x7524A8DB ^0x409ED99B
{
	int num;
	...
	return HUD::DOES_BLIP_EXIST(Global_33208[num /*23*/].f_19);
}

BOOL func_171(int iParam0) // Position - 0x1CC96 Hash - 0x937D8816 ^0x937D8816
{
	return Global_43922 == iParam0;
}

void func_172(var uParam0, int iParam1) // Position - 0x1CCA4 Hash - 0xF23F5A1A ^0xF23F5A1A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_173() // Position - 0x1CCB5 Hash - 0xAD09DE9 ^0x8867985A
{
	struct<4> args;
	...
	if (bLocal_127 && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("tennis_ambient")) == 0)
	{
		if (iLocal_126 == 1)
		{
			randomIntInRange = MISC::GET_RANDOM_INT_IN_RANGE(1, 4);
			unk4 = 3;
			unk4[0] = MISC::GET_RANDOM_INT_IN_RANGE(2, 8);
		
			for (i = 1; i < randomIntInRange && i < 3; i = i + 1)
			{
				unk4[i] = func_174(&unk4, 3, 2, 7);
			}
		
			for (i = 0; i < randomIntInRange && i < 3; i = i + 1)
			{
				if (unk4[i] > 0)
				{
					args = unk4[i];
					SYSTEM::START_NEW_SCRIPT_WITH_ARGS("tennis_ambient", &args, 4, MULTIPLAYER_MISSION);
				}
			}
		}
	}
...
int func_174(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1CD5B Hash - 0xB3367AD8 ^0xEDF3E127
{
	BOOL flag;
	int i;
	int j;
...
BOOL func_175() // Position - 0x1CDCE Hash - 0x8BE26712 ^0x880D72F5
{
	if (bLocal_127)
		if (iLocal_126 == 1)
...
void func_176() // Position - 0x1CDED Hash - 0xE45592D8 ^0x5F0798CF
{
	if (bLocal_127)
		if (iLocal_126 == 1)
...
void func_177(int iParam0) // Position - 0x1CE08 Hash - 0x28DF00E8 ^0x28DF00E8
{
	iLocal_94 = iParam0;
	return;
}

void func_178(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1CE14 Hash - 0x3DFD90D4 ^0xB85FE721
{
	int num;
	BOOL flag;
...
BOOL func_179() // Position - 0x1CF14 Hash - 0x29CB2928 ^0xE369A18D
{
...
BOOL func_180() // Position - 0x1CF31 Hash - 0x98CCC132 ^0x97B0D6ED
{
	if (Global_98294 != -1)
...
BOOL func_181(int iParam0, int iParam1) // Position - 0x1CF54 Hash - 0xDEE74A4E ^0xDEE74A4E
{
	BOOL flag;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0x1CF9E Hash - 0xECB6C71B ^0xECB6C71B
{
	return func_183(iParam0, Global_43922);
}

BOOL func_183(int iParam0, int iParam1) // Position - 0x1CFAF Hash - 0x1FD727E0 ^0x1FD727E0
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_184(int iParam0, int iParam1) // Position - 0x1D190 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

void func_185() // Position - 0x1D19F Hash - 0x1A58BBDC ^0x6DC61FF7
{
	eCharacter character;
	int clockHours;

	iLocal_98 = 13;
	TEXT_LABEL_ASSIGN_STRING(&uLocal_52, "tennis", 64);
	essLocal_96 = 60500;
	func_172(&iLocal_93, 1);
	sLocal_100 = "PLAY_TENNIS" /*Press ~INPUT_CONTEXT~ to play Tennis.*/;

	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
		iLocal_126 = func_151(uLocal_89);

	iLocal_104 = func_188(uLocal_89);
	bLocal_127 = true;
	character = _GET_PLAYER_CHARACTER_FROM_PED(PLAYER::PLAYER_PED_ID());

	if (character == CHAR_FRANKLIN)
	{
		func_172(&iLocal_93, 8388608);
		return;
	}

	if (func_133() && !func_150())
	{
		func_172(&iLocal_93, 8388608);
		return;
	}
	...
	switch (iLocal_126)
	{
		case 2:
			...
			bLocal_127 = true;
			uLocal_116 = { -765.014f, 154.244f, 67.25f };
			uLocal_119 = { -782.014f, 154.244f, 67.25f };
			fLocal_122 = 28f;
			fLocal_123 = 2f;
			break;
		...
		case 1:
			...
			uLocal_116 = { -1164.9576f, -1667.2617f, 4.28f };
			uLocal_119 = { -1200.9193f, -1615.8724f, 4.28f };
			fLocal_122 = 65.5f;
			fLocal_123 = 5f;
			break;
		...
		case 3:
			...
			uLocal_116 = { 491.2348f, -206.72147f, 52.788494f };
			uLocal_119 = { 469.6835f, -266.50696f, 53.786392f };
			fLocal_122 = 14f;
			fLocal_123 = 5f;
			break;
		...
		case 4:
			...
			uLocal_116 = { -1218.9388f, 321.685f, 79.02952f };
			uLocal_119 = { -1228.746f, 355.2947f, 79.985886f };
			fLocal_122 = 20f;
			fLocal_123 = 2f;
			break;
		...
		case 5:
			...
			uLocal_116 = { -1250.0034f, 367.62833f, 79.94628f };
			uLocal_119 = { -1216.3693f, 377.55026f, 80.10213f };
			fLocal_122 = 20f;
			fLocal_123 = 2f;
			break;
		...
		case 6:
			...
			uLocal_116 = { -1610.8618f, 249.70062f, 60.116802f };
			uLocal_119 = { -1626.5161f, 282.9467f, 59.83001f };
			fLocal_122 = 32f;
			fLocal_123 = 5f;
			break;
		...
		case 7:
			...
			uLocal_116 = { -942.1958f, -1251.2074f, 7.1391f };
			uLocal_119 = { -930.3892f, -1271.5867f, 8.0366f };
			fLocal_122 = 12f;
			fLocal_123 = 5f;
			break;
		...
		case 8:
			...
			uLocal_116 = { -1373.602f, -83.734f, 50f };
			uLocal_119 = { -1369.198f, -120.774f, 50f };
			fLocal_122 = 20.84f;
			fLocal_123 = 5f;
			fLocal_124 = 19.6f;
			break;
		...
		case 9:
			...
			uLocal_116 = { -2860.7622f, 13.3794f, 10.6083f };
			uLocal_119 = { -2924.066f, 31.5452f, 10.6083f };
			fLocal_122 = 28f;
			fLocal_123 = 5f;
			break;
	}
...
BOOL func_186() // Position - 0x1D5D9 Hash - 0x6B922756 ^0x6B922756
{
	if (func_42(20))
		return true;
...
BOOL func_187(eCharacter echParam0) // Position - 0x1D5EF Hash - 0xD066DC61 ^0xD066DC61
{
	if (func_137(echParam0))
...
int func_188(var uParam0, var uParam1, var uParam2) // Position - 0x1D63D Hash - 0x3E0E3502 ^0x3E0E3502
{
	return func_189(func_151(uParam0));
}

int func_189(int iParam0) // Position - 0x1D651 Hash - 0x42AB806F ^0x42AB806F
{
	int num;
...
void func_190(int iParam0, int iParam1) // Position - 0x1D6C9 Hash - 0xF55E891F ^0xF55E891F
{
	func_191(iParam0, iParam1);
	return;
}

void func_191(var uParam0, int iParam1) // Position - 0x1D6D9 Hash - 0x9815F445 ^0x9815F445
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_192(BOOL bParam0) // Position - 0x1D6EE Hash - 0x12400ACB ^0x3A862E90
{
	if (bParam0)
		if (iLocal_104 != 263)
			func_178(iLocal_104, 0, false);

	_CONTEXT_REMOVE_HELP_TEXT(&iLocal_95);

	if (func_184(iLocal_93, 2))
	{
		func_6();
		func_190(&iLocal_93, 2);
		func_8(&iLocal_97);
...
void func_193() // Position - 0x1D737 Hash - 0xC88B3A8B ^0xCE5EF390
{
	func_190(&iLocal_93, 4);
	func_194();

	if (SCRIPT::IS_THREAD_ACTIVE(iLocal_51))
		PLAYER::FORCE_CLEANUP_FOR_THREAD_WITH_THIS_ID(iLocal_51, 3);

	if (!MISC::IS_STRING_NULL(&uLocal_68))
		if (HUD::GET_LENGTH_OF_LITERAL_STRING(&uLocal_68) != 0)
			SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED(&uLocal_68);

	return;
}

void func_194() // Position - 0x1D774 Hash - 0x9F8B860F ^0x71E396DC
{
	func_4(128);
