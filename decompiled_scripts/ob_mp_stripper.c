...
void main() // Position - 0x0 Hash - 0x5D84F89F ^0x5D84F89F
{
	...
	iLocal_304 = 49;
	iLocal_305 = 64;
	hLocal_318 = joaat("S_F_Y_Stripper_01");
	hLocal_319 = joaat("S_F_Y_Stripper_02");
	sLocal_322 = "mini@strip_club@lap_dance_2g@ld_2g_intro";
	sLocal_323 = "ld_2g_intro_m";
	sLocal_324 = "ld_2g_intro_s1";
	sLocal_325 = "ld_2g_intro_s2";
	sLocal_326 = "ld_2g_intro_s1_face";
	sLocal_327 = "ld_2g_intro_s2_face";
	sLocal_328 = "mini@strip_club@lap_dance_2g@ld_2g_p1";
	sLocal_329 = "ld_2g_p1_m";
	sLocal_330 = "ld_2g_p1_s1";
	sLocal_331 = "ld_2g_p1_s2";
	sLocal_332 = "ld_2g_p1_s1_face";
	sLocal_333 = "ld_2g_p1_s2_face";
	sLocal_334 = "mini@strip_club@lap_dance_2g@ld_2g_p2";
	sLocal_335 = "ld_2g_p2_m";
	sLocal_336 = "ld_2g_p2_s1";
	sLocal_337 = "ld_2g_p2_s2";
	sLocal_338 = "ld_2g_p2_s1_face";
	sLocal_339 = "ld_2g_p2_s2_face";
	sLocal_340 = "mini@strip_club@lap_dance_2g@ld_2g_p3";
	sLocal_341 = "ld_2g_p3_m";
	sLocal_342 = "ld_2g_p3_s1";
	sLocal_343 = "ld_2g_p3_s2";
	sLocal_344 = "ld_2g_p3_s1_face";
	sLocal_345 = "ld_2g_p3_s2_face";
	sLocal_346 = "mini@strip_club@lap_dance_2g@ld_2g_exit";
	sLocal_347 = "ld_2g_exit_m";
	sLocal_348 = "ld_2g_exit_s1";
	sLocal_349 = "ld_2g_exit_s2";
	sLocal_350 = "ld_2g_exit_s1_face";
	sLocal_351 = "ld_2g_exit_s2_face";
	sLocal_352 = "mini@strip_club@lap_dance_2g@ld_2g_wait";
	sLocal_353 = "ld_2g_wait_m";
	sLocal_354 = "ld_2g_wait_s1";
	sLocal_355 = "ld_2g_wait_s2";
	sLocal_356 = "ld_2g_wait_s1_face";
	sLocal_357 = "ld_2g_wait_s2_face";
	sLocal_358 = "mini@strip_club@lap_dance_2g@ld_2g_accept";
	sLocal_359 = "ld_2g_accept_m";
	sLocal_360 = "ld_2g_accept_s1";
	sLocal_361 = "ld_2g_accept_s2";
	sLocal_362 = "ld_2g_accept_s1_face";
	sLocal_363 = "ld_2g_accept_s2_face";
	sLocal_364 = "mini@strip_club@lap_dance_2g@ld_2g_decline";
	sLocal_365 = "ld_2g_decline_m";
	sLocal_366 = "ld_2g_decline_s1";
	sLocal_367 = "ld_2g_decline_s2";
	sLocal_368 = "ld_2g_decline_s1_face";
	sLocal_369 = "ld_2g_decline_s2_face";

	if (func_94(9) || func_93() && !func_92())
		func_91();
	...
	if (ENTITY::DOES_ENTITY_EXIST(eScriptParam_0))
	{
		...
		epctLocal_314 = Global_1845263[PLAYER::PLAYER_ID() /*877*/].f_267.f_34;
		func_73(&Global_1569796, epctLocal_314);
		uLocal_376 = { Global_1569796.f_146.f_82[5 /*102*/] };
		fLocal_379 = Global_1569796.f_146.f_82[5 /*102*/].f_3;
	
		if (fLocal_379 < 0f)
			fLocal_379 = fLocal_379 + 360f;
	
		uLocal_386 = { Global_1569796.f_146.f_82[5 /*102*/].f_16 };
		fLocal_389 = Global_1569796.f_146.f_82[5 /*102*/].f_19.f_2;
		uLocal_380 = { Global_1569796.f_146.f_82[5 /*102*/].f_7 };
		uLocal_383 = { Global_1569796.f_146.f_82[5 /*102*/].f_10 };
	}
	...
	while (true)
	{
		...
		{
			if (MISC::GET_DISTANCE_BETWEEN_COORDS(uLocal_376, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), true) < 3f)
			{
				switch (iLocal_309)
				{
					case 0:
					...
					case 1:
						if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !_SHOULD_NETWORK_SCRIPT_TERMINATE())
							func_1();
						else
							func_91();
						break;
			...
			else if (MISC::GET_DISTANCE_BETWEEN_COORDS(uLocal_376, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), true) > 3f + 2f)
			{
				func_91();
			}
		}
...
void func_1() // Position - 0x384 Hash - 0xF45CA287 ^0xD78DF0AB
{
	var unk;
	...
	{
		case 0:
			if (func_58(uLocal_376, unk) && !func_57() && ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()) > fLocal_379 - 45f && ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()) < fLocal_379 + 45f)
			{
				if (Global_1835489 == 13)
					Global_1835489 = -1;
			
				if (!_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("SA_STRIP_CALL" /*Press ~INPUT_CONTEXT~ to call stripper.~n~*/))
					func_55("SA_STRIP_CALL" /*Press ~INPUT_CONTEXT~ to call stripper.~n~*/);
		...
		case 1:
			if (func_54(true, false, true))
			{
				if (func_58(uLocal_376, unk) && !func_57() && ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()) > fLocal_379 - 45f && ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()) < fLocal_379 + 45f)
				{
					if (!PLAYER::IS_PLAYER_FREE_AIMING(PLAYER::PLAYER_ID()) && !PLAYER::IS_PLAYER_TARGETTING_ANYTHING(PLAYER::PLAYER_ID()) && PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_CONTEXT))
					{
						func_53();
						Global_1835489 = 13;
						func_45();
						...
						MISC::CLEAR_AREA_OF_PROJECTILES(uLocal_376, 2.5f, 0);
						_SET_PLAYER_CONTROL_EX(PLAYER::PLAYER_ID(), false, SPC_LEAVE_CAMERA_CONTROL_ON, false);
						bLocal_34 = true;
						WEAPON::SET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("WEAPON_UNARMED"), true);
						func_25(true, true, true, false, false, false, false);
						TASK::TASK_PED_SLIDE_TO_COORD(PLAYER::PLAYER_PED_ID(), uLocal_376, fLocal_379, 1061158912);
						iLocal_310 = 2;
					}
				}
				else
		...
		case 2:
			...
			if (TASK::GET_SCRIPT_TASK_STATUS(PLAYER::PLAYER_PED_ID(), SCRIPT_TASK_PED_SLIDE_TO_COORD) == 7)
			{
				func_17(104, true, -1, true);
				iLocal_315 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(uLocal_380, uLocal_383, 2, false, false, 1065353216, 0, 1065353216);
				NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_315, sLocal_322, sLocal_323, 4f, -2f, 1, 0, 1148846080, 0);
			
				if (!func_16(iLocal_320))
				{
					NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(NETWORK::NET_TO_PED(iLocal_320), iLocal_315, sLocal_322, sLocal_324, 4f, -2f, 1, 0, 1148846080, 0);
					PED::PLAY_FACIAL_ANIM(NETWORK::NET_TO_PED(iLocal_320), sLocal_326, sLocal_322);
				}
			
				if (!func_16(iLocal_321))
				{
					NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(NETWORK::NET_TO_PED(iLocal_321), iLocal_315, sLocal_322, sLocal_325, 4f, -2f, 1, 0, 1148846080, 0);
					PED::PLAY_FACIAL_ANIM(NETWORK::NET_TO_PED(iLocal_321), sLocal_327, sLocal_322);
				}
			
				NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_315);
				iLocal_310 = 3;
			}
			break;
		...
		case 3:
			...
			HUD::HIDE_HUD_AND_RADAR_THIS_FRAME();
			func_21(true);
			iLocal_316 = NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(iLocal_315);
		
			if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_316) > 0.99f)
			{
				sLocal_370 = sLocal_328;
				sLocal_371 = sLocal_329;
		...
		case 4:
			...
			func_21(true);
			iLocal_315 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(uLocal_380, uLocal_383, 2, false, false, 1065353216, 0, 1065353216);
			NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_315, sLocal_370, sLocal_371, 4f, -2f, 1, 0, 1148846080, 0);
		
			if (!func_16(iLocal_320))
			{
				NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(NETWORK::NET_TO_PED(iLocal_320), iLocal_315, sLocal_370, sLocal_372, 4f, -2f, 1, 0, 1148846080, 0);
				PED::PLAY_FACIAL_ANIM(NETWORK::NET_TO_PED(iLocal_320), sLocal_374, sLocal_370);
			}
		
			if (!func_16(iLocal_321))
			{
				NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(NETWORK::NET_TO_PED(iLocal_321), iLocal_315, sLocal_370, sLocal_373, 4f, -2f, 1, 0, 1148846080, 0);
				PED::PLAY_FACIAL_ANIM(NETWORK::NET_TO_PED(iLocal_321), sLocal_375, sLocal_370);
			}
		
			NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_315);
		
			if (!_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("SA_STRIP_CAM" /*Press ~INPUT_CONTEXT~ to change view.~n~*/))
				func_55("SA_STRIP_CAM" /*Press ~INPUT_CONTEXT~ to change view.~n~*/);
		...
		case 5:
			...
			{
				iLocal_315 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(uLocal_380, uLocal_383, 2, false, false, 1065353216, 0, 1065353216);
				NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_315, sLocal_346, sLocal_347, 4f, -2f, 1, 0, 1148846080, 0);
			
				if (!func_16(iLocal_320))
				{
					NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(NETWORK::NET_TO_PED(iLocal_320), iLocal_315, sLocal_346, sLocal_348, 4f, -2f, 1, 0, 1148846080, 0);
					PED::PLAY_FACIAL_ANIM(NETWORK::NET_TO_PED(iLocal_320), sLocal_350, sLocal_346);
				}
			
				if (!func_16(iLocal_321))
				{
					NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(NETWORK::NET_TO_PED(iLocal_321), iLocal_315, sLocal_346, sLocal_349, 4f, -2f, 1, 0, 1148846080, 0);
					PED::PLAY_FACIAL_ANIM(NETWORK::NET_TO_PED(iLocal_321), sLocal_351, sLocal_346);
				}
		...
		case 6:
			...
			{
				iLocal_315 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(uLocal_380, uLocal_383, 2, false, true, 1065353216, 0, 1065353216);
				NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_315, sLocal_352, sLocal_353, 4f, -2f, 1, 0, 1148846080, 0);
			
				if (!func_16(iLocal_320))
				{
					NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(NETWORK::NET_TO_PED(iLocal_320), iLocal_315, sLocal_352, sLocal_354, 4f, -2f, 1, 0, 1148846080, 0);
					PED::PLAY_FACIAL_ANIM(NETWORK::NET_TO_PED(iLocal_320), sLocal_356, sLocal_352);
				}
			
				if (!func_16(iLocal_321))
				{
					NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(NETWORK::NET_TO_PED(iLocal_321), iLocal_315, sLocal_352, sLocal_355, 4f, -2f, 1, 0, 1148846080, 0);
					PED::PLAY_FACIAL_ANIM(NETWORK::NET_TO_PED(iLocal_321), sLocal_357, sLocal_352);
				}
			
				NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_315);
				iLocal_317 = iLocal_317 + 1;
			
				if (!_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("SA_STRIP_MENU" /*Press ~INPUT_SCRIPT_RRIGHT~ for another dance.~n~Press ~INPUT_SCRIPT_RUP~ to quit.~n~*/))
					func_55("SA_STRIP_MENU" /*Press ~INPUT_SCRIPT_RRIGHT~ for another dance.~n~Press ~INPUT_SCRIPT_RUP~ to quit.~n~*/);
		...
		case 7:
			...
			{
				if (PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_SCRIPT_RDOWN))
				{
					if (_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("SA_STRIP_MENU" /*Press ~INPUT_SCRIPT_RRIGHT~ for another dance.~n~Press ~INPUT_SCRIPT_RUP~ to quit.~n~*/))
						HUD::CLEAR_HELP(true);
		...
		case 8:
			...
			func_21(true);
			iLocal_315 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(uLocal_380, uLocal_383, 2, false, false, 1065353216, 0, 1065353216);
			NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_315, sLocal_358, sLocal_359, 4f, -2f, 1, 0, 1148846080, 0);
		
			if (!func_16(iLocal_320))
			{
				NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(NETWORK::NET_TO_PED(iLocal_320), iLocal_315, sLocal_358, sLocal_360, 4f, -2f, 1, 0, 1148846080, 0);
				PED::PLAY_FACIAL_ANIM(NETWORK::NET_TO_PED(iLocal_320), sLocal_362, sLocal_358);
			}
		
			if (!func_16(iLocal_321))
			{
				NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(NETWORK::NET_TO_PED(iLocal_321), iLocal_315, sLocal_358, sLocal_361, 4f, -2f, 1, 0, 1148846080, 0);
				PED::PLAY_FACIAL_ANIM(NETWORK::NET_TO_PED(iLocal_321), sLocal_363, sLocal_358);
			}
		...
		case 9:
			...
			if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_316) > 0.99f)
			{
				...
				switch (iLocal_317)
				{
					...
					case 1:
						sLocal_370 = sLocal_334;
						sLocal_371 = sLocal_335;
					...
					case 2:
						sLocal_370 = sLocal_340;
						sLocal_371 = sLocal_341;
		...
		case 10:
			...
			Global_1835490 = 3;
			iLocal_315 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(uLocal_380, uLocal_383, 2, false, false, 1065353216, 0, 1065353216);
			NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_315, sLocal_364, sLocal_365, 4f, -2f, 1, 0, 1148846080, 0);
		
			if (!func_16(iLocal_320))
			{
				NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(NETWORK::NET_TO_PED(iLocal_320), iLocal_315, sLocal_364, sLocal_366, 4f, -2f, 1, 0, 1148846080, 0);
				PED::PLAY_FACIAL_ANIM(NETWORK::NET_TO_PED(iLocal_320), sLocal_368, sLocal_364);
			}
		
			if (!func_16(iLocal_321))
			{
				NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(NETWORK::NET_TO_PED(iLocal_321), iLocal_315, sLocal_364, sLocal_367, 4f, -2f, 1, 0, 1148846080, 0);
				PED::PLAY_FACIAL_ANIM(NETWORK::NET_TO_PED(iLocal_321), sLocal_369, sLocal_364);
			}
		...
		case 11:
			...
			{
				if (!func_16(iLocal_320))
					if (NETWORK::NETWORK_HAS_CONTROL_OF_NETWORK_ID(iLocal_320))
						func_11(&iLocal_320);
			
				if (!func_16(iLocal_321))
					if (NETWORK::NETWORK_HAS_CONTROL_OF_NETWORK_ID(iLocal_321))
						func_11(&iLocal_321);
...
void func_2() // Position - 0xCE5 Hash - 0x4A7084F7 ^0xE5A7862D
{
	...
	if (type > PV_COMP_INVALID && type != _INVALID_PLAYER_INDEX())
	{
		for (i = 0; i < 31; i = i + 1)
		{
			if (Global_1845263[PLAYER::PLAYER_ID() /*877*/].f_267.f_34 == Global_1845263[type /*877*/].f_267[i])
			{
				if (func_9(i) != -1)
				{
...
void func_3(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0xD78 Hash - 0x62DF5F31 ^0xFDE25E75
{
	int num;
...
int func_4(ePedComponentType epctParam0) // Position - 0xDBE Hash - 0x8B0BD82A ^0xC12B7C0B
{
	int address;
...
BOOL func_5(ePedComponentType epctParam0) // Position - 0xDD9 Hash - 0x6A46C9B4 ^0x6A46C9B4
{
	Player player;
...
BOOL _NETWORK_IS_PLAYER_VALID(ePedComponentType player, BOOL bIsPlaying, BOOL bUnk) // Position - 0xDFB Hash - 0x3FF6E4CA ^0xE6B59972
{
	ePedComponentType type;
...
void func_7(int iParam0) // Position - 0xE5B Hash - 0x7B213083 ^0x717B9081
{
	int num;
	...
	{
		case 0:
			Global_2359296[func_8() /*5569*/].f_7.f_18 = Global_2359296[func_8() /*5569*/].f_7.f_18 + 1;
			break;
	
		case 1:
			Global_2359296[func_8() /*5569*/].f_7.f_21 = Global_2359296[func_8() /*5569*/].f_7.f_21 + 1;
			break;
	
		case 2:
			Global_2359296[func_8() /*5569*/].f_7.f_24 = Global_2359296[func_8() /*5569*/].f_7.f_24 + 1;
			break;
	
		case 3:
			Global_2359296[func_8() /*5569*/].f_7.f_27 = Global_2359296[func_8() /*5569*/].f_7.f_27 + 1;
			break;
	
		case 4:
			Global_2359296[func_8() /*5569*/].f_7.f_30 = Global_2359296[func_8() /*5569*/].f_7.f_30 + 1;
			break;
	
		case 99:
			Global_2359296[func_8() /*5569*/].f_7.f_33 = Global_2359296[func_8() /*5569*/].f_7.f_33 + 1;
			break;
	}
	...
	if (num != -1)
		Global_2359296[func_8() /*5569*/].f_7.f_82[num] = Global_2359296[func_8() /*5569*/].f_7.f_82[num] + 1;

	return;
}

int func_8() // Position - 0xF96 Hash - 0xF9396AAC ^0xF9396AAC
{
	int num;
...
int func_9(int iParam0) // Position - 0xFA3 Hash - 0x8AB92A53 ^0x8AB92A53
{
	if (iParam0 == 23)
		return 18;
	else if (iParam0 == 24)
...
Player _INVALID_PLAYER_INDEX() // Position - 0x1004 Hash - 0x478900E4 ^0x478900E4
{
	return -1;
}

void func_11(var uParam0) // Position - 0x100D Hash - 0x5384310F ^0xCC2BCD1A
{
	Entity entity;
...
void func_12() // Position - 0x1031 Hash - 0x1C1CFFDB ^0x87F160DE
{
...
BOOL func_13(Player plParam0) // Position - 0x104F Hash - 0xBA52AC63 ^0x583EC77A
{
	return IS_BIT_SET(Global_1668317.f_241.f_136[func_15(9) /*33*/][plParam0], func_14(9));
}

int func_14(int iParam0) // Position - 0x1072 Hash - 0x9042BAD4 ^0x9042BAD4
{
	return iParam0 % 32;
}

int func_15(int iParam0) // Position - 0x107F Hash - 0x195EBE32 ^0x195EBE32
{
	return iParam0 / 32;
}

BOOL func_16(int iParam0) // Position - 0x108C Hash - 0xAA94F01C ^0x71695F76
{
...
void func_17(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x10AB Hash - 0xC00D48A9 ^0x169717F7
{
	Hash statName;
...
Hash func_18(int iParam0, int iParam1) // Position - 0x10CE Hash - 0x1D62A43E ^0x33D7B335
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_19(iParam1));
}

int func_19(int iParam0) // Position - 0x10E3 Hash - 0x1A3F3220 ^0x1A3F3220
{
	int num;
	int num2;
...
int func_20() // Position - 0x1117 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1574925;
}

void func_21(BOOL bParam0) // Position - 0x1123 Hash - 0x77BBBED5 ^0x77BBBED5
{
	if (bParam0)
		func_23();
...
void func_22(int iParam0, int iParam1) // Position - 0x1174 Hash - 0xD7EC669C ^0xC01D15BF
{
...
void func_23() // Position - 0x11AA Hash - 0x6BEE258E ^0x6BEE258E
{
	Global_2738587.f_4636 = 0;
	return;
}

void func_24() // Position - 0x11BA Hash - 0x9A142650 ^0xE9E53C81
{
	Global_23572.f_6 = 1;
	return;
}

void func_25(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x11C8 Hash - 0x787E640E ^0x67C15509
{
	if (bParam0)
	{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_29(PLAYER::PLAYER_ID()) && !func_27(PLAYER::PLAYER_ID(), 0) && !func_26() && !bParam4 && !bParam5 && !NETWORK::NETWORK_IS_IN_SPECTATOR_MODE())
...
BOOL func_26() // Position - 0x1315 Hash - 0xAA7793E3 ^0x3F62CDC8
{
	return IS_BIT_SET(Global_1845263[PLAYER::PLAYER_ID() /*877*/].f_36.f_18, 14);
}

BOOL func_27(Player plParam0, int iParam1) // Position - 0x132F Hash - 0x1A32E11A ^0x6AADE226
{
	BOOL flag;
...
eCharacter func_28(int iParam0, BOOL bParam1) // Position - 0x1388 Hash - 0x1DCD393E ^0x1DCD393E
{
...
BOOL func_29(Player plParam0) // Position - 0x13C9 Hash - 0x68897CDD ^0x62820466
{
...
BOOL func_30() // Position - 0x1408 Hash - 0xA525B2F4 ^0xA525B2F4
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_31(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1416 Hash - 0x3167F4C7 ^0xCE6B9B6A
{
	int num;
...
BOOL func_32() // Position - 0x1449 Hash - 0xD140D54A ^0xE638D98F
{
...
void func_33(int iParam0) // Position - 0x1470 Hash - 0x1B2EEE72 ^0xEDBC1F9D
{
	if (iParam0 == 1)
...
void _SET_PLAYER_CONTROL_EX(Player plParam0, BOOL bParam1, eSetPlayerControlFlags espcfParam2, BOOL bParam3) // Position - 0x1493 Hash - 0xCD788E2C ^0x50180146
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(plParam0) && PLAYER::IS_PLAYER_PLAYING(plParam0) || bParam3 == true)
		{
			...
			if (!flag18)
			{
				...
				else if (flag14 || !func_27(PLAYER::PLAYER_ID(), 0) && !func_30() && !func_29(PLAYER::PLAYER_ID()))
			...
			if (bParam1)
			{
				...
				if (!func_38(playerPed) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(playerPed))
					if (!flag20)
			...
			else
			{
				if (!func_38(playerPed) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(playerPed))
				{
					...
					if (func_35(*Global_4718592.f_183007))
...
BOOL func_35(int iParam0) // Position - 0x1945 Hash - 0xFB453256 ^0xFB453256
{
	return iParam0 == 17;
}

void func_36() // Position - 0x1952 Hash - 0xBC63612E ^0xBC63612E
{
	var unk;
...
void func_37() // Position - 0x199F Hash - 0x5FEB45C4 ^0x33557962
{
...
BOOL func_38(Ped pedParam0) // Position - 0x19DD Hash - 0x93DB01D2 ^0x43DCC591
{
...
void func_39(BOOL bParam0, Ped pedParam1, int iParam2) // Position - 0x1A0E Hash - 0x19FE7AFC ^0x4538006F
{
	int num;
	eViewModeContext i;
...
void _MPPLY_STAT_SET_BOOL(Hash hParam0, BOOL bParam1) // Position - 0x1ADE Hash - 0x269D56BD ^0xB104E3E4
{
	Hash statName;
...
void func_41() // Position - 0x1AFA Hash - 0xEFF6029E ^0x224AB476
{
	eViewModeContext i;
...
BOOL func_42() // Position - 0x1B52 Hash - 0xDBD936D3 ^0xDBD936D3
{
	if (func_43() == 0)
		return true;
...
int func_43() // Position - 0x1B67 Hash - 0x4228A1C2 ^0x58D4D226
{
	return Global_1574632.f_18;
}

BOOL func_44() // Position - 0x1B75 Hash - 0xEBB0E6F7 ^0x19BAFBE9
{
...
void func_45() // Position - 0x1BA6 Hash - 0xA051CB78 ^0x90D5DEB3
{
	if (!NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(iLocal_320))
	{
		if (func_47(2, false, true))
		{
			if (NETWORK::CAN_REGISTER_MISSION_PEDS(2))
			{
				if (func_46(&iLocal_320, PED_TYPE_CIVFEMALE, hLocal_318, uLocal_386, fLocal_389, true, true, true) && func_46(&iLocal_321, PED_TYPE_CIVFEMALE, hLocal_319, uLocal_386, fLocal_389, true, true, true))
				{
					STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(hLocal_318);
					STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(hLocal_319);
					bLocal_312 = false;
				}
			}
		}
...
int func_46(var uParam0, ePedType eptParam1, Hash hParam2, Vector3 vParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9) // Position - 0x1C11 Hash - 0x942889BA ^0xED9BAD01
{
	Ped ped;
...
BOOL func_47(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1C70 Hash - 0xB4895AFB ^0xB4895AFB
{
	return func_48(0, iParam0, true, bParam1, bParam2);
}

BOOL func_48(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1C84 Hash - 0x888E99B4 ^0x888E99B4
{
	int num;
	int num2;
	...
	if (bParam2 && !bParam3 && iParam1 <= func_52(iParam0) - func_51(iParam0, false))
	{
		return 1;
	}
	else
	{
		...
		{
			if (bParam2)
				num = iParam1 - func_51(iParam0, false);
			else
				num = iParam1;
		
			num2 = func_52(iParam0) - func_50(iParam0);
		}
		else
		{
			if (bParam2)
...
int func_49(int iParam0) // Position - 0x1D4A Hash - 0xF61C8BEE ^0xF61C8BEE
{
	switch (iParam0)
	{
		case 0:
...
int func_50(int iParam0) // Position - 0x1D84 Hash - 0xC46ACF50 ^0x2D89675B
{
	switch (iParam0)
	{
		case 0:
...
int func_51(int iParam0, BOOL bParam1) // Position - 0x1DCA Hash - 0x8148B892 ^0x7DFB917D
{
	Player player;
...
int func_52(int iParam0) // Position - 0x1E67 Hash - 0x3D4448A4 ^0x3D4448A4
{
	switch (iParam0)
	{
		case 0:
...
void func_53() // Position - 0x1EA7 Hash - 0x330842EE ^0x47B8B9A0
{
	if (MISC::IS_PC_VERSION())
	{
		if (iLocal_390 == 0)
...
BOOL func_54(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1ECA Hash - 0xF0D380FF ^0x29DD7336
{
...
void func_55(char* sParam0) // Position - 0x1FAF Hash - 0x99A98712 ^0xE46BE9F0
{
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0x1FC5 Hash - 0xCD6A3595 ^0xB0E86AA0
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(message);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

BOOL func_57() // Position - 0x1FD8 Hash - 0x7FE517FE ^0x128A3BC8
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
BOOL func_58(Vector3 vParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x1FF4 Hash - 0xAC277417 ^0x4522E486
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && !FIRE::IS_ENTITY_ON_FIRE(PLAYER::PLAYER_PED_ID()) && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
		{
			...
			{
				if (CAM::IS_GAMEPLAY_CAM_RENDERING() && !CUTSCENE::IS_CUTSCENE_PLAYING() && !CAM::IS_CINEMATIC_CAM_RENDERING() && !func_62(0) && !func_61())
				{
					if (Global_98300 && Global_98301 || func_60())
						return false;
				
					if (func_59(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), vParam0, fParam3, false))
						return true;
				}
			}
		}
...
BOOL func_59(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x20A7 Hash - 0x1FB736D4 ^0x234AEAB7
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
BOOL func_60() // Position - 0x2122 Hash - 0x1CB029D8 ^0x1CB029D8
{
	if (Global_43922 == 15)
		return false;
...
BOOL func_61() // Position - 0x2137 Hash - 0xF5E9376F ^0xD1FAE5F8
{
	int pedNearbyPeds;
	int i;
	var sizeAndPeds;
...
BOOL func_62(int iParam0) // Position - 0x21FB Hash - 0xE8921B44 ^0x4F063755
{
	if (iParam0 == 1)
...
BOOL _SHOULD_NETWORK_SCRIPT_TERMINATE() // Position - 0x2252 Hash - 0x52E21E9B ^0xD0F85E96
{
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x22D6 Hash - 0x90B5165C ^0xB8DD5DC8
{
	switch (func_66())
	{
		case 0:
...
Hash func_65() // Position - 0x2309 Hash - 0x61402777 ^0xB9FAC976
{
...
int func_66() // Position - 0x232D Hash - 0x21D64237 ^0x21D64237
{
	return Global_32828;
}

BOOL func_67() // Position - 0x2338 Hash - 0x974E48B4 ^0x974E48B4
{
	return Global_2684312.f_698;
}

BOOL _DOES_EVENT_OF_TYPE_EXIST(int iParam0) // Position - 0x2347 Hash - 0xA28ADBB4 ^0x6EB81E64
{
...
BOOL func_69() // Position - 0x235E Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_2695951;
}

BOOL func_70() // Position - 0x236A Hash - 0x974E48B4 ^0x974E48B4
{
	return Global_2684312.f_693;
}

int func_71() // Position - 0x2379 Hash - 0x69C24223 ^0x15CBADC7
{
	STREAMING::REQUEST_MODEL(hLocal_318);
	STREAMING::REQUEST_MODEL(hLocal_319);

	if (STREAMING::HAS_MODEL_LOADED(hLocal_318) && STREAMING::HAS_MODEL_LOADED(hLocal_319))
	{
		bLocal_312 = true;
		return 1;
	}
...
int func_72() // Position - 0x23AE Hash - 0xE17AFE7F ^0xD38E1972
{
	STREAMING::REQUEST_ANIM_DICT(sLocal_322);
	STREAMING::REQUEST_ANIM_DICT(sLocal_328);
	STREAMING::REQUEST_ANIM_DICT(sLocal_334);
	STREAMING::REQUEST_ANIM_DICT(sLocal_340);
	STREAMING::REQUEST_ANIM_DICT(sLocal_346);
	STREAMING::REQUEST_ANIM_DICT(sLocal_352);
	STREAMING::REQUEST_ANIM_DICT(sLocal_358);
	STREAMING::REQUEST_ANIM_DICT(sLocal_364);

	if (!STREAMING::HAS_ANIM_DICT_LOADED(sLocal_322) || !STREAMING::HAS_ANIM_DICT_LOADED(sLocal_328) || !STREAMING::HAS_ANIM_DICT_LOADED(sLocal_334) || !STREAMING::HAS_ANIM_DICT_LOADED(sLocal_340) || !STREAMING::HAS_ANIM_DICT_LOADED(sLocal_346) || !STREAMING::HAS_ANIM_DICT_LOADED(sLocal_352) || !STREAMING::HAS_ANIM_DICT_LOADED(sLocal_358) || !STREAMING::HAS_ANIM_DICT_LOADED(sLocal_364))
		return 0;
	else if (!bLocal_311)
		bLocal_311 = true;
...
void func_73(var uParam0, ePedComponentType epctParam1) // Position - 0x246E Hash - 0xC4015B80 ^0xF4489635
{
	var unk;
	int num;
...
void func_74(ePedComponentType epctParam0, var uParam1, var uParam2, int iParam3) // Position - 0x4C55 Hash - 0x3F59E3D3 ^0x16923DFB
{
	var unk;
...
void func_75(int iParam0, int iParam1, var uParam2, BOOL bParam3) // Position - 0x50F0 Hash - 0xA1F236AB ^0x4D5AF257
{
	var unk;
	Vector3 vector;
	...
	*uParam2 = { func_77(iParam1, 86) };
	vector = { *uParam2 - unk[0 /*6*/] };
	vector = { func_76(vector, -unk[0 /*6*/].f_3.f_2) };
	vector = { func_76(vector, unk[1 /*6*/].f_3.f_2) };
...
Vector3 func_76(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x5A6D Hash - 0x8959C4D1 ^0x8922A2E2
{
	float num;
	float num2;
	float num3;
...
struct<6> func_77(int iParam0, int iParam1) // Position - 0x5AB1 Hash - 0x2496BBBB ^0x92F2F3E
{
	var unk;
	BOOL flag;
	BOOL flag2;
...
BOOL func_78(int iParam0, var uParam1) // Position - 0x5AF3 Hash - 0x7164B50D ^0x2880C8F7
{
	switch (iParam0)
	{
		case -1:
...
struct<6> func_79(int iParam0) // Position - 0x5C19 Hash - 0xC73C1158 ^0x2A6D4A6F
{
	var unk;
...
void func_80(var uParam0, ePedComponentType epctParam1) // Position - 0x630F Hash - 0xBCDD19C ^0xBCDD19C
{
	var unk;
...
BOOL func_81(ePedComponentType epctParam0) // Position - 0x6A0B Hash - 0xE48228D0 ^0xE48228D0
{
	switch (epctParam0)
	{
		case 87:
...
BOOL func_82(ePedComponentType epctParam0, int iParam1) // Position - 0x6A3A Hash - 0x32D9FCC4 ^0x32D9FCC4
{
	if (iParam1 == -1)
	{
		switch (epctParam0)
...
// Unhandled jump detected. Output should be considered invalid
int func_83(ePedComponentType epctParam0, int iParam1) // Position - 0x6B17 Hash - 0x779DF6B0 ^0x779DF6B0
{
	if (iParam1 == -1)
	{
		switch (epctParam0)
...
int func_84(ePedComponentType epctParam0) // Position - 0x6BD3 Hash - 0xE48228D0 ^0xE48228D0
{
	switch (epctParam0)
	{
		case 83:
...
void func_85(ePedComponentType epctParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x6BFC Hash - 0x91B5CD4A ^0x91B5CD4A
{
	var unk;
	Vector3 vector;
...
struct<6> func_86(ePedComponentType epctParam0, BOOL bParam1) // Position - 0x80B1 Hash - 0x293B24C9 ^0x49F602D8
{
	var unk;
...
int func_87(ePedComponentType epctParam0) // Position - 0x8C67 Hash - 0x85860E9C ^0x85860E9C
{
	switch (epctParam0)
	{
		case PV_COMP_BERD:
...
int _NETWORK_ENSURE_SCRIPT_IS_NETWORKED(int iParam0, int iParam1, BOOL bNoTerminate) // Position - 0x8EA4 Hash - 0x75751681 ^0x9140C9A0
{
	int i;
...
BOOL func_89(BOOL bParam0) // Position - 0x8FBA Hash - 0x1CCCE169 ^0x1CCCE169
{
	bParam0;
	return Global_1575052;
}

void func_90() // Position - 0x8FCB Hash - 0xCE5FB49E ^0x214A59D5
{
	SCRIPT::TERMINATE_THIS_THREAD();
	return;
}

void func_91() // Position - 0x8FD7 Hash - 0x8AE07706 ^0x3EAD5170
{
	if (_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("SA_SHWR_OUT" /*Press ~INPUT_SCRIPT_RUP~ to stop showering.~n~*/) || _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("SA_SHWR_IN" /*Press ~INPUT_CONTEXT~ to take a shower.~n~*/))
		HUD::CLEAR_HELP(true);
	...
	if (bLocal_311)
	{
		...
		STREAMING::REMOVE_ANIM_DICT(sLocal_328);
		STREAMING::REMOVE_ANIM_DICT(sLocal_334);
		STREAMING::REMOVE_ANIM_DICT(sLocal_340);
		STREAMING::REMOVE_ANIM_DICT(sLocal_346);
		STREAMING::REMOVE_ANIM_DICT(sLocal_352);
		STREAMING::REMOVE_ANIM_DICT(sLocal_358);
		STREAMING::REMOVE_ANIM_DICT(sLocal_364);
	}

	if (CAM::DOES_CAM_EXIST(caLocal_313))
		CAM::DESTROY_CAM(caLocal_313, false);
...
BOOL func_92() // Position - 0x9079 Hash - 0x29CB2928 ^0xE369A18D
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_93() // Position - 0x9096 Hash - 0x98CCC132 ^0x97B0D6ED
{
	if (Global_98294 != -1)
...
BOOL func_94(int iParam0) // Position - 0x90B9 Hash - 0x3BAB94E9 ^0x3BAB94E9
{
	if (Global_43922 == 15)
		return false;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0x90DB Hash - 0xECB6C71B ^0xECB6C71B
{
	return func_96(iParam0, Global_43922);
}

BOOL func_96(int iParam0, int iParam1) // Position - 0x90EC Hash - 0x1FD727E0 ^0x1FD727E0
{
	if (iParam1 == 15)
		return 1;
