...
void main() // Position - 0x0 Hash - 0x5D84F89F ^0x5D84F89F
{
	...
	switch (iScriptParam_0)
	{
		case 1:
			...
			{
				case 75:
					if (iScriptParam_0.f_2 == 5)
					{
						func_83(1, 0, 1);
						func_82();
					}
					else if (iScriptParam_0.f_2 == 76)
					{
						func_82();
					}
					else
				...
				case 76:
					func_33(iScriptParam_0.f_3, 0);
					break;
			
				case 52:
					if (iScriptParam_0.f_2 == 52)
						HUD::SET_SAVEGAME_LIST_UNIQUE_ID(iScriptParam_0.f_3);
					break;
			
				case 154:
					if (iScriptParam_0.f_2 == 154)
						HUD::SET_SAVEGAME_LIST_UNIQUE_ID(iScriptParam_0.f_3);
					break;
				...
				default:
					...
					if (iScriptParam_0.f_1 == 26 || iScriptParam_0.f_1 == 25 || iScriptParam_0.f_1 == 153)
					{
						func_30(false, 1);
						func_29(2, false);
						func_82();
					...
					{
						if (iScriptParam_0.f_2 == 75 || iScriptParam_0.f_2 == 133)
						{
						}
						else
						{
		...
		case 2:
			switch (iScriptParam_0.f_1)
			{
				...
				case 76:
					if (Global_79515 != -1)
					{
						func_1(Global_79515, Global_79498);
						func_28(-1);
						...
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
							if (VEHICLE::IS_VEHICLE_DRIVEABLE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), false))
								Global_79500 = { ENTITY::GET_ENTITY_VELOCITY(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)) };
...
void func_1(eCharacter echParam0, int iParam1) // Position - 0x320 Hash - 0xE14B34D3 ^0xA77BDFA7
{
	Global_79495 = echParam0;
	Global_79495.f_1 = iParam1;

	if (iParam1 == 7)
		if (echParam0 >= CHAR_MICHAEL && echParam0 < CHAR_MRS_THORNHILL)
			Global_113457[echParam0 /*10*/].f_3 = 1;

	MISC::SET_BIT(&Global_79497, 0);
	return;
}

void func_2(int iParam0, int iParam1) // Position - 0x361 Hash - 0x5CE52334 ^0x5CE52334
{
	if (func_8() == -1)
	{
		if (func_5(iParam0))
...
void func_3(BOOL bParam0) // Position - 0x395 Hash - 0x95150F14 ^0x95150F14
{
	func_29(1, bParam0);
	func_29(2, bParam0);
	return;
...
BOOL func_4(int iParam0) // Position - 0x3AB Hash - 0x65C46DC6 ^0x54782F0D
{
...
BOOL func_5(int iParam0) // Position - 0x3D0 Hash - 0xF8D2E76B ^0xF8D2E76B
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_6() // Position - 0x403 Hash - 0x47CAA55F ^0x47CAA55F
{
	if (Global_114370.f_18577.f_380 > 0)
		return 1;

	return 0;
}

BOOL func_7() // Position - 0x41E Hash - 0x5F650835 ^0x3265B087
{
	if (Global_2883694)
	{
	...
	else if (Global_114370.f_10019.f_21 > 0)
	{
		return 1;
	}
...
int func_8() // Position - 0x476 Hash - 0x51B3FB45 ^0x8D02FA9F
{
	if (func_27())
	{
		if (func_26(14))
...
BOOL func_9() // Position - 0x5D8 Hash - 0x3CA1BB47 ^0xB78A1ACB
{
...
BOOL func_10() // Position - 0x5F2 Hash - 0xE6837A46 ^0xE6837A46
{
	int i;
...
BOOL func_11(int iParam0) // Position - 0x622 Hash - 0x541882A7 ^0x541882A7
{
	return func_12(iParam0, 20, true);
}

BOOL func_12(int iParam0, int iParam1, BOOL bParam2) // Position - 0x633 Hash - 0xA45BEB30 ^0x6033D2A2
{
	if (iParam0 == -1)
		return false;
...
int func_13(int iParam0, int iParam1) // Position - 0x693 Hash - 0x744E461C ^0x94D7C845
{
	Hash statHash;
	int outValue;
...
Hash func_14(int iParam0, int iParam1) // Position - 0x6C2 Hash - 0x505A9F99 ^0x8B00E935
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_15(iParam1));
}

int func_15(int iParam0) // Position - 0x6D7 Hash - 0x1A3F3220 ^0x1A3F3220
{
	int num;
	int num2;
...
int func_16() // Position - 0x70B Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1574925;
}

int func_17(int iParam0) // Position - 0x717 Hash - 0x28E83966 ^0x9E37924F
{
	switch (iParam0)
	{
		case 0:
...
int func_18() // Position - 0xABF Hash - 0x21D64237 ^0x21D64237
{
	return Global_32828;
}

BOOL func_19() // Position - 0xACA Hash - 0xD56328D2 ^0xD56328D2
{
	return Global_101444.f_393 > 0;
}

BOOL func_20() // Position - 0xADB Hash - 0xD56328D2 ^0xD56328D2
{
	return Global_101444.f_394 > 0;
}

BOOL func_21() // Position - 0xAEC Hash - 0xB8714F4F ^0xB8714F4F
{
	return IS_BIT_SET(Global_79497, 9);
}

BOOL func_22() // Position - 0xAFB Hash - 0x4C17DBA0 ^0x4C17DBA0
{
	return IS_BIT_SET(Global_79497, 8);
}

BOOL func_23() // Position - 0xB0A Hash - 0xE69FEBE1 ^0x5D872482
{
...
BOOL func_24(int iParam0, int iParam1) // Position - 0xC7F Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0xC8E Hash - 0x15889021 ^0xE7262364
{
...
BOOL func_26(int iParam0) // Position - 0xCB6 Hash - 0x937D8816 ^0x937D8816
{
	return Global_43922 == iParam0;
}

BOOL func_27() // Position - 0xCC4 Hash - 0x1CB029D8 ^0x1CB029D8
{
	if (Global_43922 == 15)
		return false;
...
void func_28(int iParam0) // Position - 0xCD9 Hash - 0xE49C42EC ^0xE49C42EC
{
	Global_79515 = iParam0;
	return;
}

void func_29(int iParam0, BOOL bParam1) // Position - 0xCE7 Hash - 0xD7D6DF48 ^0xC6E60A2
{
	if (bParam1 == true)
		func_30(false, 1);
...
void func_30(BOOL bParam0, int iParam1) // Position - 0xD16 Hash - 0x6C084EF7 ^0x879D6199
{
	char* str;
	char* str2;
	int value;
	...
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(3 - value);
	func_31(str);
	func_31(str2);
...
void func_31(char* sParam0) // Position - 0xE97 Hash - 0x8E2F5FE2 ^0x29D9D432
{
...
void func_32(int iParam0) // Position - 0xEA9 Hash - 0xAC7AAE54 ^0xFDDAF2C8
{
	if (iParam0 == 1)
...
void func_33(int iParam0, int iParam1) // Position - 0xED1 Hash - 0xC86B77F ^0xC86B77F
{
	if (func_8() == -1)
	{
		if (func_5(Global_79498))
		{
			func_28(iParam0);
			func_47(iParam0);
			...
			if (Global_79499 > 16)
			{
				...
				func_34(func_35(iParam0), Global_79499);
			}
		}
	}
...
void func_34(int iParam0, int iParam1) // Position - 0xF1F Hash - 0x5CD9BE9D ^0xB7071DCF
{
...
int func_35(int iParam0) // Position - 0xF4A Hash - 0x8D13EF68 ^0x8D13EF68
{
	int i;
...
void func_36() // Position - 0xF78 Hash - 0xF1339A17 ^0xF1339A17
{
	switch (Global_79498)
	{
		case 1:
			Global_79499 = func_37(&uLocal_28, 1, 0, 1);
			break;
	
		case 7:
			Global_79499 = func_37(&uLocal_28, 0, 1, 1);
			break;
...
int func_37(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xFB8 Hash - 0xF73D8560 ^0xF73D8560
{
	int num;
	...
	if (iParam1 == 1)
	{
		if (iParam2 == 1)
		{
			func_38(uParam0, &num, 1, iParam3, 0);
			func_38(uParam0, &num, 7, iParam3, 0);
		}
		else
		{
			func_38(uParam0, &num, 1, iParam3, 1);
		}
	}
	else if (iParam2 == 1)
	{
		func_38(uParam0, &num, 7, iParam3, 1);
	}

	return num;
}

void func_38(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4) // Position - 0x1010 Hash - 0x174CAF97 ^0x174CAF97
{
	int num;
	int i;
	int num2;
	...
	if (iParam4 == 0)
	{
		for (i = 0; i < num; i = i + 1)
		{
			if (func_43(i, iParam2))
			{
				num2 = func_42(i, iParam2);
				...
				{
					if (iParam3 == 0 || func_40(i, iParam2) == true)
					{
						uParam0->[num2 /*2*/] = i;
						uParam0->[num2 /*2*/].f_1 = iParam2;
					}
				
					if (func_40(i, iParam2) == true)
						*uParam1 = *uParam1 + 1;
				}
			}
		}
	...
	else
	{
		...
		{
			num4 = func_39(num3, iParam3, iParam2);
		
			if (num4 != -1)
			{
				num3 = func_42(num4, iParam2) + 1;
				uParam0->[j /*2*/] = num4;
				uParam0->[j /*2*/].f_1 = iParam2;
			
				if (func_40(num4, iParam2))
					*uParam1 = *uParam1 + 1;
			}
			else
			{
...
int func_39(int iParam0, int iParam1, int iParam2) // Position - 0x10FE Hash - 0x1AFC76D3 ^0x1AFC76D3
{
	int i;
	int num;
	int num2;
	...
	num = -1;
	num2 = -1;
	num4 = func_46(iParam2);

	for (i = 0; i < num4; i = i + 1)
	{
		if (func_43(i, iParam2) == true)
		{
			if (iParam1 == 0 || func_40(i, iParam2) == true)
			{
				num3 = func_42(i, iParam2);
...
BOOL func_40(int iParam0, int iParam1) // Position - 0x117A Hash - 0xAC8757AF ^0x27E68E2B
{
	switch (iParam1)
	{
		case 1:
...
BOOL func_41(int iParam0) // Position - 0x11B8 Hash - 0xC999F6B2 ^0xC999F6B2
{
	switch (iParam0)
	{
		case 0:
...
int func_42(int iParam0, int iParam1) // Position - 0x14FE Hash - 0xFC16A83C ^0x19341493
{
	switch (iParam1)
	{
		case 1:
			return Global_114370.f_9088.f_330[iParam0 /*6*/].f_3;
	
		case 7:
			return Global_114370.f_18577[iParam0 /*6*/].f_3;
...
BOOL func_43(int iParam0, int iParam1) // Position - 0x1546 Hash - 0x9F56C2F2 ^0x9F56C2F2
{
	switch (iParam1)
	{
		case 1:
...
BOOL func_44() // Position - 0x159F Hash - 0x63C8E514 ^0x63C8E514
{
	if (Global_114370.f_9088.f_330[24 /*6*/] == true || Global_114370.f_9088.f_330[25 /*6*/] == true || Global_114370.f_9088.f_330[26 /*6*/] == true || Global_114370.f_9088.f_330[27 /*6*/] == true)
		return 1;

	return 0;
}

BOOL func_45(int iParam0) // Position - 0x1601 Hash - 0xC2488648 ^0xC2488648
{
	int num;

	num = iParam0;

	if (num == 24 || num == 25 || num == 26 || num == 27)
		return true;

	return false;
}

int func_46(int iParam0) // Position - 0x163B Hash - 0x3BB0694C ^0x3BB0694C
{
	switch (iParam0)
	{
		case 1:
...
void func_47(int iParam0) // Position - 0x166A Hash - 0xF8744AE ^0xA03DA521
{
	int i;
	int num;
	int num2;
	...
	uLocal_26 = { func_79(iParam0, Global_79498) };
	...
	for (i = 0; i < func_76(iParam0, Global_79498); i = i + 1)
	{
		num5 = func_74(iParam0, Global_79498, i);
		flag = true;
		...
		if (!Global_64263[num5 /*13*/].f_7 && flag)
		{
	...
	func_53(iParam0, &num2);
	func_49(num4, num3, false, num, num2);
	func_48(2);
	return;
}

void func_48(int iParam0) // Position - 0x17AE Hash - 0x9A867C6D ^0xD5CEA9A9
{
...
float func_49(int iParam0, int iParam1, BOOL bParam2, int iParam3, int iParam4) // Position - 0x17CB Hash - 0xCFE37593 ^0xCFE37593
{
	float value;
	int num;

	value = func_52(iParam0, iParam1, false);
	num = func_51(value);
	...
	else
	{
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD_ON_FRONTEND("SET_DESCRIPTION");
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(2);
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(func_50(num));
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(value);
...
int func_50(int iParam0) // Position - 0x189D Hash - 0xE158C251 ^0xE158C251
{
	int num;
...
int func_51(float fParam0) // Position - 0x18D9 Hash - 0x9F5139BD ^0x9F5139BD
{
	if (fParam0 == 0f)
		return 0;
...
float func_52(int iParam0, int iParam1, BOOL bParam2) // Position - 0x190E Hash - 0xB606A20F ^0xE2337BDE
{
	float num;
	float value;
...
void func_53(int iParam0, var uParam1) // Position - 0x196D Hash - 0x86D7525E ^0x86D7525E
{
	int num;
	...
	if (Global_79498 == 7)
	{
		...
		{
			case 52:
				*uParam1 = Global_114370.f_2355[0 /*2*/];
			...
			case 53:
				*uParam1 = Global_114370.f_2355[1 /*2*/];
			...
			case 54:
				*uParam1 = Global_114370.f_2355[2 /*2*/];
			...
			case 55:
				*uParam1 = Global_114370.f_2355[3 /*2*/];
			...
			case 56:
				*uParam1 = Global_114370.f_2355[4 /*2*/];
...
BOOL func_54(int iParam0, int iParam1, int iParam2) // Position - 0x1A2D Hash - 0x28F05F4B ^0x1E072287
{
	int num;
	int num2;
	int num3;
	...
	if (Global_64263[iParam0 /*13*/].f_7)
		return true;

	num = { Global_64263[iParam0 /*13*/] };
	...
	if (num3 == -1)
	{
		func_62(num3, iParam1, 0, str, iParam0, iParam2);
		num2 = 0;
	}
	else
	{
		...
		{
			case 1:
				func_61(num3, iParam1, num2, "MTTIME", iParam0, iParam2);
				break;
		
			case 2:
				func_61(num3, iParam1, num2, str, iParam0, iParam2);
				break;
		
			case 3:
				func_60(iParam1, num2, str, iParam0, iParam2);
				break;
			...
			case 5:
				func_59(num3, num.f_2, iParam1, num2, str, iParam0, iParam2);
				break;
			...
			case 9:
				func_59(num3, 100, iParam1, num2, str, iParam0, iParam2);
				break;
			...
			case 14:
			case 15:
				func_57(num3, iParam1, num2, str, iParam0, iParam2);
				break;
			...
			case 12:
			case 13:
				func_55(num3, iParam1, num2, str, iParam0, iParam2);
				break;
...
void func_55(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x1C93 Hash - 0xBBCDC2A1 ^0x31F27922
{
	if (iParam5 != 0)
	{
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x1D03 Hash - 0xA17D549C ^0x9F8053F4
{
	switch (iParam0)
	{
		case 0:
...
void func_57(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x2EDE Hash - 0x8D5F774 ^0x8A19087C
{
	if (iParam5 != 0)
	{
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam5, "SET_DATA_SLOT");
...
void func_58(int iParam0, int iParam1, int iParam2, int iParam3, char* sParam4, int iParam5, int iParam6) // Position - 0x2F4E Hash - 0x9F14AA70 ^0x261AB642
{
	int value;
...
void func_59(int iParam0, int iParam1, int iParam2, int iParam3, char* sParam4, int iParam5, int iParam6) // Position - 0x2FD3 Hash - 0x5C01F316 ^0xA6F08800
{
	float value;
...
void func_60(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4) // Position - 0x305C Hash - 0xD008E474 ^0x5EB598A
{
	if (iParam4 != 0)
	{
...
void func_61(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x30C1 Hash - 0xD57ECD74 ^0x15C64044
{
	int value;
	int value2;
...
void func_62(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x3160 Hash - 0x506839C9 ^0x8B1DD37B
{
	if (iParam5 != 0)
	{
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam5, "SET_DATA_SLOT");
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0(int iParam0) // Position - 0x31D0 Hash - 0xA17D549C ^0x30377D00
{
	switch (iParam0)
	{
		case 0:
...
int func_64(int iParam0) // Position - 0x4383 Hash - 0x400E5F53 ^0x1AB12576
{
	if (func_65(iParam0, func_72(Global_64263[iParam0 /*13*/].f_4)))
		return 1;

	return 0;
}

BOOL func_65(int iParam0, int iParam1) // Position - 0x43A6 Hash - 0x92B07CD ^0x4DDE5ABA
{
	if (iParam1 < 0)
		return false;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x4470 Hash - 0x3C5423D7 ^0x3C5423D7
{
	func_67();
	return Global_114370.f_2366.f_539.f_4321;
}

void func_67() // Position - 0x4489 Hash - 0xD1F2D853 ^0xF9F5FD4D
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114370.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_68(character) && !func_26(14) || Global_113320)
			{
...
Hash func_71(eCharacter echParam0) // Position - 0x45F4 Hash - 0xE4CEEC2C ^0xE4CEEC2C
{
	return Global_2139[echParam0 /*29*/];
}

int func_72(Hash hParam0) // Position - 0x4603 Hash - 0x671EC69 ^0xFAAE3E43
{
	int outValue;
...
int func_73(int iParam0) // Position - 0x462C Hash - 0x7ADD5368 ^0x6779994A
{
	int num;

	num = func_72(Global_64263[iParam0 /*13*/].f_4);
...
int func_74(int iParam0, int iParam1, int iParam2) // Position - 0x4651 Hash - 0x18D4F097 ^0xCC21744D
{
	switch (iParam1)
	{
		case 1:
...
int func_75(int iParam0, int iParam1) // Position - 0x4694 Hash - 0x7748E784 ^0xEC455128
{
	switch (iParam0)
	{
		case 2:
...
int func_76(int iParam0, int iParam1) // Position - 0x4D78 Hash - 0x2CB0FBEB ^0x4E4F4989
{
	switch (iParam1)
	{
		case 1:
...
int func_77(int iParam0) // Position - 0x4DB3 Hash - 0x6DC67296 ^0x6DC67296
{
	switch (iParam0)
	{
		case 2:
...
void func_78(int iParam0) // Position - 0x4F64 Hash - 0xF30DB114 ^0x9801939E
{
...
struct<2> func_79(int iParam0, int iParam1) // Position - 0x4F89 Hash - 0xF1E9A0EA ^0x96C883C0
{
	var unk;
...
struct<2> func_80(int iParam0) // Position - 0x501F Hash - 0x323E6781 ^0x99014D2D
{
	var unk;
	var unk3;

	TEXT_LABEL_ASSIGN_STRING(&unk, "", 8);
	unk3 = { func_81(iParam0) };
...
struct<2> func_81(int iParam0) // Position - 0x5057 Hash - 0x975AC8C9 ^0xAEB9808C
{
	var unk;
...
void func_82() // Position - 0x54A4 Hash - 0x84904DD8 ^0x435B6582
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD_ON_FRONTEND("SET_COLUMN_SCROLL");
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(1);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(-1);
...
void func_83(int iParam0, int iParam1, int iParam2) // Position - 0x54DA Hash - 0x8840AE89 ^0x8840AE89
{
	int num;

	num = 0;

	if (Global_79498 != iParam0 || iParam2 == 1)
		num = 1;

	Global_79498 = iParam0;
	func_4(2);
...
void func_84() // Position - 0x5574 Hash - 0xD7742884 ^0xD7742884
{
	int i;
	int num;
	int num2;
	...
	for (i = 0; i < Global_79499; i = i + 1)
	{
		num2 = 0;
		num3 = 0;
		num7 = -1;
		num = uLocal_28[i /*2*/];
		uLocal_26 = { func_79(num, Global_79498) };
	
		for (j = 0; j < func_76(num, Global_79498); j = j + 1)
		{
			num4 = func_74(num, Global_79498, j);
		
			if (!Global_64263[num4 /*13*/].f_7)
			{
				if (func_64(num4) == 1)
					num3 = num3 + 1;
...
void func_85(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, char* sParam5, int iParam6) // Position - 0x5692 Hash - 0x1C958777 ^0x5816BE53
{
...
void func_86() // Position - 0x56E9 Hash - 0x5C4DA0D5 ^0xFE13A6C8
{
