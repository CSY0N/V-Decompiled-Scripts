...
void func_1() // Position - 0x120 Hash - 0x69D2274F ^0x69D2274F
{
	iLocal_236 = 0;
	return;
}

BOOL func_2() // Position - 0x12B Hash - 0xEEAF5DD9 ^0x13C1CCC2
{
	float synchronizedScenePhase;

	if (!PED::IS_PED_INJURED(Global_101113))
	{
		if (ENTITY::DOES_ENTITY_EXIST(obLocal_238))
		{
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_101113, &uLocal_244, &uLocal_276, 3))
			{
				if (FIRE::IS_ENTITY_ON_FIRE(Global_101113))
				{
					TASK::STOP_ANIM_PLAYBACK(Global_101113, 0, false);
					TASK::CLEAR_PED_TASKS(Global_101113);
					return false;
				}
			
				synchronizedScenePhase = PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_292);
			
				if (!bLocal_237)
					if (_CONVERSATION_ADD_LINE(&uLocal_71, "PRSAUD", "FRAS_IG_7x", 3, 0, 0, 0))
						bLocal_237 = true;
			
				if (synchronizedScenePhase < 0.2812f)
				{
					if (iLocal_293 != 0)
					{
						GRAPHICS::STOP_PARTICLE_FX_LOOPED(iLocal_293, false);
						iLocal_293 = 0;
					}
				}
				else if (synchronizedScenePhase < 0.4778f)
				{
					if (iLocal_293 == 0)
					{
						iLocal_293 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_lamgraff_paint_spray", obLocal_238, 0f, 0f, 0f, 0f, 0f, 0f, 1065353216, false, false, false);
						GRAPHICS::SET_PARTICLE_FX_LOOPED_COLOUR(iLocal_293, fLocal_294, fLocal_295, fLocal_296, false);
					}
				}
				else if (synchronizedScenePhase < 0.5745f)
				{
					if (iLocal_293 != 0)
					{
						GRAPHICS::STOP_PARTICLE_FX_LOOPED(iLocal_293, false);
				...
				else if (synchronizedScenePhase < 0.7712f)
				{
					if (iLocal_293 == 0)
					{
						iLocal_293 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_lamgraff_paint_spray", obLocal_238, 0f, 0f, 0f, 0f, 0f, 0f, 1065353216, false, false, false);
...
BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x295 Hash - 0x384540C1 ^0x384540C1
{
...
BOOL func_4(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x2E3 Hash - 0x77297D51 ^0x40DC584A
{
	Global_22167 = 0;
...
void func_5() // Position - 0x5B1 Hash - 0xF42BEB19 ^0xA29557DA
{
	if (!func_6())
		return;
...
BOOL func_6() // Position - 0x5E8 Hash - 0x7B74B45F ^0xCE052A5D
{
...
BOOL func_7(Player plParam0) // Position - 0x64B Hash - 0x6E46BC72 ^0x6E46BC72
{
	return func_8(plParam0, 20);
}

BOOL func_8(Player plParam0, int iParam1) // Position - 0x65B Hash - 0x7CD5054C ^0x870BEA81
{
	return IS_BIT_SET(Global_1886967[plParam0 /*609*/].f_10.f_4, iParam1);
}

Player _INVALID_PLAYER_INDEX() // Position - 0x673 Hash - 0x478900E4 ^0x478900E4
{
	return -1;
}

void func_10() // Position - 0x67C Hash - 0x52B8B664 ^0x13371378
{
	int i;
...
void func_11() // Position - 0x6AD Hash - 0xCD8A4D28 ^0xCD8A4D28
{
...
BOOL func_12() // Position - 0x742 Hash - 0xD140D54A ^0xE638D98F
{
...
BOOL func_13() // Position - 0x769 Hash - 0x9A999369 ^0x4033F7BF
{
	int num;
	int weaponHash;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x802 Hash - 0x98476CE1 ^0x250FEB7C
{
	if (func_21(14))
	{
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x8A4 Hash - 0x3C5423D7 ^0x3C5423D7
{
	func_16();
	return Global_114370.f_2366.f_539.f_4321;
}

void func_16() // Position - 0x8BD Hash - 0xD1F2D853 ^0xF9F5FD4D
{
...
BOOL func_17(eCharacter echParam0) // Position - 0x9BA Hash - 0x8907F004 ^0x8907F004
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x9C6 Hash - 0xAC4E9801 ^0xB379A75F
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0xA03 Hash - 0xADCB9755 ^0xADCB9755
{
...
Hash func_20(eCharacter echParam0) // Position - 0xA28 Hash - 0xE4CEEC2C ^0xE4CEEC2C
{
	return Global_2139[echParam0 /*29*/];
}

BOOL func_21(int iParam0) // Position - 0xA37 Hash - 0x937D8816 ^0x937D8816
{
	return Global_43922 == iParam0;
}

void func_22() // Position - 0xA45 Hash - 0x2C6B497B ^0x2040559E
{
	int i;
...
BOOL func_23(int iParam0, int iParam1) // Position - 0xA9C Hash - 0xA14C4D3F ^0xA6034F77
{
	switch (iParam0)
	{
		case 5:
...
void func_24() // Position - 0xAD4 Hash - 0xE32CF1EF ^0xB9A7BEB2
{
...
void func_25(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xB2B Hash - 0xC6B752B2 ^0xC6B752B2
{
...
BOOL func_26() // Position - 0xB81 Hash - 0xEEAF5DD9 ^0x13C1CCC2
{
	float synchronizedScenePhase;
	...
	if (!PED::IS_PED_INJURED(Global_101113))
	{
		if (ENTITY::DOES_ENTITY_EXIST(obLocal_238))
		{
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_101113, &uLocal_244, &uLocal_260, 3))
			{
				if (FIRE::IS_ENTITY_ON_FIRE(Global_101113))
				{
					TASK::STOP_ANIM_PLAYBACK(Global_101113, 0, false);
				...
				if (synchronizedScenePhase < 0.3812f)
				{
					if (iLocal_293 != 0)
					{
						GRAPHICS::STOP_PARTICLE_FX_LOOPED(iLocal_293, false);
				...
				else if (synchronizedScenePhase < 0.6712f)
				{
					if (iLocal_293 == 0)
					{
						iLocal_293 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_lamgraff_paint_spray", obLocal_238, 0f, 0f, 0f, 0f, 0f, 0f, 1065353216, false, false, false);
				...
				else if (synchronizedScenePhase < 1f)
				{
					if (iLocal_293 != 0)
					{
						GRAPHICS::STOP_PARTICLE_FX_LOOPED(iLocal_293, false);
				...
				else
				{
					...
					{
						iLocal_292 = PED::CREATE_SYNCHRONIZED_SCENE(uLocal_240, 0f, 0f, fLocal_243, 2);
						PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_292, true);
					}
				
					TASK::TASK_SYNCHRONIZED_SCENE(Global_101113, iLocal_292, &uLocal_244, &uLocal_276, 8f, -8f, 257, 0, 8f, 0);
					return true;
				}
			}
			else
			{
				...
				{
					TASK::CLEAR_PED_TASKS(Global_101113);
					PED::CLEAR_RAGDOLL_BLOCKING_FLAGS(Global_101113, 16);
...
BOOL func_27() // Position - 0xD9D Hash - 0x6BA41259 ^0x6BA41259
{
	if (!func_28())
		return true;
...
BOOL func_28() // Position - 0xDB2 Hash - 0x9BF6DAA2 ^0xB6FD0BD5
{
...
int func_29(int iParam0, Ped pedParam1) // Position - 0xE07 Hash - 0xD1960A5B ^0x3A103378
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (pedParam1 == func_30(Global_101113) && pedParam1 != 0)
		{
			Global_101113 = 0;
		}
	}
...
Ped func_30(Ped pedParam0) // Position - 0xEEB Hash - 0xC9D82232 ^0xC9D82232
{
	return pedParam0;
}

BOOL func_31(int iParam0, int iParam1) // Position - 0xEF5 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

int func_32() // Position - 0xF04 Hash - 0x35BC7314 ^0x35BC7314
{
	func_16();
...
void func_33() // Position - 0xF4A Hash - 0xCB830ADA ^0x4F0A1B48
{
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
...
void func_34() // Position - 0xF8A Hash - 0x70035002 ^0x70035002
{
	func_35(Global_101115 - 1);
	return;
}

void func_35(int iParam0) // Position - 0xF9C Hash - 0xE49C42EC ^0xE49C42EC
{
	Global_101115 = iParam0;
	return;
}

void func_36() // Position - 0xFAA Hash - 0x850DE8C4 ^0x850DE8C4
{
	func_35(0);
	return;
}

void func_37() // Position - 0xFB7 Hash - 0x4062D4CB ^0xC009B050
{
	STREAMING::REQUEST_MODEL(hLocal_239);
	STREAMING::REQUEST_PTFX_ASSET();

	while (!ENTITY::DOES_ENTITY_EXIST(Global_101113) || !STREAMING::HAS_MODEL_LOADED(hLocal_239))
	{
		SYSTEM::WAIT(0);
	}
	...
	{
		if (!PED::IS_PED_INJURED(Global_101113))
			TASK::TASK_STAND_STILL(Global_101113, -1);
	
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(Global_101113, joaat("PLAYER"));
	}

	ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_101113, true, true);
	PED::SET_PED_CONFIG_FLAG(Global_101113, 132, true);
	PED::SET_RAGDOLL_BLOCKING_FLAGS(Global_101113, 16);
	func_39(&Global_101113, Global_96376);
	_CONVERSATION_INITIALIZE_ACTOR(&uLocal_71, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	obLocal_238 = OBJECT::CREATE_OBJECT(hLocal_239, ENTITY::GET_ENTITY_COORDS(Global_101113, true), true, true, false);
	ENTITY::ATTACH_ENTITY_TO_ENTITY(obLocal_238, Global_101113, PED::GET_PED_BONE_INDEX(Global_101113, 28422), 0f, 0f, 0f, 0f, 0f, 0f, false, false, false, false, 2, true, 0);
	return;
}

void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x1092 Hash - 0x6C235EE0 ^0x9E57F206
{
...
void func_39(Ped pedParam0, Hash hParam1) // Position - 0x112D Hash - 0x732549B ^0x340997AC
{
...
void func_40() // Position - 0x1163 Hash - 0xFD102A3E ^0xD986C073
{
	var unk;
	int num;
	var unk117;
	...
	func_46(iLocal_70, &uLocal_240, &fLocal_243, &unk);
	hLocal_239 = joaat("prop_cs_spray_can");
	num.f_1 = -1;
	num.f_17 = 4;
	num.f_17.f_8 = 4;
	num.f_17.f_13 = 4;
	...
	func_43(num, &unk117);
	func_41(iLocal_70, &uLocal_244, &unk237, &uLocal_260, &unk253, &unk254);
	TEXT_LABEL_ASSIGN_STRING(&uLocal_276, "Lamar_tagging_EXIT_LOOP_LAMAR", 64);
	return;
}

BOOL func_41(int iParam0, char* sParam1, char* sParam2, char* sParam3, var uParam4, var uParam5) // Position - 0x125F Hash - 0xA5943210 ^0xA5943210
{
	*uParam4 = 9;
	*uParam5 = 8;
...
void func_42(char* sParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5) // Position - 0x1970 Hash - 0xDFC7BEC7 ^0xDFC7BEC7
{
	...
	switch (uParam0.f_2)
	{
		...
		case 80:
			*uParam109 = { uParam0 };
			uParam109->f_109 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			uParam109->f_110 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			func_44(uParam109, 17, joaat("SCRIPT_TASK_PLAY_ANIM"), joaat("SCRIPT_TASK_PLAY_ANIM"), { 2.6407f, 8.164f, -14.1564f } + { -1f, 0.03f, -2.16f }, -66f + -56f);
		...
		case 155:
			*uParam109 = { uParam0 };
			uParam109->f_109 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			uParam109->f_110 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			func_44(uParam109, 17, joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
		...
		case 158:
			*uParam109 = { uParam0 };
			uParam109->f_109 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			uParam109->f_110 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			func_44(uParam109, 144, joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
	...
	switch (uParam0.f_2)
	{
		...
		case 196:
			*uParam109 = { uParam0 };
			uParam109->f_109 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			uParam109->f_110 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			func_44(uParam109, 43, joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
...
void func_44(var uParam0, int iParam1, int iParam2, int iParam3, float fParam4, float fParam5, float fParam6, float fParam7) // Position - 0x4D08 Hash - 0xB67DDD9F ^0xE0258F09
{
...
void func_45(var uParam0) // Position - 0x4D32 Hash - 0x9000D55C ^0x3177311F
{
	func_44(uParam0, 145, joaat("SCRIPT_TASK_ANY"), joaat("SCRIPT_TASK_ANY"), 0f, 0f, 0f, 0f);
	return;
}

int func_46(int iParam0, var uParam1, var uParam2, char* sParam3) // Position - 0x4D50 Hash - 0x36DCAE2A ^0x59910E2E
{
	int num;
...
BOOL func_47(var uParam0) // Position - 0x4F43 Hash - 0xF5357FFC ^0xF5357FFC
{
	eCharacter character;
	Vector3 entityCoords;
	float num;
	...
	if (func_48(entityCoords, 0f, 0f, 0f, false))
...
BOOL func_48(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x4FFB Hash - 0x2D46096D ^0xEA41378F
{
	if (bParam6)
...
BOOL func_49(int iParam0, var uParam1, char* sParam2) // Position - 0x5042 Hash - 0xEC8EE3D4 ^0x2CCA9401
{
	var unk;
	int num;
	var unk4;
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_114370.f_2366.f_539.f_2310[0];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_53(Global_114370.f_2366.f_539.f_2314[0]), 32);
			return true;
	
		case 6:
			*uParam1 = Global_114370.f_2366.f_539.f_2310[1];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_53(Global_114370.f_2366.f_539.f_2314[1]), 32);
			return true;
	
		case 7:
			*uParam1 = Global_114370.f_2366.f_539.f_2310[2];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_53(Global_114370.f_2366.f_539.f_2314[2]), 32);
			return true;
	
		case 11:
			if (func_52(iParam0, &unk, uParam1))
			{
...
BOOL func_50(int iParam0, int iParam1, var uParam2, var uParam3) // Position - 0x7549 Hash - 0x416CB035 ^0x416CB035
{
	switch (iParam1)
	{
		case 0:
...
BOOL _GET_RANDOM_BOOL() // Position - 0x949B Hash - 0x6E373505 ^0x528400E3
{
...
BOOL func_52(int iParam0, var uParam1, var uParam2) // Position - 0x94B9 Hash - 0x6BF2FA05 ^0x6BF2FA05
{
	switch (iParam0)
	{
		case 11:
...
char* func_53(Hash hParam0) // Position - 0x9E28 Hash - 0xE6862179 ^0x2BFACA7D
{
	switch (hParam0)
	{
...
void func_54() // Position - 0x9EBA Hash - 0xA107CF77 ^0x8DE502FE
{
	if (iLocal_293 != 0)
	{
		GRAPHICS::STOP_PARTICLE_FX_LOOPED(iLocal_293, false);
