...
void func_1() // Position - 0x103 Hash - 0x69D2274F ^0x69D2274F
{
	iLocal_70 = 0;
	return;
}

BOOL func_2() // Position - 0x10E Hash - 0x609BB0C3 ^0xF29F2340
{
	var unk;
...
int func_3(Object* pobParam0, int iParam1) // Position - 0x3E7 Hash - 0xFCC291F6 ^0xF4643650
{
	int num;
	var entityCoords;
	...
	switch (iParam1)
	{
		case 0:
			...
			if (ENTITY::GET_ENTITY_MODEL(*pobParam0) != joaat("prop_cs_ironing_board") && ENTITY::GET_ENTITY_MODEL(*pobParam0) != joaat("prop_iron_01"))
			{
				ENTITY::FREEZE_ENTITY_POSITION(*pobParam0, false);
				ENTITY::SET_ENTITY_DYNAMIC(*pobParam0, true);
			}
		
			if (ENTITY::GET_ENTITY_MODEL(*pobParam0) == joaat("prop_iron_01"))
			{
			...
			if (ENTITY::GET_ENTITY_MODEL(*pobParam0) != joaat("p_defilied_ragdoll_01_s"))
		...
		case 3:
			...
			if (ENTITY::GET_ENTITY_MODEL(*pobParam0) != joaat("prop_chateau_table_01") && ENTITY::GET_ENTITY_MODEL(*pobParam0) != joaat("v_res_tt_flusher") && ENTITY::GET_ENTITY_MODEL(*pobParam0) != joaat("v_ilev_fh_lampa_on") && ENTITY::GET_ENTITY_MODEL(*pobParam0) != joaat("prop_cs_remote_01"))
				ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(*pobParam0, -8f, true);
		
			if (ENTITY::GET_ENTITY_MODEL(*pobParam0) != joaat("v_ilev_fh_dineeamesa") && ENTITY::GET_ENTITY_MODEL(*pobParam0) != joaat("v_res_tt_flusher") && ENTITY::GET_ENTITY_MODEL(*pobParam0) != joaat("v_ilev_fh_lampa_on"))
				ENTITY::FREEZE_ENTITY_POSITION(*pobParam0, false);
		...
		case 4:
			...
			switch (ENTITY::GET_ENTITY_MODEL(*pobParam0))
			{
				case joaat("p_laptop_02_s"):
					model = joaat("prop_laptop_02_closed");
					break;
			
				case joaat("v_ilev_m_dinechair"):
					model = joaat("p_dinechair_01_s");
					break;
			
				case joaat("prop_acc_guitar_01"):
					model = joaat("prop_acc_guitar_01_d1");
					break;
			
				case joaat("p_defilied_ragdoll_01_s"):
					model = joaat("prop_defilied_ragdoll_01");
					break;
			
				case joaat("p_hand_toilet_s"):
					model = joaat("prop_toiletfoot_static");
					break;
		...
		case 7:
			if (ENTITY::GET_ENTITY_MODEL(*pobParam0) == WEAPON::GET_WEAPONTYPE_MODEL(joaat("WEAPON_PISTOL")))
			{
		...
		case 9:
			...
			switch (ENTITY::GET_ENTITY_MODEL(*pobParam0))
			{
				...
				case joaat("p_laptop_02_s"):
					model2 = joaat("prop_laptop_02_closed");
					break;
			
				case joaat("v_ilev_m_dinechair"):
					model2 = joaat("p_dinechair_01_s");
					break;
			
				case joaat("prop_acc_guitar_01"):
					model2 = joaat("prop_acc_guitar_01_d1");
					break;
			
				case joaat("p_defilied_ragdoll_01_s"):
					model2 = joaat("prop_defilied_ragdoll_01");
					break;
			...
			if (func_6(num, &animName, &unk36, &any))
				if (func_4(num, &animDict, &unk67, &unk83, &unk99, &unk100))
					if (!ENTITY::IS_ENTITY_PLAYING_ANIM(*pobParam0, &animDict, &animName, 2))
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(*pobParam0, Global_98702, &animName, &animDict, 1000f, -8f, any, 1148846080);
...
BOOL func_4(int iParam0, char* sParam1, char* sParam2, char* sParam3, var uParam4, var uParam5) // Position - 0xAC5 Hash - 0xD2057549 ^0xD2057549
{
	*uParam4 = 9;
	*uParam5 = 0;
...
void func_5(int iParam0, char* sParam1, char* sParam2, char* sParam3) // Position - 0x21F5 Hash - 0x7BFAA2D1 ^0xA8915132
{
...
BOOL func_6(int iParam0, char* sParam1, char* sParam2, var uParam3) // Position - 0x2215 Hash - 0x29D23042 ^0xB6CE9018
{
	*uParam3 = 0;
	TEXT_LABEL_ASSIGN_STRING(sParam2, "", 64);
...
void func_7(BOOL bParam0) // Position - 0x240B Hash - 0x5FE88D2A ^0xA22C291D
{
	if (bParam0)
	{
		func_14();
...
void func_8(int iParam0) // Position - 0x246E Hash - 0x4066FEF5 ^0x9787FBDA
{
	if (func_12())
		return;
...
BOOL func_9() // Position - 0x24F8 Hash - 0xD140D54A ^0xE638D98F
{
...
void func_10(BOOL bParam0, BOOL bParam1) // Position - 0x251F Hash - 0xF40FC178 ^0xA6F60F17
{
	if (bParam0)
	{
		if (func_13(0))
...
BOOL func_11() // Position - 0x2593 Hash - 0x8DF3D75D ^0x8DF3D75D
{
	return IS_BIT_SET(Global_1956030, 5);
}

BOOL func_12() // Position - 0x25A1 Hash - 0xC41437CB ^0xC41437CB
{
	return IS_BIT_SET(Global_1956030, 19);
}

BOOL func_13(int iParam0) // Position - 0x25B0 Hash - 0xE8921B44 ^0x4F063755
{
	if (iParam0 == 1)
...
void func_14() // Position - 0x2607 Hash - 0xF8FE2348 ^0xA77911B2
{
...
int func_15() // Position - 0x2630 Hash - 0xA53026BE ^0x50EB77A5
{
...
BOOL func_16() // Position - 0x2657 Hash - 0x3CA1BB47 ^0xB78A1ACB
{
...
void func_17(Ped pedParam0, Cam caParam1, int iParam2, int iParam3, int iParam4) // Position - 0x2671 Hash - 0x227F617F ^0x4B2CEA0E
{
	int num;
	int num2;
	int num3;
	...
	Global_45095 = 0.25f;
	TEXT_LABEL_ASSIGN_STRING(&Global_45096, func_23(iParam3), 16);
...
void func_18(int iParam0, int iParam1, int iParam2, Ped pedParam3, int iParam4) // Position - 0x27E3 Hash - 0xCD188BC6 ^0xCD188BC6
{
	func_19(iParam0, iParam1, iParam2, pedParam3, 0, iParam4);
	return;
}

void func_19(int iParam0, int iParam1, int iParam2, Ped pedParam3, int iParam4, int iParam5) // Position - 0x27FA Hash - 0x9F3D8BA2 ^0x9F3D8BA2
{
	int num;
...
int func_20() // Position - 0x287C Hash - 0x11506CC4 ^0x2E9F5641
{
	int i;
...
BOOL func_21(int iParam0, int iParam1, int iParam2) // Position - 0x28AD Hash - 0x3A30B8C2 ^0x3A30B8C2
{
...
int func_22(int iParam0, int iParam1, int iParam2) // Position - 0x28C8 Hash - 0x61F8C119 ^0x1C9B84EC
{
	int i;
...
char* func_23(int iParam0) // Position - 0x2914 Hash - 0x958AD60F ^0x1279DB70
{
	switch (iParam0)
	{
		case 0:
...
void func_24(Ped pedParam0, int iParam1) // Position - 0x2941 Hash - 0x7F8FABC2 ^0x752ACE0C
{
	int num;
	int num2;
...
void func_25(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x29C0 Hash - 0xB4857222 ^0xB4857222
{
	func_19(iParam0, iParam1, iParam2, 0, iParam3, 1);
	return;
}

int func_26(Ped pedParam0) // Position - 0x29D6 Hash - 0x14AF2EDD ^0xC5BC7CD2
{
	int i;
...
int func_27(int iParam0) // Position - 0x2A07 Hash - 0x671ED513 ^0x671ED513
{
	int i;
...
int func_28(Ped pedParam0) // Position - 0x2A37 Hash - 0x219FA119 ^0x5240A8AF
{
	int i;
...
void func_29(int iParam0, int iParam1, float fParam2, float fParam3, Cam caParam4, BOOL bParam5) // Position - 0x2A78 Hash - 0xE2E72367 ^0x8F691389
{
	int gameTimer;
...
float func_30() // Position - 0x2B33 Hash - 0x9866E92D ^0x4C32084D
{
	float num;
	int value;
	int value2;
...
int func_31(Ped pedParam0) // Position - 0x2BB2 Hash - 0xA8AAC40F ^0x96AA47F
{
	int num;
	int num2;
...
int func_32(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x2BF5 Hash - 0x1ECD241B ^0x2C71A0AB
{
	int num;
	int num2;
	int num3;
...
int func_33() // Position - 0x2CB1 Hash - 0x412B82DF ^0x412B82DF
{
	int i;
...
BOOL func_34(Ped pedParam0) // Position - 0x2CE0 Hash - 0xD8C74549 ^0xD8C74549
{
	if (pedParam0 == 0)
		return false;
...
int func_35(Ped pedParam0) // Position - 0x2D01 Hash - 0xDCBB968F ^0xDCBB968F
{
	int i;
...
int func_36(Ped pedParam0) // Position - 0x2D4A Hash - 0xA8AAC40F ^0x96AA47F
{
	int num;
	int num2;
...
BOOL func_37() // Position - 0x2D8D Hash - 0xF6AB6D04 ^0x35634F3E
{
	if (!(hLocal_72 == 0))
	{
		if (!ENTITY::DOES_ENTITY_EXIST(obLocal_71))
...
BOOL func_38() // Position - 0x2E87 Hash - 0x9BF6DAA2 ^0xB6FD0BD5
{
...
int func_39(int iParam0, Ped pedParam1) // Position - 0x2EDC Hash - 0xD1960A5B ^0x3A103378
{
...
Ped func_40(Ped pedParam0) // Position - 0x2FC0 Hash - 0xC9D82232 ^0xC9D82232
{
	return pedParam0;
}

BOOL func_41(int iParam0, int iParam1) // Position - 0x2FCA Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

int func_42() // Position - 0x2FD9 Hash - 0x35BC7314 ^0x35BC7314
{
	func_43();
...
void func_43() // Position - 0x301F Hash - 0xD1F2D853 ^0xF9F5FD4D
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114370.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_44(character) && !func_48(14) || Global_113320)
			{
...
BOOL func_44(eCharacter echParam0) // Position - 0x311C Hash - 0x8907F004 ^0x8907F004
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x3128 Hash - 0xAC4E9801 ^0xB379A75F
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x3165 Hash - 0xADCB9755 ^0xADCB9755
{
...
Hash func_47(eCharacter echParam0) // Position - 0x318A Hash - 0xE4CEEC2C ^0xE4CEEC2C
{
	return Global_2139[echParam0 /*29*/];
}

BOOL func_48(int iParam0) // Position - 0x3199 Hash - 0x937D8816 ^0x937D8816
{
	return Global_43922 == iParam0;
}

void func_49() // Position - 0x31A7 Hash - 0xCB830ADA ^0x4F0A1B48
{
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
...
void func_50() // Position - 0x31E7 Hash - 0x70035002 ^0x70035002
{
	func_51(Global_101115 - 1);
	return;
}

void func_51(int iParam0) // Position - 0x31F9 Hash - 0xE49C42EC ^0xE49C42EC
{
	Global_101115 = iParam0;
	return;
}

void func_52() // Position - 0x3207 Hash - 0x850DE8C4 ^0x850DE8C4
{
	func_51(0);
	return;
}

void func_53() // Position - 0x3214 Hash - 0x748208DC ^0x115C66E6
{
	int num;
	BOOL flag;
...
void func_54() // Position - 0x3365 Hash - 0x95853B25 ^0x1F12229D
{
	var unk;
	int num;
	var unk117;
	...
	switch (iLocal_69)
	{
		...
		case 310:
			...
			TEXT_LABEL_ASSIGN_STRING(&uLocal_121, "", 64);
			hLocal_72 = joaat("prop_tool_shovel");
		...
		case 315:
			...
			TEXT_LABEL_ASSIGN_STRING(&uLocal_121, "", 64);
			hLocal_72 = joaat("prop_cs_sink_filler_02");
		...
		case 124:
			...
			TEXT_LABEL_ASSIGN_STRING(&uLocal_121, "", 64);
			hLocal_72 = joaat("prop_cs_sink_filler_03");
	...
	switch (uParam0.f_2)
	{
		...
		case 12:
			*uParam109 = { uParam0 };
			...
			func_56(uParam109, 144, joaat("SCRIPT_TASK_STAND_STILL"), joaat("SCRIPT_TASK_STAND_STILL"), 0f, 0f, 0f, 0f);
			uParam109->f_118 = 2;
			return 1;
		...
		case 75:
			*uParam109 = { uParam0 };
			...
			func_56(uParam109, 30, joaat("SCRIPT_TASK_STAND_STILL"), joaat("SCRIPT_TASK_STAND_STILL"), 0f, 0f, 0f, 0f);
			uParam109->f_118 = 2;
			return 1;
		...
		case 77:
			*uParam109 = { uParam0 };
			uParam109->f_109 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			uParam109->f_110 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			func_56(uParam109, 17, joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), -0.7035f, -0.0282f, 0f, 0f);
			uParam109->f_118 = 1;
			return 1;
		...
		case 78:
			*uParam109 = { uParam0 };
			uParam109->f_109 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			uParam109->f_110 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			func_56(uParam109, 17, joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), -3.03f, -0.72f, 0.08f, 168f);
			uParam109->f_118 = 1;
			return 1;
		...
		case 80:
			*uParam109 = { uParam0 };
			uParam109->f_109 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			uParam109->f_110 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			func_56(uParam109, 17, joaat("SCRIPT_TASK_PLAY_ANIM"), joaat("SCRIPT_TASK_PLAY_ANIM"), { 2.6407f, 8.164f, -14.1564f } + { -1f, 0.03f, -2.16f }, -66f + -56f);
		...
		case 94:
			*uParam109 = { uParam0 };
			...
			if (uParam0.f_2 == 94)
				func_56(uParam109, 17, joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), -1.71f, 1.05f, 0f, -138f);
		...
		case 150:
			*uParam109 = { uParam0 };
			uParam109->f_109 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			uParam109->f_110 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			func_56(uParam109, 20, joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), 0.98f, 0.8017f, -0.42f, -180f);
			uParam109->f_118 = 1;
			return 1;
		...
		case 98:
			*uParam109 = { uParam0 };
			uParam109->f_109 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			uParam109->f_110 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			func_56(uParam109, 17, joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), 0f, 0f, 0f, 0f);
			uParam109->f_118 = 2;
			return 1;
		...
		case 99:
			*uParam109 = { uParam0 };
			uParam109->f_109 = joaat("SCRIPT_TASK_STAND_STILL");
			uParam109->f_110 = joaat("SCRIPT_TASK_STAND_STILL");
			func_56(uParam109, 15, joaat("SCRIPT_TASK_STAND_STILL"), joaat("SCRIPT_TASK_LEAVE_VEHICLE"), 0f, 0f, 0f, 0f);
			uParam109->f_118 = 2;
			return 1;
		...
		case 101:
			*uParam109 = { uParam0 };
			uParam109->f_109 = joaat("SCRIPT_TASK_STAND_STILL");
			uParam109->f_110 = joaat("SCRIPT_TASK_STAND_STILL");
			func_56(uParam109, 14, joaat("SCRIPT_TASK_STAND_STILL"), joaat("SCRIPT_TASK_LEAVE_VEHICLE"), 0f, 0f, 0f, 0f);
			uParam109->f_118 = 2;
			return 1;
		...
		case 122:
			*uParam109 = { uParam0 };
			uParam109->f_109 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			uParam109->f_110 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			func_56(uParam109, 17, joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), -2.04f, -0.15f, 0f, 14.4f);
			uParam109->f_118 = 1;
			return 1;
		...
		case 152:
			*uParam109 = { uParam0 };
			uParam109->f_109 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			uParam109->f_110 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			func_56(uParam109, 17, joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), 1.1779f, 2.4276f, 0f, 162.1022f);
			uParam109->f_118 = 1;
			return 1;
		...
		case 155:
			*uParam109 = { uParam0 };
			uParam109->f_109 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			uParam109->f_110 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			func_56(uParam109, 17, joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
		...
		case 156:
			*uParam109 = { uParam0 };
			uParam109->f_109 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			uParam109->f_110 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			func_56(uParam109, 14, joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), 0.3427f, 1.1592f, 1.0351f, 139.912f);
			uParam109->f_118 = 1;
			return 1;
		...
		case 158:
			*uParam109 = { uParam0 };
			uParam109->f_109 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			uParam109->f_110 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			func_56(uParam109, 144, joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
		...
		case 167:
			*uParam109 = { uParam0 };
			uParam109->f_109 = joaat("SCRIPT_TASK_STAND_STILL");
			uParam109->f_110 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			func_56(uParam109, 14, joaat("SCRIPT_TASK_STAND_STILL"), joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), -0.8472f, 0.155f, 0f, 152.556f);
			uParam109->f_118 = 1;
			return 1;
		...
		case 169:
			*uParam109 = { uParam0 };
			uParam109->f_109 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			uParam109->f_110 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			func_56(uParam109, 14, joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), -0.3577f, -0.8968f, -0.0003f, 0f);
			uParam109->f_118 = 1;
			return 1;
		...
		case 171:
			*uParam109 = { uParam0 };
			uParam109->f_109 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			uParam109->f_110 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			func_56(uParam109, 14, joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), 0f, 0f, 0f, 0f);
			uParam109->f_118 = 2;
			return 1;
		...
		case 172:
			*uParam109 = { uParam0 };
			uParam109->f_109 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			uParam109->f_110 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			func_56(uParam109, 15, joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), 0f, 0f, 0f, 0f);
			uParam109->f_118 = 2;
			return 1;
	...
	switch (uParam0.f_2)
	{
		...
		case 192:
			*uParam109 = { uParam0 };
			uParam109->f_109 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			uParam109->f_110 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			func_56(uParam109, 144, joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), 1f, 1f, 0f, 0f);
			uParam109->f_118 = 1;
		...
		case 193:
			*uParam109 = { uParam0 };
			uParam109->f_109 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			uParam109->f_110 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			func_56(uParam109, 144, joaat("SCRIPT_TASK_STAND_STILL"), joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), 4.2943f, -6.7858f, 0f, -133.5332f);
			uParam109->f_118 = 1;
		...
		case 196:
			*uParam109 = { uParam0 };
			uParam109->f_109 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			uParam109->f_110 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			func_56(uParam109, 43, joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f));
			uParam109->f_118 = 1;
			return 1;
		...
		case 205:
			*uParam109 = { uParam0 };
			uParam109->f_109 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			uParam109->f_110 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			func_56(uParam109, 144, joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), 3.4381f, -0.8269f, 0f, -87.6612f);
		...
		case 221:
			*uParam109 = { uParam0 };
			uParam109->f_109 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			uParam109->f_110 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			func_56(uParam109, 144, joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), -0.7949f, -0.508f, 0f, 0f);
			uParam109->f_118 = 1;
			return 1;
		...
		case 218:
			*uParam109 = { uParam0 };
			uParam109->f_109 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			uParam109->f_110 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			func_56(uParam109, 19, joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), 1.29f, 1.41f, 0f, 57.52f);
			uParam109->f_118 = 1;
			return 1;
		...
		case 220:
			*uParam109 = { uParam0 };
			uParam109->f_109 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			uParam109->f_110 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			func_56(uParam109, 19, joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), 0.5504f, -0.2322f, 0f, -9.9741f);
			uParam109->f_118 = 1;
			return 1;
		...
		case 225:
			*uParam109 = { uParam0 };
			uParam109->f_109 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			uParam109->f_110 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			func_56(uParam109, 19, joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), 1.23f, 0.6f, -1f, 34.56f);
			uParam109->f_118 = 1;
			return 1;
		...
		case 236:
			*uParam109 = { uParam0 };
			uParam109->f_109 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			uParam109->f_110 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			func_56(uParam109, 144, joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), 1.5033f, 1.2118f, 0f, -78.0449f);
			uParam109->f_118 = 1;
			return 1;
		...
		case 270:
			*uParam109 = { uParam0 };
			...
			if (uParam0.f_2 == 267)
				func_56(uParam109, 144, joaat("SCRIPT_TASK_STAND_STILL"), joaat("SCRIPT_TASK_GO_STRAIGHT_TO_COORD"), -2.4166f, -0.15f, 0f, -148.7555f);
		
			if (uParam0.f_2 == 266)
				func_56(uParam109, 144, joaat("SCRIPT_TASK_GO_STRAIGHT_TO_COORD"), joaat("SCRIPT_TASK_GO_STRAIGHT_TO_COORD"), -5.7915f, -11.0439f, 0.67f, -72.589f);
		...
		case 262:
			*uParam109 = { uParam0 };
			uParam109->f_109 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			uParam109->f_110 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			func_56(uParam109, 144, joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), 0f, 0f, 0f, 0f);
			uParam109->f_118 = 1;
			return 1;
		...
		case 289:
			*uParam109 = { uParam0 };
			uParam109->f_109 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			uParam109->f_110 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			func_56(uParam109, 144, joaat("SCRIPT_TASK_PLAY_ANIM"), joaat("SCRIPT_TASK_PLAY_ANIM"), -3.264f, -14.7895f, 14.1815f, -0.6311f);
			uParam109->f_118 = 1;
			return 1;
		...
		case 295:
			*uParam109 = { uParam0 };
			uParam109->f_109 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			uParam109->f_110 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			func_56(uParam109, 32, joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), 0f, 0f, 0f, 0f);
			uParam109->f_118 = 1;
			return 1;
		...
		case 299:
			*uParam109 = { uParam0 };
			uParam109->f_109 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			uParam109->f_110 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			func_56(uParam109, 32, joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), 0.24f, 0.33f, -0.5f, -11.88f);
			uParam109->f_118 = 1;
			return 1;
		...
		case 296:
			*uParam109 = { uParam0 };
			uParam109->f_109 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			uParam109->f_110 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			func_56(uParam109, 32, joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), 1.41f, 1.35f, 0f, 168f);
			uParam109->f_118 = 1;
			return 1;
		...
		case 297:
			*uParam109 = { uParam0 };
			uParam109->f_109 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			uParam109->f_110 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			func_56(uParam109, 32, joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), 1.7491f, 0.6423f, 0f, 166.479f);
			uParam109->f_118 = 1;
			return 1;
		...
		case 298:
			*uParam109 = { uParam0 };
			uParam109->f_109 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			uParam109->f_110 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			func_56(uParam109, 32, joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE"), 0.72f, -0.69f, 0f, 172.44f);
			uParam109->f_118 = 1;
			return 1;
		...
		case 312:
			*uParam109 = { uParam0 };
			...
			func_56(uParam109, 144, joaat("SCRIPT_TASK_COWER"), joaat("SCRIPT_TASK_HANDS_UP"), -9.5443f, -3.191f, -0.3f, 180f);
			uParam109->f_118 = 1;
			return 1;
...
void func_56(var uParam0, int iParam1, int iParam2, int iParam3, float fParam4, float fParam5, float fParam6, float fParam7) // Position - 0x6A78 Hash - 0xB67DDD9F ^0xE0258F09
{
...
void func_57(var uParam0) // Position - 0x6AA2 Hash - 0x9000D55C ^0x3177311F
{
	func_56(uParam0, 145, joaat("SCRIPT_TASK_ANY"), joaat("SCRIPT_TASK_ANY"), 0f, 0f, 0f, 0f);
	return;
}

int func_58(int iParam0, var uParam1, var uParam2, char* sParam3) // Position - 0x6AC0 Hash - 0x36DCAE2A ^0x59910E2E
{
	int num;
...
BOOL func_59(var uParam0) // Position - 0x6CB3 Hash - 0xF5357FFC ^0xF5357FFC
{
	eCharacter character;
	Vector3 entityCoords;
	float num;
...
BOOL func_60(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x6D6B Hash - 0x2D46096D ^0xEA41378F
{
	if (bParam6)
...
BOOL func_61(int iParam0, var uParam1, char* sParam2) // Position - 0x6DB2 Hash - 0xFBF08092 ^0x3A719A9A
{
	var unk;
	int num;
	var unk4;
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_114370.f_2366.f_539.f_2310[0];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_65(Global_114370.f_2366.f_539.f_2314[0]), 32);
			return true;
	
		case 6:
			*uParam1 = Global_114370.f_2366.f_539.f_2310[1];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_65(Global_114370.f_2366.f_539.f_2314[1]), 32);
			return true;
	
		case 7:
			*uParam1 = Global_114370.f_2366.f_539.f_2310[2];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_65(Global_114370.f_2366.f_539.f_2314[2]), 32);
			return true;
...
BOOL func_62(int iParam0, int iParam1, var uParam2, var uParam3) // Position - 0x92BB Hash - 0x416CB035 ^0x416CB035
{
	switch (iParam1)
	{
		case 0:
...
BOOL _GET_RANDOM_BOOL() // Position - 0xB208 Hash - 0x6E373505 ^0x528400E3
{
...
BOOL func_64(int iParam0, var uParam1, var uParam2) // Position - 0xB226 Hash - 0x6BF2FA05 ^0x6BF2FA05
{
	switch (iParam0)
	{
		case 11:
...
char* func_65(Hash hParam0) // Position - 0xBB95 Hash - 0xE6862179 ^0xBA9483E8
{
	switch (hParam0)
	{
...
void func_66() // Position - 0xBC27 Hash - 0x9788667F ^0x68EEE6D
{
	if (ENTITY::DOES_ENTITY_EXIST(obLocal_71))
		if (iLocal_81 != -1)
			func_3(&obLocal_71, iLocal_81);
