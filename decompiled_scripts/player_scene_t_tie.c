...
void func_1() // Position - 0xFD Hash - 0x69D2274F ^0x69D2274F
{
	iLocal_70 = 0;
	return;
}

BOOL func_2() // Position - 0x108 Hash - 0xE19ED930 ^0xF165FDCA
{
	float num;
...
int func_3(var uParam0, var uParam1) // Position - 0x142 Hash - 0x3DA720FA ^0x76CCC29A
{
	int num;
	int i;
	...
	for (i = 0; i < *uParam0; i = i + 1)
	{
		...
		{
			ENTITY::DOES_ENTITY_EXIST(uParam0->[i]);
		}
	}
...
BOOL func_4() // Position - 0x1A4 Hash - 0xF58BFCBD ^0xF58BFCBD
{
	func_3(&iLocal_71, &uLocal_111);
...
BOOL func_5() // Position - 0x1C2 Hash - 0x9BF6DAA2 ^0xB6FD0BD5
{
...
int func_6(int iParam0, Ped pedParam1) // Position - 0x217 Hash - 0xD1960A5B ^0x3A103378
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (pedParam1 == func_7(Global_101113) && pedParam1 != 0)
		{
			Global_101113 = 0;
		}
	}
...
Ped func_7(Ped pedParam0) // Position - 0x2FB Hash - 0xC9D82232 ^0xC9D82232
{
	return pedParam0;
}

BOOL func_8(int iParam0, int iParam1) // Position - 0x305 Hash - 0x178D9C09 ^0x178D9C09
{
	return iParam0 && iParam1 != false;
}

int func_9() // Position - 0x314 Hash - 0x35BC7314 ^0x35BC7314
{
	func_10();
...
void func_10() // Position - 0x35A Hash - 0xD1F2D853 ^0xF9F5FD4D
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114370.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_11(character) && !func_15(14) || Global_113320)
			{
...
BOOL func_11(eCharacter echParam0) // Position - 0x457 Hash - 0x8907F004 ^0x8907F004
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x463 Hash - 0xAC4E9801 ^0xB379A75F
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x4A0 Hash - 0xADCB9755 ^0xADCB9755
{
...
Hash func_14(eCharacter echParam0) // Position - 0x4C5 Hash - 0xE4CEEC2C ^0xE4CEEC2C
{
	return Global_2139[echParam0 /*29*/];
}

BOOL func_15(int iParam0) // Position - 0x4D4 Hash - 0x937D8816 ^0x937D8816
{
	return Global_43922 == iParam0;
}

void func_16() // Position - 0x4E2 Hash - 0xCB830ADA ^0x4F0A1B48
{
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
...
void func_17() // Position - 0x522 Hash - 0x70035002 ^0x70035002
{
	func_18(Global_101115 - 1);
	return;
}

void func_18(int iParam0) // Position - 0x534 Hash - 0xE49C42EC ^0xE49C42EC
{
	Global_101115 = iParam0;
	return;
}

void func_19() // Position - 0x542 Hash - 0x850DE8C4 ^0x850DE8C4
{
	func_18(0);
	return;
}

void func_20() // Position - 0x54F Hash - 0x1893571B ^0x24CB31BD
{
	int i;
	int num;
	BOOL flag;
	...
	while (!flag && num < 400)
	{
		...
		if (!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_116))
		{
			STREAMING::REQUEST_ANIM_DICT(&uLocal_116);
		
			if (!STREAMING::HAS_ANIM_DICT_LOADED(&uLocal_116))
			{
				STREAMING::REQUEST_ANIM_DICT(&uLocal_116);
				flag = false;
			}
	...
	for (i = 0; i < iLocal_71; i = i + 1)
	{
		if (iLocal_76[i] != 0)
		{
			iLocal_71[i] = PED::CREATE_PED(PED_TYPE_MISSION, iLocal_76[i], uLocal_81 + uLocal_85[i /*3*/], 0, true, true);
			ENTITY::SET_ENTITY_ROTATION(iLocal_71[i], { fLocal_84, 0f, 0f } + uLocal_98[i /*3*/], 2, true);
			PED::SET_PED_RANDOM_COMPONENT_VARIATION(iLocal_71[i], 0);
		
			if (iLocal_69 == 288)
			{
				PED::SET_PED_COMPONENT_VARIATION(iLocal_71[i], PV_COMP_UPPR, 1, 0, 0);
				PED::SET_PED_COMPONENT_VARIATION(iLocal_71[i], PV_COMP_LOWR, 0, 0, 0);
			}
			else
			{
				PED::SET_PED_RANDOM_COMPONENT_VARIATION(iLocal_71[i], 0);
			...
			PED::SET_PED_CAN_BE_TARGETTED(iLocal_71[i], false);
			TASK::TASK_PLAY_ANIM_ADVANCED(iLocal_71[i], &uLocal_116, &uLocal_124[i /*8*/], uLocal_81 + uLocal_85[i /*3*/], { fLocal_84, 0f, 0f } + uLocal_98[i /*3*/], 1000f, -8f, -1, iLocal_157, 0, 2, 0);
			PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_71[i], false, false);
			PED::SET_PED_KEEP_TASK(iLocal_71[i], true);
			PED::SET_PED_RESET_FLAG(iLocal_71[i], 55, true);
		
			if (uLocal_165[i] > 0)
			{
				PED::APPLY_PED_BLOOD_BY_ZONE(iLocal_71[i], 1, 0.36f, 0.71f, "ShotgunSmall");
				PED::APPLY_PED_BLOOD_DAMAGE_BY_ZONE(iLocal_71[i], 1, 0.81f, 0.733f, 4);
				PED::APPLY_PED_BLOOD_DAMAGE_BY_ZONE(iLocal_71[i], 0, 0.94f, 0.59f, 3);
				PED::APPLY_PED_BLOOD_DAMAGE_BY_ZONE(iLocal_71[i], 3, 0.24f, 0.62f, 4);
				PED::APPLY_PED_BLOOD_DAMAGE_BY_ZONE(iLocal_71[i], 2, 0f, 0.15f, 2);
				PED::APPLY_PED_BLOOD_DAMAGE_BY_ZONE(iLocal_71[i], 5, 0.46f, 0.853f, 3);
				PED::APPLY_PED_BLOOD_DAMAGE_BY_ZONE(iLocal_71[i], 4, 0.308f, 0.786f, 3);
				PED::APPLY_PED_BLOOD_SPECIFIC(iLocal_71[i], 3, 0.375f, 0.398f, 0f, 1f, -1, 0f, "BasicSlash");
				PED::APPLY_PED_BLOOD_SPECIFIC(iLocal_71[i], 3, 0.5f, 0.6f, 0f, 1f, -1, 0f, "BasicSlash");
				PED::APPLY_PED_BLOOD_SPECIFIC(iLocal_71[i], 3, 0.6f, 0.25f, 50f, 0.5f, -1, 0f, "BasicSlash");
				PED::APPLY_PED_BLOOD_SPECIFIC(iLocal_71[i], 3, 0.65f, 0.325f, 50f, 0.5f, -1, 0f, "BasicSlash");
				PED::APPLY_PED_BLOOD_SPECIFIC(iLocal_71[i], 0, 0.58f, 0.704f, 0f, 1f, -1, 0f, "ShotgunLarge");
			}
		}
	}

	for (i = 0; i < iLocal_158; i = i + 1)
	{
		if (uLocal_165[i] > 0)
		{
			unk = { 0f, 0f, -1f };
			unk4 = { func_21(0f, 1f, 0f) };
			width = 1.5f;
			height = 1.5f;
			rCoef = 0.196f;
			gCoef = 0f;
...
Vector3 func_21(float fParam0, float fParam1, float fParam2) // Position - 0x8D7 Hash - 0xFB6A39D2 ^0x80C9C759
{
	float num;
	float num2;
...
void func_22() // Position - 0x916 Hash - 0x6D1D2B42 ^0x78904FEA
{
	var unk;
	int num;
	var unk117;
	...
	func_26(iLocal_69, &uLocal_81, &fLocal_84, &unk);
	num.f_1 = -1;
	num.f_17 = 4;
	num.f_17.f_8 = 4;
	num.f_17.f_13 = 4;
	...
	{
		case 280:
			TEXT_LABEL_ASSIGN_STRING(&uLocal_116, "DEAD", 32);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_124[0 /*8*/], "Dead_A", 32);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_124[1 /*8*/], "Dead_D", 32);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_124[2 /*8*/], "Dead_E", 32);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_124[3 /*8*/], "Dead_G", 32);
			uLocal_85[0 /*3*/] = { 14.613f, 8.4563f, 0.9751f };
			uLocal_85[1 /*3*/] = { 10.6489f, 8.6708f, 0.7701f };
			uLocal_85[2 /*3*/] = { 6.3982f, 1.4604f, 1.1f };
			uLocal_85[3 /*3*/] = { 4.2327f, 5.864f, 0.9f - 0.15f };
			uLocal_98[0 /*3*/] = { 0f, 0f, 23.047f };
			uLocal_98[1 /*3*/] = { 0f, 0f, 97.2582f };
			uLocal_98[2 /*3*/] = { 0f, 0f, 34.2158f };
			uLocal_98[3 /*3*/] = { 0f, 0f, 61.2158f };
			iLocal_76[0] = joaat("G_M_Y_Lost_01");
			iLocal_76[1] = joaat("G_M_Y_Lost_01");
			iLocal_76[2] = joaat("G_M_Y_Lost_02");
			iLocal_76[3] = joaat("G_M_Y_Lost_03");
			iLocal_157 = 2621440;
			uLocal_111[0] = 1;
			uLocal_111[1] = 1;
			uLocal_111[2] = 1;
			...
			uLocal_165[2] = 1110;
			uLocal_165[3] = 1110;
			uLocal_172[0 /*3*/] = { ({ 0.37364f, -1445.5344f, 2803.7603f } - uLocal_81) + { 0.1f, 0f, 0f } };
			uLocal_172[1 /*3*/] = { ({ 0.28778f, -1444.8633f, 2800.022f } - uLocal_81) + { 0.1f, 0f, 0f } };
			uLocal_172[2 /*3*/] = { ({ 0.6045f, -1452.4043f, 2795.9336f } - uLocal_81) + { 0.1f, 0f, 0f } };
			uLocal_172[3 /*3*/] = { ({ 0.28483f, -1448.0331f, 2794.3005f } - uLocal_81) + { 0.1f, 0f, 0f } };
			uLocal_165[4] = joaat("XMAS_LIVERY_8");
			uLocal_165[5] = joaat("XMAS_LIVERY_8");
			uLocal_172[4 /*3*/] = { ((uLocal_172[0 /*3*/] + uLocal_172[2 /*3*/]) / { 2f, 2f, 2f }) + { 0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(0.5f, 0.5f), MISC::GET_RANDOM_FLOAT_IN_RANGE(0.5f, 0.5f) } };
			uLocal_172[5 /*3*/] = { ((uLocal_172[1 /*3*/] + uLocal_172[2 /*3*/]) / { 2f, 2f, 2f }) + { 0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(0.5f, 0.5f), MISC::GET_RANDOM_FLOAT_IN_RANGE(0.5f, 0.5f) } };
			break;
	
		default:
			TEXT_LABEL_ASSIGN_STRING(&uLocal_116, "", 32);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_124[0 /*8*/], "", 32);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_124[1 /*8*/], "", 32);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_124[2 /*8*/], "", 32);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_124[3 /*8*/], "", 32);
			iLocal_76[0] = 0;
			uLocal_85[0 /*3*/] = { 0f, 0f, 0f };
			uLocal_98[0 /*3*/] = { 0f, 0f, 0f };
			iLocal_76[1] = 0;
			uLocal_85[1 /*3*/] = { 0f, 0f, 0f };
			uLocal_98[1 /*3*/] = { 0f, 0f, 0f };
			iLocal_76[2] = 0;
			uLocal_85[2 /*3*/] = { 0f, 0f, 0f };
			uLocal_98[2 /*3*/] = { 0f, 0f, 0f };
			iLocal_76[3] = 0;
			uLocal_85[3 /*3*/] = { 0f, 0f, 0f };
			uLocal_98[3 /*3*/] = { 0f, 0f, 0f };
			iLocal_157 = 0;
			uLocal_111[0] = -1;
			uLocal_111[1] = -1;
			uLocal_111[2] = -1;
...
void func_24(var uParam0, int iParam1, int iParam2, int iParam3, float fParam4, float fParam5, float fParam6, float fParam7) // Position - 0x408A Hash - 0xB67DDD9F ^0xE0258F09
{
...
void func_25(var uParam0) // Position - 0x40B4 Hash - 0x9000D55C ^0x3177311F
{
	func_24(uParam0, 145, joaat("SCRIPT_TASK_ANY"), joaat("SCRIPT_TASK_ANY"), 0f, 0f, 0f, 0f);
	return;
}

int func_26(int iParam0, var uParam1, var uParam2, char* sParam3) // Position - 0x40D2 Hash - 0x36DCAE2A ^0x59910E2E
{
	int num;
...
BOOL func_27(var uParam0) // Position - 0x42C5 Hash - 0xF5357FFC ^0xF5357FFC
{
	eCharacter character;
	Vector3 entityCoords;
	float num;
...
BOOL func_28(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x437D Hash - 0x2D46096D ^0xEA41378F
{
	if (bParam6)
...
BOOL func_29(int iParam0, var uParam1, char* sParam2) // Position - 0x43C4 Hash - 0xFB1BA30 ^0xD8DD3BD8
{
	var unk;
	int num;
	var unk4;
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_114370.f_2366.f_539.f_2310[0];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_33(Global_114370.f_2366.f_539.f_2314[0]), 32);
			return true;
	
		case 6:
			*uParam1 = Global_114370.f_2366.f_539.f_2310[1];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_33(Global_114370.f_2366.f_539.f_2314[1]), 32);
			return true;
	
		case 7:
			*uParam1 = Global_114370.f_2366.f_539.f_2310[2];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_33(Global_114370.f_2366.f_539.f_2314[2]), 32);
			return true;
...
BOOL func_30(int iParam0, int iParam1, var uParam2, var uParam3) // Position - 0x6894 Hash - 0x416CB035 ^0x416CB035
{
	switch (iParam1)
	{
		case 0:
...
BOOL _GET_RANDOM_BOOL() // Position - 0x87E4 Hash - 0x6E373505 ^0x528400E3
{
...
BOOL func_32(int iParam0, var uParam1, var uParam2) // Position - 0x8802 Hash - 0x6BF2FA05 ^0x6BF2FA05
{
	switch (iParam0)
	{
		case 11:
...
char* func_33(Hash hParam0) // Position - 0x9171 Hash - 0x1BC50098 ^0x1BC50098
{
	switch (hParam0)
	{
...
void func_34() // Position - 0x91FB Hash - 0x1D889E33 ^0xB4095A47
{
	int i;
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_116))
		STREAMING::REMOVE_ANIM_DICT(&uLocal_116);

	for (i = 0; i < iLocal_158; i = i + 1)
	{
		GRAPHICS::IS_DECAL_ALIVE(iLocal_158[i]);
	}
