#region Local Var
	...
	Ped pedLocal_315 = 0;
	Ped pedLocal_316 = 0;
	Vehicle veLocal_317 = 0;
	Vehicle veLocal_318 = 0;
	Vehicle veLocal_319 = 0;
	Vehicle veLocal_320 = 0;
	Blip blLocal_321 = 0;
	Blip blLocal_322 = 0;
	Blip blLocal_323 = 0;
	Blip blLocal_324 = 0;
	...
	var uLocal_335 = 0;
	var uLocal_336 = 0;
	Object obLocal_337 = 0;
	Object obLocal_338 = 0;
	BOOL bLocal_339 = 0;
	BOOL bLocal_340 = 0;
	BOOL bLocal_341 = 0;
	BOOL bLocal_342 = 0;
...
void main() // Position - 0x0 Hash - 0x5D84F89F ^0x5D84F89F
{
	...
	fLocal_298 = 160f;
	iLocal_302 = 55000;
	uLocal_309 = { 30f, 30f, 5f };
	iLocal_350 = -1;
	uLocal_521 = { -458.4085f, -984.6459f, 22.5892f };
	fLocal_524 = { -458.1934f, -995.4897f, 22.7427f };
	uLocal_303 = { uScriptParam_0.f_1[0 /*3*/] };
	...
	if (func_140(uLocal_303, -1, 0, false, false))
		func_137(-1);
	else
		SCRIPT::TERMINATE_THIS_THREAD();
	...
	while (true)
	{
		...
		if (BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
		{
			...
			switch (iLocal_299)
			{
				...
				case 2:
					if (ENTITY::DOES_ENTITY_EXIST(pedLocal_315) && PED::IS_PED_DEAD_OR_DYING(pedLocal_315, true) && iLocal_346 < 5 && !bLocal_343)
						func_13();
...
void func_1() // Position - 0x1CF Hash - 0xEC77ECDA ^0x17E9215B
{
	if (bLocal_532 && !bLocal_533)
	{
		AUDIO::TRIGGER_MUSIC_EVENT("RE14A_FAIL");
	
		for (iLocal_345 = 0; iLocal_345 < 11; iLocal_345 = iLocal_345 + 1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uLocal_325[iLocal_345]))
				ENTITY::FREEZE_ENTITY_POSITION(uLocal_325[iLocal_345], false);
		}
	
		if (!ENTITY::IS_ENTITY_DEAD(veLocal_317, false))
		{
			VEHICLE::SET_VEHICLE_ENGINE_HEALTH(veLocal_317, 0f);
			ENTITY::FREEZE_ENTITY_POSITION(veLocal_317, false);
		}
	
		if (ENTITY::DOES_ENTITY_EXIST(obLocal_337))
			ENTITY::FREEZE_ENTITY_POSITION(obLocal_337, false);
	
		CAM::RENDER_SCRIPT_CAMS(false, false, 3000, true, false, 0);
		PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), true, 0);
		HUD::DISPLAY_RADAR(true);
		HUD::DISPLAY_HUD(true);
		func_2(false, true, true, false, false, false, false);
		bLocal_340 = true;
		MISC::SET_TIME_SCALE(1f);
		STREAMING::REMOVE_ANIM_DICT("re@construction");
	
		if (CAM::DOES_CAM_EXIST(caLocal_527))
		{
			CAM::DESTROY_CAM(caLocal_527, false);
			CAM::RENDER_SCRIPT_CAMS(false, false, 3000, true, false, 0);
		...
		if (HUD::DOES_BLIP_EXIST(blLocal_323))
			HUD::REMOVE_BLIP(&blLocal_323);
	
		if (HUD::DOES_BLIP_EXIST(blLocal_324))
			HUD::REMOVE_BLIP(&blLocal_324);
	
		bLocal_533 = true;
	}

	if (ENTITY::DOES_ENTITY_EXIST(uLocal_325[0]) || ENTITY::DOES_ENTITY_EXIST(uLocal_325[1]))
		if (!CAM::IS_SPHERE_VISIBLE(uLocal_306 + { 20f, 0f, 0f }, 30f) && !ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), uLocal_306, 80f, 80f, 80f, false, true, 0))
			func_182();

	return;
}

void func_2(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x372 Hash - 0x787E640E ^0x67C15509
{
	if (bParam0)
	{
		...
		func_10(true, bParam3, bParam2, false);
		Global_64044 = true;
		Global_76372 = true;
		Global_79246 = true;
	}
	else
	{
		...
		func_10(false, bParam3, bParam2, false);
...
BOOL func_3() // Position - 0x4BF Hash - 0xAA7793E3 ^0x3F62CDC8
{
	return IS_BIT_SET(Global_1845263[PLAYER::PLAYER_ID() /*877*/].f_36.f_18, 14);
}

BOOL func_4(Player plParam0, int iParam1) // Position - 0x4D9 Hash - 0x1A32E11A ^0x6AADE226
{
	BOOL flag;
	...
	if (plParam0 == PLAYER::PLAYER_ID())
		flag = func_5(-1, false) == CHAR_MIKE_FRANK_CONF;
	else
...
eCharacter func_5(int iParam0, BOOL bParam1) // Position - 0x532 Hash - 0x1DCD393E ^0x1DCD393E
{
...
int func_6() // Position - 0x573 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1574925;
}

BOOL func_7(Player plParam0) // Position - 0x57F Hash - 0x6A46C9B4 ^0x6A46C9B4
{
	Player player;
...
BOOL func_8(Player plParam0) // Position - 0x5A1 Hash - 0x68897CDD ^0x62820466
{
	if (func_4(plParam0, 0))
		return true;
...
BOOL func_9() // Position - 0x5E0 Hash - 0xA525B2F4 ^0xA525B2F4
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_10(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x5EE Hash - 0x3167F4C7 ^0xCE6B9B6A
{
	int num;
...
BOOL func_11() // Position - 0x621 Hash - 0xD140D54A ^0xE638D98F
{
...
void func_12(int iParam0) // Position - 0x648 Hash - 0x1B2EEE72 ^0xEDBC1F9D
{
	if (iParam0 == 1)
...
void func_13() // Position - 0x66B Hash - 0xC5F1AB23 ^0x9FAAD7C1
{
	if (iLocal_350 == -1)
	...
	{
		if (ENTITY::DOES_ENTITY_EXIST(veLocal_317))
		{
			ENTITY::FREEZE_ENTITY_POSITION(veLocal_317, false);
			ENTITY::APPLY_FORCE_TO_ENTITY(veLocal_317, 0, 0f, 0f, 50f, 0f, 0f, 0f, 0, true, true, true, false, true);
		
			if (!ENTITY::IS_ENTITY_DEAD(veLocal_317, false))
				VEHICLE::EXPLODE_VEHICLE(veLocal_317, true, false);
		}
	}
...
void func_14() // Position - 0x6CD Hash - 0x80A09607 ^0x22BAA323
{
...
void func_15() // Position - 0x6F1 Hash - 0x20A699E1 ^0xA7519398
{
	int i;
	Vector3 outPosition;
	float num;
	...
	if (bLocal_220 == false)
	{
		if (FIRE::GET_CLOSEST_FIRE_POS(&outPosition, iLocal_227[0 /*5*/]))
		{
			num = 0f;
			num3 = 999999f;
		
			for (i = 0; i < iLocal_227; i = i + 1)
			{
				if (i > 0)
					num = num + MISC::GET_DISTANCE_BETWEEN_COORDS(iLocal_227[i - 1 /*5*/], iLocal_227[i /*5*/], true);
			
				if (iLocal_227[i /*5*/].f_4)
				{
					if (FIRE::GET_CLOSEST_FIRE_POS(&outPosition, iLocal_227[i /*5*/]))
					{
						distanceBetweenCoords = MISC::GET_DISTANCE_BETWEEN_COORDS(iLocal_227[i /*5*/], outPosition, true);
			...
			if (num3 < fLocal_55)
			{
				...
				if (iLocal_225 >= iLocal_227 * 2)
					iLocal_225 = (iLocal_227 * 2) - 1;
			}
		}
	}
	...
	if (bLocal_220 == true)
	{
		...
		num5 = SYSTEM::TO_FLOAT(MISC::GET_GAME_TIMER() - iLocal_222) / fLocal_298;
		num6 = SYSTEM::FLOOR(num5 / 1f / 2f) - 1;
		num7 = iLocal_223 + num6;
		num8 = iLocal_223 - num6;
		...
		if (num7 > iLocal_225)
		{
			for (i = iLocal_225 + 1; i <= num7; i = i + 1)
			{
				num9 = i / 2;
			
				if (num9 < iLocal_227)
				{
					if (iLocal_227[num9 /*5*/].f_4)
					{
						func_16(i, true);
					}
					else
		...
		if (num8 < iLocal_226)
		{
			for (i = iLocal_226 - 1; i >= num8; i = i + -1)
			{
				num9 = i / 2;
		...
		for (i = 0; i < iLocal_64; i = i + 1)
		{
			if (MISC::GET_GAME_TIMER() - iLocal_64[i /*5*/].f_4 > 1000)
				GRAPHICS::FADE_DECALS_IN_RANGE(iLocal_64[i /*5*/].f_1, 0.4f, 1f);
		
			if (MISC::GET_GAME_TIMER() - iLocal_64[i /*5*/].f_4 > 6000)
				FIRE::REMOVE_SCRIPT_FIRE(iLocal_64[i /*5*/]);
		}
	}
...
void func_16(int iParam0, BOOL bParam1) // Position - 0x929 Hash - 0xD119AFCC ^0xD119AFCC
{
	int num;
	...
	if (iParam0 >= 0)
	{
		if (iParam0 % 2 == 1)
		{
			...
			if (num + 1 < 14)
				func_17(((iLocal_227[iParam0 / 2 /*5*/] + iLocal_227[(iParam0 / 2) + 1 /*5*/]) / { 2f, 2f, 2f }) + { fLocal_56, fLocal_56, fLocal_56 }, bParam1);
		}
		else if (iParam0 / 2 < 14)
		{
			func_17(iLocal_227[iParam0 / 2 /*5*/] + { fLocal_56, fLocal_56, fLocal_56 }, bParam1);
		}
	}
...
void func_17(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x992 Hash - 0x7DE4E0AC ^0xC7BA34ED
{
	if (iLocal_221 == 0)
		bParam3 = false;

	FIRE::REMOVE_SCRIPT_FIRE(iLocal_64[iLocal_224 /*5*/]);

	if (iLocal_64[iLocal_224 /*5*/].f_4 != 0)
		GRAPHICS::FADE_DECALS_IN_RANGE(iLocal_64[iLocal_224 /*5*/].f_1, 0.4f, 1f);

	iLocal_64[iLocal_224 /*5*/].f_4 = MISC::GET_GAME_TIMER();
	iLocal_64[iLocal_224 /*5*/].f_1 = { vParam0 };
	iLocal_64[iLocal_224 /*5*/] = FIRE::START_SCRIPT_FIRE(vParam0, iLocal_53, bParam3);
...
void func_18() // Position - 0xA09 Hash - 0xA4A76592 ^0x68211A17
{
	int i;
	int weaponHash;
	float distanceBetweenCoords;
			...
			if (PAD::IS_CONTROL_PRESSED(PLAYER_CONTROL, INPUT_ATTACK) && PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
			{
				...
				if (MISC::GET_GAME_TIMER() > iLocal_54)
				{
					if (!bLocal_44)
					{
						...
						for (i = 0; i < iLocal_227; i = i + 1)
						{
							if (HUD::DOES_BLIP_EXIST(iLocal_227[i /*5*/].f_3))
							{
								distanceBetweenCoords = MISC::GET_DISTANCE_BETWEEN_COORDS(uLocal_57, HUD::GET_BLIP_COORDS(iLocal_227[i /*5*/].f_3), true);
								distanceBetweenCoords2 = MISC::GET_DISTANCE_BETWEEN_COORDS(iLocal_227[i /*5*/], HUD::GET_BLIP_COORDS(iLocal_227[i /*5*/].f_3), true);
							
								if (distanceBetweenCoords2 == 0f || distanceBetweenCoords < distanceBetweenCoords2)
									if (distanceBetweenCoords < 2f)
										iLocal_227[i /*5*/] = { uLocal_57 };
						...
						if (num < 2f)
						{
							if (iLocal_50 != -1)
							{
								if (MISC::ABSI(iLocal_51 - num2) > 1)
									iLocal_51 = -1;
							
								if (iLocal_51 == -1)
									iLocal_51 = iLocal_50;
							
								if (MISC::ABSI(iLocal_51 - num2) < 3 && MISC::ABSI(iLocal_51 - num2) > 0)
								{
									if (iLocal_51 < num2)
									{
										for (j = iLocal_51; j <= num2 - 1; j = j + 1)
										{
											if (HUD::DOES_BLIP_EXIST(iLocal_227[j /*5*/].f_3))
											{
												if (HUD::GET_BLIP_ALPHA(iLocal_227[j /*5*/].f_3) > 0)
												{
													HUD::SET_BLIP_ALPHA(iLocal_227[j /*5*/].f_3, 0);
													iLocal_227[j /*5*/].f_4 = 1;
									...
									{
										for (j = num2 + 1; j <= iLocal_51; j = j + 1)
										{
											if (HUD::DOES_BLIP_EXIST(iLocal_227[j /*5*/].f_3))
											{
												if (HUD::GET_BLIP_ALPHA(iLocal_227[j /*5*/].f_3) > 0)
								...
								if (num2 == 0)
								{
									if (HUD::DOES_BLIP_EXIST(iLocal_227[num2 /*5*/].f_3))
									{
										if (HUD::GET_BLIP_ALPHA(iLocal_227[num2 /*5*/].f_3) > 0)
										{
											HUD::SET_BLIP_ALPHA(iLocal_227[num2 /*5*/].f_3, 0);
											iLocal_227[num2 /*5*/].f_4 = 1;
											iLocal_52 = iLocal_52 - 1;
										}
									}
								}
								...
								if (num2 < 13)
								{
									if (_IS_NULL_VECTOR(iLocal_227[num2 + 1 /*5*/]))
									{
										if (HUD::DOES_BLIP_EXIST(iLocal_227[num2 /*5*/].f_3))
										{
											if (HUD::GET_BLIP_ALPHA(iLocal_227[num2 /*5*/].f_3) > 0)
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0xCDE Hash - 0x16E871AD ^0x10C54C39
{
...
Vector3 func_20() // Position - 0xD08 Hash - 0x9643C622 ^0xC48176B0
{
...
void func_21() // Position - 0xD78 Hash - 0x8B6163E7 ^0xC8C57670
{
	int i;
...
void func_22() // Position - 0xDF1 Hash - 0xDE604780 ^0xDE604780
{
	if (!bLocal_47)
		bLocal_47 = true;
...
void func_23() // Position - 0xE02 Hash - 0x9D501811 ^0x548838DC
{
	switch (iLocal_300)
	{
		case 0:
			...
			if (uLocal_535.f_32 <= 0)
				uLocal_535.f_32 = MISC::GET_FRAME_COUNT();
		
			func_113(&uLocal_535, joaat("S_M_M_DockWork_01"));
			func_113(&uLocal_535, joaat("prop_generator_01a"));
			func_113(&uLocal_535, joaat("p_amb_phone_01"));
			func_110(&uLocal_535);
		
			if (AUDIO::REQUEST_SCRIPT_AUDIO_BANK("CONSTRUCTION_ACCIDENT_1", false, -1) && STREAMING::HAS_ANIM_DICT_LOADED("re@construction") && func_106(&uLocal_535))
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_317, false))
				{
					pedLocal_315 = PED::CREATE_PED_INSIDE_VEHICLE(veLocal_317, PED_TYPE_MISSION, joaat("S_M_M_DockWork_01"), -1, true, true);
					PED::SET_PED_COMPONENT_VARIATION(pedLocal_315, PV_COMP_HEAD, 1, 0, 0);
					PED::SET_PED_COMPONENT_VARIATION(pedLocal_315, PV_COMP_UPPR, 1, 1, 0);
					PED::SET_PED_COMPONENT_VARIATION(pedLocal_315, PV_COMP_LOWR, 0, 1, 0);
					PED::SET_PED_COMPONENT_VARIATION(pedLocal_315, PV_COMP_ACCS, 0, 0, 0);
					TASK::TASK_PLAY_ANIM(pedLocal_315, "re@construction", "idle_c", 1000f, -1000f, -1, 49, 0.4f, false, false, false);
					obLocal_338 = OBJECT::CREATE_OBJECT(joaat("p_amb_phone_01"), -455.6561f, -985.8071f, 22.4868f, true, true, false);
					STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("p_amb_phone_01"));
					ENTITY::ATTACH_ENTITY_TO_ENTITY(obLocal_338, pedLocal_315, PED::GET_PED_BONE_INDEX(pedLocal_315, 28422), 0f, 0f, 0f, 0f, 0f, 0f, false, false, false, false, 2, true, 0);
					PED::SET_PED_COMBAT_ATTRIBUTES(pedLocal_315, BF_AlwaysFlee, true);
					PED::SET_PED_STAY_IN_VEHICLE_WHEN_JACKED(pedLocal_315, true);
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(pedLocal_315, true);
					PED::SET_PED_CAN_BE_TARGETTED(pedLocal_315, false);
					_CONVERSATION_INITIALIZE_ACTOR(&uLocal_356, 3, pedLocal_315, "RECONACWorker", 0, 1);
					AUDIO::SET_AMBIENT_VOICE_NAME(pedLocal_315, "S_M_Y_GENERICWORKER_01_WHITE_01");
					pedLocal_316 = PED::CREATE_PED(PED_TYPE_MISSION, joaat("S_M_M_DockWork_01"), -462.2982f, -978.3272f, 65f, 221.4041f, true, true);
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(pedLocal_316, true);
					ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(pedLocal_316, true, 1);
					ENTITY::FREEZE_ENTITY_POSITION(pedLocal_316, true);
					EVENT::SET_DECISION_MAKER(pedLocal_315, joaat("empty"));
					EVENT::CLEAR_DECISION_MAKER_EVENT_RESPONSE(joaat("empty"), EVENT_FIRE_NEARBY);
					EVENT::CLEAR_DECISION_MAKER_EVENT_RESPONSE(joaat("empty"), EVENT_ON_FIRE);
					EVENT::CLEAR_DECISION_MAKER_EVENT_RESPONSE(joaat("empty"), EVENT_POTENTIAL_WALK_INTO_FIRE);
					EVENT::CLEAR_DECISION_MAKER_EVENT_RESPONSE(joaat("empty"), EVENT_VEHICLE_ON_FIRE);
					EVENT::CLEAR_DECISION_MAKER_EVENT_RESPONSE(joaat("empty"), EVENT_PED_TO_FLEE);
					obLocal_337 = OBJECT::CREATE_OBJECT(joaat("prop_generator_01a"), fLocal_524, fLocal_524.f_1 + 0.5f, fLocal_524.f_2 - 0.25f, true, true, false);
					ENTITY::SET_ENTITY_HEADING(obLocal_337, 75f);
					ENTITY::SET_ENTITY_PROOFS(obLocal_337, false, true, true, false, false, false, false, false);
					iLocal_531 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_sparking_generator", obLocal_337, 0f, 0f, 0.2f, 0f, 0f, 0f, 1065353216, false, false, false);
					ENTITY::FREEZE_ENTITY_POSITION(obLocal_337, true);
		...
		case 1:
			...
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				if (!bLocal_340)
				{
					if (!PED::IS_PED_INJURED(pedLocal_315))
					{
						if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -532.2208f, -849.2668f, 19.7038f, -531.6973f, -1065.341f, 60.7893f, 190.8125f, false, true, 0))
							if (!ENTITY::IS_ENTITY_DEAD(veLocal_317, false))
								if (!HUD::DOES_BLIP_EXIST(blLocal_322))
									blLocal_322 = func_98(veLocal_317, false, false);
					
						if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedLocal_315, PLAYER::PLAYER_PED_ID(), true) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(veLocal_317, PLAYER::PLAYER_PED_ID(), true))
						{
							ENTITY::FREEZE_ENTITY_POSITION(veLocal_317, false);
							TASK::CLEAR_PED_TASKS(pedLocal_315);
							...
							TASK::TASK_PERFORM_SEQUENCE(pedLocal_315, iLocal_355);
						...
						if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), -473.1686f, -984.6405f, 22.487f, 40f, 40f, 5f, false, true, 0) && !PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()) && func_96(true, false, true) && STREAMING::HAS_MODEL_LOADED(joaat("prop_ld_pipe_single_01")))
						{
							if (!func_136())
							{
								if (!ENTITY::IS_ENTITY_DEAD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), false))
									veLocal_320 = PLAYER::GET_PLAYERS_LAST_VEHICLE();
				...
				else
				{
					if (!PED::IS_PED_INJURED(pedLocal_315))
					{
						if (PED::IS_PED_IN_ANY_VEHICLE(pedLocal_315, false))
						{
							if (!ENTITY::IS_ENTITY_DEAD(veLocal_317, false) && !HUD::DOES_BLIP_EXIST(blLocal_322))
								blLocal_322 = func_98(veLocal_317, false, false);
						}
						else if (!HUD::DOES_BLIP_EXIST(blLocal_321))
						{
							if (HUD::DOES_BLIP_EXIST(blLocal_322))
								HUD::REMOVE_BLIP(&blLocal_322);
						
							blLocal_321 = func_83(pedLocal_315, false, 145);
						}
					}
					...
					if (!PED::IS_PED_INJURED(pedLocal_315))
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), pedLocal_315, uLocal_309, false, true, 0))
							if (!bLocal_341)
								func_49();
					}
					else
					{
						...
						if (PED::IS_PED_INJURED(pedLocal_315) || ENTITY::IS_ENTITY_DEAD(veLocal_317, false))
							func_97();
					}
				
					if (!VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_318, false))
					{
						if (HUD::DOES_BLIP_EXIST(blLocal_323))
						{
							HUD::REMOVE_BLIP(&blLocal_323);
					...
					if (iLocal_351 >= 3)
					{
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && PED::IS_PED_IN_MODEL(PLAYER::PLAYER_PED_ID(), joaat("bulldozer")))
						{
							if (HUD::DOES_BLIP_EXIST(blLocal_323))
							{
								...
								if (!PED::IS_PED_INJURED(pedLocal_315) && !ENTITY::IS_ENTITY_DEAD(veLocal_317, false))
									if (PED::IS_PED_IN_ANY_VEHICLE(pedLocal_315, false) && !HUD::DOES_BLIP_EXIST(blLocal_322))
										blLocal_322 = func_98(veLocal_317, false, false);
							}
						}
						else if (!PED::IS_PED_INJURED(pedLocal_315) && !ENTITY::IS_ENTITY_DEAD(veLocal_317, false))
						{
							if (PED::IS_PED_IN_ANY_VEHICLE(pedLocal_315, false) && HUD::DOES_BLIP_EXIST(blLocal_322))
							{
								HUD::REMOVE_BLIP(&blLocal_322);
								...
								if (!HUD::DOES_BLIP_EXIST(blLocal_323))
									blLocal_323 = func_98(veLocal_318, false, false);
							}
						}
					}
				}
				...
				if (!ENTITY::IS_ENTITY_DEAD(veLocal_317, false))
				{
					if (FIRE::IS_ENTITY_ON_FIRE(veLocal_317))
					{
						for (iLocal_345 = 0; iLocal_345 < 11; iLocal_345 = iLocal_345 + 1)
						{
							if (ENTITY::DOES_ENTITY_EXIST(uLocal_325[iLocal_345]))
						...
						if (!PED::IS_PED_INJURED(pedLocal_315))
						{
							...
							{
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(pedLocal_315, true);
								PED::SET_PED_CONFIG_FLAG(pedLocal_315, 116, false);
								PED::SET_PED_CONFIG_FLAG(pedLocal_315, 29, false);
							
								if (!bLocal_343)
								{
									func_47();
									SYSTEM::WAIT(0);
									_CONVERSATION_ADD_LINE(&uLocal_356, "CONACAU", "CONAC_DIE", 4, 0, 0, 0);
								...
								if (!PED::IS_PED_INJURED(pedLocal_315))
									ENTITY::SET_ENTITY_HEALTH(pedLocal_315, 99, 0, 0);
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x156D Hash - 0x152DA0B2 ^0x220E93E9
{
...
int _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x158F Hash - 0x384540C1 ^0x384540C1
{
	func_46(uParam0, _CHAR_NULL, sParam1, iParam4, iParam5, iParam6);
...
int func_26(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x15DD Hash - 0x77297D51 ^0x40DC584A
{
	Global_22167 = 0;
...
void func_27() // Position - 0x18AB Hash - 0xF42BEB19 ^0xA29557DA
{
	if (!func_28())
		return;
...
BOOL func_28() // Position - 0x18E2 Hash - 0x7B74B45F ^0xCE052A5D
{
...
BOOL func_29(Player plParam0) // Position - 0x1945 Hash - 0x6E46BC72 ^0x6E46BC72
{
	return func_30(plParam0, 20);
}

BOOL func_30(Player plParam0, int iParam1) // Position - 0x1955 Hash - 0x7CD5054C ^0x870BEA81
{
	return IS_BIT_SET(Global_1886967[plParam0 /*609*/].f_10.f_4, iParam1);
}

Player _INVALID_PLAYER_INDEX() // Position - 0x196D Hash - 0x478900E4 ^0x478900E4
{
	return -1;
}

void func_32() // Position - 0x1976 Hash - 0x6056DAC ^0xEDC10140
{
	int i;
...
void func_33() // Position - 0x19A7 Hash - 0xCD8A4D28 ^0xCD8A4D28
{
...
BOOL func_34() // Position - 0x1A3C Hash - 0x9A999369 ^0x4033F7BF
{
	int num;
	int weaponHash;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x1AD5 Hash - 0x98476CE1 ^0x250FEB7C
{
	if (func_42(14))
	{
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x1B77 Hash - 0x3C5423D7 ^0x3C5423D7
{
	func_37();
	return Global_114370.f_2366.f_539.f_4321;
}

void func_37() // Position - 0x1B90 Hash - 0xD1F2D853 ^0xF9F5FD4D
{
	eCharacter character;
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114370.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_38(character) && !func_42(14) || Global_113320)
			{
...
BOOL func_38(eCharacter echParam0) // Position - 0x1C8D Hash - 0x8907F004 ^0x8907F004
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x1C99 Hash - 0xAC4E9801 ^0xB379A75F
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x1CD6 Hash - 0xADCB9755 ^0xADCB9755
{
...
Hash func_41(eCharacter echParam0) // Position - 0x1CFB Hash - 0xE4CEEC2C ^0xE4CEEC2C
{
	return Global_2139[echParam0 /*29*/];
}

BOOL func_42(int iParam0) // Position - 0x1D0A Hash - 0x937D8816 ^0x937D8816
{
	return Global_43922 == iParam0;
}

void func_43() // Position - 0x1D18 Hash - 0x989CDED ^0xD019AD27
{
	int i;
...
BOOL func_44(int iParam0, int iParam1) // Position - 0x1D6F Hash - 0xA14C4D3F ^0xA6034F77
{
	switch (iParam0)
	{
		case 5:
...
void func_45() // Position - 0x1DA7 Hash - 0xE32CF1EF ^0xB9A7BEB2
{
...
void func_46(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x1DFE Hash - 0xC6B752B2 ^0xC6B752B2
{
...
void func_47() // Position - 0x1E54 Hash - 0xC536DD5 ^0xC536DD5
{
	Global_21032 = 0;
	func_48();
	return;
...
void func_48() // Position - 0x1E64 Hash - 0xF6D04E68 ^0x80AE5309
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_23177 = 0;
...
void func_49() // Position - 0x1E85 Hash - 0xA7EC3101 ^0xBCA91365
{
	switch (iLocal_351)
	{
		case 0:
			if (!PED::IS_PED_INJURED(pedLocal_315))
			{
				...
				{
					_CONVERSATION_ADD_LINE(&uLocal_356, "CONACAU", "CONAC_HELP", 4, 0, 0, 0);
		...
		case 2:
			if (!PED::IS_PED_INJURED(pedLocal_315))
			{
				if (MISC::GET_GAME_TIMER() - iLocal_349 > 5000 && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
						hLocal_354 = ENTITY::GET_ENTITY_MODEL(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false));
					...
					if (PED::IS_PED_IN_ANY_VEHICLE(pedLocal_315, false))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_318, false))
						{
							...
							else if (!HUD::DOES_BLIP_EXIST(blLocal_323))
							{
								blLocal_323 = func_98(veLocal_318, false, false);
					...
					if (hLocal_354 == joaat("bulldozer"))
						_CONVERSATION_ADD_LINE(&uLocal_356, "CONACAU", "CONAC_HELP2", 4, 0, 0, 0);
					else
						_CONVERSATION_ADD_LINE(&uLocal_356, "CONACAU", "CONAC_HELP3", 4, 0, 0, 0);
		...
		case 3:
			if (MISC::GET_GAME_TIMER() - iLocal_349 > MISC::GET_RANDOM_INT_IN_RANGE(5000, 8000))
			{
				...
				{
					_CONVERSATION_ADD_LINE(&uLocal_356, "CONACAU", "CONAC_HURRY", 4, 0, 0, 0);
					iLocal_349 = MISC::GET_GAME_TIMER();
				}
			}
			break;
...
void func_50() // Position - 0x205B Hash - 0xD4DF4A06 ^0x155F766C
{
	switch (iLocal_347)
	{
		case 0:
			GRAPHICS::ADD_PETROL_DECAL(fLocal_524 + { 0f, 1f, 0f }, 1f, 1f, 1f);
			SYSTEM::WAIT(0);
			GRAPHICS::START_PETROL_TRAIL_DECALS(1f);
			GRAPHICS::ADD_PETROL_TRAIL_DECAL_INFO(uLocal_521, 1f);
			SYSTEM::WAIT(0);
			GRAPHICS::ADD_PETROL_TRAIL_DECAL_INFO(uLocal_521 - { 0f, 4f, 0f }, 1f);
			SYSTEM::WAIT(0);
			GRAPHICS::ADD_PETROL_TRAIL_DECAL_INFO(uLocal_521 - { 0f, 8f, 0f }, 1f);
			SYSTEM::WAIT(0);
			GRAPHICS::ADD_PETROL_TRAIL_DECAL_INFO(fLocal_524, 1f);
		...
		case 2:
			if (MISC::GET_GAME_TIMER() - iLocal_353 > iLocal_302 || func_52())
			{
				...
				if (!bLocal_343)
				{
					if (!PED::IS_PED_INJURED(pedLocal_315) && !ENTITY::IS_ENTITY_DEAD(veLocal_317, false))
					{
						if (!VEHICLE::IS_ENTRY_POINT_FOR_SEAT_CLEAR(pedLocal_315, veLocal_317, -1, false, false) && !VEHICLE::IS_ENTRY_POINT_FOR_SEAT_CLEAR(pedLocal_315, veLocal_317, 0, false, false))
						{
							func_47();
							SYSTEM::WAIT(0);
							_CONVERSATION_ADD_LINE(&uLocal_356, "CONACAU", "CONAC_DIE", 4, 0, 0, 0);
				...
				MISC::CREATE_INCIDENT(DT_FireDepartment, -539.4481f, -962.3162f, 22.4918f, 4, 0f, &uLocal_530, 0, 0);
				SYSTEM::SETTIMERA(0);
				iLocal_347 = 3;
			}
			break;
		...
		case 3:
			if (ENTITY::DOES_ENTITY_EXIST(veLocal_317))
				!FIRE::IS_ENTITY_ON_FIRE(veLocal_317);
...
void func_51() // Position - 0x223E Hash - 0x75B8A4F5 ^0x75B8A4F5
{
	bLocal_46 = true;
	return;
}

BOOL func_52() // Position - 0x2249 Hash - 0xADD1C343 ^0xADD1C343
{
	if (bLocal_220 == true)
		return true;
...
void func_53() // Position - 0x225C Hash - 0x5097CA3A ^0xA9105315
{
	Vector3 vector;
	...
	switch (iLocal_346)
	{
		case 0:
			if (iLocal_351 >= 2)
			{
				if (!PED::IS_PED_INJURED(pedLocal_315) && !ENTITY::IS_ENTITY_DEAD(veLocal_317, false))
				{
					...
					OBJECT::DELETE_OBJECT(&obLocal_338);
				
					if (VEHICLE::IS_ENTRY_POINT_FOR_SEAT_CLEAR(pedLocal_315, veLocal_317, -1, false, false) || VEHICLE::IS_ENTRY_POINT_FOR_SEAT_CLEAR(pedLocal_315, veLocal_317, 0, false, false))
					{
						if (VEHICLE::IS_ENTRY_POINT_FOR_SEAT_CLEAR(pedLocal_315, veLocal_317, -1, false, false))
						{
							bLocal_342 = true;
							uLocal_312 = { ENTITY::GET_ENTITY_COORDS(veLocal_317, false) + { 0f, -1f, -3f } };
						}
						else
						{
							uLocal_312 = { ENTITY::GET_ENTITY_COORDS(veLocal_317, false) + { 0f, 1.5f, -3f } };
						}
					
						if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), uLocal_312, 4.2f, 4f, 5f, false, true, 0))
						{
							if (!bLocal_341)
							{
								func_47();
								SYSTEM::WAIT(0);
								_CONVERSATION_ADD_LINE(&uLocal_356, "CONACAU", "CONAC_FREE", 4, 0, 0, 0);
								bLocal_341 = true;
							}
						}
						else
		...
		case 1:
			if (!PED::IS_PED_INJURED(pedLocal_315) && !ENTITY::IS_ENTITY_DEAD(veLocal_317, false))
			{
				if (!ENTITY::IS_ENTITY_DEAD(veLocal_318, false))
					ENTITY::SET_ENTITY_PROOFS(veLocal_318, false, true, true, false, false, false, false, false);
			
				ENTITY::SET_ENTITY_PROOFS(pedLocal_315, false, true, false, false, false, false, false, false);
				ENTITY::FREEZE_ENTITY_POSITION(veLocal_317, false);
				TASK::OPEN_SEQUENCE_TASK(&iLocal_355);
				...
				TASK::TASK_PERFORM_SEQUENCE(pedLocal_315, iLocal_355);
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_355);
				PED::SET_PED_KEEP_TASK(pedLocal_315, true);
				iLocal_349 = MISC::GET_GAME_TIMER();
				iLocal_346 = iLocal_346 + 1;
			}
			break;
		...
		case 2:
			if (!PED::IS_PED_INJURED(pedLocal_315))
			{
				if (MISC::GET_GAME_TIMER() - iLocal_349 > 500 && !PED::IS_PED_IN_ANY_VEHICLE(pedLocal_315, false))
				{
					iLocal_302 = 0;
					VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_317, false);
					func_47();
					SYSTEM::WAIT(0);
					_CONVERSATION_ADD_LINE(&uLocal_356, "CONACAU", "CONAC_BOOM", 4, 0, 0, 0);
					iLocal_349 = MISC::GET_GAME_TIMER();
					iLocal_346 = iLocal_346 + 1;
				}
			}
		...
		case 3:
			if (!PED::IS_PED_INJURED(pedLocal_315))
			{
				if (ENTITY::IS_ENTITY_AT_COORD(pedLocal_315, -464.7217f, -989.7214f, 22.4867f, 3f, 10f, 3f, false, true, 0) || MISC::GET_GAME_TIMER() - iLocal_349 > 10000)
				{
					_CONVERSATION_ADD_LINE(&uLocal_356, "CONACAU", "CONAC_AAAH", 4, 0, 0, 0);
					iLocal_346 = iLocal_346 + 1;
				}
			}
			break;
		...
		case 4:
			if (!PED::IS_PED_INJURED(pedLocal_315))
			{
				if (ENTITY::IS_ENTITY_AT_COORD(pedLocal_315, -472.7056f, -991.105f, 22.4867f, 3f, 30f, 3f, false, true, 0) || MISC::GET_GAME_TIMER() - iLocal_349 > 10000)
				{
					if (!ENTITY::IS_ENTITY_DEAD(veLocal_317, false))
					{
						ENTITY::FREEZE_ENTITY_POSITION(veLocal_317, false);
		...
		case 5:
			if (MISC::GET_GAME_TIMER() - iLocal_349 > 3000)
			{
				...
				if (!PED::IS_PED_INJURED(pedLocal_315))
				{
					...
					if (!ENTITY::IS_ENTITY_DEAD(veLocal_318, false))
						ENTITY::SET_ENTITY_PROOFS(veLocal_318, false, false, false, false, false, false, false, false);
				
					ENTITY::SET_ENTITY_PROOFS(pedLocal_315, false, false, false, false, false, false, false, false);
					PED::SET_PED_CAN_RAGDOLL(pedLocal_315, true);
					PED::SET_PED_CAN_BE_TARGETTED(pedLocal_315, true);
					PED::SET_PED_STAY_IN_VEHICLE_WHEN_JACKED(pedLocal_315, false);
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(pedLocal_315, false);
					EVENT::SET_DECISION_MAKER(pedLocal_315, joaat("DEFAULT"));
					TASK::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
					TASK::OPEN_SEQUENCE_TASK(&iLocal_355);
					TASK::TASK_PLAY_ANIM(0, "re@construction", "Out_Of_Breath", 2f, -2f, -1, 0, 0, false, false, false);
		...
		case 6:
			if (!PED::IS_PED_INJURED(pedLocal_315))
			{
				...
				{
					vector = { -477.2774f, -990.0638f, 23.5497f };
					...
					if (ENTITY::DOES_ENTITY_EXIST(PLAYER::GET_PLAYERS_LAST_VEHICLE()))
						if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), -477.2774f, -990.0638f, 23.5497f, 3f, 3f, 3f, false, true, 0))
							vector = { -477.7884f, -996.3974f, 23.5503f };
				
					if (ENTITY::DOES_ENTITY_EXIST(veLocal_320))
						if (ENTITY::IS_ENTITY_AT_COORD(veLocal_320, -477.2774f, -990.0638f, 23.5497f, 3f, 3f, 3f, false, true, 0))
							vector = { -477.7884f, -996.3974f, 23.5503f };
				
					if (ENTITY::DOES_ENTITY_EXIST(veLocal_318))
						if (ENTITY::IS_ENTITY_AT_COORD(veLocal_318, -477.2774f, -990.0638f, 23.5497f, 3f, 3f, 3f, false, true, 0))
							vector = { -477.7884f, -996.3974f, 23.5503f };
				
					TASK::OPEN_SEQUENCE_TASK(&iLocal_355);
					TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 3000, SLF_EXTEND_YAW_LIMIT | 2048, 2);
					TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 0);
					TASK::TASK_START_SCENARIO_AT_POSITION(0, "WORLD_HUMAN_PICNIC", vector, 304.8172f, 0, true, false);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_355);
					TASK::TASK_PERFORM_SEQUENCE(pedLocal_315, iLocal_355);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_355);
					_CONVERSATION_ADD_LINE(&uLocal_356, "CONACAU", "CONAC_THANK", 4, 0, 0, 0);
					func_54();
				}
			}
			else
...
void func_54() // Position - 0x2864 Hash - 0x49F3087F ^0xC985472A
{
	while (!func_82())
	{
		SYSTEM::WAIT(0);
	...
	func_77(_GET_CURRENT_PLAYER_CHARACTER(), 4, 2);
	func_58(-1, 0);
	func_55();
	iLocal_299 = 2;
	return;
...
void func_55() // Position - 0x2894 Hash - 0xD765C186 ^0xD765C186
{
	func_56();
	return;
}

int func_56() // Position - 0x28A1 Hash - 0x9482CBBF ^0x8B17A994
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x28EC Hash - 0x15889021 ^0xE7262364
{
...
void func_58(int iParam0, int iParam1) // Position - 0x2914 Hash - 0x207C13D1 ^0xD1CFBEA4
{
	if (iParam0 == -1)
		iParam0 = func_75();
	...
	if (iParam1 <= func_74(iParam0))
	{
		...
		if (!func_72(51))
		{
			func_68("RE_REWARD" /*Some Random Events will reward the player with stat boosts or money.*/, 1, 0, 4000, 10000, func_71(), 0, 138, 0);
			func_67(51);
		}
		...
		if (func_65(iParam0, iParam1) != 322)
			func_60(func_65(iParam0, iParam1), uLocal_41, uLocal_41.f_1);
...
void func_59(int iParam0) // Position - 0x2A18 Hash - 0xE49C42EC ^0xE49C42EC
{
	Global_114356 = iParam0;
	return;
}

void func_60(int iParam0, var uParam1, var uParam2) // Position - 0x2A26 Hash - 0xEC2439E7 ^0x1B67A713
{
	BOOL flag;
...
void func_61() // Position - 0x2B0C Hash - 0x9F269E94 ^0x9F269E94
{
	int num;
	float num2;
	float num3;
...
int func_62() // Position - 0x2FCA Hash - 0x21D64237 ^0x21D64237
{
	return Global_32828;
}

BOOL func_63(int iParam0, int iParam1) // Position - 0x2FD5 Hash - 0x77E0C72A ^0x80DA2A54
{
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x3026 Hash - 0xCF91FBA1 ^0xAE1D9C41
{
	if (iParam2 == -1)
		iParam2 = func_6();
...
int func_65(int iParam0, int iParam1) // Position - 0x3044 Hash - 0xE97012CD ^0x68FBF85A
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_66(int iParam0) // Position - 0x33B8 Hash - 0xBF3EFB31 ^0xBF3EFB31
{
	switch (iParam0)
	{
		case 29:
...
void func_67(int iParam0) // Position - 0x33E7 Hash - 0x12249850 ^0x46987D7A
{
	int offset;
	int i;
...
void func_68(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x3429 Hash - 0x6C5A40D1 ^0x6C5A40D1
{
	func_69(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
	return;
}

void func_69(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x344A Hash - 0xA155C85B ^0x4C499A0E
{
	int i;
...
void func_70() // Position - 0x361D Hash - 0xCF8881D1 ^0x40507183
{
	int i;
...
int func_71() // Position - 0x3734 Hash - 0x35BC7314 ^0x35BC7314
{
	func_37();
...
BOOL func_72(int iParam0) // Position - 0x377A Hash - 0x3F44A899 ^0x7041C53
{
	int num;
	int i;
...
void func_73(int iParam0, int iParam1) // Position - 0x37BA Hash - 0xE2246457 ^0xD5018049
{
	MISC::SET_BIT(&Global_114370.f_24998.f_8[iParam0], iParam1);
	return;
}

int func_74(int iParam0) // Position - 0x37D5 Hash - 0xAA02DAD0 ^0xAA02DAD0
{
	int num;
...
int func_75() // Position - 0x3886 Hash - 0x7AC1007E ^0x4E7D4F54
{
	var unk;
	int num;
...
int func_76(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0x38A3 Hash - 0x6DA57317 ^0x57A32A43
{
...
void func_77(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x3A7D Hash - 0xF0BE1C2C ^0xAA0F7992
{
	int num;
	int num2;
...
void func_78(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x3B6B Hash - 0x99A9B13C ^0x9ABF46
{
	Hash statName;
...
Hash func_79(int iParam0, int iParam1) // Position - 0x3B99 Hash - 0x505A9F99 ^0x8B00E935
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_80(iParam1));
}

int func_80(int iParam0) // Position - 0x3BAE Hash - 0x1A3F3220 ^0x1A3F3220
{
	int num;
	int num2;
...
int func_81(int iParam0, int iParam1) // Position - 0x3BE2 Hash - 0x744E461C ^0x94D7C845
{
	Hash statHash;
	int outValue;
...
BOOL func_82() // Position - 0x3C11 Hash - 0xFD255207 ^0xFD255207
{
	return true;
}

Blip func_83(Ped pedParam0, BOOL bParam1, int iParam2) // Position - 0x3C1A Hash - 0xA714218A ^0xAD0F82BD
{
	Blip blip;

	blip = func_84(pedParam0, !bParam1, false);
...
Blip func_84(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3C64 Hash - 0x2E5A72B ^0x64F26CC0
{
	Blip blip;
...
var func_85(BOOL bParam0, var uParam1, var uParam2) // Position - 0x3D08 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
int func_86(BOOL bParam0) // Position - 0x3D1F Hash - 0x3A78A0E1 ^0x967BAB5B
{
	if (func_90())
	{
		Global_114360 = true;
		...
		if (bParam0 && func_66(Global_114359))
...
void func_87(int iParam0) // Position - 0x3D72 Hash - 0x3B4E6AAB ^0x52844A7B
{
	switch (iParam0)
	{
		case 0:
			if (Global_114370.f_24998.f_2 < 3)
			{
				...
				{
					_DISPLAY_HELP_TEXT(func_89(iParam0), -1);
...
void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x3E4D Hash - 0xCBB0D91 ^0x21070E5C
{
...
char* func_89(int iParam0) // Position - 0x3E64 Hash - 0x7EEC0515 ^0xCF6B324E
{
	char* str;
...
BOOL func_90() // Position - 0x3EA7 Hash - 0x8129EEA4 ^0x48B13301
{
	switch (func_91(&Global_32888, 0, 5, false, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return true;
...
int func_91(var uParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0x3EDD Hash - 0x8F9349A ^0xC5C097C1
{
	int i;
...
void func_92(var uParam0, int iParam1) // Position - 0x4015 Hash - 0x6AC97785 ^0x6AC97785
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0x4064 Hash - 0xECB6C71B ^0xECB6C71B
{
	return func_94(iParam0, Global_43922);
}

BOOL func_94(int iParam0, int iParam1) // Position - 0x4075 Hash - 0x1FD727E0 ^0x1FD727E0
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_95(int iParam0) // Position - 0x4256 Hash - 0x3BAB94E9 ^0x3BAB94E9
{
	if (Global_43922 == 15)
		return false;
...
BOOL func_96(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4278 Hash - 0xF0D380FF ^0x29DD7336
{
...
void func_97() // Position - 0x435D Hash - 0x9D4F6557 ^0x80E7F8A
{
	AUDIO::TRIGGER_MUSIC_EVENT("RE14A_FAIL");
	iLocal_299 = 2;
	return;
...
Blip func_98(Vehicle veParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4371 Hash - 0x177BFEFF ^0x177BFEFF
{
	return func_84(veParam0, !bParam1, bParam2);
}

void func_99() // Position - 0x4384 Hash - 0x95A23108 ^0x516C5A27
{
	if (func_102(1000))
	{
		func_47();
		...
		if (!ENTITY::IS_ENTITY_DEAD(veLocal_317, false))
			VEHICLE::SET_VEHICLE_DAMAGE(veLocal_317, 0f, 1f, 1f, 200f, 800f, true);
	...
	{
		case 0:
			func_2(true, true, true, false, false, false, false);
			...
			MISC::CLEAR_AREA_OF_PEDS(uLocal_306, 50f, 0);
			MISC::CLEAR_AREA_OF_VEHICLES(uLocal_306, 30f, false, false, false, false, false, false, 0);
			MISC::CLEAR_AREA_OF_PROJECTILES(uLocal_306, 100f, 0);
		
			if (!ENTITY::IS_ENTITY_DEAD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), false))
			{
				if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), uLocal_306, 8f, 8f, 8f, false, true, 0))
				{
					veLocal_319 = PLAYER::GET_PLAYERS_LAST_VEHICLE();
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(veLocal_319, true, false);
					VEHICLE::DELETE_VEHICLE(&veLocal_319);
				}
			}
			...
			caLocal_528 = CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", -462.711f, -992.5728f, 23.8729f, -0.1371f, -0.0346f, -29.6605f, 28f, true, 2);
			caLocal_529 = CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", -462.711f, -992.5728f, 23.8729f, 69.4831f, -0.0346f, -40.8884f, 28f, true, 2);
			CAM::SHAKE_CAM(caLocal_528, "HAND_SHAKE", 0.3f);
			CAM::SHAKE_CAM(caLocal_529, "HAND_SHAKE", 0.3f);
			func_101();
			CAM::SET_CAM_ACTIVE(caLocal_528, true);
			CAM::RENDER_SCRIPT_CAMS(true, false, 3000, true, false, 0);
			SYSTEM::WAIT(500);
			CAM::SET_CAM_ACTIVE_WITH_INTERP(caLocal_529, caLocal_528, 3500, 1, 1);
		...
		case 1:
			if (MISC::GET_GAME_TIMER() - iLocal_352 > 3500)
			{
				...
				OBJECT::SET_ACTIVATE_OBJECT_PHYSICS_AS_SOON_AS_IT_IS_UNFROZEN(uLocal_325[0], true);
				func_100(caLocal_528);
				func_100(caLocal_529);
				caLocal_528 = CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", -455.4617f, -990.631f, 61.6885f, -89.0761f, -0.0146f, -49.881f, 80.5355f, true, 2);
				caLocal_529 = CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", -455.4543f, -990.6208f, 61.012f, -89.0759f, -0.0146f, -47.8226f, 80.5355f, true, 2);
				CAM::SHAKE_CAM(caLocal_528, "HAND_SHAKE", 0.3f);
				CAM::SHAKE_CAM(caLocal_529, "HAND_SHAKE", 0.3f);
				CAM::SET_CAM_ACTIVE_WITH_INTERP(caLocal_529, caLocal_528, 4000, 1, 0);
			
				if (!PED::IS_PED_INJURED(pedLocal_315))
				{
					TASK::CLEAR_PED_TASKS(pedLocal_315);
					TASK::TASK_LOOK_AT_COORD(pedLocal_315, -461.4785f, -984.8583f, 28.0809f, 30000, SLF_WIDEST_PITCH_LIMIT | 2048, 2);
				}
			
				if (ENTITY::DOES_ENTITY_EXIST(obLocal_338))
				{
					ENTITY::DETACH_ENTITY(obLocal_338, true, true);
					OBJECT::DELETE_OBJECT(&obLocal_338);
				}
		...
		case 3:
			if (MISC::GET_GAME_TIMER() - iLocal_352 > 500)
			{
				...
				{
					ENTITY::FREEZE_ENTITY_POSITION(uLocal_325[0], false);
					ENTITY::APPLY_FORCE_TO_ENTITY(uLocal_325[0], 0, 0f, 0f, 5f, 0f, -2f, 2f, 0, true, true, true, false, true);
					OBJECT::BREAK_OBJECT_FRAGMENT_CHILD(uLocal_325[0], 11, false);
					OBJECT::BREAK_OBJECT_FRAGMENT_CHILD(uLocal_325[0], 18, false);
					OBJECT::BREAK_OBJECT_FRAGMENT_CHILD(uLocal_325[0], 19, false);
					OBJECT::BREAK_OBJECT_FRAGMENT_CHILD(uLocal_325[0], 23, false);
					OBJECT::BREAK_OBJECT_FRAGMENT_CHILD(uLocal_325[0], 9, false);
					OBJECT::BREAK_OBJECT_FRAGMENT_CHILD(uLocal_325[0], 12, false);
					OBJECT::BREAK_OBJECT_FRAGMENT_CHILD(uLocal_325[0], 17, false);
					GRAPHICS::START_PARTICLE_FX_NON_LOOPED_ON_ENTITY("scr_reconstruct_pipefall_debris", uLocal_325[0], 0f, 0f, 0f, 0f, 0f, 0f, 1065353216, false, false, false);
				}
		...
		case 4:
			if (MISC::GET_GAME_TIMER() - iLocal_352 > 2000)
			{
				func_100(caLocal_528);
				func_100(caLocal_529);
				caLocal_528 = CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", -470.5648f, -976.951f, 24.2657f, 25.437f, -0.0087f, -118.3831f, 34f, true, 2);
				caLocal_529 = CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", -470.5648f, -976.951f, 24.2657f, 2.0695f, -0.0087f, -120.2811f, 34f, true, 2);
				CAM::SHAKE_CAM(caLocal_528, "HAND_SHAKE", 0.3f);
				CAM::SHAKE_CAM(caLocal_529, "HAND_SHAKE", 0.3f);
				CAM::SET_CAM_ACTIVE_WITH_INTERP(caLocal_529, caLocal_528, 1000, 3, 3);
		...
		case 5:
			if (MISC::GET_GAME_TIMER() - iLocal_352 > 500)
			{
				if (!ENTITY::IS_ENTITY_DEAD(veLocal_317, false))
				{
					...
					if (!PED::IS_PED_INJURED(pedLocal_315))
						TASK::TASK_CLEAR_LOOK_AT(pedLocal_315);
				
					TASK::TASK_PLAY_ANIM(pedLocal_315, "re@construction", "idle_panic", 8f, -8f, -1, 16, 0, false, false, false);
					GRAPHICS::START_PARTICLE_FX_NON_LOOPED_ON_ENTITY("scr_reconstruct_pipe_impact", veLocal_317, 0f, 0f, 0f, 0f, 0f, 0f, 1065353216, false, false, false);
					_CONVERSATION_ADD_LINE(&uLocal_356, "CONACAU", "CONAC_SCREAM", 4, 0, 0, 0);
				
					if (CAM::DOES_CAM_EXIST(caLocal_528) && CAM::DOES_CAM_EXIST(caLocal_529))
					{
						CAM::SHAKE_CAM(caLocal_528, "HAND_SHAKE", 1.5f);
						CAM::SHAKE_CAM(caLocal_529, "HAND_SHAKE", 1.5f);
					}
		...
		case 6:
			if (MISC::GET_GAME_TIMER() - iLocal_352 > 500)
			{
				func_100(caLocal_528);
				func_100(caLocal_529);
				caLocal_528 = CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", -459.2609f, -987.5602f, 24.2611f, 0.583f, 0.2617f, -32.7532f, 49.9914f, true, 2);
				caLocal_529 = CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", -459.0622f, -987.2584f, 24.2661f, 5.0301f, 0.2617f, -36.7308f, 49.9914f, true, 2);
				CAM::SHAKE_CAM(caLocal_528, "HAND_SHAKE", 0.5f);
				CAM::SHAKE_CAM(caLocal_529, "HAND_SHAKE", 0.5f);
				CAM::SET_CAM_ACTIVE_WITH_INTERP(caLocal_529, caLocal_528, 2500, 3, 3);
			
				if (!PED::IS_PED_INJURED(pedLocal_315))
					TASK::TASK_LOOK_AT_COORD(pedLocal_315, ENTITY::GET_ENTITY_COORDS(pedLocal_315, true) - { 10f, 0f, 2f }, 30000, SLF_WIDEST_PITCH_LIMIT | 2048, 2);
		...
		case 7:
			if (MISC::GET_GAME_TIMER() - iLocal_352 > 2200 && !bLocal_344)
			{
			...
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_317, false))
					ENTITY::FREEZE_ENTITY_POSITION(veLocal_317, true);
		...
		case 8:
			...
			if (ENTITY::DOES_ENTITY_EXIST(uLocal_325[0]))
				OBJECT::DELETE_OBJECT(&uLocal_325[0]);
		
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_317, false))
			{
				VEHICLE::SET_VEHICLE_ENGINE_HEALTH(veLocal_317, 250f);
				ENTITY::SET_ENTITY_COORDS(veLocal_317, uLocal_306, true, false, false, true);
				ENTITY::SET_ENTITY_HEADING(veLocal_317, 80f);
				MISC::CLEAR_AREA_OF_OBJECTS(uLocal_306, 50f, 0);
			}
			...
			if (!PED::IS_PED_INJURED(pedLocal_315))
			{
				TASK::CLEAR_PED_TASKS(pedLocal_315);
				TASK::TASK_CLEAR_LOOK_AT(pedLocal_315);
				TASK::TASK_PLAY_ANIM(pedLocal_315, "re@construction", "idle_panic", 8f, -8f, -1, 1, 0, false, false, false);
			}
		
			CAM::SET_CAM_ACTIVE(caLocal_528, false);
			CAM::RENDER_SCRIPT_CAMS(false, false, 3000, true, false, 0);
			CAM::DESTROY_CAM(caLocal_528, false);
			CAM::DESTROY_CAM(caLocal_529, false);
			PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), true, 0);
			CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
			HUD::DISPLAY_RADAR(true);
			HUD::DISPLAY_HUD(true);
			...
			uLocal_325[1] = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_ld_pipe_single_01"), -457.8815f, -988.9059f, 22.9554f, true, true, false);
			ENTITY::SET_ENTITY_ROTATION(uLocal_325[1], -0.1939f, 105.0058f, 77.3964f, 2, true);
			uLocal_325[2] = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_ld_pipe_single_01"), -451.5131f, -986.8079f, 24.6947f, true, true, false);
			ENTITY::SET_ENTITY_ROTATION(uLocal_325[2], 24.3941f, 32.5423f, 80.6862f, 2, true);
			uLocal_325[3] = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_ld_pipe_single_01"), -450.8099f, -985.9972f, 24.7104f, true, true, false);
			ENTITY::SET_ENTITY_ROTATION(uLocal_325[3], 24.1841f, 110.287f, 78.4357f, 2, true);
			uLocal_325[4] = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_ld_pipe_single_01"), -456.6558f, -987.3979f, 22.9537f, true, true, false);
			ENTITY::SET_ENTITY_ROTATION(uLocal_325[4], -0.0264f, 29.5754f, 79.1811f, 2, true);
			uLocal_325[5] = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_ld_pipe_single_01"), -456.1279f, -988.4162f, 22.9889f, true, true, false);
			ENTITY::SET_ENTITY_ROTATION(uLocal_325[5], -0.6337f, 108.4339f, 77.9539f, 2, true);
			uLocal_325[6] = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_ld_pipe_single_01"), -457.0807f, -987.3059f, 23.7564f, true, true, false);
			ENTITY::SET_ENTITY_ROTATION(uLocal_325[6], 0.0929f, 74.2657f, 79.3839f, 2, true);
			uLocal_325[7] = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_ld_pipe_single_01"), -456.6558f, -983.7804f, 22.9712f, true, true, false);
			ENTITY::SET_ENTITY_ROTATION(uLocal_325[7], -0.0264f, 29.5754f, 80.9061f, 2, true);
			uLocal_325[8] = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_ld_pipe_single_01"), -455.3279f, -983.1712f, 22.9564f, true, true, false);
			ENTITY::SET_ENTITY_ROTATION(uLocal_325[8], -0.1087f, 109.7339f, 80.9789f, 2, true);
			uLocal_325[9] = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_ld_pipe_single_01"), -456.1632f, -983.9359f, 23.7964f, true, true, false);
			ENTITY::SET_ENTITY_ROTATION(uLocal_325[9], -0.3321f, 74.1907f, 81.6089f, 2, true);
			uLocal_325[10] = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_ld_pipe_single_01"), -454.644f, -994.1709f, 23.3329f, true, true, false);
			ENTITY::SET_ENTITY_ROTATION(uLocal_325[10], 5.7811f, 104.6058f, 104.6964f, 2, true);
		
			for (iLocal_345 = 0; iLocal_345 < 11; iLocal_345 = iLocal_345 + 1)
			{
				if (ENTITY::DOES_ENTITY_EXIST(uLocal_325[iLocal_345]))
				{
					ENTITY::SET_ENTITY_DYNAMIC(uLocal_325[iLocal_345], true);
					ENTITY::FREEZE_ENTITY_POSITION(uLocal_325[iLocal_345], true);
				}
			}
...
void func_100(Cam caParam0) // Position - 0x4ED0 Hash - 0x513A637 ^0x8EEA3090
{
...
void func_101() // Position - 0x4EE8 Hash - 0x1FAB512B ^0xDEDC2B21
{
...
BOOL func_102(int iParam0) // Position - 0x4EF8 Hash - 0x7FAC01B4 ^0x9388B6EC
{
...
BOOL func_103() // Position - 0x4F42 Hash - 0x57459B9C ^0x9A36D842
{
...
int func_104(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) // Position - 0x4F74 Hash - 0xD593C051 ^0xD593C051
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x4FC7 Hash - 0x6C235EE0 ^0x9E57F206
{
...
BOOL func_106(var uParam0) // Position - 0x5062 Hash - 0x20D4198E ^0x54291DEA
{
	int i;
...
BOOL func_107(var uParam0) // Position - 0x50BE Hash - 0xC32864D ^0xACB9E803
{
	return func_108(*uParam0, "NULL", uParam0->f_1);
}

BOOL func_108(int iParam0, char* sParam1, Hash hParam2) // Position - 0x50D3 Hash - 0x8008FEBF ^0xF0538B20
{
...
int func_109(int iParam0) // Position - 0x51BE Hash - 0x3A85B246 ^0x3A85B246
{
	int i;
...
void func_110(var uParam0) // Position - 0x51E7 Hash - 0x58E13B05 ^0x58E13B05
{
	func_111(uParam0, 9, -1, 0);
	return;
}

void func_111(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x51F9 Hash - 0xC6A50A87 ^0xC6A50A87
{
	int i;
...
BOOL func_112(int iParam0) // Position - 0x52B3 Hash - 0x4B6B929B ^0x4B6B929B
{
	switch (iParam0)
	{
		case -1:
...
void func_113(var uParam0, int iParam1) // Position - 0x5352 Hash - 0xA8A6A9F9 ^0xA8A6A9F9
{
	func_111(uParam0, 0, iParam1, 0);
	return;
}

void func_114(var uParam0) // Position - 0x5364 Hash - 0x849AE4BE ^0x14577356
{
	int i;
...
void func_115(int* piParam0) // Position - 0x53E2 Hash - 0x4B478A31 ^0x2BE84DD6
{
	func_116(piParam0, "NULL", piParam0->f_1);
	return;
}

void func_116(int* piParam0, char* sParam1, Hash hParam2) // Position - 0x53F6 Hash - 0xCB81CA4C ^0xCD422589
{
	if (IS_BIT_SET(*piParam0, 30))
	{
		switch (func_109(*piParam0))
		{
			case 0:
...
void func_117() // Position - 0x54C7 Hash - 0xE08021A6 ^0xFC0FEE79
{
	int i;

	func_113(&uLocal_535, joaat("bulldozer"));
	func_113(&uLocal_535, joaat("utillitruck2"));
	func_113(&uLocal_535, joaat("prop_pipe_stack_01"));

	if (func_106(&uLocal_535))
	{
		...
		PED::ADD_SCENARIO_BLOCKING_AREA(uLocal_303 + { 50f, 50f, 50f }, uLocal_303 - { 50f, 50f, 50f }, false, true, true, true, 1);
		uLocal_306 = { -455.6561f, -985.8071f, 22.4868f };
		veLocal_317 = VEHICLE::CREATE_VEHICLE(joaat("utillitruck2"), uLocal_306, 80f, true, true, false);
		VEHICLE::SET_VEHICLE_ENGINE_ON(veLocal_317, false, true, false);
		VEHICLE::SET_VEHICLE_DOORS_LOCKED(veLocal_317, 3);
		VEHICLE::SET_VEHICLE_EXTRA(veLocal_317, 1, true);
		VEHICLE::SET_VEHICLE_EXTRA(veLocal_317, 2, true);
		VEHICLE::SET_VEHICLE_EXTRA(veLocal_317, 3, false);
		VEHICLE::SET_VEHICLE_EXTRA(veLocal_317, 4, true);
		VEHICLE::SET_VEHICLE_EXTRA(veLocal_317, 5, true);
		VEHICLE::SET_VEHICLE_EXTRA(veLocal_317, 6, false);
		VEHICLE::SET_VEHICLE_EXTRA(veLocal_317, 7, true);
		ENTITY::FREEZE_ENTITY_POSITION(veLocal_317, true);
		ENTITY::SET_ENTITY_PROOFS(veLocal_317, false, false, false, true, false, false, false, false);
		ENTITY::SET_ENTITY_LOD_DIST(veLocal_317, 10000);
		VEHICLE::SET_VEHICLE_LOD_MULTIPLIER(veLocal_317, 5f);
		veLocal_318 = VEHICLE::CREATE_VEHICLE(joaat("bulldozer"), -472.9444f, -966.671f, 22.5534f, 181.8365f, true, true, false);
		MISC::CLEAR_AREA(uLocal_306, 10f, true, false, false, false);
		uLocal_325[0] = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_pipe_stack_01"), -453.2f, -986.1f, 59.45f, true, true, false);
		ENTITY::SET_ENTITY_HEADING(uLocal_325[0], 90f);
		ENTITY::FREEZE_ENTITY_POSITION(uLocal_325[0], true);
		ENTITY::SET_ENTITY_PROOFS(uLocal_325[0], true, true, true, true, false, false, false, false);
		ENTITY::SET_ENTITY_LOD_DIST(uLocal_325[0], 10000000);
		iLocal_227[0 /*5*/] = { fLocal_524 };
		iLocal_227[1 /*5*/] = { fLocal_524 + { 0f, 0.5f, 0f } };
		iLocal_227[2 /*5*/] = { fLocal_524 + { 0f, 1f, 0f } };
		iLocal_227[3 /*5*/] = { fLocal_524 + { 0f, 2.5f, 0f } };
		iLocal_227[4 /*5*/] = { fLocal_524 + { 0f, 3f, 0f } };
		iLocal_227[5 /*5*/] = { fLocal_524 + { 0f, 3.5f, 0f } };
		iLocal_227[6 /*5*/] = { fLocal_524 + { 0f, 4f, 0f } };
		iLocal_227[7 /*5*/] = { fLocal_524 + { 0f, 4.5f, 0f } };
		iLocal_227[8 /*5*/] = { fLocal_524 + { 0f, 5f, 0f } };
		iLocal_227[9 /*5*/] = { fLocal_524 + { 0f, 5.5f, 0f } };
		iLocal_227[10 /*5*/] = { fLocal_524 + { 0f, 6f, 0f } };
		iLocal_227[11 /*5*/] = { fLocal_524 + { 0f, 6.5f, 0f } };
		iLocal_227[12 /*5*/] = { fLocal_524 + { 0f, 7f, 0f } };
		iLocal_227[13 /*5*/] = { uLocal_521 };
		...
		!HUD::DOES_BLIP_EXIST(blLocal_324);
		func_118(&uLocal_535, false);
		bLocal_532 = true;
		iLocal_299 = 1;
	}
...
void func_118(var uParam0, BOOL bParam1) // Position - 0x57AE Hash - 0x16045BFE ^0x66440F01
{
	int i;
...
void func_119(var uParam0) // Position - 0x57EE Hash - 0x916F6652 ^0x26C41FA1
{
	*uParam0 = 0;
	uParam0->f_1 = -1;
	return;
...
void func_120(var uParam0) // Position - 0x57FF Hash - 0xB4367EF0 ^0x1A0632ED
{
	int i;
...
void func_121(var uParam0) // Position - 0x5835 Hash - 0xF8F4AA76 ^0x3513BC1B
{
	func_122(*uParam0, "NULL", uParam0->f_1);
	return;
}

void func_122(int iParam0, char* sParam1, Hash hParam2) // Position - 0x584A Hash - 0x2AE0929C ^0x571E5810
{
	if (IS_BIT_SET(iParam0, 30))
	{
		switch (func_109(iParam0))
...
BOOL func_123() // Position - 0x5904 Hash - 0xC05B0E62 ^0x94C54EFE
{
...
int func_124(float fParam0, BOOL bParam1) // Position - 0x598A Hash - 0xA169FFDC ^0x284941E0
{
	var unk;
	int num;
	int num2;
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (func_38(_GET_CURRENT_PLAYER_CHARACTER()))
		{
			num4 = func_71();
			i = 0;
...
void func_125(int iParam0, var uParam1) // Position - 0x5A3B Hash - 0x7228097F ^0x68B65601
{
	switch (iParam0)
	{
		case 0:
		...
		case 5:
			func_126(uParam1, "Barry3A", func_128(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH" /*Areas where you can find vehicles with a hidden stash have been marked on the map. Collect these vehicles for Barry.*/, 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_127(iParam0), 0, 1);
			break;
		...
		case 8:
			func_126(uParam1, "Dreyfuss1", func_128(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT" /*The killer's identity and location have been revealed.*/, 106, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_127(iParam0), 0, 0);
			break;
		...
		case 38:
			func_126(uParam1, "Nigel1A", func_128(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS" /*Areas where you can find celebrity items have been marked on the map. Steal these items for Nigel and Mrs. Thornhill.*/, 100, 0, "", 0, 0, 42, 4, 4, 0, 2359, func_127(iParam0), 1, 1);
			break;
		...
		case 49:
			func_126(uParam1, "Paparazzo3A", func_128(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO" /*Areas where you can find celebrity photo opportunities have been marked on the map. Track down and photograph these celebrities for Beverly.*/, 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_127(iParam0), 0, 1);
			break;
		...
		case 58:
			func_126(uParam1, "Tonya1", func_128(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS" /*Strangers and Freaks can be found throughout San Andreas at ~HUD_COLOUR_FRANKLIN~~BLIP_RANDOM_CHARACTER~~s~*/, -1, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_127(iParam0), 0, 1);
			break;
...
int func_127(int iParam0) // Position - 0x6C81 Hash - 0xC999F6B2 ^0xC999F6B2
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_128(int iParam0) // Position - 0x6FC7 Hash - 0x680676D4 ^0x8D10F3A1
{
	var unk;
	var unk3;
...
struct<2> func_129(int iParam0) // Position - 0x6FFE Hash - 0x40B9A0AA ^0x2508AE54
{
	var unk;
...
BOOL func_130() // Position - 0x744A Hash - 0x7055FFB1 ^0x7055FFB1
{
...
BOOL func_131() // Position - 0x747C Hash - 0x79CF7679 ^0x79CF7679
{
	return Global_114088 > 0;
}

BOOL func_132() // Position - 0x748A Hash - 0xCF2296C0 ^0xCF2296C0
{
	if (Global_98294 != -1)
		return true;
...
BOOL func_133() // Position - 0x749F Hash - 0x98CCC132 ^0x97B0D6ED
{
	if (Global_98294 != -1)
...
BOOL func_134() // Position - 0x74C2 Hash - 0x29CB2928 ^0xE369A18D
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_135() // Position - 0x74DF Hash - 0xF2B7F534 ^0x7F3EC4F9
{
...
BOOL func_136() // Position - 0x7541 Hash - 0x1121F6F2 ^0x90CE37A6
{
...
void func_137(int iParam0) // Position - 0x756C Hash - 0xA62BD46A ^0x1E050688
{
	if (iParam0 == -1)
		iParam0 = func_75();
...
void func_138() // Position - 0x75A2 Hash - 0x178BF2A7 ^0x744062F5
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
...
void func_139(int iParam0) // Position - 0x75DF Hash - 0xE49C42EC ^0xE49C42EC
{
	Global_114359 = iParam0;
	return;
}

BOOL func_140(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x75ED Hash - 0xC601B4EA ^0xC601B4EA
{
	BOOL flag;
	...
	if (!flag)
	{
		...
		if (func_38(_GET_CURRENT_PLAYER_CHARACTER()))
		{
			for (i = CHAR_MICHAEL; i < CHAR_MULTIPLAYER; i = i + 1)
			{
				...
				if (func_164(num))
					if (func_142(i))
						if (!func_141(vector, 0f, 0f, 0f, false))
...
BOOL func_141(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x7987 Hash - 0x2D46096D ^0xEA41378F
{
	if (bParam6)
...
BOOL func_142(eCharacter echParam0) // Position - 0x79CE Hash - 0x687D9246 ^0x687D9246
{
	int num;
...
BOOL func_143(int iParam0) // Position - 0x79EF Hash - 0x2D75E13A ^0x2D75E13A
{
	return func_144(iParam0, 1);
}

int func_144(int iParam0, int iParam1) // Position - 0x79FE Hash - 0x1F92FEBC ^0x1F92FEBC
{
	var unk;
	var unk2;
	int num;
	...
	func_145(iParam0, &unk, &unk2, &num, &num2, &num3, &num4);
...
void func_145(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x7A51 Hash - 0x2BEE335D ^0x2BEE335D
{
	func_146(func_157(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
	return;
}

void func_146(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x7A6F Hash - 0xB807819C ^0xB807819C
{
	int num;
	int num2;
	int num3;
	...
	{
		num = func_155(iParam1);
		num2 = func_153(iParam0);
		num3 = func_153(iParam0) - func_153(iParam1);
		num4 = func_155(iParam0) - func_155(iParam1);
		num5 = func_152(iParam0) - func_152(iParam1);
		num6 = func_151(iParam0) - func_151(iParam1);
		num7 = func_150(iParam0) - func_150(iParam1);
		num8 = func_149(iParam0) - func_149(iParam1);
	}
	else
	{
		num = func_155(iParam0);
		num2 = func_153(iParam1);
		num3 = func_153(iParam1) - func_153(iParam0);
		num4 = func_155(iParam1) - func_155(iParam0);
		num5 = func_152(iParam1) - func_152(iParam0);
		num6 = func_151(iParam1) - func_151(iParam0);
		num7 = func_150(iParam1) - func_150(iParam0);
		num8 = func_149(iParam1) - func_149(iParam0);
	}
	...
	while (num5 < 0)
	{
		...
		num5 = num5 + func_148(num, num2);
		num4 = num4 - 1;
		num = SYSTEM::ROUND(func_147(SYSTEM::TO_FLOAT(num + 1), 0f, 12f));
	}
...
float func_147(float fParam0, float fParam1, float fParam2) // Position - 0x7C70 Hash - 0xDB08F514 ^0x78C0BF6F
{
	float num;
...
int func_148(int iParam0, int iParam1) // Position - 0x7CB2 Hash - 0xD3EBACB3 ^0xD3EBACB3
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_149(int iParam0) // Position - 0x7D54 Hash - 0x90B520AB ^0x257AC1C4
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_150(int iParam0) // Position - 0x7D67 Hash - 0xC188C91C ^0x48884C7
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_151(int iParam0) // Position - 0x7D7A Hash - 0x626AEC54 ^0xDB28E416
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_152(int iParam0) // Position - 0x7D8D Hash - 0x826C592F ^0xDEC5AA46
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_153(int iParam0) // Position - 0x7D9F Hash - 0xE1B0542C ^0x127A471E
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_154(BOOL bParam0, var uParam1, var uParam2) // Position - 0x7DC1 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
int func_155(int iParam0) // Position - 0x7DD8 Hash - 0x2D4DB85F ^0x2D4DB85F
{
	return iParam0 & 15;
}

BOOL func_156(int iParam0, int iParam1) // Position - 0x7DE5 Hash - 0xEA08B1 ^0xEA08B1
{
	int num;
	int num2;
...
int func_157() // Position - 0x7EF1 Hash - 0x9E44C35 ^0xB9993D58
{
	var unk;

	func_163(&unk, CLOCK::GET_CLOCK_SECONDS());
	func_162(&unk, CLOCK::GET_CLOCK_MINUTES());
	func_161(&unk, CLOCK::GET_CLOCK_HOURS());
...
void func_158(var uParam0, int iParam1) // Position - 0x7F37 Hash - 0x15B9927E ^0x4A4674
{
	if (iParam1 <= 0)
		return;
...
void func_159(var uParam0, int iParam1) // Position - 0x7FBD Hash - 0x4C70B2C3 ^0x4C70B2C3
{
...
void func_160(var uParam0, int iParam1) // Position - 0x7FF0 Hash - 0x9BD35C37 ^0x9BD35C37
{
	int num;
	int num2;
	...
	if (iParam1 < 1 || iParam1 > func_148(num, num2))
		return;
...
void func_161(var uParam0, int iParam1) // Position - 0x8043 Hash - 0x864304A8 ^0x1F5003E2
{
...
void func_162(var uParam0, int iParam1) // Position - 0x807D Hash - 0x76860AE7 ^0x32308FFF
{
...
void func_163(var uParam0, int iParam1) // Position - 0x80B8 Hash - 0xDB8A72C0 ^0x4F6D426D
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_164(int iParam0) // Position - 0x80F4 Hash - 0x57D8E518 ^0xD297DD35
{
	int num;
	int num2;
	int num3;
	...
	num3 = func_151(iParam0);

	if (num3 < 0 || num3 > 23)
		return false;

	num4 = func_153(iParam0);

	if (num4 <= 0 || num4 > 2043 || num4 < 1979)
		return false;

	num5 = func_155(iParam0);

	if (num5 < 0 || num5 > 11)
		return false;

	num6 = func_152(iParam0);

	if (num6 < 1 || num6 > func_148(num5, num4))
		return false;

	return true;
}

BOOL func_165(int iParam0, int iParam1) // Position - 0x81D0 Hash - 0x577FB514 ^0xAAF8B538
{
...
BOOL func_166(int iParam0) // Position - 0x81F0 Hash - 0x97844555 ^0xADCD6DAA
{
	eCharacter character;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_174() || Global_32831 || func_173() || func_44(8, -1) || func_170() || func_172() || func_171() || func_169() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_174() || Global_113417 || Global_32831 || func_173() || func_44(8, -1) || func_170() || func_172() || func_171() || func_169() || Global_114370.f_7691.f_919[character] == 5 || Global_44469 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_174() || Global_113417 || Global_32831 || func_173() || func_44(8, -1) || func_172() || func_171() || func_169() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_174() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_44(8, -1) || func_169() || func_168() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
...
BOOL func_167() // Position - 0x890D Hash - 0x4228A1C2 ^0x952FE30F
{
	return Global_101431.f_1;
}

BOOL func_168() // Position - 0x891B Hash - 0xC20DBA70 ^0xAC4006FB
{
	if (Global_98294 != -1)
...
BOOL func_169() // Position - 0x893E Hash - 0x3CA1BB47 ^0xB78A1ACB
{
...
BOOL func_170() // Position - 0x8958 Hash - 0xE663B8F6 ^0xE663B8F6
{
	if (Global_79509)
		return true;
...
BOOL func_171() // Position - 0x8982 Hash - 0xD56328D2 ^0xD56328D2
{
	return Global_101444.f_394 > 0;
}

BOOL func_172() // Position - 0x8993 Hash - 0xD56328D2 ^0xD56328D2
{
	return Global_101444.f_393 > 0;
}

BOOL func_173() // Position - 0x89A4 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1575079;
}

BOOL func_174() // Position - 0x89B0 Hash - 0x7FE517FE ^0x128A3BC8
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
BOOL func_175() // Position - 0x89CC Hash - 0xB12DEAA2 ^0xB12DEAA2
{
	_UPDATE_CURRENT_PLAYER_CHARACTER();
...
BOOL func_176(int iParam0) // Position - 0x89F4 Hash - 0xCDB90269 ^0xCDB90269
{
	return func_156(func_157(), iParam0);
}

BOOL func_177(int iParam0, int iParam1, eCharacter echParam2) // Position - 0x8A06 Hash - 0xBEEFD79C ^0xBEEFD79C
{
	BOOL num;
	eCharacter character;
...
int func_178(eCharacter echParam0) // Position - 0x8AEA Hash - 0x45FC9D61 ^0x45FC9D61
{
...
BOOL func_179(int iParam0) // Position - 0x8B0E Hash - 0xF2A54181 ^0xF2A54181
{
	int num;
	BOOL flag;
...
BOOL func_180() // Position - 0x8B66 Hash - 0xB72C022E ^0x452A7B6D
{
	Vehicle vehiclePedIsIn;
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x8BAA Hash - 0x44DD83CC ^0x7B62A376
{
	int profileSetting;
...
void func_182() // Position - 0x8C62 Hash - 0x2982E797 ^0xD7C4612C
{
	if (bLocal_532)
	{
		if (!bLocal_533)
		{
			...
			if (!PED::IS_PED_INJURED(pedLocal_315))
				PED::SET_PED_CONFIG_FLAG(pedLocal_315, 317, true);
		
			if (!ENTITY::IS_ENTITY_DEAD(veLocal_320, false))
				if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), veLocal_320, false) && !ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), veLocal_320, 50f, 50f, 50f, false, true, 0))
					func_194(veLocal_320, 0, _CHAR_NULL);
...
void func_183(int iParam0) // Position - 0x8E4F Hash - 0xE6B11918 ^0x37AF2AD2
{
	var name;
	...
	if (func_136())
	{
		...
		func_186(30000);
		TEXT_LABEL_ASSIGN_STRING(&name, func_185(Global_114359, true), 64);
...
void func_184(var uParam0) // Position - 0x8F01 Hash - 0x995C9E2 ^0x995C9E2
{
	if (*uParam0 == -1)
		return;
...
char* func_185(int iParam0, BOOL bParam1) // Position - 0x8F3E Hash - 0x959319CB ^0x5F3F39B2
{
	switch (iParam0)
	{
		case 0:
...
void func_186(int iParam0) // Position - 0x9187 Hash - 0xC0234809 ^0x4FD853DC
{
	Global_44473 = MISC::GET_GAME_TIMER() + iParam0;
	return;
}

void func_187(int iParam0) // Position - 0x9199 Hash - 0x881273A8 ^0x881273A8
{
	func_188(iParam0, 0, func_193(iParam0));
	return;
}

void func_188(int iParam0, int iParam1, int iParam2) // Position - 0x91AE Hash - 0xA7DBC311 ^0xA7DBC311
{
	int unk;
	var unk2;

	unk = func_157();
	func_191(&unk, 0, 0, iParam2, iParam1, 0, 0);
	func_190(iParam0, &unk);
	unk2 = { func_189(&unk) };
	return;
}

struct<16> func_189(var uParam0) // Position - 0x91DD Hash - 0xDA1B281D ^0xB09CC603
{
	var unk;
	int num;
	...
	TEXT_LABEL_APPEND_STRING(&unk, "/", 64);
	TEXT_LABEL_APPEND_INT(&unk, func_153(*uParam0), 64);
	return unk;
}

void func_190(int iParam0, var uParam1) // Position - 0x92AD Hash - 0x63EF72B0 ^0xC612AA53
{
	Global_114370.f_24998.f_43[iParam0] = *uParam1;
	return;
}

void func_191(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x92C5 Hash - 0xB28A4507 ^0xB28A4507
{
	int num;
	int i;
	int num2;
	...
	for (m = func_148(i, num); num2 > m; m = func_148(i, num))
	{
		i = i + 1;
		num2 = num2 - m;
	...
	num = num + iParam6;
	func_192(uParam0, l, k, j, num2, i, num);
	return;
}

void func_192(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x9447 Hash - 0x733BFBA2 ^0x733BFBA2
{
...
int func_193(int iParam0) // Position - 0x947F Hash - 0x4219564C ^0x4219564C
{
	int num;
...
int func_194(Vehicle veParam0, int iParam1, eCharacter echParam2) // Position - 0x9622 Hash - 0xBB1BDF97 ^0xC3A3101
{
	var script;
	...
	func_195(veParam0, echParam2);
	return 1;
}

void func_195(Vehicle veParam0, eCharacter echParam1) // Position - 0x9662 Hash - 0x403E4E98 ^0x34F9BF63
{
	Ped pedInVehicleSeat;
	int i;
	int j;

	if (!func_201(veParam0))
		return;
	...
	func_196(veParam0, &(Global_114370.f_32752.f_5510));
	return;
}

void func_196(Vehicle veParam0, var uParam1) // Position - 0x9864 Hash - 0x5E84B52A ^0xEF20F807
{
	int i;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(veParam0);
		...
		func_198(&veParam0, &(uParam1->f_9), &(uParam1->f_59));
	
		for (i = 0; i <= 11; i = i + 1)
		{
			if (VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(veParam0, i + 1))
				MISC::SET_BIT(&(uParam1->f_77), func_197(i + 1));
		}
...
int func_197(int iParam0) // Position - 0x9B0F Hash - 0xEE599357 ^0xEE599357
{
	switch (iParam0)
	{
		case 1:
...
int func_198(var uParam0, var uParam1, var uParam2) // Position - 0x9BBF Hash - 0x4455160E ^0x8E5B3F28
{
	int i;
	int modType;
...
BOOL func_199(int iParam0) // Position - 0x9DB2 Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_200(var uParam0) // Position - 0x9DD2 Hash - 0xB95AF921 ^0x4DC7C61C
{
	int i;
...
BOOL func_201(Vehicle veParam0) // Position - 0x9E82 Hash - 0x835CB3EF ^0xB88368F0
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false) || func_219(veParam0, 0, false) || func_219(veParam0, 1, false) || func_219(veParam0, 2, false) || func_218(veParam0) != _CHAR_NULL || func_217(veParam0) || func_216(veParam0) || func_215(veParam0) || func_214(veParam0) || !func_202(ENTITY::GET_ENTITY_MODEL(veParam0)))
	{
		func_216(veParam0);
		func_216(veParam0);
...
BOOL func_202(Hash hParam0) // Position - 0x9F5F Hash - 0x66FE4A4A ^0x10D5195D
{
	if (hParam0 == 0)
		return false;

	if (!func_203(hParam0, false, -1))
		return false;
...
BOOL func_203(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0xA11D Hash - 0x9BD8A1CC ^0xA5081522
{
	int i;
	Hash outData;
...
BOOL func_204(Hash hParam0) // Position - 0xA29F Hash - 0xC7E3100C ^0x34FBFA3F
{
	int num;
	var unk;
	var name;
...
BOOL _NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM() // Position - 0xA36B Hash - 0x2E0B1DC1 ^0xD2D0A3D9
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_206(Hash hParam0, int iParam1) // Position - 0xA382 Hash - 0x2FF24ACC ^0x65397852
{
	BOOL num;
	int cloudTimeAsInt;
...
Hash func_207(BOOL bParam0) // Position - 0xF8BA Hash - 0x9AA99395 ^0x67DFE72D
{
	if (bParam0)
		return -426933872;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0xF8D4 Hash - 0x4C81F065 ^0x79C65D03
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0xF8EA Hash - 0x4C81F065 ^0xB17A9745
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

BOOL func_210() // Position - 0xF900 Hash - 0x98B7EFDD ^0x98B7EFDD
{
	return false;
}

BOOL func_211() // Position - 0xF909 Hash - 0xFD255207 ^0xFD255207
{
	return true;
}

BOOL func_212() // Position - 0xF912 Hash - 0xFD255207 ^0xFD255207
{
	return true;
}

BOOL func_213() // Position - 0xF91B Hash - 0x64659D79 ^0xC3C726F6
{
...
BOOL func_214(Vehicle veParam0) // Position - 0xF934 Hash - 0xC71C0264 ^0x936D1A30
{
	Hash entityModel;
	...
	if (!func_203(entityModel, false, -1))
		return true;

	return false;
}

BOOL func_215(Vehicle veParam0) // Position - 0xF97B Hash - 0xA5B9FC6B ^0x23EADD90
{
	int i;
...
BOOL func_216(Vehicle veParam0) // Position - 0xF9B6 Hash - 0xB4CAAE6F ^0x153EF8BE
{
	int i;
...
BOOL func_217(Vehicle veParam0) // Position - 0xFA32 Hash - 0x7BB181DF ^0x17C4552A
{
	int i;
...
eCharacter func_218(Vehicle veParam0) // Position - 0xFB1A Hash - 0x593067C2 ^0x2918B7DD
{
	int i;
...
BOOL func_219(Vehicle veParam0, int iParam1, BOOL bParam2) // Position - 0xFB7D Hash - 0xBCC62924 ^0x77695844
{
	int i;
	var garageName;
	int num;
...
BOOL func_220(int iParam0, int iParam1, char* sParam2, var uParam3) // Position - 0xFBEB Hash - 0xA77A379E ^0x980AD61
{
...
void func_221() // Position - 0xFCC3 Hash - 0xC536DD5 ^0xC536DD5
{
	Global_21032 = 0;
	func_222();
	return;
...
void func_222() // Position - 0xFCD3 Hash - 0x21027D29 ^0xBEB9ECFD
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
