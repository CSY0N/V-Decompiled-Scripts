...
void main() // Position - 0x0 Hash - 0x17B4681A ^0x17B4681A
{
	...
	iLocal_39 = 49;
	iLocal_40 = 64;
	uLocal_49 = { 2194.1345f, 5593.2783f, 53.703827f };
	uLocal_71 = { 2203.2703f, 5549.918f, 93.09485f };
	uLocal_74 = { 2199.6294f, 5640.293f, 52.23926f };
	fLocal_77 = 81.5f;
	...
	if (func_115(uLocal_46, -1, 0, false, false))
		func_112(-1);
	else
	...
	while (true)
	{
		...
		if (BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() || bLocal_98 || func_111() && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), uLocal_46, 500f, 500f, 500f, false, true, 0))
		{
			if (!func_111())
				if (func_110())
					func_142();
...
void func_1() // Position - 0x18C Hash - 0x87FD8CDB ^0x5CB1544E
{
	if (bLocal_86 && !bLocal_85)
	{
		...
		for (iLocal_123 = 0; iLocal_123 < 6; iLocal_123 = iLocal_123 + 1)
		{
	...
	if (SYSTEM::VDIST(_GET_PLAYER_COORDS(PLAYER::PLAYER_ID()), uLocal_46) > 150f)
		func_142();

	return;
}

Vector3 _GET_PLAYER_COORDS(Player plParam0) // Position - 0x23D Hash - 0x6712BF53 ^0x688D5BEC
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(plParam0), false);
}

void func_3(int iParam0, int iParam1, int iParam2) // Position - 0x250 Hash - 0xA7DBC311 ^0xA7DBC311
{
	int unk;
	var unk2;

	unk = func_22();
	func_13(&unk, 0, 0, iParam2, iParam1, 0, 0);
	func_12(iParam0, &unk);
	unk2 = { func_4(&unk) };
	return;
}

struct<16> func_4(var uParam0) // Position - 0x27F Hash - 0x67D8EDDB ^0x67D8EDDB
{
	var unk;
	int num;
	...
	TEXT_LABEL_APPEND_STRING(&unk, "/", 64);
	TEXT_LABEL_APPEND_INT(&unk, func_5(*uParam0), 64);
	return unk;
}

int func_5(int iParam0) // Position - 0x34A Hash - 0xE1B0542C ^0x127A471E
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_6(BOOL bParam0, var uParam1, var uParam2) // Position - 0x36C Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
int func_7(int iParam0) // Position - 0x383 Hash - 0x2D4DB85F ^0x2D4DB85F
{
	return iParam0 & 15;
}

int func_8(int iParam0) // Position - 0x390 Hash - 0x826C592F ^0xDEC5AA46
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_9(int iParam0) // Position - 0x3A2 Hash - 0x90B520AB ^0x257AC1C4
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_10(int iParam0) // Position - 0x3B5 Hash - 0xC188C91C ^0x48884C7
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_11(int iParam0) // Position - 0x3C8 Hash - 0x626AEC54 ^0xDB28E416
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

void func_12(int iParam0, var uParam1) // Position - 0x3DB Hash - 0x63EF72B0 ^0xC612AA53
{
	Global_114370.f_24998.f_43[iParam0] = *uParam1;
	return;
}

void func_13(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x3F3 Hash - 0xB28A4507 ^0xB28A4507
{
	int num;
	int i;
	int num2;
	...
	for (m = func_21(i, num); num2 > m; m = func_21(i, num))
	{
		i = i + 1;
		num2 = num2 - m;
	...
	num = num + iParam6;
	func_14(uParam0, l, k, j, num2, i, num);
	return;
}

void func_14(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x575 Hash - 0x733BFBA2 ^0x733BFBA2
{
...
void func_15(var uParam0, int iParam1) // Position - 0x5AD Hash - 0x15B9927E ^0x4A4674
{
	if (iParam1 <= 0)
		return;
...
void func_16(var uParam0, int iParam1) // Position - 0x633 Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
	...
	if (iParam1 < 1 || iParam1 > func_21(num, num2))
		return;
...
void func_17(var uParam0, int iParam1) // Position - 0x684 Hash - 0x4C70B2C3 ^0x4C70B2C3
{
...
void func_18(var uParam0, int iParam1) // Position - 0x6B7 Hash - 0x864304A8 ^0x1F5003E2
{
...
void func_19(var uParam0, int iParam1) // Position - 0x6F1 Hash - 0x76860AE7 ^0x32308FFF
{
...
void func_20(var uParam0, int iParam1) // Position - 0x72C Hash - 0xDB8A72C0 ^0x4F6D426D
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
int func_21(int iParam0, int iParam1) // Position - 0x768 Hash - 0xD3EBACB3 ^0xD3EBACB3
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_22() // Position - 0x80A Hash - 0x9E44C35 ^0xB9993D58
{
	var unk;

	func_20(&unk, CLOCK::GET_CLOCK_SECONDS());
	func_19(&unk, CLOCK::GET_CLOCK_MINUTES());
	func_18(&unk, CLOCK::GET_CLOCK_HOURS());
	func_16(&unk, CLOCK::GET_CLOCK_DAY_OF_MONTH());
	func_17(&unk, CLOCK::GET_CLOCK_MONTH());
	func_15(&unk, CLOCK::GET_CLOCK_YEAR());
	return unk;
}

void func_23(int iParam0) // Position - 0x850 Hash - 0xC421D95B ^0x6C3664BD
{
	Global_114370.f_24998.f_7 = iParam0;
	return;
}

void func_24() // Position - 0x863 Hash - 0x603A1B8E ^0x23835D64
{
	func_71();
	func_70();
	...
	{
		case 0:
			if (OBJECT::DOES_PICKUP_EXIST(pkLocal_111))
			{
				if (HUD::DOES_BLIP_EXIST(blLocal_112))
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), uLocal_71, uLocal_74, fLocal_77, false, true, 0))
					{
						func_67();
		...
		case 1:
			if (PED::IS_PED_INJURED(iLocal_101[0]) && PED::IS_PED_INJURED(iLocal_101[1]) && PED::IS_PED_INJURED(iLocal_101[2]) && PED::IS_PED_INJURED(iLocal_101[3]) && PED::IS_PED_INJURED(iLocal_101[4]))
				func_25();
			else if (!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), uLocal_46, 100f, 100f, 100f, false, true, 0))
				func_25();
			break;
	}
...
void func_25() // Position - 0x9A9 Hash - 0x228D22C5 ^0x58394260
{
	_DISPLAY_HELP_TEXT("DRUG_BLIP_END" /*Try coming back in a week or so to see if they have made more takings.*/, -1);
...
void func_26() // Position - 0x9F5 Hash - 0xD765C186 ^0xD765C186
{
	func_27();
	return;
}

int func_27() // Position - 0xA02 Hash - 0x9482CBBF ^0x8B17A994
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0xA4D Hash - 0x15889021 ^0xE7262364
{
...
void func_29(int iParam0, int iParam1) // Position - 0xA75 Hash - 0x10585743 ^0x10585743
{
	if (iParam0 == -1)
		iParam0 = func_53();
	...
	if (iParam1 <= func_52(iParam0))
	{
		...
		if (func_37(iParam0, iParam1) != 322)
			func_31(func_37(iParam0, iParam1), uLocal_41, uLocal_41.f_1);
...
void func_30(int iParam0) // Position - 0xB78 Hash - 0xE49C42EC ^0xE49C42EC
{
	Global_114356 = iParam0;
	return;
}

void func_31(int iParam0, var uParam1, var uParam2) // Position - 0xB86 Hash - 0xEC2439E7 ^0x1B67A713
{
	BOOL flag;
...
void func_32() // Position - 0xC6C Hash - 0x9F269E94 ^0x9F269E94
{
	int num;
	float num2;
	float num3;
...
int func_33() // Position - 0x112A Hash - 0x21D64237 ^0x21D64237
{
	return Global_32828;
}

BOOL func_34(int iParam0, int iParam1) // Position - 0x1135 Hash - 0x77E0C72A ^0x80DA2A54
{
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x1186 Hash - 0xCF91FBA1 ^0xAE1D9C41
{
	if (iParam2 == -1)
		iParam2 = func_36();
...
int func_36() // Position - 0x11A4 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1574925;
}

int func_37(int iParam0, int iParam1) // Position - 0x11B0 Hash - 0xE97012CD ^0x68FBF85A
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_38(int iParam0) // Position - 0x1524 Hash - 0xBF3EFB31 ^0xBF3EFB31
{
	switch (iParam0)
	{
		case 29:
...
void func_39(int iParam0) // Position - 0x1553 Hash - 0x12249850 ^0x46987D7A
{
	int offset;
	int i;
...
void func_40(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x1595 Hash - 0x1DB2B0EC ^0x1DB2B0EC
{
	func_41(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
	return;
}

void func_41(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x15B6 Hash - 0x442CE504 ^0xD696ABBA
{
	int i;
...
void func_42() // Position - 0x1789 Hash - 0xCF8881D1 ^0x40507183
{
	int i;
...
int func_43() // Position - 0x18A0 Hash - 0x35BC7314 ^0x35BC7314
{
	func_44();
...
void func_44() // Position - 0x18E6 Hash - 0xD1F2D853 ^0xF9F5FD4D
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114370.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_46(character) && !func_45(14) || Global_113320)
			{
				if (Global_114370.f_2366.f_539.f_4321 != character && func_46(Global_114370.f_2366.f_539.f_4321))
...
BOOL func_45(int iParam0) // Position - 0x19E3 Hash - 0x937D8816 ^0x937D8816
{
	return Global_43922 == iParam0;
}

BOOL func_46(eCharacter echParam0) // Position - 0x19F1 Hash - 0x8907F004 ^0x8907F004
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x19FD Hash - 0xAC4E9801 ^0xB379A75F
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x1A3A Hash - 0xADCB9755 ^0xADCB9755
{
...
Hash func_49(eCharacter echParam0) // Position - 0x1A5F Hash - 0xE4CEEC2C ^0xE4CEEC2C
{
	return Global_2139[echParam0 /*29*/];
}

BOOL func_50(int iParam0) // Position - 0x1A6E Hash - 0x3F44A899 ^0x7041C53
{
	int num;
	int i;
...
void func_51(int iParam0, int iParam1) // Position - 0x1AAE Hash - 0xE2246457 ^0xD5018049
{
	MISC::SET_BIT(&Global_114370.f_24998.f_8[iParam0], iParam1);
	return;
}

int func_52(int iParam0) // Position - 0x1AC9 Hash - 0xAA02DAD0 ^0xAA02DAD0
{
	int num;
...
int func_53() // Position - 0x1B7A Hash - 0x7AC1007E ^0x4E7D4F54
{
	var unk;
	int num;
...
int func_54(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0x1B97 Hash - 0x6DA57317 ^0x57A32A43
{
...
BOOL func_55() // Position - 0x1D71 Hash - 0xFD255207 ^0xFD255207
{
	return true;
}

BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x1D7A Hash - 0x152DA0B2 ^0x220E93E9
{
...
void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x1D9C Hash - 0xCBB0D91 ^0x21070E5C
{
...
int func_58(BOOL bParam0) // Position - 0x1DB3 Hash - 0x4B2ABEC4 ^0x20F7D869
{
	if (func_61())
	{
		Global_114360 = true;
		...
		if (bParam0 && func_38(Global_114359))
...
void func_59(int iParam0) // Position - 0x1E05 Hash - 0x3B4E6AAB ^0x52844A7B
{
	switch (iParam0)
	{
		case 0:
			if (Global_114370.f_24998.f_2 < 3)
			{
				...
				{
					_DISPLAY_HELP_TEXT(func_60(iParam0), -1);
...
char* func_60(int iParam0) // Position - 0x1EE0 Hash - 0xBFB345C9 ^0xBFB345C9
{
	char* str;
...
BOOL func_61() // Position - 0x1F20 Hash - 0x8129EEA4 ^0x48B13301
{
	switch (func_62(&Global_32888, 0, 5, false, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return true;
...
int func_62(var uParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0x1F56 Hash - 0x8F9349A ^0xC5C097C1
{
	int i;
...
void func_63(var uParam0, int iParam1) // Position - 0x208D Hash - 0x6AC97785 ^0x6AC97785
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0x20DC Hash - 0xECB6C71B ^0xECB6C71B
{
	return func_65(iParam0, Global_43922);
}

BOOL func_65(int iParam0, int iParam1) // Position - 0x20ED Hash - 0x1FD727E0 ^0x1FD727E0
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_66(int iParam0) // Position - 0x22CE Hash - 0x3BAB94E9 ^0x3BAB94E9
{
	if (Global_43922 == 15)
		return false;
...
void func_67() // Position - 0x22F0 Hash - 0xABBDB93 ^0x288978E9
{
	if (HUD::DOES_BLIP_EXIST(blLocal_112))
	{
		...
		if (OBJECT::DOES_PICKUP_EXIST(pkLocal_111))
			if (!HUD::DOES_BLIP_EXIST(blLocal_113))
				blLocal_113 = func_68(pkLocal_111);
	}

	return;
}

Blip func_68(Pickup pkParam0) // Position - 0x2322 Hash - 0x42B7DDF3 ^0xA5D225DC
{
	Blip blip;
...
var func_69(BOOL bParam0, var uParam1, var uParam2) // Position - 0x235A Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_70() // Position - 0x2371 Hash - 0xA5B79181 ^0x5574A04D
{
	if (OBJECT::HAS_PICKUP_BEEN_COLLECTED(pkLocal_111))
	{
		if (HUD::DOES_BLIP_EXIST(blLocal_112))
			HUD::REMOVE_BLIP(&blLocal_112);
...
void func_71() // Position - 0x239F Hash - 0x471E4B68 ^0x2700DC80
{
	int i;
	int j;
	...
	for (iLocal_123 = 0; iLocal_123 < 6; iLocal_123 = iLocal_123 + 1)
	{
		...
		else
		{
			if (func_95() && iLocal_125 != 2 || iLocal_125 == 1 && PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
			{
				...
				if (func_92())
				{
					_CONVERSATION_INITIALIZE_ACTOR(&uLocal_129, 4, iLocal_101[iLocal_123], "DRUGFARMGOON", 0, 1);
					_CONVERSATION_ADD_LINE(&uLocal_129, "RECSHAU", "RECSH_BACK", 4, 0, 0, 0);
				}
						...
						if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_101[iLocal_123], PLAYER::PLAYER_PED_ID(), 15f, 15f, 40f, false, true, 0) && PLAYER::CAN_PED_HEAR_PLAYER(PLAYER::PLAYER_ID(), iLocal_101[iLocal_123]) || PED::CAN_PED_SEE_HATED_PED(iLocal_101[iLocal_123], PLAYER::PLAYER_PED_ID()))
						{
							if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), uLocal_71, uLocal_74, fLocal_77, false, true, 0) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 2205.9185f, 5633.4546f, 55.7472f, 15f, 15f, 40f, false, true, 0))
							{
								...
								for (i = 0; i < iLocal_101; i = i + 1)
								{
									...
									TASK::TASK_PERFORM_SEQUENCE(iLocal_101[i], iLocal_122);
									TASK::CLEAR_SEQUENCE_TASK(&iLocal_122);
									PED::SET_PED_USING_ACTION_MODE(iLocal_101[i], true, -1, 0);
								}
				...
				case 1:
					for (j = 0; j < iLocal_101; j = j + 1)
					{
						if (!iLocal_88[j])
						{
							...
							TASK::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, false);
							TASK::CLOSE_SEQUENCE_TASK(iLocal_122);
							TASK::TASK_PERFORM_SEQUENCE(iLocal_101[j], iLocal_122);
							TASK::CLEAR_SEQUENCE_TASK(&iLocal_122);
							PED::SET_PED_USING_ACTION_MODE(iLocal_101[j], true, -1, 0);
							iLocal_88[j] = 1;
						}
					}
					...
					if (iLocal_88[iLocal_123] && !bLocal_95)
					{
						if (MISC::GET_GAME_TIMER() - iLocal_128 > 6000)
						{
							if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
					...
					if (iLocal_88[iLocal_123] && !bLocal_96)
					{
					...
					if (iLocal_88[iLocal_123])
					{
						...
						{
							if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), uLocal_71, uLocal_74, fLocal_77, false, true, 0) || ENTITY::IS_ENTITY_AT_ENTITY(iLocal_101[iLocal_123], PLAYER::PLAYER_PED_ID(), 15f, 15f, 5f, false, true, 0))
							{
								func_93();
								SYSTEM::WAIT(0);
								...
								{
									_CONVERSATION_INITIALIZE_ACTOR(&uLocal_129, 3, iLocal_101[iLocal_123], "SalvadorGang", 0, 1);
									_CONVERSATION_ADD_LINE(&uLocal_129, "RECSHAU", "RECSH_FIRE", 4, 0, 0, 0);
								}
							...
							else
							{
								if (!PED::IS_PED_IN_COMBAT(iLocal_101[iLocal_123], 0))
								{
									...
									if (!PED::IS_PED_INJURED(iLocal_101[0]))
									{
										...
										TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2222.2588f, 5613.22f, 53.5576f, 1f, -1, 1048576000, 0, 1193033728);
									...
									{
										TASK::OPEN_SEQUENCE_TASK(&iLocal_122);
										TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2210.5842f, 5580.6836f, 52.8132f, 1f, -1, 1048576000, 0, 1193033728);
										TASK::TASK_TURN_PED_TO_FACE_COORD(0, 2205.466f, 5583.631f, 52.8682f, 8000);
										TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2203.0386f, 5567.4077f, 52.7996f, 1f, -1, 1048576000, 0, 1193033728);
									...
									{
										TASK::OPEN_SEQUENCE_TASK(&iLocal_122);
										TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2199.6792f, 5590.673f, 52.7784f, 1f, -1, 1048576000, 0, 1193033728);
										TASK::TASK_TURN_PED_TO_FACE_COORD(0, 2210.6458f, 5593.5757f, 52.8312f, 8000);
										TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2232.7615f, 5593.5635f, 53.0542f, 1f, -1, 1048576000, 0, 1193033728);
									...
									{
										TASK::OPEN_SEQUENCE_TASK(&iLocal_122);
										TASK::TASK_GO_TO_ENTITY(0, iLocal_101[4], -1, 2f, 1f, 1073741824, 0);
									...
									{
										TASK::OPEN_SEQUENCE_TASK(&iLocal_122);
										TASK::TASK_GO_TO_ENTITY(0, iLocal_101[3], -1, 2f, 1f, 1073741824, 0);
					...
					for (iLocal_123 = 0; iLocal_123 < 6; iLocal_123 = iLocal_123 + 1)
					{
						if (!PED::IS_PED_INJURED(iLocal_101[iLocal_123]))
						{
							if (!PED::IS_PED_IN_COMBAT(iLocal_101[iLocal_123], 0))
							{
								...
								if (!HUD::DOES_BLIP_EXIST(uLocal_114[iLocal_123]))
									uLocal_114[iLocal_123] = func_72(iLocal_101[iLocal_123], true, 145);
							}
						}
...
Blip func_72(Entity eParam0, BOOL bParam1, int iParam2) // Position - 0x2BF3 Hash - 0xA714218A ^0xAD0F82BD
{
	Blip blip;

	blip = func_73(eParam0, !bParam1, false);
...
Blip func_73(Entity eParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2C3D Hash - 0x2E5A72B ^0x64F26CC0
{
	Blip blip;
...
int _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x2CE1 Hash - 0x384540C1 ^0x384540C1
{
...
int func_75(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x2D2F Hash - 0x77297D51 ^0x40DC584A
{
	Global_22167 = 0;
...
void func_76() // Position - 0x2FFD Hash - 0xF42BEB19 ^0xA29557DA
{
	if (!func_77())
		return;
...
BOOL func_77() // Position - 0x3034 Hash - 0x7B74B45F ^0xCE052A5D
{
...
BOOL func_78(Player plParam0) // Position - 0x3097 Hash - 0x6E46BC72 ^0x6E46BC72
{
	return func_79(plParam0, 20);
}

BOOL func_79(Player plParam0, int iParam1) // Position - 0x30A7 Hash - 0x7CD5054C ^0x870BEA81
{
	return IS_BIT_SET(Global_1886967[plParam0 /*609*/].f_10.f_4, iParam1);
}

Player _INVALID_PLAYER_INDEX() // Position - 0x30BF Hash - 0x478900E4 ^0x478900E4
{
	return -1;
}

void func_81() // Position - 0x30C8 Hash - 0x46021FAA ^0x42D52423
{
	int i;
...
void func_82() // Position - 0x30F9 Hash - 0xCD8A4D28 ^0xCD8A4D28
{
...
BOOL func_83() // Position - 0x318E Hash - 0xD140D54A ^0xE638D98F
{
...
BOOL func_84() // Position - 0x31B5 Hash - 0x9A999369 ^0x4033F7BF
{
	int num;
	int weaponHash;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x324E Hash - 0x98476CE1 ^0x250FEB7C
{
	if (func_45(14))
	{
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x32F0 Hash - 0x3C5423D7 ^0x3C5423D7
{
	func_44();
	return Global_114370.f_2366.f_539.f_4321;
}

void func_87() // Position - 0x3309 Hash - 0x6F78FD7A ^0x26861BB7
{
	int i;
...
BOOL func_88(int iParam0, int iParam1) // Position - 0x3360 Hash - 0xA14C4D3F ^0xA6034F77
{
	switch (iParam0)
	{
		case 5:
...
void func_89() // Position - 0x3398 Hash - 0xE32CF1EF ^0xB9A7BEB2
{
...
void func_90(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x33EF Hash - 0xC6B752B2 ^0xC6B752B2
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x3445 Hash - 0x6C235EE0 ^0x9E57F206
{
...
BOOL func_92() // Position - 0x34E0 Hash - 0x8190E5D8 ^0xCA87BC87
{
	return Global_114370.f_24998.f_7;
}

void func_93() // Position - 0x34F1 Hash - 0xC536DD5 ^0xC536DD5
{
	Global_21032 = 0;
	func_94();
	return;
...
void func_94() // Position - 0x3501 Hash - 0xF6D04E68 ^0x80AE5309
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_23177 = 0;
...
BOOL func_95() // Position - 0x3522 Hash - 0xCA10BEA8 ^0xC1E1868D
{
	int i;

	for (i = 0; i < iLocal_108; i = i + 1)
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_108[i], false))
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_108[i], PLAYER::PLAYER_PED_ID(), true))
				return true;
	}

	for (i = 0; i < iLocal_101; i = i + 1)
	{
		if (!PED::IS_PED_INJURED(iLocal_101[i]))
		{
			if (PED::CAN_PED_SEE_HATED_PED(iLocal_101[i], PLAYER::PLAYER_PED_ID()))
				if (PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_101[i]) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iLocal_101[i]))
					return true;
		
			if (MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_101[i], true), 5f, true) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_101[i], PLAYER::PLAYER_PED_ID(), true) || ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_101[i]) || MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_101[i], true) - { 15f, 15f, 15f }, ENTITY::GET_ENTITY_COORDS(iLocal_101[i], true) + { 15f, 15f, 15f }, joaat("WEAPON_SMOKEGRENADE"), true) || MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_101[i], true) - { 15f, 15f, 15f }, ENTITY::GET_ENTITY_COORDS(iLocal_101[i], true) + { 15f, 15f, 15f }, joaat("WEAPON_GRENADE"), true) || MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_101[i], true) - { 15f, 15f, 15f }, ENTITY::GET_ENTITY_COORDS(iLocal_101[i], true) + { 15f, 15f, 15f }, joaat("WEAPON_GRENADELAUNCHER"), true) || MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_101[i], true) - { 15f, 15f, 15f }, ENTITY::GET_ENTITY_COORDS(iLocal_101[i], true) + { 15f, 15f, 15f }, joaat("WEAPON_STICKYBOMB"), true))
				return true;
		}
	}

	if (FIRE::IS_EXPLOSION_IN_ANGLED_AREA(-1, uLocal_71, uLocal_74, fLocal_77))
		return true;
...
void func_96() // Position - 0x3795 Hash - 0x5FE7CC3E ^0xE8C5C58A
{
	int address;
	...
	{
		PED::ADD_SCENARIO_BLOCKING_AREA(uLocal_46 - { 20f, 50f, 50f }, uLocal_46 + { 20f, 50f, 50f }, false, true, true, true, 1);
		...
		VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_108[0], 1084227584);
		...
		pkLocal_111 = OBJECT::CREATE_PICKUP_ROTATE(joaat("PICKUP_MONEY_CASE"), uLocal_49, -1.368082f, 0.230633f, 176.87486f, address, MISC::GET_RANDOM_INT_IN_RANGE(40000, 100000), 2, true, joaat("prop_cash_case_01"));
		uLocal_52[0 /*3*/] = { 2205.769f, 5631.985f, 55.553f };
		uLocal_78[0] = 352.2203f;
		uLocal_52[1 /*3*/] = { 2210.5842f, 5580.6836f, 52.8132f };
		uLocal_78[1] = 300.5012f;
		uLocal_52[2 /*3*/] = { 2201.3025f, 5589.2793f, 52.9354f };
		uLocal_78[2] = 53.1602f;
		uLocal_52[3 /*3*/] = { 2202.5352f, 5613.3667f, 52.6781f };
		uLocal_78[3] = 70f;
		uLocal_52[4 /*3*/] = { 2200.764f, 5614.076f, 52.6852f };
		uLocal_78[4] = 53f;
		uLocal_52[5 /*3*/] = { 2193.714f, 5595.456f, 52.7615f };
		uLocal_78[5] = 338.8346f;
		PED::ADD_RELATIONSHIP_GROUP("DrugCult", &hLocal_121);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(3, hLocal_121, joaat("COP"));
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(3, joaat("COP"), hLocal_121);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, hLocal_121, joaat("PLAYER"));
	
		for (iLocal_123 = 0; iLocal_123 < 6; iLocal_123 = iLocal_123 + 1)
		{
			iLocal_101[iLocal_123] = PED::CREATE_PED(PED_TYPE_MISSION, joaat("G_M_Y_SalvaGoon_01"), uLocal_52[iLocal_123 /*3*/], uLocal_78[iLocal_123], true, true);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_101[iLocal_123], true);
			PED::SET_PED_COMBAT_MOVEMENT(iLocal_101[iLocal_123], CM_WillAdvance);
			PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_101[iLocal_123], BF_CanCharge, true);
			PED::SET_PED_COMBAT_RANGE(iLocal_101[iLocal_123], 0);
			PED::SET_PED_ACCURACY(iLocal_101[iLocal_123], 13);
			PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_101[iLocal_123], hLocal_121);
		...
		if (!PED::IS_PED_INJURED(iLocal_101[0]))
		{
			...
			TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2205.769f, 5631.985f, 55.553f, 1f, -1, 1048576000, 0, 1193033728);
			TASK::TASK_TURN_PED_TO_FACE_COORD(0, 2214.833f, 5635.6274f, 55.0029f, 8000);
			TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2215.9932f, 5613.299f, 53.6157f, 1f, -1, 1048576000, 0, 1193033728);
			TASK::TASK_TURN_PED_TO_FACE_COORD(0, 2221.9507f, 5593.6255f, 52.9483f, 10000);
			TASK::SET_SEQUENCE_TO_REPEAT(iLocal_122, true);
			TASK::CLOSE_SEQUENCE_TASK(iLocal_122);
			TASK::TASK_PERFORM_SEQUENCE(iLocal_101[0], iLocal_122);
		...
		{
			TASK::OPEN_SEQUENCE_TASK(&iLocal_122);
			TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2201.0137f, 5589.357f, 52.9573f, 1f, -1, 1048576000, 0, 1193033728);
			TASK::TASK_TURN_PED_TO_FACE_COORD(0, 2210.6458f, 5593.5757f, 52.8312f, 8000);
			TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2229.6667f, 5598.368f, 53.2195f, 1f, -1, 1048576000, 0, 1193033728);
			TASK::TASK_TURN_PED_TO_FACE_COORD(0, 2237.9163f, 5599.5894f, 53.2311f, 12000);
			TASK::SET_SEQUENCE_TO_REPEAT(iLocal_122, true);
			TASK::CLOSE_SEQUENCE_TASK(iLocal_122);
			TASK::TASK_PERFORM_SEQUENCE(iLocal_101[2], iLocal_122);
		...
		blLocal_112 = func_97(uLocal_49, false);
		HUD::SET_BLIP_SPRITE(blLocal_112, BLIP_WEED_STASH);
		_DISPLAY_HELP_TEXT("DRUG_BLIP_START" /*This is a Weed Farm - you can raid it and steal their takings.*/, -1);
		iLocal_44 = 1;
	}
...
Blip func_97(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x3DCD Hash - 0xF4E99477 ^0x29669E98
{
	Blip blip;
...
BOOL func_98() // Position - 0x3DF9 Hash - 0xC05B0E62 ^0x94C54EFE
{
	...
	if (func_99(100f, true) != -1)
		return true;

	return false;
}

int func_99(float fParam0, BOOL bParam1) // Position - 0x3E7F Hash - 0xA169FFDC ^0x284941E0
{
	var unk;
	int num;
	int num2;
...
void func_100(int iParam0, var uParam1) // Position - 0x3F30 Hash - 0x45E5CB0A ^0x45E5CB0A
{
	switch (iParam0)
	{
		case 0:
		...
		case 5:
			func_101(uParam1, "Barry3A", func_103(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH" /*Areas where you can find vehicles with a hidden stash have been marked on the map. Collect these vehicles for Barry.*/, 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_102(iParam0), 0, 1);
			break;
		...
		case 8:
			func_101(uParam1, "Dreyfuss1", func_103(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT" /*The killer's identity and location have been revealed.*/, 106, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_102(iParam0), 0, 0);
			break;
		...
		case 38:
			func_101(uParam1, "Nigel1A", func_103(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS" /*Areas where you can find celebrity items have been marked on the map. Steal these items for Nigel and Mrs. Thornhill.*/, 100, 0, "", 0, 0, 42, 4, 4, 0, 2359, func_102(iParam0), 1, 1);
			break;
		...
		case 49:
			func_101(uParam1, "Paparazzo3A", func_103(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO" /*Areas where you can find celebrity photo opportunities have been marked on the map. Track down and photograph these celebrities for Beverly.*/, 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_102(iParam0), 0, 1);
			break;
		...
		case 58:
			func_101(uParam1, "Tonya1", func_103(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS" /*Strangers and Freaks can be found throughout San Andreas at ~HUD_COLOUR_FRANKLIN~~BLIP_RANDOM_CHARACTER~~s~*/, -1, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_102(iParam0), 0, 1);
			break;
...
void func_101(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6, float fParam7, float fParam8, float fParam9, int iParam10, char* sParam11, int iParam12, int iParam13, char* sParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, int iParam22, int iParam23, int iParam24) // Position - 0x51AE Hash - 0x340E6E87 ^0xA591C803
{
	uParam0->f_4 = iParam5;
	*uParam0 = sParam1;
	uParam0->f_1 = { uParam2 };
...
int func_102(int iParam0) // Position - 0x523F Hash - 0xC999F6B2 ^0xC999F6B2
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_103(int iParam0) // Position - 0x5585 Hash - 0x8E0EE9EB ^0x1B64036A
{
	var unk;
	var unk3;

	TEXT_LABEL_ASSIGN_STRING(&unk, "", 8);
	unk3 = { func_104(iParam0) };
...
struct<2> func_104(int iParam0) // Position - 0x55BC Hash - 0x5818CE19 ^0xF7865EC2
{
	var unk;
...
BOOL func_105() // Position - 0x5A08 Hash - 0x7055FFB1 ^0x7055FFB1
{
...
BOOL func_106() // Position - 0x5A3A Hash - 0x79CF7679 ^0x79CF7679
{
	return Global_114088 > 0;
}

BOOL func_107() // Position - 0x5A48 Hash - 0xCF2296C0 ^0xCF2296C0
{
	if (Global_98294 != -1)
		return true;
...
BOOL func_108() // Position - 0x5A5D Hash - 0x98CCC132 ^0x97B0D6ED
{
	if (Global_98294 != -1)
...
BOOL func_109() // Position - 0x5A80 Hash - 0x29CB2928 ^0xE369A18D
{
...
BOOL func_110() // Position - 0x5A9D Hash - 0xF2B7F534 ^0x7F3EC4F9
{
...
BOOL func_111() // Position - 0x5AFF Hash - 0x1121F6F2 ^0x90CE37A6
{
...
void func_112(int iParam0) // Position - 0x5B2A Hash - 0xA62BD46A ^0x1E050688
{
	if (iParam0 == -1)
		iParam0 = func_53();
...
void func_113() // Position - 0x5B60 Hash - 0x178BF2A7 ^0x744062F5
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
...
void func_114(int iParam0) // Position - 0x5B9D Hash - 0xE49C42EC ^0xE49C42EC
{
	Global_114359 = iParam0;
	return;
}

BOOL func_115(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x5BAB Hash - 0xC601B4EA ^0xC601B4EA
{
	BOOL flag;
	...
	if (!flag)
	{
		...
		if (func_46(_GET_CURRENT_PLAYER_CHARACTER()))
			if (func_138(_GET_CURRENT_PLAYER_CHARACTER()) == 4 || func_138(_GET_CURRENT_PLAYER_CHARACTER()) == 5)
				return false;
...
BOOL func_116(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x5F45 Hash - 0x2D46096D ^0xEA41378F
{
	if (bParam6)
...
BOOL func_117(eCharacter echParam0) // Position - 0x5F8C Hash - 0x687D9246 ^0x687D9246
{
	int num;
...
BOOL func_118(int iParam0) // Position - 0x5FAD Hash - 0x2D75E13A ^0x2D75E13A
{
	return func_119(iParam0, 1);
}

int func_119(int iParam0, int iParam1) // Position - 0x5FBC Hash - 0x1F92FEBC ^0x1F92FEBC
{
	var unk;
	var unk2;
	int num;
	...
	func_120(iParam0, &unk, &unk2, &num, &num2, &num3, &num4);
...
void func_120(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x600F Hash - 0x2BEE335D ^0x2BEE335D
{
	func_121(func_22(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
	return;
}

void func_121(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x602D Hash - 0xB807819C ^0xB807819C
{
	int num;
	int num2;
	int num3;
	...
	if (func_123(iParam0, iParam1))
	{
		num = func_7(iParam1);
		num2 = func_5(iParam0);
		num3 = func_5(iParam0) - func_5(iParam1);
		num4 = func_7(iParam0) - func_7(iParam1);
		num5 = func_8(iParam0) - func_8(iParam1);
		num6 = func_11(iParam0) - func_11(iParam1);
		num7 = func_10(iParam0) - func_10(iParam1);
		num8 = func_9(iParam0) - func_9(iParam1);
	}
	else
	{
		num = func_7(iParam0);
		num2 = func_5(iParam1);
		num3 = func_5(iParam1) - func_5(iParam0);
		num4 = func_7(iParam1) - func_7(iParam0);
		num5 = func_8(iParam1) - func_8(iParam0);
		num6 = func_11(iParam1) - func_11(iParam0);
		num7 = func_10(iParam1) - func_10(iParam0);
		num8 = func_9(iParam1) - func_9(iParam0);
	}
	...
	while (num5 < 0)
	{
		...
		num5 = num5 + func_21(num, num2);
		num4 = num4 - 1;
		num = SYSTEM::ROUND(func_122(SYSTEM::TO_FLOAT(num + 1), 0f, 12f));
	}
...
float func_122(float fParam0, float fParam1, float fParam2) // Position - 0x622E Hash - 0xDB08F514 ^0x78C0BF6F
{
	float num;
...
BOOL func_123(int iParam0, int iParam1) // Position - 0x6270 Hash - 0xEA08B1 ^0xEA08B1
{
	int num;
	int num2;
...
BOOL func_124(int iParam0) // Position - 0x637C Hash - 0x57D8E518 ^0xD297DD35
{
	int num;
	int num2;
	int num3;
	...
	num2 = func_10(iParam0);

	if (num2 < 0 || num2 >= 60)
		return false;

	num3 = func_11(iParam0);
	...
	if (num6 < 1 || num6 > func_21(num5, num4))
		return false;

	return true;
}

BOOL func_125(int iParam0, int iParam1) // Position - 0x6458 Hash - 0x577FB514 ^0xAAF8B538
{
...
BOOL func_126(int iParam0) // Position - 0x6478 Hash - 0x97844555 ^0xADCD6DAA
{
	eCharacter character;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_134() || Global_113417 || Global_32831 || func_133() || func_88(8, -1) || func_132() || func_131() || func_130() || func_129() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_134() || Global_32831 || func_133() || func_88(8, -1) || func_130() || func_132() || func_131() || func_129() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_134() || Global_113417 || Global_32831 || func_133() || func_88(8, -1) || func_130() || func_132() || func_131() || func_129() || Global_114370.f_7691.f_919[character] == 5 || Global_44469 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_134() || Global_113417 || Global_32831 || func_133() || func_88(8, -1) || func_132() || func_131() || func_129() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_134() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_88(8, -1) || func_129() || func_128() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
...
BOOL func_127() // Position - 0x6B95 Hash - 0x4228A1C2 ^0x952FE30F
{
	return Global_101431.f_1;
}

BOOL func_128() // Position - 0x6BA3 Hash - 0xC20DBA70 ^0xAC4006FB
{
	if (Global_98294 != -1)
...
BOOL func_129() // Position - 0x6BC6 Hash - 0x3CA1BB47 ^0xB78A1ACB
{
...
BOOL func_130() // Position - 0x6BE0 Hash - 0xE663B8F6 ^0xE663B8F6
{
	if (Global_79509)
		return true;
...
BOOL func_131() // Position - 0x6C0A Hash - 0xD56328D2 ^0xD56328D2
{
	return Global_101444.f_394 > 0;
}

BOOL func_132() // Position - 0x6C1B Hash - 0xD56328D2 ^0xD56328D2
{
	return Global_101444.f_393 > 0;
}

BOOL func_133() // Position - 0x6C2C Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1575079;
}

BOOL func_134() // Position - 0x6C38 Hash - 0x7FE517FE ^0x128A3BC8
{
...
BOOL func_135() // Position - 0x6C54 Hash - 0xB12DEAA2 ^0xB12DEAA2
{
	_UPDATE_CURRENT_PLAYER_CHARACTER();
...
BOOL func_136(int iParam0) // Position - 0x6C7C Hash - 0xCDB90269 ^0xCDB90269
{
	return func_123(func_22(), iParam0);
}

BOOL func_137(int iParam0, int iParam1, eCharacter echParam2) // Position - 0x6C8E Hash - 0xBEEFD79C ^0xBEEFD79C
{
	BOOL num;
	eCharacter character;
...
int func_138(eCharacter echParam0) // Position - 0x6D72 Hash - 0x45FC9D61 ^0x45FC9D61
{
...
BOOL func_139(int iParam0) // Position - 0x6D96 Hash - 0xF2A54181 ^0xF2A54181
{
	int num;
	BOOL flag;
...
BOOL func_140() // Position - 0x6DEE Hash - 0xB72C022E ^0x452A7B6D
{
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x6E32 Hash - 0x44DD83CC ^0x7B62A376
{
	int profileSetting;
...
void func_142() // Position - 0x6EEA Hash - 0xCA3A4C8F ^0xBD3F9F53
{
	if (bLocal_86)
	{
		if (!bLocal_85)
...
void func_143(int iParam0) // Position - 0x6F86 Hash - 0xE6B11918 ^0x37AF2AD2
{
	var name;
	...
	if (func_111())
	{
		...
		func_146(30000);
		TEXT_LABEL_ASSIGN_STRING(&name, func_145(Global_114359, true), 64);
...
void func_144(var uParam0) // Position - 0x7038 Hash - 0x995C9E2 ^0x995C9E2
{
	if (*uParam0 == -1)
		return;
...
char* func_145(int iParam0, BOOL bParam1) // Position - 0x7075 Hash - 0x959319CB ^0xD4679856
{
	switch (iParam0)
	{
		case 0:
...
void func_146(int iParam0) // Position - 0x72BE Hash - 0xC0234809 ^0x4FD853DC
{
	Global_44473 = MISC::GET_GAME_TIMER() + iParam0;
	return;
}

void func_147(int iParam0) // Position - 0x72D0 Hash - 0x881273A8 ^0x881273A8
{
	func_3(iParam0, 0, func_148(iParam0));
	return;
}

int func_148(int iParam0) // Position - 0x72E5 Hash - 0x4219564C ^0x4219564C
{
	int num;
