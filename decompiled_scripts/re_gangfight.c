...
void main() // Position - 0x0 Hash - 0x17B4681A ^0x17B4681A
{
	...
	if (func_104(uLocal_48, -1, 0, false, false))
		func_101(-1);
	else
	...
	while (true)
	{
		...
		if (BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
		{
					...
					case 1:
						...
						if (!func_83() || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
						{
							if (!PED::IS_PED_INJURED(pedLocal_66) && !PED::IS_PED_INJURED(iLocal_67[0]) && !PED::IS_PED_INJURED(iLocal_67[1]))
							{
								...
								{
									blLocal_58 = func_80(pedLocal_66, false, 145);
									HUD::SET_BLIP_PRIORITY(blLocal_58, 9);
									uLocal_59[0] = func_80(iLocal_67[0], true, 145);
									uLocal_59[1] = func_80(iLocal_67[1], true, 145);
									HUD::SHOW_HEIGHT_ON_BLIP(blLocal_58, false);
									HUD::SHOW_HEIGHT_ON_BLIP(uLocal_59[0], false);
									HUD::SHOW_HEIGHT_ON_BLIP(uLocal_59[1], false);
									func_70(true);
								}
							}
						}
						...
						{
							for (i = 0; i < iLocal_67; i = i + 1)
							{
								if (!PED::IS_PED_INJURED(iLocal_67[i]))
									TASK::TASK_SMART_FLEE_PED(iLocal_67[i], PLAYER::PLAYER_PED_ID(), 150f, -1, false, false);
							}
						
							if (!PED::IS_PED_INJURED(pedLocal_66))
								TASK::TASK_SMART_FLEE_PED(pedLocal_66, PLAYER::PLAYER_PED_ID(), 150f, -1, false, false);
			...
			else
			{
				...
				if (!PED::IS_PED_INJURED(pedLocal_66))
				{
					if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedLocal_66, PLAYER::PLAYER_PED_ID(), true))
					{
						TASK::TASK_SMART_FLEE_PED(pedLocal_66, PLAYER::PLAYER_PED_ID(), 150f, -1, false, false);
						func_69();
					}
				
					if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), pedLocal_66, 150f, 150f, 50f, false, true, 0))
					{
						...
						switch (iLocal_45)
						{
							...
							case 1:
								if (iLocal_46 < 7 && !PED::IS_PED_INJURED(pedLocal_66))
									if (PED::IS_PED_FACING_PED(PLAYER::PLAYER_PED_ID(), pedLocal_66, 90f))
										if (PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), pedLocal_66) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), pedLocal_66))
											func_64();
				...
				else
				{
					...
					for (j = 0; j < iLocal_67; j = j + 1)
					{
						if (!PED::IS_PED_INJURED(iLocal_67[j]))
						{
							TASK::TASK_COMBAT_PED(iLocal_67[j], PLAYER::PLAYER_PED_ID(), 0, 16);
							PED::SET_PED_KEEP_TASK(iLocal_67[j], true);
						
							if (!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_67[j], 150f, 150f, 50f, false, true, 0))
								func_69();
						
							num = 1;
						}
						else if (HUD::DOES_BLIP_EXIST(uLocal_59[j]))
						{
							HUD::REMOVE_BLIP(&uLocal_59[j]);
						}
					}
...
void func_1() // Position - 0x431 Hash - 0xE86660C0 ^0xCCFDE539
{
	int i;

	if (bLocal_51 && !bLocal_56)
	{
		...
		if (!PED::IS_PED_INJURED(pedLocal_66))
		{
			ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(pedLocal_66, false);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(pedLocal_66, false);
		}
	
		for (i = 0; i < iLocal_67; i = i + 1)
		{
			if (HUD::DOES_BLIP_EXIST(uLocal_59[i]))
				HUD::REMOVE_BLIP(&uLocal_59[i]);
		
			if (!PED::IS_PED_INJURED(iLocal_67[i]) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				if (i < 2)
				{
					if (!ENTITY::IS_ENTITY_DEAD(iLocal_75[i], false))
					{
						TASK::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_67[i], iLocal_75[i], PLAYER::PLAYER_PED_ID(), 8, 20f, 786469, 150f, 10f, true);
						PED::SET_PED_KEEP_TASK(iLocal_67[i], true);
					}
					else
					{
						TASK::TASK_SMART_FLEE_PED(iLocal_67[i], PLAYER::PLAYER_PED_ID(), 200f, -1, false, false);
					}
				}
				else
				{
				...
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_67[i], false);
			}
		}
	
		for (i = 0; i < iLocal_75; i = i + 1)
		{
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_75[i], false))
			{
				ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_75[i]);
	...
	if (MISC::GET_DISTANCE_BETWEEN_COORDS(_GET_PLAYER_COORDS(PLAYER::PLAYER_ID()), uLocal_48, true) > 50f)
		func_146();

	return;
}

Vector3 _GET_PLAYER_COORDS(Player plParam0) // Position - 0x600 Hash - 0x6712BF53 ^0x688D5BEC
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(plParam0), false);
}

void func_3(var uParam0, int iParam1) // Position - 0x613 Hash - 0xD18CB130 ^0xA0F4C6FD
{
...
void func_4() // Position - 0x630 Hash - 0xC536DD5 ^0xC536DD5
{
	Global_21032 = 0;
	func_5();
	return;
...
void func_5() // Position - 0x640 Hash - 0xF6D04E68 ^0x80AE5309
{
...
BOOL func_6(char* sParam0) // Position - 0x661 Hash - 0xBFB3A048 ^0xC37F964
{
	var string2;
...
struct<6> func_7() // Position - 0x689 Hash - 0xB37EF8EF ^0xB37EF8EF
{
	var unk;
...
BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x6AD Hash - 0x152DA0B2 ^0x220E93E9
{
...
void func_9() // Position - 0x6CF Hash - 0xC907AC25 ^0x9BD36125
{
	int i;
	int j;
	...
	switch (iLocal_46)
	{
		case 0:
			if (SYSTEM::TIMERB() > 2000)
			{
				for (i = 0; i < iLocal_67; i = i + 1)
				{
					if (!PED::IS_PED_INJURED(iLocal_67[i]) && !ENTITY::IS_ENTITY_DEAD(iLocal_75[i], false))
					{
						if (!HUD::DOES_BLIP_EXIST(uLocal_59[i]))
						{
							uLocal_59[i] = func_80(iLocal_67[i], true, 145);
						
							if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_67[i], false))
							{
								if (!bLocal_53)
								{
									TASK::TASK_DRIVE_BY(iLocal_67[i], PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 150f, 100, true, joaat("FIRING_PATTERN_BURST_FIRE_DRIVEBY"));
								}
								else
								{
									...
									TASK::TASK_PERFORM_SEQUENCE(iLocal_67[i], iLocal_82);
		...
		case 1:
			for (j = 0; j < iLocal_67; j = j + 1)
			{
				if (!PED::IS_PED_INJURED(iLocal_67[j]))
				{
					if (ENTITY::IS_ENTITY_AT_COORD(iLocal_67[j], 904.3153f, 3631.684f, 31.574f, 7f, 7f, 7f, false, true, 0))
					{
						if (!ENTITY::IS_ENTITY_DEAD(iLocal_75[j], false))
							AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(iLocal_75[j], 0);
					
						if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_67[j], false))
						{
							TASK::OPEN_SEQUENCE_TASK(&iLocal_82);
							TASK::TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
							TASK::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
							TASK::CLOSE_SEQUENCE_TASK(iLocal_82);
							TASK::TASK_PERFORM_SEQUENCE(iLocal_67[j], iLocal_82);
							TASK::CLEAR_SEQUENCE_TASK(&iLocal_82);
							PED::SET_PED_KEEP_TASK(iLocal_67[j], true);
						}
					}
					...
					if (!ENTITY::IS_ENTITY_DEAD(iLocal_75[j], false))
						VEHICLE::IS_PLAYBACK_USING_AI_GOING_ON_FOR_VEHICLE(iLocal_75[j]);
				}
			
				if (PED::IS_PED_INJURED(iLocal_67[j]))
					if (HUD::DOES_BLIP_EXIST(uLocal_59[j]))
						HUD::REMOVE_BLIP(&uLocal_59[j]);
			}
		...
		case 2:
			...
			if (!PED::IS_PED_INJURED(pedLocal_66))
			{
				TASK::CLEAR_PED_TASKS(pedLocal_66);
				TASK::OPEN_SEQUENCE_TASK(&iLocal_82);
				TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, SLF_EXTEND_PITCH_LIMIT | 2048, 2);
				TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1);
				TASK::CLOSE_SEQUENCE_TASK(iLocal_82);
				TASK::TASK_PERFORM_SEQUENCE(pedLocal_66, iLocal_82);
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_82);
			}
		
			if (!ENTITY::IS_ENTITY_DEAD(veLocal_74, false))
			{
				ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(veLocal_74);
			
				if (!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), pedLocal_66, 5f, 5f, 5f, false, true, 0))
					_CONVERSATION_ADD_LINE(&uLocal_83, "RECGFAU", "RECGF_REWARD", 4, 0, 0, 0);
			}
		...
		case 3:
			...
			if (!PED::IS_PED_INJURED(pedLocal_66))
				if (!ENTITY::IS_ENTITY_AT_ENTITY(pedLocal_66, PLAYER::PLAYER_PED_ID(), 120f, 120f, 120f, false, true, 0))
					func_10();
		
			if (!ENTITY::IS_ENTITY_DEAD(veLocal_74, false))
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(veLocal_74, PLAYER::PLAYER_PED_ID(), false))
					func_69();
			break;
		...
		case 5:
			if (!PED::IS_PED_INJURED(pedLocal_66) && !ENTITY::IS_ENTITY_DEAD(veLocal_74, false))
			{
				TASK::OPEN_SEQUENCE_TASK(&iLocal_82);
				TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 1500);
				TASK::TASK_ENTER_VEHICLE(0, veLocal_74, -1, -1, 2f, 8, 0, 0);
				TASK::TASK_PAUSE(0, 2000);
				TASK::TASK_PLAY_ANIM(0, "veh@drivebystd_ds_grenades", "drop_grenade", 2f, -2f, -1, 0, 0, false, false, false);
				TASK::TASK_VEHICLE_DRIVE_WANDER(0, veLocal_74, 10f, 786603);
				TASK::CLOSE_SEQUENCE_TASK(iLocal_82);
				TASK::TASK_PERFORM_SEQUENCE(pedLocal_66, iLocal_82);
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_82);
				PED::SET_PED_KEEP_TASK(pedLocal_66, true);
		...
		case 6:
			if (!PED::IS_PED_INJURED(pedLocal_66))
			{
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(pedLocal_66, "veh@drivebystd_ds_grenades", "drop_grenade", 3))
				{
					if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(pedLocal_66, "veh@drivebystd_ds_grenades", "drop_grenade") > 0.436f && PED::IS_PED_IN_ANY_VEHICLE(pedLocal_66, false))
					{
						OBJECT::CREATE_MONEY_PICKUPS(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(PED::GET_VEHICLE_PED_IS_IN(pedLocal_66, false), -1f, 0f, 0f), 1000, 1, 0);
						iLocal_46 = iLocal_46 + 1;
					}
				}
			}
...
void func_10() // Position - 0xB8D Hash - 0x12F528D2 ^0x98FEE0B0
{
...
void func_11() // Position - 0xBC1 Hash - 0xD765C186 ^0xD765C186
{
	func_12();
	return;
}

int func_12() // Position - 0xBCE Hash - 0x9482CBBF ^0x8B17A994
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0xC19 Hash - 0x15889021 ^0xE7262364
{
...
void func_14(int iParam0, int iParam1) // Position - 0xC41 Hash - 0x612C9938 ^0x612C9938
{
	if (iParam0 == -1)
		iParam0 = func_38();
	...
	if (iParam1 <= func_37(iParam0))
	{
		...
		if (func_22(iParam0, iParam1) != 322)
			func_16(func_22(iParam0, iParam1), uLocal_41, uLocal_41.f_1);
...
void func_15(int iParam0) // Position - 0xD44 Hash - 0xE49C42EC ^0xE49C42EC
{
	Global_114356 = iParam0;
	return;
}

void func_16(int iParam0, var uParam1, var uParam2) // Position - 0xD52 Hash - 0xEC2439E7 ^0x1B67A713
{
	BOOL flag;
...
void func_17() // Position - 0xE38 Hash - 0x9F269E94 ^0x9F269E94
{
	int num;
	float num2;
	float num3;
...
int func_18() // Position - 0x12F6 Hash - 0x21D64237 ^0x21D64237
{
	return Global_32828;
}

BOOL func_19(int iParam0, int iParam1) // Position - 0x1301 Hash - 0x77E0C72A ^0x80DA2A54
{
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x1352 Hash - 0xCF91FBA1 ^0xAE1D9C41
{
	if (iParam2 == -1)
		iParam2 = func_21();
...
int func_21() // Position - 0x1370 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1574925;
}

int func_22(int iParam0, int iParam1) // Position - 0x137C Hash - 0xE97012CD ^0x68FBF85A
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_23(int iParam0) // Position - 0x16F0 Hash - 0xBF3EFB31 ^0xBF3EFB31
{
	switch (iParam0)
	{
		case 29:
...
void func_24(int iParam0) // Position - 0x171F Hash - 0x12249850 ^0x46987D7A
{
	int offset;
	int i;
...
void func_25(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x1761 Hash - 0x40156824 ^0x40156824
{
	func_26(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
	return;
}

void func_26(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x1782 Hash - 0x3511D20D ^0xEAD17F1B
{
	int i;
...
void func_27() // Position - 0x1955 Hash - 0xCF8881D1 ^0x40507183
{
	int i;
...
int func_28() // Position - 0x1A6C Hash - 0x35BC7314 ^0x35BC7314
{
	func_29();
...
void func_29() // Position - 0x1AB2 Hash - 0xD1F2D853 ^0xF9F5FD4D
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114370.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_31(character) && !func_30(14) || Global_113320)
			{
...
BOOL func_30(int iParam0) // Position - 0x1BAF Hash - 0x937D8816 ^0x937D8816
{
	return Global_43922 == iParam0;
}

BOOL func_31(eCharacter echParam0) // Position - 0x1BBD Hash - 0x8907F004 ^0x8907F004
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x1BC9 Hash - 0xAC4E9801 ^0xB379A75F
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x1C06 Hash - 0xADCB9755 ^0xADCB9755
{
...
Hash func_34(eCharacter echParam0) // Position - 0x1C2B Hash - 0xE4CEEC2C ^0xE4CEEC2C
{
	return Global_2139[echParam0 /*29*/];
}

BOOL func_35(int iParam0) // Position - 0x1C3A Hash - 0x3F44A899 ^0x7041C53
{
	int num;
	int i;
...
void func_36(int iParam0, int iParam1) // Position - 0x1C7A Hash - 0xE2246457 ^0xD5018049
{
	MISC::SET_BIT(&Global_114370.f_24998.f_8[iParam0], iParam1);
	return;
}

int func_37(int iParam0) // Position - 0x1C95 Hash - 0xAA02DAD0 ^0xAA02DAD0
{
	int num;
...
int func_38() // Position - 0x1D46 Hash - 0x7AC1007E ^0x4E7D4F54
{
	var unk;
	int num;
...
int func_39(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0x1D63 Hash - 0x6DA57317 ^0x57A32A43
{
...
BOOL func_40() // Position - 0x1F3D Hash - 0xFD255207 ^0xFD255207
{
	return true;
}

void func_41(int iParam0) // Position - 0x1F46 Hash - 0x3876D3CA ^0xB3F5688
{
	int num;
...
BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x1F75 Hash - 0x384540C1 ^0x384540C1
{
...
BOOL func_43(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x1FC3 Hash - 0x77297D51 ^0x40DC584A
{
	Global_22167 = 0;
...
void func_44() // Position - 0x2291 Hash - 0xF42BEB19 ^0xA29557DA
{
	if (!func_45())
		return;
...
BOOL func_45() // Position - 0x22C8 Hash - 0x7B74B45F ^0xCE052A5D
{
...
BOOL func_46(Player plParam0) // Position - 0x232B Hash - 0x6E46BC72 ^0x6E46BC72
{
	return func_47(plParam0, 20);
}

BOOL func_47(Player plParam0, int iParam1) // Position - 0x233B Hash - 0x7CD5054C ^0x870BEA81
{
	return IS_BIT_SET(Global_1886967[plParam0 /*609*/].f_10.f_4, iParam1);
}

Player _INVALID_PLAYER_INDEX() // Position - 0x2353 Hash - 0x478900E4 ^0x478900E4
{
	return -1;
}

void func_49() // Position - 0x235C Hash - 0x31ECD34F ^0xA5878CFF
{
	int i;
...
void func_50() // Position - 0x238D Hash - 0xCD8A4D28 ^0xCD8A4D28
{
...
BOOL func_51() // Position - 0x2422 Hash - 0xD140D54A ^0xE638D98F
{
...
BOOL func_52() // Position - 0x2449 Hash - 0x9A999369 ^0x4033F7BF
{
	int num;
	int weaponHash;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x24E2 Hash - 0x98476CE1 ^0x250FEB7C
{
	if (func_30(14))
	{
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x2584 Hash - 0x3C5423D7 ^0x3C5423D7
{
	func_29();
	return Global_114370.f_2366.f_539.f_4321;
}

void func_55() // Position - 0x259D Hash - 0xBEED4658 ^0xDCF91DB6
{
	int i;
...
BOOL func_56(int iParam0, int iParam1) // Position - 0x25F4 Hash - 0xA14C4D3F ^0xA6034F77
{
	switch (iParam0)
	{
		case 5:
...
void func_57() // Position - 0x262C Hash - 0xE32CF1EF ^0xB9A7BEB2
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_23177 = 0;
...
void func_58(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x2683 Hash - 0xC6B752B2 ^0xC6B752B2
{
...
void func_59() // Position - 0x26D9 Hash - 0xCE5466C2 ^0x21D06972
{
	int i;
	...
	switch (iLocal_46)
	{
		...
		case 1:
			if (!PED::IS_PED_INJURED(pedLocal_66))
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), pedLocal_66, 20f, 20f, 20f, false, true, 0))
				{
					TASK::TASK_LOOK_AT_ENTITY(pedLocal_66, PLAYER::PLAYER_PED_ID(), -1, SLF_EXTEND_YAW_LIMIT | 8 | 2048, 2);
					_CONVERSATION_ADD_LINE(&uLocal_83, "RECGFAU", "RECGF_THX", 4, 0, 0, 0);
					iLocal_46 = iLocal_46 + 1;
				}
			}
			break;
		...
		case 3:
			if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
			{
				if (_GET_CURRENT_PLAYER_CHARACTER() == CHAR_MICHAEL)
					...
					_CONVERSATION_ADD_LINE(&uLocal_83, "RECGFAU", "RECGF_JABF", 4, 0, 0, 0);
				else if (_GET_CURRENT_PLAYER_CHARACTER() == CHAR_TREVOR)
					_CONVERSATION_ADD_LINE(&uLocal_83, "RECGFAU", "RECGF_JABBER", 4, 0, 0, 0);
		...
		case 4:
			if (!PED::IS_PED_INJURED(pedLocal_66))
			{
				if (ENTITY::IS_ENTITY_AT_COORD(pedLocal_66, 916.5764f, 3602.1462f, 31.9262f, 3.3f, 3.3f, 3.3f, false, true, 0))
				{
					if (!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), pedLocal_66, 8f, 8f, 8f, false, true, 0))
					{
						if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
						{
							...
							{
								TASK::TASK_TURN_PED_TO_FACE_ENTITY(pedLocal_66, PLAYER::PLAYER_PED_ID(), -1);
		...
		case 5:
			if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
			{
				if (_GET_CURRENT_PLAYER_CHARACTER() == CHAR_MICHAEL)
					...
					_CONVERSATION_ADD_LINE(&uLocal_83, "RECGFAU", "RECGF_STASHF", 4, 0, 0, 0);
				...
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), pedLocal_66, 8f, 8f, 8f, false, true, 0))
				{
					if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) || PED::IS_PED_ON_ANY_BIKE(PLAYER::PLAYER_PED_ID()))
					{
						if (func_62())
						{
							...
							if (!PED::IS_PED_INJURED(pedLocal_66) && !PED::IS_PED_INJURED(iLocal_67[2]) && !ENTITY::IS_ENTITY_DEAD(veLocal_74, false))
							{
								TASK::OPEN_SEQUENCE_TASK(&iLocal_82);
								TASK::TASK_OPEN_VEHICLE_DOOR(0, veLocal_74, -1, -1, 1f);
								...
								func_4();
								func_41(0);
								_CONVERSATION_ADD_LINE(&uLocal_83, "RECGFAU", "RECGF_HIDE", 4, 0, 0, 0);
							
								if (!PED::IS_PED_INJURED(pedLocal_66) && !ENTITY::IS_ENTITY_DEAD(veLocal_74, false) && PED::IS_PED_IN_ANY_VEHICLE(pedLocal_66, false))
								{
									iLocal_46 = iLocal_46 + 1;
								}
								else
								{
									if (!PED::IS_PED_INJURED(pedLocal_66) && !PED::IS_PED_INJURED(iLocal_67[2]))
									{
										TASK::OPEN_SEQUENCE_TASK(&iLocal_82);
										TASK::TASK_COWER(0, -1);
										TASK::CLOSE_SEQUENCE_TASK(iLocal_82);
		...
		case 7:
			!PED::IS_PED_INJURED(pedLocal_66) && !ENTITY::IS_ENTITY_DEAD(veLocal_74, false) && !PED::IS_PED_IN_VEHICLE(pedLocal_66, veLocal_74, false) && !PED::IS_PED_IN_COVER(pedLocal_66, false) && !PED::IS_PED_GOING_INTO_COVER(pedLocal_66);
		
			for (i = 0; i < iLocal_67; i = i + 1)
			{
				if (!PED::IS_PED_INJURED(iLocal_67[i]) && !ENTITY::IS_ENTITY_DEAD(iLocal_75[i], false))
				{
					if (PED::IS_PED_SHOOTING_IN_AREA(PLAYER::PLAYER_PED_ID(), 916.3351f - 100f, 3602.048f - 100f, 31.9209f - 100f, 916.3351f + 100f, 3602.048f + 100f, 31.9209f + 100f, false, true) || ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_67[i], 5f, 5f, 5f, false, true, 0) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_67[i], PLAYER::PLAYER_PED_ID(), true) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_75[i], PLAYER::PLAYER_PED_ID(), true) || ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_67[i]) || ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_75[i]))
					{
						bLocal_53 = true;
			...
			if (ENTITY::IS_ENTITY_AT_COORD(iLocal_67[2], 970.3641f, 3629.8865f, 31.3694f, 5f, 5f, 5f, false, true, 0) || SYSTEM::TIMERB() > 13000)
			{
				...
				for (i = 0; i < iLocal_67; i = i + 1)
				{
					if (!PED::IS_PED_INJURED(iLocal_67[i]))
						if (!ENTITY::IS_ENTITY_DEAD(iLocal_75[i], false))
							if (PED::IS_PED_IN_VEHICLE(iLocal_67[i], iLocal_75[i], false))
								TASK::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_67[i], iLocal_75[i], PLAYER::PLAYER_PED_ID(), (i - 2) + 10, 60f, 786475, 5f, 10f, true);
				}
			
				if (!PED::IS_PED_INJURED(pedLocal_66))
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), pedLocal_66, 15f, 15f, 15f, false, true, 0))
					{
						func_60();
						func_41(0);
						_CONVERSATION_ADD_LINE(&uLocal_83, "RECGFAU", "RECGF_GANG", 4, 0, 0, 0);
					}
				}
...
void func_60() // Position - 0x2D06 Hash - 0xC536DD5 ^0xC536DD5
{
	Global_21032 = 0;
	func_61();
	return;
...
void func_61() // Position - 0x2D16 Hash - 0x21027D29 ^0xBEB9ECFD
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
...
BOOL func_62() // Position - 0x2D3A Hash - 0xE66CD422 ^0x84836509
{
	int i;
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_75[2]) && !ENTITY::DOES_ENTITY_EXIST(iLocal_75[3]) && !ENTITY::DOES_ENTITY_EXIST(iLocal_75[4]) && !ENTITY::DOES_ENTITY_EXIST(iLocal_75[5]) && !ENTITY::DOES_ENTITY_EXIST(iLocal_67[2]) && !ENTITY::DOES_ENTITY_EXIST(iLocal_67[3]) && !ENTITY::DOES_ENTITY_EXIST(iLocal_67[4]) && !ENTITY::DOES_ENTITY_EXIST(iLocal_67[5]))
	{
		...
		{
			iLocal_67[2] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_75[2], PED_TYPE_CRIMINAL, joaat("G_M_Y_Lost_01"), -1, true, true);
			iLocal_67[3] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_75[3], PED_TYPE_CRIMINAL, joaat("G_M_Y_Lost_02"), -1, true, true);
			iLocal_67[4] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_75[4], PED_TYPE_CRIMINAL, joaat("G_M_Y_Lost_01"), -1, true, true);
			iLocal_67[5] = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_75[5], PED_TYPE_CRIMINAL, joaat("G_M_Y_Lost_02"), -1, true, true);
			_CONVERSATION_INITIALIZE_ACTOR(&uLocal_83, 4, iLocal_67[4], "RECGFLost3", 0, 1);
			iLocal_57 = MISC::GET_GAME_TIMER() + 1500;
			...
			for (i = 0; i < iLocal_67; i = i + 1)
			{
				if (!PED::IS_PED_INJURED(iLocal_67[i]) && !ENTITY::IS_ENTITY_DEAD(iLocal_75[i], false))
				{
					AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(iLocal_75[i], "RE_COUNTRYSIDE_GANG_BIKES", 0);
					PED::SET_PED_CONFIG_FLAG(iLocal_67[i], 137, true);
					PED::SET_PED_RANDOM_COMPONENT_VARIATION(iLocal_67[i], 0);
					PED::SET_PED_COMBAT_MOVEMENT(iLocal_67[i], CM_WillAdvance);
					PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_67[i], BF_CanCharge, true);
					PED::SET_PED_COMBAT_ABILITY(iLocal_67[i], 2);
					PED::SET_PED_TO_INFORM_RESPECTED_FRIENDS(iLocal_67[i], 50f, 20);
					PED::SET_PED_COMBAT_RANGE(iLocal_67[i], 1);
					PED::SET_PED_ACCURACY(iLocal_67[i], 13);
					PED::SET_PED_HEARING_RANGE(iLocal_67[i], 100f);
					PED::SET_PED_SEEING_RANGE(iLocal_67[i], 100f);
					PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_67[i], hLocal_248);
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_67[i], true);
					PED::SET_PED_CAN_BE_KNOCKED_OFF_VEHICLE(iLocal_67[i], KNOCKOFFVEHICLE_HARD);
					PED::SET_PED_HELMET(iLocal_67[i], false);
					PED::SET_PED_CAN_BE_TARGETTED(iLocal_67[i], true);
					ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(iLocal_67[i], true, 1000f);
				
					if (i > 1 && i < 5)
						WEAPON::GIVE_WEAPON_TO_PED(iLocal_67[i], joaat("WEAPON_PISTOL"), -1, true, true);
					else
						WEAPON::GIVE_WEAPON_TO_PED(iLocal_67[i], joaat("WEAPON_SAWNOFFSHOTGUN"), -1, true, true);
				
					TASK::OPEN_SEQUENCE_TASK(&iLocal_82);
					TASK::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_75[2], 966.7098f, 3633.9258f, 31.3974f, 10f, 0, joaat("hexer"), 786725, 4f, 100f);
					TASK::TASK_LOOK_AT_COORD(0, uLocal_48, 5000, 0, 2);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_82);
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x3211 Hash - 0x6C235EE0 ^0x9E57F206
{
...
void func_64() // Position - 0x32AC Hash - 0x80301360 ^0x97ED1FC2
{
	if (!PED::IS_PED_INJURED(pedLocal_66))
	{
		TASK::TASK_SMART_FLEE_PED(pedLocal_66, PLAYER::PLAYER_PED_ID(), 200f, -1, false, false);
		PED::SET_PED_KEEP_TASK(pedLocal_66, true);
	
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_67[0], false) && !ENTITY::IS_ENTITY_DEAD(iLocal_67[1], false))
		{
			ENTITY::SET_ENTITY_HEALTH(pedLocal_66, 101, 0, 0);
			ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(pedLocal_66, false);
			TASK::TASK_SHOOT_AT_ENTITY(iLocal_67[0], pedLocal_66, 1000, 0);
			TASK::TASK_SHOOT_AT_ENTITY(iLocal_67[1], pedLocal_66, 1000, 0);
		}
		else
		{
			func_4();
			...
			if (!PED::IS_PED_INJURED(pedLocal_66))
				func_65(pedLocal_66, "GENERIC_FRIGHTENED_HIGH", 24);
		}
...
void func_65(Ped pedParam0, char* sParam1, int iParam2) // Position - 0x3351 Hash - 0x48D349EA ^0xA208047E
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(pedParam0, sParam1, AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(iParam2), 1);
	return;
}

char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x3368 Hash - 0xA17D549C ^0x2024229C
{
	char* str;
...
void func_67() // Position - 0x355D Hash - 0x75F05301 ^0x41911281
{
	int i;
	...
	switch (iLocal_46)
	{
			...
			if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), pedLocal_66, 45f, 45f, 20f, false, true, 0))
			{
				if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
				{
					if (_GET_CURRENT_PLAYER_CHARACTER() == CHAR_MICHAEL)
						...
						_CONVERSATION_ADD_LINE(&uLocal_83, "RECGFAU", "RECGF_COMF", 4, 0, 0, 0);
					else if (_GET_CURRENT_PLAYER_CHARACTER() == CHAR_TREVOR)
						_CONVERSATION_ADD_LINE(&uLocal_83, "RECGFAU", "RECGF_COMT", 4, 0, 0, 0);
		...
		case 1:
			if (!PED::IS_PED_INJURED(pedLocal_66))
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), pedLocal_66, 40f, 40f, 20f, false, true, 0))
					if (_CONVERSATION_ADD_LINE(&uLocal_83, "RECGFAU", "RECGF_HELP", 4, 0, 0, 0))
						iLocal_46 = iLocal_46 + 1;
			break;
		...
		case 3:
			if (!PED::IS_PED_INJURED(pedLocal_66) && !PED::IS_PED_INJURED(iLocal_67[0]) && !PED::IS_PED_INJURED(iLocal_67[1]))
			{
				...
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), pedLocal_66, 12f, 12f, 2.5f, false, true, 0))
					{
						...
						{
							TASK::TASK_LOOK_AT_ENTITY(iLocal_67[0], PLAYER::PLAYER_PED_ID(), 4000, SLF_EXTEND_PITCH_LIMIT | 2048, 4);
							TASK::TASK_LOOK_AT_ENTITY(iLocal_67[1], PLAYER::PLAYER_PED_ID(), 4000, SLF_EXTEND_PITCH_LIMIT | 2048, 4);
							...
							if (!bLocal_55)
							{
								...
								if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
									_CONVERSATION_ADD_LINE(&uLocal_83, "RECGFAU", "RECGF_GETLOS", 4, 0, 0, 0);
								else
									_CONVERSATION_ADD_LINE(&uLocal_83, "RECGFAU", "RECGF_BEGONE", 4, 0, 0, 0);
					...
					{
						if (!PED::IS_PED_FACING_PED(iLocal_67[0], pedLocal_66, 10f))
							TASK::TASK_AIM_GUN_AT_ENTITY(iLocal_67[0], pedLocal_66, -1, false);
					}
				}
				else if (!ENTITY::IS_ENTITY_DEAD(iLocal_75[0], false) && !ENTITY::IS_ENTITY_DEAD(iLocal_75[1], false))
				{
					func_4();
					func_41(0);
					_CONVERSATION_ADD_LINE(&uLocal_83, "RECGFAU", "RECGF_SHOOT", 4, 0, 0, 0);
					func_41(2000);
					func_64();
				}
			}
		...
		case 4:
			for (i = 0; i < iLocal_67; i = i + 1)
			{
				if (!PED::IS_PED_INJURED(iLocal_67[i]))
				{
					PED::SET_PED_RESET_FLAG(iLocal_67[i], 156, true);
					TASK::TASK_COMBAT_PED(iLocal_67[i], PLAYER::PLAYER_PED_ID(), 0, 16);
					PED::SET_PED_KEEP_TASK(iLocal_67[i], true);
				}
			}
		
			if (!PED::IS_PED_INJURED(pedLocal_66))
				TASK::TASK_COWER(pedLocal_66, -1);
...
void func_68() // Position - 0x390A Hash - 0x43D23365 ^0x20541F29
{
...
void func_69() // Position - 0x3972 Hash - 0xFF1DE625 ^0xFF1DE625
{
	iLocal_45 = 3;
	return;
}

int func_70(BOOL bParam0) // Position - 0x397D Hash - 0x3A78A0E1 ^0x1E9D0CF3
{
	if (func_74())
	{
		Global_114360 = true;
		...
		if (bParam0 && func_23(Global_114359))
...
void func_71(int iParam0) // Position - 0x39D0 Hash - 0x3B4E6AAB ^0x52844A7B
{
	switch (iParam0)
	{
		case 0:
...
void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x3AAB Hash - 0xCBB0D91 ^0x21070E5C
{
...
char* func_73(int iParam0) // Position - 0x3AC2 Hash - 0x9D069F7F ^0xD77A06C2
{
	char* str;
...
BOOL func_74() // Position - 0x3B05 Hash - 0x8129EEA4 ^0x48B13301
{
	switch (func_75(&Global_32888, 0, 5, false, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return true;
...
int func_75(var uParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0x3B3B Hash - 0x8F9349A ^0xC5C097C1
{
	int i;
...
void func_76(var uParam0, int iParam1) // Position - 0x3C72 Hash - 0x6AC97785 ^0x6AC97785
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0x3CC1 Hash - 0xECB6C71B ^0xECB6C71B
{
	return func_78(iParam0, Global_43922);
}

BOOL func_78(int iParam0, int iParam1) // Position - 0x3CD2 Hash - 0x1FD727E0 ^0x1FD727E0
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_79(int iParam0) // Position - 0x3EB3 Hash - 0x3BAB94E9 ^0x3BAB94E9
{
	if (Global_43922 == 15)
		return false;
...
Blip func_80(Ped pedParam0, BOOL bParam1, int iParam2) // Position - 0x3ED5 Hash - 0xA714218A ^0xAD0F82BD
{
	Blip blip;
...
Blip func_81(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3F1F Hash - 0x2E5A72B ^0x64F26CC0
{
	Blip blip;
...
var func_82(BOOL bParam0, var uParam1, var uParam2) // Position - 0x3FC3 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
BOOL func_83() // Position - 0x3FDA Hash - 0x9DE805F9 ^0xC199A3A7
{
	Vector3 vector;
	Vector3 vector2;
	...
	if (!bLocal_53)
	{
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(255, hLocal_248, joaat("PLAYER"));
			...
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_75[0], false) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_75[1], false) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_75[0], PLAYER::PLAYER_PED_ID(), true) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_75[1], PLAYER::PLAYER_PED_ID(), true))
			{
				if (!PED::IS_PED_INJURED(iLocal_67[0]) && !PED::IS_PED_INJURED(iLocal_67[1]))
				{
					if (func_99())
					{
						func_4();
						func_41(0);
						_CONVERSATION_ADD_LINE(&uLocal_83, "RECGFAU", "RECGF_BIKES", 4, 0, 0, 0);
					}
		...
		if (!PED::IS_PED_INJURED(iLocal_67[0]))
		{
			...
			vector = { vector + PED::GET_PED_BONE_COORDS(iLocal_67[0], 31086, 0f, 0f, 0f) };
			vector2 = { vector2 + PED::GET_PED_BONE_COORDS(iLocal_67[0], 31086, 0f, 0f, 0f) };
		...
		if (!PED::IS_PED_INJURED(pedLocal_66) && !PED::IS_PED_INJURED(iLocal_67[0]) && !PED::IS_PED_INJURED(iLocal_67[1]))
		{
			...
			if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), pedLocal_66, 12f, 12f, 2.5f, false, true, 0))
			{
				if (PED::CAN_PED_SEE_HATED_PED(iLocal_67[0], PLAYER::PLAYER_PED_ID()) || PED::CAN_PED_SEE_HATED_PED(iLocal_67[1], PLAYER::PLAYER_PED_ID()) || ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(iLocal_67[0], PLAYER::PLAYER_PED_ID()) || ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(iLocal_67[1], PLAYER::PLAYER_PED_ID()))
				{
					...
					if (HUD::DOES_BLIP_EXIST(uLocal_59[0]))
						HUD::SHOW_HEIGHT_ON_BLIP(uLocal_59[0], true);
					...
					if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS() || func_6("RECGF_SHUTUP") || func_6("RECGF_PAYUP"))
					{
						if (iLocal_47 == -1)
						{
							...
							if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
							{
								func_4();
								func_41(0);
								_CONVERSATION_ADD_LINE(&uLocal_83, "RECGFAU", "RECGF_REPEAT", 4, 0, 0, 0);
							}
							else
							{
								func_4();
			...
			if (iLocal_47 != -1 && MISC::GET_GAME_TIMER() > iLocal_47 + 10000)
			{
				func_4();
				func_41(0);
				_CONVERSATION_ADD_LINE(&uLocal_83, "RECGFAU", "RECGF_WARNED", 4, 0, 0, 0);
				return true;
			}
			...
			if (!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_67[0], PLAYER::PLAYER_PED_ID(), true) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_67[1], PLAYER::PLAYER_PED_ID(), true))
			{
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedLocal_66, PLAYER::PLAYER_PED_ID(), true))
				{
					if (func_99())
					{
						func_4();
						func_41(0);
						_CONVERSATION_ADD_LINE(&uLocal_83, "RECGFAU", "RECGF_DEALER", 4, 0, 0, 0);
					}
...
void func_84() // Position - 0x44F3 Hash - 0x552B4FA8 ^0x13CF3610
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_74, false))
		if (!ENTITY::IS_ENTITY_AT_COORD(veLocal_74, 915.7905f, 3603.449f, 31.9111f, 5f, 5f, 5f, false, true, 0) && !PED::IS_PED_IN_VEHICLE(pedLocal_66, veLocal_74, false) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), veLocal_74, true))
			func_64();
	else
		func_64();
...
BOOL func_85() // Position - 0x454F Hash - 0x2B711B96 ^0x89808EFC
{
	int i;

	if (!ENTITY::DOES_ENTITY_EXIST(pedLocal_66) && !ENTITY::DOES_ENTITY_EXIST(iLocal_67[0]) && !ENTITY::DOES_ENTITY_EXIST(iLocal_67[1]) && !ENTITY::DOES_ENTITY_EXIST(veLocal_74) && !ENTITY::DOES_ENTITY_EXIST(iLocal_75[0]) && !ENTITY::DOES_ENTITY_EXIST(iLocal_75[1]))
	{
		...
		if (STREAMING::HAS_MODEL_LOADED(joaat("A_M_M_Skidrow_01")) && STREAMING::HAS_MODEL_LOADED(joaat("G_M_Y_Lost_01")) && STREAMING::HAS_MODEL_LOADED(joaat("G_M_Y_Lost_02")) && STREAMING::HAS_MODEL_LOADED(joaat("picador")) && STREAMING::HAS_MODEL_LOADED(joaat("hexer")) && STREAMING::HAS_ANIM_DICT_LOADED("random@countryside_gang_fight") && STREAMING::HAS_ANIM_DICT_LOADED("veh@drivebystd_ds_grenades") && STREAMING::HAS_ANIM_SET_LOADED("move_m@gangster@var_i"))
		{
			...
			PED::ADD_SCENARIO_BLOCKING_AREA(uLocal_48 - { 20f, 50f, 80f }, uLocal_48 + { 20f, 50f, 70f }, false, true, true, true, 1);
			MISC::ENABLE_DISPATCH_SERVICE(DT_FireDepartment, false);
			MISC::ENABLE_DISPATCH_SERVICE(DT_AmbulanceDepartment, false);
			PED::ADD_RELATIONSHIP_GROUP("rghLost", &hLocal_248);
			PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, hLocal_248, joaat("PLAYER"));
			pedLocal_66 = PED::CREATE_PED(PED_TYPE_MISSION, joaat("A_M_M_Skidrow_01"), 973.053f, 3616.7375f, 31.6181f, 110.275276f, true, true);
			PED::SET_PED_COMPONENT_VARIATION(pedLocal_66, PV_COMP_HEAD, 0, 1, 0);
			PED::SET_PED_COMPONENT_VARIATION(pedLocal_66, PV_COMP_HAIR, 1, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(pedLocal_66, PV_COMP_UPPR, 1, 2, 0);
			PED::SET_PED_COMPONENT_VARIATION(pedLocal_66, PV_COMP_LOWR, 0, 0, 0);
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("A_M_M_Skidrow_01"));
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(pedLocal_66, true);
			PED::SET_PED_COMBAT_ATTRIBUTES(pedLocal_66, BF_AlwaysFlee, true);
			PED::SET_PED_CAN_BE_TARGETTED(pedLocal_66, false);
			ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(pedLocal_66, true);
			PED::SET_PED_CONFIG_FLAG(pedLocal_66, 185, true);
			PED::SET_RAGDOLL_BLOCKING_FLAGS(pedLocal_66, 16);
			AUDIO::SET_AMBIENT_VOICE_NAME(pedLocal_66, "A_M_M_TRAMP_01_BLACK_MINI_01");
			_CONVERSATION_INITIALIZE_ACTOR(&uLocal_83, 1, pedLocal_66, "RECGFDealer", 0, 1);
			AUDIO::STOP_PED_SPEAKING(pedLocal_66, true);
			TASK::TASK_PLAY_ANIM(pedLocal_66, "random@countryside_gang_fight", "gangmember_stickup_loop", 1000f, -2f, -1, 1, 0, false, false, false);
			PED::SET_PED_MOVEMENT_CLIPSET(pedLocal_66, "move_m@gangster@var_i", 1048576000);
			veLocal_74 = VEHICLE::CREATE_VEHICLE(joaat("picador"), 915.7905f, 3603.449f, 31.9111f, 111.9593f, true, true, false);
			VEHICLE::SET_VEHICLE_COLOURS(veLocal_74, 37, 0);
			VEHICLE::SET_VEHICLE_EXTRA_COLOURS(veLocal_74, 4, 0);
			VEHICLE::SET_VEHICLE_PROVIDES_COVER(veLocal_74, true);
			VEHICLE::SET_VEHICLE_NUMBER_PLATE_TEXT(veLocal_74, "WDU 696");
			iLocal_67[0] = PED::CREATE_PED(PED_TYPE_CRIMINAL, joaat("G_M_Y_Lost_01"), 970.2217f, 3614.821f, 31.6909f, 297.4345f, true, true);
			_CONVERSATION_INITIALIZE_ACTOR(&uLocal_83, 3, iLocal_67[0], "RECGFLost2", 0, 1);
			iLocal_67[1] = PED::CREATE_PED(PED_TYPE_CRIMINAL, joaat("G_M_Y_Lost_02"), 971.504f, 3618.054f, 31.5565f, 216.9967f, true, true);
			_CONVERSATION_INITIALIZE_ACTOR(&uLocal_83, 2, iLocal_67[1], "RECGFLost1", 0, 1);
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("G_M_Y_Lost_01"));
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("G_M_Y_Lost_02"));
			...
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("hexer"));
			TASK::TASK_PLAY_ANIM(iLocal_67[0], "random@countryside_gang_fight", "biker_02_stickup_loop", 1000f, -2f, -1, 1, 0, false, false, false);
			TASK::TASK_PLAY_ANIM(iLocal_67[1], "random@countryside_gang_fight", "biker_01_stickup_loop", 1000f, -2f, -1, 1, 0, false, false, false);
			...
			for (i = 0; i < iLocal_67; i = i + 1)
			{
				if (i < 2)
				{
					...
					PED::SET_PED_COMBAT_MOVEMENT(iLocal_67[i], CM_WillAdvance);
					PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_67[i], BF_CanCharge, true);
					PED::SET_PED_COMBAT_RANGE(iLocal_67[i], 0);
					...
					PED::SET_PED_KEEP_TASK(iLocal_67[i], true);
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_67[i], true);
					ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_67[i], true, 1);
				}
			}
			...
			if (_GET_CURRENT_PLAYER_CHARACTER() == CHAR_MICHAEL)
				_CONVERSATION_INITIALIZE_ACTOR(&uLocal_83, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
			else if (_GET_CURRENT_PLAYER_CHARACTER() == CHAR_FRANKLIN)
				_CONVERSATION_INITIALIZE_ACTOR(&uLocal_83, 0, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
			else if (_GET_CURRENT_PLAYER_CHARACTER() == CHAR_TREVOR)
				_CONVERSATION_INITIALIZE_ACTOR(&uLocal_83, 0, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
...
BOOL func_86() // Position - 0x4A0B Hash - 0xC05B0E62 ^0x94C54EFE
{
	...
	if (func_87(100f, true) != -1)
		return true;

	return false;
}

int func_87(float fParam0, BOOL bParam1) // Position - 0x4A91 Hash - 0xA169FFDC ^0x284941E0
{
	var unk;
	int num;
	int num2;
...
void func_88(int iParam0, var uParam1) // Position - 0x4B42 Hash - 0xBB66FD80 ^0xEA5E51D9
{
	switch (iParam0)
	{
		case 0:
...
int func_90(int iParam0) // Position - 0x5D88 Hash - 0xC999F6B2 ^0xC999F6B2
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_91(int iParam0) // Position - 0x60CE Hash - 0x8429B0EB ^0x9CCEC31
{
	var unk;
	var unk3;

	TEXT_LABEL_ASSIGN_STRING(&unk, "", 8);
	unk3 = { func_92(iParam0) };
...
struct<2> func_92(int iParam0) // Position - 0x6105 Hash - 0x7DE1120E ^0xE5A1B5C8
{
	var unk;
...
BOOL func_93() // Position - 0x6551 Hash - 0x7055FFB1 ^0x7055FFB1
{
	if (func_96() && !func_97())
		return true;
...
BOOL func_94() // Position - 0x6583 Hash - 0x79CF7679 ^0x79CF7679
{
	return Global_114088 > 0;
}

BOOL func_95() // Position - 0x6591 Hash - 0xCF2296C0 ^0xCF2296C0
{
	if (Global_98294 != -1)
		return true;
...
BOOL func_96() // Position - 0x65A6 Hash - 0x98CCC132 ^0x97B0D6ED
{
	if (Global_98294 != -1)
...
BOOL func_97() // Position - 0x65C9 Hash - 0x29CB2928 ^0xE369A18D
{
...
BOOL func_98() // Position - 0x65E6 Hash - 0xF2B7F534 ^0x7F3EC4F9
{
...
BOOL func_99() // Position - 0x6648 Hash - 0x1121F6F2 ^0x90CE37A6
{
...
void func_100() // Position - 0x6673 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_101(int iParam0) // Position - 0x667B Hash - 0xA62BD46A ^0x1E050688
{
	if (iParam0 == -1)
		iParam0 = func_38();
...
void func_102() // Position - 0x66B1 Hash - 0x178BF2A7 ^0x744062F5
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
...
void func_103(int iParam0) // Position - 0x66EE Hash - 0xE49C42EC ^0xE49C42EC
{
	Global_114359 = iParam0;
	return;
}

BOOL func_104(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x66FC Hash - 0xC601B4EA ^0xC601B4EA
{
	BOOL flag;
	...
	if (!flag)
	{
		...
		if (func_31(_GET_CURRENT_PLAYER_CHARACTER()))
			if (func_142(_GET_CURRENT_PLAYER_CHARACTER()) == 4 || func_142(_GET_CURRENT_PLAYER_CHARACTER()) == 5)
				return false;
		...
		if (func_31(_GET_CURRENT_PLAYER_CHARACTER()))
		{
			for (i = CHAR_MICHAEL; i < CHAR_MULTIPLAYER; i = i + 1)
			{
				...
				if (func_128(num))
					if (func_106(i))
						if (!func_105(vector, 0f, 0f, 0f, false))
...
BOOL func_105(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x6A96 Hash - 0x2D46096D ^0xEA41378F
{
	if (bParam6)
...
BOOL func_106(eCharacter echParam0) // Position - 0x6ADD Hash - 0x687D9246 ^0x687D9246
{
	int num;
...
BOOL func_107(int iParam0) // Position - 0x6AFE Hash - 0x2D75E13A ^0x2D75E13A
{
	return func_108(iParam0, 1);
}

int func_108(int iParam0, int iParam1) // Position - 0x6B0D Hash - 0x1F92FEBC ^0x1F92FEBC
{
	var unk;
	var unk2;
	int num;
...
void func_109(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x6B60 Hash - 0x2BEE335D ^0x2BEE335D
{
	func_110(func_121(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
	return;
}

void func_110(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x6B7E Hash - 0xB807819C ^0xB807819C
{
	int num;
	int num2;
	int num3;
...
float func_111(float fParam0, float fParam1, float fParam2) // Position - 0x6D7F Hash - 0xDB08F514 ^0x78C0BF6F
{
	float num;
...
int func_112(int iParam0, int iParam1) // Position - 0x6DC1 Hash - 0xD3EBACB3 ^0xD3EBACB3
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_113(int iParam0) // Position - 0x6E63 Hash - 0x90B520AB ^0x257AC1C4
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_114(int iParam0) // Position - 0x6E76 Hash - 0xC188C91C ^0x48884C7
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_115(int iParam0) // Position - 0x6E89 Hash - 0x626AEC54 ^0xDB28E416
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_116(int iParam0) // Position - 0x6E9C Hash - 0x826C592F ^0xDEC5AA46
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_117(int iParam0) // Position - 0x6EAE Hash - 0xE1B0542C ^0x127A471E
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_118(BOOL bParam0, var uParam1, var uParam2) // Position - 0x6ED0 Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
int func_119(int iParam0) // Position - 0x6EE7 Hash - 0x2D4DB85F ^0x2D4DB85F
{
	return iParam0 & 15;
}

BOOL func_120(int iParam0, int iParam1) // Position - 0x6EF4 Hash - 0xEA08B1 ^0xEA08B1
{
	int num;
	int num2;
...
int func_121() // Position - 0x7000 Hash - 0x9E44C35 ^0xB9993D58
{
	var unk;
...
void func_122(var uParam0, int iParam1) // Position - 0x7046 Hash - 0x15B9927E ^0x4A4674
{
	if (iParam1 <= 0)
		return;
...
void func_123(var uParam0, int iParam1) // Position - 0x70CC Hash - 0x4C70B2C3 ^0x4C70B2C3
{
...
void func_124(var uParam0, int iParam1) // Position - 0x70FF Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_125(var uParam0, int iParam1) // Position - 0x7150 Hash - 0x864304A8 ^0x1F5003E2
{
...
void func_126(var uParam0, int iParam1) // Position - 0x718A Hash - 0x76860AE7 ^0x32308FFF
{
...
void func_127(var uParam0, int iParam1) // Position - 0x71C5 Hash - 0xDB8A72C0 ^0x4F6D426D
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_128(int iParam0) // Position - 0x7201 Hash - 0x57D8E518 ^0xD297DD35
{
	int num;
	int num2;
	int num3;
...
BOOL func_129(int iParam0, int iParam1) // Position - 0x72DD Hash - 0x577FB514 ^0xAAF8B538
{
...
BOOL func_130(int iParam0) // Position - 0x72FD Hash - 0x97844555 ^0xADCD6DAA
{
	eCharacter character;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_138() || Global_113417 || Global_32831 || func_137() || func_56(8, -1) || func_136() || func_135() || func_134() || func_133() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_138() || Global_32831 || func_137() || func_56(8, -1) || func_134() || func_136() || func_135() || func_133() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_138() || Global_113417 || Global_32831 || func_137() || func_56(8, -1) || func_134() || func_136() || func_135() || func_133() || Global_114370.f_7691.f_919[character] == 5 || Global_44469 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_138() || Global_113417 || Global_32831 || func_137() || func_56(8, -1) || func_136() || func_135() || func_133() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_138() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_56(8, -1) || func_133() || func_132() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
...
BOOL func_131() // Position - 0x7A1A Hash - 0x4228A1C2 ^0x952FE30F
{
	return Global_101431.f_1;
}

BOOL func_132() // Position - 0x7A28 Hash - 0xC20DBA70 ^0xAC4006FB
{
	if (Global_98294 != -1)
...
BOOL func_133() // Position - 0x7A4B Hash - 0x3CA1BB47 ^0xB78A1ACB
{
...
BOOL func_134() // Position - 0x7A65 Hash - 0xE663B8F6 ^0xE663B8F6
{
	if (Global_79509)
		return true;
...
BOOL func_135() // Position - 0x7A8F Hash - 0xD56328D2 ^0xD56328D2
{
	return Global_101444.f_394 > 0;
}

BOOL func_136() // Position - 0x7AA0 Hash - 0xD56328D2 ^0xD56328D2
{
	return Global_101444.f_393 > 0;
}

BOOL func_137() // Position - 0x7AB1 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1575079;
}

BOOL func_138() // Position - 0x7ABD Hash - 0x7FE517FE ^0x128A3BC8
{
...
BOOL func_139() // Position - 0x7AD9 Hash - 0xB12DEAA2 ^0xB12DEAA2
{
	_UPDATE_CURRENT_PLAYER_CHARACTER();
...
BOOL func_140(int iParam0) // Position - 0x7B01 Hash - 0xCDB90269 ^0xCDB90269
{
	return func_120(func_121(), iParam0);
}

BOOL func_141(int iParam0, int iParam1, eCharacter echParam2) // Position - 0x7B13 Hash - 0xBEEFD79C ^0xBEEFD79C
{
	BOOL num;
	eCharacter character;
...
int func_142(eCharacter echParam0) // Position - 0x7BF7 Hash - 0x45FC9D61 ^0x45FC9D61
{
...
BOOL func_143(int iParam0) // Position - 0x7C1B Hash - 0xF2A54181 ^0xF2A54181
{
	int num;
	BOOL flag;
...
BOOL func_144() // Position - 0x7C73 Hash - 0xB72C022E ^0x452A7B6D
{
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x7CB7 Hash - 0x44DD83CC ^0x7B62A376
{
	int profileSetting;
...
void func_146() // Position - 0x7D6F Hash - 0xFDFA7A07 ^0xE444F125
{
	int i;
	...
	if (bLocal_51 && !bLocal_56)
	{
		...
		if (!PED::IS_PED_INJURED(pedLocal_66))
		{
			PED::SET_PED_CONFIG_FLAG(pedLocal_66, 317, true);
			ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(pedLocal_66, false);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(pedLocal_66, false);
		}
...
void func_147(int iParam0) // Position - 0x7F30 Hash - 0xE6B11918 ^0x37AF2AD2
{
	var name;
	...
	if (func_99())
	{
		...
		func_150(30000);
		TEXT_LABEL_ASSIGN_STRING(&name, func_149(Global_114359, true), 64);
...
void func_148(var uParam0) // Position - 0x7FE2 Hash - 0xD28B9901 ^0xD28B9901
{
	if (*uParam0 == -1)
		return;
...
char* func_149(int iParam0, BOOL bParam1) // Position - 0x8020 Hash - 0x959319CB ^0x7C3A1611
{
	switch (iParam0)
	{
		case 0:
...
void func_150(int iParam0) // Position - 0x8269 Hash - 0xC0234809 ^0x4FD853DC
{
	Global_44473 = MISC::GET_GAME_TIMER() + iParam0;
	return;
}

void func_151(int iParam0) // Position - 0x827B Hash - 0x881273A8 ^0x881273A8
{
	func_152(iParam0, 0, func_157(iParam0));
	return;
}

void func_152(int iParam0, int iParam1, int iParam2) // Position - 0x8290 Hash - 0xA7DBC311 ^0xA7DBC311
{
	int unk;
	var unk2;
...
struct<16> func_153(var uParam0) // Position - 0x82BF Hash - 0x6127DACB ^0xC8E4C4A
{
	var unk;
	int num;
...
void func_154(int iParam0, var uParam1) // Position - 0x838F Hash - 0x63EF72B0 ^0xC612AA53
{
	Global_114370.f_24998.f_43[iParam0] = *uParam1;
	return;
}

void func_155(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x83A7 Hash - 0xB28A4507 ^0xB28A4507
{
	int num;
	int i;
	int num2;
...
void func_156(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x8529 Hash - 0x733BFBA2 ^0x733BFBA2
{
...
int func_157(int iParam0) // Position - 0x8561 Hash - 0x4219564C ^0x4219564C
{
	int num;
