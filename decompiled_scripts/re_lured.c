...
void main() // Position - 0x0 Hash - 0x17B4681A ^0x17B4681A
{
	...
	if (func_138(uLocal_47, -1, 0, false, false))
		func_135(-1);
	else
				...
				case 1:
					if (!bLocal_241)
					{
						...
						if (!PED::IS_PED_INJURED(pedLocal_67))
							PED::SET_PED_RESET_FLAG(pedLocal_67, 247, true);
					}
					else
					{
					...
					if (!PED::IS_PED_INJURED(pedLocal_68))
						PED::SET_PED_RESET_FLAG(pedLocal_68, 156, true);
...
void func_1() // Position - 0x191 Hash - 0x26459460 ^0x48FBF096
{
	if (bLocal_241)
	{
		if (PED::IS_PED_INJURED(pedLocal_68))
			...
			if (!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), pedLocal_68, 100f, 100f, 100f, false, true, 0))
				func_2();
		else if (!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), pedLocal_68, 100f, 100f, 100f, false, true, 0))
			func_3();
	}
	else
	{
		if (!PED::IS_PED_INJURED(pedLocal_67))
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedLocal_67, PLAYER::PLAYER_PED_ID(), true) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(pedLocal_67))
				func_2();
		...
		if (PED::IS_PED_INJURED(pedLocal_67))
		{
			if (!PED::IS_PED_INJURED(pedLocal_68))
			{
				...
				TASK::TASK_PERFORM_SEQUENCE(pedLocal_68, iLocal_73);
		...
		if (PED::IS_PED_INJURED(pedLocal_68))
		{
			if (!PED::IS_PED_INJURED(pedLocal_67))
			{
				...
				TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 1000f, -1, false, false);
				TASK::CLOSE_SEQUENCE_TASK(iLocal_73);
				TASK::TASK_PERFORM_SEQUENCE(pedLocal_67, iLocal_73);
	...
	if (PED::IS_PED_INJURED(pedLocal_68))
		if (HUD::DOES_BLIP_EXIST(blLocal_70))
			HUD::REMOVE_BLIP(&blLocal_70);

	return;
}

void func_2() // Position - 0x301 Hash - 0xD8C6DE12 ^0xD8C6DE12
{
	func_180();
	return;
}

void func_3() // Position - 0x30D Hash - 0xF36F221D ^0x256657D6
{
...
void func_4() // Position - 0x342 Hash - 0xD765C186 ^0xD765C186
{
	func_5();
	return;
}

int func_5() // Position - 0x34F Hash - 0x9482CBBF ^0x8B17A994
{
...
BOOL _IS_MISSION_REPEAT_ACTIVE(BOOL bExcludeBenchmark) // Position - 0x39A Hash - 0x15889021 ^0xE7262364
{
...
void func_7(int iParam0, int iParam1) // Position - 0x3C2 Hash - 0x9B46DE17 ^0x9B46DE17
{
	if (iParam0 == -1)
		iParam0 = func_31();
	...
	if (iParam1 <= func_30(iParam0))
	{
		...
		if (func_15(iParam0, iParam1) != 322)
			func_9(func_15(iParam0, iParam1), uLocal_41, uLocal_41.f_1);
...
void func_8(int iParam0) // Position - 0x4C5 Hash - 0xE49C42EC ^0xE49C42EC
{
	Global_114356 = iParam0;
	return;
}

void func_9(int iParam0, var uParam1, var uParam2) // Position - 0x4D3 Hash - 0xEC2439E7 ^0x1B67A713
{
	BOOL flag;
...
void func_10() // Position - 0x5B9 Hash - 0x9F269E94 ^0x9F269E94
{
	int num;
	float num2;
	float num3;
...
int func_11() // Position - 0xA77 Hash - 0x21D64237 ^0x21D64237
{
	return Global_32828;
}

BOOL func_12(int iParam0, int iParam1) // Position - 0xA82 Hash - 0x77E0C72A ^0x80DA2A54
{
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0xAD3 Hash - 0xCF91FBA1 ^0xAE1D9C41
{
	if (iParam2 == -1)
		iParam2 = func_14();
...
int func_14() // Position - 0xAF1 Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1574925;
}

int func_15(int iParam0, int iParam1) // Position - 0xAFD Hash - 0xE97012CD ^0x68FBF85A
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_16(int iParam0) // Position - 0xE71 Hash - 0xBF3EFB31 ^0xBF3EFB31
{
	switch (iParam0)
	{
		case 29:
...
void func_17(int iParam0) // Position - 0xEA0 Hash - 0x12249850 ^0x46987D7A
{
	int offset;
	int i;
...
void func_18(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0xEE2 Hash - 0x1DB2B0EC ^0x1DB2B0EC
{
	func_19(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
	return;
}

void func_19(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0xF03 Hash - 0x442CE504 ^0xD696ABBA
{
	int i;
...
void func_20() // Position - 0x10D6 Hash - 0xCF8881D1 ^0x40507183
{
	int i;
...
int func_21() // Position - 0x11ED Hash - 0x35BC7314 ^0x35BC7314
{
	func_22();
...
void func_22() // Position - 0x1233 Hash - 0xD1F2D853 ^0xF9F5FD4D
{
...
BOOL func_23(int iParam0) // Position - 0x1330 Hash - 0x937D8816 ^0x937D8816
{
	return Global_43922 == iParam0;
}

BOOL func_24(eCharacter echParam0) // Position - 0x133E Hash - 0x8907F004 ^0x8907F004
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x134A Hash - 0xAC4E9801 ^0xB379A75F
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x1387 Hash - 0xADCB9755 ^0xADCB9755
{
...
Hash func_27(eCharacter echParam0) // Position - 0x13AC Hash - 0xE4CEEC2C ^0xE4CEEC2C
{
	return Global_2139[echParam0 /*29*/];
}

BOOL func_28(int iParam0) // Position - 0x13BB Hash - 0x3F44A899 ^0x7041C53
{
	int num;
	int i;
...
void func_29(int iParam0, int iParam1) // Position - 0x13FB Hash - 0xE2246457 ^0xD5018049
{
	MISC::SET_BIT(&Global_114370.f_24998.f_8[iParam0], iParam1);
	return;
}

int func_30(int iParam0) // Position - 0x1416 Hash - 0xAA02DAD0 ^0xAA02DAD0
{
	int num;
...
int func_31() // Position - 0x14C7 Hash - 0x7AC1007E ^0x4E7D4F54
{
	var unk;
	int num;
...
int func_32(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0x14E4 Hash - 0x6DA57317 ^0x57A32A43
{
...
BOOL func_33() // Position - 0x16BE Hash - 0xFD255207 ^0xFD255207
{
	return true;
}

BOOL _CONVERSATION_IS_DIALOGUE_IN_PROGRESS() // Position - 0x16C7 Hash - 0x152DA0B2 ^0x220E93E9
{
...
void func_35() // Position - 0x16E9 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_36() // Position - 0x16F1 Hash - 0x63C988F1 ^0xE8B83F50
{
	if (!bLocal_241)
	{
		if (func_56())
	...
	else if (!bLocal_244 && !bLocal_242)
	{
		if (func_56() || WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) || !ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(pedLocal_68, false), 12f, 12f, 5f, false, true, 0))
		{
			PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, hLocal_66, joaat("PLAYER"));
		
			if (!PED::IS_PED_INJURED(pedLocal_68))
			{
				TASK::CLEAR_PED_TASKS(pedLocal_68);
				TASK::TASK_COMBAT_PED(pedLocal_68, PLAYER::PLAYER_PED_ID(), 0, 16);
			
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), pedLocal_68, 15f, 15f, 15f, false, true, 0))
				{
					func_54();
					SYSTEM::WAIT(0);
					_CONVERSATION_ADD_LINE(&uLocal_74, "lurinau", "lurin_fucked", 4, 0, 0, 0);
				}
			}
			...
			{
				TASK::CLEAR_PED_TASKS(pedLocal_67);
				TASK::TASK_COMBAT_PED(pedLocal_67, PLAYER::PLAYER_PED_ID(), 0, 16);
			}
...
BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x186E Hash - 0x384540C1 ^0x384540C1
{
...
BOOL func_38(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x18BC Hash - 0x77297D51 ^0x40DC584A
{
	Global_22167 = 0;
...
void func_39() // Position - 0x1B8A Hash - 0xF42BEB19 ^0xA29557DA
{
	if (!func_40())
		return;
...
BOOL func_40() // Position - 0x1BC1 Hash - 0x7B74B45F ^0xCE052A5D
{
...
BOOL func_41(Player plParam0) // Position - 0x1C24 Hash - 0x6E46BC72 ^0x6E46BC72
{
	return func_42(plParam0, 20);
}

BOOL func_42(Player plParam0, int iParam1) // Position - 0x1C34 Hash - 0x7CD5054C ^0x870BEA81
{
	return IS_BIT_SET(Global_1886967[plParam0 /*609*/].f_10.f_4, iParam1);
}

Player _INVALID_PLAYER_INDEX() // Position - 0x1C4C Hash - 0x478900E4 ^0x478900E4
{
	return -1;
}

void func_44() // Position - 0x1C55 Hash - 0x46021FAA ^0x42D52423
{
	int i;
...
void func_45() // Position - 0x1C86 Hash - 0xCD8A4D28 ^0xCD8A4D28
{
...
BOOL func_46() // Position - 0x1D1B Hash - 0xD140D54A ^0xE638D98F
{
...
BOOL func_47() // Position - 0x1D42 Hash - 0x9A999369 ^0x4033F7BF
{
	int num;
	int weaponHash;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x1DDB Hash - 0x98476CE1 ^0x250FEB7C
{
	if (func_23(14))
	{
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x1E7D Hash - 0x3C5423D7 ^0x3C5423D7
{
	func_22();
	return Global_114370.f_2366.f_539.f_4321;
}

void func_50() // Position - 0x1E96 Hash - 0x6F78FD7A ^0x26861BB7
{
	int i;
...
BOOL func_51(int iParam0, int iParam1) // Position - 0x1EED Hash - 0xA14C4D3F ^0xA6034F77
{
	switch (iParam0)
	{
		case 5:
...
void func_52() // Position - 0x1F25 Hash - 0xE32CF1EF ^0xB9A7BEB2
{
...
void func_53(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x1F7C Hash - 0xC6B752B2 ^0xC6B752B2
{
...
void func_54() // Position - 0x1FD2 Hash - 0xC536DD5 ^0xC536DD5
{
	Global_21032 = 0;
	func_55();
	return;
...
void func_55() // Position - 0x1FE2 Hash - 0xF6D04E68 ^0x80AE5309
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_23177 = 0;
...
BOOL func_56() // Position - 0x2003 Hash - 0xFFE384D8 ^0xE7ECBBD3
{
	Vector3 vector;
	Vector3 vector2;
	...
	if (!PED::IS_PED_INJURED(pedLocal_67) && !PED::IS_PED_INJURED(pedLocal_68))
	{
		if (MISC::IS_BULLET_IN_AREA(PED::GET_PED_BONE_COORDS(pedLocal_67, 31086, 0f, 0f, 0f), 30f, true))
			return true;
	
		if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), pedLocal_67, 30f, 30f, 30f, false, true, 0) && WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
		{
			if (PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), pedLocal_67) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), pedLocal_68) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), pedLocal_67) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), pedLocal_68))
			{
				if (PED::CAN_PED_SEE_HATED_PED(pedLocal_67, PLAYER::PLAYER_PED_ID()) || PED::CAN_PED_SEE_HATED_PED(pedLocal_68, PLAYER::PLAYER_PED_ID()))
				{
					func_54();
					SYSTEM::WAIT(0);
					_CONVERSATION_ADD_LINE(&uLocal_74, "lurinau", "lurin_gun", 4, 0, 0, 0);
					return true;
				}
			}
		}
	
		vector = { vector + PED::GET_PED_BONE_COORDS(pedLocal_67, 31086, 0f, 0f, 0f) };
		vector2 = { vector2 + PED::GET_PED_BONE_COORDS(pedLocal_67, 31086, 0f, 0f, 0f) };
		...
		if (GRAPHICS::GET_IS_PETROL_DECAL_IN_RANGE(PED::GET_PED_BONE_COORDS(pedLocal_67, 31086, 0f, 0f, 0f), 3f))
			return true;
	
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			if (PED::IS_PED_IN_MODEL(PLAYER::PLAYER_PED_ID(), joaat("bulldozer")))
				if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), pedLocal_67) || ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), pedLocal_68))
					return true;
		...
		if (PED::IS_COP_PED_IN_AREA_3D(ENTITY::GET_ENTITY_COORDS(pedLocal_67, false) - uLocal_53, ENTITY::GET_ENTITY_COORDS(pedLocal_67, false) + uLocal_53) || VEHICLE::IS_COP_VEHICLE_IN_AREA_3D(ENTITY::GET_ENTITY_COORDS(pedLocal_67, false) - uLocal_53, ENTITY::GET_ENTITY_COORDS(pedLocal_67, false) + uLocal_53))
			return true;
	}
	...
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 894.1762f, -1048.2943f, 41.828f, 15f, 21.5625f, 10f, false, true, 0))
	{
		func_54();
		SYSTEM::WAIT(0);
		_CONVERSATION_ADD_LINE(&uLocal_74, "lurinau", "lurin_other", 4, 0, 0, 0);
		return true;
	}

	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), uLocal_47, 15f, 15f, 15f, false, true, 0))
	{
	...
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), uLocal_47, 40f, 40f, 40f, false, true, 0))
	...
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedLocal_67, PLAYER::PLAYER_PED_ID(), true))
		{
			func_54();
			return true;
		}
	...
	if (ENTITY::DOES_ENTITY_EXIST(pedLocal_68))
	{
...
void func_57() // Position - 0x237A Hash - 0x4812403B ^0x613ECC9D
{
...
void func_58() // Position - 0x2450 Hash - 0xB0E55852 ^0x7E5339E0
{
	if (!bLocal_242)
	{
		if (!PED::IS_PED_INJURED(pedLocal_68))
		{
			if (TASK::GET_SCRIPT_TASK_STATUS(pedLocal_68, SCRIPT_TASK_PERFORM_SEQUENCE) == 7 && ENTITY::IS_ENTITY_AT_ENTITY(pedLocal_68, PLAYER::PLAYER_PED_ID(), 2.8f, 2.8f, 2.8f, false, true, 0))
			{
				if (!bLocal_243)
				{
					iLocal_248 = 500;
					...
					if (_GET_PLAYER_CASH(_GET_CURRENT_PLAYER_CHARACTER()) >= iLocal_248)
					{
						func_59(_GET_CURRENT_PLAYER_CHARACTER(), 1, iLocal_248);
						iLocal_249 = iLocal_248;
						_CONVERSATION_ADD_LINE(&uLocal_74, "lurinau", "lurin_mugtha", 4, 0, 0, 0);
					}
					else if (_GET_PLAYER_CASH(_GET_CURRENT_PLAYER_CHARACTER()) <= 0)
					{
						iLocal_249 = 0;
						_CONVERSATION_ADD_LINE(&uLocal_74, "lurinau", "lurin_mugnom", 4, 0, 0, 0);
					}
					else
					{
						iLocal_249 = _GET_PLAYER_CASH(_GET_CURRENT_PLAYER_CHARACTER());
						func_59(_GET_CURRENT_PLAYER_CHARACTER(), 1, _GET_PLAYER_CASH(_GET_CURRENT_PLAYER_CHARACTER()));
						_CONVERSATION_ADD_LINE(&uLocal_74, "lurinau", "lurin_mugtha", 4, 0, 0, 0);
					}
				
					if (!PED::IS_PED_INJURED(pedLocal_68))
						PED::SET_PED_MONEY(pedLocal_68, iLocal_249);
...
int func_59(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x25D4 Hash - 0x24B6CAA3 ^0x24B6CAA3
{
	if (func_90(echParam0) == 3)
		return 0;

	if (func_90(echParam0) == 4)
		return 0;

	return func_60(func_90(echParam0), 0, iParam1, iParam2, false);
}

int func_60(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x2608 Hash - 0x66394909 ^0x7ECE9AC7
{
	float num;
	int num2;
	int num3;
...
void func_61(BOOL bParam0) // Position - 0x2C07 Hash - 0xB232D28E ^0x40CAA0C6
{
	int i;
	int j;
...
void func_62(int iParam0) // Position - 0x2E89 Hash - 0xD2EB197 ^0x9FF73396
{
	int value;
...
void func_63(int iParam0) // Position - 0x2EE3 Hash - 0x3705FAD4 ^0x3705FAD4
{
	BOOL flag;
	var txdName;
...
char* func_64(int iParam0) // Position - 0x305A Hash - 0xBFA8A038 ^0xBFA8A038
{
	switch (iParam0)
	{
		case 0:
...
int func_65() // Position - 0x3151 Hash - 0xF9396AAC ^0xF9396AAC
{
	int num;
...
void func_66(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x315E Hash - 0x99A9B13C ^0x9ABF46
{
	Hash statName;
...
Hash func_67(int iParam0, int iParam1) // Position - 0x318C Hash - 0x505A9F99 ^0x8B00E935
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_68(iParam1));
}

int func_68(int iParam0) // Position - 0x31A1 Hash - 0x1A3F3220 ^0x1A3F3220
{
	int num;
	int num2;
...
void func_69(int iParam0) // Position - 0x31D5 Hash - 0x35B495B7 ^0x35B495B7
{
	func_88(93, iParam0);
	func_88(29, iParam0);
	func_88(30, iParam0);
...
BOOL func_70(int iParam0) // Position - 0x31F5 Hash - 0xA882C352 ^0xA882C352
{
	int cloudTimeAsInt;
	int num;
	int cloudTimeAsInt2;
...
int func_71(int iParam0, int iParam1) // Position - 0x3395 Hash - 0x744E461C ^0x94D7C845
{
	Hash statHash;
	int outValue;
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x33C4 Hash - 0x6099A833 ^0x46750A9D
{
	if (iParam1 == -1)
		iParam1 = func_14();
...
int func_73(BOOL bParam0) // Position - 0x33E0 Hash - 0xDC114C70 ^0xC626A2DE
{
	var outValue;
	int value;
	int outValue2;
...
int func_74(int iParam0, int iParam1) // Position - 0x3497 Hash - 0x86FEA587 ^0x86FEA587
{
	if (iParam0 >= 78)
		return 0;
...
int func_75(int iParam0, int iParam1) // Position - 0x34B2 Hash - 0x2EC23578 ^0x5A6CDDE0
{
...
BOOL func_76(var uParam0, int iParam1) // Position - 0x354F Hash - 0x5631295D ^0x7E65A9A4
{
	int i;
	var unk;
...
int func_77(var uParam0, int iParam1) // Position - 0x3600 Hash - 0x80929C05 ^0xD2A2E174
{
	int i;
...
BOOL func_78(var uParam0, int iParam1) // Position - 0x367B Hash - 0xFE39C18F ^0xFE39C18F
{
	return uParam0->[iParam1] == 78;
}

void func_79(var uParam0) // Position - 0x368C Hash - 0x6E916534 ^0x6E916534
{
	int i;
...
void func_80(var uParam0, int iParam1) // Position - 0x36C0 Hash - 0xE18ECB8F ^0xE18ECB8F
{
	uParam0->[iParam1] = 78;
	return;
}

void func_81(var uParam0, int iParam1) // Position - 0x36D0 Hash - 0x8B7064C5 ^0xE61DC398
{
	if (iParam1 == 0f)
		uParam0->f_80 = 0f;
	else
...
float func_82(var uParam0) // Position - 0x36ED Hash - 0xD73B9827 ^0xE571889D
{
	return uParam0->f_80;
}

BOOL func_83(var uParam0, int iParam1) // Position - 0x36F9 Hash - 0xD7E1A70C ^0xD7E1A70C
{
	return func_84(uParam0, iParam1) != -1;
}

int func_84(var uParam0, int iParam1) // Position - 0x370B Hash - 0xA778BD6E ^0xA778BD6E
{
	int i;
...
BOOL func_85(var uParam0) // Position - 0x3738 Hash - 0x21364471 ^0xE4E379A4
{
	return uParam0->f_79 == 1;
}

BOOL func_86(int iParam0) // Position - 0x3746 Hash - 0x5000025C ^0x5000025C
{
	switch (iParam0)
	{
		case 60:
...
void func_87(Hash hParam0, int iParam1) // Position - 0x3796 Hash - 0x1F80E88A ^0x1E13AAF3
{
	int outValue;
...
void func_88(int iParam0, int iParam1) // Position - 0x37B9 Hash - 0xE9A65642 ^0xF9847A54
{
	int outValue;
...
void func_89() // Position - 0x3816 Hash - 0xFD5B61DC ^0x7C6336B1
{
	int outValue;
...
int func_90(eCharacter echParam0) // Position - 0x388B Hash - 0x12DEE71A ^0xB4CACA6A
{
	return Global_2139[echParam0 /*29*/].f_17;
}

int _GET_PLAYER_CASH(eCharacter echParam0) // Position - 0x389C Hash - 0x263E14E9 ^0x46FE135B
{
	int outValue;
...
void func_92() // Position - 0x38F4 Hash - 0xDC3A1FDC ^0x14BEE491
{
	if (!PED::IS_PED_INJURED(pedLocal_68))
	{
		if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 873.9561f, -1050.8057f, 33.0066f, 4.75f, 1.9f, 1f, false, true, 0))
		{
			...
			{
				TASK::TASK_LOOK_AT_ENTITY(pedLocal_68, PLAYER::PLAYER_PED_ID(), -1, SLF_WHILE_NOT_IN_FOV, 2);
				PED::SET_PED_DUCKING(pedLocal_68, false);
				WEAPON::GIVE_WEAPON_TO_PED(pedLocal_68, joaat("WEAPON_PISTOL"), 200, true, true);
				...
				else
				{
					...
					TASK::TASK_PLAY_ANIM(0, "random@mugging5", "ig_1_guy_enter_stickup", 2f, -2f, -1, 0, 0, false, false, false);
				...
				HUD::SET_BLIP_AS_FRIENDLY(blLocal_69, false);
				blLocal_70 = func_100(pedLocal_68, true, 145);
				AUDIO::TRIGGER_MUSIC_EVENT("RE35_OS");
				SYSTEM::WAIT(500);
			
				if (!PED::IS_PED_INJURED(pedLocal_67))
				{
					TASK::TASK_LOOK_AT_ENTITY(pedLocal_67, PLAYER::PLAYER_PED_ID(), -1, SLF_WHILE_NOT_IN_FOV, 2);
					WEAPON::GIVE_WEAPON_TO_PED(pedLocal_67, joaat("WEAPON_PISTOL"), 200, true, true);
					TASK::OPEN_SEQUENCE_TASK(&iLocal_73);
					TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, uLocal_62, PLAYER::PLAYER_PED_ID(), 2f, false, 0f, 4f, true, 512, false, joaat("FIRING_PATTERN_FULL_AUTO"), 20000);
				...
				{
					TASK::OPEN_SEQUENCE_TASK(&iLocal_73);
					TASK::TASK_LOOK_AT_ENTITY(0, pedLocal_68, -1, SLF_WHILE_NOT_IN_FOV, 2);
				...
				func_54();
				SYSTEM::WAIT(0);
				_CONVERSATION_ADD_LINE(&uLocal_74, "lurinau", "lurin_mugger", 4, 0, 0, 0);
				SYSTEM::SETTIMERA(0);
				bLocal_241 = true;
			}
			else
...
void func_93(BOOL bParam0) // Position - 0x3B93 Hash - 0x5FE88D2A ^0xA22C291D
{
	if (bParam0)
	{
		func_99();
...
void func_94(int iParam0) // Position - 0x3BF6 Hash - 0x4066FEF5 ^0x9787FBDA
{
	if (func_97())
		return;
...
void func_95(BOOL bParam0, BOOL bParam1) // Position - 0x3C80 Hash - 0xF40FC178 ^0xA6F60F17
{
	if (bParam0)
	{
		if (func_98(0))
...
BOOL func_96() // Position - 0x3CF4 Hash - 0x8DF3D75D ^0x8DF3D75D
{
	return IS_BIT_SET(Global_1956030, 5);
}

BOOL func_97() // Position - 0x3D02 Hash - 0xC41437CB ^0xC41437CB
{
	return IS_BIT_SET(Global_1956030, 19);
}

BOOL func_98(int iParam0) // Position - 0x3D11 Hash - 0xE8921B44 ^0x4F063755
{
	if (iParam0 == 1)
		if (Global_20813.f_1 > 3)
...
void func_99() // Position - 0x3D68 Hash - 0xF8FE2348 ^0xA77911B2
{
...
Blip func_100(Ped pedParam0, BOOL bParam1, int iParam2) // Position - 0x3D91 Hash - 0xA714218A ^0xAD0F82BD
{
	Blip blip;

	blip = func_101(pedParam0, !bParam1, false);
...
Blip func_101(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3DDB Hash - 0x2E5A72B ^0x64F26CC0
{
	Blip blip;
...
var func_102(BOOL bParam0, var uParam1, var uParam2) // Position - 0x3E7F Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
void func_103() // Position - 0x3E96 Hash - 0xA649A40F ^0xB12F6CEE
{
	if (!ENTITY::IS_ENTITY_DEAD(pedLocal_67, false))
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), pedLocal_67, 15f, 15f, 15f, false, true, 0))
		{
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
				if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
				{
					...
					if (SYSTEM::TIMERB() > 7000 && iLocal_247 == 2 && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
					{
						SYSTEM::SETTIMERB(0);
						TASK::TASK_LOOK_AT_ENTITY(pedLocal_67, PLAYER::PLAYER_PED_ID(), -1, SLF_EXTEND_YAW_LIMIT | 2048, 2);
						_CONVERSATION_ADD_LINE(&uLocal_74, "lurinau", "lurin_girlch", 4, 0, 0, 0);
					}
				}
			}
			else
...
void func_104() // Position - 0x3FAE Hash - 0x698F7407 ^0xEBF116
{
	if (!PED::IS_PED_INJURED(pedLocal_67))
	{
		if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			if (WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) && PED::CAN_PED_SEE_HATED_PED(pedLocal_67, PLAYER::PLAYER_PED_ID()))
			{
				TASK::CLEAR_PED_TASKS(pedLocal_67);
				TASK::OPEN_SEQUENCE_TASK(&iLocal_73);
				TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, SLF_EXTEND_YAW_LIMIT | 2048, 2);
...
void func_105() // Position - 0x40BD Hash - 0x3BAF5BB4 ^0xE6A6E3C4
{
	if (!func_134())
	{
		if (!ENTITY::IS_ENTITY_DEAD(pedLocal_67, false))
		{
			if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), uLocal_47, 65f, 60f, 60f, false, true, 0) || Global_114365)
			{
				if (HUD::DOES_BLIP_EXIST(blLocal_71))
					HUD::REMOVE_BLIP(&blLocal_71);
			
				blLocal_69 = func_100(pedLocal_67, false, 145);
				HUD::SHOW_HEIGHT_ON_BLIP(blLocal_69, false);
	...
	if (!bLocal_239)
	{
		if (!PED::IS_PED_INJURED(pedLocal_67))
		{
			if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), pedLocal_67, 25f, 25f, 25f, false, true, 0) && func_134())
			{
				if (_CONVERSATION_ADD_LINE(&uLocal_74, "lurinau", "lurin_help2", 4, 0, 0, 0))
				{
					TASK::OPEN_SEQUENCE_TASK(&iLocal_73);
					TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, SLF_WIDEST_YAW_LIMIT | 2048, 2);
					TASK::TASK_PLAY_ANIM(0, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_idle_b", 4f, -4f, -1, 49, 0, false, false, false);
	...
	if (!ENTITY::IS_ENTITY_DEAD(pedLocal_67, false))
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), pedLocal_67, 15f, 15f, 15f, false, true, 0) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			WEAPON::SET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("WEAPON_UNARMED"), true);
	
		if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), pedLocal_67, 8f, 8f, 8f, false, true, 0))
		{
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
				bLocal_240 = true;
				...
				if (HUD::DOES_BLIP_EXIST(blLocal_69))
					HUD::SHOW_HEIGHT_ON_BLIP(blLocal_69, true);
			
				TASK::CLEAR_PED_TASKS(pedLocal_67);
				_CONVERSATION_ADD_LINE(&uLocal_74, "lurinau", "lurin_help", 4, 0, 0, 0);
			
				if (!ENTITY::IS_ENTITY_DEAD(pedLocal_67, false))
				{
					SYSTEM::SETTIMERB(0);
					TASK::CLEAR_PED_SECONDARY_TASK(pedLocal_67);
					TASK::OPEN_SEQUENCE_TASK(&iLocal_73);
					TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, SLF_WIDEST_YAW_LIMIT | 2048, 2);
					TASK::TASK_STAND_STILL(0, 1000);
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, uLocal_59, 2f, -1, 0.25f, 512, 80.1325f);
					TASK::TASK_PLAY_ANIM(0, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_idle_b", 4f, -4f, -1, 1, 0, false, false, false);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_73);
					TASK::TASK_PERFORM_SEQUENCE(pedLocal_67, iLocal_73);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_73);
					uLocal_53 = { 40f, 40f, 30f };
				}
			}
			else if (!bLocal_246)
			{
				...
				if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
				{
					if (!PED::IS_PED_INJURED(pedLocal_67))
					{
						_CONVERSATION_ADD_LINE(&uLocal_74, "lurinau", "lurin_girlca", 4, 0, 0, 0);
						TASK::OPEN_SEQUENCE_TASK(&iLocal_73);
						TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, SLF_EXTEND_YAW_LIMIT | 1024 | 2048, 2);
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1);
						TASK::CLOSE_SEQUENCE_TASK(iLocal_73);
						TASK::TASK_PERFORM_SEQUENCE(pedLocal_67, iLocal_73);
						TASK::CLEAR_SEQUENCE_TASK(&iLocal_73);
...
void func_106() // Position - 0x435C Hash - 0xC536DD5 ^0xC536DD5
{
	Global_21032 = 0;
	func_107();
	return;
...
void func_107() // Position - 0x436C Hash - 0x21027D29 ^0xBEB9ECFD
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
...
int func_108(BOOL bParam0) // Position - 0x4390 Hash - 0x3A78A0E1 ^0x42FD1885
{
	if (func_112())
	{
		Global_114360 = true;
...
void func_109(int iParam0) // Position - 0x43E3 Hash - 0x3B4E6AAB ^0x52844A7B
{
	switch (iParam0)
	{
		case 0:
			if (Global_114370.f_24998.f_2 < 3)
			{
				...
				{
					_DISPLAY_HELP_TEXT(func_111(iParam0), -1);
...
void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x44BE Hash - 0xCBB0D91 ^0x21070E5C
{
...
char* func_111(int iParam0) // Position - 0x44D5 Hash - 0x866BB8A2 ^0x9E8D4BF4
{
	char* str;
...
BOOL func_112() // Position - 0x4518 Hash - 0x8129EEA4 ^0x48B13301
{
...
int func_113(var uParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0x454E Hash - 0x8F9349A ^0xC5C097C1
{
	int i;
...
void func_114(var uParam0, int iParam1) // Position - 0x4685 Hash - 0x6AC97785 ^0x6AC97785
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0x46D4 Hash - 0xECB6C71B ^0xECB6C71B
{
	return func_116(iParam0, Global_43922);
}

BOOL func_116(int iParam0, int iParam1) // Position - 0x46E5 Hash - 0x1FD727E0 ^0x1FD727E0
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_117(int iParam0) // Position - 0x48C6 Hash - 0x3BAB94E9 ^0x3BAB94E9
{
	if (Global_43922 == 15)
		return false;
...
void func_118() // Position - 0x48E8 Hash - 0x401FA16E ^0xC25E4DB
{
	func_120();
	...
	PED::ADD_SCENARIO_BLOCKING_AREA(uLocal_47 - { 10f, 30f, 30f }, uLocal_47 + { 10f, 30f, 30f }, false, true, true, true, 1);
	PED::ADD_RELATIONSHIP_GROUP("mugger", &hLocal_66);
	pedLocal_67 = PED::CREATE_PED(PED_TYPE_DEALER, joaat("A_F_M_SkidRow_01"), uLocal_56, 79.765f, true, true);
	PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(pedLocal_67, true);
	PED::SET_PED_CONFIG_FLAG(pedLocal_67, 185, true);
	PED::SET_PED_FLEE_ATTRIBUTES(pedLocal_67, 128, true);
	AUDIO::STOP_PED_SPEAKING(pedLocal_67, true);
	PED::SET_PED_RELATIONSHIP_GROUP_HASH(pedLocal_67, hLocal_66);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, hLocal_66, joaat("PLAYER"));
	TASK::OPEN_SEQUENCE_TASK(&iLocal_73);
	TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, SLF_EXTEND_YAW_LIMIT | 1024 | 2048, 2);
	TASK::TASK_PLAY_ANIM(0, "random@mugging5", "ig_1_girl_agitated_loop", 2f, -2f, -1, 1, 0, false, false, false);
	TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1);
	TASK::CLOSE_SEQUENCE_TASK(iLocal_73);
	TASK::TASK_PERFORM_SEQUENCE(pedLocal_67, iLocal_73);
	TASK::CLEAR_SEQUENCE_TASK(&iLocal_73);
	pedLocal_68 = PED::CREATE_PED(PED_TYPE_GANG_ALBANIAN, joaat("A_M_M_Tramp_01"), uLocal_50, fLocal_65, true, true);
	...
	PED::SET_PED_FLEE_ATTRIBUTES(pedLocal_68, 128, true);
	ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(pedLocal_68, true, 0);
	AUDIO::STOP_PED_SPEAKING(pedLocal_68, true);
	PED::SET_PED_RELATIONSHIP_GROUP_HASH(pedLocal_68, hLocal_66);
	TASK::TASK_LOOK_AT_ENTITY(pedLocal_68, PLAYER::PLAYER_PED_ID(), -1, SLF_EXTEND_YAW_LIMIT | 2048, 2);
	_CONVERSATION_INITIALIZE_ACTOR(&uLocal_74, 0, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	_CONVERSATION_INITIALIZE_ACTOR(&uLocal_74, 4, pedLocal_67, "HOBOFEMALE", 0, 1);
	_CONVERSATION_INITIALIZE_ACTOR(&uLocal_74, 5, pedLocal_68, "HOBOMALE", 0, 1);
	bLocal_45 = true;
	return;
}

void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x4AD5 Hash - 0x6C235EE0 ^0x9E57F206
{
...
void func_120() // Position - 0x4B70 Hash - 0x845B4B87 ^0x845B4B87
{
	uLocal_50 = { 879.8144f, -1047.4327f, 32.0067f };
	fLocal_65 = 237.0934f;
	uLocal_56 = { 862.9633f, -1049.8569f, 28.5362f };
	uLocal_53 = { 15f, 15f, 15f };
	uLocal_59 = { 881.1367f, -1050.706f, 32.0067f };
	uLocal_62 = { 876.7977f, -1052.5198f, 32.0067f };
	return;
}

BOOL func_121() // Position - 0x4BDE Hash - 0xC05B0E62 ^0x94C54EFE
{
	...
	if (func_122(100f, true) != -1)
		return true;

	return false;
}

int func_122(float fParam0, BOOL bParam1) // Position - 0x4C64 Hash - 0xA169FFDC ^0x284941E0
{
	var unk;
	int num;
	int num2;
...
void func_123(int iParam0, var uParam1) // Position - 0x4D15 Hash - 0x8D6A52D2 ^0xA5AFBFA6
{
	switch (iParam0)
	{
		case 0:
		...
		case 5:
			func_124(uParam1, "Barry3A", func_126(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH" /*Areas where you can find vehicles with a hidden stash have been marked on the map. Collect these vehicles for Barry.*/, 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_125(iParam0), 0, 1);
			break;
		...
		case 8:
			func_124(uParam1, "Dreyfuss1", func_126(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT" /*The killer's identity and location have been revealed.*/, 106, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_125(iParam0), 0, 0);
			break;
		...
		case 38:
			func_124(uParam1, "Nigel1A", func_126(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS" /*Areas where you can find celebrity items have been marked on the map. Steal these items for Nigel and Mrs. Thornhill.*/, 100, 0, "", 0, 0, 42, 4, 4, 0, 2359, func_125(iParam0), 1, 1);
			break;
		...
		case 49:
			func_124(uParam1, "Paparazzo3A", func_126(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO" /*Areas where you can find celebrity photo opportunities have been marked on the map. Track down and photograph these celebrities for Beverly.*/, 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_125(iParam0), 0, 1);
			break;
		...
		case 58:
			func_124(uParam1, "Tonya1", func_126(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS" /*Strangers and Freaks can be found throughout San Andreas at ~HUD_COLOUR_FRANKLIN~~BLIP_RANDOM_CHARACTER~~s~*/, -1, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_125(iParam0), 0, 1);
			break;
...
void func_124(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6, float fParam7, float fParam8, float fParam9, int iParam10, char* sParam11, int iParam12, int iParam13, char* sParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, int iParam22, int iParam23, int iParam24) // Position - 0x5ECA Hash - 0x340E6E87 ^0xA591C803
{
	uParam0->f_4 = iParam5;
	*uParam0 = sParam1;
	uParam0->f_1 = { uParam2 };
...
int func_125(int iParam0) // Position - 0x5F5B Hash - 0xC999F6B2 ^0xC999F6B2
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_126(int iParam0) // Position - 0x62A1 Hash - 0x8E0EE9EB ^0x93523303
{
	var unk;
	var unk3;

	TEXT_LABEL_ASSIGN_STRING(&unk, "", 8);
	unk3 = { func_127(iParam0) };
...
struct<2> func_127(int iParam0) // Position - 0x62D8 Hash - 0x5818CE19 ^0xFD17EE07
{
	var unk;
...
BOOL func_128() // Position - 0x6724 Hash - 0x7055FFB1 ^0x7055FFB1
{
...
BOOL func_129() // Position - 0x6756 Hash - 0x79CF7679 ^0x79CF7679
{
	return Global_114088 > 0;
}

BOOL func_130() // Position - 0x6764 Hash - 0xCF2296C0 ^0xCF2296C0
{
	if (Global_98294 != -1)
		return true;
...
BOOL func_131() // Position - 0x6779 Hash - 0x98CCC132 ^0x97B0D6ED
{
	if (Global_98294 != -1)
...
BOOL func_132() // Position - 0x679C Hash - 0x29CB2928 ^0xE369A18D
{
...
BOOL func_133() // Position - 0x67B9 Hash - 0xF2B7F534 ^0x7F3EC4F9
{
...
BOOL func_134() // Position - 0x681B Hash - 0x1121F6F2 ^0x90CE37A6
{
...
void func_135(int iParam0) // Position - 0x6846 Hash - 0xA62BD46A ^0x1E050688
{
	if (iParam0 == -1)
		iParam0 = func_31();
...
void func_136() // Position - 0x687C Hash - 0x178BF2A7 ^0x744062F5
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
...
void func_137(int iParam0) // Position - 0x68B9 Hash - 0xE49C42EC ^0xE49C42EC
{
	Global_114359 = iParam0;
	return;
}

BOOL func_138(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x68C7 Hash - 0xC601B4EA ^0xC601B4EA
{
	BOOL flag;
	...
	if (!flag)
	{
		...
		if (func_24(_GET_CURRENT_PLAYER_CHARACTER()))
			if (func_176(_GET_CURRENT_PLAYER_CHARACTER()) == 4 || func_176(_GET_CURRENT_PLAYER_CHARACTER()) == 5)
				return false;
		...
		if (!func_174(Global_114370.f_24998.f_43[iParam3]))
			return false;
		...
		if (func_24(_GET_CURRENT_PLAYER_CHARACTER()))
		{
			for (i = CHAR_MICHAEL; i < CHAR_MULTIPLAYER; i = i + 1)
			{
				...
				if (func_162(num))
					if (func_140(i))
						if (!func_139(vector, 0f, 0f, 0f, false))
...
BOOL func_139(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x6C61 Hash - 0x2D46096D ^0xEA41378F
{
	if (bParam6)
...
BOOL func_140(eCharacter echParam0) // Position - 0x6CA8 Hash - 0x687D9246 ^0x687D9246
{
	int num;
...
BOOL func_141(int iParam0) // Position - 0x6CC9 Hash - 0x2D75E13A ^0x2D75E13A
{
	return func_142(iParam0, 1);
}

int func_142(int iParam0, int iParam1) // Position - 0x6CD8 Hash - 0x1F92FEBC ^0x1F92FEBC
{
	var unk;
	var unk2;
	int num;
	...
	func_143(iParam0, &unk, &unk2, &num, &num2, &num3, &num4);
...
void func_143(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x6D2B Hash - 0x2BEE335D ^0x2BEE335D
{
	func_144(func_155(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
	return;
}

void func_144(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x6D49 Hash - 0xB807819C ^0xB807819C
{
	int num;
	int num2;
	int num3;
	...
	{
		num = func_153(iParam1);
		num2 = func_151(iParam0);
		num3 = func_151(iParam0) - func_151(iParam1);
		num4 = func_153(iParam0) - func_153(iParam1);
		num5 = func_150(iParam0) - func_150(iParam1);
		num6 = func_149(iParam0) - func_149(iParam1);
		num7 = func_148(iParam0) - func_148(iParam1);
		num8 = func_147(iParam0) - func_147(iParam1);
	}
	else
	{
		num = func_153(iParam0);
		num2 = func_151(iParam1);
		num3 = func_151(iParam1) - func_151(iParam0);
		num4 = func_153(iParam1) - func_153(iParam0);
		num5 = func_150(iParam1) - func_150(iParam0);
		num6 = func_149(iParam1) - func_149(iParam0);
		num7 = func_148(iParam1) - func_148(iParam0);
		num8 = func_147(iParam1) - func_147(iParam0);
	}
	...
	while (num5 < 0)
	{
		...
		num5 = num5 + func_146(num, num2);
		num4 = num4 - 1;
		num = SYSTEM::ROUND(func_145(SYSTEM::TO_FLOAT(num + 1), 0f, 12f));
	}
...
float func_145(float fParam0, float fParam1, float fParam2) // Position - 0x6F4A Hash - 0xDB08F514 ^0x78C0BF6F
{
	float num;
...
int func_146(int iParam0, int iParam1) // Position - 0x6F8C Hash - 0xD3EBACB3 ^0xD3EBACB3
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_147(int iParam0) // Position - 0x702E Hash - 0x90B520AB ^0x257AC1C4
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_148(int iParam0) // Position - 0x7041 Hash - 0xC188C91C ^0x48884C7
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_149(int iParam0) // Position - 0x7054 Hash - 0x626AEC54 ^0xDB28E416
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_150(int iParam0) // Position - 0x7067 Hash - 0x826C592F ^0xDEC5AA46
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_151(int iParam0) // Position - 0x7079 Hash - 0xE1B0542C ^0x127A471E
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_152(BOOL bParam0, var uParam1, var uParam2) // Position - 0x709B Hash - 0x3EE55A88 ^0x3EE55A88
{
	if (bParam0)
		return uParam1;
...
int func_153(int iParam0) // Position - 0x70B2 Hash - 0x2D4DB85F ^0x2D4DB85F
{
	return iParam0 & 15;
}

BOOL func_154(int iParam0, int iParam1) // Position - 0x70BF Hash - 0xEA08B1 ^0xEA08B1
{
	int num;
	int num2;
...
int func_155() // Position - 0x71CB Hash - 0x9E44C35 ^0xB9993D58
{
	var unk;

	func_161(&unk, CLOCK::GET_CLOCK_SECONDS());
	func_160(&unk, CLOCK::GET_CLOCK_MINUTES());
	func_159(&unk, CLOCK::GET_CLOCK_HOURS());
	func_158(&unk, CLOCK::GET_CLOCK_DAY_OF_MONTH());
	func_157(&unk, CLOCK::GET_CLOCK_MONTH());
	func_156(&unk, CLOCK::GET_CLOCK_YEAR());
	return unk;
}

void func_156(var uParam0, int iParam1) // Position - 0x7211 Hash - 0x15B9927E ^0x4A4674
{
	if (iParam1 <= 0)
		return;
...
void func_157(var uParam0, int iParam1) // Position - 0x7297 Hash - 0x4C70B2C3 ^0x4C70B2C3
{
...
void func_158(var uParam0, int iParam1) // Position - 0x72CA Hash - 0x2220FC6 ^0x2220FC6
{
	int num;
	int num2;
...
void func_159(var uParam0, int iParam1) // Position - 0x731B Hash - 0x864304A8 ^0x1F5003E2
{
...
void func_160(var uParam0, int iParam1) // Position - 0x7355 Hash - 0x76860AE7 ^0x32308FFF
{
...
void func_161(var uParam0, int iParam1) // Position - 0x7390 Hash - 0xDB8A72C0 ^0x4F6D426D
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_162(int iParam0) // Position - 0x73CC Hash - 0x57D8E518 ^0xD297DD35
{
	int num;
	int num2;
	int num3;
	...
	num3 = func_149(iParam0);

	if (num3 < 0 || num3 > 23)
		return false;

	num4 = func_151(iParam0);

	if (num4 <= 0 || num4 > 2043 || num4 < 1979)
		return false;

	num5 = func_153(iParam0);
...
BOOL func_163(int iParam0, int iParam1) // Position - 0x74A8 Hash - 0x577FB514 ^0xAAF8B538
{
...
BOOL func_164(int iParam0) // Position - 0x74C8 Hash - 0x97844555 ^0xADCD6DAA
{
	eCharacter character;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_172() || Global_113417 || Global_32831 || func_171() || func_51(8, -1) || func_170() || func_169() || func_168() || func_167() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_172() || Global_32831 || func_171() || func_51(8, -1) || func_168() || func_170() || func_169() || func_167() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_172() || Global_113417 || Global_32831 || func_171() || func_51(8, -1) || func_168() || func_170() || func_169() || func_167() || Global_114370.f_7691.f_919[character] == 5 || Global_44469 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_172() || Global_113417 || Global_32831 || func_171() || func_51(8, -1) || func_170() || func_169() || func_167() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_172() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_51(8, -1) || func_167() || func_166() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_172() || Global_32831 || func_171() || func_51(8, -1) || func_169() || func_168() || func_167() || Global_114370.f_7691.f_919[character] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_172() || func_169() || Global_113417 || Global_32831 || func_171() || Global_45122 || func_51(8, -1) || func_168() || func_166() || func_167() || Global_114370.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 8:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_172() || Global_113417 || Global_32831 || func_171() || func_51(8, -1) || func_168() || func_166() || func_170() || func_169() || func_167())
							return false;
						break;
				}
			}
...
BOOL func_165() // Position - 0x7BE5 Hash - 0x4228A1C2 ^0x952FE30F
{
	return Global_101431.f_1;
}

BOOL func_166() // Position - 0x7BF3 Hash - 0xC20DBA70 ^0xAC4006FB
{
	if (Global_98294 != -1)
...
BOOL func_167() // Position - 0x7C16 Hash - 0x3CA1BB47 ^0xB78A1ACB
{
...
BOOL func_168() // Position - 0x7C30 Hash - 0xE663B8F6 ^0xE663B8F6
{
	if (Global_79509)
		return true;
...
BOOL func_169() // Position - 0x7C5A Hash - 0xD56328D2 ^0xD56328D2
{
	return Global_101444.f_394 > 0;
}

BOOL func_170() // Position - 0x7C6B Hash - 0xD56328D2 ^0xD56328D2
{
	return Global_101444.f_393 > 0;
}

BOOL func_171() // Position - 0x7C7C Hash - 0x47FF56D2 ^0x47FF56D2
{
	return Global_1575079;
}

BOOL func_172() // Position - 0x7C88 Hash - 0x7FE517FE ^0x128A3BC8
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
BOOL func_173() // Position - 0x7CA4 Hash - 0xB12DEAA2 ^0xB12DEAA2
{
	_UPDATE_CURRENT_PLAYER_CHARACTER();
...
BOOL func_174(int iParam0) // Position - 0x7CCC Hash - 0xCDB90269 ^0xCDB90269
{
	return func_154(func_155(), iParam0);
}

BOOL func_175(int iParam0, int iParam1, eCharacter echParam2) // Position - 0x7CDE Hash - 0xBEEFD79C ^0xBEEFD79C
{
	BOOL num;
	eCharacter character;
...
int func_176(eCharacter echParam0) // Position - 0x7DC2 Hash - 0x45FC9D61 ^0x45FC9D61
{
...
BOOL func_177(int iParam0) // Position - 0x7DE6 Hash - 0xF2A54181 ^0xF2A54181
{
	int num;
	BOOL flag;
...
BOOL func_178() // Position - 0x7E3E Hash - 0xB72C022E ^0x452A7B6D
{
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x7E82 Hash - 0x44DD83CC ^0x7B62A376
{
	int profileSetting;
...
void func_180() // Position - 0x7F3A Hash - 0x896A9BB8 ^0x9B82D88D
{
	if (bLocal_46)
	{
...
void func_181(int iParam0) // Position - 0x7FFA Hash - 0x27C2CB4D ^0xA70907A5
{
	var name;
	...
	if (func_134())
	{
		...
		func_184(30000);
		TEXT_LABEL_ASSIGN_STRING(&name, func_183(Global_114359, true), 64);
	...
	func_182(&Global_32888);
	Global_114360 = false;
	func_137(-1);
	return;
}

void func_182(var uParam0) // Position - 0x80AD Hash - 0x995C9E2 ^0x995C9E2
{
	if (*uParam0 == -1)
		return;
...
char* func_183(int iParam0, BOOL bParam1) // Position - 0x80EA Hash - 0x959319CB ^0x91FD805B
{
	switch (iParam0)
	{
		case 0:
...
void func_184(int iParam0) // Position - 0x8333 Hash - 0xC0234809 ^0x4FD853DC
{
	Global_44473 = MISC::GET_GAME_TIMER() + iParam0;
	return;
}

void func_185(int iParam0) // Position - 0x8345 Hash - 0x881273A8 ^0x881273A8
{
	func_186(iParam0, 0, func_191(iParam0));
	return;
}

void func_186(int iParam0, int iParam1, int iParam2) // Position - 0x835A Hash - 0xA7DBC311 ^0xA7DBC311
{
	int unk;
	var unk2;
...
struct<16> func_187(var uParam0) // Position - 0x8389 Hash - 0x66A3D791 ^0x534B209B
{
	var unk;
	int num;
	...
	TEXT_LABEL_APPEND_STRING(&unk, "/", 64);
	TEXT_LABEL_APPEND_INT(&unk, func_151(*uParam0), 64);
	return unk;
}

void func_188(int iParam0, var uParam1) // Position - 0x8459 Hash - 0x63EF72B0 ^0xC612AA53
{
	Global_114370.f_24998.f_43[iParam0] = *uParam1;
	return;
}

void func_189(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x8471 Hash - 0xB28A4507 ^0xB28A4507
{
	int num;
	int i;
	int num2;
...
void func_190(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x85F3 Hash - 0x733BFBA2 ^0x733BFBA2
{
...
int func_191(int iParam0) // Position - 0x862B Hash - 0x4219564C ^0x4219564C
{
	int num;
