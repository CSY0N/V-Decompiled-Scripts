...
void main() // Position - 0x0 Hash - 0x5D84F89F ^0x5D84F89F
{
	...
	func_77();
	Global_4543841 = 0;
	MISC::SET_BIT(&Global_4543841, 0);
	MISC::SET_BIT(&Global_4543841, 1);

	for (i = 0; i < 132; i = i + 1)
	{
		func_34(&Global_1312263[i /*1951*/], i);
	}
	...
	switch (iLocal_54)
	{
		case 0:
			...
			while (!IS_BIT_SET(Global_4543841, 0) || !IS_BIT_SET(Global_4543841, 1) || !IS_BIT_SET(Global_4543841, 2))
			{
				!IS_BIT_SET(Global_4543841, 0);
				!IS_BIT_SET(Global_4543841, 1);
				!IS_BIT_SET(Global_4543841, 2);
				SYSTEM::WAIT(0);
			}
		
			MISC::START_SAVE_DATA(&Global_114370, 1, true);
			MISC::REGISTER_FLOAT_TO_SAVE(&Global_114370, "fSaveVersion");
			MISC::STOP_SAVE_DATA();
		
			if (Global_1)
				Global_0 = Global_114370;
	...
	MISC::START_SAVE_DATA(&Global_2359296, 5570, false);
	MISC::START_SAVE_ARRAY_WITH_SIZE(&Global_2359296, 5570, "g_savedMPGlobals");

	for (i = 0; i < 1; i = i + 1)
	{
		func_19(&Global_2359296[i /*5569*/], i);
		func_17(&Global_2359296[i /*5569*/], i);
		func_14(&Global_2359296[i /*5569*/], i);
		func_12(&Global_2359296[i /*5569*/], i);
		func_11(&Global_2359296[i /*5569*/], i);
		func_10(&Global_2359296[i /*5569*/], i);
		func_3(&Global_2359296[i /*5569*/], i);
	}
...
void func_1() // Position - 0x308 Hash - 0xE15AB5D8 ^0xAEDEFC14
{
	Global_31[0] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(-1680.49f, -929.44f, -0.462531f, "vbca_tunnel1");
	Global_31[1] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(-1562.04f, -876.91f, -0.471913f, "vbca_tunnel2");
	Global_31[2] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(-1429.65f, -823.211f, -0.432763f, "vbca_tunnel3");
	Global_31[3] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(-1316.9f, -843.515f, 1.43639f, "vbca_tunnel4");
	Global_31[4] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(-1249.67f, -896.27f, 0.293292f, "vbca_tunnel5");
	Global_31[5] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(-38.9818f, -570.534f, 28.4812f, "v_31_tun_01");
	Global_31[6] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(481.908f, -577.602f, 2.41908f, "v_31_newtunnel1");
	Global_31[7] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(1029.02f, -260.955f, 48.2681f, "v_31_newtun5");
	Global_31[8] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(1022.25f, -205.648f, 42.8956f, "v_31_newtun4b");
	Global_31[9] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(823.852f, -299.823f, 4.54864f, "v_31_newtun3");
	Global_31[10] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(615.395f, -409.282f, -1.57599f, "v_31_newtun2");
	Global_31[11] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(-1190.58f, -685.387f, 11.0753f, "sm20_tun4");
	Global_31[12] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(-1292.36f, -730.629f, 11.0934f, "sm20_tun3");
	Global_31[13] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(-1411.97f, -759.518f, 15.5455f, "sm20_tun2");
	Global_31[14] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(-1531.56f, -762.391f, 15.3451f, "sm20_tun1");
	Global_31[15] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(558.653f, -1486.49f, 21.4096f, "sc1_rd_inttunshort");
	Global_31[16] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(569.673f, -1920.17f, 21.1009f, "sc1_rd_inttun3b_end");
	Global_31[17] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(512.412f, -1908.55f, 21.2086f, "sc1_rd_inttun3b");
	Global_31[18] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(434.343f, -1945.27f, 17.3936f, "sc1_rd_inttun3");
	Global_31[19] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(513.914f, -2009.82f, 21.1486f, "sc1_rd_inttun2b_end");
	Global_31[20] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(465.139f, -2025.49f, 19.4406f, "sc1_rd_inttun2b");
	Global_31[21] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(406.938f, -1978.14f, 16.3512f, "sc1_rd_inttun2");
	Global_31[22] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(319.321f, -1896.97f, 22.4086f, "sc1_rd_inttun1");
	Global_31[23] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(-573.473f, -580.793f, 25.3082f, "kt1_04_roadtunnel_int");
	Global_31[24] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(-675.628f, -606.272f, 25.3078f, "kt1_03_carpark_int");
	Global_31[25] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(1314.63f, -904.059f, 53.0877f, "id2_21_a_tun5");
	Global_31[26] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(1248.64f, -773.6f, 44.5493f, "id2_21_a_tun4");
	Global_31[27] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(1213.45f, -597.799f, 37.7533f, "id2_21_a_tun3");
	Global_31[28] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(1083.25f, -502.542f, 34.6573f, "id2_21_a_tun2");
	Global_31[29] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(926.428f, -488.737f, 33.8564f, "id2_21_a_tun1");
	Global_31[30] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(732.663f, -2486.45f, 11.0686f, "id1_11_tunnel8_int");
	Global_31[31] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(749.494f, -2364.79f, 16.2255f, "id1_11_tunnel7_int");
	Global_31[32] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(758.957f, -2260.08f, 23.4637f, "id1_11_tunnel6_int");
	Global_31[33] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(769.889f, -2124.24f, 21.8223f, "id1_11_tunnel5_int");
	Global_31[34] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(789.138f, -1963.58f, 20.6408f, "id1_11_tunnel4_int");
	Global_31[35] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(815.852f, -1832.2f, 22.9671f, "id1_11_tunnel3_int");
	Global_31[36] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(829.752f, -1718.51f, 20.4594f, "id1_11_tunnel2_int");
	Global_31[37] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(829.845f, -1718.51f, 20.1823f, "id1_11_tunnel1_int");
	Global_31[38] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(274.441f, -636.403f, 29.0854f, "dt1_rd1_tun3");
	Global_31[39] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(142.198f, -581.121f, 31.2974f, "dt1_rd1_tun2");
	Global_31[40] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(204.925f, -601.567f, 29.3757f, "dt1_rd1_tun");
	Global_31[41] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(2571.05f, 3907.95f, 41.1896f, "cs4_rwayb_tunnelint");
	Global_31[42] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(-493.613f, 4275.55f, 89.1677f, "cs3_03railtunnel_int4");
	Global_31[43] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(-476.018f, 4201.55f, 87.9392f, "cs3_03railtunnel_int3");
	Global_31[44] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(-457.748f, 4125.51f, 86.1208f, "cs3_03railtunnel_int2");
	Global_31[45] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(-442.948f, 4064.86f, 84.1041f, "cs3_03railtunnel_int1");
	Global_31[46] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(2159.62f, 5995.87f, 51.2999f, "cs2_roadsb_tunnel_03");
	Global_31[47] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(2250.3f, 5915.56f, 49.6273f, "cs2_roadsb_tunnel_02");
	Global_31[48] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(2341.18f, 5814.9f, 46.7075f, "cs2_roadsb_tunnel_01");
	Global_31[49] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(-537.422f, 4613.09f, 89.7512f, "cs1_14brailway6");
	Global_31[50] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(-540.452f, 4719.74f, 89.7576f, "cs1_14brailway5");
	Global_31[51] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(-543.783f, 4821.95f, 89.7357f, "cs1_14brailway4");
	Global_31[52] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(-546.036f, 4923.02f, 89.8919f, "cs1_14brailway3");
	Global_31[53] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(-546.265f, 4999.07f, 90.8104f, "cs1_14brailway2");
	Global_31[54] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(-539.261f, 5077.03f, 91.6235f, "cs1_14brailway1");
	Global_31[55] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(-183.656f, 4664.52f, 130.5f, "cs1_12_tunnel03_int");
	Global_31[56] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(-273.86f, 4752.12f, 138.21f, "cs1_12_tunnel02_int");
	Global_31[57] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(-410.302f, 4860.98f, 144.864f, "cs1_12_tunnel01_int");
	Global_31[58] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(-2596.83f, 3088.87f, 15.4225f, "ch1_roadsdint_tun2");
	Global_31[59] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(-2583.04f, 3268.07f, 13.3157f, "ch1_roadsdint_tun1");
	Global_31[60] = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(-179.51f, -180.189f, 43.6251f, "bt1_04_carpark");
	return;
}

void func_2() // Position - 0xA26 Hash - 0x420ADB03 ^0x420ADB03
{
	Global_153242 = 1;
	Global_153243 = 1;
	return;
...
void func_3(ePedComponentType epctParam0, int iParam1) // Position - 0xA38 Hash - 0xFEE02C7D ^0xFEE02C7D
{
...
void func_4(ePedComponentType epctParam0, int iParam1) // Position - 0xA70 Hash - 0x526F6AF1 ^0x4C2A10FA
{
	var arrayName;

	TEXT_LABEL_ASSIGN_STRING(&arrayName, "g_SaveData_DATE_ScriptSaves", 32);
	TEXT_LABEL_APPEND_INT(&arrayName, iParam1, 32);
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(epctParam0->f_5542.f_19), 8, &arrayName);
	MISC::START_SAVE_STRUCT_WITH_SIZE(&epctParam0->f_5542.f_19[0 /*7*/], 7, "TEMPSTAT_DATE");
	MISC::REGISTER_INT_TO_SAVE(&epctParam0->f_5542.f_19[0 /*7*/], "TEMPSTAT_DATE.year");
	MISC::REGISTER_INT_TO_SAVE(&(epctParam0->f_5542.f_19[0 /*7*/].f_1), "TEMPSTAT_DATE.month");
	MISC::REGISTER_INT_TO_SAVE(&(epctParam0->f_5542.f_19[0 /*7*/].f_2), "TEMPSTAT_DATE.day");
	MISC::REGISTER_INT_TO_SAVE(&(epctParam0->f_5542.f_19[0 /*7*/].f_3), "TEMPSTAT_DATE.hour");
	MISC::REGISTER_INT_TO_SAVE(&(epctParam0->f_5542.f_19[0 /*7*/].f_4), "TEMPSTAT_DATE.minute");
	MISC::REGISTER_INT_TO_SAVE(&(epctParam0->f_5542.f_19[0 /*7*/].f_5), "TEMPSTAT_DATE.seconds");
	MISC::REGISTER_INT_TO_SAVE(&(epctParam0->f_5542.f_19[0 /*7*/].f_6), "TEMPSTAT_DATE.Milliseconds");
	MISC::STOP_SAVE_STRUCT();
	MISC::STOP_SAVE_ARRAY();
	return;
}

void func_5(ePedComponentType epctParam0, int iParam1) // Position - 0xB3A Hash - 0xCD0A2AD8 ^0x412E2A43
{
	var arrayName;

	TEXT_LABEL_ASSIGN_STRING(&arrayName, "g_SaveData_VECTOR_ScriptSaves", 32);
	TEXT_LABEL_APPEND_INT(&arrayName, iParam1, 32);
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(epctParam0->f_5542.f_15), 4, &arrayName);
	MISC::START_SAVE_STRUCT_WITH_SIZE(&epctParam0->f_5542.f_15[0 /*3*/], 3, "TEMPSTAT_VEC");
	MISC::REGISTER_FLOAT_TO_SAVE(&epctParam0->f_5542.f_15[0 /*3*/], "TEMPSTAT_VEC.x");
	MISC::REGISTER_FLOAT_TO_SAVE(&(epctParam0->f_5542.f_15[0 /*3*/].f_1), "TEMPSTAT_VEC.y");
	MISC::REGISTER_FLOAT_TO_SAVE(&(epctParam0->f_5542.f_15[0 /*3*/].f_2), "TEMPSTAT_VEC.z");
	MISC::STOP_SAVE_STRUCT();
	MISC::STOP_SAVE_ARRAY();
	return;
}

void func_6(ePedComponentType epctParam0, int iParam1) // Position - 0xBB3 Hash - 0x829A3A38 ^0xE7F77932
{
	var arrayName;

	TEXT_LABEL_ASSIGN_STRING(&arrayName, "g_SaveData_STRING_ScriptSaves", 32);
	TEXT_LABEL_APPEND_INT(&arrayName, iParam1, 32);
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(epctParam0->f_5542.f_6), 9, &arrayName);
	MISC::REGISTER_TEXT_LABEL_31_TO_SAVE(&epctParam0->f_5542.f_6[0 /*8*/], "TEMPSTAT_LABEL");
	MISC::STOP_SAVE_ARRAY();
	return;
}

void func_7(ePedComponentType epctParam0, int iParam1) // Position - 0xBEE Hash - 0xE0AF8A ^0x5AF7E2C9
{
	var arrayName;

	TEXT_LABEL_ASSIGN_STRING(&arrayName, "g_SaveData_BOOL_ScriptSaves", 32);
	TEXT_LABEL_APPEND_INT(&arrayName, iParam1, 32);
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(epctParam0->f_5542.f_4), 2, &arrayName);
	MISC::REGISTER_BOOL_TO_SAVE(&epctParam0->f_5542.f_4[0], "TEMPSTAT_BOOL");
	MISC::STOP_SAVE_ARRAY();
	return;
}

void func_8(ePedComponentType epctParam0, int iParam1) // Position - 0xC28 Hash - 0xE0AF8A ^0xD464F4AD
{
	var arrayName;

	TEXT_LABEL_ASSIGN_STRING(&arrayName, "g_SaveData_FLOAT_ScriptSaves", 32);
	TEXT_LABEL_APPEND_INT(&arrayName, iParam1, 32);
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(epctParam0->f_5542.f_2), 2, &arrayName);
	MISC::REGISTER_FLOAT_TO_SAVE(&epctParam0->f_5542.f_2[0], "TEMPSTAT_FLOAT");
	MISC::STOP_SAVE_ARRAY();
	return;
}

void func_9(ePedComponentType epctParam0, int iParam1) // Position - 0xC62 Hash - 0x3411E5F0 ^0x9D0C5085
{
	var arrayName;

	TEXT_LABEL_ASSIGN_STRING(&arrayName, "g_SaveData_INT_ScriptSaves", 32);
	TEXT_LABEL_APPEND_INT(&arrayName, iParam1, 32);
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(epctParam0->f_5542), 2, &arrayName);
	MISC::REGISTER_INT_TO_SAVE(&epctParam0->f_5542[0], "TEMPSTAT_INT1");
	MISC::STOP_SAVE_ARRAY();
	return;
}

void func_10(ePedComponentType epctParam0, int iParam1) // Position - 0xC98 Hash - 0x598CB8C9 ^0x387C6996
{
	var structName;
	int i;
	var arrayName;
	...
	MISC::START_SAVE_STRUCT_WITH_SIZE(&(epctParam0->f_5392), 150, &structName);
	MISC::REGISTER_INT_TO_SAVE(&(epctParam0->f_5392), "MPATM_CARET_");
	i = 0;
	TEXT_LABEL_ASSIGN_STRING(&arrayName, "MPATMLOGVAL", 16);
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(epctParam0->f_5392.f_1), 17, &arrayName);

	for (i = 0; i < 16; i = i + 1)
	{
		name = { arrayName };
		TEXT_LABEL_APPEND_INT(&name, i, 16);
		MISC::REGISTER_INT_TO_SAVE(&epctParam0->f_5392.f_1[i], &name);
	}

	MISC::STOP_SAVE_ARRAY();
	TEXT_LABEL_ASSIGN_STRING(&arrayName, "MPATMLOGSCRS", 16);
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(epctParam0->f_5392.f_18), 97, &arrayName);

	for (i = 0; i < 16; i = i + 1)
	{
		name2 = { arrayName };
		TEXT_LABEL_APPEND_INT(&name2, i, 16);
		MISC::REGISTER_TEXT_LABEL_23_TO_SAVE(&epctParam0->f_5392.f_18[i /*6*/], &name2);
	}

	MISC::STOP_SAVE_ARRAY();
	TEXT_LABEL_ASSIGN_STRING(&arrayName, "MPATMLOGACT", 16);
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(epctParam0->f_5392.f_115), 17, &arrayName);

	for (i = 0; i < 16; i = i + 1)
	{
		name3 = { arrayName };
		TEXT_LABEL_APPEND_INT(&name3, i, 16);
		MISC::REGISTER_ENUM_TO_SAVE(&epctParam0->f_5392.f_115[i], &name3);
	}

	MISC::STOP_SAVE_ARRAY();
	TEXT_LABEL_ASSIGN_STRING(&arrayName, "MPATMLOGDAT", 16);
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(epctParam0->f_5392.f_132), 17, &arrayName);

	for (i = 0; i < 16; i = i + 1)
	{
		name4 = { arrayName };
		TEXT_LABEL_APPEND_INT(&name4, i, 16);
		MISC::REGISTER_INT_TO_SAVE(&epctParam0->f_5392.f_132[i], &name4);
	}

	MISC::STOP_SAVE_ARRAY();
	MISC::REGISTER_BOOL_TO_SAVE(&(epctParam0->f_5392.f_149), "mpAnyVecBought");
	MISC::STOP_SAVE_STRUCT();
	return;
}

void func_11(ePedComponentType epctParam0, int iParam1) // Position - 0xE12 Hash - 0xFA873DA ^0x58C40FA4
{
	var structName;
	var name;
	int i;
	...
	TEXT_LABEL_APPEND_INT(&structName, iParam1, 24);
	MISC::START_SAVE_STRUCT_WITH_SIZE(&(epctParam0->f_5151), 241, &structName);
	MISC::REGISTER_INT64_TO_SAVE(&(epctParam0->f_5151), "BOUNTY_GAMERH64_1");
	MISC::REGISTER_INT64_TO_SAVE(&(epctParam0->f_5151.f_1), "BOUNTY_GAMERH64_2");
	MISC::REGISTER_INT64_TO_SAVE(&(epctParam0->f_5151.f_2), "BOUNTY_GAMERH64_3");
	MISC::REGISTER_INT64_TO_SAVE(&(epctParam0->f_5151.f_3), "BOUNTY_GAMERH64_4");
	MISC::REGISTER_INT64_TO_SAVE(&(epctParam0->f_5151.f_4), "BOUNTY_GAMERH64_5");
	MISC::REGISTER_INT64_TO_SAVE(&(epctParam0->f_5151.f_5), "BOUNTY_GAMERH64_6");
	MISC::REGISTER_INT64_TO_SAVE(&(epctParam0->f_5151.f_6), "BOUNTY_GAMERH64_7");
	MISC::REGISTER_INT64_TO_SAVE(&(epctParam0->f_5151.f_7), "BOUNTY_GAMERH64_8");
	MISC::REGISTER_INT64_TO_SAVE(&(epctParam0->f_5151.f_8), "BOUNTY_GAMERH64_9");
	MISC::REGISTER_INT64_TO_SAVE(&(epctParam0->f_5151.f_9), "BOUNTY_GAMERH64_10");
	MISC::REGISTER_INT64_TO_SAVE(&(epctParam0->f_5151.f_10), "BOUNTY_GAMERH64_11");
	MISC::REGISTER_INT64_TO_SAVE(&(epctParam0->f_5151.f_11), "BOUNTY_GAMERH64_12");
	MISC::REGISTER_INT64_TO_SAVE(&(epctParam0->f_5151.f_12), "BOUNTY_GAMERH64_13");
	MISC::REGISTER_INT_TO_SAVE(&(epctParam0->f_5151.f_13), "BOUNTY_TIME");
	MISC::REGISTER_INT_TO_SAVE(&(epctParam0->f_5151.f_14), "BOUNTY_VALUE");
	TEXT_LABEL_APPEND_STRING(&structName, "_GH", 24);
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(epctParam0->f_5151.f_15), 209, &structName);
	...
	for (i = 0; i < 16; i = i + 1)
	{
		...
		MISC::REGISTER_INT64_TO_SAVE(&epctParam0->f_5151.f_15[i /*13*/], &name);
		TEXT_LABEL_COPY(&name, { structName }, 8);
		TEXT_LABEL_APPEND_STRING(&name, "64_", 32);
		TEXT_LABEL_APPEND_INT(&name, i, 32);
		TEXT_LABEL_APPEND_STRING(&name, "_2", 32);
		MISC::REGISTER_INT64_TO_SAVE(&(epctParam0->f_5151.f_15[i /*13*/].f_1), &name);
		TEXT_LABEL_COPY(&name, { structName }, 8);
		TEXT_LABEL_APPEND_STRING(&name, "64_", 32);
		TEXT_LABEL_APPEND_INT(&name, i, 32);
		TEXT_LABEL_APPEND_STRING(&name, "_3", 32);
		MISC::REGISTER_INT64_TO_SAVE(&(epctParam0->f_5151.f_15[i /*13*/].f_2), &name);
		TEXT_LABEL_COPY(&name, { structName }, 8);
		TEXT_LABEL_APPEND_STRING(&name, "64_", 32);
		TEXT_LABEL_APPEND_INT(&name, i, 32);
		TEXT_LABEL_APPEND_STRING(&name, "_4", 32);
		MISC::REGISTER_INT64_TO_SAVE(&(epctParam0->f_5151.f_15[i /*13*/].f_3), &name);
		TEXT_LABEL_COPY(&name, { structName }, 8);
		TEXT_LABEL_APPEND_STRING(&name, "64_", 32);
		TEXT_LABEL_APPEND_INT(&name, i, 32);
		TEXT_LABEL_APPEND_STRING(&name, "_5", 32);
		MISC::REGISTER_INT64_TO_SAVE(&(epctParam0->f_5151.f_15[i /*13*/].f_4), &name);
		TEXT_LABEL_COPY(&name, { structName }, 8);
		TEXT_LABEL_APPEND_STRING(&name, "64_", 32);
		TEXT_LABEL_APPEND_INT(&name, i, 32);
		TEXT_LABEL_APPEND_STRING(&name, "_6", 32);
		MISC::REGISTER_INT64_TO_SAVE(&(epctParam0->f_5151.f_15[i /*13*/].f_5), &name);
		TEXT_LABEL_COPY(&name, { structName }, 8);
		TEXT_LABEL_APPEND_STRING(&name, "64_", 32);
		TEXT_LABEL_APPEND_INT(&name, i, 32);
		TEXT_LABEL_APPEND_STRING(&name, "_7", 32);
		MISC::REGISTER_INT64_TO_SAVE(&(epctParam0->f_5151.f_15[i /*13*/].f_6), &name);
		TEXT_LABEL_COPY(&name, { structName }, 8);
		TEXT_LABEL_APPEND_STRING(&name, "64_", 32);
		TEXT_LABEL_APPEND_INT(&name, i, 32);
		TEXT_LABEL_APPEND_STRING(&name, "_8", 32);
		MISC::REGISTER_INT64_TO_SAVE(&(epctParam0->f_5151.f_15[i /*13*/].f_7), &name);
		TEXT_LABEL_COPY(&name, { structName }, 8);
		TEXT_LABEL_APPEND_STRING(&name, "64_", 32);
		TEXT_LABEL_APPEND_INT(&name, i, 32);
		TEXT_LABEL_APPEND_STRING(&name, "_9", 32);
		MISC::REGISTER_INT64_TO_SAVE(&(epctParam0->f_5151.f_15[i /*13*/].f_8), &name);
		TEXT_LABEL_COPY(&name, { structName }, 8);
		TEXT_LABEL_APPEND_STRING(&name, "64_", 32);
		TEXT_LABEL_APPEND_INT(&name, i, 32);
		TEXT_LABEL_APPEND_STRING(&name, "_10", 32);
		MISC::REGISTER_INT64_TO_SAVE(&(epctParam0->f_5151.f_15[i /*13*/].f_9), &name);
		TEXT_LABEL_COPY(&name, { structName }, 8);
		TEXT_LABEL_APPEND_STRING(&name, "64_", 32);
		TEXT_LABEL_APPEND_INT(&name, i, 32);
		TEXT_LABEL_APPEND_STRING(&name, "_11", 32);
		MISC::REGISTER_INT64_TO_SAVE(&(epctParam0->f_5151.f_15[i /*13*/].f_10), &name);
		TEXT_LABEL_COPY(&name, { structName }, 8);
		TEXT_LABEL_APPEND_STRING(&name, "64_", 32);
		TEXT_LABEL_APPEND_INT(&name, i, 32);
		TEXT_LABEL_APPEND_STRING(&name, "_12", 32);
		MISC::REGISTER_INT64_TO_SAVE(&(epctParam0->f_5151.f_15[i /*13*/].f_11), &name);
		TEXT_LABEL_COPY(&name, { structName }, 8);
		TEXT_LABEL_APPEND_STRING(&name, "64_", 32);
		TEXT_LABEL_APPEND_INT(&name, i, 32);
		TEXT_LABEL_APPEND_STRING(&name, "_13", 32);
		MISC::REGISTER_INT64_TO_SAVE(&(epctParam0->f_5151.f_15[i /*13*/].f_12), &name);
	}
	...
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(epctParam0->f_5151.f_224), 17, &structName);

	for (i = 0; i < 16; i = i + 1)
	{
		TEXT_LABEL_COPY(&name, { structName }, 8);
		TEXT_LABEL_APPEND_INT(&name, i, 32);
		MISC::REGISTER_INT_TO_SAVE(&epctParam0->f_5151.f_224[i], &name);
	}
...
void func_12(ePedComponentType epctParam0, int iParam1) // Position - 0x1238 Hash - 0x3FAF8E18 ^0x28DE4079
{
	var unk;
...
void func_13(Any* panParam0, const char* sParam1) // Position - 0x1259 Hash - 0x97C45A38 ^0x4EEB1FCE
{
	int i;
	var name;
	int j;
	...
	MISC::START_SAVE_STRUCT_WITH_SIZE(panParam0, 4470, sParam1);
	...
	MISC::REGISTER_INT_TO_SAVE(&(panParam0->f_1335), "LAST_ACC_SMPLINT");
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(panParam0->f_1305), 30, "PROP_ARY_VAL");
	...
	MISC::STOP_SAVE_ARRAY();
	MISC::REGISTER_INT_TO_SAVE(&(panParam0->f_1336), "KR_PATCH_UPDATE");
	k = 0;
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(panParam0->f_2692), 919, "DLC_MODS");

	for (k = 0; k < panParam0->f_2692; k = k + 1)
	{
		TEXT_LABEL_ASSIGN_STRING(&name, "DLC_MODS_", 16);
		TEXT_LABEL_APPEND_INT(&name, k, 16);
		MISC::REGISTER_INT_TO_SAVE(&panParam0->f_2692[k], &name);
	}

	MISC::STOP_SAVE_ARRAY();
	k = 0;
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(panParam0->f_3611), 627, "DLC_SUPERMODS");

	for (k = 0; k < panParam0->f_3611; k = k + 1)
	{
		TEXT_LABEL_ASSIGN_STRING(&name, "DLC_SMODS_", 16);
		TEXT_LABEL_APPEND_INT(&name, k, 16);
		MISC::REGISTER_INT_TO_SAVE(&panParam0->f_3611[k], &name);
	}

	MISC::STOP_SAVE_ARRAY();
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(panParam0->f_1337), 274, "OUTFIT_CompDraw");
	...
	for (k = 0; k < 21; k = k + 1)
	{
		...
		TEXT_LABEL_APPEND_INT(&name, k, 16);
		MISC::START_SAVE_ARRAY_WITH_SIZE(&panParam0->f_1337[k /*13*/], 13, &name);
		...
		for (l = 0; l < 12; l = l + 1)
		{
			...
			MISC::REGISTER_INT_TO_SAVE(&panParam0->f_1337[k /*13*/][l], &name);
		}
	...
	MISC::STOP_SAVE_ARRAY();
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(panParam0->f_1611), 274, "OUTFIT_CompTex");
	...
	for (k = 0; k < 21; k = k + 1)
	{
		...
		TEXT_LABEL_APPEND_STRING(&name, "_", 16);
		TEXT_LABEL_APPEND_INT(&name, k, 16);
		MISC::START_SAVE_ARRAY_WITH_SIZE(&panParam0->f_1611[k /*13*/], 13, &name);
		...
		for (l = 0; l < 12; l = l + 1)
		{
			...
			TEXT_LABEL_APPEND_STRING(&name, "_", 16);
			TEXT_LABEL_APPEND_INT(&name, l, 16);
			MISC::REGISTER_INT_TO_SAVE(&panParam0->f_1611[k /*13*/][l], &name);
		}
	...
	MISC::STOP_SAVE_ARRAY();
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(panParam0->f_1885), 211, "OUTFIT_PropID");
	...
	for (k = 0; k < 21; k = k + 1)
	{
		...
		TEXT_LABEL_APPEND_STRING(&name, "_", 16);
		TEXT_LABEL_APPEND_INT(&name, k, 16);
		MISC::START_SAVE_ARRAY_WITH_SIZE(&panParam0->f_1885[k /*10*/], 10, &name);
		...
		for (l = 0; l < 9; l = l + 1)
		{
			...
			TEXT_LABEL_APPEND_STRING(&name, "_", 16);
			TEXT_LABEL_APPEND_INT(&name, l, 16);
			MISC::REGISTER_INT_TO_SAVE(&panParam0->f_1885[k /*10*/][l], &name);
		}
	...
	MISC::STOP_SAVE_ARRAY();
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(panParam0->f_2096), 211, "OUTFIT_PropTex");
	...
	for (k = 0; k < 21; k = k + 1)
	{
		...
		TEXT_LABEL_APPEND_STRING(&name, "_", 16);
		TEXT_LABEL_APPEND_INT(&name, k, 16);
		MISC::START_SAVE_ARRAY_WITH_SIZE(&panParam0->f_2096[k /*10*/], 10, &name);
		...
		for (l = 0; l < 9; l = l + 1)
		{
			...
			TEXT_LABEL_APPEND_STRING(&name, "_", 16);
			TEXT_LABEL_APPEND_INT(&name, l, 16);
			MISC::REGISTER_INT_TO_SAVE(&panParam0->f_2096[k /*10*/][l], &name);
		}
	...
	MISC::STOP_SAVE_ARRAY();
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(panParam0->f_2307), 22, "OUTFIT_Stored");
	...
	for (k = 0; k < 21; k = k + 1)
	{
		...
		TEXT_LABEL_APPEND_STRING(&name, "_", 16);
		TEXT_LABEL_APPEND_INT(&name, k, 16);
		MISC::REGISTER_BOOL_TO_SAVE(&panParam0->f_2307[k], &name);
	}

	MISC::STOP_SAVE_ARRAY();
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(panParam0->f_2329), 22, "OUTFIT_CrewTatA");
	...
	for (k = 0; k < 21; k = k + 1)
	{
		...
		TEXT_LABEL_APPEND_STRING(&name, "_", 16);
		TEXT_LABEL_APPEND_INT(&name, k, 16);
		MISC::REGISTER_BOOL_TO_SAVE(&panParam0->f_2329[k], &name);
	}

	MISC::STOP_SAVE_ARRAY();
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(panParam0->f_2351), 22, "OUTFIT_CrewTatB");
	...
	for (k = 0; k < 21; k = k + 1)
	{
		...
		TEXT_LABEL_APPEND_STRING(&name, "_", 16);
		TEXT_LABEL_APPEND_INT(&name, k, 16);
		MISC::REGISTER_BOOL_TO_SAVE(&panParam0->f_2351[k], &name);
	}

	MISC::STOP_SAVE_ARRAY();
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(panParam0->f_2373), 22, "OUTFIT_CrewTatC");
	...
	for (k = 0; k < 21; k = k + 1)
	{
		...
		TEXT_LABEL_APPEND_STRING(&name, "_", 16);
		TEXT_LABEL_APPEND_INT(&name, k, 16);
		MISC::REGISTER_BOOL_TO_SAVE(&panParam0->f_2373[k], &name);
	}

	MISC::STOP_SAVE_ARRAY();
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(panParam0->f_2395), 22, "OUTFIT_CrewTatD");
	...
	for (k = 0; k < 21; k = k + 1)
	{
		...
		TEXT_LABEL_APPEND_STRING(&name, "_", 16);
		TEXT_LABEL_APPEND_INT(&name, k, 16);
		MISC::REGISTER_BOOL_TO_SAVE(&panParam0->f_2395[k], &name);
	}

	MISC::STOP_SAVE_ARRAY();
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(panParam0->f_2417), 22, "OUTFIT_CrewTatE");
	...
	for (k = 0; k < 21; k = k + 1)
	{
		...
		TEXT_LABEL_APPEND_STRING(&name, "_", 16);
		TEXT_LABEL_APPEND_INT(&name, k, 16);
		MISC::REGISTER_BOOL_TO_SAVE(&panParam0->f_2417[k], &name);
	}

	MISC::STOP_SAVE_ARRAY();
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(panParam0->f_2439), 22, "OUTFIT_CrewTatF");
	...
	for (k = 0; k < 21; k = k + 1)
	{
		...
		TEXT_LABEL_APPEND_STRING(&name, "_", 16);
		TEXT_LABEL_APPEND_INT(&name, k, 16);
		MISC::REGISTER_BOOL_TO_SAVE(&panParam0->f_2439[k], &name);
	}

	MISC::STOP_SAVE_ARRAY();
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(panParam0->f_2630), 22, "OUTFIT_Shirt");
	...
	for (k = 0; k < 21; k = k + 1)
	{
		...
		TEXT_LABEL_APPEND_STRING(&name, "_", 16);
		TEXT_LABEL_APPEND_INT(&name, k, 16);
		MISC::REGISTER_INT_TO_SAVE(&panParam0->f_2630[k], &name);
	}

	MISC::STOP_SAVE_ARRAY();
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(panParam0->f_2461), 169, "OUTFIT_Name");
	...
	for (k = 0; k < 21; k = k + 1)
	{
		...
		TEXT_LABEL_APPEND_STRING(&name, "_", 16);
		TEXT_LABEL_APPEND_INT(&name, k, 16);
		MISC::REGISTER_TEXT_LABEL_31_TO_SAVE(&panParam0->f_2461[k /*8*/], &name);
	}

	MISC::STOP_SAVE_ARRAY();
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(panParam0->f_2652), 40, "LAST_JobGamer");
	...
	for (k = 0; k < 3; k = k + 1)
	{
		...
		MISC::REGISTER_INT64_TO_SAVE(&panParam0->f_2652[k /*13*/], &name3);
		name3 = { name };
		TEXT_LABEL_APPEND_STRING(&name3, "_2", 16);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_2652[k /*13*/].f_1), &name3);
		name3 = { name };
		TEXT_LABEL_APPEND_STRING(&name3, "_3", 16);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_2652[k /*13*/].f_2), &name3);
		name3 = { name };
		TEXT_LABEL_APPEND_STRING(&name3, "_4", 16);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_2652[k /*13*/].f_3), &name3);
		name3 = { name };
		TEXT_LABEL_APPEND_STRING(&name3, "_5", 16);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_2652[k /*13*/].f_4), &name3);
		name3 = { name };
		TEXT_LABEL_APPEND_STRING(&name3, "_6", 16);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_2652[k /*13*/].f_5), &name3);
		name3 = { name };
		TEXT_LABEL_APPEND_STRING(&name3, "_7", 16);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_2652[k /*13*/].f_6), &name3);
		name3 = { name };
		TEXT_LABEL_APPEND_STRING(&name3, "_8", 16);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_2652[k /*13*/].f_7), &name3);
		name3 = { name };
		TEXT_LABEL_APPEND_STRING(&name3, "_9", 16);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_2652[k /*13*/].f_8), &name3);
		name3 = { name };
		TEXT_LABEL_APPEND_STRING(&name3, "_10", 16);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_2652[k /*13*/].f_9), &name3);
		name3 = { name };
		TEXT_LABEL_APPEND_STRING(&name3, "_11", 16);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_2652[k /*13*/].f_10), &name3);
		name3 = { name };
		TEXT_LABEL_APPEND_STRING(&name3, "_12", 16);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_2652[k /*13*/].f_11), &name3);
		name3 = { name };
		TEXT_LABEL_APPEND_STRING(&name3, "_13", 16);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_2652[k /*13*/].f_12), &name3);
	}

	MISC::STOP_SAVE_ARRAY();
	MISC::REGISTER_BOOL_TO_SAVE(&(panParam0->f_4238), "DO_CompletedObjectives");
	MISC::REGISTER_BOOL_TO_SAVE(&(panParam0->f_4239), "DO_LoggedInToday");
	MISC::REGISTER_INT_TO_SAVE(&(panParam0->f_4240), "DO_xValue");
	MISC::REGISTER_INT_TO_SAVE(&(panParam0->f_4241), "DO_LastHistoryLength");
	MISC::REGISTER_INT_TO_SAVE(&(panParam0->f_4242), "DO_LastResetTime");
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(panParam0->f_4243), 10, "DO_Objectives");
	...
	for (k = 0; k < 3; k = k + 1)
	{
		...
		TEXT_LABEL_APPEND_STRING(&name, "_", 16);
		TEXT_LABEL_APPEND_INT(&name, k, 16);
		MISC::REGISTER_INT_TO_SAVE(&panParam0->f_4243[k /*3*/], &name);
		TEXT_LABEL_ASSIGN_STRING(&name, "Completed", 16);
		TEXT_LABEL_APPEND_STRING(&name, "_", 16);
		TEXT_LABEL_APPEND_INT(&name, k, 16);
		MISC::REGISTER_BOOL_TO_SAVE(&(panParam0->f_4243[k /*3*/].f_1), &name);
		TEXT_LABEL_ASSIGN_STRING(&name, "Initial", 16);
		TEXT_LABEL_APPEND_STRING(&name, "_", 16);
		TEXT_LABEL_APPEND_INT(&name, k, 16);
		MISC::REGISTER_INT_TO_SAVE(&(panParam0->f_4243[k /*3*/].f_2), &name);
	}

	MISC::STOP_SAVE_ARRAY();
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(panParam0->f_4253), 25, "DO_History");
	...
	for (k = 0; k < 24; k = k + 1)
	{
		...
		TEXT_LABEL_APPEND_STRING(&name, "_", 16);
		TEXT_LABEL_APPEND_INT(&name, k, 16);
		MISC::REGISTER_INT_TO_SAVE(&panParam0->f_4253[k], &name);
	}

	MISC::STOP_SAVE_ARRAY();
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(panParam0->f_4278), 49, "LAST_JobGamer_TL");
	...
	for (k = 0; k < 3; k = k + 1)
	{
		...
		MISC::REGISTER_TEXT_LABEL_63_TO_SAVE(&panParam0->f_4278[k /*16*/], &name4);
	}

	MISC::STOP_SAVE_ARRAY();
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(panParam0->f_4327), 11, "BGSAVEINT");

	for (i = 0; i < 10; i = i + 1)
	{
		TEXT_LABEL_ASSIGN_STRING(&name, "BGSAVEINT", 16);
		TEXT_LABEL_APPEND_INT(&name, i, 16);
		MISC::REGISTER_INT_TO_SAVE(&panParam0->f_4327[i], &name);
	}

	MISC::STOP_SAVE_ARRAY();
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(panParam0->f_4338), 3, "PROPLIB");

	for (i = 0; i < panParam0->f_4338; i = i + 1)
	{
		TEXT_LABEL_ASSIGN_STRING(&name, "PROPLIB", 16);
		TEXT_LABEL_APPEND_INT(&name, i, 16);
		MISC::REGISTER_INT_TO_SAVE(&panParam0->f_4338[i], &name);
	}

	MISC::STOP_SAVE_ARRAY();
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(panParam0->f_4341), 40, "LAST_GOGamer");
	...
	for (k = 0; k < 3; k = k + 1)
	{
		...
		MISC::REGISTER_INT64_TO_SAVE(&panParam0->f_4341[k /*13*/], &name5);
		name5 = { name };
		TEXT_LABEL_APPEND_STRING(&name5, "_2", 16);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_4341[k /*13*/].f_1), &name5);
		name5 = { name };
		TEXT_LABEL_APPEND_STRING(&name5, "_3", 16);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_4341[k /*13*/].f_2), &name5);
		name5 = { name };
		TEXT_LABEL_APPEND_STRING(&name5, "_4", 16);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_4341[k /*13*/].f_3), &name5);
		name5 = { name };
		TEXT_LABEL_APPEND_STRING(&name5, "_5", 16);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_4341[k /*13*/].f_4), &name5);
		name5 = { name };
		TEXT_LABEL_APPEND_STRING(&name5, "_6", 16);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_4341[k /*13*/].f_5), &name5);
		name5 = { name };
		TEXT_LABEL_APPEND_STRING(&name5, "_7", 16);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_4341[k /*13*/].f_6), &name5);
		name5 = { name };
		TEXT_LABEL_APPEND_STRING(&name5, "_8", 16);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_4341[k /*13*/].f_7), &name5);
		name5 = { name };
		TEXT_LABEL_APPEND_STRING(&name5, "_9", 16);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_4341[k /*13*/].f_8), &name5);
		name5 = { name };
		TEXT_LABEL_APPEND_STRING(&name5, "_10", 16);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_4341[k /*13*/].f_9), &name5);
		name5 = { name };
		TEXT_LABEL_APPEND_STRING(&name5, "_11", 16);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_4341[k /*13*/].f_10), &name5);
		name5 = { name };
		TEXT_LABEL_APPEND_STRING(&name5, "_12", 16);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_4341[k /*13*/].f_11), &name5);
		name5 = { name };
		TEXT_LABEL_APPEND_STRING(&name5, "_13", 16);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_4341[k /*13*/].f_12), &name5);
	}

	MISC::STOP_SAVE_ARRAY();
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(panParam0->f_4381), 40, "LAST_GOJobGamer");
	...
	for (k = 0; k < 3; k = k + 1)
	{
		...
		MISC::REGISTER_INT64_TO_SAVE(&panParam0->f_4381[k /*13*/], &name6);
		name6 = { name };
		TEXT_LABEL_APPEND_STRING(&name6, "_2", 16);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_4381[k /*13*/].f_1), &name6);
		name6 = { name };
		TEXT_LABEL_APPEND_STRING(&name6, "_3", 16);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_4381[k /*13*/].f_2), &name6);
		name6 = { name };
		TEXT_LABEL_APPEND_STRING(&name6, "_4", 16);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_4381[k /*13*/].f_3), &name6);
		name6 = { name };
		TEXT_LABEL_APPEND_STRING(&name6, "_5", 16);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_4381[k /*13*/].f_4), &name6);
		name6 = { name };
		TEXT_LABEL_APPEND_STRING(&name6, "_6", 16);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_4381[k /*13*/].f_5), &name6);
		name6 = { name };
		TEXT_LABEL_APPEND_STRING(&name6, "_7", 16);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_4381[k /*13*/].f_6), &name6);
		name6 = { name };
		TEXT_LABEL_APPEND_STRING(&name6, "_8", 16);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_4381[k /*13*/].f_7), &name6);
		name6 = { name };
		TEXT_LABEL_APPEND_STRING(&name6, "_9", 16);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_4381[k /*13*/].f_8), &name6);
		name6 = { name };
		TEXT_LABEL_APPEND_STRING(&name6, "_10", 16);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_4381[k /*13*/].f_9), &name6);
		name6 = { name };
		TEXT_LABEL_APPEND_STRING(&name6, "_11", 16);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_4381[k /*13*/].f_10), &name6);
		name6 = { name };
		TEXT_LABEL_APPEND_STRING(&name6, "_12", 16);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_4381[k /*13*/].f_11), &name6);
		name6 = { name };
		TEXT_LABEL_APPEND_STRING(&name6, "_13", 16);
		MISC::REGISTER_INT64_TO_SAVE(&(panParam0->f_4381[k /*13*/].f_12), &name6);
	}

	MISC::STOP_SAVE_ARRAY();
	MISC::START_SAVE_ARRAY_WITH_SIZE(&(panParam0->f_4421), 49, "LAST_GOJobGamer_TL");
	...
	for (k = 0; k < 3; k = k + 1)
	{
		...
		MISC::REGISTER_TEXT_LABEL_63_TO_SAVE(&panParam0->f_4421[k /*16*/], &name7);
	}
...
void func_14(ePedComponentType epctParam0, int iParam1) // Position - 0x23F8 Hash - 0xB961644E ^0xB961644E
{
	func_15(&(epctParam0->f_593), iParam1);
	return;
}

void func_15(Any* panParam0, int iParam1) // Position - 0x240B Hash - 0x8E2CD5DC ^0x2ECDE6D4
{
	var name;
	int i;
...
void func_16(Any* panParam0, char* sParam1) // Position - 0x25C4 Hash - 0x84B347DA ^0x8738141
{
...
void func_17(ePedComponentType epctParam0, int iParam1) // Position - 0x277C Hash - 0xDF7B42CB ^0x364BFDD7
{
	var unk;
...
void func_18(Any* panParam0, const char* sParam1) // Position - 0x279C Hash - 0x97C45A38 ^0xD091E4CA
{
	int i;
	var name;
...
void func_19(ePedComponentType epctParam0, int iParam1) // Position - 0x2B2C Hash - 0xD8FBF65D ^0x32B14A46
{
	var unk;
...
void func_20(ePedComponentType epctParam0, const char* sParam1) // Position - 0x2B4A Hash - 0x1B760539 ^0x39287F50
{
	int i;
	var name;
...
void func_21(float fParam0) // Position - 0x2BA8 Hash - 0xC1458E09 ^0xC1458E09
{
	func_30();
...
void func_22() // Position - 0x2C0A Hash - 0x2100AD75 ^0x3678395B
{
	Global_114370.f_26437.f_4 = 0;
	return;
}

void func_23() // Position - 0x2C1C Hash - 0x12B91D88 ^0x7553358
{
	int outValue;
	int outValue2;
	int outValue3;
	...
	if (outValue >= 0 && outValue2 >= 0 && outValue3 >= 0)
		Global_114370.f_668.f_1315 = Global_114370.f_668.f_1315 - outValue;

	return;
}

void func_24() // Position - 0x2C7B Hash - 0x750C5FAD ^0x76416C8E
{
	int i;
	int j;
	int num;
	...
	for (i = 0; i < 3; i = i + 1)
	{
		...
		{
			if (IS_BIT_SET(Global_114370.f_25185[j], i))
			{
				MISC::CLEAR_BIT(&Global_114370.f_25185[j], i);
				num = j + (198 - 171) + 1;
				MISC::SET_BIT(&Global_114370.f_25185[num], i);
			}
		}
	}
...
void func_25() // Position - 0x2CE7 Hash - 0x219867CE ^0x74CA5C84
{
	if (func_26(54) || func_26(55) || func_26(56) || func_26(57) || func_26(58))
		MISC::SET_BIT(&(Global_114370.f_10019.f_25), 6);

	return;
}

BOOL func_26(int iParam0) // Position - 0x2D36 Hash - 0x35F9F9C ^0x35F9F9C
{
...
void func_27() // Position - 0x2D62 Hash - 0xF3B2B67E ^0xF3B2B67E
{
	return;
}

void func_28() // Position - 0x2D6A Hash - 0x10E1CFBD ^0xAAD3434B
{
	if (Global_114370.f_9088.f_99.f_205[7] != 0)
		if (!Global_114370.f_9088.f_330[86 /*6*/])
			Global_114370.f_9088.f_330[86 /*6*/] = true;

	if (Global_114370.f_9088.f_99.f_205[8] != 0)
		if (!Global_114370.f_9088.f_330[71 /*6*/])
			Global_114370.f_9088.f_330[71 /*6*/] = true;

	if (Global_114370.f_9088.f_99.f_205[9] != 0)
		if (!Global_114370.f_9088.f_330[91 /*6*/])
			Global_114370.f_9088.f_330[91 /*6*/] = true;

	if (Global_114370.f_9088.f_99.f_205[10] != 0)
		if (!Global_114370.f_9088.f_330[67 /*6*/])
			Global_114370.f_9088.f_330[67 /*6*/] = true;

	if (Global_114370.f_9088.f_99.f_205[11] != 0)
		if (!Global_114370.f_9088.f_330[77 /*6*/])
			Global_114370.f_9088.f_330[77 /*6*/] = true;
...
void func_29(int iParam0, int iParam1) // Position - 0x2E8A Hash - 0xAF69B7CA ^0x2B8275AE
{
	var unk;
	float num;
	BOOL flag;
	...
	unk = { Global_114370.f_10197[iParam0 /*12*/] };
	num = Global_114370.f_10197[iParam0 /*12*/].f_4;
	flag = Global_114370.f_10197[iParam0 /*12*/].f_5;
	num2 = Global_114370.f_10197[iParam0 /*12*/].f_6;
	num3 = Global_114370.f_10197[iParam0 /*12*/].f_7;
	num4 = Global_114370.f_10197[iParam0 /*12*/].f_8;
	unk5 = Global_114370.f_10197[iParam0 /*12*/].f_9;
	num5 = Global_114370.f_10197[iParam0 /*12*/].f_10;
	num6 = Global_114370.f_10197[iParam0 /*12*/].f_11;
	Global_114370.f_10197[iParam0 /*12*/] = { Global_114370.f_10197[iParam1 /*12*/] };
	Global_114370.f_10197[iParam0 /*12*/].f_4 = Global_114370.f_10197[iParam1 /*12*/].f_4;
	Global_114370.f_10197[iParam0 /*12*/].f_5 = Global_114370.f_10197[iParam1 /*12*/].f_5;
	Global_114370.f_10197[iParam0 /*12*/].f_6 = Global_114370.f_10197[iParam1 /*12*/].f_6;
	Global_114370.f_10197[iParam0 /*12*/].f_7 = Global_114370.f_10197[iParam1 /*12*/].f_7;
	Global_114370.f_10197[iParam0 /*12*/].f_8 = Global_114370.f_10197[iParam1 /*12*/].f_8;
	Global_114370.f_10197[iParam0 /*12*/].f_9 = Global_114370.f_10197[iParam1 /*12*/].f_9;
	Global_114370.f_10197[iParam0 /*12*/].f_10 = Global_114370.f_10197[iParam1 /*12*/].f_10;
	Global_114370.f_10197[iParam0 /*12*/].f_11 = Global_114370.f_10197[iParam1 /*12*/].f_11;
	Global_114370.f_10197[iParam1 /*12*/] = { unk };
	Global_114370.f_10197[iParam1 /*12*/].f_4 = num;
	Global_114370.f_10197[iParam1 /*12*/].f_5 = flag;
	Global_114370.f_10197[iParam1 /*12*/].f_6 = num2;
	Global_114370.f_10197[iParam1 /*12*/].f_7 = num3;
	Global_114370.f_10197[iParam1 /*12*/].f_8 = num4;
	Global_114370.f_10197[iParam1 /*12*/].f_9 = unk5;
	Global_114370.f_10197[iParam1 /*12*/].f_10 = num5;
	Global_114370.f_10197[iParam1 /*12*/].f_11 = num6;
	return;
}

void func_30() // Position - 0x308E Hash - 0x8335644F ^0x8335644F
{
	int i;

	for (i = 0; i < 16; i = i + 1)
	{
		if (!func_31(Global_114370.f_24907[i /*4*/]))
			if (Global_114370.f_24907[i /*4*/] != _CHAR_NULL)
				Global_114370.f_24907[i /*4*/] = _CHAR_NULL;
	}
...
void func_33() // Position - 0x3114 Hash - 0xC42731A ^0x8F5ED4CA
{
...
int func_34(var uParam0, int iParam1) // Position - 0x3176 Hash - 0x14ADFCA ^0xFEFB0F83
{
	int i;

	for (i = 0; i < 5; i = i + 1)
	{
		uParam0->f_1742.f_130[i] = 1f;
	}
...
int func_35(int iParam0) // Position - 0x44D6 Hash - 0x95677753 ^0x95677753
{
	switch (iParam0)
	{
		case 1:
...
void func_36(var uParam0, int iParam1) // Position - 0x4A1D Hash - 0xC4015B80 ^0xF4489635
{
	var unk;
	int num;
	...
	switch (iParam1)
	{
		...
		case 69:
			...
			uParam0->f_146.f_82[2 /*102*/].f_7 = { { -99.095f, -1002.38f, 344.482f } + { 0.0058f, 0.066f, 0.0651f } };
			...
			uParam0->f_146.f_82[6 /*102*/].f_7 = { { -99.25f, -1001.646f, 341.9f } + { -0.0027f, -0.0238f, 0.0066f } };
		...
		case 72:
			...
			uParam0->f_146.f_82[2 /*102*/].f_7 = { { -98.9f, -996.94f, 266.2f } - { 0.0016f, -0.2399f, -0.0237f } };
...
void func_37(int iParam0, var uParam1, var uParam2, int iParam3) // Position - 0x7201 Hash - 0x3F59E3D3 ^0x16923DFB
{
	var unk;
	...
	switch (iParam0)
	{
		...
		case 42:
		case 43:
			func_48(iParam0, 40, &unk, -1, false);
			*uParam1 = { unk };
		...
		case 64:
		case 65:
			func_48(iParam0, 40, &unk, 61, false);
			*uParam1 = { unk };
		...
		case 75:
		case 76:
			func_48(iParam0, 40, &unk, 73, false);
			*uParam1 = { unk };
			*uParam2 = unk.f_3.f_2;
			break;
		...
		case 81:
		case 82:
			func_48(iParam0, 40, &unk, 77, false);
			*uParam1 = { unk };
			*uParam2 = unk.f_3.f_2;
			break;
		...
		case 84:
		case 85:
			func_48(iParam0, 40, &unk, 83, false);
			*uParam1 = { unk };
			*uParam2 = unk.f_3.f_2;
			break;
	
		case 86:
			func_38(iParam3, 40, &unk, false);
			*uParam1 = { unk };
			*uParam2 = unk.f_3.f_2;
			break;
		...
		case 89:
		case 90:
			func_48(iParam0, 40, &unk, 88, false);
			*uParam1 = { unk };
			*uParam2 = unk.f_3.f_2;
			break;
		...
		case 95:
		case 96:
			func_48(iParam0, 40, &unk, 91, false);
			*uParam1 = { unk };
			*uParam2 = unk.f_3.f_2;
			break;
		...
		case 101:
		case 102:
			func_48(iParam0, 40, &unk, 97, false);
			*uParam1 = { unk };
			*uParam2 = unk.f_3.f_2;
			break;
	}
...
void func_38(int iParam0, int iParam1, var uParam2, BOOL bParam3) // Position - 0x769C Hash - 0xA1F236AB ^0x4D5AF257
{
	var unk;
	Vector3 vector;
...
Vector3 func_39(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x801B Hash - 0x8959C4D1 ^0x8922A2E2
{
	float num;
	float num2;
	float num3;
...
struct<6> func_40(int iParam0, int iParam1) // Position - 0x805F Hash - 0x2496BBBB ^0x92F2F3E
{
	var unk;
	BOOL flag;
	BOOL flag2;
...
BOOL func_41(int iParam0, var uParam1) // Position - 0x80A1 Hash - 0x7164B50D ^0x19A31E94
{
	switch (iParam0)
	{
		case -1:
...
struct<6> func_42(int iParam0) // Position - 0x81C7 Hash - 0xC73C1158 ^0x2A6D4A6F
{
	var unk;
...
void func_43(var uParam0, int iParam1) // Position - 0x88BD Hash - 0xBCDD19C ^0xBCDD19C
{
	var unk;
	...
	switch (iParam1)
	{
		...
		case 42:
		case 43:
			func_48(iParam1, 4, &unk, -1, false);
			uParam0->[0 /*8*/] = { unk };
			func_48(iParam1, 5, &unk, -1, false);
			uParam0->[0 /*8*/].f_3 = { unk };
			uParam0->[0 /*8*/].f_6 = 19f;
			func_48(iParam1, 276, &unk, -1, false);
			uParam0->[1 /*8*/] = { unk };
			func_48(iParam1, 277, &unk, -1, false);
			uParam0->[1 /*8*/].f_3 = { unk };
		...
		case 64:
		case 65:
			func_48(iParam1, 4, &unk, 61, false);
			uParam0->[0 /*8*/] = { unk };
			func_48(iParam1, 5, &unk, 61, false);
			uParam0->[0 /*8*/].f_3 = { unk };
			uParam0->[0 /*8*/].f_6 = 21f;
			func_48(iParam1, 276, &unk, 61, false);
			uParam0->[1 /*8*/] = { unk };
			func_48(iParam1, 277, &unk, 61, false);
			uParam0->[1 /*8*/].f_3 = { unk };
			uParam0->[1 /*8*/].f_6 = 14.5f;
			break;
		...
		case 75:
		case 76:
			func_48(iParam1, 4, &unk, 73, false);
			uParam0->[0 /*8*/] = { unk };
			func_48(iParam1, 5, &unk, 73, false);
			uParam0->[0 /*8*/].f_3 = { unk };
			uParam0->[0 /*8*/].f_6 = 9.75f;
			func_48(iParam1, 276, &unk, 73, false);
			uParam0->[1 /*8*/] = { unk };
			func_48(iParam1, 277, &unk, 73, false);
			uParam0->[1 /*8*/].f_3 = { unk };
			uParam0->[1 /*8*/].f_6 = 10.25f;
			func_48(iParam1, 483, &unk, 73, false);
			uParam0->[2 /*8*/] = { unk };
			func_48(iParam1, 484, &unk, 73, false);
			uParam0->[2 /*8*/].f_3 = { unk };
		...
		case 81:
		case 82:
			func_48(iParam1, 4, &unk, 77, false);
			uParam0->[0 /*8*/] = { unk };
			func_48(iParam1, 5, &unk, 77, false);
			uParam0->[0 /*8*/].f_3 = { unk };
			uParam0->[0 /*8*/].f_6 = 9.75f;
			func_48(iParam1, 276, &unk, 77, false);
			uParam0->[1 /*8*/] = { unk };
			func_48(iParam1, 277, &unk, 77, false);
			uParam0->[1 /*8*/].f_3 = { unk };
			uParam0->[1 /*8*/].f_6 = 5f;
			func_48(iParam1, 483, &unk, 77, false);
			uParam0->[2 /*8*/] = { unk };
			func_48(iParam1, 484, &unk, 77, false);
			uParam0->[2 /*8*/].f_3 = { unk };
		...
		case 84:
		case 85:
			func_48(iParam1, 4, &unk, 83, false);
			uParam0->[0 /*8*/] = { unk };
			func_48(iParam1, 5, &unk, 83, false);
			uParam0->[0 /*8*/].f_3 = { unk };
			uParam0->[0 /*8*/].f_6 = 26.75f;
			func_48(iParam1, 276, &unk, 83, false);
			uParam0->[1 /*8*/] = { unk };
			func_48(iParam1, 277, &unk, 83, false);
			uParam0->[1 /*8*/].f_3 = { unk };
			uParam0->[1 /*8*/].f_6 = 18.25f;
			break;
	
		case 86:
			func_48(iParam1, 4, &unk, 86, false);
			uParam0->[0 /*8*/] = { unk };
			func_48(iParam1, 5, &unk, 86, false);
			uParam0->[0 /*8*/].f_3 = { unk };
			uParam0->[0 /*8*/].f_6 = 14.75f;
			func_48(iParam1, 276, &unk, 86, false);
			uParam0->[1 /*8*/] = { unk };
			func_48(iParam1, 277, &unk, 86, false);
			uParam0->[1 /*8*/].f_3 = { unk };
		...
		case 89:
		case 90:
			func_48(iParam1, 4, &unk, 88, false);
			uParam0->[0 /*8*/] = { unk };
			func_48(iParam1, 5, &unk, 88, false);
			uParam0->[0 /*8*/].f_3 = { unk };
			uParam0->[0 /*8*/].f_6 = 27.25f;
			func_48(iParam1, 276, &unk, 88, false);
			uParam0->[1 /*8*/] = { unk };
			func_48(iParam1, 277, &unk, 88, false);
			uParam0->[1 /*8*/].f_3 = { unk };
		...
		case 95:
		case 96:
			func_48(iParam1, 4, &unk, 91, false);
			uParam0->[0 /*8*/] = { unk };
			func_48(iParam1, 5, &unk, 91, false);
			uParam0->[0 /*8*/].f_3 = { unk };
		...
		case 101:
		case 102:
			func_48(iParam1, 4, &unk, 97, false);
			uParam0->[0 /*8*/] = { unk };
			func_48(iParam1, 5, &unk, 97, false);
			uParam0->[0 /*8*/].f_3 = { unk };
			uParam0->[0 /*8*/].f_6 = 22f;
			break;
	}
...
BOOL func_44(int iParam0) // Position - 0x8FB9 Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
		case 87:
...
BOOL func_45(int iParam0, int iParam1) // Position - 0x8FE8 Hash - 0x32D9FCC4 ^0x32D9FCC4
{
	if (iParam1 == -1)
	{
		switch (iParam0)
...
// Unhandled jump detected. Output should be considered invalid
int func_46(int iParam0, int iParam1) // Position - 0x90C5 Hash - 0x779DF6B0 ^0x779DF6B0
{
	if (iParam1 == -1)
	{
		switch (iParam0)
...
int func_47(int iParam0) // Position - 0x9181 Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
		case 83:
...
void func_48(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x91AA Hash - 0x91B5CD4A ^0x91B5CD4A
{
	var unk;
	Vector3 vector;
...
struct<6> func_49(int iParam0, BOOL bParam1) // Position - 0xA65E Hash - 0x293B24C9 ^0x49F602D8
{
	var unk;
...
int func_50(int iParam0) // Position - 0xB214 Hash - 0x85860E9C ^0x85860E9C
{
	switch (iParam0)
	{
		case 1:
...
void func_51(var uParam0, int iParam1) // Position - 0xB451 Hash - 0xDB98DDB7 ^0x6713DF47
{
	switch (iParam1)
	{
		case 2:
...
struct<8> func_52(var uParam0, int iParam1) // Position - 0xBCFE Hash - 0x89718D ^0x979A7007
{
	switch (iParam1)
	{
		case 2:
...
void func_53(var uParam0, int iParam1) // Position - 0xBDC0 Hash - 0x4DEDC2C8 ^0x4C167629
{
	var unk;
	...
	switch (iParam1)
	{
		case 1:
			*uParam0 = { -773.4775f, 310.6321f, 84.6981f };
			...
			func_58(uParam0->f_38[0 /*27*/].f_16, uParam0->f_38[0 /*27*/].f_19, &unk, uParam0->f_38[0 /*27*/].f_22);
			...
			func_58(uParam0->f_38[1 /*27*/].f_16, uParam0->f_38[1 /*27*/].f_19, &unk, uParam0->f_38[1 /*27*/].f_22);
			uParam0->f_38[1 /*27*/].f_12 = { unk };
			uParam0->f_38[1 /*27*/].f_15 = unk.f_3.f_2;
...
void func_54(var uParam0, int iParam1) // Position - 0x13DE1 Hash - 0x6F1E6E35 ^0x6F1E6E35
{
	switch (iParam1)
	{
		case 1:
...
void func_55(var uParam0, int iParam1) // Position - 0x1458D Hash - 0x4DEDC2C8 ^0x4C167629
{
	var unk;
...
void func_56(var uParam0, int iParam1) // Position - 0x174D2 Hash - 0x4DEDC2C8 ^0x4C167629
{
	var unk;
	...
	switch (iParam1)
	{
		case 68:
			*uParam0 = { -1581.5f, -558.3f, 35f };
			...
			func_58(uParam0->f_38[2 /*27*/].f_16, uParam0->f_38[2 /*27*/].f_19, &unk, uParam0->f_38[2 /*27*/].f_22);
			uParam0->f_38[2 /*27*/].f_12 = { unk };
			uParam0->f_38[2 /*27*/].f_15 = unk.f_3.f_2;
...
void func_57(var uParam0, int iParam1) // Position - 0x18AEF Hash - 0xC453A0B7 ^0xD5C79BA0
{
	var unk;
...
void func_58(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, int iParam7) // Position - 0x20610 Hash - 0x1A9A1B3A ^0xAFEB7172
{
	var unk;
	var unk7;
	var unk13;
	...
	*uParam6 = { 0f, 0f, 0f };
	...
	unk13 = { uParam0 };
	unk13.f_3 = { uParam3 };
	func_59(unk, unk7, unk13, uParam6);
	return;
}

void func_59(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, Vector3 vParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18) // Position - 0x20846 Hash - 0xAF03D6C6 ^0x10EE8207
{
	Vector3 vector;
...
BOOL func_60(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, BOOL bParam6) // Position - 0x209A0 Hash - 0x2D46096D ^0xEA41378F
{
	if (bParam6)
...
int func_61(var uParam0, int iParam1) // Position - 0x209E7 Hash - 0x7EA7B171 ^0xE80E6A41
{
	switch (iParam1)
	{
		case 103:
...
void func_62(var uParam0, int iParam1) // Position - 0x20C97 Hash - 0xE0CC43E ^0x9B0FA980
{
	var unk;
	int i;

	uParam0->f_33 = 20;
	func_48(iParam1, 6, &unk, 109, false);
	uParam0->f_1742.f_20 = { unk };
	uParam0->f_1742.f_23 = unk.f_3.f_2;

	for (i = 0; i < 10; i = i + 1)
	{
		func_48(iParam1, 913 + i, &unk, 109, false);
		uParam0->f_1742.f_28[i /*3*/] = { unk };
		uParam0->f_1742.f_62[i] = unk.f_3.f_2;
		func_48(iParam1, 933 + i, &unk, 109, false);
		uParam0->f_1742.f_74[i /*3*/] = { unk };
	}

	func_48(iParam1, 1, &unk, 109, false);
	uParam0->f_1742 = { unk };
	func_48(iParam1, 2, &unk, 109, false);
	uParam0->f_1742.f_3 = { unk };
	uParam0->f_1742.f_6 = 2f;
	uParam0->f_1742.f_7 = unk.f_3.f_2;
	func_48(iParam1, 15, &unk, 109, false);
	uParam0->f_1742.f_136 = { unk };
	func_48(iParam1, 3, &unk, 109, false);
	uParam0->f_1742.f_150 = { unk };
	func_48(iParam1, 4, &unk, 109, false);
	uParam0->f_1742.f_153 = { unk };
	func_48(iParam1, 5, &unk, 109, false);
	uParam0->f_1742.f_153.f_3 = { unk };
	uParam0->f_1742.f_153.f_6 = 22.75f;
	uParam0->f_1742.f_149 = 0;
	func_48(iParam1, 137, &unk, 109, false);
	uParam0->f_1742.f_167 = { unk };
	return;
}

int func_63(var uParam0, int iParam1) // Position - 0x20E0F Hash - 0xF04B697 ^0x8F24807C
{
	switch (iParam1)
	{
		case 91:
...
void func_64(var uParam0, int iParam1) // Position - 0x210BF Hash - 0x9E11C000 ^0x4493326F
{
	switch (iParam1)
	{
		case 91:
...
struct<4> func_65(int iParam0) // Position - 0x2157C Hash - 0x9440B077 ^0x4C5EF751
{
	var unk;
	...
	{
		case 1:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_1DES" /*This luxury triplex is move-in ready! The previous owner was so rich he just left all his furniture. Just bring yourself and be ready for lots of new superficial friends when people find out you live on Eclipse Boulevard in Rockford Hills. Includes 10-car garage.*/, 16);
			break;
	
		case 2:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_2DES" /*A massive, furnished, luxury triplex at this price? You've gotta love a bargain like this! Snap it up now before President Lawton loses the next election and they tax the hell out of you. Includes 10-car garage.*/, 16);
			break;
	
		case 3:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_3DES" /*Eclipse Towers on Eclipse Boulevard... this is the best address in Rockford Hills! Stand at your floor-to-ceiling windows, take in the spectacular panoramic views, pour yourself a drink and toast how amazing your life is while you look down on everybody else. Includes 10-car garage.*/, 16);
			break;
	
		case 4:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_4DES" /*Upper class living at middle class prices! Are you a single-digit millionaire who wants to live like a double-digit millionaire? You'll never find a better deal on a luxury condo in Rockford Hills than this again. Act now, it won't last! Includes 10-car garage.*/, 16);
			break;
	
		case 5:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_5DES" /*With its own Bean Machine outlet on the ground floor and a short commute to the financial center, this luxury condo on Alta Street in Downtown Los Santos is the perfect pad for the banker who never sleeps because he's having too much fun gambling with other people's money. Includes 10-car garage.*/, 16);
			break;
	
		case 6:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_6DES" /*Situated at the epicenter of the Los Santos financial, business and high-end shopping districts, you'll never have to see a poor person again at this luxury condo on Alta Street if you don't want to. Everything you need is right on your doorstep. Includes 10-car garage.*/, 16);
			break;
	
		case 7:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_7DES" /*This luxury condo on Marathon Avenue and Prosperity Street, in one of the most stylish apartment buildings in hip Del Perro, directly opposite the Bahama Mamas nightclub for the perfect release at the end of a hard day's work. Includes 10-car garage.*/, 16);
			break;
	
		case 8:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_8DES" /*Located steps away from a skate park, this cute-as-a-button one-bedroom in Hawick is perfect for families with teenage children or tragic 30-something hipsters with fixies. Includes 6-car garage.*/, 16);
			break;
	
		case 9:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_9DES" /*This newly-renovated one-bedroom in Downtown Vinewood is a STEAL!~n~Hurry this one won't last! It did last!~n~$10,000 price reduction!~n~Crazy value!~n~Move NOW the price is right!~n~Everything's negotiable. Motivated seller.~n~Reduced again for quick sale!~n~WILL SOMEONE JUST BUY THIS ALREADY??? Includes 6-car garage.*/, 16);
			break;
	
		case 10:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_10DES" /*This building has seen better days - the closest thing to a doorman is a homeless guy you sometimes have to step over to get into the lobby at night - but how else are you going to find a Vinewood apartment in your price range? Hope you like the smell of urine.~n~Includes 6-car garage.*/, 16);
			break;
	
		case 11:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_11DES" /*Cozy one-bedroom in a cute West Vinewood apartment block! You'll only share the building with a few other units, meaning fewer neighbors for you to grow to despise. Includes 6-car garage.*/, 16);
			break;
	
		case 12:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_12DES" /*The Royale apartment building in West Vinewood might not look regal on the outside but you'll live like a prince on the inside! PS Princes are douches.~n~Includes 6-car garage.*/, 16);
			break;
	
		case 13:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_13DES" /*This modern, renovated one-bedroom is in a well-maintained building in a great West Vinewood location. Buy now at the bottom of the market! Property values can't go any lower! We're absolutely sure this time! Includes 6-car garage.*/, 16);
			break;
	
		case 14:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_14DES" /*Hello, sailor! This renovated, fully-furnished apartment is right on the waterfront in Puerto Del Sol. Perfect for picking up other sailors.~n~Includes 6-car garage.*/, 16);
			break;
	
		case 15:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_15DES" /*Location is in the eye of the beholder! Some might call this a busy traffic junction, we call it a Commuter's Dream! Some might call this Little Seoul, we call it Vespucci so we can up the price!~n~Includes 6-car garage.*/, 16);
			break;
	
		case 16:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_16DES" /*Join the other creative types flocking to this neighborhood. With easy access to both a movie theater and a church, this apartment in Dream Tower is perfect for lovers of fiction.~n~Includes 6-car garage.*/, 16);
			break;
	
		case 17:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_17DES" /*What this Hawick apartment lacks in space and all-round condition, it makes up for in proximity to the local liquor store. Drown in debt and your sorrows.~n~Includes 2-car garage.*/, 16);
			break;
	
		case 18:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_18DES" /*Original features! This cozy apartment in West Vinewood had only one owner, who didn't update a single thing since he moved in there 40 years ago and then passed away – it was days before anyone noticed. Includes 2-car garage.*/, 16);
			break;
	
		case 19:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_19DES" /*This compact apartment in a 2-story apartment building has been meticulously maintained in its original condition! Semi-partial ocean view! Includes 2-car garage.*/, 16);
			break;
	
		case 20:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_20DES" /*The apartment building has seen better days but this affordable unit still has a Little Soul and a Lot of Potential! Bring your imagination! And an exterminator.~n~Includes 2-car garage.*/, 16);
			break;
	
		case 21:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_21DES" /*This fixer-upper offers stunning views of the cemetery to at once remind you of your mortality and motivate you to get your act together and buy a better apartment one day.~n~Includes 2-car garage.*/, 16);
			break;
	
		case 22:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_22DES" /*With both Wigwam and Up-n-Atom right on your doorstep, burger enthusiasts will be spoiled for choice at this apartment located in Del Perro or Morningwood, depending on which side of the building you stand. Includes 2-car garage.*/, 16);
			break;
	
		case 23:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_23DES" /*With a funky retro décor and carpeted throughout, you can literally smell the history in this Del Perro apartment that features an almost unobstructed ocean view for an almost unbeatable price. Includes 2-car garage.*/, 16);
			break;
	
		case 24:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_24DES" /*10-Car Garage - With good access to the major roadways in and out of Los Santos, this spacious garage is perfect for the man or woman who might need to leave town in a hurry. Or is obsessed with cars.*/, 16);
			break;
	
		case 25:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_25DES" /*6-Car Garage - If you're an individual who likes to keep their business private, look no further than this secluded garage in East Los Santos.*/, 16);
			break;
	
		case 26:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_26DES" /*10-Car Garage - Spacious garage in prime East Los Santos. Panoramic views of urban blight, walking distance to gang members.*/, 16);
			break;
	
		case 27:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_27DES" /*10-Car Garage - Newly renovated garage with excellent square footage and direct road access. What better place to keep brand-new vehicles than the neighborhood with the highest crime rate in Los Santos?*/, 16);
			break;
	
		case 28:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_28DES" /*6-Car Garage - A good-sized garage in a quiet location within walking distance of the train for those days when you feel extra guilty about your 6-car carbon footprint.*/, 16);
			break;
	
		case 29:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_29DES" /*2-Car Garage - Located just a few brain-melting steps away from an electrical substation, you'll never have to worry losing power or reaching old age again at this garage in East Los Santos.*/, 16);
			break;
	
		case 30:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_30DES" /*2-Car Garage - Affluent on the inside, effluent on the outside! This garage offers panoramic views of the Los Santos waterways.*/, 16);
			break;
	
		case 31:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_31DES" /*2-Car Garage - Calling all bargain hunters! In today's economy, it's all about desirable properties in undesirable areas. East Los Santos? We prefer to call it 'South of Vinewood'! Plus if the economy keeps tanking, you can go live in it!*/, 16);
			break;
	
		case 32:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_32DES" /*6-Car Garage - This garage is in a killer area... literally! Be first to gentrify this neighborhood! In 20 years, it will be the next big thing!*/, 16);
			break;
	
		case 33:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_33DES" /*6-Car Garage - High standards in real estate, low standards in women? End the day with your own oil change at this garage located across from a strip club!*/, 16);
			break;
	
		case 34:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_34DES" /*Luxury Del Perro Heights apartment complex! For all you voyeurs out there! This spectacular condo is one of the lower units so might not boast the best views, but all the buildings around you will have a direct eyeline into your awesome life 24/7. Includes 10-car garage.*/, 16);
			break;
	
		case 35:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_35DES" /*Calling all actors! This is your chance to live on sought-after Movie Star Way in prime Rockford Hills directly opposite the legendary Richard Majestic film studios. Stagger out of your front door right onto set! Includes 10-car garage.*/, 16);
			break;
	
		case 36:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_36DES" /*Movie Star Way! Don't miss this opportunity to live in one of the most exclusive apartment complexes in Rockford Hills. Even the janitor earns six figures in this building.~n~Includes 10-car garage.*/, 16);
			break;
	
		case 37:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_37DES" /*This spectacular condo on Movie Star Way in prime Rockford Hills is move-in ready! Don't worry if you're a rich Los Santos philistine with no taste - it's all been picked out for you. All furniture, appliances, fixtures and art included.~n~Includes 10-car garage.*/, 16);
			break;
	
		case 38:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_38DES" /*No dropped calls here! This luxury condo is located in the same building as Tinkle Mobile's headquarters in the new real estate hotspot of Downtown Los Santos. This is such an up-and-coming neighborhood, you can literally see the construction from your window!~n~Includes 10-car garage.*/, 16);
			break;
	
		case 39:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_39DES" /*This beautiful Downtown triplex apartment has spectacular views of Los Santos and the iconic Vinewood Sign in the distance. Watch all the people chasing the dream while you live it! Includes 10-car garage.*/, 16);
			break;
	
		case 40:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_40DES" /*This breathtaking luxury condo on Movie Star Way in Rockford Hills is a stone's throw from Richards Majestic Movie Studios, AKAN Records and a Sperm Donor Clinic. The ultimate trifecta of dying industries! Includes 10-car garage.*/, 16);
			break;
	
		case 41:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_41DES" /*A luxury condo on Movie Star Way in Rockford Hills? This is one of the trendiest addresses in Los Santos! Imagine if all your neighbors were hedge fund managers and celebrities? Come on, live the dream. Includes 10-car garage.*/, 16);
			break;
	
		case 42:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_42DES" /*Your split personality will be right at home in this retro-slash-ultramodern apartment building on Boulevard Del Perro. Go mad in style. Includes 10-car garage.*/, 16);
			break;
	
		case 43:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_43DES" /*Parquet flooring, granite countertops, floating fireplace, bland modern art, walk-in closet, towel warmers, leather headboard, man cave...this luxury condo in Tinsel Towers on Boulevard Del Perro checks all the boxes on the new-money millionaire ticklist.~n~Includes 10-car garage.*/, 16);
			break;
	
		case 44:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_44DES" /*2-Car Garage - Annexed to a gas station and within easy distance of a number of cheap motels, this garage on Paleto Blvd in Paleto Bay has all you need for the perfect escape from the city.*/, 16);
			break;
	
		case 45:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_45DES" /*2-Car Garage - This garage near Paleto Blvd in Paleto Bay has seen better days but there's a barber's, a tattoo parlor and a Cluckin' Bell factory on your doorstep...so what more do you need?*/, 16);
			break;
	
		case 46:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_46DES" /*2-Car Garage - The town of Grapeseed offer a unique blend of heavy industry and genetically-modified farming that explains why everyone born there in the last 20 years looks so funny. This small garage on Grapeseed Avenue needs some TLC but is priced to sell.*/, 16);
			break;
	
		case 47:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_48DES" /*2-Car Garage - This garage is situated on the site of Ron Alternates on N. Senora Way. What better way to feel better about your carbon footprint than by storing your gas-guzzlers inside a wind farm?*/, 16);
			break;
	
		case 48:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_49DES" /*2-Car Garage - Across from the beach, ocean views, steps from a delicious seafood restaurant, this property on Great Ocean Highway in North Chumash is in an unbeatable location! The catch? It's a garage...*/, 16);
			break;
	
		case 49:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_50DES" /*2-Car Garage - Small one-door garage for sale on Route 68 on Harmony. With a rundown general store, a local arm-wrestling haunt and a seedy motel all nearby, park up and live the dream!*/, 16);
			break;
	
		case 50:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_51DES" /*6-Car Garage - Garage in need of some TLC for sale on Senora Rd in the Grand Senora Desert. Nothing of great note in the surrounding area. It's a garage. In a desert.*/, 16);
			break;
	
		case 51:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_52DES" /*2-Car Garage - Steps from a liquor store, a Dollar Pills pharmacy, a Suburban store, and an Animal Ark pet store, this garage on Route 68 in Harmony is a hipster's dream. Booze, cigarettes, faux-vintage clothing and organic dog food in one!*/, 16);
			break;
	
		case 52:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_57DES" /*6-Car Garage - Located behind an Ammu-Nation store and near to the Fort Zancudo Military Base, you won't have to worry about security at this garage on Route 68.*/, 16);
			break;
	
		case 53:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_59DES" /*6-Car Garage - Calling all Los Santos Panic fans! This garage on Crusade Road is in a prime location just down the road from the Maze Bank Arena!*/, 16);
			break;
	
		case 54:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_60DES" /*10-Car Garage - Are you in need of a low-profile lock-up where people won't ask too many questions? Look no further than this garage on South Shambles in Cypress Flats.*/, 16);
			break;
	
		case 55:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_61DES" /*6-Car Garage - If you're looking for a desolate, industrial lock-up far away from prying eyes, this garage on Dry Dock St in Cypress Flats is the one for you!*/, 16);
			break;
	
		case 56:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_62DES" /*10-Car Garage - Garage for sale on Exceptionalists Way. Why would you need a spacious, anonymous, non-descript lock-up with lots of space for storage close to the airport? We won't ask if you don't tell.*/, 16);
			break;
	
		case 57:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_63DES" /*10-Car Garage - In a prime location near Greenwich parkway in Los Santos International Airport, next door to Bilgeco Shipping services, this garage is perfect for a man or woman who might need to transport something in a hurry or get out of a town in a hurry.*/, 16);
			break;
	
		case 58:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_64DES" /*2-Car Garage - Garage for sale on Innocence Blvd in La Puerta. How can there be this many garages for sale in Los Santos? We're as puzzled by this real estate boom as you are.*/, 16);
			break;
	
		case 59:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_65DES" /*2-Car Garage - If you're feeling the pinch of the economic downturn but desperate for a prime Rockford Hills address, this garage on Boulevard Del Perro might be the perfect compromise!*/, 16);
			break;
	
		case 60:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_66DES" /*2-Car Garage - Garage for sale on Mirror Park Blvd in East Vinewood. If you're looking for a garage in Los Santos, don't delay! It's an incredible buyer's market right now. They're everywhere!*/, 16);
			break;
	
		case 61:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_67DES" /*Part of The High Life Update. Perfectly proportioned, beautifully presented lateral living opportunity on exquisite Eclipse Blvd. This apartment is as unique as the new cheekbones your surgeon just gave you... by that we mean you'll see them all over town. Includes 10-car garage.*/, 16);
			break;
	
		case 62:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_68DES" /*Part of The High Life Update. Enjoy ocean views far above the fray of tourists and bums on Del Perro Beach with this lateral living opportunity for the super rich. If we can overpay for something, we have, and we're passing the expense on down to you. Includes 10-car garage.*/, 16);
			break;
	
		case 63:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_69DES" /*Part of The High Life Update. Own a piece of glamorous old Vinewood, albeit a very small and expensive piece that's been made to look just like the other super-rich corners of Los Santos. A contemporary lateral living experience with one foot in the past. Includes 10-car garage.*/, 16);
			break;
	
		case 64:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_70DES" /*Part of The High Life Update. A picture-perfect lateral living experience in one of Los Santos' most sought-after tower blocks. These gorgeous lateral apartments only become available when hedgefunder residents have massive drug-induced heart attacks or get arrested for killing hookers. Includes 10-car garage.*/, 16);
			break;
	
		case 65:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_71DES" /*Part of The High Life Update. Live in the clouds while your bank balance hits the floor. An apartment so conspicuously expensive all your friends will immediately know how much you paid for it. The Downtown lateral living experience for people who secretly want to be LC based. Includes 10-car garage.*/, 16);
			break;
	
		case 66:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_72DES" /*Part of The Independence Day Special. Crazy movie director across the road? Check. Astronomically over-priced property where your car has more square footage than you do? Check. If you're looking for the full Vinewood Hills experience, this modest home ticks all the boxes. Includes 6-car garage.*/, 16);
			break;
	
		case 67:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_73DES" /*Part of The Independence Day Special. Calling all gentrifiers... El Burro Heights is ripe for hostile takeover! Pack up the espresso machine, labradoodle and deliberately tousled toddler and snap up this property before it's too late! Act now, or you'll be priced out of this neighborhood within a year! Includes 6-car garage.*/, 16);
			break;
	
		case 68:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_74DES" /*Part of The Independence Day Special. Check out the water feature in the front yard! This is coastal, provincial living at its very finest. Worried about shade? Want easy access to groceries? How about two for the price of one? This house backs right onto the supermarket, blocking out all natural light. Includes 6-car garage.*/, 16);
			break;
	
		case 69:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_75DES" /*Part of The Independence Day Special. Stunning views of rapidly rising sea levels! And talk about amenities! This Paleto Bay beauty is walking distance to a dive bar, hospital, funeral home, crematorium and gun store, so you can go out on the town secure in the knowledge that you're covered for every eventuality. Includes 6-car garage.*/, 16);
			break;
		...
		case 71:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_77DES" /*Part of The Independence Day Special. Beggars CAN be choosers! Waterfront living at a bargain price! Steps away from both a Chinese restaurant and a tattoo parlor, this Sandy Shores location offers no shortage of late-night decisions you'll regret in the morning. Includes 2-car garage.*/, 16);
			break;
	
		case 72:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_78DES" /*Part of The Independence Day Special. Location, location, location! Across from a feed store, minimart and discount clothes emporium, this house is right in the heart of the action on Grapeseed's main drag. Living on the cutting edge of rural retail! Includes 2-car garage.*/, 16);
			break;
	
		case 83:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_79DES" /*Is the 1% starting to feel a little crowded? Are you tired of single-digit millionaires cluttering up your elevator and groping your bellboy? Do you need a new way of expressing your bottomless contempt for your fellow man? Look no further: this lavish penthouse suite at the best address in town is expensive enough to keep the riff raff at bay until at least the next federal bailout. Access to our same-day redecorating service included as standard. Part of Executives and Other Criminals.*/, 16);
			break;
	
		case 84:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_80DES" /*Penthouse living isn't just about mindless luxury. It's about knowing that when you flush a dump you're literally crapping through every single one of the $500K hovels beneath you - and that's something that only money can buy. Access to our same-day redecorating service included as standard. Part of Executives and Other Criminals.*/, 16);
			break;
	
		case 85:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_81DES" /*Let's face it: we had you at the pricetag. The fact that this happens to be one of the most decadent living spaces for hundreds of miles doesn't really matter. Just like its new owner, something this expensive doesn't need to be 'nice' or 'useful'. You're a perfect match. What are you waiting for? Access to our same-day redecorating service included as standard. Part of Executives and Other Criminals.*/, 16);
			break;
	
		case 73:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_83DES" /*Welcome to the heights of the Vinewood hills, where the average first time buyer is 24 and the web 2.0 entrepreneurs are only outnumbered by the swarms of fading teenage pop sensations. Buy in now while the price is still ridiculously high - what are you, sensible? Part of Executives and Other Criminals.*/, 16);
			break;
		...
		case 75:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_85DES" /*The previous owner of this gorgeous cliffside manor died doing a yoga pose on the rear balcony railing... but at least they got the Snapmatic shot. It's a tough act to follow, but if you're rich and stupid enough to buy into this neighborhood you're already most of the way there. Just follow your fragile heart. Part of Executives and Other Criminals.*/, 16);
			break;
	
		case 76:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_86DES" /*Clinging to the side of the Vinewood hills like a dying oil tycoon clutching his carer-turned-sixth-wife, this three story mansion more than compensates for deep structural flaws with sumptuous interior design. Open plan kitchen, minimalist furnishings, ever-present vertigo: this one really has it all. Part of Executives and Other Criminals.*/, 16);
			break;
		...
		case 78:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_89DES" /*Act now to secure your place at one of the quietest and most exclusive addresses in the city. All the other houses on this street were bought in the nineties by legitimate foreign investors who needed somewhere to store vast sums of legally acquired capital, and they've been empty ever since. It'll feel like you're living in an investment portfolio, but isn't that the point? Part of Executives and Other Criminals.*/, 16);
			break;
	
		case 79:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_90DES" /*Skyscraper views and lateral living are last year's kind of vanity project. Put a more contemporary spin on your raging superiority complex by forcing your butler to wheeze up and down all three stories of this hillside palace, while you take selfies with the spectacular views of thousands of more comfortable, less expensive places to live behind you. Part of Executives and Other Criminals.*/, 16);
			break;
	
		case 80:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_92DES" /*The tinnitus and smoker's cough are telling you that you've seen too much inner-city living, and we're telling you that this fantastically expensive apartment in leafy Vinewood is the answer to decades of hardened self-abuse. From here, you can gaze out across the whole town every morning as you retch into your green juice and paleo breakfast burrito. Just keep reminding yourself you're glad to get away from it all. Part of Executives and Other Criminals.*/, 16);
			break;
	
		case 81:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_94DES" /*Built in the 60s and surprising everyone by still being in once piece, this understated property may not look like much on the outside, but don't worry: inside it's identical to every other brainless yuppie's fantasy of open plan, designer living. Part of Executives and Other Criminals.*/, 16);
			break;
	
		case 82:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_95DES" /*Designed and constructed in direct violation of every building law in the state, this luxury apartment is a testament to the power of a can-do attitude and utter disregard for standards of health, safety and common sense. Time to pour yourself a drink, forget about the forty foot drop, and congratulate yourself on keeping that pioneer spirit alive. Part of Executives and Other Criminals.*/, 16);
			break;
	
		case 87:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_96DES", 16);
			break;
	
		case 88:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_97DES", 16);
			break;
	
		case 89:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_98DES", 16);
			break;
	
		case 90:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_PROP_99DES", 16);
			break;
	
		case 91:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_CLUBH1DES" /*This little gem is nestled so snugly in the heart of longstanding urban squalor that we'd forgotten it was even on our books. As far as we can tell it's not on any property register, so just give us the cash and make it disappear.*/, 16);
			break;
	
		case 92:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_CLUBH2DES" /*This functional ground floor property used to be a soup kitchen, and repossessing that kind of attack on American values isn't just business for us - it's pleasure. Now available for purchase by a patriotic entrepreneur or kingpin, this place will be serving the community again in no time.*/, 16);
			break;
	
		case 93:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_CLUBH3DES" /*The repo guys who raided this place died of smallpox three days later, which is almost certainly a coincidence and has in no way affected the valuation of the property. And hey, worst case scenario, you couldn't pay for a more robust security system.*/, 16);
			break;
	
		case 94:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_CLUBH4DES" /*We all thought there was a rock bottom, but nope, it turns out the value of a place like this just falls and falls! Get in here before we burn it for kicks. The authorities just want to forget it exists, so go wild.*/, 16);
			break;
	
		case 95:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_CLUBH5DES" /*You might assume this is a glass-half-empty kind of place, but the people of Paleto believe the glass is actually half full of cut-price real estate, disenfranchised workers and raw opportunity. That's right, this dingy storage unit is a step towards a brighter future for us all.*/, 16);
			break;
	
		case 96:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_CLUBH6DES" /*Are you a real fixer upper? Can you share the cool desert evenings with packs of wild dogs and openly incestuous couples? If so this is the project for you. It's got nothing but potential.*/, 16);
			break;
	
		case 97:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_CLUBH7DES" /*The locals assumed it was abandoned, but in fact this spacious warehouse was the heart and soul of the Los Santos snuff industry for years. Now tax hikes are forcing those pioneering filmmakers out of business, so this is your chance to buy your way under the radar and stay there for good.*/, 16);
			break;
	
		case 98:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_CLUBH8DES" /*Don't just sit there gorging on welfare and compassion. Take a stand for the trickle down economy today. Plunge capital back into your community. Buy up every last derelict and turn it into a living, breathing, buzzing hive of fugitives and meth heads. It's time to be the change, people.*/, 16);
			break;
	
		case 99:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_CLUBH9DES" /*You know a property must be something really special when the previous occupants have such a hard time letting go. You just can't fake that kind of helpless desperation and rage, and in a world as cynical as this that's the best review of all.*/, 16);
			break;
	
		case 100:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_CLUBH10DES" /*If you're looking for somewhere that's off the beaten path you just found it: miles from anywhere, deemed hazardous by the Los Santos Building Standards Commission, and the last occupants died in murder-suicide pact. How many reassurances of total privacy do you need?*/, 16);
			break;
	
		case 101:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_CLUBH11DES" /*Sure, coastal small town America has mile after mile of foreclosed retail premises within fifty feet of a church and a gun store, so why choose this one? Well ask yourself this: can you think of a better way to blend in and disappear? Act now before it stops making sense.*/, 16);
			break;
	
		case 102:
			TEXT_LABEL_ASSIGN_STRING(&unk, "MP_CLUBH12DES" /*You know times are tough when not even a million hipsters getting a tattoo of a swallow in flight on their taint could save this place from going under. Bad news for those who wanted to follow up with that bold yet simple triangle design, but the rock bottom pricetag is good news for you.*/, 16);
			break;
	}
...
struct<4> func_66(int iParam0) // Position - 0x21C44 Hash - 0x9440B077 ^0x3873237F
{
	var unk;
...
int func_67(int iParam0) // Position - 0x22397 Hash - 0xD720A463 ^0x1563885F
{
	int num;
	BOOL flag;
	var unk;
	...
	{
		case 1:
			return Global_262145.f_3783;
	
		case 2:
			return Global_262145.f_3784;
	
		case 3:
			return Global_262145.f_3785;
	
		case 4:
			return Global_262145.f_3786;
	
		case 5:
			return Global_262145.f_3787;
	
		case 6:
			return Global_262145.f_3788;
	
		case 7:
			return Global_262145.f_3789;
	
		case 34:
			return Global_262145.f_3790;
	
		case 35:
			return Global_262145.f_3791;
	
		case 36:
			return Global_262145.f_3792;
	
		case 37:
			return Global_262145.f_3793;
	
		case 38:
			return Global_262145.f_3794;
	
		case 39:
			return Global_262145.f_3795;
	
		case 40:
			return Global_262145.f_3796;
	
		case 41:
			return Global_262145.f_3797;
	
		case 42:
			return Global_262145.f_3798;
	
		case 43:
			return Global_262145.f_3799;
	
		case 8:
			return Global_262145.f_3800;
	
		case 9:
			return Global_262145.f_3801;
	
		case 10:
			return Global_262145.f_3802;
	
		case 11:
			return Global_262145.f_3803;
	
		case 12:
			return Global_262145.f_3804;
	
		case 13:
			return Global_262145.f_3805;
	
		case 14:
			return Global_262145.f_3806;
	
		case 15:
			return Global_262145.f_3807;
	
		case 16:
			return Global_262145.f_3808;
	
		case 17:
			return Global_262145.f_3809;
	
		case 18:
			return Global_262145.f_3810;
	
		case 19:
			return Global_262145.f_3811;
	
		case 20:
			return Global_262145.f_3812;
	
		case 21:
			return Global_262145.f_3813;
	
		case 22:
			return Global_262145.f_3814;
	
		case 23:
			return Global_262145.f_3815;
	
		case 24:
			return Global_262145.f_3816;
	
		case 25:
			return Global_262145.f_3817;
	
		case 26:
			return Global_262145.f_3818;
	
		case 27:
			return Global_262145.f_3819;
	
		case 28:
			return Global_262145.f_3820;
	
		case 29:
			return Global_262145.f_3821;
	
		case 30:
			return Global_262145.f_3822;
	
		case 31:
			return Global_262145.f_3823;
	
		case 32:
			return Global_262145.f_3824;
	
		case 33:
			return Global_262145.f_3825;
	
		case 44:
			return Global_262145.f_3826;
	
		case 45:
			return Global_262145.f_3827;
	
		case 46:
			return Global_262145.f_3828;
	
		case 47:
			return Global_262145.f_3829;
	
		case 48:
			return Global_262145.f_3830;
		...
		case 61:
			return Global_262145.f_7135[0];
	
		case 62:
			return Global_262145.f_7135[1];
	
		case 63:
			return Global_262145.f_7135[2];
	
		case 64:
			return Global_262145.f_7135[3];
	
		case 65:
			return Global_262145.f_7135[4];
	
		case 66:
			return Global_262145.f_8467;
	
		case 67:
			return Global_262145.f_8468;
		...
		case 73:
			return Global_262145.f_13515;
	
		case 74:
			return Global_262145.f_13516;
	
		case 75:
			return Global_262145.f_13517;
	
		case 76:
			return Global_262145.f_13518;
	
		case 77:
			return Global_262145.f_13519;
	
		case 78:
			return Global_262145.f_13520;
	
		case 79:
			return Global_262145.f_13521;
	
		case 80:
			return Global_262145.f_13522;
	
		case 81:
			return Global_262145.f_13523;
	
		case 82:
			return Global_262145.f_13524;
	
		case 83:
			return Global_262145.f_13512;
	
		case 84:
			return Global_262145.f_13513;
	
		case 85:
			return Global_262145.f_13514;
	
		case 86:
			return 27000000;
	
		case 87:
			return Global_262145.f_16100;
		...
		case 90:
			return Global_262145.f_16103;
	
		case 91:
			return Global_262145.f_18195;
	
		case 92:
			return Global_262145.f_18197;
	
		case 93:
			return Global_262145.f_18193;
	
		case 94:
			return Global_262145.f_18202;
	
		case 95:
			return Global_262145.f_18199;
	
		case 96:
			return Global_262145.f_18201;
	
		case 97:
			return Global_262145.f_18194;
	
		case 98:
			return Global_262145.f_18192;
		...
		case 102:
			return Global_262145.f_18196;
	
		case 103:
			return Global_262145.f_19865;
...
void func_68(char* sParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x22C32 Hash - 0x22B51A7B ^0xBC509729
{
	var unk;

	TEXT_LABEL_ASSIGN_STRING(sParam0, "FACTORY_INDEX_", 64);
	unk = { func_66(iParam1) };
	TEXT_LABEL_ASSIGN_STRING(sParam0, "PR_", 64);
...
BOOL func_69(int iParam0) // Position - 0x22C75 Hash - 0xC283774E ^0xC283774E
{
	if (func_70())
...
BOOL func_70() // Position - 0x22CB2 Hash - 0x3630EC94 ^0x3630EC94
{
	return func_72() || func_71();
}

int func_71() // Position - 0x22CC8 Hash - 0x9FCD2A0C ^0xB0CD58A
{
...
int func_72() // Position - 0x22CF6 Hash - 0x9FCD2A0C ^0x4053DDC2
{
...
BOOL func_73(int iParam0) // Position - 0x22D24 Hash - 0x4A424D7C ^0x4A424D7C
{
	if (_IS_EXCLUSIVE_CONTENT_UNLOCKED() && func_74())
		if (iParam0 == 31)
			return true;
...
int func_74() // Position - 0x22D5C Hash - 0xAF3D3332 ^0xE009CBFC
{
	int outValue;
	int outValue2;
	Hash statHash;
...
int _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x22E95 Hash - 0x44DD83CC ^0x7B62A376
{
	int profileSetting;
...
BOOL _NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM() // Position - 0x22F4D Hash - 0x2E0B1DC1 ^0xD2D0A3D9
{
...
void func_77() // Position - 0x22F64 Hash - 0xFDE1CC0C ^0x61DB6169
{
	int i;
	BOOL flag;
	int address;
...
BOOL func_78(int iParam0) // Position - 0x22FEA Hash - 0xE48228D0 ^0xE48228D0
{
	switch (iParam0)
	{
		case 8:
...
BOOL func_79(int iParam0, int iParam1) // Position - 0x2300D Hash - 0x10725834 ^0x10725834
{
	switch (iParam0)
	{
		case 11:
...
Hash func_80(int iParam0) // Position - 0x23049 Hash - 0xB8EC44B7 ^0xA99DCEEB
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_81() // Position - 0x2310F Hash - 0xEDF284C1 ^0xFD1ABEAC
{
...
void func_82(int iParam0) // Position - 0x23144 Hash - 0x8006748D ^0x3C79CCFE
{
	int i;
