	...
	for (i = 0; i < 204; i = i + 1)
	{
		if (!Global_59780[i /*7*/])
		{
			if (Global_59780[i /*7*/].f_2)
			{
				...
				{
					STATS::STAT_GET_INT(Global_59780[i /*7*/].f_3, &(Global_59780[i /*7*/].f_5), -1);
				}
				else
				{
					outValue = 0f;
					STATS::STAT_GET_FLOAT(Global_59780[i /*7*/].f_3, &outValue, -1);
					Global_59780[i /*7*/].f_5 = SYSTEM::FLOOR(outValue);
				}
			}
		}
	}
...
void func_1() // Position - 0x201 Hash - 0xE1CF4C78 ^0x37BA8AE
{
	Ped playerPed;
	Ped ped;
...
void func_4() // Position - 0x2B1 Hash - 0x5D9A9596 ^0x427B32C5
{
	...
	if (!NETWORK::NETWORK_IS_SIGNED_ONLINE())
	{
		...
		{
			Global_61210 = false;
			Global_61211 = MISC::GET_GAME_TIMER();
			Global_64023 = true;
		}
...
int func_5() // Position - 0x2FE Hash - 0x52A84F06 ^0xEF1C3284
{
	int i;
	int num;
	Hash statHash;
	...
	for (i = 0; i < 80; i = i + 1)
	{
		if (Global_56337[i /*36*/].f_8)
		{
			...
			{
				statHash = Global_59218[Global_56337[i /*36*/].f_35 /*7*/];
				STATS::STAT_GET_FLOAT(statHash, &(Global_56337[i /*36*/].f_9), -1);
			
				if (Global_56337[i /*36*/].f_9 > 0f)
				{
					num2 = 0f;
					STATS::STAT_COMMUNITY_GET_HISTORY(statHash, 0, &(Global_56337[i /*36*/].f_33));
					Global_56337[i /*36*/].f_31 = Global_56337[i /*36*/].f_9;
					Global_56337[i /*36*/].f_32 = Global_56337[i /*36*/].f_9;
					num2 = num2 + Global_56337[i /*36*/].f_33;
					...
					for (j = 0; j < 4; j = j + 1)
					{
						...
						if (outValue > Global_56337[i /*36*/].f_31)
							Global_56337[i /*36*/].f_31 = outValue;
					
						if (outValue < Global_56337[i /*36*/].f_32)
							Global_56337[i /*36*/].f_32 = outValue;
					...
					if (num3 > Global_56337[i /*36*/].f_31)
						Global_56337[i /*36*/].f_31 = num3;
				
					if (num3 < Global_56337[i /*36*/].f_32)
						Global_56337[i /*36*/].f_32 = num3;
				
					Global_56337[i /*36*/].f_33 = num3 - num2;
					Global_56337[i /*36*/].f_34 = (Global_56337[i /*36*/].f_33 / num2) * 100f;
				}
				else
				{
					num = num + 1;
...
void func_41() // Position - 0x1836 Hash - 0x3E41589 ^0xE65860AB
{
	...
	for (i = 0; i < 204; i = i + 1)
	{
		if (!Global_59780[i /*7*/])
		{
			if (Global_59780[i /*7*/].f_2)
			{
				...
				if (!Global_59780[i /*7*/].f_4)
				{
					STATS::STAT_GET_INT(Global_59780[i /*7*/].f_3, &outValue, -1);
				}
				else
				{
					outValue2 = 0f;
					STATS::STAT_GET_FLOAT(Global_59780[i /*7*/].f_3, &outValue2, -1);
					num = SYSTEM::FLOOR(outValue2);
				
					if (Global_59780[i /*7*/].f_5 < num)
						outValue = num;
					else
						outValue = Global_59780[i /*7*/].f_5;
				}
			
				Global_59780[i /*7*/].f_6 = outValue - Global_59780[i /*7*/].f_5;
			}
		}
	...
	for (i = 0; i < 80; i = i + 1)
	{
		if (!Global_56337[i /*36*/].f_8)
		{
			...
			if (Global_56337[i /*36*/].f_10 != 0f)
				num3 = num3 + ((0.02f * Global_56337[i /*36*/].f_9 * Global_56337[i /*36*/].f_10) - Global_56337[i /*36*/].f_9);
		
			num3 = num3 + (MISC::GET_RANDOM_FLOAT_IN_RANGE(-Global_59492[num2 /*7*/].f_6, Global_59492[num2 /*7*/].f_6) * 0.1f * Global_56337[i /*36*/].f_9);
			Global_59492[num2 /*7*/] = Global_59492[num2 /*7*/] * 0.995f;
		
			if (num3 < 0f)
				num3 = num3 * Global_59492[num2 /*7*/].f_2;
			else if (num3 > 0f)
				num3 = num3 * Global_59492[num2 /*7*/].f_1;
		
			num3 = func_46(num3, -Global_59492[num2 /*7*/].f_5, Global_59492[num2 /*7*/].f_5);
			num4 = 61;
		
			if (i == num4 && func_45(44) && !func_45(64) && num3 > 0f)
			{
				Global_56337[i /*36*/].f_9 = Global_56337[i /*36*/].f_9 - num3;
			}
			else
			{
				if (num3 > 0f)
			...
			if (Global_56337[i /*36*/].f_9 > Global_59492[num2 /*7*/].f_3)
			{
				num6 = Global_56337[i /*36*/].f_9 - Global_59492[num2 /*7*/].f_3;
				num6 = num6 * 0.5f;
				Global_56337[i /*36*/].f_9 = Global_56337[i /*36*/].f_9 - num6;
			}
			else if (Global_56337[i /*36*/].f_9 < Global_59492[num2 /*7*/].f_4)
			{
				num7 = Global_59492[num2 /*7*/].f_4 - Global_56337[i /*36*/].f_9;
				num7 = num7 * 0.5f;
				Global_56337[i /*36*/].f_9 = Global_56337[i /*36*/].f_9 + num7;
			}
		
			Global_59492[num2 /*7*/] = Global_59492[num2 /*7*/] - (((num3 * 0.66f) + (Global_59492[num2 /*7*/] * 0.33f)) * 0.02f);
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x1FB3 Hash - 0x3C5423D7 ^0x3C5423D7
{
	func_49();
...
BOOL func_50(eCharacter echParam0) // Position - 0x20C9 Hash - 0x8907F004 ^0x8907F004
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x20D5 Hash - 0xAC4E9801 ^0xB379A75F
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x2112 Hash - 0xADCB9755 ^0xADCB9755
{
...
Hash func_53(eCharacter echParam0) // Position - 0x2137 Hash - 0xE4CEEC2C ^0xE4CEEC2C
{
...
BOOL func_61(Vehicle veParam0, var uParam1) // Position - 0x2566 Hash - 0x9629BA52 ^0x1ECD0513
{
	...
	for (i = 0; i < 68; i = i + 1)
	{
		if (Global_78038.f_484[i] == veParam0)
		{
			...
			{
				if (IS_BIT_SET(Global_78038.f_555[0 /*21*/].f_9, 10) && Global_78038.f_555[0 /*21*/].f_4 == ENTITY::GET_ENTITY_MODEL(veParam0))
				{
					*uParam1 = i;
					return true;
				}
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x3D0C Hash - 0x44DD83CC ^0x7B62A376
{
	int profileSetting;
...
int func_65(eCharacter echParam0, int iParam1) // Position - 0x3DC4 Hash - 0x3C1119CD ^0x1010ECAE
{
	int num;
...
void func_66(eCharacter echParam0, var uParam1, int iParam2) // Position - 0x3E06 Hash - 0xF92B8944 ^0xD11BCD5C
{
	int num;
...
BOOL _IS_PLAYER_IN_VEHICLE_SEAT(Player plParam0, int iParam1) // Position - 0x4D14 Hash - 0x1C7D021F ^0xC08A6119
{
	Vehicle vehiclePedIsIn;
...
BOOL _NETWORK_IS_PLAYER_VALID(ePedComponentType player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x4D61 Hash - 0x3FF6E4CA ^0xE6B59972
{
	...
	for (i = 0; i < 80; i = i + 1)
	{
		if (Global_56337[i /*36*/].f_8)
		{
			...
			if (num > -1)
			{
				...
				STATS::STAT_SET_INT(Global_59218[num /*7*/].f_3[iParam0], value, true);
			}
		}
	}
			...
			if (Global_56337[i /*36*/].f_32 > 0f && Global_56337[i /*36*/].f_31 > 0f && Global_56337[i /*36*/].f_9 > 0f)
			{
				...
				for (j = 15; j >= 0; j = j + -1)
				{
					...
					else
					{
						...
						randomFloatInRange = MISC::GET_RANDOM_FLOAT_IN_RANGE(-num5 * num7, num5 * num6);
						Global_56337[i /*36*/].f_14[j] = Global_56337[i /*36*/].f_14[j + 1] + randomFloatInRange;
					}
				...
				if (num14 != 1f)
				{
					...
					for (j = 0; j <= 15; j = j + 1)
					{
						...
						Global_56337[i /*36*/].f_14[j] = Global_56337[i /*36*/].f_14[j] * (MISC::GET_RANDOM_FLOAT_IN_RANGE(0.95f, 1.05f) + (num16 * num15));
...
void func_94() // Position - 0x5A1F Hash - 0xD54B64BA ^0x7B3B32E8
{
	...
	if (!Global_114370.f_20567.f_101)
	{
		...
		{
			if (!Global_56337[i /*36*/].f_8)
				Global_56337[i /*36*/].f_9 = MISC::GET_RANDOM_FLOAT_IN_RANGE(15f, 290f);
		}
		...
		for (j = 0; j <= 15; j = j + 1)
		{
			...
			for (i = 0; i < 80; i = i + 1)
			{
				...
				Global_56337[i /*36*/].f_9 = Global_56337[i /*36*/].f_9 * MISC::GET_RANDOM_FLOAT_IN_RANGE(startRange, endRange);
				Global_56337[i /*36*/].f_9 = func_93(func_92(MISC::ABSF(Global_56337[i /*36*/].f_9), 3.5f), 290f);
			}
		}
...
void func_95() // Position - 0x5B64 Hash - 0xD9860646 ^0xBC0AC2AB
{
	...
	randomIntInRange = MISC::GET_RANDOM_INT_IN_RANGE(0, Global_61499 - 1);
	...
	for (i = 0; i < 4; i = i + 1)
	{
		for (j = 0; j < 3; j = j + 1)
		{
			...
			while (!func_88(&Global_61502[randomIntInRange /*14*/], i))
			{
				randomIntInRange = MISC::GET_RANDOM_INT_IN_RANGE(0, Global_61499 - 1);
				SYSTEM::WAIT(2000);
			}
		
			Global_61502[randomIntInRange /*14*/].f_10 = 0f;
			randomIntInRange = MISC::GET_RANDOM_INT_IN_RANGE(0, Global_61499 - 1);
		}
	}
